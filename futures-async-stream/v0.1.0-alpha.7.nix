...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/futures-async-stream/v0.1.0-alpha.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-async-stream-macro" = rec {
        ...
        version = "0.1.0-alpha.7";
        edition = "2018";
        sha256 = "01g2l8m6d46kway7zw3s1mg0qrf25im4yjjfm8sfd174d227q718";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "pin-project" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "190rwjdbm0q7lx2kxrng97xcw3kmhgppwnimn3jrk6c96ziplc1f";
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
        dependencies = [
      ...
      "pin-project-internal" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1la5qm2mkvaw4q5a1wpj8fgnqxc4rz447vgr1hsshn0m2j7la8jm";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "std" "synchapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
