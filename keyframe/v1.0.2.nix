...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/keyframe/v1.0.2.nix.tmp"
    ...
    crates = {
      ...
      "glyph_brush 0.5.4" = rec {
        ...
        dependencies = [
          {
            name = "glyph_brush";
            packageId = "glyph_brush 0.6.1";
            rename = "glyph_brush_next";
          }
        ];
        
      };
      "glyph_brush 0.6.1" = rec {
        crateName = "glyph_brush";
        version = "0.6.1";
        edition = "2018";
      ...
      "keyframe" = rec {
        ...
        authors = [
          "Hannes Mann <hannesmann2000@gmail.com>"
        ];
        dependencies = [
          {
            name = "mint";
        ...
        resolvedDefaultFeatures = [ "default" "mint" "mint_types" ];
      };
      "khronos_api" = rec {
