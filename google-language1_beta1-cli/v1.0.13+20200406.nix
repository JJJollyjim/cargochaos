...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-language1_beta1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-language1_beta1-cli";
  ...
  workspaceMembers = {
    "google-language1_beta1-cli" = rec {
      packageId = "google-language1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-language1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-language1_beta1" = rec {
        crateName = "google-language1_beta1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "1f1ja5sb8lbcfyshxpnsxl466r0aqqviy34fjbhplnsajvycsklj";
        authors = [
      ...
      "google-language1_beta1-cli" = rec {
        crateName = "google-language1_beta1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "language1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-language1_beta1";
            packageId = "google-language1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
