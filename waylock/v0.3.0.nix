...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/waylock/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "calloop" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1rbdmnvl4xhh26a1pmslkwj7z2zid4imlh3k139s7q2y05ccnyf0";
        authors = [
      ...
      "smithay-client-toolkit" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "1fjky6d4pk3ybl5l3rwi5xabrmspz2nhr7nhnz16f12ppr70w06z";
        authors = [
          "Victor Berger <victor.berger@m4x.org>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "std" "synchapi" "sysinfoapi" "winbase" "wincon" "windef" "winerror" "winioctl" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
