...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/osmptparser/v1.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "osm_pbf_iter" = rec {
        crateName = "osm_pbf_iter";
        version = "0.2.0";
        edition = "2015";
        crateBin = [];
        sha256 = "02igiv2dyfhl7y7q0cpj1qrgr9ab9s4h55v6kmc7cnahak2jvqmi";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "protobuf_iter";
            packageId = "protobuf_iter";
          }
        ];
        
      };
      "osmptparser" = rec {
        crateName = "osmptparser";
        version = "1.2.1";
        edition = "2018";
      ...
      "protobuf_iter" = rec {
        crateName = "protobuf_iter";
        version = "0.1.2";
        edition = "2015";
        sha256 = "0x00ic21ivz64kbz4b1cnpfkfp5nimvlpyl1jc00bnvka7p5dwzb";
        authors = [
          "Astro <astro@spaceboyz.net>"
        ];
        dependencies = [
