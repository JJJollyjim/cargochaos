...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/econf/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "econf-derive" = rec {
        crateName = "econf-derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0s32fmnkr2pzdhigdrdw6h2bzpp09z0q0x6kbmbn6jljbm5k6llx";
        procMacro = true;
        authors = [
          "Yushi OMOTE <yushiomote@gmail.com>"
        ];
      ...
      "parse_duration" = rec {
        ...
        version = "1.0.1";
        edition = "2015";
        sha256 = "1q79r26sr8vr879xhbfrry6ywwxmky2vh02bwj19jjb9xc5b1a1w";
        authors = [
