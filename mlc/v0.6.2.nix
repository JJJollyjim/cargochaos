...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mlc/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ntest" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "04cljndihkcqqwj061bgpnxyv7wqbd3f91ag1b3ryrayn7rrclxv";
        authors = [
          "Armin Becher <becherarmin@gmail.com>"
        ];
        dependencies = [
      ...
      "ntest_test_cases" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "0z8wiin2fgnyfsc0xljibbkn169m3ivwkg39pp4dqm8c9yhrz84b";
        procMacro = true;
        authors = [
      ...
      "ntest_timeout" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "0klryn3rgjxnq3cv6j8bwcsr0b7zw3x216h63144v22aja18p0g0";
        procMacro = true;
        authors = [
          "Armin Becher <armin.becher@gmail.com>"
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "default-tls" "default-tls-vendored" "hyper-tls" "native-tls" "tls" ];
      };
      "rust-argon2" = rec {
      ...
      "timebomb" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0fl8bxi9bf5bv44i1afii63695cx4jlki869v0kp01ipnvs8c23z";
        authors = [
          "Colin Sherratt <colin.sherratt@gmail.com>"
        ];
        dependencies = [
