...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mlc/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ntest" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "11ra4dl2850g7py4dqzhj0lmqk2gg8r7l107lbvfw7hvf39sffpd";
        authors = [
          "Armin Becher <becherarmin@gmail.com>"
        ];
        dependencies = [
      ...
      "ntest_test_cases" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "102kym7ryb2rilml3cp5q0lylls6b8zmppzc98khwgbns2akba0l";
        procMacro = true;
        authors = [
      ...
      "ntest_timeout" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1mshmgwpzsiigm390y2hkprawh2dj98h89xh5vg189rnwn3ygn6k";
        procMacro = true;
        authors = [
          "Armin Becher <armin.becher@gmail.com>"
        ];
