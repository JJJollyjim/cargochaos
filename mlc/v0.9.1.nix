...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mlc/v0.9.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "CanvasRenderingContext2d" "Document" "DomRect" "Element" "Headers" "HtmlCanvasElement" "HtmlElement" "MessageEvent" "Node" "Request" "RequestInit" "RequestMode" "Response" "Window" "Worker" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
