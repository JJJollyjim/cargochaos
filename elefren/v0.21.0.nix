...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/elefren/v0.21.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "elefren" = rec {
        ...
        resolvedDefaultFeatures = [ "all" "default" "env" "envy" "json" "rustls-tls" "toml" ];
      };
      "encoding_rs" = rec {
      ...
      "tap-reader" = rec {
        crateName = "tap-reader";
        version = "1.0.1";
        edition = "2015";
        sha256 = "1wxnxzmszmg8lqc3cmzzpilp7w2r1ir7k9lvaba8qnj13lqgq4wg";
        authors = [
          "Paul Woolcock <paul@woolcock.us>"
        ];
