...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/check-latest/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "check-latest" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "blocking" "default" ];
      };
      "chrono" = rec {
        crateName = "chrono";
        version = "0.4.10";
