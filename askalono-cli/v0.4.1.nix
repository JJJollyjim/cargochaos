...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/askalono-cli/v0.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "askalono-cli" = rec {
        crateName = "askalono-cli";
        version = "0.4.1";
        edition = "2018";
        crateBin = [
          { name = "askalono"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "diagnostics" "difference" "embedded-cache" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.13";
