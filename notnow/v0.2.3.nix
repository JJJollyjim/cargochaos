...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/notnow/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cell" = rec {
        ...
        version = "0.1.8";
        edition = "2018";
        sha256 = "0sgvyvjm2wqx0rng6xnpyi3lvyxqi8hq24dya31npld2jz5w2zaf";
        authors = [
      ...
      "coredump" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1c57yrnxs7gpnax4h5rbmypmxn1a8qm1pdinddzmyz6lx1h9j1y4";
        authors = [
          "Daniel Mueller <deso@posteo.net>"
        ];
        dependencies = [
      ...
      "gui" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "17c0a19b56b6sb4cf1dly0y31z6hcfzpkp3xcz01kwkix8y7967q";
        authors = [
          "Daniel Mueller <deso@posteo.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "derive" "gui-derive" ];
      };
      "gui-derive" = rec {
        crateName = "gui-derive";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0l226s6p511qbmffmx77lzj6qgj44hd9rm3w8mvprpf8b6sfvhs7";
        procMacro = true;
        authors = [
          "Daniel Mueller <deso@posteo.net>"
        ];
      ...
      "notnow" = rec {
        ...
        resolvedDefaultFeatures = [ "cdump" "coredump" "default" "readline" "rline" ];
      };
      "numtoa" = rec {
        crateName = "numtoa";
        version = "0.1.0";
      ...
      "rline" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1rhkjb2rhp6sgvsmvsm9rv462rbbcfns9j7diyvf4rkrmh7s7hin";
        authors = [
          "Daniel Mueller <deso@posteo.net>"
        ];
        dependencies = [
      ...
      "uid" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1mqb1vlfn2kvj4mky97kqc1j6i9nvk7r0c63amssh730b1dwpjjh";
        authors = [
          "Daniel Mueller <deso@posteo.net>"
        ];
