...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/enr/v0.1.0-alpha-1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "enr" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "enr-cli"; path = "src/enr-cli.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "libp2p" "libp2p-core" "serde" ];
      };
      "fake-simd" = rec {
        crateName = "fake-simd";
        version = "0.1.2";
      ...
      "parity-multiaddr" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "12wmzph9vv9rx7js6v8kbfar3dq6z34mqk4baa94wgxwk0r8ipr6";
        authors = [
      ...
      "unsigned-varint" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0w6m86zayagqxgq36i65y91cc5846nya4qaxy3sx41j2f4vgnzrv";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        features = {
