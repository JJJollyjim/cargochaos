...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vcdump/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vcd" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1v4m34l8p833mgh6v2yz02ydcbljlwibn5nlxqg430nf1kh6gzj5";
        authors = [
      ...
      "vcdump" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "vcdump"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Samuel Thomas <sgpthomas@gmail.com>"
        ];
        dependencies = [
          {
            name = "atty";
