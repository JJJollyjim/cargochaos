...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/seedstudio-gd32v/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gd32vf103xx-hal" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1ryypzwi7qfdpl4r5f54k161nqx7yj4zah686pwm0dk9h7l7kvnv";
        authors = [
          "The RISC-V Team <risc-v@teams.rust-embedded.org>"
        ];
        dependencies = [
