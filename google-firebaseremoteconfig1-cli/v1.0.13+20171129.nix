...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-firebaseremoteconfig1-cli/v1.0.13+20171129.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-firebaseremoteconfig1-cli";
  ...
  workspaceMembers = {
    "google-firebaseremoteconfig1-cli" = rec {
      packageId = "google-firebaseremoteconfig1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-firebaseremoteconfig1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-firebaseremoteconfig1" = rec {
        crateName = "google-firebaseremoteconfig1";
        version = "1.0.13+20171129";
        edition = "2015";
        sha256 = "1z0kswl6ysgc187wkwakzqdg7r0q94kc0wakz1pj96hgjwkq4azh";
        authors = [
      ...
      "google-firebaseremoteconfig1-cli" = rec {
        crateName = "google-firebaseremoteconfig1-cli";
        version = "1.0.13+20171129";
        edition = "2015";
        crateBin = [
          { name = "firebaseremoteconfig1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20171129.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-firebaseremoteconfig1";
            packageId = "google-firebaseremoteconfig1";
          }
          {
            name = "hyper";
            packageId = "hyper";
