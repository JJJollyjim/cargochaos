...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/marked-cli/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "marked" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1zl8174w7lgiv9xi0nry2kkm7ki8j1ysrb11f6ml1v6lg3ipm5sq";
        authors = [
      ...
      "marked-cli" = rec {
        crateName = "marked-cli";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "marked"; path = "src/main.rs"; }
        ];
      ...
      "tendril" = rec {
        ...
        resolvedDefaultFeatures = [ "encoding_rs" ];
      };
      "term_size" = rec {
        crateName = "term_size";
        version = "0.3.1";
