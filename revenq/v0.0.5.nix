...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/revenq/v0.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "revenq" = rec {
        ...
        features = {
          "default" = [ "woke-queue" ];
          "woke-queue" = [ "async-task" "crossbeam-utils" "futures-core" "pin-utils" ];
        };
        resolvedDefaultFeatures = [ "async-task" "crossbeam-utils" "default" "futures-core" "pin-utils" "woke-queue" ];
      };
      "rustc_version" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
