...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/show-direnv-diff/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "show-direnv-diff" = rec {
        crateName = "show-direnv-diff";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "show-direnv-diff"; path = "src/main.rs"; }
        ];
