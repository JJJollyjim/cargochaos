...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gym/v2.0.2-beta.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpython" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0ps8s6ys0jj0y7dgdiwv67wjq8d3kaiac5njka1b1bhmhdj2qlw5";
        authors = [
      ...
      "gym" = rec {
        ...
        version = "2.0.2-beta";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.2-beta.nix {};
        authors = [
      ...
      "python3-sys" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1snqczrpi0kq0g5szwp9fn6cs45wvc4hd5pkg6hzs08j7znypa7k";
        authors = [
          "Daniel Grunwald <daniel@danielgrunwald.de>"
        ];
        dependencies = [
