...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssh-gpg-agent/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ssh-agent" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "1zc341ja6b6wzprc90dpnchwchwq81k2z39xkjrs0inbq8692xm3";
        authors = [
      ...
      "ssh-gpg-agent" = rec {
        crateName = "ssh-gpg-agent";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "ssh-gpg-agent"; path = "src/main.rs"; }
        ];
      ...
      "ssh-keys" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "11jw6570l1y34dvjm710kpq8l46h85h2hzkcshdfw6i31xlpdpkd";
        authors = [
          "paul@colomiets.name"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "ntstatus" "objbase" "shlobj" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
