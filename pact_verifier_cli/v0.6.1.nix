...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pact_verifier_cli/v0.6.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "difference 0.4.1" = rec {
        crateName = "difference";
        version = "0.4.1";
        edition = "2015";
        crateBin = [];
        sha256 = "1sn5h4crfahj6hyrv5n7y39mr5f1kms1wvmxsmp906l89qa4rvzz";
        authors = [
      ...
      "pact_matching" = rec {
        ...
        version = "0.5.5";
        edition = "2015";
        sha256 = "04sbi0p63yi5cv9dfrf3kmfl2cqjrkdvcmf6x611dinm5dadz4cq";
        authors = [
      ...
      "pact_verifier" = rec {
        crateName = "pact_verifier";
        version = "0.6.1";
        edition = "2015";
        sha256 = "1anx94gkswcmqk3spgp97s02wh7hv4ic0ln8yw6sq5b7n0id02gj";type = [ "cdylib" "rlib" ];
        authors = [
          "Ronald Holshausen <uglyog@gmail.com>"
        ];
        dependencies = [
      ...
      "pact_verifier_cli" = rec {
        crateName = "pact_verifier_cli";
        version = "0.6.1";
        edition = "2015";
        crateBin = [
          { name = "pact_verifier_cli"; path = "src/main.rs"; }
        ];
