...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/moleculec/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "molecule-codegen" = rec {
        crateName = "molecule-codegen";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0qha68y66cdwk67zyjh78b730dvsh5l4j7bk9y08rnjc8wypf460";
        authors = [
          "Nervos Core Dev <dev@nervos.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "compiler-plugin" "default" "serde" "serde_json" "serde_yaml" ];
      };
      "moleculec" = rec {
        crateName = "moleculec";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "moleculec"; path = "src/compiler.rs"; }
          { name = "moleculec-c"; path = "src/compiler-c.rs"; }
          { name = "moleculec-rust"; path = "src/compiler-rust.rs"; }
        ];
      ...
      "property" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "01bf13c14bi1ahrbcp0961pny1cv1yqly5yilmvhhrqpfhadjb6w";
        procMacro = true;
        authors = [
