...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/moleculec/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "molecule" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "161rcvgrfba1bj5qk71wa2l8myc9kp73qmpmw9bmk7i1ab67cgv6";
        authors = [
      ...
      "molecule-codegen" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "01wpybq73l40rb8z7v1bh74fw1xcki16pfhsvc61qifbrqqqhs7v";
        authors = [
          "Nervos Core Dev <dev@nervos.org>"
        ];
        dependencies = [
