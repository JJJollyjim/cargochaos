...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-accesscontextmanager1_beta-cli/v1.0.12+20190626.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-accesscontextmanager1_beta-cli";
  ...
  workspaceMembers = {
    "google-accesscontextmanager1_beta-cli" = rec {
      packageId = "google-accesscontextmanager1_beta-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-accesscontextmanager1_beta-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-accesscontextmanager1_beta" = rec {
        crateName = "google-accesscontextmanager1_beta";
        version = "1.0.12+20190626";
        edition = "2015";
        sha256 = "1iw26vs2ai8h1i1z8y7x57pca09hmmp945d7bjwzxixbr407bcw8";
        authors = [
      ...
      "google-accesscontextmanager1_beta-cli" = rec {
        crateName = "google-accesscontextmanager1_beta-cli";
        version = "1.0.12+20190626";
        edition = "2015";
        crateBin = [
          { name = "accesscontextmanager1-beta"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-accesscontextmanager1_beta";
          }
          {
            name = "hyper";
            packageId = "hyper";
