...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zenroom_minimal/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rlua_serde" = rec {
        crateName = "rlua_serde";
        version = "0.3.1";
        edition = "2015";
        sha256 = "09a71dm52naylgx9zjqj6xgzy11h6s1z0vr0fbrkqxdxlrp2l1ng";
        authors = [
          "zrkn <zrkn@email.su>"
        ];
        dependencies = [
