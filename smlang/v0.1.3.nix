...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/smlang/v0.1.3.nix.tmp"
    ...
    crates = {
      ...
      "smlang" = rec {
        ...
        dependencies = [
          {
            name = "smlang-macros";
            packageId = "smlang-macros";
          }
        ];
        
      };
      "smlang-macros" = rec {
        crateName = "smlang-macros";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0qnpyarlir5zbzp8gvihlmrni1fzzalvw9dhi2b5x7543kwm9rkx";
        procMacro = true;
        authors = [
          "Emil Fresk <emil.fresk@gmail.com>"
        ];
