...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mamba/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mamba" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mamba"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Joël Abrahams <abrahamsjo@gmail.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
      ...
      "python-parser" = rec {
        crateName = "python-parser";
        version = "0.1.0";
        edition = "2015";
        crateBin = [];
        sha256 = "09kvlr794qgfs2zfp6mzwnmsw6r4y7yqc0x0sp1p429ikchvndqi";
        authors = [
          "Valentin Lorentz <progval+git@progval.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "bigint" "default" "num-bigint" "num-traits" "wtf8" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.2";
