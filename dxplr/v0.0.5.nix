...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dxplr/v0.0.5.nix.tmp"
      ...
      "dxplr" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "impl-default" "winbase" "winuser" "libloaderapi" "handleapi" "synchapi" "d3dcommon" "dxgi" "dxgidebug" "d3d12" "d3d12sdklayers" ];
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "d3dcompiler" "dxgi1_2" "dxgi1_3" "dxgi1_4" "dxgi1_5" "dxgi1_6" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.5.2";
