...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dxplr/v0.0.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dxplr" = rec {
        ...
        resolvedDefaultFeatures = [ "d3d11_1" "d3d11_2" "d3d11_3" "d3d11_4" "d3d11on12" "d3dcompiler" "dxgi1_2" "dxgi1_3" "dxgi1_4" "dxgi1_5" "dxgi1_6" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.5.3";
