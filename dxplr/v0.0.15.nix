...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dxplr/v0.0.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "com_ptr" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0bfpd629f9a2bbmq3xhbbcc4zy6gj5pyqa0xzjrrldk2gpni0yfd";
        authors = [
      ...
      "dxplr" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi 0.3.8";
            features = [ "impl-default" "winbase" "winuser" "libloaderapi" "handleapi" "synchapi" ];
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "d2d1" "d2d1_1" "d2d1_2" "d2d1_3" "d3d11" "d3d11_1" "d3d11_2" "d3d11_3" "d3d11_4" "d3d11on12" "d3d11sdklayers" "d3d12" "d3d12sdklayers" "d3dcompiler" "dwrite" "dwrite_1" "dwrite_2" "dwrite_3" "dxgi" "dxgi1_2" "dxgi1_3" "dxgi1_4" "dxgi1_5" "dxgi1_6" "dxgidebug" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.5.3";
      ...
      "smithay-client-toolkit" = rec {
        ...
        version = "0.6.5";
        edition = "2015";
        sha256 = "04ia0n2ax6nfyii9w8387ml0v8fnp1c01qc2mv2f3nzg0wq5labs";
        authors = [
          "Victor Berger <victor.berger@m4x.org>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "commctrl" "consoleapi" "d2d1" "d2d1_1" "d2d1_2" "d2d1_3" "d2d1effects" "d2d1effects_1" "d2d1effects_2" "d2d1svg" "d3d11" "d3d11_1" "d3d11_2" "d3d11_3" "d3d11_4" "d3d11on12" "d3d11sdklayers" "d3d12" "d3d12sdklayers" "d3dcommon" "d3dcompiler" "dcommon" "dwmapi" "dwrite" "dwrite_1" "dwrite_2" "dwrite_3" "dxgi" "dxgi1_2" "dxgi1_3" "dxgi1_4" "dxgi1_5" "dxgi1_6" "dxgidebug" "errhandlingapi" "fileapi" "handleapi" "hidusage" "impl-default" "libloaderapi" "memoryapi" "minwindef" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "stringapiset" "synchapi" "sysinfoapi" "unknwnbase" "winbase" "wincodec" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
