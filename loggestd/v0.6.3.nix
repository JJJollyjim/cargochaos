...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/loggestd/v0.6.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "loggestd" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "loggestd"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "minwinbase" "minwindef" "ntstatus" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "winsvc" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
