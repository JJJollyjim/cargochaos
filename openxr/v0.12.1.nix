...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openxr/v0.12.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "openxr" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "libloading" "linked" "loaded" "mint" "static" ];
      };
      "openxr-sys" = rec {
        crateName = "openxr-sys";
        version = "0.8.1";
        edition = "2018";
        sha256 = "0irs233ydia313d7w3lqkxgh2ai49a33dk956f1b6nafdzzq5adi";
        authors = [
          "Benjamin Saunders <ben.e.saunders@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi";
            target = { target, features }: target."windows";
            features = [ "windef" "ntdef" "d3dcommon" "d3d11" "d3d12" ];
          }
        ];
        buildDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "cmake" "mint" "prototypes" "static" ];
      };
      "pkg-config" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "d3d11" "d3d12" "d3dcommon" "errhandlingapi" "libloaderapi" "ntdef" "profileapi" "windef" "winerror" ];
      };
