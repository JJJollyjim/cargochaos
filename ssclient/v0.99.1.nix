...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssclient/v0.99.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "securestore" = rec {
        crateName = "securestore";
        version = "0.99.1";
        edition = "2018";
        sha256 = "1jjd5kkmw50hvkh1y38rd71zpi2dj6wryv0jssq21rkp35bikv2x";
        authors = [
        ...
        resolvedDefaultFeatures = [ "openssl-vendored" ];
      };
      "serde" = rec {
        crateName = "serde";
        version = "1.0.104";
      ...
      "ssclient" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ssclient"; path = "src/main.rs"; }
        ];
