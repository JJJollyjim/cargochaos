...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linuxcnc-hal/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linuxcnc-hal-sys" = rec {
        crateName = "linuxcnc-hal-sys";
        version = "0.1.6";
        edition = "2018";
        sha256 = "1ndaf3kgka382pk5zn62bf6sqqm6x87szh762zgd8rx2m55iw503";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        buildDependencies = [
