...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dlp2-cli/v1.0.13+20200405.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dlp2" = rec {
        crateName = "google-dlp2";
        version = "1.0.13+20200405";
        edition = "2015";
        sha256 = "15dj0fgxn9qkfm6bqizbv5jbskban6sy7jbq9kpbvjsag1icj4xj";
        authors = [
      ...
      "google-dlp2-cli" = rec {
        crateName = "google-dlp2-cli";
        version = "1.0.13+20200405";
        edition = "2015";
        crateBin = [
          { name = "dlp2"; path = "src/main.rs"; }
        ];
