...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deterministic-zip/v0.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deterministic-zip" = rec {
        crateName = "deterministic-zip";
        version = "0.0.3";
        edition = "2018";
        crateBin = [
          { name = "deterministic-zip"; path = "src/main.rs"; }
        ];
