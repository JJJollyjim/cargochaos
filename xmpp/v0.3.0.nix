...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xmpp/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jid" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "0rwcc4n1kpfciwkpqiwndzwzkrqlf78w3wka7sbf84qz5rkpcdly";
        authors = [
          "lumi <lumi@pew.im>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
