...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tulip/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libmimalloc-sys" = rec {
        ...
        version = "0.1.14";
        edition = "2018";
        sha256 = "1gd0065imijr24zbpcz3bgn18hrdanni9gn6xfz726sal9xglzxq";
        authors = [
      ...
      "mimalloc" = rec {
        ...
        version = "0.1.18";
        edition = "2018";
        sha256 = "1ppjff8i3wnylsa73mym8jirnm0r6byi0sddz2mr4vmq9vp6xccl";
        authors = [
          "Octavian Oncescu <octavonce@gmail.com>"
      ...
      "simd-json" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "04nysvnhqy7wggmchlxcdwdpfyq8bp37li46jabgwn0x2p2yv22q";
        authors = [
          "Heinz N. Gies <heinz@licenser.net>"
          "Sunny Gleason"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_impl" "serde_json" "swar-number-parsing" ];
      };
      "slab" = rec {
        crateName = "slab";
        version = "0.4.2";
      ...
      "tulip" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tulip"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "SchrodingerZhu <i@zhuyi.fan>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
