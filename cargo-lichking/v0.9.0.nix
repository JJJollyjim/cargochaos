...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-lichking/v0.9.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-lichking" = rec {
        crateName = "cargo-lichking";
        version = "0.9.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-lichking"; path = "src/main.rs"; }
        ];
