...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/regex/v1.3.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "regex" = rec {
        ...
        resolvedDefaultFeatures = [ "aho-corasick" "default" "memchr" "pattern" "perf" "perf-cache" "perf-dfa" "perf-inline" "perf-literal" "std" "thread_local" "unicode" "unicode-age" "unicode-bool" "unicode-case" "unicode-gencat" "unicode-perl" "unicode-script" "unicode-segment" "unstable" "use_std" ];
      };
      "regex-syntax" = rec {
