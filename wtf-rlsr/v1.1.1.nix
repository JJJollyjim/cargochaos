...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wtf-rlsr/v1.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wtf-rlsr" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wtf-rlsr"; path = "bin/main.rs"; }
        ];
