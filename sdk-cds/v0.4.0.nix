...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sdk-cds/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sdk-cds" = rec {
        ...
        authors = [
          "Benjamin Coenen <benjamin.coenen@corp.ovh.com>"
        ];
        dependencies = [
          {
            name = "async-std";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
