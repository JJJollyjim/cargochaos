...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/census-proteomics/v0.1.7.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "census-proteomics" = rec {
        crateName = "census-proteomics";
        version = "0.1.7";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.7.nix {};
        authors = [
          "Michael Lazear <lazear@scripps.edu>"
        ];
        dependencies = [
          {
            name = "serde";
