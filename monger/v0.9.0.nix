...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/monger/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "html5ever" = rec {
        ...
        version = "0.22.3";
        edition = "2015";
        sha256 = "0r53d6q12hhzdj8mrwq3qzxhdjgqybwclspn1c56aql8f77phi5h";
        authors = [
      ...
      "monger" = rec {
        ...
        dependencies = [
          ...
          {
            name = "monger-core";
            packageId = "monger-core";
          }
        ];
        
      };
      "monger-core" = rec {
        crateName = "monger-core";
        version = "0.9.0";
        edition = "2018";
        sha256 = "0zjhngg51mgwwsmbc2v7qawkhlmrqssvpmjkhy7q39rf1pn2cafm";
        authors = [
          "Saghm Rossi <saghmrossi@gmail.com>"
        ];
        dependencies = [
      ...
      "rs-release" = rec {
        crateName = "rs-release";
        version = "0.1.7";
        edition = "2015";
        sha256 = "0wlrshgp192wi3j9cqg5m2qq92rnc8fxhrdaxn1w56qb9b7p9a6l";
        authors = [
      ...
      "soup" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0cb00nqymi9xybliaf1gnanmzyia1xhq9vcqjl05fjk5g036psqn";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
