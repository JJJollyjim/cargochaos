...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shticker_book_unwritten/v1.0.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "shticker_book_unwritten";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shticker_book_unwritten" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "shticker_book_unwritten"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Dr. Jonathan Helianthicus Doe, IV <augiii@protonmail.com>"
        ];
        dependencies = [
          {
            name = "bzip2";
