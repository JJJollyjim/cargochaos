...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xcompress/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "processenv" "processthreadsapi" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" ];
      };
      ...
      "xcompress" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "xcompress"; path = "src/main.rs"; }
        ];
