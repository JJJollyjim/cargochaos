...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-deploymentmanager2_beta2-cli/v1.0.12+20160201.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-deploymentmanager2_beta2-cli";
  ...
  workspaceMembers = {
    "google-deploymentmanager2_beta2-cli" = rec {
      packageId = "google-deploymentmanager2_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-deploymentmanager2_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-deploymentmanager2_beta2" = rec {
        crateName = "google-deploymentmanager2_beta2";
        version = "1.0.12+20160201";
        edition = "2015";
        sha256 = "015v6hr5k58hd27a7a4jsc8i0s89gwq2aks0wgqzfii00xzh985q";
        authors = [
      ...
      "google-deploymentmanager2_beta2-cli" = rec {
        crateName = "google-deploymentmanager2_beta2-cli";
        version = "1.0.12+20160201";
        edition = "2015";
        crateBin = [
          { name = "deploymentmanager2-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20160201.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-deploymentmanager2_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
