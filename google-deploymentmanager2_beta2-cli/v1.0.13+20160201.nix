...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-deploymentmanager2_beta2-cli/v1.0.13+20160201.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-deploymentmanager2_beta2" = rec {
        ...
        version = "1.0.13+20160201";
        edition = "2015";
        sha256 = "1wy8853r1lpxwai8vv4l72pppjv5j6j9jjy5wpv1mxx06d5w5kfr";
        authors = [
      ...
      "google-deploymentmanager2_beta2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20160201.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
