...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/littlewing/v0.6.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "littlewing" = rec {
        crateName = "littlewing";
        version = "0.6.0";
        edition = "2015";
        crateBin = [
          { name = "littlewing"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
