...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_blob/v0.30.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "azure_sdk_storage_blob";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_storage_blob" = rec {
        crateName = "azure_sdk_storage_blob";
        version = "0.30.0";
        edition = "2018";
