...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_blob/v0.20.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.20.0";
        edition = "2018";
        sha256 = "0jp94cvaa3mmc755zvprhlb3fykvasmplkijvfl1sa697gzrgxwv";
        authors = [
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.20.0";
        edition = "2018";
        sha256 = "1sbahpq35xl087g23d3b6v4dpgwfqgzi3vra5jbaq59zh4ag1j0a";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
