...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/egaku2d/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "axgeom" = rec {
        ...
        version = "1.5.1";
        edition = "2018";
        sha256 = "090gflmyqqmkigmch93gziscskapk7iwj36w6j7xrmh0myalbg79";
        authors = [
      ...
      "egaku2d" = rec {
        ...
        resolvedDefaultFeatures = [ "fullscreen" ];
      };
      "egaku2d_core" = rec {
        crateName = "egaku2d_core";
        version = "0.4.1";
        edition = "2018";
        sha256 = "1fhz46dyf4g7im4vn9jg8q5lmg2a16yfnddy4238w07gmwxwalwn";
        authors = [
          "Ken <kenakioreed@gmail.com>"
        ];
        dependencies = [
          {
            name = "axgeom";
