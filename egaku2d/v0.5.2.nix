...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/egaku2d/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "axgeom" = rec {
        ...
        version = "1.6.1";
        edition = "2018";
        sha256 = "0mfjbiqiqalqgsckwhv9vbp8lbxd6cb194nyp8l64371wpk3qgrv";
        authors = [
      ...
      "egaku2d_core" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "065s27qxd1jk6zshhcgq0lbmm7rjqhkbfv5wmdiq9zlmpi2msk5y";
        authors = [
