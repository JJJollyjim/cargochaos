...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pedit/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cotton" = rec {
        ...
        version = "0.0.9";
        edition = "2018";
        sha256 = "0m9kbfb92hxgkhdhz90gpahs8lzwdyasjjmxmwfjlm0ppxrs3jpg";
        authors = [
      ...
      "winapi 0.3.6" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
