...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cursive-tabs/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive-tabs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "end2end_vertical_right"; path = "src/bin/end2end_vertical_right.rs"; }
          { name = "end2end_vertical_left"; path = "src/bin/end2end_vertical_left.rs"; }
          { name = "end2end_switch"; path = "src/bin/end2end_switch.rs"; }
          { name = "end2end_swap"; path = "src/bin/end2end_swap.rs"; }
          ...
          { name = "end2end_panel_smoke"; path = "src/bin/end2end_panel_smoke.rs"; }
          { name = "end2end_add_at_panel"; path = "src/bin/end2end_add_at_panel.rs"; }
          { name = "end2end_add_at"; path = "src/bin/end2end_add_at.rs"; }
        ];
