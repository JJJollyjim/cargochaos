...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/splitterrust_discord/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "splitterrust_discord";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "command_attr" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "0bylj95xmwi45qd3h6jp5d7k4l9s0nc7vqlck13dsg8y29k4cq77";
        procMacro = true;
        authors = [
      ...
      "serenity" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "1fcba3vz3waqzc8n690p4087zqma1w26arj22c0ar7nhppqvvmwd";
        authors = [
      ...
      "splitterrust_db" = rec {
        crateName = "splitterrust_db";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0hvl8aliqmvjll4k8g6s4bg1l2fp5gz7rgq33s0bzj1mzjhcabr8";
        authors = [
          "Maximilian Konter <biskit1943@gmx.de>"
        ];
        dependencies = [
          {
            name = "diesel";
      ...
      "splitterrust_discord" = rec {
        crateName = "splitterrust_discord";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "splitterrust_discord"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Maximilian Arlt <queso1307@gmail.com>"
          "Maximilian Konter <biskit1943@gmx.de>"
        ];
        dependencies = [
          {
          ...
          {
            name = "splitterrust_db";
            packageId = "splitterrust_db";
          }
        ];
