...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cxmr-ws-client-poloniex/v0.0.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "cxmr-ws-client-poloniex";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cxmr-ws-client-poloniex" = rec {
        crateName = "cxmr-ws-client-poloniex";
        version = "0.0.1";
        edition = "2018";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
