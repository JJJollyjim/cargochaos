...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cksfv/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cksfv" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "memmap" "mmap" "nightly" ];
      };
      "clap" = rec {
        crateName = "clap";
        version = "2.33.0";
      ...
      "crc32fast" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "nightly" "std" ];
      };
      "difference" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
