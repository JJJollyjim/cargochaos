...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/toid/v0.1.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sized-chunks" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "03ykvb21mjvhwqxqgcx8ipzb78jccdsc45p2n4a47ddkjbfn9nv2";
        authors = [
          "Bodil Stokke <bodil@bodil.org>"
        ];
        dependencies = [
      ...
      "toid" = rec {
        ...
        authors = [
          "masashi yoshikawa <earnest.marshi@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
