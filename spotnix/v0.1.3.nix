...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spotnix/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chrono" = rec {
        ...
        resolvedDefaultFeatures = [ "clock" "default" "rustc-serialize" "serde" "time" ];
      };
      "clap" = rec {
        crateName = "clap";
        version = "2.33.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
