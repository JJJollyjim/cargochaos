...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsgen-avro/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "avro-rs" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1gggxcq5sgrjbmimrswf42mhwhshxz9nhmn2gygxz11s8xfjighv";
        authors = [
      ...
      "rsgen-avro" = rec {
        crateName = "rsgen-avro";
        version = "0.6.4";
        edition = "2018";
        crateBin = [
          { name = "rsgen-avro"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.6.4.nix {};
        authors = [
          "Romain Leroux <romain@leroux.dev>"
        ];
        dependencies = [
          {
            name = "avro-rs";
