...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/filecoin-proofs/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fil-sapling-crypto" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "05hjqhgvl41vcc3zz20abw96kxxavyw9q4zkpc7hhmpm5qkbd3i3";
        authors = [
      ...
      "logging-toolkit" = rec {
        crateName = "logging-toolkit";
        version = "0.5.0";
        edition = "2018";
        sha256 = "17xla5vl71m4zh068zr5kh3ha50h27vzbifsvvnw6p1qlrrwhnqb";
        authors = [
          "laser <l@s3r.com>"
        ];
        dependencies = [
      ...
      "openssl-src" = rec {
        ...
        edition = "2015";
        sha256 = "10s3hvkfk6bi4ba1ssvj914rjs31vs8plssy4kbvsa0w7idkqfkq";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "storage-proofs" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0y4f1p7sa80zwc7ryczw9n519bnrinbi6xpvvg7v3c0jab6dacgm";
        authors = [
          "dignifiedquire <dignifiedquire@gmail.com>"
          "laser <l@s3r.com>"
          "porcuquine <porcuquine@users.noreply.github.com>"
