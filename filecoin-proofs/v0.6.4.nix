...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/filecoin-proofs/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "filecoin-proofs" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.6.4.nix {};
        authors = [
