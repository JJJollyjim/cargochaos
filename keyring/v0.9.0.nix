...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/keyring/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "winbase" "wincred" "winnt" ];
      };
      "winapi-build" = rec {
