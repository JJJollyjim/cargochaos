...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/roughenough/v1.1.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudkms1" = rec {
        crateName = "google-cloudkms1";
        version = "1.0.12+20190626";
        edition = "2015";
        sha256 = "0yraz08m3n4wgsarndlbr2av5k0fxpykdi1qvdikl94lbapf6n4p";
        authors = [
      ...
      "roughenough" = rec {
        crateName = "roughenough";
        version = "1.1.8";
        edition = "2018";
        crateBin = [
          { name = "roughenough-server"; path = "src/bin/roughenough-server.rs"; }
          { name = "roughenough-kms"; path = "src/bin/roughenough-kms.rs"; }
          { name = "roughenough-client"; path = "src/bin/roughenough-client.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.8.nix {};
        authors = [
          "Stuart Stock <stuart@int08h.com>"
        ...
        resolvedDefaultFeatures = [ "awskms" "default" "gcpkms" "google-cloudkms1" "hyper" "hyper-rustls" "rusoto_core" "rusoto_kms" "serde" "serde_json" "yup-oauth2" ];
      };
      "rusoto_core" = rec {
      ...
      "rusoto_kms" = rec {
        ...
        version = "0.42.0";
        edition = "2018";
        sha256 = "1gc7ak60qfyssh7qqclvarr5rxzvhazsivg8h2rng2z3153rak0y";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
