...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/file_shred/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "number2name" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "12xzhw4mn20zjplzx6950p67yqk6q4x3i8409mn9892h80ql4cq2";
        authors = [
          "Mark <mverleg.noreply@gmail.com>"
        ];
        dependencies = [
