...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rascam/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mmal-sys" = rec {
        ...
        version = "0.1.0-3";
        edition = "2018";
        sha256 = "185a2sds01jjwfy3yyyzws1h5a98095rx1kx4xfixhfb1k43wg58";
        authors = [
          "Peter Sutherland <pedrosland+mmalsys@gmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "rascam" = rec {
        ...
        authors = [
          "Peter Sutherland <pedrosland+rascam@gmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
