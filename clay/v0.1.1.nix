...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clay/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "clay" = rec {
        ...
        devDependencies = [
          {
            name = "clay-utils";
            packageId = "clay-utils";
          }
          {
            name = "clay-viewer";
            packageId = "clay-viewer";
          }
        ];
      ...
      "clay-core" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1p67w9gxqp594lr8j4wh0y2mlkpf72vpspzmqcwdd49969xd61f6";
        authors = [
          "Alexey Gerasev <alexey.gerasev@gmail.com>"
        ];
        dependencies = [
      ...
      "clay-utils" = rec {
        crateName = "clay-utils";
        version = "0.1.0";
        edition = "2018";
        sha256 = "16f3pm745k0qv8cfg0sblpwgm2vrawjwbbfijxyrb497qp3l9ybg";
        authors = [
          "Alexey Gerasev <alexey.gerasev@gmail.com>"
        ];
        dependencies = [
      ...
      "clay-viewer" = rec {
        crateName = "clay-viewer";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0qajsahdp9f7sjjhcfmz5897z19yq8asna66i0ayyrhnims05qyd";
        authors = [
          "Alexey Gerasev <alexey.gerasev@gmail.com>"
        ];
        dependencies = [
