...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/postio/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crypto-mac" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "160ixpghhz5kz16f38kzcyv6lx8wmi4cgbhlhq4nazf678iib43p";
        authors = [
          "The RustCrypto Devs"
        ];
        dependencies = [
      ...
      "hmac" = rec {
        ...
        version = "0.4.2";
        edition = "2015";
        sha256 = "0amfn9wggxapyva1i0j7wldy9chj487cxal4wldwmid078bg84vs";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "postio" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "postio"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.7.0.nix {};
        authors = [
          "deg4uss3r <ricky@hosfelt.io>"
        ];
        dependencies = [
          {
            name = "aead";
      ...
      "rust-s3" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0a3v4r15v1gv9h8r2gxhg77mandkg2a9y7gmkk4cfxbprdbxkj6j";
        libName = "s3";
        authors = [
          "Drazen Urch"
          "Nick Stevens"
