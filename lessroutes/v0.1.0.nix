...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lessroutes/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ipnet" = rec {
        ...
        version = "2.0.1";
        edition = "2015";
        sha256 = "0j3a562796hsgxlaak5hn1x9j8xb41lyz2c90yx64vc8w315mhbc";
        authors = [
      ...
      "lessroutes" = rec {
        crateName = "lessroutes";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "lessroutes"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "minkast <minkast@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "reqwest" = rec {
        ...
        edition = "2018";
        sha256 = "0wfva8h0mdcjvy0i71601ss6c8818svy6r457i6va7pd0prxnx9x";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
