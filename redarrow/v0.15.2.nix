...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redarrow/v0.15.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "redarrow" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "redarrow-client"; path = "src/client/main.rs"; }
          { name = "redarrow-check"; path = "src/check/main.rs"; }
          { name = "redarrow-server"; path = "src/server/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.15.2.nix {};
        authors = [
          "everpcpc <git@everpcpc.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "rt-core" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
