...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fedora/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "futures-channel-preview" "hyper-tls" "native-tls" "tls" "tokio-tls" ];
      };
      "rustc-demangle" = rec {
