...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-casperlabs/v0.7.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-casperlabs" = rec {
        crateName = "cargo-casperlabs";
        version = "0.7.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-casperlabs"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "synchapi" "winbase" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
