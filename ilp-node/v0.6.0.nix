...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ilp-node/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "config" = rec {
        ...
        resolvedDefaultFeatures = [ "json" "serde_json" "toml" "yaml" "yaml-rust" ];
      };
      "cookie" = rec {
        crateName = "cookie";
        version = "0.12.0";
      ...
      "ilp-node" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ilp-node"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "balance-tracking" "base64" "chrono" "default" "google-pubsub" "parking_lot" "reqwest" "serde_json" "yup-oauth2" ];
      };
      "im" = rec {
        crateName = "im";
        version = "12.3.4";
      ...
      "interledger" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1kl7f0xiia5a0xxrkpfdyfv2fvmcdfawmhz8g36vmxwdhnv9zwiw";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-btp" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "14jfjm0fcv1l0wdn10i2dbf6dsa6m625a24dh5c8vw0yd02snh4p";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-ccp" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "004ab335z31g26q5hbgjgz2l7fhrn1apsmzgh7vya45cd24yjpag";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-http" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0b9z0l4rf6mzhb9agf3ffhzn9xki9314mijpxf69kgp9hvikia5x";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-ildcp" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "075j9p6vcr457i34pmcx8sdm6vqy5mhbrrcgsb02402gvydifi42";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-packet" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "01bkf8mc2xf7hjlzwl7zsng0ywci77nmv4ifq42iix17jv4mrza9";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-router" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0f3s2vl0jdni9y05izs50ckc2ddi0ss9hwi8i0qccvg95l4j7gf2";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-service" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1s0gnldfryj21f49ha9g56r4bf3d1zg81g9avpshd4bfksswhxai";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "trace" "tracing-futures" ];
      };
      "interledger-service-util" = rec {
        crateName = "interledger-service-util";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1pil7pm9f45qjfjmlrcqy9vr7azdjz35rhhqyvjdsmk3nfzllzp3";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-settlement" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "11gk117cacrmxi37gm3vnk8b2y274a5wdspzckjdxymsnpmhz4lc";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "settlement_api" ];
      };
      "interledger-spsp" = rec {
        crateName = "interledger-spsp";
        version = "0.4.0";
        edition = "2018";
        sha256 = "13w6sxgikgs8c76smbr3asipb8984n6df00yvvhy5q38fq8bzqga";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "interledger-store-redis" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "01ga5aqzsrz4m3icxd87vkizmhbj248r12rcz994x8sdsjwiljdz";
      ...
      "interledger-stream" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "198gdv38zxarcr29031kx1ahb3v3pza8car2sy872s3ffnd6di37";
        authors = [
          "Evan Schwartz <evan@ripple.com>"
        ];
        dependencies = [
      ...
      "secrecy" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "bytes" "bytes_crate" "serde" ];
      };
      ...
      "warp" = rec {
        ...
        resolvedDefaultFeatures = [ "tungstenite" "websocket" ];
      };
      "wasi" = rec {
        crateName = "wasi";
        version = "0.7.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
      ...
      "yup-oauth2" = rec {
        ...
        version = "3.1.1";
        edition = "2018";
        sha256 = "0gzn4k5wyjha52ar05rmk1jvy9gcxh555rr6fhg1ysb6px91qz38";
        authors = [
