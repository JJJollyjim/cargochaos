...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/falcon-finch/v0.4.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "falcon" = rec {
        ...
        version = "0.4.11";
        edition = "2018";
        sha256 = "0xsm3b8xhwqzibjhihc47ypvgzg2mgfiinn7r8flhx33i23ay4n0";
        libPath = "lib/lib.rs";
        authors = [
      ...
      "falcon-finch" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.4.6.nix {};
        libName = "finch";
        libPath = "lib/lib.rs";
        authors = [
          "Alex Eubanks <endeavor@rainbowsandpwnies.com>"
      ...
      "falcon-z3" = rec {
        ...
        version = "0.4.11";
        edition = "2015";
        sha256 = "17fr4lzk75bx4zk5m3kdcsvh9qr940xbi1lxs7ymwx51mz87mhz7";
        libName = "falcon_z3";
        libPath = "lib/lib.rs";
        authors = [
          "Alex Eubanks <endeavor@rainbowsandpwnies.com>"
      ...
      "libunicorn-sys" = rec {
        crateName = "libunicorn-sys";
        version = "0.9.1";
        edition = "2018";
        sha256 = "0srs4mja2kfpwa10ym3jngg5grn9rqcgviisxpmhmzivhc5h0nxg";
        libName = "libunicorn_sys";
        authors = [
      ...
      "unicorn" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "05hfmy7kvibrpqgypmf84dy261a2gbym48hys5wqzdhhwv9mkg1z";
        authors = [
          "Sébastien Duquette <ekse.0x@gmail.com>"
        ];
        dependencies = [
