...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-download-response/v0.4.10.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rocket-download-response";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket-download-response" = rec {
        crateName = "rocket-download-response";
        version = "0.4.10";
        edition = "2018";
