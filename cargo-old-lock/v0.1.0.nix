...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-old-lock/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-old-lock" = rec {
        crateName = "cargo-old-lock";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-old-lock"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Anthony Ramine <nox@nox.paris>"
        ];
        dependencies = [
          {
            name = "cargo-lock";
