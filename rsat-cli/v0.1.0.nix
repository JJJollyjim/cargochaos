...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsat-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rsat" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0xbll2hikqw10gwfjd5jd6xs0rdhdd08xs0h5s6498jcrm5irazj";
        authors = [
      ...
      "rsat-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rsat"; path = "src/bin/rsat.rs"; }
        ];
