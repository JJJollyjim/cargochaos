...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-fitness1-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-fitness1" = rec {
        crateName = "google-fitness1";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "0ph7wp7ag3q68nbc739kgpsgja8z5l9bcilvic63jxgqzl652naw";
        authors = [
      ...
      "google-fitness1-cli" = rec {
        crateName = "google-fitness1-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "fitness1"; path = "src/main.rs"; }
        ];
