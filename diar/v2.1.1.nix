...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/diar/v2.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "shlobj" "std" "winbase" "winerror" "winnt" ];
      };
