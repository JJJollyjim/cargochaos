...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rudolfs/v0.2.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-backoff" = rec {
        crateName = "futures-backoff";
        version = "0.1.0";
        edition = "2015";
        sha256 = "06wp2cx289h8ifjrxrd3agvpnzhwm16bg3866qgxzkp8bqs91xbr";
        authors = [
      ...
      "futures-timer" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0hw0nlyrq5an6l6y8md1rg6r380zrddvmh9cg0h64xfwnvlxzkm5";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "rudolfs" = rec {
        ...
        dependencies = [
          ...
          {
            name = "futures-backoff";
            packageId = "futures-backoff";
          }
          {
            name = "generic-array";
            packageId = "generic-array 0.12.3";
        ...
        resolvedDefaultFeatures = [ "default" "faulty" "rand" ];
      };
      "rusoto_core" = rec {
