...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gemma_m0/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21e18a" "samd21e18a" "samd21e18a-rt" "unproven" ];
      };
      "atsamd21e18a" = rec {
        crateName = "atsamd21e18a";
        version = "0.6.0";
        edition = "2015";
        sha256 = "1xrfb7r6k69kcvxiph1q1gc200yvhzsk9kysjiw8x6939pm244zs";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
        ];
        dependencies = [
