...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lighthouse/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lighthouse" = rec {
        crateName = "lighthouse";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "lh"; path = "src/bin/lighthouse.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Finnkauski <iwiivi@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "ssdp" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "1yj1j051pfq3a3zm3gcbz6sb7lf817ad92dn2rq42avq8vd0w0lc";
        authors = [
          "GGist <amiller4421@gmail.com>"
