...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_1llksp581jqha/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "guessing_game_1llksp581jqha";
  ...
  workspaceMembers = {
    "guessing_game_1llksp581jqha" = rec {
      packageId = "guessing_game_1llksp581jqha";
      build = internal.buildRustCrateWithFeatures {
        packageId = "guessing_game_1llksp581jqha";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_1llksp581jqha" = rec {
        crateName = "guessing_game_1llksp581jqha";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_1llksp581jqha"; path = "src/main.rs"; }
        ];
