...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flate2/v1.0.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flate2" = rec {
        ...
        version = "1.0.14";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.14.nix {};
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "any_zlib" "cloudflare-zlib-sys" "cloudflare_zlib" "default" "futures" "libz-sys" "miniz-sys" "miniz_oxide" "rust_backend" "tokio" "tokio-io" "zlib" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
