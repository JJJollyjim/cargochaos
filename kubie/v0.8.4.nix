...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kubie/v0.8.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        resolvedDefaultFeatures = [ "compress" "flate2" "json" "rustls" "serde" "serde_json" "tls-rustls" "webpki" "webpki-roots" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.14";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "shlobj" "std" "sysinfoapi" "winbase" "winerror" "winnt" "winuser" "wtypesbase" ];
      };
