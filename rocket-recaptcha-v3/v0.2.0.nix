...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-recaptcha-v3/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "easy-http-request" = rec {
        ...
        version = "0.2.5";
        edition = "2018";
        sha256 = "19z76cib141zmy3w9q5bkn6b1kik09vzr2hd5rpjw6r9ys4iaz3b";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "educe" = rec {
        ...
        resolvedDefaultFeatures = [ "Clone" "Debug" ];
      };
      "fake-simd" = rec {
        crateName = "fake-simd";
        version = "0.1.2";
      ...
      "html-minifier" = rec {
        ...
        version = "1.1.9";
        edition = "2015";
        sha256 = "12k9rb4smpplg7karp90vdlqirz3j4hispxc57aq5y3sj25zidrn";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "minifier" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "030v25536568lll9s95nq991w8qmi33pl1k48in0hjxsxczqb0g9";
        authors = [
          "Guillaume Gomez <guillaume1.gomez@gmail.com>"
        ];
        dependencies = [
      ...
      "rocket-client-addr" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "012xlsay5sydzvqabygh2pfclr0z4mn55r8wzs4b9lzily255dys";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-include-tera" = rec {
        crateName = "rocket-include-tera";
        version = "0.4.6";
        edition = "2018";
        sha256 = "0d3m73bw36p1pdpqwnfpv814x01xclbkrvhryj2aiq0cmzbn4r4r";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
