...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jsonrpc-derive/v14.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jsonrpc-tcp-server" = rec {
        crateName = "jsonrpc-tcp-server";
        version = "14.1.0";
        edition = "2018";
        sha256 = "17qw87xxhbw6yd76vqdi4sy0rin43q27lbffn3za5ks1mxx6fi22";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
