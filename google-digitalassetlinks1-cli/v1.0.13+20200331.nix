...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-digitalassetlinks1-cli/v1.0.13+20200331.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-digitalassetlinks1-cli";
  ...
  workspaceMembers = {
    "google-digitalassetlinks1-cli" = rec {
      packageId = "google-digitalassetlinks1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-digitalassetlinks1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-digitalassetlinks1" = rec {
        crateName = "google-digitalassetlinks1";
        version = "1.0.13+20200331";
        edition = "2015";
        sha256 = "0jv38dza0z26j4rvhx15cinbzixjah7xp6hb185rv5fm1dsa7y8j";
        authors = [
      ...
      "google-digitalassetlinks1-cli" = rec {
        crateName = "google-digitalassetlinks1-cli";
        version = "1.0.13+20200331";
        edition = "2015";
        crateBin = [
          { name = "digitalassetlinks1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-digitalassetlinks1";
            packageId = "google-digitalassetlinks1";
          }
          {
            name = "hyper";
            packageId = "hyper";
