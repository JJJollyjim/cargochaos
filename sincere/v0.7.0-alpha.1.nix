...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sincere/v0.7.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nson" = rec {
        ...
        version = "0.3.6";
        edition = "2018";
        sha256 = "0maazd3l0zc5s4dkx1hi183l72600w2v8bpxzrrmw4cq862jqwiz";
        authors = [
          "danc <dangcheng@hotmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "queen-log" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1y1kzggqlrxdybmlq1smi603c9lkqihw1bnljach650h29xwif8s";
        authors = [
          "mitum <dangcheng@hotmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
