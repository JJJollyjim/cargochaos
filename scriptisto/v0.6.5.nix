...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scriptisto/v0.6.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ascii_table" = rec {
        crateName = "ascii_table";
        version = "2.0.0";
        edition = "2018";
        sha256 = "05i7nm4lqqrm6a10aaz0qb84ini6r3qk18p33g0valwf96zvb8fb";
        authors = [
          "Gerrit Viljoen <red.striker@protonmail.com>"
        ];
      ...
      "scrawl" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "09840fjbg2gh639d853vdxbrl76g9vglv3j038dvmrzrxdbqm8cb";
        authors = [
          "Amy <git@xvrqt.com>"
        ];
      ...
      "scriptisto" = rec {
        crateName = "scriptisto";
        version = "0.6.5";
        edition = "2018";
        crateBin = [
          { name = "scriptisto"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
