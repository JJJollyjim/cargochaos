...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thingvellir/v0.0.1-alpha1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cassandra-cpp" = rec {
        ...
        version = "0.15.0";
        edition = "2018";
        sha256 = "13faspb7wckx0ljda2dc4cdw9wbi0zxx6vcdg9hfcz9hfj6w7nbd";
        authors = [
      ...
      "cassandra-cpp-sys" = rec {
        ...
        version = "0.12.1";
        edition = "2015";
        sha256 = "1872m0lcavp1hnmwjzj89l7q57admas0sfwr1gc8pmvdaqarcs0s";
      ...
      "discord-indexmap" = rec {
        crateName = "discord-indexmap";
        version = "1.4.0";
        edition = "2015";
        sha256 = "1183wlbj3dz7xc1hy6d8nvymjh9dxj0pidxn9giph0vwd89qikpm";
        authors = [
          "bluss"
          "Josh Stone <cuviper@gmail.com>"
        ];
      ...
      "dynamic-pool" = rec {
        crateName = "dynamic-pool";
        version = "0.2.2";
        edition = "2018";
        sha256 = "07r1dl0pidg1bnzl3sn8bq85dyjhwh6v2drz7kqkyp1h9klgnx0l";
        authors = [
          "jake <jh@discordapp.com>"
        ];
        dependencies = [
          {
      ...
      "thingvellir" = rec {
        crateName = "thingvellir";
        version = "0.0.1-alpha1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.1-alpha1.nix {};
        authors = [
          "jake <jh@discordapp.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "discord-indexmap";
            rename = "indexmap";
          }
          {
            name = "dynamic-pool";
            packageId = "dynamic-pool";
          }
          {
            name = "failure";
            packageId = "failure";
        ...
        features = {
          "cassandra" = [ "cassandra-cpp" "serde_cbor" "serde" ];
        };
        resolvedDefaultFeatures = [ "cassandra" "cassandra-cpp" "default" "serde" "serde_cbor" ];
      };
      "time" = rec {
        crateName = "time";
        version = "0.1.42";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "fs" "full" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "net" "num_cpus" "process" "rt-core" "rt-threaded" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "test-util" "time" "tokio-macros" "udp" "uds" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
