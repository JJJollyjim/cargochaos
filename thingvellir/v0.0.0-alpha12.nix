...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thingvellir/v0.0.0-alpha12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "thingvellir" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.0-alpha12.nix {};
        authors = [
          "jake <jh@discordapp.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cassandra" "cassandra-cpp" "default" ];
      };
      "time" = rec {
        crateName = "time";
        version = "0.1.42";
