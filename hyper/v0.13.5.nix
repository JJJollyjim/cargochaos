...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper/v0.13.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "rt-util" "slab" "stream" "sync" "tcp" "test-util" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
