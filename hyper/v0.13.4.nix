...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper/v0.13.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper" = rec {
        ...
        resolvedDefaultFeatures = [ "__internal_happy_eyeballs_tests" "default" "net2" "nightly" "runtime" "stream" "tcp" ];
      };
      "idna" = rec {
        crateName = "idna";
        version = "0.1.5";
      ...
      "spmc" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1rgcqgj6b3d0cshi7277akr2xk0cx11rkmviaahy7a3pla6l5a02";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "rt-util" "slab" "sync" "tcp" "test-util" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
