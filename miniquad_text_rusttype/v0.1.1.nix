...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miniquad_text_rusttype/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "miniquad_text_rusttype";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "miniquad_text_rusttype" = rec {
        crateName = "miniquad_text_rusttype";
        version = "0.1.1";
        edition = "2018";
        ...
        resolvedDefaultFeatures = [ "default" "miniquad" "render" ];
      };
      "num-traits" = rec {
