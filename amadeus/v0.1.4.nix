...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amadeus/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amadeus-aws" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1z78gpwvyiq2jn1ah0f7a8k6yxfjyvinvnl89j4gp7nzlr99dbg0";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "amadeus-commoncrawl" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "12n0bs3jddpb62x96cp150w908pj2q5156bam9n1m0chxw5fqxjc";
        authors = [
      ...
      "amadeus-core" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1x07v2igwws6w2bph3ir13ii4jj3znjhy3h80yfyfkscdp5bdpnr";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "amadeus-derive" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "0p46sxqjcybjifxjpzlbpijpdb0paws1zpzpf2jrkkj51dcd4zxp";
        procMacro = true;
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
      ...
      "amadeus-parquet" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "0ra7bvlif6xavpxxsx9b2x82jravxi5wdf3ajhc554jcz1gml16j";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
      ...
      "amadeus-postgres" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1xbswbzvxnhn4rl2sjms9cpn3v6qa9flk3hnpc7ysv3wslsjfwxr";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "amadeus-serde" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1063xayj5d8y4n16k4ijwgzrraj3q4rr6n94z815z5my8wgva5zm";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "amadeus-types" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "0d7xvh8k3nhhappxqk8x5yd4pyc9wab6myzpk04x8gl6c4ajdr2d";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "build_id" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "04j0ijbvdbjhxnlm08ig2yjh5aj2xr4jizhwylaqq8j2mk3mfici";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "constellation-internal" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "12mfg3g9r8k7vn8x56bzg2wkfzg7dk2jcw5lhf19br471612cfrx";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
          ...
          {
            name = "cargo_metadata";
            packageId = "cargo_metadata 0.9.0";
            usesDefaultFeatures = false;
          }
          {
            name = "either";
      ...
      "constellation-rs" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "014hlxwx0b7dj7s7n6550wf7s9xha698ljmvy65wbb0rj83r21i7";
      ...
      "relative" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0idgwd562xasbmcz8zxia7yvc1h0sjxgnfrhixdr1cl1dqifrz5s";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "serde_closure" = rec {
        ...
        version = "0.2.5";
        edition = "2018";
        sha256 = "0bqs9x5rd38rpp39l4qrclal5fa3fii5wkrmlzn3q9ji65blcsgm";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "serde_closure_derive" = rec {
        ...
        version = "0.2.5";
        edition = "2018";
        sha256 = "1af05f33c2cd5arp1k8zrz7gnls8dfi3mxps4asxzdmxp015nf08";
        procMacro = true;
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
      ...
      "serde_traitobject" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "00l6iv65dmz41sbg0k72qvcxi5kawzd142zyis1b91ajqz8yrns1";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
