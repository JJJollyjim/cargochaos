...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-drive2-cli/v1.0.13+20200326.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-drive2" = rec {
        crateName = "google-drive2";
        version = "1.0.13+20200326";
        edition = "2015";
        sha256 = "0vy4bc0svyyfgvikl01lx7clw32ab5ks2llyv08g3i7a7qaqbbi3";
        authors = [
      ...
      "google-drive2-cli" = rec {
        crateName = "google-drive2-cli";
        version = "1.0.13+20200326";
        edition = "2015";
        crateBin = [
          { name = "drive2"; path = "src/main.rs"; }
        ];
