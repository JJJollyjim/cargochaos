...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blih/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blih" = rec {
        ...
        resolvedDefaultFeatures = [ "config" "default" ];
      };
      "blih_rs" = rec {
        crateName = "blih_rs";
        version = "0.1.2";
        edition = "2018";
        sha256 = "09igmnvjhmzjz400xxmjzlazh58hxqxckndkf7pn9zjsgwlhqxil";
        authors = [
          "Zacharie Corniere <cornierez@gmail.com>"
        ];
        dependencies = [
