...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blih/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blih" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "blih"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Zacharie Corniere <cornierez@gmail.com>"
        ];
        dependencies = [
          {
            name = "blih_rs";
      ...
      "blih_rs" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0m7pvlhg132qg8p6h0bkdi7dgvhcqfi71smzbiyqcsgr1r2wdq68";
        authors = [
          "Zacharie Corniere <cornierez@gmail.com>"
        ];
        dependencies = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "default-tls" "hyper-tls" "native-tls" "native-tls-crate" "tokio-tls" ];
      };
      "rpassword" = rec {
        crateName = "rpassword";
        version = "4.0.5";
