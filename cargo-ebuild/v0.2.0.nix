...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-ebuild/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-ebuild" = rec {
        crateName = "cargo-ebuild";
        version = "0.2.0";
        edition = "2015";
        crateBin = [
          { name = "cargo-ebuild"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "cargo_ebuild";
        authors = [
