...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-serviceregistryalpha-cli/v1.0.13+20160401.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-serviceregistryalpha-cli";
  ...
  workspaceMembers = {
    "google-serviceregistryalpha-cli" = rec {
      packageId = "google-serviceregistryalpha-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-serviceregistryalpha-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-serviceregistryalpha" = rec {
        crateName = "google-serviceregistryalpha";
        version = "1.0.13+20160401";
        edition = "2015";
        sha256 = "01dk0bqkyb654jfylnj115yflfg2pp231bsrnw2i3kgwbg7w81za";
        authors = [
      ...
      "google-serviceregistryalpha-cli" = rec {
        crateName = "google-serviceregistryalpha-cli";
        version = "1.0.13+20160401";
        edition = "2015";
        crateBin = [
          { name = "serviceregistryalpha"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20160401.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-serviceregistryalpha";
          }
          {
            name = "hyper";
            packageId = "hyper";
