...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-cache/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-cache" = rec {
        ...
        features = {
          "default" = [ "cargo_metadata" "clap" "git2" "humansize" "rayon" "regex" "rustc_tools_util" "walkdir" ];
        };
        resolvedDefaultFeatures = [ "bench" "cargo_metadata" "ci-autoclean" "clap" "default" "git2" "humansize" "rayon" "regex" "rustc_tools_util" "walkdir" ];
      };
      "cargo_metadata" = rec {
