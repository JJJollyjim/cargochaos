...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/read_input/v0.8.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossterm" = rec {
        ...
        version = "0.8.2";
        edition = "2015";
        sha256 = "13nbpqvqd3capjly6cqr293y1pgrv0a33q0b2gp052ibblq1g9sm";
        authors = [
          "T. Post"
        ];
        dependencies = [
      ...
      "crossterm_input" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0ckgyxywsfmrpgnq8na98dfyc36gc94w53nvx4m4gbvwni0dr2pn";
        authors = [
          "T. Post"
        ];
        dependencies = [
      ...
      "dont_disappear" = rec {
        crateName = "dont_disappear";
        version = "3.0.1";
        edition = "2018";
        sha256 = "1dn1zzlhi3bsh78siflr86a78cbjfpjp9bhy0miidwrkb42vpll0";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winnt" "winuser" ];
      };
