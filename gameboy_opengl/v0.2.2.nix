...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gameboy_opengl/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gameboy_core" = rec {
        ...
        version = "0.2.8";
        edition = "2015";
        sha256 = "0wq0riwpzcjlr221yadg60m7dzmmc5cy78q7x6n8gijwnw62y6ls";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "winbase" "winerror" ];
      };
