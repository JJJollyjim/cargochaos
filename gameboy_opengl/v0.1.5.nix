...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gameboy_opengl/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gameboy_core" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "06r6z78c6ygv9xf0jrj3l1rm80rfvprwgcn2c6aghy3k9lbbahv8";
        authors = [
