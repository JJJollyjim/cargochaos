...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/av-metrics-tool/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "av-metrics" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "175winsywqd35icnqvqr0vc7nn6w2iwkqsxsf432fmw8zj8a06dd";
        authors = [
        ...
        resolvedDefaultFeatures = [ "decode" "default" "y4m" "y4m-decode" ];
      };
      "av-metrics-tool" = rec {
