...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/av-metrics-tool/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "av-metrics" = rec {
        crateName = "av-metrics";
        version = "0.4.0";
        edition = "2018";
        sha256 = "0gyhh78cg6q9wrbiaql3drb74p2xkq1sr50c7g12ks29db03fv9x";
        libName = "av_metrics";type = [ "lib" "staticlib" ];
        authors = [
        ...
        resolvedDefaultFeatures = [ "decode" "default" "serde" "y4m" "y4m-decode" ];
      };
      "av-metrics-tool" = rec {
        crateName = "av-metrics-tool";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "av-metrics-tool"; path = "src/main.rs"; }
        ];
      ...
      "v_frame" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "17idk88ag4ik46c8fd8xf3kr2a60nkjc9dcs65n3zvinh4dbxcmp";
        authors = [
          "Luca Barbato <lu_zero@gentoo.org>"
        ];
        dependencies = [
