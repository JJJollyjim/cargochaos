...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/checksec/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "checksec" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "checksec"; path = "src/main.rs"; }
        ];
        ...
        features = {
          "default" = [ "elf" "macho" "pe" "shared" ];
          "elf" = [ "shared" ];
          "macho" = [ "shared" ];
        };
        resolvedDefaultFeatures = [ "default" "elf" "macho" "pe" "shared" ];
      };
      "colored" = rec {
        crateName = "colored";
        version = "1.9.3";
