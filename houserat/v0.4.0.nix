...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/houserat/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "c-ares-resolver" = rec {
        ...
        version = "6.1.0";
        edition = "2015";
        sha256 = "04804b0w6crc3wl90ra20s07bq2py0kcxxj6a81vx3qr86nnm4xv";
        authors = [
          "David Hotham"
        ];
        dependencies = [
      ...
      "houserat" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "houserat"; path = "src/main.rs"; }
        ];
