...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-mq/v1.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "amq-protocol" = rec {
        ...
        version = "4.2.2";
        edition = "2018";
        sha256 = "1zld5mf2aiyransnxapd2hc4g83vjvsjiyfys2r01sv7qsskc42r";
      ...
      "amq-protocol-codegen" = rec {
        ...
        version = "4.2.2";
        edition = "2018";
        sha256 = "0sxxzshdyqc6mj1cjgww6568mlx9lgzb4nyh9xbnfg2wjz61n2kh";
      ...
      "amq-protocol-tcp" = rec {
        ...
        version = "4.2.2";
        edition = "2018";
        sha256 = "1adshnmqshc95a6icnxidna3swsjrp8322psp5v7h3y36rbcljn4";
      ...
      "amq-protocol-types" = rec {
        ...
        version = "4.2.2";
        edition = "2018";
        sha256 = "05r3yzx5pwffc5yzsnllizzlg7r2acf29ckzvpayqw0vvxpq6i8a";
      ...
      "amq-protocol-uri" = rec {
        ...
        version = "4.2.2";
        edition = "2018";
        sha256 = "1w3534vm992zzpdzi9mgs8avp54wvpcl1m1gvzv2dq0b39ldxx3n";
      ...
      "async-mq" = rec {
        ...
        version = "1.0.6";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.6.nix {};
        authors = [
      ...
      "lapin" = rec {
        ...
        version = "0.32.5";
        edition = "2018";
        sha256 = "02p6qyrrib5jllnxv91yj2vg2mkixa11h7b787xn6dpgzilnbn10";
        authors = [
          "Geoffroy Couprie <geo.couprie@gmail.com>"
      ...
      "tcp-stream" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "0pf7a7z9capjff094i40ksap7q26zgsd5bvwsb7jmyfjrjfw1r6d";
        libName = "tcp_stream";
        authors = [
          "Marc-Antoine Perennou <Marc-Antoine@Perennou.com>"
        ];
        ...
        features = {
          ...
          "rustls-native-certs" = [ "rustls" "rustls-connector/native_certs" ];
          "vendored" = [ "openssl/vendored" ];
        };
        resolvedDefaultFeatures = [ "native-tls" ];
      };
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "num_cpus" "rt-core" "rt-threaded" "slab" "time" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntstatus" "processenv" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
