...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-jsonrpc-client/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "simple-jsonrpc-client";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple-jsonrpc-client" = rec {
        crateName = "simple-jsonrpc-client";
        version = "0.1.0";
        edition = "2018";
