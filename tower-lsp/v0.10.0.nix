...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tower-lsp/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-std" "macros" "rt-core" "slab" "stream" "sync" "test-util" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
