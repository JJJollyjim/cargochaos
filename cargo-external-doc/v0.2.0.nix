...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-external-doc/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-external-doc" = rec {
        crateName = "cargo-external-doc";
        version = "0.2.0";
        edition = "2015";
        crateBin = [
          { name = "cargo-external-doc"; path = "src/main.rs"; }
        ];
      ...
      "handlebars" = rec {
        ...
        version = "0.22.0";
        edition = "2015";
        sha256 = "1llk789s5gvfkrzdgk0awkbzn8ybzwy6px216n13wkribprfv83d";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "rustc-serialize" "rustc_ser_type" ];
      };
      "itoa" = rec {
        crateName = "itoa";
        version = "0.1.1";
      ...
      "num-traits 0.1.43" = rec {
        ...
        dependencies = [
          {
            name = "num-traits";
            packageId = "num-traits 0.2.1";
          }
        ];
        
      };
      "num-traits 0.2.1" = rec {
        crateName = "num-traits";
        version = "0.2.1";
        edition = "2015";
