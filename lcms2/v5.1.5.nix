...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lcms2/v5.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "foreign-types-macros" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0bh6z5rwdhfm987idal8r0ha5svz1li7md5l1g2a5966gya1jns0";
        procMacro = true;
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
      ...
      "lcms2" = rec {
        ...
        version = "5.1.5";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v5.1.5.nix {};
        authors = [
      ...
      "lcms2-sys" = rec {
        ...
        version = "3.1.2";
        edition = "2018";
        sha256 = "14c1kl7c05961xmi9km2ng7y920a2p487fgy0ppkf6s400bgr5wj";
        build = "src/build.rs";
        authors = [
          "Kornel Lesiński <kornel@geekhood.net>"
        ];
        ...
        resolvedDefaultFeatures = [ "cc" "default" "dynamic" "parallel" "pkg-config" "static" "static-fallback" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.65";
