...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/microbit/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dcf77" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1lqx7ccjcmrg9wav879w5i0z9862gl8mxan7lanxply6hlkzydah";
        authors = [
      ...
      "mag3110" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "15gdxb16l1b4m0wdkg2p0wicnpc0qy54qf0qhykf961f2gjfnaz9";
        authors = [
          "Daniel Egger <daniel@eggers-club.de>"
        ];
        dependencies = [
      ...
      "nrf51-hal" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0ip7b94w56arixgfr7vv7y8frgcc99yvdnc78frsfmhgmbgpkgzx";
        authors = [
          "Daniel Egger <daniel@eggers-club.de>"
        ];
        dependencies = [
