...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rumq-client/v0.1.0-alpha.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rumq-client" = rec {
        crateName = "rumq-client";
        version = "0.1.0-alpha.10";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.10.nix {};
        authors = [
          "tekjar"
        ];
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "tcp" "dns" "stream" "sync" "time" "macros" ];
          }
          {
            name = "tokio-rustls";
      ...
      "rumq-core" = rec {
        ...
        version = "0.1.0-alpha.10";
        edition = "2018";
        sha256 = "1bs0jmx124317ya2h0dmj1wr25c54200w3z7jadchdvg0bs1m7ks";
        authors = [
          "tekjar"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "memoryapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
