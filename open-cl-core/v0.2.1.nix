...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/open-cl-core/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "open-cl-core" = rec {
        crateName = "open-cl-core";
        version = "0.2.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        libName = "opencl_core";
        authors = [
          "Jason Goldberger <jasongoldberger@gmail.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
          ...
          }
          {
            ...
            packageId = "open-cl-low-level";
          }
          {
            name = "open-cl-sys";
            packageId = "open-cl-sys";
          }
          {
            name = "paste";
            packageId = "paste";
        ...
        features = {
          "default" = [ "opencl_version_1_2_0" ];
        };
        resolvedDefaultFeatures = [ "default" "opencl_version_1_2_0" ];
      };
      "open-cl-low-level" = rec {
        crateName = "open-cl-low-level";
        version = "0.2.1";
        edition = "2018";
        sha256 = "0k23jfjp1m20q8fjbxy0j2z46jxz82805vhv71fbdlfrbrrnycrj";
        libName = "open_cl_low_level";
        authors = [
          "Jason Goldberger <jasongoldberger@gmail.com>"
        ];
        dependencies = [
      ...
      "open-cl-sys" = rec {
        crateName = "open-cl-sys";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1rk3r1d0vwkrw1yks9ccp3958kdk8ss6vxcvbrskgqah3d3pqq04";
        libName = "open_cl_sys";
        authors = [
          "Jason Goldberger <jasongoldberger@gmail.com>"
        ];
