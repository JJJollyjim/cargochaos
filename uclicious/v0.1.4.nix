...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uclicious/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "uclicious" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "uclicious-libucl-sys";
            rename = "libucl-bind";
          }
          {
            name = "uclicious_derive";
            packageId = "uclicious_derive";
            optional = true;
          }
        ];
        devDependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "derive" "uclicious_derive" ];
      };
      "uclicious-libucl-sys" = rec {
        crateName = "uclicious-libucl-sys";
        version = "0.8.1";
        edition = "2015";
        sha256 = "0k5g6yrbdsc5avy4g5hhs059ip1zizdc09zgbnkisx4pw4rplg7f";
        authors = [
          "Łukasz Niemier <lukasz@niemier.pl>"
          "Igor Laćarac <draftsix@gmail.com>"
          "Andrey Cherkashin <andoriyu@gmail.com>"
        ];
        dependencies = [
          {
      ...
      "uclicious_derive" = rec {
        crateName = "uclicious_derive";
        version = "0.1.3";
        edition = "2018";
        sha256 = "16l2cklm6a2jjv395hxlckv1rl2zzj255lnchf87f0vwqayblax2";
        procMacro = true;
        authors = [
          "Andrey Cherkashin <andoriyu@gmail.com>"
        ];
