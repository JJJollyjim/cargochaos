...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uclicious/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "uclicious" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "derive" "uclicious_derive" "vh_basic" "vh_compound" "vh_env" ];
      };
      "uclicious-libucl-sys" = rec {
        crateName = "uclicious-libucl-sys";
        version = "0.8.2-alpha.2";
        edition = "2015";
        sha256 = "14qhjqz7mafpy1fbz26lf80fqxqlds6kv5z870xkcw9hiy735c8j";
        authors = [
      ...
      "uclicious_derive" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "1msfpp6cbdmik11n2hdxk0zcimicz9a8mwx3cpzr1b1i6zagrp59";
        procMacro = true;
        authors = [
          "Andrey Cherkashin <andoriyu@gmail.com>"
        ];
