...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/midas_cli/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "midas_cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "midas_cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Scott Steele <scottlsteele@gmail.com>"
        ];
        dependencies = [
          {
            name = "midas_rs";
      ...
      "midas_rs" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1bij1crkswighl44ffx8jskvg6axbf4kl05q46vb5fgp7jfvrbhn";
        authors = [
          "Scott Steele <scottlsteele@gmail.com>"
        ];
        dependencies = [
