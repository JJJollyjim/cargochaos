...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-native-tls/v0.1.0.nix.tmp"
    ...
    crates = {
      ...
      "security-framework 0.2.2" = rec {
        ...
        dependencies = [
          ...
          {
            name = "security-framework-sys";
            packageId = "security-framework-sys 0.2.3";
          }
        ];
        features = {
      ...
      "security-framework-sys 0.2.3" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "rt-core" "stream" "tcp" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "tokio-native-tls" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            name = "openssl";
            packageId = "openssl";
            target = {target, features}: ((!(target."os" == "macos")) && (!target."windows") && (!(target."os" == "ios")));
          }
          {
            name = "schannel";
            packageId = "schannel";
          ...
          {
            name = "security-framework";
            packageId = "security-framework 0.2.2";
            target = {target, features}: ((target."os" == "macos") || (target."os" == "ios"));
          }
          {
            name = "tempfile";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
