...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-aes256-gcm/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple-aes256-gcm" = rec {
        crateName = "simple-aes256-gcm";
        version = "0.2.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        libName = "simple_aes256_gcm";
        libPath = "src/simple_aes256_gcm.rs";
        authors = [
          "Nicolas Marlier <nicolas@prospect.guru>"
        ];
        dependencies = [
          {
            name = "aead";
