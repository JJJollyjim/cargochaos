...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wana_kana/v2.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wana_kana" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "to_romaji"; path = "src/bin/to_romaji.rs"; }
          { name = "to_kana"; path = "src/bin/to_kana.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "enable_regex" "regex" ];
      };
    };
