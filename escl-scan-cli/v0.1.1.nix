...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/escl-scan-cli/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "escl-scan" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1x5x07hf9qv3461jmlwr674g0xzi1b57s7hgl7l01l14zp8rqs4b";
        authors = [
      ...
      "escl-scan-cli" = rec {
        crateName = "escl-scan-cli";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "escl-scan-cli"; path = "src/main.rs"; }
        ];
