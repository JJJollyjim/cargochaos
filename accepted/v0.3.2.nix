...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/accepted/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lsp-types" = rec {
        ...
        version = "0.71.0";
        edition = "2018";
        sha256 = "0r75v61sqd1zmks1fqjkddbzzr61v7k1di3gwcp43hxh6dbbg9pg";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "objbase" "processenv" "shlobj" "std" "synchapi" "threadpoollegacyapiset" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
