...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rmicrobit/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nrf51" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "0dqklaijprbzwqzkxdlfkyarbdcmx5salx1lam477lnv7hz0dsnn";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" ];
      };
      "nrf51-hal" = rec {
        crateName = "nrf51-hal";
        version = "0.7.1";
        edition = "2018";
        sha256 = "1w7db56kfwizj72q40qy7dwyv09lxnfzg2gn2mrwq48g2y376dpj";
        authors = [
          "Daniel Egger <daniel@eggers-club.de>"
        ];
        dependencies = [
      ...
      "tiny-led-matrix" = rec {
        crateName = "tiny-led-matrix";
        version = "1.0.1";
        edition = "2018";
        sha256 = "08402cryi9aa7hifqdd2wvssbca9kms8slygzk2sakclzigr0qlc";
        authors = [
          "Matthew Woodcraft <matthew@woodcraft.me.uk>"
        ];
