...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rlua/v0.17.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rlua" = rec {
        ...
        resolvedDefaultFeatures = [ "builtin-lua" "cc" "default" "pkg-config" "system-lua" ];
      };
      "rust-argon2" = rec {
      ...
      "tester" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "1az6brh39ai1jcc6yy7xglwq8m65samkb31zr7lr18swrd2103fd";type = [ "dylib" "rlib" ];
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "shlobj" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
