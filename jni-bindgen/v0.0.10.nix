...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jni-bindgen/v0.0.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jni-bindgen" = rec {
        crateName = "jni-bindgen";
        version = "0.0.10";
        edition = "2018";
        crateBin = [
          { name = "jni-bindgen"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "jni-bindgen-reflection";
          }
          {
            name = "jni-glue";
            packageId = "jni-glue";
      ...
      "jni-bindgen-reflection" = rec {
        crateName = "jni-bindgen-reflection";
        version = "0.0.10";
        edition = "2018";
        sha256 = "1im9c1y2acjx2mcfk6l7ldb7brmjkjmnag16d9r4zrf18wn2pxk6";
        authors = [
          "MaulingMonkey <git@maulingmonkey.com>"
        ];
        dependencies = [
      ...
      "jni-glue" = rec {
        ...
        version = "0.0.10";
        edition = "2018";
        sha256 = "054kc2hkdfjiihy7ssrn97s9hs35c2v32ph2h0jlv4vkazx39ddb";
        authors = [
          "MaulingMonkey <git@maulingmonkey.com>"
        ];
        dependencies = [
