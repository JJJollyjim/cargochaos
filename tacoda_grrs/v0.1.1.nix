...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tacoda_grrs/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tacoda_grrs" = rec {
        crateName = "tacoda_grrs";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "tacoda_grrs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Ian Johnson <tacoda@pm.me>"
        ];
        dependencies = [
          {
            name = "assert_cmd";
