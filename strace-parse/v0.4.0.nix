...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/strace-parse/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "strace-parse" = rec {
        crateName = "strace-parse";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "strace-stats"; path = "src/bin/strace-stats.rs"; }
        ];
