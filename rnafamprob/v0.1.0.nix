...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rnafamprob/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bio-seq-algos" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "11y5b5hn51ywc0ybs2ppnabav3y196sxaclng8x3g1fpsirz0qq4";
      ...
      "rna-algos" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0jpidd679lckv9182paaji0fssbiyz5n3hxgvmifhd5hx3ky6vad";
        libName = "rna_algos";
        authors = [
          "heartsh <heartsh@heartsh.io>"
        ];
      ...
      "rnafamprob" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "rnafamprob"; path = "src/main.rs"; }
        ];
