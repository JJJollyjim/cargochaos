...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/circle_boundary/v0.1.19.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "circle_boundary" = rec {
        crateName = "circle_boundary";
        version = "0.1.19";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.1.19.nix {};
        authors = [
          "Samson Ootoovak <ootoovak@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
