...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bailamos/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "binn-ir" = rec {
        ...
        version = "0.14.2";
        edition = "2018";
        sha256 = "1jblxsdln063xzsqvyi6hkvk984l1vbdl6jgi3zwv9mvig8a4g2l";
        authors = [
          "Hai Bison <haibison.apps@gmail.com>"
        ];
        features = {
      ...
      "dia-args" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "04l4dyinvfsi5vp06ss07vkk5zvgigb9hagabpkgjnk1ni7y4ar1";
        authors = [
          "Hai Bison <haibison.apps@gmail.com>"
        ];
        features = {
      ...
      "zeros" = rec {
        ...
        version = "7.1.0";
        edition = "2018";
        sha256 = "0rivp96jljclxazcdpqny10am1agiwv32hcyc0frfpq8mxb58fql";
        authors = [
          "Hai Bison <haibison.apps@gmail.com>"
        ];
        features = {
