...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gimli/v0.20.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "test-assembler" = rec {
        crateName = "test-assembler";
        version = "0.1.5";
        edition = "2015";
        sha256 = "1sdx9hk0dk3z9crm8834ysyxsi92chls8arpd0gs796kis6lik2w";
        authors = [
          "Ted Mielczarek <ted@mielczarek.org>"
        ];
        dependencies = [
