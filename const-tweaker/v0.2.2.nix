...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/const-tweaker/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "const-tweaker-attribute" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1klqxmig12rxpw4bza3575jrx0d7w0bmqp6fjp0gwck65q0agi46";
        procMacro = true;
        authors = [
          "Thomas Versteeg <thomasversteeg@gmx.com>"
        ];
      ...
      "horrorshow" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "0kahf2dxv6xx1v4yzdgsqxgj4wnzl39k3260isa9djdy7pqf34si";
        authors = [
