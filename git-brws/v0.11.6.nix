...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-brws/v0.11.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "prepush-hook" "run-cargo-clippy" "run-cargo-fmt" "run-cargo-test" "run-for-all" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.46";
      ...
      "git-brws" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "git-brws"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
