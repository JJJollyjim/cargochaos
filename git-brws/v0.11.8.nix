...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-brws/v0.11.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "CanvasRenderingContext2d" "Document" "DomRect" "DomRectReadOnly" "Element" "Event" "EventTarget" "Headers" "HtmlCanvasElement" "HtmlElement" "MessageEvent" "Node" "Request" "RequestInit" "RequestMode" "Response" "Window" "Worker" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
