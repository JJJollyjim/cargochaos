...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/urlshortener-cli/v1.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "urlshortener-cli" = rec {
        crateName = "urlshortener-cli";
        version = "1.0.1";
        edition = "2018";
        crateBin = [
          { name = "urlshortener-cli"; path = "src/main.rs"; }
        ];
