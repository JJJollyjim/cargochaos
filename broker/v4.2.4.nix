...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broker/v4.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "broker" = rec {
        ...
        src = pkgs.callPackage ./tarball-v4.2.4.nix {};
        authors = [
      ...
      "jsonwebtoken" = rec {
        ...
        edition = "2018";
        sha256 = "0aih8l026rf71j3fs7wqyk14i7xpfj7qa7jjh8lxvqr7hrflmhp8";
        authors = [
