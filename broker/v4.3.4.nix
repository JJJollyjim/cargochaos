...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broker/v4.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "broker" = rec {
        ...
        src = pkgs.callPackage ./tarball-v4.3.4.nix {};
        authors = [
      ...
      "warp" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "multipart" "tls" "tokio-rustls" "tokio-tungstenite" "websocket" ];
      };
      "wasi" = rec {
        crateName = "wasi";
