...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broker/v4.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "broker-ntp" = rec {
        crateName = "broker-ntp";
        version = "0.0.1";
        edition = "2015";
        sha256 = "14j2lfdciv83zijgcn0lvipkdrh60vad6d1xv89h7qm4la7hyz83";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
      ...
      "go-flag" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0awd9yrqjzqcwf6ksdm1kana2ww1anlgdfmafgsi6xahrb4l0jkb";
        authors = [
      ...
      "jsonwebtoken" = rec {
        ...
        version = "7.0.1";
        edition = "2018";
        sha256 = "191faak4a62abvrjsnh0rljkr9yp15slklkllmfsgy8l44kwcxvm";
        authors = [
