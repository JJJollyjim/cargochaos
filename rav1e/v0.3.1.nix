...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rav1e/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aom-sys" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0ix3djcf84kk53h6fac73n7jc614745n7kbmikxwi3s73b6vzgsr";
        authors = [
      ...
      "dav1d-sys" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1022czzp3s54r42x6rhr870w1fwzyp7b6qn0zirpz55zmqjpgnwa";
        authors = [
          "Luca Barbato <lu_zero@gentoo.org>"
        ];
        buildDependencies = [
      ...
      "ivf" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1wfjf3rilqavrhvwagzinvng9dg28wcjk3c6c6p5qmc1xy65qfh1";
        authors = [
      ...
      "rav1e" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rav1e"; path = "src/bin/rav1e.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "aom-sys" "asm" "backtrace" "bench" "better-panic" "binaries" "byteorder" "capi" "cc" "check_asm" "clap" "console" "dav1d-sys" "decode_test" "decode_test_dav1d" "default" "desync_finder" "dump_ivf" "dump_lookahead_data" "fern" "image" "ivf" "nasm-rs" "quick_test" "rust_hawktracer" "scan_fmt" "serde" "serialize" "signal-hook" "signal_support" "toml" "tracing" "y4m" ];
      };
      "rayon" = rec {
        crateName = "rayon";
        version = "1.3.0";
      ...
      "rust_hawktracer" = rec {
        crateName = "rust_hawktracer";
        version = "0.7.0";
        edition = "2018";
        sha256 = "1h9an3b73pmhhpzc2kk93nh93lplkvsffysj0rp6rxi7p4lhlj73";
        authors = [
        ...
        dependencies = [
          {
            ...
            packageId = "rust_hawktracer_normal_macro";
          }
          {
            name = "rust_hawktracer_proc_macro";
            packageId = "rust_hawktracer_proc_macro";
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "profiling_enabled" ];
      };
      "rust_hawktracer_normal_macro" = rec {
        crateName = "rust_hawktracer_normal_macro";
        version = "0.4.1";
        edition = "2018";
        sha256 = "1sfjmipdbb5s498c150czr6wihjlkwwgla2jyg3cs7cyjich0mwa";
        authors = [
          "Alexandru <alex.ene0x11@gmail.com>"
        ];
        dependencies = [
          {
            name = "rust_hawktracer_sys";
            packageId = "rust_hawktracer_sys";
            optional = true;
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "profiling_enabled" "rust_hawktracer_sys" ];
      };
      "rust_hawktracer_proc_macro" = rec {
        crateName = "rust_hawktracer_proc_macro";
        version = "0.4.1";
        edition = "2018";
        sha256 = "1qfksscfv8rbbzv2zb0i9sbbqmig0dr0vrma3c1kzsfmpsynlqnb";
        procMacro = true;
        authors = [
          "Alexandru <alex.ene0x11@gmail.com>"
        ];
      ...
      "rust_hawktracer_sys" = rec {
        crateName = "rust_hawktracer_sys";
        version = "0.4.2";
        edition = "2018";
        sha256 = "15acrj881y2g7cwsgf1nr22cixrknp8m4x08dkx1an6zf4q8bk37";
        authors = [
          "Alexandru <alex.ene0x11@gmail.com>"
        ];
        buildDependencies = [
      ...
      "y4m" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "06g8c53qk4cla3xczywx5qlklvzsw54x77vm727mhizlsp5n93ar";
        authors = [
