...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/binance-client/v1.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "binance-client" = rec {
        crateName = "binance-client";
        version = "1.1.0";
        edition = "2018";
        crateBin = [
          { name = "binance-client"; path = "src/main.rs"; }
        ];
