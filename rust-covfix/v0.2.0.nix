...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-covfix/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "proc-macro2" = rec {
        ...
        resolvedDefaultFeatures = [ "span-locations" ];
      };
      "rand" = rec {
        crateName = "rand";
        version = "0.7.2";
      ...
      "regex" = rec {
        ...
        resolvedDefaultFeatures = [ "perf-dfa" "perf-inline" "std" "unicode-perl" ];
      };
      "regex-syntax" = rec {
      ...
      "rust-covfix" = rec {
        crateName = "rust-covfix";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "rust-covfix"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "rust_covfix";
        authors = [
          "Kogia-sima <orcinus4627@gmail.com>"
        ];
        dependencies = [
          {
            name = "argparse";
          ...
          }
          {
            ...
            packageId = "regex";
            usesDefaultFeatures = false;
            features = [ "std" "unicode-perl" "perf-dfa" "perf-inline" ];
          }
          {
            name = "syn";
            packageId = "syn";
        ...
        resolvedDefaultFeatures = [ "argparse" "backtrace" "cli" "default" "lcov" "noinline" ];
      };
      "rustc-demangle" = rec {
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "full" "parsing" "visit" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
