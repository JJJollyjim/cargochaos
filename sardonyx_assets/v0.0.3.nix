...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sardonyx_assets/v0.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sardonyx_assets" = rec {
        crateName = "sardonyx_assets";
        version = "0.0.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.3.nix {};
        authors = [
          "Jonathan Baginski <jonathan@baginski.org>"
        ];
        dependencies = [
          {
            name = "crossbeam-queue";
          ...
          {
            name = "sardonyx_core";
            packageId = "sardonyx_core";
          }
          {
            name = "sardonyx_error";
            packageId = "sardonyx_error";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "sardonyx_core" = rec {
        crateName = "sardonyx_core";
        version = "0.0.3";
        edition = "2018";
        sha256 = "0icjn3anxyfm3xyncadq3kyanxigk97b1g29dfx6m5rp2q8bpvy7";
        authors = [
          "Jonathan Baginski <jonathan@baginski.org>"
        ];
        dependencies = [
      ...
      "sardonyx_error" = rec {
        crateName = "sardonyx_error";
        version = "0.0.3";
        edition = "2018";
        sha256 = "102lpjjnik4zfkdz4xpp5kblhqij4wbqncjifdjx38kl28dnnzji";
        authors = [
          "Jonathan Baginski <jonathan@baginski.org>"
        ];
        dependencies = [
