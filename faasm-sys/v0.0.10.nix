...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/faasm-sys/v0.0.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "faasm-sys" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "faasm-sys"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.10.nix {};
        authors = [
          "Mayeul Fournial <mfournial@outlook.com>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "default-tls" "hyper-tls" "native-tls-crate" "tokio-tls" ];
      };
      "rustc-hash" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
