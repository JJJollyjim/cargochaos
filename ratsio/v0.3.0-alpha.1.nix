...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ratsio/v0.3.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nkeys" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0kbdj8cvhd3616rl3s5s8nm91zjx5xz0xhrxfm5n69h4b320imhj";
        authors = [
      ...
      "nom" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "regex" "regexp" "std" "verbose-errors" ];
      };
      "num_cpus" = rec {
        crateName = "num_cpus";
        version = "1.11.1";
      ...
      "ratsio" = rec {
        ...
        authors = [
          "Michael Netshipise <michael@zulzi.com>"
        ];
        dependencies = [
          {
            name = "atomic-counter";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "macros" "stream" "sync" "rt-core" "rt-threaded" "time" "tcp" ];
          }
          {
            name = "tokio-tls";
            packageId = "tokio-tls";
      ...
      "signatory" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "156cpzh5glkqchhf8zqy36vr1p4dhmg60s0iw174c7jkc1k5igz8";
        authors = [
      ...
      "signatory-dalek" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "1lw6wkpfyk0jxyxxpia3ck3xbbl7n19fcwavsmp4nc5c5bbg2gay";
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
