...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wgpu-traits/v0.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wgpu-traits" = rec {
        crateName = "wgpu-traits";
        version = "0.0.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.0.nix {};
        procMacro = true;
        authors = [
          "Mehmet Oguz Derin <mehmetoguzderin@mehmetoguzderin.com>"
        ];
        dependencies = [
          {
            name = "gltf";
