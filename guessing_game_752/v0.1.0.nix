...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_752/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_752" = rec {
        crateName = "guessing_game_752";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_752"; path = "src/main.rs"; }
        ];
