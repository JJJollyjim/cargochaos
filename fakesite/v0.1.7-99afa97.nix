...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fakesite/v0.1.7-99afa97.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fakesite" = rec {
        crateName = "fakesite";
        version = "0.1.7-99afa97";
        edition = "2018";
        crateBin = [
          { name = "fakesite"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.7-99afa97.nix {};
        authors = [
          "Christian Mauduit (ufoot) <ufoot@ufoot.org>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "ticker" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0vmpa3rkkw8ssjg2falhjvaxd4f0pyy2aajpsiqh8w72myi22s1z";
        authors = [
