...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pfza_proto1/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsame54p20a" "same54" "same54p20a" "same54p20a-rt" "unproven" ];
      };
      "atsame54p20a" = rec {
        crateName = "atsame54p20a";
        version = "0.6.1";
        edition = "2015";
        sha256 = "01mjpvxbyncvsix1dhq7kqxw7aigsmywyywljl5bzhkywc0i8d6w";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
          "Paul Sajna <sajattack@gmail.com>"
