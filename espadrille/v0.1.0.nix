...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/espadrille/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "espadrille" = rec {
        crateName = "espadrille";
        version = "0.1.0";
        edition = "2015";
        crateBin = [
          { name = "espadrille"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Leigh Brenecki <leigh@brenecki.id.au>"
        ];
        dependencies = [
          {
            name = "clap";
