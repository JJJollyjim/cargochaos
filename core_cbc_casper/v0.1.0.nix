...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/core_cbc_casper/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "core_cbc_casper" = rec {
        crateName = "core_cbc_casper";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "pZ4 <pz4@protonmail.ch>"
          "Lederstrumpf"
        ...
        resolvedDefaultFeatures = [ "integration_test" "proptest" "rand" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.2.11";
