...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xorstream/v2.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xorstream" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "xorstream"; path = "src/bin/xorstream.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v2.0.2.nix {};
        authors = [
          "Zane Hannan <zanehannanau@gmail.com>"
        ];
        dependencies = [
          {
            name = "base32";
        ...
        resolvedDefaultFeatures = [ "async-std-stream" "async-std-test" "base32" "base64" "bin" "default" "hex" "paw" "std" "stream" "structopt" ];
      };
    };
