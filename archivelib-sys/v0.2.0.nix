...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/archivelib-sys/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "archivelib-sys" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "unalszip"; path = "src/executables/decompress.rs"; }
          { name = "alszip"; path = "src/executables/compress.rs"; }
        ];
