...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/functiontrace-server/v0.1.3.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "functiontrace-server";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "functiontrace-server" = rec {
        crateName = "functiontrace-server";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "functiontrace-server"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Matt Bryant <functiontrace@programsareproofs.com>"
          "Alistair Dobke <adobke@gmail.com>"
        ];
        dependencies = [
          {
            name = "bytesize";
      ...
      "mio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "os-poll" "uds" ];
      };
      "miow" = rec {
        crateName = "miow";
        version = "0.3.3";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "windef" "winerror" "winioctl" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
