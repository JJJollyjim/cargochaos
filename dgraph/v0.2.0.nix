...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dgraph/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dgraph" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "protoc"; path = "compile-protobufs.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "compile-protobufs" "protoc-grpcio" ];
      };
      "dirs" = rec {
        crateName = "dirs";
        version = "1.0.5";
      ...
      "protobuf" = rec {
        ...
        version = "2.5.0";
        edition = "2015";
        sha256 = "0x9b7xzh3bd0mgr73zpw0k38rj46fcs8w88wlmxs4bxf8zvasyxw";
        authors = [
      ...
      "protobuf-codegen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "11q4x0fixcmmc0a3cdig0hjzv3z5k76h9abiv4xi9dcy0545mrqv";
        authors = [
          "Stepan Koltsov <stepan.koltsov@gmail.com>"
        ];
        dependencies = [
      ...
      "protoc" = rec {
        ...
        version = "2.5.0";
        edition = "2015";
        sha256 = "0ymp2ma57k6mps6srj08ln1k739qpq2pvl8yna9qnv2nv74jz6p7";
        authors = [
          "Stepan Koltsov <stepan.koltsov@gmail.com>"
        ];
        dependencies = [
      ...
      "protoc-grpcio" = rec {
        ...
        version = "1.0.2";
        edition = "2015";
        sha256 = "1pb2qlfk9z7qn97cpcf1f2ga4zyc2glf3hfyir1nidyliqjqjhys";
        authors = [
