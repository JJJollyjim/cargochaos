...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cryptsetup-rs/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "expectest" = rec {
        ...
        version = "0.11.0";
        edition = "2015";
        sha256 = "00dv47irmsyq7brzjhz4xns3p722gm98zp39h9hq2mrzd5marpgq";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
