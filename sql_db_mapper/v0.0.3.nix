...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sql_db_mapper/v0.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sql_db_mapper" = rec {
        crateName = "sql_db_mapper";
        version = "0.0.3";
        edition = "2018";
        crateBin = [
          { name = "sql_db_mapper"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.3.nix {};
        authors = [
          "John Martin <johnmartin1225+rust@gmail.com>"
        ];
        dependencies = [
          {
            name = "postgres";
