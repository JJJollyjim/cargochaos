...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/r2d2-influxdb/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "influxdb" = rec {
        ...
        version = "0.0.6";
        edition = "2018";
        sha256 = "09zawvqzwpaykimlf8b9s2xb3bhxak1fs5sn8i3v39vwnrn000a7";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_json" "use-serde" ];
      };
      "iovec" = rec {
        crateName = "iovec";
        version = "0.1.4";
      ...
      "r2d2-influxdb" = rec {
        crateName = "r2d2-influxdb";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "zjhsdtc <zjhsdtc@gmail.com>"
        ];
        dependencies = [
          {
            name = "influxdb";
