...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-credential-null/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-credential-null" = rec {
        crateName = "git-credential-null";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "git-credential-null"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" ];
      };
