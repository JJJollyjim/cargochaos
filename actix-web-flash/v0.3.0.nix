...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web-flash/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web-flash" = rec {
        crateName = "actix-web-flash";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Hans Ole Hatzel <hhatzel@gmail.com>"
        ];
        dependencies = [
          {
            name = "actix-http";
