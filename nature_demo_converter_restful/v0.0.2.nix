...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nature_demo_converter_restful/v0.0.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "nature_demo_converter_restful";
  ...
  workspaceMembers = {
    "nature_demo_converter_restful" = rec {
      packageId = "nature_demo_converter_restful";
      build = internal.buildRustCrateWithFeatures {
        packageId = "nature_demo_converter_restful";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "derive-error-chain" = rec {
        ...
        version = "0.11.2";
        edition = "2015";
        sha256 = "12pjx3gf3s436pzrbrjy5896763fbhl6ighsaza90nscvmmh1y6m";
        procMacro = true;
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "derive" "full" "printing" ];
          }
          {
            name = "syntex_fmt_macros";
            packageId = "syntex_fmt_macros";
          }
        ];
      ...
      "dotenv" = rec {
        ...
        version = "0.11.0";
        edition = "2015";
        sha256 = "1p3cqvyk6z8cy57b1n3gnah3fmjn2b7y3b1wfiqdy66fj32y63d7";
        authors = [
      ...
      "nature_common" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "1gyakr008kfvaba1d4m959ffvbiv381h76zn8h24gmjqmdnznb69";
        authors = [
      ...
      "nature_demo_converter_restful" = rec {
        crateName = "nature_demo_converter_restful";
        version = "0.0.2";
        edition = "2018";
        crateBin = [
          { name = "restful_converter"; path = "src/bin/restful_converter.rs"; }
        ];
      ...
      "syntex_fmt_macros" = rec {
        crateName = "syntex_fmt_macros";
        version = "0.5.0";
        edition = "2015";
        sha256 = "1h7grnlkd35lplw2pp6pv3xakwz1902qicw5mwvd2n47qjyqclsy";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
