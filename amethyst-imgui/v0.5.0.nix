...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst-imgui/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst-imgui" = rec {
        ...
        resolvedDefaultFeatures = [ "docking" "empty" "metal" "vulkan" ];
      };
      ...
      "amethyst_rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_window" "empty" "metal" "shader-compiler" "vulkan" "window" ];
      };
      "amethyst_ui" = rec {
      ...
      "rendy-util" = rec {
        ...
        resolvedDefaultFeatures = [ "gfx-backend-empty" "gfx-backend-metal" "gfx-backend-vulkan" "serde" "serde-1" ];
      };
      "rendy-wsi" = rec {
        crateName = "rendy-wsi";
        version = "0.3.0";
