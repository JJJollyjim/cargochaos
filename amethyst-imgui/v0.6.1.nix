...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst-imgui/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst_rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_window" "shader-compiler" "vulkan" "vulkan-x11" "window" ];
      };
      "amethyst_ui" = rec {
      ...
      "rendy-util" = rec {
        ...
        resolvedDefaultFeatures = [ "gfx-backend-vulkan" "serde" "serde-1" "vulkan" "vulkan-x11" ];
      };
      "rendy-wsi" = rec {
        crateName = "rendy-wsi";
        version = "0.4.1";
      ...
      "winit" = rec {
        ...
        dependencies = [
          ...
          {
            name = "raw-window-handle";
            packageId = "raw-window-handle 0.3.1";
          }
          {
            name = "serde";
            packageId = "serde";
