...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ketos/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ketos" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ketos"; path = "src/bin/repl.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.12.0.nix {};
        libPath = "src/ketos/lib.rs";
        authors = [
          "Murarth <murarth@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "derive" "ketos_derive" "serde" "serde_derive" ];
      };
      "ketos_derive" = rec {
        crateName = "ketos_derive";
        version = "0.12.0";
        edition = "2018";
        sha256 = "0b8b3am4jd6kx8py5r79f6fp933hq6x9h077pgbqiqr12bra120y";
        procMacro = true;
        authors = [
          "Murarth <murarth@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "handleapi" "knownfolders" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "synchapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
