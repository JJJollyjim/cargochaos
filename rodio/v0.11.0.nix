...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rodio/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "combaseapi" "coml2api" "debug" "devpkey" "errhandlingapi" "handleapi" "impl-debug" "ksmedia" "libloaderapi" "memoryapi" "mmdeviceapi" "objbase" "std" "synchapi" "sysinfoapi" "winbase" "winerror" "winuser" ];
      };
