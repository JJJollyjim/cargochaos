...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-imap/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "iovec" "lazy_static" "macros" "mio" "tcp" "tokio-macros" ];
      };
      "tokio-imap" = rec {
        crateName = "tokio-imap";
        version = "0.5.0";
        edition = "2018";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "ntsecapi" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
