...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yubihsm/v0.33.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ecdsa" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1r39mfybcik5r76qkyrvnwh8hfl0jkb5a24x5jqzlm2mhy4syyjs";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "ed25519" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0x7z5g3jw07p73w25sp8a2yw1qdw2v3nm1a7s496ip042pikz5yp";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "signatory" = rec {
        ...
        version = "0.19.0";
        edition = "2018";
        sha256 = "18xqz2l3fv1spvp8lcl9kbs255ijks0crcch1pz6lc2f4fx27b09";
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "digest" "ecdsa" "ed25519" "encoding" "getrandom" "k256" "p256" "p384" "pkcs8" "sha2" "std" "subtle-encoding" ];
      };
      "signatory-ring" = rec {
        crateName = "signatory-ring";
        version = "0.19.0";
        edition = "2018";
        sha256 = "1kh4x21xg5lxxgcc3l34j400fasjnk8j0w1vfgi2v3lb02s6cf8j";
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
        dependencies = [
      ...
      "signatory-secp256k1" = rec {
        ...
        version = "0.19.0";
        edition = "2018";
        sha256 = "1fhn89b0s7qw68bxlg7axzihq8pn47lg4xhrgarhxcd49215827z";
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
        dependencies = [
      ...
      "signature" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "1mvqlczy2l1zy8kccy70qzwzfcc4zdn3r9lvxg86zk66cmdiqpk8";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "signature_derive" = rec {
        ...
        version = "1.0.0-pre.2";
        edition = "2018";
        sha256 = "0wp8b8ald7qixrcvvclhdcpmn8hkx049jlc29g57ql0304c6qrdh";
        procMacro = true;
        authors = [
          "RustCrypto Developers"
        ];
      ...
      "yubihsm" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "signatory";
            packageId = "signatory";
            features = [ "digest" "ecdsa" "ed25519" "k256" "p256" "p384" ];
          }
          {
            name = "signature";
            packageId = "signature";
