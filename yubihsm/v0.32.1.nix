...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yubihsm/v0.32.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "signatory" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "digest" "ecdsa" "ed25519" "encoding" "getrandom" "pkcs8" "sha2" "std" "subtle-encoding" ];
      };
      "signatory-ring" = rec {
        crateName = "signatory-ring";
        version = "0.18.1";
        edition = "2018";
        sha256 = "0q052dkjxizsszvh5c4ff16mpr0di2iyfbk908kj0h0wbn7krqv5";
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "ecdsa" "ed25519" "std" ];
      };
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "CanvasRenderingContext2d" "Crypto" "Document" "DomRect" "Element" "HtmlCanvasElement" "HtmlElement" "Node" "Window" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
      ...
      "yubihsm" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "harp" "hmac" "http" "http-server" "mockhsm" "passwords" "pbkdf2" "ring" "rusb" "secp256k1" "serde_json" "setup" "sha2" "tiny_http" "untested" "usb" ];
      };
      "zeroize" = rec {
        crateName = "zeroize";
        version = "1.1.0";
