...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spacebar/v0.3.0-rc1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "spacebar" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "spacebar"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0-rc1.nix {};
        authors = [
          "Chad Baxter"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "libloaderapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
