...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper-usse/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "time" "macros" "sync" "stream" "io-util" "io-std" ];
          }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
