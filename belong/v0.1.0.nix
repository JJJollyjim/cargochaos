...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/belong/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "casual" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "14gvbw1nbxxjjp9js27kliib4857dvg2mf19b055nwjqi760wawv";
        authors = [
          "Ross MacArthur <ross@macarthur.io>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "shellapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
