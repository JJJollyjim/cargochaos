...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/projects/v1.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "projects" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "projects"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.1.nix {};
        authors = [
          "Michael Mullins <michael@webdesserts.com>"
        ];
        dependencies = [
          {
            name = "dialoguer";
          ...
          {
            name = "webdesserts-confy";
            packageId = "webdesserts-confy";
          }
        ];
      ...
      "webdesserts-confy" = rec {
        crateName = "webdesserts-confy";
        version = "1.0.0";
        edition = "2015";
        sha256 = "06v1b5gsxf8bkrkf8q21maa0qvwz5bn0lgmi2vll6blnhq4l2p3j";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
