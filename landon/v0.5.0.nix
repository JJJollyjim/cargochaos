...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/landon/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blender-armature" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "103xkif9sdg10khx0ypcp8di8svw0gg6rjm11r368gx35m0bx1wm";
        authors = [
      ...
      "blender-mesh" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1j1fk4qlgwskcrdbz114q6h1906rygj8qp8rs0yypnfyrag2h258";
        authors = [
          "Chinedu Francis Nwafili <frankie.nwafili@gmail.com>"
        ];
        dependencies = [
