...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fake_haproxy/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fake_haproxy" = rec {
        crateName = "fake_haproxy";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "fake_haproxy"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Rens Rikkerink <github@ikkerens.com>"
        ];
        dependencies = [
          {
            name = "ctrlc";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwindef" "ntsecapi" "ntstatus" "profileapi" "synchapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
