...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pgc/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
