...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pgc/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pgc" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi 0.3.8";
            target = { target, features }: target."windows";
            features = [ "winuser" "memoryapi" "errhandlingapi" "processthreadsapi" "synchapi" ];
          }
        ];
        features = {
        };
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
