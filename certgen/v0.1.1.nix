...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/certgen/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "p12" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1dm6h9r5k1p0g5am0appy14i7n56nr5iarn8sglrdfr8kz8ws4g9";
        authors = [
          "hjiayz <hjiayz@gmail.com>"
        ];
        dependencies = [
      ...
      "x509-parser" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0zfrrga194gyrfdprr38z3crhz65s78nxi5jd245cyg78my47fkd";
        authors = [
          "Pierre Chifflier <chifflier@wzdftpd.net>"
        ];
        dependencies = [
