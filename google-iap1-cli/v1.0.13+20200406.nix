...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-iap1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-iap1" = rec {
        crateName = "google-iap1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "0hrd13f6z806wgmiyzll7w6l1gbxcl2klm39y5vrsaxyznvlswgd";
        authors = [
      ...
      "google-iap1-cli" = rec {
        crateName = "google-iap1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "iap1"; path = "src/main.rs"; }
        ];
