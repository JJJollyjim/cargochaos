...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dfareporting2d8-cli/v1.0.13+20180830.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dfareporting2d8" = rec {
        ...
        version = "1.0.13+20180830";
        edition = "2015";
        sha256 = "04slha0c96s6ddqzpql8nfkl2r0i574in67k3n62ipza52977427";
        authors = [
      ...
      "google-dfareporting2d8-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20180830.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
