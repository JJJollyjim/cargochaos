...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dfareporting2d8-cli/v1.0.12+20180830.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-dfareporting2d8-cli";
  ...
  workspaceMembers = {
    "google-dfareporting2d8-cli" = rec {
      packageId = "google-dfareporting2d8-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-dfareporting2d8-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dfareporting2d8" = rec {
        crateName = "google-dfareporting2d8";
        version = "1.0.12+20180830";
        edition = "2015";
        sha256 = "15jrh7vzi9r2j4324vapcs0l2vqxk8pcpfwh7z9v8l5as5aiahn6";
        authors = [
      ...
      "google-dfareporting2d8-cli" = rec {
        crateName = "google-dfareporting2d8-cli";
        version = "1.0.12+20180830";
        edition = "2015";
        crateBin = [
          { name = "dfareporting2d8"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20180830.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-dfareporting2d8";
            packageId = "google-dfareporting2d8";
          }
          {
            name = "hyper";
            packageId = "hyper";
