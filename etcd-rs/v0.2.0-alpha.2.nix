...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/etcd-rs/v0.2.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tonic" = rec {
        ...
        edition = "2018";
        sha256 = "0j4xpsbr6qiicfi4h0zg3nwbxz6n7f4l5fb2qn86vkf63r3b59lm";
        authors = [
        ...
        features = {
          ...
          "transport" = [ "hyper" "tokio" "tower" "tower-balance" "tower-load" ];
        };
        resolvedDefaultFeatures = [ "async-trait" "codegen" "default" "hyper" "prost" "prost-derive" "tokio" "tower" "tower-balance" "tower-load" "transport" ];
      };
      "tonic-build" = rec {
        crateName = "tonic-build";
        version = "0.1.0-alpha.6";
        edition = "2018";
        sha256 = "0ra649m7i493za0mf5x624fza5xgnsls8r0gcs6mc8mqcdbg58i4";
        authors = [
          "Lucio Franco <luciofranco14@gmail.com>"
        ];
        dependencies = [
