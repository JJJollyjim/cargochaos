...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/etcd-rs/v0.2.0-alpha.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "etcd-rs" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0-alpha.6.nix {};
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
