...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/factom/v2.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "factom" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "no-runtime" "tokio" "tokio-executor" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
