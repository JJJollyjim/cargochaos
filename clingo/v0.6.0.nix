...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clingo/v0.6.0.nix.tmp"
    ...
    crates = {
      ...
      "clingo" = rec {
        ...
        dependencies = [
          ...
          {
            name = "clingo-derive";
            packageId = "clingo-derive";
            optional = true;
          }
          {
            name = "clingo-sys";
            packageId = "clingo-sys";
          }
          {
            name = "rand";
            packageId = "rand";
        ...
        resolvedDefaultFeatures = [ "clingo-derive" "derive" "dynamic_linking" ];
      };
      "clingo-derive" = rec {
        crateName = "clingo-derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0fc1wgb4cgdjmjmg5y6xdiznx1c14ijnjxljjrcfjdwi61bzz7gn";
        procMacro = true;
        authors = [
      ...
      "clingo-sys" = rec {
        crateName = "clingo-sys";
        version = "0.5.1";
        edition = "2018";
        sha256 = "1ljdcl6wyx07pyvbl2k20dg7zv3ivsq4asb3bd8yiy8m52mrxhps";
        libName = "clingo_sys";
        libPath = "lib.rs";
        authors = [
          "sthiele <sthiele78@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "dynamic_linking" ];
      };
      "env_logger" = rec {
      ...
      "trybuild" = rec {
        ...
        version = "1.0.19";
        edition = "2018";
        sha256 = "17xpybcdx76dm54dk7jvr5aickc4ia66qf57bazg7myx8pf6yzcq";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
