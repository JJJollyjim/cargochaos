...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guion_sdl2/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guion" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "01mvpcq2yq6a2dkcbqb83xv9jvpad2r1mnl9vx1nf373jw0cbi2f";
        authors = [
      ...
      "qwutils" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1gib8s1v21l2qz4m19s95v6d9cmhg0xxl9s8x1fa3fnh8jaami1v";
        authors = [
          "qwertz19281 <dellen903@gmail.com>"
        ];
        dependencies = [
