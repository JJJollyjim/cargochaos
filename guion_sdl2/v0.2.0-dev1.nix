...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guion_sdl2/v0.2.0-dev1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guion" = rec {
        ...
        version = "0.2.0-dev1";
        edition = "2018";
        sha256 = "1ri2i1cmpqjcrwl8yqjx7zpnwzjd1dplv9mf9rvhph2x2qblb0mm";
        authors = [
          "qwertz19281 <dellen903@gmail.com>"
        ];
        dependencies = [
          {
            name = "qwutils";
      ...
      "guion_sdl2" = rec {
        crateName = "guion_sdl2";
        version = "0.2.0-dev1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0-dev1.nix {};
        authors = [
          "qwertz19281 <dellen903@gmail.com>"
        ];
        dependencies = [
      ...
      "qwutils" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "10skfsfji2yppqzz9ymgvipr4hp95z1lml78cgvmh2zczl61bp1i";
        authors = [
          "qwertz19281 <dellen903@gmail.com>"
        ];
        dependencies = [
      ...
      "sdl2-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "ttf" ];
      };
    };
