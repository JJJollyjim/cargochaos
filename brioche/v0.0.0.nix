...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/brioche/v0.0.0.nix.tmp"
    ...
    crates = {
      ...
      "brioche" = rec {
        ...
        dependencies = [
          {
            name = "brioche-ducc";
            packageId = "brioche-ducc";
            rename = "ducc";
          }
          {
            name = "brioche-ducc-serde";
            packageId = "brioche-ducc-serde";
            rename = "ducc-serde";
          }
          {
            name = "err-derive";
      ...
      "brioche-ducc" = rec {
        crateName = "brioche-ducc";
        version = "0.1.2-brioche";
        edition = "2015";
        sha256 = "1hfbx5vaw5v99j6vmy1ix806h53ymknwl5pbvczdx4wi6m7nly52";
        authors = [
          "Skyler Lipthay <sl@skylerlipthay.com>"
          "Kyle Lacy <kylelacy+git@pm.me>"
        ];
        dependencies = [
          {
            name = "brioche-ducc-sys";
            packageId = "brioche-ducc-sys";
            rename = "ducc-sys";
            features = [ "use-exec-timeout-check" ];
          }
          {
            name = "cesu8";
            packageId = "cesu8";
      ...
      "brioche-ducc-serde" = rec {
        crateName = "brioche-ducc-serde";
        version = "0.1.2-brioche";
        edition = "2015";
        sha256 = "1cm7ngm6il5829q5mhp25h6vmbawx83b38cfbhvi4wfpqncargqx";
        authors = [
          "Skyler Lipthay <sl@skylerlipthay.com>"
          "Kyle Lacy <kylelacy+git@pm.me>"
        ];
      ...
      "brioche-ducc-sys" = rec {
        crateName = "brioche-ducc-sys";
        version = "0.1.2-brioche";
        edition = "2015";
        crateBin = [];
        sha256 = "0ws40m1h9brs1mg1yxwngw77s4n0zkqh3rsbbl5iis419h41xrgn";
        authors = [
          "Skyler Lipthay <sl@skylerlipthay.com>"
          "Kyle Lacy <kylelacy+git@pm.me>"
        ];
        ...
        resolvedDefaultFeatures = [ "use-exec-timeout-check" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
