...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bwtui/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "maplit" "ncurses" "ncurses-backend" "term_size" "termion" "termion-backend" ];
      };
      ...
      "cursive_table_view" = rec {
        crateName = "cursive_table_view";
        version = "0.10.0";
        edition = "2015";
        sha256 = "00ss00qc6z605b1bfd0hl3y4nf9y8nkwafavwsxrz6pggcngdmcx";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
