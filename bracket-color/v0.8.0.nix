...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bracket-color/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bracket-color" = rec {
        ...
        resolvedDefaultFeatures = [ "byteorder" "crossterm" "lazy_static" "palette" "parking_lot" "rex" "serde" ];
      };
      "byteorder" = rec {
        crateName = "byteorder";
        version = "1.3.4";
