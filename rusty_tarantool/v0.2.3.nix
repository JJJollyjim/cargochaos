...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty_tarantool/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "base64 0.2.1" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "14nqvphsyr7s13g3vwblkq1p042cx1cjk9z30xh5pajl6mwy6590";
        authors = [
          "Alice Maz <alice@alicemaz.com>"
        ];
      ...
      "rmp-serialize" = rec {
        crateName = "rmp-serialize";
        version = "0.8.1";
        edition = "2015";
        sha256 = "0isb9hd7ra8qi0dhs45kvmcbimqb12vd18cl0b8jsicszpkknxwy";
        authors = [
          "Evgeny Safronov <division494@gmail.com>"
        ];
        dependencies = [
      ...
      "rusty_tarantool" = rec {
        crateName = "rusty_tarantool";
        version = "0.2.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.3.nix {};
        authors = [
          "Michael Zheludkov https://github.com/zheludkovm"
        ];
        dependencies = [
          {
            name = "base64";
            packageId = "base64 0.2.1";
          }
          {
            name = "byteorder";
            packageId = "byteorder";
