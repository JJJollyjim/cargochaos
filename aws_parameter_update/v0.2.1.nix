...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aws_parameter_update/v0.2.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "aws_parameter_update";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aws_parameter_update" = rec {
        crateName = "aws_parameter_update";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "aws_parameter_update"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Lane Sawyer <cratesio@lanesawyer.dev>"
        ];
        dependencies = [
          {
            name = "clap";
