...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/carpo/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sciter-rs" = rec {
        ...
        version = "0.5.46";
        edition = "2015";
        sha256 = "18pak8mqzck5bcrrffyzvrqj9cfrhssrdv46r329rnl2npniz4r1";type = [ "rlib" ];
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shellapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
