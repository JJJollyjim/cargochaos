...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/timely_communication/v0.11.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "abomonation" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "00c6mmwb6jlmw5his875li988rrz9vr2x08mhn9lg1rx498jidzn";
        authors = [
      ...
      "syn 1.0.8" = rec {
        ...
        resolvedDefaultFeatures = [ "clone-impls" "derive" "extra-traits" "parsing" "printing" "proc-macro" "quote" "visit" ];
      };
      "synstructure" = rec {
