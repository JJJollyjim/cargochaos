...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web-opentelemetry/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-web-opentelemetry";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web-opentelemetry" = rec {
        crateName = "actix-web-opentelemetry";
        version = "0.1.1";
        edition = "2018";
      ...
      "opentelemetry" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "11v4wniilj6mz3sfsblqgycqvcbr8g6pxxlg8a5i92fppg3syykf";
        authors = [
      ...
      "rustracing_jaeger" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0qgyaa9r162kl70iakbsfcmkbgi7svdcrb2zs7q5p8zn4j1rzb8k";
        authors = [
          "Takeru Ohta <phjgt308@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
