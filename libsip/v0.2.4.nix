...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libsip/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bswap" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "1xbjph85zabbyxn6av6b06gwi5gg13wi6zw73gr8vrk0kk7cbb73";
        authors = [
      ...
      "libsip" = rec {
        ...
        authors = [
          "Bytebuddha <pmg41494@protonmail.com>"
        ];
        dependencies = [
          {
            name = "md5";
      ...
      "sha" = rec {
        ...
        version = "1.0.3";
        edition = "2015";
        sha256 = "0znbh365wmpkmc0b2lxh8h9xma0jpk2zdzbsg4xrysi70flxa222";
        authors = [
          "Andrew Robbins <and_j_rob@yahoo.com>"
        ];
        dependencies = [
