...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yubikey-cli/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "der-parser" = rec {
        ...
        version = "3.0.3";
        edition = "2018";
        sha256 = "0ghwnvppqarn6c1il2ycghk46bd19313j55kpbiwmhxqximpsyjk";
        authors = [
      ...
      "ecdsa" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0izkyfny3vvfi71a821fnh9ydlj5c3vz8wi5j4kcia45p9y1ipg1";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "digest" "sha2" "std" ];
      };
      "env_logger" = rec {
      ...
      "num-bigint-dig" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "1338yvm3v9fmal59c3z14w03pkvcz02545dbvrj9fa6nxnl551by";
        authors = [
      ...
      "pcsc" = rec {
        ...
        version = "2.3.0";
        edition = "2015";
        sha256 = "1nfanhkaj832x3l0jj3dmq6alfpk19jni94caamnb5g33rabaln9";
        authors = [
      ...
      "rsa" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "05dv10lg2iqa7niyakawzsfiikax4n4mlzfp57c7gzl4zfxsh22i";
        authors = [
          "RustCrypto Developers"
          "dignifiedquire <dignifiedquire@gmail.com>"
        ];
      ...
      "secrecy" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1j8l187z4jhwzdzxwgmw9girxvb0ijrp26md1dz23g1wriap7q9h";
        authors = [
      ...
      "yubikey-cli" = rec {
        crateName = "yubikey-cli";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "yubikey"; path = "src/bin/yubikey/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "yubikey-piv";
            packageId = "yubikey-piv";
          }
        ];
        
      };
      "yubikey-piv" = rec {
        crateName = "yubikey-piv";
        version = "0.0.3";
        edition = "2018";
        sha256 = "02w52n6grz2iy0xsm35kdvw6agpc7i0yw72ch23vfn5qmzysjfx7";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
          "Yubico AB"
        ];
      ...
      "zeroize_derive" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "1bnwh691i31ap3fwfmf9gbzvj1mvcv4b0l22dy60fhzwd6ffb77w";
        procMacro = true;
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
