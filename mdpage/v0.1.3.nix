...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdpage/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "handlebars" = rec {
        ...
        edition = "2018";
        sha256 = "094xflg6grpqmmkikkgsv4m9hy9a624fq05p28n64z8dlf6ia5gk";
        authors = [
      ...
      "mdpage" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mdpage"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Bojan D. <dbojan@gmail.com>"
        ];
        dependencies = [
          {
            name = "comrak";
      ...
      "voca_rs" = rec {
        ...
        version = "1.9.1";
        edition = "2015";
        sha256 = "1x0ygbmvvfjzda0q8q3hksb3wam0apwwi5ym33wwh6v2wpvdfwpz";
        authors = [
          "Anatol Merezhanyi <a.merezhanyi@gmail.com>"
        ];
        dependencies = [
          {
            name = "regex";
