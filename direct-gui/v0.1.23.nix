...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/direct-gui/v0.1.23.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blit" = rec {
        ...
        version = "0.5.7";
        edition = "2018";
        sha256 = "0l7yfz7lhhhwiyja90m481kfc1mizc9ijcmddxgz5za0r59pwj03";
        authors = [
      ...
      "direct-gui" = rec {
        ...
        version = "0.1.23";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.23.nix {};
        authors = [
          "Thomas Versteeg <thomasversteeg@gmx.com>"
        ];
        dependencies = [
