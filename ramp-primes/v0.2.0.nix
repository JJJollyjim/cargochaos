...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ramp-primes/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ramp" = rec {
        ...
        version = "0.5.5";
        edition = "2015";
        sha256 = "05cyprrnm8n99096blaazy96m25zkiicdsbyv05j653vvi0vkngv";
        authors = [
      ...
      "ramp-primes" = rec {
        crateName = "ramp-primes";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "0xSilene <51803887+0xSilene@users.noreply.github.com>"
          "0xAtropa"
        ];
        dependencies = [
          {
