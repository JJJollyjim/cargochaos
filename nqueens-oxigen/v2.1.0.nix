...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nqueens-oxigen/v2.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nqueens-oxigen" = rec {
        crateName = "nqueens-oxigen";
        version = "2.1.0";
        edition = "2015";
        crateBin = [
          { name = "nqueens-oxigen"; path = "src/main.rs"; }
        ];
      ...
      "oxigen" = rec {
        ...
        version = "2.1.0";
        edition = "2015";
        sha256 = "0mxdjjvdxjrmfbrjcazpk2cad5l74iylds5d3kd1j622ib88ffiv";
        authors = [
          "Martin1887 <marcos.martin.pozo.delgado@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "global_cache" ];
      };
      "ppv-lite86" = rec {
