...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustls-native-certs/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "lmcons" "minschannel" "ntsecapi" "schannel" "securitybaseapi" "sspi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "wtypesbase" ];
      };
