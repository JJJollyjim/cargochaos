...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dcmdump/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dicom" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "11215chk88r6fimkmx11ngp42v1vasv7wd4ziaypd6a6jal4j5kf";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
          {
            name = "dicom-core";
            packageId = "dicom-core";
          }
          {
            name = "dicom-dictionary-std";
            packageId = "dicom-dictionary-std";
          }
          {
            name = "dicom-encoding";
            packageId = "dicom-encoding";
          }
          {
            name = "dicom-object";
            packageId = "dicom-object";
          }
          {
            name = "dicom-parser";
            packageId = "dicom-parser";
          }
          {
            name = "dicom-transfer-syntax-registry";
            packageId = "dicom-transfer-syntax-registry";
          }
        ];
        
      };
      "dicom-core" = rec {
        crateName = "dicom-core";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1g09bqf8rhaql3js3p91xzg3q7pixixpvi326z0v62f7gdm5s72x";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
      ...
      "dicom-dictionary-std" = rec {
        crateName = "dicom-dictionary-std";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0sl2n520zw1yxqb1h2xhys65rwpl51m1apvi3mjjk8j77cny0wff";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
      ...
      "dicom-encoding" = rec {
        crateName = "dicom-encoding";
        version = "0.1.0";
        edition = "2018";
        sha256 = "04i6h162j4nsag7c40l71kl6xbvjk6km1yg7vigvzl6wl3qj2skr";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
      ...
      "dicom-object" = rec {
        crateName = "dicom-object";
        version = "0.1.0";
        edition = "2018";
        sha256 = "176626hx1pfijfiphf0wivxczka8ia1j092zyy54jb0n9n4arz7a";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
      ...
      "dicom-parser" = rec {
        crateName = "dicom-parser";
        version = "0.1.0";
        edition = "2018";
        sha256 = "18zvz4aw2xykjg5a0h0m7z3nfns6m6b50l5mdi98dk0pjb731m2r";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
      ...
      "dicom-transfer-syntax-registry" = rec {
        crateName = "dicom-transfer-syntax-registry";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1nl2amcg6sydf11s78c4sjs67nvj7kwydc4by0xi2p1ig2v5sbzx";
        authors = [
          "Eduardo Pinho <enet4mikeenet@gmail.com>"
        ];
        dependencies = [
