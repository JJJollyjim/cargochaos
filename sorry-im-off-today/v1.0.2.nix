...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sorry-im-off-today/v1.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ical" = rec {
        ...
        resolvedDefaultFeatures = [ "ical" "line" "property" ];
      };
      "idna" = rec {
        crateName = "idna";
        version = "0.2.0";
      ...
      "mime_guess" = rec {
        ...
        version = "2.0.2";
        edition = "2015";
        sha256 = "12c0rd048rn1in1j5y81zkh3yglz9zwvkaimygjrqqkdvdy528pl";
        authors = [
      ...
      "sorry-im-off-today" = rec {
        crateName = "sorry-im-off-today";
        version = "1.0.2";
        edition = "2018";
        crateBin = [
          { name = "sorry-im-off-today"; path = "src/main.rs"; }
        ];
