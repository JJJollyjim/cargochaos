...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/quoll/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
