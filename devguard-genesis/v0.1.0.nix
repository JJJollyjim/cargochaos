...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/devguard-genesis/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "carrier" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1ifvnzvpz6i439cpkf4a6ba3pgjbsnrcxzavvlyz7269h820mx34";
        authors = [
        ...
        resolvedDefaultFeatures = [ "conduit" "default" "gcmap" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.45";
      ...
      "ipnet" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "1by2yinh68b6w3z82ricl5gj67g4jd7vyg9i5mywf07ps2h2s776";
        authors = [
