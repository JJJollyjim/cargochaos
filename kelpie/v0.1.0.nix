...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kelpie/v0.1.0.nix.tmp"
    ...
    crates = {
      ...
      "kelpie" = rec {
        ...
        dependencies = [
          ...
          {
            name = "kelpie-client";
            packageId = "kelpie-client";
          }
          {
            name = "kelpie-proto";
            packageId = "kelpie-proto";
          }
          {
            name = "kelpie-server";
            packageId = "kelpie-server";
          }
          {
            name = "log";
            packageId = "log";
      ...
      "kelpie-client" = rec {
        crateName = "kelpie-client";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0hgffl95nsqhf3m7hmyv962psbln9vpajccflx6kf2h458hvf75p";
        authors = [
          "Minoru Osuka <minoru.osuka@gmail.com>"
        ];
        dependencies = [
      ...
      "kelpie-proto" = rec {
        crateName = "kelpie-proto";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0l7lc9zixgrgcc7fx59n2yq6z0pyii4a67q51nhmpra3f5zh6nsv";
        authors = [
      ...
      "kelpie-server" = rec {
        crateName = "kelpie-server";
        version = "0.1.0";
        edition = "2018";
        sha256 = "07lnigyryl6jj4rpf9fg7wqpm4z9ky8mg2gmg8lr1wrqkzsc0lzb";
        authors = [
          "MinoruOsuka <minoru.osuka@gmail.com>"
        ];
        dependencies = [
