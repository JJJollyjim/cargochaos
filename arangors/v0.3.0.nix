...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arangors/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arangors" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "cluster" "default" "enterprise" "mmfiles" "reqwest" "reqwest_async" "reqwest_blocking" "rocksdb" "surf" "surf_async" ];
      };
      ...
      "async-h1" = rec {
        ...
        version = "1.1.2";
        edition = "2018";
        sha256 = "0mmfg4cjmxhk6i3mjdp6zrqr0s7xlzk7392aj95m62ffxcgm1zgg";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "maybe-async" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "03x170zgbn4dna009rqs8b2j66lvfj98sj17qrc2vfsaiq74ikfb";
        procMacro = true;
        authors = [
          "Guoli Lyu <guoli-lv@hotmail.com>"
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "blocking" "default" "default-tls" "gzip" "hyper-tls" "json" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.4";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-io" = rec {
        crateName = "tokio-io";
        version = "0.1.13";
