...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-healthcare1_beta1-cli/v1.0.13+20200327.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-healthcare1_beta1-cli";
  ...
  workspaceMembers = {
    "google-healthcare1_beta1-cli" = rec {
      packageId = "google-healthcare1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-healthcare1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-healthcare1_beta1" = rec {
        crateName = "google-healthcare1_beta1";
        version = "1.0.13+20200327";
        edition = "2015";
        sha256 = "0w1zgcvwhwyja7aw99lfh8xglw964lyw2a0f3lw050gvlr68irwr";
        authors = [
      ...
      "google-healthcare1_beta1-cli" = rec {
        crateName = "google-healthcare1_beta1-cli";
        version = "1.0.13+20200327";
        edition = "2015";
        crateBin = [
          { name = "healthcare1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-healthcare1_beta1";
            packageId = "google-healthcare1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
