...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imagecli/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imagecli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "imagecli"; path = "src/main.rs"; }
        ];
      ...
      "imageproc" = rec {
        ...
        version = "0.19.1";
        edition = "2018";
        sha256 = "1ld8l0vylnzxdr3dg0i0ilqcfl07drmxwrhi9zza42mf297958pp";
        authors = [
          "theotherphil"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "winbase" "winnt" "winuser" ];
      };
