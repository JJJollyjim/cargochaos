...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-remote-wallet/v1.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hidapi" = rec {
        ...
        resolvedDefaultFeatures = [ "linux-shared-hidraw" "linux-shared-libusb" "linux-static-hidraw" "linux-static-libusb" ];
      };
      "hmac" = rec {
        crateName = "hmac";
        version = "0.7.1";
      ...
      "solana-remote-wallet" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "solana-ledger-udev"; path = "src/bin/ledger-udev.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "linux-shared-hidraw" "linux-shared-libusb" "linux-static-hidraw" "linux-static-libusb" ];
      };
      "solana-sdk" = rec {
