...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kpal/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kpal" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "kpald"; path = "src/bin/kpald.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "Kyle M. Douglass <kyle.douglass@protonmail.com>"
        ];
        dependencies = [
          {
            name = "dirs";
      ...
      "kpal-plugin" = rec {
        crateName = "kpal-plugin";
        version = "0.2.2";
        edition = "2018";
        sha256 = "0srqmdl8cz8845326pfw0a62ynxh1xivjr13r0xlqn5vpbv3f244";type = [ "cdylib" "rlib" ];
        authors = [
          "kmdouglass <kyle.m.douglass@gmail.com>"
        ];
        dependencies = [
          {
            name = "env_logger";
      ...
      "multi-map" = rec {
        ...
        version = "1.2.0";
        edition = "2015";
        sha256 = "0r12bm5076cckszsszq0g47rv1n2x22gsqxjxjhsn73z5r3zfhav";
        authors = [
