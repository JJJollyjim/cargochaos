...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hypercore/v0.11.1-beta.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitfield-rle" = rec {
        crateName = "bitfield-rle";
        version = "0.1.1";
        edition = "2018";
        sha256 = "19n989rsjwvwlxjsxwfvyq0by5pdvvanx9f1k8xc5p8lkgcp99sx";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "flat-tree" = rec {
        ...
        version = "5.0.0";
        edition = "2015";
        sha256 = "1r79llws4yjcbsb048bv4anl3x9hzf1b13j5s7rqb5bd9c6jhpgm";
        authors = [
      ...
      "hypercore" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.11.1-beta.3.nix {};
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "memory-pager";
            packageId = "memory-pager";
          }
          {
            name = "merkle-tree-stream";
            packageId = "merkle-tree-stream";
          }
          {
            name = "pretty-hash";
            packageId = "pretty-hash";
          }
          {
            name = "rand";
            packageId = "rand";
          ...
          }
          {
            ...
            packageId = "random-access-memory";
          }
          {
          ...
          {
            name = "sleep-parser";
            packageId = "sleep-parser";
          }
          {
            name = "sparse-bitfield";
            packageId = "sparse-bitfield";
          }
          {
            name = "tree-index";
            packageId = "tree-index";
          }
        ];
        devDependencies = [
          {
      ...
      "memory-pager" = rec {
        crateName = "memory-pager";
        version = "0.9.0";
        edition = "2018";
        sha256 = "1fzrfvxjby22n3scyljzgximqv9iqympn0hbl8mfm0in84xya1dd";
        authors = [
          "datrs <yoshuawuyts@gmail.com>"
        ];
        
      };
      "merkle-tree-stream" = rec {
        crateName = "merkle-tree-stream";
        version = "0.12.0";
        edition = "2018";
        sha256 = "13vmb7map9sl14z9l64p0yy712pprglfrsd02l4v6yvym6is5a54";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "pretty-hash" = rec {
        crateName = "pretty-hash";
        version = "0.4.1";
        edition = "2015";
        sha256 = "00jn7dj0j3lj229fjsr6hi1nh865zzapw4qdd9741jr7icagz1yk";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "random-access-memory" = rec {
        crateName = "random-access-memory";
        version = "1.1.0";
        edition = "2018";
        sha256 = "02aqs0ainxj8j62rhnl8n4sxvscjw3hxk7bzgf3mn979v6rr9ldm";
        authors = [
          "datrs <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "sleep-parser" = rec {
        crateName = "sleep-parser";
        version = "0.8.0";
        edition = "2018";
        sha256 = "0x57dw0jmraz6xrpsir6v49f8q5ri4rc9fncbqjk9vic7gvl8xxp";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "sparse-bitfield" = rec {
        crateName = "sparse-bitfield";
        version = "0.11.0";
        edition = "2018";
        sha256 = "0x70vsmpwmjiwnihr15z6gqihpqisfkj5y6zcwdvvjrccjfjm3pr";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "tree-index" = rec {
        crateName = "tree-index";
        version = "0.6.0";
        edition = "2015";
        sha256 = "02fkwhmqq9nycq42f1zsd93a07abyw129xnsk1yamg552k3c7j1g";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "varinteger" = rec {
        crateName = "varinteger";
        version = "1.0.6";
        edition = "2015";
        sha256 = "04hq308aan69c998pj0xywk0aa4ghwh82sv536v8pw2gz6wrv8ky";
        authors = [
          "Mathias Buus <mathiasbuus@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "processthreadsapi" "std" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
