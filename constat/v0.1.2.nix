...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constat/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "shellapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "wingdi" "winuser" ];
      };
