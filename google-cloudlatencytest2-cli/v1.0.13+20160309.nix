...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudlatencytest2-cli/v1.0.13+20160309.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudlatencytest2" = rec {
        ...
        edition = "2015";
        sha256 = "0yag2bc4rd55zpv94w1dr3ixln2pk6wgk5m40ah4f5hc98rllliq";
        authors = [
      ...
      "google-cloudlatencytest2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20160309.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
