...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudlatencytest2-cli/v1.0.12+20160309.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudlatencytest2-cli";
  ...
  workspaceMembers = {
    "google-cloudlatencytest2-cli" = rec {
      packageId = "google-cloudlatencytest2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudlatencytest2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudlatencytest2" = rec {
        crateName = "google-cloudlatencytest2";
        version = "1.0.12+20160309";
        edition = "2015";
        sha256 = "1bphly2cylc9r04anfmxc5l1iy85jimsmnzjwzd8x3x3fi2zf5wx";
        authors = [
      ...
      "google-cloudlatencytest2-cli" = rec {
        crateName = "google-cloudlatencytest2-cli";
        version = "1.0.12+20160309";
        edition = "2015";
        crateBin = [
          { name = "cloudlatencytest2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20160309.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudlatencytest2";
          }
          {
            name = "hyper";
            packageId = "hyper";
