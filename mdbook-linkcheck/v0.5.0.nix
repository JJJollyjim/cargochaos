...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-linkcheck/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0jdbdfb3ir6bjw3d7k5apdw4f1r0sig0ljfpx08mqjwa0ywv3ygq";
        authors = [
      ...
      "mdbook-linkcheck" = rec {
        crateName = "mdbook-linkcheck";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "mdbook-linkcheck"; path = "src/bin/mdbook-linkcheck.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
