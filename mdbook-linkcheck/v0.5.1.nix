...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-linkcheck/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "codespan" = rec {
        ...
        version = "0.9.2";
        edition = "2018";
        sha256 = "0dmrpbc9i0c503rgxkp2yk3n0rp1dxc00g9ri6pfijn7j8ncc8p9";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
