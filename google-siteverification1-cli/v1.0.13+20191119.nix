...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-siteverification1-cli/v1.0.13+20191119.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-siteverification1-cli";
  ...
  workspaceMembers = {
    "google-siteverification1-cli" = rec {
      packageId = "google-siteverification1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-siteverification1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-siteverification1" = rec {
        crateName = "google-siteverification1";
        version = "1.0.13+20191119";
        edition = "2015";
        sha256 = "0w2qyd6hhnbav0zwfqcmi4bh2b7lnvmwl6b633abpa34p73ngjv1";
        authors = [
      ...
      "google-siteverification1-cli" = rec {
        crateName = "google-siteverification1-cli";
        version = "1.0.13+20191119";
        edition = "2015";
        crateBin = [
          { name = "siteverification1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20191119.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-siteverification1";
          }
          {
            name = "hyper";
            packageId = "hyper";
