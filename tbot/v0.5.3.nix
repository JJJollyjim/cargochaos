...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tbot/v0.5.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-proxy" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1vlgzn708640a87ixc6vln26h4nvr2b83k3r4b90r3lfhvnj1w8c";
        authors = [
        ...
        resolvedDefaultFeatures = [ "hyper-rustls" "hyper-tls" "native-tls" "rustls" "rustls-native-certs" "tls" "tokio-rustls" "tokio-tls" "webpki" ];
      };
      "hyper-rustls" = rec {
      ...
      "is-macro" = rec {
        ...
        version = "0.1.8";
        edition = "2018";
        sha256 = "1vjh4sdpvx1kdf1znyk3b54gkyk7f8lsasc47ypkksp3r4ypz004";
        procMacro = true;
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "syn";
            packageId = "syn";
            features = [ "fold" "full" "derive" "extra-traits" ];
          }
        ];
      ...
      "tbot" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "hyper-rustls" "hyper-tls" "native-tls" "proxy" "rustls" "tls" "tokio-rustls" "tokio-tls" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "memchr" "mio" "rt-core" "slab" "sync" "tcp" "time" ];
      };
      "tokio-rustls" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
