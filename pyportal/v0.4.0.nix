...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pyportal/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd51j20a" "samd51" "samd51j20a" "samd51j20a-rt" "unproven" ];
      };
      "atsamd51j20a" = rec {
        crateName = "atsamd51j20a";
        version = "0.6.0";
        edition = "2015";
        sha256 = "0l7xq4kk4inc3pw9528h14b0xi0fbyr1a504920d8dclj3m8zq73";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
          "Paul Sajna <sajattack@gmail.com>"
