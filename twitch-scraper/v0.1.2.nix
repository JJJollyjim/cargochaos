...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/twitch-scraper/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "twitch-scraper" = rec {
        crateName = "twitch-scraper";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "twitch-scraper"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Ashkan Kiani <dev.twitch-scraper@kiani.io>"
        ];
        dependencies = [
          {
            name = "derive_more";
