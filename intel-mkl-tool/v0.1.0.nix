...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/intel-mkl-tool/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "intel-mkl-tool" = rec {
        crateName = "intel-mkl-tool";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "intel-mkl-tool"; path = "src/cli.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
