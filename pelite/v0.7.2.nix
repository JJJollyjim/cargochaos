...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pelite/v0.7.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lde" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1nnlwc9sk17waaw555hvbmjk5np38mf75n8z1xipigmcc818153h";
        authors = [
      ...
      "pelite" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "pedump"; path = "src/bin/pedump.rs"; }
          { name = "msrtti"; path = "src/bin/msrtti.rs"; }
          { name = "module-def"; path = "src/bin/module-def.rs"; }
          { name = "findsig"; path = "src/bin/findsig.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "data-encoding" "default" "libc" "mmap" "serde" "unsafe_alignment" "winapi" ];
      };
      "proc-macro2" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "fileapi" "handleapi" "memoryapi" "minwindef" "ntsecapi" "profileapi" "winnt" ];
      };
