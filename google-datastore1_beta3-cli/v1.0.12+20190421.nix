...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-datastore1_beta3-cli/v1.0.12+20190421.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-datastore1_beta3-cli";
  ...
  workspaceMembers = {
    "google-datastore1_beta3-cli" = rec {
      packageId = "google-datastore1_beta3-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-datastore1_beta3-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-datastore1_beta3" = rec {
        crateName = "google-datastore1_beta3";
        version = "1.0.12+20190421";
        edition = "2015";
        sha256 = "0hvsgl6zx44wbbbnvjwbc8i2rd1ndsw66f8dfir6png0wyyl6vj9";
        authors = [
      ...
      "google-datastore1_beta3-cli" = rec {
        crateName = "google-datastore1_beta3-cli";
        version = "1.0.12+20190421";
        edition = "2015";
        crateBin = [
          { name = "datastore1-beta3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190421.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-datastore1_beta3";
          }
          {
            name = "hyper";
            packageId = "hyper";
