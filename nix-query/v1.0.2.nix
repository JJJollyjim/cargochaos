...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nix-query/v1.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nix-query" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "nix-query"; path = "src/main.rs"; }
        ];
      ...
      "skim" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1yiyd6fml5hd2l811sckkzmiiq9bd7018ajk4qk3ai4wyvqnw8mv";
        authors = [
