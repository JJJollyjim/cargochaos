...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oci-registry-client/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oci-registry-client" = rec {
        crateName = "oci-registry-client";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "oci-registry-client"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Erle Carrara <carrara.erle@gmail.com>"
        ];
        dependencies = [
          {
            name = "bytes";
        ...
        resolvedDefaultFeatures = [ "default" "sha2" "sha256" ];
      };
      "opaque-debug" = rec {
