...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sgx-decode-pib/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sgx-decode-pib" = rec {
        crateName = "sgx-decode-pib";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "sgx-decode-pib"; path = "src/main.rs"; }
        ];
