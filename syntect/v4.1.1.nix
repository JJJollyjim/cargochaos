...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/syntect/v4.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "syntect" = rec {
        ...
        resolvedDefaultFeatures = [ "assets" "bincode" "default" "default-fancy" "default-onig" "dump-create" "dump-create-rs" "dump-load" "dump-load-rs" "fancy-regex" "flate2" "fnv" "html" "metadata" "onig" "parsing" "regex-fancy" "regex-onig" "regex-syntax" "yaml-load" "yaml-rust" ];
      };
      "termcolor" = rec {
        crateName = "termcolor";
        version = "1.0.5";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
