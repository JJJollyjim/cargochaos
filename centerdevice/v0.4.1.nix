...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/centerdevice/v0.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "buf-read-ext" = rec {
        crateName = "buf-read-ext";
        version = "0.3.0";
        edition = "2015";
        sha256 = "1aqrlk1abbjaxxz0mdqm9qzqym8dlklwr8r55ba643vsdkpknaxx";
        authors = [
        ...
        features = {
          "async" = [ "futures" "tokio-io" ];
          "default" = [ "async" ];
        };
        resolvedDefaultFeatures = [ "async" "default" "futures" "tokio-io" ];
      };
      "bumpalo" = rec {
        crateName = "bumpalo";
        version = "3.2.0";
      ...
      "centerdevice" = rec {
        crateName = "centerdevice";
        version = "0.4.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.1.nix {};
        authors = [
          "Lukas Pustina <lukas.pustina@centerdevice.de>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "mime_multipart" = rec {
        crateName = "mime_multipart";
        version = "0.5.2";
        edition = "2015";
        sha256 = "0f0lg72xgx3mw6r60brjdc973pwmiy0wk1phh6rpr3pf24n6wm8n";
        authors = [
          "Mike Dilger <mike@optcomp.nz>"
        ];
        dependencies = [
