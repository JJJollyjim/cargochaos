...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hdrhistogram/v7.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hdrhistogram" = rec {
        ...
        version = "7.0.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v7.0.0.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "base64" "bench_private" "crossbeam-channel" "default" "flate2" "nom" "serialization" "sync" ];
      };
      "ieee754" = rec {
        crateName = "ieee754";
        version = "0.2.6";
