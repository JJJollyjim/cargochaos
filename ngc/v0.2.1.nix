...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ngc/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ngc" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ngc-parse"; path = "src/bin/ngc-parse.rs"; }
          { name = "ngc-eval"; path = "src/bin/ngc-eval.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "eval" ];
      };
      "opaque-debug" = rec {
