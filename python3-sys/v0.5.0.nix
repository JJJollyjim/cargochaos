...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/python3-sys/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "python3-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "extension-module" "link-mode-default" "link-mode-unresolved-static" "pep-384" "python-3" "python-3-4" "python-3-5" "python-3-6" "python-3-7" "python-3-8" ];
      };
      "regex" = rec {
        crateName = "regex";
        version = "1.3.6";
