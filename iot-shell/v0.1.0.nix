...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/iot-shell/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iot-shell" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "iot-shell"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Matthew Taylor <taylor@cyberbacon.dev>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" ];
      };
