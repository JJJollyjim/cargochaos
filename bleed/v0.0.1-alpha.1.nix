...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bleed/v0.0.1-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bleed" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "bleed"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1-alpha.1.nix {};
        authors = [
          "Nicholas Young <nyoung@uptime.ventures>"
        ];
        dependencies = [
          {
            name = "serialport";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cguid" "commapi" "consoleapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "setupapi" "winbase" "winerror" "winnt" ];
      };
