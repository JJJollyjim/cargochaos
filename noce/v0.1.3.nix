...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/noce/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "noce" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "process" "io-util" ];
          }
        ];
      ...
      "tbot" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0l8cnqys3xiw2ichx3h3ca796sbszq20vy4w4i3589llx83fj2k8";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "slab" "sync" "tcp" "time" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
