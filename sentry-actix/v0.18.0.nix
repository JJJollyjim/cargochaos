...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sentry-actix/v0.18.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sentry" = rec {
        ...
        version = "0.18.0";
        edition = "2018";
        sha256 = "0kmd3h1x7n3gsww1a80v8qbqsc8n17h962gr9v8i0x3rb31cdqgg";
        authors = [
          "Sentry <hello@sentry.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "backtrace" "env_logger" "failure" "hostname" "httpdate" "im" "libc" "log" "rand" "regex" "reqwest" "rustc_version" "uname" "url" "with_backtrace" "with_client_implementation" "with_default_transport" "with_device_info" "with_env_logger" "with_failure" "with_log" "with_native_tls" "with_panic" "with_reqwest_transport" "with_rust_info" ];
      };
      "sentry-actix" = rec {
