...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudprivatecatalogproducer1_beta1-cli/v1.0.12+20190622.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudprivatecatalogproducer1_beta1-cli";
  ...
  workspaceMembers = {
    "google-cloudprivatecatalogproducer1_beta1-cli" = rec {
      packageId = "google-cloudprivatecatalogproducer1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudprivatecatalogproducer1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudprivatecatalogproducer1_beta1" = rec {
        crateName = "google-cloudprivatecatalogproducer1_beta1";
        version = "1.0.12+20190622";
        edition = "2015";
        sha256 = "1s49v5vn91r7h6g870fak9xp360nl6y2kfl27h1qb2kw5i0gjjji";
        authors = [
      ...
      "google-cloudprivatecatalogproducer1_beta1-cli" = rec {
        crateName = "google-cloudprivatecatalogproducer1_beta1-cli";
        version = "1.0.12+20190622";
        edition = "2015";
        crateBin = [
          { name = "cloudprivatecatalogproducer1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190622.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-cloudprivatecatalogproducer1_beta1";
            packageId = "google-cloudprivatecatalogproducer1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
