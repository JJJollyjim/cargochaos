...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudprivatecatalogproducer1_beta1-cli/v1.0.13+20200405.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudprivatecatalogproducer1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "0fpfwzplkwv9fy2nbkg3jbpzczl08ydfhy0as21viy66y7ywix90";
        authors = [
      ...
      "google-cloudprivatecatalogproducer1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200405.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
