...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fil-sapling-crypto/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bellperson" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "13wml8kzlqi01sfpq35pmzwijw36blsxhvjjwf496nlppbbc4kbc";
        authors = [
        ...
        resolvedDefaultFeatures = [ "crossbeam" "default" "futures-cpupool" "gpu" "groth16" "itertools" "multicore" "num_cpus" "ocl" "paired" ];
      };
      "bit-vec" = rec {
        crateName = "bit-vec";
        version = "0.6.1";
