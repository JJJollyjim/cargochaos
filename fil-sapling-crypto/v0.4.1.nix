...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fil-sapling-crypto/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bellperson" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "1185s5sx91a76b0nvryn0mppba2ppf6g804s5b8vj62h3qh2klnp";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
