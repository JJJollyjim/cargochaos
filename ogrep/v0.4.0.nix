...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ogrep/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "itertools" = rec {
        ...
        version = "0.7.7";
        edition = "2015";
        sha256 = "1lccfc9jxp7bg0ak5kcy0jp40yxgrarcbj5rqd280cwlfd63pm93";
        authors = [
          "bluss"
        ];
        dependencies = [
      ...
      "regex" = rec {
        ...
        version = "0.2.6";
        edition = "2015";
        sha256 = "0awbvs8qqxscg7b21ml4xxasgn79vxn7dh7xqgccyj0cvrxk9rav";
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
