...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xactor/v0.6.4.nix.tmp"
    ...
    crates = {
      ...
      "xactor" = rec {
        ...
        dependencies = [
          ...
          {
            name = "xactor-derive";
            packageId = "xactor-derive";
          }
        ];
        
      };
      "xactor-derive" = rec {
        crateName = "xactor-derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1bl5s0r87xk6snril7zmjxk48cb4yyf1jm2jvv2myzlrha9i7y9a";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
