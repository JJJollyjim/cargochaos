...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cli_color_log/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cli_color_log" = rec {
        crateName = "cli_color_log";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cli_color_log"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "zhangkefei <zhkf.hunter@gmail.com>"
        ];
        dependencies = [
          {
            name = "console";
