...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/obliviate/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "obliviate" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "obliviate"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winnls" "winnt" "winuser" ];
      };
