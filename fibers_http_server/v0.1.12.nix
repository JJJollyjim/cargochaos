...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fibers_http_server/v0.1.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "factory" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0b4vpj5jd2m7c6ff84pfabk8rd2ixqr3kfnqpq8xsr69bag5g8vk";
        authors = [
          "Takeru Ohta <phjgt308@gmail.com>"
        ];
        features = {
      ...
      "prometrics" = rec {
        ...
        version = "0.1.12";
        edition = "2015";
        sha256 = "10hymkksdcxr3y9dgkv1yvfyc4hy0k829qn3i82b0737118vi4kd";
        authors = [
          "Takeru Ohta <phjgt308@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
