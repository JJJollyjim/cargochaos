...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cobalt-bin/v0.15.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cobalt-bin" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.15.11.nix {};
        libName = "cobalt";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "mime_guess" "notify" "sass" "sass-rs" "serve" "syntax-highlight" "syntect" "tiny_http" "unstable" ];
      };
      "crc32fast" = rec {
        crateName = "crc32fast";
        version = "1.2.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "shellapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
