...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cobalt-bin/v0.15.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cobalt-bin" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.15.10.nix {};
        libName = "cobalt";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "mime_guess" "notify" "pagination-unstable" "sass" "sass-rs" "serve" "syntax-highlight" "syntect" "tiny_http" "unstable" ];
      };
      "crc32fast" = rec {
        crateName = "crc32fast";
        version = "1.2.0";
