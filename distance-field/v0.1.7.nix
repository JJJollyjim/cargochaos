...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/distance-field/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "spiral" = rec {
        ...
        version = "0.1.9";
        edition = "2015";
        sha256 = "1qfjbj1nzwk5aqlk1h7hn0p49wkwb21r4jj9j705nsyk023hdqxz";
        authors = [
          "Thomas Versteeg <thomasversteeg@gmx.com>"
        ];
