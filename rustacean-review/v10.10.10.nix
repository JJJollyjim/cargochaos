...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustacean-review/v10.10.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ferris_print" = rec {
        crateName = "ferris_print";
        version = "0.1.0";
        edition = "2015";
        sha256 = "08warpc0cfbvs7ng3i6yi2scwy0xpfjl3xnc8lmdivlmdpips6sm";
        authors = [
      ...
      "rustacean-review" = rec {
        crateName = "rustacean-review";
        version = "10.10.10";
        edition = "2018";
        crateBin = [
          { name = "rustacean-review"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v10.10.10.nix {};
        authors = [
          "Transmissions <greenfeatherhelp@gmail.com>"
        ];
        dependencies = [
          {
            name = "cursive";
