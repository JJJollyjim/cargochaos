...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo_code_tejas/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo_code_tejas" = rec {
        crateName = "cargo_code_tejas";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo_code_tejas"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Tejas Deshpande <deshpandetejas95@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
