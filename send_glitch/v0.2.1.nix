...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/send_glitch/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glitch-in-the-matrix" = rec {
        crateName = "glitch-in-the-matrix";
        version = "0.14.0";
        edition = "2018";
        sha256 = "1axwp5yna9rbpqp57yxh9m8dlhwknrjj72fra8kv9m06pjpd0a38";
        authors = [
          "eeeeeta <eeeeeta@users.noreply.github.com>"
          "digital <coding@digitalville.de>"
        ];
        dependencies = [
          {
            name = "failure";
      ...
      "gm-types" = rec {
        ...
        version = "0.4.0-pre";
        edition = "2018";
        sha256 = "05df1fwx588jw2aj1rx6fflp1s5x73m7rjhxdvw746bpd2lnrcrn";
        authors = [
          "eeeeeta <eeeeeta@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "oops" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1a34z02l5ihpib8dc83jlx3sd6fhrn084alc9a7syab4rfvdg2p2";
        authors = [
          "blakehawkins"
        ];
      ...
      "send_glitch" = rec {
        crateName = "send_glitch";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "send_glitch"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "glitch-in-the-matrix";
          }
          {
            name = "gm-types";
            packageId = "gm-types";
      ...
      "stdinix" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "02x2ccbp3nz7nhvqdwj5nkf8ib2w78a88zlpdl4xzyzylkvib8ha";
        authors = [
          "blakehawkins"
        ];
