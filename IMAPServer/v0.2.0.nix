...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/IMAPServer/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "IMAPServer" = rec {
        crateName = "IMAPServer";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "IMAPServer"; path = "src/main.rs"; }
        ];
      ...
      "mailparse" = rec {
        ...
        version = "0.10.1";
        edition = "2015";
        sha256 = "1wbvgzwd451lzpdlmdg5v144kscvrj6k4218s2nsl24gq5ybj3n0";
        authors = [
