...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-videointelligence1_beta1-cli/v1.0.12+20171122.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-videointelligence1_beta1-cli";
  ...
  workspaceMembers = {
    "google-videointelligence1_beta1-cli" = rec {
      packageId = "google-videointelligence1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-videointelligence1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-videointelligence1_beta1" = rec {
        crateName = "google-videointelligence1_beta1";
        version = "1.0.12+20171122";
        edition = "2015";
        sha256 = "0adfiv89wmy1bs41djczjzajqr41plgwzfx6yjjslmw47mfsq5nh";
        authors = [
      ...
      "google-videointelligence1_beta1-cli" = rec {
        crateName = "google-videointelligence1_beta1-cli";
        version = "1.0.12+20171122";
        edition = "2015";
        crateBin = [
          { name = "videointelligence1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20171122.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-videointelligence1_beta1";
            packageId = "google-videointelligence1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
