...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_viggin/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "guessing_game_viggin";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_viggin" = rec {
        crateName = "guessing_game_viggin";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "tests"; path = "src/bin/tests/main.rs"; }
          { name = "split"; path = "src/bin/split/main.rs"; }
          { name = "minigrep"; path = "src/bin/minigrep/main.rs"; }
          { name = "iterators"; path = "src/bin/iterators/main.rs"; }
          { name = "http_async"; path = "src/bin/http_async/main.rs"; }
          { name = "hash"; path = "src/bin/hash/main.rs"; }
          { name = "guessing_game"; path = "src/bin/guessing_game/main.rs"; }
          { name = "generics"; path = "src/bin/generics/main.rs"; }
          { name = "errors"; path = "src/bin/errors/main.rs"; }
          { name = "enums"; path = "src/bin/enums/main.rs"; }
          { name = "collections"; path = "src/bin/collections/main.rs"; }
          { name = "closures"; path = "src/bin/closures/main.rs"; }
          { name = "async"; path = "src/bin/async/main.rs"; }
        ];
