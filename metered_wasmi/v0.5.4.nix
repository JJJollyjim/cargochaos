...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/metered_wasmi/v0.5.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "metered_wasmi" = rec {
        ...
        resolvedDefaultFeatures = [ "core" "default" "libm" "std" "vec_memory" ];
      };
      "num-bigint" = rec {
      ...
      "wabt" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "0xas6g95jjfzml4k051fda81d9zgixjfxva5fl58r2gj6bwzls07";
        authors = [
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
        ];
        dependencies = [
      ...
      "wabt-sys" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1p79cpv2786z22axv83ginxqys0y788kw7v1lmfk366nl27rmaja";
        authors = [
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
        ];
        buildDependencies = [
      ...
      "wasmi-validation" = rec {
        ...
        resolvedDefaultFeatures = [ "core" "hashbrown" "std" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.7";
