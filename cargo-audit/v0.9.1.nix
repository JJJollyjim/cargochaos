...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-audit/v0.9.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-lock" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "1yk89r92sn22anryc359hqpas2cc04ik8hfkibix897230vz86n7";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
      ...
      "rustsec" = rec {
        ...
        version = "0.14.1";
        edition = "2018";
        sha256 = "0jaj6p5dw5f59wm390l1lxcprkx6ilswikib515sdqzw14iwqy7i";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
