...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-audit/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "generational-arena" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "1kmrh3nh4bnv06viafa21kq7jjwz1ygrs575kmizkfdfml1kh74j";
        authors = [
      ...
      "rustsec" = rec {
        ...
        resolvedDefaultFeatures = [ "dependency-tree" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.1";
      ...
      "zeroize" = rec {
        ...
        version = "1.0.0-pre";
        edition = "2018";
        sha256 = "1xzdfn8wj1x7gs8ssh9mymjrf928k11z76xd7ns8vygaw4k62hsm";
        authors = [
          "Tony Arcieri <tony@iqlusion.io>"
        ];
        features = {
