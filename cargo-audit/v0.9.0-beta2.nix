...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-audit/v0.9.0-beta2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-audit" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.9.0-beta2.nix {};
        authors = [
      ...
      "cargo-lock" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0vrwl4fp9qzhcl4jk9f9vaz7zhkl6mn6nlxz771ryhkwvy5sw9k9";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
      ...
      "rustsec" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1lkckbb8pmcqq2k6mg3iyv67zdl978499iar0p46dq3dvrihxikh";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
