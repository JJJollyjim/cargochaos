...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudmonitoring2_beta2-cli/v1.0.13+20170501.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudmonitoring2_beta2" = rec {
        ...
        edition = "2015";
        sha256 = "034y6p66dwkcrfpqdv99nrx3hflkm4bjgp5jpkfg8mkyfs5g59ys";
        authors = [
      ...
      "google-cloudmonitoring2_beta2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20170501.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
