...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudmonitoring2_beta2-cli/v1.0.12+20170501.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudmonitoring2_beta2-cli";
  ...
  workspaceMembers = {
    "google-cloudmonitoring2_beta2-cli" = rec {
      packageId = "google-cloudmonitoring2_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudmonitoring2_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudmonitoring2_beta2" = rec {
        crateName = "google-cloudmonitoring2_beta2";
        version = "1.0.12+20170501";
        edition = "2015";
        sha256 = "1nc97041bpv16vy3k7757436inlilqs5mrm0zydirf4grd8wb00p";
        authors = [
      ...
      "google-cloudmonitoring2_beta2-cli" = rec {
        crateName = "google-cloudmonitoring2_beta2-cli";
        version = "1.0.12+20170501";
        edition = "2015";
        crateBin = [
          { name = "cloudmonitoring2-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20170501.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudmonitoring2_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
