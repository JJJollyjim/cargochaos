...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dsf/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "audio-duration" = rec {
        crateName = "audio-duration";
        version = "0.1.0";
        edition = "2018";
        sha256 = "129bbz9qp5bcngr9m9niv8yqahim94q84i23xdqiadd3igsh8vn2";
        authors = [
      ...
      "dsf" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dsf-metadata"; path = "src/bin/dsf-metadata.rs"; }
        ];
