...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rpassword/v4.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rpassword" = rec {
        ...
        version = "4.0.5";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v4.0.5.nix {};
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "minwindef" "processenv" "std" "winbase" "wincon" "winnt" ];
      };
