...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/buildkite-workflow/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alfred" = rec {
        ...
        version = "4.0.2";
        edition = "2015";
        sha256 = "033hacfaflgpww1535z22jf51xf6hk44s1j1cs667ci47n3hzrsm";
        authors = [
          "Lily Ballard <lily@sb.org>"
        ];
        dependencies = [
          {
            name = "serde_json";
      ...
      "buildkite-workflow" = rec {
        crateName = "buildkite-workflow";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "buildkite-workflow"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        libName = "buildkite_workflow_lib";
        authors = [
      ...
      "rusqlite" = rec {
        ...
        resolvedDefaultFeatures = [ "bundled" "chrono" ];
      };
      "rust-argon2" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
