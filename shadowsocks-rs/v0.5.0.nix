...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shadowsocks-rs/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shadowsocks-rs" = rec {
        crateName = "shadowsocks-rs";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "ssserver"; path = "src/bin/ssserver.rs"; }
          { name = "sslocal"; path = "src/bin/sslocal.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "processthreadsapi" "std" "synchapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
