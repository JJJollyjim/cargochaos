...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pcap_on_demand/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pcap_on_demand" = rec {
        ...
        resolvedDefaultFeatures = [ "clippy" "full" "futures" "mio" "pcap-fopen-offline-precision" "pcap-savefile-append" "tokio" "tokio-core" ];
      };
      "rand" = rec {
        crateName = "rand";
        version = "0.4.6";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwindef" "ntsecapi" "ntstatus" "objbase" "profileapi" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
