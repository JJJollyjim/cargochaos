...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/extrahop/v0.3.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "extrahop" = rec {
        ...
        resolvedDefaultFeatures = [ "derive_builder" "native-tls" "petgraph" "topology" ];
      };
      "fixedbitset" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default" "default-tls" "hyper-tls" "json" "native-tls" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rustversion" = rec {
