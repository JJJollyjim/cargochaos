...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/envoy-dummy-stats/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "envoy-dummy-stats" = rec {
        crateName = "envoy-dummy-stats";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "envoy-dummy-stats"; path = "src/main.rs"; }
        ];
      ...
      "gotham_derive" = rec {
        crateName = "gotham_derive";
        version = "0.4.0";
        edition = "2018";
        sha256 = "101l2s20m2br11xi4ybr4bjbqzi9k6qlip3ypgj7nb8b2amd41xj";
        procMacro = true;
        authors = [
          "Bradley Beddoes <bradleybeddoes@gmail.com>"
          "Colin Bankier"
      ...
      "rand_distr" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "08drhcw9k4a79pri3rd1vkv7v9cbm6cf4i342nai39f527c58zn3";
        authors = [
          "The Rand Project Developers"
        ];
        dependencies = [
