...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crisp-status-local/v1.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crisp-status-local" = rec {
        crateName = "crisp-status-local";
        version = "1.3.0";
        edition = "2015";
        crateBin = [
          { name = "crisp-status-local"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.3.0.nix {};
        authors = [
          "Valerian Saliou <valerian@crisp.chat>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "http_req" = rec {
        ...
        version = "0.5.5";
        edition = "2018";
        sha256 = "18v3s249slh6fa2v5d8ykj58v446i907b8dxqvck01nq5idnp6pg";
        authors = [
          "jayjamesjay"
        ];
        dependencies = [
