...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-resourceviews1_beta2-cli/v1.0.13+20160512.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-resourceviews1_beta2-cli";
  ...
  workspaceMembers = {
    "google-resourceviews1_beta2-cli" = rec {
      packageId = "google-resourceviews1_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-resourceviews1_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-resourceviews1_beta2" = rec {
        crateName = "google-resourceviews1_beta2";
        version = "1.0.13+20160512";
        edition = "2015";
        sha256 = "09anac3qbvfmcgmpngkqgipind882hwvmvdpz41yb0ing2iql2f9";
        authors = [
      ...
      "google-resourceviews1_beta2-cli" = rec {
        crateName = "google-resourceviews1_beta2-cli";
        version = "1.0.13+20160512";
        edition = "2015";
        crateBin = [
          { name = "resourceviews1-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20160512.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-resourceviews1_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
