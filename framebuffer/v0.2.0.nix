...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/framebuffer/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bmp" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "02cm075qpl3bk1s6111f52agbwahr9pczbila9gwwj1jj9dbp9ik";
        authors = [
          "Sondre Lefsaker"
        ];
        dependencies = [
      ...
      "byteorder" = rec {
        ...
        version = "0.3.13";
        edition = "2015";
        sha256 = "0xd1vzp1yzw9f9qpm7w3mp9kqxdxwrwzqs4d620n6m4g194smci9";
        authors = [
      ...
      "framebuffer" = rec {
        crateName = "framebuffer";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Roy van der Vegt <royvandervegt@gmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
