...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/beziercurve-wkt/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quadtree-f32" = rec {
        crateName = "quadtree-f32";
        version = "0.2.2";
        edition = "2018";
        sha256 = "1xh4rp767xbr7f5kcdzszdz1cs3gzfvxhy61qh5v64q93sqbylna";
        authors = [
          "Felix Schütt <felix.schuett@maps4print.com>"
        ];
