...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lc3asm/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lc3-rs" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0dn7gb6faab7v8lyw3y97wiy29x6bzlyahzlcn5i55035fb86alg";
        libName = "lc3";
        authors = [
      ...
      "lc3asm" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lc3asm"; path = "src/bin/lc3asm/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "binary-build" "structopt" ];
      };
      "lc3dbg" = rec {
        crateName = "lc3dbg";
        version = "1.2.2";
        edition = "2018";
        crateBin = [];
        sha256 = "06cch3b55qssba3m7213csgmvhjrqvh06mz3v8kv9k215zx9z8gk";
        authors = [
          "cr0sh <ska827@snu.ac.kr>"
        ];
        dependencies = [
