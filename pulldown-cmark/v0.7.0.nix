...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pulldown-cmark/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pulldown-cmark" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pulldown-cmark"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "gen-tests" "getopts" "simd" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.2";
