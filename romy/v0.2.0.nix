...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/romy/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mut_static" = rec {
        crateName = "mut_static";
        version = "5.0.0";
        edition = "2015";
        sha256 = "0rkg6d34kxsgzz206zn054f2gfsb38brlz54pcc3ckls73mxi314";
        authors = [
          "Tyler Wolf Leonhardt <tyler.wolf.leonhardt@gmail.com>"
        ];
        dependencies = [
          {
            name = "error-chain";
      ...
      "romy" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "romy"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "catt-io <catt-io@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "bincode";
          ...
          {
            name = "romy-engine";
            packageId = "romy-engine";
            optional = true;
          }
          {
            name = "romy-wasmer";
            packageId = "romy-wasmer";
            target = { target, features }: ((!(target."arch" == "wasm32")) && (!(target."os" == "ios")));
          }
          {
            name = "romy-window";
            packageId = "romy-window";
            target = { target, features }: (!(target."arch" == "wasm32"));
          }
          {
            name = "serde";
        ...
        resolvedDefaultFeatures = [ "default" "romy-engine" ];
      };
      "romy-core" = rec {
        crateName = "romy-core";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1hiblag31fb0bygr3v13xvv5i00pk6anrwlk31j5y78nyldl32zp";
        authors = [
          "catt-io <catt-io@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "romy-engine" = rec {
        crateName = "romy-engine";
        version = "0.2.0";
        edition = "2018";
        sha256 = "13g6zqgxqqgjdcnhxxi1xr3xik9zd6zjw6swq1vxvffqg8c1xlaq";
        authors = [
          "catt-io <catt-io@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "romy-wasmer" = rec {
        crateName = "romy-wasmer";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0cc13g2xppqn38mjxfcxqdkz6smr1rrkjakx3igw0lyvy8a7dsdw";
        authors = [
          "catt-io <catt-io@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "romy-window" = rec {
        crateName = "romy-window";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1cdqnpc12fk9jdfrwq9byiwn7l8m600aa7rjq15gr7mlgh2j7fia";
        authors = [
          "catt-io <catt-io@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "wasmer-clif-backend" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "01k0a3q62bbhzh63ax9j0y1lp1ilrxzhc8wyrc06xb8bd0l6spmg";
        authors = [
      ...
      "wasmer-runtime" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "0zwxna0k4snvnjh4b57217c5nxd2ajv5gqdjsjw6zflvxr3g5gqw";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
      ...
      "wasmer-runtime-core" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "12qm3b66y4mn326y44wa753pg5qimb81zrfbmf3kryba2q9qhkzb";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
      ...
      "wasmer-win-exception-handler" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "1npy5dl7jvbj3lil5p5j1zm9n8a6p1a0jph9357kh1njldnkjd1z";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
