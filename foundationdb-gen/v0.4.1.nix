...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/foundationdb-gen/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "foundationdb-gen" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "foundationdb-options-gen"; path = "src/bin/foundationdb-options-gen.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "embedded-fdb-include" "fdb-5_1" "fdb-5_2" "fdb-6_0" "fdb-6_1" "fdb-6_2" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.66";
