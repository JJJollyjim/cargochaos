...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rflex/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "liquid" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1il4yfcm63s22y38vi7jlwvqx7v12yh5d2ynjghvjfcpxgvbwz6y";
        authors = [
      ...
      "liquid-compiler" = rec {
        ...
        version = "0.17.1";
        edition = "2015";
        sha256 = "05zig7v1ins77cv961sjylp47nq6nmlsbxnycqw4yx2231ixa397";
        authors = [
          "Johann Hofmann <mail@johann-hofmann.com>"
        ];
        dependencies = [
      ...
      "liquid-error" = rec {
        ...
        version = "0.16.1";
        edition = "2015";
        sha256 = "0r69zg54jgkj599g8pcm8lf001kjfqxjy4bijck3hifd6lmxl5mw";
        authors = [
          "Johann Hofmann <mail@johann-hofmann.com>"
        ];
      ...
      "liquid-interpreter" = rec {
        ...
        version = "0.17.1";
        edition = "2015";
        sha256 = "02fs3w68lhmgd4i1cjadl94ppv5fy7dda1a06z4l9fs0bx378gxz";
        authors = [
          "Johann Hofmann <mail@johann-hofmann.com>"
        ];
        dependencies = [
      ...
      "liquid-value" = rec {
        ...
        version = "0.17.1";
        edition = "2015";
        sha256 = "00mbaki5dr4xvjawgqxhzfyfqkrx46ckswkg91jgl1j5lfqyf68z";
        authors = [
          "Johann Hofmann <mail@johann-hofmann.com>"
        ];
        dependencies = [
      ...
      "rflex" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rflex"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.6.0.nix {};
        authors = [
          "Shuzo Kashihara <kashihara@preferred.jp>"
        ];
        dependencies = [
          {
            name = "failure";
