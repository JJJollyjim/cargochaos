...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/emul8/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "emul8" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "emul8"; path = "src/bin/emul8.rs"; }
          { name = "disasm"; path = "src/bin/disasm.rs"; }
          { name = "compil8"; path = "src/bin/compil8.rs"; }
          { name = "asm"; path = "src/bin/asm.rs"; }
        ];
