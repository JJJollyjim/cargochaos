...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chrobry-cli/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chrobry-cli" = rec {
        crateName = "chrobry-cli";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "chrobry"; path = "src/main.rs"; }
        ];
      ...
      "chrobry-core" = rec {
        crateName = "chrobry-core";
        version = "1.0.0";
        edition = "2018";
        sha256 = "17whmvvwk2ckqjykagrw3s3hcsyi1rg2byvj17nbfq8p0gmiz6b4";
        authors = [
          "Patryk 'PsichiX' Budzynski <psichix@gmail.com>"
        ];
        dependencies = [
