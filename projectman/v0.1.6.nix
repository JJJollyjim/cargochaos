...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/projectman/v0.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "projectman" = rec {
        crateName = "projectman";
        version = "0.1.6";
        edition = "2018";
        crateBin = [
          { name = "pm"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.6.nix {};
        authors = [
          "hskang9 <hskang9@gmail.com>"
        ];
        dependencies = [
          {
            name = "colored";
