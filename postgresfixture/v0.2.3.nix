...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/postgresfixture/v0.2.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "postgresfixture" = rec {
        crateName = "postgresfixture";
        version = "0.2.3";
        edition = "2018";
        crateBin = [
          { name = "postgresfixture"; path = "src/main.rs"; }
        ];
