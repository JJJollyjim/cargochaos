...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rerast/v0.1.90.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rerast" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-rerast"; path = "src/bin/cargo-rerast.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.90.nix {};
        authors = [
      ...
      "rerast_macros" = rec {
        crateName = "rerast_macros";
        version = "0.1.12";
        edition = "2015";
        sha256 = "1zf54g1ys1vwlm3kx3hv14wwj7nsb5rz93fcndyax97rvh4gqyvz";
        authors = [
