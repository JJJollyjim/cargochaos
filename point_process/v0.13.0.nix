...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/point_process/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "plotters" = rec {
        ...
        version = "0.2.5";
        edition = "2018";
        sha256 = "0y27kjp4q7pa67843580w9yjxk4jpllrkray5clkjp4mbj7gj20k";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bitmap" "chrono" "default" "image" "num-traits" "palette" "palette_ext" "svg" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.14.1";
      ...
      "point_process" = rec {
        crateName = "point_process";
        version = "0.13.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.13.0.nix {};
        libName = "pointprocesses";
        authors = [
          "ManifoldFR <manifoldfr@outlook.com>"
        ];
        dependencies = [
          {
            name = "ndarray";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "minwinbase" "minwindef" "ntdef" "profileapi" "std" "sysinfoapi" "timezoneapi" "wingdi" "winuser" ];
      };
