...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cyclonedx-bom/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cyclonedx-bom" = rec {
        crateName = "cyclonedx-bom";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cyclonedx-bom"; path = "src/main.rs"; }
        ];
      ...
      "packageurl" = rec {
        crateName = "packageurl";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0hqbq52wibmvc2w75534vizjq8l7pkphwylz7w0lvpwf9fa5hzsk";
        authors = [
      ...
      "xml_writer" = rec {
        crateName = "xml_writer";
        version = "0.4.0";
        edition = "2015";
        sha256 = "13i5lf7szkplxjjlmwy1dzyr2fr88vfw8s4nkvw9ja9rv13shx1s";
        authors = [
