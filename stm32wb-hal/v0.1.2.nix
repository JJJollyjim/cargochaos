...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32wb-hal/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32-device-signature" = rec {
        crateName = "stm32-device-signature";
        version = "0.3.0";
        edition = "2018";
        sha256 = "05d6sw8vkylqpyhiy0k3nshp45sfwyasl26fmjcnlbkbdcc4hp3w";
        authors = [
        ...
        resolvedDefaultFeatures = [ "stm32wb5x" ];
      };
      "stm32-usbd" = rec {
      ...
      "stm32wb-hal" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "stm32-device-signature";
            features = [ "stm32wb5x" ];
          }
          {
            name = "stm32-usbd";
        ...
        resolvedDefaultFeatures = [ "default" "rt" "stm32-usbd" "xC-package" "xE-package" "xG-package" ];
      };
      "stm32wb-pac" = rec {
        crateName = "stm32wb-pac";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1jwsf5dvg88gf49fg12iss4w3yj9cg9zai3pd5j6gnm3l6pqj5g2";
        authors = [
