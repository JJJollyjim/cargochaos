...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imgui-rs-vulkan-renderer/v0.3.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "imgui-rs-vulkan-renderer";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgui-rs-vulkan-renderer" = rec {
        crateName = "imgui-rs-vulkan-renderer";
        version = "0.3.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Adrien Bennadji <adrien.bennadji@live.fr>"
        ];
        dependencies = [
          {
            name = "ash";
      ...
      "imgui-winit-support" = rec {
        ...
        resolvedDefaultFeatures = [ "winit-19" ];
      };
      "lazy_static" = rec {
