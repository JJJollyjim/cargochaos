...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fake-temp-openmw-package/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "fake-temp-openmw-package";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "esplugin" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "0w4b2ljgk0cfgp8hhjjn0r7kf328hs2mqlal28avpiry98kgbdiq";
        authors = [
      ...
      "fake-temp-openmw-package" = rec {
        crateName = "fake-temp-openmw-package";
        version = "0.2.0";
        edition = "2015";
        crateBin = [
          { name = "fake-temp-openmw-package"; path = "src/main.rs"; }
        ];
