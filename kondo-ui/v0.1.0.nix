...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kondo-ui/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kondo-lib" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "08190b20ycyaks3akgnm45xz3sykzcr35xjj9028wfmfl9yla4xz";
        authors = [
          "Trent Billington <trent.h.billington@gmail.com>"
        ];
        dependencies = [
          {
            name = "walkdir";
      ...
      "kondo-ui" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "kondo-ui"; path = "src/main.rs"; }
        ];
