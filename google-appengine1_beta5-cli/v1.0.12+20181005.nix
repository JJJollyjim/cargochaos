...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-appengine1_beta5-cli/v1.0.12+20181005.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-appengine1_beta5-cli";
  ...
  workspaceMembers = {
    "google-appengine1_beta5-cli" = rec {
      packageId = "google-appengine1_beta5-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-appengine1_beta5-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-appengine1_beta5" = rec {
        crateName = "google-appengine1_beta5";
        version = "1.0.12+20181005";
        edition = "2015";
        sha256 = "1l1gnalf3l1a50gxd245rw3w82jdzcp18mibyf8j3m9487b7qzfr";
        authors = [
      ...
      "google-appengine1_beta5-cli" = rec {
        crateName = "google-appengine1_beta5-cli";
        version = "1.0.12+20181005";
        edition = "2015";
        crateBin = [
          { name = "appengine1-beta5"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20181005.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-appengine1_beta5";
          }
          {
            name = "hyper";
            packageId = "hyper";
