...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-appengine1_beta5-cli/v1.0.13+20181005.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-appengine1_beta5" = rec {
        ...
        edition = "2015";
        sha256 = "12fdi57x8k1iii7243p7z6s064qryr8zxbgiy8abvsr2qj4rc6iv";
        authors = [
      ...
      "google-appengine1_beta5-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20181005.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
