...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rendology/v0.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coarse-prof" = rec {
        crateName = "coarse-prof";
        version = "0.2.3";
        edition = "2018";
        sha256 = "1cdyzldvrykdm59r2bwhjab4vrlzi3w7q83rmsv6idlsj326y7x8";
        authors = [
      ...
      "glsl" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "0091m10pga38c3d55jg7ib9q3lb7rpm3hsmnp230id783lzhdi1q";
        authors = [
      ...
      "obj" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "1p550ws511h9qic01ppn1p3kgzwyhd2gd1rnrb2z17hgc8yv9bxh";
        authors = [
          "Coraline Sherratt <cora.sherratt@gmail.com>"
          "Dzmitry Malyshau <kvarkus@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "genmesh" ];
      };
      "objc" = rec {
        crateName = "objc";
        version = "0.2.7";
