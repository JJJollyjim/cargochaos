...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/conserve/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blake2-rfc" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "simd" "simd_asm" "simd_opt" "std" ];
      };
      "bstr" = rec {
        crateName = "bstr";
        version = "0.2.10";
      ...
      "conserve" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "conserve"; path = "src/bin/conserve.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "blake2_simd_asm" ];
      };
      ...
      "snafu" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "backtraces" "default" "std" ];
      };
      "snafu-derive" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
