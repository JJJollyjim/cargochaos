...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spoterm/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "spoterm" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "spoterm"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Hitoshi Togasaki <hitoshi@soundhound.com>"
        ];
        dependencies = [
          {
            name = "crossbeam";
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
