...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudresourcemanager1_beta1-cli/v1.0.13+20200408.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudresourcemanager1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "0lv17kbddnqpicr3ydg17nh65p1z1inzs6ad1bil79frfvsik0ck";
        authors = [
      ...
      "google-cloudresourcemanager1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200408.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
