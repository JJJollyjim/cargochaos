...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudresourcemanager1_beta1-cli/v1.0.12+20190701.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudresourcemanager1_beta1-cli";
  ...
  workspaceMembers = {
    "google-cloudresourcemanager1_beta1-cli" = rec {
      packageId = "google-cloudresourcemanager1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudresourcemanager1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudresourcemanager1_beta1" = rec {
        crateName = "google-cloudresourcemanager1_beta1";
        version = "1.0.12+20190701";
        edition = "2015";
        sha256 = "0whd1syxqm4zfd19l7766vinb2cz0jngrjbjl7hi5a90xs4nvgbc";
        authors = [
      ...
      "google-cloudresourcemanager1_beta1-cli" = rec {
        crateName = "google-cloudresourcemanager1_beta1-cli";
        version = "1.0.12+20190701";
        edition = "2015";
        crateBin = [
          { name = "cloudresourcemanager1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190701.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudresourcemanager1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
