...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wcolor/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wcolor" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "winuser" "stringapiset" "winnls" "impl-default" "dcomp" "d2d1" "d2d1_2" "d3d11" "dxgi1_2" "dxgi1_3" ];
          }
          {
            name = "wio";
            packageId = "wio";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "d2d1" "d2d1_2" "d3d11" "dcomp" "dxgi1_2" "dxgi1_3" "errhandlingapi" "fileapi" "handleapi" "impl-default" "minwinbase" "minwindef" "processenv" "processthreadsapi" "std" "stringapiset" "unknwnbase" "winbase" "wincon" "winnls" "winnt" "winuser" ];
      };
