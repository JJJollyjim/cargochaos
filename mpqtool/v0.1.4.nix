...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mpqtool/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ceres-mpq" = rec {
        ...
        version = "0.1.8";
        edition = "2018";
        sha256 = "01f12s2dqkcxa75j3103fva6qp0niwjcamy9pg6rwlspfa07hsri";
        authors = [
          "ElusiveMori <mori@reu.moe>"
        ];
        dependencies = [
          {
      ...
      "err-derive 0.2.2" = rec {
        ...
        dependencies = [
          {
            name = "proc-macro-error";
            packageId = "proc-macro-error 0.4.9";
          }
          {
            name = "proc-macro2";
            packageId = "proc-macro2";
