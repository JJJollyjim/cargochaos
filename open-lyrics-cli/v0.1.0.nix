...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/open-lyrics-cli/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "open-lyrics-cli" = rec {
        crateName = "open-lyrics-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "open-lyrics-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Benjamin-Davies <bentendavies@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
