...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tw2s/v1.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lazy-static-include" = rec {
        ...
        version = "1.2.0";
        edition = "2015";
        sha256 = "06spnp7q3kik5vx79pr193m5dv5ldw97gc329nm2nzksnwn2smm1";
        authors = [
      ...
      "opencc-rust" = rec {
        crateName = "opencc-rust";
        version = "1.0.7";
        edition = "2015";
        sha256 = "1xqk9s820j4viz1fg6f3zlqrx06ilrkvwb01iq1p2b8alcfs6ag7";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "lazy-static-include" "lazy_static" "static-dictionaries" ];
      };
      "path-absolutize" = rec {
        crateName = "path-absolutize";
        version = "1.1.3";
        edition = "2015";
        sha256 = "0hka5y5ink585j667c9qs965iicd046vya03680bmj8xrx9w71ky";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "path-dedot" = rec {
        ...
        version = "1.1.6";
        edition = "2015";
        sha256 = "0iqbk0nxl5qqwimrg81zzcr553fc4c1whzrkrvssrm8zkhpqav3x";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
