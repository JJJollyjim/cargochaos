...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cloudflare-soos/v1.18.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cloudflare-soos" = rec {
        crateName = "cloudflare-soos";
        version = "1.18.0";
        edition = "2018";
        crateBin = [
          { name = "soos-cf-priority"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.18.0.nix {};
        authors = [
          "Kornel Lesiński <kornel@cloudflare.com>"
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "memoryapi" "synchapi" "winbase" ];
      };
