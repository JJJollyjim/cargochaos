...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bisect-rustc/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-bisect-rustc" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "cargo-bisect-rustc"; path = "src/main.rs"; }
        ];
