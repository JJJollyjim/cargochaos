...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-youtubereporting1-cli/v1.0.13+20200405.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-youtubereporting1-cli";
  ...
  workspaceMembers = {
    "google-youtubereporting1-cli" = rec {
      packageId = "google-youtubereporting1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-youtubereporting1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-youtubereporting1" = rec {
        crateName = "google-youtubereporting1";
        version = "1.0.13+20200405";
        edition = "2015";
        sha256 = "1l03b4q0lijrgw7c0pg7bsns9xnmp9m2wh9icb75w83i6mmzg9ig";
        authors = [
      ...
      "google-youtubereporting1-cli" = rec {
        crateName = "google-youtubereporting1-cli";
        version = "1.0.13+20200405";
        edition = "2015";
        crateBin = [
          { name = "youtubereporting1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-youtubereporting1";
          }
          {
            name = "hyper";
            packageId = "hyper";
