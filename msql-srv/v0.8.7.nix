...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/msql-srv/v0.8.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "msql-srv" = rec {
        ...
        version = "0.8.7";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.8.7.nix {};
        authors = [
      ...
      "mysql_async" = rec {
        crateName = "mysql_async";
        version = "0.20.0";
        edition = "2018";
        sha256 = "1qhazw930wvcrq8ds74m7dclvwfajzhn81xggsz73zs5dq2h0sbn";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
