...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/randomx4r/v0.2.0.nix.tmp"
    ...
    crates = {
      ...
      "randomx4r" = rec {
        ...
        dependencies = [
          ...
          {
            name = "randomx4r-sys";
            packageId = "randomx4r-sys";
          }
        ];
        
      };
      "randomx4r-sys" = rec {
        crateName = "randomx4r-sys";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1ib3lbmpwhr7chfanb2pyy11c1yqzainzm6vd320ri0ksplzpbqz";
        authors = [
          "Matt Smith <matt@offtopica.uk>"
        ];
        buildDependencies = [
