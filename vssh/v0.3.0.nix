...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vssh/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "leg" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1ciijj2vq1gd4cyk5ywxvqi5b8b2r074nf6646i7h2c0119s5ns9";
        authors = [
      ...
      "vssh" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "vssh"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Alex Krantz <alex@alexkrantz.com>"
        ];
        dependencies = [
          {
            name = "dirs";
