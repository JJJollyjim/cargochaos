...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/verco/v4.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "verco" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "verco"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v4.10.0.nix {};
        authors = [
          "Matheus Lessa <matheuslessarodrigues@gmail.com>"
        ];
        dependencies = [
          {
            name = "crossterm";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-default" "knownfolders" "minwindef" "ntstatus" "objbase" "processenv" "shlobj" "synchapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
