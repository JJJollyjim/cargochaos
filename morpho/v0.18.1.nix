...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/morpho/v0.18.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "civet" = rec {
        ...
        edition = "2015";
        sha256 = "1793cba49s6c6vswj04vl1s257hq1bcxj831mkgn2ffhinjf2q7k";
        authors = [
          "wycats"
        ];
        dependencies = [
      ...
      "civet-sys" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0djr5hvm0wdd7b3w21z5886kp16x6szx9q9mrf1pk2zj5cvib3cm";
        libName = "civet_sys";
        libPath = "lib.rs";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
      ...
      "conduit" = rec {
        ...
        edition = "2018";
        sha256 = "04p4vsi22qhh9z99k8l2gwlmwfhnm74wfgkmxmp34dz38vfjwhs7";
        authors = [
          "wycats@gmail.com"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
