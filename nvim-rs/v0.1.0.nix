...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nvim-rs/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rmpv" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "0nyz89wknb7i9821cj4d8ra4psq4q01xwim5955rzxcb3c9r4izz";
        authors = [
          "Evgeny Safronov <division494@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "fs" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "num_cpus" "process" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "sync" "tcp" "tokio-macros" "uds" "winapi" ];
      };
      "tokio-macros" = rec {
