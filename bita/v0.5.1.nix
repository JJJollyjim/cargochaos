...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bita/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bita" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "lzma-compression" "rustls-tls" "zstd-compression" ];
      };
      "bitar" = rec {
        crateName = "bitar";
        version = "0.5.1";
        edition = "2018";
        sha256 = "1m7z452k6z6afgzl8qwkcwywlf2l0mj8k42i712ry4pqybgccpwi";
        authors = [
          "Olle Sandberg <olle@b3rg.se>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "lzma-compression" "rust-lzma" "rustls-tls" "zstd" "zstd-compression" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default" "default-tls" "hyper-rustls" "hyper-tls" "native-tls-crate" "rustls" "rustls-tls" "stream" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.11";
