...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bita/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitar" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1rpmnayzb12dcax041af9x5nq0igplzrqkka83myznc1dh1c7z57";
        authors = [
          "Olle Sandberg <olle@b3rg.se>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
