...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bita/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bita" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "io-std" "sync" "io-util" "macros" "time" "rt-threaded" ];
          }
          {
            name = "zstd";
            packageId = "zstd";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-std" "io-util" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
