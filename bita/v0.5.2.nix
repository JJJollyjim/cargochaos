...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bita/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bita" = rec {
        ...
        features = {
          "default" = [ "default-tls" ];
          "default-tls" = [ "bitar/default-tls" ];
          "lzma-compression" = [ "bitar/lzma-compression" ];
          "rustls-tls" = [ "bitar/rustls-tls" ];
          "zstd-compression" = [ "bitar/zstd-compression" ];
        };
        resolvedDefaultFeatures = [ "default" "default-tls" "lzma-compression" "rustls-tls" "zstd-compression" ];
      };
      "bitar" = rec {
        crateName = "bitar";
        version = "0.5.2";
        edition = "2018";
        sha256 = "189zahpaz38axcyxhir61vkkqrx1q7ijphlwin1vyf7i5hgv2li3";
        authors = [
          "Olle Sandberg <olle@b3rg.se>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default-tls" "lzma-compression" "rust-lzma" "rustls-tls" "zstd" "zstd-compression" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default-tls" "hyper-rustls" "hyper-tls" "native-tls-crate" "rustls" "rustls-tls" "stream" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.11";
      ...
      "rust-lzma" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "1njlmh9hq2qg5ssdangwbdkz1lrfj2brf8kfp65k7vmfmr6w0pc9";
        libName = "lzma";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
