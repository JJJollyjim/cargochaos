...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rnix-lsp/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nixpkgs-fmt" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1ps2yxcpry4iahxm44dsm6992z8l8iif5l391bxy8g69gm19z0q1";
        authors = [
      ...
      "rnix-lsp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rnix-lsp"; path = "src/main.rs"; }
        ];
      ...
      "text_unit" = rec {
        ...
        version = "0.1.9";
        edition = "2015";
        sha256 = "0y95lhkmw8gjdg9p47iixa6kvbdxafv0c4j34gms1gddlfvvr2z0";
        authors = [
          "Aleksey Kladov <aleksey.kladov@gmail.com>"
        ];
        dependencies = [
