...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aws-sigv4/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eliza_error" = rec {
        crateName = "eliza_error";
        version = "0.99.1";
        edition = "2018";
        sha256 = "0cbw4fxsncdxrwvwdcazr3w5cpji446szq3q65y6xqkjl7c3f47s";
        authors = [
          "Eliza Error Contributors <eliza@elizas.website>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
