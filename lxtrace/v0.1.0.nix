...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lxtrace/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "foreign-types-macros" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0x71sdffjfb123l2jn5vhz0ni09b4rdq3h3gpczd1dj1g5qlr2yv";
        procMacro = true;
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
      ...
      "foreign-types-shared" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0mg85r21bxg2i97zl3q8l3cviqz4wcbwziz875wlja3zpcrwz13n";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
      ...
      "lxtrace" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lxtrace"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Mikail Bagishov <bagishov.mikail@yandex.ru>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "rstack" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0x6pscpxgvpyn974r29d4qdiz03jm6hiv62an8805pb4dlrrvp45";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "unwind" "unwind_" ];
      };
      "rustc-demangle" = rec {
      ...
      "tiny-nix-ipc" = rec {
        crateName = "tiny-nix-ipc";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1vn0iknrrm09pp57rmjy7al87a8y1di154x95367k26lvgizajlc";
        authors = [
        ...
        resolvedDefaultFeatures = [ "ser_json" "serde" "serde_json" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
      ...
      "unwind" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1jkrinm4jl9nsbzm45rcalx7fiakq47jl7nzxjjbi9jjf4vlqy49";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "unwind-sys";
            packageId = "unwind-sys";
          }
        ];
        features = {
          "ptrace" = [ "unwind-sys/ptrace" ];
        };
        resolvedDefaultFeatures = [ "ptrace" ];
      };
      "unwind-sys" = rec {
        crateName = "unwind-sys";
        version = "0.1.1";
        edition = "2015";
        sha256 = "0zq50v94raqvxzbpjsb6ar8cj4d2zak4q78v9n97407y3inll75x";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
