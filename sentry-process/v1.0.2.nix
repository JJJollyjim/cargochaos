...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sentry-process/v1.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sentry" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "hostname" "httpdate" "im" "libc" "rand" "regex" "reqwest" "rustc_version" "uname" "url" "with_backtrace" "with_client_implementation" "with_default_transport" "with_device_info" "with_native_tls" "with_reqwest_transport" "with_rust_info" ];
      };
      "sentry-process" = rec {
        crateName = "sentry-process";
        version = "1.0.2";
        edition = "2018";
        crateBin = [
          { name = "sentry-process"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          {
            ...
            packageId = "sentry";
            usesDefaultFeatures = false;
            features = [ "with_client_implementation" "with_default_transport" "with_device_info" "with_rust_info" ];
          }
        ];
