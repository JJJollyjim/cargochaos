...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdrend-test-dont-use/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mdrend-test-dont-use";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdrend-test-dont-use" = rec {
        crateName = "mdrend-test-dont-use";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mdrend-test-dont-use"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Stii <stii.pretorius@takealot.com>"
        ];
        dependencies = [
          {
            name = "clap";
