...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-aws-lambda/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-aws-lambda" = rec {
        crateName = "cargo-aws-lambda";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "cargo-aws-lambda"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Vesa Vilhonen <vesa@vilhonen.com>"
        ];
        dependencies = [
          {
            name = "bytes";
      ...
      "rusoto_lambda" = rec {
        crateName = "rusoto_lambda";
        version = "0.40.0";
        edition = "2018";
        sha256 = "0q5iagyk6cxigrk03wlc93h996ybgq7ygiw1nflpsrxwn4ayx9yd";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
