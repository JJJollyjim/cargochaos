...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amaurymartiny-async-smtp/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "amaurymartiny-async-smtp";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amaurymartiny-async-smtp" = rec {
        crateName = "amaurymartiny-async-smtp";
        version = "0.1.0";
        edition = "2018";
      ...
      "async-native-tls" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "default" "runtime-async-std" "vendored" ];
      };
      "async-std" = rec {
        crateName = "async-std";
        version = "1.5.0";
      ...
      "fast-socks5" = rec {
        crateName = "fast-socks5";
        version = "0.3.1";
        edition = "2018";
        sha256 = "1vaqmfars1ss3iml7s8nxg3syl9va0dq5ifb51z97x8pqx040hl3";
        authors = [
