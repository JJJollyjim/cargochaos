...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/viperus/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "viperus" = rec {
        ...
        authors = [
          "mauro cordioli <coma@cordioli.it>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "cache" "clap" "default" "dotenv" "fmt-clap" "fmt-env" "fmt-javaproperties" "fmt-json" "fmt-toml" "fmt-yaml" "global" "java-properties" "lazy_static" "notify" "serde" "serde_json" "serde_yaml" "toml" "watch" ];
      };
      "walkdir" = rec {
        crateName = "walkdir";
        version = "2.3.1";
