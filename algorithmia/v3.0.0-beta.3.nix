...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/algorithmia/v3.0.0-beta.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "algorithmia" = rec {
        crateName = "algorithmia";
        version = "3.0.0-beta.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v3.0.0-beta.3.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "default-tls" "handler" "reqwest" "rust-tls" ];
      };
      "anyhow" = rec {
        crateName = "anyhow";
        version = "1.0.26";
