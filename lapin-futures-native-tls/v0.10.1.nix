...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lapin-futures-native-tls/v0.10.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lapin-futures-native-tls";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin-futures-native-tls" = rec {
        crateName = "lapin-futures-native-tls";
        version = "0.10.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.10.1.nix {};
        libName = "lapin_futures_native_tls";
        authors = [
          "Marc-Antoine Perennou <%arc-Antoine@Perennou.com>"
        ];
        dependencies = [
      ...
      "lapin-futures-tls-internal" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-native-tls" ];
      };
      "lazy_static" = rec {
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-native-tls" "dns-over-tls" "tokio" "trust-dns-native-tls" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
