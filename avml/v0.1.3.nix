...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/avml/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "avml" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "avml"; path = "src/bin/avml.rs"; }
          { name = "avml-convert"; path = "src/bin/avml-convert.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "azure" "azure_sdk_core" "azure_sdk_storage_core" "blobstore" "default" "put" "reqwest" "retry" "tokio-core" "url" ];
      };
      "azure_sdk_core" = rec {
      ...
      "azure_sdk_storage_blob" = rec {
        ...
        version = "0.23.1";
        edition = "2018";
        sha256 = "0hk1cm8i95xdm8aqlwpzcgjzzq50svw5gicwlyk4ipk5q2yfmcdy";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
      ...
      "retry" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0a2hpb2w83ap71y075r1jh9anmb51wbv93b00x5slc9q3frq7b68";
        authors = [
