...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eventsource/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "10q9sy4cvv5fnz8921mna8i6r5lap52zyzy5jm6nd3ibwaacxwlr";
        authors = [
        ...
        dependencies = [
          {
            ...
            optional = true;
            target = { target, features }: (target."unix" && (!(target."os" == "emscripten")) && (!(target."os" == "macos")) && (!(target."os" == "ios")));
          }
          {
            name = "cfg-if";
            packageId = "cfg-if";
        ...
        resolvedDefaultFeatures = [ "backtrace-sys" "coresymbolication" "dbghelp" "dbghelp-sys" "default" "dladdr" "kernel32-sys" "libbacktrace" "libunwind" "winapi" ];
      };
      "backtrace-sys" = rec {
      ...
      "cc" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1bgg57zbn49bili9x74kd6pchchwrdd07sl4a48d9nz3f044yrrc";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        features = {
      ...
      "serde" = rec {
        ...
        version = "1.0.16";
        edition = "2015";
        sha256 = "02b8wb0hlhsv3628h1dh8bpywr8xzdsj189ff5r6akjdjqgn66p1";
        authors = [
      ...
      "url 1.7.2" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "percent-encoding 1.0.0";
          }
        ];
        features = {
          "heap_size" = [ "heapsize" ];
