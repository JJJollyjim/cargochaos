...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook/v0.3.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "handlebars" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "01nq3bfw0vdha3hygzh00i4gchh96z6ciyhfz0xzvkb8xzvmkf8b";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "shellapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
