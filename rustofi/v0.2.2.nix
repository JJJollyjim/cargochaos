...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustofi/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustofi" = rec {
        ...
        authors = [
          "Kristopher Ruzic <krruzic@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-derive";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "namedpipeapi" "processenv" "processthreadsapi" "std" "synchapi" "winbase" "winerror" ];
      };
