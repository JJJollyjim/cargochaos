...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyeong/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyeong" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "hyeong"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "buttercrab <jaeyong0201@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "clap" "ctrlc" "default" "number" "termcolor" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.68";
