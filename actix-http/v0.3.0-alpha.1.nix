...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v0.3.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "ring" "rust-tls" "secure-cookies" "tokio-openssl" "webpki-roots" ];
      };
      "actix-rt" = rec {
        crateName = "actix-rt";
        version = "1.0.0-alpha.1";
