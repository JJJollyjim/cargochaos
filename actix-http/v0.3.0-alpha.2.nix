...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v0.3.0-alpha.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-http 0.3.0-alpha.2";
  ...
  internal = rec {
    ...
    crates = {
      "actix-codec" = rec {
        ...
        edition = "2018";
        sha256 = "1rsf8cfsbg14109gvgwa06y59j6yfgdgmmhf7idgv331xjgf7khc";
        libName = "actix_codec";
        authors = [
      ...
      "actix-connect" = rec {
        ...
        edition = "2018";
        sha256 = "1hyybs2j4r1zy38ldx404r7r4vm8hndl00ln7g2c9ykcsq68q6n9";
        ...
        dependencies = [
          ...
          {
            name = "actix-utils";
            packageId = "actix-utils 1.0.0-alpha.2";
          }
          {
            name = "derive_more";
      ...
      "actix-http 0.3.0-alpha.1" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "flate2" "flate2-zlib" "open-ssl" "openssl" "tokio-openssl" ];
      };
      "actix-http 0.3.0-alpha.2" = rec {
        crateName = "actix-http";
        version = "0.3.0-alpha.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0-alpha.2.nix {};
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "actix-threadpool";
            packageId = "actix-threadpool 0.3.0";
          }
          {
            name = "actix-tls";
            packageId = "actix-tls";
        ...
        devDependencies = [
          ...
          {
            name = "actix-server";
            packageId = "actix-server 1.0.0-alpha.2";
          }
          {
            name = "actix-tls";
            packageId = "actix-tls";
        ...
        resolvedDefaultFeatures = [ "actix-tls" "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "ring" "secure-cookies" "tokio-openssl" ];
      };
      "actix-http-test" = rec {
        ...
        dependencies = [
          ...
          {
            name = "actix-server";
            packageId = "actix-server 0.8.0-alpha.1";
          }
          {
            name = "actix-server-config";
            packageId = "actix-server-config";
        ...
        resolvedDefaultFeatures = [ "default" "open-ssl" "openssl" ];
      };
      "actix-macros" = rec {
        crateName = "actix-macros";
        version = "0.1.0-alpha.1";
        edition = "2018";
        sha256 = "0v8nv9aqc6c3r587p0lhlkbampw591cyv1snl4g4xsavfsmbjphp";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-rt" = rec {
        ...
        version = "1.0.0-alpha.2";
        edition = "2018";
        sha256 = "0wlxwvldrlbz4df73y66kjs7w7l17xrlvsyrvb90qfgf3v69cd70";
        libName = "actix_rt";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-current-thread" "tcp" "uds" "udp" "timer" "signal" ];
          }
          {
            name = "tokio-executor";
            packageId = "tokio-executor";
      ...
      "actix-server 0.8.0-alpha.1" = rec {
      ...
      "actix-server 1.0.0-alpha.2" = rec {
        crateName = "actix-server";
        version = "1.0.0-alpha.2";
        edition = "2018";
        sha256 = "1sf7x0sj53ybx6zyzzy51rpsr1w6129bvyjnsv2qkr16wy7pckd4";
        libName = "actix_server";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-service" = rec {
        ...
        version = "1.0.0-alpha.2";
        edition = "2018";
        sha256 = "1vwzncmj3r366a17bx22f0mf46mal27jfpsb8j9vja1rfq4731wx";
      ...
      "actix-tls" = rec {
        ...
        edition = "2018";
        sha256 = "1dgq5jaml99wxapb6whzpap7mm62fdd6xbadx92acgidsn81ld11";
        libName = "actix_tls";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-utils 1.0.0-alpha.2" = rec {
        crateName = "actix-utils";
        version = "1.0.0-alpha.2";
        edition = "2018";
        sha256 = "1syg7cinq9ccippdps7q2702j93vs76hmvx5fl8ad2gwf7ar6n7j";
        libName = "actix_utils";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "awc" = rec {
        ...
        dependencies = [
          ...
          {
            name = "actix-http";
            packageId = "actix-http 0.3.0-alpha.1";
          }
          {
            name = "actix-service";
            packageId = "actix-service";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "codec" "default" "fs" "io" "macros" "net" "num_cpus" "rt-current-thread" "rt-full" "signal" "sync" "tcp" "timer" "tokio-codec" "tokio-executor" "tokio-fs" "tokio-io" "tokio-macros" "tokio-net" "tokio-sync" "tokio-timer" "tracing-core" "udp" "uds" ];
      };
      "tokio-codec" = rec {
