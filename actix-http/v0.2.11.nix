...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v0.2.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http 0.2.10" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "flate2" "flate2-zlib" "openssl" "ssl" ];
      };
      ...
      "actix-server" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "rust-tls" "rustls" "ssl" "tokio-openssl" "tokio-rustls" "webpki" "webpki-roots" ];
      };
      "actix-server-config" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rust-tls" "rustls" "ssl" "tokio-openssl" "tokio-rustls" ];
      };
      "actix-service" = rec {
      ...
      "awc" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "default" "flate2-zlib" "openssl" "ssl" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
