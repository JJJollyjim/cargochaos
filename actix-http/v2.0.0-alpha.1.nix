...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v2.0.0-alpha.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-http 2.0.0-alpha.1";
  ...
  internal = rec {
    ...
    crates = {
      "actix" = rec {
        ...
        edition = "2018";
        sha256 = "0hdd7421rphnm4i66rypn64dwa8q4g6wyvg93ax7mw2rhvm1qypj";
        authors = [
