...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v2.0.0-alpha.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-http 2.0.0-alpha.2";
  ...
  internal = rec {
    ...
    crates = {
      "actix" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "trust-dns-proto 0.19.3";
            optional = true;
            usesDefaultFeatures = false;
          ...
          }
          {
            ...
            packageId = "trust-dns-resolver 0.19.3";
            optional = true;
            usesDefaultFeatures = false;
      ...
      "actix-connect 2.0.0-alpha.1" = rec {
        crateName = "actix-connect";
        version = "2.0.0-alpha.1";
        edition = "2018";
        sha256 = "002jhaaxi685nxs1x18pp5pj97hg2j5i95wry339ljrvlnlq7lwk";
        libName = "actix_connect";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-http 1.0.1" = rec {
        ...
        resolvedDefaultFeatures = [ "actix-tls" "brotli2" "compress" "default" "flate2" "openssl" ];
      };
      "actix-http 2.0.0-alpha.2" = rec {
        crateName = "actix-http";
        ...
        dependencies = [
          ...
          {
            name = "actix-connect";
            packageId = "actix-connect 2.0.0-alpha.1";
          }
          {
            name = "actix-rt";
            packageId = "actix-rt";
          ...
          {
            name = "actix-tls";
            packageId = "actix-tls 2.0.0-alpha.1";
            optional = true;
          }
          {
            name = "actix-utils";
        ...
        resolvedDefaultFeatures = [ "actix" "actix-tls" "actors" "brotli2" "compress" "default" "fail-ure" "failure" "flate2" "openssl" "ring" "rustls" "secure-cookies" ];
      };
      "actix-http-test" = rec {
