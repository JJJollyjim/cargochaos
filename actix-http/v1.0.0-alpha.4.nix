...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v1.0.0-alpha.4.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-http 1.0.0-alpha.4";
  ...
  internal = rec {
    ...
    crates = {
      "actix-codec" = rec {
        ...
        edition = "2018";
        sha256 = "1binfryawigxz7kghzbfcibk0gwz2m5103y6clsl9p2idyhwm9r1";
        libName = "actix_codec";
        authors = [
      ...
      "actix-http 1.0.0-alpha.3" = rec {
        crateName = "actix-http";
        version = "1.0.0-alpha.3";
        edition = "2018";
        sha256 = "0207wnsgrg2mchq5f6zah4gl135bqfxy849yn7mvcxf216d0nbvs";
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "actix-tls" "brotli" "brotli2" "default" "flate2" "flate2-zlib" "openssl" ];
      };
      "actix-http 1.0.0-alpha.4" = rec {
        crateName = "actix-http";
        version = "1.0.0-alpha.4";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0-alpha.4.nix {};
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "actix-tls" "default" "fail" "failure" "flate2" "flate2-rust" "flate2-zlib" "openssl" "ring" "rustls" "secure-cookies" ];
      };
      "actix-http-test" = rec {
        crateName = "actix-http-test";
        version = "1.0.0-alpha.3";
        edition = "2018";
        sha256 = "1f8ssv3bl6r2pv6hrjccwsghnbxclyl57xwrd44d6vm0kk4wjjl8";
      ...
      "actix-rt" = rec {
        ...
        version = "1.0.0-alpha.3";
        edition = "2018";
        sha256 = "0sa8s8kqqzgxcch700fsszdgcagxrcrpzzw7pff8vfzphpzlhyrv";
        libName = "actix_rt";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-service" = rec {
        ...
        version = "1.0.0-alpha.4";
        edition = "2018";
        sha256 = "1w3fxzqzvqlnbvzsvv9x0h6nd313l8c2yavvhs4dy6ffjww8bw0x";
      ...
      "awc" = rec {
        ...
        version = "1.0.0-alpha.3";
        edition = "2018";
        sha256 = "0nrbxcl7a4yzhzzd5pqkicq138z7fjwgzyn2kx8apnnj97b572wz";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "actix-http";
            packageId = "actix-http 1.0.0-alpha.3";
          }
          {
            name = "actix-rt";
            packageId = "actix-rt";
