...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v1.0.0-alpha.5.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-http 1.0.0-alpha.5";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http 1.0.0-alpha.4" = rec {
        ...
        edition = "2018";
        sha256 = "11d03hq43j0wrjz0rvsxi4jqmzaann13djqgpdsvnfl4jqxn9srh";
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "actix-tls" "default" "flate2" "flate2-zlib" "openssl" ];
      };
      "actix-http 1.0.0-alpha.5" = rec {
        crateName = "actix-http";
        version = "1.0.0-alpha.5";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0-alpha.5.nix {};
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "awc" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "flate2-zlib" "open-ssl" "openssl" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
