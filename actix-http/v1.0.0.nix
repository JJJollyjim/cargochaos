...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-http/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http 1.0.0" = rec {
        ...
        resolvedDefaultFeatures = [ "actix-tls" "brotli" "compress" "default" "fail-ure" "failure" "flate2" "openssl" "ring" "rustls" "secure-cookies" ];
      };
      "actix-http 1.0.0-alpha.6" = rec {
        crateName = "actix-http";
        version = "1.0.0-alpha.6";
        edition = "2018";
        sha256 = "0xp9326kshgjbci03s280zx1qsjjbd57q76jkvmdgf1dzjsd5355";
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
