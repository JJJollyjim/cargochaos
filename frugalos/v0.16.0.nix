...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/frugalos/v0.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "frugalos_mds" = rec {
        ...
        version = "0.12.0";
        edition = "2015";
        sha256 = "0h29n6x97haa2037vyfsibbdx8ayj4zksz8z8aalsxxc3hxxcrxh";
        authors = [
          "The FrugalOS Developers"
        ];
        dependencies = [
      ...
      "frugalos_segment" = rec {
        ...
        version = "0.12.0";
        edition = "2015";
        sha256 = "0wbq72bwifdyh1w25205pajsd7gfgsd26gil2xfnsgjc1bhiz5df";
        authors = [
          "The FrugalOS Developers"
        ];
        dependencies = [
