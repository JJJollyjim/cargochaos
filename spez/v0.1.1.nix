...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spez/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "spez" = rec {
        ...
        dependencies = [
          ...
          {
            name = "spez-macros";
            packageId = "spez-macros";
          }
        ];
        
      };
      "spez-macros" = rec {
        crateName = "spez-macros";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1p6i2z84a8jq0k3v4i7aq60l57mw5q32j48mvkd6rjwcgl1hdyn7";
        procMacro = true;
        authors = [
          "Mara Bos <m-ou.se@m-ou.se>"
        ];
