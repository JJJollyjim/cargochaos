...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dprint/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dprint-core" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "13490qqcc1ndd74wl6yifsi2a66b63697bg6cm2zq81b32bk68ck";
        authors = [
          "David Sherret <dsherret@gmail.com>"
        ];
        dependencies = [
      ...
      "dprint-plugin-typescript" = rec {
        ...
        version = "0.13.1";
        edition = "2018";
        sha256 = "15pgwynxv3lgaw8vwl6sppkha2jvql69asv0qlbhwlsvcpikzdxx";
        authors = [
          "David Sherret <dsherret@gmail.com>"
        ];
        dependencies = [
