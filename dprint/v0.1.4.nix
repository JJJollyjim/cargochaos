...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dprint/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dprint-core" = rec {
        ...
        version = "0.13.0";
        edition = "2018";
        sha256 = "1cs85mz2ckxcbd4ykl84a4jz4k3kvncldg87lckhlgiw7mh1ddj6";
        authors = [
      ...
      "dprint-plugin-typescript" = rec {
        ...
        version = "0.10.1";
        edition = "2018";
        sha256 = "0vkq0phyqvv4q5n3188sfg8i2xr2jpgqpwhhzx9zpdf3m859i6k6";
        authors = [
          "David Sherret <dsherret@gmail.com>"
        ];
        dependencies = [
