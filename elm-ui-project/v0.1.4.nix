...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/elm-ui-project/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "elm-ui-project" = rec {
        crateName = "elm-ui-project";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "elm-ui-project"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.4.nix {};
        authors = [
          "nikos efthias <nikos@mugsoft.io>"
        ];
        dependencies = [
          {
            name = "clap";
