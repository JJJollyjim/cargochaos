...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/atomize/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "atomize" = rec {
        ...
        authors = [
          "Brandon Dyer <brandondyer64@gmail.com>"
        ];
        dependencies = [
          {
            name = "atomize-macro";
            packageId = "atomize-macro";
          }
          {
      ...
      "atomize-macro" = rec {
        crateName = "atomize-macro";
        version = "0.1.0";
        edition = "2018";
        sha256 = "15lmq5p86sz8li91sdcfl1mvnrnvlj40j5pwq1j1mwww0dnpfrhc";
        procMacro = true;
        authors = [
          "Brandon Dyer"
        ];
