...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oxur-component/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oxur-component" = rec {
        crateName = "oxur-component";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "oxur-component"; path = "src/main.rs"; }
        ];
