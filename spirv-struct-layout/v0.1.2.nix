...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spirv-struct-layout/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "spirq" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "08w9yx5bd7s76jdl6bhvqa1l9wnq6xhfkpw6n6a8w64yv63bkylr";
        authors = [
      ...
      "spirv-struct-layout" = rec {
        crateName = "spirv-struct-layout";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Tristam MacDonald <tristam@trist.am>"
        ];
        dependencies = [
          {
            name = "spirq";
          ...
          {
            name = "spirv-struct-layout-derive";
            packageId = "spirv-struct-layout-derive";
          }
        ];
        
      };
      "spirv-struct-layout-derive" = rec {
        crateName = "spirv-struct-layout-derive";
        version = "0.1.3";
        edition = "2018";
        sha256 = "06khdajis6vgmg86rx4g7arld5rcbn50p1mm2cazind3m4a5ppfy";
        procMacro = true;
        authors = [
          "Tristam MacDonald <tristam@trist.am>"
        ];
