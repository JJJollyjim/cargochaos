...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-ruspiro-push/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-ruspiro-push" = rec {
        crateName = "cargo-ruspiro-push";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-ruspiro-push"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Andre Borrmann <pspwizard@gmx.de>"
        ];
        dependencies = [
          {
            name = "clap";
