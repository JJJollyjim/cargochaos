...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_not_so_good/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "guessing_game_not_so_good";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_not_so_good" = rec {
        crateName = "guessing_game_not_so_good";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_not_so_good"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "José Tobias <jose.tobias@outlook.com>"
        ];
        dependencies = [
          {
            name = "rand";
