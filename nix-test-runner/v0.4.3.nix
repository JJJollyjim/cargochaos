...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nix-test-runner/v0.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "derive-getters" = rec {
        ...
        version = "0.0.7";
        edition = "2015";
        sha256 = "0g0g89ccjkjshbdjhvbxwrdr6vl0x1njav3vrh3d1p8dkbmj5qa6";
        procMacro = true;
      ...
      "junit-report" = rec {
        crateName = "junit-report";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1zca3sj1pkn66f658wwj6nsmyyzv6zy126pgnfplgqz7ig0qhjnx";
        authors = [
      ...
      "nix-test-runner" = rec {
        crateName = "nix-test-runner";
        version = "0.4.3";
        edition = "2018";
        crateBin = [
          { name = "nix-test"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.3.nix {};
        authors = [
          "Stoeffel <schtoeffel@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
