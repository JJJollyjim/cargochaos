...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/timemoji/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "timemoji" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "moonmoji"; path = "src/moonmoji.rs"; }
          { name = "clockmoji"; path = "src/clockmoji.rs"; }
          { name = "timemoji"; path = "src/main.rs"; }
        ];
