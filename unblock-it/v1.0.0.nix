...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unblock-it/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "find-winsdk" = rec {
        crateName = "find-winsdk";
        version = "0.2.0";
        edition = "2015";
        sha256 = "17hx0zly3q2pwrf3rp7mph10cac67sn3nxibc7wc2w0mhxxz3jx8";
        authors = [
          "FaultyRAM <explodingpsu@gmail.com>"
        ];
        dependencies = [
      ...
      "glow" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "1m6ny76r5qz9jj9l3qdiz17fkgp91jsy8yp3jm97zh5srlpr029f";
        authors = [
      ...
      "tetra" = rec {
        ...
        version = "0.2.20";
        edition = "2018";
        sha256 = "0yx7cmawj6q8ywmi5cvld3xvs77j212x6wh4qxpj8z7rbgglc2cp";
        authors = [
      ...
      "unblock-it" = rec {
        crateName = "unblock-it";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "unblock-it"; path = "src/main.rs"; }
        ];
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Document" "Element" "HtmlCanvasElement" "WebGl2RenderingContext" "WebGlActiveInfo" "WebGlBuffer" "WebGlFramebuffer" "WebGlProgram" "WebGlRenderbuffer" "WebGlRenderingContext" "WebGlSampler" "WebGlShader" "WebGlSync" "WebGlTexture" "WebGlUniformLocation" "WebGlVertexArrayObject" "Window" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "combaseapi" "coml2api" "consoleapi" "debug" "devpkey" "errhandlingapi" "handleapi" "impl-debug" "knownfolders" "ksmedia" "ktmw32" "memoryapi" "minwinbase" "minwindef" "mmdeviceapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winuser" ];
      };
      "winapi-build" = rec {
      ...
      "windres" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "0afpw6v9wxq08fg04r73i74chmjw0da771fz5c1snzsxf3zi6vnx";
        authors = [
          "FaultyRAM <explodingpsu@gmail.com>"
        ];
        dependencies = [
