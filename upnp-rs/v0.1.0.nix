...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/upnp-rs/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "upnp-rs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "upnp"; path = "src/bin/upnp.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "command_line" "default" "env_logger" "human-panic" "structopt" ];
      };
      "utf8-ranges" = rec {
