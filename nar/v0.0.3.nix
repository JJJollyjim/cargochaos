...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nar/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minitt-util" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "repl" "rustyline" "structopt" ];
      };
      "nar" = rec {
        crateName = "nar";
        version = "0.0.3";
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "default" "minitt-util" "rustyline" "structopt" ];
      };
      "nix" = rec {
        crateName = "nix";
        version = "0.14.1";
      ...
      "voile-util" = rec {
        crateName = "voile-util";
        version = "0.1.5";
        edition = "2018";
        sha256 = "0wvjp62bpl98m6ghq7i52g0l3nhd1sskr0rxrh5myq6k591b650l";
        authors = [
          "ice1000 <ice1000kotlin@foxmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "lisp" "parser" "pest" "pest_derive" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.8";
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
