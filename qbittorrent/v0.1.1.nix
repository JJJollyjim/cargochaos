...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/qbittorrent/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "qbittorrent" = rec {
        crateName = "qbittorrent";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "qbittorrent"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "VanillaBrooks <brookskarlik@gmail.com>"
        ];
        dependencies = [
          {
            name = "async-trait";
