...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/roa/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "accept-encoding-fork" = rec {
        crateName = "accept-encoding-fork";
        version = "0.2.0-alpha.3";
        edition = "2018";
        sha256 = "15s5vfqgismv9rqgk25cqkghb949bsbc6qndnn87ajmkxnzg0jhh";
        authors = [
      ...
      "async-compression 0.3.0" = rec {
        crateName = "async-compression";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1x20dw3lam5jl6dy087f79qv3swxipvq4wwndka3j4sa23d46237";
        authors = [
          "Wim Looman <wim@nemo157.com>"
          "Allen Bui <fairingrey@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "all-algorithms" "brotli" "bzip2" "default" "deflate" "flate2" "futures-bufread" "futures-io" "gzip" "libzstd" "zlib" "zstd" "zstd-safe" ];
      };
      "async-std" = rec {
        crateName = "async-std";
        version = "1.5.0";
      ...
      "reqwest" = rec {
        ...
        dependencies = [
          {
            ...
            packageId = "async-compression 0.2.0";
            optional = true;
            usesDefaultFeatures = false;
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "gzip" "hyper-tls" "json" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.14.6";
      ...
      "roa" = rec {
        ...
        dependencies = [
          {
            ...
            packageId = "accept-encoding-fork";
          ...
          {
            name = "async-compression";
            packageId = "async-compression 0.3.0";
            optional = true;
            features = [ "all-algorithms" "futures-bufread" ];
          }
          {
            name = "async-std";
            packageId = "async-std";
        ...
        features = {
          "body" = [ "serde" "mime" "askama" "serde_json" "serde_urlencoded" "encoding" "mime_guess" ];
        ...
        resolvedDefaultFeatures = [ "accept-encoding" "askama" "async-compression" "body" "compress" "cookie" "cookies" "default" "encoding" "full" "jsonwebtoken" "jwt" "mime" "mime_guess" "radix_trie" "regex" "router" "serde" "serde_json" "serde_urlencoded" ];
      };
      "roa-core" = rec {
        crateName = "roa-core";
        version = "0.3.2";
        edition = "2018";
        sha256 = "19ph59w70i6d8i3vrvfyivjj9qwrmk7780y66mnmp9q8mlqamll2";
        authors = [
          "Hexilee <hexileee@gmail.com>"
        ];
        dependencies = [
      ...
      "typed-builder" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "1zi9mmkz2vwg5cn8x9738vli42h21jyspvfi83y2sa6lvlja5kkq";
        procMacro = true;
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
