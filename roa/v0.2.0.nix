...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/roa/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-compression" = rec {
        ...
        resolvedDefaultFeatures = [ "all-algorithms" "brotli" "brotli2" "bytes" "bzip2" "default" "deflate" "flate2" "futures-bufread" "futures-io" "gzip" "libzstd" "stream" "zlib" "zstd" "zstd-safe" ];
      };
      "async-std" = rec {
        crateName = "async-std";
        version = "1.4.0";
      ...
      "roa" = rec {
        ...
        features = {
          ...
          "cookies" = [ "cookie" ];
          "default" = [ "cookies" "router" ];
          "full" = [ "default" "jwt" "body" "compress" ];
      ...
      "roa-core" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0brr0s6bgzsday2zfiywh5ng00xlbksw890diqvq6mc87rzwbzyg";
        authors = [
          "Hexilee <hexileee@gmail.com>"
        ];
        dependencies = [
