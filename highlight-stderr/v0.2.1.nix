...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/highlight-stderr/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colorparse" = rec {
        crateName = "colorparse";
        version = "2.0.1";
        edition = "2015";
        sha256 = "0ybkydapdihylrfad2fxdpz32iskb6ysi2qx0halqpyhc8s9m7qp";
        authors = [
      ...
      "highlight-stderr" = rec {
        crateName = "highlight-stderr";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "highlight-stderr"; path = "src/main.rs"; }
        ];
      ...
      "io-mux" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "0g5z2p07af5nkwddmm7px02j67g1ajpr1qhhv5yfggnlbwcjjb1n";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
        ];
        dependencies = [
