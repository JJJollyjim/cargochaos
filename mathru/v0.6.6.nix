...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mathru/v0.6.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blas-src" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "16n9xz13jzd19nk5i2zvvl0y5qhg33hdkc9yrirc6313ml1h055f";
        authors = [
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
      ...
      "lapack-src" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "1s9q8lii2pwcvwm53738bmnizbxwsfqjnmahxiipqlg7q5si23pq";
        authors = [
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
          "Stefan Kroboth <stefan.kroboth@gmail.com>"
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
      ...
      "mathru" = rec {
        ...
        authors = [
          "Matthias Eiholzer <matthias.eiholzer@gmail.com>"
        ];
        dependencies = [
          {
            name = "blas";
        ...
        resolvedDefaultFeatures = [ "blas" "blas-src" "blaslapack" "default" "lapack" "lapack-src" "native" ];
      };
      "matrixmultiply" = rec {
      ...
      "openblas-src" = rec {
        ...
        version = "0.8.0";
        edition = "2015";
        sha256 = "19ckf64sx9xja6nfva5a26lj0pbgbx5ly2g5324hx9p9lwbj4d93";
        authors = [
          "Corey Richardson <corey@octayn.net>"
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
      ...
      "plotters" = rec {
        ...
        resolvedDefaultFeatures = [ "area_series" "bitmap" "boxplot" "candlestick" "chrono" "default" "deprecated_items" "errorbar" "font-kit" "gif" "gif_backend" "histogram" "image" "image_encoder" "lazy_static" "line_series" "palette" "palette_ext" "point_series" "rusttype" "svg" "ttf" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.15.3";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "dwrite" "dwrite_1" "dwrite_3" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "unknwnbase" "winbase" "wincon" "winerror" "winnls" "winnt" ];
      };
