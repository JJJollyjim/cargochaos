...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libparted/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libparted-sys" = rec {
        crateName = "libparted-sys";
        version = "0.3.0";
        edition = "2015";
        sha256 = "1g839rm1lsacxq2xvks4cm2kfjh8vnr1k19hj9ck801ys9c96vmw";
        authors = [
