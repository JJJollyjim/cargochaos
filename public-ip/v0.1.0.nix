...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/public-ip/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "public-ip" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-resolver" "http" "http-resolver" "hyper" "once_cell" "regex" "tokio" "trust-dns-client" "trust-dns-proto" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.2";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "udp" ];
      };
      "tokio-util" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "minwinbase" "minwindef" "ntdef" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
