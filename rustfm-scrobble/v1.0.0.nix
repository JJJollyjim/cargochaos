...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustfm-scrobble/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustfm-scrobble" = rec {
        crateName = "rustfm-scrobble";
        version = "1.0.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "David Futcher <david@futcher.io>"
        ];
        dependencies = [
          {
            name = "md5";
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "wrapped-vec" = rec {
        crateName = "wrapped-vec";
        version = "0.2.1";
        edition = "2015";
        sha256 = "0icybwpsfzj71nmamaksr72sdjpgs1qg4q4vyy71qgg9mfs9phh6";
        procMacro = true;
        authors = [
          "David Futcher <david@futcher.io>"
        ];
