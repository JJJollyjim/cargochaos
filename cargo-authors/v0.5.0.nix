...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-authors/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-authors" = rec {
        crateName = "cargo-authors";
        version = "0.5.0";
        edition = "2015";
        crateBin = [
          { name = "cargo-authors"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Henning-K <henning.kowalk962@web.de>"
        ];
        dependencies = [
          {
            name = "cargo";
