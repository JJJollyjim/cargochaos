...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tentacle-ping/v0.3.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "11lc6zcsns247z08rn0llzs59cxphms05jjnapkixxh01r5yrw7a";
        authors = [
      ...
      "bs58 0.2.4" = rec {
        ...
        version = "0.2.4";
        edition = "2015";
        sha256 = "1pd2ibrjfw6fw288xkdm9h9gfxp5pjxzwmz0l8yz8kgzcanl95hd";
        authors = [
      ...
      "faster-hex" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0nhcqy6fbcycx6w3zvna72s4ifpdwpvnhc1xyy2fnpxxxp8xy3gc";
        authors = [
      ...
      "generic-channel" = rec {
        crateName = "generic-channel";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1868dxpmfadqflx7gyxp2gmy00g5j32b8rah09hziq08fx10l6ld";
        authors = [
        ...
        resolvedDefaultFeatures = [ "all" "crossbeam-channel" "futures" ];
      };
      "heck" = rec {
        crateName = "heck";
        version = "0.3.1";
      ...
      "molecule" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0am8w01id7gliv7n8bs1lxzz6c93gzjs3dsaw3bi4gp1jfxij1ms";
        authors = [
          "Nervos Core Dev <dev@nervos.org>"
        ];
        dependencies = [
      ...
      "tentacle" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "0ysqz8b7c3ip6z53g45xf3jbs24hricp33n1m4f8mv9yi4f2jvlj";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "flatbuffers" "flatbuffers-verifier" "flatc" "molc" "molecule" ];
      };
      "tentacle-ping" = rec {
        crateName = "tentacle-ping";
        version = "0.3.9";
        edition = "2018";
      ...
      "tentacle-secio" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0dxzk7w6hy9h15g1l03azydaxfg9z1zy0bhgvc57276hjlhy2235";
        authors = [
          "piaoliu <441594700@qq.com>"
          "Nervos Core Dev <dev@nervos.org>"
        ];
      ...
      "tokio-yamux" = rec {
        crateName = "tokio-yamux";
        version = "0.1.14";
        edition = "2018";
        sha256 = "1di4c4fs07r3xfj3i9j8wl7mgrbvr25420l47lva2q8hwzspfg3j";
        authors = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
