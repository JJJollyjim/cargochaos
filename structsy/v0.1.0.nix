...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/structsy/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "persy" = rec {
        ...
        version = "0.6.2";
        edition = "2015";
        sha256 = "0qz5qwh62bway96c9z3a413ivz1i30lvfaw5qzfjrg7sqg5nh4fy";
        authors = [
      ...
      "structsy-derive" = rec {
        crateName = "structsy-derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0c03wmfs052c5i69wxy59g146awssg7hb5prqqz364lk3qy6bz4s";
        procMacro = true;
        authors = [
          "Tglman <tglman@tglman.com>"
        ];
      ...
      "synstructure" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "1xphg4zcbp5xhy25v94bwcb0fyb40qw1xd7ypa3p8kvny7ajgz5g";
        authors = [
