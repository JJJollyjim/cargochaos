...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/usi-run/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitintr" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0id1rdbns1rmpv6aqj9v25ssfc8yzhizpfrl85av81zgjm27a37q";
        authors = [
      ...
      "csa" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0rm6nf6v2ra7pzsqd7vigav068s9jldzh1b6abvn6rkdj5hzj6yv";
        authors = [
          "nozaq"
        ];
        dependencies = [
      ...
      "shogi" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "165fjchpw4yka9jipm7hadlal170prpymd6cx68cmbk455wam7yp";
        authors = [
          "nozaq"
        ];
        dependencies = [
      ...
      "usi" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0bqq6pi5gwmp9z1k4fs4x03zh965591vfnj1p4flpf910myi2vb6";
        authors = [
          "nozaq"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
