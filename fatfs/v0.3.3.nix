...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fatfs/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fatfs" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "chrono" "core_io" "default" "std" ];
      };
      "fscommon" = rec {
        crateName = "fscommon";
        version = "0.1.0";
        edition = "2015";
        sha256 = "13rn2a302igiq9wh3c5xqbk35mdc8qs97mahlrkmfw2h5n9lqjx8";
        authors = [
          "Rafał Harabień <rafalh1992@o2.pl>"
        ];
        dependencies = [
          {
            name = "log";
