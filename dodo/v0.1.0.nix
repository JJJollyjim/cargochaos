...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dodo/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dodo" = rec {
        ...
        authors = [
          "Benjamin Lemelin <benjamin.lemelin@gmail.com>"
        ];
        dependencies = [
          {
            name = "dodo-derive";
            packageId = "dodo-derive";
            optional = true;
          }
          {
            name = "err-derive";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "directory" "dodo-derive" "json" "serde_json" "serde_yaml" "yaml" ];
      };
      "dodo-derive" = rec {
        crateName = "dodo-derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1rbgfsy2sc5zqijan2yxrdn6clkwgb95msf0zsh6l0j8fpv7j0f7";
        procMacro = true;
        authors = [
          "Benjamin Lemelin <benjamin.lemelin@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "processthreadsapi" "std" "winbase" "winerror" ];
      };
