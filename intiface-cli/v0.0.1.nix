...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/intiface-cli/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "buttplug" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1fsby0p3k1apgp0a107bnvik85rihkkyf69y1fwrzyiljb6haprg";
        authors = [
        ...
        resolvedDefaultFeatures = [ "btleplug" "btleplug-manager" "client" "default" "serialize_json" "server" ];
      };
      "buttplug_derive" = rec {
      ...
      "intiface-cli" = rec {
        crateName = "intiface-cli";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "intiface-cli"; path = "src/main.rs"; }
        ];
