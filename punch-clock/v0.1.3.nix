...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/punch-clock/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "punch-clock" = rec {
        crateName = "punch-clock";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "punch"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Søren Mortensen <soren@neros.dev>"
        ];
        dependencies = [
          {
            name = "chrono";
