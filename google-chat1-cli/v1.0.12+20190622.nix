...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-chat1-cli/v1.0.12+20190622.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-chat1" = rec {
        crateName = "google-chat1";
        version = "1.0.12+20190622";
        edition = "2015";
        sha256 = "199pnazqswbd3nxyzzv8k9cmv4rr705axwqy3q2xmvrhvvz3rrfd";
        authors = [
      ...
      "google-chat1-cli" = rec {
        crateName = "google-chat1-cli";
        version = "1.0.12+20190622";
        edition = "2015";
        crateBin = [
          { name = "chat1"; path = "src/main.rs"; }
        ];
