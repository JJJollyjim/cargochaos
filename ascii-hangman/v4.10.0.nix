...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ascii-hangman/v4.10.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ascii-hangman" = rec {
        crateName = "ascii-hangman";
        version = "4.10.0";
        edition = "2018";
        crateBin = [
          { name = "ascii-hangman"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v4.10.0.nix {};
        authors = [
      ...
      "crossterm" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "1vyfhnd3zhgc9n4ldgr0zxmvn3fz9n4w9vya42fvppz2b59j8g19";
        authors = [
          "T. Post"
        ];
        dependencies = [
