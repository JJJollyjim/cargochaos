...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bottom/v0.1.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bottom" = rec {
        ...
        authors = [
          "ClementTsang <clementjhtsang@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "tui-temp-fork" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "0af6rii8228w9pg5wwkh299piawklny6yyaxv0dsvj9m72f4vy9c";
        authors = [
