...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bottom/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "combaseapi" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "ifdef" "impl-default" "in6addr" "inaddr" "ioapiset" "knownfolders" "libloaderapi" "lmaccess" "lmapibuf" "lmcons" "memoryapi" "minwinbase" "minwindef" "netioapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "objidl" "oleauto" "pdh" "powerbase" "processenv" "processthreadsapi" "profileapi" "psapi" "rpcdce" "shellapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "tlhelp32" "wbemcli" "winbase" "windef" "winerror" "winioctl" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
