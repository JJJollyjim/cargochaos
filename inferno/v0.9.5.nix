...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/inferno/v0.9.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "inferno" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "inferno-collapse-perf"; path = "src/bin/collapse-perf.rs"; }
          { name = "inferno-collapse-dtrace"; path = "src/bin/collapse-dtrace.rs"; }
          { name = "inferno-collapse-sample"; path = "src/bin/collapse-sample.rs"; }
          { name = "inferno-collapse-vtune"; path = "src/bin/collapse-vtune.rs"; }
          { name = "inferno-collapse-guess"; path = "src/bin/collapse-guess.rs"; }
          { name = "inferno-flamegraph"; path = "src/bin/flamegraph.rs"; }
          { name = "inferno-diff-folded"; path = "src/bin/diff-folded.rs"; }
        ];
      ...
      "testing_logger" = rec {
        crateName = "testing_logger";
        version = "0.1.1";
        edition = "2015";
        sha256 = "087pi7y9iisspafyzblj41qvrw95dfb6px7pavlkmls5rckvg4kd";
        authors = [
          "brucechapman <bruce.chapman.nz@gmail.com>"
