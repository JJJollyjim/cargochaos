...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thttp/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "thttp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "thttp"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "davidedelpapa <davidedelpapa@yahoo.com>"
        ];
        dependencies = [
          {
            name = "actix-files";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
