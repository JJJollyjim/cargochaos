...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/potatonet/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-task" = rec {
        ...
        version = "1.2.0";
        edition = "2018";
        sha256 = "06yyxkmp2sfpr1fnrkyhipyki7yvn1z9xq3xspmp5738prnng3b9";
        authors = [
          "Stjepan Glavina <stjepang@gmail.com>"
        ];
        dependencies = [
      ...
      "potatonet" = rec {
        ...
        dependencies = [
          ...
          {
            name = "potatonet-bus";
            packageId = "potatonet-bus";
            optional = true;
          }
          {
            name = "potatonet-client";
            packageId = "potatonet-client";
            optional = true;
          }
          {
            name = "potatonet-codegen";
            packageId = "potatonet-codegen";
            optional = true;
          }
          {
            name = "potatonet-common";
            packageId = "potatonet-common";
          }
          {
            name = "potatonet-node";
            packageId = "potatonet-node";
            optional = true;
          }
          {
            name = "serde";
        ...
        resolvedDefaultFeatures = [ "bus" "client" "codegen" "default" "node" "potatonet-bus" "potatonet-client" "potatonet-codegen" "potatonet-node" ];
      };
      "potatonet-bus" = rec {
        crateName = "potatonet-bus";
        version = "0.4.1";
        edition = "2018";
        crateBin = [];
        sha256 = "0ql7zb6453hsv9p2lwmx0bfwdx4x0fhdrkx2wc5xfcv8yqdp8h54";
        authors = [
          "Sunli <scott_s829@163.com>"
        ];
        dependencies = [
      ...
      "potatonet-client" = rec {
        crateName = "potatonet-client";
        version = "0.4.1";
        edition = "2018";
        sha256 = "1wxxhbhs0yv1azrbgbg1n6h747xsl1zm3qd146ci817hl7lfcj8r";
        authors = [
          "Sunli <scott_s829@163.com>"
        ];
        dependencies = [
      ...
      "potatonet-codegen" = rec {
        crateName = "potatonet-codegen";
        version = "0.4.1";
        edition = "2018";
        sha256 = "0rzd9gn61blc7g5lkq3ay47m29sk611lp3mi9yschcczric8xfsb";
        procMacro = true;
        authors = [
          "sunli"
        ];
      ...
      "potatonet-common" = rec {
        crateName = "potatonet-common";
        version = "0.4.2";
        edition = "2018";
        sha256 = "1cki8six6wgicwlibj875wdv8rhr1fl6w7zv2zdqmayzc3nfj6d5";
        authors = [
          "Sunli <scott_s829@163.com>"
        ];
        dependencies = [
      ...
      "potatonet-node" = rec {
        crateName = "potatonet-node";
        version = "0.4.2";
        edition = "2018";
        sha256 = "1xqhspcnj0qskd5nja0i41bfvz4mq55w7664l9jiwy29mab157lm";
        authors = [
          "Sunli <scott_s829@163.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
