...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-watchtower/v1.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-watchtower" = rec {
        crateName = "solana-watchtower";
        version = "1.1.6";
        edition = "2018";
        crateBin = [
          { name = "solana-watchtower"; path = "src/main.rs"; }
        ];
