...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androiddeviceprovisioning1-cli/v1.0.12+20190622.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-androiddeviceprovisioning1-cli";
  ...
  workspaceMembers = {
    "google-androiddeviceprovisioning1-cli" = rec {
      packageId = "google-androiddeviceprovisioning1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-androiddeviceprovisioning1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androiddeviceprovisioning1" = rec {
        crateName = "google-androiddeviceprovisioning1";
        version = "1.0.12+20190622";
        edition = "2015";
        sha256 = "18980gslmikfyv0ymasisbbw5cpdz8s2393qxj6qvxs26x1ipc60";
        authors = [
      ...
      "google-androiddeviceprovisioning1-cli" = rec {
        crateName = "google-androiddeviceprovisioning1-cli";
        version = "1.0.12+20190622";
        edition = "2015";
        crateBin = [
          { name = "androiddeviceprovisioning1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-androiddeviceprovisioning1";
          }
          {
            name = "hyper";
            packageId = "hyper";
