...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sticker-utils/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sticker" = rec {
        ...
        version = "0.11.0";
        edition = "2018";
        sha256 = "17f975w6h5njgjdjxp9z3vdv3z4ilgv5468lp7snm6dqyzh1rahl";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
      ...
      "sticker-tf-proto" = rec {
        ...
        version = "0.11.0";
        edition = "2018";
        sha256 = "1w07z2f2mr7l7d66wrfy05i576pgfvr1gd724bi4cx941hql3dpw";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
