...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stop-handle/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stop-handle" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-threaded" "time" ];
          }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "num_cpus" "rt-core" "rt-threaded" "slab" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
