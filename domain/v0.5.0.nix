...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/domain/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "domain" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "chrono" "default" "interop" "master" "ring" "sign" "smallvec" "std" "tsig" "validate" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.14";
