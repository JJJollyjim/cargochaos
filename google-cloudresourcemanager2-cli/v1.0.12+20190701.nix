...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudresourcemanager2-cli/v1.0.12+20190701.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudresourcemanager2-cli";
  ...
  workspaceMembers = {
    "google-cloudresourcemanager2-cli" = rec {
      packageId = "google-cloudresourcemanager2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudresourcemanager2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudresourcemanager2" = rec {
        crateName = "google-cloudresourcemanager2";
        version = "1.0.12+20190701";
        edition = "2015";
        sha256 = "0w39gzgl7gaa1575179y7bb45inbfny77qpwq0xi1c78rglyg7ll";
        authors = [
      ...
      "google-cloudresourcemanager2-cli" = rec {
        crateName = "google-cloudresourcemanager2-cli";
        version = "1.0.12+20190701";
        edition = "2015";
        crateBin = [
          { name = "cloudresourcemanager2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-cloudresourcemanager2";
            packageId = "google-cloudresourcemanager2";
          }
          {
            name = "hyper";
            packageId = "hyper";
