...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openssl/v0.10.29.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "openssl" = rec {
        ...
        version = "0.10.29";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.10.29.nix {};
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "v101" "v102" "v110" "v111" "vendored" ];
      };
      "openssl-src" = rec {
