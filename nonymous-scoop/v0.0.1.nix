...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nonymous-scoop/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nonymous" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "16h74h7k9h4y99kamvxga8dl5xkqppzhfz138d3ndvx8m68zjg1h";
        authors = [
      ...
      "nonymous-scoop" = rec {
        crateName = "nonymous-scoop";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "scoop"; path = "src/main.rs"; }
        ];
