...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mozrunner/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mozrunner" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "firefox-default-path"; path = "src/bin/firefox-default-path.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "shlobj" "std" "winbase" "winerror" "winnt" "winreg" ];
      };
