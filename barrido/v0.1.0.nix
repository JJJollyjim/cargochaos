...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/barrido/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "barrido" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "barrido"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Eloy zer1t0ps@protonmail.com"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_debug" "release_max_level_off" "std" ];
      };
      "mac" = rec {
        crateName = "mac";
        version = "0.1.1";
