...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pandoc-katex/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "katex" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1f7x836fj62x37llvfxkgvrb4vb6cxxa1y32mp99l7azvpxx1jqc";
        authors = [
          "Cheng XU <rust@xuc.me>"
        ];
        dependencies = [
          {
            name = "derive_builder";
      ...
      "libquickjs-sys" = rec {
        crateName = "libquickjs-sys";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1cnqfms61rlxszmqb069vvkz9z801niyq7nmcylg7hdf4pz13da4";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bundled" "copy_dir" "default" "patched" ];
      };
      "once_cell" = rec {
        crateName = "once_cell";
        version = "1.3.1";
      ...
      "pandoc-katex" = rec {
        crateName = "pandoc-katex";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "pandoc-katex"; path = "src/main.rs"; }
        ];
      ...
      "quick-js" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1rixwhx062j0gnvb9mk39zmv4kg80w93xx2qva3wajrd1sbv5gs4";
        authors = [
          "Christoph Herzog <chris@theduke.at>"
        ];
        dependencies = [
        ...
        features = {
          "bigint" = [ "num-bigint" "num-traits" "libquickjs-sys/bignum" "libquickjs-sys/patched" ];
          "patched" = [ "libquickjs-sys/patched" ];
        };
        resolvedDefaultFeatures = [ "patched" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.2";
