...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mash/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mash" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "tobj" "wavefront" ];
      };
      "rustc-demangle" = rec {
      ...
      "tobj" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "07g200hh6zkb4zx0vdn0qflfyqml4z0hphfk1pszi8lmvsphp79b";
        authors = [
