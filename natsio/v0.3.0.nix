...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/natsio/v0.3.0.nix.tmp"
    ...
    crates = {
      ...
      "structopt 0.3.13" = rec {
        ...
        dependencies = [
          ...
          {
            name = "structopt-derive";
            packageId = "structopt-derive 0.4.6";
          }
        ];
        features = {
          "color" = [ "clap/color" ];
