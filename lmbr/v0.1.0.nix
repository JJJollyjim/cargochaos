...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lmbr/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lmbr" = rec {
        ...
        authors = [
          "jeikabu <jeikabu@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "lmbr_logger";
            packageId = "lmbr_logger";
          }
          {
            name = "lmbr_sys";
            packageId = "lmbr_sys";
        ...
        resolvedDefaultFeatures = [ "default" "lmbr_sys" ];
      };
      "lmbr_build" = rec {
        crateName = "lmbr_build";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1aivflxszx8q8nn4zsrbk3l61y088jd1djhgxp3v59absypz5nh5";
        authors = [
          "jeikabu <jeikabu@users.noreply.github.com>"
        ];
      ...
      "lmbr_logger" = rec {
        crateName = "lmbr_logger";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1qwi2mfvnnmn38i27v6gwyws79b8girz8yrk8i7xcg64hnf72sac";
        authors = [
          "jeikabu <jeikabu@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "lmbr_sys" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0m7rg19xh1gxyq8z40ac9bn797mm6wa28r30qibf9w5xmqffrdxp";
        authors = [
          "jeikabu <jeikabu@users.noreply.github.com>"
        ];
        buildDependencies = [
          ...
          {
            name = "lmbr_build";
            packageId = "lmbr_build";
          }
        ];
        features = {
          "default" = [ "lmbr_editor" "lmbr_fw_azcore" ];
        };
        resolvedDefaultFeatures = [ "default" "lmbr_editor" "lmbr_fw_azcore" ];
      };
      "log" = rec {
        crateName = "log";
        version = "0.4.8";
