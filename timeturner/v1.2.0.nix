...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/timeturner/v1.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "timeturner" = rec {
        crateName = "timeturner";
        version = "1.2.0";
        edition = "2018";
        crateBin = [
          { name = "timeturner"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.2.0.nix {};
        authors = [
          "Stephen Duncan <jrduncans@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "chrono";
