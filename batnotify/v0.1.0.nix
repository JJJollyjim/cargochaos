...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/batnotify/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "batnotify" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "batnotify"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "devguid" "errhandlingapi" "handleapi" "impl-default" "ioapiset" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "setupapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
