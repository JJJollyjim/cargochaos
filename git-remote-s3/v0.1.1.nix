...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-remote-s3/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-remote-s3" = rec {
        crateName = "git-remote-s3";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "git-remote-s3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Bryan Gahagan <git@bgahagan.dev>"
        ];
        dependencies = [
          {
            name = "error-chain";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processthreadsapi" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
