...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pcg_rand/v0.11.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pcg_rand" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "serialization_example"; path = "src/bin/serialization_example.rs"; }
          { name = "generate_default_seeds"; path = "src/bin/generate_default_seeds.rs"; }
          { name = "basic_examples"; path = "src/bin/basic_examples.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.11.1.nix {};
        authors = [
          "Jeb Brooks <robojeb@robojeb.xyz>"
        ];
        dependencies = [
          {
            name = "byteorder";
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde1" "serde_derive" "serde_json" "u128" ];
      };
      "ppv-lite86" = rec {
