...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustyline/v6.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustyline" = rec {
        ...
        version = "6.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v6.1.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "dirs" "skim" "with-dirs" "with-fuzzy" ];
      };
