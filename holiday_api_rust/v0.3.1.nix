...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/holiday_api_rust/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "holiday_api_rust" = rec {
        crateName = "holiday_api_rust";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "languages-search"; path = "src/bin/languages-search.rs"; }
          { name = "holidays-search"; path = "src/bin/holidays-search.rs"; }
          { name = "countries-search"; path = "src/bin/countries-search.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Guilherme Branco Stracini <guilherme@guilhermebranco.com.br>"
        ];
        dependencies = [
          {
            name = "dotenv";
