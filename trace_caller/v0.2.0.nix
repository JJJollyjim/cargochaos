...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/trace_caller/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "trace_caller" = rec {
        crateName = "trace_caller";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Ayush Kumar Mishra <ayushmishra2005@gmail.com>"
        ];
        dependencies = [
          {
            name = "backtrace";
          ...
          {
            name = "trace_caller_macro";
            packageId = "trace_caller_macro";
          }
        ];
        
      };
      "trace_caller_macro" = rec {
        crateName = "trace_caller_macro";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0ibb94msa0q9d5rpw5g8i8k32p6nly787mjqz8fw0agffn5z9ay4";
        procMacro = true;
        authors = [
          "Ayush Kumar Mishra <ayushmishra2005@gmail.com>"
        ];
