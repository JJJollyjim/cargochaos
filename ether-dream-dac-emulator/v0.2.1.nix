...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ether-dream-dac-emulator/v0.2.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "ether-dream-dac-emulator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ether-dream-dac-emulator" = rec {
        crateName = "ether-dream-dac-emulator";
        version = "0.2.1";
        edition = "2018";
      ...
      "euclid" = rec {
        ...
        version = "0.20.9";
        edition = "2015";
        sha256 = "1z4b54jbgyb9zwiy7qz4x1adajpml52kxmmykzs841m8937kw1lg";
        authors = [
          "The Servo Project Developers"
        ];
        dependencies = [
      ...
      "nannou" = rec {
        ...
        version = "0.13.1";
        edition = "2018";
        sha256 = "1a66if4712i2gzpjdbgwrljah4g4zax7lbda6469qwc9ix4sh1hz";
        authors = [
          "mitchmindtree <mitchell.nordine@gmail.com>"
        ];
        dependencies = [
      ...
      "pennereq" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "12ywa2aip0w5jgja2qh9yy03ijcgswlxq25gw7f8q3vgavsahx11";
        authors = [
