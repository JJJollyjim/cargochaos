...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/brioche-ducc-sys/v0.1.2-brioche.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "15bjg9rdvll8mpx9ykhw4zr9pbd11m3fmk4isg1gddn29mjgmj5c";
        authors = [
      ...
      "brioche-ducc-sys" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "ffi-gen"; path = "src/ffi_gen.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2-brioche.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "bindgen" "build-ffi-gen" "use-exec-timeout-check" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
