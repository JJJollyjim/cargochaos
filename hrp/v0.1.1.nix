...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hrp/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "minwinbase" "minwindef" "processenv" "winbase" ];
      };
