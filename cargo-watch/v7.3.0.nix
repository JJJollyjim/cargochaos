...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-watch/v7.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-watch" = rec {
        ...
        src = pkgs.callPackage ./tarball-v7.3.0.nix {};
        authors = [
      ...
      "watchexec" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0lh78wmsq4jc3kw1027j6hjw3x9wrrg47slyq7naxcdiajrsh9jg";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "jobapi2" "minwinbase" "minwindef" "processenv" "std" "tlhelp32" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
