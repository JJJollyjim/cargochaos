...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/k8s-gcr-auth-helper/v0.1.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "k8s-gcr-auth-helper" = rec {
        crateName = "k8s-gcr-auth-helper";
        version = "0.1.10";
        edition = "2018";
        crateBin = [
          { name = "k8s-gcr-auth-helper"; path = "src/main.rs"; }
        ];
      ...
      "kube" = rec {
        ...
        version = "0.30.0";
        edition = "2018";
        sha256 = "0w32vp481545m3dazdz77cvkaizxg621x1kylkwja3a64359pym8";
        authors = [
        ...
        resolvedDefaultFeatures = [ "native-tls" "openssl" "rustls" "rustls-tls" ];
      };
      "lazy_static" = rec {
      ...
      "oauth2" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "0fzi4m68mp582xjd2kl6p3pml2pi287x9vqnxsykc6jqrycj2y2v";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "default-tls" "gzip" "hyper-rustls" "hyper-tls" "json" "native-tls" "native-tls-crate" "rustls" "rustls-tls" "serde_json" "stream" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.11";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
