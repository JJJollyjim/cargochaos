...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/symtool/v0.1.3.nix.tmp"
    ...
    crates = {
      ...
      "symtool" = rec {
        ...
        dependencies = [
          ...
          {
            name = "symtool-backend";
            packageId = "symtool-backend";
          }
        ];
        
      };
      "symtool-backend" = rec {
        crateName = "symtool-backend";
        version = "0.2.0";
        edition = "2018";
        sha256 = "15m3gj6v2kbf1dqhiw41fh4ls9dlphlv6q7iy31b4ay5pi4rys3r";
        authors = [
          "Caleb Zulawski <caleb.zulawski@gmail.com>"
        ];
        dependencies = [
