...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ruma-client/v0.4.0-beta.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "js_int" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "0brsf20c70a0mmp4lllkdxfh944l943dhjjh02gkdw1v7z8w0zgr";
        authors = [
      ...
      "ruma-api" = rec {
        ...
        version = "0.16.0-rc.3";
        edition = "2018";
        sha256 = "1h99n0cfv7xg6dca0ws0c74071b2s68ig3qqsl28rk2wc98sk5n2";
        authors = [
        ...
        features = {
          ...
          "with-ruma-api-macros" = [ "percent-encoding" "ruma-api-macros" "serde" ];
        };
        resolvedDefaultFeatures = [ "default" "percent-encoding" "ruma-api-macros" "serde" "with-ruma-api-macros" ];
      };
      "ruma-api-macros" = rec {
        crateName = "ruma-api-macros";
        version = "0.16.0-rc.3";
        edition = "2018";
        sha256 = "1bb5if8f3pdafdmqafg5af5r3cipiflaxj4140y6xab0m2k04sqg";
        procMacro = true;
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Jonas Platte <jplatte@posteo.de>"
      ...
      "ruma-client" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.0-beta.4.nix {};
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Jonas Platte <jplatte@posteo.de>"
        ];
      ...
      "ruma-client-api" = rec {
        ...
        version = "0.8.0-rc.5";
        edition = "2018";
        sha256 = "19girj8xi7y59rjlzc3afj96wvhvl0pqhyanzv61mr0xzkvq7c3d";
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
        dependencies = [
      ...
      "ruma-events" = rec {
        ...
        edition = "2018";
        sha256 = "0lv5m4rgmjh6130dvql61v0qcifmd54czcdpdjng45z5pdv2906l";
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
        dependencies = [
      ...
      "ruma-events-macros" = rec {
        ...
        version = "0.21.0-beta.1";
        edition = "2018";
        sha256 = "039jsdgsnvgl33kx8x286wng1zsa79ymwbpsxcpgx1wqdklwzlxb";
        procMacro = true;
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
      ...
      "ruma-identifiers" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "1ljhjnz8qcvp6swwjl3lyfq1kkc4cjvd6ps3pf9jmadmvg2lirbf";
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
        dependencies = [
      ...
      "ruma-serde" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0b626ylp8iddjkvjhnl8gah2qb94si6i6mv9ahc3dxjqi5h1v409";
        authors = [
          "Jonas Platte <jplatte@posteo.de>"
