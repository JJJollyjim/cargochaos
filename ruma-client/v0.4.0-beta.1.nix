...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ruma-client/v0.4.0-beta.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ruma-api" = rec {
        ...
        version = "0.15.0";
        edition = "2018";
        sha256 = "1r8z7zacvckz6x5wr1yy09da771hijxwlqrsxwij912vcbc0q3qj";
        authors = [
        ...
        features = {
          ...
          "with-ruma-api-macros" = [ "percent-encoding" "ruma-api-macros" "ruma-identifiers" "serde" "url" ];
        };
        resolvedDefaultFeatures = [ "default" "percent-encoding" "ruma-api-macros" "ruma-identifiers" "serde" "url" "with-ruma-api-macros" ];
      };
      "ruma-api-macros" = rec {
        crateName = "ruma-api-macros";
        version = "0.12.0";
        edition = "2018";
        sha256 = "17km2vsqz4zfzkjgnz08mqpf2y6kq58qb20pzwrp1fn1r7pj7idz";
        procMacro = true;
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Jonas Platte <jplatte@posteo.de>"
      ...
      "ruma-client" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.0-beta.1.nix {};
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Jonas Platte <jplatte@posteo.de>"
        ];
      ...
      "ruma-client-api" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "142yqy88rmzklxyvksqa1xzhigrhlgwp5dhxf2kr6p02gqwgzizr";
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
        dependencies = [
      ...
      "ruma-events" = rec {
        ...
        version = "0.18.0";
        edition = "2018";
        sha256 = "1cxjdilj16syc85kkkrdix1jjbdn7n3g3dmyy3bihbs643y4pqw0";
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
        dependencies = [
      ...
      "ruma-events-macros" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1q999wmhb5qbmxgyfm0ncmq59p8asxdb745lf6s0smqc92sbd5gz";
        procMacro = true;
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
      ...
      "ruma-identifiers" = rec {
        ...
        version = "0.14.1";
        edition = "2018";
        sha256 = "1f9rf0q0jc5vlqyvhcfvqb955lmx7r34n72avp23zcx3033l5r07";
        authors = [
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
        ];
        dependencies = [
