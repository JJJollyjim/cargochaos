...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/writedisk/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "writedisk" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "writedisk_copier"; path = "src/bin/writedisk_copier.rs"; }
          { name = "writedisk"; path = "src/bin/writedisk.rs"; }
        ];
