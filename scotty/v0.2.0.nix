...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scotty/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sled" = rec {
        ...
        version = "0.29.2";
        edition = "2018";
        sha256 = "0vi8bfdgm1ig609jn1cb12yll8ahcs6zdjbws6ypm9znw0ylbhyp";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
