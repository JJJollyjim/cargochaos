...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/trawler/v0.9.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "histogram-sampler" = rec {
        crateName = "histogram-sampler";
        version = "0.4.0";
        edition = "2015";
        sha256 = "0rfmmxinb6kkaijas9ssbrl4xsh97fwpsmna412sj88m5dg079h0";
        authors = [
          "Jon Gjengset <jon@thesquareplanet.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-util" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" ];
      };
      "tokio-util" = rec {
      ...
      "trawler" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "trawler"; path = "src/bin/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-threaded" "io-driver" "time" ];
          }
          {
            name = "tower-make";
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "cookie" "default" "http" "hyper" "lazy_static" "regex" "url" ];
      };
      "try-lock" = rec {
        crateName = "try-lock";
        version = "0.2.2";
