...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clap-v3/v3.0.0-beta.1.nix.tmp"
    ...
    crates = {
      ...
      "clap-v3" = rec {
        ...
        dependencies = [
          ...
          {
            name = "term_size";
            packageId = "term_size 1.0.0-beta1";
            optional = true;
          }
          {
            name = "textwrap";
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "cargo" "clap_derive" "color" "debug" "default" "derive" "doc" "lazy_static" "nightly" "std" "strsim" "suggestions" "term_size" "unstable" "vec_map" "wrap_help" "yaml" "yaml-rust" ];
      };
      "clap_derive-v3" = rec {
