...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/server-starter-listener/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "server-starter-listener";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-server" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "mio-uds" "tokio-uds" "uds" ];
      };
      "actix-server-config" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "tokio-uds" "uds" ];
      };
      "actix-service" = rec {
      ...
      "actix-web" = rec {
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-zlib" "uds" ];
      };
      ...
      "server-starter-listener" = rec {
        crateName = "server-starter-listener";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "krrrr38 <k.kaizu38@gmail.com>"
        ];
        dependencies = [
          {
            name = "failure";
