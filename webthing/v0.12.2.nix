...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webthing/v0.12.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "cell" "flate2" "flate2-c" "openssl" "ssl" "tokio-openssl" ];
      };
      "actix_derive" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
