...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eventsource-client/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eventsource-client" = rec {
        crateName = "eventsource-client";
        version = "0.3.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Sam Stokes <sstokes@launchdarkly.com>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
