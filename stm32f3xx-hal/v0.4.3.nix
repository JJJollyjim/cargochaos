...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f3xx-hal/v0.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32-usbd" = rec {
        ...
        resolvedDefaultFeatures = [ "ram_access_1x16" "ram_access_2x16" ];
      };
      "stm32f3" = rec {
        crateName = "stm32f3";
        version = "0.10.0";
        edition = "2018";
        sha256 = "1m9jvsilac6ilgmy329l2bi184nf8l8xpb8lqkj7wzfx23x9r020";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f301" "stm32f302" "stm32f303" "stm32f373" "stm32f3x4" "stm32f3x8" ];
      };
      "stm32f3xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "device-selected" "rt" "stm32-usbd" "stm32f301" "stm32f302" "stm32f303" "stm32f303x6" "stm32f303x8" "stm32f303xb" "stm32f303xc" "stm32f303xd" "stm32f303xe" "stm32f318" "stm32f328" "stm32f334" "stm32f358" "stm32f373" "stm32f378" "stm32f398" "unproven" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
