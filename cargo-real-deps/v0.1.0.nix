...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-real-deps/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-real-deps" = rec {
        crateName = "cargo-real-deps";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-real-deps"; path = "src/main.rs"; }
        ];
