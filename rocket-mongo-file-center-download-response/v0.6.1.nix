...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-mongo-file-center-download-response/v0.6.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rocket-mongo-file-center-download-response";
  ...
  workspaceMembers = {
    "rocket-mongo-file-center-download-response" = rec {
      packageId = "rocket-mongo-file-center-download-response";
      build = internal.buildRustCrateWithFeatures {
        packageId = "rocket-mongo-file-center-download-response";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket-mongo-file-center-download-response" = rec {
        crateName = "rocket-mongo-file-center-download-response";
        version = "0.6.1";
        edition = "2018";
