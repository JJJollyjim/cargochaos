...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/halide-build/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "halide-build" = rec {
        crateName = "halide-build";
        version = "0.3.3";
        edition = "2018";
        crateBin = [
          { name = "halide"; path = "src/bin/halide.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "bin" "clap" "default" ];
      };
      "hermit-abi" = rec {
