...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure-functions-sdk/v0.11.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure-functions-sdk" = rec {
        crateName = "azure-functions-sdk";
        version = "0.11.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-func"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.11.0.nix {};
        authors = [
          "Peter Huene <peterhuene@protonmail.com>"
        ];
        dependencies = [
          {
            name = "atty";
