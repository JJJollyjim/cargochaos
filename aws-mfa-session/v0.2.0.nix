...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aws-mfa-session/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aws-mfa-session" = rec {
        crateName = "aws-mfa-session";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "aws-mfa-session"; path = "src/bin/aws-mfa-session.rs"; }
        ];
      ...
      "rusoto_iam" = rec {
        crateName = "rusoto_iam";
        version = "0.43.0";
        edition = "2018";
        sha256 = "1a7hfkjjrvc05k0yikh4p1x46whifvnjbc3khvx5nzi99yc1niis";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
