...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-stake-accounts/v1.1.6.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "solana-stake-accounts";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-stake-accounts" = rec {
        crateName = "solana-stake-accounts";
        version = "1.1.6";
        edition = "2018";
        crateBin = [
          { name = "solana-stake-accounts"; path = "src/main.rs"; }
        ];
