...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-driveactivity2-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-driveactivity2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-driveactivity2" = rec {
        crateName = "google-driveactivity2";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "0v6hbbq8ywj9fj1s36rahb2lypqcy0srh1bkzvswlk0f4yfg2vms";
        authors = [
      ...
      "google-driveactivity2-cli" = rec {
        crateName = "google-driveactivity2-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "driveactivity2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-driveactivity2";
            packageId = "google-driveactivity2";
          }
          {
            name = "hyper";
            packageId = "hyper";
