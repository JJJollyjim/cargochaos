...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/macro-machines/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "variant_count" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "1c36b0l70v7rrdjvlcl3h5x78pxggqxily0xk21x2x117d9lld9a";
        procMacro = true;
        authors = [
