...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pazi/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arc-swap" = rec {
        ...
        version = "0.3.5";
        edition = "2015";
        sha256 = "0pxhl1acxvc528hj71fidcllcnsmjlp47hbq8c47pc5pw2qrxqz9";
        authors = [
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" "vec_map" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
