...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ohx-addon-publish/v0.0.1-preview.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ohx-addon-publish" = rec {
        crateName = "ohx-addon-publish";
        version = "0.0.1-preview";
        edition = "2018";
        crateBin = [
          { name = "ohx-addon-publish"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1-preview.nix {};
        authors = [
          "David Gräff <david.graeff@web.de>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "build-binary" "chrono" "default" "dirs" "env_logger" "log" "reqwest" "structopt" "webbrowser" ];
      };
      "owning_ref" = rec {
      ...
      "tokio 0.2.0-alpha.2" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tokio-executor";
            packageId = "tokio-executor 0.2.0-alpha.2";
            optional = true;
          }
          {
            name = "tokio-fs";
          ...
          {
            name = "tokio-sync";
            packageId = "tokio-sync 0.2.0-alpha.2";
            optional = true;
            features = [ "async-traits" ];
          }
          {
            name = "tokio-timer";
            packageId = "tokio-timer 0.3.0-alpha.2";
            optional = true;
            features = [ "async-traits" ];
          }
          {
      ...
      "tokio-executor 0.2.0-alpha.2" = rec {
        crateName = "tokio-executor";
        version = "0.2.0-alpha.2";
        edition = "2018";
