...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/semver-cli/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "semver-cli" = rec {
        crateName = "semver-cli";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "semver-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "rickycodes <ricky.miller@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
