...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-genesis/v1.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-genesis" = rec {
        crateName = "solana-genesis";
        version = "1.1.6";
        edition = "2018";
        crateBin = [
          { name = "solana-genesis"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.6.nix {};
        libName = "solana_genesis";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
