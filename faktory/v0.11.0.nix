...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/faktory/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "faktory" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "loadtest"; path = "src/bin/loadtest.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "binaries" "clap" "default" "native-tls" "tls" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
