...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/photon-rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "photon-rs" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "web-sys";
            packageId = "web-sys";
            features = [ "Document" "Element" "HtmlElement" "Node" "Window" "CanvasRenderingContext2d" "ImageData" "HtmlCanvasElement" "HtmlImageElement" "console" "CssStyleDeclaration" "EventTarget" ];
          }
          {
            name = "wee_alloc";
            packageId = "wee_alloc";
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "CanvasRenderingContext2d" "CssStyleDeclaration" "Document" "DomRect" "Element" "EventTarget" "HtmlCanvasElement" "HtmlElement" "HtmlImageElement" "ImageData" "Node" "Window" "console" ];
      };
      "wee_alloc" = rec {
        crateName = "wee_alloc";
        version = "0.4.5";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "memoryapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" ];
      };
