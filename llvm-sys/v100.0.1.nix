...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/llvm-sys/v100.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "llvm-sys" = rec {
        ...
        version = "100.0.1";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v100.0.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "disable-alltargets-init" "no-llvm-linking" "strict-versioning" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.2.1";
