...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ptail/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "processenv" "processthreadsapi" "synchapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
