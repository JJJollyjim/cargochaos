...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/templar/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "templar" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "base64-extension" "bin" "clap" "common-extensions" "default" "experimental" "full" "json-extension" "parking_lot" "serde" "serde-extensions" "serde-xml-rs" "serde_json" "serde_yaml" "shared-context" "structopt" "toml" "toml-extension" "xml-extension" "yaml-extension" ];
      };
      "textwrap" = rec {
        crateName = "textwrap";
        version = "0.11.0";
