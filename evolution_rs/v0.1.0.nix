...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evolution_rs/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "evolution_rs" = rec {
        ...
        authors = [
          "Matevž Fabjančič <matevz.fabjancic@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
