...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/timeplot/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gnuplot" = rec {
        ...
        version = "0.0.33";
        edition = "2018";
        sha256 = "13wbp7ksgpbs5vhz55ljv21hn9kbhyl6ld4y27xn29pilb4qi9ai";
        authors = [
      ...
      "timeplot" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "timeplot"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shellapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
