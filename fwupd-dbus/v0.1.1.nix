...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fwupd-dbus/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cascade" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "04r6rvx6aamr3shspjq0c10vabr91hdzh5q12cpginx9l7sdvj9i";
        authors = [
          "Jackson Lewis <inquisitivepenguin@protonmail.com>"
        ];
      ...
      "hex-view" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "0zx9bkzj1wkh6rh13sqcxa8mc11qgvrc17pyyf42ml2dzv4ickj9";
        authors = [
      ...
      "progress-streams" = rec {
        ...
        version = "1.1.0";
        edition = "2015";
        sha256 = "19w6z53nwb484x1rjk8k7hkkbzf9sdx08rldrnq0gik2h5ndjrg9";
        authors = [
