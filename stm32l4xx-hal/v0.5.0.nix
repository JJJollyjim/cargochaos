...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32l4xx-hal/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32l4" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32l4x1" "stm32l4x2" "stm32l4x3" "stm32l4x5" "stm32l4x6" ];
      };
      "stm32l4xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "rt" "stm32l4x1" "stm32l4x2" "stm32l4x3" "stm32l4x5" "stm32l4x6" "unproven" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "0.15.13";
