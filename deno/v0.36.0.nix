...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno/v0.36.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-core" "tcp" "udp" "process" "fs" "blocking" "sync" "io-std" "macros" "time" ];
          }
          {
            name = "tokio-rustls";
      ...
      "deno_core" = rec {
        ...
        version = "0.36.0";
        edition = "2018";
        sha256 = "0m5zgdzi683zv7dnwidbzghjivyxdar694bxw2apdwm2czbhq3s1";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
      ...
      "deno_typescript" = rec {
        ...
        version = "0.36.0";
        edition = "2018";
        sha256 = "150n3zqg6cg7py4rzms0myf7gkcbywva63zwqfivf9djvj8laf1q";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
      ...
      "dprint-core" = rec {
        ...
        version = "0.11.0";
        edition = "2018";
        sha256 = "1l1frmyq2ijbvv5wddnhqcv863sbn6b6b2i7j9dgp98cl27aml9p";
        authors = [
      ...
      "dprint-plugin-typescript" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "07a5q0bkx81bnkwcwk5qpm3znqrhlvxj7kb70z3xlwfbcb1jmkvd";
        authors = [
          "David Sherret <dsherret@gmail.com>"
        ];
        dependencies = [
      ...
      "swc_ecma_parser" = rec {
        ...
        version = "0.21.3";
        edition = "2018";
        sha256 = "15qnlixr4b29gk1vq332i3qdfli20fn8qlai9yikzf41rlcb1ns3";
        authors = [
          "강동윤 <kdy1997.dev@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "slab" "sync" "tcp" "time" "tokio-macros" "udp" "winapi" ];
      };
      "tokio-io" = rec {
        crateName = "tokio-io";
        version = "0.1.13";
