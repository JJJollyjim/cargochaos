...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno/v0.30.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno_core" = rec {
        ...
        version = "0.30.1";
        edition = "2018";
        sha256 = "06dx09rw0k2x78xn3d6px2gb1f58mnprfgm3ylkii3z3vbikrav6";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
      ...
      "deno_typescript" = rec {
        ...
        version = "0.30.1";
        edition = "2018";
        sha256 = "0b15a1vircxyyrgbb5gm5wmgwpjp20mkgrjbi3sy30b9yw950kcp";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
