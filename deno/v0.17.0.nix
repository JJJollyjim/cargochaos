...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno/v0.17.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno-x86_64-apple-darwin" = rec {
        ...
        version = "0.17.0";
        edition = "2015";
        sha256 = "0ld84mscl2gcr5ivj04sp63i6majmbni0jd5gkc8k0fx1r8r8y1b";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.17.0";
        edition = "2015";
        sha256 = "0vj1bl8ilp2q3dh898qns4c9p7yw6j148sxl5qgvd3190bs6h3md";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno-x86_64-unknown-linux-gnu" = rec {
        ...
        version = "0.17.0";
        edition = "2015";
        sha256 = "0dvas3d6h5h52lipwsshhr3n481smnx5dk5g48065zr419v2idc9";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
