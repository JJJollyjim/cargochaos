...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno/v0.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno-x86_64-apple-darwin" = rec {
        ...
        version = "0.16.0";
        edition = "2015";
        sha256 = "0p83qjq3lk9hhz12pn1im6bm04gk1knm77lmdgl8k0d65wx640li";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.16.0";
        edition = "2015";
        sha256 = "1q1k017nh43sdcgw3zhdg5jxf3y74faf1k7yfg14phf3djcz8y27";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno-x86_64-unknown-linux-gnu" = rec {
        ...
        version = "0.16.0";
        edition = "2015";
        sha256 = "02d7q86sxyw3li2h914kxga6islncqyyjmpaxypx121da28p1f61";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
