...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/horust/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "horust" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "http-healthcheck" "reqwest" ];
      };
      "http" = rec {
        crateName = "http";
        version = "0.2.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
