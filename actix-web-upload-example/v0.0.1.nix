...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web-upload-example/v0.0.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-web-upload-example";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-multipart" = rec {
        ...
        version = "0.2.0-alpha.1";
        edition = "2018";
        sha256 = "0gcc6imd8w4phgw754b6gnwid91c9qisjg670xcawq9zw6fmwrr6";
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        sha256 = "1rqims88075akfmdf51m273g238l1z4xdnwi3lrq25xzkwpf07k7";
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-web-upload-example" = rec {
        crateName = "actix-web-upload-example";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "actix-web-upload-example"; path = "src/main.rs"; }
        ];
      ...
      "concat-string" = rec {
        crateName = "concat-string";
        version = "1.0.1";
        edition = "2015";
        sha256 = "02c6hfxsvs1ff2j58f3qzr526w1yg8d2nf6yyjv81ixgbz5vwfbl";
        authors = [
          "FaultyRAM <explodingpsu@gmail.com>"
        ];
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
