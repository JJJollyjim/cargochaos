...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/root-ls/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alice-open-data" = rec {
        crateName = "alice-open-data";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1cd7mxm46nvy4ikinzc5nsgjl34ym1n87vnpxgqi194vv6lwxq1g";
        authors = [
          "cbourjau <c.bourjau@posteo.de>"
        ];
        dependencies = [
          {
            name = "dirs";
      ...
      "root-io" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0lk0f40kh83m6w25fckmv3j5l71ggz0si54ivv7h6jigj13yy2jn";
        authors = [
          "cbourjau <c.bourjau@posteo.de>"
        ];
        dependencies = [
      ...
      "root-ls" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "root-ls"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.4.nix {};
        authors = [
          "cbourjau <christian.bourjau@cern.ch>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "rustfmt" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0yl1q7izhld704lcwyn52mxj26ism912c6wwd47dca6qak3i2zha";
        authors = [
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Event" "EventTarget" "Headers" "MessageEvent" "Request" "RequestInit" "RequestMode" "Response" "Window" "Worker" "console" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
