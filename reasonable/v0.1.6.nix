...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reasonable/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fasthash" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "03v9g4ajw0zk9pv2ranq65xcly1b68hg0qzc2y8y1ajfdfa168h3";
        authors = [
      ...
      "pyo3" = rec {
        ...
        edition = "2018";
        sha256 = "1pqik8pq0blbp5v6j2d08hdayapayyap0x1jpgfvlhh9q49dc4wl";
        authors = [
      ...
      "pyo3-derive-backend" = rec {
        ...
        version = "0.9.0-alpha.1";
        edition = "2018";
        sha256 = "1a58hp2k36jx9vhsc6h1x23csyi5dqw35v0rqafrnnj1yfc37h30";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
      ...
      "pyo3cls" = rec {
        ...
        version = "0.9.0-alpha.1";
        edition = "2018";
        sha256 = "1hal0l399dpjxqxcxx5j7klln46j6kcdhhvqr04v2kic5wk75m19";
        procMacro = true;
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
      ...
      "rdf" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0in6sjc1nbh44d8872xzas1wnlprd5nzv3p1g4r4mzik06zja5xv";
        authors = [
      ...
      "reasonable" = rec {
        crateName = "reasonable";
        version = "0.1.6";
        edition = "2018";
        crateBin = [
          { name = "reasonable"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "pyo3" "python-library" ];
      };
      "redox_syscall" = rec {
      ...
      "roaring" = rec {
        ...
        version = "0.5.2";
        edition = "2015";
        sha256 = "0bf25j9sd3vkxg6j0fxw9ysn34x2iiv9g8lz91bjlws47rfhxwja";
        authors = [
