...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aoc-puzzle-desc-md/v0.9.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aoc-puzzle-desc-md" = rec {
        crateName = "aoc-puzzle-desc-md";
        version = "0.9.0";
        edition = "2018";
        crateBin = [
          { name = "aoc-puzzle-desc-md"; path = "src/main.rs"; }
        ];
