...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/atomig/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "atomig" = rec {
        ...
        resolvedDefaultFeatures = [ "atomig-macro" "derive" "nightly" ];
      };
      "atomig-macro" = rec {
        crateName = "atomig-macro";
        version = "0.1.0";
        edition = "2018";
        sha256 = "067ifdqmk2zy7wm4pji062zdy4607ihf0wnbnr2pbag765g0rjdc";
        procMacro = true;
        authors = [
          "Lukas Kalbertodt <lukas.kalbertodt@gmail.com>"
        ];
