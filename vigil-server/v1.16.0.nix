...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vigil-server/v1.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "openssl-src" = rec {
        ...
        edition = "2015";
        sha256 = "1i4yyckhjx4q4fbgsqi53m27n6ryl7mb43kqlfmkbcqyvl6y3nx2";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "ping" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1mwhi1yxz3j0sy6b4hx520ch4rimxn7qsq3jmw4ysv7k22xdc8bm";
        authors = [
      ...
      "vigil-server" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.16.0.nix {};
        authors = [
