...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/merkle-tree-stream/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "minwindef" "processthreadsapi" "wincrypt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
