...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gitmoji/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" "default" "strsim" "suggestions" "term_size" "vec_map" "wrap_help" "yaml" "yaml-rust" ];
      };
      ...
      "confy" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "1spddm0kpirn94m0jw25c7gy5llq2cp4knffqz92fzxf1p6h052b";
        authors = [
      ...
      "directories" = rec {
        ...
        version = "0.10.0";
        edition = "2015";
        sha256 = "1gqf0niyi8pzwcra9yhdc7s3x16f53nnfszis0hi6vqv0bdn29gw";
        authors = [
        ...
        dependencies = [
          {
            ...
            packageId = "winapi 0.3.8";
            target = { target, features }: target."windows";
            features = [ "knownfolders" "objbase" "shlobj" ];
          }
        ];
      ...
      "enquirer" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1vhvrnmqs04ww2syfr2hwi6jrc06llin2x40sgc281jk9hvwmwrm";
        authors = [
      ...
      "gitmoji" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "gitmoji"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Jonas Geschke <github@yonny.de>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "spinners" = rec {
        ...
        version = "1.2.0";
        edition = "2015";
        sha256 = "0wk43cwk0z8j45vxd1hgzx8f101z2m9ikfwppqv16vn9rsmmcvp2";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
