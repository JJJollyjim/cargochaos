...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/phase21/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bellperson" = rec {
        ...
        version = "0.6.4";
        edition = "2018";
        sha256 = "05dnycgffv1v4bxidbr6s4r11xmz9pky13c1y0q3xyb5cyrq6n4h";
        authors = [
      ...
      "sha2ni" = rec {
        ...
        version = "0.8.3";
        edition = "2015";
        sha256 = "0zgjvrfqk6ixydr23hsv4i0k8k4hv5lxcv7vdfspq1ny3f2rd612";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "fileapi" "handleapi" "memoryapi" "minwindef" "ntsecapi" "processthreadsapi" "profileapi" "std" "sysinfoapi" "winbase" "winerror" "winnt" ];
      };
