...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hecs/v0.2.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hecs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "hecs-macros" "lazy_static" "macros" "std" ];
      };
      "hecs-macros" = rec {
        crateName = "hecs-macros";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1sjjxq8090g9nnrmv0qavjaxmvgddxlx9hv9gy0cyl4q9ap1391g";
        procMacro = true;
        authors = [
          "Benjamin Saunders <ben.e.saunders@gmail.com>"
        ];
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "derive" "parsing" "printing" "proc-macro" "quote" ];
      };
      "unicode-xid" = rec {
