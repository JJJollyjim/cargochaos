...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redis_raw/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "redis_raw" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "tcp" "macros" "rt-core" "dns" "io-util" ];
          }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
