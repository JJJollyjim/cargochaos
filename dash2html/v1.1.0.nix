...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dash2html/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dash2html" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "dash2html"; path = "src/main.rs"; }
        ];
      ...
      "libsqlite3-sys" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "16z5pvs1jvypp36zi2asyvc16650kk7936rq8461hz69kxcsxj6h";
        authors = [
      ...
      "rusqlite" = rec {
        ...
        version = "0.6.1";
        edition = "2015";
        sha256 = "1s56rs4fzgyinygbsjcz3inkla7fmfdlm3ayszf2si5fd0w9j2k4";
        authors = [
          "John Gallagher <jgallagher@bignerdranch.com>"
        ];
        dependencies = [
