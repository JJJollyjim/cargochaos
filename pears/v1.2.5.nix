...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pears/v1.2.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pears" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "pears"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.2.5.nix {};
        authors = [
          "Richard Howard <richard@howard.io>"
        ];
        dependencies = [
          {
            name = "chrono";
