...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xtr/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gettext-rs" = rec {
        ...
        version = "0.4.4";
        edition = "2015";
        sha256 = "0z6fcsn1g3w9mlgfj6ln6qvqf8610w3zwvk6g062h657v114lifz";
        libName = "gettextrs";
        authors = [
      ...
      "gettext-sys" = rec {
        ...
        version = "0.19.9";
        edition = "2015";
        sha256 = "0lzi6ja81vc16mhcdmn3lw35120n9ijhvsy5dh5775mpbfxc8d70";
        libPath = "lib.rs";
        authors = [
      ...
      "locale_config" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "0p2kdgc1c9cq5bi2rpszbhkh7pdk1fwxhij37gayb2alwkmikb3k";
        authors = [
      ...
      "tr" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "gettext-rs" ];
      };
      "unicode-width" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winnls" ];
      };
