...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/trello-rs/v1.21.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "trello-rs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tro"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.21.1.nix {};
        libName = "trello";
        libPath = "src/trello/mod.rs";
        authors = [
