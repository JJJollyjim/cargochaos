...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-fcm1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-fcm1" = rec {
        crateName = "google-fcm1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "1dxafg3x2w039sjzdi0yam92q3rw2nlxdp1wpqcyq64wpcp0d6qz";
        authors = [
      ...
      "google-fcm1-cli" = rec {
        crateName = "google-fcm1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "fcm1"; path = "src/main.rs"; }
        ];
