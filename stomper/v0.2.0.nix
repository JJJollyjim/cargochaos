...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stomper/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libstomper" = rec {
        crateName = "libstomper";
        version = "0.2.0";
        edition = "2018";
        sha256 = "18xwwn2apq6hs5bpy1masgm5hlb4yqd6krwcf9s09yg4hgvlqac0";
        authors = [
          "Santtu Lempinen <santtu.lempinen@helsinki.fi>"
        ];
        dependencies = [
          {
            name = "byteorder";
