...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aparte/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "aparte" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "aparte"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Paul Fariello <paul@fariello.eu>"
        ];
        dependencies = [
          {
            name = "bytes";
          ...
          }
          {
            ...
            packageId = "tokio-file-unix";
          }
          {
            name = "tokio-xmpp";
            packageId = "tokio-xmpp";
          }
          {
            name = "toml";
            packageId = "toml";
          ...
          {
            name = "xmpp-parsers";
            packageId = "xmpp-parsers 0.16.0";
          }
        ];
        features = {
        };
        resolvedDefaultFeatures = [ "no-cursor-save" ];
      };
      "arc-swap" = rec {
        crateName = "arc-swap";
        version = "0.4.3";
      ...
      "jid 0.7.2" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "0g8nvr10n1xg387bin0wwbaswwclwl3p6kkvps3c667xxp4czd1j";
        authors = [
          "lumi <lumi@pew.im>"
      ...
      "jid 0.8.0" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0kprkklksjxqyvv6qjink2dyg8bsfr5j3n2xpn1jjjfaigcaz396";
        authors = [
          "lumi <lumi@pew.im>"
          "Emmanuel Gil Peyrot <linkmauve@linkmauve.fr>"
          "Maxime “pep” Buquet <pep@bouah.net>"
      ...
      "sasl" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "007654lhj7d5lzdq067q9iaik71arl3982fwasnvndmphn67amz4";
        authors = [
          "lumi <lumi@pew.im>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "scram" ];
      };
      "schannel" = rec {
        crateName = "schannel";
        version = "0.1.16";
      ...
      "tokio-file-unix" = rec {
        crateName = "tokio-file-unix";
        version = "0.5.1";
        edition = "2015";
        sha256 = "131fxaygphd1mg82mlbla9gi6bgfcqg69qj6gmh7551p46jf4hkp";
        authors = [
      ...
      "tokio-xmpp" = rec {
        crateName = "tokio-xmpp";
        version = "1.0.1";
        edition = "2018";
        sha256 = "09j1g9f69h2gazi8r5hplhawcd5c63ja9xibq50c7ng16nfjb521";
        authors = [
          "Astro <astro@spaceboyz.net>"
          "Emmanuel Gil Peyrot <linkmauve@linkmauve.fr>"
          "pep <pep+code@bouah.net>"
          "O01eg <o01eg@yandex.ru>"
        ];
        dependencies = [
          {
            name = "bytes";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "xml5ever" = rec {
        ...
        version = "0.15.0";
        edition = "2015";
        sha256 = "1is9c4xm5ddgx4q3fzc5h8zpak3a9sjsw7x60zwc1hxvpxcwm4rb";
        authors = [
      ...
      "xmpp-parsers 0.15.0" = rec {
        crateName = "xmpp-parsers";
        version = "0.15.0";
        edition = "2018";
        sha256 = "00lhnyf684g0pgj32kin86fc6hlv92047vfqxv56c6q1q1biz6ap";
        authors = [
          "Emmanuel Gil Peyrot <linkmauve@linkmauve.fr>"
          "Maxime “pep” Buquet <pep@bouah.net>"
        ];
      ...
      "xmpp-parsers 0.16.0" = rec {
        crateName = "xmpp-parsers";
        version = "0.16.0";
        edition = "2018";
        sha256 = "1q2hrlcl4327xrnd3xqkkwx6lmnncv3vgjmhc83lq3n4symar03k";
        authors = [
          "Emmanuel Gil Peyrot <linkmauve@linkmauve.fr>"
          "Maxime “pep” Buquet <pep@bouah.net>"
        ];
