...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dfareporting3d2-cli/v1.0.13+20190531.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-dfareporting3d2-cli";
  ...
  workspaceMembers = {
    "google-dfareporting3d2-cli" = rec {
      packageId = "google-dfareporting3d2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-dfareporting3d2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dfareporting3d2" = rec {
        crateName = "google-dfareporting3d2";
        version = "1.0.13+20190531";
        edition = "2015";
        sha256 = "0iaywxq8ipd9vm729v69r8s1qafxrkw55143nivmbxijx0nj24f2";
        authors = [
      ...
      "google-dfareporting3d2-cli" = rec {
        crateName = "google-dfareporting3d2-cli";
        version = "1.0.13+20190531";
        edition = "2015";
        crateBin = [
          { name = "dfareporting3d2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190531.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-dfareporting3d2";
          }
          {
            name = "hyper";
            packageId = "hyper";
