...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/memory-balloon/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "memory-balloon" = rec {
        crateName = "memory-balloon";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "balloon"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "memoryapi" "minwinbase" "minwindef" "processenv" "sysinfoapi" "winbase" "winnt" ];
      };
