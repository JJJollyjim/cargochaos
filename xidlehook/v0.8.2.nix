...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xidlehook/v0.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xidlehook-core" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0szxy6asbh6379h130gnf8n8bpma1qdra8735dg8x57p1bzdrkkf";
        authors = [
          "jD91mZM2 <me@krake.one>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "async-std" "libpulse-binding" "pulse" ];
      };
    };
