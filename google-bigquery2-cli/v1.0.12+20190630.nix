...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-bigquery2-cli/v1.0.12+20190630.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-bigquery2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-bigquery2" = rec {
        crateName = "google-bigquery2";
        version = "1.0.12+20190630";
        edition = "2015";
        sha256 = "00x7xgmpvmilqf16gjh7dx0kyy3h4ic9al2f09r4j43z083rbnfw";
        authors = [
      ...
      "google-bigquery2-cli" = rec {
        crateName = "google-bigquery2-cli";
        version = "1.0.12+20190630";
        edition = "2015";
        crateBin = [
          { name = "bigquery2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190630.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
