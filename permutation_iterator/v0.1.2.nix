...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/permutation_iterator/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "permutation_iterator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "permutation_iterator" = rec {
        crateName = "permutation_iterator";
        version = "0.1.2";
        edition = "2018";
