...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alder/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "alder" = rec {
        ...
        resolvedDefaultFeatures = [ "alder-derive" "derive" "termion" "tty" ];
      };
      "alder-derive" = rec {
        crateName = "alder-derive";
        version = "0.2.3";
        edition = "2018";
        sha256 = "1a1dc5ikn5k1kbcw5zrb36q54xwi5s6pdsm01dy08nys0h0jliv2";
        procMacro = true;
        authors = [
          "Wojciech Polak <frondeus@gmail.com>"
        ];
