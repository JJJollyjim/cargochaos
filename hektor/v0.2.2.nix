...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hektor/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hektor" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "free_functions" "mint" "serde" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.60";
      ...
      "lokacore" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "064jmbgassm1ss7vb2k221m1kvgp6ddy9z743ibgw4qwapn5svmv";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
          {
            name = "libm";
            packageId = "libm";
            target = { target, features }: (!((target."feature" == "sse") && (target."feature" == "sse2")));
          }
        ];
        features = {
        };
      ...
      "randomize" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0sxfh1h7j72n24sn81gp61parpb75flsvb9d1lqfyy125jq8pkvn";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
