...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/limitation-proxy/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "strsim" "suggestions" "term_size" "wrap_help" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
      ...
      "limitation" = rec {
        crateName = "limitation";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1m96yxhjpdsmkkll5cdknpw5xivd6gylp6911w2zfc1rjq9m8hby";
        authors = [
      ...
      "limitation-actix-middleware" = rec {
        crateName = "limitation-actix-middleware";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1cc2w03j3rlzm9zpxq5bviinml06pfhc21c3dpb3cy3p67ywh6gi";
        authors = [
          "Fletcher Nichol <fnichol@nichol.ca>"
        ];
        dependencies = [
      ...
      "limitation-proxy" = rec {
        crateName = "limitation-proxy";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "limitation-proxy"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "limitation-actix-middleware";
            packageId = "limitation-actix-middleware";
          }
          {
            name = "log";
            packageId = "log";
      ...
      "structopt" = rec {
        ...
        resolvedDefaultFeatures = [ "suggestions" "wrap_help" ];
      };
