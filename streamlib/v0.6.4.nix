...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/streamlib/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "duct" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1ir3884i1yznkfdccqqbcb9v5sdpcgxlv41hgzncrqaljv18r0wj";
        authors = [
      ...
      "streamlib" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "streamlib"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
