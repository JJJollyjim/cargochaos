...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/whalespotter/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "open" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0pz0s84rx36fa42lz8ad50498rl3hk055r6fav2ccddplfyllb4x";
        authors = [
      ...
      "whalespotter" = rec {
        crateName = "whalespotter";
        version = "0.1.5";
        edition = "2018";
        crateBin = [
          { name = "whalespotter"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwindef" "ntstatus" "processenv" "shellapi" "synchapi" "winbase" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
