...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/askii/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "maplit" "ncurses" "ncurses-backend" "pancurses" "pancurses-backend" "term_size" "unstable_scroll" ];
      };
      "darling" = rec {
        crateName = "darling";
        version = "0.10.2";
