...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/askii/v0.5.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pathfinding" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "1ykh07w5h9w35jmjigkwkydrvy2j6kdirsilwzca0z2jmay0pyab";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "shellapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winuser" ];
      };
      "winapi-build" = rec {
