...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-i18n/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-i18n" = rec {
        crateName = "mdbook-i18n";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "mdbook-i18n"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "funkill2 <funkill2@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
