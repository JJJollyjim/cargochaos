...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bitcoincash-addr/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitcoincash-addr" = rec {
        crateName = "bitcoincash-addr";
        version = "0.2.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Harry L. Barber <harrybarber@protonmail.com>"
        ];
        dependencies = [
          {
            name = "bitcoin_hashes";
