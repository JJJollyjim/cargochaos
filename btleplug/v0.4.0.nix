...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/btleplug/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "dbghelp" "errhandlingapi" "handleapi" "hstring" "minwindef" "ntsecapi" "ntstatus" "oleauto" "processthreadsapi" "profileapi" "restrictederrorinfo" "roapi" "roerrorapi" "winbase" "winerror" "winnt" "winsock2" "winstring" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
