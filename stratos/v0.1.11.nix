...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stratos/v0.1.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kern" = rec {
        ...
        version = "1.1.6";
        edition = "2018";
        sha256 = "0v9lj1ma7wzmxyryifg4d6128rbklx9gwprlnd441gcmad32j493";
        authors = [
      ...
      "lhi" = rec {
        ...
        edition = "2018";
        sha256 = "0l8fsxpy15v3j4i40fkg9pmim9hixcj9l6xfk47rjl772xfzha6p";
        authors = [
          "Lennart Heinrich <lennart@ltheinrich.de>"
        ];
        dependencies = [
      ...
      "plotlib" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0hnjl32ja7q37qlxi145vk8hp2cb3i7pdizh4mk0z3bxk17i0qll";
        authors = [
