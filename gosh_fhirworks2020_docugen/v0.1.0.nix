...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gosh_fhirworks2020_docugen/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "gosh_fhirworks2020_docugen";
  ...
  workspaceMembers = {
    "gosh_fhirworks2020_docugen" = rec {
      packageId = "gosh_fhirworks2020_docugen";
      build = internal.buildRustCrateWithFeatures {
        packageId = "gosh_fhirworks2020_docugen";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gosh_fhirworks2020_docugen" = rec {
        crateName = "gosh_fhirworks2020_docugen";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "docugen_bin"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        libName = "docugen";
        authors = [
          "许杰友 Jieyou Xu (Joe) <jieyouxu@outlook.com>"
        ];
        dependencies = [
          {
            name = "env_logger";
