...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/myxine/v0.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-usse" = rec {
        crateName = "hyper-usse";
        version = "0.3.1";
        edition = "2018";
        sha256 = "0mp470glvdgbkb36zlvmxd4w205w0ldhjrlsnjg8rgsnpvax4scm";
        authors = [
      ...
      "myxine" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "myxine"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.2.nix {};
        authors = [
          "Kenny Foner <kwf@very.science>"
        ];
        dependencies = [
          {
            name = "bytes";
