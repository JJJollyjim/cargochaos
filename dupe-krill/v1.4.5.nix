...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dupe-krill/v1.4.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dupe-krill" = rec {
        crateName = "dupe-krill";
        version = "1.4.5";
        edition = "2018";
        crateBin = [
          { name = "dupe-krill"; path = "src/bin.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwindef" "ntsecapi" "profileapi" "std" "synchapi" "winbase" "winerror" "winnt" ];
      };
