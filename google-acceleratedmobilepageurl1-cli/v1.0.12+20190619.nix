...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-acceleratedmobilepageurl1-cli/v1.0.12+20190619.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-acceleratedmobilepageurl1-cli";
  ...
  workspaceMembers = {
    "google-acceleratedmobilepageurl1-cli" = rec {
      packageId = "google-acceleratedmobilepageurl1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-acceleratedmobilepageurl1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-acceleratedmobilepageurl1" = rec {
        crateName = "google-acceleratedmobilepageurl1";
        version = "1.0.12+20190619";
        edition = "2015";
        sha256 = "1k9vd85vwxp9zvrqnj4p26fgs0xzy3r1xmsnz4l3lwyazn2jkwlj";
        authors = [
      ...
      "google-acceleratedmobilepageurl1-cli" = rec {
        crateName = "google-acceleratedmobilepageurl1-cli";
        version = "1.0.12+20190619";
        edition = "2015";
        crateBin = [
          { name = "acceleratedmobilepageurl1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190619.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-acceleratedmobilepageurl1";
          }
          {
            name = "hyper";
            packageId = "hyper";
