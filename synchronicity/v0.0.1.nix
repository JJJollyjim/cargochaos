...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/synchronicity/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "synchronicity" = rec {
        crateName = "synchronicity";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "synchronicity"; path = "src/bin/synchronicity/main.rs"; }
        ];
