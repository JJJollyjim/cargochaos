...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evtx/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evtx" = rec {
        ...
        resolvedDefaultFeatures = [ "anyhow" "backtraces" "clap" "default" "dialoguer" "evtx_dump" "indoc" "multithreading" "rayon" "simplelog" ];
      };
      "failure" = rec {
        crateName = "failure";
        version = "0.1.6";
      ...
      "winstructs" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "18sn7fp9gnj8fikpvsdvxj7714lpps9ayw5x3xy7jvf5iqvkvfdw";
        authors = [
          "Omer Ben-Amram <omerbenamram@gmail.com>"
