...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evtx/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "snafu 0.4.1" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0kqfn3p3qw4lz9gpa8wm8wa5bcjljs0sn74vixnb1k754qr3a4jp";
        authors = [
        ...
        resolvedDefaultFeatures = [ "backtrace" "backtraces" "default" "rust_1_30" ];
      };
      "snafu 0.5.0" = rec {
        crateName = "snafu";
        version = "0.5.0";
      ...
      "snafu-derive 0.4.1" = rec {
        crateName = "snafu-derive";
        version = "0.4.1";
        edition = "2015";
        sha256 = "1vllp2h2qb88br7l7zmp49585i0jcimv4gvfp85xg8id0jq8y5vq";
        procMacro = true;
        authors = [
          "Jake Goulding <jake.goulding@gmail.com>"
        ];
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
