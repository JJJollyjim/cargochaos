...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evtx/v0.6.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evtx" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.6.5.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "anyhow" "clap" "default" "dialoguer" "evtx_dump" "fast-alloc" "indoc" "jemallocator" "multithreading" "rayon" "rpmalloc" "simplelog" ];
      };
      "failure" = rec {
        crateName = "failure";
        version = "0.1.6";
      ...
      "rpmalloc" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "05f7029m0hnbzznmzy40x5rc4zv84dnzwzixaaz5059jaa1ja1br";
        authors = [
        ...
        dependencies = [
          {
            name = "rpmalloc-sys";
            packageId = "rpmalloc-sys";
            features = [ "preload" ];
          }
        ];
        features = {
          "adaptive_thread_cache" = [ "rpmalloc-sys/adaptive_thread_cache" ];
          "asserts" = [ "rpmalloc-sys/asserts" ];
          "global_cache" = [ "rpmalloc-sys/global_cache" ];
          "guards" = [ "rpmalloc-sys/guards" ];
          "statistics" = [ "rpmalloc-sys/statistics" ];
          "thread_cache" = [ "rpmalloc-sys/thread_cache" ];
          "unlimited_cache" = [ "rpmalloc-sys/unlimited_cache" ];
          "unlimited_global_cache" = [ "rpmalloc-sys/unlimited_global_cache" ];
          "unlimited_thread_cache" = [ "rpmalloc-sys/unlimited_thread_cache" ];
          "validate_args" = [ "rpmalloc-sys/validate_args" ];
        };
        resolvedDefaultFeatures = [ "default" ];
      };
      "rpmalloc-sys" = rec {
        crateName = "rpmalloc-sys";
        version = "0.1.3";
        edition = "2018";
        sha256 = "0882k6y5ma7vqibsv4b39s7akrd8aizd6a4y4iqz588mdgzmbnq9";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Johan Andersson <repi@repi.se>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "preload" ];
      };
      "rust-argon2" = rec {
