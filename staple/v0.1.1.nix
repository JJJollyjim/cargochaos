...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/staple/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "file-lock" = rec {
        ...
        version = "1.1.20";
        edition = "2015";
        sha256 = "18ki56lv3yjid8k6yb02h5advxgs4jcny2q9xw64hh9pkciqcr5i";
        authors = [
      ...
      "staple" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "staple"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Kilerd Chan <blove694@gmail.com>"
        ];
        dependencies = [
          {
            name = "actix";
      ...
      "thiserror" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "08x7i1pqw9z1xcg96w33dnm93vind5ilhgfkj41xzdv9ld1ph1kr";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "thiserror-impl" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "1aarcl0alfmxig20giffw1s5kfsmkhd61038v1gk8yx06xc23iid";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
