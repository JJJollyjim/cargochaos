...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/watchman_client/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "proc-macro-error" = rec {
        ...
        version = "0.4.6";
        edition = "2018";
        sha256 = "0axc4sb8xyx6ahwfnzzz8faza0xd9w0vvxl0jwhpm59329mif9x4";
        authors = [
      ...
      "proc-macro-error-attr" = rec {
        ...
        version = "0.4.6";
        edition = "2018";
        sha256 = "05kzzk5hlwqxhynbv3jq87a764988bwsbkwf6kdk0gxf1sm4sghz";
        procMacro = true;
        authors = [
          "CreepySkeleton <creepy-skeleton@yandex.ru>"
        ];
      ...
      "serde_bser" = rec {
        crateName = "serde_bser";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0my5vlpbsnp2z4l5isxy0yhl7qh2ain710dn5h7wcw35fh4af5y1";
        authors = [
          "Rain <rain1@fb.com>"
          "Wez Furlong"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "sync" "tokio-macros" "uds" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "watchman_client" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "macros" "process" "rt-core" "sync" "uds" ];
          }
          {
            name = "winapi";
            packageId = "winapi 0.3.8";
            target = { target, features }: target."windows";
            features = [ "handleapi" "winuser" ];
          }
        ];
        devDependencies = [
          {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "std" "synchapi" "threadpoollegacyapiset" "winbase" "winerror" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
