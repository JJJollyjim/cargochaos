...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fancy-prompt/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fancy-prompt" = rec {
        crateName = "fancy-prompt";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "fancy-prompt"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "verbose" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.13";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "wow64apiset" ];
      };
      "winapi-build" = rec {
