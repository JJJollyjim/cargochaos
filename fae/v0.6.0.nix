...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fae/v0.6.0.nix.tmp"
    ...
    crates = {
      ...
      "core-text" = rec {
        ...
        dependencies = [
          ...
          {
            name = "core-graphics";
            packageId = "core-graphics 0.14.0";
          }
          {
            name = "foreign-types";
            packageId = "foreign-types";
      ...
      "fae" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "font8x8" "lazy_static" "png" "profiler" "rusttype" "stb_truetype" "text" "ttf" ];
      };
      "filetime" = rec {
        crateName = "filetime";
        version = "0.2.8";
