...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mangaplus-parser-json/v0.3.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mangaplus-parser-json";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mangaplus-parser" = rec {
        crateName = "mangaplus-parser";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1jdlvszif00lnjx52bn3z71xa8a9c8kh3xxsi6b0gs0gb215skhk";
        authors = [
      ...
      "mangaplus-parser-json" = rec {
        crateName = "mangaplus-parser-json";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "mangaplus-parser"; path = "mangaplus-parser.rs"; }
        ];
