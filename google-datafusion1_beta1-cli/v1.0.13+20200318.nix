...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-datafusion1_beta1-cli/v1.0.13+20200318.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-datafusion1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "0bqkrc0xlp01m33azjcxidvsrcl0gr9nj3bkdn2wyyhrsxs1l7w1";
        authors = [
      ...
      "google-datafusion1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200318.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
