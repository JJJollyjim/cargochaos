...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-datafusion1_beta1-cli/v1.0.12+20190617.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-datafusion1_beta1-cli";
  ...
  workspaceMembers = {
    "google-datafusion1_beta1-cli" = rec {
      packageId = "google-datafusion1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-datafusion1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-datafusion1_beta1" = rec {
        crateName = "google-datafusion1_beta1";
        version = "1.0.12+20190617";
        edition = "2015";
        sha256 = "13ipcazra7kj3iz7akj6h4mcmd4m9njk326c1nvv6pra54kcbrl3";
        authors = [
      ...
      "google-datafusion1_beta1-cli" = rec {
        crateName = "google-datafusion1_beta1-cli";
        version = "1.0.12+20190617";
        edition = "2015";
        crateBin = [
          { name = "datafusion1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-datafusion1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
