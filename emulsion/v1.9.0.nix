...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/emulsion/v1.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "emulsion" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "emulsion"; path = "src/main.rs"; }
        ];
      ...
      "gelatin" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1fm5w2qlr6x82k1y8rwxzw4i243q3ifh528iabkg4amfywjmf2fk";
        authors = [
          "Artur Barnabas <kovacs.artur.barnabas@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "commctrl" "consoleapi" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "impl-debug" "impl-default" "libloaderapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shellapi" "shellscalingapi" "shobjidl_core" "sspi" "std" "sysinfoapi" "timezoneapi" "unknwnbase" "winbase" "wincon" "wincrypt" "windowsx" "winerror" "wingdi" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
