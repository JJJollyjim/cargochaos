...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/csound/v0.1.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "csound-sys" = rec {
        crateName = "csound-sys";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0fgyphfq9pf5fkmiddr3nvap5wg9gmfcqrlys9j1n4gdx9liicc6";
        authors = [
          "Natanael Mojica <neithanmo@gmail.com>"
        ];
        dependencies = [
      ...
      "va_list" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "19g78bc8lpfaf27818irfrkxbjb15wf9ygvbvd7i74nss58ldjwk";
        authors = [
