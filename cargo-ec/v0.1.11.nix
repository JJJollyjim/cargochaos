...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-ec/v0.1.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-ec" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-ec"; path = "src/main.rs"; }
        ];
      ...
      "ec-client" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0sqkdxdn3xhggbch1c31q0g0ks8qd2n8brxqclfswy17yq7ivb3w";
        authors = [
          "Mason Fischer <mason@kissr.co>"
        ];
        dependencies = [
      ...
      "lazy-static-include" = rec {
        ...
        version = "2.0.1";
        edition = "2015";
        sha256 = "02hcsikiy8vs5a2flaah59n168k46y5120h6a12n766y84pklyii";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "starts-ends-with-caseless" "syn" ];
      };
      "lazy_static" = rec {
      ...
      "starts-ends-with-caseless" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1iqkqq1bsyl2vd0m113d7km2jha2kbw6lmjjqwamrwbpc2x6gy7n";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        features = {
      ...
      "walrus" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "111h6frn4dyc5h61rpxbdg59drmwga7gry475qkkgqv0cyg7vi53";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
        dependencies = [
      ...
      "walrus-macro" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "10ppqjszrzm8q718dpky80yr04a3di60knjcv5hzywmq71km1vw7";
        procMacro = true;
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
      ...
      "wasm-snip" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0dasl1zja0kvzzl521gc7pqql76l2rdzx1167mqlv4fsmg2m5gq0";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
