...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shell-rs/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nc" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "1gk3mdjzj391xykfzsklrk067jf2rk5pp3vj905vslbmrzqxdg90";
        authors = [
          "Xu Shaohua <xushaohua2016@outlook.com>"
        ];
