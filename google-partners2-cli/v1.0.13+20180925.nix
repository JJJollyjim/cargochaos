...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-partners2-cli/v1.0.13+20180925.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-partners2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-partners2" = rec {
        crateName = "google-partners2";
        version = "1.0.13+20180925";
        edition = "2015";
        sha256 = "05rxa6l2gpjybd2ypk3yfdx9j0pzk87fsh2c8qni068ial2b3gpb";
        authors = [
      ...
      "google-partners2-cli" = rec {
        crateName = "google-partners2-cli";
        version = "1.0.13+20180925";
        edition = "2015";
        crateBin = [
          { name = "partners2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20180925.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
