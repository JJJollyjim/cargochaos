...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fleetspeak/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fleetspeak-proto" = rec {
        crateName = "fleetspeak-proto";
        version = "0.1.1";
        edition = "2018";
        sha256 = "15g1n61f00mywdpx7wmqrrsj366ljfj3qiq6gxbqm1fsz5irqj3a";
        authors = [
          "Łukasz Hanuszczak <hanuszczak@google.com>"
        ];
        dependencies = [
