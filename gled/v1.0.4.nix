...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gled/v1.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cairo-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "glib" "glib-sys" "gobject-sys" "png" "use_glib" "v1_14" ];
      };
      "cairo-sys-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "glib-sys" "png" "use_glib" "v1_14" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "libgled" = rec {
        ...
        version = "1.0.4";
        edition = "2018";
        sha256 = "0ffyblmdiikdwhdxxm9hiffp0aisy6388z9rqa2q3lw12b1i3h3c";
        libName = "gled";
        authors = [
          "René Rössler <rene@freshx.de>"
        ];
