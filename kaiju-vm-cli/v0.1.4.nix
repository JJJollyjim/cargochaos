...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kaiju-vm-cli/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kaiju-compiler-cli-core" = rec {
        crateName = "kaiju-compiler-cli-core";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1a391cpggn146rzbwpiywf01lr4fvws2541bwamp3dlhml35f3bm";
        authors = [
          "Patryk 'PsichiX' Budzynski <psichix@gmail.com> (https://psichix.io)"
        ];
        dependencies = [
          {
            name = "kaiju-compiler-core";
            packageId = "kaiju-compiler-core";
          }
          {
            name = "kaiju-core";
            packageId = "kaiju-core";
          }
          {
            name = "lazy_static";
      ...
      "kaiju-compiler-core" = rec {
        crateName = "kaiju-compiler-core";
        version = "0.1.4";
        edition = "2018";
        sha256 = "10yx5jlh4clf88sn70v5bixwgr63gghk2wba6qzkhpaiyinnj5qy";
        authors = [
          "Patryk 'PsichiX' Budzynski <psichix@gmail.com> (https://psichix.io)"
        ];
        dependencies = [
      ...
      "kaiju-core" = rec {
        crateName = "kaiju-core";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1wcy148xi7srhw07if6ssnqb66amg9v8glg9d68ya3p6rh4ylzlf";
        authors = [
          "Patryk 'PsichiX' Budzynski <psichix@gmail.com> (https://psichix.io)"
        ];
        dependencies = [
      ...
      "kaiju-vm-cli" = rec {
        crateName = "kaiju-vm-cli";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "keijo"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "kaiju-compiler-cli-core";
            packageId = "kaiju-compiler-cli-core";
          }
          {
            name = "kaiju-core";
            packageId = "kaiju-core";
      ...
      "kaiju-vm-core" = rec {
        crateName = "kaiju-vm-core";
        version = "0.1.4";
        edition = "2018";
        sha256 = "0k4aqmqzn36jbjasap5j9b8wlrzli7b7zyjvirww97aclvflnj9h";
        authors = [
          "Patryk 'PsichiX' Budzynski <psichix@gmail.com> (https://psichix.io)"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "winbase" "winerror" ];
      };
