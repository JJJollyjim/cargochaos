...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tydi/v0.0.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tydi" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tydi"; path = "src/bin/tydi.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "cli" "default" "generator" "nom" "parser" "structopt" ];
      };
