...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wifi-qr-code/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "qrcode-generator" = rec {
        ...
        version = "1.0.5";
        edition = "2015";
        sha256 = "0610454nqm097jyxvrkjc92vjpgnqcz10j4l09h7f968v7krdpzg";
        authors = [
      ...
      "rc-writer" = rec {
        ...
        version = "1.1.6";
        edition = "2018";
        sha256 = "019yd9xa93lvmjjkm25hxyxg5b76avsl0qcwiaw6fllbdbp36x6r";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
      ...
      "wifi-qr-code" = rec {
        crateName = "wifi-qr-code";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Amy Keibler <wanderingelf14@gmail.com>"
        ];
        dependencies = [
          {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "std" "winbase" "wincon" "winnt" ];
      };
