...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reed/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rdkafka" = rec {
        ...
        resolvedDefaultFeatures = [ "cmake-build" "default" "libz" ];
      };
      "rdkafka-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "cmake" "cmake-build" "libz" "libz-sys" ];
      };
      "redox_syscall" = rec {
      ...
      "reed" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "reed"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Simon Dickson <simonhdickson@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "argh";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-core" "macros" "stream" ];
          }
          {
            name = "tonic";
            packageId = "tonic";
