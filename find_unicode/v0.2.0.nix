...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/find_unicode/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "find_unicode" = rec {
        crateName = "find_unicode";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "fu"; path = "src/main.rs"; }
          { name = "gen_data"; path = "src/gen_data.rs"; }
        ];
