...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/proxy_cfg/v0.3.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "proxy_cfg" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "env" "sysconfig_proxy" ];
      };
      "rand 0.3.23" = rec {
        crateName = "rand";
        version = "0.3.23";
      ...
      "system-configuration-sys" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "16ddk13k77v091zd78y0y4h6ih1ai41vy5zmzm5hhm1di2i0dndz";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntsecapi" "profileapi" "timezoneapi" "winerror" "winhttp" "winnt" "winreg" ];
      };
      "winapi-build" = rec {
