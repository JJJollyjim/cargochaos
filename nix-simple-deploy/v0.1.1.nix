...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nix-simple-deploy/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nix-simple-deploy" = rec {
        crateName = "nix-simple-deploy";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "nix-simple-deploy"; path = "src/main.rs"; }
        ];
