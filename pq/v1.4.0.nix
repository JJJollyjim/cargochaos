...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pq/v1.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "erased_serde_json" = rec {
        crateName = "erased_serde_json";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1vj7aswi8d5451fq0pqv0is5q16i9axib9l2d6x99bhrcbs475p7";
        authors = [
          "Sevag Hanssian <sevag.hanssian@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "stream_delimit" = rec {
        crateName = "stream_delimit";
        version = "0.5.5";
        edition = "2018";
        sha256 = "1s5yyr3n07cnbf10an3a0389nyfnblnhhy1k8w9si4hbl41pq9bf";
        authors = [
          "Sevag Hanssian <sevag.hanssian@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "kafka" "with_kafka" ];
      };
      "strsim" = rec {
        crateName = "strsim";
        version = "0.8.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "winerror" "winnt" ];
      };
