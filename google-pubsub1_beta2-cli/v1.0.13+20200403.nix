...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-pubsub1_beta2-cli/v1.0.13+20200403.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-pubsub1_beta2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-pubsub1_beta2" = rec {
        crateName = "google-pubsub1_beta2";
        version = "1.0.13+20200403";
        edition = "2015";
        sha256 = "19415i6giiapd8md72kwblar9a9b3xc6sfkrc1q8dz8xlw6ww712";
        authors = [
      ...
      "google-pubsub1_beta2-cli" = rec {
        crateName = "google-pubsub1_beta2-cli";
        version = "1.0.13+20200403";
        edition = "2015";
        crateBin = [
          { name = "pubsub1-beta2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-pubsub1_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
