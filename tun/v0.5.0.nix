...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tun/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hwaddr" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "0rfvcarhws1nwyn1gvi1l13ip3viln0j1hsr6sa4mkid1z41xbjx";
        authors = [
      ...
      "ioctl-sys" = rec {
        ...
        version = "0.5.2";
        edition = "2015";
        sha256 = "0jjh6fggwd9akklwcgcqyz9ijd79k6yskkx7ijmfm5i46lk4nb2y";
        authors = [
      ...
      "packet" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "1xmlf81iykf2qbihb7bl39z3vd1ivz2hzs2clrdn42kzgj2p97qn";
        authors = [
          "meh. <meh@schizofreni.co>"
        ];
        dependencies = [
      ...
      "tun" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "byteorder" "bytes" "mio" "tokio" "tokio-util" ];
      };
      "unicase" = rec {
        crateName = "unicase";
        version = "2.6.0";
