...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/procdump/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "procdump" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "procdump"; path = "src/main.rs"; }
        ];
      ...
      "procfs" = rec {
        ...
        version = "0.7.6";
        edition = "2018";
        sha256 = "14xr72ya74zwsxlwswcim4gaqjl3w6zavxw4il924iakhghz7a0k";
        authors = [
          "Andrew Chin <achin@eminence32.net>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winnt" ];
      };
