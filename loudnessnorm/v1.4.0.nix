...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/loudnessnorm/v1.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "loudnessnorm" = rec {
        crateName = "loudnessnorm";
        version = "1.4.0";
        edition = "2018";
        crateBin = [
          { name = "loudnessnorm"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.4.0.nix {};
        authors = [
          "nullvideo <bsantanu381@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
