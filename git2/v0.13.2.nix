...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git2/v0.13.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git2" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "https" "openssl-probe" "openssl-sys" "ssh" "ssh_key_from_memory" "unstable" "vendored-openssl" ];
      };
      "heck" = rec {
        crateName = "heck";
        version = "0.3.1";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" ];
      };
