...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/metro_m0/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "metro_m0" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "unproven" "use_rtt" ];
      };
      "nb" = rec {
        crateName = "nb";
        version = "0.1.2";
      ...
      "sx1509" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0jgncbpfdnlw03vnvj1kjddjk1haarmlcrhv5gvlm43lp6kpi43h";
        authors = [
          "Wez Furlong"
        ];
        dependencies = [
