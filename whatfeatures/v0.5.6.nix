...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/whatfeatures/v0.5.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        resolvedDefaultFeatures = [ "compress" "default" "json" "libflate" "native-tls" "serde" "serde_json" "tls" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "0.1.7";
      ...
      "lexical_bool" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "13cmp1f8h46h1im558j6s1vdwk9y51yv9ghfyla72jhg4marf495";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwindef" "ntstatus" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" ];
      };
