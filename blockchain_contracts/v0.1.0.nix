...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blockchain_contracts/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitcoin" = rec {
        ...
        version = "0.19.2";
        edition = "2015";
        sha256 = "18snkrd85hnwnqrbnz3mvlragx3cxy28jah3cwdwmhjh54zkblag";
        authors = [
      ...
      "bitcoincore-rpc" = rec {
        ...
        version = "0.8.0-rc1";
        edition = "2015";
        sha256 = "1vlxl3lrfhbfaijlvxzv2qck08hanz18x09ri5sk3b8yhnhs3kyw";
      ...
      "bitcoincore-rpc-json" = rec {
        ...
        version = "0.8.0-rc1";
        edition = "2015";
        sha256 = "16jijmfi5b62gvk4kh9pxg6sb2dxpwmlsdd9vwsrndjbv4iaggrk";
      ...
      "ethereum-types" = rec {
        ...
        dependencies = [
          ...
          {
            name = "primitive-types";
            packageId = "primitive-types 0.3.0";
            usesDefaultFeatures = false;
            features = [ "rlp" "byteorder" "rustc-hex" ];
          }
          {
            name = "uint";
            packageId = "uint 0.7.1";
            usesDefaultFeatures = false;
          }
        ];
        features = {
      ...
      "impl-codec 0.4.1" = rec {
        crateName = "impl-codec";
        version = "0.4.1";
        edition = "2015";
        sha256 = "1lr1dw4w7a8c7k2z1si1fbwy4ybdxc2pnbmkagym0k2ja5i0i81z";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "parity-scale-codec" = rec {
        ...
        version = "1.0.6";
        edition = "2018";
        sha256 = "0s1n5jnhd43jx9p9f8vqcnr9jb3bs5j4yy3s3hr3ynfqaswvn7q0";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "heapapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
