...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/septid/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "septid" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "septid"; path = "src/bin/septid.rs"; }
          { name = "sockaddr"; path = "src/bin/sockaddr.rs"; }
        ];
        ...
        features = {
          "cli" = [ "clap" "getopts" "pretty_env_logger" ];
          "server" = [ "futures" "pin-utils" "tokio" ];
        };
        resolvedDefaultFeatures = [ "clap" "cli" "default" "futures" "getopts" "pin-utils" "pretty_env_logger" "server" "tokio" ];
      };
      "sha2" = rec {
        crateName = "sha2";
        version = "0.8.1";
