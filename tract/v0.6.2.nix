...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tract/v0.6.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "box_drawing" = rec {
        crateName = "box_drawing";
        version = "0.1.2";
        edition = "2015";
        sha256 = "0jx4rrxy4xmgmplmgl398vrng67sfl8qny7n7d91fyw6zpaxh9za";
        authors = [
          "Agent Alfa <chronos.alfa@atlas.cz>"
        ];
      ...
      "ndarray-npy" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1xggzaxmvkaw81fz8mrb71if5j28r9gzccaym5bkpm37l8421cxw";
        authors = [
      ...
      "py_literal" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "12i5rjyfy8dxcai0rpspvma0562vz403hn83r9bfn5ib9nnv3nz8";
        authors = [
      ...
      "readings-probe" = rec {
        crateName = "readings-probe";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1cxfzqag8bx0agywjmggffrn8klj2nnj3sb3xpndgv38mvafwc5i";
        authors = [
      ...
      "tract" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tract-kaldi";
            packageId = "tract-kaldi";
            optional = true;
          }
          {
            name = "tract-onnx";
            packageId = "tract-onnx";
            optional = true;
          }
          {
        ...
        resolvedDefaultFeatures = [ "conform" "default" "kaldi" "onnx" "tf" "tract-kaldi" "tract-onnx" "tract-tensorflow" ];
      };
      "tract-core" = rec {
      ...
      "tract-kaldi" = rec {
        crateName = "tract-kaldi";
        version = "0.6.2";
        edition = "2018";
        sha256 = "1iwydf7mjxg9h0hrj13bkpvyvvyxar7lg3biym1kasdn5mak37yq";
        authors = [
          "Mathieu Poumeyrol <kali@zoy.org>"
      ...
      "tract-onnx" = rec {
        crateName = "tract-onnx";
        version = "0.6.2";
        edition = "2018";
        sha256 = "1ahzx3df84dqw964yzza0c88bwfac8pp2sy71f9r07y444x4kxan";
        authors = [
          "Mathieu Poumeyrol <kali@zoy.org>"
        ];
        dependencies = [
      ...
      "tract-tensorflow" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "1bfxdl92p7rcy6s4mq88n17xfklrsy109wai7ngll7zcfad25ipy";
        authors = [
          "Mathieu Poumeyrol <kali@zoy.org>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "processenv" "processthreadsapi" "profileapi" "psapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
