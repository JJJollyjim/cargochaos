...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mcr/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "extendhash" = rec {
        crateName = "extendhash";
        version = "1.0.8";
        edition = "2018";
        sha256 = "1qd51fivdsmawwvvshbi7wgih02npm46v3hvx7x4jqd2k18zl880";
        authors = [
