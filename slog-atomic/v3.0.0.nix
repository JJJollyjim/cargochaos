...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/slog-atomic/v3.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "arc-swap" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1iym22lis9i1mzsj12w96hjgcfbf0rp80ilympf3sd5apilc8hvf";
        authors = [
