...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lognplot/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lognplot" = rec {
        ...
        features = {
          "cairo" = [ "cairo-rs" ];
          "server" = [ "tokio" "futures" "serde" "serde_cbor" ];
        };
        resolvedDefaultFeatures = [ "cairo" "cairo-rs" "futures" "serde" "serde_cbor" "server" "tokio" ];
      };
      "maybe-uninit" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "windef" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
