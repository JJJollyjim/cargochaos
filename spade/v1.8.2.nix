...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spade/v1.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rc" "serde_derive" "std" ];
      };
      "serde_derive" = rec {
      ...
      "spade" = rec {
        ...
        version = "1.8.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.8.2.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "serde" "serde_derive" "serde_serialize" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.5";
