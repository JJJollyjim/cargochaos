...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-deny/v0.3.0-beta.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "askalono" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1qgiqfpqf815wqmfx09r9y8f6avi3pajzk7v0mn5prdkzhyy0bg6";
        authors = [
      ...
      "cargo-deny" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.0-beta.nix {};
        authors = [
      ...
      "spdx" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "10jadi3w3bq2c9k7zlp7yn51q5fmjai51jik5hl69hvcfxxj977a";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
