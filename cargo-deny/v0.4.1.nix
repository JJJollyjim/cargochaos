...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-deny/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitvec" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "0ifp53flrpsk91490j9abszqqk0dfnmzynzkyc6iy4fdrl02yqgh";
        authors = [
      ...
      "spdx" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "1b0liy0r6l1nfpqjxbj9dkk48vxarrbmf8ha1fcmilmiq8f7waw4";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
