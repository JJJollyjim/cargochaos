...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-deny/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "askalono" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "16sdcb5plk065yb25xridykcwqax32js9mdvfa81zg911qcgchl8";
        authors = [
      ...
      "bitvec" = rec {
        ...
        version = "0.17.2";
        edition = "2018";
        sha256 = "1xb2al7a6fcmnjv741aw2zhpkfv2k2ri177kwgrsd7ks3l631r0z";
        authors = [
      ...
      "cfg-expr" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0ya5s06s0awy4mg99n70jphns76h688d603cggc9m59pxsxd7rix";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
      ...
      "krates" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0mpqm45l8da94naa0hxwxfddlds9g31grbfmwd5djiip81bc08f7";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
      ...
      "rustsec" = rec {
        ...
        resolvedDefaultFeatures = [ "vendored-openssl" ];
      };
      "rustversion" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
