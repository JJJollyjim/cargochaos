...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sodaq_sara_aff/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21j18a" "samd21" "samd21j18a" "samd21j18a-rt" "unproven" ];
      };
      "atsamd21j18a" = rec {
        crateName = "atsamd21j18a";
        version = "0.6.0";
        edition = "2015";
        sha256 = "0r0vabrbql6y6z8yij8mpa76zdr61z37zvnclhxfvlv15khv8hpk";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
          "Paul Sajna <sajattack@gmail.com>"
        ];
      ...
      "sodaq_sara_aff" = rec {
        crateName = "sodaq_sara_aff";
        version = "0.4.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Stefan de Lange <langestefan@msn.com>"
        ];
        dependencies = [
          {
            name = "atsamd-hal";
