...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsrl/v0.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lfa" = rec {
        ...
        version = "0.13.0";
        edition = "2018";
        sha256 = "0y6hxshhmr81y61hn1jycyjbhi45dvsvz0fz9cd8cky1h6770scd";
        authors = [
      ...
      "lfa_derive" = rec {
        crateName = "lfa_derive";
        version = "0.13.0";
        edition = "2018";
        sha256 = "07a831fc7xrnd499x5npf6i47hi8xbjdsahc571bk4axhs9nl2xj";
        procMacro = true;
        authors = [
          "Tom Spooner <spooner10000@gmail.com>"
        ];
      ...
      "rsrl_domains" = rec {
        crateName = "rsrl_domains";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0k96cz83fl4msgaspczvp0sil2sxmg6h81g9lyqg5r4q9wqzpcpp";
        authors = [
          "Tom Spooner <t.spooner@liverpool.ac.uk>"
        ];
        dependencies = [
      ...
      "rstat" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0cmfn6db9yvnzdbg3rccq17nk7ngd1jjkp7dgypj81vkg767s9m9";
        authors = [
          "Tom Spooner <spooner10000@gmail.com>"
        ];
        dependencies = [
