...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-classroom1-cli/v1.0.12+20190701.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-classroom1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-classroom1" = rec {
        crateName = "google-classroom1";
        version = "1.0.12+20190701";
        edition = "2015";
        sha256 = "159vjp7nqp2m0aksqlnkvk5whn9w0vicdsbzkwwj5knqgck99nz2";
        authors = [
      ...
      "google-classroom1-cli" = rec {
        crateName = "google-classroom1-cli";
        version = "1.0.12+20190701";
        edition = "2015";
        crateBin = [
          { name = "classroom1"; path = "src/main.rs"; }
        ];
