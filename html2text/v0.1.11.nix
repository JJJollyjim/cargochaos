...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/html2text/v0.1.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "html2text" = rec {
        ...
        resolvedDefaultFeatures = [ "clippy" "default" "html_trace" ];
      };
      "html5ever" = rec {
        crateName = "html5ever";
        version = "0.24.1";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "profileapi" "shlobj" "winbase" "wincon" "winerror" "winnt" ];
      };
