...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/romp/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sanename" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1mk8y5jvrgzck2af7lv62wbsb93jldsy14q1mr8ri6biwd0iyx6k";
        authors = [
          "teknopaul <teknopaul@gmail.com>"
        ];
      ...
      "totems" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "0sp1ay6ql1clflq8haffk1mld85xw81lay51ps8rcwxlni4xxlff";
        authors = [
          "ObliqueMotion <aeketn@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
