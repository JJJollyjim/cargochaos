...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/feather_m4/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "07cnzyvpnzy6cryyfw0djs8dfi5zlisxkgma99czkn0ma187zcai";
        authors = [
        ...
        features = {
          ...
          "samd21j18a" = [ "atsamd21j18a" ];
          "samd21j18a-rt" = [ "atsamd21j18a" "atsamd21j18a/rt" ];
        ...
        resolvedDefaultFeatures = [ "atsamd51j19a" "samd51" "samd51j19a" "samd51j19a-rt" "unproven" ];
      };
      "atsamd51j19a" = rec {
      ...
      "feather_m4" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "unproven" ];
      };
      ...
      "jlink_rtt" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1w87x0ij387ahjs1mdvsbfl6a2d256rxnbaq95mnlf66lbhp3439";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
        ];
      ...
      "panic_rtt" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1byzs5ng6j9spmvsfq5bs3qzs1kydmr412v2kc8l67j90m5fh5gz";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
        ];
        dependencies = [
      ...
      "smart-leds" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "17vyq1929srvksp27qb2qhghyv3fdh0wh4abi2rgx20qb3q5n7qz";
        authors = [
      ...
      "smart-leds-trait" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1sni17cs41dhnjfi7dncprcb3kmjs46337cigdsrvp7m0y12s58d";
        authors = [
          "David Sawatzke <david-sawatzke@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "ws2812-timer-delay" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "07w523aic3a31jrvl2lr27l80gyd8wwzw3yj08yqw51jg5c4vxw2";
        authors = [
          "David Sawatzke <david-sawatzke@users.noreply.github.com>"
        ];
        dependencies = [
