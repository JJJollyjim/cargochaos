...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tca62724fmg/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32h7xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "device-selected" "rt" "singlecore" "stm32h743" "unproven" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
