...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xcp/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "anyhow" = rec {
        ...
        version = "1.0.21";
        edition = "2018";
        sha256 = "0mv5yj56xzbk1j8jvv7736fy4lmwd52i73mbz0wm8q5syhs2h8vk";
        authors = [
      ...
      "unbytify" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0scqzkqb6krrdx1zc1z85kjkfpsfy7nd7hyc6lfja36n9wsk3x31";
        authors = [
          "Dmytro Milinevskyi <dmilinevskyi@gmail.com>"
        ];
        dependencies = [
          {
            name = "lazy_static";
      ...
      "xcp" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "kernel_copy_file_range" ];
      };
    };
