...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-tasks1-cli/v1.0.13+20190628.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-tasks1" = rec {
        crateName = "google-tasks1";
        version = "1.0.13+20190628";
        edition = "2015";
        sha256 = "141xpmjz12zq79b730np6vxm070bc16n31zwz9gi6w59gljqg8jl";
        authors = [
      ...
      "google-tasks1-cli" = rec {
        crateName = "google-tasks1-cli";
        version = "1.0.13+20190628";
        edition = "2015";
        crateBin = [
          { name = "tasks1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190628.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
