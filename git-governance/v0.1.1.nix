...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-governance/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-governance" = rec {
        crateName = "git-governance";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "gg"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Ninan John <jninan@thoughtworks.com>"
          "Dinesh B<dineshudt17@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "mockers" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "1jbfni3kn75s9r7bzg1lvbbwcmz1zbqzyh4n56yywq86awa6vwwb";
        authors = [
          "Mikhail Trishchenkov <kriomant@gmail.com>"
        ];
        dependencies = [
          {
            name = "itertools";
      ...
      "mockers_derive" = rec {
        crateName = "mockers_derive";
        version = "0.21.0";
        edition = "2018";
        sha256 = "0v3jsml96v1n5w6da69pii8dz6v5r2xqcl0fp3icpsgqdgj3sg55";
        procMacro = true;
        authors = [
          "Mikhail Trishchenkov <kriomant@gmail.com>"
        ];
      ...
      "select-rustc" = rec {
        crateName = "select-rustc";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0daqd56smi93g59nz43n4mh3d8whr6j5pa8dmwlf8bd76mdy3cpx";
        procMacro = true;
        libName = "rustc";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
