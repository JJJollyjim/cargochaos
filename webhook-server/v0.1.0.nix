...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webhook-server/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "webhook-server" = rec {
        crateName = "webhook-server";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "webhookserver"; path = "src/main.rs"; }
        ];
