...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-mander/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-mander" = rec {
        crateName = "git-mander";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "gmdr"; path = "src/gmdr/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        libName = "git_commander";
        libPath = "src/gmdr/lib.rs";
        authors = [
