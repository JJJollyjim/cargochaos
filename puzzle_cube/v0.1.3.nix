...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/puzzle_cube/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "puzzle_cube" = rec {
        crateName = "puzzle_cube";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "puzzle_cube"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Jake Carrington <jake.ethan.carrington@gmail.com>"
        ];
        dependencies = [
          {
            name = "dirs";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
