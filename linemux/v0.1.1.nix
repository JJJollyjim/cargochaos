...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linemux/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linemux" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "io-util" "macros" "stream" "sync" "time" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "fs" "futures-core" "io-util" "macros" "memchr" "rt-core" "slab" "stream" "sync" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
