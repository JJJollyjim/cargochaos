...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/entry/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "entry" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "entry"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Byron Batteson <byronbatteson@gmail.com>"
        ];
        dependencies = [
          {
            name = "assert_cmd";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" ];
      };
