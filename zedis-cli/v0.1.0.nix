...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zedis-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winuser" ];
      };
      ...
      "zedis-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "zedis-cli"; path = "src/main.rs"; }
        ];
