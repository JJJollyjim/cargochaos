...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ed_join/v1.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ed_join" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "dialoguer" "env_logger" "indicatif" "log" ];
      };
      "edit-distance" = rec {
