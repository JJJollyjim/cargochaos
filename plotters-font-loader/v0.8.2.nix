...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/plotters-font-loader/v0.8.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "plotters-font-loader";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "plotters-font-loader" = rec {
        crateName = "plotters-font-loader";
        version = "0.8.2";
        edition = "2015";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "wingdi" "winuser" ];
      };
