...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-install/v1.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-install" = rec {
        crateName = "solana-install";
        version = "1.1.6";
        edition = "2018";
        crateBin = [
          { name = "solana-install"; path = "src/main-install.rs"; }
          { name = "solana-install-init"; path = "src/main-install-init.rs"; }
        ];
