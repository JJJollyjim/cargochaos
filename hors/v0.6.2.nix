...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hors/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hors" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "hors"; path = "src/bin/hors.rs"; }
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "hyper-tls" "json" "native-tls-crate" "serde_json" "socks" "tokio-socks" "tokio-tls" ];
      };
      "rust-argon2" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
