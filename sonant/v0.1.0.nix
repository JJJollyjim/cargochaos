...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sonant/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "riff-wave" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0hscyp7sa94r0m2hj8ham11y5kl5n1llqyqs9sjf5myhhz0ky7bs";
        authors = [
          "Kevin Brothaler <contact@digipom.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "combaseapi" "coml2api" "consoleapi" "debug" "devpkey" "errhandlingapi" "handleapi" "impl-debug" "ksmedia" "libloaderapi" "minwindef" "mmdeviceapi" "ntsecapi" "objbase" "processenv" "profileapi" "std" "synchapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winuser" ];
      };
