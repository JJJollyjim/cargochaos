...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miniotp/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "miniotp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "brute-force-sha1-otp-demo"; path = "src/bin/brute-force-sha1-otp-demo.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "alloc" "base32" "cstr" "default" "only-gauth" "serde" "std" ];
      };
      "proc-macro2" = rec {
