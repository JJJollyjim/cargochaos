...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mailchimp/v0.1.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "paho-mqtt" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0w044lhhsa8mv40vqp17ixi889cri3kl5zdiw36cg9kmxk80rg5a";
        authors = [
      ...
      "paho-mqtt-sys" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "17qydcvrr846c843iysgna1gwgarcdlw63jsbaazy0d9hg0mfnza";
        authors = [
          "Frank Pagliughi <fpagliughi@mindspring.com>"
        ];
        features = {
