...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-folderinfo/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-folderinfo" = rec {
        crateName = "cargo-folderinfo";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-folderinfo"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "adria0 <adria@codecontext.io>"
        ];
        dependencies = [
          {
            name = "itertools";
