...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/asn-tools/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "asn-db" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1y2pmylfcq9m9bh1yq6qa0pwf1l9s0plyrz24x6ifih0q45fzy5d";
        authors = [
      ...
      "asn-tools" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "asn-update"; path = "src/bin/asn-update.rs"; }
          { name = "asn-lookup"; path = "src/bin/asn-lookup.rs"; }
        ];
      ...
      "json_in_type" = rec {
        crateName = "json_in_type";
        version = "1.1.1";
        edition = "2018";
        crateBin = [];
        sha256 = "0pp6ch6w05c73y2m6cw2m6k3vyfd2l1053vi9dva8y7bxz1zwryd";
        authors = [
          "ophir <pere.jobs@gmail.com>"
        ];
        dependencies = [
          {
            name = "itoa";
      ...
      "ryu-ecmascript" = rec {
        crateName = "ryu-ecmascript";
        version = "0.1.1";
        edition = "2015";
        sha256 = "0p2py0m62djz2yzm089ypvwwqa8m3fl5rni2jigmfqlsxbw9xwbr";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
          "Aljoscha Meyer"
        ];
      ...
      "tabular" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "02hfch6d214p3rp31rrid1h0l1y6lq8ddrmz79qdscvdjm7h6vgx";
        authors = [
