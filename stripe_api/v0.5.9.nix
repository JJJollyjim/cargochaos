...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stripe_api/v0.5.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "h2" = rec {
        ...
        version = "0.1.21";
        edition = "2015";
        sha256 = "0n21ry97kmv8zdnq284yfsdxil8gklnkn3liw7ibvavq9l8r2vc7";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
      ...
      "stripe_api" = rec {
        crateName = "stripe_api";
        version = "0.5.9";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.9.nix {};
        authors = [
          "Darius C. <darius.clark@bundleofbytes.com>"
          "Thibaut R. <thibaut.roche.perso@gmail.com>"
        ];
        dependencies = [
          {
            name = "futures";
