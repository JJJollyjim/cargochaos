...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mpu9250/v0.20.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "i2cdev" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0p1jzsijknx5az617mk84w31z8834yd0chk3z8h3p5vc3kfviarx";
        authors = [
      ...
      "sysfs_gpio" = rec {
        ...
        version = "0.5.3";
        edition = "2015";
        sha256 = "0gqyd76kfq4vk6sfargf8i3rf0gv3z1qr1carra9zly7wg5g4s1x";
        authors = [
          "Paul Osborne <osbpau@gmail.com>"
        ];
        dependencies = [
