...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.21.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.1.21.nix {};
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.21";
        edition = "2015";
        sha256 = "0cj0paxb9vl20b088w92hpy046fjc8ikc2hsj7ky51830k5qg1b8";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.21";
        edition = "2015";
        sha256 = "0l3n0pyazq9wr11ipgmwvh0ccsfqb2xrfals13wnc8ss0wrkdlsm";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.21";
        edition = "2015";
        sha256 = "0li1902a7afj65wcvhppw7hd9dd39hw1pcbk3z5bg0x2a5bkypf6";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-src" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "011ij6xnmp0jx3qc5jkxbrwhwjbd2lbl53lqdawch4474qzwjmyr";
        libName = "cargo_wasi";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "walrus" = rec {
        ...
        version = "0.15.0";
        edition = "2018";
        sha256 = "10b4p13mj0cg7lsdf2x2lp39hfq5qlfrv198b9qwzgpb0ixisrc4";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
        dependencies = [
      ...
      "walrus-macro" = rec {
        ...
        version = "0.15.0";
        edition = "2018";
        sha256 = "1yg3sn4s10gzscbv27pp6zmava21grhymrgh4ibfrz5i6g54a61b";
        procMacro = true;
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
      ...
      "wasmparser" = rec {
        ...
        version = "0.48.2";
        edition = "2018";
        sha256 = "1y50wkfsprxr98wy7lcgsaif622a3c66dkk8vl0b0kf8y6dshg87";
        authors = [
