...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.19.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.1.19.nix {};
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.19";
        edition = "2015";
        sha256 = "03l03win94v2j6bf3wi8sgc698aqhwcb569cx682k931aymw54d4";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.19";
        edition = "2015";
        sha256 = "0n9sm73qqns66vrn8mv5xqd77ygi2sqycldpgh3g61bq0v0wv73s";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.19";
        edition = "2015";
        sha256 = "1vi7iq5y44mwznws9chl1nnmpkb619qpny5cf3w90fw9x3zz6kf4";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-src" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0cir71nd14ds630lb4sgkzvw7hjwlb0w3wwl1nk7n276w5747231";
        libName = "cargo_wasi";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
