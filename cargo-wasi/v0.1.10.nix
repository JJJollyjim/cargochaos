...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.10";
        edition = "2015";
        sha256 = "1svkk4h1aqzryb50mkqvvz8vkdz5gzm12wbmykymz9y2hyd2sns3";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.10";
        edition = "2015";
        sha256 = "070r2dnz5m7k4rv4f115r3fbk7qlrz3wdkkfdfnf3pslkan7y32y";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.10";
        edition = "2015";
        sha256 = "01sn91b4j0aj4c6m3qsf0yc80l1jc6dwv0jsdc0df07fw6bj693r";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-src" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "05912zpi7jydhzj1jskg0p4alrsjvx0209ymp81hw5if94hlhj8y";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
