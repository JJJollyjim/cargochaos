...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "0a6m6asd92i4mvvbai9bmabzp1ryfs3bffx8mqsl15z14hr8h4pc";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "0wvkgyl5nl0w2sbqa4c1k63jv5nq230zqc2r521rylxmfm8dhrip";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "1xz6nxgb7rrrh0w5amfrpxhhb7lxm23cn87na0c7sgcll4b2rs99";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
