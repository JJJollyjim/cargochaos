...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.11";
        edition = "2015";
        sha256 = "13xf9wz93fljnnm8lri4clk1vf1bcpbfl80aqnqy6rbwmsb69w7f";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.11";
        edition = "2015";
        sha256 = "1q1f33ynahrzfzfz9y07gdirzx18m6cq0k5a1i4lf40pppw36gb8";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.11";
        edition = "2015";
        sha256 = "0j2fgpyha2crmgm9f077nrhf0gl2fy9ap7zag3m3dv4g9k15d5dd";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-src" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0nkc7ysj2ixgfp4gyww09q75x49aqfcz3makk3256cb2hymknxp4";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
