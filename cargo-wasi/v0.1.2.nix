...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0ignk31b170zriisgq0ihiqnyhglwss6vc9bcm31nrsmlzs4qkvr";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "1819c4fn242kf55d93rijwiwyc6dpdl42x5bm8239xl1ma20vlqk";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0m38lssnaj8q8mygrz5w5bfb9m3y3qiz2p1lwljim7jqmr519qxj";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
