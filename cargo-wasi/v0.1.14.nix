...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi/v0.1.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-wasi-exe-x86_64-apple-darwin" = rec {
        ...
        version = "0.1.14";
        edition = "2015";
        sha256 = "0s8lzmbfnzds10l8qiqpaayz6wpraiihlcxl3qrkjvm2wcp9n01m";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.1.14";
        edition = "2015";
        sha256 = "158lk4x13wkn3vz29h0cz5jdz7jghw1bx8iqdlhwf9ddipqagsbk";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-exe-x86_64-unknown-linux-musl" = rec {
        ...
        version = "0.1.14";
        edition = "2015";
        sha256 = "073ncx28pcw13nx361v2vvjlr812srhhblxjlc5nqb62jzfb9hcp";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "cargo-wasi-src" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1911gmil239p3sd1shrmj47x4xi75l3cclg9c7hnrpn0wp4x3rcg";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
