...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pad-motion/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pad-motion" = rec {
        crateName = "pad-motion";
        version = "0.1.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        libName = "pad_motion";
        authors = [
          "zduny <dzduniak@gmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "fileapi" "handleapi" "hidpi" "hidsdi" "libloaderapi" "synchapi" "winbase" "winerror" "winnt" "winuser" "xinput" ];
      };
