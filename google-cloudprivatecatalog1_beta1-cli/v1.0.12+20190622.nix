...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudprivatecatalog1_beta1-cli/v1.0.12+20190622.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudprivatecatalog1_beta1-cli";
  ...
  workspaceMembers = {
    "google-cloudprivatecatalog1_beta1-cli" = rec {
      packageId = "google-cloudprivatecatalog1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudprivatecatalog1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudprivatecatalog1_beta1" = rec {
        crateName = "google-cloudprivatecatalog1_beta1";
        version = "1.0.12+20190622";
        edition = "2015";
        sha256 = "1xzwnmgs74cz3bmjxj5yv5k7r255wd8sqc0wk1743pi1nqp07rcj";
        authors = [
      ...
      "google-cloudprivatecatalog1_beta1-cli" = rec {
        crateName = "google-cloudprivatecatalog1_beta1-cli";
        version = "1.0.12+20190622";
        edition = "2015";
        crateBin = [
          { name = "cloudprivatecatalog1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-cloudprivatecatalog1_beta1";
            packageId = "google-cloudprivatecatalog1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
