...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/serialitm/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "itm" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1wknl58ac6r0si9w8rf9vfgvx3ilsxcdfmc76hbffxyaxvdns3x1";
        authors = [
      ...
      "serialitm" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "serialitm"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "David Haig <david@ninjasource.com>"
        ];
        dependencies = [
          {
            name = "clap";
