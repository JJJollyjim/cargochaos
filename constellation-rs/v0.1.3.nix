...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constellation-internal" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0i74xq4nm3s6mm28bivw6imwhgzxhl0dryck08xvy6dix60fsbl0";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "heapless" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "16yaz9pk7ch5jk6yx35bs9cyldq3krgzxwnbgb8k8vq18wpcxiy6";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
      ...
      "serde_traitobject" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "1l98qvh5i1n2jmfldlh5s5prz3gscgirb3xzjhwr3vz6qn61rkdb";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
