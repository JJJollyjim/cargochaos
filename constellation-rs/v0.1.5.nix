...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.36";
        edition = "2018";
        sha256 = "07b8fd0bbvbn0rhy7yljcdkl8yrh4qp683znd5v7fxv1mpk16fz4";
        authors = [
      ...
      "constellation-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "distribute_binaries" "fringe" "nightly" "no_alloc" ];
      };
      "crossbeam" = rec {
        crateName = "crossbeam";
        version = "0.7.2";
      ...
      "once_cell" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "0bqkl8mirc2k9mvr2gphc4l463apyys1pvrqxhws530la6xw2f5x";
        authors = [
