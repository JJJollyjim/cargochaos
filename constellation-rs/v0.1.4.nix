...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constellation-internal" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1s1crjf9qph8sl12xy2w9zghn8sk7vqizk99lxvd8lc69p5gp5hn";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "once_cell" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "1sfndijx2bd47szcjbhkz56szc4m93bigj72q29qrbi7658166hx";
        authors = [
