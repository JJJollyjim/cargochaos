...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constellation-internal" = rec {
        ...
        version = "0.1.10";
        edition = "2018";
        sha256 = "0aim56g5x6rn1mdikpv4i6fw18mfrzk1jabi9nl9djm9qwkj96i9";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "constellation-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "distribute_binaries" "fringe" "k8s-openapi" "kube" "kubernetes" "nightly" "no_alloc" "openssl" "tokio" ];
      };
      "core-foundation" = rec {
