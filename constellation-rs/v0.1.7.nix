...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kube" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "1w8m8yh5524vi8ckmqlp5ahh8swfclwsmygp7bq6yxapy1l45h3y";
        authors = [
      ...
      "relative" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1zvqq6shbavi15sf2nz86dlh6km0rfrccfpmz9kv6fhkhhpx42vf";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
