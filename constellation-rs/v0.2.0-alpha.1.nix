...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.2.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constellation-internal" = rec {
        ...
        edition = "2018";
        sha256 = "0y4h131635f29y0y7b1y3bimkavx6chhbcs9xym6m66jf3zz49zv";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "constellation-rs" = rec {
        ...
        dependencies = [
          ...
          {
            name = "palaver";
            packageId = "palaver 0.3.0-alpha.2";
          }
          {
            name = "pin-utils";
            packageId = "pin-utils";
        ...
        resolvedDefaultFeatures = [ "default" "distribute_binaries" "fringe" "k8s-openapi" "kube" "kubernetes" "nightly" "no_alloc" "openssl" "strict" "tokio" ];
      };
      "core-foundation" = rec {
      ...
      "kube" = rec {
        ...
        version = "0.23.0";
        edition = "2018";
        sha256 = "0ahavzld07pfkpcc3md8gkd2d2fh8f4xv77hpmp9zjz8lcyaba11";
        authors = [
      ...
      "palaver 0.3.0-alpha.2" = rec {
        crateName = "palaver";
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "0mj4kvyl7qz99xpcm1xn808a4y2xvzvr72n4qgzxv4kyz3r5ylav";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "default" "default-tls" "gzip" "hyper-tls" "json" "native-tls" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rle-decode-fast" = rec {
      ...
      "serde_closure" = rec {
        ...
        version = "0.2.10";
        edition = "2018";
        sha256 = "1jhv474w7vw2rgqdl94gn3mms2yjr2kd0g72s23j0mavb3m1jrvb";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "serde_closure_derive" = rec {
        ...
        version = "0.2.10";
        edition = "2018";
        sha256 = "0fxv7scahmqsaa5jqhhfmx0a2isiv8hmsv9wmqij4li19a8sxb9d";
        procMacro = true;
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
