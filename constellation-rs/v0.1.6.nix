...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "k8s-openapi" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1nj26g8kbm30kizqxyjz5mifdw8a7d2spd8fglahv4nmjqaarqih";
        authors = [
      ...
      "kube" = rec {
        ...
        version = "0.16.1";
        edition = "2018";
        sha256 = "1pkc5jyd1k2n8ih0ahw2y2n3i76r3hxg6l4qnzg1628l2ikhk7lr";
        authors = [
