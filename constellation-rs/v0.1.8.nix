...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constellation-internal" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc_counter" "distribute_binaries" "no_alloc" ];
      };
      "constellation-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "distribute_binaries" "fringe" "kube" "kubernetes" "nightly" "no_alloc" "openssl" ];
      };
      "cookie" = rec {
        crateName = "cookie";
        version = "0.12.0";
      ...
      "kube" = rec {
        ...
        version = "0.17.1";
        edition = "2018";
        sha256 = "1nfw4d9y9ylm4wqy17hiqw487nvviqkpqhh1n88ma2v5r9hgr6l0";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "k8s-openapi" "openapi" ];
      };
      "lazy_static" = rec {
      ...
      "serde_closure" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "0zznadhb0v4d689s31ial63gj1pshhhqjz9hvq84xnmkzllc04id";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "serde_closure_derive" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "07pqjgc5d5rssvxdfqb4mm4fi1fxyqj1wf2rl3g28yb5n7s9xbpq";
        procMacro = true;
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
      ...
      "serde_traitobject" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "15qdh3q8f5ivgwsrda529dymwb63mf2vk6akpfiwagircl0f8v3l";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
