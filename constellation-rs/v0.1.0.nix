...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constellation-rs/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constellation-internal" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1cs9f95ij2dvyg687kh7z3sx8q7zh8blfncs3panm4jc1mpvnq40";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "constellation-rs" = rec {
        ...
        crateBin = [
          ...
          { name = "bridge"; path = "src/bin/bridge.rs"; }
        ];
      ...
      "notifier" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "100p0lba8n5cnmdbzvvnim4vgfcgx4gmphna1fdadmdf8ymdvsk8";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "palaver" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "19mby6p8psjgvrkl6lfr2ia3wsxfpvbi70ixvpiw50v6bwwxgxsw";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "relative" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "10bfz0fg9lcsmjqp5qz8a71jmph39i9jg0rpxqnnaqz6mxnqvr6j";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
      ...
      "simple-logging" = rec {
        crateName = "simple-logging";
        version = "2.0.2";
        edition = "2015";
        sha256 = "0hmm523f0ax76yljf3z178rn9cm0q6knwa52haqnnckmavl4h3dh";
        authors = [
          "Carol Schulze <carol@ereski.org>"
        ];
        dependencies = [
          {
            name = "lazy_static";
      ...
      "tcp_typed" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0y75ygxw33fa3gl3q2w5jrm57wgc6g1n66glam8m2v97rq5pgkv9";
        authors = [
          "Alec Mocatta <alec@mocatta.net>"
        ];
        dependencies = [
