...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thunderborg_driver/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "thunderborg_driver" = rec {
        crateName = "thunderborg_driver";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "thunderborg_driver"; path = "src/main.rs"; }
        ];
