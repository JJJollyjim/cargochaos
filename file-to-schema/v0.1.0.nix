...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/file-to-schema/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "file-to-schema" = rec {
        crateName = "file-to-schema";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "file-to-schema"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "nerdovert <saquibulhassan6@gmail.com>"
        ];
        dependencies = [
          {
            name = "csv";
