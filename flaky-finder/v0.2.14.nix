...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flaky-finder/v0.2.14.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flaky-finder" = rec {
        crateName = "flaky-finder";
        version = "0.2.14";
        edition = "2018";
        crateBin = [
          { name = "flaky-finder"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.14.nix {};
        authors = [
          "dymayday <dymayday@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
