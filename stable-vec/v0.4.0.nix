...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stable-vec/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "criterion" = rec {
        ...
        resolvedDefaultFeatures = [ "criterion-plot" "default" "html_reports" "real_blackbox" "tinytemplate" ];
      };
      "criterion-plot" = rec {
      ...
      "stable-vec" = rec {
        ...
        resolvedDefaultFeatures = [ "nightly-bench" ];
      };
      "syn 0.15.44" = rec {
        crateName = "syn";
        version = "0.15.44";
