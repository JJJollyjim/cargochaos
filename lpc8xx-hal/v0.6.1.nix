...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lpc8xx-hal/v0.6.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lpc82x-pac" = rec {
        crateName = "lpc82x-pac";
        version = "0.7.0";
        edition = "2015";
        sha256 = "03fs5qzwzdgr90ix8g8iy1i8n2y2sv3s11y9gkx463a98zwk9yrd";
        authors = [
      ...
      "lpc845-pac" = rec {
        crateName = "lpc845-pac";
        version = "0.3.0";
        edition = "2015";
        sha256 = "0d289bq2xd58lg3sh5mwcq6xx51qska02983yj3j13m21b8w2i4a";
        authors = [
          "David Sawatzke <d-lpc@sawatzke.dev>"
        ];
        dependencies = [
          {
            name = "bare-metal";
      ...
      "lpc8xx-hal" = rec {
        ...
        dependencies = [
          ...
          {
            name = "lpc82x-pac";
            packageId = "lpc82x-pac";
            optional = true;
          }
          {
            name = "lpc845-pac";
            packageId = "lpc845-pac";
            optional = true;
          }
          {
            name = "nb";
        ...
        resolvedDefaultFeatures = [ "82x" "82x-rt" "845" "845-rt" "compiletest" "compiletest_rs" "cortex-m-rt" "default" "lpc82x-pac" "lpc845-pac" "rt-selected" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.2.1";
