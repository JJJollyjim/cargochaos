...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libunftp/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libunftp" = rec {
        ...
        resolvedDefaultFeatures = [ "cloud_storage" "hyper" "hyper-rustls" "jsonfile_auth" "mime" "oauth2" "pam-auth" "pam_auth" "percent-encoding" "rest_auth" "serde" "serde_json" "yup-oauth2" ];
      };
      "log" = rec {
        crateName = "log";
        version = "0.4.8";
