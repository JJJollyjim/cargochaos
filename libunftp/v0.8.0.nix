...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libunftp/v0.8.0.nix.tmp"
    ...
    crates = {
      ...
      "hyper-rustls 0.19.1" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "rustls-native-certs 0.1.0";
            optional = true;
          }
          {
            name = "tokio";
      ...
      "hyper-rustls 0.20.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "rustls-native-certs";
            packageId = "rustls-native-certs 0.3.0";
            optional = true;
          }
          {
            name = "tokio";
      ...
      "libunftp" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-core" "net" "sync" "io-util" "macros" "time" "fs" ];
          }
          {
            name = "tokio-tls";
            packageId = "tokio-tls";
        ...
        resolvedDefaultFeatures = [ "cloud_storage" "http" "hyper" "hyper-rustls" "jsonfile_auth" "mime" "oauth2" "pam-auth" "pam_auth" "percent-encoding" "rest_auth" "serde" "serde_json" "yup-oauth2" ];
      };
      "log" = rec {
        crateName = "log";
        version = "0.4.8";
      ...
      "native-tls" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "security-framework 0.4.1";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "ios"));
          }
          {
            name = "security-framework-sys";
            packageId = "security-framework-sys 0.4.1";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "ios"));
          }
          {
            name = "tempfile";
      ...
      "security-framework-sys 0.4.1" = rec {
        crateName = "security-framework-sys";
        version = "0.4.1";
        edition = "2015";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "fs" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-io" = rec {
        crateName = "tokio-io";
        version = "0.1.12";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
