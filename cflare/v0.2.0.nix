...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cflare/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cflare" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cflare"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Carlos Yakimov <carlos@cyakimov.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "tabular" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "0fsci58lxkklc1gdd87y08dan7i4kn36nnq6fi5fdvyw0bp5pqz7";
        authors = [
