...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-urlshortener1-cli/v1.0.13+20150519.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-urlshortener1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-urlshortener1" = rec {
        crateName = "google-urlshortener1";
        version = "1.0.13+20150519";
        edition = "2015";
        sha256 = "1sl5p2hlflm11sydjhh3r787kg5vm1n8h2blmjpc1mgij39sabms";
        authors = [
      ...
      "google-urlshortener1-cli" = rec {
        crateName = "google-urlshortener1-cli";
        version = "1.0.13+20150519";
        edition = "2015";
        crateBin = [
          { name = "urlshortener1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20150519.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-urlshortener1";
          }
          {
            name = "hyper";
            packageId = "hyper";
