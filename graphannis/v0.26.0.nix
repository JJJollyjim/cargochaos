...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/graphannis/v0.26.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "boolean_expression" = rec {
        crateName = "boolean_expression";
        version = "0.3.10";
        edition = "2015";
        sha256 = "04y95khnj1kxf7i161gnl0d7xgdik7f1agp02dbs3yhywkr4ybf3";
        authors = [
          "Chris Fallin <cfallin@c1f.net>"
        ];
        dependencies = [
          {
            name = "itertools";
      ...
      "file_diff" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "19a34rvbqg3b2my6ykax5n1qi2ahwbjacn9y2ji3h9gkp04ak9ri";
        authors = [
          "Ethan Pailes <ethanpailes@gmail.com>"
        ];
      ...
      "graphannis" = rec {
        crateName = "graphannis";
        version = "0.26.0";
        edition = "2018";
        crateBin = [
          { name = "annis"; path = "src/bin/annis.rs"; }
          { name = "bench_annisqueries"; path = "src/bin/bench_annisqueries.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.26.0.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "graphannis-malloc_size_of";
          }
          {
            name = "graphannis-malloc_size_of_derive";
            packageId = "graphannis-malloc_size_of_derive";
          }
          {
            name = "itertools";
            packageId = "itertools 0.8.2";
        ...
        resolvedDefaultFeatures = [ "c-api" "clap" "cli" "criterion" "prettytable-rs" "rustyline" "rustyline-derive" "simplelog" ];
      };
      "graphannis-malloc_size_of" = rec {
        crateName = "graphannis-malloc_size_of";
        version = "1.0.0";
        edition = "2015";
        sha256 = "1qk22lk6pfcfw3fxvh9ramsr5bgw2q2jivpzfv63mrq0hglw8fd0";
        libPath = "lib.rs";
        authors = [
      ...
      "graphannis-malloc_size_of_derive" = rec {
        crateName = "graphannis-malloc_size_of_derive";
        version = "2.0.0";
        edition = "2015";
        sha256 = "1ydgpv93dfl61wc5kmdkr142xh1md5cgqqag20gglahbjvd8sbc1";
        procMacro = true;
        libPath = "lib.rs";
        authors = [
          "The Servo Project Developers"
      ...
      "sstable" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0xx75j57frdahq3084ddap0wxgnqxav11ia72rf1wd3vdyrf6csl";
        authors = [
          "Lewin Bormann <lbo@spheniscida.de>"
        ];
        dependencies = [
      ...
      "synstructure" = rec {
        ...
        version = "0.11.0";
        edition = "2015";
        sha256 = "1spqy31qcss57mciklc4nky4v778fvqs9qwdjgvnmf0hr5ichcca";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
