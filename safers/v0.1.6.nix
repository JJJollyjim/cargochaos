...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/safers/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "safers" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "safers"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.6.nix {};
        authors = [
          "Martin GUILLOUX <martin.guilloux@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "syspass_api" = rec {
        crateName = "syspass_api";
        version = "0.1.5";
        edition = "2018";
        sha256 = "1qv8r0wppys78sbzpzpwb28lqmbdy4sq7q7ljgl90dqr8in01n64";
        authors = [
          "Martin GUILLOUX <martin.guilloux@protonmail.com.com>"
        ];
        dependencies = [
          {
            name = "json";
