...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redpitaya/v0.28.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rp-sys" = rec {
        ...
        version = "0.26.0";
        edition = "2018";
        sha256 = "1cxmnsryj7d45hz7lpnr8kp3klfp7mmfmgm4lrbid9ivxmw12gxr";
        authors = [
          "Sanpi <sanpi@homecomputing.fr>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "mock" ];
      };
      "rustc-hash" = rec {
