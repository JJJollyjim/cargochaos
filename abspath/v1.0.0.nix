...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/abspath/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "abspath" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "abspath"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "m <mhmorgan42@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "mhlog" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "1yv5rac1z3xpv7ys0jj8grx3g9xmilw5mq5ww9q2gdpjv1qh49a3";
        authors = [
