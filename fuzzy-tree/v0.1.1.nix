...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fuzzy-tree/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fuzzy-tree" = rec {
        crateName = "fuzzy-tree";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "fztree"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Lewis Belcher <belcher_lewis@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
