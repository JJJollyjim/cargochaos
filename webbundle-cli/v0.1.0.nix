...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webbundle-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "io-util" "macros" "memchr" "rt-core" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "webbundle-cli" = rec {
        crateName = "webbundle-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "webbundle"; path = "src/main.rs"; }
        ];
