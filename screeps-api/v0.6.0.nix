...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/screeps-api/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "screeps-api" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "destructive-tests" "hyper-tls" "protocol-docs" "sync" "tokio" ];
      };
      ...
      "serde-tuple-vec-map" = rec {
        crateName = "serde-tuple-vec-map";
        version = "0.2.1";
        edition = "2015";
        sha256 = "111bkiznbwz3mi920rzdynmwdk4sq1z5m1x06jf4c2pymkrajv8p";
        libName = "tuple_vec_map";
        authors = [
          "David Ross <daboross@daboross.net>"
        ];
        dependencies = [
