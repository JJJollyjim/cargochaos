...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ledb-actix/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "awc" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "1mg1f397lkxazkjfqd5jrvpsqvcg3401nwfrrr4mq58347q51zwn";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "ledb" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "10dz00v3klc6f31yl6j49g83bvlrsydyk5aw1bwqphgz3npj59ar";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "ledb-derive";
            packageId = "ledb-derive";
            optional = true;
          }
          {
            name = "ledb-types";
            packageId = "ledb-types";
            features = [ "json" "cbor" ];
          }
          {
            name = "lmdb-zero";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "ledb-derive" ];
      };
      "ledb-actix" = rec {
        crateName = "ledb-actix";
        version = "0.3.0";
        edition = "2015";
        ...
        resolvedDefaultFeatures = [ "actix-web" "default" "serde_with" "web" ];
      };
      "ledb-derive" = rec {
        crateName = "ledb-derive";
        version = "0.3.0";
        edition = "2015";
        sha256 = "0vd60sv64yzdp2bbss45bb2mkhgkv7iafq85an4hinsxydfc23l9";
        procMacro = true;
        authors = [
          "Kayo <kayo@illumium.org>"
        ];
      ...
      "ledb-types" = rec {
        crateName = "ledb-types";
        version = "0.3.0";
        edition = "2015";
        sha256 = "1qfjyyr0ppbnmgpin09hkz6k9k7xba80hyjqvg71giplhs9wkxpj";
        authors = [
          "Kayo <kayo@illumium.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cbor" "default" "json" "serde_cbor" "serde_json" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.62";
      ...
      "serde_with" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "15dr26dh5bq6rvgmyr65whxk0dwm3na5qvk3hkgmb9cjaph61hcp";
        authors = [
          "jonasbb"
        ];
        dependencies = [
