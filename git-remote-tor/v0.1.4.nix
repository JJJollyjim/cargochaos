...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-remote-tor/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "git-remote-tor" = rec {
        crateName = "git-remote-tor";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "git-remote-tor"; path = "src/main.rs"; }
        ];
