...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fints-institute-db/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arrayvec" = rec {
        ...
        resolvedDefaultFeatures = [ "array-sizes-33-128" "default" "serde" "std" ];
      };
      "assert_cmd" = rec {
      ...
      "iban_validate" = rec {
        crateName = "iban_validate";
        version = "3.0.0";
        edition = "2018";
        sha256 = "1ji5yl6rcjblw9bbfc0gn3fkwyzaqxrza1idj9mk8yjaim4pg4q9";
        libName = "iban";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "array-sizes-33-128" "serde" ];
          }
          {
            name = "lazy_static";
            packageId = "lazy_static";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
