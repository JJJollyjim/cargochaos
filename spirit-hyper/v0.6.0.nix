...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spirit-hyper/v0.6.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "config-spirit-fork" = rec {
        crateName = "config-spirit-fork";
        version = "0.1.0";
        edition = "2015";
        sha256 = "1lwcza22dl4ln1aci0k74gr9cy5q0zjbwhw3wv32hnrww51y8bqs";
        authors = [
      ...
      "serde_ignored" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0naf6s0x17ai62z4yzyzdnhgphimh9ljhgnd33v3865qyjwbn91w";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "spirit" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0gclbc6b67s0sdp54s7fbx6gxbzg4jkc01prmrfk9xzp6d1ndwyr";
        authors = [
          "Michal 'vorner' Vaner <vorner@vorner.cz>"
        ];
        dependencies = [
