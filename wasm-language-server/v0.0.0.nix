...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasm-language-server/v0.0.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "wasm-language-server";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lsp-types" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "proposed" ];
      };
      "matches" = rec {
        crateName = "matches";
        version = "0.1.8";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-std" "macros" "num_cpus" "rt-core" "rt-threaded" "stream" "sync" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "wasm-language-server" = rec {
        crateName = "wasm-language-server";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "wasm-language-server"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.0.nix {};
        authors = [
          "Darin Morrison <darinmorrison@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "dashmap";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-std" "macros" "sync" "rt-threaded" ];
          }
          {
            name = "tower-lsp";
            packageId = "tower-lsp";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntstatus" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
