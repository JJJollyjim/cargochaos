...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ppatcher/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ppatch" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0z35mv5jgc9x70wa4f68h1bwfx9cr16xvbrks9z7qzdaaxfbvdm3";
        authors = [
      ...
      "ppatcher" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ppatcher"; path = "src/main.rs"; }
        ];
