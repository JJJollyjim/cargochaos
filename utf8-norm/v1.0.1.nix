...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/utf8-norm/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "lapp" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0acqmpdw1s2vnpzwxzp7a229gwh37cwajaddfni3g55szrd4igv0";
        authors = [
      ...
      "utf8-norm" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "utf8-norm"; path = "src/main.rs"; }
        ];
