...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bq24195-i2c/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arduino_mkrvidor4000" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "panic-halt" "panic_halt" "rt" ];
      };
      "as-slice" = rec {
        crateName = "as-slice";
        version = "0.1.3";
