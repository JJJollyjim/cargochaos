...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/date-formats-workflow/v1.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "date-formats-workflow";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "date-formats-workflow" = rec {
        crateName = "date-formats-workflow";
        version = "1.1.0";
        edition = "2018";
        crateBin = [
          { name = "date-formats-workflow"; path = "src/main.rs"; }
        ];
