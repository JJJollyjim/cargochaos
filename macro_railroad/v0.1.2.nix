...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/macro_railroad/v0.1.2.nix.tmp"
    ...
    crates = {
      ...
      "macro_railroad" = rec {
        ...
        devDependencies = [
          ...
          {
            name = "railroad_verification";
            packageId = "railroad_verification";
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "default" "extra-traits" "visual-debug" ];
      };
      "ppv-lite86" = rec {
      ...
      "railroad" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "1aa763g039ig0mbh4y1nfxqnvsn1b0c7nzjgxs0vb0z37d6pri2r";
        authors = [
          "Lukas Lueg <lukas.lueg@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "visual-debug" ];
      };
      "railroad_verification" = rec {
        crateName = "railroad_verification";
        version = "0.1.0";
        edition = "2015";
        sha256 = "131qx7xjs06gmna8xvnw6js31y9wmhayaiykssv45qrh3gr7c9dr";
        authors = [
          "Lukas Lueg <lukas.lueg@gmail.com>"
        ];
        dependencies = [
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "extra-traits" "full" "parsing" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
