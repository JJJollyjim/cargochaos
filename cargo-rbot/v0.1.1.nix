...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-rbot/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-rbot" = rec {
        crateName = "cargo-rbot";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-rbot"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "processenv" "processthreadsapi" "std" "synchapi" "winbase" "winerror" ];
      };
