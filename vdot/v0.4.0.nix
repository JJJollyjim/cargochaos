...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vdot/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vdot" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "vdot"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Samuel Parkinson <sam.james.parkinson@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
