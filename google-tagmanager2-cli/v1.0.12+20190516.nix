...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-tagmanager2-cli/v1.0.12+20190516.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-tagmanager2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-tagmanager2" = rec {
        crateName = "google-tagmanager2";
        version = "1.0.12+20190516";
        edition = "2015";
        sha256 = "1b7h38jz319gn3853md08wxprgi3qggpbxlghnf7vpj2wjf2gshh";
        authors = [
      ...
      "google-tagmanager2-cli" = rec {
        crateName = "google-tagmanager2-cli";
        version = "1.0.12+20190516";
        edition = "2015";
        crateBin = [
          { name = "tagmanager2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190516.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-tagmanager2";
            packageId = "google-tagmanager2";
          }
          {
            name = "hyper";
            packageId = "hyper";
