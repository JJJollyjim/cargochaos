...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gls/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "egls" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "025mq3s3szsnpn4ggl5lm33q7cg38dpamfja6qf56sdygwndb8c3";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "hi3559av100" ];
      };
      "encoding_rs" = rec {
      ...
      "gls" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "egls" "gl2" "gl3" "gl4" "gles1" "gles2" "gles3" "hi3516ev200" "hi3516ev300" "hi3518ev200" "hi3518ev300" "hi3519av100" "hi3531v100" "hi3559av100" ];
      };
      "khronos_api" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "fileapi" "libloaderapi" "minwindef" "ntsecapi" "profileapi" "winbase" "winnt" ];
      };
