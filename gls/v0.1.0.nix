...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gls/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gls" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "gl2" "gl3" "gl4" "gles1" "gles2" "gles3" "hi3516ev200" "hi3516ev300" "hi3518ev200" "hi3518ev300" "hi3519av100" "hi3531v100" "hi3559av100" ];
      };
      "khronos_api" = rec {
