...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sled/v0.31.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_off" "std" ];
      };
      "maybe-uninit" = rec {
      ...
      "sled" = rec {
        ...
        resolvedDefaultFeatures = [ "color-backtrace" "compression" "default" "event_log" "fail" "failpoints" "io_uring" "lock_free_delays" "measure_allocs" "no_inline" "no_logs" "no_metrics" "pretty_backtrace" "rand" "rand_chacha" "rand_distr" "rio" "testing" "zstd" ];
      };
      "smallvec 0.6.13" = rec {
        crateName = "smallvec";
        version = "0.6.13";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" ];
      };
