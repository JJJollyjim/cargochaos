...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pygamer/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "accelerometer" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "092s37awj31cvigmw1cfzl3braq8g48h19fy5nzq3anr2k05v7bb";
        authors = [
      ...
      "atsamd-hal" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0q9bi87yxby41ai593bjqzdygmp8m5pwdy823m23bd4sh8xv999k";
        authors = [
        ...
        resolvedDefaultFeatures = [ "atsamd51j19a" "samd51" "samd51j19a" "samd51j19a-rt" "unproven" "usb" "usb-device" ];
      };
      "atsamd51j19a" = rec {
        crateName = "atsamd51j19a";
        version = "0.6.0";
        edition = "2015";
        sha256 = "0bd81g02w0l8mxfb817kp4lw6xi7mzcgvzh97259p0p6bcnf06s5";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
          "Paul Sajna <sajattack@gmail.com>"
        ];
      ...
      "embedded-graphics" = rec {
        ...
        version = "0.4.9";
        edition = "2018";
        sha256 = "1cidd9vvk5yfmaang8jf3y0fpkdldqndg73ldzmbx368k8lfxrxj";
        authors = [
      ...
      "embedded-sdmmc" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0z0k32gg4d78prxwd1kmrxfm60kf86afcg2dpfbw80wr0652zap0";
        authors = [
          "Jonathan 'theJPster' Pallant <github@thejpster.org.uk>"
        ];
        dependencies = [
      ...
      "lis3dh" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "15ldy8aak4fxxm4kwnw47wmjy75an0mab1dqdjzmqkf4jnp03i84";
        authors = [
      ...
      "micromath 0.3.1" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0j05af5gpx5alqvckpdadki96f0nzq5vnznx87qvvrmshw00i72y";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "quaternion" "statistics" "vector" ];
      };
      "micromath 0.5.1" = rec {
        crateName = "micromath";
        version = "0.5.1";
        edition = "2018";
        sha256 = "0dngnsn5n5nnvk9ra51pkw9dq2qpxk2bgicdb2070zirb5451c8x";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        features = {
      ...
      "pygamer" = rec {
        ...
        devDependencies = [
          ...
          {
            name = "smart-leds";
            packageId = "smart-leds";
          }
          {
            name = "ws2812-spi";
            packageId = "ws2812-spi";
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "embedded-sdmmc" "math" "micromath" "rt" "sd-card" "unproven" "usb" "usb-device" "usbd-serial" "ws2812-timer" "ws2812-timer-delay" ];
      };
      "quote 0.6.13" = rec {
        crateName = "quote";
        version = "0.6.13";
      ...
      "smart-leds" = rec {
        crateName = "smart-leds";
        version = "0.3.0";
        edition = "2018";
        sha256 = "02r92mqgvjn3m6wnhaxjigw89lqsc6152pxc1q8v8w2z4zx4bp9q";
        authors = [
        ...
        dependencies = [
          {
            ...
            packageId = "smart-leds-trait";
          }
        ];
        
      };
      "smart-leds-trait" = rec {
        crateName = "smart-leds-trait";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1ryf21s8s0l5vbj61gs666i7mcizq287bka0wqcxwvqssih8xwgy";
        authors = [
          "David Sawatzke <david-sawatzke@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "st7735-lcd" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "02ww036m006b803h9imk1vppvmdm4jdvgz3dglcl4cavg3m482qs";
        authors = [
          "Paul Sajna <sajattack@gmail.com>"
        ];
        dependencies = [
      ...
      "tinybmp" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "047sp4b77c5an0zlzch7vgch36vc13q3m2mg8lismc9ngvg3ygjh";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
      ...
      "tinytga" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "01rzw0ii2k42r6hbra8xqbh72xlmv56mc7cgi0fm8jqz5h2qb56w";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
      ...
      "ws2812-spi" = rec {
        crateName = "ws2812-spi";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1xvg02xwrsgd21l36zhmdkvcsva6dq806cmyc9h1k9y9sa0awiyf";
        authors = [
          "David Sawatzke <david-sawatzke@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "ws2812-timer-delay" = rec {
        crateName = "ws2812-timer-delay";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0048wb5jgadbpvlscf5ava021ls4fc6arif48hc16i3dbk13kcxr";
        authors = [
          "David Sawatzke <david-sawatzke@users.noreply.github.com>"
        ];
        dependencies = [
