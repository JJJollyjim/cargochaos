...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darklua/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lualexer" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0a4wqn9dpjgc8jwhgd73jhknny503c7dx690dfmjdwnx52ik0k37";
        authors = [
          "jeparlefrancais <jeparlefrancais21@gmail.com>"
        ];
      ...
      "luaparser" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0dm4ilgx83bi1w793822s7q9l4bamxa0nsq8b6vnhij8xksjbj6m";
        authors = [
          "jeparlefrancais <jeparlefrancais21@gmail.com>"
        ];
        dependencies = [
