...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darklua/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lualexer" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1raq1yl4cxpfbwqg0dxjfxz75yrhzmv6v50qgqf13nmg0slk5mfs";
        authors = [
          "jeparlefrancais <jeparlefrancais21@gmail.com>"
        ];
      ...
      "luaparser" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1p3v5vbslh39xmjirysrq3rhzlfizvpcbmhxwvn826j84kvrn22h";
        authors = [
          "jeparlefrancais <jeparlefrancais21@gmail.com>"
        ];
        dependencies = [
