...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/where_am_i/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "where_am_i" = rec {
        crateName = "where_am_i";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "where_am_i"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "kekonen <daniil.naumetc@gmail.com>"
        ];
        dependencies = [
          {
            name = "reqwest";
