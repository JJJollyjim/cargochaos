...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-stake-monitor/v1.0.17.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-archiver-lib" = rec {
        ...
        version = "1.1.3";
        edition = "2018";
        sha256 = "0y35mfh44mlrzy1p3jfmxm6zrx6s8yar55f6l96b1qkw3vjn6ksw";
      ...
      "solana-download-utils" = rec {
        ...
        version = "1.1.3";
        edition = "2018";
        sha256 = "01x6ncwsp13h5sf3d966wwy1wrxpnp88v8zri4xv955d6y951kn6";
      ...
      "solana-local-cluster" = rec {
        ...
        version = "1.1.3";
        edition = "2018";
        sha256 = "0jc6jm0dnvmfjxcf6g7pnnrv69va7h1l57spsnwhq073ibd9fc23";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
      ...
      "solana-stake-monitor" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.17.nix {};
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
