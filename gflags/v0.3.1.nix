...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gflags/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gflags-impl" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0jr5yqqbzps509ivmph21rz86cv755czjl6jd6ds4qf3gl98w4hp";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "ref-cast" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "0jgj1zxaikqm030flpifbp517fy4z21lly6ysbwyciii39bkzcf1";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "ref-cast-impl" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "0hw0frpzna5rf5szix56zyzd0vackcb3svj94ndj629xi75dkb32";
        procMacro = true;
