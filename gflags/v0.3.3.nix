...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gflags/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "argv" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "083q7a8ryajivmc4p15jlmc51cs8591gvcv2mrm6vw28d3cfc619";
        authors = [
      ...
      "gflags-impl" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "0jxxda959idalgfka93ib455na6pdzanrbkn3pp72ac5a3jd2arq";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
