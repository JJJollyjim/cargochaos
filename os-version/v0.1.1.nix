...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/os-version/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "os-version" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "libloaderapi" "ntstatus" "sysinfoapi" "winnt" "winuser" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "libloaderapi" "ntstatus" "sysinfoapi" "winnt" "winuser" ];
      };
