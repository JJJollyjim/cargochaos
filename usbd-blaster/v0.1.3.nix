...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/usbd-blaster/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arduino_mkrvidor4000" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0cq5zai2vx6klhsgph2wih8f7chxkih94rc11zlvia2l3wjpjbfj";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "panic-halt" "panic_halt" "rt" "unproven" "usb" ];
      };
      "as-slice" = rec {
        crateName = "as-slice";
        version = "0.1.3";
