...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-playmoviespartner1-cli/v1.0.13+20170919.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-playmoviespartner1-cli";
  ...
  workspaceMembers = {
    "google-playmoviespartner1-cli" = rec {
      packageId = "google-playmoviespartner1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-playmoviespartner1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-playmoviespartner1" = rec {
        crateName = "google-playmoviespartner1";
        version = "1.0.13+20170919";
        edition = "2015";
        sha256 = "1s9lqm3sbslv3pvmxzs1calmzs75s202x21jx4zphc57rkx6zspw";
        authors = [
      ...
      "google-playmoviespartner1-cli" = rec {
        crateName = "google-playmoviespartner1-cli";
        version = "1.0.13+20170919";
        edition = "2015";
        crateBin = [
          { name = "playmoviespartner1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20170919.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-playmoviespartner1";
          }
          {
            name = "hyper";
            packageId = "hyper";
