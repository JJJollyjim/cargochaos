...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eigenvalues/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eigenvalues" = rec {
        crateName = "eigenvalues";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "eigenvalues"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "felipe <tifonzafel@gmail.com>"
        ];
        dependencies = [
          {
            name = "approx";
