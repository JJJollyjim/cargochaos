...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-open-on-git-xx/v0.0.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mdbook-open-on-git-xx";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-open-on-git-xx" = rec {
        crateName = "mdbook-open-on-git-xx";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "mdbook-open-on-git-xx"; path = "src/bin/mdbook-open-on-git-xx.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "gameendman <gameendman99@gmail.com>"
