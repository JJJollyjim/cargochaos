...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ta/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "assert_approx_eq" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "0mb6alf90c0xvljinzniddkmayccwr3wrhfpc654pws9azfs0f0s";
        authors = [
      ...
      "backtrace-sys" = rec {
        ...
        version = "0.1.14";
        edition = "2015";
        sha256 = "12fi5hljlgbp4xkg2rpz7gs4xy2imhqayp8gkm011nwgxx0s2gn6";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "libc" = rec {
        ...
        version = "0.2.31";
        edition = "2015";
        sha256 = "0v45hr5mias9carylbqr5d9nnm67hcancd7bgyvl9g5074lrnhfi";
        authors = [
          "The Rust Project Developers"
        ];
        features = {
