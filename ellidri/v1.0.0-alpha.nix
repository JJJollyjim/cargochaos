...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ellidri/v1.0.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ellidri" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "tokio";
            usesDefaultFeatures = false;
            features = [ "rt-core" "io-util" "tcp" "sync" ];
          }
          {
            name = "tokio-tls";
            packageId = "tokio-tls";
        ...
        resolvedDefaultFeatures = [ "default" "threads" ];
      };
      "ellidri-unicase" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "sync" "tcp" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
