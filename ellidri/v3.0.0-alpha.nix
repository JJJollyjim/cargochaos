...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ellidri/v3.0.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ellidri" = rec {
        ...
        src = pkgs.callPackage ./tarball-v3.0.0-alpha.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "tokio";
            usesDefaultFeatures = false;
            features = [ "blocking" "io-util" "rt-threaded" "sync" "tcp" "time" ];
          }
          {
            name = "tokio-postgres";
      ...
      "ellidri-unicase" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "075j6ddw6icw58pyh33d1clalrvn1bp4xxj3ihy2p4jx4anig5gi";
        authors = [
          "Hubert Hirtz <hubert.hirtz@laposte.net>"
        ];
