...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ellidri/v3.0.0-beta.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chrono" = rec {
        ...
        resolvedDefaultFeatures = [ "clock" "std" "time" ];
      };
      "clap" = rec {
        crateName = "clap";
        version = "2.33.0";
      ...
      "ellidri" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ellidri"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v3.0.0-beta.nix {};
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "ellidri-reader";
            packageId = "ellidri-reader";
          }
          {
            name = "ellidri-tokens";
            packageId = "ellidri-tokens";
          }
          {
            name = "ellidri-unicase";
            packageId = "ellidri-unicase";
          }
          {
            name = "env_logger";
          ...
          }
          {
            ...
            packageId = "regex";
            usesDefaultFeatures = false;
            features = [ "std" "perf" "unicode-case" ];
          }
          {
            name = "regex-syntax";
          ...
          }
          {
            ...
            packageId = "tokio";
            usesDefaultFeatures = false;
            features = [ "blocking" "io-util" "rt-threaded" "signal" "sync" "tcp" "time" ];
          }
          {
            name = "tokio-postgres";
        ...
        resolvedDefaultFeatures = [ "default" "postgres" "r2d2" "r2d2_postgres" "r2d2_sqlite" "rusqlite" "sqlite" "tokio-postgres" ];
      };
      "ellidri-reader" = rec {
        crateName = "ellidri-reader";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0fqqjxkzj9bvbg0xbqs6ci789qchxwzbbwgsajmbl3pzwqg716gd";
        authors = [
          "Hubert Hirtz <hubert.hirtz@laposte.net>"
        ];
        dependencies = [
      ...
      "ellidri-tokens" = rec {
        crateName = "ellidri-tokens";
        version = "0.1.0";
        edition = "2018";
        sha256 = "18nf1ifslskym78wrh3mzcz2gzgg7zwmy6jmkqhs2yjawi0gpm3w";
        authors = [
          "Hubert Hirtz <hubert.hirtz@laposte.net>"
        ];
      ...
      "ellidri-unicase" = rec {
        crateName = "ellidri-unicase";
        version = "2.1.0";
        edition = "2018";
        sha256 = "14ak17iv4dim4xnbg1qk7zmwibqsvrzjd70bykycdjicblyp2v9p";
        authors = [
          "Hubert Hirtz <hubert.hirtz@laposte.net>"
        ];
      ...
      "r2d2_postgres" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "13zyiq4rsqakmk3rgbj153dfgk7z3xhxkxj1244c3fj3dzv2fzbh";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "regex" = rec {
        ...
        resolvedDefaultFeatures = [ "aho-corasick" "memchr" "perf" "perf-cache" "perf-dfa" "perf-inline" "perf-literal" "std" "thread_local" "unicode-case" ];
      };
      "regex-syntax" = rec {
        ...
        resolvedDefaultFeatures = [ "unicode-case" ];
      };
      "remove_dir_all" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-postgres" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
