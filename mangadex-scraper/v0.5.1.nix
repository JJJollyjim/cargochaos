...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mangadex-scraper/v0.5.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mangadex-scraper" = rec {
        crateName = "mangadex-scraper";
        version = "0.5.1";
        edition = "2018";
        crateBin = [
          { name = "mangadex-scraper"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.1.nix {};
        authors = [
          "dyedquartz <dyedquartz@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
