...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/itsybitsy_m4/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "apa102-spi" = rec {
        crateName = "apa102-spi";
        version = "0.3.2";
        edition = "2018";
        sha256 = "18sp9i7r7cl4mfq3kajiz36b7al2j0nkkp72972mpbiazn8dcb6r";
        authors = [
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd51g19a" "samd51" "samd51g19a" "samd51g19a-rt" "unproven" "usb" "usb-device" "use_uart_debug" ];
      };
      "atsamd51g19a" = rec {
      ...
      "bitbang-hal" = rec {
        crateName = "bitbang-hal";
        version = "0.3.0";
        edition = "2018";
        sha256 = "095wcv4i2bfhfq90qjs0m90n3fvgm5wc65qgj6y42piik23r4x5r";
        authors = [
          "Paul Sajna <sajattack@gmail.com>"
        ];
        dependencies = [
      ...
      "itsybitsy_m4" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "unproven" "usb" "usb-device" "usbd-serial" "use_uart_debug" ];
      };
      "jlink_rtt" = rec {
        crateName = "jlink_rtt";
        version = "0.1.0";
      ...
      "smart-leds" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "106h9q9z0djzynrjrbznf59n78y8girc5m10q2zm02766klk02mb";
        authors = [
          "David Sawatzke <david-sawatzke@users.noreply.github.com>"
          "Paul Sajna <sajattack@gmail.com>"
        ];
