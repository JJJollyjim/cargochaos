...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miniaudio/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ep-miniaudio-sys" = rec {
        ...
        version = "1.1.1";
        edition = "2018";
        sha256 = "1614srjpkmzkxh2d323fm25szscjfdpvkrkifj07p0nkv1id93xc";
      ...
      "miniaudio" = rec {
        ...
        features = {
          ...
          "ma-enable-dr-flac" = [ "ep-miniaudio-sys/ma-enable-dr-flac" ];
          "ma-enable-dr-mp3" = [ "ep-miniaudio-sys/ma-enable-dr-mp3" ];
          "ma-enable-dr-wav" = [ "ep-miniaudio-sys/ma-enable-dr-wav" ];
