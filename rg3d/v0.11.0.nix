...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rg3d/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lewton" = rec {
        ...
        version = "0.10.0";
        edition = "2015";
        sha256 = "08xfry2an25sw5a66w8dcjipkc28ja4cns8x6c41s8px61s7md9p";type = [ "lib" "staticlib" ];
        authors = [
      ...
      "rg3d-physics" = rec {
        crateName = "rg3d-physics";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1h9alddflfbs9cg061d9z39hsw2fjfa88x0mxk5mn7gnq900k6jv";
        authors = [
          "Dmitry Stepanov <d1maxa@yandex.ru>"
        ];
        dependencies = [
      ...
      "rg3d-sound" = rec {
        ...
        version = "0.13.0";
        edition = "2018";
        sha256 = "1h2zwdlwmqkv4fwxnv7zm6c5169f8jpv7r7pgmydc9ncnl12pz0p";
        authors = [
          "Dmitry Stepanov <d1maxa@yandex.ru>"
        ];
        dependencies = [
      ...
      "rg3d-ui" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0zbswin1hvq27n13m9cqvz4343dy16yrpn1cd5yqrzlvr5sbzrzw";
        authors = [
          "Dmitry Stepanov <d1maxa@yandex.ru>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "commctrl" "consoleapi" "dsound" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "libloaderapi" "memoryapi" "minwindef" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "synchapi" "sysinfoapi" "unknwnbase" "winbase" "wincon" "windef" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
