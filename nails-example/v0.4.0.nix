...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nails-example/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nails" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0mj1za59sn3qkwpp4k1dj38b682snm31sgsgd1kxf7rqb7v25w5v";
        authors = [
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "stream" ];
          }
        ];
        
      };
      "nails-example" = rec {
        crateName = "nails-example";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "nails-example"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "nails-fork";
            packageId = "nails-fork";
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-core" "stream" "tcp" ];
          }
        ];
        
      };
      "nails-fork" = rec {
        crateName = "nails-fork";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1rmmrp0g1paw8m75nkswcxwbm17af7iffdwgd3bc1ma22jsc6lwd";
        authors = [
          "Stu Hood <stuhood@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "futures-core" "io-driver" "iovec" "lazy_static" "libc" "macros" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "stream" "tcp" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
