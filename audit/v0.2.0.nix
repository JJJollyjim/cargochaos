...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/audit/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "netlink-packet-audit" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0gdfkfn5lynkkscjk6m40vka4kqn6dhcsv347f21cnjq3ds8vsv4";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
      ...
      "netlink-packet-core" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0myr7qp8f9r82rzqcry4rrj73l1rpb6y6vc8b3xvy06vl2dfknlw";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
      ...
      "netlink-packet-utils" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1zysdwwvph4x06l4y4kgvfarlsb5kh292li54nlhkk777wzxw9na";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
      ...
      "netlink-proto" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1974qdkg4w7gg4sdff4nmfa2465f4x1jcvjyw2w2s55hp0q1rskl";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "workaround-audit-bug" ];
      };
      "netlink-sys" = rec {
        crateName = "netlink-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1gr5aqlm4pyvwjra6w0pnjspcrvjfwqbzq5mv4kg816ckfxjiqdf";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "futures" "mio" "mio_socket" "tokio" "tokio_socket" ];
      };
      "paste" = rec {
        crateName = "paste";
        version = "0.1.6";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "io-util" "lazy_static" "macros" "memchr" "mio" "rt-core" "tokio-macros" ];
      };
      "tokio-macros" = rec {
