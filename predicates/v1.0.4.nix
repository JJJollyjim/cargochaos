...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/predicates/v1.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "predicates" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "difference" "float-cmp" "normalize-line-endings" "regex" "unstable" ];
      };
      "predicates-core" = rec {
