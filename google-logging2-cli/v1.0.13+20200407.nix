...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-logging2-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-logging2" = rec {
        crateName = "google-logging2";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "047fdyzjzx9ddr6a0lfnsqlwq0a2gai3l67di1r6lxz4q0lfk2v2";
        authors = [
      ...
      "google-logging2-cli" = rec {
        crateName = "google-logging2-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "logging2"; path = "src/main.rs"; }
        ];
