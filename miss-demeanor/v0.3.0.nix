...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miss-demeanor/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "miss-demeanor" = rec {
        crateName = "miss-demeanor";
        version = "0.3.0";
        edition = "2015";
        crateBin = [
          { name = "miss-demeanor"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "miss-demeanor-pluginutils";
            packageId = "miss-demeanor-pluginutils";
          }
          {
            name = "native-tls";
            packageId = "native-tls";
      ...
      "miss-demeanor-pluginutils" = rec {
        crateName = "miss-demeanor-pluginutils";
        version = "0.3.0";
        edition = "2015";
        sha256 = "05k64ki4dsk9l3793zxzrb1fgmfnhawm3yihymxvn1fddqpc6lys";
        libName = "missdemeanor";type = [ "lib" "staticlib" ];
        authors = [
          "John Baublitz <john.m.baublitz@gmail.com>"
        ];
        dependencies = [
