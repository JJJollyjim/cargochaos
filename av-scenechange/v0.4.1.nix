...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/av-scenechange/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "av-scenechange" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "av-scenechange"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "binary" "clap" "default" "serde" "serde_json" "serialize" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
