...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/track/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde-diff" = rec {
        crateName = "serde-diff";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1nxf58z0xbijxhryfdzhxj162ircyiggl3nh8ddg4ffr9vicyczb";
        authors = [
      ...
      "serde-diff-derive" = rec {
        crateName = "serde-diff-derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "07sl07vwch5sk5fpygz9vqkp2x4ddhjyp149i37vms4c5fx41jw6";
        procMacro = true;
        libName = "serde_diff_derive";
        authors = [
          "Karl Bergström <karl.anton.bergstrom@gmail.com>"
          "Philip Degarmo <aclysma@gmail.com>"
        ];
      ...
      "serde_derive" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "deserialize_in_place" ];
      };
      "serde_json" = rec {
      ...
      "track" = rec {
        ...
        dependencies = [
          ...
          {
            name = "serde-diff";
            packageId = "serde-diff";
          }
          {
            name = "track-macro";
            packageId = "track-macro";
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "bincode" "bincode-serialization" "default" "rmp-serde" "rmp-serialization" ];
      };
      "track-macro" = rec {
        crateName = "track-macro";
        version = "0.1.0";
        edition = "2018";
        sha256 = "12psh8icn2pcmq2v0f143129h0qzfkiyhrkna9z1djiikg57pdvh";
        procMacro = true;
        authors = [
          "Timon Post"
        ];
