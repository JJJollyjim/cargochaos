...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/multican/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "14l9nbpsrj772i3nrk235chm87hs1svsl7dp67fmh7lc0s8dx891";
        authors = [
      ...
      "clang-sys" = rec {
        ...
        version = "0.16.0";
        edition = "2015";
        sha256 = "0ks158y4zwhxa01xdkis9pa992z4aypayh199p6ii8ygqjh6lksz";
        authors = [
      ...
      "multican" = rec {
        ...
        authors = [
          "Nick Gamroth <thebeekeeper@gmail.com>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "pcan-basic-sys" = rec {
        crateName = "pcan-basic-sys";
        version = "0.2.0";
        edition = "2015";
        sha256 = "1v0bidgcmq26y55vgq6k2wlpgsbmk55si1pn7ihg7hxam5p1chdi";
        authors = [
          "Christopher J. Woodall <chris.j.woodall@gmail.com>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "processenv" "winbase" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
