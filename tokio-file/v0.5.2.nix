...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-file/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cc" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1cbn5aqp6kdd5lkfgm05hz1wqlbzbbb9rc31wyz0yzld413g3ckx";
        authors = [
      ...
      "divbuf" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "092nj17y839y34ikinlk65p7hv61iqhw9038i4rnm2p7vfg760pv";
        authors = [
      ...
      "errno" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "0w2xp7vkiwf9ssy09nb43x7ssz4lxnq8ijlgyhr8bf605b25ij5j";
        authors = [
      ...
      "galvanic-test" = rec {
        crateName = "galvanic-test";
        version = "0.1.5";
        edition = "2015";
        sha256 = "0zbxjwk3brcwnzzqfvhab6zqzlgbh7jgqxw1n7m4m6w0p8la5s2b";
        authors = [
          "Christopher Bacher <mindsbackyard@gmail.com>"
        ];
        features = {
      ...
      "kernel32-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1npa4wj6bqb6bsp89q3a5pzk9si73mgim3i8h98rgzcvnj2a075d";
        libName = "kernel32";
        authors = [
      ...
      "mio-aio" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "140z6inxgcclqnfmsv7776q06phqq9ld9dnh9cc2xk2x0s16k7ip";
        authors = [
          "Alan Somers <asomers@gmail.com>"
        ];
        dependencies = [
      ...
      "sysctl" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "070lw9sv33450lqwdd0xy4fsrxn4w4vbyci1px72k4dbjmyshz9w";
        authors = [
      ...
      "tokio-timer" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "0smrds9c6cxp9vmhfwscynwk3xz4chijgggqvw706qaggblv8xhw";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
      ...
      "winapi 0.2.6" = rec {
        ...
        version = "0.2.6";
        edition = "2015";
        sha256 = "1m2zvmw4c99dnj28v890359df3b9kmvb4nabj6k8yqdapn7smyjd";
        authors = [
          "Peter Atashian <retep998@gmail.com>"
        ];
      ...
      "ws2_32-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1n79driq2qvnaxqvfz8yr95jsn5vdpaf9p04c5p9nxjzbcw6qpzf";
        libName = "ws2_32";
        authors = [
          "Peter Atashian <retep998@gmail.com>"
        ];
