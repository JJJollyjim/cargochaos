...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/foxdie/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "foxdie" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "foxdie"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Aaron Sky <asky@wayfair.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "what_git" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "16ng25qhnmzvl30rcxq4idcn1vh8fq2jx564y2lvr9r6q70q8v9n";
        authors = [
          "Aaron Sky <asky@wayfair.com>"
        ];
        dependencies = [
