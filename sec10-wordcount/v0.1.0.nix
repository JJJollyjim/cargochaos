...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sec10-wordcount/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sec10-wordcount" = rec {
        crateName = "sec10-wordcount";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "sec10-wordcount"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "modeverv <modeverv@gmail.com>"
        ];
        dependencies = [
          {
            name = "regex";
