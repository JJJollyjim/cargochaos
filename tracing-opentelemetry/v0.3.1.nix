...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tracing-opentelemetry/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "opentelemetry" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0557sgkdcmcza1cdla4fk0sdbj0afhqdi47nadp5dfqqd8wajssx";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "futures" "metrics" "pin-project" "prometheus" "rand" "trace" ];
      };
      "opentelemetry-jaeger" = rec {
        crateName = "opentelemetry-jaeger";
        version = "0.3.0";
        edition = "2018";
        sha256 = "19z6ywbfpxlynl4snpnfp1rbgz06xy01v4ljahkcnpc1v1r54y71";
        authors = [
          "OpenTelemetry Authors <cncf-opentelemetry-contributors@lists.cncf.io>"
        ];
        dependencies = [
