...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-commentanalyzer1_alpha1-cli/v1.0.12+20190616.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-commentanalyzer1_alpha1-cli";
  ...
  workspaceMembers = {
    "google-commentanalyzer1_alpha1-cli" = rec {
      packageId = "google-commentanalyzer1_alpha1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-commentanalyzer1_alpha1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-commentanalyzer1_alpha1" = rec {
        crateName = "google-commentanalyzer1_alpha1";
        version = "1.0.12+20190616";
        edition = "2015";
        sha256 = "0c139a8cmngv3ylgj37mlniy1q5x3xwzw2wk152yprqpfb6m137r";
        authors = [
      ...
      "google-commentanalyzer1_alpha1-cli" = rec {
        crateName = "google-commentanalyzer1_alpha1-cli";
        version = "1.0.12+20190616";
        edition = "2015";
        crateBin = [
          { name = "commentanalyzer1-alpha1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190616.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-commentanalyzer1_alpha1";
          }
          {
            name = "hyper";
            packageId = "hyper";
