...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dnscat/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dnscat" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dnscat"; path = "src/bin/dnscat.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "cli" "client" "client-cli" "constant_time_eq" "default" "dotenv" "encryption" "env_logger" "ring" "salsa20" "secstr" "sha3" "structopt" "trust-dns-client" "trust-dns-resolver" ];
      };
      "dotenv" = rec {
        crateName = "dotenv";
        version = "0.15.0";
