...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fit_text/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fit_text" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "graphics" "piston2d-graphics" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "graphics_buffer" = rec {
        ...
        version = "0.7.3";
        edition = "2018";
        sha256 = "00k8adl0v3ha0rc31m49yglid6yhgkpdiablb7aw3frjh4nfshfi";
        authors = [
          "Kai Schmidt <kaikaliischmidt@gmail.com>"
        ];
        dependencies = [
      ...
      "vector2math" = rec {
        crateName = "vector2math";
        version = "0.6.0";
        edition = "2018";
        sha256 = "0mfbxc6yndwc9125ayh5600i5gwmpgslj7iwgh58p375ip11acr4";
        authors = [
          "Kai Schmidt <kaikaliischmidt@gmail.com>"
        ];
