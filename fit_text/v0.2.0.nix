...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fit_text/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fit_text" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "piston2d-graphics 0.36.0";
            optional = true;
          }
          {
            name = "rusttype";
      ...
      "graphics_buffer" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "1ffzvvcn1qhjj588955fff8mvp899lrs5jzs844x19m3qiz4g1b8";
        authors = [
          "Kai Schmidt <kaikaliischmidt@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "piston2d-graphics";
            packageId = "piston2d-graphics 0.35.0";
