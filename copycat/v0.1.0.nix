...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/copycat/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "minwinbase" "minwindef" "processenv" "shellapi" "std" "winbase" "winuser" ];
      };
