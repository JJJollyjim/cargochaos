...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/syslog_loose/v0.2.0.nix.tmp"
    ...
    crates = {
      ...
      "syslog_loose" = rec {
        ...
        devDependencies = [
          ...
          {
            name = "syslog_rfc5424";
            packageId = "syslog_rfc5424";
          }
        ];
        
      };
      "syslog_rfc5424" = rec {
        crateName = "syslog_rfc5424";
        version = "0.6.1";
        edition = "2015";
        sha256 = "0yvynyl4iwg7p3l8ariwy15dsvg5f9v313g2lyjd432aa4kw9xfi";
        authors = [
