...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/quicksilver/v0.4.0-alpha0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "19ldz597ysbhvkh3caazyaa32fj8nacqn3l9jkdhk8spmy25anxl";
        authors = [
        ...
        resolvedDefaultFeatures = [ "enum-map" "event-cache" "gamepad" "gilrs" "gl" "glow" "glutin" "rustc-hash" "std_web" "stdweb" "wasm-bindgen" "web-sys" "web_sys" "webgl_stdweb" ];
      };
      "block" = rec {
        crateName = "block";
        version = "0.1.6";
      ...
      "elefont" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "17mf8jxqsplbfnp1xirzlb81k9g7vq0kx8jhb92hhxxcv96qd0d7";
        authors = [
          "Ryan Goldstein <ryan@ryanisaacg.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "rusttype" "unicode-normalization" ];
      };
      "ena" = rec {
        crateName = "ena";
        version = "0.11.0";
      ...
      "gestalt" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1c5h711m7j1rbi96m84fgvwj3q1is2flaadnjlw7r1v5vk7r91iq";
        authors = [
          "Ryan Goldstein <ryanisaacg@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "golem" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "09bb8jq4gx6gns9lx8r1n6f0i25dhjw3c2355qjs59mva342d8x9";
        authors = [
          "Ryan Goldstein <ryan@ryanisaacg.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "std" "stdweb" "web-sys" ];
      };
      "hashbrown" = rec {
        crateName = "hashbrown";
        version = "0.7.1";
      ...
      "platter" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0921x6w4paqphlv3z1d3d7hiph23fcmwjzhi158p1sjcxm879585";
        authors = [
          "Ryan Goldstein <ryanisaacg@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "js-sys" "stdweb" "wasm-bindgen" "web-sys" "web_sys" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.15.3";
      ...
      "quicksilver" = rec {
        crateName = "quicksilver";
        version = "0.4.0-alpha0.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.0-alpha0.3.nix {};
        authors = [
          "Ryan Goldstein <ryanisaacg@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "elefont";
            optional = true;
            features = [ "rusttype" "unicode-normalization" ];
          }
          {
            name = "gestalt";
            packageId = "gestalt";
        ...
        resolvedDefaultFeatures = [ "default" "easy-log" "elefont" "event-cache" "font" "gamepad" "gestalt" "rusttype" "saving" "simple_logger" "stdweb" "ttf" "web-sys" "web_logger" ];
      };
      "quote 0.3.15" = rec {
        crateName = "quote";
        version = "0.3.15";
      ...
      "simple_logger" = rec {
        ...
        version = "1.4.0";
        edition = "2015";
        sha256 = "0kn7pilam4412l0vy5p3fdisiy7h67hba4vkapg7jjyvj7gsr7qh";
        authors = [
      ...
      "web_logger" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "wasm-bindgen";
            packageId = "wasm-bindgen";
            target = { target, features }: ((target."arch" == "wasm32") && (!target."cargo_web"));
          }
        ];
      ...
      "winit" = rec {
        ...
        resolvedDefaultFeatures = [ "std_web" "stdweb" "wasm-bindgen" "web-sys" "web_sys" ];
      };
      "ws2_32-sys" = rec {
