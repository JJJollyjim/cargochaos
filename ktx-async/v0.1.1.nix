...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ktx-async/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "commctrl" "consoleapi" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "ioapiset" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
