...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/foundationdb/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "foundationdb-gen" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "153psidbkk2ppwdczmgs1m16vbyjkwlj72lvqx1v8ry8i6kksg87";
        authors = [
      ...
      "foundationdb-sys" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "1rb87d5lpr60kvryzcw7jk7kdlxj996g51a467vgbjxdjriwayjl";
        authors = [
          "Benjamin Fry <benjaminfry@me.com>"
          "Vincent Rouillé <vincent@clikengo.com>"
        ];
