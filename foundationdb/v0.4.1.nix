...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/foundationdb/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "foundationdb" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "embedded-fdb-include" "fdb-5_1" "fdb-5_2" "fdb-6_0" "fdb-6_1" "fdb-6_2" "uuid" ];
      };
      "foundationdb-gen" = rec {
        crateName = "foundationdb-gen";
        version = "0.4.1";
        edition = "2018";
        crateBin = [];
        sha256 = "17bbabailg82yr5h571n0yadha161ilm4ca7prdmzm6f7ikdlqkb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "embedded-fdb-include" "fdb-5_1" "fdb-5_2" "fdb-6_0" "fdb-6_1" "fdb-6_2" ];
      };
      "foundationdb-sys" = rec {
        crateName = "foundationdb-sys";
        version = "0.4.1";
        edition = "2018";
        sha256 = "157vr53fcnd12hpp5p5c2rcgjxcbh9w7b5l0wqg6v0c93av5g3r3";
        authors = [
          "Benjamin Fry <benjaminfry@me.com>"
          "Vincent Rouillé <vincent@clikengo.com>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rt-core" ];
      };
      "unicode-width" = rec {
