...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-groupssettings1-cli/v1.0.13+20190725.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-groupssettings1-cli";
  ...
  workspaceMembers = {
    "google-groupssettings1-cli" = rec {
      packageId = "google-groupssettings1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-groupssettings1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-groupssettings1" = rec {
        crateName = "google-groupssettings1";
        version = "1.0.13+20190725";
        edition = "2015";
        sha256 = "0mpiq0vvs9z7aa4whj6kqvldwmrwcb7pifl5h2xaacm8l46nj68p";
        authors = [
      ...
      "google-groupssettings1-cli" = rec {
        crateName = "google-groupssettings1-cli";
        version = "1.0.13+20190725";
        edition = "2015";
        crateBin = [
          { name = "groupssettings1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190725.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-groupssettings1";
          }
          {
            name = "hyper";
            packageId = "hyper";
