...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zmq/v0.9.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "zmq" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "vendored" "zmq_has" ];
      };
      "zmq-sys" = rec {
        crateName = "zmq-sys";
        version = "0.11.0";
