...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket_cors/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket_cors" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_derive" "serialization" "unicase_serde" ];
      };
      "rocket_http" = rec {
      ...
      "unicase_serde" = rec {
        crateName = "unicase_serde";
        version = "0.1.0";
        edition = "2015";
        sha256 = "1w8iig5nqia75ggppmc5m4q2gqcdq85zh2hnydllv1wxcybkdxbf";
        authors = [
          "Yong Wen Chua <me@yongwen.xyz>"
        ];
        dependencies = [
