...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/quiche/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quiche" = rec {
        ...
        build = "src/build.rs";type = [ "lib" "staticlib" "cdylib" ];
        authors = [
        ...
        resolvedDefaultFeatures = [ "bench" "boringssl-vendored" "criterion" "default" "fuzzing" "ndk-old-gcc" "pkg-config-meta" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.3";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "std" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
