...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/envopt/v0.0.0.nix.tmp"
    ...
    crates = {
      "envopt" = rec {
        ...
        dependencies = [
          {
            name = "envopt-derive";
            packageId = "envopt-derive";
          }
        ];
        
      };
      "envopt-derive" = rec {
        crateName = "envopt-derive";
        version = "0.0.0";
        edition = "2018";
        sha256 = "1ngl1mrf5mxmq4x1ybfbkljgrg40qlcw4h8vb217zmcw1hz8fr06";
        procMacro = true;
        authors = [
          "Zoran Zaric <zz@zoranzaric.de>"
        ];
