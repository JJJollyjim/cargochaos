...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markup5ever_arcdom/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "markup5ever_arcdom" = rec {
        crateName = "markup5ever_arcdom";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        libPath = "lib.rs";
        authors = [
          "Max Gonzih <gonzih@gmail.com>"
        ];
        dependencies = [
          {
            name = "html5ever";
