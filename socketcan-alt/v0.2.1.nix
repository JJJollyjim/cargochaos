...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/socketcan-alt/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "socketcan-alt" = rec {
        ...
        resolvedDefaultFeatures = [ "aio" "futures" "mio" "tokio" ];
      };
      "spin" = rec {
        crateName = "spin";
        version = "0.5.2";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "macros" "mio" "rt-core" "slab" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
