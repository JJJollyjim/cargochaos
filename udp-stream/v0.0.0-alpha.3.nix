...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/udp-stream/v0.0.0-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "io-driver" "io-util" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "sync" "time" "tokio-macros" "udp" ];
      };
      "tokio-macros" = rec {
      ...
      "udp-stream" = rec {
        crateName = "udp-stream";
        version = "0.0.0-alpha.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.0-alpha.3.nix {};
        authors = [
          "SajjadPourali <sajjad@securation.com>"
        ];
        dependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "udp" "sync" "rt-core" "io-util" ];
          }
        ];
        devDependencies = [
          {
