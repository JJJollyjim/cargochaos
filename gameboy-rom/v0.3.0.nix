...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gameboy-rom/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gameboy-rom" = rec {
        crateName = "gameboy-rom";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "gb2json"; path = "src/bin/gb2json.rs"; }
          { name = "gbstats"; path = "src/bin/gbstats.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Mark McCaskey <maoeurk@gmail.com>"
        ];
        dependencies = [
          {
            name = "nom";
