...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-apk/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-apk" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-apk"; path = "src/main.rs"; }
        ];
      ...
      "cargo-subcommand" = rec {
        crateName = "cargo-subcommand";
        version = "0.4.4";
        edition = "2018";
        crateBin = [];
        sha256 = "1f3h17yhqg0s7b41n59g8197kff48rahq09ydb2rvj9cz6czdwll";
        authors = [
          "David Craven <david@craven.ch>"
        ];
        dependencies = [
      ...
      "ndk-build" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "06qbw3pn7mnc2n5pdh4bkvjxr0lcm2lms2p94y1racwpvqnd9bxd";
        authors = [
          "David Craven <david@craven.ch>"
        ];
        dependencies = [
