...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dht-sensor/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dht-sensor" = rec {
        crateName = "dht-sensor";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Michael Beaumont <mjboamail@gmail.com>"
        ];
        dependencies = [
          {
            name = "embedded-hal";
      ...
      "stm32f0" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "1lbrrc1b3af3dwpa9m8hm3m66nmv94176x73r2bzwv2k457lizma";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "stm32f0x2" ];
      };
      "stm32f0xx-hal" = rec {
        crateName = "stm32f0xx-hal";
        version = "0.15.2";
        edition = "2018";
        sha256 = "1qwdn0v4nljjqj7ml8569657cnnq7fflg52mg1kfc43mfprldy6c";
        authors = [
        ...
        resolvedDefaultFeatures = [ "device-selected" "stm32f042" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.13";
