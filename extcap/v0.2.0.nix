...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/extcap/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "extcap" = rec {
        ...
        resolvedDefaultFeatures = [ "async-api" "ctrl-pipe" "default" "futures" "tokio" "tokio-util" ];
      };
      "fuchsia-zircon" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "futures-core" "io-driver" "io-util" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "stream" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "cguid" "commapi" "consoleapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "objbase" "processenv" "profileapi" "setupapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
