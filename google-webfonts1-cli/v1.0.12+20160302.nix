...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-webfonts1-cli/v1.0.12+20160302.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-webfonts1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-webfonts1" = rec {
        crateName = "google-webfonts1";
        version = "1.0.12+20160302";
        edition = "2015";
        sha256 = "0qa90xn3wvs3fcyw6ck1zjr7id8amnp07d960briy35i12gchhbx";
        authors = [
      ...
      "google-webfonts1-cli" = rec {
        crateName = "google-webfonts1-cli";
        version = "1.0.12+20160302";
        edition = "2015";
        crateBin = [
          { name = "webfonts1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20160302.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
