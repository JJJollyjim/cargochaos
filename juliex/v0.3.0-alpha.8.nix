...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/juliex/v0.3.0-alpha.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-ready" = rec {
        ...
        version = "2.1.0";
        edition = "2018";
        sha256 = "0lz7n0mcjldl30xkr7p3jf9y43vzx5sbrxci4p4dbvklys40ysdv";
        authors = [
          "The Rust Async Ecosystem Working Group"
        ];
      ...
      "romio" = rec {
        ...
        edition = "2018";
        sha256 = "1vvi3svial47kr9x3c18lx7x9f92pynv7d74h7aaj53js0p3is07";
        authors = [
