...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust_keylock_shell/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcrypt" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "0cw6zfslx1pwwpbmv1ncaifgflrjbgbk27yfqlmbspa92k7xjn61";
        authors = [
      ...
      "rust_keylock_shell" = rec {
        crateName = "rust_keylock_shell";
        version = "0.11.0";
        edition = "2018";
        crateBin = [
          { name = "rust-keylock"; path = "src/main.rs"; }
        ];
