...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssb-handshake/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-ringbuffer" = rec {
        crateName = "async-ringbuffer";
        version = "0.5.2";
        edition = "2018";
        sha256 = "138mpi05r7lfphky14xjf6zafis8crxjxzi7030qkkc3ni5kjchm";
        authors = [
          "AljoschaMeyer <mail@aljoscha-meyer.de>"
        ];
        dependencies = [
          {
            name = "futures-io";
      ...
      "readwrite" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "06kz5zgizf1yjznnw6vv59r5ls760gf8ih5jff5alrws1mqc862p";
        authors = [
      ...
      "ssb-crypto" = rec {
        crateName = "ssb-crypto";
        version = "0.1.3";
        edition = "2018";
        sha256 = "05zvvlvljqrxxviryrkdq4fwq3a1zi1ig8rjn3rl8z219wlg06sn";
        authors = [
          "sean billig <sean.billig@gmail.com>"
        ];
        dependencies = [
          {
            name = "libsodium-sys";
      ...
      "ssb-handshake" = rec {
        ...
        dependencies = [
          ...
          {
            name = "ssb-crypto";
            packageId = "ssb-crypto";
          }
        ];
        devDependencies = [
          {
            name = "async-ringbuffer";
            packageId = "async-ringbuffer";
          }
          {
            name = "criterion";
            packageId = "criterion";
