...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-feature-set/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-feature-set" = rec {
        crateName = "cargo-feature-set";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-feature-set"; path = "src/main.rs"; }
        ];
