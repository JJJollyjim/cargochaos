...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-books1-cli/v1.0.12+20181212.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-books1" = rec {
        crateName = "google-books1";
        version = "1.0.12+20181212";
        edition = "2015";
        sha256 = "03ky8qaaacmk6k4qvlx49s2zrfrw8khjhigdspnba4fnlbmirp2p";
        authors = [
      ...
      "google-books1-cli" = rec {
        crateName = "google-books1-cli";
        version = "1.0.12+20181212";
        edition = "2015";
        crateBin = [
          { name = "books1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20181212.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
