...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ip-command/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ip-command" = rec {
        crateName = "ip-command";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "namespaced_process"; path = "src/command/test_fixture/namespaced_process.rs"; }
        ];
      ...
      "serde-command-opts" = rec {
        crateName = "serde-command-opts";
        version = "0.1.1";
        edition = "2018";
        sha256 = "00d7yrgk0h9sjrmc1lnk2800rh2nlgwpqm407lvm5g5lmmc543dh";
        authors = [
          "fsyncd"
        ];
        dependencies = [
