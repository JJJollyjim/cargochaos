...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/taskwarrior-hooks/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "taskwarrior-hooks" = rec {
        crateName = "taskwarrior-hooks";
        version = "0.2.2";
        edition = "2018";
        crateBin = [
          { name = "scheduled-recur"; path = "src/bin/scheduled-recur.rs"; }
          { name = "auto-tagger"; path = "src/bin/auto-tagger.rs"; }
        ];
