...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/generic-octree/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dot_vox" = rec {
        ...
        version = "4.0.0";
        edition = "2015";
        sha256 = "0w0ym2s57zq1pp6vshnayamgihjysnhv4nb649q2g3sq3qjx7bqi";
        authors = [
      ...
      "generic-octree" = rec {
        ...
        resolvedDefaultFeatures = [ "bincode" "dot_tree" "dot_vox" "serde" "serialize" "vox" ];
      };
      "lazy_static" = rec {
