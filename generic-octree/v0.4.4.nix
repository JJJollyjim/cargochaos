...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/generic-octree/v0.4.4.nix.tmp"
    ...
    crates = {
      ...
      "generic-octree" = rec {
        ...
        features = {
          ...
          "render" = [ "genmesh" "rendy" "lazy_static" "color-rs" "petgraph" ];
          "serialize" = [ "serde" "flate2" ];
          "vox" = [ "dot_vox" ];
        };
        resolvedDefaultFeatures = [ "bincode" "color-rs" "dot_tree" "dot_vox" "flate2" "genmesh" "lazy_static" "petgraph" "render" "rendy" "serde" "serialize" "vox" ];
      };
      "genmesh" = rec {
        crateName = "genmesh";
        version = "0.6.2";
      ...
      "rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "command" "descriptor" "factory" "memory" "mesh" "rendy-command" "rendy-descriptor" "rendy-factory" "rendy-memory" "rendy-mesh" "rendy-resource" "rendy-wsi" "resource" "wsi" ];
      };
      "rendy-command" = rec {
