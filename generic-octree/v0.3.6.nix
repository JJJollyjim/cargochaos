...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/generic-octree/v0.3.6.nix.tmp"
    ...
    crates = {
      ...
      "generic-octree" = rec {
        ...
        features = {
          ...
          "render" = [ "genmesh" "rendy" "lazy_static" "color-rs" ];
          "serialize" = [ "serde" "flate2" ];
          "vox" = [ "dot_vox" ];
        };
        resolvedDefaultFeatures = [ "bincode" "color-rs" "dot_tree" "dot_vox" "flate2" "genmesh" "lazy_static" "render" "rendy" "serde" "serialize" "vox" ];
      };
      "genmesh" = rec {
        crateName = "genmesh";
        version = "0.6.2";
