...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/io-uring/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "io-uring" = rec {
        ...
        resolvedDefaultFeatures = [ "bindgen" "concurrent" "overwrite" "parking_lot" "unstable" ];
      };
      "iou" = rec {
        crateName = "iou";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0s6qjr3liflx7d9i8nap1375jcq008j9h3s9al2rp0rx04c2bfyy";
        authors = [
      ...
      "uring-sys" = rec {
        ...
        version = "1.0.0-beta";
        edition = "2018";
        sha256 = "0mpqvbba89iby8mzl9yxx6bi1br3g7icqvl2rbxi1433s7n2h4aq";
        authors = [
          "Without Boats <boats@mozilla.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "ntstatus" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
