...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ashpaper-bin/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ashpaper" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0s0cssdvbflac17p3q1r5v6lcpmbdhvc3m4ma5bpfi584rs0r6ph";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "wordsworth";
            packageId = "wordsworth";
          }
        ];
        
      };
      "ashpaper-bin" = rec {
        crateName = "ashpaper-bin";
        version = "0.1.3";
        edition = "2015";
        crateBin = [
          { name = "ashpaper-bin"; path = "src/main.rs"; }
        ];
      ...
      "wordsworth" = rec {
        crateName = "wordsworth";
        version = "0.1.1";
        edition = "2015";
        sha256 = "0rc917mv9f8h7i4dwzgxvybnr0cli5nba2sxvm28qgrbq7rlvhz6";
        authors = [
