...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ashpaper-bin/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ashpaper" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "00q6amywiw7v5kwcigbnb9wxdp2vkgdigqykgj0h8lgaxds3yasd";
        authors = [
      ...
      "ashpaper-bin" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "ashpaper"; path = "src/main.rs"; }
        ];
