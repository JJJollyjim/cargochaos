...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/asciii/v3.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-files" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "1iay2r8ndh6s9lqkp612rjyplq08abkkgbph1ymrczwpcwxm6nh9";
        libName = "actix_files";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "asciii" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "asciii"; path = "src/bin/asciii.rs"; }
          { name = "asciii-web"; path = "src/bin/asciii-web.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v3.8.0.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "crowbook-intl-runtime";
          }
          {
            name = "custom_derive";
        ...
        resolvedDefaultFeatures = [ "actix" "actix-files" "actix-web" "actix-web-actors" "cli" "default" "deserialization" "document_export" "full_tool" "git2" "git_statuses" "handlebars" "localize" "manual" "meta" "nightly" "num-traits" "ordered-float" "rustyline" "serde" "serde_base" "serde_derive" "serde_json" "serde_yaml" "serialization" "server" "shell" "travis_compatible" "version_string" "webapp" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.13";
      ...
      "bill" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1qzjkm6hma8pjfidn9z202zq1hw52bwx2hbl2wvb6qnhwyidadnh";
        authors = [
          "Hendrik Sollich <hendrik@hoodie.de>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_json" "serialization" ];
      };
      "bitflags 0.4.0" = rec {
        crateName = "bitflags";
        version = "0.4.0";
      ...
      "claude" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "198klbnm60ra2slqccfdwly5sgihpqbcq7fiv3b83bpgvdrrxh9j";
        authors = [
          "hendrik@hoodie.de"
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_derive" "serde_json" "serialization" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
      ...
      "crowbook-intl" = rec {
        crateName = "crowbook-intl";
        version = "0.2.1";
        edition = "2015";
        sha256 = "119clmr9zsqwb3pfp6qpmzg536f29x8hr6x394f43j6vajhkinq4";
        authors = [
      ...
      "crowbook-intl-runtime" = rec {
        crateName = "crowbook-intl-runtime";
        version = "0.1.0";
        edition = "2015";
        sha256 = "074lkl1py8wjzg4pxsx94ig8ynvyn41sgvw3hryzpmxl2b2nxkv2";
        authors = [
          "Elisabeth Henry <liz.henry@ouvaton.org>"
        ];
        dependencies = [
      ...
      "icalendar" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1va7yx6cfwzipvgh028y2f1zpjni1l6if1fm0b37ihpsrqf91a3m";
        authors = [
          "Hendrik Sollich <hendrik@hoodie.de>"
        ];
        dependencies = [
      ...
      "miniz_oxide" = rec {
        ...
        version = "0.3.4";
        edition = "2018";
        sha256 = "0ax8a4klp8w2k51lxrsihlnjgqmig0160pd955y2d08dbklbdd4a";
        authors = [
      ...
      "serde_test" = rec {
        ...
        version = "1.0.101";
        edition = "2015";
        sha256 = "0070ycbh47yhxb5vxwa15vi2wpdkw3v1m14v4mjryz1568fqkbsa";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
        ];
