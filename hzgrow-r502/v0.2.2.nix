...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hzgrow-r502/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hzgrow-r502" = rec {
        crateName = "hzgrow-r502";
        version = "0.2.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "Filip Wieland <filiplamparski@gmail.com>"
        ];
        dependencies = [
          {
            name = "arrayvec";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cguid" "commapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "minwinbase" "minwindef" "ntdef" "setupapi" "winbase" "winerror" "winnt" ];
      };
