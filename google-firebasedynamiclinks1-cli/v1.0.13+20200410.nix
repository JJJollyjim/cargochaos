...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-firebasedynamiclinks1-cli/v1.0.13+20200410.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-firebasedynamiclinks1-cli";
  ...
  workspaceMembers = {
    "google-firebasedynamiclinks1-cli" = rec {
      packageId = "google-firebasedynamiclinks1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-firebasedynamiclinks1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-firebasedynamiclinks1" = rec {
        crateName = "google-firebasedynamiclinks1";
        version = "1.0.13+20200410";
        edition = "2015";
        sha256 = "0la11rd2ngjd3b0r948h2ml9nhng5y5q95qrzws6mhvlg928ysrm";
        authors = [
      ...
      "google-firebasedynamiclinks1-cli" = rec {
        crateName = "google-firebasedynamiclinks1-cli";
        version = "1.0.13+20200410";
        edition = "2015";
        crateBin = [
          { name = "firebasedynamiclinks1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200410.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-firebasedynamiclinks1";
          }
          {
            name = "hyper";
            packageId = "hyper";
