...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zram-generator/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "zram-generator" = rec {
        crateName = "zram-generator";
        version = "0.1.2";
        edition = "2015";
        crateBin = [
          { name = "zram-generator"; path = "src/main.rs"; }
        ];
