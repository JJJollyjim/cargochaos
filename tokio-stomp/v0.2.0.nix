...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-stomp/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "custom_debug_derive" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "16k4dw6dp64c8jq4k5da0fs5fyx6y3c36fv8vhf3ly42q85gsfca";
        procMacro = true;
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "iovec" "lazy_static" "libc" "macros" "mio" "mio-uds" "net" "rt-core" "slab" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
