...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/casperlabs-engine-grpc-server/v0.17.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "casperlabs-engine-core" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0119wk8d5qpdjhvjbwi58h0qfa044z33zjv6xmhaqj5fsqcckfv5";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-engine-grpc-server" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.17.1.nix {};
        authors = [
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
        dependencies = [
      ...
      "casperlabs-engine-storage" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1r0zfsr0mhs0cw8g2im0aml4i74924yk8plrmj65yrlljfz994dh";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
        ];
        dependencies = [
