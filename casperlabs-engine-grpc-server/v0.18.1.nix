...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/casperlabs-engine-grpc-server/v0.18.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "casperlabs-contract" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0lkiks8y8hry65fjq0i6nwpmp6c2awb18dvyvhqh5m831m6i7wi9";
        authors = [
      ...
      "casperlabs-engine-core" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0614n9p85w8rpcrwcm8484da0bpigdxn6529l77k9vc9xm9zgyp6";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-engine-grpc-server" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.18.1.nix {};
        authors = [
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
        dependencies = [
      ...
      "casperlabs-engine-shared" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "15nkdhl4mz4vq4xs0s15v978xmznhszh532m45fg69s336v49zma";
        authors = [
      ...
      "casperlabs-engine-storage" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1b4a2hx5viv7x7qyvxkg6igb0c8px74ig9bnf3qdg2pk9smfa2rq";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
        ];
        dependencies = [
      ...
      "casperlabs-engine-wasm-prep" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0pxz6adv83kvcp807a1wnhx6wgakzc4wv1bfi1rgn1460wg0j0c6";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-mint" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0fr668j417aal49sn58vkppgmri8pgyr8gjgdbpbckkj325vg4k5";
        authors = [
          "Henry Till <henrytill@gmail.com>"
        ];
        dependencies = [
      ...
      "casperlabs-proof-of-stake" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0n6sz51qcj38ln48g98chnalnpv55bp621hjzv261c83ngrp2sc3";
        authors = [
          "Henry Till <henrytill@gmail.com>"
        ];
        dependencies = [
      ...
      "casperlabs-standard-payment" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1hagrjy07sn05k2j6wc8ji4q32s4aafajjvr6g1hvghvfszh7yi1";
        authors = [
      ...
      "casperlabs-types" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0aq266fxaqfsxs5igngblgm5fmvvrgzx5fv5z8wr8fyjrprdp0ri";
        authors = [
          "Fraser Hutchison <fraser@casperlabs.io>"
        ];
        dependencies = [
