...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/casperlabs-engine-grpc-server/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "casperlabs-contract" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "19ibwzhmxacfngfcr68q74jm1kva6ljllk6crf2wxi8sd9p6gdrs";
        authors = [
      ...
      "casperlabs-engine-core" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0rqcgjza3iwzpfhpj30j0vi5r9y9lf43b7fn9dabh9kzbqcsmick";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-engine-shared" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0i4avn16391nsi4pxfi91h5dyhb5w5jmv0qk5jidknwadpvwirgi";
        authors = [
      ...
      "casperlabs-engine-storage" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1d10k4f7xbzbn9jrcb6nkjsk4a8wkprcarwnfcfk3zgga65c2vzf";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
        ];
        dependencies = [
      ...
      "casperlabs-engine-wasm-prep" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1in4krmh4jgpph7983v08yy2nym0k9bfj50k67dnqv67p98mdzgv";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-types" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "18bpw3hdkal0b3chf3gia56zakb2jbjgl0z67rsni62flnj5i86a";
        authors = [
