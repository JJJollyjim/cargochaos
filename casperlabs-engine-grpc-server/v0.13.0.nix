...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/casperlabs-engine-grpc-server/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "casperlabs-contract" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "13iaxksirir0rz134hxrmfr4ki8wnir451zlxdi87zvkki3fvn89";
        authors = [
      ...
      "casperlabs-engine-core" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0gam2kx67zpy7f817gbdvfi1bsadn7ibxbbhplxqnfcz3br5k18g";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-engine-shared" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "09z1caspqm64iqhyjhkd3gr86c9dg654nrav8v6p03fw9fsrsaix";
        authors = [
      ...
      "casperlabs-engine-storage" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0scy9w4h4kf9nk9vvqcql339qfqxkb410caxlbq529frxwd1kdix";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
        ];
        dependencies = [
      ...
      "casperlabs-engine-wasm-prep" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0dxdr466pbb539xqnccyp4d7cfm1pvni4s3v5s8mxhgz2zfr2vfq";
        authors = [
          "Michael Birch <birchmd@casperlabs.io>"
          "Mateusz Górski <gorski.mateusz@protonmail.ch>"
        ];
      ...
      "casperlabs-types" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0nwa0bb09dwzwx58yk5gd13y269zhr4fzjy5jnkzasmplfrzvymq";
        authors = [
