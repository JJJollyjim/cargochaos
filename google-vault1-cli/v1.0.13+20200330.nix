...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-vault1-cli/v1.0.13+20200330.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-vault1" = rec {
        crateName = "google-vault1";
        version = "1.0.13+20200330";
        edition = "2015";
        sha256 = "1ipwlhcqnqqjh5f50a8bfvyizw41bsqbk3d4wkvn3gwil8xn7z7w";
        authors = [
      ...
      "google-vault1-cli" = rec {
        crateName = "google-vault1-cli";
        version = "1.0.13+20200330";
        edition = "2015";
        crateBin = [
          { name = "vault1"; path = "src/main.rs"; }
        ];
