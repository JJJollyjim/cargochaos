...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/radicle-surf/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nonempty" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0zyrv4cnnrzf42miy567klll3ibicx55p2c4iw1nnhhprqp9hm39";
        authors = [
      ...
      "radicle-surf" = rec {
        ...
        authors = [
          "Monadic GmbH <radicle@monadic.xyz>"
        ];
        dependencies = [
          {
            name = "git2";
