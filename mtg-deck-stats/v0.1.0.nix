...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mtg-deck-stats/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mtg-deck-stats" = rec {
        crateName = "mtg-deck-stats";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mtg-deck-stats"; path = "src/main.rs"; }
        ];
