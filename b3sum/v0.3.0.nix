...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/b3sum/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "b3sum" = rec {
        ...
        resolvedDefaultFeatures = [ "neon" "prefer_intrinsics" "pure" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
      ...
      "blake3" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1g3qw5j0ff7zrnsj4f6c47jw0vwmwl1f900q9mkivqgfbdr9l6w6";
        authors = [
          "Jack O'Connor <oconnor663@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "neon" "prefer_intrinsics" "pure" "rayon" "std" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
