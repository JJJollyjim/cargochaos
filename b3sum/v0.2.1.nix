...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/b3sum/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "b3sum" = rec {
        ...
        resolvedDefaultFeatures = [ "c" "c_neon" "default" "memmap" "rayon" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
      ...
      "blake3" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "12h99p5gfdii1ry19wjj53akg1vz0apx1llwigqyq66i6yzqm68r";
        authors = [
          "Jack O'Connor <oconnor663@gmail.com>"
        ];
        dependencies = [
