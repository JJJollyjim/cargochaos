...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rrc/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rrc" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rrc"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.7.nix {};
        authors = [
          "mopemope <yutaka.matsubara@gmail.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
