...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-groupsmigration1-cli/v1.0.13+20181126.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-groupsmigration1-cli";
  ...
  workspaceMembers = {
    "google-groupsmigration1-cli" = rec {
      packageId = "google-groupsmigration1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-groupsmigration1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-groupsmigration1" = rec {
        crateName = "google-groupsmigration1";
        version = "1.0.13+20181126";
        edition = "2015";
        sha256 = "039fnmwzfmadcyhkx7zghgp7iwlnyfa2jpr2paxjkr6w855mkfqy";
        authors = [
      ...
      "google-groupsmigration1-cli" = rec {
        crateName = "google-groupsmigration1-cli";
        version = "1.0.13+20181126";
        edition = "2015";
        crateBin = [
          { name = "groupsmigration1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20181126.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-groupsmigration1";
          }
          {
            name = "hyper";
            packageId = "hyper";
