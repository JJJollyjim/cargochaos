...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/psi/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "epoll" = rec {
        ...
        version = "4.1.0";
        edition = "2015";
        sha256 = "1186f57fl1fqk1y32q46pj6mc0hxyrqgkhv8vsg6d2gadgicy2wr";
        authors = [
      ...
      "psi" = rec {
        ...
        authors = [
          "Chris Manning <cmanning999@gmail.com>"
        ];
        dependencies = [
          {
            name = "epoll";
        ...
        resolvedDefaultFeatures = [ "default" "epoll" "monitor" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "0.6.13";
