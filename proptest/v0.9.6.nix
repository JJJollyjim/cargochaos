...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/proptest/v0.9.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "proptest" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "atomic64bit" "bit-set" "break-dead-code" "default" "default-code-coverage" "fork" "lazy_static" "quick-error" "regex-syntax" "rusty-fork" "std" "tempfile" "timeout" "unstable" ];
      };
      "quick-error" = rec {
