...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tin-summer/v1.21.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cli-setup" = rec {
        ...
        version = "0.2.6";
        edition = "2015";
        sha256 = "001bf50gm9cmaa9n4wa0g5v9qqr3dhvd09jzhrmkjj1x33qhbkb2";
        authors = [
      ...
      "tin-summer" = rec {
        crateName = "tin-summer";
        version = "1.21.13";
        edition = "2015";
        crateBin = [
          { name = "sn"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.21.13.nix {};
        libName = "liboskar";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bash" "default" "deutsch" "english" "fish" "francais" ];
      };
      "unicode-width" = rec {
