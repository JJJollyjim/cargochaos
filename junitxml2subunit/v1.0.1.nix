...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/junitxml2subunit/v1.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "junitxml2subunit" = rec {
        crateName = "junitxml2subunit";
        version = "1.0.1";
        edition = "2015";
        crateBin = [
          { name = "junitxml2subunit"; path = "src/main.rs"; }
        ];
      ...
      "subunit-rust" = rec {
        crateName = "subunit-rust";
        version = "0.1.3";
        edition = "2015";
        sha256 = "12ms0g8xyc6vdhnlx4x6agcrnybn2r0wf143n9bmb4014jxlxh8d";
        authors = [
          "Matthew Treinish <mtreinish@kortar.org>"
        ];
        dependencies = [
