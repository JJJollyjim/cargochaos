...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffizer/v1.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffizer" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.5.1.nix {};
        authors = [
          "David Bernard"
        ];
        dependencies = [
      ...
      "self_update" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1ng196q27c20k3zwi7ygf7jz7qlpbb9c7b5gj530b9v36hwcpdyq";
        authors = [
