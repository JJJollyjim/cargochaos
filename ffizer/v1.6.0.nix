...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffizer/v1.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        resolvedDefaultFeatures = [ "compress" "default" "libflate" "native-tls" "tls" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.13";
      ...
      "ffizer" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.6.0.nix {};
        authors = [
          "David Bernard"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cli" "default" "human-panic" "self_update" "slog-async" "slog-term" "test_remote" ];
      };
      "filetime" = rec {
        crateName = "filetime";
        version = "0.2.7";
      ...
      "git2_credentials" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "1jk0mcx5z79jrw3wmq69wb5pz4cjz7j0jgzxbfbg3jgf4k1incdk";
        authors = [
      ...
      "handlebars" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dir_source" "log" "logging" "no_dir_source" "walkdir" ];
      };
      "handlebars_misc_helpers" = rec {
        crateName = "handlebars_misc_helpers";
        version = "0.5.2";
        edition = "2018";
        sha256 = "19z72xw6vvklvvfdmpcy7kwzw99iva1qizs6lf6lw17pcjfr3sa1";
        authors = [
          "David Bernard"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "Inflector" "attohttpc" "default" "http" "jmespath" "json" "serde" "serde_json" "string" ];
      };
      "hashbrown" = rec {
        crateName = "hashbrown";
        version = "0.5.0";
      ...
      "jmespath" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0cm2jmzpr2zn2ckszx40y5rg2av8mb0mmjwqxzafay29xn1di5md";
        authors = [
