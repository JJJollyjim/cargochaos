...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffizer/v1.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffizer" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.7.1.nix {};
        authors = [
          "David Bernard"
        ];
        dependencies = [
      ...
      "run_script" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1b3m6a9sd5nyxr0r80m2q4qcjjyah47n8s6rmnx73vn7p54bpyrd";
        authors = [
      ...
      "self_update" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "0srzg23l1zscd246x75dy9c1bbm25y69gj48aq97xd5jyc7bjpwf";
        authors = [
