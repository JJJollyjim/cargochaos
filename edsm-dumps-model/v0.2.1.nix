...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/edsm-dumps-model/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "edsm-dumps-model" = rec {
        crateName = "edsm-dumps-model";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "model_check"; path = "src/bin/model_check.rs"; }
          { name = "gen_schema"; path = "src/bin/gen_schema.rs"; }
        ];
      ...
      "tiny_fail" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0qfzzscwk14y96rsy60gsfxzagzjaca31scxgbq478rbh6kgds6c";
        authors = [
          "Igaguri <igagurimk@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winnt" "winuser" ];
      };
