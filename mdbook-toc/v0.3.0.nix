...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-toc/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-toc" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mdbook-toc"; path = "src/bin/mdbook-toc.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "shellapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
