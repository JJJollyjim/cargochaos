...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/seshat/v1.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fake" = rec {
        ...
        version = "2.2.2";
        edition = "2018";
        sha256 = "09l0q3afqv435nb8bxb5yl34lljaa2j0z14y62yjwdny3256p6ws";
        authors = [
      ...
      "libsqlite3-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "min_sqlite_version_3_6_8" "pkg-config" "sqlcipher" "vcpkg" ];
      };
      "linked-hash-map" = rec {
      ...
      "rusqlite" = rec {
        ...
        resolvedDefaultFeatures = [ "sqlcipher" ];
      };
      "rust-stemmers" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
