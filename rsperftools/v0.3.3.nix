...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsperftools/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "inferno" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0fhgspzk9wpcp3bksqyjn0k5f68ydjxyx4hkpv3a85irdjaf4fzw";
        authors = [
      ...
      "rsperftools" = rec {
        ...
        resolvedDefaultFeatures = [ "flamegraph" "inferno" ];
      };
      "rustc-demangle" = rec {
