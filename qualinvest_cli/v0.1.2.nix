...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/qualinvest_cli/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eodhistoricaldata_api" = rec {
        crateName = "eodhistoricaldata_api";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0bg35ws38m3rlni6b94dmgcfw4jcvcfvhk3mnp6038wmd5gabjy4";
        authors = [
      ...
      "finql" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "06s2g9iy6cdqzlvm9hx0m523ap0aj6p5n1pjf3767sk7nr4f0x92";
        authors = [
          "Mark Beinker <mwb@quantlink.de>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "eodhistoricaldata_api";
          }
          {
            name = "gurufocus_api";
            packageId = "gurufocus_api";
          }
          {
            name = "postgres";
            packageId = "postgres";
      ...
      "gurufocus_api" = rec {
        crateName = "gurufocus_api";
        version = "0.3.2";
        edition = "2018";
        sha256 = "0rdymh9xn57hqirwf2f042x59gy4c8ax4n8gavffrgxn5q2hzssc";
        authors = [
          "Mark Beinker <mwb@quantlink.de>"
        ];
        dependencies = [
      ...
      "qualinvest_cli" = rec {
        crateName = "qualinvest_cli";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "qualinvest_cli"; path = "src/main.rs"; }
        ];
      ...
      "qualinvest_core" = rec {
        crateName = "qualinvest_core";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1l8snq9gsg7xg03f21nzr2bss3jlszv3dl467g40ky7c8pykm8j0";
        authors = [
          "Mark Beinker <mwb@quantlink.de>"
        ];
        dependencies = [
      ...
      "tokio 0.2.18" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-buf" = rec {
        crateName = "tokio-buf";
        version = "0.1.1";
      ...
      "yahoo-finance" = rec {
        crateName = "yahoo-finance";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0phdayhcdqwm3cpgzrf3kaib7jdln90fjjjws39x0z35x20kz5xm";
        authors = [
          "Fred Briden <fred.briden@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
          ...
          }
          {
            ...
            packageId = "tokio 0.2.18";
            usesDefaultFeatures = false;
            features = [ "stream" "rt-threaded" "macros" ];
          }
          {
