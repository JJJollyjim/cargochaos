...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/carrier/v0.9.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "osaka-dns" = rec {
        ...
        version = "0.2.10";
        edition = "2015";
        sha256 = "1pkgvrp0vvm6kf90jggn4dz34i5f2qjr6zwczq3kbzsd5hgg7gm3";
        authors = [
          "Arvid E. Picciani <aep@exys.org>"
        ];
        dependencies = [
      ...
      "winapi 0.3.6" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
