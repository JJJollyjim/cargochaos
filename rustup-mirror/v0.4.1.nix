...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustup-mirror/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "default" "default-tls" "hyper-tls" "native-tls-crate" "socks" "tokio-socks" "tokio-tls" ];
      };
      "rust-crypto" = rec {
      ...
      "rustup-mirror" = rec {
        crateName = "rustup-mirror";
        version = "0.4.1";
        edition = "2018";
        crateBin = [
          { name = "rustup-mirror"; path = "src/main.rs"; }
        ];
