...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zypo-rs/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "winbase" "wincon" "winerror" "winnt" ];
      };
      ...
      "zypo-rs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "zypo-rs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.3.nix {};
        authors = [
          "Owez <owez@scalist.net>"
        ];
        dependencies = [
          {
            name = "itertools";
