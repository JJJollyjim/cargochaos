...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cst816s/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cst816s" = rec {
        ...
        authors = [
          "Todd Stellanova <tstellanova@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "cortex-m";
      ...
      "panic-rtt-core" = rec {
        crateName = "panic-rtt-core";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0n6cyxwgjjpyv9ibryl1f0r2bnh7ywnx2hbzw2pi8b5gwrq5g60i";
        authors = [
          "Todd Stellanova <tstellanova@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "rtt-target" = rec {
        crateName = "rtt-target";
        version = "0.1.0";
        edition = "2018";
        sha256 = "003llkphh8xzg9gasaqy7084ji7bw6g3ghzdylcpkpbrwji4imxi";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m" ];
      };
      "rustc_version" = rec {
      ...
      "ufmt-write" = rec {
        crateName = "ufmt-write";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0sdx0r6ah9xr3nydrqxj01v25sb956c0jk5rqf6f5i9fnkb2wyp8";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        features = {
