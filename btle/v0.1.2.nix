...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/btle/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "btle" = rec {
        ...
        features = {
          "async" = [ "tokio" ];
          "bluez" = [ "nix" "libc" "std" "hci" ];
          "bluez_async" = [ "bluez" "async" "tokio/uds" ];
          "default" = [ "hci" "std" ];
          "remote" = [ "std" "hci" ];
          "std" = [ "futures-core/std" "futures-io/std" "futures-util/std" "futures-task/std" ];
        };
        resolvedDefaultFeatures = [ "async" "bluez" "bluez_async" "default" "futures-io" "futures-task" "futures-util" "hci" "libc" "nix" "remote" "std" "tokio" ];
      };
      "bytes" = rec {
        crateName = "bytes";
        version = "0.5.4";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "io-driver" "lazy_static" "libc" "mio" "mio-uds" "uds" ];
      };
      "void" = rec {
        crateName = "void";
        version = "1.0.2";
