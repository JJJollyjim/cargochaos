...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/btle/v0.1.3.nix.tmp"
    ...
    crates = {
      ...
      "btle" = rec {
        ...
        features = {
          ...
          "default" = [ "hci" "std" "tokio_asyncs" ];
          "remote" = [ "std" "hci" ];
          "std" = [ "futures-core/std" "futures-io/std" "futures-task/std" ];
          "tokio_asyncs" = [ "asyncs" "tokio/time" "tokio/sync" "tokio/rt-core" ];
        };
        resolvedDefaultFeatures = [ "asyncs" "bluez" "default" "futures-io" "futures-task" "hci" "libc" "nix" "remote" "std" "tokio" "tokio_asyncs" ];
      };
      "bytes" = rec {
        crateName = "bytes";
        version = "0.5.4";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "fnv" "io-driver" "lazy_static" "libc" "mio" "mio-uds" "rt-core" "slab" "sync" "time" "uds" ];
      };
      "void" = rec {
        crateName = "void";
        version = "1.0.2";
