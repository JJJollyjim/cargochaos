...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dcc-lsystem/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gifski" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1d8lzdvmqh548g65i1jl9lj55d9wlaaiscc9k28z2070bsg580z7";type = [ "lib" "staticlib" "cdylib" ];
        authors = [
