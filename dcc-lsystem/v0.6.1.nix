...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dcc-lsystem/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dcc-lsystem-derive" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "17n8x6dpm59np31vcq39z6wz1f1bqqmx00485c0y72d8y5yadz5h";
        procMacro = true;
        authors = [
          "Robert Usher <266585+dcchut@users.noreply.github.com>"
        ];
      ...
      "gifski" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1k9bgll700b3c9slfh3fzlywwrr2bm2fyy5zd4rz3dnl4jwjvhq2";type = [ "lib" "staticlib" "cdylib" ];
        authors = [
      ...
      "imagequant" = rec {
        ...
        version = "2.11.9";
        edition = "2015";
        sha256 = "0680xry2gdl7bs8cgg7fn9k96y7jgyakl3f17gnva0r2mdnc23x8";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "sse" ];
      };
      "imagequant-sys" = rec {
