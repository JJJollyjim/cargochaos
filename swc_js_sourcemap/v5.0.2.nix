...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/swc_js_sourcemap/v5.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "swc_js_sourcemap" = rec {
        crateName = "swc_js_sourcemap";
        version = "5.0.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v5.0.2.nix {};
        authors = [
          "Sentry <hello@sentry.io>"
          "강도윤 <kdy1997.dev@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
        ...
        resolvedDefaultFeatures = [ "ram_bundle" "scroll" ];
      };
      "syn 0.15.44" = rec {
        crateName = "syn";
        version = "0.15.44";
