...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fd-find/v8.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fd-find" = rec {
        ...
        src = pkgs.callPackage ./tarball-v8.0.0.nix {};
        authors = [
      ...
      "lscolors" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0zp489bfxz0cbldxg8a551wxy3a6ypjrylpd1nbar7hlcwi4axqz";
        authors = [
          "David Peter <mail@david-peter.de>"
        ];
        dependencies = [
