...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-fixeq/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-fixeq" = rec {
        crateName = "cargo-fixeq";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-fixeq"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "syn";
            usesDefaultFeatures = false;
            features = [ "parsing" "printing" "full" "visit" ];
          }
        ];
        devDependencies = [
          {
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "full" "parsing" "printing" "quote" "visit" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
