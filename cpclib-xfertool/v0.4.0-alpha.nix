...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpclib-xfertool/v0.4.0-alpha.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpclib-xfertool" = rec {
        crateName = "cpclib-xfertool";
        version = "0.4.0-alpha";
        edition = "2018";
        crateBin = [
          { name = "cpclib-xfertool"; path = "src/main.rs"; }
        ];
      ...
      "term_grid" = rec {
        ...
        version = "0.1.7";
        edition = "2015";
        sha256 = "1kq2sy3b8329jrsrpcvijvyz4gbqjyvyy6c3n0wmmvda9y03w393";
        authors = [
