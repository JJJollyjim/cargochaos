...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/legion/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "legion" = rec {
        ...
        resolvedDefaultFeatures = [ "crossbeam" "default" "events" "ffi" "log" "metrics" "par-iter" "par-schedule" "rayon" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.65";
      ...
      "tracing" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "log" "log-always" "std" ];
      };
