...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rendy/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "base" "command" "default" "descriptor" "dx12" "empty" "factory" "frame" "full" "gl" "graph" "init" "init-winit" "memory" "mesh" "mesh-obj" "metal" "no-slow-safety-checks" "profiler" "rendy-command" "rendy-descriptor" "rendy-factory" "rendy-frame" "rendy-graph" "rendy-init" "rendy-memory" "rendy-mesh" "rendy-resource" "rendy-shader" "rendy-texture" "rendy-wsi" "resource" "serde-1" "shader" "shader-compiler" "spirv-reflection" "texture" "texture-image" "texture-palette" "vulkan" "wsi" ];
      };
      "rendy-chain" = rec {
      ...
      "rendy-core" = rec {
        ...
        resolvedDefaultFeatures = [ "dx12" "empty" "gfx-backend-dx12" "gfx-backend-empty" "gfx-backend-gl" "gfx-backend-metal" "gfx-backend-vulkan" "gl" "metal" "no-slow-safety-checks" "serde" "serde-1" "vulkan" ];
      };
