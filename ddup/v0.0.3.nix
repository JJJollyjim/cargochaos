...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ddup/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ddup" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ddup"; path = "src/bin/ddup.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "std" "winuser" "winioctl" "ioapiset" "errhandlingapi" "fileapi" "handleapi" "handleapi" "winnt" "ntdef" "minwindef" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "ntdef" "processenv" "std" "winbase" "wincon" "winerror" "winioctl" "winnt" "winuser" ];
      };
