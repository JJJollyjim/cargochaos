...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ddup/v0.0.2-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ddup" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.0.2-alpha.nix {};
        authors = [
          "netaneld122"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "ntdef" "processenv" "std" "winbase" "winioctl" "winnt" "winuser" ];
      };
