...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/loge/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "loge" = rec {
        ...
        authors = [
          "Chojan Shang <psiace@outlook.com>"
        ];
        dependencies = [
          {
            name = "atty";
        ...
        resolvedDefaultFeatures = [ "chrono" "colored" "default" "json" "json-color" "serde_json" ];
      };
      "num-integer" = rec {
