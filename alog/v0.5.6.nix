...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alog/v0.5.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "alog" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "alog"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.6.nix {};
        authors = [
          "thyrc <thyrc@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "alog-cli" "clap" ];
      };
      "ansi_term" = rec {
        crateName = "ansi_term";
        version = "0.11.0";
