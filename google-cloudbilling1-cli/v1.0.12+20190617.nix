...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudbilling1-cli/v1.0.12+20190617.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudbilling1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudbilling1" = rec {
        crateName = "google-cloudbilling1";
        version = "1.0.12+20190617";
        edition = "2015";
        sha256 = "0sdg4pgj7w4aidmrrbdp5jrxry20vckwcpyx5mih4y874x5dz26c";
        authors = [
      ...
      "google-cloudbilling1-cli" = rec {
        crateName = "google-cloudbilling1-cli";
        version = "1.0.12+20190617";
        edition = "2015";
        crateBin = [
          { name = "cloudbilling1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudbilling1";
          }
          {
            name = "hyper";
            packageId = "hyper";
