...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-taskqueue1_beta2-cli/v1.0.13+20160428.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-taskqueue1_beta2-cli";
  ...
  workspaceMembers = {
    "google-taskqueue1_beta2-cli" = rec {
      packageId = "google-taskqueue1_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-taskqueue1_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-taskqueue1_beta2" = rec {
        crateName = "google-taskqueue1_beta2";
        version = "1.0.13+20160428";
        edition = "2015";
        sha256 = "17kacx7xg97p07xhnvwck6xpz8ckgavmmjab48zkdm25hpj3hzid";
        authors = [
      ...
      "google-taskqueue1_beta2-cli" = rec {
        crateName = "google-taskqueue1_beta2-cli";
        version = "1.0.13+20160428";
        edition = "2015";
        crateBin = [
          { name = "taskqueue1-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20160428.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-taskqueue1_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
