...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper-rustls/v0.20.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-rustls" = rec {
        ...
        resolvedDefaultFeatures = [ "ct-logs" "default" "native-tokio" "rustls-native-certs" "tokio-runtime" "webpki-roots" "webpki-tokio" ];
      };
      "indexmap" = rec {
        crateName = "indexmap";
        version = "1.3.2";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
