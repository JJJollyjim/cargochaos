...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pathfinding/v2.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "movingai" = rec {
        ...
        version = "1.1.0";
        edition = "2018";
        sha256 = "0jr0m81g23862ldlnf3ix3b9f8shaa6i4hh7ac2jh3y34xjwgqjg";
        authors = [
          "Davide Aversa <thek3nger@gmail.com>"
        ];
