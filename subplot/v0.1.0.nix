...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/subplot/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pandoc" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "0x5kns2sykny98sax1ladkqyc2bcxan314l8sj30kzgp9vj7lq3r";
        authors = [
          "Oliver Schneider <rust-pandoc61914191@oli-obk.de>"
          "Felix S. Klock II <pnkfelix@pnkfx.org>"
          "Chris Krycho <chris@chriskrycho.com>"
        ];
        dependencies = [
          {
            name = "itertools";
      ...
      "pandoc_ast" = rec {
        ...
        version = "0.7.2";
        edition = "2015";
        sha256 = "15jn9ipcip6r11kllka8fnn2h6617hycvx67cbq4qn3n4mlzdliz";
        authors = [
          "Oliver Schneider <rust-pandoc-ast885559849564@oli-obk.de>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "roadmap" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1x34xsp6z3r7wh6axmlqkgi24njb21pi3qwc0xq9czg1hz2m4pyk";
        authors = [
      ...
      "subplot" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "codegen"; path = "src/bin/codegen.rs"; }
        ];
      ...
      "tempfile-fast" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0b3n1g3h71c1isnzif61a847w9hjksw6swg94b8g23nlz0rdmaqq";
        authors = [
