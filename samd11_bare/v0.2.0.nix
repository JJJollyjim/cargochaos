...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/samd11_bare/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd11c14a" "samd11" "samd11c14a" "samd11c14a-rt" "unproven" ];
      };
      "atsamd11c14a" = rec {
        crateName = "atsamd11c14a";
        version = "0.6.0";
        edition = "2015";
        sha256 = "1khfclbj50is6wnvfp1v2dfc5nrj6qp95ayi7ij961af76d92nw6";
        authors = [
          "Jesse Braham <jesse@beta7.io>"
        ];
        dependencies = [
