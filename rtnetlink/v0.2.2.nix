...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rtnetlink/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "netlink-packet-route" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0hzizml4x749cyghw5a67jacw66678giyn6slf6817rbimdj3w2m";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
      ...
      "netlink-proto" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "05ddfak79frmdv90a0v6j0jfyfg3gkjmcf4phsbbk1gfifkphjl4";
        authors = [
          "Corentin Henry <corentinhenry@gmail.com>"
        ];
        dependencies = [
