...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql-actix-web/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        version = "1.4.0";
        edition = "2018";
        sha256 = "1izf0fjzw7pfpi1g8107qscappbxkhmh015dihqhkz8841291w87";
        authors = [
      ...
      "async-graphql-derive" = rec {
        ...
        version = "1.4.0";
        edition = "2018";
        sha256 = "0yd246vaqzanb7wz5kz2wwa1x0p8g8r3agmciy28j3i3q1vjvmyl";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
