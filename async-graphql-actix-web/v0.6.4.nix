...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql-actix-web/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        version = "1.6.1";
        edition = "2018";
        sha256 = "0cxg84z4vq1i7gqhvi1bhb28xp7nn78bv2lq4m37vs5hj6ksbyzm";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bson" "default" "once_cell" "regex" "url" "uuid" "validators" ];
      };
      "async-graphql-actix-web" = rec {
      ...
      "async-graphql-derive" = rec {
        ...
        version = "1.6.1";
        edition = "2018";
        sha256 = "1aml099giw0mdqsxak7yznvkdfykyh32m6nswb4v8riqy53m9rpn";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
      ...
      "im" = rec {
        ...
        version = "14.3.0";
        edition = "2018";
        sha256 = "1rqcrw0qi43r3rdc67w9878kwplimz1ngkbyh5ca5ic3gg45jq39";
        authors = [
          "Bodil Stokke <bodil@bodil.org>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntstatus" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
