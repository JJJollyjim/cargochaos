...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql-actix-web/v0.6.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        version = "1.6.0";
        edition = "2018";
        sha256 = "1ms8i6d44rp47aakc92g5zgn24nxg2qckjdp5b35pkvmagn05bgn";
        authors = [
      ...
      "async-graphql-derive" = rec {
        ...
        version = "1.6.0";
        edition = "2018";
        sha256 = "1syx04hfwapv12lmbb4xkdxpkw4nwm7yr8hsh87d5wzbf2m7gvzn";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
