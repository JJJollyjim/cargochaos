...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql-actix-web/v0.6.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        version = "1.6.8";
        edition = "2018";
        sha256 = "11mnz2zdx3fg02fzlrvwqgx5k29f19qd504r21wxdb2ddnjhba35";
        authors = [
      ...
      "async-graphql-actix-web" = rec {
        ...
        version = "0.6.11";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.6.11.nix {};
        authors = [
          "sunli <scott_s829@163.com>"
        ];
        dependencies = [
