...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql-actix-web/v0.6.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        version = "1.6.3";
        edition = "2018";
        sha256 = "0q7vl5kym3qspsgxvlrql9l9hcay98mxq9gfqfpjx339fzn1l36g";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bson" "chrono-tz" "default" "once_cell" "regex" "url" "uuid" "validators" ];
      };
      "async-graphql-actix-web" = rec {
      ...
      "async-graphql-derive" = rec {
        ...
        version = "1.6.3";
        edition = "2018";
        sha256 = "0fih88rjy50ak9bsj70v99h88lmvq30i51c6w8a5apmixyd7qz8g";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
