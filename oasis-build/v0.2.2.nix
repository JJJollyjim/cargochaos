...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oasis-build/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blockchain-traits" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "117yb4hqpl4smy76lg47nkjpn4srvjah7a3k60mr3jf3lmvqj2nk";
        authors = [
      ...
      "oasis-build" = rec {
        crateName = "oasis-build";
        version = "0.2.2";
        edition = "2018";
        crateBin = [
          { name = "oasis-build"; path = "src/main.rs"; }
        ];
      ...
      "oasis-macros" = rec {
        crateName = "oasis-macros";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1alzxs97mlzrpw93s7q0a1gd5c47aa9zph0gw27j16m9pcr2yd38";
        procMacro = true;
        authors = [
          "Oasis Labs <feedback@oasislabs.com>"
        ];
      ...
      "oasis-std" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "12l0c0iw8f2afyn8adz27vhya1ps580iqn7kvlirzn6m8ac1zggm";
        authors = [
          "Oasis Labs <feedback@oasislabs.com>"
        ];
        dependencies = [
          ...
          {
            name = "oasis-macros";
            packageId = "oasis-macros";
          }
          {
            name = "oasis-types";
            packageId = "oasis-types";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "oasis-types" = rec {
        crateName = "oasis-types";
        version = "0.2.0";
        edition = "2018";
        sha256 = "172a9an7pq41mzjvljxyllgmfzca8sgf1hi9qz0xlfakmfcdj9jp";
        authors = [
          "Oasis Labs <feedback@oasislabs.com>"
        ];
        dependencies = [
