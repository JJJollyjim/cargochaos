...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-firestore1_beta1-cli/v1.0.13+20200311.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-firestore1_beta1-cli";
  ...
  workspaceMembers = {
    "google-firestore1_beta1-cli" = rec {
      packageId = "google-firestore1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-firestore1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-firestore1_beta1" = rec {
        crateName = "google-firestore1_beta1";
        version = "1.0.13+20200311";
        edition = "2015";
        sha256 = "1y948q7nj1h0bw6w1975fkgdi57kqqfihv66q5rmxjldccgbrksh";
        authors = [
      ...
      "google-firestore1_beta1-cli" = rec {
        crateName = "google-firestore1_beta1-cli";
        version = "1.0.13+20200311";
        edition = "2015";
        crateBin = [
          { name = "firestore1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200311.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-firestore1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
