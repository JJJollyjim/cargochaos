...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/assert2/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "assert2" = rec {
        ...
        resolvedDefaultFeatures = [ "doc-cfg" "let-assert" ];
      };
      "assert2-macros" = rec {
        crateName = "assert2-macros";
        version = "0.2.0";
        edition = "2018";
        sha256 = "05bla4zbc0ly5pgk2g68vhbrmr523xvzxz4sajlzh5i5wppzhsak";
        procMacro = true;
        authors = [
          "Maarten de Vries <maarten@de-vri.es>"
          "Mara Bos <m-ou.se@m-ou.se>"
        ...
        resolvedDefaultFeatures = [ "let-assert" ];
      };
      "proc-macro-hack" = rec {
