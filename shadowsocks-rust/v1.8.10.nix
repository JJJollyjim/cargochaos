...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shadowsocks-rust/v1.8.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bloomfilter" = rec {
        ...
        version = "1.0.2";
        edition = "2015";
        sha256 = "0a44823xvnqf1mr39wy7z8gyi3zxd3bfqkkd6qlx953vzzkkhhmi";
        libPath = "src/bloomfilter/lib.rs";
        authors = [
      ...
      "env_logger" = rec {
        ...
        resolvedDefaultFeatures = [ "atty" "regex" "termcolor" ];
      };
      "fake-simd" = rec {
        crateName = "fake-simd";
        version = "0.1.2";
      ...
      "iprange" = rec {
        ...
        version = "0.6.2";
        edition = "2015";
        sha256 = "1fks910s80z11yacwbr6mwk8l5vg9iwqgs3wws8gsjp4nsmy76f7";
        authors = [
      ...
      "json5" = rec {
        ...
        version = "0.2.5";
        edition = "2018";
        sha256 = "19mvsarw44cks2fp0gq7ywi19xmqp0qdq3harvsix2p1zg6liyw5";
        authors = [
          "Callum Oakley <c.oakley108@gmail.com>"
        ];
        dependencies = [
          {
            name = "pest";
      ...
      "shadowsocks-rust" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "sslocal"; path = "src/bin/local.rs"; }
          { name = "ssserver"; path = "src/bin/server.rs"; }
          { name = "ssurl"; path = "src/bin/ssurl.rs"; }
          { name = "ssmanager"; path = "src/bin/manager.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.8.10.nix {};
        libName = "shadowsocks";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "nix";
            packageId = "nix";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "ios") || (target."os" == "freebsd") || (target."os" == "netbsd") || (target."os" == "openbsd"));
          }
          {
            name = "openssl";
            packageId = "openssl";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "net" "signal" "time" "sync" "process" "rt-threaded" "rt-core" "stream" "io-util" ];
          }
          {
            name = "tower";
            packageId = "tower";
        ...
        features = {
          ...
          "default" = [ "sodium" "rc4" "aes-cfb" "aes-ctr" "trust-dns" "local-http" ];
          "dns-over-https" = [ "trust-dns-resolver/dns-over-https-rustls" ];
          "dns-over-tls" = [ "trust-dns-resolver/dns-over-rustls" ];
        ...
        resolvedDefaultFeatures = [ "aes-cfb" "aes-ctr" "aes-pmac-siv" "camellia-cfb" "default" "dns-over-https" "dns-over-tls" "http" "hyper" "libsodium-sys" "local-dns-relay" "local-flow-stat" "local-http" "local-redir" "miscreant" "openssl" "openssl-vendored" "rc4" "single-threaded" "sodium" "tower" "trust-dns" "trust-dns-resolver" ];
      };
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-named-pipes" "mio-uds" "net" "num_cpus" "process" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-rustls" = rec {
      ...
      "trust-dns-https" = rec {
        ...
        version = "0.19.3";
        edition = "2018";
        sha256 = "1nhy78xy8l2qhgqi5h5pxzxxxd0xp2irdhxfpp0dbd1q0iynxlf5";
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-https" "dns-over-https-rustls" "dns-over-rustls" "dns-over-tls" "ipconfig" "resolv-conf" "rustls" "system-config" "tokio" "tokio-runtime" "tokio-rustls" "trust-dns-https" "trust-dns-rustls" "webpki-roots" ];
      };
      "trust-dns-rustls" = rec {
        crateName = "trust-dns-rustls";
        version = "0.19.3";
        edition = "2018";
        sha256 = "0s0j5kzdxhdwrjlphbsbhwx1v7bv274izg8c16x60w70cmma4kgv";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
