...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/weather_util_rust/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "default" "default-tls" "gzip" "hyper-rustls" "hyper-tls" "json" "native-tls-crate" "rustls" "rustls-tls" "serde_json" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "retry" = rec {
        crateName = "retry";
        version = "1.0.0";
      ...
      "weather_util_rust" = rec {
        crateName = "weather_util_rust";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "weather-util-rust"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
