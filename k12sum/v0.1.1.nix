...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/k12sum/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "k12sum" = rec {
        ...
        dependencies = [
          ...
          {
            name = "kangarootwelve_xkcp";
            packageId = "kangarootwelve_xkcp";
          }
          {
            name = "memmap";
            packageId = "memmap";
      ...
      "kangarootwelve_xkcp" = rec {
        crateName = "kangarootwelve_xkcp";
        version = "0.1.1";
        edition = "2018";
        sha256 = "096s7md1jzj8g2h084s5ib1xqa4pvcs859fvd00vm55y8vznqbiw";
        authors = [
          "Jack O'Connor <oconnor663@gmail.com>"
        ];
        dependencies = [
