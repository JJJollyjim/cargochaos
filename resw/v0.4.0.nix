...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/resw/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ressa" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1d12fwj2vg3c7g86mvk6kfrx5sympaq5wz4a889jyf22hpg9s23c";
        authors = [
          "Robert Masen <r@robertmasen.pizza>"
        ];
        dependencies = [
      ...
      "resw" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "moz_central" ];
      };
      "rustc-demangle" = rec {
