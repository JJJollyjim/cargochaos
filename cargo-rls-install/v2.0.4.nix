...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-rls-install/v2.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "timezoneapi" "winbase" "winnt" "wtypesbase" ];
      };
