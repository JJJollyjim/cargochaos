...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/math-calc-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "math-calc" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0kyi6gkkhxx54bzqgix02ww2d4vqzv5wdn5ybvndydrb833h27m4";
        authors = [
      ...
      "math-calc-cli" = rec {
        crateName = "math-calc-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "math-calc-cli"; path = "src/main.rs"; }
        ];
