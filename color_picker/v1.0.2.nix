...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/color_picker/v1.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "color_picker" = rec {
        crateName = "color_picker";
        version = "1.0.2";
        edition = "2018";
        crateBin = [
          { name = "color_picker"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.2.nix {};
        authors = [
          "Mendess2526 <pedro.mendes.26@gmail.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
