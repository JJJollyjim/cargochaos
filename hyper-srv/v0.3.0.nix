...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper-srv/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-srv" = rec {
        ...
        authors = [
          "Eugene Palmoff <mahou@shoujo.pw>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
