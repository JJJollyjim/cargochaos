...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mobc-postgres/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mobc" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "11hd14k9q1vvgkgs0zn1mngdnjznl4pj4zbs9r59b8dzz0psgqld";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "tokio" "unstable" ];
      };
      "mobc-postgres" = rec {
        crateName = "mobc-postgres";
        version = "0.5.0";
        edition = "2018";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
