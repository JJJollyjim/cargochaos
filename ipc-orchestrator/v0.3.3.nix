...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ipc-orchestrator/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ipc-orchestrator" = rec {
        crateName = "ipc-orchestrator";
        version = "0.3.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.3.nix {};
        authors = [
          "Maksym Vorobiov <maxim.vorobjov@gmail.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "process" "rt-core" "blocking" "io-util" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
