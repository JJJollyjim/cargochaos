...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/project_init/v3.1.23.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cli-setup" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "1vxyr785rbvz8r0gy2zxvv2h1b559q4gx4cswskm68wbfzpv7ap2";
        authors = [
      ...
      "project_init" = rec {
        crateName = "project_init";
        version = "3.1.23";
        edition = "2015";
        crateBin = [
          { name = "pi"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v3.1.23.nix {};
        authors = [
          "Vanessa McHale <vamchale@gmail.com>"
        ];
        dependencies = [
      ...
      "rustache-lists" = rec {
        crateName = "rustache-lists";
        version = "0.1.2";
        edition = "2015";
        sha256 = "088dk2bjdpccqv0apvkff7nkc1gwlaf0cwhkpd5mn9v73kc157vr";
        libName = "rustache";
        authors = [
          "Vanessa McHale <tmchale@wisc.edu>"
      ...
      "text_io" = rec {
        ...
        version = "0.1.6";
        edition = "2015";
        sha256 = "0v9yyy1z1gcv6mc5vcdpfjhsxcphk4pvgyq0sm31dw787bkjw389";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
