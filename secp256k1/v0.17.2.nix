...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/secp256k1/v0.17.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "secp256k1" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "endomorphism" "external-symbols" "fuzztarget" "lowmemory" "rand" "rand-std" "recovery" "serde" "std" "unstable" ];
      };
      "secp256k1-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "endomorphism" "external-symbols" "fuzztarget" "lowmemory" "recovery" "std" ];
      };
      "serde" = rec {
        crateName = "serde";
        version = "1.0.80";
