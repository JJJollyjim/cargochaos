...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grass/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "grass" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "grass"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.7.0.nix {};
        authors = [
          "ConnorSkees <39542938+ConnorSkees@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "clap" "commandline" "default" "nightly" "rand" "random" ];
      };
      "hermit-abi" = rec {
