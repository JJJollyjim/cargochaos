...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/requirements/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "requirements" = rec {
        crateName = "requirements";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "parsereqs"; path = "src/bin/parsereqs.rs"; }
        ];
