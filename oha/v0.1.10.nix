...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oha/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "average" = rec {
        ...
        version = "0.10.4";
        edition = "2018";
        sha256 = "1dmsxqcr1n0i20qr9g2g6j89kkx8dy6w18dbqzx1wi42wj1chgvh";
        authors = [
      ...
      "get-port" = rec {
        ...
        version = "1.3.1";
        edition = "2018";
        sha256 = "1cv5lgm9f00vz13aplm4qn9in5q4sx5w1i8l5n44m4bx8rm1ws72";
        authors = [
          "Carlos Menezes <carlos-menezes212@hotmail.com>"
        ];
      ...
      "parse_duration" = rec {
        ...
        version = "2.1.0";
        edition = "2015";
        sha256 = "1bljgqz2c46vgppajlcb9361ys3jdz3pisjxqnx1smsgp8j873fw";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "brotli" "default" "default-tls" "gzip" "hyper-tls" "native-tls-crate" "tokio-tls" ];
      };
      "rlimit" = rec {
        crateName = "rlimit";
        version = "0.3.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
