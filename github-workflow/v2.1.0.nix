...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/github-workflow/v2.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "github-workflow" = rec {
        crateName = "github-workflow";
        version = "2.1.0";
        edition = "2018";
        crateBin = [
          { name = "github-workflow"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v2.1.0.nix {};
        libName = "github_workflow_lib";
        authors = [
