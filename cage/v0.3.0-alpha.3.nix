...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cage/v0.3.0-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "boondock" = rec {
        ...
        edition = "2018";
        sha256 = "1p9x0xq6ksabrwxjx9knfvs46ffa7sl4q4pm84jaksbvqj5k3sbv";
        authors = [
      ...
      "tokio 0.2.17" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "rt-core" "slab" "stream" "sync" "tcp" "time" "uds" ];
      };
      "tokio-buf" = rec {
        crateName = "tokio-buf";
        version = "0.1.1";
