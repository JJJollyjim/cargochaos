...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redelete/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mockito" = rec {
        ...
        version = "0.23.1";
        edition = "2018";
        sha256 = "0lyq8l1rxk0kf3a630gn6l98pnb8slrpx9z9vbzy5rwqbn8pq097";
        authors = [
      ...
      "rate_limit" = rec {
        crateName = "rate_limit";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1jhzdjp7c25ngsna79vbsg0qpv4zkid9prb732lx8ibb9w86kcr2";
        authors = [
      ...
      "redelete" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "redelete"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "ardeaf <ardeaf@gmail.com>"
        ];
        dependencies = [
          {
            name = "async-std";
