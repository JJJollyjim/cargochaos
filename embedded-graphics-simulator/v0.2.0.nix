...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/embedded-graphics-simulator/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "embedded-graphics-simulator";
  ...
  workspaceMembers = {
    "embedded-graphics-simulator" = rec {
      packageId = "embedded-graphics-simulator";
      build = internal.buildRustCrateWithFeatures {
        packageId = "embedded-graphics-simulator";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "embedded-graphics" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "07nbrcnic2c402iif6m327qmrmfc6khml9cdr31jxgc7nkk2a9cv";
        authors = [
      ...
      "embedded-graphics-simulator" = rec {
        crateName = "embedded-graphics-simulator";
        version = "0.2.0";
        edition = "2018";
      ...
      "tinybmp" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0qw0r9xx24zs9pcfxdyyqvrwwhsazash1wlc8blqq0bzgpilcsaw";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "embedded-graphics" "graphics" ];
      };
      "tinytemplate" = rec {
      ...
      "tinytga" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "1s7amq5x3cy00qzpnnjf2cvhb1w7x23k80n73fq5svawny1smzpy";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
