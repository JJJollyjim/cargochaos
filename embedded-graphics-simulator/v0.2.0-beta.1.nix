...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/embedded-graphics-simulator/v0.2.0-beta.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "embedded-graphics" = rec {
        ...
        edition = "2018";
        sha256 = "0brdv4axw924yh3239l8bcf39m8wkiv5wssbipalp2kzjg0hja27";
        authors = [
      ...
      "embedded-graphics-simulator" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0-beta.1.nix {};
        authors = [
      ...
      "tinybmp" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0116j0bsxax5pigd3sl3sgl2ih14m2xrfan64zhkgrf7liybxvxl";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
      ...
      "tinytga" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0ab71x817y8i36rlsxpycm220cxzyh7mnmhja5pv44b0av23i1di";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
