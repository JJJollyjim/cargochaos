...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/num_stream/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "macros" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
