...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/persway/v0.3.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "swayipc" = rec {
        ...
        version = "2.4.1";
        edition = "2018";
        sha256 = "1fi9aizrn8v63mx684blwm5q7fdys62phpj0hvqh8dblvygyr39q";
        authors = [
        ...
        resolvedDefaultFeatures = [ "async" "async-std" "event_stream" "futures-core" "futures-util" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "winbase" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
