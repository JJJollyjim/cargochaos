...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chmlib/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chmlib-sys" = rec {
        crateName = "chmlib-sys";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0clivyw5iqid6rx94k0dcr9libbibj0an75a6gdsq1913rqh245r";
        authors = [
          "Michael Bryan <michaelfbryan@gmail.com>"
        ];
        buildDependencies = [
