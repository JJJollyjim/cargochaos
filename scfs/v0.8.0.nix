...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scfs/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "scfs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "scfs"; path = "src/main.rs"; }
          { name = "splitfs"; path = "src/bin/splitfs.rs"; }
          { name = "catfs"; path = "src/bin/catfs.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" ];
      };
