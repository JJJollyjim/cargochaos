...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-cat-prep/v1.0.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-cat-prep" = rec {
        crateName = "mdbook-cat-prep";
        version = "1.0.8";
        edition = "2018";
        crateBin = [
          { name = "mdbook-cat-prep"; path = "src/main.rs"; }
        ];
      ...
      "shells" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0a45a6wzv4qhjl5g2qgfgf0jrx0qdwjfx2i6zz249qj6a8fksaax";
        authors = [
          "Damien Levac <damien.levac@gmail.com>"
        ];
