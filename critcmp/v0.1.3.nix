...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/critcmp/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tabwriter" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_formatting" "default" "lazy_static" "regex" ];
      };
      "termcolor" = rec {
        crateName = "termcolor";
        version = "1.0.5";
