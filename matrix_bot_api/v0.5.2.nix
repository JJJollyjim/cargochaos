...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/matrix_bot_api/v0.5.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fractal-matrix-api" = rec {
        crateName = "fractal-matrix-api";
        version = "4.2.0";
        edition = "2018";
        sha256 = "165skypm40rjpcznbdz36j0lc5389vq16af03qswpx16jlv3hxgb";
        authors = [
      ...
      "matrix_bot_api" = rec {
        crateName = "matrix_bot_api";
        version = "0.5.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.2.nix {};
        authors = [
          "zwieberl <donko@posteo.de>"
        ];
        dependencies = [
          {
            name = "chrono";
