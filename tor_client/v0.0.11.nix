...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tor_client/v0.0.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "socks" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "168jamig6g5rjrp86snbr5c287w66frfcz0qhqq793z8dzhxj2cb";
        authors = [
      ...
      "tor_client" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tor_client"; path = "src/bin/tor_client.rs"; }
        ];
