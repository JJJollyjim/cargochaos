...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/orientdb-client/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "orientdb-client" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "async-std" "async-std-runtime" "async-trait" "default" "futures" "mobc" "tokio" "tokio-runtime" ];
      };
      "parking_lot" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
