...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uom/v0.26.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "uom" = rec {
        ...
        resolvedDefaultFeatures = [ "autoconvert" "bigint" "bigint-support" "bigrational" "biguint" "default" "f32" "f64" "i128" "i16" "i32" "i64" "i8" "isize" "num-bigint" "num-rational" "rational" "rational-support" "rational32" "rational64" "serde" "si" "std" "try-from" "u128" "u16" "u32" "u64" "u8" "use_serde" "usize" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.8";
