...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cxmr-ws-client-binance/v0.0.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "cxmr-ws-client-binance";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cxmr-api" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "1gp5wqdbxnnf49p6mm8z4gzpi37ya43a5mf086iwc1lxgidzcfdh";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "cxmr-currency";
            packageId = "cxmr-currency";
          }
          {
            name = "cxmr-exchanges";
            packageId = "cxmr-exchanges";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "cxmr-api-binance" = rec {
        crateName = "cxmr-api-binance";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1jdk3bks2n8wcsnv6agb6pap3g2kqv66bsrqnbby7j9kkx4inna8";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "cxmr-api-clients-errors";
            packageId = "cxmr-api-clients-errors";
          }
          {
            name = "cxmr-balances";
            packageId = "cxmr-balances";
          }
          {
            name = "cxmr-currency";
            packageId = "cxmr-currency";
          ...
          {
            name = "cxmr-http-client";
            packageId = "cxmr-http-client";
          }
          {
            name = "hashbrown";
            packageId = "hashbrown";
      ...
      "cxmr-api-clients-errors" = rec {
        crateName = "cxmr-api-clients-errors";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1xlvi92jynb3qal0jgm7jj5imivhq9vqsi32vb4dz1czxspc0mk8";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "err-convert-macro";
            packageId = "err-convert-macro";
          }
          {
            name = "failure";
            packageId = "failure";
      ...
      "cxmr-balances" = rec {
        crateName = "cxmr-balances";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1h583qvfs7jx542shggnrhfk6plb452rkm4c1qqln1gnq10021l0";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-currency" = rec {
        crateName = "cxmr-currency";
        version = "0.0.1";
        edition = "2018";
        sha256 = "0484jvx49gl3rpfqjgn9k3qj1r3wwwahs2qf30w6yiq3q4qrvpyv";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-exchanges" = rec {
        crateName = "cxmr-exchanges";
        version = "0.0.1";
        edition = "2018";
        sha256 = "11a1v1m3572kvcsw6iimjp4qdgibyr7f40wzaf6j3lh15bgzhy55";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-feeds" = rec {
        crateName = "cxmr-feeds";
        version = "0.0.1";
        edition = "2018";
        sha256 = "187dchsz4ghbdjl1985wjyjar9bqlq938wr1fpmg8bbvm6j4z4xl";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-http-client" = rec {
        crateName = "cxmr-http-client";
        version = "0.0.1";
        edition = "2018";
        sha256 = "13zsrqliynfdlglxyn41yha3psnrzqj0zydagw3nlli80v7hl4ls";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-ws-client" = rec {
        crateName = "cxmr-ws-client";
        version = "0.0.1";
        edition = "2018";
        sha256 = "0ijljb2s6jl9925yx2imfii6imsmplbqmkxd8scvjdg88rcsnblz";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "websocket-lite";
            packageId = "websocket-lite";
          }
        ];
        
      };
      "cxmr-ws-client-binance" = rec {
        crateName = "cxmr-ws-client-binance";
        version = "0.0.1";
        edition = "2018";
        ...
        dependencies = [
          ...
          {
            name = "cxmr-api-binance";
            packageId = "cxmr-api-binance";
          }
          {
            name = "cxmr-balances";
            packageId = "cxmr-balances";
      ...
      "err-convert-macro" = rec {
        crateName = "err-convert-macro";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1j88ghk6vbnd5dmjxjr07s57bxd916d6jzn12ax2ilpvvjcw2fgl";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
      ...
      "futures-async-stream" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "18p6yb7fal4ikg2zrhc881fd3npd9vxadgrlbbw4hzd53b1wsr95";
        authors = [
      ...
      "futures-async-stream-macro" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1gql1ksldjjgv86w3ap87dw9zcrzx6jhn3lrz0wfq9da31p1yxv7";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "websocket-codec" = rec {
        crateName = "websocket-codec";
        version = "0.2.2";
        edition = "2018";
        sha256 = "0gsbw3iy6halmvvmvmi3kykkr9cg3ifh9i8gscrkqphy3k1z4jdr";
        authors = [
          "Tim Robinson <tim.g.robinson@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "websocket-lite" = rec {
        crateName = "websocket-lite";
        version = "0.3.2";
        edition = "2018";
        sha256 = "1pg46k6a8sv9mimjdy7kpnaa392cdbrchq7qylmy2xslkrfl10rs";
        authors = [
          "Tim Robinson <tim.g.robinson@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "native-tls" "ssl-native-tls" "tokio-tls" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
