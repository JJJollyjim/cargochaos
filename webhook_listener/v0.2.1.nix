...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webhook_listener/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lock_api 0.3.0" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0bppa6rdkqly08rsf6qr7d5yfjs4bzymyfipvlvndb70g8f00kzj";
        authors = [
          "Amanieu d'Antras <amanieu@gmail.com>"
        ];
        dependencies = [
      ...
      "parking_lot 0.8.1" = rec {
        crateName = "parking_lot";
        version = "0.8.1";
        edition = "2018";
        sha256 = "0klsvm827yf9impx04dsra9g3bzivyhnjqcicxj233bc1bz6bxz0";
        authors = [
          "Amanieu d'Antras <amanieu@gmail.com>"
        ];
        dependencies = [
      ...
      "webhook_listener" = rec {
        crateName = "webhook_listener";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "webhook_listener"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "FKYnJYQ <loveress01@gmail.com>"
        ];
        dependencies = [
          {
            name = "actix-web";
