...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-nono/v0.1.7.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-nono" = rec {
        crateName = "cargo-nono";
        version = "0.1.7";
        edition = "2018";
        crateBin = [
          { name = "cargo-nono"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "proc_macro_spans" ];
      };
      "cargo_metadata" = rec {
