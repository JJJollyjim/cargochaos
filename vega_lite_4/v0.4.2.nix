...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vega_lite_4/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "showata" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1jgd1sqnccrakmpp4m6r8wb6dfkp5ldbksz5zigrw51sibnkvpzp";
        authors = [
      ...
      "vega_lite_4" = rec {
        ...
        resolvedDefaultFeatures = [ "anyhow" "csv" "default" "nalgebra" "ndarray" "rulinalg" "show_vega" "showata" ];
      };
      "wasi" = rec {
        crateName = "wasi";
        version = "0.7.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "shellapi" ];
      };
