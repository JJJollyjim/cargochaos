...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/close_enough/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "close_enough" = rec {
        crateName = "close_enough";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "cle"; path = "src/cle.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Claire Harris <wishing.engine@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "libc" = rec {
        ...
        version = "0.2.32";
        edition = "2015";
        sha256 = "0j010f7hqazh1lqkq2f9nj7q1iay5r4wi5glys6w4h6h1w9y7k2n";
        authors = [
          "The Rust Project Developers"
        ];
        features = {
