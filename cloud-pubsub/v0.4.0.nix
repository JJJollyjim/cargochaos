...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cloud-pubsub/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cloud-pubsub" = rec {
        crateName = "cloud-pubsub";
        version = "0.4.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Kayle Gishen <k@bkdsw.com>"
      ...
      "goauth" = rec {
        ...
        version = "0.6.1";
        edition = "2015";
        sha256 = "0viam4h24yj4493il7x7k2fkn76ywkqw8zf9lp4py8sqv1s68709";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
