...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adexchangebuyer1d4-cli/v1.0.12+20190614.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-adexchangebuyer1d4-cli";
  ...
  workspaceMembers = {
    "google-adexchangebuyer1d4-cli" = rec {
      packageId = "google-adexchangebuyer1d4-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-adexchangebuyer1d4-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adexchangebuyer1d4" = rec {
        crateName = "google-adexchangebuyer1d4";
        version = "1.0.12+20190614";
        edition = "2015";
        sha256 = "0qmbj02gyqma3k7hvim7wcr91s9kkc8s9wmsbik0yj1jadiwa2ds";
        authors = [
      ...
      "google-adexchangebuyer1d4-cli" = rec {
        crateName = "google-adexchangebuyer1d4-cli";
        version = "1.0.12+20190614";
        edition = "2015";
        crateBin = [
          { name = "adexchangebuyer1d4"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-adexchangebuyer1d4";
          }
          {
            name = "hyper";
            packageId = "hyper";
