...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rweb/v0.5.1.nix.tmp"
    ...
    crates = {
      ...
      "rweb" = rec {
        ...
        dependencies = [
          ...
          {
            name = "rweb-macros";
            packageId = "rweb-macros";
          }
          {
            name = "rweb-openapi";
            packageId = "rweb-openapi 0.5.0";
            optional = true;
          }
          {
            name = "scoped-tls";
        ...
        resolvedDefaultFeatures = [ "default" "multipart" "openapi" "rweb-openapi" "tls" "websocket" ];
      };
      "rweb-macros" = rec {
        crateName = "rweb-macros";
        version = "0.4.2";
        edition = "2018";
        sha256 = "1wdlzygq1gyk941ijfqb15kgbk2ipg21mx6hjlhmq0kk1dbxgkx8";
        procMacro = true;
        authors = [
          "강동윤 <kdy1997.dev@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "openapi" ];
      };
      "rweb-openapi 0.4.0" = rec {
        crateName = "rweb-openapi";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1vzz87nl81gj7bxjzl1mipqn1babwckfjmhrqikgfhw80vklls0x";
        authors = [
          "강동윤 <kdy1997.dev@gmail.com>"
        ];
        dependencies = [
      ...
      "rweb-openapi 0.5.0" = rec {
        crateName = "rweb-openapi";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1wqpb0i4hv6d10kba444y7l3zfhcg8wnc7hgmazah4wl9dgl8cmn";
        authors = [
          "강동윤 <kdy1997.dev@gmail.com>"
        ];
        dependencies = [
      ...
      "warp" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "multipart" "rustls" "tungstenite" "websocket" ];
      };
      "wasi" = rec {
        crateName = "wasi";
