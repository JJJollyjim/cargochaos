...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/updns/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "ace" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0jpscnf998qppgggrwz0j9xsihkynkcj255959k2jxdmrmqy5jbp";
        authors = [
          "wyhaya <wyhaya@gmail.com>"
        ];
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_trace" "release_max_level_info" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.2.1";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "rt-core" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "updns" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "io-util" "macros" "net" "stream" "time" "sync" ];
          }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
