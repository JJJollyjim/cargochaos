...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sha2/v0.8.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sha2" = rec {
        ...
        resolvedDefaultFeatures = [ "asm" "asm-aarch64" "default" "libc" "sha2-asm" "std" ];
      };
      "sha2-asm" = rec {
        crateName = "sha2-asm";
        version = "0.5.3";
        edition = "2015";
        sha256 = "0k3qwv2yl8fyi2i6cprfb8d874ii5kmcmckgnjkwnz2ac9fayyl1";
        authors = [
          "RustCrypto Developers"
        ];
        buildDependencies = [
