...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu_plugin_ps/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "heim" = rec {
        ...
        resolvedDefaultFeatures = [ "heim-cpu" "heim-disk" "heim-host" "heim-memory" "heim-net" "heim-process" "heim-sensors" "heim-virt" "process" "runtime-polyfill" ];
      };
      "heim-common" = rec {
      ...
      "nu_plugin_ps" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "nu_plugin_ps"; path = "src/main.rs"; }
        ];
