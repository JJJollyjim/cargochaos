...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xpring/v0.0.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mockall" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "110rca65vxgjsll78nsjz05d4ynm0c1f8r4xl0l7mvk8fzyfxja8";
        authors = [
      ...
      "mockall_derive" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0vrpcwrdfyj2p4gcyv457b10fd0yzjxrqng5nrra57nrwva2cws4";
        procMacro = true;
        authors = [
          "Alan Somers <asomers@gmail.com>"
        ];
      ...
      "xpring" = rec {
        ...
        authors = [
          "Javier Romero <elmurci@gmail.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
