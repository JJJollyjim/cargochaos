...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ripasso-cursive/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "maplit" "ncurses" "ncurses-backend" "term_size" "toml" ];
      };
      "custom_derive" = rec {
      ...
      "gpgme" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "13s7yfdps2a73fxn34nr9izvwpdzn4cqjh3ad5s0rssm32c8p2sj";
        authors = [
          "John Schug <john.ips.schug@gmail.com>"
        ];
        dependencies = [
      ...
      "ripasso" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1mw56i0f77ri7gg85zly05mfxnmlbpzw709h6csf2rlj1qy324zj";
        authors = [
      ...
      "ripasso-cursive" = rec {
        crateName = "ripasso-cursive";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "ripasso-cursive"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shellapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
