...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wayland-client/v0.26.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wayland-client" = rec {
        ...
        version = "0.26.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.26.3.nix {};
        authors = [
          "Victor Berger <victor.berger@m4x.org>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "std" "winbase" "winerror" ];
      };
