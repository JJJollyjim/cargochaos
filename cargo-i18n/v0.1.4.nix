...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-i18n/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "i18n-build" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1mr97gq0dpahlk8hpm81fndy8pwaf899bihm8x453vixnjkzh4fs";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-config" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0nlyh6gs6pppwa60lqdynwqq8qlw1d88z3il54zjh71kizy6rc2c";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-embed" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "17l6wfqpn5h2rgdw1vsicgcgj2nsnpvm2xca5xb3i6p9fb41sd6d";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-embed-impl" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1dxf8mklah1vdvhzdf4dbq2vh0k1vr2h13vv02jzcmn81x2awhdx";
        procMacro = true;
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
