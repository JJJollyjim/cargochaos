...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-i18n/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "i18n-build" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1bgzakxfl0jq8dwx2yg8y2w6kq1xc6rwkf5y3yws9rf47q7h75ka";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "gettext" "i18n-embed" "lazy_static" "localize" ];
      };
      "i18n-config" = rec {
        crateName = "i18n-config";
        version = "0.2.2";
        edition = "2018";
        sha256 = "1b6gh8fgx4w08bnzqhg67jnnmsbmy32k4184lacg2y8dl5rb1i5v";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-embed" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1x29gdjm4qh35hjnf1lxv8cn160lrpkihp756q8fzaf9gvcr57iq";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-embed-impl" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0pvbarcxvkq4vlc0q2f6n73967kwrpmrvagj8psc6v0fqv1z1rdl";
        procMacro = true;
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
