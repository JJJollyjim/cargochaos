...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-i18n/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "i18n-build" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1f9kak2wag6jg1phi7x1cims70x4bni2m6pyvw5zynfsi46hhxdp";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-embed" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0jzfamwp0ff8j1q1p8alqrhln997wdwpbwv350pg8v6pcn000420";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
