...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty-swagger/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusty-swagger" = rec {
        crateName = "rusty-swagger";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "rusty-swagger"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Patrick Amrein <amrein@ubique.ch>"
        ];
        dependencies = [
          {
            name = "mustache";
