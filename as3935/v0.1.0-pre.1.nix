...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/as3935/v0.1.0-pre.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "as3935" = rec {
        ...
        version = "0.1.0-pre.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-pre.1.nix {};
        authors = [
          "Michael Moravec <oss@majkl.me>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "rppal" = rec {
        ...
        version = "0.11.3";
        edition = "2018";
        sha256 = "1qfvdn299f8rjg7k9w2i2mdbp9dw25mcvhx4rlkslzc6zfhvnz8k";
        authors = [
      ...
      "simple-signal" = rec {
        crateName = "simple-signal";
        version = "1.1.1";
        edition = "2015";
        sha256 = "12r82dpipdkkfmslp04pd3b2fpr9h4zxjfs8axynchncmm2dmxsk";
        libName = "simple_signal";
        authors = [
          "Antti Keränen <detegr@gmail.com>"
          "Alexey Voznyuk <me@swizard.info>"
        ];
        dependencies = [
          {
            name = "lazy_static";
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "stable" ];
      };
      "simple_logger" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winnls" "winnt" "winuser" ];
      };
