...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/anevicon/v6.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "anevicon" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "anevicon"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v6.0.2.nix {};
        authors = [
      ...
      "anevicon_core" = rec {
        crateName = "anevicon_core";
        version = "0.5.1";
        edition = "2018";
        sha256 = "1fpir64jdkbsfdsgzjp7r1d381l8w5r58iz2db846mnanadvragf";
        authors = [
          "Temirkhan Myrzamadi <gymmasssorla@gmail.com>"
        ];
        dependencies = [
      ...
      "ifaces" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1wc19gwj402321wiw170vm4hjq0rpr943czgi8vr4rxf9imwwp7s";
        authors = [
          "David Levy <dlevy47>"
      ...
      "sendmmsg" = rec {
        ...
        version = "0.3.5";
        edition = "2018";
        sha256 = "18lfhvhw0vka8hc4z1x5wxsdkk9ll7bh2c8j541pwsk37q9gb7im";
        authors = [
          "Temirkhan Myrzamadi <gymmasssorla@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winnls" "winnt" "winuser" ];
      };
