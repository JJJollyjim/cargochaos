...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/anevicon/v7.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "anevicon" = rec {
        ...
        src = pkgs.callPackage ./tarball-v7.0.4.nix {};
        authors = [
      ...
      "etherparse" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "1pikxznr7xgkx657d20ab75ccr7k7h7flmp92kdfrk5c6w81277z";
        authors = [
