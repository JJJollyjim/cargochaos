...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/anevicon/v6.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "anevicon" = rec {
        ...
        src = pkgs.callPackage ./tarball-v6.0.5.nix {};
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winnt" ];
      };
