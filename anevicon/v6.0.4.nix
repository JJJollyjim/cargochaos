...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/anevicon/v6.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "anevicon" = rec {
        ...
        src = pkgs.callPackage ./tarball-v6.0.4.nix {};
        authors = [
      ...
      "anevicon_core" = rec {
        ...
        version = "0.5.3";
        edition = "2018";
        sha256 = "1j8phrjz33jzqklcpg0ragi9y6n4xlnkfg2mhvn4nf04z832dvfr";
        authors = [
          "Temirkhan Myrzamadi <gymmasssorla@gmail.com>"
        ];
        dependencies = [
