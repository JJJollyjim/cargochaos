...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/anevicon/v6.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "anevicon" = rec {
        ...
        src = pkgs.callPackage ./tarball-v6.0.3.nix {};
        authors = [
      ...
      "anevicon_core" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "0y85nlqsnbxfz5b6v8bcksi13lfb50kkg9sv81gsgbfn42jpz8zp";
        authors = [
          "Temirkhan Myrzamadi <gymmasssorla@gmail.com>"
        ];
        dependencies = [
