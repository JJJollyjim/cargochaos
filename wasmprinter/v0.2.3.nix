...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasmprinter/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasmparser" = rec {
        ...
        version = "0.51.0";
        edition = "2018";
        sha256 = "0h7v75x6sdyj98c3y4babx543h4l705n6aprbbxzbjb4vr9a8q38";
        authors = [
      ...
      "wat" = rec {
        ...
        version = "1.0.8";
        edition = "2018";
        sha256 = "1kp8v61sqyln936bw6nfw2c17hw5mi7n8zn9vr9kd29r9d5f75ap";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
