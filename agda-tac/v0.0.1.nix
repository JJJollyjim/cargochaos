...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/agda-tac/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "agda-mode" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "0vcbpy0gw0clhg2198dj7nqnibbqmjv6fdbi0zgpbin475wd6rrh";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "processenv" "processthreadsapi" "std" "synchapi" "threadpoollegacyapiset" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
