...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/agda-tac/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "agda-mode" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "1q52dzc2fykx37f9pfib6yh9pm0fmwynwb18901kk4v68q4c0mq3";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "rt-core" "process" ];
          }
        ];
      ...
      "agda-tac" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "rt-core" "process" "macros" ];
          }
        ];
      ...
      "minitt-util" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0a8nphln595qsml5a0jvpfvynccc3lhrg5mb8jq7j8lq69y5fz5y";
        authors = [
          "ice1000 <ice1000kotlin@foxmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "shlobj" "std" "synchapi" "threadpoollegacyapiset" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
