...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mech/v0.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hashbrown" = rec {
        ...
        resolvedDefaultFeatures = [ "ahash" "ahash-compile-time-rng" "default" "inline-more" "nightly" ];
      };
      "hermit-abi" = rec {
      ...
      "mech" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mech"; path = "src/bin/mech.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "mech-program";
            packageId = "mech-program";
          }
          {
            name = "mech-server";
            packageId = "mech-server";
          }
          {
            name = "mech-syntax";
            packageId = "mech-syntax";
          }
          {
            name = "mech-utilities";
            packageId = "mech-utilities";
          }
          {
            name = "nom";
            packageId = "nom";
      ...
      "mech-core" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "05k4kqcqi58ax10nqi9axrkhpls7vya6z0d1s75pdm9hvssav6db";
        authors = [
          "Corey Montella <corey@mech-lang.org>"
        ];
        dependencies = [
      ...
      "mech-program" = rec {
        crateName = "mech-program";
        version = "0.0.4";
        edition = "2018";
        crateBin = [];
        sha256 = "1r64y2hghn59zcmgvmq56bhign8dcknsn51fah2zkxdig9imdzv6";
        authors = [
          "Corey Montella <corey@mech-lang.org>"
        ];
        dependencies = [
      ...
      "mech-server" = rec {
        crateName = "mech-server";
        version = "0.0.4";
        edition = "2015";
        sha256 = "15cgggw0a8xl55a7xw69s3qn2rh4vf2zfk0mpx1g2i0c1m7q7n42";
        authors = [
          "Corey Montella <corey@mech-lang.org>"
        ];
        dependencies = [
      ...
      "mech-syntax" = rec {
        crateName = "mech-syntax";
        version = "0.0.4";
        edition = "2015";
        crateBin = [];
        sha256 = "0sp0387rfbmkg9chhcb523gc9a30h47m1qslwhdv5wkf4cdxf6ak";
        authors = [
          "Corey Montella <corey@mech-lang.org>"
        ];
        dependencies = [
      ...
      "mech-utilities" = rec {
        crateName = "mech-utilities";
        version = "0.0.4";
        edition = "2015";
        sha256 = "0b3654ran8njrlj36rkcsp42rl2xrc3d4a9caffiihsr09hv80hh";
        authors = [
          "Corey Montella <corey@mech-lang.org>"
        ];
        dependencies = [
