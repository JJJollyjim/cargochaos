...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tdb-server/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "circular-queue" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "1dvvm1h1c7fy4hvv99xmi7cbi83447gcfv9kccpibm43fjhrqswr";
        authors = [
      ...
      "libtectonic" = rec {
        crateName = "libtectonic";
        version = "0.3.0";
        edition = "2018";
        sha256 = "02ndjl7w0q7pzkfzlmphzasxiasgvba8hkapfcn247x8zd8qfkk3";
        authors = [
      ...
      "tdb-server" = rec {
        crateName = "tdb-server";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "tdb-server"; path = "src/main.rs"; }
        ];
        ...
        features = {
          "default" = [ "gcs" ];
          "gcs" = [ "tempdir" "reqwest" "serde_json" "serde" "config" "time" ];
        };
        resolvedDefaultFeatures = [ "config" "default" "gcs" "reqwest" "serde" "serde_json" "tempdir" "time" ];
      };
      "tempdir" = rec {
        crateName = "tempdir";
        version = "0.3.7";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
