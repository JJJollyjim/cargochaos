...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vmread/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vmread" = rec {
        ...
        authors = [
          "Aurimas Blažulionis <0x60@pm.me>"
        ];
        dependencies = [
          {
            name = "libc";
          ...
          {
            name = "vmread-sys";
            packageId = "vmread-sys";
            optional = true;
          }
          {
            name = "vmread-sys-internal";
            packageId = "vmread-sys-internal";
            optional = true;
          }
          {
            name = "vmread-sys-kmod";
            packageId = "vmread-sys-kmod";
            optional = true;
          }
        ];
        devDependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "internal_rw" "kmod_rw" "libc" "vmread-sys" "vmread-sys-internal" "vmread-sys-kmod" ];
      };
      "vmread-sys" = rec {
        crateName = "vmread-sys";
        version = "0.1.4";
        edition = "2018";
        sha256 = "0qrcrlbjxpn4pj8nc1rj0qlzi63j3fgg9kjqfyibc6z58dacm47m";
        authors = [
          "Aurimas Blažulionis <0x60@pm.me>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "internal_rw" "kmod_rw" ];
      };
      "vmread-sys-internal" = rec {
        crateName = "vmread-sys-internal";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1k717g2ix5pzr9980ghhkbvb023hazkf4pwplvj8bhk9ddrj7bp2";
        authors = [
          "Aurimas Blažulionis <0x60@pm.me>"
        ];
        dependencies = [
          {
            name = "vmread-sys";
            packageId = "vmread-sys";
            features = [ "internal_rw" ];
          }
        ];
        
      };
      "vmread-sys-kmod" = rec {
        crateName = "vmread-sys-kmod";
        version = "0.1.4";
        edition = "2018";
        sha256 = "16mq1vp34cfw3xq0zjlbah6z2qz8814hdiw1dj03rzzcpfq1z1md";
        authors = [
          "Aurimas Blažulionis <0x60@pm.me>"
        ];
        dependencies = [
