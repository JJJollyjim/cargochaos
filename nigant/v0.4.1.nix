...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nigant/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cacache" = rec {
        ...
        version = "6.0.0";
        edition = "2018";
        sha256 = "1rpbx9iskpg5hmyv67rhnmnzi3l7cyzk6y176pdrgyk80brq4dyg";
        authors = [
      ...
      "nigant" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "nigant"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.1.nix {};
        authors = [
          "Sujith Jay Nair <sujith@sujithjay.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "ssri" = rec {
        ...
        version = "5.0.0";
        edition = "2018";
        sha256 = "1jbhzf53ad1l5c9sgmw8h66s917fk83lpyfg14nq6gy32a7yaxg8";
        authors = [
          "Kat Marchán <kzm@zkat.tech>"
        ];
        dependencies = [
