...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libucl/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libucl" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "ucltool"; path = "src/bin/ucltool.rs"; }
        ];
      ...
      "libucl-bind" = rec {
        crateName = "libucl-bind";
        version = "0.2.2";
        edition = "2015";
        sha256 = "1mm1i4j2z3yfrm3rgcdd3zlzk5ydnf7vrhaj4rrzjirs19ffv7hi";
        authors = [
          "Łukasz Niemier <lukasz@niemier.pl>"
          "Igor Laćarac <draftsix@gmail.com>"
        ];
