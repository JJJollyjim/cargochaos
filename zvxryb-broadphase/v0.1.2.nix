...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zvxryb-broadphase/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "zvxryb-broadphase" = rec {
        crateName = "zvxryb-broadphase";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Michael Lodato <zvxryb@gmail.com>"
        ];
        dependencies = [
          {
            name = "cgmath";
        ...
        resolvedDefaultFeatures = [ "default" "parallel" "rayon" "serde" "thread_local" ];
      };
    };
