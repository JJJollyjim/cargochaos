...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vte/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vte" = rec {
        ...
        resolvedDefaultFeatures = [ "arrayvec" "default" "nightly" "no_std" ];
      };
      "vte_generate_state_changes" = rec {
        crateName = "vte_generate_state_changes";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1d809ick2gpd47hb160vlcg7cz9033i6s6jxbfw9prn08qlq2gdi";
        procMacro = true;
        authors = [
          "Christian Duerr <contact@christianduerr.com>"
        ];
