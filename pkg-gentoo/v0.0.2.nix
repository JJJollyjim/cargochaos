...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pkg-gentoo/v0.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pkg-gentoo" = rec {
        crateName = "pkg-gentoo";
        version = "0.0.2";
        edition = "2018";
        crateBin = [
          { name = "pkg"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.2.nix {};
        authors = [
          "Ash <ValleyKnight@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
