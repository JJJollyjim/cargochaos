...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cellar/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cellar-core" = rec {
        crateName = "cellar-core";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1y3c2vaj4yg0ny8wzvk3pxfq2k4rw2spbin7pk92b95wpbd9hgs5";
        authors = [
          "Tyr Chen <tyr.chen@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "io-util" "memchr" "rt-core" ];
      };
      "toml" = rec {
        crateName = "toml";
        version = "0.5.5";
