...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/industrial-io/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "industrial-io" = rec {
        crateName = "industrial-io";
        version = "0.2.0";
        edition = "2015";
        crateBin = [
          { name = "iio_info_rs"; path = "src/bin/iio_info_rs.rs"; }
        ];
      ...
      "libiio-sys" = rec {
        crateName = "libiio-sys";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0fck1m9y5jrkc9y69b6fl2hpn50bd0npy0h0qz46nmpa2ag4dcms";
        authors = [
          "Frank Pagliughi <fpagliughi@mindspring.com>"
        ];
      ...
      "schedule_recv" = rec {
        crateName = "schedule_recv";
        version = "0.1.0";
        edition = "2015";
        sha256 = "1ss07pn259fjl95bxh26bm7yk3xngsrsdfapxff350iikp7j05fa";
        authors = [
          "Peter Reid <peter.d.reid@gmail.com>"
          "Andrew Hobden <andrew@hoverbear.org>"
          "Demur Rumed <unkmute@hotmail.com>"
        ];
        dependencies = [
          {
            name = "lazy_static";
