...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-gan1_beta1-cli/v1.0.13+20130205.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-gan1_beta1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-gan1_beta1" = rec {
        crateName = "google-gan1_beta1";
        version = "1.0.13+20130205";
        edition = "2015";
        sha256 = "1k17q2w58g45zlg76ggddqr4qfc11xhphq4bkz650f40yk1dk73d";
        authors = [
      ...
      "google-gan1_beta1-cli" = rec {
        crateName = "google-gan1_beta1-cli";
        version = "1.0.13+20130205";
        edition = "2015";
        crateBin = [
          { name = "gan1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20130205.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
