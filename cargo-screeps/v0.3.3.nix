...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-screeps/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-screeps" = rec {
        crateName = "cargo-screeps";
        version = "0.3.3";
        edition = "2018";
        crateBin = [
          { name = "cargo-screeps"; path = "src/main.rs"; }
        ];
      ...
      "cargo-web" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0y52mdbbfpi29v2991i0kh1lpydbqdvz0j4giyr25yhjajy8jycj";
        authors = [
          "Jan Bujak <j@exia.io>"
        ];
        dependencies = [
      ...
      "parity-wasm" = rec {
        ...
        version = "0.35.7";
        edition = "2015";
        sha256 = "14sx2m1sj20n3m1fywa68apa7fwh5zs8sfkrs1n9nf819rn0f7iy";
        authors = [
      ...
      "tar" = rec {
        ...
        version = "0.4.25";
        edition = "2018";
        sha256 = "1w322xk7rdjx7wa47lr8yhdgsd7cvjv5g58cq0xlxcwmxm6j20bj";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
