...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fehler/v1.0.0-alpha.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "fehler" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0-alpha.0.nix {};
        authors = [
      ...
      "fehler-macros" = rec {
        ...
        edition = "2018";
        sha256 = "0x4a38qjm2qijw7r4z2zggmakgyq1467f0c063564c09ggwdwi6x";
        procMacro = true;
        authors = [
          "Without Boats <boats@mozilla.com>"
        ];
