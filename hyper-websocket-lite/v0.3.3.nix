...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper-websocket-lite/v0.3.3.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "hyper-websocket-lite";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-websocket-lite" = rec {
        crateName = "hyper-websocket-lite";
        version = "0.3.3";
        edition = "2018";
