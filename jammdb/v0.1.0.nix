...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jammdb/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "fileapi" "handleapi" "memoryapi" "minwindef" "processthreadsapi" "std" "sysinfoapi" "winbase" "winerror" ];
      };
