...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo/v0.37.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo"; path = "src/bin/cargo/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "deny-warnings" "openssl" "pretty-env-logger" "pretty_env_logger" "vendored-openssl" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.37";
