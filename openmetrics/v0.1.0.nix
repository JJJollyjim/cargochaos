...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openmetrics/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "openmetrics" = rec {
        crateName = "openmetrics";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "openmetrics"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Ian Pringle <ipringle2@liberty.edu>"
        ];
        dependencies = [
          {
            name = "pest";
