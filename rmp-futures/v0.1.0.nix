...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rmp-futures/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "default" "executor" "futures-executor" "read-initializer" "std" "unstable" ];
      };
      "futures-channel" = rec {
      ...
      "futures-io" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "read-initializer" "std" "unstable" ];
      };
      "futures-macro" = rec {
      ...
      "futures-util" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "async-await-macro" "channel" "futures-channel" "futures-io" "futures-macro" "futures-sink" "io" "memchr" "proc-macro-hack" "proc-macro-nested" "read-initializer" "sink" "slab" "std" "unstable" ];
      };
      "hermit-abi" = rec {
      ...
      "rmp-futures" = rec {
        ...
        resolvedDefaultFeatures = [ "read-initializer" ];
      };
      "rmpv" = rec {
        crateName = "rmpv";
        version = "0.4.4";
