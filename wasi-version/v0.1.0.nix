...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasi-version/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasi-version" = rec {
        crateName = "wasi-version";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "wasi-version"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "wasm-interface";
            packageId = "wasm-interface";
          }
        ];
        
      };
      "wasm-interface" = rec {
        crateName = "wasm-interface";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0h3by09g9wad5ppsq3hj43w6w9025a3gpi7acdchhl1k2al46nih";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "validation" "wasmparser" ];
      };
      "wasmparser" = rec {
