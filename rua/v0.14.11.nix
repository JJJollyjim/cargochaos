...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rua/v0.14.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "raur" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "0y5y888vmp3m92fn0yysd401k8ysdrhki7yaixqr9n7w468i6bpw";
        authors = [
      ...
      "rua" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.14.11.nix {};
        authors = [
