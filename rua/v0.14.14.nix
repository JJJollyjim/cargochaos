...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rua/v0.14.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alpm" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0fip86aing2dgwl5q1q6av7srggbcp3ih5qy64smyqfizgg5wlf2";
        authors = [
      ...
      "alpm-sys-fork" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "1w9m9xsfgb6drx65jimnspvmi452kkv6cg67mbmilhkzvbs93yrb";
        authors = [
          "morganamilo <morganamilo@gmail.com>"
        ];
        features = {
      ...
      "rua" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.14.14.nix {};
        authors = [
      ...
      "stacker" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "0js0axz5nla1mkr2dm2vrv9rj964ng1lrv4l43sqlnfgawplhygv";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
