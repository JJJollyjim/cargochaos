...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rua/v0.14.16.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rm_rf" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "01ywxmm2y46yivy8mk65g0jgkml1qrzx7dx9ib1bisvwi73fy266";
        authors = [
      ...
      "rua" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.14.16.nix {};
        authors = [
