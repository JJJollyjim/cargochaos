...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rua/v0.14.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alpm" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1lyzahwbky37x0slyfw4nr1fp9niwvcrsaj6qjqm0la1mix370is";
        authors = [
      ...
      "rua" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.14.15.nix {};
        authors = [
      ...
      "tokio-rustls" = rec {
        ...
        version = "0.10.1";
        edition = "2015";
        sha256 = "19ziv3433cxzys8pxa4rwcnj2znnlkclfslrz9x1mgryv92csg3y";
        authors = [
