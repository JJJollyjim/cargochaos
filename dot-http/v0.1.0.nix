...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dot-http/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "Boa" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1s9xr9izl1hyyn0nsa2g6r70rrf1b9rl8fscmx608snnc25n0qqk";
        libName = "boa";
        libPath = "src/lib/lib.rs";type = [ "cdylib" "lib" ];
        authors = [
          "Jason Williams <jase.williams@gmail.com>"
        ];
        dependencies = [
          {
            name = "gc";
      ...
      "dot-http" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dot-http"; path = "src/main.rs"; }
        ];
      ...
      "gc" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "04mmxgmhjkqcns71z6z5k800hwvylr1f91dn6c63v2r4xh06hrbm";
        authors = [
      ...
      "gc_derive" = rec {
        ...
        version = "0.3.2";
        edition = "2015";
        sha256 = "19hf9qv5bj3irpk7z4ypc4qr6alqa59shyk12hi0r2pjp9fc2095";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
      ...
      "http-test-server" = rec {
        crateName = "http-test-server";
        version = "1.0.0";
        edition = "2015";
        sha256 = "1373i61crx34nx0r1wdh18bxr27fmczih5v13lchb0536yaqr8jv";
        authors = [
          "Vinicius Gerevini <viniciusgerevini@gmail.com>"
        ];
