...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/photo-captioner/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive" = rec {
        ...
        version = "0.11.2";
        edition = "2018";
        sha256 = "1501frzcvk9h5p1cj12267jm07mbznv5zvnmqsbv3wwq9hmbpvy4";
        authors = [
      ...
      "photo-captioner" = rec {
        crateName = "photo-captioner";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "photo-captioner"; path = "src/main.rs"; }
        ];
