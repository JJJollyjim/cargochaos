...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mender_artifact/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mender_artifact" = rec {
        crateName = "mender_artifact";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "mender_artifact"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Ole Petter <olepor@matnat.uio.no>"
        ];
        dependencies = [
          {
            name = "flate2";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winnls" "winnt" "winuser" ];
      };
