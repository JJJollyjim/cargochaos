...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/credstash/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusoto_dynamodb" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "1lzhpcqvfifj9safq3d2b2s2m9mnhb073vcy9r8s9flx9jzr4qb8";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "rusoto_kms" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "1fq2rbmnhz2h0527wkdindk5nyyspbm9jkwiv5y0ymnah5f76z0n";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
