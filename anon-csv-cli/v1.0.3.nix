...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/anon-csv-cli/v1.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "anon-csv-cli" = rec {
        crateName = "anon-csv-cli";
        version = "1.0.3";
        edition = "2018";
        crateBin = [
          { name = "anon-csv"; path = "src/main.rs"; }
        ];
      ...
      "fake" = rec {
        ...
        version = "1.3.0";
        edition = "2015";
        sha256 = "0lag47b6c6yw1z3zr5zdf15w8m7p1gx2ilm7pilns8db80mr7rdp";
        authors = [
