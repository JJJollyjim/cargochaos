...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dkregistry/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dkregistry" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "mockito" "reqwest-default-tls" "reqwest-rustls" "test-mock" "test-net" ];
      };
      "dtoa" = rec {
        crateName = "dtoa";
        version = "0.4.3";
      ...
      "libflate" = rec {
        ...
        version = "0.1.22";
        edition = "2015";
        sha256 = "0sknagxm084dsd6bkiga4cdpswdlgxgz7pfq20mfh31dnap888y5";
        authors = [
      ...
      "reqwest" = rec {
        ...
        version = "0.9.15";
        edition = "2015";
        sha256 = "0yvn2s9rajp2q9k3ghqzwm13k3k84dprkq112zvvqlrgca2ryfwl";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default-tls" "hyper-rustls" "hyper-tls" "native-tls" "rustls" "rustls-tls" "tls" "tokio-rustls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.14.6";
      ...
      "tar" = rec {
        ...
        version = "0.4.23";
        edition = "2018";
        sha256 = "0j8vw4lnxrbdi5q0d7ijfpjapk21ydip8icf787hc3fkid6qkkwa";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "tokio-rustls" = rec {
        ...
        version = "0.9.2";
        edition = "2015";
        sha256 = "17d95m4d42c2xik5xg1n9g9d0k8fnm2pdznrzmjvlsj0jg389n62";
        authors = [
