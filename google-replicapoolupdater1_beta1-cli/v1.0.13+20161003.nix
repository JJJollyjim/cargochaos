...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-replicapoolupdater1_beta1-cli/v1.0.13+20161003.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-replicapoolupdater1_beta1-cli";
  ...
  workspaceMembers = {
    "google-replicapoolupdater1_beta1-cli" = rec {
      packageId = "google-replicapoolupdater1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-replicapoolupdater1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-replicapoolupdater1_beta1" = rec {
        crateName = "google-replicapoolupdater1_beta1";
        version = "1.0.13+20161003";
        edition = "2015";
        sha256 = "0c7sfyjhv1aayd5k57ysjb3lcyjcdnvn2awc6s5c1wrgjq7lqr2c";
        authors = [
      ...
      "google-replicapoolupdater1_beta1-cli" = rec {
        crateName = "google-replicapoolupdater1_beta1-cli";
        version = "1.0.13+20161003";
        edition = "2015";
        crateBin = [
          { name = "replicapoolupdater1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20161003.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-replicapoolupdater1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
