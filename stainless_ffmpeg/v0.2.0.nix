...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stainless_ffmpeg/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stainless-ffmpeg-sys" = rec {
        crateName = "stainless-ffmpeg-sys";
        version = "4.2.2-update.1";
        edition = "2018";
        sha256 = "0ymj2f0m488csdjgnhfc6f7prk8zv636lsnlx03cyqcc4qnshxlx";
        authors = [
        ...
        resolvedDefaultFeatures = [ "avcodec" "avdevice" "avfilter" "avformat" "default" "swresample" "swscale" ];
      };
      "stainless_ffmpeg" = rec {
        crateName = "stainless_ffmpeg";
        version = "0.2.0";
        edition = "2018";
        ...
        dependencies = [
          ...
          {
            name = "stainless-ffmpeg-sys";
            packageId = "stainless-ffmpeg-sys";
          }
        ];
        devDependencies = [
          {
