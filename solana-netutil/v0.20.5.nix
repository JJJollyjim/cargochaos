...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-netutil/v0.20.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-netutil" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "solana-ip-address"; path = "src/bin/ip_address.rs"; }
          { name = "solana-ip-address-server"; path = "src/bin/ip_address_server.rs"; }
        ];
