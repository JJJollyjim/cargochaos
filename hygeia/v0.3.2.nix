...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hygeia/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hygeia" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "self-update" "self_update" ];
      };
      "hyper" = rec {
        crateName = "hyper";
        version = "0.13.1";
      ...
      "question" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "13gsclz5649g5cjd8h0ky9c1n020rzr3fikiksw8m6lggbg3xfxc";
        authors = [
      ...
      "rstest" = rec {
        ...
        version = "0.5.3";
        edition = "2018";
        sha256 = "0syrsk54jwzc5vzpy49asprrjahnziqqvbbbfz0mcscz27bdpfhi";
        procMacro = true;
        authors = [
