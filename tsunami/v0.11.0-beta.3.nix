...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tsunami/v0.11.0-beta.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusoto_ec2" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "0l30zs8wvipzkv42rx9nw0bf2ayvm4i76s7yvcwgzfpjiminc5hj";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "tsunami" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.11.0-beta.3.nix {};
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
