...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethcontract/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethcontract-common" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0fw1lzkzksnz1i42s37a75807gf35llgf2f9agdyygy033x3vg0k";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
      ...
      "ethcontract-derive" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1yww5z7il6x2m4c1khkjln688rxi0bwx4gnyimnbkarx11z7pcil";
        procMacro = true;
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
      ...
      "ethcontract-generate" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1rmw30m7j69bkbymqwx4jr4nc2in5cfzqrmny37kx7mkxsazxxir";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
