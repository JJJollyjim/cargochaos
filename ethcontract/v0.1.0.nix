...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethcontract/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethcontract" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "samples" ];
      };
      "ethcontract-common" = rec {
        crateName = "ethcontract-common";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1a4xx4lf84jjzfc5fvqxbp1jxxqglnvjz9kic13c1z4mlmk5y34g";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
      ...
      "ethcontract-derive" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "05s4njw78prw5islcxd0viwm0c87yf3a88p6v8ds9iylxz52fwr2";
        procMacro = true;
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
      ...
      "ethsign" = rec {
        ...
        version = "0.7.3";
        edition = "2018";
        sha256 = "0prnqd5771hmry6811h1hpqw09z9b69wcch500wipx2r1gxgwmmn";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "parity-crypto" "secp256k1" ];
      };
      "fake-simd" = rec {
        crateName = "fake-simd";
        version = "0.1.2";
      ...
      "parity-crypto" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "1fgh9g3vck5cmsgxfl5c11xxky3lck121cjf4dx72gf94nsw5a97";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "rlp" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "17zhnjm3j4kjiaf404hjapyzsqb3351bpgiv4rlkzdgb4pvs6xl3";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
