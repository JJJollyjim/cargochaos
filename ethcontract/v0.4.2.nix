...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethcontract/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethcontract-common" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "1lrsm23m3a8hmkvbcyll9mzdp4pcgpgp4lihjk07biawi7n81qm6";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
      ...
      "ethcontract-derive" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "0dx9iax0g887qf80dqnwb1iq2dx9xicqmjgddynisazyqbm3j5ad";
        procMacro = true;
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
      ...
      "ethcontract-generate" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "088c88lhhhx590fyvkrp1j6gdx9ch7655h1wg0bbmn3xf97p0w4f";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
