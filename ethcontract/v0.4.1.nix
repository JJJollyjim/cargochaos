...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethcontract/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethcontract-common" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "07mc9pfwvmqb8nxprb3qxm0g161ysaf8f9anjxydpa0pslc1phng";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
      ...
      "ethcontract-derive" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "11bmd31mw248nbxbjf3rhx98n59fzglqgvxq4da5rzfaplia5q4w";
        procMacro = true;
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
      ...
      "ethcontract-generate" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0r66w0k6dgfl75n62czaqycd5zxgpqhqbianxxjjapisknmbmhzp";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
