...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethcontract/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethcontract-common" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0yzwlgbrb36qq7m9w5q5snp18cmfjccs68cyd90999qjyd2rxk46";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
      ...
      "ethcontract-derive" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1kmq0p93ppbqpq7fin17mx3j7jf2wb9yw256f7jwgm0xr7blj9ag";
        procMacro = true;
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
      ...
      "ethcontract-generate" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "03wzrzbkm31dwnm58clznqbka6c1lymariys8ml7ak3by9bwdh25";
        authors = [
          "Nicholas Rodrigues Lordello <nlordell@gmail.com>"
        ];
        dependencies = [
