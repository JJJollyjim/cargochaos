...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/faster-rs/v0.10.0.nix.tmp"
    ...
    crates = {
      ...
      "faster-rs" = rec {
        ...
        authors = [
          ...
          "Matthew Brookes <mbrookes1304@gmail.com>"
        ];
        dependencies = [
          {
            name = "bincode";
      ...
      "libfaster-sys" = rec {
        crateName = "libfaster-sys";
        version = "0.10.0";
        edition = "2018";
        sha256 = "1sz9jykrz2sxa1l5j5ayz190kmyn1pmlmg8n8x9397i796sk3xs2";
        authors = [
          "Max Meldrum <mmeldrum@kth.se>"
          "Matthew Brookes <mbrookes1304@gmail.com>"
        ];
