...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/color-backtrace/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "color-backtrace" = rec {
        ...
        resolvedDefaultFeatures = [ "failure" "failure-bt" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "fileapi" "handleapi" "knownfolders" "memoryapi" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" ];
      };
