...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/magic-wormhole/v0.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "magic-wormhole" = rec {
        crateName = "magic-wormhole";
        version = "0.0.2";
        edition = "2018";
        crateBin = [
          { name = "wormhole"; path = "src/bin/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "bin" "clap" "default" "futures" "io-blocking" "io-tokio" "tokio-core" "url" "websocket" "ws" ];
      };
      "matches" = rec {
        crateName = "matches";
        version = "0.1.8";
      ...
      "spake2" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0vrg27421k0r9s1yczbq89h8dl8irvjzk7vz1l878r0jb08p4frn";
        authors = [
          "Brian Warner <warner@lothar.com>"
        ];
        dependencies = [
