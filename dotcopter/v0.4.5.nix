...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dotcopter/v0.4.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dotcopter" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dotcopter"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.5.nix {};
        authors = [
          "Patrick Haun <bomgar85@googlemail.com>"
        ];
        dependencies = [
          {
            name = "clap";
          ...
          }
          {
            name = "slog";
            packageId = "slog";
            features = [ "release_max_level_trace" "max_level_debug" ];
          }
          {
            name = "slog-async";
      ...
      "slog" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "max_level_debug" "release_max_level_trace" "std" ];
      };
      "slog-async" = rec {
