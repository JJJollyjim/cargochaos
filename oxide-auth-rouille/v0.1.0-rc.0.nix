...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oxide-auth-rouille/v0.1.0-rc.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oxide-auth" = rec {
        crateName = "oxide-auth";
        version = "0.5.0-preview.0";
        edition = "2015";
        sha256 = "1dgndmdj6rxs003cn35m8b0xapzia1v136qa9l9swbsl1qi3frhx";
        authors = [
      ...
      "oxide-auth-rouille" = rec {
        crateName = "oxide-auth-rouille";
        version = "0.1.0-rc.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-rc.0.nix {};
        authors = [
          "Andreas Molzer <andreas.molzer@gmx.de>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
