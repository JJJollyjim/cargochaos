...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fcm/v0.7.0-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fcm" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.0-alpha.3.nix {};
        authors = [
      ...
      "hyper-tls" = rec {
        ...
        edition = "2018";
        sha256 = "1xqg3l24dgyj914k0zd5kr6fl9akgz67v9068yb6h97phj4pa5vj";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
      ...
      "tokio-tls" = rec {
        ...
        version = "0.3.0-alpha.5";
        edition = "2018";
        sha256 = "04s8wnxxhi2ckq8zqm7mlf3dixl7szl5h9xy27r3sbprdrwzrnak";
        authors = [
          "Tokio Contributors <team@tokio.rs>"
        ];
        dependencies = [
