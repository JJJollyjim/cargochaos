...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hkdf/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "block-cipher-trait" = rec {
        ...
        version = "0.4.2";
        edition = "2015";
        sha256 = "10qmg8vphqmfllb9a2yx6s7r66jh1wh33clhsawq7ikg2wgz2p6q";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "crypto-tests" = rec {
        crateName = "crypto-tests";
        version = "0.5.5";
        edition = "2015";
        sha256 = "08yrh40a9ll4k29ppizg2yjf96i6s3i9pbkhxp60y8arar93134v";
        authors = [
