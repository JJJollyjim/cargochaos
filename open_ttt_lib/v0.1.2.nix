...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/open_ttt_lib/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "open_ttt_lib" = rec {
        crateName = "open_ttt_lib";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "James Richey <james.richey+open_ttt_lib@imaginaryphase.com>"
        ];
        dependencies = [
          {
            name = "doc-comment";
