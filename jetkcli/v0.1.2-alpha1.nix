...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jetkcli/v0.1.2-alpha1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jetkcli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "jet"; path = "src/bin/jet.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2-alpha1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "default" ];
      };
      "jobserver" = rec {
        crateName = "jobserver";
        version = "0.1.21";
      ...
      "moins" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "08dfff7qal61ddd9f6s19qlsq9lw1xhzzx1hld8a3daqlknyfr78";
        authors = [
          "Paul Delafosse <paul.delafosse@protonmail.com>"
        ];
        dependencies = [
