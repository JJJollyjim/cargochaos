...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scrub_log/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "argv" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0f5l2njcwqig2zfrvyb5fi2vzqr8ik3sxxmk57gp55b7gdbrsqp2";
        authors = [
      ...
      "gflags" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "08qa385gw2jmzj25zxh0p2bxa4i345ffjvgkp8ia4hc79fpk2wdj";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "gflags-impl" = rec {
        crateName = "gflags-impl";
        version = "0.3.2";
        edition = "2018";
        sha256 = "1vlykky1ij2rw8mdiqqn8niqsw9rlbfx4dgpzw8avabk47hq2cf2";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "ref-cast" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "1fcbpfb7xhr992qvyfg9hr5p63xqykjp48pm3f7a1q21vmhzksvv";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "ref-cast-impl" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "0av43xxjlinfqklb67rpj217cmaxfjsf8151gs0hbs4hnr5664ck";
        procMacro = true;
      ...
      "scrub_log" = rec {
        ...
        authors = [
          "Geoffrey Lalonde <lalondegeoffrey@gmail.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
