...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uniconize/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "uniconize" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "uniconize"; path = "src/main.rs"; }
        ];
      ...
      "x11rb" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0lymp10gy8aihi5l54p84018g4hrbh1bw4yvmpg4xn7dwv2x8vfa";
        authors = [
        ...
        resolvedDefaultFeatures = [ "vendor-xcb-proto" ];
      };
    };
