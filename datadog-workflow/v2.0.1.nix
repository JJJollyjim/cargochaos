...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/datadog-workflow/v2.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "datadog-workflow" = rec {
        crateName = "datadog-workflow";
        version = "2.0.1";
        edition = "2018";
        crateBin = [
          { name = "datadog-workflow"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v2.0.1.nix {};
        libName = "datadog_workflow_lib";
        authors = [
