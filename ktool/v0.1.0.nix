...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ktool/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ktool" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ktool"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "King-1025 <1543641386@qq.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "shell_command" = rec {
        crateName = "shell_command";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0w6msw4mqr26zz7cdc3zkn3i3b83knhq0j1p6a87ph3sgpdcjyqp";
        authors = [
          "Thomas BESSOU <thomas.bessou@hotmail.fr>"
        ];
        dependencies = [
          {
            name = "failure";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "libloaderapi" "lmcons" "minschannel" "minwindef" "schannel" "securitybaseapi" "sspi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
