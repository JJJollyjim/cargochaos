...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/awmp/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flate2" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "libc" "miniz-sys" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
