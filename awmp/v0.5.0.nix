...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/awmp/v0.5.0.nix.tmp"
    ...
    crates = {
      ...
      "actix-connect 0.2.3" = rec {
        ...
        dependencies = [
          ...
          {
            name = "actix-service";
            packageId = "actix-service 0.4.1";
          }
          {
            name = "actix-utils";
            packageId = "actix-utils 0.4.5";
          }
          {
            name = "derive_more";
      ...
      "actix-multipart 0.1.2" = rec {
        crateName = "actix-multipart";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0hq3xqpsbw0mlmmrnmsvr48z8ag5w4704bspnpn7cvah0r2chg5z";
      ...
      "actix-multipart 0.2.0" = rec {
        crateName = "actix-multipart";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0dnqy02b4wq3lssncm30dy014rqpzdcagyll7wssadrar9gr75s3";
        libName = "actix_multipart";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "awmp" = rec {
        ...
        dependencies = [
          {
            ...
            packageId = "actix-multipart 0.1.2";
            rename = "actix-multipart-v01";
            optional = true;
          }
          {
            name = "actix-multipart";
            packageId = "actix-multipart 0.2.0";
            rename = "actix-multipart-v02";
            optional = true;
          }
          {
            name = "actix-web";
        ...
        resolvedDefaultFeatures = [ "actix-multipart-v01" "actix-multipart-v02" "actix-web-v1" "actix-web-v2" "default" "futures-v01" "futures-v03" "v1" "v2" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.34";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
