...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lonsdaleite/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lonsdaleite" = rec {
        crateName = "lonsdaleite";
        version = "0.0.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Lonsdaleiter <lonsdaleiteproductions@gmail.com>"
        ];
        dependencies = [
          {
            name = "cocoa";
        ...
        resolvedDefaultFeatures = [ "default" "empty" "mtl" ];
      };
      "malloc_buf" = rec {
