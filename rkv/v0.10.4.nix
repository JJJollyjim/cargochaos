...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rkv/v0.10.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lmdb-rkv" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "with-asan" "with-fuzzer" "with-fuzzer-no-link" ];
      };
      "lmdb-rkv-sys" = rec {
      ...
      "rkv" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "default" "with-asan" "with-fuzzer" "with-fuzzer-no-link" ];
      };
      "rustc-demangle" = rec {
