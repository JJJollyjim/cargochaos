...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rkv/v0.10.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lmdb-rkv" = rec {
        ...
        version = "0.12.2";
        edition = "2015";
        sha256 = "0s690m22wfzyfsjb0dfap0z04f87v1ql42sknb3k70mzpkzj7614";
        libName = "lmdb";
        authors = [
      ...
      "lmdb-rkv-sys" = rec {
        ...
        version = "0.9.2";
        edition = "2015";
        sha256 = "18np9030yahgmycfmx5sla7vv839gjjw87snqj47ji8i2d9nws4s";
        libName = "lmdb_sys";
        authors = [
          "Dan Burkert <dan@danburkert.com>"
          "Victor Porof <vporof@mozilla.com>"
