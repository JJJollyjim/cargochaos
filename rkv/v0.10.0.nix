...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rkv/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lmdb-rkv" = rec {
        ...
        version = "0.12.1";
        edition = "2015";
        sha256 = "099kb50in66jip5v2mbq4glpl1l66bmk4hvn285648rij74mnzd5";
        libName = "lmdb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "with-asan" "with-clang" "with-fuzzer" "with-fuzzer-no-link" ];
      };
      "lmdb-rkv-sys" = rec {
        crateName = "lmdb-rkv-sys";
        version = "0.9.1";
        edition = "2015";
        sha256 = "12ix9aj8gdvd9ah1fkbhis4qyk6cdxsb11fyw50c5ki8aqnizk0w";
        libName = "lmdb_sys";
        authors = [
          "Dan Burkert <dan@danburkert.com>"
          "Victor Porof <vporof@mozilla.com>"
      ...
      "rkv" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rand"; path = "src/bin/rand.rs"; }
          { name = "dump"; path = "src/bin/dump.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "backtrace" "default" "with-asan" "with-clang" "with-fuzzer" "with-fuzzer-no-link" ];
      };
      "rustc-demangle" = rec {
