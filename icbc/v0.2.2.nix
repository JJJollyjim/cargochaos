...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/icbc/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "icb" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "1vap1sxbyahnql3m6z9b4zcf607rf5klvk83hbmh9wlqjx6kdmwx";
        authors = [
          "Jasper Lievisse Adriaanse <j+rust@jasper.la>"
        ];
        dependencies = [
          {
