...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/djpass/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "djangohashers" = rec {
        ...
        version = "1.1.1";
        edition = "2018";
        sha256 = "1rcgmvhcmpig15mnsa8b7mv7dd9lrcs6fcr23f9dm0vcz8i41m2v";
        authors = [
        ...
        resolvedDefaultFeatures = [ "base64" "bcrypt" "cargon" "constant_time_eq" "default" "hmac" "md-5" "pbkdf2" "pwhash" "sha-1" "sha2" "with_argon2" "with_bcrypt" "with_legacy" "with_pbkdf2" ];
      };
      "djpass" = rec {
        crateName = "djpass";
        version = "1.0.1";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwindef" "ntsecapi" "processenv" "profileapi" "std" "winbase" "wincon" "winnt" ];
      };
