...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/self_update/v0.14.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "self_update" = rec {
        ...
        resolvedDefaultFeatures = [ "archive-tar" "archive-zip" "compression-flate2" "compression-zip-bzip2" "compression-zip-deflate" "default" "either" "flate2" "rustls" "tar" "zip" ];
      };
      "semver" = rec {
        crateName = "semver";
        version = "0.9.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
