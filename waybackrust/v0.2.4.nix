...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/waybackrust/v0.2.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "waybackrust" = rec {
        crateName = "waybackrust";
        version = "0.2.4";
        edition = "2018";
        crateBin = [
          { name = "waybackrust"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.4.nix {};
        authors = [
          "Neolex (Kevin Hascoet) <hascoet.kevin@neolex-security.fr>"
        ];
        dependencies = [
          {
            name = "ansi_term";
          ...
          }
          {
            name = "openssl";
            packageId = "openssl";
            target = { target, features }: (target."arch" == "x86_64-unknown-linux-musl");
            features = [ "vendored" ];
          }
          {
            name = "reqwest";
