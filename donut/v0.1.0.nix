...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/donut/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "donut" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "donut"; path = "src/bin/donut.rs"; }
          { name = "dns2bin"; path = "src/bin/dns2bin.rs"; }
          { name = "bin2dns"; path = "src/bin/bin2dns.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        libPath = "src/donut/lib.rs";
        authors = [
          "TSH Labs"
        ];
        dependencies = [
      ...
      "trust-dns-client" = rec {
        ...
        version = "0.18.1";
        edition = "2018";
        sha256 = "0xwjcxqw6ds326asa23bpfpw7v13ayg3hf4hmff3xl3lhzyd75lx";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
