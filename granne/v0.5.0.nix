...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/granne/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "granne" = rec {
        ...
        resolvedDefaultFeatures = [ "blas" "default" "rw_granne" "singlethreaded" ];
      };
      "hermit-abi" = rec {
      ...
      "madvise" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "11hv2qn3hsvy8d8nmqsxxvmwfh2jnf6429zir7738ascqg1pa7jf";
        authors = [
      ...
      "stream-vbyte" = rec {
        crateName = "stream-vbyte";
        version = "0.3.2";
        edition = "2015";
        sha256 = "19kjzrq87ysbsb0l1qfh4gxbbgszqwbhnq5ksfd11vvxwi2yikhl";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
