...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nvml-examples/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nvml-binding" = rec {
        crateName = "nvml-binding";
        version = "0.1.0";
        edition = "2018";
        sha256 = "14wkaygd992lnlpw3fr1r2k8n04n4jxy0pxvrjc1ical6zdbpxxf";
        authors = [
          "divinerapier <poriter.coco@gmail.com>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
      ...
      "nvml-examples" = rec {
        crateName = "nvml-examples";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "nvml-examples"; path = "src/main.rs"; }
        ];
      ...
      "nvml-rs" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0l62b16qylfqwjlgsf3jl7bh85x4gbfdp2wdiv0qvi5f5jp4vksw";
        authors = [
          "divinerapier <poriter.coco@gmail.com>"
        ];
        dependencies = [
