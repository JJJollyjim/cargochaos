...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/task-list/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "task-list" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "task-list"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.1.nix {};
        authors = [
          "ThePuzzlemaker <tpzker@thepuzzlemaker.info>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "winbase" "winerror" "winnt" "winreg" ];
      };
