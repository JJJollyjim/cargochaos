...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/digest-tool/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "digest-tool" = rec {
        crateName = "digest-tool";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "digest-tool"; path = "src/main.rs"; }
        ];
      ...
      "libsm" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1wnqh6af5w44jfyvx49f9md79h9w5q7am4hbp9b58p0v1mvz0f2m";
        authors = [
          "Nebula Moe <nebula_moe@outlook.com>"
          "Itachi <494521900@qq.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "rust_util" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "08n0q4bsf186v2ac817chn5zi6ms5c52yqhwijiaisglbkabkjax";
        authors = [
          "Hatter Jiang <jht5945@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
      ...
      "yasna" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "1frcd79rzi6dlly7lldjn2avnhfmj6yxrjsgvb2p1k2zbxdzyc9s";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bigint" "bit-vec" "bitvec" "default" "num" ];
      };
    };
