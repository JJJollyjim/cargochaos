...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gaea/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gaea" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "disable_test_deadline" "nightly" "std" "user_space" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.58";
      ...
      "std-logger" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "07knq6zs3w8r5jqn50clz3p2yi0kvvz77kgbr3xnkgh0n3rpnfmi";
        authors = [
          "Thomas de Zeeuw <thomasdezeeuw@gmail.com>"
        ];
        dependencies = [
