...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-minicov/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-minicov" = rec {
        crateName = "cargo-minicov";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-minicov"; path = "src/main.rs"; }
        ];
      ...
      "postcard" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0r41zmmh6yjb7p3q17hp1h02nynxmh2gbh4ls84ry2k4d8x0ifnj";
        authors = [
