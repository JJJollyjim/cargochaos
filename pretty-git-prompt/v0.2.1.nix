...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pretty-git-prompt/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pretty-git-prompt" = rec {
        crateName = "pretty-git-prompt";
        version = "0.2.1";
        edition = "2015";
        crateBin = [
          { name = "pretty-git-prompt"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Tomas Tomecek <tomas@tomecek.net>"
        ];
        dependencies = [
          {
            name = "clap";
