...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-fetcher/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-fetcher" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures" "gcs" "rusoto_core" "rusoto_s3" "s3" "s3_test" "tame-gcs" "tame-oauth" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.47";
      ...
      "rusoto_s3" = rec {
        ...
        version = "0.41.0";
        edition = "2018";
        sha256 = "1mqnqjslglr8mw5gnh833jqaa6ii6pmqkslv1jphr59hl3y41j5n";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "tame-gcs" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0v4lqa1zv147ydm206mkknb4nyj2xc3b5h1q8rv5w4ss0pn25wpd";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
      ...
      "tame-oauth" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0lm9fw0hj2vcpq7b99dqhcag1dsf8720zv99zwpksw0vada53ka5";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
      ...
      "thiserror" = rec {
        ...
        version = "1.0.5";
        edition = "2018";
        sha256 = "0928apqg4gnz7hnj9hv8x3bdag02znkbwnblcwg3nmvyfgzn5yzr";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "thiserror-impl" = rec {
        ...
        version = "1.0.5";
        edition = "2018";
        sha256 = "0z82r50z27ahwlmc9frq2lgcdbwldl1za9bakll59awal05rq1i4";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
