...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-fetcher/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tar" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1msazbis5rh6ss6082ma7wpvcjbcgh4qxivrbwplivy18pyw9y4b";
        authors = [
      ...
      "cargo-fetcher" = rec {
        crateName = "cargo-fetcher";
        version = "0.7.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-fetcher"; path = "src/cmds/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "gcs" "rusoto_core" "rusoto_s3" "s3" "s3_test" "tame-gcs" "tame-oauth" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "hyper-rustls" "rustls" "rustls-tls" "tokio-rustls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.11";
      ...
      "rusoto_s3" = rec {
        ...
        version = "0.43.0-beta.1";
        edition = "2018";
        sha256 = "0mny3cw0ph4wbf16l5fjdx65b8zbfh2xjxl00ypl9f298wfg13lj";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "tame-gcs" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "0g2hvdpn1nbjzgqb428qvaqxbfz1xgjp1vpwc4rwkvp4gcvyykrj";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "v1" ];
      };
      "tame-oauth" = rec {
        crateName = "tame-oauth";
        version = "0.4.2";
        edition = "2018";
        sha256 = "08an6jl2jzhxiym7jg4rp2ig0abn3pnp1xwv0yz4arjfsjwg49r3";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "gcp" "jwt" "ring" "url" ];
      };
      "tar" = rec {
        crateName = "tar";
        version = "0.4.26";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "num_cpus" "process" "rt-core" "rt-threaded" "rt-util" "signal" "signal-hook-registry" "slab" "sync" "tcp" "time" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "tracing-subscriber" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "02ddpl5nxbdhdkjkmls672d95w9hyzblppxhi68n9687mgszrfy6";
        authors = [
          "Eliza Weisman <eliza@buoyant.io>"
