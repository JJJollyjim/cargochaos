...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-graphviz/v0.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-graphviz" = rec {
        crateName = "mdbook-graphviz";
        version = "0.0.2";
        edition = "2018";
        crateBin = [
          { name = "mdbook-graphviz"; path = "src/main.rs"; }
        ];
