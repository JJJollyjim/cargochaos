...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xtra/v0.2.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xtra" = rec {
        ...
        authors = [
          "Restioson <restiosondev@gmail.com>"
        ];
        dependencies = [
          {
            name = "async-std";
        ...
        resolvedDefaultFeatures = [ "async-std" "tokio" "with-async_std-1" "with-tokio-0_2" ];
      };
    };
