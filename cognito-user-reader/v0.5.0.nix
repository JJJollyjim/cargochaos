...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cognito-user-reader/v0.5.0.nix.tmp"
    ...
    crates = {
      ...
      "cognito-user-reader" = rec {
        ...
        dependencies = [
          ...
          {
            name = "cognito_user_reader_lib";
            packageId = "cognito_user_reader_lib";
          }
          {
            name = "console";
            packageId = "console";
      ...
      "cognito_user_reader_lib" = rec {
        crateName = "cognito_user_reader_lib";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0yi4xq4xa47rwfhpcr56sf6chx0wykpwfxqvava930199d3vs290";
        authors = [
          "Roberto Huertas <roberto.huertas@outlook.com>"
        ];
        dependencies = [
