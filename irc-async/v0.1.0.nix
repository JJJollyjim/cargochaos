...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/irc-async/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "irc-async" = rec {
        ...
        authors = [
          "Michael Zhang <iptq@protonmail.com>"
        ];
        dependencies = [
          {
            name = "bytes";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "macros" "mio" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
