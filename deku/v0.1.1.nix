...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deku/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitvec" = rec {
        ...
        version = "0.17.3";
        edition = "2018";
        sha256 = "17drndwxzw6mhvih2ygmmznf62ggss7ml622m947nm2h8yazd8zy";
        authors = [
      ...
      "deku_derive" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0rprw3sjqnyak7idw8s7gaw81z3hh8cfxz9blqbc69iqic9l94g8";
        procMacro = true;
        authors = [
          "sharks <sharks@sharks>"
        ];
