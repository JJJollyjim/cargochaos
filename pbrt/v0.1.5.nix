...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pbrt/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pbrt" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pbrt"; path = "src/bin/pbrt.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.5.nix {};
        authors = [
          "Bill Thiede <rust@xinu.tv>"
        ];
        dependencies = [
          {
            name = "image";
        ...
        resolvedDefaultFeatures = [ "float-as-double" "sampled-spectrum" "uble" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.15.2";
