...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/annatar/v0.4.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "artano" = rec {
        ...
        version = "0.2.10";
        edition = "2018";
        sha256 = "0qp41yan3j5y49m2k6739xq16dvk3l5wb7pa6x7bs0f5lz2b2l5h";
        authors = [
          "J/A <archer884@gmail.com>"
        ];
        dependencies = [
      ...
      "imageproc" = rec {
        ...
        version = "0.20.0";
        edition = "2018";
        sha256 = "1lx3qdplmz75xqcmzx4cg8d45z40nh2hh4k3312y0rngrg1g6lj5";
        authors = [
          "theotherphil"
        ];
        dependencies = [
