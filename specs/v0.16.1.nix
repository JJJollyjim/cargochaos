...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/specs/v0.16.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "getrandom" = rec {
        ...
        resolvedDefaultFeatures = [ "std" "stdweb" "wasm-bindgen" ];
      };
      "hashbrown" = rec {
        crateName = "hashbrown";
        version = "0.7.0";
      ...
      "rand" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "getrandom" "getrandom_package" "libc" "std" "stdweb" "wasm-bindgen" ];
      };
      "rand_chacha" = rec {
      ...
      "specs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "parallel" "rayon" "serde" "shred-derive" "specs-derive" "stdweb" "storage-event-control" "uuid" "uuid_entity" "wasm-bindgen" ];
      };
      "specs-derive" = rec {
      ...
      "uuid" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rand" "serde" "std" "stdweb" "v4" "wasm-bindgen" ];
      };
      "version_check" = rec {
