...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scroll-ssg/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "scroll-ssg" = rec {
        crateName = "scroll-ssg";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "scroll-ssg"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "metin ur <metinur.1311@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "simple-server" = rec {
        crateName = "simple-server";
        version = "0.4.0";
        edition = "2015";
        sha256 = "0qappa47rq2dd33zay7z1qmy4g04fnc33ck4yzbnnhg3ngy28xml";
        authors = [
          "steveklabnik <steve@steveklabnik.com>"
          "ashleygwilliams <ashley666ashley@gmail.com>"
        ];
        dependencies = [
          {
            name = "http";
