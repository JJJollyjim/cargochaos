...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/random-show-themes/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "random-show-themes" = rec {
        crateName = "random-show-themes";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "random-show-themes"; path = "src/main.rs"; }
        ];
