...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vulkano_text/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vulkano-shaders" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "1bjp8cmkkpirjca29z3nl0p1pz5yjdixjg5ymb4k1fvhp9k3kqa4";
        procMacro = true;
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
          "The vulkano contributors"
