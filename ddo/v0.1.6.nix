...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ddo/v0.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "binary-heap-plus" = rec {
        crateName = "binary-heap-plus";
        version = "0.2.0";
        edition = "2015";
        sha256 = "14mfbj1fckn21h1ixc2miyd0ryhvmhm2mxy6wp1jlm4n2nhlfzk2";
        authors = [
          "SEKINE, Hideki <sekineh@me.com>"
        ];
        dependencies = [
          {
            name = "compare";
      ...
      "bitset-fixed" = rec {
        crateName = "bitset-fixed";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1zxbhml6prkxdndz3wyfglqwlzya80lvyhjdmvzk4p5sjs78dk58";
        authors = [
      ...
      "compare" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1lv84g7l04vc1g54z5sigz330xklhkljwl165vz7xi1fvga3608j";
        authors = [
      ...
      "ddo" = rec {
        ...
        authors = [
          "Xavier Gillard <xavier.gillard@uclouvain.be>"
        ];
        dependencies = [
          {
            name = "binary-heap-plus";
            packageId = "binary-heap-plus";
          }
          {
            name = "bitset-fixed";
            packageId = "bitset-fixed";
          }
          {
            name = "compare";
            packageId = "compare";
      ...
      "mock-it" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0xzgx5p82jfm4mcc4w7d5br60img02p7mpli73rbbkns7k73lk8l";
        authors = [
          "nathanielsimard <nathaniel.simard@outlook.com>"
        ];
