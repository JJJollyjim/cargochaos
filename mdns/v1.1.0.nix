...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdns/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "io-driver" "lazy_static" "macros" "mio" "rt-core" "slab" "stream" "time" "tokio-macros" "udp" ];
      };
      "tokio-macros" = rec {
