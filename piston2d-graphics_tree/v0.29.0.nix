...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/piston2d-graphics_tree/v0.29.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "piston2d-graphics_tree";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "piston2d-graphics_tree" = rec {
        crateName = "piston2d-graphics_tree";
        version = "0.29.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.29.0.nix {};
        libName = "graphics_tree";
        authors = [
          "Sven Nilsen <bvssvni@gmail.com>"
        ];
        dependencies = [
