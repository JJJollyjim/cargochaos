...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f1xx-hal/v0.5.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "m" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0xynpz2iv6rkbz8srf9rfwa26inx3a93mh2qvn9k8ipkzf7196ci";
        authors = [
          "Jorge Aparicio <japaricious@gmail.com>"
        ];
      ...
      "mfrc522" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1y4ykd0x2z3yk43aslax4gf2li606vbq26k8sn42k5flj39hxxrs";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
      ...
      "stm32-usbd" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "044pd8a426dgqlbny7zzvbnb51m1mh8wz3m0whn0snqvvwzsc3rn";
        authors = [
        ...
        resolvedDefaultFeatures = [ "ram_access_1x16" ];
      };
      "stm32f1" = rec {
        crateName = "stm32f1";
        version = "0.9.0";
        edition = "2018";
        sha256 = "0nh5fbgczhcykfgk4r546imgvss0f7f1p1h26ik926434f8n5ki2";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f100" "stm32f101" "stm32f103" ];
      };
      "stm32f1xx-hal" = rec {
        crateName = "stm32f1xx-hal";
        version = "0.5.3";
        edition = "2018";
        ...
        resolvedDefaultFeatures = [ "device-selected" "doc" "high" "medium" "rt" "stm32-usbd" "stm32f100" "stm32f101" "stm32f103" "xl" ];
      };
      "syn 0.15.44" = rec {
        crateName = "syn";
        version = "0.15.44";
