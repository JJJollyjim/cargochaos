...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eff/v0.0.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eff-attr" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "0hz9b6185dnqv3cgxwd7rr4mm2wi8gwkzz6sbyx8cf83q3746mf8";
        procMacro = true;
        authors = [
      ...
      "tracing" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "1060ph2ndd4rqha875pl35kw82r38rrnga0zmdz6jb8qfhk29xys";
        authors = [
          "Tokio Contributors <team@tokio.rs>"
        ];
        dependencies = [
