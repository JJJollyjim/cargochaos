...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/static_test/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "static_test" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "external_doc" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.5";
