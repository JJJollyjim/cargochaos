...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/decide/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cmd_lib" = rec {
        ...
        version = "0.7.8";
        edition = "2018";
        sha256 = "0x52v6068wdizxwvnck568wypfmwhbl4b5xmdf7yvd40fsmdfns7";
        authors = [
          "rust-shell-script <rust-shell-script@gmail.com>"
        ];
