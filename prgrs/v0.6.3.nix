...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/prgrs/v0.6.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "prgrs" = rec {
        ...
        authors = [
          "phil0x2e <ph-ketteni@t-online.de>"
        ];
        dependencies = [
          {
            name = "terminal_size";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "processenv" "winbase" "wincon" "winnt" ];
      };
