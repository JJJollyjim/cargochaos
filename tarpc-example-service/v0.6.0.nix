...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tarpc-example-service/v0.6.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "tarpc-example-service";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tarpc-example-service" = rec {
        crateName = "tarpc-example-service";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "std" "synchapi" "threadpoollegacyapiset" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
