...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/process-memory/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "process-memory" = rec {
        crateName = "process-memory";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Tommoa <tommoa256@gmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "memoryapi" "minwindef" "processthreadsapi" "tlhelp32" "winnt" ];
      };
