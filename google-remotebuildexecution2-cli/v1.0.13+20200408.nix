...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-remotebuildexecution2-cli/v1.0.13+20200408.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-remotebuildexecution2-cli";
  ...
  workspaceMembers = {
    "google-remotebuildexecution2-cli" = rec {
      packageId = "google-remotebuildexecution2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-remotebuildexecution2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-remotebuildexecution2" = rec {
        crateName = "google-remotebuildexecution2";
        version = "1.0.13+20200408";
        edition = "2015";
        sha256 = "1qpg2asidl5q1p085jn7qylpys0dm2jzyn23pr1mbys7gsbmnqnx";
        authors = [
      ...
      "google-remotebuildexecution2-cli" = rec {
        crateName = "google-remotebuildexecution2-cli";
        version = "1.0.13+20200408";
        edition = "2015";
        crateBin = [
          { name = "remotebuildexecution2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-remotebuildexecution2";
            packageId = "google-remotebuildexecution2";
          }
          {
            name = "hyper";
            packageId = "hyper";
