...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudscheduler1-cli/v1.0.12+20190617.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudscheduler1-cli";
  ...
  workspaceMembers = {
    "google-cloudscheduler1-cli" = rec {
      packageId = "google-cloudscheduler1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudscheduler1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudscheduler1" = rec {
        crateName = "google-cloudscheduler1";
        version = "1.0.12+20190617";
        edition = "2015";
        sha256 = "0bdi50dnz8bmb23hdj11ps5r9m6gs6g2ixv2nk5hkq0wwcd5g421";
        authors = [
      ...
      "google-cloudscheduler1-cli" = rec {
        crateName = "google-cloudscheduler1-cli";
        version = "1.0.12+20190617";
        edition = "2015";
        crateBin = [
          { name = "cloudscheduler1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudscheduler1";
          }
          {
            name = "hyper";
            packageId = "hyper";
