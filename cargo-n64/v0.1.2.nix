...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-n64/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-n64" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-n64"; path = "src/bin/cargo-n64.rs"; }
        ];
      ...
      "fatfs" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "0zcfwvrfa6s2gwghiclq5v25rmjw8gyf8pjaa1h4z5838ngdzlgn";
        authors = [
        ...
        resolvedDefaultFeatures = [ "alloc" "chrono" "default" "std" ];
      };
      "goblin" = rec {
        crateName = "goblin";
        version = "0.2.0";
        ...
        resolvedDefaultFeatures = [ "alloc" "elf32" "elf64" "endian_fd" "log" "std" ];
      };
      "hermit-abi" = rec {
