...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargx/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargx" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargx"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.6.nix {};
        authors = [
          "Vincenzo Tilotta <tailot@gmail.com>"
        ];
        dependencies = [
          {
            name = "yamlette";
      ...
      "skimmer" = rec {
        ...
        version = "0.0.2";
        edition = "2015";
        sha256 = "066p6xpbdqmikbadnxvjsj02bx59zccqlhzpapkn9r4gj0gzb659";
        authors = [
          "dnsl48 <dnsl48@gmail.com>"
        ];
      ...
      "yamlette" = rec {
        ...
        version = "0.0.8";
        edition = "2015";
        sha256 = "14hyp02rrdiyxqirm400rsssjhrcjs55n3i2md52vf7dxfzi70vf";
        authors = [
          "dnsl48 <dnsl48@gmail.com>"
        ];
        dependencies = [
        ...
        features = {
          "onetest" = [ "test_reader" "test_savant" "test_sage" "test_book" "test_orchestra" "test_face" ];
        };
      };
    };
