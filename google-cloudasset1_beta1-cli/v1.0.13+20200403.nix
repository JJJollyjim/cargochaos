...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudasset1_beta1-cli/v1.0.13+20200403.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudasset1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "0ddmhchmnfw6kbmidip8pcpbkfvpifnl3q16z2388ah8792g0lpn";
        authors = [
      ...
      "google-cloudasset1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200403.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
