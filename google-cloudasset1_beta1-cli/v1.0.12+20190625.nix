...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudasset1_beta1-cli/v1.0.12+20190625.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudasset1_beta1-cli";
  ...
  workspaceMembers = {
    "google-cloudasset1_beta1-cli" = rec {
      packageId = "google-cloudasset1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudasset1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudasset1_beta1" = rec {
        crateName = "google-cloudasset1_beta1";
        version = "1.0.12+20190625";
        edition = "2015";
        sha256 = "18wgya2i7syx9zin6ak4famg7gkcibyp7c2y4l50iyfbh0w7w5fm";
        authors = [
      ...
      "google-cloudasset1_beta1-cli" = rec {
        crateName = "google-cloudasset1_beta1-cli";
        version = "1.0.12+20190625";
        edition = "2015";
        crateBin = [
          { name = "cloudasset1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-cloudasset1_beta1";
            packageId = "google-cloudasset1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
