...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-whoknows/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-whoknows" = rec {
        crateName = "git-whoknows";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "git-whoknows"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Jayson Messenger <jayson.messenger@gmail.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
