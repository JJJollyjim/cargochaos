...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "uuid" ];
      };
      "async-graphql-derive" = rec {
        crateName = "async-graphql-derive";
        version = "0.10.0";
        edition = "2018";
        sha256 = "0804ilfvprdsqk1l7w5153dp4d830vz76rcyp9c193if2hllqs7m";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
