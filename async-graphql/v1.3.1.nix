...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-graphql/v1.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        version = "1.3.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.3.1.nix {};
        authors = [
      ...
      "async-graphql-derive" = rec {
        ...
        version = "1.3.1";
        edition = "2018";
        sha256 = "05qpi47lb5a8p4fqs78ljxpya6c06hg4f9rjiqdnsy7mkg1r4ida";
        procMacro = true;
        authors = [
          "sunli <scott_s829@163.com>"
        ];
