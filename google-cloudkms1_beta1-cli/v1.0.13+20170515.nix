...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudkms1_beta1-cli/v1.0.13+20170515.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudkms1_beta1" = rec {
        ...
        version = "1.0.13+20170515";
        edition = "2015";
        sha256 = "1kl7k4v25q1s7wdppccajvi0z3yzhh80jjwad0fsgvfvys35z3y7";
        authors = [
      ...
      "google-cloudkms1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20170515.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
