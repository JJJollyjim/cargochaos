...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudkms1_beta1-cli/v1.0.12+20170515.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudkms1_beta1-cli";
  ...
  workspaceMembers = {
    "google-cloudkms1_beta1-cli" = rec {
      packageId = "google-cloudkms1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudkms1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudkms1_beta1" = rec {
        crateName = "google-cloudkms1_beta1";
        version = "1.0.12+20170515";
        edition = "2015";
        sha256 = "0ambl9xxj4jw5bnw2rhdzn8plhm9ncc7jgssi5wk9by9jhsf7w1s";
        authors = [
      ...
      "google-cloudkms1_beta1-cli" = rec {
        crateName = "google-cloudkms1_beta1-cli";
        version = "1.0.12+20170515";
        edition = "2015";
        crateBin = [
          { name = "cloudkms1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20170515.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-cloudkms1_beta1";
            packageId = "google-cloudkms1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
