...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/json_typegen_cli/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        version = "2.19.3";
        edition = "2015";
        sha256 = "0x13cjfiilvh8lxg6rkicdx5ajz0c0r3c50pfcyc357ww0zqzdwm";
        authors = [
        ...
        resolvedDefaultFeatures = [ "ansi_term" "color" "default" "libc" "strsim" "suggestions" "term_size" "wrap_help" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
      ...
      "json_typegen_cli" = rec {
        crateName = "json_typegen_cli";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "json_typegen"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Erik Vesteraas <erik@vestera.as>"
        ];
        dependencies = [
          {
            name = "clap";
          ...
          }
          {
            ...
            packageId = "json_typegen_shared";
          }
        ];
        
      };
      "json_typegen_shared" = rec {
        crateName = "json_typegen_shared";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1m3i5g643i2li3v8ks70zd67n11rvy49b88r6j8x4akfx37wiqd9";
        authors = [
          "Erik Vesteraas <erik@vestera.as>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "local-samples" "remote-samples" "reqwest" ];
      };
      "kernel32-sys" = rec {
      ...
      "term_size" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "06mj1zjidq9rjlm7l29phni6f7yhxqfclsr7fd8dgzrzbfnc3dh7";
        authors = [
          "Kevin K. <kbknapp@gmail.com>"
