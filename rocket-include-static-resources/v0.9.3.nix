...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-include-static-resources/v0.9.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crc-any" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "0dnc1qapr64g6ig5hwqbbdq9gd5szzdnf9kw62sa3gzx8xfgzlqn";
        authors = [
      ...
      "rc-u8-reader" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "0qfzyrjqsq6h8g1g1slxsfgf25p75wzsx45dxpxm35vilnafdazq";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        features = {
      ...
      "ring" = rec {
        ...
        version = "0.13.2";
        edition = "2015";
        sha256 = "1w0jw3f0cfx8mgxy3h8msjs7hqg53sfrk8y4g26h780vvnwl5rnv";
        authors = [
      ...
      "rocket-etag-if-none-match" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "12x4hgaq5m9jrixzn25hbj0nnby7m92d4s95dhq3r8wwaybi9fd3";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
