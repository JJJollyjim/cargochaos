...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fake_serialize/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "fake_serialize" = rec {
        ...
        resolvedDefaultFeatures = [ "defaults" "json" "serde_json" ];
      };
      "itoa" = rec {
        crateName = "itoa";
        version = "0.4.4";
