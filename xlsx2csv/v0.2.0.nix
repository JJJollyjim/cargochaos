...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xlsx2csv/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "calamine" = rec {
        ...
        version = "0.15.5";
        edition = "2015";
        sha256 = "09lp8j5svg44xxnnvqay69gdrpn88f58pv294yvabmfcf54bffmz";
        authors = [
      ...
      "xlsx2csv" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "xlsx2csv"; path = "src/main.rs"; }
        ];
