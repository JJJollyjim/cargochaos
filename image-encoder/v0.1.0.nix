...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/image-encoder/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "scrap" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0v0jr62igmy13iz137xy644dmqnivc5zws779nq6b3dxngjybwq4";
        authors = [
