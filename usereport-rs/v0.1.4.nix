...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/usereport-rs/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "usereport-rs" = rec {
        crateName = "usereport-rs";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "usereport"; path = "src/bin/usereport.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "atty" "bin" "env_logger" "exitfailure" "failure" "human-panic" "indicatif" "prettytable-rs" "structopt" ];
      };
      "uuid" = rec {
        crateName = "uuid";
        version = "0.6.5";
