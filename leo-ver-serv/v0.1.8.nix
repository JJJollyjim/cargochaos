...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/leo-ver-serv/v0.1.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fossil-delta" = rec {
        crateName = "fossil-delta";
        version = "0.1.6";
        edition = "2018";
        sha256 = "13q7540x908xr6dl62yjazzir8m1jkxy2xy6byqw2i017ngaagyn";
        authors = [
          "vitalije <vitalije@kviziracija.net>"
        ];
      ...
      "leo-ver-serv" = rec {
        crateName = "leo-ver-serv";
        version = "0.1.8";
        edition = "2018";
        crateBin = [
          { name = "leo-ver-serv"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
