...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ublox-core/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shufflebuf" = rec {
        crateName = "shufflebuf";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1aq2ay8j83rdqnafyaqslqcqa78l67j3g58s83gmz2yh3awks1l4";
        authors = [
      ...
      "stm32h7" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "stm32h743" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
