...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-diesel/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "bitflags" "default" "postgres" "pq-sys" "r2d2" "uuidv07" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "clone-impls" "default" "derive" "fold" "full" "parsing" "printing" "proc-macro" "quote" "visit-mut" ];
      };
      "tokio" = rec {
        crateName = "tokio";
        version = "0.2.4";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "profileapi" "std" "synchapi" "threadpoollegacyapiset" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
