...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chttp/v0.5.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "auto_enums" = rec {
        ...
        version = "0.5.8";
        edition = "2018";
        sha256 = "1przgngyxvqwbnsmywxzx64qr3hsbsr9wz0n463k6v21ps44dhvl";
        authors = [
      ...
      "auto_enums_core" = rec {
        ...
        version = "0.5.8";
        edition = "2018";
        sha256 = "1l8r2gc7p40w7gxl99llm5dxhg9d24l383w0vggmhcsws2l9q6az";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "auto_enums_derive" = rec {
        ...
        version = "0.5.8";
        edition = "2018";
        sha256 = "1mg48a69i1ny61v27hsdq6zm5djw58abfjwwwp9v74wi87cbml6g";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "chttp" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "cookies" "default" "http2" "middleware-api" "psl" "static-curl" ];
      };
      ...
      "derive_utils" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "173xzaixf50pavng9n7rjdv1h418awj70s2is0appy6aqa774lc0";
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
        dependencies = [
      ...
      "sluice" = rec {
        ...
        edition = "2018";
        sha256 = "1vhr88wfd4adz0rzarcsfcaqlikxnpyqll99jn4s6g1vlhjm9jzs";
        authors = [
          "Stephen M. Coakley <me@stephencoakley.com>"
        ];
        dependencies = [
