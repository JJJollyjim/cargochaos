...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/revent/v0.28.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "isize-vec" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "091y4z1llh2vhx40p9if3f295d5lk252fy2p5lx2rld5qdjsw11a";
        authors = [
          "Kevin Robert Stravers <macocio@gmail.com>"
        ];
      ...
      "revent" = rec {
        ...
        version = "0.28.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.28.1.nix {};
        authors = [
          "Kevin Robert Stravers <macocio@gmail.com>"
        ];
        dependencies = [
