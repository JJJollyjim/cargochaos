...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-runtimeconfig1_beta1-cli/v1.0.12+20190624.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-runtimeconfig1_beta1-cli";
  ...
  workspaceMembers = {
    "google-runtimeconfig1_beta1-cli" = rec {
      packageId = "google-runtimeconfig1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-runtimeconfig1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-runtimeconfig1_beta1" = rec {
        crateName = "google-runtimeconfig1_beta1";
        version = "1.0.12+20190624";
        edition = "2015";
        sha256 = "0i77ds8kxdjrcalgdf7sl39rsl2krwx7hxx229iw7cmkahm6xlla";
        authors = [
      ...
      "google-runtimeconfig1_beta1-cli" = rec {
        crateName = "google-runtimeconfig1_beta1-cli";
        version = "1.0.12+20190624";
        edition = "2015";
        crateBin = [
          { name = "runtimeconfig1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-runtimeconfig1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
