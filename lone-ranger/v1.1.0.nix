...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lone-ranger/v1.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lone-ranger" = rec {
        crateName = "lone-ranger";
        version = "1.1.0";
        edition = "2018";
        crateBin = [
          { name = "ranger"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "json" "gzip" "brotli" "rustls-tls" "socks" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "brotli" "gzip" "hyper-rustls" "json" "rustls" "rustls-tls" "serde_json" "socks" "tokio-rustls" "tokio-socks" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.12";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
