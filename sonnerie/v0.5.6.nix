...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sonnerie/v0.5.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "escape_string" = rec {
        crateName = "escape_string";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1rhva3wmvnab6fnmg1myw84dx73i5pszqhxdij0vj0flisx5f3cm";
        authors = [
          "Charles Samuels <kalle@eventures.vc>"
      ...
      "lines_from_request" = rec {
        crateName = "lines_from_request";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0qqgpl45qkxinlaa5ap8jd2qnw6y255vx2rr4fq5z988i25pr0g4";
        authors = [
          "Charles Samuels <kalle@eventures.vc>"
        ];
        dependencies = [
      ...
      "min-max-heap" = rec {
        crateName = "min-max-heap";
        version = "1.3.0";
        edition = "2018";
        sha256 = "060bwpg7zw65yjfvyfklqwyd0hgk5rgx37yghj98xx00kk7yd1r6";
        authors = [
      ...
      "shardio" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1ba5w93f3mdq29lr78kvk49kzn00hzjwz43d283khq3blsvzqj4c";
        authors = [
      ...
      "sonnerie" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "sonnerie"; path = "src/main.rs"; }
          { name = "sonnerie-serve"; path = "src/bin/sonnerie-serve.rs"; }
        ];
        ...
        features = {
          ...
          "sonnerie-serve" = [ "clap" "url" "hyper" "tokio" "futures" "lines_from_request" "serde" "serde_derive" "shardio" ];
        };
        resolvedDefaultFeatures = [ "bin" "clap" "default" "futures" "hyper" "lines_from_request" "serde" "serde_derive" "shardio" "sonnerie-serve" "tokio" "url" ];
      };
      "strsim" = rec {
        crateName = "strsim";
        version = "0.8.0";
