...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v1.0.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-connect" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "http" "openssl" "rust-tls" "rustls" "ssl" "tokio-openssl" "tokio-rustls" "uri" "webpki" ];
      };
      "actix-http" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-rust" "flate2-zlib" "openssl" "ring" "rust-tls" "rustls" "secure-cookies" "ssl" "webpki-roots" ];
      };
      "actix-http-test" = rec {
        crateName = "actix-http-test";
        version = "0.2.5";
        edition = "2018";
        sha256 = "0m1ghgllf7ws5wk51x8phcdjq21phylawmvp7wb29zd1d0aw2aac";
      ...
      "actix-server" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "mio-uds" "openssl" "rust-tls" "rustls" "ssl" "tokio-openssl" "tokio-rustls" "tokio-uds" "uds" "webpki" "webpki-roots" ];
      };
      "actix-server-config" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rust-tls" "rustls" "ssl" "tokio-openssl" "tokio-rustls" "tokio-uds" "uds" ];
      };
      "actix-service" = rec {
      ...
      "actix-web" = rec {
        ...
        version = "1.0.9";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.9.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-rust" "flate2-zlib" "openssl" "rust-tls" "rustls" "secure-cookies" "ssl" "uds" ];
      };
      ...
      "awc" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "default" "flate2-zlib" "openssl" "rust-tls" "rustls" "ssl" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
