...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v2.0.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        edition = "2018";
        sha256 = "1hghfg5a185rw2xdhjcjs5q535kqjir4pz9jgml8i0044qhp9i55";
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-http-test" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "0d06x2h0ny4qblia2kldq0dkpdir1d5p7mpksdqg41ydzgnqdbiv";
      ...
      "actix-testing" = rec {
        ...
        version = "1.0.0-alpha.2";
        edition = "2018";
        sha256 = "0hq060n2vc54l26ryh0adhnbxylkhl8sfar2dni7fxavx0q7374z";
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-alpha.2.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "secure-cookies" ];
      };
      ...
      "awc" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "04aqh40vf660h5q56mwhvys8wark9vdzs8ibslh0iy68c9xrb8zx";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
