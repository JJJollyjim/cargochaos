...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v2.0.0-alpha.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-alpha.4.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "awc" "client" "default" "fail" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "rust-tls" "rustls" "secure-cookies" ];
      };
      ...
      "awc" = rec {
        ...
        resolvedDefaultFeatures = [ "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "rust-tls" "rustls" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
