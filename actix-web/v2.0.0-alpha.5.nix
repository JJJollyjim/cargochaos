...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v2.0.0-alpha.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-alpha.5.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "awc" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1vmqha0s01kamkq5c2n73hy5ypcmfm4lj9ccz0a10qlp14h9k99v";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
