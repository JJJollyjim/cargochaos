...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v2.0.0-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        resolvedDefaultFeatures = [ "actix-tls" "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-rust" "flate2-zlib" "openssl" "ring" "rustls" "secure-cookies" ];
      };
      "actix-http-test" = rec {
      ...
      "actix-server" = rec {
        ...
        version = "1.0.0-alpha.3";
        edition = "2018";
        sha256 = "1swy7ixnwbd3hb1igbfqzxpy0zi3nvl6gy3mq7xqkx9pgk5385jk";
      ...
      "actix-service" = rec {
        ...
        version = "1.0.0-alpha.3";
        edition = "2018";
        sha256 = "0b3sww485g7arzrvs725xsb9zd133qvdjwpyzqmap0kxr7ah7s04";
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-alpha.3.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "rust-tls" "rustls" "secure-cookies" ];
      };
      ...
      "awc" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "default" "flate2-zlib" "open-ssl" "openssl" "rust-tls" "rustls" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
