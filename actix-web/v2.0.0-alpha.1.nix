...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v2.0.0-alpha.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-codec 0.2.0-alpha.1" = rec {
        crateName = "actix-codec";
        version = "0.2.0-alpha.1";
        edition = "2018";
        sha256 = "1xgn4pcd38ysc9wb2wr6k93hv1aajsg701f1qky7wljw1mj5bf7x";
        libName = "actix_codec";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-connect 0.3.0" = rec {
        crateName = "actix-connect";
        version = "0.3.0";
        edition = "2018";
        sha256 = "00rrymaqvcj6ls3igbikkv8hp6n3dbp889hq41vgfpbf4nsqygm1";
        ...
        dependencies = [
          ...
          {
            name = "actix-rt";
            packageId = "actix-rt 0.2.6";
          }
          {
            name = "actix-service";
            packageId = "actix-service 0.4.2";
          }
          {
            name = "actix-utils";
            packageId = "actix-utils 0.4.7";
          }
          {
            name = "derive_more";
      ...
      "actix-connect 1.0.0-alpha.1" = rec {
        crateName = "actix-connect";
        version = "1.0.0-alpha.1";
        edition = "2018";
        sha256 = "06a97kgyj25cg6zkl4fbgl4drzfyq0xcl6mzcmpzmxyxn9myssi7";
        libName = "actix_connect";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          {
            name = "actix-codec";
            packageId = "actix-codec 0.2.0-alpha.1";
          }
          {
            name = "actix-rt";
            packageId = "actix-rt 1.0.0-alpha.1";
          }
          {
            name = "actix-service";
            packageId = "actix-service 1.0.0-alpha.1";
          }
          {
            name = "actix-utils";
            packageId = "actix-utils 0.5.0-alpha1";
          }
          {
            name = "derive_more";
            packageId = "derive_more";
          ...
          {
            name = "trust-dns-resolver";
            packageId = "trust-dns-resolver 0.18.0-alpha.1";
            usesDefaultFeatures = false;
          }
        ];
        features = {
      ...
      "actix-http" = rec {
        ...
        edition = "2018";
        sha256 = "0kiga9marsr3kps6dwid4ympxjb9xznfv46g28lpag1p2rvch49y";
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "actix-connect";
            packageId = "actix-connect 1.0.0-alpha.1";
          }
          {
          ...
          }
          {
            ...
            packageId = "actix-threadpool 0.2.0";
          }
          {
            name = "actix-utils";
            packageId = "actix-utils 0.5.0-alpha1";
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "ring" "secure-cookies" "tokio-openssl" ];
      };
      "actix-http-test" = rec {
        crateName = "actix-http-test";
        version = "0.3.0-alpha.1";
        edition = "2018";
        sha256 = "1nqvniwb3n2f28j6jw92g7695b5hqs2wzhslxkvd7ximzxkbchj2";
      ...
      "actix-rt 0.2.6" = rec {
        ...
        dependencies = [
          {
            name = "actix-threadpool";
            packageId = "actix-threadpool 0.1.2";
          }
          {
            name = "copyless";
            packageId = "copyless";
      ...
      "actix-rt 1.0.0-alpha.1" = rec {
        crateName = "actix-rt";
        version = "1.0.0-alpha.1";
        edition = "2018";
        sha256 = "0vrnvhfq3iqjzzg3fjk2npvm8sb0gc62czhgc01cadv3sxaan2w4";
        libName = "actix_rt";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-server" = rec {
        ...
        edition = "2018";
        sha256 = "0n3571zz2bcgi1xyyvk3f7i84cljn6sf5wsnq65ing83jwjra58h";
      ...
      "actix-server-config" = rec {
        ...
        version = "0.3.0-alpha.1";
        edition = "2018";
        sha256 = "07x8580y7d8hp3mi7vxyjw7b7h47267xgsqq2hjnaqa3rrx23gf0";
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "tokio-openssl" ];
      };
      "actix-service 0.4.2" = rec {
      ...
      "actix-service 1.0.0-alpha.1" = rec {
        crateName = "actix-service";
        version = "1.0.0-alpha.1";
        edition = "2018";
        sha256 = "05i0jvbccah9c8vsgmff49i88i59v3vaknxdw5y8hnmzs10pcl2i";
        libName = "actix_service";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-testing" = rec {
        ...
        version = "0.3.0-alpha.1";
        edition = "2018";
        sha256 = "171yzryk8jizjg345q7ivvmz10cqb7gfswq442a1knc5lg8rqk85";
      ...
      "actix-threadpool 0.2.0" = rec {
        crateName = "actix-threadpool";
        version = "0.2.0";
        edition = "2018";
        sha256 = "10jj3aadwmrmm6q9bwj4lkmpcsadmfjyqn2zwln71jmz8bxyj159";
        libName = "actix_threadpool";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-utils 0.5.0-alpha1" = rec {
        crateName = "actix-utils";
        version = "0.5.0-alpha1";
        edition = "2018";
        sha256 = "1rs4skynnf2kx7qi8bs2ghs8xx1qn2d3q2ps1qpsp69r3bl4jvr5";
        libName = "actix_utils";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-alpha.1.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-rust" "flate2-zlib" "open-ssl" "openssl" "rust-tls" "secure-cookies" ];
      };
      "actix-web-codegen" = rec {
        crateName = "actix-web-codegen";
        version = "0.2.0-alpha.1";
        edition = "2018";
        sha256 = "053pvgdh85pbkgxhbhm7pjzbav7gjzzs53192zw7k33qlbsmhfi5";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "awc" = rec {
        ...
        version = "0.3.0-alpha.1";
        edition = "2018";
        sha256 = "06lrf3hcd4sydngcqa6wf0qn5jvivclxdx4vx5nxbkrixqr1074s";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "brotli" "default" "flate2-zlib" "open-ssl" "openssl" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
      ...
      "tokio-net" = rec {
        ...
        resolvedDefaultFeatures = [ "async-traits" "bytes" "futures-sink-preview" "iovec" "libc" "mio-uds" "signal" "signal-hook-registry" "tcp" "tracing" "udp" "uds" "winapi" ];
      };
      "tokio-openssl" = rec {
      ...
      "trust-dns-proto 0.18.0-alpha.1" = rec {
        crateName = "trust-dns-proto";
        version = "0.18.0-alpha.1";
        edition = "2018";
        sha256 = "0jfkbqxfxy56pw6w7hj7yfq9ra16hibpf9dwcl4pwxhqizmd97mx";
        ...
        resolvedDefaultFeatures = [ "default" "tokio-compat" "tokio-net" ];
      };
      ...
      "trust-dns-resolver 0.18.0-alpha.1" = rec {
        crateName = "trust-dns-resolver";
        version = "0.18.0-alpha.1";
        edition = "2018";
        sha256 = "12vafdb86fx8fydg27v8hdl88ddbjm0cgkr2gdb7ws5shwpv9h5i";
        libName = "trust_dns_resolver";
        authors = [
          "Benjamin Fry <benjaminfry@me.com>"
        ];
        dependencies = [
          ...
          {
            name = "trust-dns-proto";
            packageId = "trust-dns-proto 0.18.0-alpha.1";
          }
        ];
        features = {
          "default" = [ "tokio" ];
