...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web/v2.0.0-alpha.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "actix" = rec {
        ...
        edition = "2018";
        sha256 = "16l1p7fs6qhmq9l5dz49qb114wqdnlf282xlgqrivxbg3w6n6b8g";
        authors = [
      ...
      "actix-web" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-alpha.6.nix {};
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
