...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/websocket/v0.24.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "websocket" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "async-ssl" "bytes" "default" "futures" "native-tls" "nightly" "sync" "sync-ssl" "tokio-codec" "tokio-io" "tokio-reactor" "tokio-tcp" "tokio-tls" ];
      };
      "websocket-base" = rec {
