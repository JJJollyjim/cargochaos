...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_zix/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_zix" = rec {
        crateName = "guessing_game_zix";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_zix"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Kyeongmin Cho <kyeongmin.cho@kaist.ac.kr>"
        ];
        dependencies = [
          {
            name = "rand";
