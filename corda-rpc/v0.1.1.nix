...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/corda-rpc/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oasis-amqp" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "05lmwb4vpzafqsxkc8cpnxa41mbjglb0d2lhd1iwxbh5jx3wqi1y";
        authors = [
          "Dirkjan Ochtman <dirkjan.ochtman@ing.com>"
        ];
        dependencies = [
      ...
      "oasis-amqp-macros" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0sks38nc2djk3ysivq1i0dsvmjsc1wcknn0rr1a9hw5pd0riwy4i";
        procMacro = true;
        authors = [
          "Dirkjan Ochtman <dirkjan.ochtman@ing.com>"
        ];
