...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/corda-rpc/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "corda-rpc" = rec {
        ...
        authors = [
          "Dirkjan Ochtman <dirkjan.ochtman@ing.com>"
        ];
        dependencies = [
          {
            name = "futures";
          ...
          {
            name = "oasis-amqp";
            packageId = "oasis-amqp";
          }
          {
            name = "oasis-amqp-macros";
            packageId = "oasis-amqp-macros";
          }
          {
            name = "rand";
            packageId = "rand";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "dns" "macros" "rt-threaded" "tcp" ];
          }
          {
            name = "tokio-util";
      ...
      "oasis-amqp" = rec {
        crateName = "oasis-amqp";
        version = "0.1.0";
        edition = "2018";
        sha256 = "01n5l66i8y5v7i84x05cllh72ff3mscxsllai0lfcfnynybpa8bq";
        authors = [
          "Dirkjan Ochtman <dirkjan.ochtman@ing.com>"
        ];
        dependencies = [
      ...
      "oasis-amqp-macros" = rec {
        crateName = "oasis-amqp-macros";
        version = "0.1.0";
        edition = "2018";
        sha256 = "18r853nbgbr9qdfik1llpgyyn81v6zwwpmhxx8i0pimzpqdwpkn0";
        procMacro = true;
        authors = [
          "Dirkjan Ochtman <dirkjan.ochtman@ing.com>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "futures-core" "io-driver" "iovec" "lazy_static" "macros" "mio" "num_cpus" "rt-core" "rt-threaded" "stream" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
