...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crates-io-cli/v3.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crates-index-diff" = rec {
        ...
        version = "6.2.0";
        edition = "2018";
        sha256 = "16ic3cy7cdx0vnpx0l8108dz5v3i7r81v4sx2gfx89dcx37lnmrb";
        authors = [
      ...
      "crates-io-cli" = rec {
        ...
        resolvedDefaultFeatures = [ "crates-index-diff" "criner-cli" "curl" "default" "futures" "list" "mine" "open" "parking_lot" "recent-changes" "search" "tokio-core" "tokio-curl" "urlencoding" "utility" ];
      };
      "crc32fast" = rec {
        crateName = "crc32fast";
        version = "1.2.0";
      ...
      "criner" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1qk9byri6cdarz26qdxq5b21amq73x0zpsajzxyk2kbw3pcx3gnv";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "prodash";
            usesDefaultFeatures = false;
            features = [ "tui-renderer" "log-renderer" ];
          }
          {
            name = "quick-error";
            packageId = "quick-error";
          ...
          }
          {
            name = "rusqlite";
            packageId = "rusqlite";
            features = [ "bundled" "unlock_notify" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "criner-cli" = rec {
        crateName = "criner-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "1kcz9zclyc4g53b9w4wa2hfvdi52q1d7dshn0x93gv52rgzy1cfd";
        authors = [
          "Sebastian Thiel <sebastian.thiel@icloud.com>"
        ];
        dependencies = [
      ...
      "git2" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "0s3wvbhsv3kf1ccinx4k0jslsb1gqz1bm3i1imz8z9v0fbr7xq16";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "horrorshow" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "1pzh0j45xvkdp77mnsb93smvbpq43c1h4jxh6mkqb71x28r7cldd";
        authors = [
      ...
      "libgit2-sys" = rec {
        ...
        edition = "2018";
        sha256 = "1krfj4d8zksns1mn0xp9df797piqccb6525ikw17lf9x6mci8pad";
        libName = "libgit2_sys";
        libPath = "lib.rs";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
      ...
      "libsqlite3-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "bundled" "cc" "default" "min_sqlite_version_3_6_8" "pkg-config" "unlock_notify" "vcpkg" ];
      };
      "libssh2-sys" = rec {
      ...
      "prodash" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "05n2q2s5jqscsz3w9j075rrp89qfaqdnjviw4kwazxsz51fv4yvq";
        authors = [
          "Sebastian Thiel <sebastian.thiel@icloud.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "futures" "futures-timer" "humantime" "log" "log-renderer" "termion" "tui" "tui-react" "tui-renderer" "unicode-segmentation" "unicode-width" ];
      };
      "quick-error" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "default" "default-tls" "gzip" "hyper-tls" "native-tls-crate" "tokio-tls" ];
      };
      "rle-decode-fast" = rec {
      ...
      "rusqlite" = rec {
        ...
        resolvedDefaultFeatures = [ "bundled" "unlock_notify" ];
      };
      "rust-argon2" = rec {
      ...
      "tokio 0.2.13" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" ];
      };
      "tokio-codec" = rec {
      ...
      "tui-react" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1dand12z7riifyjrapazgwg7vc50xh65i2wp7a1hxhvwz0r6fw09";
        authors = [
