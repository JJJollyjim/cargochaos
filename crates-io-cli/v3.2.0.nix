...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crates-io-cli/v3.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crates-index-diff" = rec {
        ...
        version = "7.0.1";
        edition = "2018";
        sha256 = "03zhv97ha0n1jimfxr3lcsmm93rfmml4rjj6pczka4dvnn8b4srf";
        authors = [
      ...
      "crates-io-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v3.2.0.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
      ...
      "criner" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1pndnajig7amad4k5r0ld4hhcb9j7nspyz0psc01r7drlz95cqy9";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "prodash";
            usesDefaultFeatures = false;
            features = [ "tui-renderer" "log-renderer" "localtime" ];
          }
          {
            name = "quick-error";
            packageId = "quick-error";
      ...
      "criner-cli" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1ccr4diiqy6vz2fangrbp3iy1j387vr49cqwq2llw9k4kb89brlm";
        authors = [
          "Sebastian Thiel <sebastian.thiel@icloud.com>"
        ];
        dependencies = [
      ...
      "dia-semver" = rec {
        crateName = "dia-semver";
        version = "8.0.1";
        edition = "2015";
        sha256 = "1pqngg7114rv190ydsx4w4j1qkcrzl9kwrd01f1g9qr75h8387mw";
        authors = [
      ...
      "flume" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "default" "futures" "select" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "libsqlite3-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "bundled" "bundled_bindings" "cc" "default" "min_sqlite_version_3_6_8" "pkg-config" "unlock_notify" "vcpkg" ];
      };
      "libz-sys" = rec {
        crateName = "libz-sys";
        version = "1.0.25";
      ...
      "prodash" = rec {
        ...
        version = "3.6.1";
        edition = "2018";
        sha256 = "0v18vzvf0nl8s6ix5x4gam8w84p1gs9w3dhll3gmvw2b04yi6fsp";
        authors = [
          "Sebastian Thiel <sebastian.thiel@icloud.com>"
        ];
        dependencies = [
        ...
        features = {
          "default" = [ "tui-renderer" "log-renderer" "localtime" ];
          "localtime" = [ "time" ];
          "log-renderer" = [ "log" ];
          "tui-renderer" = [ "tui" "tui-react" "termion" "futures-timer" "futures" "unicode-segmentation" "unicode-width" "humantime" ];
        };
        resolvedDefaultFeatures = [ "futures" "futures-timer" "humantime" "localtime" "log" "log-renderer" "termion" "time" "tui" "tui-react" "tui-renderer" "unicode-segmentation" "unicode-width" ];
      };
      "quick-error" = rec {
      ...
      "tokio 0.2.17" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" ];
      };
      "tokio-codec" = rec {
      ...
      "tui-react" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0y2l2yy1hkqkspfbdgvv6y6h4r2l6zg65mbkdvh1svd4iki5di0n";
        authors = [
