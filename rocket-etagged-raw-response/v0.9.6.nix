...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-etagged-raw-response/v0.9.6.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rocket-etagged-raw-response";
  ...
  workspaceMembers = {
    "rocket-etagged-raw-response" = rec {
      packageId = "rocket-etagged-raw-response";
      build = internal.buildRustCrateWithFeatures {
        packageId = "rocket-etagged-raw-response";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket-etagged-raw-response" = rec {
        crateName = "rocket-etagged-raw-response";
        version = "0.9.6";
        edition = "2018";
