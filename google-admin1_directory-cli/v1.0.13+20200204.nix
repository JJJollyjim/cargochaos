...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-admin1_directory-cli/v1.0.13+20200204.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-admin1_directory" = rec {
        ...
        edition = "2015";
        sha256 = "0hpljck4j8pkwqa7jijc0ld53fg13vk1a4k3dp1j8cdy5843q2ck";
        authors = [
      ...
      "google-admin1_directory-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200204.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
