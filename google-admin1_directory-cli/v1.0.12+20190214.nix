...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-admin1_directory-cli/v1.0.12+20190214.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-admin1_directory-cli";
  ...
  workspaceMembers = {
    "google-admin1_directory-cli" = rec {
      packageId = "google-admin1_directory-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-admin1_directory-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-admin1_directory" = rec {
        crateName = "google-admin1_directory";
        version = "1.0.12+20190214";
        edition = "2015";
        sha256 = "1mazxrgh31psxq2lf9ywb93x9cx5d3232zvlwh7hl66lrkvm3v6w";
        authors = [
      ...
      "google-admin1_directory-cli" = rec {
        crateName = "google-admin1_directory-cli";
        version = "1.0.12+20190214";
        edition = "2015";
        crateBin = [
          { name = "admin1-directory"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190214.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-admin1_directory";
          }
          {
            name = "hyper";
            packageId = "hyper";
