...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lindera-ipadic-builder/v0.3.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lindera-ipadic-builder";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lindera-ipadic-builder" = rec {
        crateName = "lindera-ipadic-builder";
        version = "0.3.2";
        edition = "2018";
        crateBin = [
          { name = "lindera-ipadic"; path = "src/main.rs"; }
        ];
