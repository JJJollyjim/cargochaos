...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-testing1-cli/v1.0.13+20200408.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-testing1" = rec {
        crateName = "google-testing1";
        version = "1.0.13+20200408";
        edition = "2015";
        sha256 = "1zfa1qd7dr7g7rlf6hbnvfim3chlr052va3651lbkqdhbchkgil0";
        authors = [
      ...
      "google-testing1-cli" = rec {
        crateName = "google-testing1-cli";
        version = "1.0.13+20200408";
        edition = "2015";
        crateBin = [
          { name = "testing1"; path = "src/main.rs"; }
        ];
