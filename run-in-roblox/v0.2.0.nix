...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/run-in-roblox/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rbx_binary" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "079jkjh6gmai1pvqg6bn3gwfqzj6ds40l61ikjngx8q73998qhl1";
        authors = [
      ...
      "rbx_dom_weak" = rec {
        ...
        version = "1.9.0";
        edition = "2018";
        sha256 = "1i0fmkrm0w185yz92ilipihyxbx6szsn31iab0cbv5h0hpz7k05v";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
      ...
      "rbx_reflection" = rec {
        ...
        version = "3.2.395";
        edition = "2018";
        sha256 = "15vrr9k4ixawnksh1p0nsjbvihd0drmvk71mfhbrz7n2x763rd73";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
      ...
      "rbx_xml" = rec {
        ...
        version = "0.11.1";
        edition = "2018";
        sha256 = "11l1xggbkrgdw84lzalmbd550fqsi9l6nvd91cnciq6lpfy7z0qv";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
      ...
      "run-in-roblox" = rec {
        crateName = "run-in-roblox";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "run-in-roblox"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "run_in_roblox";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
