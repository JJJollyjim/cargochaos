...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cord-client/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cord-client" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cord-client"; path = "src/bin/cord-client.rs"; }
        ];
      ...
      "cord-message" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "11jzvf979ppx7lr902yyl0m68dv3pblk3d0aqcyj9p6ii7nyvyh2";
        authors = [
          "Cord Contributors"
        ];
        dependencies = [
      ...
      "futures-locks-pre" = rec {
        crateName = "futures-locks-pre";
        version = "0.5.1-pre";
        edition = "2018";
        sha256 = "14y1nhzq6ivh5vn6nvrx0iyhl507xmibbl5n6nji7kcsnaibci4w";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "tokio" "tokio_" ];
      };
      "futures-macro" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "stream" "sync" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
