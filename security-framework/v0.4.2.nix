...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/security-framework/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "security-framework" = rec {
        ...
        resolvedDefaultFeatures = [ "OSX_10_10" "OSX_10_11" "OSX_10_12" "OSX_10_13" "OSX_10_9" "alpn" "nightly" "session-tickets" ];
      };
