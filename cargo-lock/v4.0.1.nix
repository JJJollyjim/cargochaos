...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-lock/v4.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-lock" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-lock"; path = "src/bin/cargo-lock/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "cli" "default" "dependency-tree" "gumdrop" "petgraph" ];
      };
      "fixedbitset" = rec {
