...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cbor-diag-cli/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cbor-diag" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "1di8fidcza7jkvrqavsqb2dabzv3iba09cj0lir5fmjwjpc35yig";
        authors = [
          "Wim Looman <wim@nemo157.com>"
        ];
        dependencies = [
      ...
      "chrono" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "clock" "default" "std" "time" ];
      };
      "clap" = rec {
        crateName = "clap";
        version = "2.33.0";
