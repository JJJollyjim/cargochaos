...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cbor-diag-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cbor-diag" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "17qjigvisp6acn7irnfzgcm4ivddb4g9lylcrq6c342b0n9k2vpw";
        authors = [
          "Wim Looman <wim@nemo157.com>"
        ];
        dependencies = [
      ...
      "cbor-diag-cli" = rec {
        crateName = "cbor-diag-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cbor-diag"; path = "src/main.rs"; }
        ];
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" ];
      };
      "ctor" = rec {
        crateName = "ctor";
        version = "0.1.10";
      ...
      "paw-attributes" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1sasafgblzl87629qlr1arwdfv6qpbqhvyf056snxf16lrlw34fp";
        procMacro = true;
        authors = [
      ...
      "structopt" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "paw" ];
      };
