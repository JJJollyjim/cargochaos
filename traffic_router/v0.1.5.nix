...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/traffic_router/v0.1.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-reverse-proxy" = rec {
        crateName = "hyper-reverse-proxy";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1s1c962hc4zm8s0p8ysz3wvv08995am76jpw2kchac614k31jks7";
        authors = [
      ...
      "traffic_router" = rec {
        crateName = "traffic_router";
        version = "0.1.5";
        edition = "2018";
        crateBin = [
          { name = "traffic_router"; path = "src/main.rs"; }
        ];
