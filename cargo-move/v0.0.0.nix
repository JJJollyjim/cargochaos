...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-move/v0.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-move" = rec {
        crateName = "cargo-move";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-move"; path = "src/bin/cargo-move/main.rs"; }
        ];
