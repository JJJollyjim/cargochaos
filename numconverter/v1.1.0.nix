...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/numconverter/v1.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "numconverter" = rec {
        crateName = "numconverter";
        version = "1.1.0";
        edition = "2018";
        crateBin = [
          { name = "numconverter"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.0.nix {};
        authors = [
          "Zach Nielsen <zach@zachn.me>"
        ];
        dependencies = [
          {
            name = "clipboard";
        ...
        resolvedDefaultFeatures = [ "fail-on-warnings" ];
      };
      "objc" = rec {
        crateName = "objc";
        version = "0.2.6";
