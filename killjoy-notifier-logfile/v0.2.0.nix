...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/killjoy-notifier-logfile/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "killjoy-notifier-logfile";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "killjoy-notifier-logfile" = rec {
        crateName = "killjoy-notifier-logfile";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "killjoy-notifier-logfile"; path = "src/main.rs"; }
        ];
