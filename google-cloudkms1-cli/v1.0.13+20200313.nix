...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudkms1-cli/v1.0.13+20200313.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudkms1" = rec {
        ...
        edition = "2015";
        sha256 = "0y1alzd7805lf1b3d0bvclzas2nsy7cydkqwn5j0wjk9fg0gw2zf";
        authors = [
      ...
      "google-cloudkms1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200313.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
