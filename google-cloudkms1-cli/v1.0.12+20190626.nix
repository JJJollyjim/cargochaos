...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudkms1-cli/v1.0.12+20190626.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudkms1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudkms1-cli" = rec {
        crateName = "google-cloudkms1-cli";
        version = "1.0.12+20190626";
        edition = "2015";
        crateBin = [
          { name = "cloudkms1"; path = "src/main.rs"; }
        ];
