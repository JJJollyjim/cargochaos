...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mack/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "taglib" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "04r0mm35nr9pjjk27c59ysx8bgjbas5ag7j5xpzfyva2gvrmx7xq";
        authors = [
      ...
      "taglib-sys" = rec {
        crateName = "taglib-sys";
        version = "1.0.0";
        edition = "2015";
        sha256 = "0kia1mlg7jvdx3b43fynsvjr58g3x3w4qs8nxb6fiw83lqifl84y";
        libName = "taglib_sys";
        authors = [
          "Emmanuele Bassi <ebassi@gnome.org>"
          "Chris Down <chris@chrisdown.name>"
