...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bitsign/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitsign" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "secp256k1";
            packageId = "secp256k1";
            features = [ "recovery" "endomorphism" ];
          }
          {
            name = "structopt";
            packageId = "structopt";
      ...
      "secp256k1" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "endomorphism" "rand" "recovery" "std" ];
      };
      "serde" = rec {
        crateName = "serde";
        version = "1.0.101";
