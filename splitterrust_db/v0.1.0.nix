...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/splitterrust_db/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "splitterrust_db" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "read_spell"; path = "src/bin/read_spell.rs"; }
          { name = "populate_spells"; path = "src/bin/populate_spells.rs"; }
        ];
