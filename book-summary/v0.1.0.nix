...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/book-summary/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "book-summary" = rec {
        crateName = "book-summary";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "book-summary"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Vogt, Dimitrij <divogt@dima23.de>"
        ];
        dependencies = [
          {
            name = "serde_json";
      ...
      "titlecase" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1j0naf5784bfiqc4vy6q31y1ya884v78p1yc3ilyjq8wfsd3jl06";
        authors = [
