...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/weresocool/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "watch" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1kdj7v6h9bs3z659vav84a7g51y8sw7chscpjr759iw1k58bqgk5";
        authors = [
          "snnsnn <sinan38tr@gmail.com>"
        ];
      ...
      "weresocool" = rec {
        crateName = "weresocool";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "wsc"; path = "bin/wsc.rs"; }
          { name = "stems"; path = "bin/stems.rs"; }
          { name = "real_time"; path = "bin/real_time.rs"; }
          { name = "scratch"; path = "bin/pad.rs"; }
      ...
      "weresocool_parser" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0qvlapz35k4hlzyldns2yykgxmc877il23b46sn4hs1nbxrz8ffv";
        authors = [
          "Danny Meyer <Danny.Meyer@gmail.com>"
        ];
        dependencies = [
