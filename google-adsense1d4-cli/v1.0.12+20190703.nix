...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adsense1d4-cli/v1.0.12+20190703.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-adsense1d4-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adsense1d4" = rec {
        crateName = "google-adsense1d4";
        version = "1.0.12+20190703";
        edition = "2015";
        sha256 = "159610vwx6b8ira4sf8nqg1ksa4diaqfwyqsv9nissxl62gsz5kc";
        authors = [
      ...
      "google-adsense1d4-cli" = rec {
        crateName = "google-adsense1d4-cli";
        version = "1.0.12+20190703";
        edition = "2015";
        crateBin = [
          { name = "adsense1d4"; path = "src/main.rs"; }
        ];
