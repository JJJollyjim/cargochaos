...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xladd-derive/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "debugapi" "libloaderapi" "winuser" ];
      };
      ...
      "xladd" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1wqgyga7f26awndrg5dc5ig766ggiprdksv5x5sdiz20dg5s8j5s";
        authors = [
          "Marcus Rainbow"
        ];
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "winuser" "libloaderapi" "debugapi" ];
          }
        ];
        
      };
      "xladd-derive" = rec {
        crateName = "xladd-derive";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        procMacro = true;
        authors = [
          "Ronnie Chowdhury <Ronnie.c995@gmail.com>"
        ];
        dependencies = [
          {
            name = "proc-macro2";
