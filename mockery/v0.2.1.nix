...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mockery/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fake" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "http" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "rayon-hash" = rec {
        crateName = "rayon-hash";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1qprl1ybzyyqgcypinhw1x0l9gv8q5l3qlb77g1s03ph2mskgm4m";
        authors = [
          "Josh Stone <cuviper@gmail.com>"
        ];
        dependencies = [
