...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actyxos_sdk/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actyxos_sdk" = rec {
        ...
        features = {
          "client" = [ "reqwest" "url" "futures" "bytes" ];
          "dataflow" = [ "abomonation" "abomonation_derive" ];
        };
        resolvedDefaultFeatures = [ "abomonation" "abomonation_derive" "bytes" "client" "dataflow" "futures" "reqwest" "url" ];
      };
      "adler32" = rec {
        crateName = "adler32";
        version = "1.0.4";
      ...
      "fixed" = rec {
        ...
        version = "0.5.5";
        edition = "2018";
        sha256 = "0n5dq8dsb8vf5gp5j0jifvscvkrrsvm9ysap41azwlingn38sk37";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "default" "default-tls" "gzip" "hyper-tls" "json" "native-tls-crate" "serde_json" "stream" "tokio-tls" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.3";
