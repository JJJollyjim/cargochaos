...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/servant-log/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ring-channel" = rec {
        crateName = "ring-channel";
        version = "0.7.0";
        edition = "2018";
        sha256 = "0dfmalhkciqns4xs2d3a2ckm81l7whbjfia9qxbhdzaar1wg7s3w";
        authors = [
          "Bruno Dutra <brunocodutra@gmail.com>"
        ];
        dependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "default" "futures-preview" "futures_api" ];
      };
      "servant-log" = rec {
        crateName = "servant-log";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "automan.yang <automanyang@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
