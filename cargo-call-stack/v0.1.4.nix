...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-call-stack/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-call-stack" = rec {
        crateName = "cargo-call-stack";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "cargo-call-stack"; path = "src/main.rs"; }
        ];
      ...
      "stack-sizes" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "18ps08bszrdll68wyan2xgsljlfc2pw2vagzvk57fz0ji1r3gvng";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
