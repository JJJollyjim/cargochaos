...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustomword/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustomword" = rec {
        crateName = "rustomword";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "rustomword"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "hbina085 <hanif.ariffin.4326@gmail.com>"
        ];
        dependencies = [
          {
            name = "actix-rt";
