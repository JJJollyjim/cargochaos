...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pingkeeper/v3.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pingkeeper" = rec {
        crateName = "pingkeeper";
        version = "3.2.0";
        edition = "2018";
        crateBin = [
          { name = "pingkeeper"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v3.2.0.nix {};
        authors = [
          "Ignacio Lago <ignacio@ignaciolago.com>"
        ];
        dependencies = [
          {
            name = "nix";
      ...
      "pipeliner" = rec {
        ...
        version = "1.0.1";
        edition = "2015";
        sha256 = "0xpym8m88zkfcjbsncf6pqx4p0zsysm734rc8d1i1c4rnignak2g";
        authors = [
          "Cody Casterline <cody.casterline@gmail.com>"
        ];
        dependencies = [
          {
