...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sky-color-wallpaper/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "geodate" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0kh88pjgx4g6zbl1rgd14hflnfk8p7xaabb2b64r870887b01gkz";
        authors = [
      ...
      "sky-color-wallpaper" = rec {
        crateName = "sky-color-wallpaper";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "sky-color-wallpaper"; path = "src/main.rs"; }
        ];
      ...
      "wallpaper" = rec {
        ...
        version = "2.0.1";
        edition = "2015";
        sha256 = "1gvncv1vs2sc22klamhx65bnkmw57hhwv7jdp7w9wgv23i6nqqcy";
        authors = [
          "reujab <reujab@gmail.com>"
        ];
        dependencies = [
