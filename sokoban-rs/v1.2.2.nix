...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sokoban-rs/v1.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sdl2" = rec {
        ...
        resolvedDefaultFeatures = [ "image" "ttf" ];
      };
      "sdl2-sys" = rec {
        crateName = "sdl2-sys";
        version = "0.32.6";
      ...
      "sokoban-rs" = rec {
        crateName = "sokoban-rs";
        version = "1.2.2";
        edition = "2015";
        crateBin = [
          { name = "sokoban-rs"; path = "src/main.rs"; }
        ];
