...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.48.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.48";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.48.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.33";
        edition = "2018";
        sha256 = "1xm6q992i31a5fm02di9qjv052ygh410v5bdlgd6c6ijmsgzq62g";
        authors = [
