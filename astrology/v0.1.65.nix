...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.65.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.65";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.65.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.52";
        edition = "2018";
        sha256 = "1dx2hygyix32g1lr566nqpr5yi22gnapixsbmhzdnbx35y934ss6";
        authors = [
