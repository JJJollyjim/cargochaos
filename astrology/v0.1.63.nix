...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.63.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.63";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.63.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.50";
        edition = "2018";
        sha256 = "1v8csjv09q2k8azi9ysigrb6lxzynay2xvixlm571v6d5pd1y9mg";
        authors = [
