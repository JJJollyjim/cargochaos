...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.67.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.67";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.67.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.54";
        edition = "2018";
        sha256 = "134yvgp8va25gir165ffqr302nl4slyzx602fck3pwzb0zz765js";
        authors = [
