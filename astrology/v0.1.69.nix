...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.69.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.69";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.69.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.55";
        edition = "2018";
        sha256 = "0id1qw4iimyi6vwpzja612rb81zpcikl949kh29lc9k0xqpvb89h";
        authors = [
