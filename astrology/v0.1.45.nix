...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.45.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.45";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.45.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.29";
        edition = "2018";
        sha256 = "1mbrwhpn581mkhjc3ac3z2ghkvc0b45dlry94zn1xsjg69ps18hp";
        authors = [
