...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.43.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.43";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.43.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.24";
        edition = "2018";
        sha256 = "0y8db0kahih933fgli9kjsrd0x93sdbmd04g5xz923mb8w5n6bg1";
        authors = [
