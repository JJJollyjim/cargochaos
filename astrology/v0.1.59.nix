...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.59.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.59";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.59.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.48";
        edition = "2018";
        sha256 = "0fzxw0q0jr7c756szzj9zw7nn4369iwhldpn55sksfwm0vlvvdhl";
        authors = [
