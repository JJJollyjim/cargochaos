...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.37.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.37";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.37.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.18";
        edition = "2018";
        sha256 = "0rh8dv0jfbfb7an74zfk7f2sfajg1syyzh9lxv3q9vjj3jcy58pz";
        authors = [
