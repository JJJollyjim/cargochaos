...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.55.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.55";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.55.nix {};
        authors = [
      ...
      "ferris-says" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "17b189cy9rdn21xccw8ij14z4rnfjcc1klmqgrpi9navlii9ly8n";
        libName = "ferris_says";
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.43";
        edition = "2018";
        sha256 = "1nd2hvrpfp8zdm58y7s658a8m41v6hbl7c8l9sfn6qnm457zmm7v";
        authors = [
