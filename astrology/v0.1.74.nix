...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.74.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.74";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.74.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.57";
        edition = "2018";
        sha256 = "1awq02jrppsmjiw71d9xcxf11x26kndlmngj0zqj8jr1wywqmg29";
        authors = [
