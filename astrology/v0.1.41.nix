...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.41.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.41";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.41.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.22";
        edition = "2018";
        sha256 = "1j8vvf908a1crpqnnc4i3k2r96v19dcvrvbqs5chpsijp922dsvw";
        authors = [
