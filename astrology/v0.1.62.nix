...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.62.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.62";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.62.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.49";
        edition = "2018";
        sha256 = "0ridippkwirj5s3b4ivsxcb65zn3fgi0q3lap4hj0j9q3r9a0qmh";
        authors = [
