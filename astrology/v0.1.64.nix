...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.64.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "astrology" = rec {
        ...
        version = "0.1.64";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.64.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.51";
        edition = "2018";
        sha256 = "0c5i1xp91ikr2s0vmyrk1g2n0x4dmzvw7jp330cyxhsgxr9dl3r0";
        authors = [
