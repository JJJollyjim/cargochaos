...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.53.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.53";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.53.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.37";
        edition = "2018";
        sha256 = "018q6hf15a7rwhfyckpmqcnww38bh47b64q0ykcm20yix70inaiq";
        authors = [
