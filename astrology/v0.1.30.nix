...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.30.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.30";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.30.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.13";
        edition = "2018";
        sha256 = "08gy5qjflz5v3k87w9h9hp5pb53hn409l2nj5wxzzkn7fn2ris94";
        authors = [
