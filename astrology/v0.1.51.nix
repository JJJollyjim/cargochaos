...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.51.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.51";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.51.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.34";
        edition = "2018";
        sha256 = "1l4xiv4fwlqqm8dxa1v3a7wchy06ymmy22n1g054ki7vg96bd3jc";
        authors = [
