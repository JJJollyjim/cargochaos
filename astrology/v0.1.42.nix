...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.42.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.42";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.42.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.23";
        edition = "2018";
        sha256 = "1767viikxiwc1b2havpb4424yiy9hy6xfkr7kjpw2ljyh8yl4f59";
        authors = [
