...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/astrology/v0.1.44.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "astrology" = rec {
        ...
        version = "0.1.44";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.44.nix {};
        authors = [
      ...
      "libswe-sys" = rec {
        ...
        version = "0.1.26";
        edition = "2018";
        sha256 = "00y0fli5l568lfp82y901xh4f6m48szfvzasznqym9dm6n4ninhq";
        authors = [
