...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-deploymentmanager2-cli/v1.0.13+20181207.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-deploymentmanager2" = rec {
        ...
        edition = "2015";
        sha256 = "113dig7vf4rf9993pxlnn5n7m9s8lr8j98fzl0i6256daw2f6ryy";
        authors = [
      ...
      "google-deploymentmanager2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20181207.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
