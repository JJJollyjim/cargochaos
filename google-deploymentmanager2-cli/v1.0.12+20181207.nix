...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-deploymentmanager2-cli/v1.0.12+20181207.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-deploymentmanager2-cli";
  ...
  workspaceMembers = {
    "google-deploymentmanager2-cli" = rec {
      packageId = "google-deploymentmanager2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-deploymentmanager2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-deploymentmanager2" = rec {
        crateName = "google-deploymentmanager2";
        version = "1.0.12+20181207";
        edition = "2015";
        sha256 = "0c0awqnb3irk0nfgqrmvi9in8yhzjs39940v95ddcyy7xrpbfll1";
        authors = [
      ...
      "google-deploymentmanager2-cli" = rec {
        crateName = "google-deploymentmanager2-cli";
        version = "1.0.12+20181207";
        edition = "2015";
        crateBin = [
          { name = "deploymentmanager2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20181207.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-deploymentmanager2";
          }
          {
            name = "hyper";
            packageId = "hyper";
