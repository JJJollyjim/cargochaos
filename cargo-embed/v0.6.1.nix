...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-embed/v0.6.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-embed" = rec {
        crateName = "cargo-embed";
        version = "0.6.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-embed"; path = "src/main.rs"; }
        ];
      ...
      "gdb-server" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "034hpdsdfmqmd2symhy1hx4y8l4qwrvc5k517dj31lskd8rls557";
      ...
      "probe-rs" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1a0qh20sgj9a4rw6265w7h4dhns61m35izgac4znja3zhmg3whmn";
        authors = [
          "Noah Hüsser <yatekii@yatekii.ch>"
          "Dominik Boehi <dominik.boehi@gmail.ch>"
        ];
      ...
      "probe-rs-rtt" = rec {
        crateName = "probe-rs-rtt";
        version = "0.1.0";
        edition = "2018";
        sha256 = "07d09hsik0zj1c79nr1bbwi0a0rnzrb4g36kf8va9giyap4l6g42";
        authors = [
