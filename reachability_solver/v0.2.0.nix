...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reachability_solver/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linear_solver" = rec {
        crateName = "linear_solver";
        version = "0.2.2";
        edition = "2018";
        sha256 = "18kscc0h7mjb3m6llzrhqrpx7457s2gacmkdl1bykn0vr99549bc";
        authors = [
