...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/poetry-book-cli/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "poetry-book" = rec {
        crateName = "poetry-book";
        version = "0.1.3";
        edition = "2018";
        sha256 = "0bj8yjb5kfsmxy7k2gr7xn5kp7zv0b1k95sj5w7crawwm5vzlkai";
        authors = [
          "MarcoIeni"
        ];
      ...
      "poetry-book-cli" = rec {
        crateName = "poetry-book-cli";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "poetry-book-cli"; path = "src/main.rs"; }
        ];
