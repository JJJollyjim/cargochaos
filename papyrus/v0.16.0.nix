...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/papyrus/v0.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kserd" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0zf9p6vkhzfazn0dnbfdjkmc2bqspvxshzh3pmdwrma9y8ng5l3j";
        authors = [
          "kurt <kurtlawrence92@gmail.com>"
        ];
        dependencies = [
      ...
      "racer" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0hiylb0xx15r99y9h5sz98bbg1zki084l96hg46hxwkxdxljncjl";
