...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bitcoincash/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitcoincash" = rec {
        crateName = "bitcoincash";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "bitcoincash"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Gabriel Cardona <cgcardona@gmail.com>"
        ];
        dependencies = [
          {
            name = "bech32";
        ...
        resolvedDefaultFeatures = [ "bitcoinconsensus" "serde" ];
      };
      "bitcoinconsensus" = rec {
        crateName = "bitcoinconsensus";
        version = "0.17.1";
        edition = "2015";
        sha256 = "16gzjdnqv61kw0a263w8ynp4pzwsqfz96pkd56k5mwxxh9i9k24r";
        authors = [
