...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/geonamestools/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "geonamestools" = rec {
        crateName = "geonamestools";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "gntools"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        libName = "geonames";
        authors = [
          "Davide Del Papa <davidedelpapa@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
