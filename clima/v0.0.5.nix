...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clima/v0.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "termimad" = rec {
        ...
        version = "0.8.8";
        edition = "2018";
        sha256 = "132393qwrlm7idmr1w7v0wcjaykkqyg7pbl70q6mm03hpahc24zq";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
