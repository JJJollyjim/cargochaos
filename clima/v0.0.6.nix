...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clima/v0.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "termimad" = rec {
        ...
        version = "0.8.15";
        edition = "2018";
        sha256 = "1m611128sc7yw2qym4f8ppn30qhdqnli6g9f2p9b69khp6lxhjrj";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
