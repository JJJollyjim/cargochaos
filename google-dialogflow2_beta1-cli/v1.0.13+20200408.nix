...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dialogflow2_beta1-cli/v1.0.13+20200408.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-dialogflow2_beta1-cli";
  ...
  workspaceMembers = {
    "google-dialogflow2_beta1-cli" = rec {
      packageId = "google-dialogflow2_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-dialogflow2_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dialogflow2_beta1" = rec {
        crateName = "google-dialogflow2_beta1";
        version = "1.0.13+20200408";
        edition = "2015";
        sha256 = "1hi2h8yp980az68yy1nj2bk0a2rb7838z2k6f9fwy15c79p7wlfz";
        authors = [
      ...
      "google-dialogflow2_beta1-cli" = rec {
        crateName = "google-dialogflow2_beta1-cli";
        version = "1.0.13+20200408";
        edition = "2015";
        crateBin = [
          { name = "dialogflow2-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-dialogflow2_beta1";
            packageId = "google-dialogflow2_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
