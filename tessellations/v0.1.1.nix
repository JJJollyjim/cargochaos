...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tessellations/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "raqote" = rec {
        ...
        version = "0.7.13";
        edition = "2018";
        sha256 = "003s1xgxvz2b3cws0r2syk5aqw94xhjm4ivqbx3d56xk547zmyxf";
        authors = [
