...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.5.0-alpha.17.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.17.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "activitystreams-derive" "chrono" "default" "derive" "kinds" "mime" "primitives" "serde" "serde_json" "thiserror" "types" "url" ];
      };
      "activitystreams-derive" = rec {
        crateName = "activitystreams-derive";
        version = "0.5.0-alpha.9";
        edition = "2018";
        sha256 = "1yqxfwmyahwnhvag8km1lc9j5v5pkzdcjn6jv6k5ni948rbzavxg";
        procMacro = true;
        authors = [
