...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.5.0-alpha.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.14.nix {};
        authors = [
      ...
      "activitystreams-derive" = rec {
        ...
        edition = "2018";
        sha256 = "1rjf1camcwxh440zp0vgi0ihwdj6bc0mmn1gfa9ri10vw251k6n4";
        procMacro = true;
        authors = [
