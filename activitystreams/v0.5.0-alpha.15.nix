...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.5.0-alpha.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.15.nix {};
        authors = [
      ...
      "activitystreams-derive" = rec {
        ...
        edition = "2018";
        sha256 = "0p8842lcm4wv3rxhcdqhhklyngp353rvq8y1aidwq293hh8qhjfp";
        procMacro = true;
        authors = [
