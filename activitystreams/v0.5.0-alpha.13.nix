...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.5.0-alpha.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.13.nix {};
        authors = [
      ...
      "activitystreams-derive" = rec {
        ...
        edition = "2018";
        sha256 = "131pfqvb3i8wldb5kllxbm0kl92ymv2mnp4qdl00vn982sx87nqp";
        procMacro = true;
        authors = [
