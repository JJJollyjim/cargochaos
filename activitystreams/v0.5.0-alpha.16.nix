...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.5.0-alpha.16.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.16.nix {};
        authors = [
      ...
      "activitystreams-derive" = rec {
        ...
        edition = "2018";
        sha256 = "0dkv0v2666gn6x47fa8ja9vs0gfmy8p64kvrg0z7czdnwcmlmzy7";
        procMacro = true;
        authors = [
