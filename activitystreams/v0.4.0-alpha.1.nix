...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.4.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        resolvedDefaultFeatures = [ "activitystreams-derive" "chrono" "default" "derive" "kinds" "mime" "primitives" "serde" "thiserror" "types" "url" ];
      };
      "activitystreams-derive" = rec {
        crateName = "activitystreams-derive";
        version = "0.4.0-alpha.1";
        edition = "2018";
        sha256 = "158sd029jc0g089frw9drhslbblnc494mf0glzp19l5r5hj3v6nj";
        procMacro = true;
        authors = [
