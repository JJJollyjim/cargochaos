...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/activitystreams/v0.5.0-alpha.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "activitystreams" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.10.nix {};
        authors = [
      ...
      "activitystreams-derive" = rec {
        ...
        edition = "2018";
        sha256 = "0bsxc8xi4j3bjs7yhq7vyxmfgqpllxvwnsqyr3x2xsyw10469g62";
        procMacro = true;
        authors = [
