...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glium_shapes/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glium_shapes" = rec {
        crateName = "glium_shapes";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "James Bird <jbrd@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "approx";
