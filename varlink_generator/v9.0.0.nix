...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/varlink_generator/v9.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "varlink_generator" = rec {
        ...
        src = pkgs.callPackage ./tarball-v9.0.0.nix {};
        authors = [
          "Harald Hoyer <harald@redhat.com>"
        ];
        dependencies = [
      ...
      "varlink_parser" = rec {
        ...
        version = "4.0.2";
        edition = "2018";
        sha256 = "1xlmzhnz32zlalbssp71m3xmvnby12bnpm5ds5j6wssslhdwh042";
        authors = [
          "Harald Hoyer <harald@redhat.com>"
        ];
        dependencies = [
