...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nrc-protobuf-codegen/v2.8.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "nrc-protobuf-codegen";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nrc-protobuf" = rec {
        crateName = "nrc-protobuf";
        version = "2.8.0";
        edition = "2015";
        sha256 = "1xqrlgfdyknrq5amj44ahis12z1wa2szc5j16r5lwcgzw7d0zh89";
        authors = [
      ...
      "nrc-protobuf-codegen" = rec {
        crateName = "nrc-protobuf-codegen";
        version = "2.8.0";
        edition = "2015";
        crateBin = [
        ...
        src = pkgs.callPackage ./tarball-v2.8.0.nix {};
        authors = [
          "Nick Cameron <nrc@ncameron.org>"
          "Stepan Koltsov <stepan.koltsov@gmail.com>"
        ];
