...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shorty-http/v0.5.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shorty" = rec {
        ...
        version = "0.5.3";
        edition = "2018";
        sha256 = "1k3wa0wiym83xnryvak8kc5dd8arxmjra4pamz7a7z07bvli273y";
        authors = [
      ...
      "shorty-conf" = rec {
        crateName = "shorty-conf";
        version = "0.5.3";
        edition = "2018";
        sha256 = "1y2jigx7m7izzfx7l1in4gf02b9bcxzrd1p8khcvpnb9z46911dp";
        authors = [
          "Federico Fissore <federico@fissore.org>"
        ];
      ...
      "shorty-http" = rec {
        crateName = "shorty-http";
        version = "0.5.3";
        edition = "2018";
        crateBin = [
          { name = "shorty-http"; path = "src/main.rs"; }
        ];
