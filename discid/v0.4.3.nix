...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/discid/v0.4.3.nix.tmp"
    ...
    crates = {
      ...
      "discid" = rec {
        ...
        dependencies = [
          ...
          {
            name = "discid-sys";
            packageId = "discid-sys";
          }
        ];
        
      };
      "discid-sys" = rec {
        crateName = "discid-sys";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1hb7ig409c2fip9l4ih8hb50f98r6c4qfmi9wc440j36aj64fq6k";
        authors = [
          "Philipp Wolfer <phil@parolu.io>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
