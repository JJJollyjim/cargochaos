...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vkcargo/v0.45.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git2-curl" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1mrb44zc78rz40dr4b1qwcs0krin0bcx8sf87gmln6065lm56bah";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "vkcargo" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "vkcargo"; path = "src/bin/cargo/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.45.1.nix {};
        libName = "cargo";
