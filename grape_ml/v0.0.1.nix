...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grape_ml/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "grape_ml" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "grape_ml"; path = "src/main.rs"; }
        ];
      ...
      "simdeez" = rec {
        ...
        version = "0.6.4";
        edition = "2018";
        sha256 = "1p04jnr3cjh9jcynygi6lqzl2l72bc06yhi0vhlg8wd8n94aw122";
        authors = [
