...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openpol/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flic" = rec {
        ...
        version = "0.1.6";
        edition = "2015";
        sha256 = "1rd5yiyzvlpih4brnc3piiarfmlrhqlg88awwrdqlb6z1cb77i7i";type = [ "rlib" "dylib" ];
        authors = [
      ...
      "openpol" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "openpol"; path = "src/bin/openpol.rs"; }
          { name = "openpol-image13h-to-ppm"; path = "src/bin/openpol-image13h-to-ppm.rs"; }
          { name = "openpol-grafdat-to-image13h"; path = "src/bin/openpol-grafdat-to-image13h.rs"; }
          { name = "openpol-extract-palette"; path = "src/bin/openpol-extract-palette.rs"; }
          { name = "openpol-extract-audio"; path = "src/bin/openpol-extract-audio.rs"; }
        ];
