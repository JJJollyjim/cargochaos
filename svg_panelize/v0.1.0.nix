...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/svg_panelize/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "svg_panelize" = rec {
        crateName = "svg_panelize";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "svg_panelize"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Josh Gao <josh@jmgao.dev>"
        ];
        dependencies = [
          {
            name = "clap";
