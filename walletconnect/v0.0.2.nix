...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/walletconnect/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "qrcode" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "12pb6fqfldc6jbzaa5hhr78ggmic29vgs2qa656x79cakgz9xc7m";
        authors = [
      ...
      "walletconnect" = rec {
        ...
        resolvedDefaultFeatures = [ "atty" "default" "qr" "qrcode" "termcolor" "terminfo" "transport" "web3" ];
      };
      "want" = rec {
        crateName = "want";
        version = "0.2.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
