...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mozjpeg-sys/v0.10.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mozjpeg-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "arith_dec" "arith_enc" "default" "jpeg70_abi" "jpeg80_abi" "nasm-rs" "nasm_simd" "turbojpeg_api" "unwinding" "with_simd" ];
      };
      "nasm-rs" = rec {
        crateName = "nasm-rs";
        version = "0.1.7";
