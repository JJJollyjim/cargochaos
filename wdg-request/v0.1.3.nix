...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wdg-request/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "default-port" = rec {
        crateName = "default-port";
        version = "2.1.0";
        edition = "2018";
        sha256 = "08ap8hgismhm03vcp25wqxkai3in8zicwn4fbjd6cqd6dbzi840h";
        authors = [
          "Grigoriy Baranov <baranov@w3m.co>"
        ];
      ...
      "regexp" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "1brkwk4mbi4l53rysk54fdmbhbpk44vhwilymkvhsp99mpvmham8";
        authors = [
          "Grigoriy Baranov <baranov@w3m.co>"
        ];
        dependencies = [
      ...
      "string-repr" = rec {
        crateName = "string-repr";
        version = "1.0.1";
        edition = "2018";
        sha256 = "09mx8rkbi2dxw1ciwjmvmcw79b3inyd0khr6hazdk64nk52qlql1";
        authors = [
          "Grigoriy Baranov <baranov@w3m.co>"
        ];
      ...
      "wdg-uri" = rec {
        ...
        version = "0.3.7";
        edition = "2018";
        sha256 = "0gyv8xrg6m14d926xhmair2wwv60lp2ipp0rgjn2asj6hbmrl6gp";
        authors = [
          "Grigoriy Baranov <baranov@w3m.co>"
        ];
        dependencies = [
