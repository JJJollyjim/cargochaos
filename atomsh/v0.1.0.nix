...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/atomsh/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "swears" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0k94hc4b00aya162izbvj3nq5ajp3zm4csbhn0v9566csaba7l5n";
        authors = [
          "adam-mcdaniel <adam.mcdaniel17@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "winbase" "wincon" "winerror" "winnt" "winreg" ];
      };
      ...
      "xmachine" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "09w6jfhf2igb49rfzq8imb7d6740aihh0xnxjxzw95xy2gvyhbs5";
        authors = [
