...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cordoba/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cordoba" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cdb"; path = "src/bin/cdb.rs"; }
          { name = "cdbwrite"; path = "src/bin/cdbwrite.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "build-binary" "clap" "default" "memmap" "pyo3" "python" "std" ];
      };
      "ctor" = rec {
        crateName = "ctor";
        version = "0.1.13";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntstatus" "processenv" "std" "sysinfoapi" "winbase" "winerror" "winnt" ];
      };
