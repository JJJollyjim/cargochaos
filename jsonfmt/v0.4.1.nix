...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jsonfmt/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde_json" = rec {
        ...
        resolvedDefaultFeatures = [ "arbitrary_precision" "default" "indexmap" "preserve_order" ];
      };
    };
