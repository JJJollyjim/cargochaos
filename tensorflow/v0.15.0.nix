...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tensorflow/v0.15.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tensorflow" = rec {
        ...
        resolvedDefaultFeatures = [ "examples_system_alloc" "experimental_training" "tensorflow_gpu" "tensorflow_unstable" ];
      };
      ...
      "tensorflow-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "examples_system_alloc" "tensorflow_gpu" ];
      };
      "unicode-xid" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "fileapi" "handleapi" "libloaderapi" "lmcons" "minschannel" "minwindef" "schannel" "securitybaseapi" "sspi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
