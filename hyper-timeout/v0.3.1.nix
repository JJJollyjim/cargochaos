...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper-timeout/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
