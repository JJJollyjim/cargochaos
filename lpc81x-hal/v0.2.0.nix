...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lpc81x-hal/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lpc81x-pac" = rec {
        crateName = "lpc81x-pac";
        version = "0.1.0";
        edition = "2018";
        sha256 = "11byjzdb357xrliqvwqyjhb66hwhlwyz627xwk18cc98j8hpbspm";
        authors = [
