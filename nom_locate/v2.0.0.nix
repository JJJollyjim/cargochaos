...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nom_locate/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "bytecount" = rec {
        ...
        resolvedDefaultFeatures = [ "generic-simd" "packed_simd" "runtime-dispatch-simd" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.9";
      ...
      "nom_locate" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "generic-simd" "runtime-dispatch-simd" "std" ];
      };
      "packed_simd" = rec {
