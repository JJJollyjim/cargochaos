...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpp_demangle/v0.2.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "afl" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "14k6hnwzqn7rrs0hs87vcfqj4334k9wff38d15378frlxpviaard";
        authors = [
      ...
      "cpp_demangle" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "afl_runner"; path = "src/bin/afl_runner.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "afl" "alloc" "cppfilt" "default" "fuzz" "logging" "nightly" "run_libiberty_tests" "std" ];
      };
      "diff" = rec {
        crateName = "diff";
        version = "0.1.11";
