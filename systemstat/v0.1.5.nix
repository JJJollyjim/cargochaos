...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/systemstat/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "fileapi" "minwinbase" "minwindef" "ntdef" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "ws2def" "ws2ipdef" ];
      };
