...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kippschalter/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "i3ipc" = rec {
        ...
        resolvedDefaultFeatures = [ "i3-4-12" "i3-4-13" "i3-4-14" ];
      };
      "itoa" = rec {
        crateName = "itoa";
        version = "0.4.4";
      ...
      "kippschalter" = rec {
        crateName = "kippschalter";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "kippschalter"; path = "src/main.rs"; }
        ];
