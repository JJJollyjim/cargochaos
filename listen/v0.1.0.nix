...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/listen/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fsutils" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0ncd17ca2g3wjnn178i6p42c05brrwwz76yy96dqrgm5xxqgkh91";
        authors = [
          "Jared Forth <jaredforthdev@gmail.com>"
        ];
        dependencies = [
          {
            name = "env_logger";
