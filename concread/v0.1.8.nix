...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/concread/v0.1.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntstatus" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
