...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yaks/v0.0.0-alpha1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hecs" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "08kj9g04g2lsk26629rmgi6lc536zmxg33nrynvbs4nccf0j1579";
        authors = [
      ...
      "resources" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0x6mwjhkid7ygk3q2n9l13mbrazkmn2806a6lrxv8kf4zacliigq";
        authors = [
          "Alexander Sepity <alexander.sepity@gmail.com>"
        ];
        dependencies = [
          {
            name = "downcast-rs";
      ...
      "yaks" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.0-alpha1.nix {};
        authors = [
          "Alexander Sepity <alexander.sepity@gmail.com>"
        ];
        dependencies = [
