...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-file1_beta1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-file1_beta1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-file1_beta1" = rec {
        crateName = "google-file1_beta1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "0c2d7rdclcqbqsjsmnp4fd4xf0br80cpkyr8f26qix4c1shdq2jh";
        authors = [
      ...
      "google-file1_beta1-cli" = rec {
        crateName = "google-file1_beta1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "file1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-file1_beta1";
            packageId = "google-file1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
