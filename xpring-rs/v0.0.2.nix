...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xpring-rs/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fehler" = rec {
        ...
        edition = "2018";
        sha256 = "0kjkyyyl46ys0154vl7w71q4q5b4s372kx7l68d9c6c08acbw36i";
        authors = [
      ...
      "fehler-macros" = rec {
        ...
        version = "1.0.0-alpha.2";
        edition = "2018";
        sha256 = "118wvakricbg3nzi1lv44439q25mawr6wbxrsz7v5192jdamapcs";
        procMacro = true;
        authors = [
          "Without Boats <boats@mozilla.com>"
        ];
