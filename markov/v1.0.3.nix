...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markov/v1.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "markov" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "markgen"; path = "src/bin/markgen.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "getopts" "graph" "itertools" "markgen" "petgraph" "serde_yaml" "yaml" ];
      };
      "ordermap" = rec {
        crateName = "ordermap";
        version = "0.3.5";
