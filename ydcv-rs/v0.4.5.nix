...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ydcv-rs/v0.4.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clipboard2" = rec {
        crateName = "clipboard2";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1rc0c895gg4d92n39nzvcfrw41947r0552pp8xyjlc7v2zr0s3r4";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "default-tls" "hyper-tls" "native-tls" "socks" "tls" ];
      };
      "rust-argon2" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "hstring" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "oleauto" "processenv" "profileapi" "restrictederrorinfo" "roapi" "roerrorapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winstring" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "winrt-notification" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "0hm2c8zyklk65myrnkyksaqlyv2n95i23qyjkdpjqy8dlmfsccbc";
        authors = [
          "allenbenz"
        ];
        dependencies = [
      ...
      "ydcv-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "clipboard2" "default" "notify-rust" "windows" "winrt-notification" "x11-clipboard" ];
      };
    };
