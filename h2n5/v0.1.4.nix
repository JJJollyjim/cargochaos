...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/h2n5/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-cors" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0afiiv09mwbqys8n7hkb2qzak7pjgqb1fxvv5qcapj4aqrqv1rb6";
        libName = "actix_cors";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "n5" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0l4zh22pdqd9092d41226143ixmpl4w67qihwnxy29j4cwg247rw";
        authors = [
          "Andrew Champion <andrew.champion@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "bzip" "bzip2" "default" "filesystem" "flate2" "fs2" "gzip" "itertools" "lz" "lz4" "ndarray" "num-traits" "use_ndarray" "walkdir" "xz" "xz2" ];
      };
      "ndarray" = rec {
        crateName = "ndarray";
        version = "0.13.0";
