...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lsd/v0.17.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lsd" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi 0.3.8";
            target = { target, features }: target."windows";
            features = [ "aclapi" "accctrl" "winnt" "winerror" "securitybaseapi" "winbase" ];
          }
        ];
        buildDependencies = [
          {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "accctrl" "aclapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "securitybaseapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
