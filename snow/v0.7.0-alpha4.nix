...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/snow/v0.7.0-alpha4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aes-gcm" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1mnvw8x31a6zwyh1536kmxs19ygl91rjry188xvqr6zw00cg60a0";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "blake2" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "simd" "simd_opt" "std" ];
      };
      "block-buffer" = rec {
      ...
      "chacha20poly1305" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1l0dslpjajqa9v1w98vwj1jrhs1m662qamajnyji2vsfkkppsz2d";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "pqcrypto-kyber" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "1y7461bx3y5pxxmqv4jw0gvlq6mjxljzwc9zf4hz4qci1flbhnq6";
        authors = [
      ...
      "snow" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.0-alpha4.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "aes-gcm" "blake2" "byteorder" "chacha20poly1305" "default" "default-resolver" "hfs" "libsodium-accelerated" "libsodium-resolver" "nightly" "pqclean_kyber1024" "pqcrypto-kyber" "pqcrypto-traits" "rand" "ring" "ring-accelerated" "ring-resolver" "sha2" "sodiumoxide" "vector-tests" "x25519-dalek" ];
      };
      "sodiumoxide" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "wtypesbase" ];
      };
      ...
      "x25519-dalek" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "nightly" "std" "u64_backend" ];
      };
      "xattr" = rec {
        crateName = "xattr";
        version = "0.2.2";
