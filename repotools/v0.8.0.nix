...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/repotools/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "repotools" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dp"; path = "src/bin/dp.rs"; }
          { name = "aa"; path = "src/bin/aa.rs"; }
          { name = "st"; path = "src/bin/st.rs"; }
          { name = "di"; path = "src/bin/di.rs"; }
          { name = "cm"; path = "src/bin/cm.rs"; }
          { name = "pu"; path = "src/bin/pu.rs"; }
          { name = "le"; path = "src/bin/le.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "aa" "cm" "default" "di" "dp" "le" "pu" "st" ];
      };
      "textwrap" = rec {
        crateName = "textwrap";
        version = "0.11.0";
