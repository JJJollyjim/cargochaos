...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blog-client/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blog-client" = rec {
        crateName = "blog-client";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "blog-client"; path = "src/main.rs"; }
        ];
      ...
      "yew" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "04yv5llhxnq1q7y4rvygq306mdr5fcnbn4mikf8lmi4j6xhxasxs";
        authors = [
      ...
      "yew-macro" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1cpbi81zb3n3xdrlyjrk3x7v8mh2v879x7gdj7mlpn4cc57sgc55";
        procMacro = true;
        authors = [
