...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/backtrace/v0.3.45.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.45";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.45.nix {};
        authors = [
      ...
      "backtrace-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace-sys" "compiler_builtins" "core" "rustc-dep-of-std" ];
      };
      "byteorder" = rec {
        crateName = "byteorder";
        version = "1.3.4";
      ...
      "compiler_builtins" = rec {
        ...
        version = "0.1.26";
        edition = "2015";
        sha256 = "1rhj6ccmfkh9gcxnxgjq4fg257yi4f9325nfzsphbmxwkrg06sq3";
        authors = [
