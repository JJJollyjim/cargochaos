...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/backtrace/v0.3.44.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.44";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.44.nix {};
        authors = [
      ...
      "compiler_builtins" = rec {
        ...
        version = "0.1.24";
        edition = "2015";
        sha256 = "1bx7g4lvklxgac8c48mnl2m8f55q3gzi7w4wr9syz5rrlvpmm5xr";
        authors = [
