...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/backtrace/v0.3.35.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "addr2line" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "17rlf04nx3g3rcy661v24ksnmpk6vqn680g5b5sp8lk20iih2xnx";
        authors = [
      ...
      "backtrace" = rec {
        ...
        version = "0.3.35";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.35.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: (!((target."os" == "macos") || target."windows"));
      ...
      "cfg-if" = rec {
        ...
        version = "0.1.8";
        edition = "2015";
        sha256 = "1ck67y9z9888vpffdwdj4v65av2rrbvac06dbzxr4w3b9sx1nhw9";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "compiler_builtins" = rec {
        ...
        version = "0.1.19";
        edition = "2015";
        sha256 = "1fpabpmg8paj4r5a37vmidh1jx1b7a6ilxm4s3xsxczx27ybjcjf";
        authors = [
      ...
      "goblin" = rec {
        ...
        version = "0.0.23";
        edition = "2018";
        sha256 = "1g92bl76dgc3v3rins61l811pkwsl3jif1x35h2jx33b7dsv8mmc";
        authors = [
      ...
      "libc" = rec {
        ...
        resolvedDefaultFeatures = [ "align" "default" "rustc-dep-of-std" "rustc-std-workspace-core" "std" ];
      };
      "log" = rec {
        crateName = "log";
        version = "0.4.8";
      ...
      "rustc-std-workspace-core" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "1309xhwyai9xpz128xrfjqkmnkvgjwddznmj7brbd8i8f58zamhr";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "dbghelp" "handleapi" "libloaderapi" "memoryapi" "minwindef" "processthreadsapi" "std" "synchapi" "sysinfoapi" "winbase" "winnt" ];
      };
