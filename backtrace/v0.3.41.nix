...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/backtrace/v0.3.41.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.41";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.41.nix {};
        authors = [
      ...
      "compiler_builtins" = rec {
        ...
        version = "0.1.23";
        edition = "2015";
        sha256 = "0m8rfikg08av2plyp32drjfsv7i10nf2kwzajjjkvl13yhj9s5fn";
        authors = [
