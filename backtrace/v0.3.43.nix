...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/backtrace/v0.3.43.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.43";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.43.nix {};
        authors = [
      ...
      "compiler_builtins" = rec {
        ...
        version = "0.1.16";
        edition = "2015";
        sha256 = "1kv1fhj28df7mywai0cb84yvn2cl871hhvnphsrp35y9jfbx37p7";
        authors = [
