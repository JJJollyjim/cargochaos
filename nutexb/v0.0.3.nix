...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nutexb/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "binwrite" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "01p86x7nv2yl2l93kz9q1sg9p4wa08fb4gq4rhrniqswl9sjgyir";
        authors = [
      ...
      "binwrite_derive" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1dcqdmzazsxv9x0nyizk6cla3xmcsihfvkk93l5cahxp54ry0n1s";
        procMacro = true;
        authors = [
          "jam1garner <jam1.mcleod@hotmail.com>"
        ];
      ...
      "ddsfile" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1ffalziivn52hn5xc0czz0317b2nm6sz5x5n32227d25cklmgwrl";
        authors = [
