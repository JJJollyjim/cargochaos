...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openidconnect/v1.0.0-alpha.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oauth2" = rec {
        ...
        resolvedDefaultFeatures = [ "async-trait" "curl" "default" "futures-0-1" "futures-0-3" "futures-01" "futures-03" "http-0-2" "reqwest-0-10" "reqwest-0-9" "reqwest-010" "reqwest-09" ];
      };
      "openidconnect" = rec {
        crateName = "openidconnect";
        version = "1.0.0-alpha.13";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0-alpha.13.nix {};
        authors = [
          "David A. Ramos <ramos@cs.stanford.edu>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "curl" "default" "futures-0-1" "futures-0-3" "futures-01" "futures-03" "nightly" "reqwest-010" "reqwest-09" ];
      };
      "openssl" = rec {
        crateName = "openssl";
        version = "0.10.26";
