...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/color_blinder/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "color_blinder" = rec {
        crateName = "color_blinder";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "color_blinder"; path = "src/bin/color_blinder.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "labels" "rusttype" ];
      };
      "color_quant" = rec {
