...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/servant-codec/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "test-case" = rec {
        ...
        edition = "2018";
        sha256 = "10zgaz1dkln9y95k9gl36rzlhqrxklsz09x0wy6rs38v9gd9nrpd";
        procMacro = true;
        authors = [
