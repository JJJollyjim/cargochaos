...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/include-glsl/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "include-glsl" = rec {
        ...
        dependencies = [
          {
            name = "include-glsl-impl";
            packageId = "include-glsl-impl";
          }
          {
      ...
      "include-glsl-impl" = rec {
        crateName = "include-glsl-impl";
        version = "0.2.0";
        edition = "2018";
        sha256 = "14qa8qf22dgca184l4pnpyanx025yivn6i8j3scga25apzxa9bhz";
        procMacro = true;
        authors = [
          "Ram Kaniyur <quadrupleslap@gmail.com>"
        ];
