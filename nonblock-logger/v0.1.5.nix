...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nonblock-logger/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nonblock-logger" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "colored" "dbg" ];
      };
      "num-integer" = rec {
