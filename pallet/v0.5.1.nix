...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pallet/v0.5.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pallet-macros" = rec {
        crateName = "pallet-macros";
        version = "0.4.0";
        edition = "2018";
        sha256 = "01wvcg613j0dq6hxfbg8iw79030fp0hvvsy3msxhy8ww0w8hj2g7";
        procMacro = true;
        authors = [
          "Jacob Brown <kardeiz@gmail.com>"
        ];
