...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/feather_m0/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21g18a" "jlink_rtt" "samd21" "samd21g18a" "samd21g18a-rt" "unproven" "use_rtt" ];
      };
      "atsamd21g18a" = rec {
      ...
      "panic-abort" = rec {
        ...
        version = "0.3.2";
        edition = "2015";
        sha256 = "1vkqqwsgylnpgcmx4prxfnh6yv1mdcs44jmhh3r15i5vkd4yc82f";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
