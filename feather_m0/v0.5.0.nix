...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/feather_m0/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "aligned 0.1.2" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0f0gxzixajazk3qym6yghsihqjcv96781n2vh71rfk58wqaws482";
        authors = [
        ...
        resolvedDefaultFeatures = [ "const-fn" "default" ];
      };
      "aligned 0.2.0" = rec {
        crateName = "aligned";
        version = "0.2.0";
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21g18a" "jlink_rtt" "samd21g18a" "samd21g18a-rt" "unproven" "use_rtt" ];
      };
      "atsamd21g18a" = rec {
      ...
      "bare-metal 0.1.3" = rec {
        crateName = "bare-metal";
        version = "0.1.3";
        edition = "2015";
        sha256 = "1x147xqxwj3h8s0ysc0dlnmym09zf11l8zfnpj6pchyq6fqqhc6z";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        features = {
      ...
      "cortex-m 0.4.3" = rec {
        ...
        version = "0.4.3";
        edition = "2015";
        sha256 = "1xxpx666mc6mh23f4q65rxizg2yqikmzpgljc5xbwjilhcgdsr18";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
          {
            name = "aligned";
            packageId = "aligned 0.1.2";
          }
          {
            name = "bare-metal";
            packageId = "bare-metal 0.1.3";
          }
          {
      ...
      "cortex-m-rtfm" = rec {
        ...
        version = "0.3.4";
        edition = "2015";
        sha256 = "0hwmggdwy0fdcq7hdn6ibkw1znvzpfjpinwr1lmd3sfigqj4jmfr";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
      ...
      "cortex-m-rtfm-macros" = rec {
        ...
        version = "0.3.2";
        edition = "2015";
        sha256 = "1ns94lil87ra6knsqnqsisff5r95igl0vxmksgnb3lzzdjfgwgn7";
        procMacro = true;
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
      ...
      "feather_m0" = rec {
        crateName = "feather_m0";
        version = "0.5.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Ben Bergman <ben@benbergman.ca>"
        ];
        dependencies = [
          {
            name = "atsamd-hal";
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "cortex-m-rtfm" "cortex_m_rtfm" "default" "panic-abort" "panic-halt" "panic-semihosting" "panic_abort" "panic_halt" "panic_rtt" "panic_semihosting" "rt" "unproven" "use_rtt" ];
      };
      "generic-array" = rec {
      ...
      "panic-abort" = rec {
        crateName = "panic-abort";
        version = "0.3.1";
        edition = "2015";
        sha256 = "03v3gvwcmnwma7m5xc8xi5nq61yjgy6qcsr5njlbc5zd25jsc51c";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
      ...
      "panic_rtt" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0562jgqnq9chcxz95byj4sjxf0bzfpaf1yw08k63s7fisp2lc1h6";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
        ];
        dependencies = [
      ...
      "rtfm-core" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0hdlpr04kpzpk6xkda307khnxqrkc4qkk7257qmpinwmm06l9fhi";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
      ...
      "rtfm-syntax" = rec {
        ...
        version = "0.3.4";
        edition = "2015";
        sha256 = "1gg6r81891wi0y50fdkzlj6015xfdr9zik7avam3bnrsimj4h142";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
