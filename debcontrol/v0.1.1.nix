...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/debcontrol/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "debcontrol" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "std" "verbose-errors" ];
      };
      "indoc" = rec {
        crateName = "indoc";
        version = "0.3.4";
