...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pact_mock_server_cli/v0.6.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "pact_mock_server_cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "expectest" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "0w1brkmqn041sj6lwwxxximjd4c8pj9sapp3ldjgd4d7p5h9bn2h";
        authors = [
      ...
      "indextree" = rec {
        ...
        version = "1.3.0";
        edition = "2015";
        sha256 = "103b3r7smrdg4nx74w0zxddac6kwqc86q39b25qg95b6hpxvfwfb";
        authors = [
      ...
      "p-macro" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1jc1hlb3gb9jl6cg5s1xyl036iyf03cv4l8icj8f397w1wkfrrm2";
        libName = "p_macro";
        libPath = "lib.rs";
        authors = [
      ...
      "pact_matching" = rec {
        crateName = "pact_matching";
        version = "0.5.7";
        edition = "2018";
        sha256 = "1kmy6pimnnvyz10j3nsjbkn1mf07ja7yx96f7y2g5nkqs7j0msrs";
        authors = [
          "Ronald Holshausen <uglyog@gmail.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
      ...
      "pact_mock_server" = rec {
        crateName = "pact_mock_server";
        version = "0.6.2";
        edition = "2018";
        sha256 = "0npsidqdm83a27d24i6rvs7qn58avr6qacg5rirnfflj8v8chlcz";
        authors = [
          "Ronald Holshausen <uglyog@gmail.com>"
        ];
        dependencies = [
      ...
      "pact_mock_server_cli" = rec {
        crateName = "pact_mock_server_cli";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "pact_mock_server_cli"; path = "src/main.rs"; }
        ];
      ...
      "rand_regex" = rec {
        ...
        version = "0.12.0";
        edition = "2015";
        sha256 = "1dxyhck7d1p2jnkcfcz83b0vhgby8k1mhc7a8sxq66lxlyibbly7";
        authors = [
      ...
      "semver 0.7.0" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "11bac3qzsvppsy2cx18k1l8ip55ji68lnibwzgvpg9qgbaw63p9z";
        authors = [
      ...
      "sxd-document" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "18p028mjmqrgjdq0nrpcl8knssxrp9ysj7440rsq8wxifljhsdhy";
        authors = [
          "Jake Goulding <jake.goulding@gmail.com>"
        ];
        dependencies = [
      ...
      "webmachine-rust" = rec {
        crateName = "webmachine-rust";
        version = "0.0.0";
        edition = "2015";
        sha256 = "1ymzd959qazzv25mnkvbyziv9dw6r2vkvp404czc891s8rdc9ss5";
        authors = [
          "Ronald Holshausen <uglyog@gmail.com>"
        ];
        dependencies = [
