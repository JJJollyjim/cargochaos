...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-appstate1-cli/v1.0.12+20190627.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-appstate1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-appstate1" = rec {
        crateName = "google-appstate1";
        version = "1.0.12+20190627";
        edition = "2015";
        sha256 = "0zvbpb9w4x3isvw4i0jl5gnkv4gqdv1b20ccxkxywqsl44bj59cm";
        authors = [
      ...
      "google-appstate1-cli" = rec {
        crateName = "google-appstate1-cli";
        version = "1.0.12+20190627";
        edition = "2015";
        crateBin = [
          { name = "appstate1"; path = "src/main.rs"; }
        ];
