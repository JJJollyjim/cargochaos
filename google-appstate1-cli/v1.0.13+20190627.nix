...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-appstate1-cli/v1.0.13+20190627.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-appstate1" = rec {
        ...
        edition = "2015";
        sha256 = "0zrr4df9s1491rw5fcimr3yymavph0v06dayq2gms0bgp32yh1pi";
        authors = [
      ...
      "google-appstate1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20190627.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
