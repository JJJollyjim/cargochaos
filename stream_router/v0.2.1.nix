...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stream_router/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "num_stream" = rec {
        crateName = "num_stream";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1mbzv8b6h6jydw9k4lflv6i9yb3mkyhz70pvryb0r891500a746k";
        authors = [
