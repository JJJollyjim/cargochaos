...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/typeshare/v0.0.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "text-diff" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "15rqqhi7lklqpdq6gmdqzh9llabgj9xp4nq11ni13gzqcvfki4ih";
        authors = [
      ...
      "typeshare" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "typeshare"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "syn";
            packageId = "syn";
            features = [ "full" "visit" "printing" "extra-traits" ];
          }
        ];
        devDependencies = [
          {
