...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fumarole/v0.1.21.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glium" = rec {
        ...
        edition = "2015";
        sha256 = "1cpk8asb32yifw198jw37lllsqfcbq8qaxkk5lh6npb0dw2kp7b4";
        build = "build/main.rs";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
        ];
      ...
      "rusttype 0.3.0" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1i8c8sz49m8w5lyfsh51bab07v3jwlvx8cwl8s7951vypi1ffmc8";
        authors = [
