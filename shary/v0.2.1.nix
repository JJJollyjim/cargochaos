...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shary/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-ctrlc" = rec {
        crateName = "async-ctrlc";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0baa65jy3jnd6l6xr62h5492m4g2i9161gfmrh3pgmlqrhnig6nm";
        authors = [
      ...
      "shary" = rec {
        ...
        resolvedDefaultFeatures = [ "read_index_html_from_file_system" ];
      };
      "slab" = rec {
        crateName = "slab";
        version = "0.4.2";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
