...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/texture_packer/v0.21.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "bmp" "gif" "hdr" "ico" "jpeg" "png" "pnm" "scoped_threadpool" "tga" "tiff" "webp" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
      ...
      "texture_packer" = rec {
        ...
        resolvedDefaultFeatures = [ "bmp" "common" "gif" "hdr" "ico" "jpeg" "png" "pnm" "tga" "tiff" "webp" ];
      };
      "tiff" = rec {
        crateName = "tiff";
        version = "0.4.0";
