...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vga-framebuffer/v0.9.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "console-traits" = rec {
        crateName = "console-traits";
        version = "0.3.0";
        edition = "2015";
        sha256 = "1infl9rn7saj0azqdb6g1y05qpsx7q7ir418ciysxxy3sp8v64gp";
        authors = [
      ...
      "const-ft" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "1zar5s0ccbjginx2mp8xba2lp6cm21gb068fwpswczchrvmml3wr";
        authors = [
          "dylan_DPC <dylan.dpc@gmail.com>"
        ];
        features = {
        };
        resolvedDefaultFeatures = [ "const_fn" "default" ];
      };
      ...
      "vga-framebuffer" = rec {
        ...
        features = {
          "const_fn" = [ "const-ft/const_fn" ];
        };
        resolvedDefaultFeatures = [ "const_fn" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.7";
