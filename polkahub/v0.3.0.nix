...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/polkahub/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "circle-rs" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1613c7j706lz7c05inira2qnagkh830m1nvnrwi795mj063773m2";
        libName = "circle_rs";
        authors = [
          "Aleks Gnatovskyi <aleks.work2222@gmail.com>"
        ];
      ...
      "polkahub" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "polkahub"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Akropolis Decentralised Ltd., <team@akropolis.io>"
        ];
        dependencies = [
          {
            name = "anyhow";
