...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-git/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-git" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-git"; path = "src/main.rs"; }
        ];
      ...
      "git2_credentials" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "00rb4shnw3zfl3qvwlnm73c9hgax479i6wlvq7nczzknfx355rsv";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winuser" ];
      };
