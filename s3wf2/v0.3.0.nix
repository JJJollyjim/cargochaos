...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/s3wf2/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "s3wf2" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "s3wf2-cli"; path = "src/s3wf2-cli/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Yū Kobayashi <kb10uy@kb10uy.org>"
        ];
        dependencies = [
          {
            name = "ansi_term";
        ...
        resolvedDefaultFeatures = [ "ansi_term" "clap" "cli" "console_error_panic_hook" "foreign" "libc" "serde" "serde_json" "wasm" "wasm-bindgen" "wee_alloc" ];
      };
      "serde" = rec {
        crateName = "serde";
        version = "1.0.104";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "processenv" "synchapi" "winbase" ];
      };
