...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miniscript/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitcoin" = rec {
        ...
        resolvedDefaultFeatures = [ "fuzztarget" ];
      };
      "bitcoin_hashes" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fuzztarget" "std" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.41";
      ...
      "miniscript" = rec {
        ...
        resolvedDefaultFeatures = [ "compiler" "default" "fuzztarget" "serde" "trace" "unstable" ];
      };
      "secp256k1" = rec {
        crateName = "secp256k1";
        version = "0.17.2";
      ...
      "secp256k1-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "fuzztarget" "std" ];
      };
      "serde" = rec {
        crateName = "serde";
        version = "1.0.89";
