...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno_cli/v0.21.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "02kvgsc9a41zd48xnxzxhl7zkzdgbf7fx5nfcprq46x8js8k0781";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
      ...
      "deno_typescript" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "15dpn0j3grkp7g651kgvws2gi1qcfmniwi7j3rilwi9h8rk2qkcg";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
