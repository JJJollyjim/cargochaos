...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno_cli/v0.18.0-preview4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno" = rec {
        ...
        version = "0.18.0";
        edition = "2018";
        sha256 = "18c9z5y9nyzclxliwl3chn4xshdbjyyp8c3f892242s3rc39s87m";
        libPath = "lib.rs";
        authors = [
      ...
      "deno-x86_64-apple-darwin" = rec {
        ...
        version = "0.18.0";
        edition = "2015";
        sha256 = "18p0crjn7l2j7z768ca9fmk526637c3vi0ia4qlbhq1vqkm8lksv";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno-x86_64-pc-windows-msvc" = rec {
        ...
        version = "0.18.0";
        edition = "2015";
        sha256 = "1rdcx23akfpzlmhy577j21s9f7nfwj0783zaa55r3amhqmhkqg67";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno-x86_64-unknown-linux-gnu" = rec {
        ...
        version = "0.18.0";
        edition = "2015";
        sha256 = "1gjx7hpl1sfi1jll47w2flv2zc19j6i78i16iyjqv6swnyx5h3kn";
        authors = [
          "The deno authors <bertbelder@nodejs.org>"
        ];
      ...
      "deno_cli" = rec {
        crateName = "deno_cli";
        version = "0.18.0-preview4";
        edition = "2018";
        crateBin = [
          { name = "deno"; path = "main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.18.0-preview4.nix {};
        authors = [
      ...
      "deno_cli_snapshots" = rec {
        crateName = "deno_cli_snapshots";
        version = "0.18.0-preview4";
        edition = "2018";
        sha256 = "16h60c2mfv07rdqv77vb97s4xc8148dg46z11q130kq118hq65cw";
        libPath = "lib.rs";
        authors = [
          "Ryan Dahl <ry@tinyclouds.org>"
        ];
      ...
      "deno_typescript" = rec {
        ...
        version = "0.18.1";
        edition = "2018";
        sha256 = "0ba434783g9d4ciakd1wz500kh42hqcsib89fsgvwlldq7lbrkzs";
        libPath = "lib.rs";
        authors = [
          "Ryan Dahl <ry@tinyclouds.org>"
        ];
