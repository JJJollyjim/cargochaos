...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno_cli/v0.18.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno_cli_snapshots" = rec {
        ...
        version = "0.18.2";
        edition = "2018";
        sha256 = "0khlz1m8clqjabkbh0173fcjp8y2nb80w8bqradfsb9mwqb1rj5r";
        libPath = "lib.rs";
        authors = [
          "Ryan Dahl <ry@tinyclouds.org>"
        ];
      ...
      "deno_typescript" = rec {
        ...
        version = "0.18.2";
        edition = "2018";
        sha256 = "14kdafwf460wa7ammiyki7fjbx6fvn56qjvnnzph7h5l5pglva05";
        libPath = "lib.rs";
        authors = [
          "Ryan Dahl <ry@tinyclouds.org>"
        ];
