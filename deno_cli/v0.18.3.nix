...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deno_cli/v0.18.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deno_cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.18.3.nix {};
        authors = [
          "the Deno authors"
        ];
        dependencies = [
      ...
      "deno_cli_snapshots" = rec {
        ...
        version = "0.18.3";
        edition = "2018";
        sha256 = "0nmvn8srnbnc7pbxq848z446jvpmaq1x70l1aa864pdgwkn5xiny";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
      ...
      "deno_typescript" = rec {
        ...
        version = "0.18.3";
        edition = "2018";
        sha256 = "0577vsh2y69nmdppnh5wjn5kr119x32fbxbyl32kyzpnxflmh5py";
        libPath = "lib.rs";
        authors = [
          "the Deno authors"
        ];
