...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty-driver/v0.3.0.nix.tmp"
    ...
    crates = {
      ...
      "hyper 0.12.24" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tokio-executor";
            packageId = "tokio-executor 0.1.6";
            optional = true;
          }
          {
            name = "tokio-io";
          ...
          {
            name = "tokio-timer";
            packageId = "tokio-timer 0.2.10";
            optional = true;
          }
          {
            name = "want";
            packageId = "want 0.0.6";
          }
        ];
        features = {
      ...
      "hyper 0.13.0-alpha.4" = rec {
        ...
        resolvedDefaultFeatures = [ "__internal_flaky_tests" "default" "net2" "runtime" "tcp" "tokio" "tokio-net" "tokio-timer" ];
      };
      "hyper-tls" = rec {
        crateName = "hyper-tls";
      ...
      "pin-project" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "0979hn6y0yjwxq1lr8d0bd87qr3pi632q7iylllabch5rmfra0qq";
        authors = [
      ...
      "pin-project-internal" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "0763yy4l9k71c2kacgzxnq0ms4yv7jvnzfpd6jnxz4b4408sgrq8";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "webdriver" = rec {
        ...
        version = "0.40.2";
        edition = "2015";
        sha256 = "08163pzjsp70bpkvb6fkv7iaz5w3lwhhl15rypr281fl85vx3cz1";
        authors = [
          "Mozilla"
        ];
        dependencies = [
      ...
      "winapi 0.3.6" = rec {
        ...
        resolvedDefaultFeatures = [ "dbghelp" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
