...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cross/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "minwinbase" "minwindef" "processenv" "shlobj" "std" "winbase" "winerror" ];
      };
