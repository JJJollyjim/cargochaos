...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jeu_du_plus_ou_du_moins/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "jeu_du_plus_ou_du_moins";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jeu_du_plus_ou_du_moins" = rec {
        crateName = "jeu_du_plus_ou_du_moins";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "jeu_du_plus_ou_du_moins"; path = "src/main.rs"; }
        ];
