...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fiscalidade/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fiscalidade" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "embed_webservices" ];
      };
      "flate2" = rec {
        crateName = "flate2";
        version = "1.0.13";
      ...
      "rust-ini" = rec {
        ...
        resolvedDefaultFeatures = [ "case-insensitive" "default" "unicase" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.2";
