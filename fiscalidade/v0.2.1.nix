...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fiscalidade/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dlv-list" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1s5j7zafi5gvjxdfqffyrvqj7hjl90w82isfg2sv982lgc41gv20";
        authors = [
      ...
      "fiscalidade" = rec {
        crateName = "fiscalidade";
        version = "0.2.1";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Silvio Clecio (silvioprog) <silvioprog@gmail.com>"
        ];
        dependencies = [
          {
            name = "regex";
          ...
          }
          {
            name = "reqwest";
            packageId = "reqwest";
            features = [ "blocking" "gzip" "native-tls" ];
          }
          {
            name = "rust-ini";
            packageId = "rust-ini";
      ...
      "ordered-multimap" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "1k9p4ra46ij9cyjv7sqpqsryc6bxzk4gagl7854hgrpwn204p6vn";
        authors = [
          "Scott Godwin <sgodwincs@gmail.com>"
        ];
        dependencies = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "blocking" "default" "default-tls" "gzip" "hyper-tls" "native-tls" "native-tls-crate" "tokio-tls" ];
      };
      "rust-ini" = rec {
        crateName = "rust-ini";
        version = "0.15.0";
        edition = "2018";
        sha256 = "1mafyf53ck6vp91yri3mmwpacd2331ym1kv6dyj0cf2fj0jad6bf";
        libName = "ini";
        authors = [
