...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mediawiki/v0.1.28.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "user_agent" = rec {
        crateName = "user_agent";
        version = "0.9.0";
        edition = "2018";
        sha256 = "0k0pahldi1fhgz4xvvpxyg7fbbk9s7b18d0x4fc4js5s1v6lyx5s";
        authors = [
          "patrick.fernie@gmail.com"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "default-tls" "preserve_order" ];
      };
      "uuid 0.7.4" = rec {
        crateName = "uuid";
        version = "0.7.4";
