...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/frauth/v0.2.4.nix.tmp"
    ...
    crates = {
      ...
      "frauth" = rec {
        ...
        dependencies = [
          ...
          {
            name = "frauth-ed25519-dalek";
            packageId = "frauth-ed25519-dalek";
            rename = "ed25519-dalek";
            features = [ "serde" ];
          }
          {
            name = "lazy_static";
      ...
      "frauth-ed25519-dalek" = rec {
        crateName = "frauth-ed25519-dalek";
        version = "1.0.0-pre.3";
        edition = "2018";
        sha256 = "116jq215g2vrzcbd9cqzr2i7frl10abcv7wrgqapg10bkd1bgvj6";
        authors = [
          "isis lovecruft <isis@patternsinthevoid.net>"
          "James Munns <james.munns@ferrous-systems.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "rand" "serde" "std" "u64_backend" ];
      };
      "fuchsia-cprng" = rec {
