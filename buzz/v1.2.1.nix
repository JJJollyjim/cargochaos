...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/buzz/v1.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imap" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "1z9i7kfarw28r4paz5gwc4hcp543nq253q0jnjpcn9zrijahlw8z";
        authors = [
      ...
      "notify-rust" = rec {
        ...
        edition = "2018";
        sha256 = "000zr2s42nq0xxjv9aps8yd7gx5k1mngf51rha81vgq8c06pdhwd";
        authors = [
          "Hendrik Sollich <hendrik@hoodie.de>"
        ];
        dependencies = [
      ...
      "systray" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1dfqyaqbafzis97wz66m9xa6jdb6cg8afxmv8kab9mapn9ij7lz2";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" ];
      };
