...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/base58m/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "base58m" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "macros" "io-std" "io-util" ];
          }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "futures-core" "io-std" "io-util" "macros" "memchr" "rt-core" "stream" "tokio-macros" ];
      };
      "tokio-macros" = rec {
