...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/logq/v0.1.11.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pdatastructs" = rec {
        crateName = "pdatastructs";
        version = "0.6.0";
        edition = "2018";
        sha256 = "1h7n4p364mw487ggwnfyibbknfqvad1s63wxm7sq5afpb4m9hb7x";
        authors = [
      ...
      "succinct" = rec {
        ...
        version = "0.4.4";
        edition = "2015";
        sha256 = "1nk4q58msmbsqknyv0rsjz15axqyxcyknrigap6qcx840k2i976b";
        authors = [
      ...
      "tdigest" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0b3s39pzp205qa6zwdzazi4l6zp6yifc030rpg139y0xc8f6qxwv";
        authors = [
          "Paul Meng <me@paulme.ng>"
        ];
        dependencies = [
