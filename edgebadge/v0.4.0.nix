...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/edgebadge/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "edgebadge" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "math" "micromath" "rt" "unproven" "usb" "usb-device" "usbd-serial" "ws2812-timer" "ws2812-timer-delay" ];
      };
