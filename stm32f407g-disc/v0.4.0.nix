...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f407g-disc/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f4xx-hal" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1i4hpp9ki326b1zp3mb6pvcz8rcrnzv99cfsinpg9xmnmgzb3df8";
        authors = [
          "Daniel Egger <daniel@eggers-club.de>"
        ];
        dependencies = [
