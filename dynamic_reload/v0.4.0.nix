...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dynamic_reload/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dynamic_reload" = rec {
        ...
        resolvedDefaultFeatures = [ "no-timestamps" "no-unload" ];
      };
      "filetime" = rec {
        crateName = "filetime";
        version = "0.2.5";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwindef" "ntsecapi" "processenv" "profileapi" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
