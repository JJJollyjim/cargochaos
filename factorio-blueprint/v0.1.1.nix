...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/factorio-blueprint/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "factorio-blueprint" = rec {
        crateName = "factorio-blueprint";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "factorio-blueprint"; path = "src/main.rs"; }
        ];
        ...
        features = {
          "codec-cli" = [ "anyhow" "structopt" ];
        };
        resolvedDefaultFeatures = [ "anyhow" "codec-cli" "default" "structopt" ];
      };
      "flate2" = rec {
        crateName = "flate2";
        version = "1.0.14";
