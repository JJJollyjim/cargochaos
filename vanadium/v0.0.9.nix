...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vanadium/v0.0.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chlorine" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "15zv9d3gl8ybsdszxhs8p0p6vl8cvzpd8hiii7rj9nc76ij9a3k3";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
          {
            ...
            target = { target, features }: (!(target."windows" || ((target."arch" == "wasm32") && (!((target."env" == "wasi") || (target."env" == "emscripten"))))));
          }
        ];
      ...
      "fenestroj" = rec {
        ...
        version = "0.0.9";
        edition = "2018";
        sha256 = "10db0m1cv0b195awhx8i360k0dkbpmz6mz0i860nqx35d784phwx";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "winbase" "wincon" "wincontypes" "windef" "winerror" "winnt" "winuser" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.66";
      ...
      "tinyvec" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "grab_spare_slice" ];
      };
      "vanadium" = rec {
        crateName = "vanadium";
        version = "0.0.9";
        edition = "2018";
        crateBin = [
          { name = "vanadium"; path = "src/bin/vanadium.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "consoleapi" "processenv" "winuser" ];
          }
          {
            name = "libc";
            packageId = "libc";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-default" "libloaderapi" "minwinbase" "minwindef" "processenv" "winbase" "wincon" "wincontypes" "windef" "winerror" "winnt" "winuser" ];
      };
