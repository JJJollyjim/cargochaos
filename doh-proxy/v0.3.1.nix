...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/doh-proxy/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "doh-proxy" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-threaded" "time" "tcp" "udp" "stream" "parking_lot" ];
          }
        ];
        features = {
          "default" = [ "tls" ];
        ...
        resolvedDefaultFeatures = [ "default" "tls" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "libdoh" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0q3xa4gg58xjjicqrrgcll6swqkjb04vlzkbk230ddgzlq9fgapv";
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "tls" "tokio-rustls" ];
      };
      "lock_api" = rec {
        crateName = "lock_api";
        version = "0.3.3";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "parking_lot" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "udp" ];
      };
      "tokio-rustls" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
