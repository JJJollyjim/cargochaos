...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eventio/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pcap-file" = rec {
        ...
        version = "0.10.0";
        edition = "2015";
        sha256 = "0izxf25f3i8xx93n0fdi2nl4af4sh9hd6fyyr4dbmqzsk6c74nxd";
        authors = [
          "François Courvoisier <f.courvoisier@protonmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "pcap-parser" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "1zz968qma9vcyh6xrkjvdnldnw9gznwmvkpp3h0spdn9aa9y7r64";
        authors = [
        ...
        resolvedDefaultFeatures = [ "data" "default" ];
      };
      "pkg-config" = rec {
