...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shared_memory/v0.10.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shared_memory" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "shared_memory_derive";
          }
          {
      ...
      "shared_memory_derive" = rec {
        crateName = "shared_memory_derive";
        version = "0.10.0";
        edition = "2018";
        sha256 = "0fnx4lsc8isicxxw175amzhgm75fz19051k99sqg1qjb63qi8ykn";
        procMacro = true;
        authors = [
          "ElasT0ny <elast0ny00@gmail.com>"
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
