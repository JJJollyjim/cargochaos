...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adexchangeseller2-cli/v1.0.13+20171101.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adexchangeseller2" = rec {
        ...
        version = "1.0.13+20171101";
        edition = "2015";
        sha256 = "05xrn0968md9lk9wj2a7bhhwsb18wl5dbxf9b62xwmqgcn4zj0js";
        authors = [
      ...
      "google-adexchangeseller2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20171101.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
