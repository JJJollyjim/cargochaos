...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adexchangeseller2-cli/v1.0.12+20171101.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-adexchangeseller2-cli";
  ...
  workspaceMembers = {
    "google-adexchangeseller2-cli" = rec {
      packageId = "google-adexchangeseller2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-adexchangeseller2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adexchangeseller2" = rec {
        crateName = "google-adexchangeseller2";
        version = "1.0.12+20171101";
        edition = "2015";
        sha256 = "0symmr5wi7amr5gp1qddqmayr6xizqml04iiad34916iyz8xvbw7";
        authors = [
      ...
      "google-adexchangeseller2-cli" = rec {
        crateName = "google-adexchangeseller2-cli";
        version = "1.0.12+20171101";
        edition = "2015";
        crateBin = [
          { name = "adexchangeseller2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20171101.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-adexchangeseller2";
          }
          {
            name = "hyper";
            packageId = "hyper";
