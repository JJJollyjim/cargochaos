...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spritec/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gltf" = rec {
        ...
        resolvedDefaultFeatures = [ "KHR_lights_punctual" "base64" "default" "image" "import" "names" "utils" ];
      };
      "gltf-derive" = rec {
      ...
      "gltf-json" = rec {
        ...
        resolvedDefaultFeatures = [ "KHR_lights_punctual" "default" "names" ];
      };
      "glutin" = rec {
        crateName = "glutin";
        version = "0.23.0";
      ...
      "spritec" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "spritec"; path = "src/bin/spritec/main.rs"; }
        ];
      ...
      "terminator" = rec {
        crateName = "terminator";
        version = "0.1.0";
        edition = "2015";
        sha256 = "041qq5rplmh6jnabdz68jc595j52x2xadzzwnfa3pl8g05zr25r0";
        authors = [
      ...
      "vek" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "repr_simd" "rgb" "rgba" "serde" ];
      };
      "version_check" = rec {
