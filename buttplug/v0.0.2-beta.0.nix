...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/buttplug/v0.0.2-beta.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-std" = rec {
        ...
        resolvedDefaultFeatures = [ "broadcaster" "unstable" ];
      };
      "async-task" = rec {
      ...
      "buttplug" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.0.2-beta.0.nix {};
        authors = [
