...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deadpool-postgres/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deadpool" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "1wjmn4y2lvf748rnmacbh0f140iffdj7bqvmk5ks23q0v27kmypx";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "rt-core" "slab" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
