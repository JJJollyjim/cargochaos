...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deadpool-postgres/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deadpool" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0mbyzkaan6b3kiq5b3i5bcswg6gvrlb7mamxim2ad2fkw0p16z97";
        authors = [
      ...
      "postgres-protocol" = rec {
        ...
        edition = "2018";
        sha256 = "00gpm038324y41968rfin7c9wkckqy3knz5hskj8v0z243vh1d03";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "postgres-types" = rec {
        ...
        edition = "2018";
        sha256 = "1d6mp7sjb88q49vzfj6q13fgs2giz2h00xkl33pib7knp5cpym70";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio-postgres" = rec {
        ...
        version = "0.5.0-alpha.2";
        edition = "2018";
        sha256 = "14wd88nqr6ky8nb03l3vzxr79j7dcbzy9x8l6czgnc00pcw4hw2q";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
