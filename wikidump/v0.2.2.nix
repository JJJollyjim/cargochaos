...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wikidump/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "parse_wiki_text" = rec {
        crateName = "parse_wiki_text";
        version = "0.1.5";
        edition = "2018";
        sha256 = "1pbif5qb8q1vlk5nnb09a3b552f2skcjyin9ffyh5ylfqm2s4nfx";
        authors = [
      ...
      "wikidump" = rec {
        ...
        authors = [
          "camchenry <camchenry@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "bzip2";
