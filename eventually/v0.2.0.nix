...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eventually/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eventually" = rec {
        crateName = "eventually";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Danilo Cianfrone <danilocianfr@gmail.com>"
        ];
        dependencies = [
          {
            name = "async-trait";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "rt-core" "slab" "sync" "test-util" "time" ];
      };
      "tokio-test" = rec {
