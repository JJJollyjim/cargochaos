...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu_plugin_sys/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "heim" = rec {
        ...
        resolvedDefaultFeatures = [ "cpu" "disk" "heim-cpu" "heim-disk" "heim-host" "heim-memory" "heim-net" "heim-process" "heim-sensors" "heim-virt" "host" "memory" "net" "runtime-polyfill" "sensors" ];
      };
      "heim-common" = rec {
      ...
      "nu_plugin_sys" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "nu_plugin_sys"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "devguid" "errhandlingapi" "evntrace" "fileapi" "handleapi" "impl-default" "in6addr" "inaddr" "ioapiset" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "powerbase" "processenv" "processthreadsapi" "profileapi" "psapi" "setupapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "tlhelp32" "winbase" "wincon" "windef" "winerror" "winioctl" "winnt" "ws2def" ];
      };
