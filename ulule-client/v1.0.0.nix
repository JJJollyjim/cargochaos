...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ulule-client/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ulule" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "18hpbd3xy750r0c40fsvd9d6xagqx6p9xhk8paadisp79gr1phmv";
        authors = [
          "Edouard Paris <m@edouard.paris>"
        ];
        dependencies = [
          {
            name = "futures";
