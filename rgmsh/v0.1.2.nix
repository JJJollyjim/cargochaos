...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rgmsh/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gmsh-sys" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0rq7xvmyf4cvfq58wpv2gib0cwx4b1qgadlnny8lvwrm9yivnd26";
        authors = [
      ...
      "rgmsh" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "api_gen"; path = "src/bin/api_gen.rs"; }
        ];
