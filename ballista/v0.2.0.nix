...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ballista/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "datafusion" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1zkrlf8w7lgxqiqj3xzz3wgnz5fjvx3bzbbnm9c9hc5rpndrsxz3";
        authors = [
          "Apache Arrow <dev@arrow.apache.org>"
        ];
        dependencies = [
      ...
      "kube" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1fbdnhia058m8yi4cffdfw9iamm1zldvqz00d31msrx48vk8ich0";
        authors = [
      ...
      "parquet" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0xh6aam07pj0d5m004yp4afp70pfvn58x6xjvbkf3693br9md4vn";
        authors = [
          "Apache Arrow <dev@arrow.apache.org>"
        ];
        dependencies = [
      ...
      "sqlparser" = rec {
        ...
        version = "0.2.5";
        edition = "2018";
        sha256 = "04gzkazifvrmas2xj8kpyypv1cqf3jmxiyjnckjgvksj07r48qd2";
        authors = [
          "Andy Grove <andygrove73@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
