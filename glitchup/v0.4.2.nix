...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glitchup/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cfgmap" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0414b1sdhqdg0gs0pb4k9rh71cbymd0ym9hc748mwq379xy7mafx";
        libPath = "src/cfgmap.rs";
        authors = [
        ...
        features = {
          "default" = [ "from_json" "from_toml" ];
          "from_json" = [ "serde_json" ];
          "from_toml" = [ "toml" ];
        };
        resolvedDefaultFeatures = [ "default" "from_json" "from_toml" "serde_json" "toml" ];
      };
      "crossbeam-deque" = rec {
      ...
      "glitchup" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "glitchup"; path = "src/main.rs"; }
        ];
      ...
      "moveslice" = rec {
        ...
        version = "2.0.1";
        edition = "2018";
        sha256 = "01nrfy9zz699901ncc7pjv8rkc40biccbwq6wvsg6jchjgww1xi3";
        authors = [
          "Calmynt <mctech26@gmail.com>"
        ];
