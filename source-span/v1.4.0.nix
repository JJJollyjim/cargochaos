...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/source-span/v1.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "source-span" = rec {
        ...
        resolvedDefaultFeatures = [ "colors" "default" "termion" ];
      };
      "termion" = rec {
        crateName = "termion";
        version = "1.5.5";
      ...
      "utf8-decode" = rec {
        crateName = "utf8-decode";
        version = "1.0.1";
        edition = "2018";
        sha256 = "1674kmm1pfv6s9pk0m92zkqdid4rggl077x24s4a16ikz8kynqfa";
        authors = [
          "Timothée Haudebourg <author@haudebourg.net>"
        ];
