...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pong-cli/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossterm" = rec {
        ...
        resolvedDefaultFeatures = [ "cursor" "input" "lazy_static" "mio" "screen" "serde" "style" ];
      };
      ...
      "pong-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pong-cli"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "nightly" "rand" "random" "style" ];
      };
      "ppv-lite86" = rec {
      ...
      "specs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "nightly" "parallel" "rayon" "shred-derive" "specs-derive" ];
      };
      "specs-derive" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
