...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imgui-miniquad-render/v0.1.6.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "imgui-miniquad-render";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgui-miniquad-render" = rec {
        crateName = "imgui-miniquad-render";
        version = "0.1.6";
        edition = "2018";
