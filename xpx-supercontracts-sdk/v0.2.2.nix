...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xpx-supercontracts-sdk/v0.2.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "xpx-supercontracts-sdk";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xpx-supercontracts-sdk" = rec {
        crateName = "xpx-supercontracts-sdk";
        version = "0.2.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "ProxymaX Core Development Team"
          "Evgeny Ukhanov <mrlsd@ya.ru>"
        ];
        dependencies = [
          {
            name = "csv";
