...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rls-analysis/v0.18.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rls-analysis" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "derive" "idents" ];
      };
      "rls-data" = rec {
        crateName = "rls-data";
        version = "0.19.0";
        edition = "2018";
        sha256 = "14f4ymf04ndgvwmgf7w3jfqg5sayvkmmgc8b57vfanq4gsljxivn";
        authors = [
          "Nick Cameron <ncameron@mozilla.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "derive" "serde_derive" ];
      };
      "rls-span" = rec {
        crateName = "rls-span";
        version = "0.5.2";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "nightly" "serde_derive" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "0.2.7";
