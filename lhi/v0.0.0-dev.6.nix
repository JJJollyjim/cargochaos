...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lhi/v0.0.0-dev.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kern" = rec {
        ...
        version = "1.1.3";
        edition = "2018";
        sha256 = "0ywa1ixs5v9ybzbm8zqdi4sbjqg7ffdbjivjng8i0x8l2hmym8lf";
        authors = [
      ...
      "lhi" = rec {
        ...
        version = "0.0.0-dev.6";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.0-dev.6.nix {};
        authors = [
          "Lennart Heinrich <lennart@ltheinrich.de>"
        ];
        dependencies = [
