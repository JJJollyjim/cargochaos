...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lhi/v0.0.0-dev.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kern" = rec {
        ...
        version = "1.1.2";
        edition = "2018";
        sha256 = "133yqjj0pvbxpdhkanng5lzdkk1a6rs3wnrav630rm6yw3igs6h8";
        authors = [
      ...
      "lhi" = rec {
        ...
        version = "0.0.0-dev.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.0-dev.2.nix {};
        authors = [
          "Lennart Heinrich <lennart@ltheinrich.de>"
        ];
        dependencies = [
