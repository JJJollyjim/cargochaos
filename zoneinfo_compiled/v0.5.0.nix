...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zoneinfo_compiled/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "datetime" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0yyvafs4zvn1z69azn0b7fdr8sc6dz513ggq3zi50x67vz57ikml";
        authors = [
      ...
      "locale" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "1z87wc7z6889x1pqlrwjw8f1crshzi15q5m102lqs8y0m69f9nsz";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "minwindef" "sysinfoapi" ];
      };
