...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/binaryen/v0.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "binaryen-sys" = rec {
        ...
        version = "0.8.2";
        edition = "2015";
        sha256 = "0i6fyi9aw1iwm828hxijnm8x0wxs2n752cr5vn13jfqwr85n03a4";
        authors = [
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
        ];
        buildDependencies = [
      ...
      "syn" = rec {
        ...
        version = "0.15.25";
        edition = "2015";
        sha256 = "1m9s5injm7pllivqsizsxccsj00871clw79x58v5m4r6jqynkdvi";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
