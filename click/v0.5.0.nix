...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/click/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "der-parser" = rec {
        ...
        version = "0.3.5";
        edition = "2015";
        sha256 = "1psnhckvydkp9zq4kb0b8dsb6kpkjvjg9r6j1i94xikpz25f06mz";
        authors = [
      ...
      "rusticata-macros" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "12gvvj8hr34xmcm604gv5mgqf67w27mm8gs63q9x4ca3az6ymhn4";
        authors = [
          "Pierre Chifflier <chifflier@wzdftpd.net>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" "wtypesbase" ];
      };
