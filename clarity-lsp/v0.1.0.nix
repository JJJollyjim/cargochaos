...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clarity-lsp/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clarity-lsp" = rec {
        crateName = "clarity-lsp";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "clarity-lsp"; path = "src/main.rs"; }
        ];
      ...
      "lsp-types" = rec {
        ...
        version = "0.68.1";
        edition = "2018";
        sha256 = "107cmkwvgbq82nqr65bkpkg2r5kli55i70rl4sm9v4jbj5r9zdqr";
        authors = [
      ...
      "tower-lsp" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1pgvvnkyl3axbvplzralkn6024d01wskc6m2bf6y7fc1g0pwsrj2";
        authors = [
