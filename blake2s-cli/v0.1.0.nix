...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blake2s-cli/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blake2s-cli" = rec {
        crateName = "blake2s-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "blake2s-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Jack Arthur Harrhy <me@jackharrhy.com>"
        ];
        dependencies = [
          {
            name = "blake2";
