...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/atcoder-util/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atcoder-util" = rec {
        crateName = "atcoder-util";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "atcoder-util"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Yuta Nagaoka <wani0202nvkdi@gmail.com>"
        ];
        dependencies = [
          {
            name = "reqwest";
