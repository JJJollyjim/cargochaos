...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/staticvec/v0.9.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "cool_asserts" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "164rc9317k43r1saiibghj0fg8zqgz3xv61bk5fbby0vmwizqpmp";
        authors = [
      ...
      "staticvec" = rec {
        ...
        authors = [
          "SlightlyOutOfPhase <slightlyoutofphase@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_json" "serde_json_support" "serde_support" "std" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
