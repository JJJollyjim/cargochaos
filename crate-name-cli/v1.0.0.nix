...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crate-name-cli/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crate-name-cli" = rec {
        crateName = "crate-name-cli";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "crate-name-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Carlos Menezes <talk@carlosmenezes.com>"
        ];
        dependencies = [
          {
            name = "clap";
