...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lapin-async/v0.22.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amq-protocol" = rec {
        ...
        version = "2.3.0";
        edition = "2018";
        sha256 = "01vnyh9dpvq31hqrzm7rrkfgi4436r741ml84434qv5lvgah1dx8";
        ...
        resolvedDefaultFeatures = [ "native-tls" "openssl" "rustls" "tokio" ];
      };
      "amq-protocol-codegen" = rec {
        crateName = "amq-protocol-codegen";
        version = "2.3.0";
        edition = "2018";
        sha256 = "06f34b2zab56sk2n7b8nf92hb3lvcnqb6n3mz19isfarhs1pkjmv";
      ...
      "amq-protocol-tcp" = rec {
        ...
        version = "2.3.0";
        edition = "2018";
        sha256 = "06db6159rs35vs13dqnb8ab2zavnp1sxq6j77hf024zjnypkk874";
      ...
      "amq-protocol-types" = rec {
        ...
        version = "2.3.0";
        edition = "2018";
        sha256 = "1z6h38dlhlxki9a9z8mvck34f0m0ywpcdd9pg1n5idhdqfmgpz3x";
      ...
      "amq-protocol-uri" = rec {
        ...
        version = "2.3.0";
        edition = "2018";
        sha256 = "0by5qcsnaflszq2wkpss7mjkjw5v3w9d8vvhaq2nif0vb4qyldap";
      ...
      "cookie-factory" = rec {
        ...
        version = "0.3.0-beta2";
        edition = "2015";
        sha256 = "1mfxiawbl0b56rxmck6r13mzzmx15dqpkd0r5paxah56zq1hb8xi";
        authors = [
      ...
      "handlebars" = rec {
        ...
        edition = "2018";
        sha256 = "1lii4snp3amq8dy6s0cz99w5r8d7pysn950xbifgmsvla9ylrk6g";
        authors = [
      ...
      "lapin-async" = rec {
        ...
        version = "0.22.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.22.1.nix {};
        authors = [
          "Geoffroy Couprie <geo.couprie@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "default" "native-tls" "openssl" "rustls" "tokio" ];
      };
      "lazy_static" = rec {
      ...
      "rustls-connector" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0w7z66cwdm5mwxkkzcb9v6cyk7aqxxcqndxyk4qh7g5vp3iv6jva";
      ...
      "tcp-stream" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1fny047qc3lrglm1pixr1086awb4lxmpg7sq9kx0yjrlf5xx2a3a";
        libName = "tcp_stream";
        authors = [
          "Marc-Antoine Perennou <Marc-Antoine@Perennou.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "futures" "native-tls" "openssl" "rustls" "rustls-connector" "tokio" "tokio-io" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
