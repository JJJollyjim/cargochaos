...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vkopt-message-parser/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "vkopt-message-parser";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vkopt-message-parser" = rec {
        crateName = "vkopt-message-parser";
        version = "0.1.0";
        edition = "2018";
