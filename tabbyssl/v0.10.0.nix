...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tabbyssl/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustls" = rec {
        ...
        resolvedDefaultFeatures = [ "dangerous_configuration" "log" "logging" ];
      };
      "scopeguard" = rec {
      ...
      "tabbyssl" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "error_strings" "jemalloc_allocator" "jemallocator" "verifier" ];
      };
      "termcolor" = rec {
        crateName = "termcolor";
        version = "1.0.5";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "wtypesbase" ];
      };
