...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustdoc-stripper/v0.1.9.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustdoc-stripper" = rec {
        crateName = "rustdoc-stripper";
        version = "0.1.9";
        edition = "2015";
        crateBin = [
          { name = "rustdoc-stripper"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.9.nix {};
        libName = "stripper_lib";
        authors = [
