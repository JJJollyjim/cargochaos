...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/conduit-static/v0.9.0-alpha.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "civet" = rec {
        ...
        edition = "2015";
        sha256 = "0mqa31084kl9p04gs6db081pn1rxspxch2vsx1iqk9djrsblqf79";
        authors = [
          "wycats"
        ];
        dependencies = [
      ...
      "civet-sys" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "18n4341w4wa4vwkxiwhsxy1i3y6mw9i8xf78zq8l58hm4vg10sc7";
        libName = "civet_sys";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "conduit-static" = rec {
        ...
        version = "0.9.0-alpha.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.9.0-alpha.0.nix {};
        authors = [
          "wycats@gmail.com"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "conduit-test" = rec {
        ...
        version = "0.9.0-alpha.0";
        edition = "2015";
        sha256 = "0bw4x45yqrhq6sz9sb6xad6sww2nz3g2sxz8arx0hc3nk8kjl6yq";
        authors = [
          "wycats@gmail.com"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
