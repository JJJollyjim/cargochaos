...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/conduit-static/v0.9.0-alpha.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "conduit-test" = rec {
        crateName = "conduit-test";
        version = "0.9.0-alpha.2";
        edition = "2015";
        sha256 = "1p1245rpjmimijdqv7i7xv8q668zgn84cynzyd15592pkxm2rxqr";
        authors = [
          "wycats@gmail.com"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
