...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/conduit-static/v0.9.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "civet" = rec {
        ...
        edition = "2015";
        sha256 = "0f2vsa9qzik78nlhdwmcyix2q42c81nrsqw8zq7p9wqramn7ibmn";
        authors = [
          "wycats"
        ];
        dependencies = [
      ...
      "conduit-test" = rec {
        ...
        version = "0.9.0-alpha.1";
        edition = "2015";
        sha256 = "1nbk3jlwv49jai4sb3pcb8glv916r9bhgrmbiv9rgvzzzds3b7m2";
        authors = [
          "wycats@gmail.com"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
