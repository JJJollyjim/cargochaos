...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cortex-m-rt/v0.6.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compiletest_rs" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "0pmc3lg3ad26aqb1dnk4an4jkgxzik9j7k7azfh0p80hfaapidnp";
        authors = [
          "The Rust Project Developers"
      ...
      "tester" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0v1vy4kj3dfvzjhvsrs73qxsp4xlcbsdidx6x4yvahls00qyqwpf";
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "shlobj" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
