...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cortex-m-rt/v0.6.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compiletest_rs" = rec {
        ...
        version = "0.3.19";
        edition = "2015";
        sha256 = "0j9pl2h7vj6r5qpl7cjgg1mnpjac0zrc3d27n3rssaqlyyqrkisn";
        authors = [
          "The Rust Project Developers"
        ...
        devDependencies = [
          {
            ...
            target = {target, features}: (!(target."os" == "none"));
          }
          {
            name = "cortex-m";
          ...
          }
          {
            ...
            target = {target, features}: (stdenv.hostPlatform.config == "thumbv6m-none-eabi");
          }
          {
            name = "cortex-m-semihosting";
            packageId = "cortex-m-semihosting";
            target = {target, features}: (stdenv.hostPlatform.config == "thumbv7em-none-eabi");
          }
          {
            name = "cortex-m-semihosting";
            packageId = "cortex-m-semihosting";
            target = {target, features}: (stdenv.hostPlatform.config == "thumbv7em-none-eabihf");
          }
          {
            name = "cortex-m-semihosting";
            packageId = "cortex-m-semihosting";
            target = {target, features}: (stdenv.hostPlatform.config == "thumbv7m-none-eabi");
          }
          {
            name = "panic-halt";
