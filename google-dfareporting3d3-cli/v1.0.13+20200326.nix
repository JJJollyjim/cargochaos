...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dfareporting3d3-cli/v1.0.13+20200326.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-dfareporting3d3-cli";
  ...
  workspaceMembers = {
    "google-dfareporting3d3-cli" = rec {
      packageId = "google-dfareporting3d3-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-dfareporting3d3-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dfareporting3d3" = rec {
        crateName = "google-dfareporting3d3";
        version = "1.0.13+20200326";
        edition = "2015";
        sha256 = "1pl49bgfq25hmbivs4ndimfy9zdfwxhm8mrdrjp5z8p052l202jj";
        authors = [
      ...
      "google-dfareporting3d3-cli" = rec {
        crateName = "google-dfareporting3d3-cli";
        version = "1.0.13+20200326";
        edition = "2015";
        crateBin = [
          { name = "dfareporting3d3"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-dfareporting3d3";
            packageId = "google-dfareporting3d3";
          }
          {
            name = "hyper";
            packageId = "hyper";
