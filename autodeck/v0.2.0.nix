...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/autodeck/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "streamdeck" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "12xw0y7fb4rjf7qic4lfydgvpr3g330fpbiza5iqg8r6npy2l8dj";
        authors = [
          "ryan <ryan@kurte.nz>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "humantime" "simplelog" "structopt" "util" ];
      };
      "strsim" = rec {
        crateName = "strsim";
        version = "0.8.0";
