...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/autodeck/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "autodeck" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "autodeck"; path = "src/main.rs"; }
        ];
      ...
      "streamdeck" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0lz6g84srnns89118whm7wa8zkfsqk3kba0hkx47yzwv3ab590zm";
        authors = [
          "ryan <ryan@kurte.nz>"
        ];
        dependencies = [
