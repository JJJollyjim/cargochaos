...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/service_bus/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ra_common" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "12k9w65xq1823qizf034xs1sl5vib2dmiblna3q4gp9bk0pai7l5";
        authors = [
      ...
      "seda_bus" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0s1ry480ak0hk93ghaqqnzkiws1b2b9k0galgphjdwnzps4cxlf1";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
