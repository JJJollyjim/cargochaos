...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aster-proxy/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libaster" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0mw0jzfsqaphplz5xdd5kh58kgkn49j6vn0v8nsm7xw28pd2nznj";
        authors = [
          "wayslog <zxs867179@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "actix-rt" "actix-web" "default" "metrics" "prometheus" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.62";
