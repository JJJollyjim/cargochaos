...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aster-proxy/v1.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libaster" = rec {
        ...
        version = "1.2.0";
        edition = "2018";
        sha256 = "0zn1gdv1r566211h2k74mxp6hrwawdjly2f0x39276xmxh4w5lh6";
        authors = [
          "wayslog <zxs867179@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio 0.2.11" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "mio" ];
      };
      "tokio-codec" = rec {
