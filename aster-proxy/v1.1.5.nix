...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aster-proxy/v1.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aster-proxy" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.1.5.nix {};
        libName = "aster";
        authors = [
      ...
      "libaster" = rec {
        ...
        version = "1.1.5";
        edition = "2018";
        sha256 = "0kvsyyl6gf5y6c5a9fvc82jfjgrsx1plkci4sbvgggqsh5wkb0hv";
        authors = [
          "wayslog <zxs867179@gmail.com>"
        ];
        dependencies = [
        ...
        features = {
          "metrics" = [ "prometheus" "actix-web" "actix-rt" "sysinfo" ];
        };
        resolvedDefaultFeatures = [ "actix-rt" "actix-web" "default" "metrics" "prometheus" "sysinfo" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.62";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "pdh" "processenv" "processthreadsapi" "profileapi" "psapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "tlhelp32" "winbase" "wincon" "winerror" "winioctl" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
