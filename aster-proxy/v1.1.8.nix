...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aster-proxy/v1.1.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aster-proxy" = rec {
        crateName = "aster-proxy";
        version = "1.1.8";
        edition = "2018";
        crateBin = [
          { name = "aster-proxy"; path = "bin/proxy.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.8.nix {};
        libName = "aster";
        authors = [
          "wayslog <zxs867179@gmail.com>"
        ];
        dependencies = [
          {
            name = "libaster";
      ...
      "libaster" = rec {
        ...
        version = "1.1.8";
        edition = "2018";
        sha256 = "0kvwyjnx0k7kp7xrbm3dfyv0kkr107pfa08l6qxmbdhvami0l30l";
        authors = [
          "wayslog <zxs867179@gmail.com>"
        ];
        dependencies = [
        ...
        features = {
          "metrics" = [ "prometheus" "actix-web" "actix-rt" "sysinfo" "rayon" ];
        };
        resolvedDefaultFeatures = [ "actix-rt" "actix-web" "default" "metrics" "prometheus" "rayon" "sysinfo" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.62";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "jobapi" "jobapi2" "libloaderapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "pdh" "processenv" "processthreadsapi" "profileapi" "psapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "tlhelp32" "winbase" "wincon" "wincrypt" "winerror" "winioctl" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
