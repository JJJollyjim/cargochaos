...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aster-proxy/v1.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aster-proxy" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.1.7.nix {};
        libName = "aster";
        authors = [
      ...
      "libaster" = rec {
        ...
        version = "1.1.7";
        edition = "2018";
        sha256 = "00mi44yyjj4w5ild0038h2ymc93k0x6g7db3iqikby82ifvqa06c";
        authors = [
          "wayslog <zxs867179@gmail.com>"
        ];
        dependencies = [
