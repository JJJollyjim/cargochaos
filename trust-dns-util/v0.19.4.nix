...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/trust-dns-util/v0.19.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "trust-dns-client" = rec {
        ...
        version = "0.19.4";
        edition = "2018";
        sha256 = "0pk7xsrqy3h22ddz51p82l0srsyyrv8s8s0mk6v009i7vmi9sdqi";
        ...
        resolvedDefaultFeatures = [ "dnssec" "dnssec-openssl" "openssl" ];
      };
      "trust-dns-proto" = rec {
        ...
        resolvedDefaultFeatures = [ "data-encoding" "default" "dnssec" "dnssec-openssl" "openssl" "tokio" "tokio-runtime" ];
      };
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dnssec" "dnssec-openssl" "ipconfig" "resolv-conf" "system-config" "tokio" "tokio-runtime" ];
      };
      "trust-dns-util" = rec {
        crateName = "trust-dns-util";
        version = "0.19.4";
        edition = "2018";
        crateBin = [
          { name = "dnskey-to-pem"; path = "src/bind_dnskey_to_pem.rs"; }
          { name = "get-root-ksks"; path = "src/get_root_ksks.rs"; }
          { name = "pem-to-public-dnskey"; path = "src/pem_to_public_dnskey.rs"; }
        ];
