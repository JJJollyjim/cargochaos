...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-sqlx/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "async-native-tls" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "runtime-async-std" ];
      };
      "async-std" = rec {
        crateName = "async-std";
        version = "1.4.0";
      ...
      "cargo-sqlx" = rec {
        crateName = "cargo-sqlx";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-sqlx"; path = "src/main.rs"; }
        ];
      ...
      "sqlx" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "runtime-async-std" "sqlx-macros" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.2.4";
        ...
        resolvedDefaultFeatures = [ "async-native-tls" "async-std" "runtime-async-std" ];
      };
      "sqlx-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "processthreadsapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
