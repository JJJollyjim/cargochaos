...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sardonyx_tools/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sardonyx_tools" = rec {
        crateName = "sardonyx_tools";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "sardonyx"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        libName = "sardonyx_cli";
        authors = [
