...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pact-stub-server/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "expectest" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "0y290ak3q5l8l8ajg00mqx1lx9f1pagk6ckmplzibf5ach5pr0bq";
        authors = [
      ...
      "pact-stub-server" = rec {
        crateName = "pact-stub-server";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "pact-stub-server"; path = "src/main.rs"; }
        ];
      ...
      "pact_matching" = rec {
        ...
        version = "0.5.9";
        edition = "2018";
        sha256 = "0wxnrxi89ij48k21hgkm3nglgy5zs9a7r29dlwd06ybrnscqa9g9";
        authors = [
          "Ronald Holshausen <uglyog@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "reqwest";
            packageId = "reqwest";
            features = [ "default-tls" "blocking" "json" ];
          }
          {
            name = "semver";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "default" "default-tls" "hyper-tls" "json" "native-tls" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rust-argon2" = rec {
