...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dune/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "honeycomb" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1idzpyhm8z3pav0bb7fw2nnn5pjdy2bayz8dda5hk8l4j667falf";
        authors = [
          "Adam McDaniel <adam.mcdanie17@gmail.com>"
        ];
      ...
      "xmachine" = rec {
        ...
        version = "0.1.11";
        edition = "2018";
        sha256 = "0pm0djfwm3mnyg3xas0jz3sllr37zdbxwn22dkm42g1blcjib8km";
        authors = [
          "adam-mcdaniel <adam.mcdanie17@gmail.com>"
        ];
