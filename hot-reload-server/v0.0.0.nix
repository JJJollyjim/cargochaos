...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hot-reload-server/v0.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hot-reload-server" = rec {
        crateName = "hot-reload-server";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "hot-reload-server"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-core" "fs" "io-std" ];
          }
        ];
