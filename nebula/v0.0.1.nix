...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nebula/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "rt-core" "slab" "stream" "sync" "tcp" "time" ];
      };
