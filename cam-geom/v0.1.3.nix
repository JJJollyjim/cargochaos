...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cam-geom/v0.1.3.nix.tmp"
    ...
    crates = {
      ...
      "cam-geom" = rec {
        ...
        features = {
          ...
          "std" = [ "nalgebra/std" "num-traits/std" "num-iter" ];
        };
        resolvedDefaultFeatures = [ "default" "num-iter" "serde" "serde-serialize" "std" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
