...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sodaq_one/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sodaq_one" = rec {
        ...
        authors = [
          "Robert Hennig <robert.hennig@freylax.de>"
        ];
        dependencies = [
          {
            name = "atsamd-hal";
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "unproven" "use_rtt" "use_semihosting" ];
      };
