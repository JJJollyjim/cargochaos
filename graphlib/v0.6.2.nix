...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/graphlib/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dot" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "01jr7px6anh3yasz8cbbr9ij989gnwb3qdk4852mzzqw996nqjx7";
        authors = [
          "The Rust Project Developers"
      ...
      "graphlib" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dot" "no_std" "sbench" ];
      };
      "hashbrown" = rec {
        crateName = "hashbrown";
        version = "0.6.3";
