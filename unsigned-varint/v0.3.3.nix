...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unsigned-varint/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unsigned-varint" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "codec" "futures" "futures-codec" "futures-io" "futures-util" "futures_codec" "nom" "tokio-util" ];
      };
      "version_check" = rec {
