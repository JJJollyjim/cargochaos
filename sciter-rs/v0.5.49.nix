...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sciter-rs/v0.5.49.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sciter-rs" = rec {
        ...
        version = "0.5.49";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.5.49.nix {};
        authors = [
        ...
        devDependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "impl-default" "winuser" "wingdi" "sysinfoapi" ];
          }
          {
            name = "winit";
            packageId = "winit";
        ...
        resolvedDefaultFeatures = [ "default" "dynamic" "nightly" "windowless" ];
      };
      "scopeguard" = rec {
