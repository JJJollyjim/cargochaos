...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix_web_metrics_mw/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix_web_metrics_mw";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix_web_metrics_mw" = rec {
        crateName = "actix_web_metrics_mw";
        version = "0.2.0";
        edition = "2018";
      ...
      "cadence" = rec {
        ...
        version = "0.18.0";
        edition = "2018";
        sha256 = "0hyyi848vnj396a1fc3fc2qj4qg79492y2xj2gyh4cd44sijm21c";
        authors = [
          "TSH Labs"
        ];
        dependencies = [
      ...
      "metrics-exporter-http" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "12gcfb19wqa1dlhxsb99pw54hk7w4m2wm2dvhy02p0w96jq10fmh";
        authors = [
          "Toby Lawrence <toby@nuclearfurnace.com>"
        ];
        dependencies = [
      ...
      "metrics-exporter-log" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1vxwnz6hq80aaq9mfv1d4vx0p6ygk061wgnsscaism8zz15b7w62";
        authors = [
          "Toby Lawrence <toby@nuclearfurnace.com>"
        ];
        dependencies = [
      ...
      "metrics-runtime" = rec {
        ...
        version = "0.12.1";
        edition = "2018";
        sha256 = "1vbwixq3m6gn7vylanf4flmy3dqxq50fz245iz9q5pd0wkl9vvqm";
        authors = [
          "Toby Lawrence <toby@nuclearfurnace.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
