...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/howto-cli/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "howto" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "09hj7hh7bygax8x7kid249d35vaaxajrszdai1lxnkvz66q8libk";
        authors = [
      ...
      "howto-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "howto-cli"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
