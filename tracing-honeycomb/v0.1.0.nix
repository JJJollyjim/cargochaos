...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tracing-honeycomb/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libhoney-rust" = rec {
        crateName = "libhoney-rust";
        version = "0.1.3";
        edition = "2018";
        sha256 = "1bpwmmswh7i1vvwy8kaq92889vpn32bi7p6p3v9yjw2v0j57mlzx";
        libName = "libhoney";
        authors = [
      ...
      "tracing-distributed" = rec {
        crateName = "tracing-distributed";
        version = "0.1.0";
        edition = "2018";
        sha256 = "19s6pq6ksj9p5d9nzc98k3npql69zaipiipikzz4qag4krjwqamk";
        authors = [
      ...
      "tracing-subscriber" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "033gvl3dy9yp4bfgagy8diyjq3m6vqbcp6f36pghlvxy8pr0vifg";
        authors = [
          "Eliza Weisman <eliza@buoyant.io>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
