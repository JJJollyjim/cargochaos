...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rdev/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "core-graphics" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "highsierra" ];
      };
      "crc32fast" = rec {
        crateName = "crc32fast";
        version = "1.2.0";
      ...
      "protocol" = rec {
        ...
        version = "3.1.3";
        edition = "2015";
        sha256 = "0s1hlx43q3swbxkj2amlrwxdzf85pz91zg0ckv6y46hr4lmsicf5";
        authors = [
      ...
      "protocol-derive" = rec {
        crateName = "protocol-derive";
        version = "3.1.3";
        edition = "2015";
        sha256 = "071612x172h4y6jxx9ckvsgr5lnm2b6gqfsnj7ds6f5xp3p4g8g9";
        procMacro = true;
        authors = [
          "Dylan McKay <me@dylanmckay.io>"
        ];
      ...
      "rdev" = rec {
        ...
        resolvedDefaultFeatures = [ "serde" "serialize" "unstable_grab" ];
      };
      "redox_syscall" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwindef" "ntstatus" "processthreadsapi" "winbase" "winerror" "winnt" "winuser" ];
      };
      ...
      "x11" = rec {
        ...
        resolvedDefaultFeatures = [ "xinput" "xlib" "xrecord" "xtst" ];
      };
      "xproto" = rec {
        crateName = "xproto";
        version = "1.1.5";
        edition = "2015";
        sha256 = "1wrjimn500d2x88jy29i1q3ggdjh20qykx33kvq4n0avazkvg1dd";
        authors = [
          "Dylan McKay <me@dylanmckay.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "protocol" "protocol-derive" "protocol-support" ];
      };
    };
