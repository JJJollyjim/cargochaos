...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbgen/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "muldiv" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "03wqr4v1lwm18m094mz9vwpysyfgjpmf0dbqi5n5cb53s82rl6j5";
        authors = [
      ...
      "rand" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "getrandom" "getrandom_package" "nightly" "packed_simd" "simd_support" "std" ];
      };
      "rand_chacha" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" ];
      };
