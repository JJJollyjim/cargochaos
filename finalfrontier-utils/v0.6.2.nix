...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/finalfrontier-utils/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "conllx" = rec {
        ...
        version = "0.11.2";
        edition = "2018";
        sha256 = "0sdw0vmah26qzghvxkbc3j1haxrxhsyh5sysy1iqa9vzgvys2alh";
        authors = [
      ...
      "finalfrontier" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "0jjlrsq1hmv68mciw9v54bkj6r5hig8kgqq0d68zgr3b7sjk7id6";
        authors = [
      ...
      "finalfrontier-utils" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ff-train-skipgram"; path = "src/bin/ff-train-skipgram.rs"; }
          { name = "ff-train-deps"; path = "src/bin/ff-train-deps.rs"; }
        ];
      ...
      "finalfusion" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "019sijs091mmsg78msrj8jahdpm48ccvksxmkd2xsxlzh8fnn3q4";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
      ...
      "hogwild" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1vfr95cz8iidzsbgpx3k1ix1kpla4bgjk6dpc3vgbzsxwd3i0rha";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
      ...
      "lazy-init" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "04ykc9ccprzca4224y0ci2wq479kawdf53nsfra936i3mwrj47z7";
        authors = [
      ...
      "ndarray-parallel" = rec {
        ...
        version = "0.9.1";
        edition = "2015";
        sha256 = "0s3xmpfa63kflzp7idax50b9xiwv6p94qwzlrs88379gdjg4qi59";
        authors = [
          "bluss"
        ];
        dependencies = [
      ...
      "reductive" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1hm2hjipl86rr2gz4kvyrmw575jjcjzih24rn3dqclfdr57igahc";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
      ...
      "zipf" = rec {
        ...
        version = "5.0.1";
        edition = "2015";
        sha256 = "07x6a7072xvqxsl5yvam7hqhrz2j1w7fwhiqv7ps1pmyhwnpfmr0";
        authors = [
