...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-net/v0.2.0-alpha.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio-net" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "test-cat"; path = "src/bin/test-cat.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "async-traits" "bytes" "crossbeam-queue" "futures-sink-preview" "iovec" "libc" "log" "mio-named-pipes" "mio-uds" "process" "signal" "signal-hook-registry" "tcp" "tracing" "udp" "uds" "winapi" ];
      };
      "tokio-sync" = rec {
