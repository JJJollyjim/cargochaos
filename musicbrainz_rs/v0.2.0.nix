...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/musicbrainz_rs/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "musicbrainz_rs" = rec {
        crateName = "musicbrainz_rs";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "okno <paul.delafosse@protonmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
