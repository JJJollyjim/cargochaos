...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-licensing1-cli/v1.0.13+20190916.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-licensing1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-licensing1" = rec {
        crateName = "google-licensing1";
        version = "1.0.13+20190916";
        edition = "2015";
        sha256 = "0bipkps6mbvq3javzvv0h68krkx4d4ff3w1krqdf52q3f55h5mx1";
        authors = [
      ...
      "google-licensing1-cli" = rec {
        crateName = "google-licensing1-cli";
        version = "1.0.13+20190916";
        edition = "2015";
        crateBin = [
          { name = "licensing1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190916.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
