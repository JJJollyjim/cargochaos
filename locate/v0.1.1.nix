...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/locate/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fstream" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "15p57mhy81ifsl4frqd1s9q0bmw48am0zcyan1xx2gcc6kdzhfzx";
        authors = [
          "DimChtz"
        ];
      ...
      "locate" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "locate"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Prakhar <b118038@iiit-bh.ac.in>"
        ];
        dependencies = [
          {
            name = "argparse";
