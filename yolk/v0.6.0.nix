...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yolk/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cylon_ast" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "0iig31kcamjghxf16x95whrb9m8k6hglvvgc5f9ly91ki7mm4rr4";
        authors = [
          "Matrixmage <osmithsi@sfu.ca>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "yolk" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "yolkc"; path = "src/bin/yolkc.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.6.0.nix {};
        authors = [
          "Avery Crespi <averycrespi@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "yolol_number 0.6.2" = rec {
        crateName = "yolol_number";
        version = "0.6.2";
        edition = "2018";
        sha256 = "0n3xhjsfvcf8smkidxwgr6scxhm3ahlhlz0r8crpkgw73z089mrm";
        authors = [
          "Matrixmage <osmithsi@sfu.ca>"
        ];
        dependencies = [
      ...
      "yolol_number 0.7.0" = rec {
        crateName = "yolol_number";
        version = "0.7.0";
        edition = "2018";
        sha256 = "1ig4g7bbdbg4wmcgvjc89mksqqf2b40kp8cn97iqb80j1rzbnzfv";
        authors = [
          "Matrixmage <osmithsi@sfu.ca>"
        ];
        dependencies = [
      ...
      "yoloxide" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "19mrk8xf66y1jksyf8ajf3r4m51l1d7pj2m58mlyxyi49j3g93w1";type = [ "cdylib" "rlib" ];
        authors = [
          "Matrixmage <osmithsi@sfu.ca>"
        ];
        dependencies = [
