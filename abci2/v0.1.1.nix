...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/abci2/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "abci2" = rec {
        ...
        features = {
          "codegen" = [ "protobuf-codegen-pure" ];
        };
        resolvedDefaultFeatures = [ "codegen" "protobuf-codegen-pure" ];
      };
      "protobuf" = rec {
        crateName = "protobuf";
        version = "2.8.1";
