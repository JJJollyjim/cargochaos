...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/llhd/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "llhd" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "llhd-opt"; path = "src/bin/llhd-opt.rs"; }
          { name = "llhd-conv"; path = "src/bin/llhd-conv/main.rs"; }
          { name = "llhd-check"; path = "src/bin/llhd-check.rs"; }
        ];
