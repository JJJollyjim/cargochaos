...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/docx/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "docx-codegen" = rec {
        crateName = "docx-codegen";
        version = "0.1.3";
        edition = "2018";
        sha256 = "1qh97k7d9laj6gv8471icx3rl74l4vv2wdx776g43fpyghkjajav";
        procMacro = true;
        libName = "docx_codegen";
        authors = [
          "PoiScript <poiscript@gmail.com>"
        ];
        dependencies = [
