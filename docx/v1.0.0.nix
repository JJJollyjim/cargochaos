...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/docx/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "strong-xml" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "01sw3vbhp6r5if5lp1gy2vzqnr3zc6rskw9dcphjqgfw8z0b8gs6";
        authors = [
          "PoiScript <poiscript@gmail.com>"
        ];
        dependencies = [
      ...
      "strong-xml-derive" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1zyymqndyxkq0krfaw31xffdcz7yfjip3pvjcf8q35q8sl7hd8wf";
        procMacro = true;
