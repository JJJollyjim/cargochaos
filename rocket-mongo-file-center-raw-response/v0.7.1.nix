...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-mongo-file-center-raw-response/v0.7.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rocket-mongo-file-center-raw-response";
  ...
  workspaceMembers = {
    "rocket-mongo-file-center-raw-response" = rec {
      packageId = "rocket-mongo-file-center-raw-response";
      build = internal.buildRustCrateWithFeatures {
        packageId = "rocket-mongo-file-center-raw-response";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "base64-url" = rec {
        ...
        version = "1.1.13";
        edition = "2018";
        sha256 = "1ns0rasqq9xl61qd7j73x2llah2n1krg9rz9npv19m2ab8b3jq66";
        authors = [
      ...
      "mongo-file-center" = rec {
        crateName = "mongo-file-center";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1hpabz1zic6xv1dpm5cwh1yxqy1xy8bmy2hjj20f12lm3g561cnb";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "mongodb" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1zcl2yplghwfalg2v88z838rapmqjwcs3z9l4sv64zxarqw4z8pg";
        authors = [
          "Kevin Yeh <kevinyeah@utexas.edu>"
      ...
      "rocket-mongo-file-center-raw-response" = rec {
        crateName = "rocket-mongo-file-center-raw-response";
        version = "0.7.1";
        edition = "2018";
      ...
      "short-crypt" = rec {
        ...
        version = "1.0.15";
        edition = "2018";
        sha256 = "0fiqsci9kbzrylscjkxr1mwpdkdmawcwjhxg9nmnm7nw7fkzprrw";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winnt" ];
      };
