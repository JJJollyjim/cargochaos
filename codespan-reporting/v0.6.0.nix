...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/codespan-reporting/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "codespan" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1dqp31x6sk0axmdz7ljyq5ni7x2l5357ilanycbmf3ykjk5gkxsq";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "heapapi" "minwinbase" "minwindef" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
