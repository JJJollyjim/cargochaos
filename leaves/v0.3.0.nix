...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/leaves/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-native-tls" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "runtime-async-std" "runtime-tokio" "tokio" ];
      };
      "async-std" = rec {
        crateName = "async-std";
        version = "1.4.0";
      ...
      "dashmap" = rec {
        ...
        version = "3.0.4";
        edition = "2018";
        sha256 = "0mxb5dxvmzzkj4c71mxw7z2a7izvkaljwcjixjkqvgpa39vqwimk";
        authors = [
      ...
      "leaves" = rec {
        ...
        features = {
          ...
          "redis" = [ "runtime-tokio" "redis-async" ];
          "runtime-async-std" = [ "async-std" "sqlx/runtime-async-std" ];
          "runtime-tokio" = [ "tokio" "sqlx/runtime-tokio" ];
        };
        resolvedDefaultFeatures = [ "async-std" "default" "mysql" "postgres" "redis" "redis-async" "runtime-async-std" "runtime-tokio" "sqlx" "tokio" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.66";
      ...
      "sqlx" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "08q095pygj5ifjm353zwzrqwqmny18fl24kgx0c072gz6y736cpf";
        authors = [
        ...
        resolvedDefaultFeatures = [ "mysql" "postgres" "runtime-async-std" "runtime-tokio" "sqlx-macros" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.2.4";
        edition = "2018";
        sha256 = "05ra72900r1zw484glzcl1ri98hk49qiyir6ndzn3nhyy3mk2i5p";
        authors = [
          "Ryan Leckey <leckey.ryan@gmail.com>"
          "Austin Bonander <austin.bonander@gmail.com>"
          "Zachery Gyurkovitz <zgyurkovitz@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "async-native-tls" "async-std" "base64" "digest" "generic-array" "hmac" "md-5" "mysql" "num-bigint" "postgres" "rand" "runtime-async-std" "runtime-tokio" "sha-1" "sha2" "tokio" ];
      };
      "sqlx-macros" = rec {
        crateName = "sqlx-macros";
        version = "0.2.3";
        edition = "2018";
        sha256 = "0qibv19qi363y4j4ymg5gkr8kksid50gkc96k588x8x1xncynqrw";
        procMacro = true;
        authors = [
          "Ryan Leckey <leckey.ryan@gmail.com>"
          "Austin Bonander <austin.bonander@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "async-std" "lazy_static" "mysql" "postgres" "runtime-async-std" "runtime-tokio" "tokio" ];
      };
      "subtle" = rec {
        crateName = "subtle";
        version = "1.0.0";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "fs" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "udp" "uds" ];
      };
      "tokio-util" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
