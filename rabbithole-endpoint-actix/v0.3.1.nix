...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rabbithole-endpoint-actix/v0.3.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rabbithole-endpoint-actix";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "frunk_derives" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0248cmyffdshyxcxpjw66x7k52qpzsi75nqhm2g8d46kb0zd48ld";
        procMacro = true;
        authors = [
          "Lloyd <lloydmeta@gmail.com>"
        ];
      ...
      "frunk_proc_macro_helpers" = rec {
        ...
        version = "0.0.3";
        edition = "2015";
        sha256 = "1w6cmay4p4kvm48z0brws75yx35lak0a07z726py0mzn484qy30r";
        authors = [
          "Lloyd <lloydmeta@gmail.com>"
        ];
        dependencies = [
      ...
      "frunk_proc_macros" = rec {
        ...
        version = "0.0.3";
        edition = "2015";
        sha256 = "1w508x5habfsj9i9nbskcc9znagggvjyp9w16apgbhq7xs3akk0y";
        authors = [
          "Lloyd <lloydmeta@gmail.com>"
        ];
        dependencies = [
      ...
      "frunk_proc_macros_impl" = rec {
        ...
        version = "0.0.3";
        edition = "2015";
        sha256 = "03dfjjfqw3yr27b4s2a6xklfnpcwgvlg3s0w846gjvvxvd5k7d21";
        procMacro = true;
        authors = [
          "Lloyd <lloydmeta@gmail.com>"
        ];
      ...
      "rabbithole" = rec {
        crateName = "rabbithole";
        version = "0.3.1";
        edition = "2018";
        sha256 = "18f8z56yk54ix5j75d1s5wbjfmrh6hjjg87v48c69fz1mx4gzcpf";
        authors = [
          "Ukonn Ra <ukonnra@outlook.com>"
        ];
        dependencies = [
          {
            name = "async-trait";
      ...
      "rabbithole-derive" = rec {
        crateName = "rabbithole-derive";
        version = "0.3.1";
        edition = "2018";
        sha256 = "07zaja039dka0d4pjrwmjjmka3b46j070dd6ikf3apr0yfay1gxf";
        procMacro = true;
        authors = [
          "Ukonn Ra <ukonnra@outlook.com>"
        ];
      ...
      "rabbithole-endpoint-actix" = rec {
        crateName = "rabbithole-endpoint-actix";
        version = "0.3.1";
        edition = "2018";
        ...
        dependencies = [
          ...
          {
            name = "rabbithole";
            packageId = "rabbithole";
          }
          {
            name = "rabbithole-derive";
            packageId = "rabbithole-derive";
          }
          {
            name = "rand";
            packageId = "rand 0.7.2";
      ...
      "rsql-rs" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "04bmv548v75cl8p6mxqypda80bfxwccszj7kq4sdiq41r77p2zji";
        authors = [
          "Ukonn Ra <ukonnra@outlook.com>"
        ];
        dependencies = [
