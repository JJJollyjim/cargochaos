...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/YieldSimRust/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "YieldSimRust" = rec {
        crateName = "YieldSimRust";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "YieldSimRust"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Frank Lee <franklee@umail.ucsb.edu>"
        ];
        dependencies = [
          {
            name = "rand";
