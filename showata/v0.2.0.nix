...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/showata/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libm" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "1qwrgsc5x1qp6m4qhs853dmkik5yj61c4l515xaw1m5am39zpkng";
        authors = [
      ...
      "showata" = rec {
        ...
        resolvedDefaultFeatures = [ "all" "default" "image" "nalgebra" "ndarray" "num-traits" "show_image" "show_nalgebra" "show_ndarray" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "0.15.35";
