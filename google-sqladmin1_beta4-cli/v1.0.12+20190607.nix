...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-sqladmin1_beta4-cli/v1.0.12+20190607.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-sqladmin1_beta4-cli";
  ...
  workspaceMembers = {
    "google-sqladmin1_beta4-cli" = rec {
      packageId = "google-sqladmin1_beta4-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-sqladmin1_beta4-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-sqladmin1_beta4" = rec {
        crateName = "google-sqladmin1_beta4";
        version = "1.0.12+20190607";
        edition = "2015";
        sha256 = "0hzgqwya08kp4qfsfpk81dn15y3vm3ls2kj40yw4lbdg1s55j07d";
        authors = [
      ...
      "google-sqladmin1_beta4-cli" = rec {
        crateName = "google-sqladmin1_beta4-cli";
        version = "1.0.12+20190607";
        edition = "2015";
        crateBin = [
          { name = "sqladmin1-beta4"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190607.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-sqladmin1_beta4";
          }
          {
            name = "hyper";
            packageId = "hyper";
