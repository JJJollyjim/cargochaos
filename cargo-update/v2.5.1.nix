...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-update/v2.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-update" = rec {
        ...
        src = pkgs.callPackage ./tarball-v2.5.1.nix {};
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "timezoneapi" "winbase" "winerror" "winnt" "winreg" ];
      };
