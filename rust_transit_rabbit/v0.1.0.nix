...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust_transit_rabbit/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin" = rec {
        ...
        version = "0.34.0";
        edition = "2018";
        sha256 = "0cmsjl6plbc8934zkp4qzs4lw09a0x860ik48s2488ps46yrqkym";
        authors = [
          "Geoffroy Couprie <geo.couprie@gmail.com>"
      ...
      "rust_transit" = rec {
        crateName = "rust_transit";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1ygfdsbgy52gznj6iza5s2dphwffz1w7bgp3fy418jzsx59l7a70";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "rust_transit_derive";
            packageId = "rust_transit_derive";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "rust_transit_derive" = rec {
        crateName = "rust_transit_derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1f8mpxk5bm0h5j8ag65p7hdlnx1awzlzy73dphf79q3y2pcvhjab";
        procMacro = true;
        authors = [
          "JP Moresmau <jp@moresmau.fr>"
        ];
      ...
      "rust_transit_rabbit" = rec {
        crateName = "rust_transit_rabbit";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rust_transit_rabbit"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "windef" "winerror" "winioctl" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
