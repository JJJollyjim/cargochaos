...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/connman/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "connman" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "introspection" "xml-rs" ];
      };
      "crossbeam-deque" = rec {
      ...
      "dbus-tokio" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0lms7n884b5c0ww345wc664mi9jd6188slyk636i4ycgjcxyy49y";
        authors = [
          "David Henningsson <diwic@ubuntu.com>"
        ];
        dependencies = [
