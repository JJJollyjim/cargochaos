...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_v94876/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "guessing_game_v94876";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_v94876" = rec {
        crateName = "guessing_game_v94876";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_v94876"; path = "src/main.rs"; }
        ];
