...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasmi/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libm" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0688d8k5w5y6sv0wg9cinnsqi7ccq75w33jps1pwrdg1binvph03";
        authors = [
      ...
      "wasmi" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "instantiate"; path = "src/bin/instantiate.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "core" "default" "errno" "libm" "std" "vec_memory" ];
      };
      "wasmi-validation" = rec {
        ...
        resolvedDefaultFeatures = [ "core" "std" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.6";
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "minwindef" "ntdef" "ntsecapi" "profileapi" "winbase" "winnt" ];
      };
