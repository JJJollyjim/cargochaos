...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ipset_lookup/v0.4.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ipset_lookup" = rec {
        crateName = "ipset_lookup";
        version = "0.4.4";
        edition = "2018";
        crateBin = [
          { name = "ipset-zmq"; path = "src/bin/ipset-zmq.rs"; }
          { name = "ipset"; path = "src/bin/ipset.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.4.nix {};
        authors = [
          "Taneli Kaivola <tanelikaivola@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "bench" "default" "git2" "microservice" "update" "windows-all" "zmq" ];
      };
      "jobserver" = rec {
        crateName = "jobserver";
        version = "0.1.19";
