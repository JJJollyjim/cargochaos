...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-sweep/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-sweep" = rec {
        crateName = "cargo-sweep";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-sweep"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "holmgr <viktor.holmgren@gmail.com>"
        ];
        dependencies = [
          {
            name = "cargo_metadata";
