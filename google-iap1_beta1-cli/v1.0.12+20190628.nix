...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-iap1_beta1-cli/v1.0.12+20190628.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-iap1_beta1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-iap1_beta1" = rec {
        crateName = "google-iap1_beta1";
        version = "1.0.12+20190628";
        edition = "2015";
        sha256 = "07axdax8lpjrgjvdpl4ghll4s2brn6fzm03lylhb6avr22j3hh2q";
        authors = [
      ...
      "google-iap1_beta1-cli" = rec {
        crateName = "google-iap1_beta1-cli";
        version = "1.0.12+20190628";
        edition = "2015";
        crateBin = [
          { name = "iap1-beta1"; path = "src/main.rs"; }
        ];
