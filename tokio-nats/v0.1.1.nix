...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-nats/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "subslice" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "0xa83i5v9ym0pspb7csphpbfmgrym3l23pa1hrgzvxggsp1qgr33";
        authors = [
          "bluss"
          "strake"
        ];
      ...
      "tokio-nats" = rec {
        crateName = "tokio-nats";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Sebastian Zimmer <sebastian.zim@googlemail.com>"
        ];
        dependencies = [
          {
            name = "bytes";
