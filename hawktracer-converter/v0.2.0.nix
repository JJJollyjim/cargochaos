...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hawktracer-converter/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "hawktracer-converter";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hawktracer-converter" = rec {
        crateName = "hawktracer-converter";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "hawktracer-converter-rs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "hawktracer_converter_lib";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "hawktracer-parser";
            packageId = "hawktracer-parser";
          }
          {
            name = "indicatif";
            packageId = "indicatif";
      ...
      "hawktracer-parser" = rec {
        crateName = "hawktracer-parser";
        version = "0.2.3";
        edition = "2018";
        sha256 = "1yybmrwwgl752k1slj8snj1fkq32imz1vvnzbgrqwwfghvjy7xdh";
        authors = [
          "Marcin Kolny <marcin.kolny@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winuser" ];
      };
