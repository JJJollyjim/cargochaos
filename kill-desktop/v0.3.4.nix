...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kill-desktop/v0.3.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kill-desktop" = rec {
        crateName = "kill-desktop";
        version = "0.3.4";
        edition = "2018";
        crateBin = [
          { name = "kill-desktop"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "knownfolders" "objbase" "processenv" "shlobj" "winbase" "wincon" "winerror" "winnt" ];
      };
