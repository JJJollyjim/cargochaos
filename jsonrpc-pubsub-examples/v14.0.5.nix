...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jsonrpc-pubsub-examples/v14.0.5.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "jsonrpc-pubsub-examples";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jsonrpc-ipc-server" = rec {
        ...
        version = "14.0.5";
        edition = "2018";
        sha256 = "026in9k52cvvj3sqyphd8k5cbdlv292dx784vcm1n8bkng83kfjv";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "jsonrpc-pubsub" = rec {
        ...
        version = "14.0.5";
        edition = "2018";
        sha256 = "16pkjmpa7xmipcfbnz0bcaccq3ypnxrrsf3dfzbdcp0g1xgn4lrl";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "jsonrpc-pubsub-examples" = rec {
        crateName = "jsonrpc-pubsub-examples";
        version = "14.0.5";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v14.0.5.nix {};
        authors = [
          "tomusdrw <tomasz@parity.io>"
        ];
        dependencies = [
          {
            name = "jsonrpc-core";
      ...
      "jsonrpc-ws-server" = rec {
        ...
        version = "14.0.5";
        edition = "2018";
        sha256 = "1la1rk2a4q6v842bwpa293rjjr85lq6nr66bxrd71j9sghbalkxk";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "parity-tokio-ipc" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "15y2hcdv4qhr4687xyarys37wcx5zrfxk3zp1l9gwl6vf6i8xd94";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "accctrl" "aclapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "securitybaseapi" "std" "synchapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
