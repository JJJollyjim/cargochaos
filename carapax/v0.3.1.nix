...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/carapax/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "regex" = rec {
        ...
        version = "1.3.2";
        edition = "2015";
        sha256 = "1arm6rxvivqwsvz87s2q0qn8pksb4nzjm96l7ddn7nm8vjkxqcp1";
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
      ...
      "tgbot" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0j62svwfa5vmxwipll40z3swmg39i64jk90qp26xz0bcn6wanjbv";
        authors = [
          "Ross Nomann <rossnomann@protonmail.com>"
        ];
        dependencies = [
