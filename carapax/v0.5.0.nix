...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/carapax/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "carapax" = rec {
        ...
        resolvedDefaultFeatures = [ "access" "default" "dialogue" "full" "gettext" "i18n" "nonzero_ext" "ratelimit" "ratelimit_meter" "seance" "serde" "session" "session-fs" "session-redis" ];
      };
      "carapax-codegen" = rec {
        crateName = "carapax-codegen";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0qd6pdmx9ihdg3palndbn9p6hal9xc4yy9awk34mc4w9bgy86h9q";
        procMacro = true;
        authors = [
          "Ross Nomann <rossnomann@protonmail.com>"
        ];
      ...
      "darkredis" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "0kp0z1hr0kx2knp0zixmvk7kggx46vchjqc8izin1awgcf3nlram";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "hyper-rustls" "json" "rustls" "rustls-tls" "serde_json" "socks" "stream" "tokio-rustls" "tokio-socks" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.11";
      ...
      "seance" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1g8y1f21i33kqps85z3hlasznm3rkm2swd836j9fky3pwwcc1nqz";
        authors = [
          "Ross Nomann <rossnomann@protonmail.com>"
        ];
        dependencies = [
      ...
      "tgbot" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1cp0x6mm0qfzrz69yjs8pv956snjvvh371nz0d8p8r1z5r6c20s9";
        authors = [
          "Ross Nomann <rossnomann@protonmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "json" "socks" "rustls-tls" "stream" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "tokio-socks" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "170h5j816kxfh7sixb2kjg0134kbg1ccvfch80l5j4ki1npng7wj";
        authors = [
