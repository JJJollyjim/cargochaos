...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yatt/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "indexed" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1ri76ilx64ygh4ixbzfx3awnarikcx8klgdja690mrwyp5vwmnb4";
        authors = [
      ...
      "trees" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1yqnl57lppss5mq6fcmkah2kgs1aqrwdddy24h3hn1ckyv3i5k8z";
        authors = [
          "oooutlk <oooutlk@outlook.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
      ...
      "yatt" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "yatt"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "dinAlt <dinalt2@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "yatt_orm" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1bgzw3rb7xgrf0ya7vr4xzyksh98cbnqp9i8hljkygygc7v43zzy";
        authors = [
          "dinAlt <dinalt2@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "yatt_orm_derive";
            packageId = "yatt_orm_derive";
          }
        ];
        
      };
      "yatt_orm_derive" = rec {
        crateName = "yatt_orm_derive";
        version = "0.2.1";
        edition = "2018";
        sha256 = "1wxqhqb0abar14q2l1s67y0981z4808dfv68krvs2flj162visjp";
        procMacro = true;
        authors = [
          "dinAlt <dinalt2@gmail.com>"
        ];
