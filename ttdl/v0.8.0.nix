...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ttdl/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "todo-txt" = rec {
        ...
        version = "1.3.0";
        edition = "2018";
        sha256 = "143zkqg83bq2x91s24p64yqsil0fsg5fschhv711wi9za0p6q37h";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "extended" "log" "rand" ];
      };
      "todo_lib" = rec {
        crateName = "todo_lib";
        version = "0.3.2";
        edition = "2018";
        sha256 = "16v46fhikkc7wb2cbzw0dlkflcqpxr5ivin3x93liqap3ghi7364";
        authors = [
