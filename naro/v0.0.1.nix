...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/naro/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "naro" = rec {
        ...
        authors = [
          "phonkee <phonkee@phonkee.eu>"
        ];
        dependencies = [
          {
            name = "naro-derive";
            packageId = "naro-derive";
          }
        ];
        
      };
      "naro-derive" = rec {
        crateName = "naro-derive";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1gfq8snhsi6f2pdrk8mn9jif5awghrwf1a6sc7s00ahhq1wavhnq";
        procMacro = true;
        authors = [
          "phonkee <phonkee@phonkee.eu>"
        ];
