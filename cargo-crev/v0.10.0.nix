...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-crev/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crev-common" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "1gcd5k8yv74ss49k2r08b8wxfqdb4hhm4djawdn8vd2b0w2i5wl9";
        authors = [
          "Dawid Ciężarkiewicz <dpc@dpc.pw>"
        ];
        dependencies = [
      ...
      "crev-data" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "05z096b30q8w1mxwrlsw0wmcri61x62rxghcx2nx3i69zdqs86f0";
        authors = [
          "Dawid Ciężarkiewicz <dpc@dpc.pw>"
        ];
        dependencies = [
      ...
      "crev-lib" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "1jrnbi5vvrlb09pk0aysi1lrzdqiqlr091n5i6c60p0qn86fx0qd";
        authors = [
          "Dawid Ciężarkiewicz <dpc@dpc.pw>"
        ];
        dependencies = [
