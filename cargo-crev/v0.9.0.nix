...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-crev/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crev-common" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1fxffvs4h9qwswizkqryl0y9ba3hnjq099z1f6vkjd357dm0sx6i";
        authors = [
          "Dawid Ciężarkiewicz <dpc@dpc.pw>"
        ];
        dependencies = [
      ...
      "crev-data" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1wwp21a3q6mcxqhp7v4y7cnjyzi68canwkjfdr2w3m7nivd0frs9";
        authors = [
          "Dawid Ciężarkiewicz <dpc@dpc.pw>"
        ];
        dependencies = [
      ...
      "crev-lib" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "0jrrb0s8x0wqsxqnxc5ph650mizcp1y06pqmc96g3qgrg4njixlj";
        authors = [
          "Dawid Ciężarkiewicz <dpc@dpc.pw>"
        ];
        dependencies = [
      ...
      "flate2" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "libz-sys" "miniz-sys" "miniz_oxide" "rust_backend" "zlib" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
