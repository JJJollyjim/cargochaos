...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/multibase-cli/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "multibase-cli" = rec {
        crateName = "multibase-cli";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "multibase"; path = "src/bin/multibase.rs"; }
        ];
