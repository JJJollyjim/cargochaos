...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/swgoh_farming_bot/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "api-swgoh-gg" = rec {
        crateName = "api-swgoh-gg";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0rwd3i7rn7aldfpn4sxshm6gw5xkai2znhr3dfhw3pw0mgbadd95";
        authors = [
          "David Wittwer <wittwer.david1@gmail.com>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "command_attr" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "0dmk90g5qix8qbxnbz2rr0n259rjkymk1bhq95nda2iydla9h45n";
        procMacro = true;
        authors = [
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "chrono" "default" "mysql" "mysqlclient-sys" "url" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "numerals" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "13nf06jpja92j0c08zlzp0h80fqarl4gcjibjnfdhlr7dv85kwl7";
        authors = [
          "ogham@bsago.me"
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "default" "default-tls" "hyper-rustls" "hyper-tls" "json" "native-tls-crate" "rustls" "rustls-tls" "serde_json" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.11";
      ...
      "serenity" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0nrg9lfjq2zimbw2jmbnafmmpy19746hfva9yn1sigc4iacv10xl";
        authors = [
      ...
      "swgoh_farming_bot" = rec {
        crateName = "swgoh_farming_bot";
        version = "0.4.0";
        edition = "2015";
        crateBin = [
          { name = "swgoh_farming_bot"; path = "src/main.rs"; }
        ];
