...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket_seek_stream/v0.2.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "range_header" = rec {
        crateName = "range_header";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0d29sia22jn11in8pr350399f07lpl5fmy9cyiffpn80pjxnc47r";
        authors = [
      ...
      "rocket_seek_stream" = rec {
        crateName = "rocket_seek_stream";
        version = "0.2.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.3.nix {};
        authors = [
          "Ryan Dzengelewski <rdzengelewski@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
