...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ftml-rpc/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ftml" = rec {
        ...
        version = "0.2.19";
        edition = "2018";
        sha256 = "1r0zwrh0v3ksbsc33r8gkxvz5l4vb7gcr7rh1xqfjrfv3yfcgwf5";
        authors = [
      ...
      "ftml-rpc" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ftml-server"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "memoryapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
