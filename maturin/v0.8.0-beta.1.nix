...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/maturin/v0.8.0-beta.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cbindgen" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0673pq96hs7waavkv58v2pakpxpsfyjvbraa5kyl2b44phgdzcid";
        authors = [
      ...
      "maturin" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "maturin"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.8.0-beta.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "auditwheel" "default" "faster-tests" "human-panic" "keyring" "log" "password-storage" "pretty_env_logger" "reqwest" "rpassword" "rustls" "skip-nightly-tests" "upload" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.3.3";
      ...
      "platform-info" = rec {
        ...
        version = "0.0.1";
        edition = "2015";
        sha256 = "1s6p9pq57591qb5aw8ggbci9fnb7mzrhnc3fvrs87af7rmm0gzgj";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincred" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winver" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
