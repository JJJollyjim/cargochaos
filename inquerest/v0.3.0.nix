...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/inquerest/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pom-preview" = rec {
        crateName = "pom-preview";
        version = "3.0.4-alpha-1";
        edition = "2018";
        sha256 = "0wnisjsxp50z3xx8wcwacn25gglzmzgqh0h353h4srj7rzid614g";
        libName = "pom";
        authors = [
      ...
      "restq" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0ncpv294dy788zs730mlif8s22x30kssba66fypi0xixh8dr28mv";
        authors = [
          "Jovansonlee Cesar<ivanceras@gmail.com>"
        ];
        dependencies = [
      ...
      "restq-http" = rec {
        crateName = "restq-http";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1ajgvav748rhflgb9w6qsybb7fb09d3d93ns71ii2mgvrwq7gzah";
        authors = [
          "Jovansonlee Cesar <ivanceras@gmail.com>"
        ];
        dependencies = [
      ...
      "sql-ast" = rec {
        ...
        edition = "2018";
        sha256 = "0p4wq6ch8y0ax6agmdarw7gs5qc6yk11xrl08nb17xz8izwy7gs1";
        authors = [
