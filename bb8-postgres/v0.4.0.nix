...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bb8-postgres/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bb8-postgres" = rec {
        ...
        resolvedDefaultFeatures = [ "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_8" ];
      };
      "bit-vec" = rec {
        crateName = "bit-vec";
        version = "0.6.1";
      ...
      "postgres-types" = rec {
        ...
        resolvedDefaultFeatures = [ "bit-vec-06" "chrono-04" "eui48-04" "geo-types-04" "serde-1" "serde_json-1" "uuid-08" "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_8" ];
      };
      "ppv-lite86" = rec {
      ...
      "tokio-postgres" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "runtime" "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_8" ];
      };
      "tokio-util" = rec {
