...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/auto-check-rs/v0.3.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "auto-check-rs" = rec {
        crateName = "auto-check-rs";
        version = "0.3.2";
        edition = "2018";
        crateBin = [
          { name = "auto-check-rs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.2.nix {};
        authors = [
          "Bjorn Ove Hay Andersen <bjrnove@gmail.com>"
        ];
        dependencies = [
          {
            name = "docopt";
