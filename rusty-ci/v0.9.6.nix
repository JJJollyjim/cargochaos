...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty-ci/v0.9.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusty-yaml" = rec {
        crateName = "rusty-yaml";
        version = "0.4.3";
        edition = "2018";
        sha256 = "180hq0hxmjd1pbq1pf7qan71y16ywr9h2da458r8i7qxbxnndffi";
        authors = [
          "adam-mcdaniel <adam.mcdaniel17@gmail.com>"
        ];
        dependencies = [
