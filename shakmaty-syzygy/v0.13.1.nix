...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shakmaty-syzygy/v0.13.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "positioned-io-preview" = rec {
        crateName = "positioned-io-preview";
        version = "0.3.3";
        edition = "2015";
        sha256 = "1hqsl1fzkgaavbya9xrmzgdd1wsjfxyy463m80c1gp0cgwfvjz2c";
        authors = [
      ...
      "shakmaty" = rec {
        ...
        version = "0.16.3";
        edition = "2018";
        sha256 = "13gf9jy1g971j0c3m1x7x4h5gs1zvvhi37g6fh3mnv7365s8h512";
        build = "src/build.rs";
        authors = [
          "Niklas Fiekas <niklas.fiekas@backscattering.de>"
        ];
      ...
      "shakmaty-syzygy" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "positioned-io-preview";
            rename = "positioned-io";
          }
          {
            name = "shakmaty";
            packageId = "shakmaty";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "processenv" "sysinfoapi" "winbase" "winnt" ];
      };
