...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cups-cli/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cups-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cups-cli"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "futures" "pancurses" "tui" ];
      };
      "derefable" = rec {
        crateName = "derefable";
        version = "0.1.0";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default" "default-tls" "hyper-tls" "native-tls-crate" "socks" "tokio-socks" "tokio-tls" ];
      };
      "rpassword" = rec {
        crateName = "rpassword";
        version = "4.0.5";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
