...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amiquip/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mockstream" = rec {
        crateName = "mockstream";
        version = "0.0.3";
        edition = "2015";
        sha256 = "0bmsjqj2jxssgvkv2lp08yajh8ql3lvbqd1pn5iv8m6jr70f1frm";
        authors = [
          "Alex Bogma <bitfield.alex@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
