...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libmonsterengine/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libmonsterengine" = rec {
        crateName = "libmonsterengine";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        libName = "monsterengine";type = [ "cdylib" "lib" ];
        authors = [
          "Shogo Otake <shogo.otake@gmail.com>"
        ];
        dependencies = [
          {
            name = "hyper";
      ...
      "plamo" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0nqc3jjbp5pnhmpm4pz2nngxy5d18yjl2y9bjrs1cgv786ysxdxa";
        authors = [
          "Shogo Otake <shogo.otake@gmail.com>"
        ];
