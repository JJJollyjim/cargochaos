...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-discovery1-cli/v1.0.12+20190619.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-discovery1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-discovery1" = rec {
        crateName = "google-discovery1";
        version = "1.0.12+20190619";
        edition = "2015";
        sha256 = "1pnggyrdiih5vfiqwd79llsqxs1frv4i3x5k4snwqvlx7islivn5";
        authors = [
      ...
      "google-discovery1-cli" = rec {
        crateName = "google-discovery1-cli";
        version = "1.0.12+20190619";
        edition = "2015";
        crateBin = [
          { name = "discovery1"; path = "src/main.rs"; }
        ];
