...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-drone/v0.21.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ed25519-dalek" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rand_os" "serde" "std" "u64_backend" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.5.3";
      ...
      "solana-clap-utils" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "1p66qc4v293p9q6c7qw3fa0cp0w40czfvaqzy0hyb6q8gi0zqca2";
      ...
      "solana-crate-features" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "1c8v2ww98simn467f7dikxvp0aigs5nlkjc0s8nr0s9ai0kyc46z";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
      ...
      "solana-drone" = rec {
        crateName = "solana-drone";
        version = "0.21.0";
        edition = "2018";
        crateBin = [
          { name = "solana-drone"; path = "src/bin/drone.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.21.0.nix {};
        libName = "solana_drone";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
      ...
      "solana-logger" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "18m2nxdmxkadpc5f5gqbczbbmm10g0kqdb97vca8lhkgj5f3xlra";
      ...
      "solana-metrics" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "1dr546zldd9zz1sc224zfs8nagnmv4rmg3nxb2x7zgdxm9lpbxfa";
      ...
      "solana-sdk" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "0inial1k52yq6crv5pqn9n1g52mb9ndf1ljfp9wkkghhkcpv0q62";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
        ...
        features = {
          "default" = [ "assert_matches" "byteorder" "memmap" "rand" "rand_chacha" "serde_json" "ed25519-dalek" "solana-logger" "solana-crate-features" ];
        };
        resolvedDefaultFeatures = [ "assert_matches" "byteorder" "default" "ed25519-dalek" "memmap" "rand" "rand_chacha" "serde_json" "solana-crate-features" "solana-logger" ];
      };
      "sourcefile" = rec {
