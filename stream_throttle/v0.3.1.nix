...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stream_throttle/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stream_throttle" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-timer" "timer-futures-timer" "timer-tokio" "tokio" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.14";
