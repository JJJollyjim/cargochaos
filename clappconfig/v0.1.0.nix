...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clappconfig/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "json5" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "0lbfwgxwiyprjgqzdqvcvjfxpzgva03hnnmjmnz5vm968khncb4y";
        authors = [
