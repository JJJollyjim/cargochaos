...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xmc1100-hal/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "embedded-hal" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "0cwc88kanaqprj9c6fycqfcmfjcxh5xarwc83pa180w3719fb04q";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
      ...
      "xmc1100" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1jkgibapbbsy7yryi7vc6f8bhv2wydc1mz1mgp6ahkvldhhq9bgy";
        authors = [
