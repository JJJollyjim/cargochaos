...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dynomite/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dynomite" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "derive" "dynomite-derive" "rusoto_core_default" "rusoto_core_rustls" "rusoto_dynamodb_default" "rusoto_dynamodb_rustls" "rustls" "uuid" ];
      };
      "dynomite-derive" = rec {
        crateName = "dynomite-derive";
        version = "0.7.0";
        edition = "2018";
        sha256 = "00bzyg4j917m2m4m1v4y9qp29qi2bbpzn9c6fybglxvvcg51m8hl";
        procMacro = true;
        authors = [
          "softprops <d.tangren@gmail.com>"
        ];
