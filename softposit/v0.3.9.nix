...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/softposit/v0.3.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "softposit" = rec {
        ...
        resolvedDefaultFeatures = [ "alga" "alga_derive" "approx" "default" "linalg" "nalgebra" "nightly" "rand" "std" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "0.15.39";
