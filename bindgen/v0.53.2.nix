...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bindgen/v0.53.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.53.2.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "clap" "default" "env_logger" "log" "logging" "runtime" "static" "testing_only_docs" "testing_only_extra_assertions" "testing_only_libclang_3_8" "testing_only_libclang_3_9" "testing_only_libclang_4" "testing_only_libclang_5" "testing_only_libclang_9" "which" "which-rustfmt" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.0";
      ...
      "clang-sys" = rec {
        ...
        version = "0.29.0";
        edition = "2015";
        sha256 = "01qcgnhlmsqzkyvwkcd1gdg742x214gh7v44bi5bmk0axni2ym03";
        authors = [
        ...
        resolvedDefaultFeatures = [ "clang_6_0" "gte_clang_3_6" "gte_clang_3_7" "gte_clang_3_8" "gte_clang_3_9" "gte_clang_4_0" "gte_clang_5_0" "gte_clang_6_0" "libloading" "runtime" "static" ];
      };
      "clap" = rec {
        crateName = "clap";
        version = "2.33.0";
