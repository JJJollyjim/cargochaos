...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bindgen/v0.51.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.51.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "clap" "default" "env_logger" "log" "logging" "static" "testing_only_docs" "testing_only_extra_assertions" "testing_only_libclang_3_8" "testing_only_libclang_3_9" "testing_only_libclang_4" "testing_only_libclang_5" "which" "which-rustfmt" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.0.4";
