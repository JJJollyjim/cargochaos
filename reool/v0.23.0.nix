...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reool/v0.23.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reool" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "metrix" ];
      };
      "resolv-conf" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "processenv" "processthreadsapi" "std" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
