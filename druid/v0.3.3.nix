...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/druid/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "druid" = rec {
        ...
        resolvedDefaultFeatures = [ "use_gtk" ];
      };
      "druid-derive" = rec {
      ...
      "druid-shell" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "09pi09kyrf18q63p3bjqkcic21w0wqhkj91n35nrbr2cbg3lk7qh";
        authors = [
          "Raph Levien <raph.levien@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cairo-rs" "gdk" "gdk-sys" "gio" "glib" "glib-sys" "gtk" "use_gtk" ];
      };
      "dxgi" = rec {
        crateName = "dxgi";
        version = "0.1.7";
