...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/druid/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "druid-shell" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "10wh4jdhcxn7hdg18s8kckym9jxk4p16nw2pjnw3dx4a61ks46n9";
        authors = [
          "Raph Levien <raph.levien@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "core-graphics";
            packageId = "core-graphics 0.18.0";
            target = { target, features }: (target."os" == "macos");
          }
          {
            name = "direct2d";
