...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-accesscontextmanager1-cli/v1.0.13+20200405.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-accesscontextmanager1" = rec {
        ...
        edition = "2015";
        sha256 = "1km4mv0kv2l7f0chigz5kzy6bspq3zaxjhfysfpbcd2r4ffv8qpl";
        authors = [
