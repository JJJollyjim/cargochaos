...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-accesscontextmanager1-cli/v1.0.12+20190626.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-accesscontextmanager1-cli";
  ...
  workspaceMembers = {
    "google-accesscontextmanager1-cli" = rec {
      packageId = "google-accesscontextmanager1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-accesscontextmanager1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-accesscontextmanager1" = rec {
        crateName = "google-accesscontextmanager1";
        version = "1.0.12+20190626";
        edition = "2015";
        sha256 = "1slvsvbm627yjwn88v31pc2y3vc50ib8gffia3xbj9rivlmrsrlz";
        authors = [
      ...
      "google-accesscontextmanager1-cli" = rec {
        crateName = "google-accesscontextmanager1-cli";
        version = "1.0.12+20190626";
        edition = "2015";
        crateBin = [
          { name = "accesscontextmanager1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-accesscontextmanager1";
          }
          {
            name = "hyper";
            packageId = "hyper";
