...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/k8s-kx/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "k8s-kx" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "k8s-kx"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Martin Ivicic <max.enhanced@gmail.com>"
        ];
        dependencies = [
          {
            name = "dirs";
      ...
      "skim" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1w9h1c5a0kbfc1r8w353dh64yybr0kjkrz32zwfkmlvhm7j3nmw7";
        authors = [
