...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/timpack-cli/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "timpack-cli" = rec {
        crateName = "timpack-cli";
        version = "0.3.1";
        edition = "2015";
        crateBin = [
          { name = "timpack-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Timon de Groot <tdegroot96@gmail.com>"
        ];
        dependencies = [
          {
            name = "which";
