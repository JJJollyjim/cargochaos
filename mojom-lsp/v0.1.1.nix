...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mojom-lsp/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mojom-lsp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mojom-lsp-server"; path = "src/bin/mojom-lsp-server.rs"; }
          { name = "chromium-mojom-check"; path = "src/bin/chromium-mojom-check.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "chromium-mojom-check" "glob" ];
      };
      "opaque-debug" = rec {
