...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gift/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gift" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "gift"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Doug Lau <doug.p.lau@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "clap" "cmd" "env_logger" "termcolor" ];
      };
      "hermit-abi" = rec {
