...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusync/v0.5.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colored" = rec {
        ...
        version = "1.6.0";
        edition = "2015";
        sha256 = "1z67f9jsmgmil5gggsmg9j3pgdcv51mhkmj5k2sn2casx1rk9amh";
        authors = [
      ...
      "structopt" = rec {
        ...
        version = "0.2.8";
        edition = "2015";
        sha256 = "0vg3ycdl6kjmpjm8qgpq37sncz4zii9xxmndlnzq1kx83g0nzffk";
        authors = [
      ...
      "structopt-derive" = rec {
        ...
        version = "0.2.8";
        edition = "2015";
        sha256 = "19jks6zbi2h6mszlfhd1y4ifcvimzxnx5z03kz7cyxjrliakw1lm";
        procMacro = true;
        authors = [
          "Guillaume Pinot <texitoi@texitoi.eu>"
        ];
      ...
      "syn" = rec {
        ...
        version = "0.13.9";
        edition = "2015";
        sha256 = "0f00xzy57387lf05wsh43ksxkk7zh2isvl6r7fv3xybgxpfm0mah";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
