...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sso/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-zlib" "ring" "rust-tls" "rustls" "secure-cookies" "webpki-roots" ];
      };
      "actix-identity" = rec {
        crateName = "actix-identity";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1pcf4bnk1bbwfgk2xcf0hbsvj1m1c6wlfvzzxbnbxj0dz3075nc4";
        libName = "actix_identity";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "actix-web 1.0.8" = rec {
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-zlib" "rust-tls" "rustls" "secure-cookies" ];
      };
      ...
      "curl-sys" = rec {
        ...
        version = "0.4.22";
        edition = "2015";
        sha256 = "0mcjsxn6rl8sd8mvbd7s66rwxhljrz500shk69iqf8kp8579m6if";
        libName = "curl_sys";
        libPath = "lib.rs";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "bitflags" "chrono" "default" "libsqlite3-sys" "postgres" "pq-sys" "r2d2" "serde_json" "sqlite" "uuidv07" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "libsqlite3-sys" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "1lbai9xfnp2py07rbmzqidckwz64bsisppj9zvcmdx5z1g3mfr7x";
        authors = [
      ...
      "migrations_macros" = rec {
        ...
        version = "1.4.0";
        edition = "2015";
        sha256 = "1zik529qhpc07cw51cxm8b2hqy4rn0w2mr4bsnkbickxpwm42r0n";
        procMacro = true;
        authors = [
          "Sean Griffin <sean@seantheprogrammer.com>"
        ];
      ...
      "sentry-actix" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "02lvpz10qk2k0m0vh3jksi01yfplfdhbldzsbnbf5nvb64qmvwpx";
        authors = [
          "Sentry <hello@sentry.io>"
        ];
        dependencies = [
        ...
        features = {
          ...
          "with_sentry_default" = [ "sentry/with_client_implementation" "sentry/with_default_transport" "sentry/with_panic" "sentry/with_failure" "sentry/with_log" "sentry/with_env_logger" "sentry/with_device_info" "sentry/with_rust_info" "sentry/with_native_tls" ];
        };
        resolvedDefaultFeatures = [ "default" "with_sentry_default" ];
      };
      "sentry-types" = rec {
      ...
      "sso" = rec {
        ...
        dependencies = [
          {
            name = "actix";
            packageId = "actix 0.8.3";
          }
          {
            name = "actix-identity";
            packageId = "actix-identity";
          }
          {
            name = "actix-rt";
            packageId = "actix-rt";
          ...
          }
          {
            name = "diesel";
            packageId = "diesel";
            features = [ "postgres" "sqlite" "r2d2" "chrono" "serde_json" "uuidv07" ];
          }
          {
        ...
        resolvedDefaultFeatures = [ "async_client" "default" "postgres" "sqlite" "sync_client" ];
      };
      ...
      "syn 0.11.11" = rec {
        ...
        resolvedDefaultFeatures = [ "aster" "default" "parsing" "printing" "quote" "synom" "unicode-xid" ];
      };
      "syn 0.15.44" = rec {
        crateName = "syn";
        version = "0.15.44";
      ...
      "sysinfo" = rec {
        ...
        version = "0.9.5";
        edition = "2015";
        sha256 = "1dpp3s9x75ca89idvp8lsrimmpgq8lb6jl666f02lmcl7n0kpgfm";type = [ "rlib" "cdylib" ];
        authors = [
          "Guillaume Gomez <guillaume1.gomez@gmail.com>"
        ];
        dependencies = [
      ...
      "validator" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "13vc0h5s34s3hsx1qg0pgm0j4qcnq1j6b1y0kdszp42i7p2n7iqn";
        authors = [
          "Vincent Prouillet <prouillet.vincent@gmail.com"
        ];
        dependencies = [
      ...
      "validator_derive" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "0z59hjsykhmsk9y5q3qxqwcxl95gw1jk6jm7wfp0mpi4rxxdmjwk";
        procMacro = true;
        authors = [
          "Vincent Prouillet <prouillet.vincent@gmail.com"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "pdh" "processenv" "processthreadsapi" "profileapi" "psapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "tlhelp32" "winbase" "wincon" "wincrypt" "winerror" "winioctl" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
