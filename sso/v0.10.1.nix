...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sso/v0.10.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "bitflags" "chrono" "default" "postgres" "pq-sys" "r2d2" "serde_json" "uuid" "uuidv07" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "procfs" = rec {
        ...
        version = "0.7.8";
        edition = "2018";
        sha256 = "0x848fvymhiqpw3aw6m6lp3si2mzm9xsnj0c98x5a7mpl5m06l7y";
        authors = [
      ...
      "sso" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "diesel";
            packageId = "diesel";
            features = [ "postgres" "r2d2" "chrono" "serde_json" "uuidv07" "uuid" ];
          }
          {
      ...
      "tokio 0.2.14" = rec {
        ...
        version = "0.2.14";
        edition = "2018";
        sha256 = "03dvq2lmvlvg3nspp9qz4dxsnl4qprl01nvzqr2x0xd0klpnfl97";
        authors = [
