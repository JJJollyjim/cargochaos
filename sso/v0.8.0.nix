...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sso/v0.8.0.nix.tmp"
    ...
    crates = {
      ...
      "derive_builder 0.8.1" = rec {
        ...
        dependencies = [
          ...
          {
            name = "derive_builder_core";
            packageId = "derive_builder_core 0.8.1";
          }
          {
            name = "proc-macro2";
            packageId = "proc-macro2 1.0.6";
      ...
      "sso" = rec {
        ...
        dependencies = [
          ...
          {
            name = "derive_builder";
            packageId = "derive_builder 0.8.1";
          }
          {
            name = "diesel";
            packageId = "diesel";
