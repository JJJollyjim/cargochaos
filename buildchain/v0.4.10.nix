...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/buildchain/v0.4.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "buildchain" = rec {
        crateName = "buildchain";
        version = "0.4.10";
        edition = "2015";
        crateBin = [
          { name = "buildchain"; path = "src/main.rs"; }
        ];
      ...
      "lxd" = rec {
        ...
        version = "0.1.8";
        edition = "2015";
        sha256 = "07a3ccb1yfyvm9qlb727b7gsqbvfvb4l7kpls48i79l2bzs9dzml";
        authors = [
          "Jeremy Soller <jackpot51@gmail.com>"
        ];
        dependencies = [
