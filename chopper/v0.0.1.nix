...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chopper/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chopper" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "chop"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        libName = "chopper_lib";
        authors = [
          "Xinyun Wu <xin@snaar.net>"
        ];
        dependencies = [
          {
            name = "backtrace";
      ...
      "lzf" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "000d608k90mjimppgd6398hq260fkzhr4yhhhd61i8kxnw7bxr8p";
        authors = [
          "Jan-Erik Rediger <badboy@fnordig.de>"
        ];
