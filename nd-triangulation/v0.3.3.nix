...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nd-triangulation/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nd-triangulation" = rec {
        crateName = "nd-triangulation";
        version = "0.3.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.3.nix {};
        authors = [
          "Florian Barth <barth@fmi.uni-stuttgart.de>"
        ];
        dependencies = [
          {
            name = "cpp";
