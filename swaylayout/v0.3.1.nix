...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/swaylayout/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "swayipc" = rec {
        ...
        version = "2.2.6";
        edition = "2018";
        sha256 = "1dvsyp0im59y6x964lr8s5b7avrqqrw4rvkl8sazbm3c5h911w0a";
        authors = [
      ...
      "swaylayout" = rec {
        crateName = "swaylayout";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "swaylayout"; path = "src/main.rs"; }
        ];
