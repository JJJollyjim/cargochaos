...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/terraform-sage/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "terraform-sage" = rec {
        crateName = "terraform-sage";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "terraform-sage"; path = "src/main.rs"; }
        ];
