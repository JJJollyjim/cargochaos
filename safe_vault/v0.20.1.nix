...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/safe_vault/v0.20.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quic-p2p" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "15j88vijbb6yzdq57jsrsqi2r9fwmf5lgc16fr9xhpxzraw8q0cx";
        authors = [
      ...
      "quinn" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1n86dbfzm51gjm35vvjlcqyarkag2a9br25qkak9fgvsz6cvfycz";
        authors = [
      ...
      "quinn-proto" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0r9z23pr61ivwf03v2589hxzg59dz4wn2rhar6k6c037bpfbdbm5";
        authors = [
          "Benjamin Saunders <ben.e.saunders@gmail.com>"
          "Dirkjan Ochtman <dirkjan@ochtman.nl>"
        ];
      ...
      "rcgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1vbnan3781ysd55x3gpmdjpyrzz13ksx2yvpb4izgp04j3dvv8b5";
        authors = [
      ...
      "safe-nd" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "084pbc2wiy3wvn8f9azmbv9pij2s21yq70g0l5ks2xidqdc01qx3";
        authors = [
          "MaidSafe Developers <dev@maidsafe.net>"
        ];
        dependencies = [
      ...
      "safe_vault" = rec {
        crateName = "safe_vault";
        version = "0.20.1";
        edition = "2018";
        crateBin = [
          { name = "safe_vault"; path = "src/bin/safe_vault.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "fxhash" "hex_fmt" "mock" "quic-p2p" ];
      };
      "safemem" = rec {
        crateName = "safemem";
        version = "0.3.2";
      ...
      "self_update" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "0x2dqiyf9qy07h168vam98l7pq0f9w4gspjb4gm3p7rj53c9fjaf";
        authors = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
