...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/h2/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "stream" "sync" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
