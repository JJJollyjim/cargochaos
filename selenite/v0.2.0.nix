...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/selenite/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pqcrypto-falcon" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1k7qlj2d4lxi8x6ndlyhyrqsxsyw28v2ipdy6jk5scy1h0ax3lp2";
        authors = [
      ...
      "pqcrypto-newhope" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1y2rlw167gjyghqlj35c4qlqh3ag5wfwln4i3v95ywrnchnjyc5f";
        authors = [
          "Thom Wiggers <thom@thomwiggers.nl>"
        ];
        dependencies = [
      ...
      "pqcrypto-qtesla" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1brm2273hvb9bckqdrsisqfyn019pllmq3jvkk0c0isgsny08hbn";
        authors = [
          "Thom Wiggers <thom@thomwiggers.nl>"
        ];
        dependencies = [
      ...
      "pqcrypto-sphincsplus" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "1d8a23q15iiz9pk4zjw85isqb4rs2r60qq2h8smw3887hnh4w58n";
        authors = [
          "Thom Wiggers <thom@thomwiggers.nl>"
        ];
        dependencies = [
