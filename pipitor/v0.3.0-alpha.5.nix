...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pipitor/v0.3.0-alpha.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "libsqlite3-sys" "r2d2" "sqlite" ];
      };
      "diesel_derives" = rec {
      ...
      "diesel_migrations" = rec {
        ...
        resolvedDefaultFeatures = [ "sqlite" ];
      };
      "digest" = rec {
        crateName = "digest";
        version = "0.8.1";
      ...
      "oauth1-request" = rec {
        crateName = "oauth1-request";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1ry66fnd7ccvp8yhgf9gp2fj6jkf74myg8cmgry0dw7k0p70c91h";
        authors = [
          "Daiki Mizukami <tesaguriguma@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
          ...
          }
          {
            ...
            packageId = "oauth1-request-derive";
            optional = true;
          }
          {
        ...
        resolvedDefaultFeatures = [ "default" "derive" "hmac" "hmac-sha1" "oauth1-request-derive" "sha-1" ];
      };
      "oauth1-request-derive" = rec {
        crateName = "oauth1-request-derive";
        version = "0.3.1";
        edition = "2018";
        sha256 = "0kqlad33xhwizhavir2a966zr06mncp9rwnq0x4ih72yddgjcga2";
        procMacro = true;
        authors = [
          "Daiki Mizukami <tesaguriguma@gmail.com>"
        ];
      ...
      "pipitor" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pipitor"; path = "src/bin/pipitor/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-std" "signal" "stream" "time" "uds" ];
          }
          {
            name = "toml";
            packageId = "toml";
        ...
        resolvedDefaultFeatures = [ "ct-logs" "default" "hyper" "hyper-rustls" "hyper-tls" "libsqlite3-sys" "native-tls" "openssl-vendored" "rustls" "rustls-pkg" "sqlite-bundled" "webpki-roots" ];
      };
      "pkg-config" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "rt-core" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "uds" "winapi" ];
      };
      "tokio-rustls" = rec {
      ...
      "twitter-stream" = rec {
        crateName = "twitter-stream";
        version = "0.10.0-alpha.5";
        edition = "2018";
        sha256 = "17c3yhdxr6ks5sc3ig9v9fkihq6rwxjv6i7yw11j9ar19wy6xb4i";
        authors = [
          "Daiki Mizukami <tesaguriguma@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
