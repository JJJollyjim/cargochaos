...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/may/v0.3.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "generator" = rec {
        ...
        version = "0.6.16";
        edition = "2018";
        sha256 = "0x4ksyx7hcmpficrj55vnd9s6xj3lllq5in6nkcvbarmdsfj7s8k";
        authors = [
      ...
      "may_queue" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "0pdfpmfk98irmc261rxzb7agv7y5j410a2gql5dwnpa181y1105j";
        authors = [
          "Xudong Huang <huangxu008@hotmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
