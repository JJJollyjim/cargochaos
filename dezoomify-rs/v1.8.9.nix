...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dezoomify-rs/v1.8.9.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dezoomify-rs" = rec {
        crateName = "dezoomify-rs";
        version = "1.8.9";
        edition = "2018";
        crateBin = [
          { name = "dezoomify-rs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.8.9.nix {};
        authors = [
          "lovasoa"
        ];
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-threaded" "rt-core" "macros" "rt-util" "time" "fs" ];
          }
        ];
      ...
      "evalexpr" = rec {
        ...
        version = "4.1.0";
        edition = "2015";
        sha256 = "1fp4kd3a35qh4s0065001w3cj4safr8vhnfsqhw9xi10wxx7qnym";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "rt-util" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
