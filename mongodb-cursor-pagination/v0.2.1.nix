...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mongodb-cursor-pagination/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mongodb" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "0f5ixib6hzi4r3gn20a4mb676rgb35kd2xvdks5r5jp7a0h6q9nf";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "impl-debug" "impl-default" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "winuser" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
