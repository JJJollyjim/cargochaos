...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/userfaultfd/v0.2.0.nix.tmp"
      ...
      "userfaultfd" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "userfaultfd-sys";
          }
        ];
        
      };
      "userfaultfd-sys" = rec {
        crateName = "userfaultfd-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "00xca1vf755f13idrlf13b74glcx53dkjq9gk248krxgdlghhd1y";
        authors = [
          "Adam C. Foltzer <acfoltzer@fastly.com>"
        ];
        dependencies = [
