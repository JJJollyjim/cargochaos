...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kademlia-dht/v1.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bincode" = rec {
        ...
        version = "0.9.2";
        edition = "2015";
        sha256 = "1bzi5w0daikmxj9jn913yg6h2w8l93imlny13dan7ys91gdh2qws";
        authors = [
      ...
      "kademlia-dht" = rec {
        crateName = "kademlia-dht";
        version = "1.2.0";
        edition = "2018";
        crateBin = [
          { name = "kademlia-dht"; path = "src/main.rs"; }
        ];
      ...
      "sha3" = rec {
        ...
        version = "0.7.3";
        edition = "2015";
        sha256 = "1g1hfm3r5wwcfbacv3lyagb90ijngzq3vdb2nnghnaflkvswwkdn";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
