...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/persy_expimp/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "persy" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1mpw5bijbzy50pdzm228drd68xwh9p53x552256dygsjf4gjx6si";
        authors = [
      ...
      "persy_expimp" = rec {
        crateName = "persy_expimp";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "persy_expimp"; path = "src/bin/persy_expimp.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "cli" "data-encoding" "json" "serde_json" "structopt" ];
      };
      "ppv-lite86" = rec {
