...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/s3-algo/v0.1.16.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-stopwatch" = rec {
        crateName = "futures-stopwatch";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0iax07ifcaj291fikixs01c5gji1m2q27frl3yc211jd8ry7bswm";
        authors = [
      ...
      "multi-default-trait-impl" = rec {
        crateName = "multi-default-trait-impl";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1r6y5zb6kg655zi02yk4amkwsgds5ay9ag1dk30cls7rn3dlvvqs";
        procMacro = true;
        authors = [
      ...
      "s3-algo" = rec {
        ...
        dependencies = [
          ...
          {
            name = "futures-stopwatch";
            packageId = "futures-stopwatch";
          }
          {
            name = "rusoto_core";
            packageId = "rusoto_core";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "time" "fs" "macros" "rt-threaded" "io-util" "sync" ];
          }
          {
            name = "tokio-util";
            packageId = "tokio-util";
        ...
        devDependencies = [
          ...
          {
            name = "multi-default-trait-impl";
            packageId = "multi-default-trait-impl";
          }
          {
            name = "rand";
      ...
      "snafu" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1b8bjaddj0clj9faib1lm3ffaifhki4kdklnlrkmnm33z22974k5";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "futures" "futures-core-crate" "pin-project" "std" ];
      };
      "snafu-derive" = rec {
        crateName = "snafu-derive";
        version = "0.6.1";
        edition = "2018";
        sha256 = "105f9r9gb3847jnrknnw4imypqs32kjj33fcf9gby6nkmz8v3ln6";
        procMacro = true;
        authors = [
          "Jake Goulding <jake.goulding@gmail.com>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "num_cpus" "process" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "slab" "sync" "tcp" "time" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
