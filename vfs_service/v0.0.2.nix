...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vfs_service/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "file_node" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "0lj29vlg4xa5wzfda3y4fkvlmkm5n53b93ggyshf6h0s6g9bxqph";
        authors = [
          "Drake Talley robertdraketalley@gmail.com"
        ];
        
      };
      "file_store" = rec {
        crateName = "file_store";
        version = "0.0.1";
        edition = "2018";
        sha256 = "0nbgzad4x5znw4gg1k12gixcl8lwanb7mm5nzz93qjiil1l32p0j";
        authors = [
          "Drake Talley robertdraketalley@gmail.com"
        ];
        dependencies = [
