...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grid_search_cardinal_point_to_point/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "grid_search_cardinal_point_to_point";
  ...
  workspaceMembers = {
    "grid_search_cardinal_point_to_point" = rec {
      packageId = "grid_search_cardinal_point_to_point";
      build = internal.buildRustCrateWithFeatures {
        packageId = "grid_search_cardinal_point_to_point";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coord_2d" = rec {
        ...
        version = "0.2.19";
        edition = "2018";
        sha256 = "16s1zljbigjxapjwnxdkm2x4yqpawks9xybnvag0cjp2160136ap";
        authors = [
        ...
        resolvedDefaultFeatures = [ "rand" "serde" "serialize" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.3.1";
      ...
      "grid_2d" = rec {
        ...
        version = "0.14.2";
        edition = "2018";
        sha256 = "0gdmiqq9q3vhxkyg7nbpzjjrn50py3arf0fxwf0x4cdarg46yc56";
        authors = [
          "Stephen Sherratt <sfsherratt@gmail.com>"
        ];
        dependencies = [
      ...
      "grid_search_cardinal_common" = rec {
        crateName = "grid_search_cardinal_common";
        version = "0.2.0";
        edition = "2018";
        sha256 = "17iqc86k1kn6szd9npmy81z0wdfjamzhdcx403g2q7p7s5wfg9dj";
        authors = [
        ...
        features = {
          "serialize" = [ "serde" "grid_2d/serialize" "direction/serialize" ];
        };
        resolvedDefaultFeatures = [ "serde" "serialize" ];
      };
      "grid_search_cardinal_point_to_point" = rec {
        crateName = "grid_search_cardinal_point_to_point";
        version = "0.2.0";
        edition = "2018";
        ...
        dependencies = [
          ...
          {
            name = "grid_search_cardinal_common";
            packageId = "grid_search_cardinal_common";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "grid_search_maze" = rec {
        crateName = "grid_search_maze";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0jbi23pq7s7vvrclmfinnv9p0dpzvf1rgbwqyfiab5r0ip4sgv0j";
        authors = [
          "Stephen Sherratt <stephen@sherra.tt>"
        ];
        dependencies = [
