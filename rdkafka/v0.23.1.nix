...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rdkafka/v0.23.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rdkafka" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "blocking" "macros" "rt-core" "time" ];
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "cmake-build" "cmake_build" "default" "dynamic_linking" "external-lz4" "external_lz4" "gssapi" "libz" "libz-static" "sasl" "ssl" "ssl-vendored" "zstd" "zstd-pkg-config" ];
      };
      "rdkafka-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "cmake" "cmake-build" "cmake_build" "dynamic_linking" "external-lz4" "external_lz4" "gssapi" "libz" "libz-static" "libz-sys" "lz4-sys" "openssl-sys" "sasl" "ssl" "ssl-vendored" "zstd" "zstd-pkg-config" "zstd-sys" ];
      };
      "rdrand" = rec {
        crateName = "rdrand";
        version = "0.4.0";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "macros" "rt-core" "slab" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "zstd-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "legacy" "pkg-config" ];
      };
    };
