...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/atat/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atat" = rec {
        ...
        resolvedDefaultFeatures = [ "atat_derive" "default" "derive" ];
      };
      "atat_derive" = rec {
        crateName = "atat_derive";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0g7xmsxhs72cbsqmk6s2migz0207g1fflg6ra53pbn10682dbqy3";
        procMacro = true;
        authors = [
          "Mathias Koch <mk@blackbird.online>"
        ];
      ...
      "embedded-hal-mock" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "0klbz9l1lm6mqy7ba2k6pn194d8fq3k3zmbja2r3wnj5nl53wbnj";
        authors = [
      ...
      "heapless" = rec {
        ...
        resolvedDefaultFeatures = [ "cas" "default" "serde" ];
      };
      "indexmap" = rec {
        crateName = "indexmap";
        version = "1.3.2";
      ...
      "serde_at" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "04v6bnaxw0vw2jvpclarhj01wrxjsrapzy5l43vdg0f0gxvyias2";
        authors = [
          "Mathias Koch <mk@blackbird.online>"
        ];
        dependencies = [
      ...
      "ufmt" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1844qwbmc4m69nfi6xmdcdf4fmjjvypi9rpfg3wgilvrxykwwzif";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
      ...
      "ufmt-macros" = rec {
        crateName = "ufmt-macros";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0sf0z9f6kjw5h15xd1hlj46dgri59lqwin1fxrcdradzl8s3x0gd";
        procMacro = true;
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
