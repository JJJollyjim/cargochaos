...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/devicon-lookup/v0.7.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "devicon-lookup" = rec {
        crateName = "devicon-lookup";
        version = "0.7.1";
        edition = "2018";
        crateBin = [
          { name = "devicon-lookup"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.7.1.nix {};
        authors = [
          "Corey Alexander <coreyja@gmail.com>"
        ];
        dependencies = [
          {
            name = "docopt";
