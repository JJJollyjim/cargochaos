...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-abusiveexperiencereport1-cli/v1.0.12+20190624.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-abusiveexperiencereport1-cli";
  ...
  workspaceMembers = {
    "google-abusiveexperiencereport1-cli" = rec {
      packageId = "google-abusiveexperiencereport1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-abusiveexperiencereport1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-abusiveexperiencereport1" = rec {
        crateName = "google-abusiveexperiencereport1";
        version = "1.0.12+20190624";
        edition = "2015";
        sha256 = "1hxvjz39rdb378555pnjvww1y1r5z03s11vwcl0wdzcd7zdjfl61";
        authors = [
      ...
      "google-abusiveexperiencereport1-cli" = rec {
        crateName = "google-abusiveexperiencereport1-cli";
        version = "1.0.12+20190624";
        edition = "2015";
        crateBin = [
          { name = "abusiveexperiencereport1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190624.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-abusiveexperiencereport1";
          }
          {
            name = "hyper";
            packageId = "hyper";
