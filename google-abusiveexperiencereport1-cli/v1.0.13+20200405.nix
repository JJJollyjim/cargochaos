...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-abusiveexperiencereport1-cli/v1.0.13+20200405.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-abusiveexperiencereport1" = rec {
        ...
        edition = "2015";
        sha256 = "0admiac6rjx6gcxqqmbgyiz6qf8gfbl7pbnp5kwbkl08lncgjyp3";
        authors = [
