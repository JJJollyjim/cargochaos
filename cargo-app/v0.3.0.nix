...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-app/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-app" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-app"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "tga <tga@wengwengweng.me>"
        ];
        dependencies = [
          {
            name = "cargo_toml";
      ...
      "cargo_toml" = rec {
        ...
        version = "0.6.4";
        edition = "2018";
        sha256 = "1abmbnal0c2rlycmv33xspykfn8yvq2x0kwiklyshrm59gk5qzq9";
      ...
      "packapp" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "12q6mk4564as41lfdgwdpz4szrj44w0yg7dwr23izrgf7bskrmvj";
        authors = [
          "tga <tga@wengwengweng.me>"
        ];
        dependencies = [
