...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rcon-shell/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rcon" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "06gzn3f0hmpd163ciql916jh0520dz7qzg726aj3fzvf6nlip92j";
        authors = [
          "panicbit <panicbit@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "err-derive";
        ...
        resolvedDefaultFeatures = [ "default" "delay" ];
      };
      "rcon-shell" = rec {
        crateName = "rcon-shell";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "rcon-shell"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Nick Farley <nick-1154@hotmail.com>"
        ];
        dependencies = [
          {
            name = "directories";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
