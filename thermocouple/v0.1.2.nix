...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thermocouple/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "thermocouple" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "extrapolate" "f32" "f64" "k-type" "libm" "use_serde" ];
      };
    };
