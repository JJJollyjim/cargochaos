...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webrtc-audio-processing/v0.3.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "webrtc-audio-processing";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "autotools" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "150hff6w3xmirqlgrjw7byyvhxp17ld67b8b58q3kaarsjrd2kvp";
        authors = [
      ...
      "webrtc-audio-processing" = rec {
        crateName = "webrtc-audio-processing";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Ryo Kawaguchi <ryo@kawagu.ch>"
        ];
        dependencies = [
          {
            name = "webrtc-audio-processing-sys";
            packageId = "webrtc-audio-processing-sys";
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "bundled" "derive_serde" ];
      };
      "webrtc-audio-processing-sys" = rec {
        crateName = "webrtc-audio-processing-sys";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0014wknw3g8hvpzs0px3kdkr10l2n3xab9g5qq18040k21pb6rwz";
        authors = [
          "Ryo Kawaguchi <ryo@kawagu.ch>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "bundled" "derive_serde" "serde" ];
      };
      "which" = rec {
        crateName = "which";
        version = "3.1.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" ];
      };
