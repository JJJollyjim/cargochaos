...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/leaky-bucket/v0.7.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "leaky-bucket" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "static" ];
      };
      "log" = rec {
        crateName = "log";
        version = "0.4.8";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "macros" "rt-core" "slab" "stream" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
