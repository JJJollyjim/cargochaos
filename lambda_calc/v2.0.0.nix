...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lambda_calc/v2.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lambda_calc" = rec {
        crateName = "lambda_calc";
        version = "2.0.0";
        edition = "2018";
        crateBin = [
          { name = "lambda_calc"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v2.0.0.nix {};
        authors = [
          "Mateus Carmo M de F Barbosa <mcmfb@protonmail.com>"
        ];
        dependencies = [
          {
            name = "rustyline";
