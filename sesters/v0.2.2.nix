...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sesters/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kv" = rec {
        ...
        version = "0.9.2";
        edition = "2018";
        sha256 = "12zlk282101l27m68h6phiba753bkg1bjszbqyln5bwly5z7wv5j";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bincode" "bincode-value" "default" ];
      };
      "lazy_static" = rec {
      ...
      "lmdb-rkv" = rec {
        ...
        version = "0.11.4";
        edition = "2015";
        sha256 = "0vkbpc6w248xfg5p74fcyz321v4ay4lq5mbgkl3arxwvg1ll0nz2";
        libName = "lmdb";
        authors = [
      ...
      "lmdb-rkv-sys" = rec {
        ...
        version = "0.8.6";
        edition = "2015";
        sha256 = "0w1c4kjbf76glcl66zhi463ikgxy0p0hfgfg9kxd9921rql2f3n6";
        authors = [
          "Dan Burkert <dan@danburkert.com>"
        ];
        dependencies = [
      ...
      "sesters" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "sesters"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "Clément Joly <oss+sesters@131719.xyz>"
        ];
        dependencies = [
          {
            name = "bincode";
      ...
      "test-case" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0l5q1918j74qx3pc9d8asdkwx81hj3yazxa3k2kin65y8y83sp17";
        procMacro = true;
        authors = [
