...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/addon_distributor/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "addon_distributor" = rec {
        crateName = "addon_distributor";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "addon_distributor"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Akshay S Dinesh <asdofindia@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
