...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spotify-tui/v0.17.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default" "default-tls" "hyper-tls" "json" "native-tls-crate" "serde_json" "socks" "tokio-socks" "tokio-tls" ];
      };
      "rspotify" = rec {
        crateName = "rspotify";
        version = "0.9.0";
        edition = "2018";
        sha256 = "1dbf3n58xna7riivi2hqf76g1s6vvlmsw2a6lhg9n8ap6pd7k6yj";
        authors = [
      ...
      "spotify-tui" = rec {
        crateName = "spotify-tui";
        version = "0.17.1";
        edition = "2018";
        crateBin = [
          { name = "spt"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
