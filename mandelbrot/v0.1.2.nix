...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mandelbrot/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "inflate" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1r9pqj7mpgjajhfbn1vrl25vhm2qafchi63lgj597wsscwj8a8yi";
        authors = [
          "nwin <nwin@users.noreply.github.com>"
        ];
        features = {
      ...
      "mandelbrot" = rec {
        crateName = "mandelbrot";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "mandelbrot"; path = "src/main.rs"; }
        ];
      ...
      "png" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "0s0qnvnzfvy64zigz1985d8r9nry0anmcyrwllxpbhl382w9gws8";
        authors = [
          "nwin <nwin@users.noreply.github.com>"
        ];
        dependencies = [
