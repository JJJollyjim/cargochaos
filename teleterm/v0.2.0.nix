...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/teleterm/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "component-future" = rec {
        crateName = "component-future";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0qid8kwniav6ispjc51xaik533j4ywcrzw8flv1hlvhixwf4wg04";
        authors = [
      ...
      "crossterm" = rec {
        ...
        version = "0.13.2";
        edition = "2018";
        sha256 = "19kp9qxc2sbsn0li43pmkdazprp2zh5m4yv7f2yhg4h7ggi60ab8";
        authors = [
          "T. Post"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cursor" "input" "lazy_static" "mio" "screen" "terminal" ];
      };
      ...
      "teleterm" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "crossterm";
            usesDefaultFeatures = false;
            features = [ "terminal" "input" "screen" ];
          }
          {
            name = "directories";
          ...
          }
          {
            ...
            packageId = "snafu";
            usesDefaultFeatures = false;
            features = [ "rust_1_30" "futures-01" ];
          }
          {
            name = "tokio";
            packageId = "tokio";
            usesDefaultFeatures = false;
            features = [ "codec" "fs" "io" "reactor" "rt-full" "sync" "tcp" "timer" ];
          }
          {
            name = "tokio-pty-process-stream";
            packageId = "tokio-pty-process-stream";
          }
          {
            name = "tokio-signal";
          ...
          }
          {
            ...
            packageId = "tokio-terminal-resize";
          }
          {
            name = "tokio-tls";
            packageId = "tokio-tls";
      ...
      "tokio-pty-process-stream" = rec {
        crateName = "tokio-pty-process-stream";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1y6ry846dszswcqvvwrpyzql3ad4fp52hb0n88qqlz4hndrkxiw7";
        authors = [
          "Jesse Luehrs <doy@tozt.net>"
        ];
        dependencies = [
      ...
      "tokio-terminal-resize" = rec {
        crateName = "tokio-terminal-resize";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1i2fq3jp19gbr1pd77b0qkpq06hnlcnz66nyi5qsx8llpyjia6ch";
        authors = [
          "Jesse Luehrs <doy@tozt.net>"
        ];
        dependencies = [
      ...
      "ttyrec" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "019ck27kpr72v2d5bf2r8r9hpy1kjsbsl7wf4fsy5c7gnicqgqi4";
        authors = [
          "Jesse Luehrs <doy@tozt.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "async" "default" "futures" "tokio" ];
      };
      "twoway" = rec {
        crateName = "twoway";
        version = "0.2.1";
      ...
      "vt100" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "12mx57yn7s9lx0csvkgq0zhhzyp982b2lfhzwrkr4l3pxp0w9kj9";
        authors = [
          "Jesse Luehrs <doy@tozt.net>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
