...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cw-nameservice/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cosmwasm" = rec {
        ...
        version = "0.6.3";
        edition = "2018";
        sha256 = "0pbkfsq8aqfxhb40l3519jq2gr33wxz017146sdfdkin64agd0ck";
        authors = [
      ...
      "cosmwasm-vm" = rec {
        ...
        version = "0.6.3";
        edition = "2018";
        sha256 = "0y4csyn34qdsprh1rk9gvv0h8paahfmjhpfv1x9x33cgncsnsdpd";
        authors = [
          "Ethan Frey <ethanfrey@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "cw-storage" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "018ykligsyxdl8rax1g3fd6nfc45shwf3g0cqadgdzxk9q3pgrri";
        authors = [
          "Ethan Frey <ethanfrey@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "parity-wasm" = rec {
        ...
        version = "0.19.3";
        edition = "2015";
        sha256 = "1scza5h329l695g14jgq83kwynr8cngay6k0bqxn9mydsqf2fl1x";
        authors = [
      ...
      "wasm-nm" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0ah6b885a1qzyqd6kb7skcj052dxaj7yx0gryz0kwfhp9xr5kkxq";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
        dependencies = [
      ...
      "wasmer-middleware-common" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "1ivy98f0ml6nlflcx1pi68vp8s67sg9cvr6iib0pcn66fclqcahy";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
      ...
      "wasmer-singlepass-backend" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "01g8kvbcrc857lkml8yvrbwl3vfnsi6ryxz26f35j3z0f0yxmd2r";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "winbase" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
