...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbl-rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default-tls" "hyper-rustls" "hyper-tls" "json" "native-tls-crate" "rustls" "rustls-tls" "serde_json" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
