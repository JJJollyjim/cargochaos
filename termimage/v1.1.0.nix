...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/termimage/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "termimage" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "termimage"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "processenv" "winbase" "wincon" ];
      };
      "winapi-build" = rec {
