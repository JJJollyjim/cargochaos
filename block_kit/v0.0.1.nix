...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/block_kit/v0.0.1.nix.tmp"
    ...
    crates = {
      ...
      "actix-connect 1.0.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "actix-service";
            packageId = "actix-service 1.0.0";
          }
          {
            name = "actix-utils";
            packageId = "actix-utils 1.0.3";
          }
          {
            name = "derive_more";
      ...
      "actix-http 1.0.0-alpha.6" = rec {
        ...
        resolvedDefaultFeatures = [ "actix-tls" "default" "fail" "failure" "flate2" "flate2-zlib" "openssl" ];
      };
      "actix-macros" = rec {
      ...
      "actix-web" = rec {
        ...
        resolvedDefaultFeatures = [ "awc" "client" "default" "fail" "flate2-zlib" "open-ssl" "openssl" ];
      };
      ...
      "awc" = rec {
        ...
        resolvedDefaultFeatures = [ "flate2-zlib" "open-ssl" "openssl" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.40";
      ...
      "block_kit" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "block_kit"; path = "src/main.rs"; }
        ];
