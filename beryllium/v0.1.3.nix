...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/beryllium/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "beryllium" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "impl_global_alloc" "link_dynamic" "link_static" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.1.0";
      ...
      "fermium" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0qhmqvq1x7l0k38l8kx4h2z0n31ilm87w142w1spilrs5vz5gxs6";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cmake" "link_dynamic" "link_static" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "gl" = rec {
        ...
        version = "0.12.0";
        edition = "2015";
        sha256 = "135v8ld0545qwd6igi07600p6wra2nnjhqxwaj29f2sjjdsq27dx";
        authors = [
          "Brendan Zabarauskas <bjzaba@yahoo.com.au>"
          "Corey Richardson"
          "Arseny Kapoulkine"
