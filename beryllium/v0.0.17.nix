...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/beryllium/v0.0.17.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "beryllium" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dynamic_link" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.1.0";
      ...
      "fermium" = rec {
        ...
        version = "0.0.15";
        edition = "2018";
        sha256 = "1qvblh48550j7fm09mhq6qcx81d6c0sgzq4njxaf3chi7iy7y4f7";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
