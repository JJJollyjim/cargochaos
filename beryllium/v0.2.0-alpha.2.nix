...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/beryllium/v0.2.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "beryllium" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "extern_crate_raw_window_handle" "link_dynamic" "link_static" "raw-window-handle" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.47";
