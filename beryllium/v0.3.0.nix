...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/beryllium/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "beryllium" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dynamic_link" "extern_crate_raw_window_handle" "raw-window-handle" "static_link" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.47";
      ...
      "fermium" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1gw2cglwr2hv52mcswji9xqw3c44xih66rs9n8ysddsgrqp7g6s5";
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cmake" "dynamic_link" "static_link" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.65";
