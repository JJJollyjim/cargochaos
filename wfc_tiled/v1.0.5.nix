...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wfc_tiled/v1.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coord_2d" = rec {
        ...
        version = "0.2.15";
        edition = "2015";
        sha256 = "0qjkj3ip7dixkvy32by34jkxa55dnnb4rxz05yd0wj53inc17zbl";
        authors = [
      ...
      "direction" = rec {
        ...
        version = "0.17.8";
        edition = "2018";
        sha256 = "0vp3jd6ddggzmm00yh6widl5l6pxr5palid8qf9y4z3i0yp9c3j0";
        authors = [
          "Stephen Sherratt <sfsherratt@gmail.com>"
        ];
        dependencies = [
      ...
      "wfc" = rec {
        ...
        version = "0.8.1";
        edition = "2015";
        sha256 = "165gl2xac2a0xmy47i26a667z594lkqd89vzh3d1826h0df7i701";
        authors = [
