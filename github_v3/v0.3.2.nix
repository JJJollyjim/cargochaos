...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/github_v3/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "github_v3" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "gzip" ];
      };
      "h2" = rec {
        crateName = "h2";
        version = "0.2.1";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "default" "default-tls" "gzip" "hyper-tls" "json" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.2";
