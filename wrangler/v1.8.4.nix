...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wrangler/v1.8.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "billboard" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1vk5xq9zvkc1qjm9vvlxkkxwdb1y843c7ngvxh1wm1w8nxk9m4ac";
        authors = [
          "Avery Harnish <averyharnish@gmail.com>"
        ];
        dependencies = [
          {
            name = "console";
      ...
      "binary-install" = rec {
        crateName = "binary-install";
        version = "0.0.3-alpha";
        edition = "2015";
        sha256 = "01izhq3wq648wjy32mv667pqmnp390zfmwk1rxqq5fnvy8bxl7d8";
        authors = [
      ...
      "chrome-devtools-rs" = rec {
        crateName = "chrome-devtools-rs";
        version = "0.0.0-alpha.0";
        edition = "2018";
        sha256 = "0lnphw08yzmc72fc3fis2yb26jslh6rig7xd3ah848vbmnhvisfy";
        libName = "chrome_devtools";
        authors = [
          "Avery Harnish <averyharnish@gmail.com>"
        ];
        dependencies = [
      ...
      "cloudflare" = rec {
        ...
        version = "0.6.4";
        edition = "2018";
        sha256 = "1f028fbfq6h840gi48sgph4va32q13njw05caihdhpfwj8s0vrhc";
        authors = [
      ...
      "serde_qs" = rec {
        ...
        version = "0.4.6";
        edition = "2015";
        sha256 = "1bx0smxp08vmfrzfl03jyzxn65rybhgxzhk77l2ifds1sahmz5im";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "udp" "uds" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
      ...
      "wrangler" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wrangler"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.8.4.nix {};
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "binary-install";
            packageId = "binary-install";
          }
          {
            name = "chrome-devtools-rs";
            packageId = "chrome-devtools-rs";
            features = [ "color" ];
          }
          {
            name = "chrono";
