...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lorikeet/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lorikeet" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lorikeet"; path = "src/main.rs"; }
        ];
      ...
      "serde_test" = rec {
        ...
        version = "1.0.106";
        edition = "2015";
        sha256 = "0liq1w07p2vgcl047wg0avnxfwwf0w6j9wwfwrsnq9cwq6a0dy28";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "sys-info" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "1lfzmlnbvi7iacx6pn1cda3s2vw9m0x0p02sxfawm1v3p7p0gfsb";
        libName = "sys_info";
        libPath = "lib.rs";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
