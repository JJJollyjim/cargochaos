...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scryer-prolog/v0.8.120.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gmp-mpfr-sys" = rec {
        ...
        version = "1.1.14";
        edition = "2015";
        sha256 = "1ysm543ndl05844wc44yy39214c35v22aj2185ggmviza7bjqnbj";
        authors = [
          "Trevor Spiteri <trevor.spiteri@um.edu.mt>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "num-rug-adapter" = rec {
        crateName = "num-rug-adapter";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0ar7xd3sbi8p5pfrmpc1kzg2bii0ss6mwj96y5g54pvsphvblva8";
        authors = [
      ...
      "prolog_parser" = rec {
        crateName = "prolog_parser";
        version = "0.8.51";
        edition = "2015";
        sha256 = "0g0wqxlgzsnjm6jhls03si6idp3p6w08zgw3kjgfnxmsry216yki";
        authors = [
        ...
        resolvedDefaultFeatures = [ "num" "num-rug-adapter" "rug" ];
      };
      "quote 0.6.13" = rec {
        crateName = "quote";
        version = "0.6.13";
      ...
      "rug" = rec {
        ...
        version = "1.5.2";
        edition = "2018";
        sha256 = "1d9qq1bq0qqn7f9g3bkc4q5miamkq8940d9726wwybs5p8dklbsr";
        authors = [
          "Trevor Spiteri <trevor.spiteri@um.edu.mt>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "complex" "default" "float" "gmp-mpfr-sys" "integer" "rand" "rational" ];
      };
      "rust-argon2" = rec {
      ...
      "scryer-prolog" = rec {
        crateName = "scryer-prolog";
        version = "0.8.120";
        edition = "2018";
        crateBin = [
          { name = "scryer-prolog"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.8.120.nix {};
        authors = [
          "Mark Thom <markjordanthom@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "num" "num-rug-adapter" "rug" ];
      };
      "signal-hook" = rec {
      ...
      "unicode_reader" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0d1hrpj7vcc42nacz6zcks5556dxknb8y25i9j0dnrdyl82x91pq";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-default" "knownfolders" "minwindef" "ntsecapi" "ntstatus" "objbase" "processenv" "shlobj" "synchapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
