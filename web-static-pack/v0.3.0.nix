...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/web-static-pack/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "web-static-pack" = rec {
        crateName = "web-static-pack";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Paweł Kubrak <peku33@gmail.com>"
        ];
        dependencies = [
          {
            name = "failure";
        ...
        resolvedDefaultFeatures = [ "default" "http" "http-body" "hyper" "hyper_loader" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
