...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mkgitignore/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mkgitignore" = rec {
        crateName = "mkgitignore";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "mkgitignore"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Dante Helmore <cprootintootinsecrets@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
