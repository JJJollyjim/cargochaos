...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-binaryauthorization1_beta1-cli/v1.0.12+20190628.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-binaryauthorization1_beta1-cli";
  ...
  workspaceMembers = {
    "google-binaryauthorization1_beta1-cli" = rec {
      packageId = "google-binaryauthorization1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-binaryauthorization1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-binaryauthorization1_beta1" = rec {
        crateName = "google-binaryauthorization1_beta1";
        version = "1.0.12+20190628";
        edition = "2015";
        sha256 = "1q7jw6778q8a30frd4lkngpcq5xzrqsi91rj2ykj9r6g1dra17rj";
        authors = [
      ...
      "google-binaryauthorization1_beta1-cli" = rec {
        crateName = "google-binaryauthorization1_beta1-cli";
        version = "1.0.12+20190628";
        edition = "2015";
        crateBin = [
          { name = "binaryauthorization1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190628.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-binaryauthorization1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
