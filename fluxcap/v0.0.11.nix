...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluxcap/v0.0.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "abackus" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0hd2fmamqfpskv0msym9ywd2l97c1fgjfi2kml4yigpdrqi4hyv1";
        authors = [
      ...
      "earlgrey" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "15n638mzxcbpd2caxndrgfqnzjal9brs61qivmjplhrxnb6y9jal";
        authors = [
          "Rodolfo Granata <warlock.cc@gmail.com>"
        ];
        features = {
      ...
      "fluxcap" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "flux"; path = "src/bin/flux.rs"; }
        ];
      ...
      "kronos" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0c2x85j06s1z5r1jk856fvqizxmp3jriwyph20g8crw0ylrvbymp";
        authors = [
          "Rodolfo Granata <warlock.cc@gmail.com>"
        ];
        dependencies = [
