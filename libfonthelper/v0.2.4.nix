...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libfonthelper/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "finder" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1bk1fv4wmrkhmggkiw98g249xh638d6h9lvfqmd45j6zn9p3xwh0";
        authors = [
          "Chugunov Roman <Zebs-BMK@yandex.ru>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "freetype-rs" = rec {
        ...
        version = "0.21.0";
        edition = "2015";
        sha256 = "1hc0wz79vz6r0d3jybyzpqds9yv0147sj13dnxwmqp8kfk8q1bm8";
        libName = "freetype";
        authors = [
      ...
      "libfonthelper" = rec {
        crateName = "libfonthelper";
        version = "0.2.4";
        edition = "2018";
        crateBin = [
          { name = "libfonthelper"; path = "src/main.rs"; }
        ];
