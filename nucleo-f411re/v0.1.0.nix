...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nucleo-f411re/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nucleo-f411re" = rec {
        crateName = "nucleo-f411re";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Zisis Adamos <zisarono@gmail.com>"
        ];
        dependencies = [
          {
            name = "bare-metal";
      ...
      "stm32f4" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f411" ];
      };
      "stm32f4xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "device-selected" "rt" "stm32f411" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
