...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ccache_stats_reader_extras/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "ccache_stats_reader_extras";
  ...
  workspaceMembers = {
    "ccache_stats_reader_extras" = rec {
      packageId = "ccache_stats_reader_extras";
      build = internal.buildRustCrateWithFeatures {
        packageId = "ccache_stats_reader_extras";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ccache_stats_reader" = rec {
        crateName = "ccache_stats_reader";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1qsk5dg98ck9s6kydd802d0j50sk7i4xp81jzx9n0acwj3rafjhi";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "external_doc" "nightly" "non_exhaustive" ];
      };
      "ccache_stats_reader_extras" = rec {
        crateName = "ccache_stats_reader_extras";
        version = "0.1.0";
        edition = "2018";
        ...
        dependencies = [
          {
            ...
            packageId = "ccache_stats_reader";
          }
        ];
        features = {
          "nightly" = [ "ccache_stats_reader/nightly" ];
        };
