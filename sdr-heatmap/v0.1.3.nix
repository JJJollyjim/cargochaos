...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sdr-heatmap/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sdr-heatmap" = rec {
        crateName = "sdr-heatmap";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "sdr-heatmap"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "J2ghz <j2.00ghz@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
