...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cdrs-async/v0.1.0-alpha.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cassandra-proto" = rec {
        crateName = "cassandra-proto";
        version = "0.1.2";
        edition = "2018";
        sha256 = "05nh5qxdqkd78zyjg8l40vd5c374182afszdm7sf6j4v37j47dc5";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
