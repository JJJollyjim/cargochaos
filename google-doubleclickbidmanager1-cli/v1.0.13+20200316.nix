...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-doubleclickbidmanager1-cli/v1.0.13+20200316.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-doubleclickbidmanager1-cli";
  ...
  workspaceMembers = {
    "google-doubleclickbidmanager1-cli" = rec {
      packageId = "google-doubleclickbidmanager1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-doubleclickbidmanager1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-doubleclickbidmanager1" = rec {
        crateName = "google-doubleclickbidmanager1";
        version = "1.0.13+20200316";
        edition = "2015";
        sha256 = "09dii0kpfgvqls868y0jkbsv9vh511hz5lvpji9jmirrny7mawiz";
        authors = [
      ...
      "google-doubleclickbidmanager1-cli" = rec {
        crateName = "google-doubleclickbidmanager1-cli";
        version = "1.0.13+20200316";
        edition = "2015";
        crateBin = [
          { name = "doubleclickbidmanager1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200316.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-doubleclickbidmanager1";
          }
          {
            name = "hyper";
            packageId = "hyper";
