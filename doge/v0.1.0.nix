...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/doge/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "doge" = rec {
        ...
        authors = [
          "Colin Reeder <vpzomtrrfrt@gmail.com>"
        ];
        dependencies = [
          {
            name = "lexical";
      ...
      "lexical" = rec {
        ...
        resolvedDefaultFeatures = [ "correct" "default" "radix" "ryu" "std" ];
      };
      "lexical-core" = rec {
        ...
        resolvedDefaultFeatures = [ "arrayvec" "correct" "radix" "ryu" "std" "table" ];
      };
      "nodrop" = rec {
        crateName = "nodrop";
        version = "0.1.14";
