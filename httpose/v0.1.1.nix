...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/httpose/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "httpose" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "httpose"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Chen Weiguang <chen.weiguang@gmail.com>"
        ];
        dependencies = [
          {
            name = "ctrlc";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
