...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dropbox-sdk/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dropbox-sdk" = rec {
        ...
        resolvedDefaultFeatures = [ "dbx_account" "dbx_async" "dbx_auth" "dbx_check" "dbx_common" "dbx_contacts" "dbx_file_properties" "dbx_file_requests" "dbx_files" "dbx_paper" "dbx_secondary_emails" "dbx_seen_state" "dbx_sharing" "dbx_team" "dbx_team_common" "dbx_team_log" "dbx_team_policies" "dbx_users" "dbx_users_common" "default" "hyper" "hyper-native-tls" "hyper_client" ];
      };
      "env_logger" = rec {
