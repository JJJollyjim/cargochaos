...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/climer/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "climer" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "default" "parser" "regex" "serde" "serialize" ];
      };
      "climer_derive" = rec {
        crateName = "climer_derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1k2chcqk1n3zvrax68yd9gjdiy5pjlfn14cad8q452nn5qzzwqfw";
        procMacro = true;
        authors = [
          "Noah Rosenzweig <noah@aware.vision>"
        ];
        dependencies = [
          {
            name = "quote";
