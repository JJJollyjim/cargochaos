...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/godunov/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "assert_float_eq" = rec {
        crateName = "assert_float_eq";
        version = "1.1.3";
        edition = "2015";
        sha256 = "0xryhlk2p012y109048c5jj5f448cv0b86ylkjgg5v7dzcpnbsjc";
        authors = [
      ...
      "gauss-quad" = rec {
        crateName = "gauss-quad";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1gs86ga15l57nks1vw6pi8xfghh4za7xvp098b0q5a0md90dfhrb";type = [ "lib" "cdylib" ];
        authors = [
          "DomiDre <dominiquedresen@gmail.com>"
        ];
        dependencies = [
          {
            name = "assert_float_eq";
            packageId = "assert_float_eq";
          }
          {
            name = "nalgebra";
            packageId = "nalgebra";
      ...
      "lapack-src" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "0v5rxyfwwv36lncdcdpgxg7xrkfkxf3fnzfzxkwwbavl4fwa8h60";
        authors = [
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
      ...
      "nalgebra-lapack" = rec {
        crateName = "nalgebra-lapack";
        version = "0.10.0";
        edition = "2018";
        sha256 = "1w9lv52agg6wfigysfczzw7l12m0z86252s9s24h4xwn2am7706n";
        authors = [
          "Sébastien Crozet <developer@crozet.re>"
          "Andrew Straw <strawman@astraw.com>"
        ];
