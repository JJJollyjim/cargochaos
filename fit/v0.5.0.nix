...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fit/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fit" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "test_std"; path = "bin/test_std.rs"; }
          { name = "test_all"; path = "bin/test_all.rs"; }
          { name = "test_dev_fields"; path = "bin/test_dev_fields.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Richard Brodie <richard@radagast.nu>"
        ];
        dependencies = [
          {
            name = "copyless";
      ...
      "fitsdk" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "19z7s3195dv2lgazjap9q49wn2mi3mmfsqzfs6mpb2cn521gsf50";
        authors = [
          "Richard Brodie <richard@radagast.nu>"
        ];
