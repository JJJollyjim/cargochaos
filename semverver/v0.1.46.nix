...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/semverver/v0.1.46.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "semverver" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-semver"; path = "src/bin/cargo_semver.rs"; }
          { name = "rust-semverver"; path = "src/bin/rust_semverver.rs"; }
          { name = "rust-semver-public"; path = "src/bin/rust_semver_public.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.46.nix {};
        authors = [
