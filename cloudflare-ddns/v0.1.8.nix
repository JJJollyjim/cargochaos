...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cloudflare-ddns/v0.1.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cloudflare-ddns" = rec {
        crateName = "cloudflare-ddns";
        version = "0.1.8";
        edition = "2018";
        crateBin = [
          { name = "cloudflare-ddns"; path = "src/main.rs"; }
        ];
      ...
      "structopt 0.3.1" = rec {
        ...
        dependencies = [
          ...
          {
            name = "structopt-derive";
            packageId = "structopt-derive 0.3.1";
          }
        ];
        features = {
          "color" = [ "clap/color" ];
