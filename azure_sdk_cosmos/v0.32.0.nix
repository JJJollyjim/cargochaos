...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_cosmos/v0.32.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.30.3";
        edition = "2018";
        sha256 = "0lwr90lh4z4lfvh2059f2ql71mdax7x05h3s87cv14i4xa5zm73n";
        authors = [
      ...
      "azure_sdk_cosmos" = rec {
        crateName = "azure_sdk_cosmos";
        version = "0.32.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.32.0.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
        ];
