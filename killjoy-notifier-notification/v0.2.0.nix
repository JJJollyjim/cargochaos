...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/killjoy-notifier-notification/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "killjoy-notifier-notification";
  ...
  workspaceMembers = {
    "killjoy-notifier-notification" = rec {
      packageId = "killjoy-notifier-notification";
      build = internal.buildRustCrateWithFeatures {
        packageId = "killjoy-notifier-notification";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "killjoy-notifier-notification" = rec {
        crateName = "killjoy-notifier-notification";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "killjoy-notifier-notification"; path = "src/main.rs"; }
        ];
