...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fbleau/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "docopt" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1h1s3lg61yivsyqrsll0fwj0zfjmkzbryh2bq7napanzf3gr436n";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "fbleau" = rec {
        ...
        resolvedDefaultFeatures = [ "numpy" "pyo3" "python-module" ];
      };
      "float-cmp" = rec {
        crateName = "float-cmp";
        version = "0.5.2";
      ...
      "rustlearn" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0v5dw1mp8bqx50147zb956vhhd0b26ghzp14w7wzy06m684rx1k5";
        authors = [
