...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tex/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tex" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tex"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "cjayross <calvinjayross@gmail.com>"
        ];
        dependencies = [
          {
            name = "pest";
          ...
          {
            name = "tex_derive";
            packageId = "tex_derive";
          }
        ];
        
      };
      "tex_derive" = rec {
        crateName = "tex_derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "03xa2bqrclfscf0slp3f355jhp7lsifrnwlks3mcjs4qq668idv5";
        procMacro = true;
        authors = [
          "cjayross <calvinjayross@gmail.com>"
        ];
