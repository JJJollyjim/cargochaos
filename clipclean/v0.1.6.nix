...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clipclean/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clipclean" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "clipclean"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "shellapi" "std" "winbase" "winuser" ];
      };
