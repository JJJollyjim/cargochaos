...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-autoscaler1_beta2-cli/v1.0.12+20150629.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-autoscaler1_beta2-cli";
  ...
  workspaceMembers = {
    "google-autoscaler1_beta2-cli" = rec {
      packageId = "google-autoscaler1_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-autoscaler1_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-autoscaler1_beta2" = rec {
        crateName = "google-autoscaler1_beta2";
        version = "1.0.12+20150629";
        edition = "2015";
        sha256 = "0hdxll2wrzsdr0yprrpvn4fm92am8lv2964gsyigpgzi62d5ammb";
        authors = [
      ...
      "google-autoscaler1_beta2-cli" = rec {
        crateName = "google-autoscaler1_beta2-cli";
        version = "1.0.12+20150629";
        edition = "2015";
        crateBin = [
          { name = "autoscaler1-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20150629.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-autoscaler1_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
