...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/renderdoc/v0.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cgl" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "0ajhq77hcfddl1bqhxhyr8497944lbnhy4ckcvjxw7v3z4jmxw40";
        authors = [
      ...
      "gfx_device_gl" = rec {
        ...
        version = "0.16.1";
        edition = "2015";
        sha256 = "00r0zp7j9d13jw90lph9d80976p051x77f67kxd2vwsps0hrrnrz";
        authors = [
          "The Gfx-rs Developers"
        ];
        dependencies = [
      ...
      "gleam" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "0iafb81am0y4361vlkxva26gi5pbnf524k0q5wvxs8qayky97dqj";
        authors = [
          "The Servo Project Developers"
        ];
        buildDependencies = [
      ...
      "renderdoc-sys" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "146kl0p73j5ssx93rb3yy9k1fss1q5r8p9igzrjyghs9i02skm30";
        authors = [
          "Eyal Kalderon <ebkalderon@gmail.com>"
        ];
      ...
      "shared_library" = rec {
        ...
        version = "0.1.8";
        edition = "2015";
        sha256 = "1hc9s8dskh0ni3wgwzsvgqlwbbc8aj647pn6gk6dgn74ih4vym42";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "consoleapi" "d3d11" "d3d12" "dbghelp" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "libloaderapi" "memoryapi" "minwindef" "ntsecapi" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "profileapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "sysinfoapi" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winuser" ];
      };
      ...
      "wio" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "04xjmlfvxd3j1907v8km7syr4iiyr6grimzqnzzl2scd4s51x8zq";
        authors = [
          "Peter Atashian <retep998@gmail.com>"
        ];
        dependencies = [
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "errhandlingapi" "minwindef" "unknwnbase" ];
          }
        ];
