...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reset-router/v0.8.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reset-recognizer" = rec {
        crateName = "reset-recognizer";
        version = "0.8.0";
        edition = "2018";
        sha256 = "1j142hybhj9vicw6flwcm8brqqa09105zfnkki2vg9m1z5f16lv9";
        authors = [
      ...
      "reset-router" = rec {
        ...
        dependencies = [
          ...
          {
            name = "reset-recognizer";
            packageId = "reset-recognizer";
          }
          {
            name = "tower";
            packageId = "tower";
      ...
      "type-map" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "08xg0hfn7lflkb4kpfbwmqjv28pywhnn460pciijfqx8wz7553lr";
        authors = [
          "Jacob Brown <kardeiz@gmail.com>"
        ];
        dependencies = [
