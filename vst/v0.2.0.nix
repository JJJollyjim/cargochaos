...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vst/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "profileapi" "std" "sysinfoapi" "timezoneapi" "winerror" ];
      };
