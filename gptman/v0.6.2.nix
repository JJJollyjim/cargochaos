...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gptman/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gptman" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "gptman"; path = "src/cli/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "ansi_term" "clap" "cli" "default" "lazy_static" "linefeed" "nix" "pad" "rand" "structopt" "unicode-width" ];
      };
      "heck" = rec {
        crateName = "heck";
        version = "0.3.1";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "synchapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
