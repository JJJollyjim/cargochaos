...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustpub/v0.1.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustpub" = rec {
        ...
        resolvedDefaultFeatures = [ "complex" "default" "simple" ];
      };
      "rustpub-macro" = rec {
        crateName = "rustpub-macro";
        version = "0.1.4";
        edition = "2018";
        sha256 = "13qyi3ds02jh4hq90gg7vhiv5qvbm40rpw5w180k5bn0l221shlh";
        procMacro = true;
        authors = [
          "csos95 <csoscss@gmail.com>"
        ];
