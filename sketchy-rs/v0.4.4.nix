...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sketchy-rs/v0.4.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cute" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1za9nkkb2w9zwbx5diaqd9al0c5rxvgv4yayd6dymzn3s7101rs5";
        authors = [
      ...
      "sketchy-rs" = rec {
        crateName = "sketchy-rs";
        version = "0.4.4";
        edition = "2018";
        crateBin = [
          { name = "sketchy-rs"; path = "src/main.rs"; }
        ];
