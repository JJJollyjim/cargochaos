...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsndom-demo/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rsndom-demo" = rec {
        crateName = "rsndom-demo";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rsndom-demo"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "SecretShangri-La <byobu@vivaldi.net>"
        ];
        dependencies = [
          {
            name = "rand";
