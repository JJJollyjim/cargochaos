...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-ml1-cli/v1.0.13+20200328.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-ml1" = rec {
        crateName = "google-ml1";
        version = "1.0.13+20200328";
        edition = "2015";
        sha256 = "1y1kq7wf8374y7ana5b324l95sdjv537xayyk3p52kdgqcxw5zn2";
        authors = [
      ...
      "google-ml1-cli" = rec {
        crateName = "google-ml1-cli";
        version = "1.0.13+20200328";
        edition = "2015";
        crateBin = [
          { name = "ml1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200328.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
