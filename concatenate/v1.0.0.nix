...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/concatenate/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "concatenate" = rec {
        crateName = "concatenate";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "concat"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "jam1garner <jam1garner@github.com>"
        ];
        dependencies = [
          {
            name = "structopt";
