...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/leptess/v0.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "leptess" = rec {
        ...
        authors = [
          "QP Hou <dave2008713@gmail.com>"
        ];
        dependencies = [
          {
            name = "leptonica-sys";
            packageId = "leptonica-sys";
          }
          {
            name = "tesseract-sys";
            packageId = "tesseract-sys";
          }
        ];
        
      };
      "leptonica-sys" = rec {
        crateName = "leptonica-sys";
        version = "0.3.1";
        edition = "2018";
        sha256 = "1r1kaqb6gibswqxpcdmwkw7f3p3rmg8abffbn174gng6y7fmi5w9";
        authors = [
      ...
      "tesseract-sys" = rec {
        crateName = "tesseract-sys";
        version = "0.5.2";
        edition = "2018";
        sha256 = "0h79lk1x0kbx7mkhnhzzpmc2m6k7a4191b13isgg87wjlamggb9n";
        authors = [
