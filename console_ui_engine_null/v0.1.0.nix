...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/console_ui_engine_null/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "console_ui_engine_null";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "console_ui_engine_null" = rec {
        crateName = "console_ui_engine_null";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "example"; path = "examples/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Harry Yu <harryyunull@gmail.com>"
        ];
        dependencies = [
          {
            name = "crossterm";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "minwindef" "processenv" "winbase" "wincon" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
