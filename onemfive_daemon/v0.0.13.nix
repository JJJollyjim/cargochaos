...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/onemfive_daemon/v0.0.13.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bluetooth_client" = rec {
        crateName = "bluetooth_client";
        version = "0.0.10";
        edition = "2018";
        crateBin = [];
        sha256 = "1pa43bb6z2bh3xmznrwsmh0qnifa1a2nhqm1fvsj74lxyvf9669m";
        authors = [
      ...
      "https_client" = rec {
        crateName = "https_client";
        version = "0.0.6";
        edition = "2018";
        crateBin = [];
        sha256 = "12i6h2pw73lqlk8v4jjargbdmi31q0iv703p30ciwbf0vz3r9fa1";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
      ...
      "i2p_client" = rec {
        crateName = "i2p_client";
        version = "0.0.11";
        edition = "2018";
        crateBin = [];
        sha256 = "1gl6avkjy645qjchk46cbiknxn5h886ycr4l0vygsg8jpdczdjlf";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
      ...
      "onemfive_common" = rec {
        crateName = "onemfive_common";
        version = "0.0.7";
        edition = "2018";
        sha256 = "0vrgcjlk7r471vnwbr9cnkksycr4cndmgrj91rs8jpzd66jr084k";
        authors = [
          "objectorange <objectorange@1m5.io>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "onemfive_daemon" = rec {
        crateName = "onemfive_daemon";
        version = "0.0.13";
        edition = "2018";
        crateBin = [
          { name = "onemfive_daemon"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "https_client";
            packageId = "https_client";
          }
          {
            name = "i2p_client";
            packageId = "i2p_client";
          }
          {
            name = "log";
            packageId = "log 0.4.8";
          ...
          {
            name = "onemfive_common";
            packageId = "onemfive_common";
          }
          {
            name = "ra_common";
            packageId = "ra_common 0.0.43";
          ...
          {
            name = "tor_client";
            packageId = "tor_client";
          }
          {
            name = "vpn_client";
            packageId = "vpn_client";
          }
        ];
      ...
      "ra_common 0.0.32" = rec {
        crateName = "ra_common";
        version = "0.0.32";
        edition = "2018";
        sha256 = "0804494f4qryg2dlig4r0r84wh3fbcwi97h5h23syp63ski3yq8f";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
      ...
      "rocket_contrib" = rec {
        ...
        resolvedDefaultFeatures = [ "json" "serde" "serde_json" "serve" ];
      };
      "rocket_http" = rec {
      ...
      "seda_bus" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1cr9l440swvi6xkkilr1sp6z5yigy5s7v2a0x5hzdmjhwgp9wx3r";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
      ...
      "tor_client" = rec {
        crateName = "tor_client";
        version = "0.0.8";
        edition = "2018";
        crateBin = [];
        sha256 = "02cgawdm2xbapcgzfw9gzv6gjkl1z2iclf7bnwcf50m5sn0vadv3";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
      ...
      "vpn_client" = rec {
        crateName = "vpn_client";
        version = "0.0.7";
        edition = "2018";
        crateBin = [];
        sha256 = "1jkgrw36vdsccf10i8dh5zqvvlszdn8z5hz36zzy9pi8k4sdwfgk";
        authors = [
          "Brian Taylor <brian@resolvingarchitecture.io>"
        ];
        dependencies = [
