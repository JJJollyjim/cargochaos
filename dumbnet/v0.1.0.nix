...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dumbnet/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "numeric-array" = rec {
        crateName = "numeric-array";
        version = "0.4.2";
        edition = "2015";
        sha256 = "10a1x77hcq7lgd4vn6yp5f8ca3d9rfqx2vijl4zjvc5pc1h516ns";
        authors = [
          "Aaron Trent <novacrazy@gmail.com>"
        ];
        dependencies = [
