...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tide-validator/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tide" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "05ci1ir3ga1zbyqma5myl52znrzbm8357nk3l9246vspy1rfmzfs";
        authors = [
          "Aaron Turon <aturon@mozilla.com>"
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "h1-server" "http-service-h1" ];
      };
      "tide-validator" = rec {
        crateName = "tide-validator";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Benjamin Coenen <benjamin.coenen@hotmail.com>"
        ];
        dependencies = [
          {
            name = "async-std";
