...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/messagepack-rs/v0.8.0.nix.tmp"
    ...
    crates = {
      ...
      "messagepack-rs" = rec {
        ...
        dependencies = [
          ...
          {
            name = "messagepack-rs-macros";
            packageId = "messagepack-rs-macros";
          }
        ];
        
      };
      "messagepack-rs-macros" = rec {
        crateName = "messagepack-rs-macros";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0fljk5jcayvsf852qmiqxd02d53vlhzz2hql7kqg6bar0jwkd11m";
        procMacro = true;
        authors = [
          "Shogo Otake <shogo.otake@gmail.com>"
        ];
