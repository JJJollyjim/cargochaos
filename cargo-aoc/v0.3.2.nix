...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-aoc/v0.3.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aoc-runner-internal" = rec {
        crateName = "aoc-runner-internal";
        version = "0.1.0";
        edition = "2015";
        sha256 = "10lrgh1r9jkcay8n0xxbh3l9sx1a0gmr9kxa1bn4b6k6yfkhnjr7";
        authors = [
      ...
      "cargo-aoc" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "cargo-aoc"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.2.nix {};
        authors = [
          "Grégory Obanos <gregory.obanos@gmail.com>"
          "Olivier Pinon <oliv.pinon@gmail.com>"
        ];
        dependencies = [
          {
            name = "aoc-runner-internal";
            packageId = "aoc-runner-internal";
          }
          {
            name = "chrono";
            packageId = "chrono";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
