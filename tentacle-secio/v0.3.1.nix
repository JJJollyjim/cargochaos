...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tentacle-secio/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "rt-core" "slab" "tcp" "time" ];
      };
      "tokio-util" = rec {
