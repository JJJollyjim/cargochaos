...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/attohttpc/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        resolvedDefaultFeatures = [ "charsets" "compress" "default" "encoding_rs" "form" "json" "libflate" "native-tls" "openssl" "serde" "serde_json" "serde_urlencoded" "tls" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.13";
