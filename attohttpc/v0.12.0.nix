...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/attohttpc/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        resolvedDefaultFeatures = [ "charsets" "compress" "default" "encoding_rs" "encoding_rs_io" "flate2" "form" "json" "native-tls" "openssl" "rustls" "serde" "serde_json" "serde_urlencoded" "tls" "tls-rustls" "webpki" "webpki-roots" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.14";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "wtypesbase" ];
      };
