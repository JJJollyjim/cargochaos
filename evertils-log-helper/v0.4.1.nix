...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evertils-log-helper/v0.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evertils-log-helper" = rec {
        crateName = "evertils-log-helper";
        version = "0.4.1";
        edition = "2015";
        crateBin = [
          { name = "log"; path = "src/log.rs"; }
          { name = "logt"; path = "src/logt.rs"; }
          { name = "log-yesterday"; path = "src/log_yesterday.rs"; }
          { name = "log-today"; path = "src/log_today.rs"; }
          { name = "logm"; path = "src/logm.rs"; }
          { name = "newday"; path = "src/newday.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.1.nix {};
        authors = [
          "Ryan Priebe <rpriebe@me.com>"
        ];
        dependencies = [
          {
            name = "chrono";
