...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ressa/v0.7.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hash-chain" = rec {
        crateName = "hash-chain";
        version = "0.2.5";
        edition = "2018";
        sha256 = "057djanzl4r9jfwqmrx54h5h792cx0xhvbg175j5m4dkq25gikh7";
        authors = [
          "Robert Masen <r.f.masen@gmail.com>"
          "Ben Gummoe <b.gummoe@gmail.com>"
        ];
      ...
      "res-regex" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "139dmrlwklnb44cmgf36pym5zasa543mwnvyhmrv9vmlbx8n9kma";
        authors = [
          "Robert Masen <r@robertmasen.pizza>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "resast" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1dfxksjsgfanqmfn0gwzklq90bp8gar4vyh614r7py8wnyi2cf17";
        authors = [
          "rfm <r@robertmasen.pizza>"
        ];
        dependencies = [
          {
            name = "serde";
        ...
        resolvedDefaultFeatures = [ "default" "esprima" "serde" "serde_derive" "serialization" ];
      };
      "ress" = rec {
        crateName = "ress";
        version = "0.9.0";
        edition = "2018";
        sha256 = "1mj0270wnpj4gwgnihqa1dn6c5pv0h51mj0ak339lykyz7d8899f";
        authors = [
          "Robert Masen <r@robertmasen.pizza>"
        ];
        dependencies = [
      ...
      "ressa" = rec {
        ...
        resolvedDefaultFeatures = [ "debug_look_ahead" "default" "error_backtrace" "esprima" "indicatif" "major_libs" "moz_central" "pulldown-cmark" "rayon" "serialization" "test_262" "test_262_parser" "walkdir" ];
      };
      "rust-argon2" = rec {
