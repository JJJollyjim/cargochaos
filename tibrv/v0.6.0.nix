...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tibrv/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tibrv" = rec {
        ...
        authors = [
          "Richard Bradfield <bradfier@fstab.me>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "async" "futures" "mio" "tibrv_8_2" "tibrv_8_3" "tibrv_8_4" "tokio" ];
      };
      "tibrv-sys" = rec {
        crateName = "tibrv-sys";
        version = "0.6.0";
        edition = "2015";
        sha256 = "116vxkpyvypnnjcfxgkvnipjj8c2a5yn5hlk8df0kwry9rdf92xh";
        libName = "tibrv_sys";
        authors = [
          "Richard Bradfield <bradfier@fstab.me>"
        ];
        ...
        resolvedDefaultFeatures = [ "tibrv_8_2" "tibrv_8_3" "tibrv_8_4" ];
      };
      "time" = rec {
        crateName = "time";
        version = "0.1.42";
