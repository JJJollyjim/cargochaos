...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/polyhedra/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kiss3d" = rec {
        ...
        version = "0.23.0";
        edition = "2015";
        sha256 = "15ic9svxyyz6dlb9k1kwwkypgm6xpw1vlymqbmiq0xxrg1l1wbmd";
        authors = [
      ...
      "ncollide3d" = rec {
        ...
        version = "0.22.0";
        edition = "2018";
        sha256 = "0m4ps7hnan4pf1fsc540s5xax8z92miz90k7v4pjbp3lhjjhlsyg";
        authors = [
          "Sébastien Crozet <developer@crozet.re>"
        ];
        dependencies = [
      ...
      "polyhedra" = rec {
        ...
        authors = [
          "Michael Mauderer <michael@mauderer.me>"
        ];
        dependencies = [
          {
            name = "nalgebra";
