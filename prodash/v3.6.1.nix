...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/prodash/v3.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dashmap" = rec {
        ...
        version = "3.10.0";
        edition = "2018";
        sha256 = "1h4gdpw8r3y7g2mj0km6dx573zdn1i63pm2fr0s4i9srycqci688";
        authors = [
      ...
      "prodash" = rec {
        ...
        version = "3.6.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v3.6.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "futures" "futures-timer" "humantime" "localtime" "log" "log-renderer" "termion" "time" "tui" "tui-react" "tui-renderer" "unicode-segmentation" "unicode-width" ];
      };
      "quick-error" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntstatus" "processenv" "std" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
