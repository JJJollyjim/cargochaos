...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rgb-io/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rgb-io" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rgb-io"; path = "src/bin/rgb-io/main.rs"; }
        ];
        ...
        features = {
          "bin" = [ "dia-args" "termion" ];
        };
        resolvedDefaultFeatures = [ "bin" "dia-args" "termion" ];
      };
      "termion" = rec {
        crateName = "termion";
        version = "1.5.4";
