...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mixer_wrappers/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oauth2" = rec {
        ...
        version = "1.3.0";
        edition = "2015";
        sha256 = "0q187f1b5yhbggwjwr24q9sax32fl9drm5kjzjxwprm073jc7hqq";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
          "Florin Lipan <florinlipan@gmail.com>"
        ];
