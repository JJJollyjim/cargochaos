...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/notes-cli/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "notes-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "notes-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Weston Carlson <wez470@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" ];
      };
