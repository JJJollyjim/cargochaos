...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/derive_more/v0.99.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "derive_more" = rec {
        ...
        resolvedDefaultFeatures = [ "add" "add_assign" "as_mut" "as_ref" "constructor" "default" "deref" "deref_mut" "display" "from" "from_str" "generate-parsing-rs" "index" "index_mut" "into" "into_iterator" "iterator" "mul" "mul_assign" "nightly" "not" "peg" "sum" "try_into" ];
      };
      "peg" = rec {
        crateName = "peg";
        version = "0.5.7";
