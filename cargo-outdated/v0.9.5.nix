...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-outdated/v0.9.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-outdated" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-outdated"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "debug" "default" "termcolor" ];
      };
      "cargo-platform" = rec {
