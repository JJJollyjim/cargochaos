...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/favicon-generator/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "enum-ordinalize" = rec {
        ...
        version = "2.2.1";
        edition = "2015";
        sha256 = "1c84xsj0cbibsi30ba6iw9azvibw9lgynmz46nr14bmh7ypk2n64";
        authors = [
      ...
      "image-convert" = rec {
        ...
        version = "0.8.7";
        edition = "2015";
        sha256 = "0568ynrnynsg3gm2cy464ld44cv9qc0ilx77zbqpb9f90n38g6rr";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "scanner-rust" = rec {
        ...
        version = "1.2.0";
        edition = "2018";
        sha256 = "12gmabdwx16za7048vap6bg5q1nv0ljc0yy5br2dby39gxlxz2fa";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        features = {
      ...
      "tera" = rec {
        ...
        edition = "2018";
        sha256 = "1yw4j3qd6a926vqfckn8izd6spvdwfqvams4xa4ikg77dzpy4gb0";
        authors = [
      ...
      "validators" = rec {
        ...
        version = "0.20.9";
        edition = "2015";
        sha256 = "0yvaifgc6hzm85fsnhi3mkm13jfpxk3wdgblzxya8f4dyk4gl4c4";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
