...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/codetrotter_aoc_2019_solutions/v0.9.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "codetrotter_aoc_2019_solutions";
  ...
  workspaceMembers = {
    "codetrotter_aoc_2019_solutions" = rec {
      packageId = "codetrotter_aoc_2019_solutions";
      build = internal.buildRustCrateWithFeatures {
        packageId = "codetrotter_aoc_2019_solutions";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "codetrotter_aoc_2019_solutions" = rec {
        crateName = "codetrotter_aoc_2019_solutions";
        version = "0.9.0";
        edition = "2018";
        crateBin = [
          { name = "aoc-2019"; path = "src/bin/aoc-2019.rs"; }
        ];
