...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dora/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "docopt" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1n6gbhsks2w9y0b4bwqyawh4ghbkka09w6pjcrq9i1sd51pflcmb";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "dora-parser" = rec {
        crateName = "dora-parser";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1fgxg6ipsw8cb9cfdbpg73984vgs2fcr29wqycmbfnh6i33nfn98";
        authors = [
          "Dominik Inführ <dominik.infuehr@gmail.com>"
        ];
        dependencies = [
