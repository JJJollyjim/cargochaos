...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/init_tree/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "init_tree" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "outside_crate_test"; path = "src/bin/outside_crate_test.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "cache" "default" "serde" ];
      };
      "itertools" = rec {
        crateName = "itertools";
        version = "0.8.0";
