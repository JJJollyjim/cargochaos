...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libperl-rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0qdyfnrskwma1lddrd2bz6w1bkjzd2l91sh0xl4mw52jq931kpnq";
        authors = [
      ...
      "libperl-config" = rec {
        crateName = "libperl-config";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0wv9379n2h8iayylm0rhilc96dhgd3sv89dhw62bbf5ckvsi27w7";
        authors = [
      ...
      "libperl-rs" = rec {
        ...
        dependencies = [
          {
            name = "libperl-sys";
            packageId = "libperl-sys";
          }
        ];
        buildDependencies = [
          {
            name = "libperl-config";
            packageId = "libperl-config";
          }
          {
            name = "regex";
            packageId = "regex";
      ...
      "libperl-sys" = rec {
        crateName = "libperl-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1hk8jhqp42gl93gi7r5i2ja4075vwqjrpijvrwp4ihr8l2rv5fsl";type = [ "rlib" "cdylib" ];
        authors = [
          "Kobayasi, Hiroaki <buribullet@gmail.com>"
        ];
        buildDependencies = [
