...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ptt/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "minwinbase" "minwindef" "ntdef" "profileapi" "std" "sysinfoapi" "timezoneapi" "wincrypt" ];
      };
