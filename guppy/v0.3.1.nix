...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guppy/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cfg-expr" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1sckbwjr84lfvasm187l9fxp1kdv1dvvq82b3xnqs1ify62y7zkd";
        authors = [
      ...
      "guppy" = rec {
        ...
        resolvedDefaultFeatures = [ "proptest" "proptest-derive" "proptest09" ];
      };
      "indexmap" = rec {
        crateName = "indexmap";
        version = "1.3.2";
      ...
      "nested" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "17lwhdw0z8c4g00yfdasxh4zc5dq1ccylmbb0n1zw1wgcc7l4aya";
        authors = [
      ...
      "target-spec" = rec {
        crateName = "target-spec";
        version = "0.2.3";
        edition = "2018";
        sha256 = "0j94a7yh6b1j68ahzw95p2909pihq8pgkp55h9zjf58yd2pa0hdj";
        authors = [
