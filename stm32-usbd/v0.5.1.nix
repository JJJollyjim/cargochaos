...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32-usbd/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f1" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "197wmjj6xyfhskciplim19dfri0syk0vd8bk5vff55dfd630rz66";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "stm32f103" ];
      };
      "stm32f1xx-hal" = rec {
        crateName = "stm32f1xx-hal";
        version = "0.4.0";
        edition = "2018";
        sha256 = "0gahvcv9768x3w1z70a3yijaij3i7s70nqj3wyavlbblfkjkq95i";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ...
        resolvedDefaultFeatures = [ "device-selected" "stm32f103" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.14";
