...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-makedocs/v1.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-makedocs" = rec {
        crateName = "cargo-makedocs";
        version = "1.2.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-makedocs"; path = "src/main.rs"; }
        ];
