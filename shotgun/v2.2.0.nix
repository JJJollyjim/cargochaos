...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shotgun/v2.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "png" "png_codec" "pnm" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
      ...
      "x11" = rec {
        ...
        resolvedDefaultFeatures = [ "xlib" "xrandr" ];
      };
    };
