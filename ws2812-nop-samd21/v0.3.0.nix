...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ws2812-nop-samd21/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21g18a" "samd21" "samd21g18a" "samd21g18a-rt" ];
      };
      "atsamd21g18a" = rec {
      ...
      "circuit_playground_express" = rec {
        crateName = "circuit_playground_express";
        version = "0.6.0";
        edition = "2015";
        sha256 = "1aj5s090510in86ahkz8x0kwaz2xzmrpl56hpb42w60z911xkkks";
        authors = [
          "Paul Sajna <paulsajna@gmail.com>"
        ];
        dependencies = [
          {
            name = "atsamd-hal";
        ...
        devDependencies = [
          {
            ...
            packageId = "circuit_playground_express";
          }
          {
            name = "panic-halt";
