...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sqstransfer/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sqstransfer" = rec {
        crateName = "sqstransfer";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "sqstransfer"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Kenta Onishi <kenta1988@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
