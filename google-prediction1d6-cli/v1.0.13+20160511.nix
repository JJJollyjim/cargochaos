...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-prediction1d6-cli/v1.0.13+20160511.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-prediction1d6-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-prediction1d6" = rec {
        crateName = "google-prediction1d6";
        version = "1.0.13+20160511";
        edition = "2015";
        sha256 = "1jyrv8f5skkhj2kkpdbmnbn93zg635rrpv5yz1skcz16x8x6znf1";
        authors = [
      ...
      "google-prediction1d6-cli" = rec {
        crateName = "google-prediction1d6-cli";
        version = "1.0.13+20160511";
        edition = "2015";
        crateBin = [
          { name = "prediction1d6"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20160511.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-prediction1d6";
          }
          {
            name = "hyper";
            packageId = "hyper";
