...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ciff/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ciff" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ciff2pisa"; path = "src/ciff2pisa.rs"; }
          { name = "pisa2ciff"; path = "src/pisa2ciff.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Michal Siedlaczek <michal.siedlaczek@nyu.edu>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "processenv" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winuser" ];
      };
