...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/c-lightning-pruning-plugin/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "c-lightning-pruning-plugin";
  ...
  workspaceMembers = {
    "c-lightning-pruning-plugin" = rec {
      packageId = "c-lightning-pruning-plugin";
      build = internal.buildRustCrateWithFeatures {
        packageId = "c-lightning-pruning-plugin";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "c-lightning-pruning-plugin" = rec {
        crateName = "c-lightning-pruning-plugin";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "c-lightning-pruning-plugin"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
