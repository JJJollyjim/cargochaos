...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stream-body/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-pipe" = rec {
        crateName = "async-pipe";
        version = "0.1.2";
        edition = "2018";
        sha256 = "14r9dsl9j118dml25q00ipg5gcbx8l2s4zhf34984rcm5vdm122v";
        authors = [
