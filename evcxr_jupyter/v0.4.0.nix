...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr_jupyter/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evcxr" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "07qgda5ki9s0y16zzb9y5x1bnslswlfd12nw9wxn7i88i2669094";
        authors = [
      ...
      "libc" = rec {
        ...
        version = "0.2.63";
        edition = "2015";
        sha256 = "10v5hm7yiirj0kpwr52a5d2cc1zqdwvdsi6a0zhj61gz5d8875fp";
        authors = [
          "The Rust Project Developers"
        ];
        features = {
