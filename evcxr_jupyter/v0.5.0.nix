...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr_jupyter/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evcxr" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1q9lvnzd3gg8awwlmfdbcx0apm8679w9ccbhg6k3gwky5va60k6q";
        authors = [
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "clone-impls" "extra-traits" "full" "parsing" "printing" "quote" "visit" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
