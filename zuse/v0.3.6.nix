...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zuse/v0.3.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mpmc" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "0fygw43hb5whrq14azakg1hrdssvc6q6jwnrn7392hkqimlpr56b";
        authors = [
          "Dmitry Vyukov"
      ...
      "rusoto_sns" = rec {
        crateName = "rusoto_sns";
        version = "0.43.0";
        edition = "2018";
        sha256 = "12y2ysxnz07cvanda4aadf4fbnz5lz8hx09qsf637srfjki5a383";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "telegram-bot" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0q7q0lhcry4liiddzsci8ikryzrm9znc5sdlqv0kkj20xw8znadv";
        authors = [
          "Lukas Kalbertodt <lukas.kalbertodt@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "default" "hyper-tls" "openssl" ];
      };
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "zuse" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "zuse"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.6.nix {};
        authors = [
          "Kenan Sulayman <kenan@sig.dev>"
        ];
        dependencies = [
          {
            name = "anyhow";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-core" "macros" "time" "fs" "tcp" "sync" ];
          }
          {
            name = "url";
            packageId = "url";
