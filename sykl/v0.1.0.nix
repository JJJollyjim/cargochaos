...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sykl/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "attohttpc" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "0xkxdb5p2rzbdixwgql07klc21f1wf9rgzr05p94ijm7shrnppy3";
        authors = [
        ...
        resolvedDefaultFeatures = [ "charsets" "compress" "default" "encoding_rs" "encoding_rs_io" "flate2" "json" "native-tls" "openssl" "serde" "serde_json" "tls" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "0.1.7";
