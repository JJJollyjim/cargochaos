...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lazy_transducer/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lazy_transducer" = rec {
        ...
        resolvedDefaultFeatures = [ "default_features" "scroll" "use_scroll" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.67";
