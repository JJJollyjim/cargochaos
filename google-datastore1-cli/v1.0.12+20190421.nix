...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-datastore1-cli/v1.0.12+20190421.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-datastore1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-datastore1" = rec {
        ...
        edition = "2015";
        sha256 = "1j9bgp2x2ybrbczqnq1irlhb7kqss3s8afxsaqqn0ar0dmlflxii";
        authors = [
      ...
      "google-datastore1-cli" = rec {
        crateName = "google-datastore1-cli";
        version = "1.0.12+20190421";
        edition = "2015";
        crateBin = [
          { name = "datastore1"; path = "src/main.rs"; }
        ];
