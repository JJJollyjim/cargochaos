...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sm-ext/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sm-ext" = rec {
        ...
        authors = [
          "Asher Baker <asherkin@limetech.io>"
        ];
        dependencies = [
          {
            name = "c_str_macro";
        ...
        resolvedDefaultFeatures = [ "abi_thiscall" "default" ];
      };
      "sm-ext-derive" = rec {
        crateName = "sm-ext-derive";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1hkgwm83zx0c3xwsbzvld9vgbrsl0ycl04psc02db0gsp6067sbm";
        procMacro = true;
        authors = [
          "Asher Baker <asherkin@limetech.io>"
        ];
