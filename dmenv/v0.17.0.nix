...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dmenv/v0.17.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rand 0.6.3" = rec {
        ...
        version = "0.6.3";
        edition = "2015";
        sha256 = "1q7wgj1372vvrb4zz9c81qs58pw92nh00cfj3f24ya560lqicpmn";
        authors = [
      ...
      "rand_os" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0wr209vmlj5p75a2b64f0rccp247pw7wn1f33lwy2wr93kgc8nny";
        authors = [
          "The Rand Project Developers"
        ];
        dependencies = [
      ...
      "winapi 0.3.6" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
