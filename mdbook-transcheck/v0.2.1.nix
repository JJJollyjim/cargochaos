...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-transcheck/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-transcheck" = rec {
        crateName = "mdbook-transcheck";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "mdbook-transcheck"; path = "src/main.rs"; }
        ];
