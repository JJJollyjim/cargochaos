...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sudachiclone/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sudachiclone" = rec {
        crateName = "sudachiclone";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "sudachiclone"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Yasu_umiNishikawa <yasu.umi.19910101@gmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
