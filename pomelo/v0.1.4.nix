...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pomelo/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compiletest_rs" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0z5wfw9bj5xr6r7dgcljjvgsnyigmv0mgvpqz1szfaaisjph1k26";
        authors = [
      ...
      "pm-lexer" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "00wnwybjwxgylp0yb8xmi5rgy5z675j5dc4j4vdbyrnb0ijnwg38";
        authors = [
      ...
      "pomelo" = rec {
        ...
        resolvedDefaultFeatures = [ "doc_generated" ];
      };
      "pomelo-impl" = rec {
        crateName = "pomelo-impl";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1r4w9jwvlqxrwkmspxnqhxnnl67jbz9ibqd7vdr6x3b207ijvlxb";
        procMacro = true;
        authors = [
          "Rodrigo Rivas Costa <rodrigorivascosta@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwindef" "namedpipeapi" "ntdef" "objbase" "shlobj" "std" "synchapi" "winbase" "wincon" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
