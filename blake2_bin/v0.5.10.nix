...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blake2_bin/v0.5.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "namedpipeapi" "processenv" "processthreadsapi" "std" "synchapi" "sysinfoapi" "winbase" "winerror" "winnt" ];
      };
