...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-storage1-cli/v1.0.13+20200326.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-storage1" = rec {
        crateName = "google-storage1";
        version = "1.0.13+20200326";
        edition = "2015";
        sha256 = "05wa9sdvhlmy95ghdpz6mxjxhj9zixyidd47nqdn2xsy2diqmzxn";
        authors = [
      ...
      "google-storage1-cli" = rec {
        crateName = "google-storage1-cli";
        version = "1.0.13+20200326";
        edition = "2015";
        crateBin = [
          { name = "storage1"; path = "src/main.rs"; }
        ];
