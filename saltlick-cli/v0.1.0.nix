...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/saltlick-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "saltlick" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0vwm2x8c27w5w1mxnwlk13r0c912fmi2pcnqdmbvvw8lcs5xxiv4";
        authors = [
          "Nick Stevens <nick@bitcurry.com>"
        ];
        dependencies = [
      ...
      "saltlick-cli" = rec {
        crateName = "saltlick-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "saltlick"; path = "src/main.rs"; }
        ];
