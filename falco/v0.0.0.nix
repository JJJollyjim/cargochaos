...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/falco/v0.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "grpcio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "protobuf" "protobuf-codec" "secure" ];
      };
      "grpcio-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "secure" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.66";
