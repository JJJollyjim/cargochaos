...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-build-deps/v0.1.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-build-deps" = rec {
        crateName = "cargo-build-deps";
        version = "0.1.5";
        edition = "2015";
        crateBin = [
          { name = "cargo-build-deps"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.5.nix {};
        authors = [
          "Nick Cardin <nick@cardin.email>"
        ];
        dependencies = [
          {
            name = "clap";
