...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/colortty/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwindef" "ntsecapi" "objbase" "schannel" "securitybaseapi" "shlobj" "sspi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
