...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xls2txt/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xls2txt" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "xls2txt"; path = "src/main.rs"; }
          { name = "xls2csv"; path = "src/bin/xls2csv.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.1.nix {};
        authors = [
          "Masklinn <masklinn@masklinn.net>"
        ];
        dependencies = [
          {
            name = "calamine";
