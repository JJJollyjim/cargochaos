...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/filite/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-identity" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0ykwywnkkb9q8c2dyjlhbiqbg1scz70qryyyf4njk4y27439ndra";
      ...
      "blake3" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "137hhlcirld7bahchrcdaxqi0v5gjd9dmpxqywgcpngpyjvi21ds";
        authors = [
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "default" "libsqlite3-sys" "r2d2" "sqlite" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "filite" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dev" "dotenv" ];
      };
      "flate2" = rec {
        crateName = "flate2";
        version = "1.0.13";
      ...
      "radix_fmt" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "09jlq152iwn56215kghqby4pi8vamhg0nzcb9any5b5782cjl26f";
        authors = [
          "Félix <felix-dev@daudre-vignier.fr>"
        ];
