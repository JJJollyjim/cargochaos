...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kcov-coverage-fix/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "kcov-coverage-fix" = rec {
        crateName = "kcov-coverage-fix";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "kcov-coverage-fix"; path = "src/main.rs"; }
        ];
