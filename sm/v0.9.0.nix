...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sm/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compiletest_rs" = rec {
        ...
        version = "0.3.14";
        edition = "2015";
        sha256 = "0f7p8yip6g4zxyvm851z6hc9x76kgb1j6pvxrcjlypwazc75pcd2";
        authors = [
          "The Rust Project Developers"
        ...
        resolvedDefaultFeatures = [ "norustc" "stable" "tester" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.2.5";
      ...
      "sm" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macro" "sm_macro" ];
      };
      "sm_macro" = rec {
        crateName = "sm_macro";
        version = "0.9.0";
        edition = "2018";
        sha256 = "0qg8kvqfflc55cnchwvjrscrx6lj152z16lb9lp4adbl0v4mn95s";
        procMacro = true;
        authors = [
          "Jean Mertz <helloworld@rustic.games>"
        ];
      ...
      "syn 0.15.4" = rec {
        ...
        version = "0.15.4";
        edition = "2015";
        sha256 = "04aa4ywa9h65dmkj3pln72jaa3a3sg8nz0bi6738p8ynybkynmlh";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "tester" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "137k961gj0bmznl6dscq0k2siwlcg97lx6qfxhxl08kn779k9bcl";type = [ "dylib" "rlib" ];
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
      ...
      "winapi 0.3.5" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
