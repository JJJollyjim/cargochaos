...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/icbiadb/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "icbiadb" = rec {
        ...
        authors = [
          "Emanuel GS <grundligt@hotmail.com>"
        ];
        dependencies = [
          {
            name = "async-std";
        ...
        features = {
          "aio" = [ "async-trait" "rayon" ];
          "async-std-comp" = [ "async-std" "aio" ];
          "default" = [ "std" ];
        };
        resolvedDefaultFeatures = [ "aio" "alloc" "async-std" "async-std-comp" "async-trait" "default" "rayon" "std" "unstable" ];
      };
      "iovec" = rec {
        crateName = "iovec";
        version = "0.1.4";
