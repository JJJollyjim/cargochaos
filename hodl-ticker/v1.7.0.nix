...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hodl-ticker/v1.7.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hodl-ticker" = rec {
        crateName = "hodl-ticker";
        version = "1.7.0";
        edition = "2018";
        crateBin = [
          { name = "hodl-ticker"; path = "src/main.rs"; }
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "default-tls" "futures-channel-preview" "hyper-tls" "native-tls" "tls" "tokio-tls" ];
      };
      "rust-argon2" = rec {
