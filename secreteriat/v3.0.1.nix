...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/secreteriat/v3.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "secreteriat" = rec {
        crateName = "secreteriat";
        version = "3.0.1";
        edition = "2018";
        crateBin = [
          { name = "secreteriat"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v3.0.1.nix {};
        authors = [
          "William Culhane <sxroka@gmail.com>"
        ];
        dependencies = [
          {
            name = "lazy_static";
      ...
      "serenity" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "1iwnvd4x93inivyj8q9dyw3ysa01algvnsxw08pj3cbg5wzr6dbf";
        authors = [
