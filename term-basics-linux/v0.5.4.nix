...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/term-basics-linux/v0.5.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "term-basics-linux" = rec {
        crateName = "term-basics-linux";
        version = "0.5.4";
        edition = "2018";
        crateBin = [
          { name = "testbin"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.4.nix {};
        libName = "term_basics_linux";
        authors = [
