...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bulls-and-cows/v1.0.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "random-integer" = rec {
        ...
        version = "1.0.5";
        edition = "2018";
        sha256 = "1pmqcych7mj0yj459q7hzv4k79gp3qrlhij5grbhp41vbfa7gab5";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "random-pick" = rec {
        ...
        version = "1.2.7";
        edition = "2018";
        sha256 = "1wjzb45a990d3g89jfrv3wbrl9943xp5249lnv13giz2qhw585h7";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
