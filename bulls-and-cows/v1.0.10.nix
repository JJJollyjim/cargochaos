...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bulls-and-cows/v1.0.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "debug-helper" = rec {
        ...
        version = "0.3.6";
        edition = "2018";
        sha256 = "1lqi0a4lxsbr9mr8m5awhcbmayvzsbpg4b4p5h45lzk5i7gxd298";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
      ...
      "random-integer" = rec {
        ...
        version = "1.0.4";
        edition = "2015";
        sha256 = "1zgs11c8g4vggqvsmzszk3ilvi789iq4rd4w891lnd77jj12rhb4";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "random-pick" = rec {
        ...
        version = "1.2.5";
        edition = "2015";
        sha256 = "1m33qdgwqvm82vg0673xbx3ajjnj0ynimjqy144m3fzxh0h1akfn";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
