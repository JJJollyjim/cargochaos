...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bulls-and-cows/v1.0.7.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "permutohedron" = rec {
        crateName = "permutohedron";
        version = "0.2.4";
        edition = "2015";
        sha256 = "0b1pzh48j86v46wxngch6k1kx9cdw3jr3lwa86gd6jd4bmxzz1xn";
        authors = [
          "bluss"
        ];
        features = {
      ...
      "random-integer" = rec {
        crateName = "random-integer";
        version = "1.0.2";
        edition = "2015";
        sha256 = "0f9mfjvpm1nax2rilciah9h17vkip22vixlx9qhb2gl524wbxww4";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "random-pick" = rec {
        crateName = "random-pick";
        version = "1.2.3";
        edition = "2015";
        sha256 = "0qk8zxayyr0cna4f2ywc2zpb3d2d3mpbyc163p1bd24nn04m32pm";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
