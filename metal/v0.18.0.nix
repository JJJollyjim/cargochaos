...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/metal/v0.18.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cocoa 0.19.1" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "core-foundation 0.6.1";
          }
          {
            name = "core-graphics";
      ...
      "sema" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0ckq33sg84785p195m54h03jcn7fai8w08hjnb94nzaakgzibbz3";
        authors = [
