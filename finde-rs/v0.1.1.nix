...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/finde-rs/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "precommit-hook" "run-cargo-fmt" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "finde-rs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "finde-rs"; path = "src/main.rs"; }
        ];
      ...
      "tantivy" = rec {
        ...
        version = "0.11.3";
        edition = "2018";
        sha256 = "0qmdql7hpmya7k5qmc52yqil0glp4g38n1vv5v4i6slsh0sal3y9";
        authors = [
          "Paul Masurel <paul.masurel@gmail.com>"
        ];
        dependencies = [
      ...
      "tantivy-query-grammar" = rec {
        ...
        version = "0.11.0";
        edition = "2018";
        sha256 = "1bdmpgj9l1r732y1s8mq3cs64l3a0g18vy0vwhwy9inrv43kghqk";
        authors = [
          "Paul Masurel <paul.masurel@gmail.com>"
        ];
        dependencies = [
