...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/finde-rs/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "partial_application" = rec {
        crateName = "partial_application";
        version = "0.2.0";
        edition = "2015";
        sha256 = "1f1i1lh4d17bsvdf31v1fs5dvbqlz8z944dam4m1r6wzynaaqvs3";
        authors = [
          "Emerentius"
        ];
