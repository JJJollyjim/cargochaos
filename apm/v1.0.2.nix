...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/apm/v1.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "apm" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "apm"; path = "src/apm.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.2.nix {};
        authors = [
          "Malachi Austin <karrighan@protonmail.com>"
        ];
        dependencies = [
          {
            name = "libarc";
      ...
      "libarc" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1zg13kv4xj6rryg7vjm65ip1xczl4p57x4a5b800hav8jdxiqlkr";
        libName = "arc";
        libPath = "src/arc.rs";
        authors = [
          "Malachi Austin <karrighan@protonmail.com>"
      ...
      "tokio-async" = rec {
        crateName = "tokio-async";
        version = "0.0.0";
        edition = "2015";
        sha256 = "0scmddagjfiy72hkr2vyrv50rlaqn7xk4a0dhcvsph91yrhrx4rl";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
