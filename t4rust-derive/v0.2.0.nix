...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/t4rust-derive/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "t4rust-derive" = rec {
        crateName = "t4rust-derive";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        procMacro = true;
        libName = "t4rust_derive";
        authors = [
          "Splamy <splamyn@gmail.com>"
        ];
        dependencies = [
          {
            name = "nom";
