...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/substrate-deps/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-deps" = rec {
        crateName = "cargo-deps";
        version = "1.4.1";
        edition = "2018";
        crateBin = [];
        sha256 = "1i2d68fmmz5v1vw6z54hmi9vpcr5h26zh7icf45c8sam7divphw5";
        authors = [
          "Marcin S. <marcin.swieczkowski@gmail.com>"
      ...
      "cargo-edit" = rec {
        ...
        resolvedDefaultFeatures = [ "add" "atty" "cli" "default" "rm" "structopt" "upgrade" ];
      };
      "cargo_metadata" = rec {
      ...
      "substrate-deps" = rec {
        crateName = "substrate-deps";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "substrate-deps"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Steve Degosserie <steve@parity.io>"
        ];
        dependencies = [
          {
            name = "Inflector";
