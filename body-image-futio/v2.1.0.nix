...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/body-image-futio/v2.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "parking_lot" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
