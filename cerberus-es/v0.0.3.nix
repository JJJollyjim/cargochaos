...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cerberus-es/v0.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cerberus-es" = rec {
        crateName = "cerberus-es";
        version = "0.0.3";
        edition = "2018";
        crateBin = [
          { name = "cerberus"; path = "src/main.rs"; }
        ];
      ...
      "eventstore" = rec {
        crateName = "eventstore";
        version = "0.4.5";
        edition = "2018";
        sha256 = "0a0h9ldl27dw8a3wlljzb9sfizkhwsbkfyaigfrb9yxca5f9qbdj";
        authors = [
          "Yorick Laupa <yo.eight@gmail.com>"
        ];
        dependencies = [
