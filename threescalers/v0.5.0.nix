...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/threescalers/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "threescalers" = rec {
        ...
        resolvedDefaultFeatures = [ "all-types" "chrono" "curl" "curl-all" "curl-easy" "curl-easy2" "curl-types" "default" "http-types" "nightly" "reqwest" "reqwest-all" "reqwest-async" "reqwest-sync" "reqwest-types" "serde" "serde-xml-rs" "xml-response" ];
      };
      "time" = rec {
        crateName = "time";
        version = "0.1.42";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
