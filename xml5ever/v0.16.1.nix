...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xml5ever/v0.16.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "getopts" = rec {
        ...
        version = "0.2.14";
        edition = "2015";
        sha256 = "11fnh4awj227c85ax1sixbl5yb25c3qmxlv3nd870hwas3xpq16r";
        authors = [
          "The Rust Project Developers"
        ];
      ...
      "term" = rec {
        ...
        version = "0.4.5";
        edition = "2015";
        sha256 = "12frpf6mdin235d7aw4lsrrxips7kmbm098k8picysdk60wsys6i";
        authors = [
          "The Rust Project Developers"
          "Steven Allen"
        ];
