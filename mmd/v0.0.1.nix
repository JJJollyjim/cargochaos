...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mmd/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "enumflags2" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "173sicnasij2yx4slm286d0i5vih6y0y8p061w2br4jjvf3919f7";
        authors = [
      ...
      "enumflags2_derive" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "18j210zvrxibh66i076i1vfpdfiky89n8fbqqkz8g86pqjv317zg";
        procMacro = true;
        authors = [
          "maik klein <maikklein@googlemail.com>"
          "Jakub \"NieDżejkob\" Kądziołka <kuba@kadziolka.net>"
