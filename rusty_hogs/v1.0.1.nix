...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty_hogs/v1.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-drive3" = rec {
        crateName = "google-drive3";
        version = "1.0.12+20190620";
        edition = "2015";
        sha256 = "0j65pllkx7dc75ypl19jhnn8xq3xwdxn1nhsw49a5wsn0ahnszk3";
        authors = [
      ...
      "rust-s3" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0r6781v35d7xfay0b0gd6v4587m9jb8phjjcgd1vz81w4byysb82";
        libName = "s3";
        authors = [
          "Drazen Urch"
          "Nick Stevens"
      ...
      "rusty_hogs" = rec {
        crateName = "rusty_hogs";
        version = "1.0.1";
        edition = "2018";
        crateBin = [
          { name = "choctaw_hog"; path = "src/bin/choctaw_hog.rs"; }
          { name = "berkshire_hog_lambda"; path = "src/bin/berkshire_hog_lambda.rs"; }
          { name = "berkshire_hog"; path = "src/bin/berkshire_hog.rs"; }
          { name = "ankamali_hog"; path = "src/bin/ankamali_hog.rs"; }
        ];
      ...
      "simple-error" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "0lggl41nm4ar5fymr6x242zhqyd737wfha5v6294p11dmz4l961k";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
