...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/node-prune/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "node-prune" = rec {
        crateName = "node-prune";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "node-prune"; path = "src/bin/node-prune.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "makeco <lidongjies@gmail.com>"
        ];
        dependencies = [
          {
            name = "log";
