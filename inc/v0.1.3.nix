...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/inc/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwindef" "ntsecapi" "processenv" "profileapi" "utilapiset" "winbase" "wincon" "windef" "winnls" "winnt" "winuser" ];
      };
