...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssdp-client/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "genawaiter" = rec {
        ...
        resolvedDefaultFeatures = [ "futures-core" "futures03" ];
      };
