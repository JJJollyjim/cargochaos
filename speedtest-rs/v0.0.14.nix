...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/speedtest-rs/v0.0.14.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "speedtest-rs" = rec {
        crateName = "speedtest-rs";
        version = "0.0.14";
        edition = "2018";
        crateBin = [
          { name = "speedtest-rs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.14.nix {};
        authors = [
          "Nelson Chen <nelson@mindflakes.com>"
        ];
        dependencies = [
          {
            name = "chrono";
