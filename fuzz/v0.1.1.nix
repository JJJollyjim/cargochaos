...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fuzz/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fuzz" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "reqwest";
            packageId = "reqwest";
            features = [ "gzip" "cookies" ];
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "io-util" "io-std" "sync" "time" "stream" ];
          }
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "gzip" "hyper-tls" "native-tls-crate" "tokio-tls" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.3";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "memchr" "mio" "rt-core" "slab" "stream" "sync" "tcp" "time" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
