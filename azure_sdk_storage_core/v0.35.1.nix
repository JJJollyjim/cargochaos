...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_core/v0.35.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.36.0";
        edition = "2018";
        sha256 = "0q4hnd9gjy74yhb746xr6h5m7yxz91v7f0n16k9cnk116bwnni18";
        authors = [
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.35.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.35.1.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
