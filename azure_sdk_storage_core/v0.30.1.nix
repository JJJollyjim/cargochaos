...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_core/v0.30.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.30.1";
        edition = "2018";
        sha256 = "1sljyd4g4nqdh9l0bkdah33liy8fyiajwxwfsxyarm7jyf0l9f5h";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "default-tls" "hyper-tls" "native-tls" "tls" "tokio-tls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
