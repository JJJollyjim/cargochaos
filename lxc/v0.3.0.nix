...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lxc/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lxc" = rec {
        ...
        resolvedDefaultFeatures = [ "v1_0" "v1_1" "v2_0" "v2_1" "v3_0" "v3_1" "v3_2" ];
      };
      "lxc-sys" = rec {
        crateName = "lxc-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "18aranwvp1hibhq3v60ic8cjv42r552mi186sddd489c2hi2bbpi";
        authors = [
          "Sanpi <sanpi@homecomputing.fr>"
        ];
        dependencies = [
