...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lxc/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lxc" = rec {
        ...
        resolvedDefaultFeatures = [ "v1_0" "v1_1" "v2_0" "v2_1" "v3_0" "v3_1" "v3_2" "v4_0" ];
      };
      "lxc-sys" = rec {
        crateName = "lxc-sys";
        version = "0.2.1";
        edition = "2018";
        sha256 = "16kjspi7cpzlb04zilv651mmylxyd04i3vxd93l37ckhsa4c1mh2";
        authors = [
          "Sanpi <sanpi@homecomputing.fr>"
        ];
        dependencies = [
