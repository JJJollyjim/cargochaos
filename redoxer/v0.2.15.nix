...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redoxer/v0.2.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "partition-identity" = rec {
        ...
        version = "0.2.7";
        edition = "2015";
        sha256 = "0xwbwv0gzk97gvwf8nv2s63rbgn85lilhccya0y09nr2fgnzjhv1";
        authors = [
          "Michael Aaron Murphy <mmstickman@gmail.com>"
        ];
        dependencies = [
      ...
      "proc-mounts" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "1nmd8bg59lr24n8g54md68d5gxacs41dfxs4rdzx47a36hhlg8ga";
        authors = [
      ...
      "redox_installer" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "14jf6lx3h7xmqfla3niy891z90nvvj5qagdvdkjjybzjggf8w0zk";
        authors = [
          "Jeremy Soller <jackpot51@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
