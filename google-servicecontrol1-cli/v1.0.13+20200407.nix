...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-servicecontrol1-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-servicecontrol1-cli";
  ...
  workspaceMembers = {
    "google-servicecontrol1-cli" = rec {
      packageId = "google-servicecontrol1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-servicecontrol1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-servicecontrol1" = rec {
        crateName = "google-servicecontrol1";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "0ygi41303zlw2fgyk3h6g5wv779ik2rqp9xbhr9ib7jbdvkc5iq7";
        authors = [
      ...
      "google-servicecontrol1-cli" = rec {
        crateName = "google-servicecontrol1-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "servicecontrol1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200407.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-servicecontrol1";
            packageId = "google-servicecontrol1";
          }
          {
            name = "hyper";
            packageId = "hyper";
