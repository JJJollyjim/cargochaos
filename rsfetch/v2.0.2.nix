...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsfetch/v2.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rsfetch" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rsfetch"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v2.0.2.nix {};
        authors = [
          "Phate6660 <ValleyKnight@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "snafu" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "06aywfjahj82g5y8big0prs2kyrlxx6y2y2fbz5lcnjm27xq619j";
        authors = [
      ...
      "snafu-derive" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "17bv82qzyvis7k524k2ciqp3702paawd8q91zk4ghf9k4f3n7c28";
        procMacro = true;
        authors = [
          "Jake Goulding <jake.goulding@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
