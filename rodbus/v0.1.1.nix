...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rodbus/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "test-util" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
