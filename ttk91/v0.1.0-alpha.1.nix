...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ttk91/v0.1.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ttk91" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ttk91repl"; path = "bin/repl.rs"; }
          { name = "ttk91run"; path = "bin/run.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.1.nix {};
        authors = [
          "Mitja Karhusaari <mitja@karhusaari.me>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "clap" "slog-async" "slog-term" "tools" "ttk91repl" "ttk91run" ];
      };
      "unicode-width" = rec {
