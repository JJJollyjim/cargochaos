...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fido2luks/v0.2.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ctap_hmac" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0la35cfkkn7vnnvdlxkjj183sz7vxyrqwr8h7k2kjidp6dr4a8kb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "crossbeam" "request_multiple" ];
      };
      "darling" = rec {
        crateName = "darling";
        version = "0.10.2";
