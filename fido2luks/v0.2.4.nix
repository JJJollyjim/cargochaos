...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fido2luks/v0.2.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libcryptsetup-rs" = rec {
        crateName = "libcryptsetup-rs";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0lpijxbabrjxmlki509a20l3r489hciy64vy4kdmlah2xk87y5y0";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "libcryptsetup-rs-sys";
          }
          {
            name = "serde_json";
      ...
      "libcryptsetup-rs-sys" = rec {
        crateName = "libcryptsetup-rs-sys";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0hjmplx07x315bxw643nnspz1hqx083z26i0cbyrkncy2kyrgba1";
        authors = [
          "John Baublitz <jbaublitz@redhat.com>"
        ];
        buildDependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
