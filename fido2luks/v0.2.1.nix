...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fido2luks/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blkid-rs" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1l0xwyhnw8n73q04i9yi8rsfc6a5iwd337yzv84zfy4qlqbyamjh";
        libName = "blkid_rs";
        authors = [
          "Vladimir Lushnikov <vladimir@solidninja.is>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "cryptsetup-rs" = rec {
        crateName = "cryptsetup-rs";
        version = "0.2.1";
        edition = "2018";
        sha256 = "12h20wm5b5hj5jqcf6n0zy5sggacba7ybcrp5jswgzc0zymvc7lb";
        libName = "cryptsetup_rs";
        authors = [
          "Vladimir Lushnikov <vladimir@solidninja.is>"
        ];
        dependencies = [
      ...
      "ctap_hmac" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1qqmw4w365d4zmkd2zvsffxskw5pdvymnpq6h0r9xjf9190bk4ag";
        authors = [
          "Arda Xi <arda@ardaxi.com>"
          "shimun <shimun@shimun.net>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "fido2luks" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "fido2luks"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "shimunn <shimun@shimun.net>"
        ];
        dependencies = [
          {
            name = "cryptsetup-rs";
            packageId = "cryptsetup-rs";
          }
          {
            name = "ctap_hmac";
            packageId = "ctap_hmac";
      ...
      "libcryptsetup-sys" = rec {
        crateName = "libcryptsetup-sys";
        version = "0.1.2";
        edition = "2018";
        sha256 = "15pmhirnkphnlkbm0qsp70jh5jbm9cdsbzs278kfl5kkziyv7jpq";
        libName = "libcryptsetup_sys";
        libPath = "lib.rs";
        authors = [
          "Vladimir Lushnikov <vladimir@solidninja.is>"
        ];
