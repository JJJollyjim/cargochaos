...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dicom-dictionary-builder/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "dicom-dictionary-builder";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dicom-dictionary-builder" = rec {
        crateName = "dicom-dictionary-builder";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "dicom-dictionary-builder"; path = "src/main.rs"; }
        ];
