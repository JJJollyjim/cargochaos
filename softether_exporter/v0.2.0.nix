...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/softether_exporter/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "softether_exporter" = rec {
        crateName = "softether_exporter";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "softether_exporter"; path = "src/main.rs"; }
        ];
