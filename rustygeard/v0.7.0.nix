...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustygeard/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hash_ring" = rec {
        ...
        version = "0.1.7";
        edition = "2015";
        sha256 = "0r5wcjhzqcz56rg0zmvlxf66hz29hcb5mmynhm8ka5kkd9skrz70";
        authors = [
      ...
      "rustygear" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0sy707ni4j7fixlviyjqh0ca5yvfdxgbwj5fxi9nc1bhpx8dd98q";
        authors = [
      ...
      "rustygeard" = rec {
        crateName = "rustygeard";
        version = "0.7.0";
        edition = "2018";
        crateBin = [
          { name = "rustygeard"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "wrappinghashset";
            packageId = "wrappinghashset";
          }
        ];
      ...
      "wrappinghashset" = rec {
        crateName = "wrappinghashset";
        version = "0.4.1";
        edition = "2018";
        crateBin = [];
        sha256 = "0kxr0mqs13sz4nn0b8iyhyjsmam9dsqm7kjj0brvsvb68asl10bm";
        authors = [
          "Clint Byrum <clint@fewbar.com>"
        ];
