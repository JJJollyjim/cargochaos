...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/syswall_cli/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "signal-hook" = rec {
        ...
        version = "0.1.8";
        edition = "2015";
        sha256 = "089h7qii58p36ffpshx4p9m1wni007bg7rll0bmyr2ri4bkpm94p";
        authors = [
          "Michal 'vorner' Vaner <vorner@vorner.cz>"
        ];
        dependencies = [
      ...
      "syswall" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1ch27xhhg66fi3z1zpwsy9dbchh16pszfpywv86clj0lhab3xnkk";
        authors = [
      ...
      "syswall_cli" = rec {
        crateName = "syswall_cli";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "syswall_cli"; path = "src/main.rs"; }
        ];
