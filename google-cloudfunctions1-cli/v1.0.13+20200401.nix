...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudfunctions1-cli/v1.0.13+20200401.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudfunctions1" = rec {
        ...
        edition = "2015";
        sha256 = "1v3kc2n4hh33ml818m2k9hd1pz34wh71nwkp9ksk4zbyx93qnh9h";
        authors = [
      ...
      "google-cloudfunctions1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200401.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
