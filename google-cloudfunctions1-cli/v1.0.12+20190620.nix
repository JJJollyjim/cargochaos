...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudfunctions1-cli/v1.0.12+20190620.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudfunctions1-cli";
  ...
  workspaceMembers = {
    "google-cloudfunctions1-cli" = rec {
      packageId = "google-cloudfunctions1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudfunctions1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudfunctions1" = rec {
        crateName = "google-cloudfunctions1";
        version = "1.0.12+20190620";
        edition = "2015";
        sha256 = "1vaicmx8vajzkkvsxdhhsy2bx9c9sa0qdydxlrjskv4p8h1ia5a6";
        authors = [
      ...
      "google-cloudfunctions1-cli" = rec {
        crateName = "google-cloudfunctions1-cli";
        version = "1.0.12+20190620";
        edition = "2015";
        crateBin = [
          { name = "cloudfunctions1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190620.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-cloudfunctions1";
            packageId = "google-cloudfunctions1";
          }
          {
            name = "hyper";
            packageId = "hyper";
