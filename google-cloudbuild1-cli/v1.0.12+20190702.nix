...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudbuild1-cli/v1.0.12+20190702.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudbuild1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudbuild1" = rec {
        crateName = "google-cloudbuild1";
        version = "1.0.12+20190702";
        edition = "2015";
        sha256 = "13f7qys6n9pkv3i1821rs7cbcnhzbn04lh8s7bs9xm84pmf2xkh4";
        authors = [
      ...
      "google-cloudbuild1-cli" = rec {
        crateName = "google-cloudbuild1-cli";
        version = "1.0.12+20190702";
        edition = "2015";
        crateBin = [
          { name = "cloudbuild1"; path = "src/main.rs"; }
        ];
