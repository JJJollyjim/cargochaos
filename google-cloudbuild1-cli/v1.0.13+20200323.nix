...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudbuild1-cli/v1.0.13+20200323.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudbuild1" = rec {
        ...
        edition = "2015";
        sha256 = "0k3g2xj8lw8hcpx4sqmpkg0q14w09cfyb4x81y1h5ah92rrbk3m5";
        authors = [
      ...
      "google-cloudbuild1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200323.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
