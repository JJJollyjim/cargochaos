...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/random-geojson-points/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "random-geojson-points";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "random-geojson-points" = rec {
        crateName = "random-geojson-points";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "random-geojson-points"; path = "src/main.rs"; }
        ];
