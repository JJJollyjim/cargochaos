...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lol_html/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "html5ever" = rec {
        ...
        version = "0.21.0";
        edition = "2015";
        sha256 = "08zmgsqpxp9pdla7amdbq23n92mzsz2n84qr1i0lswbshp8iyfms";
        authors = [
      ...
      "lol_html" = rec {
        ...
        resolvedDefaultFeatures = [ "debug_trace" "integration_test" ];
      };
      "mac" = rec {
        crateName = "mac";
        version = "0.1.1";
      ...
      "markup5ever" = rec {
        ...
        version = "0.6.2";
        edition = "2015";
        sha256 = "1z7mvwaxqvh86rlkggg23h592f54z7fma52jk6fjrhw60hz9vy1c";
        libPath = "lib.rs";
        authors = [
          "The html5ever Project Developers"
        ];
      ...
      "pre-commit" = rec {
        crateName = "pre-commit";
        version = "0.5.2";
        edition = "2015";
        sha256 = "13xglppqipxiqrik6alcpi2df29ji0xij77phv6r3v44gy4bkwnh";
        authors = [
          "Joe Grund <grundjoseph@gmail.com>"
        ];
        buildDependencies = [
          {
            name = "rustc-serialize";
      ...
      "rustc-test" = rec {
        crateName = "rustc-test";
        version = "0.3.0";
        edition = "2015";
        sha256 = "0a27mlcg0ck0hgsdvwk792x9z1k1qq1wj091f1l5yggbdbcsnx5w";
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
