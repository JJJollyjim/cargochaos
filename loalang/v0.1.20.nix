...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/loalang/v0.1.20.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fraction" = rec {
        ...
        version = "0.6.2";
        edition = "2015";
        sha256 = "0knp3m68cyhx5sydphjykp77mdcddimp2grh2g411cigr2d1am8h";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "serde" "serde_derive" "with-bigint" "with-decimal" "with-dynaint" "with-serde-support" ];
      };
      "fuchsia-cprng" = rec {
      ...
      "hyper-staticfile" = rec {
        ...
        version = "0.4.2";
        edition = "2015";
        sha256 = "17s1j2dvgz9zhah0yww3fz8w40k9777fm886jlp73y165l145ysl";
        authors = [
      ...
      "jsonrpc-core" = rec {
        ...
        version = "14.0.0";
        edition = "2018";
        sha256 = "0va2zlinzs1cmxljp3ihryi56nzprgkzymwmscpkz14xvx7l2d6g";
        authors = [
      ...
      "jsonrpc-stdio-server" = rec {
        crateName = "jsonrpc-stdio-server";
        version = "14.0.0";
        edition = "2018";
        sha256 = "13r6wgm43cxy8rx6d1rzf71v8zd2nnbgs53x32lbji8fsg7wvxzi";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "loalang" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "loa"; path = "src/bin/loa.rs"; }
          { name = "loavm"; path = "src/bin/loavm.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.20.nix {};
        libName = "loa";
        libPath = "src/lib/mod.rs";
        authors = [
          "Emil Broman <emil@emilbroman.me>"
        ];
        dependencies = [
          {
            name = "atty";
          ...
          }
          {
            ...
            packageId = "jsonrpc-stdio-server";
            optional = true;
          }
          {
            name = "log";
        ...
        resolvedDefaultFeatures = [ "build-bin-loa" "build-bin-vm" "clap" "colored" "dirs" "graphql_client" "http" "hyper" "hyper-staticfile" "ignore" "jsonrpc-stdio-server" "log-panics" "lsp-server" "lsp-types" "reqwest" "rpassword" "rust-crypto" "rustyline" "serde_json" "serde_yaml" "simple-logging" "tar" "tee" "test-library" ];
      };
      "lock_api" = rec {
        crateName = "lock_api";
        version = "0.3.1";
      ...
      "lsp-server" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "04i06q85g9n0yp3xqpsjdksfdxa2nb8hz8mlkwyw559j1cfgp30l";
        authors = [
      ...
      "lsp-types" = rec {
        ...
        version = "0.60.0";
        edition = "2018";
        sha256 = "1zafi5g1j8b6v93mgg54bkf3mjd341jz81pp3mzizpkdsvydwgpy";
        authors = [
          "Markus Westerlind <marwes91@gmail.com>"
      ...
      "ngrammatic" = rec {
        crateName = "ngrammatic";
        version = "0.3.1";
        edition = "2015";
        sha256 = "0s5jhrrz2zhz63vawi8l6nyivyaiw2wsf5ng61fykcpiva709lgn";
        authors = [
          "Will Page <compenguy@gmail.com>"
        ];
      ...
      "num" = rec {
        ...
        resolvedDefaultFeatures = [ "num-bigint" "serde" "std" ];
      };
      "num-bigint" = rec {
      ...
      "peekmore" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0kki0vbb8vj7nxi52b9v916p97sqfifi8d00jjkd9wh3k2akdxm2";
        authors = [
          "foresterre <garm@ilumeo.com>"
        ];
        features = {
        };
        resolvedDefaultFeatures = [ "default" ];
      ...
      "tee" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1nm3k4bi2cdrr9dkfi2hi3y5pwzc9gi5pxxgz8jkcf57vdcjbh9p";
        authors = [
          "softprops <d.tangren@gmail.com>"
        ];
      ...
      "tokio-stdin-stdout" = rec {
        crateName = "tokio-stdin-stdout";
        version = "0.1.5";
        edition = "2015";
        sha256 = "05qcf9nigsra3m1qcvij5ws6p2sn8fa7ypm6iqpsa3ri0p981i0z";
        authors = [
