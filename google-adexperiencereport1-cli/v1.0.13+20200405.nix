...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adexperiencereport1-cli/v1.0.13+20200405.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adexperiencereport1" = rec {
        ...
        edition = "2015";
        sha256 = "1r50xjrs3nmnsxm9v2bx73vdx3arm0vl5y5s6mmi7rgz1qrfl88f";
        authors = [
