...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/urpc/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "postcard" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "143sj78nqlb9xy7ik016zbbm02l25x1n10mljsd78fmzn165ncgr";
        authors = [
      ...
      "postcard-cobs" = rec {
        crateName = "postcard-cobs";
        version = "0.1.5-pre";
        edition = "2018";
        sha256 = "0zzr5963a48gn6i86h0h2niw3nf8nxjz3f2xvp4ppz8kxlwcns3w";
        authors = [
          "Allen Welkie <>"
          "James Munns <james.munns@ferrous-systems.com>"
        ];
