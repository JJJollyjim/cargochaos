...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/phosphorus/v0.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "phosphorus" = rec {
        ...
        features = {
          "default" = [ "global_loader" "struct_loader" "trace_calls" "error_checks" ];
        };
        resolvedDefaultFeatures = [ "default" "error_checks" "global_loader" "struct_loader" "trace_calls" ];
      };
      "ppv-lite86" = rec {
