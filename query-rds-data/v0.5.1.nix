...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/query-rds-data/v0.5.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "query-rds-data" = rec {
        crateName = "query-rds-data";
        version = "0.5.1";
        edition = "2018";
        crateBin = [
          { name = "query-rds-data"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "rusoto_rds";
            packageId = "rusoto_rds";
          }
          {
            name = "rusoto_rds_data";
            packageId = "rusoto_rds_data";
          }
          {
            name = "rusoto_secretsmanager";
            packageId = "rusoto_secretsmanager";
          }
          {
            name = "snafu";
            packageId = "snafu";
      ...
      "rusoto_rds" = rec {
        crateName = "rusoto_rds";
        version = "0.42.0";
        edition = "2018";
        sha256 = "1vp8k62k926rd1nn28d9v0l2180crpx2zkp7zwivs1y6bihdp68c";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "rusoto_rds_data" = rec {
        crateName = "rusoto_rds_data";
        version = "0.42.0";
        edition = "2018";
        sha256 = "1k3b53npwxs74gv0r7hnkg80q4zgarll70s0p9pi4i3imkp6smzj";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "rusoto_secretsmanager" = rec {
        crateName = "rusoto_secretsmanager";
        version = "0.42.0";
        edition = "2018";
        sha256 = "0prjrp4fg09k7wvvg6m6czhx3bgayag4yddydy1fg6748xb0z3hg";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
