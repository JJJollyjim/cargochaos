...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hole-punch/v0.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hole-punch" = rec {
        crateName = "hole-punch";
        version = "0.0.3";
        edition = "2018";
        crateBin = [
          { name = "hole_info"; path = "src/bin/hole_info.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwindef" "ntdef" "std" "winbase" "winerror" "winioctl" ];
      };
