...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sim2h_server/v0.0.47-alpha1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sim2h_server" = rec {
        crateName = "sim2h_server";
        version = "0.0.47-alpha1";
        edition = "2018";
        crateBin = [
          { name = "sim2h_server"; path = "src/main.rs"; }
        ];
