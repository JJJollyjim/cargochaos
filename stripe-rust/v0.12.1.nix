...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stripe-rust/v0.12.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stripe-rust" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "billing" "blocking" "checkout" "connect" "default" "events" "fraud" "full" "hmac" "issuing" "orders" "sha2" "sigma" "webhook-endpoints" "webhook-events" "webhooks" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.11";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
