...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gitweb/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "processenv" "shellapi" "winbase" ];
      };
