...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/inkwell/v0.1.0-llvm8sample.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alloc-traits" = rec {
        crateName = "alloc-traits";
        version = "0.1.1";
        edition = "2018";
        sha256 = "10z4rmykwnp8ps5r5n34190h6gmzpj1f67fqildi1z8r6f2m8bbb";
        libName = "alloc_traits";
        authors = [
          "Andreas Molzer <andreas.molzer@gmx.de>"
        ];
      ...
      "inkwell" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-llvm8sample.nix {};
        authors = [
        ...
        features = {
          ...
          "target-all" = [ "target-x86" "target-arm" "target-mips" "target-aarch64" "target-amdgpu" "target-systemz" "target-hexagon" "target-nvptx" "target-msp430" "target-xcore" "target-powerpc" "target-sparc" "target-bpf" "target-lanai" "target-webassembly" ];
        };
        resolvedDefaultFeatures = [ "default" "experimental" "llvm3-6" "llvm3-7" "llvm3-8" "llvm3-9" "llvm4-0" "llvm5-0" "llvm6-0" "llvm7-0" "llvm8-0" "no-llvm-linking" "static-alloc" "target-aarch64" "target-all" "target-amdgpu" "target-arm" "target-bpf" "target-hexagon" "target-lanai" "target-mips" "target-msp430" "target-nvptx" "target-powerpc" "target-sparc" "target-systemz" "target-webassembly" "target-x86" "target-xcore" ];
      };
      "inkwell_internals" = rec {
        crateName = "inkwell_internals";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0arzyvjjdwwa006gsp6pvpbkrr7pmpy0mqqqhgliaqpqiyyl562m";
        procMacro = true;
        authors = [
          "Daniel Kolsoi <thadan64@gmail.com>"
        ];
      ...
      "llvm-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "no-llvm-linking" ];
      };
      "lock_api" = rec {
        crateName = "lock_api";
        version = "0.3.1";
      ...
      "static-alloc" = rec {
        crateName = "static-alloc";
        version = "0.2.1";
        edition = "2018";
        sha256 = "14gwc0q9vxybqx1x4lprj7zjs2k2iqc3dirzkxnzfh1glmy9f8jv";
        authors = [
          "Andreas Molzer <andreas.molzer@gmx.de>"
        ];
        dependencies = [
