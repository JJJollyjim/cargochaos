...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pyflow/v0.2.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" "doc" "term_size" "wrap_help" "yaml" "yaml-rust" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
        ...
        dependencies = [
          {
            ...
            packageId = "crossterm_cursor 0.3.1";
            optional = true;
          }
          {
            name = "crossterm_input";
            packageId = "crossterm_input 0.4.1";
            optional = true;
          }
          {
          ...
          }
          {
            ...
            packageId = "crossterm_utils 0.3.1";
          }
        ];
        features = {
      ...
      "crossterm_cursor 0.3.1" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "crossterm_winapi 0.2.1";
            target = { target, features }: target."windows";
          }
          {
            name = "winapi";
      ...
      "crossterm_cursor 0.4.0" = rec {
        ...
        dependencies = [
          {
            name = "crossterm_input";
            packageId = "crossterm_input 0.5.0";
          }
          {
            name = "crossterm_utils";
            packageId = "crossterm_utils 0.4.0";
          }
          {
            name = "crossterm_winapi";
            packageId = "crossterm_winapi 0.3.0";
            target = { target, features }: target."windows";
          }
          {
            name = "lazy_static";
      ...
      "crossterm_style" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "11hxr0gjzr8mn1cb84lkhg9r50jgwcvdypn8cpvvjx5y0cml0mml";
        authors = [
          "T. Post"
        ];
        dependencies = [
      ...
      "crossterm_terminal" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "125wsjg1nbv1yiw3h2x8c3bdp6dcwhah5mrzz8ir259pdja9pw5k";
        authors = [
          "T. Post"
        ];
        dependencies = [
          {
            name = "crossterm_cursor";
            packageId = "crossterm_cursor 0.4.0";
          }
          {
            name = "crossterm_utils";
            packageId = "crossterm_utils 0.4.0";
      ...
      "pyflow" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pyflow"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.5.nix {};
        authors = [
          "David O'Connor <david.alan.oconnor@gmail.com>"
        ];
        dependencies = [
          {
            name = "crossterm";
      ...
      "structopt" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "doc" "wrap_help" ];
      };
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
