...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-genomics1-cli/v1.0.13+20200316.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-genomics1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-genomics1" = rec {
        crateName = "google-genomics1";
        version = "1.0.13+20200316";
        edition = "2015";
        sha256 = "1w6dk2cn8zbwh0fv7mskfz94jz3l1jag24lipfp7f18dxwjcx3wk";
        authors = [
      ...
      "google-genomics1-cli" = rec {
        crateName = "google-genomics1-cli";
        version = "1.0.13+20200316";
        edition = "2015";
        crateBin = [
          { name = "genomics1"; path = "src/main.rs"; }
        ];
