...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst_gltf" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "1r21dsgbxa1znjx5qy1wwb1jknm49am2irvmfjny6j6cc24vkya4";
        authors = [
      ...
      "amethyst_tiles" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0m87dh8l6w2cfkqki81vxcqa6bs2gfqzyy5bw8dghgaxp8f96881";
        authors = [
      ...
      "shred 0.9.3" = rec {
        ...
        resolvedDefaultFeatures = [ "nightly" "parallel" "rayon" "shred-derive" ];
      };
      "shred-derive" = rec {
