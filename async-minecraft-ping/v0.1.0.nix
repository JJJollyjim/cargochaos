...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-minecraft-ping/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "async-minecraft-ping";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-minecraft-ping" = rec {
        crateName = "async-minecraft-ping";
        version = "0.1.0";
        edition = "2018";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "rt-core" "tcp" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
