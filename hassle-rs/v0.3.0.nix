...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hassle-rs/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "com-rs" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0qrf5i1pvb1b4cc00j888908fai6npg671y435j38bnwz4qkj5lq";
        authors = [
      ...
      "rspirv" = rec {
        ...
        version = "0.5.4";
        edition = "2015";
        sha256 = "1qr0qf48gik7bgjqabhzn00krbffnbkb4gcyr63vadjg362qa4ps";
        libPath = "lib.rs";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "libloaderapi" "minwindef" "ntsecapi" "oleauto" "profileapi" "winerror" "winnt" "wtypes" ];
      };
