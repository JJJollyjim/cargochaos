...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/archivelib/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "archivelib" = rec {
        crateName = "archivelib";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "unalzip"; path = "src/executables/decompress.rs"; }
          { name = "alzip"; path = "src/executables/compress.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Opal Symes <code@opal.codes>"
        ];
        dependencies = [
          {
            name = "archivelib-sys";
            packageId = "archivelib-sys";
            optional = true;
          }
          {
            name = "failure";
        ...
        resolvedDefaultFeatures = [ "archivelib-sys" "default" "new_impl" "sys" ];
      };
      "archivelib-sys" = rec {
        crateName = "archivelib-sys";
        version = "0.2.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0l6dbhr2q6asa1rvrlwhrnqqw6pz077znw87im7h5akaab5ycipk";
        authors = [
          "Opal Symes <code@opal.codes>"
        ];
        buildDependencies = [
      ...
      "humthreads" = rec {
        crateName = "humthreads";
        version = "0.1.4";
        edition = "2018";
        sha256 = "0z28iw86fwkgfl62dn2frlx7wvf178mv3hgdpv92hykxlv3kf9nd";
        authors = [
          "Stefano Pogliani <stefano@spogliani.net>"
        ];
        dependencies = [
          {
