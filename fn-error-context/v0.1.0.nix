...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fn-error-context/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fn-error-context" = rec {
        crateName = "fn-error-context";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        procMacro = true;
        libName = "fn_error_context";
        authors = [
