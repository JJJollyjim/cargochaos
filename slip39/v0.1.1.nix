...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/slip39/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitvec" = rec {
        ...
        version = "0.10.2";
        edition = "2018";
        sha256 = "1yk6r6c8ykimkdvswn55bqs3bybscahf5y21bc0hnlk3kyarai18";
        authors = [
      ...
      "sssmc39" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "0s61qayy2xv46gmf9mjgz3kwqzhrlng2250ab0j22ji12ln1rck5";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "digest" "ring" "ring_pbkdf2" ];
      };
      "strsim" = rec {
        crateName = "strsim";
        version = "0.8.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "winbase" "winerror" "winnt" "wtypesbase" ];
      };
