...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/heed/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "heed" = rec {
        ...
        resolvedDefaultFeatures = [ "arbitrary_precision" "bincode" "default" "preserve_order" "raw_value" "serde" "serde-bincode" "serde-json" "serde_json" "unbounded_depth" ];
      };
      "idna" = rec {
        crateName = "idna";
        version = "0.2.0";
      ...
      "serde_json" = rec {
        ...
        resolvedDefaultFeatures = [ "arbitrary_precision" "default" "indexmap" "preserve_order" "raw_value" "std" "unbounded_depth" ];
      };
      "smallvec" = rec {
        crateName = "smallvec";
        version = "1.2.0";
