...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ash-molten/v0.30.0+38.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ash-molten" = rec {
        crateName = "ash-molten";
        version = "0.30.0+38";
        edition = "2018";
        crateBin = [
          { name = "main"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.30.0+38.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "external" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
