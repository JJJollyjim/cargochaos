...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/coinmarket/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coinmarket" = rec {
        crateName = "coinmarket";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Anthony Wilcox <35226681+antonwilc0x@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "reqwest";
