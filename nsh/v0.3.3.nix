...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nsh/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "winbase" "winerror" "winuser" ];
      };
