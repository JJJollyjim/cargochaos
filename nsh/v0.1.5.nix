...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nsh/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_trace" "release_max_level_warn" ];
      };
      "maplit" = rec {
        crateName = "maplit";
        version = "1.0.2";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "winerror" "winnt" "winuser" ];
      };
