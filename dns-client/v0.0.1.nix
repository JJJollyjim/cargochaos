...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dns-client/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dns-client" = rec {
        crateName = "dns-client";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "dns-client"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Torben Carstens <github@carstens.tech>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "dnsclient" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "08w4rpvlxq567sic7r4w3q2hfgah8h1pxnk4jmpgbvjhwdr6931i";
        authors = [
      ...
      "dnssector" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0z2wvv6k4nkvzf187kpzs11gb91w974gsmc18pn5q5wy0fv8n4zp";
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
