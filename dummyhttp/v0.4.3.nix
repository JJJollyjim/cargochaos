...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dummyhttp/v0.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web" = rec {
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-zlib" "rust-tls" "rustls" ];
      };
      ...
      "dummyhttp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dummyhttp"; path = "src/main.rs"; }
        ];
      ...
      "port_check" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0q4r7ayc9v4482b56pzx171ap3kqdkbj3fwn8a69apry68qnisjf";
        authors = [
      ...
      "rstest" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1xzlrf89lhji7pg3ggxf9v55cbh15k60pr01f0ygdg45nwxk84kd";
        procMacro = true;
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
