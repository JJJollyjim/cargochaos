...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ganganonline-parser-json/v0.0.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "ganganonline-parser-json";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ganganonline-parser-json" = rec {
        crateName = "ganganonline-parser-json";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "ganganonline-parser-json"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          {
            ...
            packageId = "ganganonline-parser-lib";
            features = [ "serde" ];
          }
          {
            name = "quick-protobuf";
      ...
      "ganganonline-parser-lib" = rec {
        crateName = "ganganonline-parser-lib";
        version = "0.0.0";
        edition = "2018";
        sha256 = "0b727zcld01v78vv59rwxcvh8400ps4lw2xgn2xwwppb5b9fz4n9";
        authors = [
          "Zane Hannan <zanehannanau@gmail.com>"
        ];
        dependencies = [
      ...
      "pb-rs" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "082cl7krf6v0cjdm1v13kgwzryi776mn24bp1idsapycsxyc0g9k";
        authors = [
      ...
      "quick-protobuf" = rec {
        ...
        version = "0.6.4";
        edition = "2018";
        sha256 = "1hin36bg7mnh9ccf1jbai80f9ryv5dlwjq2vpkzbrsycg9414l1m";
        authors = [
          "Johann Tuffe <tafia973@gmail.com>"
        ];
        dependencies = [
