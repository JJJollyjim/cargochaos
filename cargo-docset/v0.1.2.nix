...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-docset/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-docset" = rec {
        crateName = "cargo-docset";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "cargo-docset"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "R.Chavignat <r.chavignat@gmail.com>"
        ];
        dependencies = [
          {
            name = "cargo";
