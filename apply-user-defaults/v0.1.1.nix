...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/apply-user-defaults/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "apply-user-defaults" = rec {
        crateName = "apply-user-defaults";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "apply-user-defaults"; path = "src/main.rs"; }
        ];
