...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/deadpool/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deadpool" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "bench_postgres"; path = "src/bin/bench_postgres.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "postgres" "tokio-postgres" ];
      };
      "digest" = rec {
        crateName = "digest";
        version = "0.8.1";
