...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket_prometheus/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket_contrib" = rec {
        ...
        version = "0.4.3";
        edition = "2015";
        sha256 = "08xmxz01y9h3shpqqiy9ws6ai50f3d5gb19qql264fclxya6i4k6";
        authors = [
          "Sergio Benitez <sb@sergio.bz>"
        ];
        dependencies = [
