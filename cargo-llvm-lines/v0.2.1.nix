...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-llvm-lines/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-llvm-lines" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-llvm-lines"; path = "src/main.rs"; }
        ];
