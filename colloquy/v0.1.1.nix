...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/colloquy/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colloquy" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "colloquy"; path = "src/main.rs"; }
        ];
      ...
      "libc-stdhandle" = rec {
        crateName = "libc-stdhandle";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0lbmg42kncl3yjgzx48d2sa3p78w4fmhs9c21dg4r4r8virj9b3d";
        authors = [
          "CrLF0710 <crlf0710@gmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "libnotcurses-sys" = rec {
        crateName = "libnotcurses-sys";
        version = "1.2.5";
        edition = "2018";
        sha256 = "08gvx9glamd1yddycikndy5z70r3dp785n31zi3zhipwphwvihwn";
        authors = [
          "nick black <dankamongmen@gmail.com>"
        ];
        dependencies = [
      ...
      "notcurses" = rec {
        ...
        version = "1.2.5";
        edition = "2018";
        sha256 = "1vxh4h5x62k3cx84akrqvirwn8nrkxa8arvn7j1432mhs256s9hh";
        authors = [
          "nick black <dankamongmen@gmail.com>"
        ];
        dependencies = [
