...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/viscous/v0.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cryptovec" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "1gdl3sjnaakbc03cdz3k3khggh8jshv1iv4nchbimcxpykg98f6j";
        authors = [
      ...
      "mini-fs" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "0fkv1sgicv3szr6iqd42s742w190392354lamkrmhl42pv3nxyfy";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "flate2" "tar" "tar_" "zip" "zip_" ];
      };
      "miniz_oxide" = rec {
      ...
      "thrussh" = rec {
        ...
        version = "0.22.1";
        edition = "2018";
        sha256 = "0rma2a9rb8rb8m2slnmz8vcx4c661zrh4alhiyhm62rnxzn1p0ac";
        authors = [
          "Pierre-Étienne Meunier <pe@pijul.org>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "thrussh-libsodium 0.1.4";
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "rt-threaded" "time" "stream" "tcp" "sync" "macros" ];
          }
        ];
        devDependencies = [
          {
      ...
      "thrussh-keys" = rec {
        ...
        version = "0.13.1";
        edition = "2018";
        sha256 = "144cza49ajx954nmdabv3qpz7sbkfv045q8qanc5qcmqs79ndvdz";
        authors = [
          "Pierre-Étienne Meunier <pe@pijul.org>"
        ];
        dependencies = [
          ...
          {
            name = "thrussh-libsodium";
            packageId = "thrussh-libsodium 0.2.0";
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "rt-threaded" "time" "uds" "stream" ];
          }
          {
            name = "yasna";
            packageId = "yasna";
      ...
      "thrussh-libsodium 0.1.4" = rec {
        crateName = "thrussh-libsodium";
        version = "0.1.4";
        edition = "2015";
        sha256 = "0fjssjiwnmbxjvajk37l7k0fcw1ys97j7n8bpn3q3bbnz2qfrphv";
        authors = [
      ...
      "thrussh-libsodium 0.2.0" = rec {
        crateName = "thrussh-libsodium";
        version = "0.2.0";
        edition = "2015";
        sha256 = "02kyc5hs805hmr90xd503hklwidvzqia76l45ac2v6a3j6fh8x46";
        authors = [
          "pe@pijul.org <pe@pijul.org>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "twitter-stream" = rec {
        ...
        edition = "2018";
        sha256 = "0ipb21mb019vymak4a06yrnsn8fzrjnabyd9f68kw3zxgpkhb3sk";
        authors = [
          "Daiki Mizukami <tesaguriguma@gmail.com>"
        ];
        dependencies = [
      ...
      "vfs" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "10a23ggdfdfnffz04nk6fa865x8g6v6rm4r7pf3pn75cv500wy9p";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
