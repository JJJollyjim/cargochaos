...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bpf/v0.9.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bpf-sys" = rec {
        ...
        version = "0.9.9";
        edition = "2018";
        sha256 = "01qasg4wrmcsx9a8inpk18ryrc6hcd0w58dgiwkxi47ximi3wszz";
        authors = [
      ...
      "redbpf" = rec {
        ...
        version = "0.9.9";
        edition = "2018";
        sha256 = "1h6y0x6b0w4xp0gfkr4j5lcm8s5lzpmbmang8a6yqc20chmazniv";
        authors = [
          "Peter Parkanyi <peter@redsift.io>"
          "Alessandro Decina <alessandro.d@gmail.com>"
        ];
