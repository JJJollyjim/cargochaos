...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bpf/v0.9.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bpf-sys" = rec {
        ...
        version = "0.9.3";
        edition = "2018";
        sha256 = "04cj7bdcad3zm1w123rilf1k5ifb5bkhi9dc21hwmfkibwz7wwbf";
        authors = [
      ...
      "redbpf" = rec {
        ...
        version = "0.9.2";
        edition = "2018";
        sha256 = "1y23ij30frjb2gzgd46pchspgbvjjhf0mb7qzy1fw943vq8904gc";
        authors = [
          "Peter Parkanyi <peter@redsift.io>"
          "Alessandro Decina <alessandro.d@gmail.com>"
        ];
