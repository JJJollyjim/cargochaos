...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bpf/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bpf-sys" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0jmly0w4s07xcs9v5bd3jg5sxwmd40bf20dkwqb8xssc7ljny1p2";
        authors = [
      ...
      "cargo-bpf" = rec {
        ...
        resolvedDefaultFeatures = [ "build" "build-c" "clap" "command-line" "default" "futures" "hexdump" "redbpf" "tokio" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "redbpf" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1k5mirrsbmlck6xp2i5mbzx748cqyj94cyi1avns6m4bgpyq7zil";
        authors = [
          "Peter Parkanyi <peter@redsift.io>"
          "Alessandro Decina <alessandro.d@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "futures" "load" "mio" "tokio" ];
      };
      "redox_syscall" = rec {
