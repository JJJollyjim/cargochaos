...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bpf/v0.9.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bpf-sys" = rec {
        ...
        version = "0.9.4";
        edition = "2018";
        sha256 = "0jycvi1rb4kh9c3j7175zlb4pq79x23dv92rfm3079dff4p415m3";
        authors = [
      ...
      "redbpf" = rec {
        ...
        version = "0.9.4";
        edition = "2018";
        sha256 = "1v5sw7zqrc9hsypcqbdkssg9sqhszq1m78ip5xb33zrh4s5qpc84";
        authors = [
          "Peter Parkanyi <peter@redsift.io>"
          "Alessandro Decina <alessandro.d@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
