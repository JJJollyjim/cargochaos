...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bpf/v0.9.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bpf-sys" = rec {
        ...
        version = "0.9.8";
        edition = "2018";
        sha256 = "11y7abga3qaqr8hgn5p4dgvq9b4pbcy3npsylcsjq161z0dyjxm2";
        authors = [
      ...
      "cargo-bpf" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.9.8.nix {};
      ...
      "redbpf" = rec {
        ...
        version = "0.9.8";
        edition = "2018";
        sha256 = "0ppps43b8y96n3wla60phr2hm3gg3n32ddsg7wl013rq72ki08av";
        authors = [
          "Peter Parkanyi <peter@redsift.io>"
          "Alessandro Decina <alessandro.d@gmail.com>"
        ];
