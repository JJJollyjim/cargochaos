...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bpf/v0.9.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bpf-sys" = rec {
        ...
        version = "0.9.12";
        edition = "2018";
        sha256 = "0mw7w80y84ldxn0d6p4l4brvchs36s941m8px52c9rdm7ycicdz9";
        authors = [
      ...
      "cargo-bpf" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.9.12.nix {};
      ...
      "redbpf" = rec {
        ...
        version = "0.9.12";
        edition = "2018";
        sha256 = "0nsvpbgrc51phkgd0jwmn2ppkvhcq0c06liqzrh6mg1pj461b9i8";
        authors = [
          "Peter Parkanyi <peter@redsift.io>"
          "Alessandro Decina <alessandro.d@gmail.com>"
        ];
