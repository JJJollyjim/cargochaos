...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-ssdp-client/v0.1.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple-ssdp-client" = rec {
        crateName = "simple-ssdp-client";
        version = "0.1.5";
        edition = "2015";
        crateBin = [
          { name = "simple_ssdp_client"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.5.nix {};
        libName = "simple_ssdp_client";
        libPath = "src/ssdp/mod.rs";
        authors = [
