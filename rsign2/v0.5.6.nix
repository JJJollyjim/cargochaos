...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rsign2/v0.5.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minisign" = rec {
        ...
        version = "0.5.15";
        edition = "2015";
        sha256 = "06jyf43pfj8qnqzw1wc7ix1k0p4zf7mwl1c8n7qxwrrdz8xlzfp4";
        authors = [
      ...
      "rsign2" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "rsign"; path = "src/bin/rsign/main.rs"; }
        ];
