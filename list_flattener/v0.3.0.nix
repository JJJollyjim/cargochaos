...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/list_flattener/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "afl" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1adjixm6d85jcr0282pp7kaa3kfva7jrzciglhy3n5ldz5h6482r";
        authors = [
      ...
      "list_flattener" = rec {
        crateName = "list_flattener";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "list_flattener"; path = "src/bin/list_flattener.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "afl" "default" "fuzz" ];
      };
      "num-traits" = rec {
      ...
      "parse_int" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0j6cs1ijnh4qbwwf7nz6w2xrays4i3x07lys1nqn62cgq754inw2";
        authors = [
          "Stefan Schindler <dns2utf8@estada.ch>"
        ];
        dependencies = [
