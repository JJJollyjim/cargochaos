...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple_azure_monitor_data_collector/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "simple_azure_monitor_data_collector";
  ...
  workspaceMembers = {
    "simple_azure_monitor_data_collector" = rec {
      packageId = "simple_azure_monitor_data_collector";
      build = internal.buildRustCrateWithFeatures {
        packageId = "simple_azure_monitor_data_collector";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple_azure_monitor_data_collector" = rec {
        crateName = "simple_azure_monitor_data_collector";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "A Mackay <amackayfoss@outlook.com>"
        ];
        dependencies = [
          {
            name = "base64";
