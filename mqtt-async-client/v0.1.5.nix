...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mqtt-async-client/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mqtt-async-client" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mqttc"; path = "src/bin/mqttc.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "dns" "io-util" "macros" "rt-core" "sync" "tcp" "time" ];
          }
          {
            name = "tokio-rustls";
        ...
        resolvedDefaultFeatures = [ "unsafe-logging" ];
      };
      "mqttrs" = rec {
        crateName = "mqttrs";
        version = "0.2.0";
