...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webdesserts-confy/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "webdesserts-confy" = rec {
        ...
        resolvedDefaultFeatures = [ "sd" "serde_derive" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.8";
        ...
        resolvedDefaultFeatures = [ "knownfolders" "objbase" "shlobj" ];
      };
