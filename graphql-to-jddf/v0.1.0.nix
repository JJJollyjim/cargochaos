...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/graphql-to-jddf/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "graphql-to-jddf" = rec {
        crateName = "graphql-to-jddf";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "graphql-to-jddf"; path = "src/main.rs"; }
        ];
      ...
      "jddf" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "099bxqhmabnfvsl8ali652svalg7q169rfhncz5by4mw2f8zqjx7";
        authors = [
