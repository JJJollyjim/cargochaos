...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/iced-pancurses/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iced_core" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1za7vsypjryz5vzswb2a5ks039mq467pgxrm7z8qis6zprbyphzc";
        authors = [
        ...
        resolvedDefaultFeatures = [ "command" "futures" ];
      };
      "iced_native" = rec {
        crateName = "iced_native";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0z5kw03j1dbqlf4629ymaxcx3d3qk9bn9vlcmwdisxd51lkikylp";
        authors = [
          "Héctor Ramón Jiménez <hector0193@gmail.com>"
        ];
        dependencies = [
