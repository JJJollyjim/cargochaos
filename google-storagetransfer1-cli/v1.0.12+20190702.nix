...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-storagetransfer1-cli/v1.0.12+20190702.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-storagetransfer1-cli";
  ...
  workspaceMembers = {
    "google-storagetransfer1-cli" = rec {
      packageId = "google-storagetransfer1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-storagetransfer1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-storagetransfer1" = rec {
        crateName = "google-storagetransfer1";
        version = "1.0.12+20190702";
        edition = "2015";
        sha256 = "1vx2kj4dlildp34sn47gmwj5rmwhayvzv7jfv7n4w3an5zx2xwf3";
        authors = [
      ...
      "google-storagetransfer1-cli" = rec {
        crateName = "google-storagetransfer1-cli";
        version = "1.0.12+20190702";
        edition = "2015";
        crateBin = [
          { name = "storagetransfer1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-storagetransfer1";
          }
          {
            name = "hyper";
            packageId = "hyper";
