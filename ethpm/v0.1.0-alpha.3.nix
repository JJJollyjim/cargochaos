...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethpm/v0.1.0-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethpm" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ethpm"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.3.nix {};
        authors = [
          "Bryant Eisenbach <fubuloubu@gmail.com>"
          "Sean Coughlin <sean@froth.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "default" "no-std" "serde" "serde-json-core" "serde_json" "std" ];
      };
      "fixed-hash" = rec {
      ...
      "heapless" = rec {
        ...
        version = "0.2.7";
        edition = "2015";
        sha256 = "0a6bxywpw96gwbq1zqa34d077kg57ac04gq0300dji3d1izslni3";
        authors = [
      ...
      "serde-json-core" = rec {
        ...
        version = "0.0.1";
        edition = "2015";
        sha256 = "1v7npy9xmjgmc5ci1nhxahv93lz0542jx9gr87frw59216cf11z2";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
      ...
      "untagged-option" = rec {
        crateName = "untagged-option";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1rign7xhg9wgx57jyban2h3948nsfwhff841w5hqg1jyi5h3ymc9";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "heapapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
