...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-dtmo/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-dtmo" = rec {
        crateName = "mdbook-dtmo";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "mdbook-dtmo"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "mdbook-mermaid";
            packageId = "mdbook-mermaid";
          }
          {
            name = "mdbook-open-on-gh";
            packageId = "mdbook-open-on-gh";
          }
          {
            name = "mdbook-toc";
            packageId = "mdbook-toc";
          }
          {
            name = "notify";
            packageId = "notify";
        ...
        resolvedDefaultFeatures = [ "default" "gitignore" "iron" "notify" "serve" "staticfile" "watch" "ws" ];
      };
      "mdbook-mermaid" = rec {
        crateName = "mdbook-mermaid";
        version = "0.3.0";
        edition = "2018";
        crateBin = [];
        sha256 = "1alf83k0dwyb880f140y8d3n09mqq3jb0iwsyhvpif033wc486i1";
        authors = [
          "Jan-Erik Rediger <janerik@fnordig.de>"
        ];
        dependencies = [
      ...
      "mdbook-open-on-gh" = rec {
        crateName = "mdbook-open-on-gh";
        version = "1.1.1";
        edition = "2018";
        crateBin = [];
        sha256 = "01pyd9927nbals68mcgj4pk6saiwrg6sm6lqp4yxawj5khfhamja";
        authors = [
          "Jan-Erik Rediger <janerik@fnordig.de>"
        ];
        dependencies = [
      ...
      "mdbook-toc" = rec {
        crateName = "mdbook-toc";
        version = "0.3.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0csdiyn0kdjvcnbp88l0ld652q0snyn49pkr94rq1r7yq4civdmf";
        authors = [
          "Jan-Erik Rediger <janerik@fnordig.de>"
        ];
        dependencies = [
