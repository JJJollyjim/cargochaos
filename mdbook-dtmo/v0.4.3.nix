...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-dtmo/v0.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-mermaid" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0fv36cpldlcqllsmk1lr3wjmqdzm0ijqk8svnk0ppcz1jyl4ai28";
        authors = [
          "Jan-Erik Rediger <janerik@fnordig.de>"
        ];
        dependencies = [
      ...
      "mdbook-toc" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0m46j2gm8abm1k9nxvabz27kl1s8sh36mj4g0xk4b0rl3kfgjcdv";
        authors = [
          "Jan-Erik Rediger <janerik@fnordig.de>"
        ];
        dependencies = [
