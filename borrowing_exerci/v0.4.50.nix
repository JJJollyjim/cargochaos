...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/borrowing_exerci/v0.4.50.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "borrowing_exerci" = rec {
        crateName = "borrowing_exerci";
        version = "0.4.50";
        edition = "2018";
        crateBin = [
          { name = "bwx"; path = "src/bin/bwx.rs"; }
          { name = "bw"; path = "src/bin/bw.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.50.nix {};
        libName = "aide";
        authors = [
          "cnruby <gudao.luo@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "cp" "err" "err_01" "err_02" "err_03" "err_04" "err_05" "err_06" "err_07" "err_08" "err_09" "err_10" "err_11" "ok" "okay" "okey" ];
      };
      "bstr" = rec {
        crateName = "bstr";
        version = "0.2.8";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
