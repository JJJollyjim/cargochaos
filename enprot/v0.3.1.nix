...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/enprot/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "botan" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1gljsiz431pqixhzbxjggs89dic6fai5fn0j5881141dzxg1dasw";
        authors = [
      ...
      "botan-sys" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "0fqv6wi44455rmzl75w420apwnr9g5i50i6c6m4y0pfy3pw0c36r";
        authors = [
          "Jack Lloyd <jack@randombit.net>"
        ];
        dependencies = [
      ...
      "phc" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "006yhscgha1nqwfj9ryxlwq8blr3zdknaxwnxd9lc008003jl92l";
        authors = [
          "Kyle Strohbeck <kstrohbeck@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "std" "winbase" "winerror" ];
      };
      "winapi-build" = rec {
