...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cdg_renderer/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cdg" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1ri6k6fzdylmd0b8zqidldpvk6vbvizfwak5bpd1h5cpzk4v4m6j";
        authors = [
