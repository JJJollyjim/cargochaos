...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-sgx-util/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-sgx-util" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "default" "serde" "with_serde" ];
      };
      "serde" = rec {
        crateName = "serde";
        version = "1.0.106";
