...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-tagmanager1-cli/v1.0.13+20200408.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-tagmanager1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-tagmanager1" = rec {
        crateName = "google-tagmanager1";
        version = "1.0.13+20200408";
        edition = "2015";
        sha256 = "1bcj0ainqkpbj6ssys0viwwpn04zikyqqfjq36fcx0hlymkj9xk8";
        authors = [
      ...
      "google-tagmanager1-cli" = rec {
        crateName = "google-tagmanager1-cli";
        version = "1.0.13+20200408";
        edition = "2015";
        crateBin = [
          { name = "tagmanager1"; path = "src/main.rs"; }
        ];
