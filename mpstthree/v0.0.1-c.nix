...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mpstthree/v0.0.1-c.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mpstthree" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "mpstthree"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1-c.nix {};
        authors = [
          "NicolasLagaillardie <lagaillardie.nicolas@live.fr>"
        ];
        dependencies = [
          {
