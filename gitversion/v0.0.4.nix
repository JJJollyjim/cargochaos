...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gitversion/v0.0.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gitversion" = rec {
        crateName = "gitversion";
        version = "0.0.4";
        edition = "2015";
        crateBin = [
          { name = "gitversion"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "processenv" "winbase" "winsock2" "ws2def" ];
      };
