...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sps30/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sensirion-hdlc" = rec {
        crateName = "sensirion-hdlc";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1gflwvp6bzcnixz7jxxnia0gl2qahwg012g94vcw2s6a6aksdclx";
        authors = [
