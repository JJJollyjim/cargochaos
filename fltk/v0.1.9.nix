...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fltk/v0.1.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fltk-derive" = rec {
        ...
        version = "0.1.9";
        edition = "2018";
        sha256 = "1j10s0ydsbziaa6dmfrv7cas66b3mz09jhz0b9q8siawpxnblaka";
        procMacro = true;
        libName = "fltk_derive";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
      ...
      "fltk-sys" = rec {
        ...
        version = "0.1.9";
        edition = "2018";
        sha256 = "1w7r7xni8mmninlscrzdrar5pl2pcyh228cfzsnadl01564i549k";
        libName = "fltk_sys";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
        ];
