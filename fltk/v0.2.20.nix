...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fltk/v0.2.20.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fltk" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fltk-shared" "use-ninja" ];
      };
      "fltk-derive" = rec {
        crateName = "fltk-derive";
        version = "0.2.20";
        edition = "2018";
        sha256 = "10rff5cny4x5xb504jfmnzhcapyxdal7jhf5snw95vs7gpm731lp";
        procMacro = true;
        libName = "fltk_derive";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
      ...
      "fltk-sys" = rec {
        ...
        version = "0.2.20";
        edition = "2018";
        sha256 = "1cs0j2ac3lha2m24si0pvsn4ypa1vsbrxaylr3367sb19gx7lrs3";
        libName = "fltk_sys";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
        ];
