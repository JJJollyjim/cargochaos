...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fltk/v0.2.18.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fltk" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fltk-shared" ];
      };
      "fltk-derive" = rec {
        crateName = "fltk-derive";
        version = "0.2.18";
        edition = "2018";
        sha256 = "1cyz5mnxwi4y2azhhijwmkxn6ji93mg204sbzq1ky82ldrgw43y5";
        procMacro = true;
        libName = "fltk_derive";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
      ...
      "fltk-sys" = rec {
        ...
        version = "0.2.18";
        edition = "2018";
        sha256 = "16akwz7kfglcfv6xb0pwrnwikzqfxvsklqr0hw7i8jk2zlvdk254";
        libName = "fltk_sys";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
        ];
