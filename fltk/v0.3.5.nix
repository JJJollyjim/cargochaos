...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fltk/v0.3.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fltk" = rec {
        ...
        features = {
          "cpp-testing" = [ "fltk-sys/cpp-testing" ];
          "fltk-shared" = [ "fltk-sys/fltk-shared" ];
          "system-fltk" = [ "fltk-sys/system-fltk" ];
          "use-ninja" = [ "fltk-sys/use-ninja" ];
        };
        resolvedDefaultFeatures = [ "cpp-testing" "default" "fltk-shared" "system-fltk" "use-ninja" ];
      };
      "fltk-derive" = rec {
        crateName = "fltk-derive";
        version = "0.3.5";
        edition = "2018";
        sha256 = "1wm9j2v8n87y1v0rzxdzjpw05imjq6hb84xm1s0mydc0pbyjj6h1";
        procMacro = true;
        libName = "fltk_derive";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
      ...
      "fltk-sys" = rec {
        ...
        version = "0.3.5";
        edition = "2018";
        sha256 = "17p6vm7y8w9dz08skjmkczp3m1yhwmyqillj7lnl231v7pkd5f80";
        libName = "fltk_sys";
        authors = [
          "MoAlyousef <mohammed.alyousef@neurosrg.com>"
        ];
