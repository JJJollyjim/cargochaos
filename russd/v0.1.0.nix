...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/russd/v0.1.0.nix.tmp"
    ...
    crates = {
      ...
      "russd" = rec {
        ...
        dependencies = [
          ...
          {
            name = "website-icon-extract";
            packageId = "website-icon-extract";
          }
        ];
      ...
      "website-icon-extract" = rec {
        crateName = "website-icon-extract";
        version = "0.4.1";
        edition = "2015";
        sha256 = "09k1isp6qbpijkgsmcsskcvqdc7w9bls09v38p5f06dwac40khfx";
        authors = [
          "segler-alex <segler_alex@web.de>"
        ];
        dependencies = [
          {
            name = "native-tls";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
