...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/holochain-client-core/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "holochain-client-core";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "holochain-client-core" = rec {
        crateName = "holochain-client-core";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Willem Olding <willemolding@gmail.com>"
        ];
        dependencies = [
          {
            name = "jsonrpc-core";
