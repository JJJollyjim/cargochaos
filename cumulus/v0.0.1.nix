...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cumulus/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "inspector" = rec {
        ...
        version = "0.0.5";
        edition = "2018";
        sha256 = "1m6h60kng16bc0q0i2qg5m8p8b9qh56s5rvlpkxawzjhqzac7mjc";
        authors = [
          "Cyril Plisko <cyril.plisko@mountall.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "futures" "option" "result" ];
      };
      "itoa" = rec {
        crateName = "itoa";
        version = "0.4.4";
