...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/qcow2-fuse/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "daemonize" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "0dg9w1p717ky0jgdncnxhp7jav9kqzs8qwkkxkahd92c3cn86f82";
        authors = [
      ...
      "fuse" = rec {
        ...
        version = "0.2.8";
        edition = "2015";
        sha256 = "1xh1h1sfzs0pyz92h0wc70c1qv9579sa59ys6iggkkrrxdw89w5d";
        authors = [
      ...
      "linked-hash-map" = rec {
        ...
        version = "0.0.9";
        edition = "2015";
        sha256 = "0yfxr2z2w1a8zwnx0l4dhqk3pfs232v59kyc47wzv6g9m8xzzxw3";
        authors = [
      ...
      "lru-cache" = rec {
        ...
        version = "0.0.7";
        edition = "2015";
        sha256 = "135z7hzvqnk5lj614klwfyf7rhy039z20hqh7gw5s54zbp5hvma2";
        authors = [
          "Stepan Koltsov <stepan.koltsov@gmail.com>"
        ];
        dependencies = [
      ...
      "positioned-io" = rec {
        crateName = "positioned-io";
        version = "0.2.2";
        edition = "2015";
        sha256 = "1mjljc289ki5a9hybha4cczgmc4i0zip05zs0yxqswlayijsa1f4";
        authors = [
      ...
      "qcow2" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1yiq67kxch56vp9wdy4w1nif49jn17lw7sixgnaf1qv3nfjxl2dj";
        authors = [
          "Dave Vasilevsky <dave@vasilevsky.ca>"
        ];
        dependencies = [
          ...
          {
            name = "positioned-io";
            packageId = "positioned-io";
          }
        ];
        
      };
      "qcow2-fuse" = rec {
        crateName = "qcow2-fuse";
        version = "0.1.1";
        edition = "2015";
        crateBin = [
          { name = "qcow2-fuse"; path = "src/main.rs"; }
        ];
