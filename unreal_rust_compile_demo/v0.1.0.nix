...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unreal_rust_compile_demo/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "unreal_rust_compile_demo";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unreal_rust_compile_demo" = rec {
        crateName = "unreal_rust_compile_demo";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "unreal_rust_compile_demo"; path = "src/main.rs"; }
        ];
