...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simulation/v0.0.2-alpha.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-trait" = rec {
        ...
        version = "0.1.16";
        edition = "2018";
        sha256 = "0kkgf22xgpd6ni408jwhiv1mr9n2h512as253pnviglxz3cwg3nb";
        procMacro = true;
        authors = [
      ...
      "hyper" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tower-service";
            packageId = "tower-service 0.3.0-alpha.2";
          }
          {
            name = "want";
            packageId = "want";
      ...
      "simulation" = rec {
        crateName = "simulation";
        version = "0.0.2-alpha.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.2-alpha.0.nix {};
        authors = [
          "Gardner Vickers <gardner@vickers.me>"
        ];
        dependencies = [
          {
            name = "async-trait";
      ...
      "tokio-test" = rec {
        ...
        version = "0.2.0-alpha.6";
        edition = "2018";
        sha256 = "003j9cyaaq79ypf8bbzi2x6f1cq1d086yshjy2dbj6l8zw6hhdqp";
        authors = [
          "Tokio Contributors <team@tokio.rs>"
        ];
        dependencies = [
      ...
      "tonic" = rec {
        ...
        edition = "2018";
        sha256 = "0y5nc7w6kamr6s1dx0v22037gq4p1v57wfpa1m32km95hznaqqgy";
        authors = [
        ...
        features = {
          ...
          "transport" = [ "hyper" "tokio" "tower" "tower-reconnect" "tower-balance" "tower-load" ];
        };
        resolvedDefaultFeatures = [ "async-trait" "codegen" "default" "hyper" "prost" "prost-derive" "tokio" "tower" "tower-balance" "tower-load" "tower-reconnect" "transport" ];
      };
      "tower" = rec {
        crateName = "tower";
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "0dbrm6hkx3191lvm8xi5x223zbyf5qq4b1aksmjiqd9wj6jycp5h";
        authors = [
      ...
      "tower-balance" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "0wlx9ikzwr6ix2643h45c4h9kg74p1bv19v5k7lbi5hicwlf1p1q";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-buffer" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "150641snijq57fz0i3a6i4jrdn1b3jy7qqcnqgmc70hn8jmwlrpb";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-discover" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "1sd2d0wjphmggxvakrpsw0x4jd2a700ji8f96mvsmrvc50hnxa7v";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-layer" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "1qnjs9mcbsf2h6nq0fc9fhs8a4aip8479pwxaw3ppmb4pqjqcia4";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
      ...
      "tower-limit" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "06k8h2pk4fkbsdrfp4lvy8gx2sc6v3cpib9pkykjxdar9n0yyc7n";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-load" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "1g55k0va3hv9n7xkiiw3jwi1dzw40m3i5k7n7wssd3ljv5wmlcw7";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-load-shed" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "1q9dxdq6n97jlgnxvcmwcmg57xrm5k2zpz7x402rdmipg798inm2";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-reconnect" = rec {
        crateName = "tower-reconnect";
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "01qr7zs5b31vzlanxympwws6yablya90sb452s05alfrhpvhyfzc";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-retry" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "0626m2qvwiy7zwf2cgn2bx2ghlrqaraf43n5206abmbhhn4ppcwb";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-service 0.3.0-alpha.2" = rec {
        crateName = "tower-service";
        version = "0.3.0-alpha.2";
        edition = "2015";
      ...
      "tower-timeout" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "1zrm5f323d8c796q0f6r7lm9zv74i6d11jy395wlq9jplzl7sgx4";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
      ...
      "tower-util" = rec {
        ...
        version = "0.3.0-alpha.2";
        edition = "2018";
        sha256 = "0sxpkrdaqqhpj9ix6xxi6z5vj4r4axc9z9k443s7vmplhza11y5f";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
