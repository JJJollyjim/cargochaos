...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdrend-dont-use-test/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mdrend-dont-use-test";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdrend-dont-use-test" = rec {
        crateName = "mdrend-dont-use-test";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mdrend-dont-use-test"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Justin Parado <justin.parado@dice205.com>"
        ];
        dependencies = [
          {
            name = "clap";
