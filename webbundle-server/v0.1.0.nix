...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webbundle-server/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cbor_event" = rec {
        ...
        version = "2.1.3";
        edition = "2015";
        sha256 = "0ld429li4b64dxbn6gg7va2pg96vjyy0dlchwa74h5cqg25dlv1b";
        authors = [
      ...
      "webbundle" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1hpvkg0ma045fsrpcq7dh28wyiyl9hds6dkirqk6l1ni5nx8418n";
        authors = [
      ...
      "webbundle-server" = rec {
        crateName = "webbundle-server";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "webbundle-server"; path = "src/main.rs"; }
        ];
