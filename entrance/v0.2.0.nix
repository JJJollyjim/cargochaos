...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/entrance/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "entrance" = rec {
        ...
        authors = [
          "Suguru Kato <salmon.bioinformatics@gmail.com>"
        ];
        dependencies = [
          {
            name = "entrance_derive";
            packageId = "entrance_derive";
            optional = true;
          }
          {
            name = "failure";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "entrance_derive" ];
      };
      "entrance_derive" = rec {
        crateName = "entrance_derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1j1p3w78f1qxnwvf4vwnhcw70l24ln83vr4dn68fnac1z4adywr7";
        procMacro = true;
        authors = [
          "Suguru Kato <salmon.bioinformatics@gmail.com>"
        ];
