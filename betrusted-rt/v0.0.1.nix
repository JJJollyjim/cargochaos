...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/betrusted-rt/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vexriscv" = rec {
        ...
        version = "0.0.2";
        edition = "2015";
        sha256 = "0l8aiwfjmh3ciwxj7rdmggmg6a4xa9khfnlanfnrq1609sia9k58";
        authors = [
