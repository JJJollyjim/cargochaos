...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tts/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "speech-dispatcher" = rec {
        ...
        version = "0.4.2";
        edition = "2015";
        sha256 = "03znwhgkb5fivgn5y8rqlsz7gidkc0qibsb7c8ifw8ydwasj2j5h";
        authors = [
      ...
      "speech-dispatcher-sys" = rec {
        ...
        version = "0.4.2";
        edition = "2015";
        sha256 = "0a07sl2mkwbiildpnfljav031s9gb1d4clhagq9b4fmw11g5bgds";
        authors = [
          "Nolan Darilek <nolan@thewordnerd.info>"
        ];
        buildDependencies = [
