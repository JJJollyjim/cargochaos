...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tts/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "speech-dispatcher" = rec {
        crateName = "speech-dispatcher";
        version = "0.3.2";
        edition = "2015";
        sha256 = "1808wblpfmcgl9dkajs4wyzyjkl7nia73pjgnbyg63ygwvhl7yv2";
        authors = [
        ...
        dependencies = [
          {
            ...
            packageId = "speech-dispatcher-sys";
          }
        ];
        
      };
      "speech-dispatcher-sys" = rec {
        crateName = "speech-dispatcher-sys";
        version = "0.3.0";
        edition = "2015";
        sha256 = "1rp31v8vzmn4jv7x8dgp0i3995mbhjz8p4dx2j4arl9n6dvy55g2";
        authors = [
          "Nolan Darilek <nolan@thewordnerd.info>"
        ];
        buildDependencies = [
      ...
      "tolk" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "17nilalx4h1hdrc4zlnqfr0jsxjpjwkrxs37j8z8fp7piqycdf1p";
        authors = [
          "Dhruv kumar <darbaga10@gmail.com>"
        ];
        dependencies = [
          {
            name = "tolk-sys";
      ...
      "tolk-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "12j7afivl73kn573aphf6rvyjw4dmc7sw8xw2b3apz3fm5sajxkm";
        authors = [
          "Dhruv kumar <darbaga10@gmail.com>"
        ];
        dependencies = [
      ...
      "tts" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "web-sys";
            target = { target, features }: (stdenv.hostPlatform.config == "wasm32-unknown-unknown");
            features = [ "SpeechSynthesis" "SpeechSynthesisUtterance" "Window" ];
          }
        ];
        devDependencies = [
          {
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "SpeechSynthesis" "SpeechSynthesisUtterance" "Window" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
