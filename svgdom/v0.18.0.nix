...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/svgdom/v0.18.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "roxmltree" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "0ydm25hc0cyisfzqyanbazf1syk9gmqr4r87sv7zdcx8pw621c2k";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winuser" ];
      };
