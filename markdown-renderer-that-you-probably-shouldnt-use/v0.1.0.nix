...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markdown-renderer-that-you-probably-shouldnt-use/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "markdown-renderer-that-you-probably-shouldnt-use";
  ...
  workspaceMembers = {
    "markdown-renderer-that-you-probably-shouldnt-use" = rec {
      packageId = "markdown-renderer-that-you-probably-shouldnt-use";
      build = internal.buildRustCrateWithFeatures {
        packageId = "markdown-renderer-that-you-probably-shouldnt-use";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "literalext" = rec {
        crateName = "literalext";
        version = "0.1.1";
        edition = "2015";
        sha256 = "10aa300w4bqr5lfhbwi50651hwc6k43hfbkj1lg5m5r7jmlxshig";
        authors = [
      ...
      "markdown-renderer-that-you-probably-shouldnt-use" = rec {
        crateName = "markdown-renderer-that-you-probably-shouldnt-use";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "markdown-renderer-that-you-probably-shouldnt-use"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Joerez <rezenbiz@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "maud" = rec {
        ...
        version = "0.20.0";
        edition = "2015";
        sha256 = "0fvrwn6jyhbid5ia3prkwc463p19nprjrndd1d2hk27z28jlnyrk";
        authors = [
      ...
      "maud_macros" = rec {
        ...
        version = "0.20.0";
        edition = "2015";
        sha256 = "0hfazfcw7qljlx2pbhrf86ga9p48rmdhxrlccvffwybzv8f7an3g";
        procMacro = true;
        authors = [
          "Chris Wong <lambda.fairy@gmail.com>"
        ];
