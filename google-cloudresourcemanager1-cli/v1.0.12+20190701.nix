...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudresourcemanager1-cli/v1.0.12+20190701.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudresourcemanager1-cli";
  ...
  workspaceMembers = {
    "google-cloudresourcemanager1-cli" = rec {
      packageId = "google-cloudresourcemanager1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudresourcemanager1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudresourcemanager1" = rec {
        crateName = "google-cloudresourcemanager1";
        version = "1.0.12+20190701";
        edition = "2015";
        sha256 = "1qkpn5d8m86xfkrj7dw7klbcs5m4c9dp6xgq67k2xs7fxklm8sgj";
        authors = [
      ...
      "google-cloudresourcemanager1-cli" = rec {
        crateName = "google-cloudresourcemanager1-cli";
        version = "1.0.12+20190701";
        edition = "2015";
        crateBin = [
          { name = "cloudresourcemanager1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudresourcemanager1";
          }
          {
            name = "hyper";
            packageId = "hyper";
