...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudresourcemanager1-cli/v1.0.13+20200408.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudresourcemanager1" = rec {
        ...
        edition = "2015";
        sha256 = "1nwjjwidnqfrlxyk8pigi7c6wwk85hkjbjdnljfsbbrn59wpdzig";
        authors = [
