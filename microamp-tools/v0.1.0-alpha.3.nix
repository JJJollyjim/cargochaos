...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/microamp-tools/v0.1.0-alpha.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "microamp-tools" = rec {
        crateName = "microamp-tools";
        version = "0.1.0-alpha.3";
        edition = "2018";
        crateBin = [
          { name = "microamp-true"; path = "src/bin/microamp-true.rs"; }
          { name = "cargo-microamp"; path = "src/bin/cargo-microamp.rs"; }
        ];
