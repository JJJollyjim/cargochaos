...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darling/v0.10.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "darling" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "diagnostics" "suggestions" ];
      };
      "darling_core" = rec {
        ...
        resolvedDefaultFeatures = [ "diagnostics" "strsim" "suggestions" ];
      };
      "darling_macro" = rec {
