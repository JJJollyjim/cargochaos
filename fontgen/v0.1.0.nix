...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fontgen/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fontgen-export" = rec {
        crateName = "fontgen-export";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1w0xv6aj8cpjb3lmsbyll16dll68yk267hwpc1p1bdaz3l7p0w38";
        authors = [
          "Darren Kaste <darrenkaste@gmail.com>"
        ];
        dependencies = [
      ...
      "freetype-rs" = rec {
        ...
        version = "0.24.0";
        edition = "2015";
        sha256 = "0ps47himb8ygi5hzxbhlqcni1ins68pa0h1qgg1433ywghi1j19l";
        libName = "freetype";
        authors = [
