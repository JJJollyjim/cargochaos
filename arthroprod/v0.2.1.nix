...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arthroprod/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "arthroprod" = rec {
        crateName = "arthroprod";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "aprod-demo"; path = "src/bin/demo/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Innes Anderson-Morrison <innesdmorrison@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
