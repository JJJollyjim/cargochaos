...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/generic/v0.0.1.nix.tmp"
    ...
    crates = {
      ...
      "generic" = rec {
        ...
        dependencies = [
          {
            name = "generic-core";
            packageId = "generic-core";
          }
          {
            name = "generic-derive";
            packageId = "generic-derive";
          }
        ];
        
      };
      "generic-core" = rec {
        crateName = "generic-core";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1h7imp1q5kalqcy984j0aah9rcvrig1i75q5lzykg7j3yr9bbcyd";
        authors = [
          "colbyn <hello@colbyn.com>"
        ];
      ...
      "generic-derive" = rec {
        crateName = "generic-derive";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1r18rcqhaxk1k08y8sgsc4acfr16ap3zi3sk6zl5czc8wg5v3hxj";
        procMacro = true;
        authors = [
          "colbyn <hello@colbyn.com>"
        ];
