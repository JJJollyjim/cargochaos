...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/generic/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "generic-core" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "085b7d2w2ip4zm9b8mg3wabdsmk6npbpysq9j75jw5qzwnx5yr63";
        authors = [
          "colbyn <hello@colbyn.com>"
        ];
        dependencies = [
      ...
      "generic-derive" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "04xb8ad4cys8aqcgyf145h827pgcd0c7q3hb9fniycpgi6qxz0in";
        procMacro = true;
        authors = [
          "colbyn <hello@colbyn.com>"
        ];
