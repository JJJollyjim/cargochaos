...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ckb-vm/v0.19.1-alpha.0+perf-test.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ckb-vm" = rec {
        crateName = "ckb-vm";
        version = "0.19.1-alpha.0+perf-test";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.19.1-alpha.0+perf-test.nix {};
        authors = [
      ...
      "ckb-vm-definitions" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0y0nb0vs5kl109kb7bhdh5p0fi1b57jgvfpwb6khxf29bnm2nr20";
        authors = [
          "Nervos Core Dev <dev@nervos.org>"
        ];
