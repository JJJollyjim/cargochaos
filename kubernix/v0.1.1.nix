...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kubernix/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kubernix" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "kubernix"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" "wow64apiset" ];
      };
      "winapi-build" = rec {
