...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/exe_iza/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "exe_iza" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "iza"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Keishi Kawada <megumish@exploitouri.st>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "kotonoha" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "05pz0irgh8v7w2krxbr1z34zwbyg8ps67xwnkfr6yj3ks5vk0511";
        authors = [
          "Keishi Kawada <megumish@exploitouri.st>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "channel" "default" "log" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.62";
