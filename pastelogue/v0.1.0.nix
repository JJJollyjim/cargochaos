...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pastelogue/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pastelogue" = rec {
        crateName = "pastelogue";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "pastelogue"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Deseteral <deseteral@gmail.com>"
        ];
        dependencies = [
          {
            name = "kamadak-exif";
