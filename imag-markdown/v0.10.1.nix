...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imag-markdown/v0.10.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imag-markdown" = rec {
        crateName = "imag-markdown";
        version = "0.10.1";
        edition = "2018";
        crateBin = [
          { name = "imag-markdown"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.1.nix {};
        libName = "libimagmarkdowncmd";
        authors = [
          "Matthias Beyer <mail@beyermatthias.de>"
        ];
        dependencies = [
