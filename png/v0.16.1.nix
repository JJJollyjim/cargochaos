...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/png/v0.16.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "consoleapi" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "knownfolders" "libloaderapi" "memoryapi" "minwindef" "ntsecapi" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shlobj" "shobjidl_core" "std" "sysinfoapi" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winuser" ];
      };
