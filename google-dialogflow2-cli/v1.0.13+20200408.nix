...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dialogflow2-cli/v1.0.13+20200408.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-dialogflow2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dialogflow2" = rec {
        crateName = "google-dialogflow2";
        version = "1.0.13+20200408";
        edition = "2015";
        sha256 = "06zak3n8h080c7hrvj0jkr856zkcf4wrppncg66z16dma2939rvb";
        authors = [
      ...
      "google-dialogflow2-cli" = rec {
        crateName = "google-dialogflow2-cli";
        version = "1.0.13+20200408";
        edition = "2015";
        crateBin = [
          { name = "dialogflow2"; path = "src/main.rs"; }
        ];
