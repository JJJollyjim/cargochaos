...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/elastictea/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "elastic" = rec {
        ...
        edition = "2015";
        sha256 = "10r1h6pirdybffgviyg3i0wlk1rcxknj6lkn1s7x27bfbmi0gspq";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "elastic_requests";
          }
          {
            name = "elastic_responses";
            packageId = "elastic_responses";
          }
          {
            name = "elastic_types";
            packageId = "elastic_types";
          }
          {
            name = "error-chain";
      ...
      "elastic_derive" = rec {
        ...
        version = "0.21.0-pre.4";
        edition = "2015";
        sha256 = "1xx0my6yhv9i04a5rw56kv0bzvq47lxxllvr6h91w4v4yanid2q7";
        procMacro = true;
        authors = [
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
        dependencies = [
          {
            ...
            packageId = "elastic_types_derive_internals";
          }
          {
            name = "quote";
      ...
      "elastic_requests" = rec {
        crateName = "elastic_requests";
        version = "0.21.0-pre.4";
        edition = "2015";
        sha256 = "07pvixmydn921l52g9zan600z8wspmziqp2gxpvjlwwmlcgvfpiw";
        authors = [
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
        dependencies = [
      ...
      "elastic_responses" = rec {
        crateName = "elastic_responses";
        version = "0.21.0-pre.4";
        edition = "2015";
        sha256 = "0rpb8f01iym9pk9kj62ph5aq13abbbs8s5v55qdzrpywv5vds3mv";
        authors = [
          "Stephan Buys <stephan.buys@panoptix.co.za>"
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
        dependencies = [
          {
      ...
      "elastic_types" = rec {
        crateName = "elastic_types";
        version = "0.21.0-pre.4";
        edition = "2015";
        sha256 = "1ks1waqs96ndwnql49gjbda9spqvcw81v406plm1p3zja2rvv9y8";
        authors = [
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "elastic_types_derive";
          }
          {
            name = "geo";
            packageId = "geo 0.4.13";
          }
          {
            name = "geohash";
            packageId = "geohash";
      ...
      "elastic_types_derive" = rec {
        crateName = "elastic_types_derive";
        version = "0.21.0-pre.4";
        edition = "2015";
        sha256 = "1rqvksq88mdmdvrp0w58965kbh0gpzs0l674m5dg8l6ial7cnfh3";
        procMacro = true;
        authors = [
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
      ...
      "elastic_types_derive_internals" = rec {
        crateName = "elastic_types_derive_internals";
        version = "0.21.0-pre.4";
        edition = "2015";
        sha256 = "0x75vdjfirsnl1l7q8n9w27irbsf8ffibbz658ji55nydh72wa3a";
        authors = [
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
        dependencies = [
      ...
      "elastictea" = rec {
        crateName = "elastictea";
        version = "2.0.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0.nix {};
        authors = [
          "Benjamin Slater <benjamin.ed.slater@gmail.com>"
        ];
        dependencies = [
          {
            name = "elastic";
      ...
      "fluent_builder" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0mqbqbb8d02x3jh6qf7nb7fkm4s0m0vr9a2whj9n9s3mxkqbag7h";
        authors = [
          "Ashley Mannix <ashleymannix@live.com.au>"
        ];
      ...
      "geo 0.6.3" = rec {
        ...
        version = "0.6.3";
        edition = "2015";
        sha256 = "1s3dxcg7lbh7b8ryqh5p3ngx1nmnpr5s59247iiv3s3wirx5hgqg";
        authors = [
          "Corey Farwell <coreyf@rwell.org>"
        ];
        dependencies = [
      ...
      "geohash" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1rjl9qc6vzz7fy2aswj158wj004nzqpl2prrh5dpvi32an1ybbyp";
        authors = [
      ...
      "geojson" = rec {
        ...
        version = "0.9.1";
        edition = "2015";
        sha256 = "1lf3jykmcb5l7wcjzb1xzj2zgnzj5kz5ss7yvzjyf2snx7llqj5k";
        authors = [
          "Corey Farwell <coreyf@rwell.org>"
      ...
      "rettle" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "1vin8grii8qqy45cw3chj5v7kssj5smm23m9khgiqyy2dfg8c9nz";
        authors = [
          "Benjamin Slater <benjamin.ed.slater@gmail.com>"
        ];
        dependencies = [
