...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jobrog/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colonnade" = rec {
        ...
        version = "1.3.1";
        edition = "2018";
        sha256 = "11sbdhljjv1afyy7355hmacsrcmnlxsgkf7q70g7n1y7xz7gzk9s";
        authors = [
        ...
        resolvedDefaultFeatures = [ "lazy_static" "nbsp" "regex" ];
      };
      "const-random" = rec {
      ...
      "pidgin" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "14y2rl6n48aj8f988nkzvxi5dj08jy3b173f3dd2pchlk26gx0va";
        authors = [
          "dfhoughton <dfhoughton@gmail.com>"
        ];
        dependencies = [
      ...
      "two_timer" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1rh73hr0g3v9599jd4y3l9j3f157bk22z2c8bhagp5jmh88pwka7";
        authors = [
          "dfhoughton <dfhoughton@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "small_grammar" ];
      };
