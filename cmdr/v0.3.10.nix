...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cmdr/v0.3.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cmdr_macro" = rec {
        crateName = "cmdr_macro";
        version = "0.3.10";
        edition = "2018";
        sha256 = "1p5kw8casqi990i9cwn4jx76hi26ggbmfg8nl1vdgy3x2gv10cvw";
        procMacro = true;
        authors = [
          "Mendelt Siebenga <msiebenga@gmail.com>"
        ];
