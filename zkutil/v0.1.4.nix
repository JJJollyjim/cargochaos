...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zkutil/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bellman_ce" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "1fgbrg49s3n69fa933fjblpkb17zml4dmmir1b3j00hcilmia003";type = [ "cdylib" "lib" "staticlib" ];
        authors = [
      ...
      "ff_ce" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1z8r08z4f461vbih9wq39iay0wd1r1nq2xp9rbcdc2rvqniadh43";
        authors = [
          "Sean Bowe <ewillbefull@gmail.com>"
          "Alex Gluchowski <alex@gluchowski.net>"
          "Alex Vlasov <alex.m.vlasov@gmail.com>"
      ...
      "ff_derive_ce" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1c8v7bhblq5a681psq5fm1wlx9k8acpyw1jpxdih74ai1izmchvm";
        procMacro = true;
        authors = [
          "Sean Bowe <ewillbefull@gmail.com>"
          "Alex Gluchowski <alex@gluchowski.net>"
      ...
      "pairing_ce" = rec {
        ...
        version = "0.20.0";
        edition = "2018";
        sha256 = "0f891dj5pllizdsqhaw1cjfrngjgrfvwap71x2jxk284gym26yvc";
        authors = [
          "Sean Bowe <ewillbefull@gmail.com>"
