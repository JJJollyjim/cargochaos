...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/make_pluralrules/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cldr_pluralrules_parser" = rec {
        crateName = "cldr_pluralrules_parser";
        version = "2.0.0";
        edition = "2018";
        sha256 = "13vm7lq1lzpwpi4rggfbrf9ci059168w68kx486srh3dfwaxlqxc";
        authors = [
      ...
      "make_pluralrules" = rec {
        crateName = "make_pluralrules";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "make_pluralrules"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "cldr_pluralrules_parser";
          }
          {
            name = "proc-macro2";
      ...
      "serde_json" = rec {
        ...
        version = "1.0.22";
        edition = "2015";
        sha256 = "03irp9v14k5ljv5prpbfzybvrxnm0gzcb2pcmmw5icz9mdf07f44";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "syn" = rec {
        ...
        version = "0.14.4";
        edition = "2015";
        sha256 = "1sma3clcsrfsr7ka9cj7zps21pfxba3ncf21598hg3v5qgmzivrb";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
