...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wat/v1.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasmparser" = rec {
        ...
        version = "0.45.0";
        edition = "2018";
        sha256 = "081h5mb0cbclbgv24spnzqrmnxa8hr6d6azv54z7q0i5if22q96d";
        authors = [
      ...
      "wast" = rec {
        ...
        version = "5.0.0";
        edition = "2018";
        sha256 = "15db1rhmq16rwmampm8cncr289zr3b7hyvda6qd1i1fyq0xbdv08";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
