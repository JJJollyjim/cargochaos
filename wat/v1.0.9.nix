...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wat/v1.0.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasmparser" = rec {
        ...
        version = "0.51.1";
        edition = "2018";
        sha256 = "1m2vzrj116zvgya34b6fzvvi9fysap5fyjfy2p0jizkp2rxb4hcy";
        authors = [
      ...
      "wast" = rec {
        ...
        version = "8.0.0";
        edition = "2018";
        sha256 = "138yn3j4b3hqgbg02yqnrjq7m691dgs6zfvb5wxm12hi2vbz779z";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
