...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xain-fl/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "derivative" = rec {
        ...
        version = "2.0.2";
        edition = "2015";
        sha256 = "0lc17x3q4lnbha61c7wj1sw1gqwhp1yz7si59r5whbkkjzmx550v";
        procMacro = true;
        authors = [
      ...
      "influxdb" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0g1nj9lfk86p75rrd160afxcmcam5irkgib2rgqmgsz5xllwp3pc";
        authors = [
          "Gero Gerke <11deutron11@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "influxdb_derive" "serde" "serde_json" "use-serde" ];
      };
      "influxdb_derive" = rec {
        crateName = "influxdb_derive";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0jn3dsf3i2ig7yxsd3ya0jvdmhnf0xriy54qkalil4cb579bm8a0";
        procMacro = true;
        authors = [
          "Gero Gerke <11deutron11@gmail.com>"
        ];
      ...
      "pyo3" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "1w686a3dfxz7vbgmyqz5jvlqn46p5sbq30mcxm24kn42v42yyzrr";
        authors = [
      ...
      "pyo3-derive-backend" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "0la8q3lpjmbxcwzn4ay9q32icy4jxjcw5qmn76286jcc3afnnrdq";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
      ...
      "pyo3cls" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "1jnrksplgc62yc0r23fs2m519b4wv07s43gldbamzpil4qyq54db";
        procMacro = true;
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
      ...
      "stubborn-io" = rec {
        crateName = "stubborn-io";
        version = "0.1.8";
        edition = "2018";
        sha256 = "0fxrnkgbn9ipc0czpdjbf5vs465cfnsdx0j3liyb36nq9mrylyxv";
        authors = [
          "David Raifaizen <d-raif@outlook.com>"
        ];
        dependencies = [
          {
            name = "bytes";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "udp" "uds" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "tokio-serde" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "16fyasv35xdyhhx36zlzgxsb04bf5fsv76xh9qlpj5q205xqkpgb";
        authors = [
          "Carl Lerche <me@carllerche.com>"
      ...
      "warp" = rec {
        ...
        resolvedDefaultFeatures = [ "multipart" ];
      };
      "wasi" = rec {
        crateName = "wasi";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "xain-fl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "coordinator"; path = "src/bin/coordinator.rs"; }
          { name = "aggregator"; path = "src/bin/aggregator.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.8.0.nix {};
        authors = [
          "XAIN AG <engineering@xain.io>"
        ];
        dependencies = [
          {
            name = "anyhow";
        ...
        resolvedDefaultFeatures = [ "all" "chrono" "default" "influx_metrics" "influxdb" "opentelemetry" "opentelemetry-jaeger" "telemetry" "tracing-opentelemetry" ];
      };
    };
