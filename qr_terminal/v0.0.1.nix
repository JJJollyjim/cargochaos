...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/qr_terminal/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "qr_terminal" = rec {
        crateName = "qr_terminal";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "qr_terminal"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Calum Forster <calumforster@live.co.uk>"
        ];
        dependencies = [
          {
            name = "qrcode";
      ...
      "terminal_graphics" = rec {
        crateName = "terminal_graphics";
        version = "0.1.5";
        edition = "2015";
        crateBin = [];
        sha256 = "1nsf920k4wqdihfv0v6p9qflhadk35sdwgcjdpap5jr3w495jn7k";
        authors = [
          "calum"
        ];
