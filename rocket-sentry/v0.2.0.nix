...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-sentry/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sentry" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "default" "failure" "hostname" "httpdate" "im" "libc" "rand" "regex" "reqwest" "rustc_version" "uname" "url" "with_backtrace" "with_client_implementation" "with_default_transport" "with_device_info" "with_failure" "with_native_tls" "with_panic" "with_reqwest_transport" "with_rust_info" ];
      };
      "sentry-types" = rec {
