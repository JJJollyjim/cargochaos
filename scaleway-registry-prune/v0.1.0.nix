...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scaleway-registry-prune/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "scaleway-registry-prune";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "scaleway-registry-prune" = rec {
        crateName = "scaleway-registry-prune";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "scaleway-registry-prune"; path = "src/main.rs"; }
        ];
      ...
      "scaleway_sdk" = rec {
        crateName = "scaleway_sdk";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1yzr47cvmbyv0y635p9qkcsrl049k430jy0i24f7kgv26mflv7vc";
        authors = [
          "Mikkel Kroman <mk@maero.dk>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
