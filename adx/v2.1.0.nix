...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/adx/v2.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "timezoneapi" "winbase" "wincon" "winuser" "wtypesbase" ];
      };
