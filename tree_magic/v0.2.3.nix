...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tree_magic/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tree_magic" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "default" "num_cpus" "scoped_threadpool" "staticmime" "tabwriter" "walkdir" ];
      };
      "unicode-width" = rec {
