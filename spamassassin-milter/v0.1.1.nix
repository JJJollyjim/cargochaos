...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spamassassin-milter/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "milter" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "113nmf1l14kd909d6f0nwfs7080liqld3sgxhh4pzf44g5ym7xdm";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "milter-callback";
          }
          {
            name = "milter-sys";
            packageId = "milter-sys";
          }
          {
            name = "once_cell";
            packageId = "once_cell";
      ...
      "milter-callback" = rec {
        crateName = "milter-callback";
        version = "0.2.0";
        edition = "2018";
        sha256 = "07y9l0ckxyr3jdkawk0y3n3xsaird3l4qplkq5nrah0abjwxj5rs";
        procMacro = true;
        authors = [
          "David Bürgin <dbuergin@gluet.ch>"
        ];
      ...
      "milter-sys" = rec {
        crateName = "milter-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "04icva83q9322s6sv4wdafg1r59r0cml8sm15pjxn3zdylrd1axs";
        authors = [
          "David Bürgin <dbuergin@gluet.ch>"
        ];
        dependencies = [
      ...
      "spamassassin-milter" = rec {
        crateName = "spamassassin-milter";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "spamassassin-milter"; path = "src/main.rs"; }
        ];
