...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/saigon/v0.1.2.nix.tmp"
    ...
    crates = {
      ...
      "saigon" = rec {
        ...
        dependencies = [
          ...
          {
            name = "saigon_core";
            packageId = "saigon_core";
          }
        ];
        
      };
      "saigon_core" = rec {
        crateName = "saigon_core";
        version = "0.1.1";
        edition = "2018";
        sha256 = "018sxr5x3ncyxr917bz878fhbp7cp093aj69lz04z6cgk4g2c0fa";
        authors = [
          "Marshall Bowers <elliott.codes@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
