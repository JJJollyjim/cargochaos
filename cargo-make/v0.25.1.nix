...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.25.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-make" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.25.1.nix {};
        libName = "cli";
      ...
      "ci_info" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "0apdcqggfs7q8ca1apkhi016gb6i2dsgqw6vmx370pi87lf0ksd4";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "duckscript" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "19i6vp291dv2b63b19qrna46jc7kzk8m296p71n6w71dxbamvcv4";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
      ...
      "duckscriptsdk" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "10a1bpgxpqqrdmkxk2csj6bxh2frhkdj4ahsbsjanbajzjw3xifl";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "envmnt" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "0sdw6yyz85kvwqd2kbglhqxy70xarcizh3npknjwzf0hpzyxkk9r";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "userenv" "winbase" "winerror" "winnt" ];
      };
