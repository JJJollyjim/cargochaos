...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.30.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-make" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.30.4.nix {};
        libName = "cli";
      ...
      "duckscriptsdk" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "0ih08knscwq0kmaz769gpq6h321wk23604i8px7pl98a8n95vi0c";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
