...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.24.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-make" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.24.1.nix {};
        libName = "cli";
      ...
      "git_info" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "02933zldc9s64fv5svbzdr8fhw2v9hmdm3by4kn8gq5zmcpxqqj8";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
