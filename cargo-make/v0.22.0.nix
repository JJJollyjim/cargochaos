...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.22.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ci_info" = rec {
        ...
        version = "0.8.0";
        edition = "2015";
        sha256 = "1rcv5apb0m9hm40061dm16kis64gymdg8z6bskhvz41hizcs9q9d";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "envmnt" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "12zkq3p999bypyxmjnpiqw9r3hmifb3bcikd7j3as1fdcbq01fyl";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "rust_info" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "1nwplpvp40yvdwyjd2h1phh9nk6jrnsbxc4549fcj21c0ajh8kkf";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
      ...
      "shell2batch" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0sr6ijpidphs66fymn745c619iry544k6jpfhvdp6v4h5cscwypp";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winuser" ];
      };
