...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.27.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "duckscript" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1d9l2s1syiszlcsvyvslhfb2bp6k8l801z5zh52hp0x087jv8yvl";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
      ...
      "duckscriptsdk" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "155sd2djasyghk30qj87divfx9d9kd7kqrgfl6g81fq57n20773r";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
