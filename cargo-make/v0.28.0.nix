...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.28.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "duckscript" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1ivj779waw1iz529vmd85c90hzcdnjcd1vnqdqnlq9pwbw8rkxn0";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "duckscriptsdk" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "01f84krysaz0hc5m4lh3q0cn610d48k3jfd14rf0r91h22hbpmns";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" ];
      };
