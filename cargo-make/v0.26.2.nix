...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-make/v0.26.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-make" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.26.2.nix {};
        libName = "cli";
      ...
      "ci_info" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "1ndzf92pgsz35jcki27r9pw5h6m9h8cqjz0w9nzd9bqaxd9nhfp5";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
      ...
      "envmnt" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0lkk5zyg5fh26vqc3w16v7lcpgsvvzck4373ls8pz8sc2cb1y46v";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
