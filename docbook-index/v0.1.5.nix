...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/docbook-index/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "docbook-index" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "docbook-index"; path = "src/main.rs"; }
        ];
      ...
      "elasticlunr-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "da" "de" "default" "du" "es" "fi" "fr" "it" "languages" "pt" "ro" "ru" "rust-stemmers" "sv" "tr" ];
      };
      "glob" = rec {
        crateName = "glob";
        version = "0.3.0";
