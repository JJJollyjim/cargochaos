...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/os_info/v2.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "os_info" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "os_info"; path = "src/bin/os_info.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "libloaderapi" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "sysinfoapi" "winbase" "winnt" "winuser" ];
      };
