...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lag/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-default" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
