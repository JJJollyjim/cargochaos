...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/test_first_proj_guess_game_hsdbhjsdbjfwehi/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "test_first_proj_guess_game_hsdbhjsdbjfwehi";
  ...
  workspaceMembers = {
    "test_first_proj_guess_game_hsdbhjsdbjfwehi" = rec {
      packageId = "test_first_proj_guess_game_hsdbhjsdbjfwehi";
      build = internal.buildRustCrateWithFeatures {
        packageId = "test_first_proj_guess_game_hsdbhjsdbjfwehi";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "test_first_proj_guess_game_hsdbhjsdbjfwehi" = rec {
        crateName = "test_first_proj_guess_game_hsdbhjsdbjfwehi";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "test_first_proj_guess_game_hsdbhjsdbjfwehi"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "emilbabazade29@gmail.com"
        ];
        dependencies = [
          {
            name = "rand";
