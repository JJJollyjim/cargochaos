...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nvtt_rs/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nvtt_rs" = rec {
        ...
        resolvedDefaultFeatures = [ "image" "maybe-owned" "nvtt_image_integration" "safe-transmute" ];
      };
      "nvtt_sys" = rec {
        crateName = "nvtt_sys";
        version = "0.2.1";
        edition = "2018";
        sha256 = "1sddyhgnk153n12xdppqvw6gy3y4nq7cwddd9cslppq8hv5mzbid";
        authors = [
          "George Burton <burtonageo@gmail.com>"
        ];
        dependencies = [
      ...
      "vswhere" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "05fqph76h1aj8xvzq7jmn1x9z4krj990gmhh24vhp079hqfpv9fj";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "errhandlingapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntdef" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winerror" ];
      };
