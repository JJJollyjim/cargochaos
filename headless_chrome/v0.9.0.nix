...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/headless_chrome/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "headless_chrome" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "directories" "fetch" "nightly" "ureq" "zip" ];
      };
      "httparse" = rec {
        crateName = "httparse";
        version = "1.3.4";
      ...
      "tiny_http" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "chunked_transfer 0.3.1";
          }
          {
            name = "log";
            packageId = "log 0.4.8";
      ...
      "ureq" = rec {
        ...
        dependencies = [
          ...
          {
            name = "chunked_transfer";
            packageId = "chunked_transfer 1.0.0";
          }
          {
            name = "cookie";
            packageId = "cookie";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "wtypesbase" ];
      };
