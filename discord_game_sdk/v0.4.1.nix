...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/discord_game_sdk/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "discord_game_sdk" = rec {
        ...
        features = {
          "default" = [ "discord_game_sdk_sys/link" ];
        };
        resolvedDefaultFeatures = [ "default" ];
      };
      "discord_game_sdk_sys" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1qgdsc0kb624hcdz7rsmq3z87yl05znl1cfdwcqpgvhnpz6fvaqb";
        authors = [
          "ldesgoui <ldesgoui@gmail.com>"
        ];
        buildDependencies = [
