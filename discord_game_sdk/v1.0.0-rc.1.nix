...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/discord_game_sdk/v1.0.0-rc.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "discord_game_sdk" = rec {
        ...
        features = {
          "default" = [ "link" ];
          "doc" = [ "discord_game_sdk_sys/doc" ];
          "link" = [ "discord_game_sdk_sys/link" ];
        };
        resolvedDefaultFeatures = [ "default" "doc" "image" "link" ];
      };
      "discord_game_sdk_sys" = rec {
        crateName = "discord_game_sdk_sys";
        version = "1.0.0-rc.1";
        edition = "2018";
        sha256 = "0bsxvk0jn0mc03hywgr9xljvwxbrmyf8dsvdr6fp5gmhwyy7w1jp";
        authors = [
          "ldesgoui <ldesgoui@gmail.com>"
        ];
        buildDependencies = [
        ...
        resolvedDefaultFeatures = [ "doc" "link" ];
      };
      "env_logger" = rec {
