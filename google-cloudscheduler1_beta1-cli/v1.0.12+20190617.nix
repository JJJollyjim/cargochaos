...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudscheduler1_beta1-cli/v1.0.12+20190617.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudscheduler1_beta1-cli";
  ...
  workspaceMembers = {
    "google-cloudscheduler1_beta1-cli" = rec {
      packageId = "google-cloudscheduler1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudscheduler1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudscheduler1_beta1" = rec {
        crateName = "google-cloudscheduler1_beta1";
        version = "1.0.12+20190617";
        edition = "2015";
        sha256 = "1hr0p26ibmcp5m0ipqskmzs5wqqglndhhnn69hahcxmfvl2pnn3k";
        authors = [
      ...
      "google-cloudscheduler1_beta1-cli" = rec {
        crateName = "google-cloudscheduler1_beta1-cli";
        version = "1.0.12+20190617";
        edition = "2015";
        crateBin = [
          { name = "cloudscheduler1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190617.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-cloudscheduler1_beta1";
            packageId = "google-cloudscheduler1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
