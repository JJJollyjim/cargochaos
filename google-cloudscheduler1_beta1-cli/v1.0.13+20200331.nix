...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudscheduler1_beta1-cli/v1.0.13+20200331.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudscheduler1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "0z13qjr538r5gfbiyl4ksw8255mnv6691pp5jzjv278hwhmpb214";
        authors = [
