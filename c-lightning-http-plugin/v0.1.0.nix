...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/c-lightning-http-plugin/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "c-lightning-http-plugin";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "c-lightning-http-plugin" = rec {
        crateName = "c-lightning-http-plugin";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "c-lightning-http-plugin"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Keagan McClelland <keagan@start9labs.com>"
      ...
      "lazy_async_pool" = rec {
        crateName = "lazy_async_pool";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1007k0jxbswgxvrzwmlfc4m1znvyqs6a788j34a6wblab6bv6j9h";
        authors = [
          "Aiden McClelland <me@drbonez.dev>"
        ];
        dependencies = [
