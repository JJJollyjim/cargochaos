...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-unleash/v1.0.0-alpha.10.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-unleash" = rec {
        crateName = "cargo-unleash";
        version = "1.0.0-alpha.10";
        edition = "2018";
        crateBin = [
          { name = "cargo-unleash"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0-alpha.10.nix {};
        authors = [
      ...
      "flexi_logger" = rec {
        ...
        version = "0.14.8";
        edition = "2018";
        sha256 = "1s4s31w9jbgn3savaj63nv60q6ajdamsf4kwr11fbbqxakvbfpsi";
        authors = [
