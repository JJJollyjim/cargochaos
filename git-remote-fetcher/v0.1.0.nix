...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-remote-fetcher/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-remote-fetcher" = rec {
        crateName = "git-remote-fetcher";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "git-remote-fetcher"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Marais Rossouw <me@marais.io>"
        ];
        dependencies = [
          {
            name = "clap";
