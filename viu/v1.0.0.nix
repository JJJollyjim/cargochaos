...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/viu/v1.0.0.nix.tmp"
      ...
      "viu" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            target = { target, features }: (target."os" == "wasi");
            features = [ "gif_codec" "jpeg" "ico" "jpeg-decoder" "png_codec" "pnm" "tga" "tiff" "webp" "bmp" "hdr" "dxt" ];
          }
          {
            name = "image";
            packageId = "image 0.23.1";
            target = { target, features }: (!(target."os" == "wasi"));
          }
          {
            name = "libc";
