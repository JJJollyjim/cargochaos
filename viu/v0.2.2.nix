...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/viu/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossterm" = rec {
        ...
        resolvedDefaultFeatures = [ "crossterm_terminal" "terminal" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" ];
      };
