...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ndarray-linalg/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "intel-mkl-src" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "16kq725cl4rnvfpwq9x4rl83ylcqs7d0xryagx8ijm6bdblbfabc";
        authors = [
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
        buildDependencies = [
      ...
      "ndarray" = rec {
        ...
        resolvedDefaultFeatures = [ "blas" "blas-src" "cblas-sys" "serde" "serde-1" ];
      };
      "ndarray-linalg" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "intel-mkl" "netlib" "openblas" "openblas-src" "openblas-static" "serde-1" "static" ];
      };
      "net2" = rec {
        crateName = "net2";
        version = "0.2.33";
      ...
      "openblas-src" = rec {
        ...
        resolvedDefaultFeatures = [ "cblas" "default" "lapacke" "static" ];
      };
      "openssl" = rec {
        crateName = "openssl";
        version = "0.10.25";
