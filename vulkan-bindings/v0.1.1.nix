...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vulkan-bindings/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vulkan-bindings" = rec {
        crateName = "vulkan-bindings";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Bart Sekura <bart.sekura@gmail.com>"
        ];
        devDependencies = [
          {
            name = "libloading";
