...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/serde-version/v0.5.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "proc-macro-util" = rec {
        crateName = "proc-macro-util";
        version = "0.1.1";
        edition = "2018";
        sha256 = "082mjwa92xijwlp2503hcsxf57bad8lzgllwb83b9x1ggzhpgm6j";
        authors = [
          "Frédéric Vauchelles <frederic.vauchelles@gmail.com>"
        ];
        dependencies = [
          {
            name = "failure";
      ...
      "serde-version" = rec {
        ...
        dependencies = [
          ...
          {
            name = "serde_version_derive";
            packageId = "serde_version_derive";
            optional = true;
          }
          {
            name = "toml";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "ron" "serde_version_derive" "toml" "toml-support" ];
      };
      "serde_derive" = rec {
      ...
      "serde_version_derive" = rec {
        crateName = "serde_version_derive";
        version = "0.5.1";
        edition = "2015";
        sha256 = "1bk14mkd71ra8prcigj6nkhbv8v5z93vv4z0d8ia76ijv9sccf4q";
        procMacro = true;
        authors = [
          "Frédéric Vauchelles <frederic.vauchelles@gmail.com>"
        ];
        dependencies = [
          {
            name = "proc-macro-util";
            packageId = "proc-macro-util";
          }
          {
            name = "proc-macro2";
            packageId = "proc-macro2 1.0.6";
