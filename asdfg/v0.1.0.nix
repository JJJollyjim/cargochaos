...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/asdfg/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shellapi" "shlobj" "winbase" "winerror" "winnt" ];
      };
