...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/v_hist/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "winbase" "wincon" "winnt" "winuser" ];
      };
