...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bishop-cli/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bishop" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "03rkrhxrwz6r4s50c25njxi043axwps201w3fx4jd8143kfdsz8q";
        authors = [
          "AbsurdlySuspicious <repom2@airmail.cc>"
        ];
        dependencies = [
          {
            name = "thiserror";
      ...
      "bishop-cli" = rec {
        crateName = "bishop-cli";
        version = "0.2.3";
        edition = "2018";
        crateBin = [
          { name = "bishop"; path = "src/main.rs"; }
        ];
