...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bishop-cli/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bishop" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "16idnm146sqns7wij7rnbnxg1k1ai0zpxafyznymvj80xhv58b2d";
        authors = [
      ...
      "thiserror" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "0c67zyi4khqfnfcvplypl6d888wnlf788fbyxklmk5gr563p59kn";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "thiserror-impl" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1jgagdpgfy25ac6gyn7incb648janyza8s8yhhfnvmib1md3zmg9";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
