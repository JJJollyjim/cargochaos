...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/meli/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dbus" = rec {
        ...
        version = "0.6.4";
        edition = "2015";
        sha256 = "1ms7rvw7rajchy88c2kljfyng4cy3sghykrcaahx98va7ygv7qdr";
        authors = [
      ...
      "libdbus-sys" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "044j33bjl7b59c38m31cjvcq09yq6dcvnp90c94hzl2q6ab8ijqq";
        authors = [
          "David Henningsson <diwic@ubuntu.com>"
        ];
        buildDependencies = [
      ...
      "linkify" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "0pyyh503xjj0rz6s2fpi77d92j0307pjn9v133f9442adyf47scw";
        authors = [
      ...
      "meli" = rec {
        ...
        resolvedDefaultFeatures = [ "debug-tracing" "default" "jmap" "notmuch" "rusqlite" "sqlite3" ];
      };
      "melib" = rec {
        crateName = "melib";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1bdns85xsa1s2l3wd69l5mi2b81fbmcbmvdbrpmx8jfy6qsj24iw";
        authors = [
        ...
        resolvedDefaultFeatures = [ "debug-tracing" "default" "imap_backend" "jmap_backend" "maildir_backend" "mbox_backend" "memmap" "native-tls" "notify" "notify-rust" "notmuch_backend" "reqwest" "serde_json" "unicode-segmentation" "unicode_algorithms" "vcard" ];
      };
      "memchr 1.0.2" = rec {
        crateName = "memchr";
        version = "1.0.2";
      ...
      "notify-rust" = rec {
        ...
        version = "3.6.0";
        edition = "2015";
        sha256 = "0plcz2vpix87ndjd111mpzw9ll9rmm0rzdqj4x622mib0dg52mi9";
        authors = [
          "Hendrik Sollich <hendrik@hoodie.de>"
        ];
        dependencies = [
      ...
      "xdg-utils" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0gmffrmjlzzr4bs8q0ssjv8l5j2fz1m8yi76vd8m5cisidxa0jjb";
        authors = [
          "Manos Pitsidianakis <el13635@mail.ntua.gr>"
        ];
