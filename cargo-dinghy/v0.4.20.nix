...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-dinghy/v0.4.20.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-dinghy" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.4.20.nix {};
        authors = [
      ...
      "dinghy-build" = rec {
        ...
        version = "0.4.20";
        edition = "2015";
        sha256 = "04cwsq5z9k4al023s2dj9fjxcv9y0q2pdyajrmrhpy8s32sp2z5x";
        authors = [
          "Mathieu Poumeyrol <mathieu.poumeyrol@snips.ai>"
        ];
        dependencies = [
      ...
      "dinghy-lib" = rec {
        ...
        version = "0.4.20";
        edition = "2015";
        sha256 = "1fmc9inndfh20dp0x090pq1z6mnvzwzxpiych3f1h844kabzf3ir";
        authors = [
          "Mathieu Poumeyrol <mathieu.poumeyrol@snips.ai>"
        ];
        dependencies = [
      ...
      "plist" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "05ygnni4ijmy8f1k54i889n0fx9pxr2n082b1rgvgqjjjca0v19i";
        authors = [
