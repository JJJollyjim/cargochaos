...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-dinghy/v0.4.17.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-dinghy" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.4.17.nix {};
        authors = [
      ...
      "dinghy-build" = rec {
        ...
        version = "0.4.17";
        edition = "2015";
        sha256 = "1fdasr0cdxk9649jd91f0p9a2w9xi9drca5aga4y5ygyvl3xc606";
        authors = [
          "Mathieu Poumeyrol <mathieu.poumeyrol@snips.ai>"
        ];
        dependencies = [
      ...
      "dinghy-lib" = rec {
        ...
        version = "0.4.17";
        edition = "2015";
        sha256 = "0qfph5am0jcam01ri1n7db4brwwgr59z1pmqpmbvfjb9yg77m5r6";
        authors = [
          "Mathieu Poumeyrol <mathieu.poumeyrol@snips.ai>"
        ];
        dependencies = [
