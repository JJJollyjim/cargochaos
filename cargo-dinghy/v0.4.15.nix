...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-dinghy/v0.4.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-dinghy" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.4.15.nix {};
        authors = [
      ...
      "dinghy-build" = rec {
        ...
        version = "0.4.15";
        edition = "2015";
        sha256 = "0ylglsf9gz5wppwr4zj7gi2qq1vcj0ssgzlwnmdrbhbnx2h8f46h";
        authors = [
          "Mathieu Poumeyrol <mathieu.poumeyrol@snips.ai>"
        ];
        dependencies = [
      ...
      "dinghy-lib" = rec {
        ...
        version = "0.4.15";
        edition = "2015";
        sha256 = "0ri58n2fms0l572vpl1is7c1dhldq5f0g22yq70fiikr2b7szc7j";
        authors = [
          "Mathieu Poumeyrol <mathieu.poumeyrol@snips.ai>"
        ];
        dependencies = [
