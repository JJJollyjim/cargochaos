...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shunkakinoki/v4.23.29.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shunkakinoki" = rec {
        crateName = "shunkakinoki";
        version = "4.23.29";
        edition = "2018";
        crateBin = [
          { name = "shunkakinoki"; path = "shunkakinoki/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v4.23.29.nix {};
        authors = [
          "Shun Kakinoki <shunkakinoki@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
