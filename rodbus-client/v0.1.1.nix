...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rodbus-client/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rodbus" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "11aqw9i5scq4wqrlalkpffjbla3jfsg8ilg16ddi0367zdfrm3pa";
        authors = [
          "Adam Crain <jadamcrain@automatak.com>"
          "Émile Grégoire <emile@automatak.com>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "rodbus-client" = rec {
        crateName = "rodbus-client";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "rodbus-client"; path = "src/main.rs"; }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
