...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-smtp/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-smtp" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "bufstream" "default" "file-transport" "hostname" "native-tls-vendored" "nom" "sendmail-transport" "serde" "serde-impls" "serde_derive" "serde_json" "smtp-transport" "unstable" ];
      };
      "async-std" = rec {
        crateName = "async-std";
        version = "1.4.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntstatus" "processenv" "processthreadsapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
