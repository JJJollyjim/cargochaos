...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/surfman/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "surfman" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "mozangle" "osmesa-sys" "sm-angle" "sm-angle-builtin" "sm-angle-default" "sm-no-wgl" "sm-test" "sm-wayland-default" "sm-winit" "sm-x11" "winit" "x11" ];
      };
      "textwrap" = rec {
        crateName = "textwrap";
        version = "0.11.0";
