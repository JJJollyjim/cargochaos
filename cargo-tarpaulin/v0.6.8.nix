...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-tarpaulin/v0.6.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-tarpaulin" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.6.8.nix {};
        authors = [
      ...
      "curl" = rec {
        ...
        version = "0.4.18";
        edition = "2015";
        sha256 = "12a3zkwi2p10q0zgp7vci99rmn8lin03nzclii8h2i5l95djird9";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "curl-sys" = rec {
        ...
        version = "0.4.12";
        edition = "2015";
        sha256 = "0cbc462d7lhrf6vz8as3hrb5iz0lkhv6yv72djmmvxj2winhm03q";
        libName = "curl_sys";
        libPath = "lib.rs";
        authors = [
          "Carl Lerche <me@carllerche.com>"
      ...
      "encoding_rs" = rec {
        ...
        version = "0.8.9";
        edition = "2015";
        sha256 = "1ifymp2kavmny1qjrhbjlv279fdk9w2lhdz1gl45p6ijdjjrz9zi";
        authors = [
      ...
      "libz-sys" = rec {
        ...
        version = "1.0.23";
        edition = "2015";
        sha256 = "1av96k41pyxbn1nzd3gczy8nvr5bdj8p2apbwqqaj0m0592cmgf7";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "openssl" = rec {
        ...
        version = "0.10.12";
        edition = "2015";
        sha256 = "13ah91xnz7zc3a3qf5gc5pdckqgqr8akkysjmjii6n05vvp7jbjy";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "openssl-sys" = rec {
        ...
        version = "0.9.36";
        edition = "2015";
        sha256 = "0pp6bmskiq4bpyrrhka3njb78z7zfbpb48mkdsysx8cjnkp7g7a0";
        build = "build/main.rs";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
          "Steven Fackler <sfackler@gmail.com>"
      ...
      "quick-xml" = rec {
        ...
        version = "0.13.0";
        edition = "2015";
        sha256 = "1812jnn6glzhk9c8mnkviaazva58kkfd7ngjrzsyivhxw5x54k0m";
        authors = [
      ...
      "syn 0.15.8" = rec {
        ...
        version = "0.15.8";
        edition = "2015";
        sha256 = "0pp4ndcqlv1kpr1mpmxpk4zc7vvzii4x5wlskr440z2r8d81qv9m";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "tar" = rec {
        ...
        version = "0.4.17";
        edition = "2015";
        sha256 = "1pmkbbh9d4mrk829wr2b13k9jpw13rjxvyik35l65zfvad5x3c43";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
