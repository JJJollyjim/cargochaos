...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-tarpaulin/v0.6.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flate2" = rec {
        ...
        version = "1.0.5";
        edition = "2015";
        sha256 = "1742iwgpv0sggg06fmg2lf6875bnqrmf2vr3r0g22zvkq97ix5wn";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "flate2-crc" = rec {
        crateName = "flate2-crc";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1ifb44glapxxc35xvkgsrilmv6074mc21kj78sc4fxzdx92j4yca";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
