...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imag-category/v0.10.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imag-category" = rec {
        crateName = "imag-category";
        version = "0.10.1";
        edition = "2015";
        crateBin = [
          { name = "imag-category"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.1.nix {};
        libName = "libimagcategorycmd";
        authors = [
          "Matthias Beyer <mail@beyermatthias.de>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "libimagentrycategory";
          }
          {
            name = "libimagerror";
      ...
      "libimagentrycategory" = rec {
        crateName = "libimagentrycategory";
        version = "0.10.1";
        edition = "2015";
        sha256 = "15b4zfj17yrs7jrpka0dqqxdpliqdsqwdrnva0yspdqll2icak89";
        authors = [
          "Matthias Beyer <mail@beyermatthias.de>"
        ];
        dependencies = [
