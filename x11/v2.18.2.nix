...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/x11/v2.18.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "x11" = rec {
        ...
        version = "2.18.2";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v2.18.2.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "dox" "dpms" "glx" "xcursor" "xf86vmode" "xft" "xinerama" "xinput" "xlib" "xlib_xcb" "xmu" "xrandr" "xrecord" "xrender" "xss" "xt" "xtest" "xtst" ];
      };
    };
