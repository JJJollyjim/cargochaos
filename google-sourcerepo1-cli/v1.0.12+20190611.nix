...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-sourcerepo1-cli/v1.0.12+20190611.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-sourcerepo1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-sourcerepo1" = rec {
        crateName = "google-sourcerepo1";
        version = "1.0.12+20190611";
        edition = "2015";
        sha256 = "1svid1zdk314x9c4400yf794f95r24r6h1wxaw4fxrk7xwsd548v";
        authors = [
      ...
      "google-sourcerepo1-cli" = rec {
        crateName = "google-sourcerepo1-cli";
        version = "1.0.12+20190611";
        edition = "2015";
        crateBin = [
          { name = "sourcerepo1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190611.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-sourcerepo1";
            packageId = "google-sourcerepo1";
          }
          {
            name = "hyper";
            packageId = "hyper";
