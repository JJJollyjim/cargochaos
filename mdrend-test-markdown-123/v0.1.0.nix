...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdrend-test-markdown-123/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mdrend-test-markdown-123";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdrend-test-markdown-123" = rec {
        crateName = "mdrend-test-markdown-123";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mdrend-test-markdown-123"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "xodltus <xodltus@naver.com>"
        ];
        dependencies = [
          {
            name = "clap";
