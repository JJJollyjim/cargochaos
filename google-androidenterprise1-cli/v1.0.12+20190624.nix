...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidenterprise1-cli/v1.0.12+20190624.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-androidenterprise1-cli";
  ...
  workspaceMembers = {
    "google-androidenterprise1-cli" = rec {
      packageId = "google-androidenterprise1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-androidenterprise1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidenterprise1" = rec {
        crateName = "google-androidenterprise1";
        version = "1.0.12+20190624";
        edition = "2015";
        sha256 = "0rm42mx6czrpdikz5m6sd0cwvv4zwqdd1f28qlvygz5ifyhn8kv3";
        authors = [
      ...
      "google-androidenterprise1-cli" = rec {
        crateName = "google-androidenterprise1-cli";
        version = "1.0.12+20190624";
        edition = "2015";
        crateBin = [
          { name = "androidenterprise1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-androidenterprise1";
          }
          {
            name = "hyper";
            packageId = "hyper";
