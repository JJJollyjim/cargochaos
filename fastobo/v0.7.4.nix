...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fastobo/v0.7.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fastobo-derive-internal" = rec {
        ...
        version = "0.7.4";
        edition = "2018";
        sha256 = "1l8zsiirhw3d212cmnpxzm8yf5xygaw3akx0563sbh2p1kqmlaf8";
        procMacro = true;
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
      ...
      "fastobo-syntax" = rec {
        ...
        version = "0.3.6";
        edition = "2018";
        sha256 = "1zhk197mpipn43hd1jyfxa6q8bldip40q1mmjjp61cyy2yiwgax3";
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
        dependencies = [
