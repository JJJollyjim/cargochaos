...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fastobo/v0.7.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fastobo" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.5.nix {};
        authors = [
      ...
      "fastobo-derive-internal" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "07g8yiqq8g06dkljm6bf5567zj7pij9cfmcf36hi0qaincw9vh51";
        procMacro = true;
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
      ...
      "fastobo-syntax" = rec {
        ...
        version = "0.3.7";
        edition = "2018";
        sha256 = "0zqlv7yf2wfi2vsldnk0scshdhmq4immz4lffi80b7ylp8hrzmif";
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
        dependencies = [
      ...
      "textwrap-macros" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0l768j5sb17qp81viwm22n5rbvqd1ddky7y3y4p6apz1wwqiby2w";
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
        dependencies = [
      ...
      "textwrap-macros-impl" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1jsx778xnxzpqx0hkkz6hyd8b2gw3ym1jk77zb7mj0pm80kqlp8d";
        procMacro = true;
        libPath = "lib.rs";
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
