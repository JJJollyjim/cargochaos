...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fastobo/v0.8.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fastobo" = rec {
        ...
        resolvedDefaultFeatures = [ "_doc" "crossbeam-channel" "default" "lazy_static" "memchr" "num_cpus" "threading" ];
      };
      "fastobo-derive-internal" = rec {
        crateName = "fastobo-derive-internal";
        version = "0.8.1";
        edition = "2018";
        sha256 = "03s8dlpfzwwzmwifbw4y1dkxcmhg54ahwrsxwp216vgh91qhfp45";
        procMacro = true;
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
      ...
      "textwrap-macros" = rec {
        crateName = "textwrap-macros";
        version = "0.2.1";
        edition = "2018";
        sha256 = "10fgv0d9933474d54208lsffly98488w2jhnafqxpik14442qpjj";
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "textwrap-macros-impl";
          }
        ];
        
      };
      "textwrap-macros-impl" = rec {
        crateName = "textwrap-macros-impl";
        version = "0.2.1";
        edition = "2018";
        sha256 = "0pwf2w8gdcw8ivy3qcq1wmr1w8sqcbgbd66kw8hnc96iv5vmk0nc";
        procMacro = true;
        libPath = "lib.rs";
        authors = [
          "Martin Larralde <martin.larralde@ens-paris-saclay.fr>"
