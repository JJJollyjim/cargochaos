...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/n5gest/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "bmp" "dxt" "gif" "gif_codec" "jpeg" "jpeg-decoder" "png" "png_codec" "pnm" "tga" "tiff" "webp" ];
      };
      "indicatif" = rec {
        crateName = "indicatif";
        version = "0.13.0";
      ...
      "n5" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "0i50gdb3ind9fh64r2s7qn47sv5rbixvbb7qsw14zppizvlhir3q";
        authors = [
      ...
      "n5gest" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "image";
            usesDefaultFeatures = false;
            features = [ "gif_codec" "jpeg" "png_codec" "pnm" "tga" "tiff" "webp" "bmp" "dxt" ];
          }
          {
            name = "indicatif";
            packageId = "indicatif";
        ...
        resolvedDefaultFeatures = [ "nightly" "serde_plain" ];
      };
      "ndarray" = rec {
        crateName = "ndarray";
        version = "0.13.0";
