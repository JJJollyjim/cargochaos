...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/adnix/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "timezoneapi" "winbase" "wtypesbase" ];
      };
      "winapi-build" = rec {
