...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-speech1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-speech1" = rec {
        crateName = "google-speech1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "1wd2y5qjys29r50ymsdwvp4anhc6ksbbrhjvrxmakm6g5c3liqr1";
        authors = [
      ...
      "google-speech1-cli" = rec {
        crateName = "google-speech1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "speech1"; path = "src/main.rs"; }
        ];
