...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-serde-cbor/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "iovec" "lazy_static" "macros" "mio" "rt-core" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
