...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-std/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-std" = rec {
        ...
        resolvedDefaultFeatures = [ "async-attributes" "async-macros" "async-task" "attributes" "broadcaster" "crossbeam-channel" "crossbeam-deque" "crossbeam-utils" "default" "docs" "futures-core" "futures-io" "futures-timer" "kv-log-macro" "log" "memchr" "mio" "mio-uds" "num_cpus" "once_cell" "pin-project-lite" "pin-utils" "slab" "std" "unstable" ];
      };
      "async-task" = rec {
