...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-std/v0.99.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-std" = rec {
        ...
        version = "0.99.8";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.99.8.nix {};
        authors = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
