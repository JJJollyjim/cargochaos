...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-std/v0.99.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-std" = rec {
        ...
        version = "0.99.7";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.99.7.nix {};
        authors = [
      ...
      "broadcaster" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "default-channels" "futures-channel-preview" ];
      };
      "bumpalo" = rec {
        crateName = "bumpalo";
        version = "2.6.0";
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "AbortSignal" "Headers" "MessageEvent" "ObserverCallback" "ReferrerPolicy" "Request" "RequestCache" "RequestCredentials" "RequestInit" "RequestMode" "RequestRedirect" "Response" "Window" "Worker" "console" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
