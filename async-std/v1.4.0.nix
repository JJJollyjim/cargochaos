...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-std/v1.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-std" = rec {
        ...
        version = "1.4.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.4.0.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "async-attributes" "async-task" "attributes" "broadcaster" "crossbeam-channel" "crossbeam-deque" "crossbeam-utils" "default" "docs" "futures-core" "futures-io" "futures-timer" "kv-log-macro" "log" "memchr" "mio" "mio-uds" "num_cpus" "once_cell" "pin-project-lite" "pin-utils" "slab" "std" "unstable" ];
      };
      "async-task" = rec {
