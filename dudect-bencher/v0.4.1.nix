...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dudect-bencher/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "processenv" "synchapi" "winbase" ];
      };
      "winapi-build" = rec {
