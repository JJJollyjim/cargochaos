...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/trellis_m4/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "accelerometer" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0m3zw7m0i09xss43k40bxl36x64lprf9xvwl9zrqvkijhnw7cnnr";
        authors = [
      ...
      "adxl343" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "1l289csk0anjyaa3h7z02fixkjkfmq0r7q2k84klg8q0ycvv6abq";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "i16x3" ];
      };
      "aligned 0.2.0" = rec {
        crateName = "aligned";
        version = "0.2.0";
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd51g19a" "samd51" "samd51g19a" "samd51g19a-rt" "unproven" ];
      };
      "atsamd51g19a" = rec {
        crateName = "atsamd51g19a";
        version = "0.6.0";
        edition = "2015";
        sha256 = "0a8nc9vsx0f0ixpz6zgkrsmqdzc7gg5v3rihf945kc9w61d9wfcs";
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
          "Tony Arcieri <bascule@gmail.com>"
        ];
      ...
      "keypad" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "076fj2p1c26z72ph7zviwpvmh335i18xf3pw5jrw7riwfbzy26rd";
        authors = [
      ...
      "micromath" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "17f9bkamk1cs4m8s0nkdg7z8idmcqkrlbm18mk451cfqzzfkawjb";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
      ...
      "trellis_m4" = rec {
        ...
        resolvedDefaultFeatures = [ "adxl343" "cortex-m-rt" "default" "keypad" "keypad-unproven" "rt" "unproven" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
