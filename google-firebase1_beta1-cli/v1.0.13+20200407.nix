...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-firebase1_beta1-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-firebase1_beta1-cli";
  ...
  workspaceMembers = {
    "google-firebase1_beta1-cli" = rec {
      packageId = "google-firebase1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-firebase1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-firebase1_beta1" = rec {
        crateName = "google-firebase1_beta1";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "0q0p9lzymij77xagh4sblx6kjc8c49si8j99jjlsk5bvpbi870qn";
        authors = [
      ...
      "google-firebase1_beta1-cli" = rec {
        crateName = "google-firebase1_beta1-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "firebase1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-firebase1_beta1";
            packageId = "google-firebase1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
