...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/varlink_parser/v4.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "varlink_parser" = rec {
        ...
        version = "4.0.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v4.0.3.nix {};
        authors = [
          "Harald Hoyer <harald@redhat.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "dynamic_peg" "peg" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.8";
