...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-logging2_beta1-cli/v1.0.13+20190325.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-logging2_beta1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-logging2_beta1" = rec {
        crateName = "google-logging2_beta1";
        version = "1.0.13+20190325";
        edition = "2015";
        sha256 = "1yw6jpxd1avlzppma6nawqidvs0gig36868swrdabpjn55cc57i5";
        authors = [
      ...
      "google-logging2_beta1-cli" = rec {
        crateName = "google-logging2_beta1-cli";
        version = "1.0.13+20190325";
        edition = "2015";
        crateBin = [
          { name = "logging2-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190325.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-logging2_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
