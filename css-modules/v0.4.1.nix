...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/css-modules/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "dbghelp" "minwindef" "processthreadsapi" "winnt" ];
      };
