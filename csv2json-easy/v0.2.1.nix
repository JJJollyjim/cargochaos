...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/csv2json-easy/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "csv2json-easy" = rec {
        crateName = "csv2json-easy";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "csv2json-easy"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "hgfkeep <hgfkeep@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
