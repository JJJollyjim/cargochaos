...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/letsencrypt-inwx/v2.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "data-encoding-macro" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "0lrlxqpyr6ghliip3ad3ghnankas6vsgqpzmkksf81jk5gis558r";
        authors = [
      ...
      "data-encoding-macro-internal" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "0ylg6ckyjj97fbr4ccpydafjflkn03b2nmni1jzdbwwjlbvachfx";
        procMacro = true;
        authors = [
          "Julien Cretin <cretin@google.com>"
        ];
      ...
      "letsencrypt-inwx" = rec {
        crateName = "letsencrypt-inwx";
        version = "2.0.2";
        edition = "2018";
        crateBin = [
          { name = "letsencrypt-inwx"; path = "src/main.rs"; }
        ];
