...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rawloader/v0.36.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rawloader" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "benchmark"; path = "src/bin/benchmark.rs"; }
          { name = "identify"; path = "src/bin/identify.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.36.2.nix {};
