...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nvim_windows_remote/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nvim_windows_remote" = rec {
        crateName = "nvim_windows_remote";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "nvim_windows_remote"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "nicolasyang <bill.lee.y@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
