...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/particle-xenon/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cortex-m-semihosting" = rec {
        ...
        version = "0.3.4";
        edition = "2015";
        sha256 = "12j1nlpfd8yl5443rlbm59vfza4chkfdwzkzmx73ckrldp11gg85";
        authors = [
          "The Cortex-M Team <cortex-m@teams.rust-embedded.org>"
