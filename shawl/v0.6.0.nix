...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shawl/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shawl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "shawl"; path = "src/main.rs"; }
          { name = "shawl-child"; path = "src/bin/shawl-child.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.6.0.nix {};
        authors = [
          "mtkennerly <mtkennerly@gmail.com>"
        ];
        dependencies = [
          {
            name = "ctrlc";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winsvc" ];
      };
      ...
      "windows-service" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1ax66dd7i21whv5957wkpii98ay189f9gny5i3zflfyhj5d1i2q4";
        authors = [
