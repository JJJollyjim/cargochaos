...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mimicaw/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "precommit-hook" "prepush-hook" "run-cargo-fmt" "run-cargo-test" "run-for-all" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
      ...
      "maybe-unwind" = rec {
        crateName = "maybe-unwind";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1ysd0c0mgf2yapmgsr3lp6l08m1fcilwqdw7jvkmm1jz0p6in1bn";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "futures" "futures-core" "pin-project" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.3.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
