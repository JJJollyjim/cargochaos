...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/apt-pkg-native/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "apt-pkg-native" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "ye-olde-apt" ];
      };
      "boolinator" = rec {
