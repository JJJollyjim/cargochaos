...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rs-graph/v0.19.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "peg" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1nyhds9rp26npry6q4mz4z6jsdip5gw9532gbnx55kdwlz8vb996";
        authors = [
      ...
      "peg-macros" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "176d203k8hkzvi0nz6dpk46agn15008a5gd1pcd7kcb2cd7ss21x";
        procMacro = true;
        libName = "peg_macros";
        libPath = "lib.rs";
        authors = [
      ...
      "peg-runtime" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "05841rqpv462r9n0apn8z7mb8hw2pp3yaqvii529qv3qllyp4zi0";
        libPath = "lib.rs";
        authors = [
          "Kevin Mehall <km@kevinmehall.net>"
        ];
      ...
      "rs-graph" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dimacs" "peg" "serde" "serde_derive" "serialize" "steinlib" ];
      };
      "rustop" = rec {
        crateName = "rustop";
        version = "1.0.4";
        edition = "2018";
        sha256 = "09ika84skxv1p341i77ybgdn6d44ijd0m0s61pwbh5iqs0jddd20";
        libPath = "src/rustop.rs";
        authors = [
          "Frank Fischer <frank-fischer@shadow-soft.de>"
        ];
