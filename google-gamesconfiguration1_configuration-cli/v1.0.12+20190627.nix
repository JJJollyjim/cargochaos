...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-gamesconfiguration1_configuration-cli/v1.0.12+20190627.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-gamesconfiguration1_configuration-cli";
  ...
  workspaceMembers = {
    "google-gamesconfiguration1_configuration-cli" = rec {
      packageId = "google-gamesconfiguration1_configuration-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-gamesconfiguration1_configuration-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-gamesconfiguration1_configuration" = rec {
        crateName = "google-gamesconfiguration1_configuration";
        version = "1.0.12+20190627";
        edition = "2015";
        sha256 = "1fnr95afy7zghpzlsz0545gam5zs4rnwcz6sj27kqfcr7pcykwcf";
        authors = [
      ...
      "google-gamesconfiguration1_configuration-cli" = rec {
        crateName = "google-gamesconfiguration1_configuration-cli";
        version = "1.0.12+20190627";
        edition = "2015";
        crateBin = [
          { name = "gamesconfiguration1-configuration"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190627.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-gamesconfiguration1_configuration";
          }
          {
            name = "hyper";
            packageId = "hyper";
