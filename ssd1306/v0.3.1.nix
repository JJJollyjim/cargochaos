...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssd1306/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rand" = rec {
        ...
        resolvedDefaultFeatures = [ "rand_pcg" "small_rng" ];
      };
      "rand_chacha" = rec {
      ...
      "stm32f1" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f103" ];
      };
      "stm32f1xx-hal" = rec {
        crateName = "stm32f1xx-hal";
        version = "0.5.3";
        edition = "2018";
        sha256 = "0a515agavrf6pprm25r6x3hivya2rb8ca9h62fc29p1wh52g8ns5";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ...
        resolvedDefaultFeatures = [ "device-selected" "rt" "stm32f103" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
