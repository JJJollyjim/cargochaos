...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tuftool/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "olpc-cjson" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1hfrvygsaf6hj09z2j5znm0pb4wwmf4m3369hy9z3j366d4y42cl";
        authors = [
      ...
      "rusoto_ssm" = rec {
        ...
        resolvedDefaultFeatures = [ "native-tls" "rustls" ];
      };
      "rust-argon2" = rec {
      ...
      "snafu" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "backtraces" "backtraces-impl-backtrace-crate" "default" "std" ];
      };
      "snafu-derive" = rec {
      ...
      "tough" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "00h6yc7lh8hg78rpjxq886gnp1gfpiwzgv1prh2gllxq2c8y8bjr";
        authors = [
          "iliana destroyer of worlds <iweller@amazon.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "http" "reqwest" ];
      };
      "tower-service" = rec {
      ...
      "tuftool" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rusoto" "rusoto-native-tls" "rusoto-rustls" "rusoto_core" "rusoto_credential" "rusoto_ssm" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
