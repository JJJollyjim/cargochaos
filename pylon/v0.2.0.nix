...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pylon/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgref" = rec {
        ...
        version = "1.3.5";
        edition = "2015";
        sha256 = "1n6jrs60phiyd4gza4bjhgd4dg547j6swhmygrcnxcy0hlxjxn64";
        authors = [
      ...
      "pylon-sys" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0hjsxyhvqhq4k1qjrzfwqv6naz7p8r778fwijvfhg5b5489zhms9";
        authors = [
          "Falco Hirschenberger <falco.hirschenberger@gmail.com>"
        ];
        buildDependencies = [
