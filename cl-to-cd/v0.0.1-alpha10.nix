...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cl-to-cd/v0.0.1-alpha10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cl-to-cd" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cl-to-cd"; path = "src/main.rs"; }
          { name = "cd-to-notice"; path = "src/bin/cd-to-notice.rs"; }
          { name = "cd-to-csv"; path = "src/bin/cd-to-csv.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1-alpha10.nix {};
        authors = [
