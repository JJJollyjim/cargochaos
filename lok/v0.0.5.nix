...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lok/v0.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "ace" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "0h51518kjxdjqvywzbq46ig5c9d21clzyp4bz1s4w35292ais0hy";
        authors = [
      ...
      "bright" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0kab6w8svgckka34nqwf1w2b8077sqwvdynnsz9y1whang1j94np";
        authors = [
          "wyhaya <wyhaya@gmail.com>"
        ];
