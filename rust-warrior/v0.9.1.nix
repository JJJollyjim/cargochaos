...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-warrior/v0.9.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-warrior" = rec {
        crateName = "rust-warrior";
        version = "0.9.1";
        edition = "2018";
        crateBin = [
          { name = "rust-warrior"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.9.1.nix {};
        authors = [
          "Russell Cousineau <miller.time.baby@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
