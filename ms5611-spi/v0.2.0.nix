...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ms5611-spi/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "embedded-hal-mock" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1vkrdngs57ys3v5iav5jdxriaccyxbikvmmn4kvg15y8fjvlfzi3";
        authors = [
      ...
      "ms5611-spi" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "ms5607" "ms5611" ];
      };
      "nb" = rec {
        crateName = "nb";
        version = "0.1.2";
