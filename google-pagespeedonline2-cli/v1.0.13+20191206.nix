...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-pagespeedonline2-cli/v1.0.13+20191206.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-pagespeedonline2-cli";
  ...
  workspaceMembers = {
    "google-pagespeedonline2-cli" = rec {
      packageId = "google-pagespeedonline2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-pagespeedonline2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-pagespeedonline2" = rec {
        crateName = "google-pagespeedonline2";
        version = "1.0.13+20191206";
        edition = "2015";
        sha256 = "0lnqfrav1nkaawlx7h70cab8ilbxiimi2yf6ml0044scrv4ksmz8";
        authors = [
      ...
      "google-pagespeedonline2-cli" = rec {
        crateName = "google-pagespeedonline2-cli";
        version = "1.0.13+20191206";
        edition = "2015";
        crateBin = [
          { name = "pagespeedonline2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20191206.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-pagespeedonline2";
          }
          {
            name = "hyper";
            packageId = "hyper";
