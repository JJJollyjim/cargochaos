...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shrapnel/v0.1.0-alpha.29.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shrapnel" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "shrapnel"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.29.nix {};
        authors = [
          "aeldar <eldar.aliyev8@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
