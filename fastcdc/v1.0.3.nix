...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fastcdc/v1.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "processenv" "std" "sysinfoapi" "winbase" "wincrypt" ];
      };
