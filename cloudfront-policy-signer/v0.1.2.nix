...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cloudfront-policy-signer/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "cloudfront-policy-signer";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cloudfront-policy-signer" = rec {
        crateName = "cloudfront-policy-signer";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Martin Karlsen Jensen <martin@martin8412.dk>"
        ];
        dependencies = [
          {
            name = "log";
