...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/optimization_engine/v0.6.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "icasadi_test" = rec {
        crateName = "icasadi_test";
        version = "0.0.2";
        edition = "2018";
        sha256 = "0dlcw62hrjwqcpm2yknbxkfrqpydk5vs6yskz0y3pmidr5rvbn85";
        authors = [
          "Pantelis Sopasakis"
        ];
        dependencies = [
      ...
      "optimization_engine" = rec {
        ...
        devDependencies = [
          {
            name = "icasadi_test";
            packageId = "icasadi_test";
          }
          {
            name = "unit_test_utils";
            packageId = "unit_test_utils";
          }
        ];
      ...
      "unit_test_utils" = rec {
        crateName = "unit_test_utils";
        version = "0.1.3";
        edition = "2015";
        sha256 = "00bcgj061n8bdf23g8mhwd2q265dgsh6z8lpb01sykfhmgr7dvhb";
        authors = [
          "Pantelis Sopasakis"
        ];
        dependencies = [
