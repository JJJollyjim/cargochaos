...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nucleo-f401re/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hd44780-driver" = rec {
        crateName = "hd44780-driver";
        version = "0.3.0";
        edition = "2015";
        sha256 = "0sf8k81zavrrf5c5p191y6mfhgcika89w1x50pgw2qrgs7d2m5s9";
        authors = [
      ...
      "segment-display" = rec {
        crateName = "segment-display";
        version = "0.1.0";
        edition = "2018";
        sha256 = "10wki49vjs8mwv12n09jk3c2l2kf3nh3sqjr60sw9mqrgwd1fv89";
        authors = [
          "Johan Kristell <johan@jott.se>"
          "Daniel Moberg <daniel.moberg@gmail.com>"
        ];
        dependencies = [
          {
            name = "embedded-hal";
      ...
      "stm32f4" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f401" ];
      };
      "stm32f4xx-hal" = rec {
        crateName = "stm32f4xx-hal";
        version = "0.7.0";
        edition = "2018";
        sha256 = "1k3762l62pmb2r2qsm4ijxxv180l5sfa67jr302hvyxbnjlwrasl";
        authors = [
        ...
        resolvedDefaultFeatures = [ "device-selected" "rt" "stm32f401" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
      ...
      "tpa2016d2" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "08dqhbkwl1v8yd6ynmxxkz7jaq650h34f1dc8ln2l6x4lw4bpwj1";
        authors = [
          "Johan Kristell <johan@jott.se>"
        ];
        dependencies = [
