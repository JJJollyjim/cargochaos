...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mcl/v0.2.3-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mcl" = rec {
        ...
        version = "0.2.3-alpha";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.3-alpha.nix {};
        authors = [
      ...
      "mcl_derive" = rec {
        ...
        version = "0.2.3-alpha";
        edition = "2018";
        sha256 = "1glb9dnzhlxlcdax86kz3r87h7sdxqghi0wc0dlw8vmkaj58sn9m";
        procMacro = true;
        authors = [
          "Adam Budziak <adambudziak@protonmail.com>"
        ];
