...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mcl/v0.5.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mcl" = rec {
        ...
        version = "0.5.0-alpha";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.nix {};
        authors = [
      ...
      "mcl_derive" = rec {
        ...
        version = "0.5.0-alpha";
        edition = "2018";
        sha256 = "0s2wi0yyk1bb2nhy4yw9qh5rji16g7m6iyiyykfjxvhprwjkk0wr";
        procMacro = true;
        authors = [
          "Adam Budziak <adambudziak@protonmail.com>"
        ];
