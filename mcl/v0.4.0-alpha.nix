...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mcl/v0.4.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mcl" = rec {
        ...
        authors = [
          "Adam Budziak <adambudziak@protonmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_lib" ];
      };
      "mcl_derive" = rec {
        crateName = "mcl_derive";
        version = "0.4.0-alpha";
        edition = "2018";
        sha256 = "1rkvn8pwajfiln270vrl72n3ywj5l5k1lcmragwkv70z0za3gb1r";
        procMacro = true;
        authors = [
          "Adam Budziak <adambudziak@protonmail.com>"
        ];
