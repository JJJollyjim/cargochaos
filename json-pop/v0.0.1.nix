...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/json-pop/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "beef" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "05jidgqjbvqabww70hfl4q1849n0jsb0mjrks755z03vygnjzwa0";
        authors = [
      ...
      "json-pop" = rec {
        ...
        resolvedDefaultFeatures = [ "codespan-reporting" "default" "pretty_errors" ];
      };
      "lalrpop" = rec {
        crateName = "lalrpop";
        version = "0.18.1";
      ...
      "logos" = rec {
        ...
        version = "0.10.0-rc5";
        edition = "2018";
        sha256 = "1a4igxlhjr12imgi7za4qxw5idxzmrh271yl070jkrphw5r4w5b7";
        authors = [
          "Maciej Hirsz <hello@maciej.codes>"
        ];
        dependencies = [
      ...
      "logos-derive" = rec {
        ...
        version = "0.10.0-rc5";
        edition = "2018";
        sha256 = "13b2g5x8k3x9b7gc6dxaxix2n7s2vmpyfv93v170cfsjb98xss6z";
        procMacro = true;
