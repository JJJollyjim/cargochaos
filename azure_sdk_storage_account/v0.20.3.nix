...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_account/v0.20.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_storage_account" = rec {
        ...
        version = "0.20.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.20.3.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
        ];
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.20.3";
        edition = "2018";
        sha256 = "1zmg34rzr012cx27iyh22km0kjwdnnsg05svhnkfdyhbv7qg2ygn";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
