...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_account/v0.20.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.20.1";
        edition = "2018";
        sha256 = "11b5p639lw194w7gl8mgxccqsqav1wcq0d03d9rwwivdl8ws8lj2";
        authors = [
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.20.1";
        edition = "2018";
        sha256 = "1ficsf5h3pr9z1xfgdjhnp5y06lbxx9qlq6b74yc27wp22fkz2z5";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
