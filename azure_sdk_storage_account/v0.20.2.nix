...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_account/v0.20.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.20.2";
        edition = "2018";
        sha256 = "0xsfp0avfa3vfjbky7i83rx8pc99ivz6rbprnviv01faa1nmbvip";
        authors = [
      ...
      "azure_sdk_storage_account" = rec {
        ...
        version = "0.20.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.20.2.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
        ];
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.20.2";
        edition = "2018";
        sha256 = "1l8blfdcssja6hdm7dy3b78lna3i2hbr4ln407qr9ip8mabsgi4a";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
