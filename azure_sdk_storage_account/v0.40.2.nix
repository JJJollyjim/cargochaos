...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_account/v0.40.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_storage_account" = rec {
        ...
        version = "0.40.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.40.2.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
        ];
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "0zrcph70gapbsi4qvsfsdxbkypgb02y7zj5fsm2rapjnxpjmjxyb";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
