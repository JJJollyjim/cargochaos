...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/megafb/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gfx-backend-dx12" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "1hr76igx5zxr811ba6alcfg7fk6raghv36mzn5y23qwf3fr73mys";
      ...
      "megafb" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dx12" "gfx-backend-dx12" "gfx-backend-metal" "gfx-backend-vulkan" "metal" "vulkan" ];
      };
      "memmap" = rec {
        crateName = "memmap";
        version = "0.7.0";
      ...
      "shaderc" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "0mqggx56yg63f72xs4w0mj8rl3cggr68djblbi6d77kn9v04jl7w";
        authors = [
      ...
      "shaderc-sys" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "1i7xpg6jm1wqq80ax50rpp49ahq5b5igcwdcnwdpl268r5x651g7";
      ...
      "smithay-client-toolkit 0.6.3" = rec {
        crateName = "smithay-client-toolkit";
        version = "0.6.3";
        edition = "2015";
        sha256 = "13g7352mr8p3144q4mq2gszb7ii26layyylcamksvhdaplz0j8wc";
        authors = [
          "Victor Berger <victor.berger@m4x.org>"
        ];
        dependencies = [
          ...
          {
            name = "wayland-client";
            packageId = "wayland-client 0.23.5";
            features = [ "cursor" ];
          }
          {
            name = "wayland-protocols";
            packageId = "wayland-protocols 0.23.5";
      ...
      "wayland-client 0.23.5" = rec {
        ...
        dependencies = [
          ...
          {
            name = "wayland-commons";
            packageId = "wayland-commons 0.23.5";
          }
          {
            name = "wayland-sys";
            packageId = "wayland-sys 0.23.5";
          }
        ];
        buildDependencies = [
          {
            name = "wayland-scanner";
            packageId = "wayland-scanner 0.23.5";
          }
        ];
        features = {
          "cursor" = [ "wayland-sys/cursor" "native_lib" ];
      ...
      "winit 0.20.0-alpha2" = rec {
        crateName = "winit";
        version = "0.20.0-alpha2";
        edition = "2018";
        sha256 = "1r5ll3djsvqzdpfwk57bl92j68j5brh87wk2fx0kb8q2n8y5kpqn";
        authors = [
          "The winit contributors"
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "smithay-client-toolkit";
            packageId = "smithay-client-toolkit 0.6.3";
            target = { target, features }: ((target."os" == "linux") || (target."os" == "dragonfly") || (target."os" == "freebsd") || (target."os" == "openbsd") || (target."os" == "netbsd"));
          }
          {
            name = "wayland-client";
