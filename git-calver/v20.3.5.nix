...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-calver/v20.3.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-calver" = rec {
        crateName = "git-calver";
        version = "20.3.5";
        edition = "2018";
        crateBin = [
          { name = "git-calver"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v20.3.5.nix {};
        authors = [
