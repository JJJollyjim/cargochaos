...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ttspico/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ttspico" = rec {
        ...
        authors = [
          "Paolo Jovon <paolo.jovon@gmail.com>"
          "Sergio Tortosa Benedito"
        ];
        dependencies = [
          {
            name = "ttspico-sys";
            packageId = "ttspico-sys";
          }
        ];
        devDependencies = [
          {
      ...
      "ttspico-sys" = rec {
        crateName = "ttspico-sys";
        version = "0.1.4";
        edition = "2018";
        sha256 = "0q6zyqr815w77ikmi0qaaw16hi5rhhcn9vivah51q2vb94s6zcz1";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "combaseapi" "coml2api" "debug" "devpkey" "errhandlingapi" "handleapi" "impl-debug" "ksmedia" "libloaderapi" "mmdeviceapi" "objbase" "std" "synchapi" "winbase" "winerror" "winuser" ];
      };
