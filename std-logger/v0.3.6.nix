...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/std-logger/v0.3.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "std-logger" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "log-panic" "log-panics" "timestamp" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.14";
