...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glium/v0.26.0-alpha3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glium" = rec {
        ...
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.26.0-alpha3.nix {};
        build = "build/main.rs";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "default" "glutin" "test_headless" "unstable" ];
      };
      "glutin" = rec {
        crateName = "glutin";
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "commctrl" "consoleapi" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "libloaderapi" "memoryapi" "minwindef" "ntsecapi" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "profileapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "sysinfoapi" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
