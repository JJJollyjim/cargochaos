...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glium/v0.26.0-alpha6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glium" = rec {
        ...
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.26.0-alpha6.nix {};
        build = "build/main.rs";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
        ];
      ...
      "glutin" = rec {
        ...
        edition = "2018";
        sha256 = "0cmmnmzf6sycgdfia6mc2hcb8h73dvzvb34s9m72mrp6l02369kq";
        authors = [
