...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr_repl/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winuser" ];
      };
