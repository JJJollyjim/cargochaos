...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr_repl/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evcxr_repl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "evcxr"; path = "src/bin/evcxr.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winuser" ];
      };
