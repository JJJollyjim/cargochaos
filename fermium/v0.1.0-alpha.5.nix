...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fermium/v0.1.0-alpha.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fermium" = rec {
        ...
        resolvedDefaultFeatures = [ "bind_SDL2_2_0_10" "bind_SDL2_2_0_9" "cmake" "default" "link_dynamic" "link_static" "use_bindgen_bin" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.62";
