...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/phetch/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "phetch" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "phetch"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "chris west <c@xvxx.io>"
        ];
        dependencies = [
          {
            name = "atty";
        ...
        resolvedDefaultFeatures = [ "default" "native-tls" "tls" "tor" "tor-stream" ];
      };
      "pkg-config" = rec {
      ...
      "tor-stream" = rec {
        crateName = "tor-stream";
        version = "0.2.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0ij7cwwrq4n9siibk9lak3gp2mzxl167kwwrqbwc02qfr6gi0raq";
        authors = [
          "Draphar <draphar-code@protonmail.com>"
        ];
        dependencies = [
          {
            name = "lazy_static";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "processenv" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
