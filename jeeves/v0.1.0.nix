...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jeeves/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "peg" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "1m7c4mnsfammv030gjgzdp6vh3pva5kj9gl3hkvpdyphscvlsmn2";
        authors = [
      ...
      "peg-macros" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0vp7w8r9p9cxxa0vcwikmwcb3sbz2zr6rlv97xml1mh7nm9li07j";
        procMacro = true;
        libName = "peg_macros";
        libPath = "lib.rs";
        authors = [
      ...
      "peg-runtime" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "1isjp09n5kzpxqy9vspanxp6pklfpc5fv24b306hn8p1wmi6fh8k";
        libPath = "lib.rs";
        authors = [
          "Kevin Mehall <km@kevinmehall.net>"
        ];
