...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scrappy-http/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "scrappy-codec" = rec {
        crateName = "scrappy-codec";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1zramwbdlq188cag8zhd034hk94day4ibk25wkim4dkcnpx9ky2v";
        libName = "scrappy_codec";
        authors = [
      ...
      "scrappy-connect" = rec {
        crateName = "scrappy-connect";
        version = "0.0.1";
        edition = "2018";
        sha256 = "078hl45s3cykdwx4bh6dwbqyp4xnrlnkkzanr4dlabm7llg9m4yi";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
          ...
          {
            name = "scrappy-codec";
            packageId = "scrappy-codec";
          }
          {
            name = "scrappy-rt";
            packageId = "scrappy-rt";
          }
          {
            name = "scrappy-service";
            packageId = "scrappy-service";
          }
          {
            name = "scrappy-utils";
            packageId = "scrappy-utils";
          }
          {
            name = "tokio-openssl";
      ...
      "scrappy-http" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "scrappy-threadpool";
          }
          {
            name = "scrappy-tls";
            packageId = "scrappy-tls";
            optional = true;
          }
          {
            name = "scrappy-utils";
        ...
        resolvedDefaultFeatures = [ "brotli2" "compress" "default" "fail-ure" "failure" "flate2" "openssl" "ring" "rustls" "scrappy-tls" "secure-cookies" ];
      };
      "scrappy-macros" = rec {
        crateName = "scrappy-macros";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1f2hpqgs915viqj8wwrfapp39xyjyjqak9n26rkig0f1rf48710v";
        procMacro = true;
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
      ...
      "scrappy-rt" = rec {
        crateName = "scrappy-rt";
        version = "0.0.1";
        edition = "2018";
        sha256 = "09rbvjw54d00qzwp5lybnb6dbia5j0q04csflr98gk7ki49p6r9m";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
      ...
      "scrappy-server" = rec {
        crateName = "scrappy-server";
        version = "0.0.1";
        edition = "2018";
        sha256 = "04yasn7p3iah8y2zrpxdyxnf2r325h8rb6iz9w8m3ma3iysi3mm0";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
      ...
      "scrappy-service" = rec {
        crateName = "scrappy-service";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1hl3n8rfqa5sg8ir11s8ji7kjnacid6r5m89lj6m8dvh00kg03d0";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
      ...
      "scrappy-threadpool" = rec {
        crateName = "scrappy-threadpool";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1byr4babwq0hxdm43sk7p4a9vknrdfd783df9ciyk9ginv6vlh6x";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
      ...
      "scrappy-tls" = rec {
        crateName = "scrappy-tls";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1mz8ascdwla36bacc7pmwjvg3zdn8lb37zi6by2zrwni9cn4nfs1";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
      ...
      "scrappy-utils" = rec {
        crateName = "scrappy-utils";
        version = "0.0.1";
        edition = "2018";
        sha256 = "0jpa2xylm3ffb61f391pmw4n4mlnxpidd8ahp8i1shw9snbv45h7";
        authors = [
          "Bevan Hunt <bevan@bevanhunt.com>"
        ];
        dependencies = [
