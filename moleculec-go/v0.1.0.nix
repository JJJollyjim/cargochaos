...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/moleculec-go/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "moleculec-go" = rec {
        crateName = "moleculec-go";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "moleculec-go"; path = "src/bin/moleculec-go.rs"; }
        ];
