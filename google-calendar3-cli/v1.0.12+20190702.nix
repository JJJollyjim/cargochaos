...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-calendar3-cli/v1.0.12+20190702.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-calendar3-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-calendar3" = rec {
        crateName = "google-calendar3";
        version = "1.0.12+20190702";
        edition = "2015";
        sha256 = "065nsqhj8n61zj387d16dbr1mmvr9frrk8pzy7bkpjb7dm7b7fzi";
        authors = [
      ...
      "google-calendar3-cli" = rec {
        crateName = "google-calendar3-cli";
        version = "1.0.12+20190702";
        edition = "2015";
        crateBin = [
          { name = "calendar3"; path = "src/main.rs"; }
        ];
