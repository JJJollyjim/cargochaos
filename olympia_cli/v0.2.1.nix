...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/olympia_cli/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "olympia_cli" = rec {
        crateName = "olympia_cli";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "olympia_cli"; path = "src/main.rs"; }
        ];
      ...
      "olympia_core" = rec {
        crateName = "olympia_core";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1w116jf7i9ypv0js4d6kn82rsila1rgzlx38di2k8hqha470mkil";
        authors = [
          "Tony Finn <git@tonyfinn.com>"
        ];
      ...
      "olympia_engine" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "06774zrxjiw924xjql4sd1cfdx6iwc74f9hya3skxbay3y0ba0r4";
        authors = [
          "Tony Finn <olympia@tonyfinn.com>"
        ];
        dependencies = [
