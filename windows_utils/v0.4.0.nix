...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/windows_utils/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "datetimeapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "processthreadsapi" "psapi" "shellapi" "timezoneapi" "winbase" "winerror" "winnls" "winnt" "winreg" "winuser" ];
      };
      ...
      "windows_utils" = rec {
        crateName = "windows_utils";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "hardlock"; path = "src/hardlock.rs"; }
          { name = "emptyrecyclebin"; path = "src/emptyrecyclebin.rs"; }
          { name = "cmd_startup_script"; path = "src/cmd_startup_script.rs"; }
          { name = "display_insomnia"; path = "src/display_insomnia.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "aQaTL <mmsoltys@outlook.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "winuser" "shellapi" "winbase" "datetimeapi" "errhandlingapi" "winnls" "psapi" "processthreadsapi" ];
          }
          {
            name = "winreg";
            packageId = "winreg";
