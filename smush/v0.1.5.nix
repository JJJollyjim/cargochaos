...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/smush/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "smush" = rec {
        ...
        features = {
          "all" = [ "bincode_support" "brotli_support" "base58_support" "deflate_support" "gzip_support" "xz_support" "lz4_support" "zlib_support" "zstd_support" ];
          "base58_support" = [ "bs58" ];
        ...
        resolvedDefaultFeatures = [ "all" "base58_support" "bincode" "bincode_support" "brotli" "brotli_support" "bs58" "default" "deflate_support" "flate2" "gzip_support" "lz4" "lz4_support" "xz2" "xz_support" "zlib_support" "zstd" "zstd_support" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.11";
