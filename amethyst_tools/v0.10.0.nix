...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst_tools/v0.10.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst_tools" = rec {
        crateName = "amethyst_tools";
        version = "0.10.0";
        edition = "2018";
        crateBin = [
          { name = "amethyst"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.0.nix {};
        libName = "amethyst_cli";
        authors = [
