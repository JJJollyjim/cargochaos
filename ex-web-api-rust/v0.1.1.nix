...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ex-web-api-rust/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ex-web-api-rust" = rec {
        crateName = "ex-web-api-rust";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "ex-web-api-rust"; path = "src/main.rs"; }
        ];
