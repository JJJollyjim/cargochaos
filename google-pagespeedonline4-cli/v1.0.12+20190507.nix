...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-pagespeedonline4-cli/v1.0.12+20190507.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-pagespeedonline4-cli";
  ...
  workspaceMembers = {
    "google-pagespeedonline4-cli" = rec {
      packageId = "google-pagespeedonline4-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-pagespeedonline4-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-pagespeedonline4" = rec {
        crateName = "google-pagespeedonline4";
        version = "1.0.12+20190507";
        edition = "2015";
        sha256 = "1q3djp11v99kkr8yk99i59d31gjk292kjn9w4hs8q8xadxclhag9";
        authors = [
      ...
      "google-pagespeedonline4-cli" = rec {
        crateName = "google-pagespeedonline4-cli";
        version = "1.0.12+20190507";
        edition = "2015";
        crateBin = [
          { name = "pagespeedonline4"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190507.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-pagespeedonline4";
            packageId = "google-pagespeedonline4";
          }
          {
            name = "hyper";
            packageId = "hyper";
