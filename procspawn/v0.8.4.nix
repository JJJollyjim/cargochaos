...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/procspawn/v0.8.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace-sys" "dbghelp" "default" "dladdr" "libbacktrace" "libunwind" "serde" "std" ];
      };
      "backtrace-sys" = rec {
      ...
      "procspawn" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "async-executor" "backtrace" "ctor" "default" "findshlibs" "futures" "json" "safe-shared-libraries" "serde_json" "test-support" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.2";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "std" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
