...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-tpu1-cli/v1.0.13+20200318.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-tpu1" = rec {
        crateName = "google-tpu1";
        version = "1.0.13+20200318";
        edition = "2015";
        sha256 = "1g742iiaj5p6pf01majrglh7adyn3j0hdva08xg3yg2jljzxic17";
        authors = [
      ...
      "google-tpu1-cli" = rec {
        crateName = "google-tpu1-cli";
        version = "1.0.13+20200318";
        edition = "2015";
        crateBin = [
          { name = "tpu1"; path = "src/main.rs"; }
        ];
