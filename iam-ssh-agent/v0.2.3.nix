...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/iam-ssh-agent/v0.2.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iam-ssh-agent" = rec {
        crateName = "iam-ssh-agent";
        version = "0.2.3";
        edition = "2018";
        crateBin = [
          { name = "iam-ssh-agent"; path = "src/main.rs"; }
        ];
      ...
      "ssh-agent" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "01cjr0fi8p6r0njqk76m6dzdazifbk1k4lvnc78b9g8cw5z63j22";
        authors = [
