...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/appinsights/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "appinsights" = rec {
        crateName = "appinsights";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "dmolokanov <dmolokanov@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "mockito" = rec {
        ...
        version = "0.23.0";
        edition = "2018";
        sha256 = "11687yzfsggppbkfv0a7556yf1pvkiyrv8c34rdj2m928xgb7s00";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "json" "serde_json" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.2";
      ...
      "sm" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "0sapiv8s338plja6n00cm4cikl8hrypp6irjli2i0h8scprs7r6q";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
