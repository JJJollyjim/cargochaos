...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/appinsights/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "assert-json-diff" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "06pl9bsgfwqwv4w0ybp79qr26q62lbql6cvr67qk1vz6prg0v3bg";
        authors = [
      ...
      "mockito" = rec {
        ...
        version = "0.23.2";
        edition = "2018";
        sha256 = "18bginlhqqaa9aizpi38w1vxg82wlx3ygvaq0vpkq0s73pmy9cd5";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "default-tls" "hyper-tls" "json" "native-tls" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rustversion" = rec {
