...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/konj/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "konj" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "konj"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Akshay Gupta <kitallis@gmail.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "processenv" ];
      };
