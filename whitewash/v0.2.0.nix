...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/whitewash/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gexiv2-sys" = rec {
        crateName = "gexiv2-sys";
        version = "1.1.1";
        edition = "2018";
        sha256 = "0z39aqp8zj3kvkwspy821hw8kgksmigqkxigg6cil5v2k7kzgj7d";
        authors = [
      ...
      "rexiv2" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "019zb761shq5gzw9v20xr0v26lrqm8b254ag4h80ssn7m7jg6jk9";
        authors = [
          "Felix Crux <felixc@felixcrux.com>"
        ];
        dependencies = [
      ...
      "whitewash" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "whitewash"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "t1ra t1ra@protonmail.com"
        ];
        dependencies = [
          {
            name = "indicatif";
