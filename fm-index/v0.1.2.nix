...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fm-index/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fid" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1rm3y390gq6nih0m4w3w7awfxiqm79i321jhmf27fv8vb3n96n7r";
        authors = [
          "Koki Kato <koki.kato1994@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
