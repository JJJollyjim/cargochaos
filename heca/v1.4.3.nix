...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/heca/v1.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "heca" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "heca"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.4.3.nix {};
        authors = [
          "picked name <ipickedaname@mail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "profile" ];
      };
      "heca-lib" = rec {
        crateName = "heca-lib";
        version = "1.3.1";
        edition = "2018";
        sha256 = "1a29x9j56khcawdd470kvfmv6yvpzq47cbx2sj42nghkj07bj23b";
        authors = [
          "picked name <ipickedaname@mail.com>"
        ];
        dependencies = [
