...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssb-multiformats/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ssb-crypto" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "06lig9diyzfk74bxx6zh9bvsn12a1c2a2pwr3kla8pfccgs4cbwz";
        authors = [
