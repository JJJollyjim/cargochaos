...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/notes/v0.1.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "notes" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "notes"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.8.nix {};
        authors = [
          "Rémi Passmoilesel <r.passmoilesel@protonmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winuser" ];
      };
