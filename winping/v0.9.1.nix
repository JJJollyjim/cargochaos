...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/winping/v0.9.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi_forked_icmpapi" = rec {
        crateName = "winapi_forked_icmpapi";
        version = "0.3.7";
        edition = "2015";
        sha256 = "1qy1f7dhfzmyr1rd2pvc4vbxbdpapzm9mawdrjfayh33bn4wpbj2";
        authors = [
          "Peter Atashian <retep998@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "icmpapi" "impl-default" "iphlpapi" "synchapi" "winbase" "winerror" ];
      };
      "winping" = rec {
        crateName = "winping";
        version = "0.9.1";
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi_forked_icmpapi";
            rename = "winapi";
        ...
        resolvedDefaultFeatures = [ "default" "no_async" "real-tests" "real-tests-v4" "real-tests-v6" ];
      };
    };
