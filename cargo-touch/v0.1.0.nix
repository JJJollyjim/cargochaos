...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-touch/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-touch" = rec {
        crateName = "cargo-touch";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-touch"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "David McGillicuddy <david.mcgillicuddy@moixa.com>"
        ];
        dependencies = [
          {
            name = "cargo_toml";
