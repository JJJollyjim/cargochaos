...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hueclient/v0.3.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hueclient" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "hue_set_light_state"; path = "src/bin/hue_set_light_state.rs"; }
          { name = "hue_register_user"; path = "src/bin/hue_register_user.rs"; }
          { name = "hue_get_all_lights"; path = "src/bin/hue_get_all_lights.rs"; }
          { name = "hue_discover_bridge"; path = "src/bin/hue_discover_bridge.rs"; }
        ];
