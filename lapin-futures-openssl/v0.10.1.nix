...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lapin-futures-openssl/v0.10.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lapin-futures-openssl";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin-futures-openssl" = rec {
        crateName = "lapin-futures-openssl";
        version = "0.10.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.10.1.nix {};
        libName = "lapin_futures_openssl";
        authors = [
          "Marc-Antoine Perennou <%arc-Antoine@Perennou.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-tls" ];
      };
      "lapin-futures-tls-internal" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-openssl" ];
      };
      "lazy_static" = rec {
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-openssl" "dns-over-tls" "tokio" "trust-dns-openssl" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
