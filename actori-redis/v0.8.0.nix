...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actori-redis/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "actori" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1q82s8n4gkf1r6xl4vzv7qi3ly1rrlm5jgg4s92w4940lyg97s5f";
        authors = [
        ...
        resolvedDefaultFeatures = [ "actori-http" "default" "http" "resolver" "trust-dns-proto" "trust-dns-resolver" ];
      };
      "actori-codec" = rec {
        crateName = "actori-codec";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1mjlsai2xpj3pr9gwj3abw07g5nq93bi013ypi7w4mv7vxkrszkx";
        libName = "actori_codec";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-connect" = rec {
        crateName = "actori-connect";
        version = "1.0.2";
        edition = "2018";
        sha256 = "0vzqv9jivz9nzc5m0siqh40px5nyqwb882wxh7fayayz9p18979w";
        libName = "actori_connect";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "actori-service";
            packageId = "actori-service";
          }
          {
            name = "actori-utils";
            packageId = "actori-utils";
          }
          {
            name = "derive_more";
            packageId = "derive_more";
      ...
      "actori-http" = rec {
        crateName = "actori-http";
        version = "1.0.1";
        edition = "2018";
        sha256 = "10rfknf6ginpdsvlzy0lzy2yfk0bg2p2kym9xxrir3vsqgs988m9";
        libName = "actori_http";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
      ...
      "actori-macros" = rec {
        crateName = "actori-macros";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1rnlafkjysaqf5l6fxzjmsi6km18kha63j8p71mkj25aykv2bra3";
        procMacro = true;
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
      ...
      "actori-redis" = rec {
        crateName = "actori-redis";
        version = "0.8.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.8.0.nix {};
        libName = "actori_redis";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "actori-service" "actori-session" "actori-web" "default" "rand" "serde" "serde_json" "web" ];
      };
      "actori-router" = rec {
        crateName = "actori-router";
        version = "0.2.4";
        edition = "2018";
        sha256 = "0kgiz3rxfivxayjplqh2vcibz49x1fnzhgpqp4kyplwdhq58cgj2";
        libName = "actori_router";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-rt" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0rnla2lw1a1zv0vsyxzami9xw9xzzzvl48qh5xlin6hbja0n70li";
        libName = "actori_rt";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
      ...
      "actori-server" = rec {
        crateName = "actori-server";
        version = "1.0.1";
        edition = "2018";
        sha256 = "0sp1yr1j3nw41kh7pv9kk15v69xk7qq05jk36r6blmvnfjljm8k4";
        libName = "actori_server";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-service" = rec {
        crateName = "actori-service";
        version = "1.0.5";
        edition = "2018";
        sha256 = "1vyipk96s81pbdmigmfyiwngrkm46mfyibbbmsyxs5iyd2vd8mr7";
        libName = "actori_service";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-session" = rec {
        crateName = "actori-session";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1ysfz1ibj9yanwb9ipp3yqc59jzdj7rqh152b89w2a97wna0dp98";
        libName = "actori_session";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-testing" = rec {
        crateName = "actori-testing";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1xrl7my2irni1vgmp81j3qnfmhv8bq8kyfp67sigajyy8p4vn55i";
        libName = "actori_testing";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-threadpool" = rec {
        crateName = "actori-threadpool";
        version = "0.3.1";
        edition = "2018";
        sha256 = "16a7dw51ix9kiwn1q5i0fnnnjyp2mbq94vidsx7hmn8dzs2svvav";
        libName = "actori_threadpool";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-tls" = rec {
        crateName = "actori-tls";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0409f7p5j52q2yjnbxdz12vb5wnnrrvs3pmmnidnlsiivh1haxnm";
        libName = "actori_tls";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
      ...
      "actori-utils" = rec {
        crateName = "actori-utils";
        version = "1.0.6";
        edition = "2018";
        sha256 = "14qjqgncaijnpvgjmxglxxs0y97qyxph0z1ak9ygbxsw2fz85xdr";
        libName = "actori_utils";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actori-web" = rec {
        crateName = "actori-web";
        version = "2.0.0";
        edition = "2018";
        sha256 = "0bac2vq0by3p047g81cv30ikzkk01b48apbx0d3bk8w6r5zn882w";
        libName = "actori_web";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ...
        dependencies = [
          ...
          {
            name = "actori-web-codegen";
            packageId = "actori-web-codegen";
          }
          {
            name = "actoriwc";
            packageId = "actoriwc";
      ...
      "actori-web-codegen" = rec {
        crateName = "actori-web-codegen";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0xhmrsj4nxzvk9km3c2qz59ym1n4zklfdi451n9m5zb78i853rjw";
        procMacro = true;
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
      ...
      "actori_derive" = rec {
        crateName = "actori_derive";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0dn0c36wlv7c6gp1p19bjnhhb0sffdjw85l8myimp62xcr3am1gv";
        procMacro = true;
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
      ...
      "actoriwc" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "1rq8fbpsah5j9qrkgfay9x3z7sz6gfda0hwypzdzjffps3h0zfhj";
        authors = [
          "Christian Haynes <06chaynes@gmail.com>"
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "pin-project-lite" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0j1j4k1asqs4pbjbqi2zpm0npi1wljyl990xw2m96ps4f12harkj";
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "rt-core" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-util" = rec {
