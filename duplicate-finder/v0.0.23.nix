...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/duplicate-finder/v0.0.23.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "duplicate-finder" = rec {
        crateName = "duplicate-finder";
        version = "0.0.23";
        edition = "2018";
        crateBin = [
          { name = "duplicate-finder"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.23.nix {};
        authors = [
          "Ilia Mazurenko <ivmazurenko@yandex.ru>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "processenv" "winbase" "wincon" ];
      };
