...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/in-dir-exec/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "in-dir-exec" = rec {
        crateName = "in-dir-exec";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "in-dir-exec"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "jjlorenzo <jjlorenzo@gmail.com>"
        ];
        dependencies = [
          {
            name = "colored";
