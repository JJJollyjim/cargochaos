...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/inheritance/v0.0.1-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "fstrings" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "03vvc84w98s1b9v803xcybxd5rdh6jn4l2hjqigza9gllwvhg9f1";
        authors = [
      ...
      "fstrings-proc-macro" = rec {
        crateName = "fstrings-proc-macro";
        version = "0.1.4";
        edition = "2018";
        sha256 = "17nkvqah5709l8fqzf4q5wdvykl62s7fpmwak0l1bxa66rwcldgx";
        procMacro = true;
        libPath = "mod.rs";
        authors = [
          "Daniel Henry-Mantilla <daniel.henry.mantilla@gmail.com>"
      ...
      "inheritance" = rec {
        crateName = "inheritance";
        version = "0.0.1-alpha.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.1-alpha.2.nix {};
        authors = [
          "Daniel Henry-Mantilla <daniel.henry.mantilla@gmail.com>"
        ];
        dependencies = [
          {
            name = "inheritance-proc-macro";
            packageId = "inheritance-proc-macro";
            rename = "proc_macro";
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "default" "external_doc" "specialization" "verbose-expansions" ];
      };
      "inheritance-proc-macro" = rec {
        crateName = "inheritance-proc-macro";
        version = "0.0.1-alpha.2";
        edition = "2018";
        sha256 = "13xvz03fcc8d9gwn4zwh2jxff4s9j12cb8h17sivwncmp4sss7m2";
        procMacro = true;
        libPath = "mod.rs";
        authors = [
          "Daniel Henry-Mantilla <daniel.henry.mantilla@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "default" "specialization" "verbose-expansions" ];
      };
