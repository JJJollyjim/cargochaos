...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unic-locale/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-locale" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "likelysubtags" "macros" "unic-locale-macros" ];
      };
      "unic-locale-impl" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "likelysubtags" ];
      };
