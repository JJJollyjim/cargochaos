...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glk/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glk-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "05k05pz6zghj15mzaqgzpdg8qx4jqczm4qnjghc6kg2a0sz3rizm";
        authors = [
          "mara <vmedea@protonmail.com>"
          "Andrew Plotkin"
        ];
      ...
      "glulxe" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1l83assqi9gfknzh1fgc5hlmjcfh7shnginfhl5qsv8jrcll6zyi";
        authors = [
          "mara <vmedea@protonmail.com>"
        ];
        dependencies = [
      ...
      "glulxe-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0hf508hyrdmshbb9i9a9a2v5lk7qqy3489sg7sxgg2pz4z7akczc";
        authors = [
          "mara <vmedea@protonmail.com>"
          "Andrew Plotkin"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
