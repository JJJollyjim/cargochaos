...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/acpitool/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "acpi_client" = rec {
        crateName = "acpi_client";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1r36krzh0hb5diay256iikxppbrrq8jfrxpzvnz1jxhqdvz0i8sn";
        authors = [
          "ssnover95 <ssnover95@gmail.com>"
        ];
      ...
      "acpitool" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "acpitool"; path = "src/main.rs"; }
        ];
