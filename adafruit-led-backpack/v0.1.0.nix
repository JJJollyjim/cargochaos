...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/adafruit-led-backpack/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "adafruit-led-backpack";
  ...
  internal = rec {
    ...
    crates = {
      "adafruit-led-backpack" = rec {
        crateName = "adafruit-led-backpack";
        version = "0.1.0";
        edition = "2018";
      ...
      "ht16k33" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "19xabqcamwvv71zrkw1wg3z1x852qjmzxx8lswswi3v30q8g4724";
        authors = [
          "Jason Peacock <jason@jasonpeacock.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
