...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ddns-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-compression" = rec {
        ...
        edition = "2018";
        sha256 = "1bwq5dkfwvwpvalspc7y8z6knz65sw2x6azm0mwlyqccpqfqh6hi";
        authors = [
      ...
      "ddns-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ddns-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "owent <admin@owent.net>"
        ];
        dependencies = [
          {
            name = "bytes";
        ...
        resolvedDefaultFeatures = [ "default" "default-logger" "slog-envlogger" "slog-stdlog" "system-alloc" ];
      };
      "dirs" = rec {
        crateName = "dirs";
        version = "2.0.2";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "async-compression" "default" "default-tls" "gzip" "hyper-tls" "json" "native-tls" "serde_json" "tls" "tokio-tls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
