...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nanoid/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "postmerge-hook" "precommit-hook" "prepush-hook" "run-cargo-check" "run-cargo-clippy" "run-cargo-fmt" "run-cargo-test" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
        ...
        devDependencies = [
          {
            ...
            features = [ "prepush-hook" "precommit-hook" "postmerge-hook" "run-cargo-test" "run-cargo-check" "run-cargo-clippy" "run-cargo-fmt" ];
          }
        ];
