...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rlifesrc/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ca-rules" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0ixdb26apn559yv044j97948qz36jc2i90rdj68zb2pdpv9q58mj";
        authors = [
      ...
      "rlifesrc" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rlifesrc"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "async-std" "crossterm" "default" "futures" "tui" ];
      };
      "rlifesrc-lib" = rec {
        crateName = "rlifesrc-lib";
        version = "0.3.2";
        edition = "2018";
        sha256 = "08fndnraxzdmi2l12iwkaw4qqkxqfaridi3xh51rw9pjgn8p3a99";
        authors = [
          "AlephAlpha <alephalpha911@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-default" "minwinbase" "minwindef" "ntstatus" "processenv" "processthreadsapi" "synchapi" "winbase" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
