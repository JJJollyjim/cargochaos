...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-analyticsreporting4-cli/v1.0.12+20190625.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-analyticsreporting4-cli";
  ...
  workspaceMembers = {
    "google-analyticsreporting4-cli" = rec {
      packageId = "google-analyticsreporting4-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-analyticsreporting4-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-analyticsreporting4" = rec {
        crateName = "google-analyticsreporting4";
        version = "1.0.12+20190625";
        edition = "2015";
        sha256 = "08ffgd58q2xwvjyxdb1dwcyam3gqrnf8igl5wpvh6qvm0ldvik1s";
        authors = [
      ...
      "google-analyticsreporting4-cli" = rec {
        crateName = "google-analyticsreporting4-cli";
        version = "1.0.12+20190625";
        edition = "2015";
        crateBin = [
          { name = "analyticsreporting4"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-analyticsreporting4";
          }
          {
            name = "hyper";
            packageId = "hyper";
