...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dns1-cli/v1.0.13+20191205.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dns1" = rec {
        crateName = "google-dns1";
        version = "1.0.13+20191205";
        edition = "2015";
        sha256 = "1vjx7mxkqw8mdvxlq0ysck8w2d7xdlhimmapk5v8qjshm8fk69sk";
        authors = [
      ...
      "google-dns1-cli" = rec {
        crateName = "google-dns1-cli";
        version = "1.0.13+20191205";
        edition = "2015";
        crateBin = [
          { name = "dns1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20191205.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
