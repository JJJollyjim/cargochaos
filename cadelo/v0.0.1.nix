...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cadelo/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cadelo" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cadelo"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Zer1t0 <Zer1t0@hotmail.com>"
        ];
        dependencies = [
          {
            name = "ascii";
      ...
      "kerbeiros" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "1z0j6i3dw5vm8jdg4giq2bxiimgnyxhnh88c188ijqkg0zjxw3c1";
        authors = [
          "Zer1t0 <Zer1t0@hotmail.com>"
        ];
        dependencies = [
      ...
      "red_asn1" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0q2v4knhk36l8sdlp8cpn52rdj6rha1sxi3gb63f1b1gldxab72b";
        authors = [
          "Zer1t0 <Zer1t0@hotmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "red_asn1_derive";
            packageId = "red_asn1_derive";
          }
        ];
        
      };
      "red_asn1_derive" = rec {
        crateName = "red_asn1_derive";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0g741cqzfrc7cayxzwfjpczla1rmsafzzljg8mfk26shhfl3b9v5";
        procMacro = true;
        authors = [
          "Zer1t0 <Zer1t0@hotmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "windef" "winnt" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
