...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty_ulid/v0.9.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusty_ulid" = rec {
        crateName = "rusty_ulid";
        version = "0.9.3";
        edition = "2018";
        crateBin = [
          { name = "rusty_ulid"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.9.3.nix {};
        authors = [
          "Joern Huxhorn <jhuxhorn@googlemail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "doc-comment" "rand" "serde" "ulid-generation" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.2";
