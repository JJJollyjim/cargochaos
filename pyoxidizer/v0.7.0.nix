...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pyoxidizer/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mailparse" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "1llw8rw74lv4q2yn6fdbllfqf86axx1z3h5h27q23ygyd1x510bi";
        authors = [
          "Kartikaya Gupta"
        ];
        dependencies = [
      ...
      "pyoxidizer" = rec {
        crateName = "pyoxidizer";
        version = "0.7.0";
        edition = "2018";
        crateBin = [
          { name = "pyoxidizer"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.7.0.nix {};
        libName = "pyoxidizerlib";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "python-packed-resources";
          }
          {
            name = "regex";
            packageId = "regex";
      ...
      "python-packed-resources" = rec {
        crateName = "python-packed-resources";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1jl6xpayihbbyizh48ndb5rlmikwi400ac00ar1677bwf8fkbzrg";
        authors = [
          "Gregory Szorc <gregory.szorc@gmail.com>"
        ];
        dependencies = [
      ...
      "uuid 0.8.1" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rand" "sha1" "std" "v4" "v5" ];
      };
      "vcpkg" = rec {
        crateName = "vcpkg";
        version = "0.2.8";
