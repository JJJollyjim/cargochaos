...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/image-interlacer/v0.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image-interlacer" = rec {
        crateName = "image-interlacer";
        version = "0.1.6";
        edition = "2018";
        crateBin = [
          { name = "image-interlacer"; path = "src/main.rs"; }
        ];
      ...
      "path-absolutize" = rec {
        ...
        version = "1.1.7";
        edition = "2018";
        sha256 = "0zw706x5c11zizsd9vdmrqam776jvaqyk5825f9yr49pgck1cp96";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "path-dedot" = rec {
        ...
        version = "1.1.13";
        edition = "2018";
        sha256 = "1y1hg1ajlg0kk8943i3hviwzrs136y1v0h9sq7ms8315934apqwy";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
