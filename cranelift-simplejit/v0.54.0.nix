...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cranelift-simplejit/v0.54.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cranelift-native" = rec {
        ...
        version = "0.54.0";
        edition = "2018";
        sha256 = "0d3vc931jypcdsvqz4lr7qcs76kzdrrkk0ln11rl6klqprf7akk2";
        authors = [
          "The Cranelift Project Developers"
        ];
        dependencies = [
      ...
      "cranelift-simplejit" = rec {
        ...
        version = "0.54.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.54.0.nix {};
        authors = [
          "The Cranelift Project Developers"
        ];
        dependencies = [
