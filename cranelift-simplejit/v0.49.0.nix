...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cranelift-simplejit/v0.49.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cranelift-native" = rec {
        ...
        version = "0.49.0";
        edition = "2018";
        sha256 = "1wdhgp7y7by4b7fpjqwradrg37bsjlgmc1gg5ng3mdskaij38pms";
        authors = [
          "The Cranelift Project Developers"
        ];
        dependencies = [
      ...
      "cranelift-simplejit" = rec {
        ...
        version = "0.49.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.49.0.nix {};
        authors = [
          "The Cranelift Project Developers"
        ];
        dependencies = [
