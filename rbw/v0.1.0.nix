...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rbw/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chbs" = rec {
        ...
        version = "0.0.10";
        edition = "2018";
        sha256 = "1aw2k95xsi0gb888k0r3yf3dwgjlz5qmbg4ibyv8bq81552pk1cv";
        authors = [
      ...
      "rbw" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rbw"; path = "src/bin/rbw/main.rs"; }
          { name = "rbw-agent"; path = "src/bin/rbw-agent/main.rs"; }
        ];
