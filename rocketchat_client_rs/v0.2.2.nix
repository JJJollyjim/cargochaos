...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocketchat_client_rs/v0.2.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rocketchat_client_rs";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocketchat_client_rs" = rec {
        crateName = "rocketchat_client_rs";
        version = "0.2.2";
        edition = "2018";
        crateBin = [
          { name = "rocketchat-client"; path = "src/bin.rs"; }
        ];
