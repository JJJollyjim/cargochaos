...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-mybusiness4-cli/v1.0.13+0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-mybusiness4-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-mybusiness4" = rec {
        crateName = "google-mybusiness4";
        version = "1.0.13+0";
        edition = "2015";
        sha256 = "0kms24vbssdb9zpl6yz8mgsrv0nl3ppsrq7mj53dfk6d1kmjyj3a";
        authors = [
      ...
      "google-mybusiness4-cli" = rec {
        crateName = "google-mybusiness4-cli";
        version = "1.0.13+0";
        edition = "2015";
        crateBin = [
          { name = "mybusiness4"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+0.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
