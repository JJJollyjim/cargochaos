...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/farctool/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "farctool" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "farctool"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "marius851000 <mariusdavid@laposte.net>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "io_partition" = rec {
        crateName = "io_partition";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0sm5cc5a8fjvf8f48q1ja2rln8ffjvn8pz9zb2xhm7a93gycj3jn";
        authors = [
          "marius851000 <mariusdavid@laposte.net>"
        ];
      ...
      "pmd_farc" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0rxwirid89nz61vnivhvs4hqxrldszbnhdw2gg87cr38p8rfvswb";
        authors = [
          "marius851000 <mariusdavid@laposte.net>"
        ];
        dependencies = [
      ...
      "pmd_sir0" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "18iwnfmfb99ihy8v3bj9d4q8crc7as8xaakqh8p2lhxrja8vwpa2";
        authors = [
          "marius851000 <mariusdavid@laposte.net>"
        ];
        dependencies = [
