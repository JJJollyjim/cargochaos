...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zim/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stopwatch" = rec {
        ...
        version = "0.0.7";
        edition = "2015";
        sha256 = "0a7p7gcznjpmqd6wpdfbgk6dirw34yydh6b38lx4v94dqzmva11x";
        authors = [
          "Chucky Ellison <cme@freefour.com>"
        ];
        dependencies = [
          {
            name = "num";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winnt" "winuser" ];
      };
      ...
      "zim" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "extract_zim"; path = "src/bin/extract_zim.rs"; }
          { name = "ipfs_link"; path = "src/bin/ipfs_link.rs"; }
          { name = "zim-info"; path = "src/bin/zim_info.rs"; }
        ];
