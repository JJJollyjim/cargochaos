...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/youtube-subscriptions/v0.2.72.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "youtube-subscriptions";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blockish-caca" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "06w4qc4gl2cbah29zfrsbq50jyjs4cbr2qgvl7znf4v02z272bv4";type = [ "dylib" ];
        authors = [
          "yazgoo <yazgoo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "blockish-player 0.0.2";
          }
          {
            name = "crossterm";
            packageId = "crossterm";
      ...
      "blockish-player 0.0.2" = rec {
        crateName = "blockish-player";
        version = "0.0.2";
        edition = "2018";
        sha256 = "19xhj8kb6cwl9ix8jj250h2pfd76x0rcnh7v5lc876w8p9w3xiqn";
        authors = [
          "yazgoo <yazgoo@gmail.com>"
        ];
        dependencies = [
      ...
      "blockish-player 0.0.3" = rec {
        crateName = "blockish-player";
        version = "0.0.3";
        edition = "2018";
        sha256 = "1idwsf8yqm7632jr56xq3dkcgqnljm1l0admlhk5gidm9kcn0xbw";
        authors = [
          "yazgoo <yazgoo@gmail.com>"
        ];
        dependencies = [
      ...
      "crossterm_input" = rec {
        ...
        dependencies = [
          ...
          {
            name = "crossterm_winapi";
            packageId = "crossterm_winapi 0.1.5";
            target = { target, features }: target."windows";
          }
          {
            name = "libc";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "blocking" "default" "default-tls" "gzip" "hyper-rustls" "hyper-tls" "native-tls-crate" "rustls" "rustls-tls" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
      ...
      "wasm-bindgen-futures" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "01ldmddb7af7qw6mdiw24kznakwg5zd7wdi1ffv208gcl2rvfzcs";
        authors = [
          "The wasm-bindgen Developers"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shellapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
      ...
      "youtube-subscriptions" = rec {
        crateName = "youtube-subscriptions";
        version = "0.2.72";
        edition = "2018";
        crateBin = [
          { name = "youtube-subscriptions"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.72.nix {};
        authors = [
          "yazgoo <yazgoo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "blockish-player";
            packageId = "blockish-player 0.0.3";
          }
          {
            name = "chrono";
            packageId = "chrono";
          ...
          }
          {
            name = "reqwest";
            packageId = "reqwest";
            features = [ "gzip" "rustls-tls" "blocking" ];
          }
          {
            name = "roxmltree";
            packageId = "roxmltree";
