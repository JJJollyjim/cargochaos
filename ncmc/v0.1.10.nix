...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ncmc/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "metaflac" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "075skmki75r373ld4mpsf3p6yw0229c416kls7vnx6dww9h7cq9m";
        authors = [
      ...
      "mini-internal" = rec {
        crateName = "mini-internal";
        version = "0.1.12";
        edition = "2018";
        sha256 = "1yl7bgqrdd51hzaxw3cxizsbvab1s5gwjxara3a88y1gqxvl8smw";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "miniserde" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "16y5i4inxcryc31vhkh4fsvz83a05qlcl3h5wlk7h688j8mmsz2d";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "ncmc" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ncmc"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.10.nix {};
        authors = [
          "阿卡琳 <hufan.akarin@Gmail.com>"
        ];
        dependencies = [
          {
            name = "aes";
