...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rspell/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rspell" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rspell-dic"; path = "src/bin/rspell-dic.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Martin Chaine <martin@casimir.me>"
        ];
        dependencies = [
          {
            name = "curl";
        ...
        resolvedDefaultFeatures = [ "env_logger" "local_files" "structopt" "tools" ];
      };
      "rust-argon2" = rec {
