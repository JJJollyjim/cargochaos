...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sniffglue/v0.10.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "caps" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "1vplgzx8nifzr3f0l8ca77jqnz3fdymdg0ickacgdvawc44a3n90";
        authors = [
      ...
      "dhcp4r" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "13mfizcd8sn9iiy6m4lv9g7sgcq7cv59xq71f6647q0mw4pz0287";
        authors = [
      ...
      "pcap-sys" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "18w9c8i5zjnazay86219w4789482ya617z35cw433h12wbgjaiqi";
        authors = [
          "Michael McLellan <jmikem825@gmail.com>"
        ];
        dependencies = [
          {
            name = "libc";
      ...
      "pktparse" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0qif4556q7zx17cs5smh3zr7h9pjlq8l4qsz8yhxyri370yirj0r";
        authors = [
          "Nathan Moos"
          "Xavier Bestel"
        ];
        ...
        features = {
          "derive" = [ "serde" "serde_derive" ];
        };
        resolvedDefaultFeatures = [ "derive" "serde" "serde_derive" ];
      };
      "pledge" = rec {
        crateName = "pledge";
        version = "0.3.1";
      ...
      "reduce" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0g1zkanp4a0jb7cpyn1s29xhik4qiy7mbfkbfiljlbxhd1bgmcbm";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "sniffglue" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "sniffglue"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
