...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gelf/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "loom" = rec {
        ...
        version = "0.2.14";
        edition = "2018";
        sha256 = "0v34dmrw46g0xnmms2rwj78ljfgcj59p54zcicm38z7zsal68ph2";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "wow64apiset" ];
      };
