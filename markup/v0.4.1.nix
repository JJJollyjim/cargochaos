...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markup/v0.4.1.nix.tmp"
        ...
        dependencies = [
          {
            ...
            packageId = "markup-proc-macro";
          }
        ];
        
      };
      "markup-proc-macro" = rec {
        crateName = "markup-proc-macro";
        version = "0.4.1";
        edition = "2018";
        sha256 = "0v66m1w9jdjyqcmhl3jvai4vkgqk5k9f2jyih3mnm34b3lp1xjn0";
        procMacro = true;
        authors = [
          "Utkarsh Kukreti <utkarshkukreti@gmail.com>"
        ];
