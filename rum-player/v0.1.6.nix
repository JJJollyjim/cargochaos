...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rum-player/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mpv" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "10kg4c4n7i9hcfaxy7i1mym5mmcfyyq598dqm9mfzfsm8sagsmwy";
        authors = [
      ...
      "rum-player" = rec {
        crateName = "rum-player";
        version = "0.1.6";
        edition = "2018";
        crateBin = [
          { name = "rum-player"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "stream" "rt-threaded" "macros" "io-std" ];
          }
          {
            name = "toml";
            packageId = "toml";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "unhtml" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "1w5my1m7gsjq4sl5qpvdf6hihbnr5yjiy4khm3zsrxa4zbfpjfdq";
        authors = [
      ...
      "unhtml_derive" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "1w17limy64dp94npxlj4yw59i8a9wk1app35ba4i5blja8131vnz";
        procMacro = true;
        authors = [
          "Hexilee <hexileee@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
