...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mcio/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwindef" "ntsecapi" "ntstatus" "profileapi" "sysinfoapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
