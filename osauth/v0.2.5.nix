...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/osauth/v0.2.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "osauth" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "native-tls" "rustls" "sync" "tokio" ];
      };
      "osproto" = rec {
        crateName = "osproto";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1w65i52h6g5r4hlbsms6alg60wlpia8vy2p7738798437nxj96wf";
        authors = [
          "Dmitry Tantsur <divius.inside@gmail.com>"
        ];
        dependencies = [
