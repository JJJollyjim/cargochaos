...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rooster/v2.8.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rooster" = rec {
        ...
        src = pkgs.callPackage ./tarball-v2.8.5.nix {};
        authors = [
      ...
      "rprompt" = rec {
        ...
        version = "1.0.4";
        edition = "2015";
        sha256 = "0r6x9zggdymry9g8ms3ffgbm9xbga5rvj5ch2p7mkf1129ix48qc";
        authors = [
          "Conrad Kleinespel <conradk@conradk.com>"
        ];
