...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/transit_model/v0.17.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minidom_ext" = rec {
        crateName = "minidom_ext";
        version = "1.1.0";
        edition = "2018";
        sha256 = "008ppnh364vg5b6a3mj2jm26dkir88g07v495dvricnr92n8aj6d";
        authors = [
          "Kisio Digital <team.coretools@kisio.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "skip_error" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "022a59pc5a6g5hz52k2v42b0ayhh2b45kzqil98dnki6z2jgxx7i";
        authors = [
          "Kisio Digital <team.coretools@kisio.org>"
        ];
        dependencies = [
