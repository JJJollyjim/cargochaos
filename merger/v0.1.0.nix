...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/merger/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "merge-yaml-hash" = rec {
        crateName = "merge-yaml-hash";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0kjmr36dhki1a174cb62avcz8m68sqdqbqknv05954xxkyjgn7qk";
        authors = [
          "qtfkwk <qtfkwk+mergeyamlhash@gmail.com>"
        ];
        dependencies = [
          {
      ...
      "merger" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "merger"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "kainlite <kainlite@gmail.com>"
        ];
        dependencies = [
          {
            name = "merge-yaml-hash";
            packageId = "merge-yaml-hash";
          }
          {
            name = "yaml-rust";
