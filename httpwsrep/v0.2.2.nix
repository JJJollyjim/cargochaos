...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/httpwsrep/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dsn" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "1q7vv53i26s9rja75f7jqn7yqc9sxhr16vmsmm3ajvxsql9z84s1";
        authors = [
      ...
      "httpwsrep" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "httpwsrep"; path = "src/bin/httpwsrep.rs"; }
        ];
      ...
      "mysql_async" = rec {
        ...
        version = "0.23.0";
        edition = "2018";
        sha256 = "1x52shpvvsx65bqs6nibrrsda6jckkbl7i2mxkshn57wwimdcgqs";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "net" "sync" "fs" "rt-core" "time" "stream" "macros" ];
          }
          {
            name = "tokio-tls";
            packageId = "tokio-tls";
      ...
      "mysql_common" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "1wxx4mmi5ilks86bhh4dxg9xk2r9vy44yhifrl7an8ypwnl15xm2";
        authors = [
          "blackbeam <aikorsky@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
