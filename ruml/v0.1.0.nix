...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ruml/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ruml" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ruml"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "nrskt <chipuno0602@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
          ...
          }
          {
            name = "syn";
            packageId = "syn";
            features = [ "extra-traits" "full" "parsing" "printing" ];
          }
          {
            name = "walkdir";
            packageId = "walkdir";
