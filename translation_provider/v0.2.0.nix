...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/translation_provider/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "translation_provider";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "translation_provider" = rec {
        crateName = "translation_provider";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        procMacro = true;
        authors = [
          "Paul Lesur <git@lesurpaul.fr>"
        ];
        dependencies = [
          {
            name = "proc-macro2";
