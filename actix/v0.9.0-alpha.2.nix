...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix/v0.9.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "actix" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.9.0-alpha.2.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "actix-http" "default" "http" "mailbox_assert" "resolver" "trust-dns-proto" "trust-dns-resolver" ];
      };
      "actix-codec" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
