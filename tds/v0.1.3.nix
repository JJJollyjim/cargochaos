...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tds/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tds" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tds"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "iiran <percivalstr@163.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
