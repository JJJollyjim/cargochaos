...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/teleport/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "meio" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1csm8aw30v5gb3gbpq6ggkn70adfk69y86hj0zdbzyl7xyajk8ri";
        authors = [
      ...
      "teleport" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "teleport"; path = "src/main.rs"; }
        ];
