...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust_qt_binding_generator/v0.3.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust_qt_binding_generator" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "rust_qt_binding_generator"; path = "src/bin/rust_qt_binding_generator.rs"; }
        ];
