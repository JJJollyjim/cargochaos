...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/null-terminated/v0.3.14.nix.tmp"
    ...
    crates = {
      ...
      "null-terminated" = rec {
        ...
        devDependencies = [
          ...
          {
            name = "system-call";
            packageId = "system-call";
          }
        ];
        features = {
          "default" = [ "utf" ];
        };
        resolvedDefaultFeatures = [ "default" "utf" ];
      };
      "proc-macro2" = rec {
      ...
      "system-call" = rec {
        crateName = "system-call";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1183q3fqwkazjlx9bmald2vzcyl2kzqgp4vfky7sprcfp0mpzsxd";
        libName = "syscall";
        authors = [
      ...
      "utf" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "01k0xj2h17wxb2hcx5sp0ragx1vk5bigkcz19m2rqkm79dnkkjp5";
        authors = [
          "M Farkas-Dyck <strake888@gmail.com>"
        ];
