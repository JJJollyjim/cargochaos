...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flexi_logger/v0.14.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flexi_logger" = rec {
        ...
        version = "0.14.7";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.14.7.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "colors" "default" "flate2" "hostname" "libc" "notify" "serde" "serde_derive" "specfile" "syslog_writer" "toml" "yansi" "ziplogs" ];
      };
      "fsevent" = rec {
        crateName = "fsevent";
        version = "0.4.0";
