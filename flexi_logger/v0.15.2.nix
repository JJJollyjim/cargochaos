...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flexi_logger/v0.15.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flexi_logger" = rec {
        ...
        resolvedDefaultFeatures = [ "colors" "default" "flate2" "hostname" "libc" "notify" "regex" "serde" "serde_derive" "specfile" "syslog_writer" "textfilter" "toml" "yansi" "ziplogs" ];
      };
      "fsevent" = rec {
        crateName = "fsevent";
        version = "0.4.0";
