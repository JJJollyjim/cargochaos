...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/autojump/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atomicwrites" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "1jiwvrbwisg0a3li0yjqhk9rfvd2jf0sbbjcrq0znmkbcvrz1pvs";
        authors = [
      ...
      "autojump" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "autojump"; path = "src/bin/autojump/main.rs"; }
        ];
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "winbase" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
