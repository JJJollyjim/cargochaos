...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-dataproc1-cli/v1.0.12+20190620.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-dataproc1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-dataproc1" = rec {
        crateName = "google-dataproc1";
        version = "1.0.12+20190620";
        edition = "2015";
        sha256 = "0i5r9v9zr9ahqz4mdfgxmmry6h57v8haaz2xcxf2hsnf0cy12zrd";
        authors = [
      ...
      "google-dataproc1-cli" = rec {
        crateName = "google-dataproc1-cli";
        version = "1.0.12+20190620";
        edition = "2015";
        crateBin = [
          { name = "dataproc1"; path = "src/main.rs"; }
        ];
