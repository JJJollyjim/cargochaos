...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glyph_brush/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "consoleapi" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "libloaderapi" "memoryapi" "minwindef" "mmsystem" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "sysinfoapi" "timeapi" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winuser" ];
      };
