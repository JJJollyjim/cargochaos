...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/NeteaseCloudMusicRustApi/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "NeteaseCloudMusicRustApi";
  ...
  internal = rec {
    ...
    crates = {
      "NeteaseCloudMusicRustApi" = rec {
        crateName = "NeteaseCloudMusicRustApi";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "NeteaseCloudMusicRustApi"; path = "src/main.rs"; }
        ];
      ...
      "actix-connect 1.0.1" = rec {
        ...
        dependencies = [
          ...
          {
            name = "actix-service";
            packageId = "actix-service 1.0.1";
          }
          {
            name = "actix-utils";
            packageId = "actix-utils 1.0.4";
          }
          {
            name = "derive_more";
      ...
      "urlqstring" = rec {
        crateName = "urlqstring";
        version = "0.3.1";
        edition = "2018";
        sha256 = "0h8k28pr9p571bqwqdgb4737lg98nyfiyxpxl12l7xdpin985nl6";
        authors = [
          "zmant <zmant724@aliyun.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
