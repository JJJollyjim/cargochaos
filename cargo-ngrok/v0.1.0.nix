...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-ngrok/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-ngrok" = rec {
        crateName = "cargo-ngrok";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-ngrok"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "syn";
            packageId = "syn";
            features = [ "parsing" "printing" "full" "visit" "extra-traits" ];
          }
          {
            name = "tokio";
            packageId = "tokio";
