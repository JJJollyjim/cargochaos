...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gfwx/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gfwx" = rec {
        ...
        authors = [
          "Vlad Aleksashin <aleksashin.vlad@apriorit.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
        ...
        resolvedDefaultFeatures = [ "adaptive_multithreading" "default" "rayon" ];
      };
      "gif" = rec {
        crateName = "gif";
        version = "0.10.3";
