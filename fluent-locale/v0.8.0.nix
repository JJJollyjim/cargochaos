...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluent-locale/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-langid" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1vvd4hzjjjvd2p17afhcnp2pbym0s6ph18y9s62194sj4nf995qx";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-langid-impl" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "19ln6daskycaf7gd1k6bnk2safmbd4ccssas2zkfy1cp2r97pmiw";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
