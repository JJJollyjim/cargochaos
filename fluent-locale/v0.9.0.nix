...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluent-locale/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-locale" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "107hwpgkkawaqrzqg2ria8mx429k1wmr23fy9z947k3svfrd7mgl";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-impl" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1fqz3yi72157w8iq4vi0f30phklqjlgazvi8r0akx0gwqf0im6wl";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-macros" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1jyvzcpa4ci69nl6428lspp7fp673hgkz17yxlk2wh85yzfr352j";
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
      ...
      "unic-locale-macros-impl" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0mf4yppmy5rvmx9vf4yva349snqsfb7p8bqii32a82iy97a917i0";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
