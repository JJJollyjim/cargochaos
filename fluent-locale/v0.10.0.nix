...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluent-locale/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fluent-locale" = rec {
        ...
        resolvedDefaultFeatures = [ "cldr" "default" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.12";
      ...
      "unic-langid" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "likelysubtags" "macros" "unic-langid-macros" ];
      };
      "unic-langid-impl" = rec {
        ...
        resolvedDefaultFeatures = [ "likelysubtags" ];
      };
      ...
      "unic-locale" = rec {
        crateName = "unic-locale";
        version = "0.6.1";
        edition = "2018";
        sha256 = "1vp6mrn8krwcjm45lsldsyr05a43r1092gbf36xx4flzbxbdryhm";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "unic-locale-impl";
          }
          {
            name = "unic-locale-macros";
            packageId = "unic-locale-macros";
            optional = true;
          }
        ];
        devDependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "macros" "unic-locale-macros" ];
      };
      "unic-locale-impl" = rec {
        crateName = "unic-locale-impl";
        version = "0.6.0";
        edition = "2018";
        sha256 = "080ycq2sckhgimy0jjnhgkzn9d7h4svvip95qv2parljnv7gfg1m";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-macros" = rec {
        crateName = "unic-locale-macros";
        version = "0.6.0";
        edition = "2018";
        sha256 = "1prqdk8vz2njvrvzk92m7q93pfcqjbv73sy3mnn43qdmwlcwma7g";
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "unic-locale-macros-impl";
          }
        ];
        
      };
      "unic-locale-macros-impl" = rec {
        crateName = "unic-locale-macros-impl";
        version = "0.6.0";
        edition = "2018";
        sha256 = "1jyb549vhykdkwzyjbigh4m04naivg1ymgnln5rqa85a8dvvg7j6";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
