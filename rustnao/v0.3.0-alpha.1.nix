...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustnao/v0.3.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "default-tls" "default-tls-vendored" "futures-channel-preview" "hyper-tls" "json" "native-tls" "serde_json" "tls" "tokio-tls" ];
      };
      "rustc-demangle" = rec {
      ...
      "rustnao" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "reqwest";
            packageId = "reqwest";
            features = [ "blocking" "json" "default-tls" "default-tls-vendored" ];
          }
          {
            name = "serde";
            packageId = "serde";
