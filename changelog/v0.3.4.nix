...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/changelog/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "changelog" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "changelog"; path = "src/main.rs"; }
        ];
      ...
      "clap_flags" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1a860zqjrds5gqxffirs643clkb96s32zpr3s490jfpc1bi7drhz";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
