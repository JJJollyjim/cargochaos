...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/badtouch/v0.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "badtouch" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "badtouch"; path = "src/main.rs"; }
        ];
      ...
      "rlimit" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1s7ac6fi4q4f2djg5ljbch7ab3shyh9fq2gjqll2c7iax1jnxlp6";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
