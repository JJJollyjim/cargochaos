...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zk-loader/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "winbase" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "zk-loader" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "zk-loader"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Khayrutdinov Marat <mail@wtiger.org>"
        ];
        dependencies = [
          {
            name = "clap";
