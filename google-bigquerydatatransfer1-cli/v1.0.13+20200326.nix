...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-bigquerydatatransfer1-cli/v1.0.13+20200326.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-bigquerydatatransfer1" = rec {
        ...
        edition = "2015";
        sha256 = "0wv3dw8629nr278nx1lfy39wgfy07xa2wqf0cj2ayqpj07fp168r";
        authors = [
      ...
      "google-bigquerydatatransfer1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200326.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
