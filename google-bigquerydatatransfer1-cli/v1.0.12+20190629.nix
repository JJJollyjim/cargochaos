...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-bigquerydatatransfer1-cli/v1.0.12+20190629.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-bigquerydatatransfer1-cli";
  ...
  workspaceMembers = {
    "google-bigquerydatatransfer1-cli" = rec {
      packageId = "google-bigquerydatatransfer1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-bigquerydatatransfer1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-bigquerydatatransfer1" = rec {
        crateName = "google-bigquerydatatransfer1";
        version = "1.0.12+20190629";
        edition = "2015";
        sha256 = "1j8k0grzs0f7wy9kcqy8mlzalk5xldrk1nfsmjxagv571zdspfvp";
        authors = [
      ...
      "google-bigquerydatatransfer1-cli" = rec {
        crateName = "google-bigquerydatatransfer1-cli";
        version = "1.0.12+20190629";
        edition = "2015";
        crateBin = [
          { name = "bigquerydatatransfer1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190629.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-bigquerydatatransfer1";
            packageId = "google-bigquerydatatransfer1";
          }
          {
            name = "hyper";
            packageId = "hyper";
