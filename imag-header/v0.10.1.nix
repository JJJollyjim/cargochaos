...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imag-header/v0.10.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imag-header" = rec {
        crateName = "imag-header";
        version = "0.10.1";
        edition = "2015";
        crateBin = [
          { name = "imag-header"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.1.nix {};
        libName = "libimagheadercmd";
        authors = [
          "Matthias Beyer <mail@beyermatthias.de>"
        ];
        dependencies = [
