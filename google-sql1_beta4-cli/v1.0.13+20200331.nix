...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-sql1_beta4-cli/v1.0.13+20200331.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-sql1_beta4-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-sql1_beta4" = rec {
        crateName = "google-sql1_beta4";
        version = "1.0.13+20200331";
        edition = "2015";
        sha256 = "1n89nrc5gvbxff41c5zv2n1q9hf0xgpwmi363i2bjc0g62hcilm0";
        authors = [
      ...
      "google-sql1_beta4-cli" = rec {
        crateName = "google-sql1_beta4-cli";
        version = "1.0.13+20200331";
        edition = "2015";
        crateBin = [
          { name = "sql1-beta4"; path = "src/main.rs"; }
        ];
