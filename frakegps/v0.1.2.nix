...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/frakegps/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "frakegps" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "frakegps"; path = "src/main.rs"; }
        ];
      ...
      "web-view" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "1g7lv8x13lf9d3fbgdl7lm7b6b4rvs32i2irh93ik1wn6mpcfwi0";
        authors = [
          "Boscop"
      ...
      "webview-sys" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "0zhdmn80spd6lciwjbavii1xapj5vbgbyns6bj5kbz9yp6sgv7ls";
        libName = "webview_sys";
        libPath = "lib.rs";
        authors = [
          "Boscop"
