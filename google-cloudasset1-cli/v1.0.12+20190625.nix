...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudasset1-cli/v1.0.12+20190625.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudasset1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudasset1" = rec {
        crateName = "google-cloudasset1";
        version = "1.0.12+20190625";
        edition = "2015";
        sha256 = "0pd97hg87y0w60fhl6p4xxlvp1yv3n94c243dbfn6k9cjprr1wsk";
        authors = [
      ...
      "google-cloudasset1-cli" = rec {
        crateName = "google-cloudasset1-cli";
        version = "1.0.12+20190625";
        edition = "2015";
        crateBin = [
          { name = "cloudasset1"; path = "src/main.rs"; }
        ];
