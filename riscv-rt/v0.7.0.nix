...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/riscv-rt/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "riscv" = rec {
        ...
        version = "0.5.5";
        edition = "2015";
        sha256 = "1nlk9rwg86cy7vr3wyv8vi8l9009hbhxkansc2qzdbhwn6g0b6ky";
        authors = [
        ...
        resolvedDefaultFeatures = [ "inline-asm" ];
      };
      "riscv-rt" = rec {
        crateName = "riscv-rt";
        version = "0.7.0";
