...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broot/v0.10.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minimad" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1i4hyi9g6l218qgdxb6251d47da5x57qvmipv44a5rm4f8mmf0v6";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
      ...
      "termimad" = rec {
        ...
        version = "0.8.5";
        edition = "2018";
        sha256 = "1kj4rklqp61nsfgq05400aj08c8xxhvmw9jnw1ys6nr2cdlracqy";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
