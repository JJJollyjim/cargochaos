...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broot/v0.11.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "broot" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.11.6.nix {};
        authors = [
      ...
      "termimad" = rec {
        ...
        version = "0.8.9";
        edition = "2018";
        sha256 = "197g9m878p4sflbdgjz0iipbq0q9aciybmf8s6nhfw719zswjg25";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
