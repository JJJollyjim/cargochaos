...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broot/v0.11.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minimad" = rec {
        ...
        version = "0.6.3";
        edition = "2018";
        sha256 = "1dwzichvg4ny0hba6v1if9bgxah8na7k7p8h13hczr0rzrx8gmb4";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
      ...
      "termimad" = rec {
        ...
        version = "0.8.10";
        edition = "2018";
        sha256 = "06k4nzrx2460pj16823yqhg9mw0lnd30jhknza508vngc4sh458m";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shellapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
