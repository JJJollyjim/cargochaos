...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broot/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossterm" = rec {
        ...
        version = "0.13.0";
        edition = "2018";
        sha256 = "1pspsf9ww37ylxgaqxpn1n613lkxrsdc3l5zmx0s5is3ng9w2j9z";
        authors = [
          "T. Post"
        ];
        dependencies = [
      ...
      "termimad" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "0a6f9lbdlp5b461n18shmbarmm8a5w38x1pvqvxm5bbblfhs1lxj";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
