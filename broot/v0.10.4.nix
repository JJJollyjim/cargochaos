...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/broot/v0.10.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minimad" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "1bm47f47icm08dwxfgn2i86i0cp40f9jz4kxk4p8c1sn6iagb7br";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
      ...
      "termimad" = rec {
        ...
        version = "0.8.4";
        edition = "2018";
        sha256 = "0r60sm6nksimbzxwvwzjvwxz6s6nxvdcxa55lrbiq55rs2sd023a";
        authors = [
          "dystroy <denys.seguret@gmail.com>"
        ];
        dependencies = [
