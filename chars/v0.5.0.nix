...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chars/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chars_data" = rec {
        crateName = "chars_data";
        version = "0.5.0";
        edition = "2015";
        crateBin = [];
        sha256 = "1nahmqk0xmfb7dkd2sfssxxkcfw9mi9xrpkhaisnqdxvymj51cax";
        authors = [
          "Andreas Fuchs <asf@boinkor.net>"
        ];
        dependencies = [
      ...
      "fst" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0ybmdzkknhv1wx6ws86iyixfyzc04l4nm71b9va7953r1m3i6z1z";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        features = {
      ...
      "unicode_names2" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1wcckqdyfpmp74gp0zdx9bc1ybl0sgs9vcfls2x4lf8ng66ngml7";
        authors = [
