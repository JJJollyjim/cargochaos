...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webhdfs/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "webhdfs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "webhdfs"; path = "src/bin/webhdfs.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "Valery Vybornov <vvybornov@gmail.com>"
        ];
        dependencies = [
          {
            name = "bytes";
        ...
        resolvedDefaultFeatures = [ "default" "zero-copy-on-write" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
