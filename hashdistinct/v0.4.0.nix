...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hashdistinct/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hashdistinct" = rec {
        crateName = "hashdistinct";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "hashdistinct"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "starfear <starfear@outlook.com>"
        ];
        dependencies = [
          {
            name = "clap";
