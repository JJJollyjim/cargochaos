...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ncursesw-win/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ncursesw" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "0vn8i9vj2pi1ibigdr4r3c88praindbdysnxv05inan5fizh9hrd";
        authors = [
          "Steve Whittle <narfit66@googlemail.com>"
        ];
        dependencies = [
          {
            name = "ascii";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "processenv" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
