...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/noughts-and-crosses/v0.0.9.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "noughts-and-crosses" = rec {
        crateName = "noughts-and-crosses";
        version = "0.0.9";
        edition = "2018";
        crateBin = [
          { name = "noughts-and-crosses"; path = "src/main.rs"; }
        ];
      ...
      "shadow-clone" = rec {
        crateName = "shadow-clone";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1qj6356y106cpmxbgksxj278bpk89902b9ij9045y8y8ijdz2hn2";
        authors = [
          "Ethan Brierley <ethanboxx@gmail.com>"
        ];
