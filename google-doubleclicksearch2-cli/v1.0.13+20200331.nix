...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-doubleclicksearch2-cli/v1.0.13+20200331.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-doubleclicksearch2-cli";
  ...
  workspaceMembers = {
    "google-doubleclicksearch2-cli" = rec {
      packageId = "google-doubleclicksearch2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-doubleclicksearch2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-doubleclicksearch2" = rec {
        crateName = "google-doubleclicksearch2";
        version = "1.0.13+20200331";
        edition = "2015";
        sha256 = "04j6ydq01pr2i499znrl7bs74acszvhsy9283nan8jkg8ja4af3v";
        authors = [
      ...
      "google-doubleclicksearch2-cli" = rec {
        crateName = "google-doubleclicksearch2-cli";
        version = "1.0.13+20200331";
        edition = "2015";
        crateBin = [
          { name = "doubleclicksearch2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-doubleclicksearch2";
          }
          {
            name = "hyper";
            packageId = "hyper";
