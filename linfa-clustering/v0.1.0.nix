...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linfa-clustering/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ndarray" = rec {
        ...
        resolvedDefaultFeatures = [ "approx" "rayon" "serde" ];
      };
      "ndarray-npy" = rec {
      ...
      "ndarray-stats" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0606qxylfs7na52wkf3hvyg9m2rr3v9pibq51yykswb066vs8g8f";
        authors = [
      ...
      "noisy_float" = rec {
        ...
        version = "0.1.11";
        edition = "2018";
        sha256 = "0d1jrqvcfj3jjfyqwma17q9qba75mia3i0wgrm3lyq1c8p35w6a8";
        authors = [
