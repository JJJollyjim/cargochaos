...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bat/v0.14.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bat" = rec {
        ...
        resolvedDefaultFeatures = [ "application" "atty" "clap" "default" "dirs" "git" "git2" "lazy_static" "liquid" "paging" "regex-fancy" "regex-onig" "shell-words" "wild" ];
      };
      "bincode" = rec {
        crateName = "bincode";
        version = "1.2.1";
      ...
      "git2" = rec {
        ...
        version = "0.13.3";
        edition = "2018";
        sha256 = "03qakwsph13damv4hywqvqpfshsv51zr1869ypqlpvq584k6xz5x";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "libgit2-sys" = rec {
        ...
        edition = "2018";
        sha256 = "0i0wxw2cvw9y4vav86jv5svd4fi8c8ndr3hh3cwpc2mmszn70a7g";
        libName = "libgit2_sys";
        libPath = "lib.rs";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
      ...
      "syntect" = rec {
        ...
        version = "4.1.1";
        edition = "2018";
        sha256 = "08gnswryxph77mmfwl3wxkp2gl7v4ffgvic3xgxkk3nkliv95ivb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bincode" "dump-create" "dump-load" "fancy-regex" "flate2" "fnv" "onig" "parsing" "regex-fancy" "regex-onig" "regex-syntax" "yaml-load" "yaml-rust" ];
      };
      "tempdir" = rec {
        crateName = "tempdir";
        version = "0.3.7";
