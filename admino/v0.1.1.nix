...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/admino/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mailchecker" = rec {
        crateName = "mailchecker";
        version = "3.3.4";
        edition = "2015";
        sha256 = "04wn6dqfgm50n1frn5x1gh2fq74y784sc0pmmfkir2sbrcfj07br";
        authors = [
