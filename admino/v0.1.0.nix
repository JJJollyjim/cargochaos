...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/admino/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "admino" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "admino"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "gengteng <me@gteng.org>"
        ];
        dependencies = [
          {
            name = "actix-files";
          ...
          }
          {
            ...
            features = [ "with-chrono-0_4" "derive" ];
          }
          {
            name = "rand";
            packageId = "rand";
          ...
          }
          {
            ...
            packageId = "tokio-pg-mapper";
          }
          {
            name = "tokio-pg-mapper-derive";
            packageId = "tokio-pg-mapper-derive";
          }
          {
            name = "tokio-postgres";
      ...
      "deadpool" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1li702z7y0gw2jisic9kjrfimp9rmmjkrg725c5yv25dn6q55kiq";
        authors = [
        ...
        resolvedDefaultFeatures = [ "async-trait" "config" "config-crate" "default" "managed" "serde" "unmanaged" ];
      };
      "deadpool-postgres" = rec {
        crateName = "deadpool-postgres";
        version = "0.5.4";
        edition = "2018";
        sha256 = "1hv5bq3cjv1c35f4l21afphsm19rfsmc2629gy8ws35p29pdrpls";
        authors = [
          "Michael P. Jung <michael.jung@terreon.de>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "config" "config-crate" "default" "serde" ];
      };
      "deadpool-redis" = rec {
        crateName = "deadpool-redis";
        version = "0.5.2";
        edition = "2018";
        sha256 = "0p6q9byzvm90zcnmda2dxffm1q7wlvj8rvdiwiz5wcbq3qhw6mbn";
        authors = [
          "Michael P. Jung <michael.jung@terreon.de>"
        ];
        dependencies = [
      ...
      "hex-serde" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "04kh3fzyhi72j92c9fr0zjcj87dl99g8mbjn33ycbi2jksydg1il";
        authors = [
          "Mathias Svensson <mathias@seasoned.software>"
        ];
        dependencies = [
          {
            name = "hex";
      ...
      "phonenumber" = rec {
        ...
        edition = "2015";
        sha256 = "0gj6cw6d12bsdsrlbxy2l8bw9njk5i6bm84vk2194qhg1wcschmm";
        authors = [
          "meh. <meh@1aim.com>"
        ];
        dependencies = [
      ...
      "postgres-types" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono-04" "derive" "postgres-derive" "with-chrono-0_4" ];
      };
      "ppv-lite86" = rec {
      ...
      "quick-xml" = rec {
        ...
        version = "0.13.3";
        edition = "2015";
        sha256 = "0lq9nj5zx9g1613cbnsvkpyf13nhjm3gy0cc7qj9nq7lrs7c9z12";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "rt-core" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-pg-mapper" = rec {
        crateName = "tokio-pg-mapper";
        version = "0.1.4";
        edition = "2018";
        sha256 = "12xj9zh04rkgqrdrx3i5lz875zcxnn5wrs87k65dlybx66jfkxgj";
        authors = [
          "Darin Gordon <dkcdkg@gmail.com>"
      ...
      "tokio-pg-mapper-derive" = rec {
        crateName = "tokio-pg-mapper-derive";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1makr0j4y7rmdq7crf319j4w1q6mjhgkpri4fqk5krd8l448gk7g";
        procMacro = true;
        authors = [
          "Darin Gordon <dkcdkg@gmail.com>"
          "Zeyla Hellyer <zeyla@hellyer.dev>"
      ...
      "tokio-postgres" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "1nyb1ijjdf4yz84v8pmgjw1l9vqqjsz6qbkm5ah9a03gl5q44ydl";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
