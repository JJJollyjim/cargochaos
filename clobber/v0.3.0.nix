...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clobber/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "byte-mutator" = rec {
        crateName = "byte-mutator";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0nnh3x0ai6zpwnfkvqbq274mx7rdiz098yqhh7j9iyksf489ikva";
        authors = [
