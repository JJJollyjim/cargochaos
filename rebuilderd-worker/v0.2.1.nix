...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rebuilderd-worker/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rebuilderd-worker" = rec {
        crateName = "rebuilderd-worker";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "rebuilderd-worker"; path = "src/main.rs"; }
        ];
