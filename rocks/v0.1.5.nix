...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocks/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocks" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "full" "static-link" ];
      };
      "rocks-sys" = rec {
        crateName = "rocks-sys";
        version = "0.1.5";
        edition = "2018";
        sha256 = "15iq6ja0q78vp3fx04xjkas12c7kancnaazlkxzp0zg8ys07ndg1";
        authors = [
          "BH1XUW <bh1xuw@gmail.com>"
        ];
        buildDependencies = [
        ...
        resolvedDefaultFeatures = [ "bzip2" "default" "lz4" "snappy" "static-link" "static-link-all" "zlib" "zstd" ];
      };
      "tempdir" = rec {
        crateName = "tempdir";
        version = "0.3.7";
