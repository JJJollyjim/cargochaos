...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pbkdf2-identifier-cli/v0.0.6.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "pbkdf2-identifier-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pbkdf2-identifier" = rec {
        crateName = "pbkdf2-identifier";
        version = "0.0.6";
        edition = "2018";
        sha256 = "08yz1c1jlzjf7vxyvihnf1aj9rdpqbwj8fbk5m24jhigdp0fhdl7";
        authors = [
          "zer0x64"
        ];
        dependencies = [
      ...
      "pbkdf2-identifier-cli" = rec {
        crateName = "pbkdf2-identifier-cli";
        version = "0.0.6";
        edition = "2018";
        crateBin = [
          { name = "pbkdf2-identifier"; path = "src/main.rs"; }
        ];
