...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/http-bytes/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http-bytes" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "basicauth" "default" "percent-encoding" ];
      };
      "httparse" = rec {
        crateName = "httparse";
        version = "1.3.3";
      ...
      "proptest-http" = rec {
        crateName = "proptest-http";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1dy1w8xcbvsj8grql9w26zrqwrbp5qwjl34sy55shfbiv44qd1sf";
        authors = [
          "Vitaly _Vi Shukela <vi0oss@gmail.com>"
        ];
        dependencies = [
