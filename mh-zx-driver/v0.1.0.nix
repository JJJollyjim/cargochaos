...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mh-zx-driver/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mh-zx-driver" = rec {
        crateName = "mh-zx-driver";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Constantine Verutin <cverutin@gmail.com>"
        ];
        dependencies = [
          {
            name = "embedded-hal";
        ...
        resolvedDefaultFeatures = [ "env_logger" "examples" "linux-embedded-hal" "log" "prometheus" "prometheus_exporter" ];
      };
      "mio" = rec {
        crateName = "mio";
        version = "0.6.21";
      ...
      "prometheus_exporter" = rec {
        crateName = "prometheus_exporter";
        version = "0.4.1";
        edition = "2018";
        sha256 = "080vlm1h8n049jp6d537cwpgbjkq29cckfa2swv6xfbaxj1a9cv1";
        authors = [
