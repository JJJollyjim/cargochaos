...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web-httpauth/v0.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web-httpauth" = rec {
        crateName = "actix-web-httpauth";
        version = "0.4.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.1.nix {};
        libName = "actix_web_httpauth";
        authors = [
