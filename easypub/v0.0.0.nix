...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/easypub/v0.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "fileapi" "handleapi" "minwindef" "processthreadsapi" "winbase" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
