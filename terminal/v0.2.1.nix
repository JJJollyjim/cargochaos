...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/terminal/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crosscurses" = rec {
        crateName = "crosscurses";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0w452g5xwpjw51qi4y5gzz194fa85v39z93bm1b741f0gni4nzgy";
        authors = [
      ...
      "terminal" = rec {
        ...
        resolvedDefaultFeatures = [ "crossbeam-channel" "crosscurses" "crosscurses-backend" "crossterm" "crossterm-backend" "default" "libc" "signal-hook" "termion" "termion-backend" ];
      };
      "termion" = rec {
        crateName = "termion";
        version = "1.5.4";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntstatus" "processenv" "synchapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
