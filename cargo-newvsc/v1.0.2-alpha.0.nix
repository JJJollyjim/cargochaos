...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-newvsc/v1.0.2-alpha.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "cargo-newvsc" = rec {
        crateName = "cargo-newvsc";
        version = "1.0.2-alpha.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-newvsc"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.2-alpha.0.nix {};
        authors = [
          "Adam Smith <adamsmith2708@gmail.com>"
        ];
        dependencies = [
          {
            name = "rust-embed";
