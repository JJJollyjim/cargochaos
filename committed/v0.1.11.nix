...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/committed/v0.1.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "committed" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "committed"; path = "src/main.rs"; }
        ];
      ...
      "imperative" = rec {
        crateName = "imperative";
        version = "1.0.1";
        edition = "2018";
        sha256 = "0snpc1yshrqmflhnvm3ymlglmyya2jn6frc6n0djsj4b34g8p14r";
        authors = [
          "Ed Page <eopage@gmail.com>"
        ];
        dependencies = [
