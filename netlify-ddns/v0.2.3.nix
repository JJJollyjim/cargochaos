...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/netlify-ddns/v0.2.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "netlify-ddns" = rec {
        crateName = "netlify-ddns";
        version = "0.2.3";
        edition = "2018";
        crateBin = [
          { name = "netlify-ddns"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.3.nix {};
        authors = [
          "Luke Hsiao <lwhsiao@stanford.edu>"
        ];
        dependencies = [
          {
            name = "failure";
