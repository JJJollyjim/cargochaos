...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/objc-macros/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "objc-macros" = rec {
        crateName = "objc-macros";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "objc-macros"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "John Gallagher <john.willis.gallagher@gmail.com>"
        ];
        dependencies = [
          {
            name = "objc";
