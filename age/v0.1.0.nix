...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/age/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "age" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "cli" "cli-common" "console" "default" "dialoguer" "dirs" "env_logger" "fuse_mt" "gumdrop" "libc" "log" "minreq" "mount" "rsa" "tar" "time" "unstable" "zip" ];
      };
      "aho-corasick" = rec {
