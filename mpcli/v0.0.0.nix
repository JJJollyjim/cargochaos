...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mpcli/v0.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mpcli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mpcli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.0.nix {};
        authors = [
          "4meta5 <asinghchrony@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "parity-scale-codec" = rec {
        ...
        resolvedDefaultFeatures = [ "derive" "parity-scale-codec-derive" ];
      };
      "parity-scale-codec-derive" = rec {
        crateName = "parity-scale-codec-derive";
        version = "1.1.1";
        edition = "2018";
        sha256 = "0xh4n2z8l4b3fg7irslccs3gnbxks21xrp4nczg3wvs07vzi7r9l";
        procMacro = true;
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
