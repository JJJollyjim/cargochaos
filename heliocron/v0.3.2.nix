...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/heliocron/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "heliocron" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "heliocron"; path = "src/bin/heliocron.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.2.nix {};
        authors = [
          "Michael Freeborn <michaelfreeborn1@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "integration-test" ];
      };
      "hermit-abi" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
