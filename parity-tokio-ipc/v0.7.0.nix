...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/parity-tokio-ipc/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "parity-tokio-ipc" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-driver" "io-util" "uds" "stream" "rt-core" "macros" "time" ];
          }
          {
            name = "winapi";
            packageId = "winapi 0.3.7";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "rt-core" "slab" "stream" "time" "tokio-macros" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "accctrl" "aclapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "securitybaseapi" "std" "synchapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
