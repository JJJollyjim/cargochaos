...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bayard/v0.6.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lindera-tantivy" = rec {
        crateName = "lindera-tantivy";
        version = "0.1.0";
        edition = "2018";
        sha256 = "15hn41bsb7p3g95b29gacsvc9bzc26s3vixj6lcqspv4d0xi6bhn";
        authors = [
          "Minoru Osuka <minoru.osuka@gmail.com>"
        ];
        dependencies = [
