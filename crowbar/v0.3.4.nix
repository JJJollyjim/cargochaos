...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crowbar/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "hyper-tls" "json" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rusoto_core" = rec {
      ...
      "rusoto_sts" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "1r8m733mh8c1rdss4m0hr736k08sm325j0d6k3dp4ii9zdn1cgg8";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "num_cpus" "process" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincred" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
