...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alloc-fmt/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "alloc-fmt" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "print"; path = "src/bin/print.rs"; }
          { name = "assert"; path = "src/bin/assert.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Joshua Liebow-Feeser <hello@joshlf.com>"
        ];
        dependencies = [
          {
            name = "backtrace";
        ...
        features = {
          "default" = [ "print-backtrace" ];
          "print-backtrace" = [ "backtrace" ];
        };
        resolvedDefaultFeatures = [ "backtrace" "default" "print-backtrace" ];
      };
      "backtrace" = rec {
        crateName = "backtrace";
        version = "0.3.9";
      ...
      "spin" = rec {
        ...
        resolvedDefaultFeatures = [ "const_fn" "default" "once" "unstable" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.6";
