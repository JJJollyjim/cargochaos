...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/radius-debug/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "radius-debug" = rec {
        crateName = "radius-debug";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "radius-debug"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Kris <kristhesavage@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
