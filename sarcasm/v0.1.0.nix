...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sarcasm/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sarcasm-utils" = rec {
        crateName = "sarcasm-utils";
        version = "0.1.0";
        edition = "2018";
        sha256 = "09lgghxdvw0fdjyc5xh8iyn7srwk0igdd8k244qzzdq88bjjd61a";
        authors = [
          "Connor Fitzgerald <connorwadefitzgerald@gmail.com>"
        ];
        dependencies = [
