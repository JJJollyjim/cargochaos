...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-imap/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures_codec" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "11qfq39x4pcwypgiwimziff38n7ixq0ghfi07q0q4909mknvivxq";
        authors = [
      ...
      "imap-proto" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "1xzpmxhd4br5z70s77c1qxl2h8qdxzcyvnp1vw8q3zlakxl0ssg0";
        authors = [
      ...
      "stop-token" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "08413r346c2r59r914qflvbvkixy5zcb2klmfl9pw0m00v8sdzng";
        authors = [
          "Aleksey Kladov <aleksey.kladov@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
