...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/passfd/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "passfd" = rec {
        ...
        resolvedDefaultFeatures = [ "futures" "futures-core" "mio" "mio-uds" "tokio-reactor" "tokio-uds" "tokio2" "tokio_01" "tokio_02" ];
      };
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "libc" "mio" "mio-uds" "uds" ];
      };
      "tokio-codec" = rec {
