...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eb/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eb" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "simple_logger" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.14";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" ];
      };
