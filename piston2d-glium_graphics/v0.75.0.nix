...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/piston2d-glium_graphics/v0.75.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "piston2d-glium_graphics";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "piston2d-glium_graphics" = rec {
        crateName = "piston2d-glium_graphics";
        version = "0.75.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.75.0.nix {};
        libName = "glium_graphics";
        authors = [
        ...
        resolvedDefaultFeatures = [ "check_current_window" "default" "glium_window" "image" "piston" "pistoncore-glutin_window" ];
      };
