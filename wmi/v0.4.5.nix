...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wmi/v0.4.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "oaidl" "objbase" "objidlbase" "oleauto" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "wbemcli" "winbase" "wincon" "winerror" "winnt" ];
      };
      ...
      "wmi" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wmiq"; path = "src/bin/wmiq.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "lazy_static" "test" ];
      };
    };
