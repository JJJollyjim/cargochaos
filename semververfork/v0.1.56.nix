...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/semververfork/v0.1.56.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "semververfork" = rec {
        crateName = "semververfork";
        version = "0.1.56";
        edition = "2018";
        crateBin = [
          { name = "cargo-semverfork"; path = "src/bin/cargo_semver.rs"; }
          { name = "rust-semververfork"; path = "src/bin/rust_semverver.rs"; }
          { name = "rust-semverfork-public"; path = "src/bin/rust_semver_public.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.56.nix {};
        authors = [
          "Inokentiy Babushkin <twk@twki.de>"
