...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fern/v0.5.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fern" = rec {
        ...
        resolvedDefaultFeatures = [ "colored" "libc" "meta-logging-in-format" "reopen" "reopen-03" "syslog-3" "syslog-4" "syslog3" "syslog4" ];
      };
      "fuchsia-cprng" = rec {
