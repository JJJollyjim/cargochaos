...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lapin-futures-tls-internal/v0.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin-futures-tls-internal" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-https-rustls" "dns-over-native-tls" "dns-over-openssl" "dns-over-rustls" ];
      };
      "lazy_static" = rec {
      ...
      "trust-dns-native-tls" = rec {
        ...
        version = "0.6.3";
        edition = "2015";
        sha256 = "0v18xwcy2vz57gnp1a6wx52c4zpwlakpr75ydmai8gc0h2kfzd7l";
      ...
      "trust-dns-openssl" = rec {
        ...
        version = "0.6.3";
        edition = "2015";
        sha256 = "0zwx2bsf1rbyjr6l2c3vi24z7414n4b5qiymva9dmbvwxnqqyk1j";
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-https" "dns-over-https-rustls" "dns-over-native-tls" "dns-over-openssl" "dns-over-rustls" "dns-over-tls" "rustls" "tokio" "trust-dns-https" "trust-dns-native-tls" "trust-dns-openssl" "trust-dns-rustls" "webpki-roots" ];
      };
