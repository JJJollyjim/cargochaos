...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mount_status_monitor/v2.1.5.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mount_status_monitor";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mount_status_monitor" = rec {
        crateName = "mount_status_monitor";
        version = "2.1.5";
        edition = "2015";
        crateBin = [
          { name = "mount_status_monitor"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v2.1.5.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "hostname" "lazy_static" "prometheus" "with_prometheus" ];
      };
      "native-tls" = rec {
      ...
      "prometheus" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "libc" "protobuf" "push" "reqwest" ];
      };
      "protobuf" = rec {
        crateName = "protobuf";
        version = "2.10.2";
      ...
      "syslog" = rec {
        ...
        version = "5.0.0";
        edition = "2015";
        sha256 = "0paii62qnwjnfliygdal1x3hqxjkci1nlczfydv7kh3rnvqqwpcs";
        authors = [
          "contact@geoffroycouprie.com"
        ];
        dependencies = [
