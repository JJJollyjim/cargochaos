...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-identitytoolkit3-cli/v1.0.13+20180723.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-identitytoolkit3-cli";
  ...
  workspaceMembers = {
    "google-identitytoolkit3-cli" = rec {
      packageId = "google-identitytoolkit3-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-identitytoolkit3-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-identitytoolkit3" = rec {
        crateName = "google-identitytoolkit3";
        version = "1.0.13+20180723";
        edition = "2015";
        sha256 = "11m89f4r8llppqfpafxpj02cj4ddlwj4js7nhmpasw3dd2n8k0hn";
        authors = [
      ...
      "google-identitytoolkit3-cli" = rec {
        crateName = "google-identitytoolkit3-cli";
        version = "1.0.13+20180723";
        edition = "2015";
        crateBin = [
          { name = "identitytoolkit3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20180723.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-identitytoolkit3";
          }
          {
            name = "hyper";
            packageId = "hyper";
