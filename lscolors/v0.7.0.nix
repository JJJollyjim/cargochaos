...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lscolors/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "processenv" "std" "winbase" "winerror" ];
      };
