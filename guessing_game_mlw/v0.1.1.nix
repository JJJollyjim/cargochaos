...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_mlw/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_mlw" = rec {
        crateName = "guessing_game_mlw";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_mlw"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "mattlwhitaker-IO <whitaker@imageowl.com>"
        ];
        dependencies = [
          {
            name = "rand";
