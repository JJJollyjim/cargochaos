...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/btc_spv_bin/v0.20.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "btc_spv_bin" = rec {
        crateName = "btc_spv_bin";
        version = "0.20.4";
        edition = "2018";
        crateBin = [
          { name = "blockheaders"; path = "src/blockheade.rs"; }
          { name = "blocks"; path = "src/block.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
