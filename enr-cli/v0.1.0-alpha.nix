...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/enr-cli/v0.1.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "enr" = rec {
        ...
        edition = "2018";
        sha256 = "0ylv0ixwmjcx2xs180vrrja9r7x9vq25g53xhzsv5k3bz9skcqjy";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "ed25519" "ed25519-dalek" "libp2p" "libp2p-core" "serde" ];
      };
      "enr-cli" = rec {
        crateName = "enr-cli";
        version = "0.1.0-alpha";
      ...
      "libp2p-core" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "0z18rb2zlgfgqzwfi8d8ajm17kg6m3miz1r7kyif37djqja4b1rv";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "compat" "io-compat" "executor" "thread-pool" ];
          }
          {
            name = "futures-timer";
      ...
      "multistream-select" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "155d04x5z3b6a67brp65i748zxl348l3zk6bnv47fgj943jgyf7r";
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "std" "winbase" "winerror" "winnt" "wtypesbase" ];
      };
