...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/borsh/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "borsh-derive" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1a88r8m2zvhlm9zb9yqrs27k60a1l278zgpb6ya7djamkc9q8ixb";
        procMacro = true;
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
      ...
      "borsh-derive-internal" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1y0yg5292d9phpljrdr18gavhgv1i4ld9az1kkmialx95rwq3hnz";
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
        dependencies = [
      ...
      "borsh-schema-derive-internal" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0ym5pj312i6gs0bkq1bss2hdxr1q5i2g4qjzk8fk4fgqk7m5gcf4";
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
        dependencies = [
