...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/borsh/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "borsh-derive" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "01x7kbbjgb5jam46yyd12rj7j5wh0v23xacgy52v3n947490nhzv";
        procMacro = true;
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
      ...
      "borsh-derive-internal" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "06zckcp5dm9a23943mxyqfjx959byz56w61hcwa8772bdh6a0crz";
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
        dependencies = [
      ...
      "borsh-schema-derive-internal" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0cc94pjiahx74323wmpw2smdpw4djwx48jyh3i56ichcxxwpw5xy";
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
        dependencies = [
