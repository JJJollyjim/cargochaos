...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/borsh/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "borsh-derive" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0kgk90h6cpfrk9bk28ii9rkfd3197dk2d8k011p0qym1nn7jg24c";
        procMacro = true;
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
      ...
      "borsh-derive-internal" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0lx89x23hlqm7znyh3zn1bkfkw10ffkfr0f7bazbmfhwr1j8vbwx";
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
        dependencies = [
      ...
      "borsh-schema-derive-internal" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "05x2vy2rfmzjm4rm3qf6kzvr72mh0yzrnggbw4prvdll56rdsg7z";
        authors = [
          "Near Inc <hello@nearprotocol.com>"
        ];
        dependencies = [
