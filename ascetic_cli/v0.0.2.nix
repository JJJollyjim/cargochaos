...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ascetic_cli/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "aces" = rec {
        ...
        version = "0.0.13";
        edition = "2018";
        sha256 = "1yh5cvxvpj4bb0xynl71wy3xcbv4bpmpyarwk56dx7rm8jizh57k";
        authors = [
          "k7f"
        ];
        dependencies = [
      ...
      "ascesis" = rec {
        ...
        version = "0.0.6";
        edition = "2018";
        sha256 = "0kiarbpi6qirqlr2ryq46f0jqxgj6ac3aw5f7ybga05d8b9h9isx";
        authors = [
          "k7f"
        ];
        dependencies = [
      ...
      "ascetic_cli" = rec {
        crateName = "ascetic_cli";
        version = "0.0.2";
        edition = "2018";
        crateBin = [
          { name = "ascesis"; path = "src/main.rs"; }
        ];
      ...
      "beef" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "0zvfkhhqcrdv4j4hg9s0b8bj26ckf6rgv9j2vsyikgvnd965sv4d";
        authors = [
      ...
      "logos" = rec {
        ...
        version = "0.11.0-rc5";
        edition = "2018";
        sha256 = "11w9d7z8bfb83kpbbcx4kgd9rffn4qrgqnzai7a76p0fyzj72jk5";
        authors = [
          "Maciej Hirsz <hello@maciej.codes>"
        ];
        dependencies = [
      ...
      "logos-derive" = rec {
        ...
        version = "0.11.0-rc5";
        edition = "2018";
        sha256 = "1bfxvj4dm7nh5f4ljnsqpglvlcpkhgdhpni6snd7rxmgvhqrihnn";
        procMacro = true;
