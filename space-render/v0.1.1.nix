...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/space-render/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_animation" "amethyst_audio" "amethyst_locale" "amethyst_network" "amethyst_rendy" "animation" "audio" "default" "empty" "locale" "metal" "network" "renderer" "vulkan" ];
      };
      ...
      "amethyst_rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_window" "empty" "metal" "vulkan" "vulkan-x11" "window" ];
      };
      "amethyst_ui" = rec {
      ...
      "space-render" = rec {
        crateName = "space-render";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Brodie Knight <ncbmknight@gmail.com>"
        ];
        dependencies = [
          {
            name = "amethyst";
        ...
        resolvedDefaultFeatures = [ "default" "empty" "metal" "vulkan" ];
      };
      "specs" = rec {
        crateName = "specs";
        version = "0.16.1";
