...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yeslogic-ucd-generate/v0.3.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "yeslogic-ucd-generate";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "regex-syntax" = rec {
        ...
        version = "0.6.9";
        edition = "2015";
        sha256 = "02kv0j62sfzrgj7mjj4ygsn2z1vsv3jmayzpc3xxy6cyfj7aib5z";
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
      ...
      "yeslogic-ucd-generate" = rec {
        crateName = "yeslogic-ucd-generate";
        version = "0.3.0";
        edition = "2015";
        crateBin = [
          { name = "yeslogic-ucd-generate"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "yeslogic-ucd-parse";
            packageId = "yeslogic-ucd-parse";
            rename = "ucd-parse";
          }
        ];
        devDependencies = [
      ...
      "yeslogic-ucd-parse" = rec {
        crateName = "yeslogic-ucd-parse";
        version = "0.1.5";
        edition = "2015";
        sha256 = "084v4graavrp7p6j2bdgvdiyv99x7ad8g54w3hsmwpn8m193c7ha";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
          "YesLogic Pty. Ltd. <info@yeslogic.com>"
        ];
