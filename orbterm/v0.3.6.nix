...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/orbterm/v0.3.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ransid" = rec {
        ...
        version = "0.4.7";
        edition = "2015";
        sha256 = "008n7qmls0a0v7c87gn4y1h6iwh6amw6hwk3lykvd2kd7qk6waz0";
        authors = [
          "Jeremy Soller <jackpot51@gmail.com>"
        ];
        dependencies = [
      ...
      "rusttype" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "1ccwr3i613vf5m9mnlq707cqad1wz1wmrmicpx1f12m78z3pq11h";
        authors = [
