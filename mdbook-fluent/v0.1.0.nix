...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-fluent/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0j9mbb1ryy63n68hnwlpm71jkbbp52x2r6ha2glyax92dzc1799j";
        authors = [
        ...
        resolvedDefaultFeatures = [ "ammonia" "debug" "default" "elasticlunr-rs" "gitignore" "iron" "notify" "output" "search" "serve" "staticfile" "watch" "ws" ];
      };
      "mdbook-fluent" = rec {
        crateName = "mdbook-fluent";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mdbook-fluent"; path = "src/bin/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Jakub Koralewski\\ <contact@jcubed.me>"
        ];
        dependencies = [
          {
            name = "clap";
