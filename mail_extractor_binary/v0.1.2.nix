...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mail_extractor_binary/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "mail_extractor_binary";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mail_extractor" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "03wchhsz6bv7qn8fhmrd4ysxq5ab0yzlff05p325qx3hkk3c1zwk";
        authors = [
      ...
      "mail_extractor_binary" = rec {
        crateName = "mail_extractor_binary";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "mail_extractor_binary"; path = "src/main.rs"; }
        ];
