...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kg-diag/v0.4.0.nix.tmp"
    ...
    crates = {
      ...
      "kg-diag" = rec {
        ...
        dependencies = [
          ...
          {
            name = "kg-display";
            packageId = "kg-display";
          }
          {
            name = "kg-display-derive";
            packageId = "kg-display-derive";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "kg-display" = rec {
        crateName = "kg-display";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1bphix7vvr5f6a6mbhywjpp1y50abp5y67miaiq5v3d7xcskari4";
        authors = [
          "Jakub Chłapiński <jakub.chlapinski@kodegenix.pl>"
        ];
        dependencies = [
      ...
      "kg-display-derive" = rec {
        crateName = "kg-display-derive";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1gp9azlx55jh98lhlyc825126vs53bq9ldnwzjyln0wwyyvpbx84";
        procMacro = true;
        authors = [
          "Jakub Chłapiński <jakub.chlapinski@kodegenix.pl>"
        ];
      ...
      "kg-utils" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "08p5cbb4c5b00adk7hl83g8iar736l3rkf489pghc7gax9jjn8ya";
        authors = [
          "Jakub Chłapiński <jakub.chlapinski@kodegenix.pl>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "heapsize" "heapsize_impl" "serde" "serde_impl" ];
      };
      "lazy_static" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "heapapi" "std" "winbase" "winerror" ];
      };
