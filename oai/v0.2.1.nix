...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oai/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "roxmltree" = rec {
        ...
        version = "0.7.2";
        edition = "2015";
        sha256 = "0l8ciwi5h0f79yskwpnq5jind9sbyi2scj5zbvjwgl9zanjwpbz9";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
