...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/langtons-termite/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "langtons-termite" = rec {
        crateName = "langtons-termite";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "langtons-termite"; path = "src/main.rs"; }
        ];
