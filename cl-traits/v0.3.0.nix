...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cl-traits/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "cl-traits" = rec {
        ...
        authors = [
          "Caio Fernandes <c410.f3r@gmail.com>"
        ];
        dependencies = [
          {
            name = "cl-traits-derive";
            packageId = "cl-traits-derive";
            optional = true;
          }
          {
            name = "smallvec";
        ...
        features = {
          "derive" = [ "cl-traits-derive" ];
        };
        resolvedDefaultFeatures = [ "alloc" "cl-traits-derive" "derive" "smallvec" ];
      };
      "cl-traits-derive" = rec {
        crateName = "cl-traits-derive";
        version = "0.3.0";
        edition = "2018";
        sha256 = "19r3ncb8n5qckbszdbmbraryizcrhmxicd7b46dvd20bglnvjz8r";
        procMacro = true;
        authors = [
          "Caio Fernandes <c410.f3r@gmail.com>"
        ];
