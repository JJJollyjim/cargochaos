...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libbruteforce/v2.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libbruteforce" = rec {
        crateName = "libbruteforce";
        version = "2.1.0";
        edition = "2018";
        crateBin = [
          { name = "readme_example"; path = "src/bin/readme_example.rs"; }
