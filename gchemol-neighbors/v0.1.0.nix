...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gchemol-neighbors/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gchemol-gut" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "10sz1sf90p5awj69iaj166anhzb09iqc035xjb5jrc8dbgdlglz1";
        authors = [
      ...
      "gchemol-lattice" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1ykn9f1di3vzfa8qci989k5pzcsiirjimsg72xqycx8j7ngs3f70";
        authors = [
          "Wenping Guo <ybyygu@gmail.com>"
        ];
        dependencies = [
      ...
      "octree" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0jdnks283ap2ran4z30r8lxyknkzwm0s9xk7ayhk79828j8srd5c";
        authors = [
          "Wenping Guo <ybyygu@gmail.com>"
        ];
        dependencies = [
      ...
      "vecfx" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0h96awsbap6dq4qw0gr94gdg2n56ib1na8fipxn7lq589p8277bm";
        authors = [
          "Wenping Guo <ybyygu@gmail.com>"
        ];
        dependencies = [
