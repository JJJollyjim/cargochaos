...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cologen/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "getopt" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "08pw5r3khnrpn14mad1v4b8w6fsajznjhx66p9l3l0n0vym2alm9";
        authors = [
          "David Wildasin <dragonmaus@posteo.net>"
        ];
