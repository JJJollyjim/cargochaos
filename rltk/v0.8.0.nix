...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rltk/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_animation" "amethyst_audio" "amethyst_locale" "amethyst_network" "amethyst_rendy" "amethyst_tiles" "animation" "audio" "default" "locale" "metal" "network" "renderer" "tiles" "vulkan" ];
      };
      ...
      "amethyst_rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_window" "metal" "vulkan" "vulkan-x11" "window" ];
      };
      "amethyst_tiles" = rec {
        crateName = "amethyst_tiles";
        version = "0.3.0";
        edition = "2018";
        sha256 = "163vxlp04aiagiz6yr2bhmfgkxl7qqyk6n1cj2w1w1s9ah709f2g";
        authors = [
      ...
      "bracket-algorithm-traits" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "1dj3q1lx15pi1kz13ld110kxy2a0aykhb78gc6zmi380mzvh76v3";
        authors = [
      ...
      "bracket-color" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "05nwyx20qidksh42sqqzk4va049n4zq519q2nf6igp261lllx52x";
        authors = [
          "Herbert Wolverson <herberticus@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "byteorder" "lazy_static" "palette" "parking_lot" "rex" "serde" ];
      };
      "bracket-geometry" = rec {
        crateName = "bracket-geometry";
        version = "0.8.0";
        edition = "2018";
        sha256 = "18yi5nzbs5y91g1i5mn26dgbqy4ji6j4h1m6vkgr1493wlgyqrva";
        authors = [
          "Herbert Wolverson <herberticus@gmail.com>"
        ];
        dependencies = [
      ...
      "bracket-lib" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "17i88hw5mfxb9r1rnhph9ixxfb0kqxxns7sl5rs207kly9dcd0xd";
        authors = [
          "Herbert Wolverson <herberticus@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "amethyst_engine_metal" "amethyst_engine_vulkan" "crossterm" "curses" "opengl" "serde" "specs" "threaded" ];
      };
      "bracket-noise" = rec {
        crateName = "bracket-noise";
        version = "0.8.0";
        edition = "2018";
        sha256 = "1z0ljmnbl26v816nwhwal9d60vzdl02qpnif18gq3pb3ih522krb";
        authors = [
          "Herbert Wolverson <herberticus@gmail.com>"
        ];
        dependencies = [
      ...
      "bracket-pathfinding" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0skbw8xfz0lbnldf9578rwzqgzsrs7q9fx8mjq4vsaiivn7fhmr7";
        authors = [
          "Herbert Wolverson <herberticus@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "rayon" "threaded" ];
      };
      "bracket-random" = rec {
      ...
      "bracket-terminal" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "06iw4zslrm14mbpi1d8x9krl5cxs6nxdzy4dysxvlabzng27misr";
        authors = [
          "Herbert Wolverson <herberticus@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "amethyst" "amethyst_engine_metal" "amethyst_engine_vulkan" "crossterm" "curses" "glow" "glutin" "image" "opengl" "pancurses" ];
      };
      "build_const" = rec {
      ...
      "rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "base" "command" "descriptor" "factory" "frame" "graph" "memory" "mesh" "mesh-obj" "metal" "rendy-command" "rendy-descriptor" "rendy-factory" "rendy-frame" "rendy-graph" "rendy-memory" "rendy-mesh" "rendy-resource" "rendy-shader" "rendy-texture" "rendy-wsi" "resource" "serde-1" "shader" "texture" "texture-image" "texture-palette" "vulkan" "vulkan-x11" "wsi" "wsi-winit" ];
      };
      "rendy-chain" = rec {
      ...
      "rendy-util" = rec {
        ...
        resolvedDefaultFeatures = [ "gfx-backend-metal" "gfx-backend-vulkan" "serde" "serde-1" "vulkan" "vulkan-x11" ];
      };
      "rendy-wsi" = rec {
        crateName = "rendy-wsi";
        version = "0.4.1";
      ...
      "rltk" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_engine_metal" "amethyst_engine_vulkan" "crossterm" "curses" "default" "opengl" "serde" "specs" "threaded" ];
      };
      "rodio" = rec {
        crateName = "rodio";
        version = "0.11.0";
      ...
      "specs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "parallel" "rayon" "shred-derive" "specs-derive" ];
      };
      "specs-derive" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "basetsd" "combaseapi" "coml2api" "commctrl" "consoleapi" "debug" "devpkey" "dwmapi" "dwrite" "dwrite_1" "dwrite_3" "errhandlingapi" "fileapi" "handleapi" "hidusage" "impl-debug" "impl-default" "knownfolders" "ksmedia" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "mmdeviceapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "profileapi" "shellapi" "shellscalingapi" "shlobj" "shobjidl_core" "std" "synchapi" "sysinfoapi" "timezoneapi" "unknwnbase" "winbase" "wincon" "windef" "windowsx" "winerror" "wingdi" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
