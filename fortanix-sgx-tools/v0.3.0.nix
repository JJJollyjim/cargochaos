...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fortanix-sgx-tools/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "aesm-client" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1nwxw604ydvfl0d4d0ara4zkc1qldjlvmclf29h7qbsawyj7krzf";
        authors = [
          "Fortanix, Inc."
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "enclaveapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "objbase" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
