...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-jobs3-cli/v1.0.13+20200409.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-jobs3" = rec {
        crateName = "google-jobs3";
        version = "1.0.13+20200409";
        edition = "2015";
        sha256 = "0w8zhgcfwghyjm0i1mscs0ihzni7q981mkkvcs4qfqvcs4m16wkb";
        authors = [
      ...
      "google-jobs3-cli" = rec {
        crateName = "google-jobs3-cli";
        version = "1.0.13+20200409";
        edition = "2015";
        crateBin = [
          { name = "jobs3"; path = "src/main.rs"; }
        ];
