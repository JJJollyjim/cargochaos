...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/abuseipdb/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jsonapi" = rec {
        ...
        version = "0.6.5";
        edition = "2015";
        sha256 = "1a8w1282kg4ypq08yv6kpnd82wpimk07qziqk85pbr0r6zj9wn8q";
        authors = [
          "Michiel Kalkman <michiel@nosuchtype.com>"
        ];
        dependencies = [
          {
            name = "error-chain";
      ...
      "queryst" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "00flhdbf4shdrk4y8n6rdm0zagiw68761r02zkwipy5ylnf7icgw";
        authors = [
          "Stanislav Panferov <fnight.m@gmail.com>"
          "Robert Lord <hello@lord.io>"
        ];
        dependencies = [
          {
            name = "lazy_static";
