...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/abuseipdb/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jsonapi" = rec {
        ...
        version = "0.6.6";
        edition = "2015";
        sha256 = "1dcp3r70dpii7aqpq6pykxy0f7043a8fdzl0xpxpkh316ddf6kw1";
        authors = [
      ...
      "queryst" = rec {
        ...
        version = "2.0.1";
        edition = "2015";
        sha256 = "1d7jaw8riajjjcwgx2c01c4bz35rfhdc3br9y82alsb4g7dlkwy4";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "regex" "regex1" ];
      };
      "quote" = rec {
        crateName = "quote";
        version = "1.0.3";
