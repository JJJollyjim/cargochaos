...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/javadec-rs/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "javaclass-rs" = rec {
        crateName = "javaclass-rs";
        version = "0.1.0";
        edition = "2018";
        sha256 = "16xrriidiwkchznx8p2gj92093d127ajbc2jq1070mqh89iz246d";
        libName = "javaclass";
        authors = [
          "Ian Rehwinkel <ian.rehwinkel@tutanota.com>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "javadec-rs" = rec {
        crateName = "javadec-rs";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "javadec"; path = "src/main.rs"; }
        ];
