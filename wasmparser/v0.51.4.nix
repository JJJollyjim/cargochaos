...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasmparser/v0.51.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasmparser" = rec {
        ...
        version = "0.51.4";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.51.4.nix {};
        authors = [
      ...
      "wast" = rec {
        ...
        version = "7.0.0";
        edition = "2018";
        sha256 = "0g8nbprm5cfaiznl8s29z6a977vj4zag4wgs162rrcnyfv82k9qj";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
