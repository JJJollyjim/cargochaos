...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/emojihash-rs/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "emojihash-rs" = rec {
        crateName = "emojihash-rs";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "emojihash-rs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        libName = "emojihash";
        authors = [
          "Markus Becker <mtib.becker@gmail.com>"
        ];
        dependencies = [
          {
            name = "sha2";
