...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sel/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sel" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "sel"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "SpiritCS <sp1ritcs@protonmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "victoria-dom" = rec {
        crateName = "victoria-dom";
        version = "0.1.2";
        edition = "2015";
        sha256 = "00is508vxg3zdcfrb55nxm04m056zc22svriq5qf1vq37qsjxvr7";
        authors = [
