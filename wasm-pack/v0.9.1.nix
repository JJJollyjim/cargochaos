...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasm-pack/v0.9.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "binary-install" = rec {
        ...
        version = "0.0.2";
        edition = "2015";
        sha256 = "1m2czm8wa8pnxh3q3mj3zm9cppa2kyvxlg9h1c6simhdqpwcanvv";
        authors = [
          "The wasm-pack team"
        ];
        dependencies = [
      ...
      "wasm-pack" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "wasm-pack"; path = "src/main.rs"; }
        ];
