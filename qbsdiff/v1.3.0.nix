...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/qbsdiff/v1.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "qbsdiff 1.2.1" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0kpx30z4mvs7grp0impm299iim9c7rcvqss383bms5pv8y5i41j8";
        authors = [
          "hucsmn <hucsmn@hotmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "qbsdiff 1.3.0" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "qbsdiff"; path = "cmd/qbsdiff.rs"; }
          { name = "qbspatch"; path = "cmd/qbspatch.rs"; }
        ];
        ...
        devDependencies = [
          ...
          }
          {
            ...
            packageId = "qbsdiff_test_bench_utils";
          }
        ];
        features = {
          "cmd" = [ "clap" ];
        };
        resolvedDefaultFeatures = [ "clap" "cmd" "default" ];
      };
      "qbsdiff_test_bench_utils" = rec {
        crateName = "qbsdiff_test_bench_utils";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1qih45mgm6hwa4ysrzh0cgc1g4fnnf715n6c0jl71bbiix6lfni4";
        authors = [
          "hucsmn <hucsmn@hotmail.com>"
        ];
        dependencies = [
      ...
      "suffix_array" = rec {
        crateName = "suffix_array";
        version = "0.4.0";
        edition = "2018";
        sha256 = "0ki1cfc624snrv5fgfvabgrqs965gvpjksafs09xvq12v4pg4495";
        authors = [
          "hucsmn <hucsmn@hotmail.com>"
        ];
        dependencies = [
