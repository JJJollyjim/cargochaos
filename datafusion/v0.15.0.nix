...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/datafusion/v0.15.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arrow" = rec {
        ...
        version = "0.15.0";
        edition = "2018";
        sha256 = "1wjcwhpg895gv59ssqxcqh2l7z86xymra4hwf161cl2cifsb4knb";
        authors = [
      ...
      "parquet" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1i1vzdnm57vas3mzh49h1ifd4w8mm4hiy0z7sl2x72f3dkrrhpjg";
        authors = [
          "Apache Arrow <dev@arrow.apache.org>"
        ];
        dependencies = [
