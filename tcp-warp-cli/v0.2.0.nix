...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tcp-warp-cli/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tcp-warp" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0bngcpwbanr3wr835243birv6lsv95i63cc6iq893p6nnkxm1rf5";
        libName = "tcpwarp";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "dns" "io-util" "tcp" "rt-core" "sync" "stream" "time" ];
          }
          {
            name = "tokio-util";
      ...
      "tcp-warp-cli" = rec {
        crateName = "tcp-warp-cli";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "tcp-warp"; path = "src/main.rs"; }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "stream" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
