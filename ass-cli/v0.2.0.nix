...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ass-cli/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ass-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ass-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Michael A. Plikk <michael@plikk.com>"
        ];
        dependencies = [
          {
            name = "ass-rs";
      ...
      "ass-rs" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "0bkgnwxm3m0kzjfj1yywjvmkg2ccdp863dihrh4qi4w37a7slapn";
        authors = [
          "Michael A. Plikk <michael@plikk.com>"
        ];
        dependencies = [
      ...
      "h2" = rec {
        ...
        version = "0.1.15";
        edition = "2015";
        sha256 = "0gy43dlg1h7k1qbsvrv30q0zb1cf3y2hb5ibvvdgwzsdbgjviq1h";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
      ...
      "hyper" = rec {
        ...
        version = "0.12.21";
        edition = "2015";
        sha256 = "0ar3ac1b0l9pfvnvlilhy132gf7aai90wknrsaw3b05c04yilsvd";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
      ...
      "proc-macro2" = rec {
        ...
        version = "0.4.25";
        edition = "2015";
        sha256 = "0zalkyqz1zvzbs0z4szzpg75hygfpf4w07rm9sap9an989qpnyfk";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "reqwest" = rec {
        ...
        version = "0.9.8";
        edition = "2015";
        sha256 = "0vxiybrmvmsmf9g6qvgkrrk2j3gh97jxsmcdh6ac459rmxlz2q0f";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
      ...
      "ring" = rec {
        ...
        version = "0.14.2";
        edition = "2018";
        sha256 = "1nbqpzsmiq9byzf86934hhgkszx373fbl97vybfx1pd5wz9cc7w9";
        authors = [
      ...
      "winapi 0.3.6" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
