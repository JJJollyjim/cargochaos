...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pprof/v0.3.16.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "inferno" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "16rqvi920782mvw0bg6kkss12p3qzz89521wy6hsdbc6qbw56b9s";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwindef" "std" "sysinfoapi" "winbase" "winerror" ];
      };
