...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/remarkjs/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-files" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "1ix0y4yflg6n31nvizcqbmb5gssk2p3134bpqp60zq7lgi2ifxsk";
        libName = "actix_files";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "remarkjs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "remarkjs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Siyun Wu <siwu@linkedin.com>"
        ];
        dependencies = [
          {
            name = "actix-files";
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "shellapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
