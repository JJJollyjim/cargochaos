...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/font-kit/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "font-kit" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "freetype" "loader-freetype" "loader-freetype-default" "servo-fontconfig" "source" "source-fontconfig" "source-fontconfig-default" ];
      };
      "foreign-types" = rec {
      ...
      "freetype-sys" = rec {
        ...
        version = "0.11.0";
        edition = "2015";
        sha256 = "1spk6igzacbblm9mxv9dqm7rfjhvqpbrirf8bq8pmm3d6v7c12nl";
        authors = [
      ...
      "servo-fontconfig 0.4.0" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "servo-fontconfig-sys 4.0.6";
          }
        ];
        
      };
      "servo-fontconfig 0.5.0" = rec {
        crateName = "servo-fontconfig";
        version = "0.5.0";
        edition = "2015";
        sha256 = "0w1c7vhg77yr5b2jzs54v9aviw4m0p34jsbmij1mbysjkkvgwiqb";
        libName = "fontconfig";
        authors = [
          "The Servo Project Developers"
        ];
        dependencies = [
          ...
          {
            name = "servo-fontconfig-sys";
            packageId = "servo-fontconfig-sys 5.0.1";
          }
        ];
        
      };
      "servo-fontconfig-sys 4.0.6" = rec {
        crateName = "servo-fontconfig-sys";
        version = "4.0.6";
        edition = "2015";
        sha256 = "050s9vj7j4a6gnvsslk50nk4hd60x3502vzkma4g2mfvaq40iamh";
      ...
      "servo-fontconfig-sys 5.0.1" = rec {
        crateName = "servo-fontconfig-sys";
        version = "5.0.1";
        edition = "2015";
        sha256 = "1pynwm13q8ckajm1kyzz94znn8nhgqkn3awh7m1nyzwmq918sphw";
        libName = "fontconfig_sys";
        libPath = "lib.rs";
        authors = [
          "Keith Packard <keithp@keithp.com>"
      ...
      "servo-freetype-sys" = rec {
        ...
        version = "4.0.3";
        edition = "2015";
        sha256 = "06qd0qh26nwhs6js06s9apk1c8xira22qmn6h818q4c55qn06clj";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dwrite" "dwrite_1" "dwrite_3" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "unknwnbase" "winbase" "wincon" "winerror" "winnls" "winnt" ];
      };
