...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-oslogin1-cli/v1.0.13+20200329.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-oslogin1" = rec {
        crateName = "google-oslogin1";
        version = "1.0.13+20200329";
        edition = "2015";
        sha256 = "0f9xh71cb576f9qn4gpjwpwzxj48n5jpkj4rkn93calx8i4vh7x7";
        authors = [
      ...
      "google-oslogin1-cli" = rec {
        crateName = "google-oslogin1-cli";
        version = "1.0.13+20200329";
        edition = "2015";
        crateBin = [
          { name = "oslogin1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-oslogin1";
            packageId = "google-oslogin1";
          }
          {
            name = "hyper";
            packageId = "hyper";
