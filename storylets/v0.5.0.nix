...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/storylets/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "storylets" = rec {
        ...
        authors = [
          "Tobias Mansfield-Williams <contact@tmwhere.com>"
        ];
        dependencies = [
          {
            name = "rand";
      ...
      "throne" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "06k918nlrib8fppdl2lvpq82ljsni45c025msavd16nd86njix64";
        authors = [
          "Tobias Mansfield-Williams <contact@tmwhere.com>"
        ];
        dependencies = [
