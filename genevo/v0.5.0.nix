...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/genevo/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "galvanic-assert" = rec {
        crateName = "galvanic-assert";
        version = "0.8.7";
        edition = "2015";
        sha256 = "0h5v0hk7idyzgpb9xqa2ji9zb9l4fjzd1j82hkqv8f4mh9n93yrs";
        authors = [
      ...
      "genevo" = rec {
        ...
        resolvedDefaultFeatures = [ "fixedbitset" "smallvec" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.13";
