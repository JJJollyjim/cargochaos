...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xio_webclient/v0.18.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ommui_file_loading" = rec {
        crateName = "ommui_file_loading";
        version = "0.7.0";
        edition = "2015";
        sha256 = "0zp95mj7ml27vzf7ksiy8bnci1lgcgv8sgxff1p13f9r2zy0zjzq";
        authors = [
      ...
      "ommui_string_patterns" = rec {
        crateName = "ommui_string_patterns";
        version = "0.1.2";
        edition = "2015";
        sha256 = "1f20w0pd5sk83c9zxd4pz9zly780vw84v5nqjj5p7cwgdn0shscz";
        authors = [
          "Wolfgang Silbermayr <wolfgang@silbermayr.at>"
        ];
        dependencies = [
      ...
      "ws" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "0cd633b4r2d6956n8pajm1kh61gn1gsi112074b4vzv3csw5nvwa";
        authors = [
      ...
      "xio_base_datatypes" = rec {
        crateName = "xio_base_datatypes";
        version = "0.8.0";
        edition = "2015";
        sha256 = "1r3zz65i80vnapzb0d910ld7nbngas68gz05imzllh7if2z2li9d";
        authors = [
          "Wolfgang Silbermayr <wolfgang@silbermayr.at>"
        ];
        dependencies = [
      ...
      "xio_hwdb" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "1lw9dx81dizya7vrblbh4kz5m1w07wl7g553hk01hccxmh0b1nyw";
        authors = [
          "Wolfgang Silbermayr <wolfgang@silbermayr.at>"
        ];
        dependencies = [
          ...
          {
            name = "ommui_file_loading";
            packageId = "ommui_file_loading";
          }
          {
            name = "ommui_string_patterns";
            packageId = "ommui_string_patterns";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "xio_jobset" = rec {
        crateName = "xio_jobset";
        version = "0.13.0";
        edition = "2015";
        crateBin = [];
        sha256 = "0bs1lxw9v4sf0937dzfqhca5jiz4d4vs7vsyqbb88m9d0l0mdfxa";
        authors = [
          "Wolfgang Silbermayr <wolfgang@silbermayr.at>"
        ];
        dependencies = [
      ...
      "xio_webapi" = rec {
        crateName = "xio_webapi";
        version = "0.19.0";
        edition = "2015";
        crateBin = [];
        sha256 = "0iph0mpz2qibjr04v14hkvqydl90yav8aapn0jknw0dqrxgv30zv";
        authors = [
          "Wolfgang Silbermayr <wolfgang@silbermayr.at>"
        ];
        dependencies = [
        ...
        features = {
          "default" = [ "tools" ];
          "tools" = [ "serde_json" "snafu" "structopt" "csv" ];
        };
        resolvedDefaultFeatures = [ "csv" "default" "serde_json" "snafu" "structopt" "tools" ];
      };
      "xio_webclient" = rec {
        crateName = "xio_webclient";
        version = "0.18.1";
        edition = "2015";
        crateBin = [
          { name = "xioclient"; path = "src/bin/xioclient.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "xio_webapi";
            packageId = "xio_webapi";
          }
        ];
        features = {
          "clienttool" = [ "prettytable-rs" ];
          "default" = [ "clienttool" ];
        };
        resolvedDefaultFeatures = [ "clienttool" "default" "noclienttool" "prettytable-rs" ];
      };
    };
