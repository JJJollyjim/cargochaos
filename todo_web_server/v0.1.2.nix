...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/todo_web_server/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "todo_app_server" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1syifqwwyhgkrxaxsrad78hwm266x9cqx85nmjalyb0ykvvi3krv";
        authors = [
      ...
      "todo_web_server" = rec {
        crateName = "todo_web_server";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "todo_web"; path = "src/bin/todo_web.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
