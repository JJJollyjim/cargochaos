...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tectonic/v0.1.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tectonic" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tectonic"; path = "src/bin/tectonic.rs"; }
        ];
        ...
        buildDependencies = [
          ...
          }
          {
            ...
            packageId = "tectonic_cfg_support";
          }
          {
            name = "vcpkg";
            packageId = "vcpkg";
        ...
        resolvedDefaultFeatures = [ "default" "profile" "serde" "serialization" "toml" ];
      };
      "tectonic_cfg_support" = rec {
        crateName = "tectonic_cfg_support";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1yrn27j2ggdg2ndm54qm9qnv5hcg80f3whc3qsk851wdm76i2hpg";
        authors = [
      ...
      "tectonic_xdv" = rec {
        crateName = "tectonic_xdv";
        version = "0.1.8";
        edition = "2015";
        sha256 = "0xyn88xh103jq7xqbjz4ryzi0ys3zbgw934m0adpppcwajvmbfyb";
        authors = [
          "Peter Williams <peter@newton.cx>"
        ];
        dependencies = [
