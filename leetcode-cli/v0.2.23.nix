...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/leetcode-cli/v0.2.23.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "precommit-hook" "user-hooks" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "leetcode-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "leetcode"; path = "src/bin/lc.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.23.nix {};
        authors = [
          "clearloop <cdr.today@foxmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "pym" "pyo3" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.67";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincred" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
