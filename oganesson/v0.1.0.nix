...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oganesson/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oci" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1a5xvgjw90qch9bm9jnwszdg3xsbs32gv1ap19pgfi4f11cv94k9";
        authors = [
          "iceyer <me@iceyer.net>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "oganesson" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "oganesson"; path = "src/main.rs"; }
        ];
