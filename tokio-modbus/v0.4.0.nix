...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-modbus/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "iovec" "lazy_static" "libc" "macros" "mio" "mio-uds" "net" "rt-core" "tcp" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "tokio-modbus" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures" "net2" "rtu" "server" "sync" "tcp" "tcp-server-unstable" "tokio-serial" ];
      };
      "tokio-serial" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "cguid" "commapi" "consoleapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "setupapi" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
