...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fenestroj/v0.0.10-alpha.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "chlorine" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "1w089qgizw7ccw7zyczq3f6sjmddr6n4xkv66wq5qs01y9i2ph4l";
        authors = [
      ...
      "fenestroj" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.10-alpha.0.nix {};
        authors = [
          "Lokathor <zefria@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "profileapi" "winbase" "wincon" "wincontypes" "windef" "winerror" "wingdi" "winnt" "winuser" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.66";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-default" "libloaderapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "profileapi" "winbase" "wincon" "wincontypes" "windef" "winerror" "wingdi" "winnt" "winuser" ];
      };
