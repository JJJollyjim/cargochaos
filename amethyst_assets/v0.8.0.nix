...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst_assets/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst_assets" = rec {
        ...
        resolvedDefaultFeatures = [ "float64" "json" "nightly" "profiler" "serde_json" "thread_profiler" ];
      };
      "amethyst_core" = rec {
        ...
        resolvedDefaultFeatures = [ "float64" "nightly" ];
      };
      "amethyst_error" = rec {
