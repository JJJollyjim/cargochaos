...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-pack-docker/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-pack" = rec {
        crateName = "cargo-pack";
        version = "0.6.0";
        edition = "2018";
        sha256 = "1na9r67fz5k2734rjjphwsf5n391li96hsw9032g5p46lw2phkgi";
        authors = [
      ...
      "cargo-pack-docker" = rec {
        crateName = "cargo-pack-docker";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-pack-docker"; path = "src/main.rs"; }
        ];
