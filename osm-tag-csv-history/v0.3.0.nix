...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/osm-tag-csv-history/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "do_every" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1mjsp56qn009ar8mkap2gvmfqyqykhr9qhbalf17x2dhfmfbxnxk";
        authors = [
      ...
      "osm-tag-csv-history" = rec {
        crateName = "osm-tag-csv-history";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "osm-tag-csv-history"; path = "src/main.rs"; }
        ];
      ...
      "osmio" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "08nl5fxs0anjxvalca777izcl3p9213ppcswbji84ibc1xgf85bz";
        authors = [
          "Rory McCann <rory@technomancy.org>"
        ];
        dependencies = [
      ...
      "read-progress" = rec {
        crateName = "read-progress";
        version = "0.2.0";
        edition = "2018";
        sha256 = "04955c6z2451licarkkz64nv9ryf9imsn2s1655z9bfvm2mfz833";
        authors = [
          "Rory McCann <rory@technomancy.org>"
        ];
