...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-test-all/v0.1.0.nix.tmp"
    ...
    crates = {
      ...
      "cargo 0.30.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "git2";
            packageId = "git2 0.7.5";
          }
          {
            name = "git2-curl";
            packageId = "git2-curl 0.8.2";
          }
          {
            name = "glob";
      ...
      "cargo 0.37.0" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0cyqxkw8di9zhq0dk1xjc7lr43zbl8j14a9zs7zqffyyy1slp4p6";
        libPath = "src/cargo/lib.rs";
        authors = [
          "Yehuda Katz <wycats@gmail.com>"
          "Carl Lerche <me@carllerche.com>"
        ...
        dependencies = [
          ...
          {
            name = "git2";
            packageId = "git2 0.8.0";
          }
          {
            name = "git2-curl";
            packageId = "git2-curl 0.9.0";
          }
          {
            name = "glob";
      ...
      "cargo-clone" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0hlmwr0wc1zdbsynnxvs4v4r20kw8ywp45fbzrzwm1lb51rya0pc";
        authors = [
      ...
      "crates-io 0.25.0" = rec {
        crateName = "crates-io";
        version = "0.25.0";
        edition = "2018";
        sha256 = "0skxmcrkvg0gz4a66wgbzhc91qy2m8917k8gnps3bxijxd7wfl6m";
        libName = "crates_io";
        libPath = "lib.rs";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
