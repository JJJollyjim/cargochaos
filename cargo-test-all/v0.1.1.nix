...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-test-all/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-clone" = rec {
        crateName = "cargo-clone";
        version = "0.1.4";
        edition = "2018";
        crateBin = [];
        sha256 = "0ai15jqlxnkwwkdqcyzlbh7phl1li6cas5xzyzk78af2rx7g833q";
        authors = [
      ...
      "cargo-test-all" = rec {
        crateName = "cargo-test-all";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-test-all"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          {
            name = "cargo";
            packageId = "cargo 0.42.0";
          }
          {
            name = "cargo-clone";
            packageId = "cargo-clone";
          }
          {
            name = "failure";
            packageId = "failure";
      ...
      "psm" = rec {
        ...
        version = "0.1.6";
        edition = "2015";
        sha256 = "1q1hdbnp2j3zz1vhzp1xhds6ynan3mg5bhjlhfy5m1sg8n5wckxi";
        authors = [
      ...
      "rm_rf" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0ywr1d2ac8d9qcrzz5a8nfgagnkwszkjsz411sfwhf96565j15h3";
        authors = [
