...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pwfr/v0.0.0-none.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pwfr" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pwfr"; path = "src/bin/pwfr/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.0-none.nix {};
        libPath = "src/pwfr/lib.rs";
        authors = [
