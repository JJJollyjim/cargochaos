...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/slr_config/v0.0.20.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "slr_config" = rec {
        crateName = "slr_config";
        version = "0.0.20";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.0.20.nix {};
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "slr_parser";
            packageId = "slr_parser";
          }
        ];
        
      };
      "slr_parser" = rec {
        crateName = "slr_parser";
        version = "0.0.20";
        edition = "2015";
        sha256 = "0lxlcg0afwpdacxnn2k87mn3j26crjjh2xqnq1vgfdnf7z0cmn55";
        authors = [
          "SiegeLord <slabode@aim.com>"
        ];
        dependencies = [
