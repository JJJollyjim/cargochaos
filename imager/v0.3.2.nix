...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imager/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colourado" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0zkj7cv8g1ikyya2zqvdjyhkq7i6nbhb5a3xj4x843z6qrzb8l8x";
        authors = [
          "PrydeRage <marius.brandt@hotmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
      ...
      "imager" = rec {
        ...
        resolvedDefaultFeatures = [ "buildtype-docs-only" "default" ];
      };
      "indexmap" = rec {
        crateName = "indexmap";
        version = "1.3.0";
      ...
      "mozjpeg-sys" = rec {
        ...
        version = "0.10.2";
        edition = "2018";
        sha256 = "1sx870kggbv57xs5jpp29z2bfkbc64rhpg55ajg65vpbd2acxfrc";
        build = "src/build.rs";
        libName = "mozjpeg_sys";type = [ "staticlib" "cdylib" "lib" ];
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "nasm-rs" "nasm_simd" "with_simd" ];
      };
      "nasm-rs" = rec {
        crateName = "nasm-rs";
        version = "0.1.5";
        edition = "2015";
        sha256 = "0mvyvkr9m5ablbmr43rc9qh8jk7vp2gimq1igvjr05zlkn66saw8";
        authors = [
      ...
      "rgb2yuv420" = rec {
        crateName = "rgb2yuv420";
        version = "0.2.3";
        edition = "2015";
        sha256 = "0fs5yabi09h33f0npvwckwb5pyd99a0hkini9qhbp8lk2m1svwsc";
        authors = [
          "Marcell Bán <Marcell.Ban@ccsys.eu>"
        ];
      ...
      "vmaf-sys" = rec {
        ...
        version = "0.0.10";
        edition = "2018";
        sha256 = "13761f3s6srld3zq6sfqawlij3mm8mp9nip0bpy6xph708kcx9jm";
        authors = [
          "colbyn <hello@colbyn.com>"
        ];
        dependencies = [
      ...
      "webp-dev" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0irq02ixh2mg882xxvnicyr65kwrpksl8cpk19cgyl63zcyxbkdz";
        authors = [
          "colbyn <hello@colbyn.com>"
        ];
        dependencies = [
