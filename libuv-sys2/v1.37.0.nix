...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libuv-sys2/v1.37.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libuv-sys2" = rec {
        crateName = "libuv-sys2";
        version = "1.37.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.37.0.nix {};
        authors = [
          "Bob Matcuk <bmatcuk@gmail.com>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
      ...
      "nt_version" = rec {
        crateName = "nt_version";
        version = "0.1.3";
        edition = "2018";
        sha256 = "19hl3ggrv1732z4l8cf78xcimfgm4j0jl1agr6aiin81dbyv73cm";
        authors = [
          "viri <git@stuff.moe>"
        ];
        features = {
