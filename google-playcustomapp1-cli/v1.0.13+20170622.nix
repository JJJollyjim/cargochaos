...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-playcustomapp1-cli/v1.0.13+20170622.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-playcustomapp1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-playcustomapp1" = rec {
        crateName = "google-playcustomapp1";
        version = "1.0.13+20170622";
        edition = "2015";
        sha256 = "0qnd7zwivwqbv8fwgfnz7bjcip2mmmjamnyl98kzdria7xp34n2v";
        authors = [
      ...
      "google-playcustomapp1-cli" = rec {
        crateName = "google-playcustomapp1-cli";
        version = "1.0.13+20170622";
        edition = "2015";
        crateBin = [
          { name = "playcustomapp1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20170622.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-playcustomapp1";
            packageId = "google-playcustomapp1";
          }
          {
            name = "hyper";
            packageId = "hyper";
