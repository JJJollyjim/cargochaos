...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rtforth/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "approx" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "14rdksmdq5fg4m9c746r54fwgyp1p72m086n6cjac0blphf9cd71";
        authors = [
      ...
      "hibitset" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "10msjhlzkismxhjpnin2b5vihv5qf9ps5mm4y7pigs8bpzpv57qy";
        authors = [
          "csheratt"
        ];
        dependencies = [
      ...
      "region" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "1rf8mrc0prl1i0pdqn2dgf2v0n9y71wi48sd0nig5xj48zv7gwfg";
        authors = [
      ...
      "rtforth" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "stc" ];
      };
      "rustc-serialize" = rec {
      ...
      "uom" = rec {
        ...
        version = "0.18.0";
        edition = "2015";
        sha256 = "1a2nq0xnqfs7lvdg1mwfcdq0amdy3yvph5nzarj6y21m4if50gss";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
