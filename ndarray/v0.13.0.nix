...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ndarray/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "defmac" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "14cqfvc0f1pkd6gdhjxa2wv3iibqprc0n203ims8lvg96752ynfm";
        authors = [
          "bluss"
        ];
      ...
      "ndarray" = rec {
        ...
        resolvedDefaultFeatures = [ "approx" "blas" "blas-src" "cblas-sys" "docs" "rayon" "serde" "serde-1" "test" "test-blas-openblas-sys" ];
      };
      "nodrop" = rec {
        crateName = "nodrop";
        version = "0.1.13";
