...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gmorph/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gmorph" = rec {
        ...
        authors = [
          "Marcin Benke <marcin.benke@golem.network>"
          "Jakub Konka <jakub.konka@golem.network>"
        ];
        dependencies = [
          {
            name = "alga";
        ...
        resolvedDefaultFeatures = [ "experimental-normalize" ];
      };
      "half" = rec {
        crateName = "half";
        version = "1.5.0";
      ...
      "modinverse" = rec {
        crateName = "modinverse";
        version = "0.1.1";
        edition = "2015";
        sha256 = "0cv6f07is62pgvksbsyc6zasfrllwli5l1p7csa1mk28y5vzaqig";
        authors = [
          "Simon Andrews <simon.andrews212@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-integer";
