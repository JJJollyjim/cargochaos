...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mpq/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "implode" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0539nm46midvr7ildf792y3992cc17qdrsq98053a32hx09fssmy";
        authors = [
          "coderbot16 <coderbot16@gmail.com>"
        ];
      ...
      "mpq" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mpq"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.7.0.nix {};
        authors = [
          "Michael Sierks <msierks117@gmail.com>"
        ];
        dependencies = [
          {
            name = "adler32";
