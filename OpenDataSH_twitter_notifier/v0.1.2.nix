...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/OpenDataSH_twitter_notifier/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "OpenDataSH_twitter_notifier";
  ...
  workspaceMembers = {
    "OpenDataSH_twitter_notifier" = rec {
      packageId = "OpenDataSH_twitter_notifier";
      build = internal.buildRustCrateWithFeatures {
        packageId = "OpenDataSH_twitter_notifier";
      };
  ...
  internal = rec {
    ...
    crates = {
      "OpenDataSH_twitter_notifier" = rec {
        crateName = "OpenDataSH_twitter_notifier";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "OpenDataSH_twitter_notifier"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Marcel Radzio <mtrnord1@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "egg-mode" = rec {
        ...
        resolvedDefaultFeatures = [ "hyper-rustls" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.5.2";
      ...
      "twitter-text" = rec {
        crateName = "twitter-text";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0766mgds4gl0a0rk0hk903vhjfgmj2zhmb5rnf26cbfifv1cz98d";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "twitter_text_config";
          }
          {
            name = "twitter_text_parser";
            packageId = "twitter_text_parser";
          }
          {
            name = "unicode-normalization";
            packageId = "unicode-normalization";
      ...
      "twitter_text_config" = rec {
        crateName = "twitter_text_config";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0n8k0cy0cdmd2qxq4crhwk21bwfs0skl56vhvqn8ccpwqh5jfscz";
        authors = [
          "Robert Sayre <sayrer@gmail.com>"
        ];
        dependencies = [
      ...
      "twitter_text_parser" = rec {
        crateName = "twitter_text_parser";
        version = "0.1.0";
        edition = "2018";
        sha256 = "08m7ljf027dybpnqin562y93l6f6fhrkvj8hd2s9h4d2l92lqdnb";
        authors = [
          "Robert Sayre <sayrer@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
