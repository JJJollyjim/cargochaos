...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shader-translator/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shader-translator" = rec {
        crateName = "shader-translator";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "shader-translator"; path = "src/main.rs"; }
        ];
