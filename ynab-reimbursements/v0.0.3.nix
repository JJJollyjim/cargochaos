...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ynab-reimbursements/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "ynab-api" = rec {
        ...
        version = "3.0.0";
        edition = "2015";
        sha256 = "0i69dz3vcx8k4bk9ayz82m2f0c4w7ngas7z4znn75b1brc9fmdcp";
        authors = [
      ...
      "ynab-reimbursements" = rec {
        crateName = "ynab-reimbursements";
        version = "0.0.3";
        edition = "2018";
        crateBin = [
          { name = "ynab-reimbursements"; path = "src/main.rs"; }
        ];
