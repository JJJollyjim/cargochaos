...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-ssl-acme-cloudflare/v1.0.7.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "simple-ssl-acme-cloudflare";
  ...
  workspaceMembers = {
    "simple-ssl-acme-cloudflare" = rec {
      packageId = "simple-ssl-acme-cloudflare";
      build = internal.buildRustCrateWithFeatures {
        packageId = "simple-ssl-acme-cloudflare";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple-ssl-acme-cloudflare" = rec {
        crateName = "simple-ssl-acme-cloudflare";
        version = "1.0.7";
        edition = "2018";
        crateBin = [
          { name = "simple-ssl-acme-cloudflare"; path = "src/main.rs"; }
        ];
