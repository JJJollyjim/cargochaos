...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/runt/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "runt" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "runt"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.4.nix {};
        authors = [
          "Rachit Nigam <rachit.nigam12@gmail.com>"
        ];
        dependencies = [
          {
            name = "colored";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-threaded" "process" "macros" "fs" ];
          }
          {
            name = "toml";
            packageId = "toml";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "num_cpus" "process" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "std" "synchapi" "threadpoollegacyapiset" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
