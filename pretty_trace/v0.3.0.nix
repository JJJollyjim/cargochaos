...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pretty_trace/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "io_utils" = rec {
        ...
        version = "0.2.4";
        edition = "2015";
        sha256 = "08gs01620vwba3isamyl49gnwi9w6xx8j2bak4yrdc1472gkdb5w";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "string_utils";
            packageId = "string_utils";
          }
          {
            name = "vector_utils";
            packageId = "vector_utils";
          }
        ];
      ...
      "stats_utils" = rec {
        crateName = "stats_utils";
        version = "0.1.0";
        edition = "2015";
        sha256 = "1sps310ljv3gmp7irxmqnwha8ba3a3dpklzsnp1vsjc5l1lwl9mq";
        authors = [
          "David Jaffe <david.jaffe@10xgenomics.com>"
        ];
      ...
      "string_utils" = rec {
        crateName = "string_utils";
        version = "0.1.1";
        edition = "2015";
        sha256 = "0jrq6a38cf3fdsp9yl5scpz2h1l9wdp1ggm1ymbqzyajkjppy2ld";
        authors = [
          "David Jaffe <david.jaffe@10xgenomics.com>"
        ];
        dependencies = [
      ...
      "superslice" = rec {
        crateName = "superslice";
        version = "1.0.0";
        edition = "2015";
        sha256 = "07z84bqs2kncgchrv1pafwlsqzbjm3ckw7nq5z44d2mx9pcww5mb";
        authors = [
      ...
      "vector_utils" = rec {
        crateName = "vector_utils";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0qa592as0ajr98ijzj1k835wlprw096shygdr38hp4s3q4s0rdci";
        authors = [
          "David Jaffe <david.jaffe@10xgenomics.com>"
        ];
        dependencies = [
