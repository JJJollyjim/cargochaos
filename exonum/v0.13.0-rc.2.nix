...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/exonum/v0.13.0-rc.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "exonum" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "exonum_sodiumoxide" "float_serialize" "long_benchmarks" "rocksdb_bzip2" "rocksdb_lz4" "rocksdb_snappy" "rocksdb_zlib" "rocksdb_zstd" "sodiumoxide-crypto" "with-protobuf" "with-serde" ];
      };
      "exonum-build" = rec {
      ...
      "exonum-merkledb" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "exonum-proto" "protobuf" "rocksdb_bzip2" "rocksdb_lz4" "rocksdb_snappy" "rocksdb_zlib" "rocksdb_zstd" "with-protobuf" ];
      };
      "exonum-proto" = rec {
