...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wcp/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http_io" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "1zhrc9f56ihsfvqcfg3dy6nwaxxd65xayyd65sgk55r6p69z0g6n";
        authors = [
          "Remi Bernotavicius <remi@abort.cc>"
        ];
        dependencies = [
          {
            name = "hashbrown";
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "std" ];
      };
      "indicatif" = rec {
        crateName = "indicatif";
        version = "0.13.0";
      ...
      "wcp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wcp"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Remi Bernotavicius <remi@kunugiken.com>"
        ];
        dependencies = [
          {
            name = "http_io";
