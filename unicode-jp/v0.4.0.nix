...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unicode-jp/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unicode-jp" = rec {
        crateName = "unicode-jp";
        version = "0.4.0";
        edition = "2015";
        crateBin = [
          { name = "converchar-jp"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        libName = "kana";
        libPath = "src/kana.rs";
        authors = [
          "gemmarx <gemmarx@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "clap";
