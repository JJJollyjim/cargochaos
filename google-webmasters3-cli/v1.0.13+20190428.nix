...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-webmasters3-cli/v1.0.13+20190428.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-webmasters3-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-webmasters3" = rec {
        crateName = "google-webmasters3";
        version = "1.0.13+20190428";
        edition = "2015";
        sha256 = "1vh465gchsy853jvzw2nqls689k5y2lvanki7669nwbg703lzvyc";
        authors = [
      ...
      "google-webmasters3-cli" = rec {
        crateName = "google-webmasters3-cli";
        version = "1.0.13+20190428";
        edition = "2015";
        crateBin = [
          { name = "webmasters3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190428.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
