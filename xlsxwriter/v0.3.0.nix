...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xlsxwriter/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libxlsxwriter-sys" = rec {
        crateName = "libxlsxwriter-sys";
        version = "0.9.4";
        edition = "2018";
        sha256 = "04rywjs4l5cc5rjy8ryb2a7rh9zgb739aj7zfc43bysa9j4wk4gj";
        authors = [
