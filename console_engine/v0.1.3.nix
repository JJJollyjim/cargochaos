...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/console_engine/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "console_engine" = rec {
        crateName = "console_engine";
        version = "0.1.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Vincent Foulon <sup.vfoulon@gmail.com>"
        ];
        dependencies = [
          {
            name = "termion";
