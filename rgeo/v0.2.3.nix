...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rgeo/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kdtree" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "18mip12jillxil7agmi7l5lyq9yxqikla2pwwglqg47w529kbvl0";
        authors = [
      ...
      "rgeo" = rec {
        ...
        crateBin = [
          ...
          { name = "generate"; path = "src/bin/generate.rs"; }
        ];
