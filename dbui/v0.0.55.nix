...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbui/v0.0.55.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dbui" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.0.55.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "web-view";
            packageId = "web-view";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "windows"));
          }
        ];
      ...
      "dbui-assets" = rec {
        ...
        version = "0.0.55";
        edition = "2018";
        sha256 = "050hgdfgqiw4c51agqvfnmi7nh5pb9g9zr4lwp2iq3hlylqmn7yb";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-controllers" = rec {
        ...
        version = "0.0.55";
        edition = "2018";
        sha256 = "0azp7qm8n9i01b4yddl50qk1qpfsv26q1v50xz9gnf8lhscysr0i";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-core" = rec {
        ...
        version = "0.0.55";
        edition = "2018";
        sha256 = "1z2y4s7ncszdr6idp0icdgkcbn988253aldm9vkpqksyq5rzl60m";
        authors = [
      ...
      "dbui-database" = rec {
        ...
        version = "0.0.55";
        edition = "2018";
        sha256 = "1abwzwb146hmr1x5j06y6wv720gb84b5vr7ck3ldhk94f8hnwsrd";
        authors = [
          "Kyle Unverferth <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-service" = rec {
        ...
        version = "0.0.55";
        edition = "2018";
        sha256 = "1yz2al04qiw9fljm06zdqdy5hlqlc6zh1vq2hlxb295vv90x4a2i";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-templates" = rec {
        ...
        version = "0.0.55";
        edition = "2018";
        sha256 = "07hmj50dplc5g4dgs4pmfpn85iyiyrx87mhc1wndnbz78z765db6";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
