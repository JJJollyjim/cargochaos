...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbui/v0.0.28.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dbui" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.0.28.nix {};
        authors = [
      ...
      "dbui-assets" = rec {
        ...
        version = "0.0.28";
        edition = "2018";
        sha256 = "04c4vnagzwq9isp7rak3mr8m4s54nszzw492lgnqk8xghgqa1821";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-controllers" = rec {
        ...
        version = "0.0.28";
        edition = "2018";
        sha256 = "17amm4ar7cg7zh31iwmkd6f4a9d8s1sk0d7zwxslzd30f3pnx0ps";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-core" = rec {
        ...
        version = "0.0.28";
        edition = "2018";
        sha256 = "0iqn6sljwisjnhiph1xl4mhnj5j17dvfszznrbr0565ha1x02iah";
        authors = [
      ...
      "dbui-database" = rec {
        ...
        version = "0.0.28";
        edition = "2018";
        sha256 = "0q6vijxh10spmmf935dlxbi28wa0z797sn5ymqwdskh4znmkx1dz";
        authors = [
          "Kyle Unverferth <kyle@kyleu.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "postgres";
            packageId = "postgres";
            features = [ "with-uuid" "with-serde_json" "with-chrono" "with-bit-vec" "with-eui48" "with-geo" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "dbui-templates" = rec {
        ...
        version = "0.0.28";
        edition = "2018";
        sha256 = "1fa19rzb48jqky78pb38qqiz6k6qsf9pjl8ajf5l5fv583z87kq7";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "eui48" = rec {
        ...
        version = "0.3.2";
        edition = "2015";
        sha256 = "0mmdhczfdxwv5v5h90ydqkx0mdqiv0h2clshm2cm4qlwp0gacw29";
        authors = [
      ...
      "postgres" = rec {
        ...
        resolvedDefaultFeatures = [ "with-bit-vec" "with-chrono" "with-eui48" "with-geo" "with-serde_json" "with-uuid" ];
      };
      ...
      "postgres-shared" = rec {
        ...
        resolvedDefaultFeatures = [ "bit-vec" "chrono" "eui48" "geo" "serde_json" "uuid" "with-bit-vec" "with-chrono" "with-eui48" "with-geo" "with-serde_json" "with-uuid" ];
      };
      "ppv-lite86" = rec {
