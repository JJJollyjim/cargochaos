...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbui/v0.0.53.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dbui" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.0.53.nix {};
        authors = [
      ...
      "dbui-assets" = rec {
        ...
        version = "0.0.53";
        edition = "2018";
        sha256 = "1b23hdbvfpdy44mhlphhqxgr75zyvqbaa5s0fr74lrjlfsrjb3wq";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-controllers" = rec {
        ...
        version = "0.0.53";
        edition = "2018";
        sha256 = "0zwfilm11lpxhsv9vnisags638hj9836fymjyv4sy26sy677q27z";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-core" = rec {
        ...
        version = "0.0.53";
        edition = "2018";
        sha256 = "0w2v01629vwv2hm8l30lg4sbshxmkgal8hhcvyk6zcf4ykvyn9f6";
        authors = [
      ...
      "dbui-database" = rec {
        ...
        version = "0.0.53";
        edition = "2018";
        sha256 = "1g32blwnzm8bxxi0mfi9ylrw8ak3687i34z9d2vs7rmhnm42p128";
        authors = [
          "Kyle Unverferth <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-service" = rec {
        ...
        version = "0.0.53";
        edition = "2018";
        sha256 = "1afmra67jr6rlv9sardxfnfz63zqhnic1zzb76mvxwjcn0hakb21";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-templates" = rec {
        ...
        version = "0.0.53";
        edition = "2018";
        sha256 = "1863lqzgqx3rmf5w6hzmkhzkzsxm383wk8sds19zsmysskgzlmdn";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "postgres 0.16.0-rc.2" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "log" "runtime" "tokio" "with-bit-vec-0_5" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_7" ];
      };
      ...
      "tokio-postgres" = rec {
        ...
        resolvedDefaultFeatures = [ "bit-vec-05" "chrono-04" "default" "eui48-04" "futures-cpupool" "geo-types-04" "lazy_static" "runtime" "serde-1" "serde_json-1" "tokio-tcp" "tokio-timer" "tokio-uds" "uuid-07" "with-bit-vec-0_5" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_7" ];
      };
      "tokio-reactor" = rec {
      ...
      "web-view" = rec {
        ...
        version = "0.4.5";
        edition = "2015";
        sha256 = "0nvrhpi6wqbpn5j86kvrs7s9ixnjlxl8p9lc787g9ihngc0m8679";
        authors = [
          "Boscop"
        ];
        dependencies = [
      ...
      "webview-sys" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0wx1x34rr4588h0qpw4nnwnkagzah0saallhc9m4df2aljpmyshh";
        libName = "webview_sys";
        libPath = "lib.rs";
        authors = [
          "Boscop"
