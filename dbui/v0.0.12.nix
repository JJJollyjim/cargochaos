...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbui/v0.0.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ructe" = rec {
        ...
        version = "0.7.2";
        edition = "2015";
        sha256 = "1hnlr98im83ywv71a3yj2bny5vyrb792lcyhjp9l8fdv6vaw2xdl";
        authors = [
        ...
        resolvedDefaultFeatures = [ "mime" "mime03" ];
      };
      "rust-argon2" = rec {
