...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbui/v0.0.54.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "actix-server-config 0.1.2";
          }
          {
            name = "actix-service";
            packageId = "actix-service";
      ...
      "actix-server 0.7.0" = rec {
        crateName = "actix-server";
        version = "0.7.0";
        edition = "2018";
        sha256 = "1mxiy4zdnzlk65xla650ac07l4dkz5ywbqp19csb9x8xy5xvcjnw";
        libName = "actix_server";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "actix-server-config";
            packageId = "actix-server-config 0.2.0";
          }
          {
            name = "actix-service";
            packageId = "actix-service";
      ...
      "actix-server-config 0.2.0" = rec {
        crateName = "actix-server-config";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0g0fpw5wryzgbsd46y3zl0lwjwwy2qf1qvznvcaw72b0m1z0w7za";
        libName = "actix_server_config";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "base64-url" = rec {
        ...
        version = "1.1.12";
        edition = "2018";
        sha256 = "1ask4awk6nb3px5azkg75fi17mybd295gfpxg0xrd6bbqdzgh4h7";
        authors = [
      ...
      "dbui" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.0.54.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "web-view";
            packageId = "web-view";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "linux") || (target."os" == "windows"));
          }
        ];
      ...
      "dbui-assets" = rec {
        ...
        version = "0.0.54";
        edition = "2018";
        sha256 = "0nmxp4r6ahqli8h9bhci3fpkrlrsvg8x3yp11msjdj115rp4vc1r";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-controllers" = rec {
        ...
        version = "0.0.54";
        edition = "2018";
        sha256 = "14sipkjdjrv5w6kl04m7ihw0741ajrax04ahxm77n1m3lb4cfk3q";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-core" = rec {
        ...
        version = "0.0.54";
        edition = "2018";
        sha256 = "1nfyhj2b757b82k7bp20cnf7vvdsv46983jc6nbgjn3sfpxmzhq6";
        authors = [
      ...
      "dbui-database" = rec {
        ...
        version = "0.0.54";
        edition = "2018";
        sha256 = "10mw4xcz25f73qnfnhgbjwffiksyhcyk7ivanv7sxifvy3x9kg20";
        authors = [
          "Kyle Unverferth <kyle@kyleu.com>"
        ];
        dependencies = [
          ...
          {
            name = "postgres";
            packageId = "postgres 0.17.0-alpha.1";
            features = [ "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_7" ];
          }
          {
            name = "r2d2";
            packageId = "r2d2";
      ...
      "dbui-service" = rec {
        crateName = "dbui-service";
        version = "0.0.54";
        edition = "2018";
        sha256 = "1jg2l3khfzqxq81dn823sb0caqrlxh0q661y6rz75xz3c53n0qhp";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "dbui-templates" = rec {
        ...
        version = "0.0.54";
        edition = "2018";
        sha256 = "1zg4mmi6m7968x2x03skki6r5va78vvw6hpwfvb98qlbnwvzzsqp";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "postgres 0.17.0-alpha.1" = rec {
        crateName = "postgres";
        version = "0.17.0-alpha.1";
        edition = "2018";
        sha256 = "1xsmp19qn1xk6af6d4gc1j9p8nbzx7b6f04x8ix40m2scdrap9sf";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "log" "runtime" "tokio" "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_7" ];
      };
      ...
      "postgres-protocol 0.5.0-alpha.1" = rec {
        crateName = "postgres-protocol";
        version = "0.5.0-alpha.1";
        edition = "2018";
        sha256 = "191vkzhr3q8dm32pq3cnmvrzpgr6899fd1rhzcfjyrs5yyc90cr7";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "postgres-types" = rec {
        ...
        edition = "2018";
        sha256 = "0hz8dx5s6c3035b5r36ds18p1cmmky91j0x62vfh8yk21vmzi4r0";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "postgres-protocol";
            packageId = "postgres-protocol 0.5.0-alpha.1";
          }
          {
            name = "serde";
            packageId = "serde";
        ...
        resolvedDefaultFeatures = [ "bit-vec-06" "chrono-04" "eui48-04" "geo-types-04" "serde-1" "serde_json-1" "uuid-07" "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_7" ];
      };
      "ppv-lite86" = rec {
      ...
      "short-crypt" = rec {
        crateName = "short-crypt";
        version = "1.0.14";
        edition = "2018";
        sha256 = "1cqafx10m7dhv7fibsch502yrhimsnn61ynmsbb9k8zhzkpxrfkm";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "tokio-postgres" = rec {
        ...
        version = "0.5.0-alpha.1";
        edition = "2018";
        sha256 = "0iwxsgx8qqxfbn4djmxyhh8zvlkqfma60kxk9qs2j6lw4ykqc9bf";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "runtime" "with-bit-vec-0_6" "with-chrono-0_4" "with-eui48-0_4" "with-geo-types-0_4" "with-serde_json-1" "with-uuid-0_7" ];
      };
      "tokio-reactor" = rec {
      ...
      "web-view" = rec {
        ...
        version = "0.5.2";
        edition = "2015";
        sha256 = "0cgrvhynn45cvmx4qsa04v85i7mxppypsm1rka5p2y76n8qf1hcf";
        authors = [
          "Boscop"
      ...
      "webview-sys" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "0mapica5v5a7phb1v2dccvnqyih86wx2hjmcdgyh9hdnvmzn3r1k";
        libName = "webview_sys";
        libPath = "lib.rs";
        authors = [
          "Boscop"
