...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rawarray/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "microbench" = rec {
        crateName = "microbench";
        version = "0.5.0";
        edition = "2018";
        sha256 = "02ysyvxz574892a14jdrms2r5rwcjkjr3fsp88pzvrp4mr04xi64";
        authors = [
