...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markovian/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "markovian" = rec {
        ...
        authors = [
          "Raimundo Saona <rasa200@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-traits";
      ...
      "preexplorer" = rec {
        crateName = "preexplorer";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "000kzycgja1sh3cdz20yzidrp3yd0zavx2qqmwja70s4wly4n15m";
        authors = [
          "Raimundo Saona <rasa200@gmail.com>"
        ];
        dependencies = [
