...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/exonum-supervisor/v0.13.0-rc.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "exonum" = rec {
        ...
        version = "0.13.0-rc.1";
        edition = "2018";
        sha256 = "05706rhyj50g7r4ind5qfvy41316zvnb50pnbqscaj2wnp3xrvj5";
        authors = [
      ...
      "exonum-testkit" = rec {
        ...
        version = "0.13.0-rc.1";
        edition = "2018";
        sha256 = "06vclfzggyz4pv2fvkh04zfk6adrdbbw2gl020ibw0zaykcdijjr";
        authors = [
          "The Exonum Team <contact@exonum.com>"
        ];
        dependencies = [
