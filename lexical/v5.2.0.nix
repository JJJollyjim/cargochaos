...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lexical/v5.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lexical" = rec {
        ...
        version = "5.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v5.2.0.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "comprehensive_float_test" "correct" "default" "format" "grisu3" "noinline" "radix" "rand" "rounding" "ryu" "serde" "serde_derive" "std" "toml" "trim_floats" "unchecked_index" ];
      };
      "lexical-core" = rec {
        ...
        resolvedDefaultFeatures = [ "arrayvec" "correct" "dtoa" "format" "grisu3" "noinline" "radix" "rounding" "ryu" "static_assertions" "std" "table" "trim_floats" "unchecked_index" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.66";
