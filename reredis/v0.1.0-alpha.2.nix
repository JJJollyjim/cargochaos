...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reredis/v0.1.0-alpha.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "murmurhash64" = rec {
        crateName = "murmurhash64";
        version = "0.3.1";
        edition = "2015";
        sha256 = "0174pwq37czfk296rc7ibvrxgdpn0wh3nxfpada651c9x94gwags";
        authors = [
      ...
      "reredis" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "reredis"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.2.nix {};
        authors = [
          "huangjiahua <jiahua.h@outlook.com>"
        ];
        dependencies = [
          {
            name = "chrono";
