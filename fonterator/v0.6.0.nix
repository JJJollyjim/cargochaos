...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fonterator/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fonterator" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "monospace-font" "normal-font" ];
      };
      "footile" = rec {
        crateName = "footile";
        version = "0.3.1";
      ...
      "pix" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "0w66r1a133pwk6hghzpvhm9lh5108pjgxr9djlrjj6nxfcm92fsr";
        authors = [
          "Douglas Lau <doug.p.lau@gmail.com>"
        ];
      ...
      "png_pong" = rec {
        ...
        version = "0.0.2";
        edition = "2018";
        sha256 = "13jrrilx8yr5pxqswah4wdsx459wkr78f6q3a43kqvjqbkvy209k";
        authors = [
          "Jeron Aldaron Lau <jeronlau@plopgrizzly.com>"
        ];
        dependencies = [
