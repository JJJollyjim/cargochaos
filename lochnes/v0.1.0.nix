...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lochnes/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lochnes" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lochnes"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Kyle Lacy <kylelacy+git@pm.me>"
        ];
        dependencies = [
          {
            name = "bitflags";
        ...
        resolvedDefaultFeatures = [ "default" "easter-egg" ];
      };
      "log" = rec {
        crateName = "log";
        version = "0.4.8";
      ...
      "sdl2" = rec {
        ...
        version = "0.32.1";
        edition = "2015";
        sha256 = "14qm6d5wkh8csx5nql3k90i0pzz5gfbzy7x3kyjlsbnl0zr8bgqf";
      ...
      "sdl2-sys" = rec {
        ...
        version = "0.32.5";
        edition = "2015";
        sha256 = "1hg6a8rys8vz4kr3kxzgrbpc5bsk5idz5kl6i397hq9fbkl06a78";
        libName = "sdl2_sys";
        authors = [
          "Tony Aldridge <tony@angry-lawyer.com>"
        ];
