...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/quickproj/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quickproj" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "quickproj"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fibersapi" "fileapi" "handleapi" "knownfolders" "memoryapi" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
