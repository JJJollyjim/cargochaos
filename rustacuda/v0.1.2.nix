...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustacuda/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cuda-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1hz6r80ickhx2ww4xss5576vzkgx6321p1dvrmxchvqj2dsy2jxk";
        authors = [
      ...
      "rustacuda" = rec {
        ...
        dependencies = [
          ...
          {
            name = "rustacuda_core";
            packageId = "rustacuda_core";
          }
          {
            name = "rustacuda_derive";
            packageId = "rustacuda_derive";
          }
        ];
        
      };
      "rustacuda_core" = rec {
        crateName = "rustacuda_core";
        version = "0.1.1";
        edition = "2018";
        sha256 = "03nz07d6dacbaqjm2gk5iimff0an5vpcksga5i40ig18c5sm4z9f";
        authors = [
          "Brook Heisler <brookheisler@gmail.com>"
        ];
        
      };
      "rustacuda_derive" = rec {
        crateName = "rustacuda_derive";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0qh6iah802svfhnqza7vyxlzx45dm4b8jrlx9cha1cckn8l9d1zv";
        procMacro = true;
        authors = [
          "Brook Heisler <brookheisler@gmail.com>"
        ];
