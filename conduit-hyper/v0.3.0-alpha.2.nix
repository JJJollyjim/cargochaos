...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/conduit-hyper/v0.3.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "conduit-hyper" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "blocking" "fs" "rt-threaded" "stream" ];
          }
          {
            name = "tower-service";
      ...
      "conduit-router" = rec {
        ...
        version = "0.9.0-alpha.2";
        edition = "2015";
        sha256 = "1v351wwckyrbfq0j4yniax76g9sz9376spsipzi63z1107m6iakf";
        authors = [
          "wycats@gmail.com"
        ];
        dependencies = [
