...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/conduit-hyper/v0.3.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "conduit" = rec {
        ...
        edition = "2015";
        sha256 = "159prchhc4v0wzq7mmx317yczcg559y41sh4jhlh2shv3zs079rc";
        authors = [
          "wycats@gmail.com"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "conduit-router" = rec {
        ...
        version = "0.9.0-alpha.1";
        edition = "2015";
        sha256 = "1j45zmkiq6xlm3slx0528884zn1w69f96wh54f72isswjn7gvxbr";
        authors = [
          "wycats@gmail.com"
        ];
        dependencies = [
