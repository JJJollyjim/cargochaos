...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arima/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arima" = rec {
        ...
        resolvedDefaultFeatures = [ "accelerate" "accelerate-src" "default" "intel-mkl" "intel-mkl-src" "netlib" "netlib-src" "openblas" "openblas-src" ];
      };
      "arrayvec" = rec {
        crateName = "arrayvec";
        version = "0.4.12";
