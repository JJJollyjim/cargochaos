...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arima/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arima" = rec {
        ...
        authors = [
          "Kai Fricke <coding@kaifricke.com>"
        ];
        dependencies = [
          {
            name = "accelerate-src";
        ...
        resolvedDefaultFeatures = [ "accelerate" "accelerate-src" "default" "intel-mkl" "intel-mkl-src" "lapack" "lapack-sys" "netlib" "netlib-src" "openblas" "openblas-src" ];
      };
      "arrayvec" = rec {
        crateName = "arrayvec";
        version = "0.4.12";
      ...
      "lbfgs" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1x0904g114g6i2s3lrjch7pl5nmq7jap8d34vbxw7lskapv9dp8b";
        authors = [
      ...
      "optimization" = rec {
        crateName = "optimization";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0ydbhfwzhk63rzxdw85dkkj1xbwq0hp1n0hyb795c1kzwncjpz30";
        authors = [
