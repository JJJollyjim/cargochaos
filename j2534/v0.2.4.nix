...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/j2534/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "impl-debug" "impl-default" "libloaderapi" "minwinbase" "minwindef" "timezoneapi" "winerror" "winnt" "winreg" ];
      };
