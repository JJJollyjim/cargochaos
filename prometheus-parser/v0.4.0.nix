...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/prometheus-parser/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "prometheus-parser" = rec {
        crateName = "prometheus-parser";
        version = "0.4.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        libName = "prometheus_parser";
        authors = [
