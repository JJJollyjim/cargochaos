...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/selene/v0.5.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "full_moon" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "roblox" "serde" ];
      };
      ...
      "rbx_reflection" = rec {
        ...
        version = "3.3.408";
        edition = "2018";
        sha256 = "0xqj7clhz83lyxim9ypsji5qva7wsn8nxlvj30xgs73c03wlghd4";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
      ...
      "selene" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "reqwest" "roblox" ];
      };
      "selene-lib" = rec {
        ...
        resolvedDefaultFeatures = [ "rbx_reflection" "roblox" ];
      };
      "semver" = rec {
        crateName = "semver";
        version = "0.9.0";
