...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hoyomi/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hoyomi" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "hoyomi"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "alanb <efik722life@gmail.com>"
        ];
        dependencies = [
          {
            name = "dirs";
      ...
      "rusoto_ec2" = rec {
        ...
        version = "0.40.0";
        edition = "2018";
        sha256 = "1312b2s4h1911x7izbg4c21rqr9j81xnq5vlz49xmfp8132l0c77";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
