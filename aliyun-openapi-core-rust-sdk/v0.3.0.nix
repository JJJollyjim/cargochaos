...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aliyun-openapi-core-rust-sdk/v0.3.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "aliyun-openapi-core-rust-sdk";
  ...
  workspaceMembers = {
    "aliyun-openapi-core-rust-sdk" = rec {
      packageId = "aliyun-openapi-core-rust-sdk";
      build = internal.buildRustCrateWithFeatures {
        packageId = "aliyun-openapi-core-rust-sdk";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aliyun-openapi-core-rust-sdk" = rec {
        crateName = "aliyun-openapi-core-rust-sdk";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "mc404 <antix.blue@antix.blue>"
        ];
        dependencies = [
          {
            name = "base64";
