...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libchip8/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libchip8" = rec {
        ...
        authors = [
          "Yushi Omote <yushi.omote@sbibits.com>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "orbclient" = rec {
        ...
        version = "0.3.22";
        edition = "2015";
        sha256 = "0in56xjz2jc5v7gcj2hksd3x7pajkmkza71d4lmzb98w0253j3hx";
        authors = [
