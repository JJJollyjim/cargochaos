...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudiot1-cli/v1.0.12+20190618.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudiot1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudiot1" = rec {
        crateName = "google-cloudiot1";
        version = "1.0.12+20190618";
        edition = "2015";
        sha256 = "0qshzlfvhqs87h89s35w90n73dygr5sgii13a3a0nk18sqvwsvx6";
        authors = [
      ...
      "google-cloudiot1-cli" = rec {
        crateName = "google-cloudiot1-cli";
        version = "1.0.12+20190618";
        edition = "2015";
        crateBin = [
          { name = "cloudiot1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-cloudiot1";
            packageId = "google-cloudiot1";
          }
          {
            name = "hyper";
            packageId = "hyper";
