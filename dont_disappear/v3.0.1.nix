...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dont_disappear/v3.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "minwindef" "processenv" "winbase" "wincon" "winnt" "winuser" ];
      };
