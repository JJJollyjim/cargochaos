...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aiven_rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aiven_rs" = rec {
        ...
        resolvedDefaultFeatures = [ "openssl" "static" ];
      };
      ...
      "mockito" = rec {
        ...
        version = "0.25.1";
        edition = "2018";
        sha256 = "1p4mwm9nhb7zyx8457mlvk4m4hsyh5irf14m1w2dli7l928b1nq3";
        authors = [
