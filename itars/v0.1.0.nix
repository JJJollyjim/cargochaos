...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/itars/v0.1.0.nix.tmp"
    ...
    crates = {
      "itars" = rec {
        ...
        dependencies = [
          {
            name = "itars-core";
            packageId = "itars-core";
          }
        ];
        
      };
      "itars-core" = rec {
        crateName = "itars-core";
        version = "0.1.0";
        edition = "2018";
        sha256 = "03ilc2gfzpbv45j69gycblvs2c511sychn2rm2bdii8iih2cb7bc";
        authors = [
          "Scliang <sclwork@hotmail.com>"
        ];
        dependencies = [
