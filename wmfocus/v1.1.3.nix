...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wmfocus/v1.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cairo-rs" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "0pmrprj8cci2v600lh6yyrscbrslarwj0vpbmcfp0kcw93bfmhya";
        libName = "cairo";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "glib" "glib-sys" "gobject-sys" "use_glib" "xcb" ];
      };
      "cairo-sys-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "glib-sys" "use_glib" "xcb" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.37";
      ...
      "css-color-parser" = rec {
        crateName = "css-color-parser";
        version = "0.1.2";
        edition = "2015";
        sha256 = "07aqswgwc5fjfzqmwyrhib45r6l8r6bbalayaxpdrrlpxzknrjww";
        authors = [
          "Katkov Oleksandr <alexx.katkoff@gmail.com>"
        ];
        dependencies = [
          {
            name = "lazy_static";
      ...
      "glib" = rec {
        ...
        version = "0.8.0";
        edition = "2015";
        sha256 = "06vw4fxg8x07p4rdy3mivjbni37m3ibl14kdrnkp616s35q763fp";
        authors = [
          "The Gtk-rs Project Developers"
        ];
        dependencies = [
      ...
      "i3ipc" = rec {
        ...
        version = "0.10.1";
        edition = "2015";
        sha256 = "0zljiin4s8d5ci18f87v5yinji10299z651irf4awgs71k0dmwv3";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "windef" "winerror" "wingdi" "winnt" "winuser" ];
      };
      ...
      "wmfocus" = rec {
        ...
        resolvedDefaultFeatures = [ "i3" "i3ipc" ];
      };
      "x11" = rec {
        crateName = "x11";
        version = "2.18.1";
      ...
      "xcb-util" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "1ayq93ncbrjlzr9yyk7njql2rnplc47nf2pk49is8ja3pq5zqd8d";
        authors = [
        ...
        resolvedDefaultFeatures = [ "keysyms" ];
      };
      "xkbcommon" = rec {
        crateName = "xkbcommon";
        version = "0.4.0";
