...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustfmt_ignore/v0.4.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "globset" = rec {
        ...
        resolvedDefaultFeatures = [ "simd-accel" ];
      };
      "lazy_static" = rec {
      ...
      "rustfmt_ignore" = rec {
        crateName = "rustfmt_ignore";
        version = "0.4.10";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.4.10.nix {};
        libName = "ignore";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>, topecongiro <seuchida@gmail.com>"
        ];
        dependencies = [
          {
