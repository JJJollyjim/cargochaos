...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/F80A18/v0.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "F80A18" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "default" "hmac" "sha2" "webhooks" ];
      };
      "adler32" = rec {
        crateName = "adler32";
        version = "1.0.3";
      ...
      "smol_str" = rec {
        ...
        version = "0.1.12";
        edition = "2015";
        sha256 = "1yqlk7vkhksgsibl1n3c0zbnliw1k2ihwg67z1b7qi9h6sz001sr";
        authors = [
