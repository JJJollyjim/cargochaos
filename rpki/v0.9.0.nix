...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rpki/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcder" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1srx0fnfgcp68p0l8qvpjbx3mkrjzfralm23nhm7yzcrv7zk88jx";
        authors = [
      ...
      "rpki" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "readroa"; path = "src/bin/readroa.rs"; }
          { name = "readmft"; path = "src/bin/readmft.rs"; }
          { name = "readcer"; path = "src/bin/readcer.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "extra-debug" "openssl" "slab" "softkeys" ];
      };
      "rustc-demangle" = rec {
