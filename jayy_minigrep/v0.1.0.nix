...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jayy_minigrep/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jayy_minigrep" = rec {
        crateName = "jayy_minigrep";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "jayy_minigrep"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Jayy-Lmao <jameswarringtonholman@gmail.com>"
        ];
        dependencies = [
          {
            name = "colored";
