...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openstack/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "openstack" = rec {
        ...
        resolvedDefaultFeatures = [ "compute" "default" "image" "native-tls" "network" "object-storage" "rustls" ];
      };
      "osauth" = rec {
        crateName = "osauth";
        version = "0.2.5";
        edition = "2018";
        sha256 = "1gxbjxm12vr9r2569lzn94azm0vzsds9yy20xdv1v80lvphmqdnm";
        authors = [
          "Dmitry Tantsur <divius.inside@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "native-tls" "rustls" "sync" "tokio" ];
      };
      "osproto" = rec {
        crateName = "osproto";
        version = "0.1.2";
      ...
      "waiter" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0yiikj2zsbks1hcv9hl3bp1dc6vz4h4wklqfpbd26dc7j41b3ixz";
        authors = [
          "Dmitry Tantsur <divius.inside@gmail.com>"
        ];
