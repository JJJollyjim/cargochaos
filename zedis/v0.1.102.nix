...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zedis/v0.1.102.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "zedis" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "zedis"; path = "src/bin/zedis.rs"; }
          { name = "zedis-gui"; path = "src/bin/zedis-gui.rs"; }
          { name = "zedis-encryption"; path = "src/bin/zedis-encryption.rs"; }
          { name = "zedis-cli"; path = "src/bin/zedis-cli.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.102.nix {};
        authors = [
