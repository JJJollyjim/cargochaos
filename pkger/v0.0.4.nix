...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pkger/v0.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpio" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0hn2rph6c4l84r8hhhbazk6i2r3pbh90dddi0l55np5vl76pf0gh";
        authors = [
      ...
      "pkger" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pkger"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.4.nix {};
        authors = [
          "wojciech.kepka <wojtek.kepka@protonmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "rpm-rs" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "05xxjq4f30f18q1cgpffhybrmfpd4c6sw61pljazbiwj90sqh277";
        libName = "rpm";
        libPath = "src/rpm.rs";
        authors = [
      ...
      "wharf" = rec {
        ...
        version = "0.1.10";
        edition = "2018";
        sha256 = "0x92zlngp1591waq51b1kpw08cmvi3zcl6mqxm0c1ki05fbk9xwz";
        authors = [
          "wojciechkepka <wojtek.kepka@protonmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
