...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/epkard/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "minwindef" "ntsecapi" "processenv" "profileapi" "utilapiset" "winbase" "wincon" "windef" "winnls" "winnt" "winuser" ];
      };
