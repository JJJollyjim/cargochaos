...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-containeranalysis1_beta1-cli/v1.0.13+20200327.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-containeranalysis1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "1d21y4d7sqbfi7zs3576m1zai7bhxazm1sdwx0b8sh08mpb8lpr8";
        authors = [
      ...
      "google-containeranalysis1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200327.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
