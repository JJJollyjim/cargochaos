...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-containeranalysis1_beta1-cli/v1.0.12+20190625.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-containeranalysis1_beta1-cli";
  ...
  workspaceMembers = {
    "google-containeranalysis1_beta1-cli" = rec {
      packageId = "google-containeranalysis1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-containeranalysis1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-containeranalysis1_beta1" = rec {
        crateName = "google-containeranalysis1_beta1";
        version = "1.0.12+20190625";
        edition = "2015";
        sha256 = "0lkambmzs8vj88ygvbynfn5fihy3dk3rr9azgrj83pkwn7j6h7i5";
        authors = [
      ...
      "google-containeranalysis1_beta1-cli" = rec {
        crateName = "google-containeranalysis1_beta1-cli";
        version = "1.0.12+20190625";
        edition = "2015";
        crateBin = [
          { name = "containeranalysis1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190625.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-containeranalysis1_beta1";
            packageId = "google-containeranalysis1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
