...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sheldon/v0.4.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quick-error2" = rec {
        crateName = "quick-error2";
        version = "2.0.1";
        edition = "2018";
        sha256 = "1c60wpbdaawks52gh30nzxk4q0da2rpgvyslnvsk0f4p6907g5h1";
        authors = [
          "Paul Colomiets <paul@colomiets.name>"
          "Colin Kiegel <kiegel@gmx.de>"
