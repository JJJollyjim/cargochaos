...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sspi/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sspi" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "sspi" "rpcdce" "impl-default" "timezoneapi" "wincrypt" ];
          }
        ];
        devDependencies = [
          {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "rpcdce" "sspi" "std" "sysinfoapi" "timezoneapi" "wincrypt" "winnt" ];
      };
