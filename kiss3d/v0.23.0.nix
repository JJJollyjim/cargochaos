...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kiss3d/v0.23.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "conrod_derive" = rec {
        ...
        version = "0.63.0";
        edition = "2015";
        sha256 = "1ifv9mgrj61vs57aw51filjy9938an65xhbvxhad2ph16jfrip5a";
        procMacro = true;
        authors = [
      ...
      "kiss3d" = rec {
        ...
        resolvedDefaultFeatures = [ "conrod" "kiss3d_conrod" ];
      };
      "kiss3d_conrod" = rec {
        crateName = "kiss3d_conrod";
        version = "0.64.0";
        edition = "2015";
        sha256 = "16slgh5ypl645p38xzkqss331mv5rnzxkfcj92rghyncp1vcyl62";
        authors = [
      ...
      "ncollide2d" = rec {
        ...
        version = "0.22.0";
        edition = "2018";
        sha256 = "0sw21m86kfn4g5xlz73yqwdg5dgbskaa1i17ncvq1h8mdlsm6p15";
        authors = [
          "Sébastien Crozet <developer@crozet.re>"
        ];
        dependencies = [
