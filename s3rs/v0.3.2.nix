...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/s3rs/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hmac-sha1" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "08k7aylc0v8x3abmxn3h73dkad3anfq2i94xk2mjrf4linnkycz1";
        libName = "hmacsha1";
        authors = [
      ...
      "s3handler" = rec {
        ...
        version = "0.4.3";
        edition = "2018";
        sha256 = "1r6k2zldhihmdx1s8cfnd4js0rahc7v7m7gwxgw76jd0sailas8c";
        authors = [
          "Antonio Yang <antonio.yang@siliconmotion.com.tw>"
        ];
        dependencies = [
          {
            name = "base64";
