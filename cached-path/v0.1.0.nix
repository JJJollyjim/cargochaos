...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cached-path/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cached-path" = rec {
        crateName = "cached-path";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cached-path"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "macros" "io-util" "fs" "sync" "time" ];
          }
        ];
        devDependencies = [
          {
      ...
      "httpmock" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1cl6plvhi1mq9y43hc00zh4dczmscci25xzp09jiir8g9slgh8mw";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "httpmock-macros";
            packageId = "httpmock-macros";
          }
          {
            name = "hyper";
      ...
      "httpmock-macros" = rec {
        crateName = "httpmock-macros";
        version = "0.2.0";
        edition = "2018";
        sha256 = "02b33j5wwad9yi0s9x5v8wzfjsk4ms3bgifjrxr1rg1j5wmaxdbd";
        procMacro = true;
        authors = [
          "Alexander Liesenfeld <alexander.liesenfeld@outlook.com>"
        ];
