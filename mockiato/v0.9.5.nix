...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mockiato/v0.9.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mockiato-codegen" = rec {
        crateName = "mockiato-codegen";
        version = "0.9.5";
        edition = "2018";
        sha256 = "0jsr2ngj1vj0kk214bss7pblvck3f3lr43gbw3v9r6shgi0a23hx";
        procMacro = true;
        authors = [
          "Ruben Schmidmeister <ruben@myelin.ch>"
          "Jeremy Stucki <jeremy@myelin.ch>"
      ...
      "nameof" = rec {
        ...
        version = "1.1.0";
        edition = "2015";
        sha256 = "1zbyb03v0qwngkj7y6vbxnm9vp0kh8yxzjfb6ddawnl3dgv0s1vd";
        authors = [
      ...
      "nearly_eq" = rec {
        ...
        version = "0.2.4";
        edition = "2015";
        sha256 = "0dan5ihg9g590zjy87f7wd1a0s4acjs1y7jfcmfw6a1k8f58cad6";
        authors = [
          "Mitsuharu Seki <mitsu1986@gmail.com>"
        ];
        features = {
          "complex" = [ "num-complex" ];
          "docs" = [ "complex" "rational" "ndarray" "use_fpa" "i128" ];
          "rational" = [ "num-rational" "num-integer" "num-traits" ];
          "use_fpa" = [ "fpa" "typenum" "num-traits" ];
        };
      };
      "proc-macro2" = rec {
