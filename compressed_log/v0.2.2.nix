...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/compressed_log/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-web" = rec {
        ...
        resolvedDefaultFeatures = [ "openssl" "ssl" "tokio-openssl" ];
      };
      "actix_derive" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
