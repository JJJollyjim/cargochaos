...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lindera-ko-dic-builder/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lindera-ko-dic-builder";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lindera-ko-dic-builder" = rec {
        crateName = "lindera-ko-dic-builder";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "lindera-ko-dic"; path = "src/main.rs"; }
        ];
