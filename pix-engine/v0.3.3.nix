...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pix-engine/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pix-engine" = rec {
        crateName = "pix-engine";
        version = "0.3.3";
        edition = "2018";
        crateBin = [
          { name = "pix-engine"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "sdl2" "sdl2-driver" "wasm-bindgen" "wasm-driver" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.16.1";
      ...
      "sdl2" = rec {
        ...
        resolvedDefaultFeatures = [ "unsafe_textures" ];
      };
      "sdl2-sys" = rec {
        crateName = "sdl2-sys";
        version = "0.33.0";
