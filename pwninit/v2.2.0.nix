...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pwninit/v2.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "derive_setters" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0f09x031b1acza2mm77zlmvz1v9spr8pcvchiax3r5zns6af7dwq";
        procMacro = true;
        authors = [
      ...
      "ex" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "1mbl6vpzln3gjwhlsdm8xkr2nm2mc7b5axccgx96p35ihwm8sqgv";
        authors = [
