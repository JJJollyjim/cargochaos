...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/termagotchi/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "termagotchi" = rec {
        crateName = "termagotchi";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "termagotchi"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Trevor Arjeski <tmarjeski@gmail.com>"
        ];
        dependencies = [
          {
            name = "crossterm";
