...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ham/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gpio-cdev" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "10d9vnvivlxxdk7dmvfx7k2i7dd4bvfjh2szqncf5fhg111hgm84";
        authors = [
      ...
      "ham" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ham"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Curtis Maves <curtismaves@gmail.com>"
        ];
        dependencies = [
          {
            name = "gpio-cdev";
        ...
        resolvedDefaultFeatures = [ "default" "hp-sleep" "spin_sleep" ];
      };
      "lazy_static" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "minwindef" "mmsystem" "timeapi" ];
      };
