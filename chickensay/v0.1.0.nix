...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chickensay/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chickensay" = rec {
        crateName = "chickensay";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "chickensay"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Shaopeng Zhang <zsp1987@gmail.com>"
        ];
        dependencies = [
          {
            name = "assert_cmd";
