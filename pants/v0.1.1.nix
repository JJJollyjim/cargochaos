...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pants/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket_contrib" = rec {
        ...
        resolvedDefaultFeatures = [ "glob" "serde" "serde_json" "serve" "templates" "tera" "tera_templates" ];
      };
      "rocket_http" = rec {
