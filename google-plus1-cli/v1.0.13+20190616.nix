...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-plus1-cli/v1.0.13+20190616.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-plus1" = rec {
        crateName = "google-plus1";
        version = "1.0.13+20190616";
        edition = "2015";
        sha256 = "0dc22k74dbsp3fgj070kyvvdwrh892m10zi9fz8j04hm4cdixwl0";
        authors = [
      ...
      "google-plus1-cli" = rec {
        crateName = "google-plus1-cli";
        version = "1.0.13+20190616";
        edition = "2015";
        crateBin = [
          { name = "plus1"; path = "src/main.rs"; }
        ];
