...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32h7-ethernet/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cortex-m-log" = rec {
        ...
        resolvedDefaultFeatures = [ "itm" "log" "log-integration" ];
      };
      "cortex-m-rt" = rec {
      ...
      "smoltcp" = rec {
        ...
        resolvedDefaultFeatures = [ "ethernet" "log" "proto-dhcpv4" "proto-ipv4" "socket-raw" "socket-tcp" ];
      };
      ...
      "stm32h7" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "0apq24wmcqkvmirdzvibxixqvyifr52xvcbsia7690p0cr809c75";
        authors = [
      ...
      "stm32h7-ethernet" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "phy0" "phy1" "phy_ksz8081r" "phy_lan8742a" ];
      };
      "stm32h7xx-hal" = rec {
        crateName = "stm32h7xx-hal";
        version = "0.4.0";
        edition = "2018";
        sha256 = "0py1qfpw0ddh4fz8dr3lnc2bvrj0nl5m9i91z0yf0hygl5hzz6k8";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "unproven" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
