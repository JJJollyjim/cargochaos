...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/josh/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "josh" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "josh-test-server"; path = "src/bin/josh-test-server.rs"; }
          { name = "josh-proxy"; path = "src/bin/josh-proxy.rs"; }
          { name = "josh-filter"; path = "src/bin/josh-filter.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Christian Schilling <christian.schilling@esrlabs.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "rs_tracing" = rec {
        crateName = "rs_tracing";
        version = "1.0.1";
        edition = "2015";
        sha256 = "0fy0d8ri46kqd7zncpvkrcfmh3xm0sykc0wwdbcya6x2b2zhrccj";
        authors = [
          "Andreas Jonson"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "rs_tracing" "serde" "serde_json" "time" ];
      };
      "rust-crypto" = rec {
      ...
      "tracing-log" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0qsinlbk2knrqgx1k2zq8kjxs71x44vzpma2rin1sm462agcjav5";
        authors = [
          "Tokio Contributors <team@tokio.rs>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "log-tracer" "trace-logger" ];
      };
      "tracing-subscriber" = rec {
        crateName = "tracing-subscriber";
        version = "0.1.5";
        edition = "2018";
        sha256 = "0k9finzhcaqkvq35a7knr1n53hncdf9lz29v1cxhpwcr599bprk3";
        authors = [
          "Eliza Weisman <eliza@buoyant.io>"
          "Tokio Contributors <team@tokio.rs>"
        ];
