...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/i3-scratchmenu/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "i3-scratchmenu" = rec {
        crateName = "i3-scratchmenu";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "i3-scratchmenu"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "aedoq <aedoq@protonmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
