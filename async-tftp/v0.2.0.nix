...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-tftp/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tftp" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "tokio";
            optional = true;
            features = [ "rt-core" "io-util" "fs" "sync" "udp" "time" ];
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "async-std" "default" "external-client-tests" "tokio" "use-async-std" "use-tokio" ];
      };
      "async-trait" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "objbase" "processthreadsapi" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
