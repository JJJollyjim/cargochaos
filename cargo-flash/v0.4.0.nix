...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-flash/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gdb-server" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1pis0c2w53vb93qi8p1zcx1b2jjcgqpzkkr6g95jl15djn0g3xjs";
      ...
      "probe-rs" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0gjwh38q026pckrz0yys75w0174vbvqmyr3kw399c0j653fi9gph";
        authors = [
          "Noah Hüsser <yatekii@yatekii.ch>"
          "Dominik Boehi <dominik.boehi@gmail.ch>"
        ];
      ...
      "probe-rs-t2rust" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "142a49vnm2l35l7blid00rlqz5liv62ai2jprbn9l518w9gaplr1";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
