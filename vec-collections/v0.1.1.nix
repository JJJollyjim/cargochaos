...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vec-collections/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "testdrop" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "1bmyxcxc8d1pzkfl6jpg3pr4ld2qmhrlazcjsddk5dcflhrfwf9x";
        authors = [
          "malbarbo"
        ];
