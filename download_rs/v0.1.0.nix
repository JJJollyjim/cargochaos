...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/download_rs/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "download_rs" = rec {
        crateName = "download_rs";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "fengzhongyun1992 <1677658490@qq.com>"
        ];
        dependencies = [
          {
            name = "indicatif";
        ...
        resolvedDefaultFeatures = [ "async_download" "default" "full" "indicatif" "sync_download" "tokio" ];
      };
      "dtoa" = rec {
        crateName = "dtoa";
        version = "0.4.4";
