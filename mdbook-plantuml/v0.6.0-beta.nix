...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-plantuml/v0.6.0-beta.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "deflate" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "1lkqy0yi415i6fiydqf43224bzlwah8j6vxm3c53ds3n6i5f3wzm";
        authors = [
      ...
      "elasticlunr-rs" = rec {
        ...
        version = "2.3.5";
        edition = "2015";
        sha256 = "0vzshypvzvqq6x5fhsfvggc9pcqm47gyzhgqp08r7k6a5sy3rnh1";
        libName = "elasticlunr";
        authors = [
      ...
      "handlebox" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1bm0qkv6nnzr1mklnyyxyi69yw4ssmfjgw8l9093iirnfrm169j7";
        authors = [
          "Jason Grlicky <jason@paracosm.us>"
        ];
      ...
      "mdbook-plantuml" = rec {
        crateName = "mdbook-plantuml";
        version = "0.6.0-beta";
        edition = "2015";
        crateBin = [
          { name = "mdbook-plantuml"; path = "src/bin/mdbook-plantuml.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.6.0-beta.nix {};
        authors = [
          "Sytse Reitsma <mdbook-plantuml@sreitsma.nl>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "default" "deflate" "plantuml-server" "plantuml-ssl-server" "reqwest" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.2.1";
      ...
      "simulacrum" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "1kjq1794025xjwbkmr9gp1fvrgzg3wi27ifmw3vb4rhz24bbqv7w";
        authors = [
          "Jason Grlicky <jason@paracosm.us>"
        ];
        dependencies = [
          {
            ...
            packageId = "simulacrum_macros";
          }
          {
            name = "simulacrum_mock";
            packageId = "simulacrum_mock";
          }
          {
            name = "simulacrum_user";
            packageId = "simulacrum_user";
          }
        ];
        
      };
      "simulacrum_macros" = rec {
        crateName = "simulacrum_macros";
        version = "0.3.1";
        edition = "2015";
        sha256 = "1jmd14yi3p033f9bzn4x67v978xf8kankxkm2sjdq5n3gfk5mp6z";
        authors = [
          "Jason Grlicky <jason@paracosm.us>"
        ];
        dependencies = [
      ...
      "simulacrum_mock" = rec {
        crateName = "simulacrum_mock";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0jpcpaaswn0pz98ijdc5izgfnj9rgyizmqbvxqppjz81mf0vx8xh";
        authors = [
          "Jason Grlicky <jason@paracosm.us>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "simulacrum_shared";
          }
        ];
        
      };
      "simulacrum_shared" = rec {
        crateName = "simulacrum_shared";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0siigq5k4h3rkkkb9rq220icli9sczzhvqiyf5d3gv4i6qxgv17p";
        authors = [
          "Jason Grlicky <jason@paracosm.us>"
        ];
        dependencies = [
      ...
      "simulacrum_user" = rec {
        crateName = "simulacrum_user";
        version = "0.1.0";
        edition = "2015";
        sha256 = "07z85bnzdq84j3mxxbx1gl86ap8s1698vkpbyddvkf88zvyzhn6v";
        authors = [
          "Jason Grlicky <jason@paracosm.us>"
        ];
        dependencies = [
      ...
      "toml-query" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1fxf4xjk3k3xxkkqi67lj813dshs2hypqmpxzi725j2ai6hnjhx2";
        authors = [
          "Matthias Beyer <mail@beyermatthias.de>"
        ];
        dependencies = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
