...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sha-1/v0.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "blobby" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "1xicpf3s2mi5xqnx8ps5mdych4ib5nh2nfsbrsg8ar8bjk1girbg";
        authors = [
      ...
      "digest" = rec {
        ...
        resolvedDefaultFeatures = [ "blobby" "dev" "std" ];
      };
      "fake-simd" = rec {
        crateName = "fake-simd";
        version = "0.1.2";
      ...
      "hex-literal" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0ffnn5g9q5xhdmzj2ic5hk9y18kyqflbmqcssqcya9gixs5r5hnx";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "hex-literal-impl" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "1nnxqhyn9l998ma04ip79bmpqv1as6003s03g26ynhrr471p022j";
        procMacro = true;
        authors = [
          "RustCrypto Developers"
        ];
      ...
      "sha-1" = rec {
        ...
        resolvedDefaultFeatures = [ "asm" "asm-aarch64" "default" "libc" "sha1-asm" "std" ];
      };
      "sha1-asm" = rec {
        crateName = "sha1-asm";
        version = "0.4.4";
        edition = "2015";
        sha256 = "1z5vdimd7l0vmr2p7kjibi0rghf5frb1ld0gzdkxrxfmkllf5nmr";
        authors = [
          "RustCrypto Developers"
        ];
        buildDependencies = [
