...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/automatic/v0.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "automatic" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "automatic"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "processenv" "winbase" ];
      };
