...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kaiju-compiler-cli/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kaiju-compiler-cli" = rec {
        crateName = "kaiju-compiler-cli";
        version = "0.1.4";
        edition = "2018";
        crateBin = [
          { name = "ckaiju"; path = "src/main.rs"; }
        ];
      ...
      "kaiju-compiler-cli-core" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "1ax7g8ywgqzviglm5isg148k959sbd8qxniyibmkvb40f24j69jq";
        authors = [
          "Patryk 'PsichiX' Budzynski <psichix@gmail.com> (https://psichix.io)"
        ];
        dependencies = [
