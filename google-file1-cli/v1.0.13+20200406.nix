...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-file1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-file1" = rec {
        crateName = "google-file1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "1kjyz09nkbps0cg4vshi80p13gw8dm03kvwaw4pj9b50ybcix0r9";
        authors = [
      ...
      "google-file1-cli" = rec {
        crateName = "google-file1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "file1"; path = "src/main.rs"; }
        ];
