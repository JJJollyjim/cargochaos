...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rx-editor/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gfx-backend-dx11" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0v5m3jaspaqgmsld9b215v6r585n9s19dy7gam1c0b0bwq0jslrn";
      ...
      "meowhash" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "02r3m1h5k27160z7pfnp01qmidbar6z8fyvf1qzmqlm35yp8a2mh";
        authors = [
      ...
      "nonempty" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "01jphl3zv5p26v8cxsa99afld3h8r1qkbz9pnpzcpaq4nr13krlg";
        authors = [
      ...
      "rgx" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1hgp20blx49cyy2q6qhzjbwl2q5mfj4ri63k7v3ly6j8p1faaxj8";
        authors = [
          "Alexis Sellier <self@cloudhead.io>"
        ];
        dependencies = [
      ...
      "rx-editor" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "glfw" "winit" ];
      };
      "same-file" = rec {
        crateName = "same-file";
        version = "1.0.5";
