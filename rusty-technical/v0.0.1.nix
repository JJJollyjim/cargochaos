...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty-technical/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0apj8lhybz7ldjbq8mrafww0ddzzm71a6817s7sdry1idq7nqzf5";
        authors = [
      ...
      "rusty-technical" = rec {
        crateName = "rusty-technical";
        version = "0.0.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        libName = "rusty_technical";
        authors = [
          "David Holtz <david.richard.holtz@gmail.com>"
        ];
        dependencies = [
          {
            name = "ta-lib-wrapper";
            packageId = "ta-lib-wrapper";
          }
        ];
      ...
      "ta-lib-wrapper" = rec {
        crateName = "ta-lib-wrapper";
        version = "0.1.1";
        edition = "2015";
        sha256 = "00yhklmndg0x9z5mk66cjixfg6y7pphh9x6rnbylz66fgnz4qj0k";
        authors = [
          "Carl Levasseur <carl.levasseur@protonmail.com>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
