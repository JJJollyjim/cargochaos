...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dua-cli/v2.1.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dua-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v2.1.13.nix {};
        libName = "dua";
        authors = [
      ...
      "failure-tools" = rec {
        ...
        version = "4.0.4";
        edition = "2018";
        sha256 = "13z3227mpscb1n98jgbk5ljjnnqga6p9sxa68a78zp2lvdhhvfzi";
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
