...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/drone/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "drone" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "drone"; path = "src/bin/drone.rs"; }
          { name = "drone-ld"; path = "src/bin/drone-ld.rs"; }
        ];
      ...
      "drone-config" = rec {
        crateName = "drone-config";
        version = "0.9.0";
        edition = "2018";
        sha256 = "1hx4xh7jl807pp1hkpbpyvlccx7dkwgiyzig0zg7l4rw3hrxcgsd";
        authors = [
          "Valentine Valyaeff <valentine.valyaeff@gmail.com>"
        ];
        dependencies = [
