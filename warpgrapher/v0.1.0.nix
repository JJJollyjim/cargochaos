...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/warpgrapher/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "juniper" = rec {
        ...
        version = "0.13.1";
        edition = "2018";
        sha256 = "0p776ix5yk7a2dld8lsrczr3jpjcy80x5qjvjs82adpaqly60w5m";
        authors = [
      ...
      "juniper_codegen" = rec {
        ...
        version = "0.13.2";
        edition = "2018";
        sha256 = "064ln6hnk7zzvivbndmka2f0ddywmvclpgrk7nskniwwb2x9j3i3";
        procMacro = true;
        authors = [
          "Magnus Hallin <mhallin@fastmail.com>"
          "Christoph Herzog <chris@theduke.at>"
      ...
      "r2d2_cypher" = rec {
        crateName = "r2d2_cypher";
        version = "0.4.0";
        edition = "2015";
        sha256 = "144maik2k1jhk8ijm31ak1s5jrkgylij4ms8lj922hr9xxvd54g4";
        authors = [
      ...
      "rusted_cypher" = rec {
        crateName = "rusted_cypher";
        version = "1.1.0";
        edition = "2015";
        sha256 = "078mwmi8ir6g5qpmjxxyhmxcw0l29mril7is4dg75n54jvhidas4";
        authors = [
      ...
      "warpgrapher" = rec {
        crateName = "warpgrapher";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "warpgrapher"; path = "src/main.rs"; }
        ];
