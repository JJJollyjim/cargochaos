...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasmtime-cli/v0.15.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "filecheck" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1amvf0jyhrrk16lvjwrxnrv46qv3k9xynw11p3w3aj3wgd10pq1g";
        authors = [
          "The Cranelift Project Developers"
        ];
        dependencies = [
      ...
      "lightbeam" = rec {
        ...
        version = "0.15.0";
        edition = "2018";
        sha256 = "1qikrr1xgjijnl7i6a4xivhyxpkhvcmwv6n12hp5pghlgvq116v3";
        authors = [
      ...
      "structopt" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "default" "suggestions" ];
      };
      ...
      "wasmtime" = rec {
        ...
        resolvedDefaultFeatures = [ "jitdump" "lightbeam" "wat" ];
      };
      "wasmtime-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wasmtime"; path = "src/bin/wasmtime.rs"; }
        ];
        ...
        features = {
          ...
          "lightbeam" = [ "wasmtime-environ/lightbeam" "wasmtime-jit/lightbeam" "wasmtime-wast/lightbeam" "wasmtime/lightbeam" ];
        };
        resolvedDefaultFeatures = [ "default" "jitdump" "lightbeam" ];
      };
      "wasmtime-debug" = rec {
      ...
      "wasmtime-environ" = rec {
        ...
        resolvedDefaultFeatures = [ "lightbeam" ];
      };
      "wasmtime-jit" = rec {
        ...
        resolvedDefaultFeatures = [ "jitdump" "lightbeam" ];
      };
      "wasmtime-obj" = rec {
        crateName = "wasmtime-obj";
        version = "0.15.0";
        edition = "2018";
        sha256 = "1i5yby4r521sd011z5gp33dilbbsbas6hanqw9fdmr2v5zgfsi8z";
        authors = [
          "The Wasmtime Project Developers"
        ];
        dependencies = [
      ...
      "wasmtime-wast" = rec {
        crateName = "wasmtime-wast";
        version = "0.15.0";
        edition = "2018";
        sha256 = "02g0il02slvygspdsnhzfy2cvdz65p6gysmpvfll2f22m718aa0j";
        authors = [
          "The Wasmtime Project Developers"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "aclapi" "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "knownfolders" "memoryapi" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "processthreadsapi" "profileapi" "securitybaseapi" "shlobj" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" "ws2def" ];
      };
