...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudtasks2_beta3-cli/v1.0.12+20190618.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudtasks2_beta3-cli";
  ...
  workspaceMembers = {
    "google-cloudtasks2_beta3-cli" = rec {
      packageId = "google-cloudtasks2_beta3-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudtasks2_beta3-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudtasks2_beta3" = rec {
        crateName = "google-cloudtasks2_beta3";
        version = "1.0.12+20190618";
        edition = "2015";
        sha256 = "1k2wjkky299z8ipaf562mljfbkj3dj10qpl48v00x8f4bj5ifhwv";
        authors = [
      ...
      "google-cloudtasks2_beta3-cli" = rec {
        crateName = "google-cloudtasks2_beta3-cli";
        version = "1.0.12+20190618";
        edition = "2015";
        crateBin = [
          { name = "cloudtasks2-beta3"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudtasks2_beta3";
          }
          {
            name = "hyper";
            packageId = "hyper";
