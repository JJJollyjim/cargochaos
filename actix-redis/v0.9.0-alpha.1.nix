...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-redis/v0.9.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        resolvedDefaultFeatures = [ "actix" "actors" "brotli2" "compress" "default" "fail-ure" "failure" "flate2" "ring" "secure-cookies" ];
      };
      "actix-macros" = rec {
      ...
      "actix-redis" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.9.0-alpha.1.nix {};
        libName = "actix_redis";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "actix-http" "actix-service" "actix-session" "actix-web" "default" "rand" "serde" "serde_json" "web" ];
      };
      "actix-router" = rec {
      ...
      "actix-session" = rec {
        ...
        edition = "2018";
        sha256 = "181dw5qjvyrn55j4zlr9m4j2sl9cvw327mk0m34qfadcyqp2l7pd";
      ...
      "redis-async" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "1wc43gvqr6xky7kywr25vhf5xa5lgc82n4q411y4w0x4yghbncmy";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
