...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-redis/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-redis" = rec {
        ...
        resolvedDefaultFeatures = [ "actix-service" "actix-session" "actix-utils" "actix-web" "default" "rand" "serde" "serde_json" "web" ];
      };
      "actix-router" = rec {
      ...
      "redis-async" = rec {
        ...
        version = "0.4.5";
        edition = "2015";
        sha256 = "18m9ml8ah8a970v14dbl4brgr012d5w1pwkbajacrl4ypyalzb58";
        authors = [
