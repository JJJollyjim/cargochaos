...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-pushrod-render/v0.1.9.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-pushrod-render" = rec {
        crateName = "rust-pushrod-render";
        version = "0.1.9";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.9.nix {};
        libName = "pushrod_render";
        authors = [
