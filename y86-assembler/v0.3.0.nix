...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/y86-assembler/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "y86-assembler" = rec {
        crateName = "y86-assembler";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "y86-assembler"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        libName = "assembler";
        authors = [
          "Tarik <tarikishaq@hotmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
