...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasi-worker-cli/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasi-worker-cli" = rec {
        crateName = "wasi-worker-cli";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "wasiworker"; path = "src/main.rs"; }
        ];
