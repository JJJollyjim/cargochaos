...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ucd-generate/v0.2.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ucd-generate" = rec {
        crateName = "ucd-generate";
        version = "0.2.8";
        edition = "2018";
        crateBin = [
          { name = "ucd-generate"; path = "src/main.rs"; }
        ];
      ...
      "ucd-parse" = rec {
        ...
        version = "0.1.8";
        edition = "2018";
        sha256 = "0z0vw78ynfjhylmf7bizl6yf82fg5rs6sfilb03vdf7nbp9zhsaj";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
