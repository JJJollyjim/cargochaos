...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/axfive-matrix-dicebot/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "axfive-matrix-dicebot";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "axfive-matrix-dicebot" = rec {
        crateName = "axfive-matrix-dicebot";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "dicebot"; path = "src/bin/dicebot.rs"; }
          { name = "dicebot-cmd"; path = "src/bin/dicebot-cmd.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
