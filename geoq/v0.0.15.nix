...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/geoq/v0.0.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "MacTypes-sys" = rec {
        ...
        version = "1.3.0";
        edition = "2015";
        sha256 = "16261z2sg7bp6h99l924vfqrz8jjv4r72z2i3251kqjak4ry1fvx";
        authors = [
      ...
      "geoq" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "geoq"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.15.nix {};
        authors = [
          "Horace Williams <horace@worace.works>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "os_type" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "0qc4ch3fkr15dmw8gra8hpflsm4hgqsywzshbxbanl9ypbv9hvmq";
        authors = [
      ...
      "security-framework-sys" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "1qj58kcipg8jgnifxs7k40ihskr6g06k4zw9zspi55m0glymzna0";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
