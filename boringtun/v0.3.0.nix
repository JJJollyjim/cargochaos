...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/boringtun/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "boringtun" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "boringtun"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "chrono";
            packageId = "chrono";
            target = { target, features }: (!((target."os" == "windows") || (target."os" == "ios") || (target."os" == "android")));
          }
          {
            name = "clap";
            packageId = "clap";
          ...
          }
          {
            name = "ring";
            packageId = "ring";
            target = { target, features }: (!(target."arch" == "arm"));
          }
          {
            name = "spin";
            packageId = "spin";
      ...
      "jni" = rec {
        ...
        version = "0.10.2";
        edition = "2015";
        sha256 = "1hdmswrqxpns00w32fki3iakraf9dblyqklwafkdjr7w3awa7kqy";
        authors = [
