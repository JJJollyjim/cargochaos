...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xch/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "syscall" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "0mmmnn660wpl8qxl1ifs8l811i120br22rpljvfkiwwv0ggc9qns";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "ktmw32" "minwindef" "ntdef" "ntsecapi" "profileapi" "std" "winbase" "winerror" "winnt" ];
      };
      ...
      "xch" = rec {
        ...
        resolvedDefaultFeatures = [ "errno" "nightly" "syscall" ];
      };
    };
