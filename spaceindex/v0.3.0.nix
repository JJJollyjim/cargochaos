...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spaceindex/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustc-ap-graphviz" = rec {
        ...
        version = "645.0.0";
        edition = "2018";
        sha256 = "0ry63ash8b5si0w27h0416xhwyddw0vkiimw773zmmqwf3gpwkl2";
        libPath = "lib.rs";
        authors = [
          "The Rust Project Developers"
        ];
      ...
      "spaceindex" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "graphviz" "image" "imagegen" "imageproc" "rustc-ap-graphviz" ];
      };
      "stb_truetype" = rec {
