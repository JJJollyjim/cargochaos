...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kari/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "acc_reader" = rec {
        crateName = "acc_reader";
        version = "2.0.0";
        edition = "2015";
        sha256 = "1697ivh4rbkp0b1603nrcr36vnjayrihbgijms8dmfx2zspj7l0g";
        authors = [
      ...
      "kari" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "tester"; path = "src/bin/tester.rs"; }
          { name = "interpreter"; path = "src/bin/interpreter.rs"; }
        ];
