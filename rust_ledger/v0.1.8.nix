...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust_ledger/v0.1.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pargs" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "0805cm6yx07ykdk54wy65wmggkxyl4sy2zc81pj4y337bs4i7xls";
        authors = [
      ...
      "rust_ledger" = rec {
        crateName = "rust_ledger";
        version = "0.1.8";
        edition = "2018";
        crateBin = [
          { name = "rust_ledger"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.8.nix {};
        authors = [
          "ebcrowder <ebcrowder@gmail.com>"
        ];
        dependencies = [
          {
            name = "csv";
