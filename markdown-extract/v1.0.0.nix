...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markdown-extract/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "markdown-extract" = rec {
        crateName = "markdown-extract";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "markdown-extract"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Sean Bailey <hello@seanbailey.dev>"
        ];
        dependencies = [
          {
            name = "log";
