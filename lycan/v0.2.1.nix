...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lycan/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lycan" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lycan"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Z. Charles Dziura <zcdziura@gmail.com>"
        ];
        dependencies = [
          {
            name = "colored";
      ...
      "numeral" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "1a5012igxdbjg231vmkwirrp35hflzwk7rcxxx69byfcpykf3ygp";
        authors = [
          "Letheed <dev@daweb.se>"
        ];
