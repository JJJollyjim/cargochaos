...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pir-8-emu/v2.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "embed-resource" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "10j8h5fr7v6r6fl58c534ssffis1cfghw29rd7g6l9mvmhwvk643";
        authors = [
          "nabijaczleweli <nabijaczleweli@gmail.com>"
          "Cat Plus Plus <piotrlegnica@piotrl.pl>"
          "Liigo <liigo@qq.com>"
      ...
      "pir-8-emu" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "pir-8-emu"; path = "src/bin/pir-8-emu.rs"; }
          { name = "pir-8-disasm"; path = "src/bin/pir-8-disasm.rs"; }
          { name = "pir-8-as"; path = "src/bin/pir-8-as.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "dbghelp" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" ];
      };
