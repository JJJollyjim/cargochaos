...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/meep/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fehler" = rec {
        ...
        edition = "2018";
        sha256 = "1xf3sj75n1jhq4nblis2kqil4ra0fjbdmls0lzn7y0d9bf0s3879";
        authors = [
          "Without Boats <boats@mozilla.com>"
        ];
        dependencies = [
      ...
      "fehler-macros" = rec {
        ...
        version = "1.0.0-alpha.1";
        edition = "2018";
        sha256 = "1x57z1d7sbf4hixcd56l7gpy9a0d2mk5l423b86z35nraxrh7gsv";
        procMacro = true;
        authors = [
          "Without Boats <boats@mozilla.com>"
        ];
      ...
      "rocket_contrib" = rec {
        ...
        resolvedDefaultFeatures = [ "glob" "handlebars" "handlebars_templates" "serde" "serde_json" "templates" ];
      };
      "rocket_http" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
