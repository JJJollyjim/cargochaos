...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/schemars/v0.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "schemars" = rec {
        ...
        resolvedDefaultFeatures = [ "arrayvec" "chrono" "derive_json_schema" "either" "impl_json_schema" "indexmap" "smallvec" "uuid" ];
      };
      "schemars_derive" = rec {
        crateName = "schemars_derive";
        version = "0.7.1";
        edition = "2018";
        sha256 = "19z23567qz2k53iah3288azfirh397q8j5vkdafl4jhc297rdhih";
        procMacro = true;
        authors = [
          "Graham Esau <gesau@hotmail.co.uk>"
        ];
