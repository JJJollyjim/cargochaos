...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-svgbob/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-svgbob" = rec {
        crateName = "mdbook-svgbob";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "mdbook-svgbob"; path = "src/main.rs"; }
        ];
      ...
      "pulldown-cmark-to-cmark" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "01xr3gxsc9szw3srfi9zwl7z4bd0pyqg68429fvf3sv7nx6hvan6";
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
      ...
      "svgbob" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "1ddlh6lh1wjhmd55mk330l0p3xhx57q5badjg0ypyqyqznxnqlnx";
        authors = [
