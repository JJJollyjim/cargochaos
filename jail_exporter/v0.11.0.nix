...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jail_exporter/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "vec_map" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
      ...
      "jail" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "1qgpazasfm18kv3hqsgjf9klf3lnyj89zabwq9y8p94w72cvxnhg";
        authors = [
      ...
      "jail_exporter" = rec {
        crateName = "jail_exporter";
        version = "0.11.0";
        edition = "2018";
        crateBin = [
          { name = "jail_exporter"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "winuser" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
