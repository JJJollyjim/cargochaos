...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluminurs/v1.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "hyper-tls" "json" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rpassword" = rec {
        crateName = "rpassword";
        version = "4.0.3";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
