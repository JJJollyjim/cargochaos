...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shrust/v0.0.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "winbase" "wincon" ];
      };
