...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rand/v0.7.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rand" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "getrandom" "getrandom_package" "libc" "log" "nightly" "packed_simd" "rand_pcg" "serde1" "simd_support" "small_rng" "std" "stdweb" "wasm-bindgen" ];
      };
      "rand_chacha" = rec {
