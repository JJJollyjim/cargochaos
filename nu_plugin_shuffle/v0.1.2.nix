...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu_plugin_shuffle/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nu_plugin_shuffle" = rec {
        crateName = "nu_plugin_shuffle";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "nu_plugin_shuffle"; path = "src/main.rs"; }
        ];
