...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/buildkit-frontend/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "buildkit-llb" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "02j397zq6krp3vcn7vhgjxz9m5nf2hrkz5wpcxdysxsx9yggpq07";
        authors = [
          "Denys Zariaiev <denys.zariaiev@gmail.com>"
        ];
        dependencies = [
      ...
      "buildkit-proto" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "05g8y7p54wkfx72jrdi2wbylr3g17gjpfa1z1i5vbwpvb9r65q9d";
        authors = [
          "Denys Zariaiev <denys.zariaiev@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
