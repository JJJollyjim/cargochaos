...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/effective-limits/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "effective-limits" = rec {
        crateName = "effective-limits";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "test-limited"; path = "src/bin/test-limited.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "combaseapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "ioapiset" "jobapi" "jobapi2" "minwindef" "processthreadsapi" "psapi" "shlobj" "shtypes" "synchapi" "sysinfoapi" "tlhelp32" "userenv" "winbase" "winerror" "winioctl" "winnt" "winuser" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "ioapiset" "jobapi" "jobapi2" "minwindef" "processthreadsapi" "psapi" "shlobj" "shtypes" "synchapi" "sysinfoapi" "tlhelp32" "userenv" "winbase" "winerror" "winioctl" "winnt" "winuser" ];
      };
