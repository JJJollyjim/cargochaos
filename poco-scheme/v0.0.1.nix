...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/poco-scheme/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lexpr" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "11db8mqvc76430vkrkz72ca0fp48bkaapc7i42jg8bvaawvsnma3";
        authors = [
      ...
      "lexpr-macros" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "079134mi2kwbzprar5jvcyh1w6s57825almb21whx269xxzpdk8x";
        procMacro = true;
        authors = [
          "Andreas Rottmann <mail@r0tty.org>"
        ];
      ...
      "poco-scheme" = rec {
        crateName = "poco-scheme";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "poco-scheme"; path = "src/main.rs"; }
        ];
