...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/devserver/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "devserver" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "devserver"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Ian Kettlewell <ian.kettlewell@gmail.com>"
        ];
        dependencies = [
          {
            name = "devserver_lib";
            packageId = "devserver_lib";
            features = [ "reload" ];
          }
        ];
      ...
      "devserver_lib" = rec {
        crateName = "devserver_lib";
        version = "0.1.3";
        edition = "2018";
        sha256 = "0myqdg9777snaw8xrg0gy57bqz6nh8910dbh5rhasid987qyyfmn";
        authors = [
          "Ian Kettlewell <ian.kettlewell@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "base64" "default" "notify" "reload" "sha-1" ];
      };
      "digest" = rec {
        crateName = "digest";
        version = "0.8.1";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "processenv" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
