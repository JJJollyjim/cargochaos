...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clickhouse-rs/v0.2.0-alpha.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
