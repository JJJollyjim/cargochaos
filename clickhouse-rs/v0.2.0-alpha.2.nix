...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clickhouse-rs/v0.2.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "io" "net" "num_cpus" "rt-full" "sync" "tcp" "timer" "tokio-executor" "tokio-io" "tokio-macros" "tokio-net" "tokio-sync" "tokio-timer" "tracing-core" "udp" "uds" ];
      };
      "tokio-codec" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
