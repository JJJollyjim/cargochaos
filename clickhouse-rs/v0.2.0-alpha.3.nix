...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clickhouse-rs/v0.2.0-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clickhouse-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "async_std" "default" "native-tls" "tls" "tokio" "tokio-tls" "tokio_io" ];
      };
