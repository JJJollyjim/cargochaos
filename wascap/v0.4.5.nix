...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wascap/v0.4.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wascap" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wascap"; path = "src/bin/wascap.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "cli" "exitfailure" "quicli" "structopt" "term-table" ];
      };
      "wasi" = rec {
        crateName = "wasi";
