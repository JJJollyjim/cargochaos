...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/msgbox/v0.5.0.nix.tmp"
      ...
      "msgbox" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "gtk";
            packageId = "gtk";
            target = { target, features }: ((target."os" == "linux") || (target."os" == "dragonfly") || (target."os" == "freebsd") || (target."os" == "netbsd") || (target."os" == "openbsd"));
          }
          {
            name = "objc";
            packageId = "objc";
