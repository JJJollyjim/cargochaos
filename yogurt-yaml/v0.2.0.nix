...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yogurt-yaml/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "yogurt-yaml" = rec {
        crateName = "yogurt-yaml";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "curt-extract"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "libcurt";
        authors = [
          "Johannes Jeising <Johannes.Jeising@gmail.com>"
        ];
        dependencies = [
          {
            name = "argparse";
