...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/omikuji/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "omikuji" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "omikuji"; path = "src/bin/omikuji.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "simple_logger" ];
      };
      "order-stat" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" ];
      };
