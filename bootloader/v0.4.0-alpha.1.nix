...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bootloader/v0.4.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bootloader" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "map_physical_memory" "recursive_level_4_table" "vga_320x200" ];
      };
      "fixedvec" = rec {
        crateName = "fixedvec";
        version = "0.2.3";
      ...
      "x86_64" = rec {
        ...
        version = "0.3.5";
        edition = "2015";
        sha256 = "0gwrai8dzz9cawvbz2xwmzjy9sx46gbh8w3h7bfycb7m83h3rnv8";
        authors = [
