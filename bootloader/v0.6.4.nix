...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bootloader/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bootloader" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "font8x8" "map_physical_memory" "recursive_page_table" "vga_320x200" ];
      };
      "cast" = rec {
        crateName = "cast";
        version = "0.2.2";
