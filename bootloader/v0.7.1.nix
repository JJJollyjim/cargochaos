...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bootloader/v0.7.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bootloader" = rec {
        ...
        resolvedDefaultFeatures = [ "binary" "default" "fixedvec" "font8x8" "llvm-tools" "map_physical_memory" "recursive_page_table" "usize_conversions" "vga_320x200" "x86_64" "xmas-elf" ];
      };
      "cast" = rec {
        crateName = "cast";
        version = "0.2.2";
