...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bootloader/v0.2.0-alpha-005.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bootloader" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.0-alpha-005.nix {};
        authors = [
          "Philipp Oppermann <dev@phil-opp.com>"
        ];
        dependencies = [
      ...
      "x86_64" = rec {
        ...
        version = "0.2.7";
        edition = "2015";
        sha256 = "10zg09la2ksq899aw3f39kq9ppz2db28k1q4v2sz9c2bqi8wlk7i";
        authors = [
