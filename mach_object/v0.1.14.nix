...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mach_object/v0.1.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mach_object" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "display" "integration_tests" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.2.1";
