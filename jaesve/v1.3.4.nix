...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jaesve/v1.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jaesve" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "jaesve"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.3.4.nix {};
        authors = [
          "Baz <github(a)luxolus.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "config-file" "dirs" "serde" "toml" ];
      };
      "lazy_static" = rec {
      ...
      "linereader" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0sj0n14h3wd37jiw6sf4pjwarpz3367ixpz1l23k1gyiwsy1v7gj";
        authors = [
