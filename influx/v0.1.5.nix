...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/influx/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "regexp" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "02qr8liq7705rnnad0w3pfyvcshy4naxahky0kvj99904q048m9a";
        authors = [
          "Grigoriy Baranov <baranov@w3m.co>"
        ];
        dependencies = [
      ...
      "wdg-uri" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0pz30gywqjy9h9ckm90i6kmkjscbg1yw4ji5hw08l74fl8kxn7pc";
        authors = [
          "Grigoriy Baranov <baranov@w3m.co>"
        ];
        dependencies = [
