...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wyr/v0.3.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "my_internet_ip" = rec {
        crateName = "my_internet_ip";
        version = "0.1.1";
        edition = "2015";
        sha256 = "05gn9dgyqv540dln71rhgjqvl9ki5jlsnaabqkffwffkj8vxic6d";
        authors = [
          "Philipp Ludwig <git@philippludwig.net>"
        ];
        dependencies = [
          {
            name = "curl";
