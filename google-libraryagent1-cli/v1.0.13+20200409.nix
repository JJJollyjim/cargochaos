...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-libraryagent1-cli/v1.0.13+20200409.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-libraryagent1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-libraryagent1" = rec {
        crateName = "google-libraryagent1";
        version = "1.0.13+20200409";
        edition = "2015";
        sha256 = "0vlmwcnsw68sznn5cvkr78ibg7piv72xi22x8cjkgh5qbx2bb1ry";
        authors = [
      ...
      "google-libraryagent1-cli" = rec {
        crateName = "google-libraryagent1-cli";
        version = "1.0.13+20200409";
        edition = "2015";
        crateBin = [
          { name = "libraryagent1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-libraryagent1";
            packageId = "google-libraryagent1";
          }
          {
            name = "hyper";
            packageId = "hyper";
