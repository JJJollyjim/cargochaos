...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zeebest/v0.20.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "zeebest" = rec {
        ...
        authors = [
          "Mackenzie Clark <mackenzie.a.z.c@gmail.com>"
        ];
        dependencies = [
          {
            name = "failure";
        ...
        resolvedDefaultFeatures = [ "futures01" ];
      };
    };
