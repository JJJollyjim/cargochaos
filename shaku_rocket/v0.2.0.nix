...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shaku_rocket/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shaku" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0cidaag8v298wfjvmy6awyvyzigj5062l1wci9jpd2ng67fdmd5i";
        authors = [
          "Mark Drobnak <mark.drobnak@gmail.com>"
        ];
        dependencies = [
          {
            name = "anymap";
        ...
        resolvedDefaultFeatures = [ "default" "derive" "shaku_derive" "thread_safe" ];
      };
      "shaku_derive" = rec {
        crateName = "shaku_derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0ad7d7zqqb0ryly9vawyj2gqdm0mpm3rqsxbyf1qw9pnrhyihbii";
        procMacro = true;
        authors = [
          "Mark Drobnak <mark.drobnak@gmail.com>"
        ];
