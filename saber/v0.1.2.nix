...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/saber/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "analytic" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "099v4bpkd60i9kmfrjlrp5vhhi1663qmmz2fsyy54j35x17srhk4";
        authors = [
          "Aaron"
        ];
        dependencies = [
      ...
      "biofile" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "0d3ssksj84b990jq4says0zpmmw1h2n1130fryh9wpv9h1pljfap";
        authors = [
          "Aaron"
        ];
        dependencies = [
      ...
      "blas-src 0.3.0" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0cxln7bgwxbknaf3qbv4hscy9k53msax14x0szvvp680km3z9zs6";
        authors = [
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
      ...
      "ndarray-linalg" = rec {
        ...
        version = "0.10.0";
        edition = "2015";
        sha256 = "1f4allm71i22nv49sxfdbjsixqhb6nmssd87ymd2y26lgzdj4s1k";
        authors = [
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
        dependencies = [
      ...
      "ndarray-rand" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "0l22wl3ixsdhc4j9m4xh48rfmby5mh1nk9bv8jjpxag6x5zbi8mm";
        authors = [
          "bluss"
        ];
        dependencies = [
      ...
      "openblas-src" = rec {
        ...
        version = "0.6.1";
        edition = "2015";
        sha256 = "1bbs55s8bz2z0gcj7kh9ykxqn3x79m4cnmip7r6n5w4msyinalmg";
        authors = [
      ...
      "procedurals" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "08s31ayjln8v1wcn9p7r1g81g2y1s5rip4zpx07aa7yh4kx6cghd";
        procMacro = true;
        authors = [
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
      ...
      "saber" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "test_gg_trace_estimates"; path = "src/bin/test_gg_trace_estimates.rs"; }
          { name = "replace_missing_pheno_with_mean"; path = "src/bin/replace_missing_pheno_with_mean.rs"; }
          { name = "regress_out_covariates"; path = "src/bin/regress_out_covariates.rs"; }
          { name = "partition_by_chrom"; path = "src/bin/partition_by_chrom.rs"; }
          { name = "leave_one_chrom_out"; path = "src/bin/leave_one_chrom_out.rs"; }
          { name = "get_snp_correlation_stats"; path = "src/bin/get_snp_correlation_stats.rs"; }
          { name = "generate_gxg_bed"; path = "src/bin/generate_gxg_bed.rs"; }
          { name = "generate_g_and_gxg_effects"; path = "src/bin/generate_g_and_gxg_effects.rs"; }
          { name = "estimate_multi_gxg_heritability"; path = "src/bin/estimate_multi_gxg_heritability.rs"; }
          { name = "estimate_heritability"; path = "src/bin/estimate_heritability.rs"; }
          { name = "estimate_g_gxg_heritability"; path = "src/bin/estimate_g_gxg_heritability.rs"; }
          { name = "create_bedt"; path = "src/bin/create_bedt.rs"; }
        ];
