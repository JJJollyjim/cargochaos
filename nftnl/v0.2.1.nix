...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nftnl/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mnl" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1xxqz3jz4x5j1hm3k72q8qinn5qk1dcmwci7c7fr0w3i6d5mdpwx";
        authors = [
      ...
      "mnl-sys" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1cs19n2i63w23ysc5x2r8z4ls9h1fqmysyj3dj5ydxpy2w8b0z2x";
        authors = [
          "Mullvad VPN <admin@mullvad.net>"
          "Linus Färnstrand <faern@faern.net>"
        ];
      ...
      "nftnl" = rec {
        ...
        resolvedDefaultFeatures = [ "nftnl-1-0-7" "nftnl-1-0-8" "nftnl-1-0-9" "nftnl-1-1-0" "nftnl-1-1-1" "nftnl-1-1-2" ];
      };
      "nftnl-sys" = rec {
        crateName = "nftnl-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1arb7yjqdsz9173ikpwf3lwvdxrsxsbwn9458whglcwlq1492m9d";
        authors = [
          "Mullvad VPN <admin@mullvad.net>"
          "Linus Färnstrand <linus@mullvad.net>"
        ];
