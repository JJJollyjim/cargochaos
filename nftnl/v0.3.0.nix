...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nftnl/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mnl" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "09p26grjxi425wm359iv8x5fqc55gy2bjiz8ww9d3b6v905bbvz6";
        authors = [
      ...
      "mnl-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "08kilcrbj35f1ygvhlqc21nxq0f5fgzh4r9ap6jv68n7k5ah60jk";
        authors = [
          "Mullvad VPN <admin@mullvad.net>"
          "Linus Färnstrand <faern@faern.net>"
        ];
      ...
      "nftnl-sys" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0cyahr889yv3j5wh5dqyzdhbmviaxfm8hcw17p0xgdr5n74k98fv";
        authors = [
          "Mullvad VPN"
        ];
        dependencies = [
