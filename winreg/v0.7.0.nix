...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/winreg/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "impl-debug" "impl-default" "ktmw32" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winerror" "winnt" "winreg" ];
      };
      ...
      "winreg" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "serde" "serialization-serde" "transactions" ];
      };
    };
