...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-keygen/v1.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-keygen" = rec {
        crateName = "solana-keygen";
        version = "1.1.6";
        edition = "2018";
        crateBin = [
          { name = "solana-keygen"; path = "src/keygen.rs"; }
        ];
