...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/krankerl/v0.12.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "composer" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0ix02jam7dyrdfynpinl2qrz5230fh0bwiwvd09p9jj8lar543fq";
        authors = [
      ...
      "krankerl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "krankerl"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "nextcloud_appinfo";
          }
          {
            name = "nextcloud_appsignature";
            packageId = "nextcloud_appsignature";
          }
          {
            name = "nextcloud_appstore";
            packageId = "nextcloud_appstore";
          }
          {
            name = "npm_scripts";
            packageId = "npm_scripts";
          }
          {
            name = "pathdiff";
            packageId = "pathdiff";
      ...
      "nextcloud_appinfo" = rec {
        crateName = "nextcloud_appinfo";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0nlbnsxw57ilaf0sx3s2d7krn00abg2vxgw4bym4508cban8xrdx";
        authors = [
          "Christoph Wurst <christoph@winzerhof-wurst.at>"
        ];
        dependencies = [
          ...
          {
            name = "xpath_reader";
            packageId = "xpath_reader";
          }
        ];
        
      };
      "nextcloud_appsignature" = rec {
        crateName = "nextcloud_appsignature";
        version = "0.4.0";
        edition = "2018";
        sha256 = "03xb6zsz2bb5bala76h3308v84lgbhklhhp9y9j7damhvx0bsk92";
        authors = [
          "Christoph Wurst <christoph@winzerhof-wurst.at>"
        ];
        dependencies = [
      ...
      "nextcloud_appstore" = rec {
        crateName = "nextcloud_appstore";
        version = "0.6.0";
        edition = "2018";
        sha256 = "15lnk2ssaappgfd6p8aw0qzhqn90ldyxycq3709qllqwvfwjcjxn";
        authors = [
          "Christoph Wurst <christoph@winzerhof-wurst.at>"
        ];
        dependencies = [
      ...
      "npm_scripts" = rec {
        crateName = "npm_scripts";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0rgkkjld44w7iz4h8gqfxpaz8inp0j963fjasw5d2cg7vndw5r76";
        authors = [
          "Christoph Wurst <christoph@winzerhof-wurst.at>"
        ];
        dependencies = [
      ...
      "xpath_reader" = rec {
        crateName = "xpath_reader";
        version = "0.5.3";
        edition = "2015";
        sha256 = "1jg0gk5pgllpg9pvi6nsi09c3n781mmv48426x7aq1r7wgi1wvgb";
        authors = [
          "Leo Schwarz <mail@leoschwarz.com>"
        ];
        dependencies = [
          {
            name = "sxd-document";
