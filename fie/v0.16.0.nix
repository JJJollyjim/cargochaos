...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fie/v0.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compu-brotli-sys" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "15nw2hxqiv6h96mm2fzdc7znbsddk8rc7gf3n6pc99ljffy6jz95";
        authors = [
          "Douman <douman@gmx.se>"
        ];
        buildDependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "rt-core" "slab" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
