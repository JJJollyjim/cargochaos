...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/olympia_disassembler/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "olympia_disassembler";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "olympia_disassembler" = rec {
        crateName = "olympia_disassembler";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "olympia_disassembler"; path = "src/main.rs"; }
        ];
      ...
      "olympia_engine" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1r9i6l89a86dmhpayzm6ag8g5ffgglnq45r6fd5hkvbya33q0lv9";
        authors = [
          "Tony Finn <olympia@tonyfinn.com>"
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "default" "disassembler" ];
      };
