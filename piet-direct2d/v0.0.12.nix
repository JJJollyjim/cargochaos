...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/piet-direct2d/v0.0.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "piet-test" = rec {
        ...
        version = "0.0.12";
        edition = "2018";
        sha256 = "1970qrg2rp10jj36m6rzy0v7c7llahgymj8pwnr13clz1x5kjlyh";
        authors = [
          "Raph Levien <raph.levien@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "d2d1" "d2d1_1" "d2d1effects" "d3d11" "dxgi" "errhandlingapi" "fileapi" "handleapi" "minwindef" "processthreadsapi" "std" "unknwnbase" "wincon" "winnt" ];
      };
