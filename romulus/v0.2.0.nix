...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/romulus/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "romulus" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "romulus"; path = "src/bin/romulus/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "eulegang<eulegang@gmail.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
        ...
        resolvedDefaultFeatures = [ "bind" "color" "default" "envvar" "stdin-tty" ];
      };
      "rustc_version" = rec {
