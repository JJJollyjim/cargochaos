...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jlib/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "basex-rs" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1kz98j7vfz9d3lc3ihpkj9a3907xyjcrn20sys45hqrzf53h3igi";
        authors = [
          "zTgx <747674262@qq.com>"
        ];
      ...
      "cast-rs" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1hpgn7dklmv0pyy5a9zlyp0pw9b2flvqikb4paiv5n58c23rb6x6";
        libName = "cast_rs";
        authors = [
          "zTgx <beautifularea@163.com>"
        ];
        dependencies = [
          {
            name = "downcast-rs";
      ...
      "juniper" = rec {
        ...
        version = "0.9.2";
        edition = "2015";
        sha256 = "0cfxg700jml3gpglf7ps1v3an2pcxgb0mah3ml8icqnfxzjhllmw";
        authors = [
      ...
      "juniper_codegen" = rec {
        ...
        version = "0.9.2";
        edition = "2015";
        sha256 = "17jcardg0h669y6v0x8fiiq57ghbjn2sjv1f5vb0mzv8slpmwq6j";
        procMacro = true;
        authors = [
          "Magnus Hallin <mhallin@fastmail.com>"
          "Christoph Herzog <chris@theduke.at>"
      ...
      "secp256k1" = rec {
        ...
        version = "0.13.0";
        edition = "2015";
        sha256 = "1v7pnic8brnv3782jpvi8bh6kn2mpf2mhh314p91qcs4dxc2q7zv";
        authors = [
      ...
      "slice-cast" = rec {
        crateName = "slice-cast";
        version = "0.1.2";
        edition = "2015";
        sha256 = "12793chfrzr9n16kna28jjp86z331qd78ysizy026g6adxbr27yf";
        authors = [
      ...
      "typename" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "1gcklp311s5dj7vw04vld88fh52dqayafbm6b87b68x11qlm9yww";
        authors = [
      ...
      "typename_derive" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "1dj58rkrgr8rkclg7ygjw1v87zymmilw179ml3xahn1j397b3wzn";
        procMacro = true;
        authors = [
          "Sebastian Wicki <swicki@inf.ethz.ch>"
        ];
