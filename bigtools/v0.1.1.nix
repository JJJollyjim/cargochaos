...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bigtools/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "bigtools" = rec {
        ...
        crateBin = [
          ...
          { name = "verify"; path = "src/bin/verify.rs"; }
          { name = "bigwigvaluesoverbed"; path = "src/bin/bigwigvaluesoverbed.rs"; }
          { name = "bigwigtobedgraph"; path = "src/bin/bigwigtobedgraph.rs"; }
          { name = "bigwigmerge"; path = "src/bin/bigwigmerge.rs"; }
          { name = "bigwiginfo"; path = "src/bin/bigwiginfo.rs"; }
          { name = "bigwigaverageoverbed"; path = "src/bin/bigwigaverageoverbed.rs"; }
          { name = "bedtobigbed"; path = "src/bin/bedtobigbed.rs"; }
          { name = "bedgraphtobigwig"; path = "src/bin/bedgraphtobigwig.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Jack Huey <jackh726@gmail.com>"
        ];
        dependencies = [
          {
            name = "bincode";
        ...
        resolvedDefaultFeatures = [ "default" "remote" "reqwest" ];
      };
      "bincode" = rec {
        crateName = "bincode";
        version = "1.2.0";
      ...
      "libdeflater" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0ih2x22qpxsm9nq7d9hjdjz5r61kz02xv8fwysr6b61n2f5s1p36";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "io" "tcp" "timer" "tokio-io" "tokio-net" "tokio-timer" ];
      };
      "tokio-codec" = rec {
      ...
      "tokio-net" = rec {
        ...
        resolvedDefaultFeatures = [ "async-traits" "bytes" "iovec" "tcp" "tracing" ];
      };
      "tokio-sync" = rec {
