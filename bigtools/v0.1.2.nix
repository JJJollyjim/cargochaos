...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bigtools/v0.1.2.nix.tmp"
    ...
    crates = {
      ...
      "bigtools" = rec {
        ...
        crateBin = [
          ...
          { name = "bigtools"; path = "src/bin/bigtools.rs"; }
          { name = "bigbedtobed"; path = "src/bin/bigbedtobed.rs"; }
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            usesDefaultFeatures = false;
            features = [ "io-util" "rt-core" "rt-threaded" ];
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "default" "remote" "reqwest" "tokio" ];
      };
      "bincode" = rec {
        crateName = "bincode";
        version = "1.2.0";
