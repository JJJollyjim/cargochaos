...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/screenruster-saver-hacks/v0.2.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "screenruster-saver-hacks";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "screenruster-saver-hacks" = rec {
        crateName = "screenruster-saver-hacks";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "screenruster-saver-hacks"; path = "src/main.rs"; }
        ];
