...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mavlink2rest/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mavlink" = rec {
        ...
        resolvedDefaultFeatures = [ "byteorder" "common" "default" "direct-serial" "serde" "serial" "std" "tcp" "udp" ];
      };
      "mavlink2rest" = rec {
        crateName = "mavlink2rest";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "mavlink2rest"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
