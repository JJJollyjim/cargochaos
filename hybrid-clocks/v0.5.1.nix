...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hybrid-clocks/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hex-slice" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0k3ck81m9lz5wz3c7qqj3j3m5xa5pr599n41gbq58i91w04a74al";
        authors = [
      ...
      "hybrid-clocks" = rec {
        ...
        resolvedDefaultFeatures = [ "deserialize-v1" "pretty-print" "serde" "serde_derive" "serialization" "time" ];
      };
      "itoa" = rec {
        crateName = "itoa";
        version = "0.4.4";
      ...
      "suppositions" = rec {
        crateName = "suppositions";
        version = "0.1.4";
        edition = "2015";
        sha256 = "1n03ipkqgpvdmjcz9xp9d6yyf58rq7c5g4ki76k848a18r59m9qm";
        authors = [
          "Ceri Storey <cez@necrofish.org.uk>"
        ];
        dependencies = [
