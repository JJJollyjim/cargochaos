...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gitlab-ci-validate/v0.0.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gitlab-ci-validate" = rec {
        crateName = "gitlab-ci-validate";
        version = "0.0.4";
        edition = "2018";
        crateBin = [
          { name = "gitlab-ci-validate"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.4.nix {};
        authors = [
          "pradel <pradel.leo@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
