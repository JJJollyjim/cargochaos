...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty-menu/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusty-menu" = rec {
        crateName = "rusty-menu";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "rusty-menu"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "michael hertsens <michael28072000@outlook.be>"
        ];
        dependencies = [
          {
            name = "colored";
