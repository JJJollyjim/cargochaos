...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-gamesmanagement1_management-cli/v1.0.13+20200402.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-gamesmanagement1_management-cli";
  ...
  workspaceMembers = {
    "google-gamesmanagement1_management-cli" = rec {
      packageId = "google-gamesmanagement1_management-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-gamesmanagement1_management-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-gamesmanagement1_management" = rec {
        crateName = "google-gamesmanagement1_management";
        version = "1.0.13+20200402";
        edition = "2015";
        sha256 = "1ar2cfnmmkynz5rcd2pqqm9wlvk2qj6kpvpxjamq0sfs3pszhb29";
        authors = [
      ...
      "google-gamesmanagement1_management-cli" = rec {
        crateName = "google-gamesmanagement1_management-cli";
        version = "1.0.13+20200402";
        edition = "2015";
        crateBin = [
          { name = "gamesmanagement1-management"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200402.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-gamesmanagement1_management";
          }
          {
            name = "hyper";
            packageId = "hyper";
