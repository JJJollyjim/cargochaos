...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imgui-ext/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgui 0.0.22" = rec {
        ...
        version = "0.0.22";
        edition = "2018";
        sha256 = "1c31drhlln2f28hppzcr74z1k9c8sg3h2hzywmpshlk4s2gis4md";
        authors = [
      ...
      "imgui 0.1.0" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1iwxiprpcpavqqzk0fdmxikwqq4ywyicsylbvvr62cc4wai3gqdh";
        authors = [
          "Joonas Javanainen <joonas.javanainen@gmail.com>"
          "imgui-rs contributors"
        ];
      ...
      "imgui-ext" = rec {
        ...
        dependencies = [
          {
            name = "imgui";
            packageId = "imgui 0.1.0";
          }
          {
            name = "imgui-ext-derive";
            packageId = "imgui-ext-derive";
          }
        ];
        devDependencies = [
          {
          ...
          }
          {
            ...
            packageId = "imgui-opengl-renderer";
          }
          {
            name = "imgui-sdl2";
            packageId = "imgui-sdl2";
          }
          {
            name = "nalgebra";
            packageId = "nalgebra";
        ...
        resolvedDefaultFeatures = [ "default" "matrix" "mint" ];
      };
      "imgui-ext-derive" = rec {
        crateName = "imgui-ext-derive";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1x97n8bvfxnrhgcj5r86b1g09p12v6c78rliydwrxhpkvaa491zz";
        procMacro = true;
        authors = [
          "german gomez <germangb42@gmail.com>"
        ];
      ...
      "imgui-opengl-renderer" = rec {
        crateName = "imgui-opengl-renderer";
        version = "0.4.0";
        edition = "2015";
        sha256 = "07gjp03c0yfjcnv6ma8syy05vhplsx9zxirqi3l01r3lh8fxmf64";
        authors = [
          "Michael Fairley <michael@michaelfairley.com>"
        ];
        dependencies = [
          {
            name = "imgui";
            packageId = "imgui 0.0.22";
          }
        ];
        buildDependencies = [
          {
      ...
      "imgui-sdl2" = rec {
        crateName = "imgui-sdl2";
        version = "0.5.0";
        edition = "2015";
        sha256 = "1sb63ana2sd9yk4nd4p5iyp2qc7w3fj0506yki9h7vvc3avjpp1c";
        authors = [
          "Michael Fairley <michael@michaelfairley.com>"
        ];
        dependencies = [
      ...
      "imgui-sys 0.0.22" = rec {
        crateName = "imgui-sys";
        version = "0.0.22";
        edition = "2018";
        sha256 = "0daq85fp19arr8mjvb64q55q4pbhx0fgfcl3437a9a248ywdmhyc";
        authors = [
          "Joonas Javanainen <joonas.javanainen@gmail.com>"
          "imgui-rs contributors"
        ];
      ...
      "imgui-sys 0.1.0" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0zyma3wxsl34hnlbas69khka66lj4p8is1pmk9vmhmpqvqks9vz5";
        authors = [
          "Joonas Javanainen <joonas.javanainen@gmail.com>"
          "imgui-rs contributors"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "minwindef" "ntsecapi" "ntstatus" "profileapi" "winbase" "winerror" "winnt" ];
      };
