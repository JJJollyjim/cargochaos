...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo2junit/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo2junit" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo2junit"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.4.nix {};
        authors = [
          "John Erickson <john.t.erickson@gmail.com>"
        ];
        dependencies = [
          {
            name = "junit-report";
