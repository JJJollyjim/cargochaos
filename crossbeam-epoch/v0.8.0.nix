...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crossbeam-epoch/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossbeam-epoch" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "lazy_static" "nightly" "sanitize" "std" ];
      };
      "crossbeam-utils" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "lazy_static" "nightly" "std" ];
      };
      "fuchsia-cprng" = rec {
