...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbookshelf/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git2" = rec {
        ...
        resolvedDefaultFeatures = [ "curl" "default" "https" "openssl-probe" "openssl-sys" "ssh" ];
      };
      "gitignore" = rec {
        crateName = "gitignore";
        version = "1.0.6";
      ...
      "libgit2-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "curl" "curl-sys" "https" "libssh2-sys" "openssl-sys" "ssh" ];
      };
      "libssh2-sys" = rec {
      ...
      "mdbook-epub" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "14lmmzd1wpgyc6c1y5dyrq3k02hr2b7dbh9xdxr125nr1lnr2g73";
        authors = [
      ...
      "mdbookshelf" = rec {
        crateName = "mdbookshelf";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "mdbookshelf"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Ramses Ladlani <rladlani@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shellapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
