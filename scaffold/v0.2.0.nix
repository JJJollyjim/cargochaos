...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/scaffold/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quest" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1n2rzql4dcchdp2wrhqvapk7i5wglf0yalspyh9yx8jkr7szasjm";
        authors = [
      ...
      "scaffold" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "scaffold"; path = "src/main.rs"; }
        ];
