...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/carapax-session/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "carapax" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1nr001xrjhbr51g1x0ayg9cr1b7jrlv16za6ja30xfc37ym53srb";
        authors = [
      ...
      "carapax-codegen" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1mdlfv1fznyq2fz9sq55rxrkxhhsmfs4dv38xh0qr2x25p7ygfmc";
        procMacro = true;
        authors = [
          "Ross Nomann <rossnomann@protonmail.com>"
        ];
      ...
      "derefable" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1ryb8k7dj4v41rx62qj9qnghg2wli679b0f9f4q7cxch53qsn6g5";
        procMacro = true;
        authors = [
          "Aaron Power <a.power@1aim.com>"
        ];
        dependencies = [
          {
            name = "proc-macro2";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "hyper-rustls" "json" "rustls" "rustls-tls" "serde_json" "socks" "tokio-rustls" "tokio-socks" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
      ...
      "tgbot" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0p22dk6l4vizfbi04mlgal0d7719ssj7ndbynabdi51363xp76y9";
        authors = [
          "Ross Nomann <rossnomann@protonmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "socks" "json" "rustls-tls" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "tokio-socks" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "14p3x6swp299igfk04pbg2ckkirbxnd0b5bn4wssixsi9p3md9s5";
        authors = [
