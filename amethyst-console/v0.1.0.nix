...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst-console/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst-imgui" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "0ck0v1fcwimvxyr9q48fxibl1v5lcg0dbkca29a97icafakknhr3";
        authors = [
      ...
      "cvar" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0gmiygbb5hin14qvgh4yamkivdqbjs0jyxyjvlnah0r13fpkdz7i";
        authors = [
