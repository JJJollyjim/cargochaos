...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/protobuf_message_factory/v0.1.3.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "protobuf_message_factory";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "protobuf_message_factory" = rec {
        crateName = "protobuf_message_factory";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "protobuf_message_factory"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "egmkang wang <egmkang@outlook.com>"
        ];
        dependencies = [
          {
            name = "glob";
