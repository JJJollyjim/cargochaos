...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/probe-rs-cli/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "capstone" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1jcd7cmnq22xrs6cisp3q6gnycpblnsi8qlccydrm847g44py3pn";
        authors = [
      ...
      "capstone-sys" = rec {
        ...
        version = "0.11.0";
        edition = "2018";
        sha256 = "0ffpgs2lvl2m34y330bccd8zmawa371vyqinji3ki628gf4hggmf";
        authors = [
          "m4b <m4b.github.io@gmail.com>"
      ...
      "probe-rs-cli" = rec {
        crateName = "probe-rs-cli";
        version = "0.6.1";
        edition = "2018";
        crateBin = [
          { name = "probe-rs-cli"; path = "src/main.rs"; }
        ];
