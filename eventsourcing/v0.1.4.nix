...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eventsourcing/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eventsourcing" = rec {
        ...
        devDependencies = [
          {
            ...
            packageId = "eventsourcing-derive";
          }
        ];
        features = {
          "eventstore" = [ "uuid" ];
        ...
        resolvedDefaultFeatures = [ "default" "eventstore" "orgeventstore" "reqwest" "uuid" ];
      };
      "eventsourcing-derive" = rec {
        crateName = "eventsourcing-derive";
        version = "0.1.2";
        edition = "2015";
        sha256 = "0n69lrxlk8dyqp9gw7vfa1bpdiwi8sxcsk8g1flnw1nj60qzgvpn";
        procMacro = true;
        authors = [
          "autodidaddict <alothien@gmail.com>"
        ];
        dependencies = [
          {
            name = "quote";
