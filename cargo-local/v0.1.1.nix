...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-local/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-local" = rec {
        crateName = "cargo-local";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-local"; path = "src/main.rs"; }
        ];
