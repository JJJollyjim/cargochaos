...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/weasel/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "weasel" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rand" "rand_pcg" "random" "serde" "serialization" ];
      };
    };
