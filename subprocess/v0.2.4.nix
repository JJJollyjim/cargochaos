...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/subprocess/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "subprocess" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "just-echo"; path = "src/bin/just-echo.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "minwindef" "namedpipeapi" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "winbase" "winerror" "winnt" ];
      };
