...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/serde-with-expand-env/v1.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "serde-with-expand-env";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde-with-expand-env" = rec {
        crateName = "serde-with-expand-env";
        version = "1.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.1.0.nix {};
        authors = [
          "roger <rogerduran@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
