...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/raptorq/v1.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "primal" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "1900ilhxiid26krry95694qpi0lnd1k1l5sjahiv3bnyz9pbhc8f";
        authors = [
          "Huon Wilson <dbau.pp@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "primal-estimate";
          }
          {
            name = "primal-sieve";
            packageId = "primal-sieve";
          }
        ];
        features = {
      ...
      "primal-bit" = rec {
        crateName = "primal-bit";
        version = "0.2.4";
        edition = "2015";
        sha256 = "08cvigajy2pdf9yn137qp1sqfvkbkrwzaalr894wd501ypi68sk8";
        authors = [
          "Huon Wilson <dbau.pp@gmail.com>"
          "The Rust Project Developers"
        ];
      ...
      "primal-check" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "1lf2clwljbwhsjvg6lvzm9jyy5m1k4n3jx62k1qqh7qp19ngjrcf";
        authors = [
          "Huon Wilson <dbau.pp@gmail.com>"
        ];
        dependencies = [
      ...
      "primal-estimate" = rec {
        crateName = "primal-estimate";
        version = "0.2.1";
        edition = "2015";
        sha256 = "1mgq54jbvjn9p47sinlwpw3ld88xch28cg290rlvamz7vlqlbsjn";
        authors = [
          "Huon Wilson <dbau.pp@gmail.com>"
        ];
        features = {
      ...
      "primal-sieve" = rec {
        crateName = "primal-sieve";
        version = "0.2.9";
        edition = "2015";
        sha256 = "133rxfr8whqr0yr2gs5sgiqif0aw21yg0hzbmrrh4jxvd79nwbfs";
        authors = [
          "Huon Wilson <dbau.pp@gmail.com>"
        ];
        dependencies = [
      ...
      "raptorq" = rec {
        ...
        resolvedDefaultFeatures = [ "benchmarking" "pyo3" "python" ];
      };
      "rayon" = rec {
        crateName = "rayon";
        version = "1.3.0";
