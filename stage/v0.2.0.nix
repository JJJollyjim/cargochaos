...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stage/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "os-poll" "tcp" "udp" ];
      };
      "miow" = rec {
        crateName = "miow";
        version = "0.3.3";
      ...
      "mirai" = rec {
        ...
        version = "0.0.4";
        edition = "2018";
        sha256 = "02g6jhz7i0sqd0kr0fhzm1bqb68ry8f45x2ywirawaj3hxqxdmwm";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "tcp" "udp" ];
      };
      "ntapi" = rec {
        crateName = "ntapi";
        version = "0.3.3";
      ...
      "stage" = rec {
        ...
        features = {
          "default" = [ "tcp" "udp" ];
          "tcp" = [ "use-mirai" "mirai/tcp" ];
          "udp" = [ "use-mirai" "mirai/udp" ];
          "use-mirai" = [ "mirai" ];
        };
        resolvedDefaultFeatures = [ "default" "mirai" "tcp" "udp" "use-mirai" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "windef" "winerror" "winioctl" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
