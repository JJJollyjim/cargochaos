...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudtasks2_beta2-cli/v1.0.13+20200331.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudtasks2_beta2" = rec {
        ...
        edition = "2015";
        sha256 = "1bf6gd09pi6bg2p3lvn0rvhw7i5vjhrp2kvaf98vwd7r3943k21n";
        authors = [
