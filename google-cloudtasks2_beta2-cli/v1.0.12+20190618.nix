...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudtasks2_beta2-cli/v1.0.12+20190618.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudtasks2_beta2-cli";
  ...
  workspaceMembers = {
    "google-cloudtasks2_beta2-cli" = rec {
      packageId = "google-cloudtasks2_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-cloudtasks2_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudtasks2_beta2" = rec {
        crateName = "google-cloudtasks2_beta2";
        version = "1.0.12+20190618";
        edition = "2015";
        sha256 = "129bx7giq6l2vlxrww269vd3zghdjqpzmq9h3df5iijkwx54s1rd";
        authors = [
      ...
      "google-cloudtasks2_beta2-cli" = rec {
        crateName = "google-cloudtasks2_beta2-cli";
        version = "1.0.12+20190618";
        edition = "2015";
        crateBin = [
          { name = "cloudtasks2-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190618.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-cloudtasks2_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
