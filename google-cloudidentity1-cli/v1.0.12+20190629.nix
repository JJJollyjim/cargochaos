...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudidentity1-cli/v1.0.12+20190629.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudidentity1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudidentity1" = rec {
        crateName = "google-cloudidentity1";
        version = "1.0.12+20190629";
        edition = "2015";
        sha256 = "1rzcgx1r3yx6h4f4x7dk3arjpww4apnblzn5wrzys9jk70m4p7p5";
        authors = [
      ...
      "google-cloudidentity1-cli" = rec {
        crateName = "google-cloudidentity1-cli";
        version = "1.0.12+20190629";
        edition = "2015";
        crateBin = [
          { name = "cloudidentity1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-cloudidentity1";
            packageId = "google-cloudidentity1";
          }
          {
            name = "hyper";
            packageId = "hyper";
