...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-sheets4-cli/v1.0.13+20200402.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-sheets4" = rec {
        ...
        edition = "2015";
        sha256 = "1np6sdkpi1axw6waclisn1x2226jdp6a00fpn2l5fzna3kbz713r";
        authors = [
      ...
      "google-sheets4-cli" = rec {
        crateName = "google-sheets4-cli";
        version = "1.0.13+20200402";
        edition = "2015";
        crateBin = [
          { name = "sheets4"; path = "src/main.rs"; }
        ];
