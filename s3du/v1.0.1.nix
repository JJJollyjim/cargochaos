...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/s3du/v1.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusoto_cloudwatch" = rec {
        crateName = "rusoto_cloudwatch";
        version = "0.43.0";
        edition = "2018";
        sha256 = "07450n5kaxmasiia85ghgn6nkq6w87wj7b5rnkdsmyrigzqb52ni";
        authors = [
      ...
      "s3du" = rec {
        ...
        resolvedDefaultFeatures = [ "cloudwatch" "default" "rusoto_cloudwatch" "rusoto_s3" "s3" ];
      };
      "schannel" = rec {
        crateName = "schannel";
        version = "0.1.18";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
