...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/compress_history/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compress_history" = rec {
        crateName = "compress_history";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "compress_history"; path = "src/main.rs"; }
        ];
