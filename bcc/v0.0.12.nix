...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bcc/v0.0.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "processenv" "synchapi" "winbase" ];
      };
