...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bcc/v0.0.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcc" = rec {
        ...
        resolvedDefaultFeatures = [ "specific" "static" "v0_10_0" "v0_11_0" "v0_12_0" "v0_4_0" "v0_5_0" "v0_6_0" "v0_6_1" "v0_7_0" "v0_8_0" "v0_9_0" ];
      };
      "bcc-sys" = rec {
        crateName = "bcc-sys";
        version = "0.12.0";
        edition = "2018";
        sha256 = "0jbl4ynwajrx10flzhxfx3c5kz88hxr1ydk8pingqc05f5x5svfk";
        libName = "bcc_sys";
        authors = [
