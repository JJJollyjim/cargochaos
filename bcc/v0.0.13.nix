...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bcc/v0.0.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcc" = rec {
        ...
        resolvedDefaultFeatures = [ "static" "v0_10_0" "v0_4_0" "v0_5_0" "v0_6_0" "v0_6_1" "v0_7_0" "v0_8_0" "v0_9_0" ];
      };
      "bcc-sys" = rec {
        crateName = "bcc-sys";
        version = "0.10.0";
        edition = "2018";
        sha256 = "07p612nfinf0gnyxrnqdr380x46jkaf8y9g9qahkbpld15nrp55b";
        libName = "bcc_sys";
        authors = [
