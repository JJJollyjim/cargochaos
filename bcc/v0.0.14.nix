...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bcc/v0.0.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcc" = rec {
        ...
        resolvedDefaultFeatures = [ "specific" "static" "v0_10_0" "v0_11_0" "v0_4_0" "v0_5_0" "v0_6_0" "v0_6_1" "v0_7_0" "v0_8_0" "v0_9_0" ];
      };
      "bcc-sys" = rec {
        crateName = "bcc-sys";
        version = "0.11.0";
        edition = "2018";
        sha256 = "062m895gpn3r5jc3j1l6y4j0g4mr95pl25w8mxbjipg2qhzk7d52";
        libName = "bcc_sys";
        authors = [
