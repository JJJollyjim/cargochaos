...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidmanagement1-cli/v1.0.12+20190624.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-androidmanagement1-cli";
  ...
  workspaceMembers = {
    "google-androidmanagement1-cli" = rec {
      packageId = "google-androidmanagement1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-androidmanagement1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidmanagement1" = rec {
        crateName = "google-androidmanagement1";
        version = "1.0.12+20190624";
        edition = "2015";
        sha256 = "00mv8rl6q690j1hcxkmdpyfpx740vqhh047xkbaykpdrcfkxx3l6";
        authors = [
      ...
      "google-androidmanagement1-cli" = rec {
        crateName = "google-androidmanagement1-cli";
        version = "1.0.12+20190624";
        edition = "2015";
        crateBin = [
          { name = "androidmanagement1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-androidmanagement1";
            packageId = "google-androidmanagement1";
          }
          {
            name = "hyper";
            packageId = "hyper";
