...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidmanagement1-cli/v1.0.13+20200330.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidmanagement1" = rec {
        ...
        edition = "2015";
        sha256 = "0dn0fxada68kyv43yrl8rxfh087bnpgdciirqaz4v28raksjrzr5";
        authors = [
      ...
      "google-androidmanagement1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200330.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
