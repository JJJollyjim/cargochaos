...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/risq/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" "default" "strsim" "suggestions" "unstable" "vec_map" ];
      };
      "cloudabi" = rec {
        crateName = "cloudabi";
        version = "0.0.3";
      ...
      "futures-locks" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "10677ldd48ax9xs9fs2zl8jrqkzdcz1v51lbc8k7k619va46i80l";
        authors = [
      ...
      "juniper" = rec {
        ...
        version = "0.14.1";
        edition = "2018";
        sha256 = "1iycfrnpzms1fvpgkyz8jmazr0rvjg8hd1q9pf75ap9cfi5xwpjc";
        authors = [
      ...
      "juniper-from-schema" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0qp5jkmrsjbmpqrvg7mppxfrxwgxwqi9940hl5wcxpm11v98vnzk";
        authors = [
      ...
      "juniper-from-schema-code-gen" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0wffcnhadv7jvgrp0k15lx33lamjvdfxz75p9bzbaqsymrh8znnq";
        procMacro = true;
        authors = [
          "David Pedersen <david.pdrsn@gmail.com>"
        ];
      ...
      "juniper_codegen" = rec {
        ...
        version = "0.14.1";
        edition = "2018";
        sha256 = "1m6dyla0rp0kxmds4gqcgn8xyn38g03va4km6p2zkqzvsjynm4w0";
        procMacro = true;
        authors = [
          "Magnus Hallin <mhallin@fastmail.com>"
          "Christoph Herzog <chris@theduke.at>"
      ...
      "risq" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "risq"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.1.nix {};
        authors = [
          "Justin Carter <justin@misthos.io>"
        ];
        dependencies = [
          {
            name = "actix";
        ...
        resolvedDefaultFeatures = [ "checker" "default" "dummy-seed" "fail-on-warnings" "statistics" "vendored-openssl" ];
      };
      "rust-argon2" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
