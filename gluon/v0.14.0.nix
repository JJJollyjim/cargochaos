...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gluon/v0.14.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gluon_base" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "05kbr5nmz62v73wg56iahin2hmifvhqs3lg53ixicwvwa90q0qh2";
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "gluon_check" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1vb93s7nfdaa5rzm4il6ikv0pbz8qz6zcmlgyjbykm03ha5sdql5";
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "gluon_codegen" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "0vnnc6awsha3av9xw4kivlwj3hr5m22nwhqmj0pvk85rkpjg19gy";
        procMacro = true;
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
      ...
      "gluon_completion" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1va3d760l6q0q3lz3vgzvdi47q2xg7mycljkqn1ng6sph8vkdx6h";
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "gluon_format" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "142bj0bh2yvsz8c7rk125ni2d4dmb84lmac3dlm333x5zp3rcjjs";
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "gluon_parser" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1mpcp5m3fwazlmka4vwrqp0ibx95mi51s80d82x7akvqs29s170b";
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "gluon_vm" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1a8ll14bi4rfpgv3y9j5b5q4xmr55nnp0cqbwbv9i1pfk5z8qis8";
        authors = [
          "Markus <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "tensile" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "11p93d18798fb45cnkmcdh4kc0f41k5gnlrr4y4di6qb8xga3yqp";
        authors = [
          "Markus Westerlind <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
