...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gluon/v0.13.1.nix.tmp"
    ...
    crates = {
      ...
      "gluon" = rec {
        ...
        devDependencies = [
          ...
          {
            name = "pulldown-cmark";
            packageId = "pulldown-cmark 0.6.0";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "gluon_vm" = rec {
        ...
        resolvedDefaultFeatures = [ "difference" "gluon_parser" "lalrpop" "lalrpop-util" "regex" "serde" "serde_derive" "serde_derive_state" "serde_json" "serde_state" "serialization" "test" ];
      };
      "h2" = rec {
        crateName = "h2";
        version = "0.1.26";
      ...
      "tensile" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1qdazlg89hhc4511g071b3qlxk88p3g9i0l9hgkhfa0rbnq66mcv";
        authors = [
          "Markus Westerlind <marwes91@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
