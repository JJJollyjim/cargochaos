...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/soundio/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libsoundio-sys" = rec {
        crateName = "libsoundio-sys";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0zrsv4hsj30p35xy50hgybgrpmkc9c0xnavyg18cjaa0wfg5y6g2";
        libName = "libsoundio_sys";
        libPath = "lib.rs";
        authors = [
