...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-serde/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio-serde" = rec {
        ...
        resolvedDefaultFeatures = [ "bincode" "bincode-crate" "cbor" "derivative" "json" "messagepack" "rmp-serde" "serde" "serde_cbor" "serde_json" ];
      };
      "tokio-util" = rec {
        ...
        resolvedDefaultFeatures = [ "codec" "compat" "default" "full" "futures-io" "udp" ];
      };
      "unicode-xid" = rec {
