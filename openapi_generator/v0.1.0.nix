...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/openapi_generator/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "openapi_generator" = rec {
        crateName = "openapi_generator";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "openapi_generator"; path = "src/main.rs"; }
        ];
