...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-people1-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-people1" = rec {
        crateName = "google-people1";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "0yswdk78z4sw8dqs6lh178csvi15p8fd78gswxm54xma5b4yrk4i";
        authors = [
      ...
      "google-people1-cli" = rec {
        crateName = "google-people1-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "people1"; path = "src/main.rs"; }
        ];
