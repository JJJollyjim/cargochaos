...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/raster2svg/v1.0.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "contour_tracing" = rec {
        crateName = "contour_tracing";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1wrgqfqi87h3d530vmgla6d1kz39khly7qxn09lpagnvm5j5j9jq";
        authors = [
          "STPR"
        ];
      ...
      "raster2svg" = rec {
        crateName = "raster2svg";
        version = "1.0.5";
        edition = "2018";
        crateBin = [
          { name = "raster2svg"; path = "src/main.rs"; }
        ];
