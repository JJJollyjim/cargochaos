...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eaesy/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eaesy" = rec {
        ...
        resolvedDefaultFeatures = [ "aes" "block-cipher-trait" "block-modes" "block-padding" "default" "s32k144" "s32k144evb" "s32k144evb-q100" "software" ];
      };
      "embedded_types" = rec {
      ...
      "s32k144evb" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "1hb54zns6ka8yj0gi3rydac0f7wrvijgf8w6lp385mdzcqpd1glp";
        authors = [
          "Kjetil Kjeka <kjetilkjeka@gmail.com>"
          "tmplt <tmplt@dragons.rocks>"
        ];
