...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/knapsack-oxigen/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "knapsack-oxigen" = rec {
        crateName = "knapsack-oxigen";
        version = "1.0.0";
        edition = "2015";
        crateBin = [
          { name = "knapsack-oxigen"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Martin1887 <marcos.martin.pozo.delgado@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "oxigen" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "0zyr720h9c5gnf66xz4yl4f2wx8fkvv71ldq0q6fr9jhz2xlzcv8";
        authors = [
          "Martin1887 <marcos.martin.pozo.delgado@gmail.com>"
        ];
        dependencies = [
