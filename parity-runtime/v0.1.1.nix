...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/parity-runtime/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "parity-runtime" = rec {
        ...
        resolvedDefaultFeatures = [ "test-helpers" ];
      };
      "parking_lot" = rec {
