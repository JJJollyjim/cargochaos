...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tictactoe-gui/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tictactoe-gui" = rec {
        crateName = "tictactoe-gui";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "tictactoe-gui"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Guillermo Lella <arkorott@gmail.com>"
        ];
        dependencies = [
          {
            name = "ggez";
