...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dali/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "luminance" = rec {
        ...
        version = "0.34.1";
        edition = "2018";
        sha256 = "11f3lwsmzv198b1y4m2k74xpp2ckxcvxr1w2wj8al9pp9cx011yd";
        authors = [
      ...
      "luminance-derive" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1g1fdcs0cj6k1jnll218cm9vqn81aq7i7rmb31zwniags84wh34g";
        procMacro = true;
        authors = [
          "Dimitri Sabadie <dimitri.sabadie@gmail.com>"
        ];
      ...
      "luminance-glfw" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "1323g4x2f9q37myzbayd5a0y10njpza98k9pii1ivvrh0201m2d5";
        authors = [
          "Dimitri Sabadie <dimitri.sabadie@gmail.com>"
        ];
        dependencies = [
      ...
      "luminance-windowing" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1jb8w4568kg4irrn7pl1wpyd7y1f9z3kz5jm8cs38nw59rb3kjs8";
        authors = [
          "Dimitri Sabadie <dimitri.sabadie@gmail.com>"
        ];
        dependencies = [
