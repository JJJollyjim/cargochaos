...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dali/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "luminance" = rec {
        ...
        version = "0.33.0";
        edition = "2018";
        sha256 = "0rf65idhhfjixksshd18aa77a38aghvihh5w4wj15lks98jcrq6g";
        authors = [
      ...
      "luminance-derive" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "10vc3h4ank46z83v9zfg0927kbhnvm7jh4yfyk6s3855kf18ff4j";
        procMacro = true;
        authors = [
          "Dimitri Sabadie <dimitri.sabadie@gmail.com>"
        ];
      ...
      "luminance-glfw" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0xd5x4lx857vv1ysh873rhdydnndi3jdxy9yc8vs8diw78mibw64";
        authors = [
          "Dimitri Sabadie <dimitri.sabadie@gmail.com>"
        ];
        dependencies = [
      ...
      "luminance-windowing" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0cnw4z5mffpp3dd02061b72i0afr084i5k0z6n4gymqv3a1rxm3n";
        authors = [
          "Dimitri Sabadie <dimitri.sabadie@gmail.com>"
        ];
        dependencies = [
