...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ds/v1.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ds" = rec {
        ...
        authors = [
          "Kaitlyn Kenwell <redrield@gmail.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
