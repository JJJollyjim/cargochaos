...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lll/v0.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "minwinbase" "minwindef" "ntdef" "profileapi" "shellapi" "std" "sysinfoapi" "timezoneapi" ];
      };
      "winapi-build" = rec {
