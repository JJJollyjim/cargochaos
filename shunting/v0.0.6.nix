...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shunting/v0.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dylib" = rec {
        ...
        version = "0.0.3";
        edition = "2015";
        sha256 = "07kkci6i50wks3d34m5hlql216j9f8sl7qgfcfri5a8k603i6v7h";type = [ "rlib" ];
        authors = [
          "Simon Wollwage"
        ];
        dependencies = [
      ...
      "shunting" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dylib" "dynlink-eval" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
