...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cl/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "anyhow" = rec {
        ...
        version = "1.0.4";
        edition = "2018";
        sha256 = "00kfq16v9is3235g7wjznn3kkqjmh701wnkhqyxzxw1mz1kfqhn7";
        authors = [
      ...
      "clparse" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1l25kbxzddk30yq296qd5r27bvk4mfg6my74yb506xjyrpp2gmdk";
        authors = [
          "Marc Addeo <hi@marc.cx>"
        ];
        dependencies = [
      ...
      "derive-getters" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0cbn177ql3bvg50hdnf6349hvn5s043kd94sc2cfwq32ydbkfpng";
        procMacro = true;
      ...
      "scan_dir" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "0mcidja2xx12r24cpqwpxxadj3mrzqkihg85ic95nxzj4qyqxjqw";
        authors = [
          "Paul Colomiets <paul@colomiets.name>"
        ];
        dependencies = [
