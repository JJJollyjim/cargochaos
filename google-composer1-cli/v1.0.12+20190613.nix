...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-composer1-cli/v1.0.12+20190613.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-composer1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-composer1" = rec {
        crateName = "google-composer1";
        version = "1.0.12+20190613";
        edition = "2015";
        sha256 = "0sm888zl4m9yisrfv69rxvll7f1r1j2b39xvrnp0p8vz8f0axi86";
        authors = [
      ...
      "google-composer1-cli" = rec {
        crateName = "google-composer1-cli";
        version = "1.0.12+20190613";
        edition = "2015";
        crateBin = [
          { name = "composer1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190613.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
