...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grep/v0.2.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "grep" = rec {
        ...
        resolvedDefaultFeatures = [ "avx-accel" "grep-pcre2" "pcre2" "simd-accel" ];
      };
      "grep-cli" = rec {
        crateName = "grep-cli";
        version = "0.1.4";
      ...
      "grep-regex" = rec {
        ...
        version = "0.1.6";
        edition = "2015";
        sha256 = "12yzalhxb6xh8iyydvdpd7jwrafv3d0zbmkzhjy32nk1ifybbfld";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
