...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/print-type-sizes/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "print-type-sizes" = rec {
        crateName = "print-type-sizes";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "print-type-sizes"; path = "src/main.rs"; }
        ];
