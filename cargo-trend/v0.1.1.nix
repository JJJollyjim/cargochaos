...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-trend/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-trend" = rec {
        crateName = "cargo-trend";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "cargo-trend"; path = "src/main.rs"; }
        ];
      ...
      "crates-index" = rec {
        ...
        version = "0.13.3";
        edition = "2015";
        sha256 = "0hvqxzj144yvrjymrvbmv8r4kqz587dkkg52cdvrxjinwpg1kds7";
        authors = [
      ...
      "plotters" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "01myh36gs8ypxxyhmbvyk48ckdbf79kf9mpxdmh39fj4i6j91mp0";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bitmap" "chrono" "default" "gif" "gif_backend" "image" "make_partial_axis" "num-traits" "palette" "palette_ext" "svg" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.14.1";
      ...
      "random_color" = rec {
        ...
        version = "0.4.4";
        edition = "2015";
        sha256 = "0jc5s40v4189whw2cp83sm1qb5q5n3ib6sb0x7sa7g8i74qj1wik";
        authors = [
          "Lucas Maximiliano Marino <lucasmmarino@icloud.com>"
        ];
        dependencies = [
          {
            name = "rand";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "userenv" "winbase" "wincrypt" "winerror" "wingdi" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
