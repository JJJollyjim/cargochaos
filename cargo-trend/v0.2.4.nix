...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-trend/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "euclid" = rec {
        ...
        version = "0.20.5";
        edition = "2015";
        sha256 = "05ywmgh0cbswkm62026wmzz5y4iwfy3akm4w5r6fzibj4zw3v0d8";
        authors = [
          "The Servo Project Developers"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "dwrite" "dwrite_1" "dwrite_3" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "libloaderapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "unknwnbase" "userenv" "winbase" "wincon" "wincrypt" "winerror" "winnls" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
