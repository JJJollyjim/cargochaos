...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bluetooth_client/v0.0.12.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bluetooth_client" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "bluetooth_client"; path = "src/bin/bluetooth_client.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" ];
      };
