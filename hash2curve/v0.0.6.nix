...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hash2curve/v0.0.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "amcl-milagro" = rec {
        crateName = "amcl-milagro";
        version = "3.2.6";
        edition = "2015";
        sha256 = "0w77f4zxi7w6iq4jazgia71cqzv1si7riqk2zq0wwxhq3pi1nzws";
        libName = "amcl";
        authors = [
          "The Apache Milagro Cryptography Team"
        ];
        features = {
        };
        resolvedDefaultFeatures = [ "bls381" "default" ];
      };
      "arrayref" = rec {
        crateName = "arrayref";
        version = "0.3.6";
      ...
      "hash2curve" = rec {
        ...
        resolvedDefaultFeatures = [ "amcl-milagro" "bls" "default" "nightly" ];
      };
      "hermit-abi" = rec {
      ...
      "subtle-encoding" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "base64" "default" "hex" "std" "zeroize" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
