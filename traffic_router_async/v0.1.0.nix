...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/traffic_router_async/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "traffic_router_async";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "traffic_router_async" = rec {
        crateName = "traffic_router_async";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "traffic_router_async"; path = "src/main.rs"; }
        ];
