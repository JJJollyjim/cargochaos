...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/auto-diff/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "auto-diff" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "try_out"; path = "src/bin/try_out.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "yguan <yguan@example.com>"
        ];
        dependencies = [
          {
            name = "ndarray";
      ...
      "openblas-src" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "0syy38a5bgv5mj6mb1n1zk1d6l5gqqrswvbmwkwx6h4z9wfrsql4";
        authors = [
