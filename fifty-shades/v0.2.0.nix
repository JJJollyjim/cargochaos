...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fifty-shades/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fifty-shades" = rec {
        crateName = "fifty-shades";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "50shades"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Alexander Kahl <ak@communicatio.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "pidgin" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0yd1wzs9z82jj64jjn35z99isklbl6ywz2bfxs7vp5i4rgdy79ky";
        authors = [
      ...
      "two_timer" = rec {
        ...
        version = "1.2.0";
        edition = "2018";
        sha256 = "05xy7kig0d7zc0b8ljdykka9mc3dhjalnwsa73p8a5vyj48zwn8n";
        authors = [
          "dfhoughton <dfhoughton@gmail.com>"
        ];
        dependencies = [
