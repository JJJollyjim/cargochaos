...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/HPGO/v0.9.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "HPGO" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "HPGO-CMD"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.9.2.nix {};
        authors = [
          "Yi Rong <hi@rongyi.io>"
        ];
        dependencies = [
          {
            name = "ansi_term";
      ...
      "pyo3" = rec {
        ...
        version = "0.8.4";
        edition = "2018";
        sha256 = "0dki0z8m2v70aflmp1xyxafw0pmp1f9kpkwrqygaby6xim3g37bz";
        authors = [
      ...
      "pyo3-derive-backend" = rec {
        ...
        version = "0.8.4";
        edition = "2018";
        sha256 = "1cchywl7kl0c4zk9v53mdcn416c3aya6y0vxz2l49cwp7vxmcvlz";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
      ...
      "pyo3cls" = rec {
        ...
        version = "0.8.4";
        edition = "2018";
        sha256 = "0s3466z8wfhrg0hz05bmip47zz11g2h68rn0qpmjf5llyp6jsicp";
        procMacro = true;
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
