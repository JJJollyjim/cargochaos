...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpclib/v0.3.1-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "built" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "0dbm8li5i2zvq4s4jn04hl2b1b39kdi2k679lqkg97sz8scgyywy";
        authors = [
      ...
      "casey" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0z697gq0als7sq21pd2qj88yk3k365nnkqxgmnqlxmzm9krawzls";
        procMacro = true;
        authors = [
          "holygits <beauchjord@gmail.com>"
        ];
        dependencies = [
          {
            name = "heck";
      ...
      "cpclib" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "snapshot"; path = "src/bin/snapshot.rs"; }
          { name = "xfer"; path = "src/bin/xfer/main.rs"; }
          ...
          { name = "locomotive"; path = "src/bin/locomotive.rs"; }
          { name = "basm"; path = "src/bin/basm.rs"; }
          { name = "catalog"; path = "src/bin/catalog.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.1-alpha.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "asm" "basic" "built" "catalog" "clap" "curl" "dskmanager" "exitcode" "hideur" "imgconverter" "log" "notify" "path-absolutize" "reqwest" "rustyline" "semver" "simplelog" "snapshot" "time" "xfer" "xferlib" ];
      };
      "crc32fast" = rec {
        crateName = "crc32fast";
        version = "1.2.0";
      ...
      "delegate" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0j7rc5n45lsffbzjk49dl2x9v7fzrkrng68q2mihk71mkbpri75n";
        authors = [
      ...
      "getset" = rec {
        ...
        version = "0.0.6";
        edition = "2015";
        sha256 = "10h740vb4sqdz15qr4fkdirzbxi8pcyjnsjdj0jvnf2p4dmg7isl";
        procMacro = true;
        authors = [
      ...
      "num_enum" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "0ys6r15iq50y4sh1gjxarxl4m7n6gbwb6cb0xdygg30420radqps";
        procMacro = true;
        authors = [
      ...
      "slice-of-array" = rec {
        crateName = "slice-of-array";
        version = "0.2.1";
        edition = "2015";
        sha256 = "0rv3j2hzqkyyfq6yai95b2c680d1w95m16sji13p46h5n4yfkzwg";
        libPath = "lib.rs";
        authors = [
