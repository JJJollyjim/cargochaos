...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpclib/v0.4.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpclib" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "imgconverter"; path = "src/bin/imgconverter.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "cpclib-asm";
            packageId = "cpclib-asm";
          }
          {
            name = "cpclib-basic";
            packageId = "cpclib-basic";
          }
          {
            name = "cpclib-disc";
          ...
          {
            name = "cpclib-xfer";
            packageId = "cpclib-xfer";
          }
          {
            name = "cpclib-z80emu";
            packageId = "cpclib-z80emu";
          }
          {
        ...
        resolvedDefaultFeatures = [ "clap" "crossbeam-channel" "curl" "exitcode" "imgconverter" "log" "notify" "path-absolutize" "reqwest" "semver" "time" "xferlib" ];
      };
      "cpclib-asm" = rec {
        crateName = "cpclib-asm";
        version = "0.4.0-alpha";
        edition = "2018";
        crateBin = [];
        sha256 = "0jv0kjqhv4gskf4zh9sgib1ihx91yxcs932m4vqg5xnymw261rdl";
        authors = [
          "Romain Giot <giot.romain@gmail.com>"
        ];
        dependencies = [
        ...
        features = {
          "basm" = [ "clap" "semver" "time" "cpclib-disc" ];
        };
      };
      "cpclib-basic" = rec {
        crateName = "cpclib-basic";
        version = "0.4.0-alpha";
        edition = "2018";
        crateBin = [];
        sha256 = "1ss4lhmhkdsyrc4qmmhzg3s11jf22215lc97p5wfn46z602fplyj";
        authors = [
          "Romain Giot <giot.romain@gmail.com>"
        ];
        dependencies = [
      ...
      "cpclib-disc" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1h2wz58k716465hj2yl6c4xss7yx764xp04icx2qm2j2jzj6j6fv";
        authors = [
          "Romain Giot <giot.romain@gmail.com>"
        ];
        dependencies = [
      ...
      "cpclib-xfer" = rec {
        crateName = "cpclib-xfer";
        version = "0.4.0-alpha";
        edition = "2018";
        sha256 = "1az1ix6b2hbv6i6yf9a47is3chkjx7jgdhn6w23his272ha4xs17";
        authors = [
          "Romain Giot <giot.romain@gmail.com>"
        ];
        dependencies = [
      ...
      "cpclib-z80emu" = rec {
        crateName = "cpclib-z80emu";
        version = "0.4.0-alpha";
        edition = "2018";
        sha256 = "1gv1c55xrb78dang5kdgdir0nn8iz94dask6d63l485xqqx5g2mg";
        authors = [
          "Romain Giot <giot.romain@gmail.com>"
        ];
        dependencies = [
      ...
      "dbg" = rec {
        ...
        version = "1.0.4";
        edition = "2015";
        sha256 = "08djm30k4lsw6a9h1yclr6bck8z7l7wpr6fmrsnxgsg02f2ihxs6";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
