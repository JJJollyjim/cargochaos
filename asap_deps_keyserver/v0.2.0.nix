...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/asap_deps_keyserver/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "asap_deps_keyserver" = rec {
        crateName = "asap_deps_keyserver";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "asap_deps_keyserver"; path = "src/main.rs"; }
        ];
