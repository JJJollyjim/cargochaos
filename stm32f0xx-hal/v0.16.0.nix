...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f0xx-hal/v0.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f0" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1q5v1149qac0akh92rv76g41fh7szgkmxrm45v1h3jc06f2abkf7";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f0x0" "stm32f0x1" "stm32f0x2" "stm32f0x8" ];
      };
      "stm32f0xx-hal" = rec {
        crateName = "stm32f0xx-hal";
        version = "0.16.0";
        edition = "2018";
        ...
        resolvedDefaultFeatures = [ "device-selected" "rt" "stm32-usbd" "stm32f030" "stm32f030x4" "stm32f030x6" "stm32f030x8" "stm32f030xc" "stm32f031" "stm32f038" "stm32f042" "stm32f048" "stm32f051" "stm32f058" "stm32f070" "stm32f070x6" "stm32f070xb" "stm32f071" "stm32f072" "stm32f078" "stm32f091" "stm32f098" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.14";
      ...
      "usb-device" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "0fxabmqlxrr26lpnxb36wi7x251l4aj20ap21q7jm8affi04wxfg";
        authors = [
          "Matti Virkkunen <mvirkkunen@gmail.com>"
        ];
        features = {
