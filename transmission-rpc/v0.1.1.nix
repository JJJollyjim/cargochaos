...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/transmission-rpc/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ajson" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "01h6wlsxcm51xkw23x7npmkmr9g0f5224dywdqdwl05izjhb93ry";
        authors = [
      ...
      "transmission-rpc" = rec {
        crateName = "transmission-rpc";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "red <red.avtovo@gmail.com>"
        ];
        dependencies = [
          {
            name = "ajson";
