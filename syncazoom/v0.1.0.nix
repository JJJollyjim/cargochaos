...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/syncazoom/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "job_scheduler" = rec {
        ...
        version = "1.2.1";
        edition = "2015";
        sha256 = "0z0d9n84i86xyqbch1hcg992g75pfk12vqsaf6125pkdqz4niwsi";
        authors = [
      ...
      "minreq" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "https" "json-using-serde" "lazy_static" "rustls" "serde" "serde_json" "webpki" "webpki-roots" ];
      };
      "nom" = rec {
        crateName = "nom";
        version = "2.1.0";
      ...
      "syncazoom" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "syncazoom"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "wtypesbase" ];
      };
