...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-pagespeedonline5-cli/v1.0.13+20200318.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-pagespeedonline5-cli";
  ...
  workspaceMembers = {
    "google-pagespeedonline5-cli" = rec {
      packageId = "google-pagespeedonline5-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-pagespeedonline5-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-pagespeedonline5" = rec {
        crateName = "google-pagespeedonline5";
        version = "1.0.13+20200318";
        edition = "2015";
        sha256 = "1d9k3izq228fsz2g60z70alfifv0p889n137l7nsk6jxc53li1fd";
        authors = [
      ...
      "google-pagespeedonline5-cli" = rec {
        crateName = "google-pagespeedonline5-cli";
        version = "1.0.13+20200318";
        edition = "2015";
        crateBin = [
          { name = "pagespeedonline5"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-pagespeedonline5";
          }
          {
            name = "hyper";
            packageId = "hyper";
