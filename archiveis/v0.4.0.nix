...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/archiveis/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "archiveis" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "archiveis"; path = "src/archiveis.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Matthias Seitz <matthias.seitz@tum.de>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "cli" "pretty_env_logger" "serde" "serde_json" "structopt" "tokio" "with-serde" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.14";
