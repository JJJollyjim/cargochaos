...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tindercrypt/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tindercrypt" = rec {
        crateName = "tindercrypt";
        version = "0.2.2";
        edition = "2018";
        crateBin = [
          { name = "tindercrypt"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "Alex Pyrgiotis <apyrgio@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "default" "dialoguer" "lazy_static" "proto-gen" "protoc-rust" ];
      };
      "treeline" = rec {
        crateName = "treeline";
        version = "0.1.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "std" "winbase" "wincon" "winerror" "winnt" "winuser" "wtypesbase" ];
      };
