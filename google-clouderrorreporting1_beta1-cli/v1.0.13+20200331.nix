...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-clouderrorreporting1_beta1-cli/v1.0.13+20200331.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-clouderrorreporting1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "1qgggmk9c6fdgphc1nckh54wsp3z8gvpz3swqsa7fmvw9ppwflj6";
        authors = [
      ...
      "google-clouderrorreporting1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200331.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
