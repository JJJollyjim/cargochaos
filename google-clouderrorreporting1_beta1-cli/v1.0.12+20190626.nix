...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-clouderrorreporting1_beta1-cli/v1.0.12+20190626.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-clouderrorreporting1_beta1-cli";
  ...
  workspaceMembers = {
    "google-clouderrorreporting1_beta1-cli" = rec {
      packageId = "google-clouderrorreporting1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-clouderrorreporting1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-clouderrorreporting1_beta1" = rec {
        crateName = "google-clouderrorreporting1_beta1";
        version = "1.0.12+20190626";
        edition = "2015";
        sha256 = "0j0kw9n6g9nyzx5rhcj5m9dqyfz01kkpvbq4bi2cdfmndw8pg8cx";
        authors = [
      ...
      "google-clouderrorreporting1_beta1-cli" = rec {
        crateName = "google-clouderrorreporting1_beta1-cli";
        version = "1.0.12+20190626";
        edition = "2015";
        crateBin = [
          { name = "clouderrorreporting1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190626.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-clouderrorreporting1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
