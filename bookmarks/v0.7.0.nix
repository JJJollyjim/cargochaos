...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bookmarks/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bookmarks" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "bookmarks"; path = "src/main.rs"; }
        ];
      ...
      "tagsearch" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "00dawba5dlr3c1gzvncfw7rdzii4rdvln8av0nh4cl4qk4qnhnkm";
        authors = [
          "Chris Davison <c.jr.davison@gmail.com>"
        ];
        dependencies = [
