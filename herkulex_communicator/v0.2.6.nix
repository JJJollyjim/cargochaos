...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/herkulex_communicator/v0.2.6.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "herkulex_communicator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "drs-0x01" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1908prkzqrlddz9shhx82fllbss6rfjjqflhpw0yllwpzddr1kcz";
        authors = [
      ...
      "herkulex_communicator" = rec {
        crateName = "herkulex_communicator";
        version = "0.2.6";
        edition = "2015";
        crateBin = [
          { name = "herkulex_communicator"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.6.nix {};
        authors = [
          "Paul Florence <florencepaul@hotmail.fr>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cguid" "commapi" "consoleapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "setupapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" ];
      };
