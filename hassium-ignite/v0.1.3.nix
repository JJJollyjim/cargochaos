...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hassium-ignite/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hassium-ignite" = rec {
        crateName = "hassium-ignite";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "hassium-ignite"; path = "src/main.rs"; }
        ];
