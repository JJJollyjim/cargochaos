...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-bigtableadmin2-cli/v1.0.13+20200211.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-bigtableadmin2" = rec {
        ...
        edition = "2015";
        sha256 = "0z5rhz1hmvn8rpnfk1b3sxscq8gq1qqp5g88l4k5kq52mcyd28fw";
        authors = [
      ...
      "google-bigtableadmin2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200211.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
