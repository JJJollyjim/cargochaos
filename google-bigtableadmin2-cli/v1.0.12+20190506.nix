...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-bigtableadmin2-cli/v1.0.12+20190506.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-bigtableadmin2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-bigtableadmin2" = rec {
        crateName = "google-bigtableadmin2";
        version = "1.0.12+20190506";
        edition = "2015";
        sha256 = "1rvchc9kxsz2bl77y8pzya5v38877nkpmnx8kxk31lc8z4xnrlka";
        authors = [
      ...
      "google-bigtableadmin2-cli" = rec {
        crateName = "google-bigtableadmin2-cli";
        version = "1.0.12+20190506";
        edition = "2015";
        crateBin = [
          { name = "bigtableadmin2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190506.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-bigtableadmin2";
          }
          {
            name = "hyper";
            packageId = "hyper";
