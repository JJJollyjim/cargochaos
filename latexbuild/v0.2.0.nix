...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/latexbuild/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "latexbuild" = rec {
        crateName = "latexbuild";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "latexbuild"; path = "src/bin/latexbuild/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libPath = "src/latexbuild/lib.rs";
        authors = [
          "Zehua-Chen <peterchen06242000@outlook.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
