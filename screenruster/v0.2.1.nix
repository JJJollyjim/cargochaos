...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/screenruster/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "screenruster" = rec {
        crateName = "screenruster";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "screenruster"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "xcb";
            packageId = "xcb";
            features = [ "randr" "dpms" "xkb" "thread" ];
          }
          {
            name = "xcb-util";
            packageId = "xcb-util";
            rename = "xcbu";
            features = [ "icccm" "ewmh" "thread" ];
          }
          {
            name = "xkb";
            packageId = "xkb";
        ...
        resolvedDefaultFeatures = [ "auth-internal" "auth-pam" "auth-pam-accounts" "default" "pam" ];
      };
      ...
      "xcb" = rec {
        ...
        resolvedDefaultFeatures = [ "dpms" "randr" "render" "thread" "xkb" ];
      };
      "xcb-util" = rec {
        crateName = "xcb-util";
        version = "0.2.2";
        edition = "2015";
        sha256 = "1y0x0xr26d02lbbs3xx633lp8rfyqz690kwxv1401v7mfx0aa5yv";
        authors = [
          "meh. <meh@schizofreni.co>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "ewmh" "icccm" "thread" ];
      };
      "xdg" = rec {
        crateName = "xdg";
        version = "2.2.0";
