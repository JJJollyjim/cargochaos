...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bastion/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bastion-executor" = rec {
        ...
        version = "0.3.4";
        edition = "2018";
        sha256 = "1vdcs8w63s4ng6zaq1wbq9jhbn0g18wka5z8c253wy36g3d02hk6";
        authors = [
          "Mahmut Bulut <vertexclique@gmail.com>"
        ];
        dependencies = [
      ...
      "futures-timer" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "1zzzgfqf7spi5wvv1yizbicpis3vaq2ri7b24z66yrrp8r7cq7fa";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        features = {
