...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bastion/v0.1.4-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bastion" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.4-alpha.1.nix {};
        authors = [
      ...
      "ratelimit" = rec {
        ...
        version = "0.4.4";
        edition = "2015";
        sha256 = "0zhyydi9dmlvwawgiikxcmpljp4f5fr57dg8pr12l7278zmpfisw";
        authors = [
