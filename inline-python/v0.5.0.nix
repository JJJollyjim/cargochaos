...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/inline-python/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
        ...
        dependencies = [
          {
            ...
            packageId = "inline-python-macros";
          }
          {
            name = "pyo3";
            packageId = "pyo3";
      ...
      "inline-python-macros" = rec {
        crateName = "inline-python-macros";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1drnkxq0sz0jhpca20i4ri2zhd6mx24rqlkbzrwsjnbbrr27ph0p";
        procMacro = true;
        authors = [
          "Mara Bos <m-ou.se@m-ou.se>"
          "Maarten de Vries <maarten@de-vri.es>"
