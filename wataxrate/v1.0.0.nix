...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wataxrate/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "default" "default-tls" "hyper-tls" "native-tls-crate" "rustls" "tokio-tls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.12";
      ...
      "strong-xml" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "02g3q6505x54z8nk4ya601l62lhq2y8k0g2a1cq6yb97iihvdi4h";
        authors = [
      ...
      "strong-xml-derive" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1kaqk4kxyw5akfjp3wj3zkivr5l899n5c0hxf2wrlvhqgla78046";
        procMacro = true;
      ...
      "wataxrate" = rec {
        ...
        authors = [
          "Ryan Gorup <gorup@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "log";
