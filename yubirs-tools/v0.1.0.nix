...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yubirs-tools/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bdrck" = rec {
        ...
        version = "0.15.5";
        edition = "2018";
        sha256 = "1pjid9i39ch48qb52qk7mlbpmckibmlpyjmvcpqdv3hs8fpb50k7";
        authors = [
          "Axel Rasmussen <axel.rasmussen1@gmail.com>"
        ];
        dependencies = [
          {
            name = "atty";
        ...
        features = {
          ...
          "crypto" = [ "rmp-serde" "serde" "sodiumoxide" ];
        ...
        resolvedDefaultFeatures = [ "atty" "chrono" "cli" "crypto" "errno" "fs" "futures" "http" "libc" "log" "logging" "rand" "regex" "reqwest" "rmp-serde" "serde" "serde_json" "sodiumoxide" "testing" "url" ];
      };
      "bincode" = rec {
        crateName = "bincode";
        version = "1.2.1";
      ...
      "flaggy" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1vdp0myb6170hz0asl3fx6s98kyqkbrms89b0raf2yyvgd73z516";
        authors = [
          "Axel Rasmussen <axel.rasmussen1@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "flaggy-codegen";
            packageId = "flaggy-codegen";
          }
          {
            name = "flaggy-values";
            packageId = "flaggy-values";
          }
        ];
        
      };
      "flaggy-codegen" = rec {
        crateName = "flaggy-codegen";
        version = "0.1.1";
        edition = "2018";
        sha256 = "109ya5rhhri2wa36bm6j9mni8gms3mcp0pk81rdhfhzqdscvdgnr";
        procMacro = true;
        authors = [
          "Axel Rasmussen <axel.rasmussen1@gmail.com>"
        ];
      ...
      "flaggy-values" = rec {
        crateName = "flaggy-values";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1r1iqdiscmf66qzf80hd7033y310zxknfdajfk54xpc5b1hxxvrk";
        authors = [
          "Axel Rasmussen <axel.rasmussen1@gmail.com>"
        ];
      ...
      "pcsc-sys" = rec {
        ...
        version = "1.2.0";
        edition = "2015";
        sha256 = "1si37v9n07r3csqcnnqn4i82j75b6dssyz0fzdg1n3rcpbnbzdz1";
        authors = [
      ...
      "yubirs" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0nmvydbl0mnjh9a55l76cbs0lvcs9nv0yjw6vaphppzn5ch905l9";
        authors = [
          "Axel Rasmussen <axel.rasmussen1@gmail.com>"
        ];
        dependencies = [
        ...
        features = {
          ...
          "piv" = [ "bdrck/cli" "bdrck/crypto" "bdrck/testing" "bincode" "libc" "log" "pcsc-sys" ];
        };
        resolvedDefaultFeatures = [ "bdrck" "bincode" "libc" "log" "pcsc-sys" "piv" ];
      };
      "yubirs-tools" = rec {
        crateName = "yubirs-tools";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "piv-tool"; path = "src/bin/piv-tool.rs"; }
        ];
