...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yubirs-tools/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bdrck" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "0kdl3a3mzh18ra93fqixl14i5gaz3ylflfkpa4ak04z1acsc15g5";
        authors = [
        ...
        resolvedDefaultFeatures = [ "chrono" "cli" "crypto" "data-encoding" "errno" "fs" "futures" "http" "io" "libc" "log" "logging" "rand" "regex" "reqwest" "rmp-serde" "serde" "serde_json" "sodiumoxide" "testing" "url" ];
      };
      "bincode" = rec {
        crateName = "bincode";
        version = "1.2.1";
      ...
      "yubirs" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "03l4vri8w037j69kw62yz0sfi8rjlbh698fbp87zjyqimjgyrk0n";
        authors = [
          "Axel Rasmussen <axel.rasmussen1@gmail.com>"
        ];
        dependencies = [
