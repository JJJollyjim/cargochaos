...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bstr/v0.2.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "regex-automata" = rec {
        ...
        version = "0.1.5";
        edition = "2015";
        sha256 = "1z5amnzbx273q32wyk7vra7havfanpj0bs4jbsc867rxs5xwj923";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "ucd-parse" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "13mq6c85r6ak10gjlq74mzdhsi0g0vps2y73by420513gfnipm97";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
