...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/detour/v0.7.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "detour" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            ...
            target = {target, features}: target."windows";
            features = [ "minwindef" "windef" "winnt" ];
          }
        ];
        features = {
          "default" = [ "nightly" ];
      ...
      "libudis86-sys" = rec {
        crateName = "libudis86-sys";
        version = "0.2.1";
        edition = "2015";
        sha256 = "1c5612mp4p8j3301awzf7i1wsmy9v4ijkpb4mk0r1z0vvffvz6qk";
        authors = [
          "Elliott Linder <elliott.darfink@gmail.com>"
        ];
        dependencies = [
      ...
      "mmap-fixed" = rec {
        crateName = "mmap-fixed";
        version = "0.1.5";
        edition = "2015";
        sha256 = "08bvs08wxijkfx635cbc2324s1vdksygcjcm0ysd6hv39lkaxh97";
        authors = [
      ...
      "slice-pool" = rec {
        crateName = "slice-pool";
        version = "0.4.1";
        edition = "2015";
        sha256 = "0yifbvph8xmaqf88rjgwq88cj5sz9vmbvja2z0v82fmxy7jwcgvk";
        authors = [
          "Elliott Linder <elliott.darfink@gmail.com>"
        ];
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "memoryapi" "minwindef" "sysinfoapi" "windef" "winnt" ];
      };
      "winapi-build" = rec {
