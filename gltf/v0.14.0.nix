...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gltf/v0.14.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gltf" = rec {
        ...
        resolvedDefaultFeatures = [ "KHR_lights_punctual" "KHR_materials_pbrSpecularGlossiness" "base64" "default" "extras" "image" "image_jpeg_rayon" "import" "names" "utils" ];
      };
      "gltf-derive" = rec {
      ...
      "gltf-json" = rec {
        ...
        resolvedDefaultFeatures = [ "KHR_lights_punctual" "KHR_materials_pbrSpecularGlossiness" "default" "extras" "names" ];
      };
      "image" = rec {
        crateName = "image";
        version = "0.21.3";
