...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gltf/v0.15.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gltf" = rec {
        ...
        resolvedDefaultFeatures = [ "KHR_lights_punctual" "KHR_materials_pbrSpecularGlossiness" "KHR_materials_unlit" "base64" "default" "extras" "guess_mime_type" "image" "image_jpeg_rayon" "import" "names" "utils" ];
      };
      "gltf-derive" = rec {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "jpeg" "jpeg_rayon" "png" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
