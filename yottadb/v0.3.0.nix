...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yottadb/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sdl2" = rec {
        ...
        resolvedDefaultFeatures = [ "c_vec" "default" "gfx" "ttf" ];
      };
      "sdl2-sys" = rec {
        crateName = "sdl2-sys";
        version = "0.32.6";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "libloaderapi" "minwindef" "ntsecapi" "profileapi" "winerror" "winnt" ];
      };
      ...
      "yottadb" = rec {
        ...
        authors = [
          "Charles Hathaway <charles@yottadb.com>"
          "Joshua Nelson <joshua@yottadb.com>"
        ];
        buildDependencies = [
          {
            name = "bindgen";
