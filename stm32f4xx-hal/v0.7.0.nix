...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f4xx-hal/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f4" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "0xp9r9idnzb5qhl6kkimbqy53528ckfyg51n4wk3krhlig2xd8s4";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f401" "stm32f405" "stm32f407" "stm32f410" "stm32f411" "stm32f412" "stm32f413" "stm32f427" "stm32f429" "stm32f446" "stm32f469" ];
      };
      "stm32f4xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "device-selected" "rt" "stm32f401" "stm32f405" "stm32f407" "stm32f410" "stm32f411" "stm32f412" "stm32f413" "stm32f415" "stm32f417" "stm32f423" "stm32f427" "stm32f429" "stm32f437" "stm32f439" "stm32f446" "stm32f469" "stm32f479" "synopsys-usb-otg" "usb_fs" "usb_hs" ];
      };
      "stm32ral" = rec {
        crateName = "stm32ral";
        version = "0.3.1";
        edition = "2018";
        sha256 = "15m4djm1dbbvk2nw8dv99xla0as3qnrnrgsps9adyba2ncf5crc6";
        authors = [
          "Adam Greig <adam@adamgreig.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "armv7em" "default" "stm32f429" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
      ...
      "synopsys-usb-otg" = rec {
        crateName = "synopsys-usb-otg";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1c4dnd2rxmknym29ys9ml0hnfc1wddglic72vwrjzka6x6j2rkbb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m" "fs" "hs" ];
      };
      "tinybmp" = rec {
        crateName = "tinybmp";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0c2j1ypyalrkdq3f4wy4pym728mj2vp9vi3js3b6f597idzjpl9h";
        authors = [
          "James Waples <james@wapl.es>"
        ];
        dependencies = [
