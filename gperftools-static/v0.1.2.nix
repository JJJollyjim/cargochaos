...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gperftools-static/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gperftools-static" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "static_gperftools" "static_unwind" ];
      };
      "lazy_static" = rec {
