...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-raze/v0.2.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace" = rec {
        ...
        version = "0.3.24";
        edition = "2015";
        sha256 = "1qkq6crk5pz6qbvzylbci345yi9qdv8jdiq6s2w08pcbyshs1a4c";
        authors = [
      ...
      "cargo-raze" = rec {
        crateName = "cargo-raze";
        version = "0.2.15";
        edition = "2018";
        crateBin = [
          { name = "cargo-raze"; path = "src/bin/cargo-raze.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.15.nix {};
        authors = [
          "Alex McArther <acmcarther@google.com>"
        ];
        dependencies = [
          {
            name = "cargo";
