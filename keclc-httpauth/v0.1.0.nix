...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/keclc-httpauth/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kayrx" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "0rw2x85link1whl1yzz0cb15c64mq2yh32wgmywryqsr43bsr7mj";
        authors = [
          "Tokio Contributors <team@tokio.rs>"
          "Nikolay Kim <fafhrd91@gmail.com>"
          "krircc <krircc@qq.com>"
        ];
        dependencies = [
          {
            name = "arc-swap";
      ...
      "kayrx-macro" = rec {
        crateName = "kayrx-macro";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1i1g32v933misici0h07xvmb9gyj5ihfhbffvni87sa8wmpbgans";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
          "krircc <krircc@qq.com>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
