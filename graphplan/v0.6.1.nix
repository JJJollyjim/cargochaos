...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/graphplan/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "graphplan" = rec {
        ...
        authors = [
          "Alex Kehayias <alex.kehayias@gmail.com>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_debug" "release_max_level_warn" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.3.0";
