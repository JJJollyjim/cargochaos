...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/quicksilver-utils-ecs/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "quicksilver-utils-ecs";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1r0sa6b5g1bcc2kmghhw3wwh20p4hqgrn8bcsx3yfd34b4h13s1k";
        authors = [
        ...
        resolvedDefaultFeatures = [ "enum-map" "event-cache" "gamepad" "gilrs" "gl" "glow" "glutin" "rustc-hash" "std_web" "stdweb" "webgl_stdweb" ];
      };
      "block" = rec {
        crateName = "block";
        version = "0.1.6";
      ...
      "glow" = rec {
        ...
        resolvedDefaultFeatures = [ "std_web" "stdweb" "webgl_stdweb" ];
      };
      "glutin" = rec {
        crateName = "glutin";
        version = "0.22.1";
      ...
      "golem" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0w09schw1wbyml16s08p6i8c7fm3imbx3s7vhkssc6mplac24w20";
        authors = [
          "Ryan Goldstein <ryan@ryanisaacg.com>"
        ];
        dependencies = [
      ...
      "platter" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1nd6cr7ibh97zd3qlkkbadzkd2f51nwkz4yfw0zff77zxm9mc8mk";
        authors = [
          "Ryan Goldstein <ryanisaacg@gmail.com>"
        ];
        dependencies = [
      ...
      "quicksilver" = rec {
        ...
        edition = "2018";
        sha256 = "06zd482x42g6hlfd921gihw2i37nl5rfi1gdg0d7izwmk969b62z";
        authors = [
          "Ryan Goldstein <ryanisaacg@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "easy-log" "event-cache" "gamepad" "gestalt" "saving" "simple_logger" "stdweb" "web_logger" ];
      };
      "quicksilver-utils-ecs" = rec {
        crateName = "quicksilver-utils-ecs";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        libName = "quicksilver_utils_ecs";
        authors = [
      ...
      "winit" = rec {
        ...
        resolvedDefaultFeatures = [ "std_web" "stdweb" ];
      };
      "ws2_32-sys" = rec {
