...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nom/v6.0.0-alpha1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nom" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v6.0.0-alpha1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "lazy_static" "lexical" "lexical-core" "regex" "regexp" "std" ];
      };
      "num-traits" = rec {
