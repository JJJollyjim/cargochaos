...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nom/v5.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nom" = rec {
        ...
        version = "5.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v5.1.0.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "lazy_static" "lexical" "lexical-core" "regex" "regexp" "regexp_macros" "std" ];
      };
      "num-traits" = rec {
