...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/klondike-rs/v1.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "klondike-rs" = rec {
        crateName = "klondike-rs";
        version = "1.1.0";
        edition = "2018";
        crateBin = [
          { name = "klondike"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.0.nix {};
        libName = "klondike_lib";
        authors = [
          "Chris Bouchard <chris@upliftinglemma.net>"
        ];
        dependencies = [
          {
            name = "config";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
