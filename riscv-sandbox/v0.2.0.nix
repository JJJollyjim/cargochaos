...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/riscv-sandbox/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "riscv-sandbox" = rec {
        crateName = "riscv-sandbox";
        version = "0.2.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Arthur Blanleuil <arthur.blanleuil@inria.fr>"
        ];
        dependencies = [
          {
            name = "bitvec";
