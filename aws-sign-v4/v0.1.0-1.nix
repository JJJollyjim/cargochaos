...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aws-sign-v4/v0.1.0-1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aws-sign-v4" = rec {
        crateName = "aws-sign-v4";
        version = "0.1.0-1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-1.nix {};
        authors = [
          "Vlad Pănăzan <brgdvz@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
