...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eventific/v0.1.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eventific" = rec {
        ...
        resolvedDefaultFeatures = [ "grpc" "hyper" "protobuf" "tls-api" "tls-api-stub" "with_grpc" ];
      };
      "failure" = rec {
        crateName = "failure";
        version = "0.1.6";
      ...
      "grpcio" = rec {
        ...
        version = "0.4.5";
        edition = "2015";
        sha256 = "0x35inbwlgm2gqj46gis1psrbad2lbrp7w4090sq6pbr824wjifg";
        authors = [
      ...
      "grpcio-sys" = rec {
        ...
        version = "0.4.5";
        edition = "2015";
        sha256 = "0274zdpffri17hr8vxzzdm8dvdz6r863qzhnvqh8xlb98y5iv8zn";
        authors = [
          "The TiKV Project Developers"
        ];
        dependencies = [
