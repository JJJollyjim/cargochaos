...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uint/v0.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rug" = rec {
        ...
        version = "1.6.0";
        edition = "2018";
        sha256 = "1z1qzfjbirc7y2b1pnj6aciigj66x8gjrmc1xwi9nhp8qnl2scac";
        authors = [
          "Trevor Spiteri <trevor.spiteri@um.edu.mt>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "gmp-mpfr-sys" "integer" ];
      };
      "rust-argon2" = rec {
      ...
      "static_assertions" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "0my6vsxnqrgsliczrw5gg3mfvnv2i8vir6v3d1dnd22n6l9kd88g";
        authors = [
          "Nikolai Vazquez"
        ];
        features = {
      ...
      "uint" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "qc" "quickcheck" "rand" "std" ];
      };
      "unicode-width" = rec {
