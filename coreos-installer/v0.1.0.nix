...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/coreos-installer/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coreos-installer" = rec {
        crateName = "coreos-installer";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "coreos-installer"; path = "src/main.rs"; }
        ];
