...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aspotify/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aspotify" = rec {
        ...
        authors = [
          "KaiJewson <58880148+KaiJewson@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "base64";
          ...
          {
            name = "isocountry";
            packageId = "isocountry";
          }
          {
            name = "isolanguage-1";
            packageId = "isolanguage-1";
      ...
      "isocountry" = rec {
        crateName = "isocountry";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0zfk56jhjy26675wl1vv2x3xv7zz8k7j946schgzi0123zbaks9n";
        authors = [
          "Brett <brett.russell@centro.net>"
        ];
        dependencies = [
          {
            name = "failure";
      ...
      "isolanguage-1" = rec {
        crateName = "isolanguage-1";
        version = "0.1.0";
        edition = "2018";
        sha256 = "16rp70j3rp43yrwkr3xv2c97gm2kgra2hvmcraisdmgz7cikzrwq";
        authors = [
          "Koxiaet <38139193+Koxiaet@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "serde";
