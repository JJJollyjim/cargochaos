...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/smol_webhook/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "smol_webhook" = rec {
        crateName = "smol_webhook";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "smol_webhook"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Tanapol Prucksakorn <tanapol.pr@gmail.com>"
        ];
        dependencies = [
          {
            name = "rust-crypto";
