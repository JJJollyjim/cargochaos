...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/surf/v2.0.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-h1" = rec {
        ...
        version = "1.1.0";
        edition = "2018";
        sha256 = "0cw0gni3240mf6pyksx0b273vi6xl6rn2m2s6w1v5fgab6r1w8sl";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "http-client" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "1ma2yl8mfr1ri5nijmnffqv8g5xqabj4dgy6x21cmaix852sw7r7";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
          "dignifiedquire <me@dignifiedquire.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "async-h1" "async-native-tls" "async-std" "curl_client" "default" "h1_client" "isahc" "js-sys" "native_client" "wasm-bindgen" "wasm-bindgen-futures" "wasm_client" "web-sys" ];
      };
      "http-types" = rec {
        crateName = "http-types";
        version = "1.2.0";
        edition = "2018";
        sha256 = "1z4vzym4gvcv7bswvb39l0bmk158nvmpplmifba67cgyinkpbbq5";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "http" "hyperium_http" ];
      };
      "httparse" = rec {
        crateName = "httparse";
        version = "1.3.4";
      ...
      "infer" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "08s1ilqcms0jxfnh3jlf0xcn5c1wnyblpv99m13b6khnfrm40p6m";
        authors = [
      ...
      "surf" = rec {
        ...
        resolvedDefaultFeatures = [ "async-h1" "curl-client" "default" "encoding" "encoding_rs" "h1-client" "hyper" "hyper-client" "hyper-tls" "isahc" "js-sys" "middleware-logger" "native-client" "native-tls" "runtime" "runtime-raw" "runtime-tokio" "wasm-bindgen" "wasm-bindgen-futures" "wasm-client" "web-sys" ];
      };
      "syn 0.15.44" = rec {
        crateName = "syn";
        version = "0.15.44";
      ...
      "tokio 0.2.18" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-util" "memchr" "stream" "sync" ];
      };
      "tokio-buf" = rec {
        crateName = "tokio-buf";
        version = "0.1.1";
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "AbortSignal" "Event" "EventTarget" "Headers" "MessageEvent" "ObserverCallback" "ReferrerPolicy" "Request" "RequestCache" "RequestCredentials" "RequestInit" "RequestMode" "RequestRedirect" "Response" "TextDecoder" "Window" "Worker" "console" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
