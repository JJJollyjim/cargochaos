...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adsensehost4d1-cli/v1.0.12+20190703.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-adsensehost4d1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adsensehost4d1" = rec {
        crateName = "google-adsensehost4d1";
        version = "1.0.12+20190703";
        edition = "2015";
        sha256 = "1v79x0pmnlvj46zi5prgllgy60n9am3d195pd5afs09377zz8pm8";
        authors = [
      ...
      "google-adsensehost4d1-cli" = rec {
        crateName = "google-adsensehost4d1-cli";
        version = "1.0.12+20190703";
        edition = "2015";
        crateBin = [
          { name = "adsensehost4d1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190703.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-adsensehost4d1";
          }
          {
            name = "hyper";
            packageId = "hyper";
