...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/labhub/v0.1.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rocket_contrib" = rec {
        ...
        resolvedDefaultFeatures = [ "json" "serde" "serde_json" ];
      };
      "rocket_http" = rec {
