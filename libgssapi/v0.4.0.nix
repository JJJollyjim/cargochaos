...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libgssapi/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libgssapi-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0x1l9x3c95rf2w3n2vc252h7blg213dv7wvx5nxq7fq7g7dp9lcd";
        authors = [
          "Eric Stokes <letaris@gmail.com>"
        ];
        buildDependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "ntstatus" "processenv" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
