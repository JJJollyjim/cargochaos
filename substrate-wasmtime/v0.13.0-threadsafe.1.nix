...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/substrate-wasmtime/v0.13.0-threadsafe.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lightbeam" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "0hryxjs7hq3infh01i059iq7awv7sv7s3ynjp1x25nwgxrdpac7m";
        authors = [
      ...
      "substrate-wasmtime" = rec {
        crateName = "substrate-wasmtime";
        version = "0.13.0-threadsafe.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.13.0-threadsafe.1.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "substrate-wasmtime-jit";
            rename = "wasmtime-jit";
          }
          {
            name = "substrate-wasmtime-runtime";
            packageId = "substrate-wasmtime-runtime";
            rename = "wasmtime-runtime";
          }
          {
            name = "target-lexicon";
            packageId = "target-lexicon";
        ...
        resolvedDefaultFeatures = [ "default" "lightbeam" "wat" ];
      };
      "substrate-wasmtime-jit" = rec {
        crateName = "substrate-wasmtime-jit";
        version = "0.13.0-threadsafe.1";
        edition = "2018";
        sha256 = "149vz7vspyhlvg7c7sjqm9c0gdff2k8rq71mvpzvrll691bfa3d2";
        authors = [
          "The Wasmtime Project Developers"
          "ParityTech"
        ];
      ...
      "substrate-wasmtime-runtime" = rec {
        crateName = "substrate-wasmtime-runtime";
        version = "0.13.0-threadsafe.1";
        edition = "2018";
        sha256 = "1f6f10g21kpkq7794l8gw971nbnac9ig0c7bgv17yfi90ipq823d";
        authors = [
          "The Wasmtime Project Developers"
          "ParityTech"
        ];
      ...
      "wast 10.0.0" = rec {
        ...
        version = "10.0.0";
        edition = "2018";
        sha256 = "01shq3pir0cyic9plnf0a1jrqa0nv0h9lc2l56zrvk7mxgn65ysf";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "wat" = rec {
        ...
        version = "1.0.11";
        edition = "2018";
        sha256 = "17065f66krpyfm20n35mfmc655krgm61lfmfydi3mk3kabiabppz";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
