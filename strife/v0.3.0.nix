...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/strife/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "int-enum" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1a04cmdyax950pnw8c5w8smvznznmwqgkbzx03v6348pp2dl1gdg";
        authors = [
          "James Whaley <juicy66173@gmail.com>"
        ];
        dependencies = [
          {
            name = "cfg-if";
        ...
        features = {
          "alloc" = [ "int-enum-impl/alloc" ];
          "convert" = [ "int-enum-impl/convert" ];
          "default" = [ "std" ];
          "serialize" = [ "serde" "int-enum-impl/serialize" ];
          "std" = [ "int-enum-impl/std" ];
        };
        resolvedDefaultFeatures = [ "convert" "default" "serde" "serialize" "std" ];
      };
      "int-enum-impl" = rec {
        crateName = "int-enum-impl";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0jcg11yrvjwsng929dagspc5kkyh7a7l4gc74lfkjyr6zyaqf80i";
        procMacro = true;
        authors = [
          "James Whaley <juicy66173@gmail.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "convert" "default" "serialize" "std" ];
      };
      "iovec" = rec {
        crateName = "iovec";
        version = "0.1.4";
      ...
      "remain" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1fk8r2brwya883rwldg1fivfqlmclw4jnaaxl8mv0nzyr8mfl7kv";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "strife" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "systime_ratelimits" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.11";
