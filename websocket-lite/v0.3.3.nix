...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/websocket-lite/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "io-std" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "websocket-codec" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "1myy44d4vbnz57cgd75k32c7anqw1hkn24snsi7avsaz1pdz7x8h";
        authors = [
      ...
      "websocket-lite" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "native-tls" "nightly" "openssl" "ssl-native-tls" "ssl-openssl" "tokio-openssl" "tokio-tls" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "processenv" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
