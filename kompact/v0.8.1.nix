...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kompact/v0.8.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "as_num" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "1h381pql7imjj71nz66g7ng62dnm9madxdmryz13s6sy6ads3sk2";
        authors = [
          "philipp <philipp>"
        ];
      ...
      "bitfields" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "02mz07dkjgd1v8wpg2bwaj4z6xcv1y6m899y0nz5fr7nvqzxv81m";
        authors = [
          "Johan Mickos <johan.mickos@gmail.com>"
        ];
      ...
      "executors" = rec {
        ...
        version = "0.5.3";
        edition = "2018";
        sha256 = "1r5f5hqah4ihvqapclyy3d5mfapkmkk3wqxmb6qqkc2l0ppz3kbb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cb-channel-exec" "crossbeam-channel" "crossbeam-deque" "crossbeam-utils" "default" "defaults" "num_cpus" "rand" "threadpool" "threadpool-exec" "time" "workstealing-exec" "ws-no-park" "ws-timed-fairness" ];
      };
      "failure" = rec {
        crateName = "failure";
        version = "0.1.6";
      ...
      "kompact" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pingperf"; path = "src/bin/pingperf.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "kompact-actor-derive";
          }
          {
            name = "kompact-component-derive";
            packageId = "kompact-component-derive";
          }
          {
            name = "log";
            packageId = "log";
        ...
        resolvedDefaultFeatures = [ "core_affinity" "default" "low_latency" "protobuf" "ser_id_64" "serde" "silent_logging" "thread_pinning" ];
      };
      "kompact-actor-derive" = rec {
        crateName = "kompact-actor-derive";
        version = "0.8.1";
        edition = "2018";
        sha256 = "07vgv1jrnw6mawfwb9555in25qgwkkbnbifw0ywmgni8xfygl8w6";
        procMacro = true;
        authors = [
          "Lars Kroll <lkroll@kth.se>"
        ];
      ...
      "kompact-component-derive" = rec {
        crateName = "kompact-component-derive";
        version = "0.8.1";
        edition = "2018";
        sha256 = "0hq7fw1i5i8hva74b4yh0q5141idnw8mw9kf4pi2fvmhriynv39f";
        procMacro = true;
        authors = [
          "Lars Kroll <lkroll@kth.se>"
        ];
      ...
      "redox_syscall" = rec {
        ...
        version = "0.1.32";
        edition = "2015";
        sha256 = "187f61ha332m4jh17s0y8qhxj0jhlv470w2vsicxwkl8apv5s45b";
        libName = "syscall";
        authors = [
      ...
      "slog" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "max_level_info" "max_level_trace" "release_max_level_error" "release_max_level_info" "std" ];
      };
      "slog-async" = rec {
      ...
      "spaniel" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0sv9ym0wklb54ckfzpb0sz3i9syang8wab52inav2is7l590cgxl";
        authors = [
          "Johan Mickos <johanmi@kth.se>"
        ];
        dependencies = [
