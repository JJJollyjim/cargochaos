...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dapr/v0.1.0-alpha.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dapr-derive" = rec {
        crateName = "dapr-derive";
        version = "0.1.0-alpha.2";
        edition = "2018";
        sha256 = "1dvavigz30zr64xz32vdakmd759fy7zq2k68bcqlbpbphrdgk9hw";
        procMacro = true;
        authors = [
          "Flier Lu <flier.lu@gmail.com>"
        ];
      ...
      "tonic" = rec {
        ...
        version = "0.1.0-alpha.4";
        edition = "2018";
        sha256 = "1b0q6mww6aka720j4x122hv7c258k8inksjgcvzflhhnsv87zxbv";
        authors = [
      ...
      "tonic-build" = rec {
        ...
        version = "0.1.0-alpha.4";
        edition = "2018";
        sha256 = "1c501n4fa0kv50mb9fgk4s4vv92byy844hs6yj60rnlk593f1ppj";
        authors = [
          "Lucio Franco <luciofranco14@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
