...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fakelogs/v0.1.6-a180978.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fakelogs" = rec {
        crateName = "fakelogs";
        version = "0.1.6-a180978";
        edition = "2018";
        crateBin = [
          { name = "fakelogs"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.6-a180978.nix {};
        authors = [
