...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/raqote/v0.7.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "euclid" = rec {
        ...
        version = "0.20.0";
        edition = "2015";
        sha256 = "01m1h685nhr62kawy3vdiiifgr48076k5gsmwy93f67c3x98circ";
        authors = [
          "The Servo Project Developers"
        ];
        dependencies = [
      ...
      "raqote" = rec {
        ...
        version = "0.7.14";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.14.nix {};
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "dwrite" "dwrite_1" "dwrite_3" "errhandlingapi" "fileapi" "knownfolders" "libloaderapi" "minwindef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "shlobj" "std" "sysinfoapi" "unknwnbase" "winbase" "wincon" "winerror" "winnls" "winnt" ];
      };
