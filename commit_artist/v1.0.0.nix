...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/commit_artist/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "commit_artist" = rec {
        crateName = "commit_artist";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "commit_artist"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "rnitta <attinyes@gmail.com>"
        ];
        dependencies = [
          {
            name = "num_cpus";
      ...
      "seahorse" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "00plfb0mpy9zllr1hw1y8lppiyr8f0f82b2fv1cld5na98livsrl";
        authors = [
