...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/monadic/v0.5.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "monadic" = rec {
        ...
        authors = [
          "Gabriel Riba Faura <griba2001@gmail.com>"
        ];
        devDependencies = [
          {
            name = "num";
        ...
        resolvedDefaultFeatures = [ "default" "reader" "reader_trans" "state" "state_trans" "writer" "writer_trans" ];
      };
      "num" = rec {
        crateName = "num";
        version = "0.2.0";
