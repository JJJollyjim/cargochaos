...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libcryptsetup-rs/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "keyutils" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "1k5jribk0bgvv3mdk8hw1m08qb9p55h0yybs8gqv9fzdkf2fgnyb";
        authors = [
      ...
      "libcryptsetup-rs-sys" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1rwsykmxpc27535gar6w8pfg3xhxx92vxl65yk0rjahyx2c5jq0c";
        authors = [
          "John Baublitz <jbaublitz@redhat.com>"
        ];
        buildDependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
