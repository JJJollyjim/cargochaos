...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/minimp4/v0.1.0.nix.tmp"
    ...
    crates = {
      ...
      "minimp4" = rec {
        ...
        dependencies = [
          ...
          {
            name = "minimp4-sys";
            packageId = "minimp4-sys";
          }
        ];
        
      };
      "minimp4-sys" = rec {
        crateName = "minimp4-sys";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1palk3a5jcaqi54qmckxnxhwsia6amgwc9r72paczx3pr8f3kjg1";
        authors = [
          "DarkSky"
        ];
        buildDependencies = [
