...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdcat/v0.16.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" "term_size" "wrap_help" ];
      };
      "color_quant" = rec {
      ...
      "syntect" = rec {
        ...
        resolvedDefaultFeatures = [ "assets" "bincode" "dump-load" "fancy-regex" "flate2" "fnv" "parsing" "regex-fancy" "regex-syntax" ];
      };
      "tempfile" = rec {
        crateName = "tempfile";
        version = "3.1.0";
