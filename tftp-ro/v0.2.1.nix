...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tftp-ro/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simon" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "08xs7xanyrw8540vpbxh1byhmklc0yzk64653imkwfrqrvfnqf5j";
        authors = [
      ...
      "tftp-ro" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "fs" "udp" "stream" "io-util" ];
          }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "futures-core" "io-driver" "io-util" "lazy_static" "macros" "memchr" "mio" "rt-core" "stream" "tokio-macros" "udp" ];
      };
      "tokio-macros" = rec {
