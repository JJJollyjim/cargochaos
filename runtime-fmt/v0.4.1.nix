...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/runtime-fmt/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "runtime-fmt" = rec {
        ...
        devDependencies = [
          {
            name = "runtime-fmt-derive";
            packageId = "runtime-fmt-derive";
          }
        ];
        
      };
      "runtime-fmt-derive" = rec {
        crateName = "runtime-fmt-derive";
        version = "0.2.0";
        edition = "2015";
        sha256 = "1jxhnn2m9jdnsvsv9vsrjbf3i7gqdg774564pp63ndb373m3d4s1";
        procMacro = true;
        authors = [
          "Tad Hardesty <tad@platymuus.com>"
        ];
