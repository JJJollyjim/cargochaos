...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-translate2-cli/v1.0.13+20170525.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-translate2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-translate2" = rec {
        crateName = "google-translate2";
        version = "1.0.13+20170525";
        edition = "2015";
        sha256 = "1w5g6fn0kk5yk0nbbdjmmhj5kki16lbd14rw6gjyi25awyqkngyy";
        authors = [
      ...
      "google-translate2-cli" = rec {
        crateName = "google-translate2-cli";
        version = "1.0.13+20170525";
        edition = "2015";
        crateBin = [
          { name = "translate2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20170525.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
