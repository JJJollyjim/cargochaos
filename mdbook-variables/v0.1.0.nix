...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mdbook-variables/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mdbook-variables" = rec {
        crateName = "mdbook-variables";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mdbook-variables"; path = "src/main.rs"; }
        ];
