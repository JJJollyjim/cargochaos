...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-proximitybeacon1_beta1-cli/v1.0.12+20190323.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-proximitybeacon1_beta1-cli";
  ...
  workspaceMembers = {
    "google-proximitybeacon1_beta1-cli" = rec {
      packageId = "google-proximitybeacon1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-proximitybeacon1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-proximitybeacon1_beta1" = rec {
        crateName = "google-proximitybeacon1_beta1";
        version = "1.0.12+20190323";
        edition = "2015";
        sha256 = "08gzmjd29kbac12j58j6wdb59kaviylmfwsimnjcazb9v86m5x7r";
        authors = [
      ...
      "google-proximitybeacon1_beta1-cli" = rec {
        crateName = "google-proximitybeacon1_beta1-cli";
        version = "1.0.12+20190323";
        edition = "2015";
        crateBin = [
          { name = "proximitybeacon1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190323.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-proximitybeacon1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
