...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-json-response/v0.5.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "debug-helper" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "18yq21fms9j8j03zy6yh4j07mf7r7fqwfrhzpbmvpw1ldqfxzfn7";
        authors = [
      ...
      "enum-ordinalize" = rec {
        ...
        version = "2.5.0";
        edition = "2015";
        sha256 = "0gw4arn1bmdkxlylc719xvp4xcldl8fk842wgnjxwwxrjfvmgmv5";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        features = {
      ...
      "json-gettext" = rec {
        ...
        version = "3.0.1";
        edition = "2015";
        sha256 = "162d68v9zby9awmikwfrq7kfykzc5w13skbhgaf18mrj9pq8k6y0";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-json-response" = rec {
        ...
        version = "0.5.10";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.10.nix {};
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
