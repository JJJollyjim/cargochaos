...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mprober/v0.10.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "benchmarking" = rec {
        ...
        version = "0.4.7";
        edition = "2018";
        sha256 = "187ms90d5lb4a8li090h4syc4j6pj9crb96ixfs0my96gws6l9j8";
        authors = [
      ...
      "html-minifier" = rec {
        ...
        version = "1.2.0";
        edition = "2018";
        sha256 = "0q9m28sfwy33msjh95ipqlrabzrvf7m05wr91yaa5i62yv8qn46l";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "mprober" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mprober"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.11.nix {};
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "rocket-cache-response";
          }
          {
          ...
          }
          {
            ...
            packageId = "rocket-include-static-resources";
          }
          {
            name = "rocket-json-response";
            packageId = "rocket-json-response";
          }
          {
            name = "rocket-simple-authorization";
            packageId = "rocket-simple-authorization";
          }
          {
            name = "scanner-rust";
      ...
      "rocket" = rec {
        ...
        version = "0.4.3";
        edition = "2015";
        sha256 = "1pjg5xn09azs3nln39939pwyhvqn3r3bbxc4x1m3d6sammgspa8a";
        authors = [
          "Sergio Benitez <sb@sergio.bz>"
        ];
        dependencies = [
      ...
      "rocket-cache-response" = rec {
        crateName = "rocket-cache-response";
        version = "0.5.1";
        edition = "2018";
        sha256 = "0vs8fhmad9zr4i22dq9nnv2cdfqahii8v3mdkzlkcs3kbwdzvchy";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-include-handlebars" = rec {
        ...
        version = "0.12.10";
        edition = "2018";
        sha256 = "0qpwqhb52zqzx6ikccws5iky9mj5ssdb345nvpmxr5fjb1jvw664";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-include-static-resources" = rec {
        crateName = "rocket-include-static-resources";
        version = "0.9.3";
        edition = "2018";
        sha256 = "17g110fg1kvkp86r1x8is6bbri6iw2nba8r0cgw50ilrvyq76drn";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-json-response" = rec {
        crateName = "rocket-json-response";
        version = "0.5.10";
        edition = "2018";
        sha256 = "1c6b95wggfkczjx1bbpm4kwya8fa21x0hg9k6v8h5447kza5cfq6";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-simple-authorization" = rec {
        crateName = "rocket-simple-authorization";
        version = "0.9.5";
        edition = "2018";
        sha256 = "1qsi1ypnmvckrl3d3i83zsbkb044z5s8rfrzqaavp0b30dwxzpsr";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket_codegen" = rec {
        ...
        version = "0.4.3";
        edition = "2015";
        sha256 = "0b3026hqd4rlf2xxg47x15f03izyj9zpbyg4q7l928mffc7m8v65";
        procMacro = true;
        authors = [
          "Sergio Benitez <sb@sergio.bz>"
        ];
      ...
      "rocket_http" = rec {
        ...
        version = "0.4.3";
        edition = "2015";
        sha256 = "1minsvhvbpixiz39ams1m5fyi08j1sw5k8xb7418m34zzb5hg2ln";
        authors = [
          "Sergio Benitez <sb@sergio.bz>"
        ];
        dependencies = [
      ...
      "validators" = rec {
        ...
        version = "0.20.16";
        edition = "2018";
        sha256 = "0jk5j3ms2gh5yb75j6hd76zsn86ifa6ykdr68jkhbsh23diib1f9";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "nightly" "rocket" "rocketly" ];
      };
      "vec_map" = rec {
        crateName = "vec_map";
        version = "0.8.1";
