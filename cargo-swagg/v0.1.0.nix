...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-swagg/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-swagg" = rec {
        crateName = "cargo-swagg";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-swagg"; path = "src/main.rs"; }
        ];
      ...
      "swagg" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1rfw2q6fdjxyszdx94x9503vnvldfyw6gm8fgnjipfm1ryl6x4p2";
        authors = [
          "Sergey Sova <mail@sergeysova.com>"
        ];
        dependencies = [
