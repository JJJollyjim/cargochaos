...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/image/v0.23.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "benchmarks" "bmp" "dds" "default" "dxt" "farbfeld" "gif" "hdr" "ico" "jpeg" "jpeg_rayon" "png" "pnm" "scoped_threadpool" "tga" "tiff" "webp" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
