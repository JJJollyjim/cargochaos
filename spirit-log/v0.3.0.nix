...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spirit-log/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fern" = rec {
        ...
        resolvedDefaultFeatures = [ "syslog" "syslog-4" ];
      };
      "heck" = rec {
        crateName = "heck";
        version = "0.3.1";
      ...
      "log-reroute" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1vidd0ra51zpl32ifgjhkfxnqavi0g8pyijymkjxjpwrm4c0cvqs";
        authors = [
          "Michal 'vorner' Vaner <vorner@vorner.cz>"
        ];
        dependencies = [
      ...
      "spirit-log" = rec {
        ...
        resolvedDefaultFeatures = [ "background" "cfg-help" "crossbeam-channel" "default" "either" "structdoc" "syslog" "to-syslog" "with-backtrace" ];
      };
      "structdoc" = rec {
        crateName = "structdoc";
        version = "0.1.4";
