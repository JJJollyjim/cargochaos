...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rv/v0.7.0-rc1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nalgebra" = rec {
        ...
        version = "0.16.13";
        edition = "2015";
        sha256 = "0fdpq23il22xjmjly9vmpcdp0m1gy8jg0dqmi82ckfa776srj1wf";
        authors = [
      ...
      "rv" = rec {
        ...
        version = "0.7.0-rc1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.0-rc1.nix {};
        authors = [
          "Baxter Eaves"
          "Michael Schmidt"
        ];
