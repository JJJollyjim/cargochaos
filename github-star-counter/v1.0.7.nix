...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/github-star-counter/v1.0.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "compat" "default" "io-compat" "nightly" "std" ];
      };
      ...
      "tokio" = rec {
        ...
        dependencies = [
          ...
          {
            name = "tokio-io";
            packageId = "tokio-io 0.2.0-alpha.2";
            optional = true;
            features = [ "util" ];
          }
          {
      ...
      "tokio-fs" = rec {
        ...
        version = "0.2.0-alpha.2";
        edition = "2018";
        sha256 = "0hiz1aaw7m3bsc538655663k2860dn9qwl593ax3pack3v8xwrpp";
        authors = [
          "Tokio Contributors <team@tokio.rs>"
        ];
        dependencies = [
      ...
      "tokio-net" = rec {
        ...
        resolvedDefaultFeatures = [ "async-traits" "bytes" "futures-sink-preview" "futures-util-preview" "iovec" "libc" "mio-uds" "tcp" "udp" "uds" ];
      };
      "tokio-sync" = rec {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
