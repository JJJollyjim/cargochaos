...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tapper/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "tapper" = rec {
        ...
        dependencies = [
          ...
          {
            name = "testanything";
            packageId = "testanything";
          }
        ];
        
      };
      "testanything" = rec {
        crateName = "testanything";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0x5l2wawa1b0lkxmzx7v9nlyrdwh2r1igdscal7x8f2gynqhifi8";
        authors = [
          "Jonathan E. Magen <jonathan.magen@cigna.com>"
        ];
