...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/trinket_m0/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21e18a" "samd21" "samd21e18a" "samd21e18a-rt" "unproven" ];
      };
      "atsamd21e18a" = rec {
