...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hars/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hars" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "hars"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Adrian Wozniak <adrian.wozniak@ita-prog.pl>"
        ];
        dependencies = [
          {
            name = "bincode";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
