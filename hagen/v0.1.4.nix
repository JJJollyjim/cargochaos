...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hagen/v0.1.4.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hagen-core" = rec {
        crateName = "hagen-core";
        version = "0.1.4";
        edition = "2018";
        sha256 = "13x5x0h32vs7avnz4rlvbcb854bafz0fjqw4h65sqpfri1cmc010";
        authors = [
          "Jens Reimann <ctron@dentrassi.de>"
        ];
        dependencies = [
      ...
      "jsonpath_lib" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "1jh93zp4qfv7qdxsgbrgcy5l3bp2kpspblmdr4702v49hxlpywpq";type = [ "cdylib" "rlib" ];
        authors = [
