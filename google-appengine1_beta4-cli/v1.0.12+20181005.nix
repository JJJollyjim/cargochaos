...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-appengine1_beta4-cli/v1.0.12+20181005.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-appengine1_beta4-cli";
  ...
  workspaceMembers = {
    "google-appengine1_beta4-cli" = rec {
      packageId = "google-appengine1_beta4-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-appengine1_beta4-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-appengine1_beta4" = rec {
        crateName = "google-appengine1_beta4";
        version = "1.0.12+20181005";
        edition = "2015";
        sha256 = "0y1flg51syqadqvmim8p33jglbgy7g1m5vc2xrc721wx5hjf21pc";
        authors = [
      ...
      "google-appengine1_beta4-cli" = rec {
        crateName = "google-appengine1_beta4-cli";
        version = "1.0.12+20181005";
        edition = "2015";
        crateBin = [
          { name = "appengine1-beta4"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-appengine1_beta4";
          }
          {
            name = "hyper";
            packageId = "hyper";
