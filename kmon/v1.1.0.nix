...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kmon/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colorsys" = rec {
        ...
        version = "0.5.3";
        edition = "2018";
        sha256 = "0b1xzlhcs0zbmnhk4pizivndaka60gqk7hlpf7wgqw1mqpm5gnd3";
        authors = [
          "mz <emgyrz@gmail.com>"
        ];
      ...
      "enum-iterator" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "14a2kk83z5wz8678kcf84607nvj4lss2xcxlq70nwbn7nivkhy6y";
        authors = [
      ...
      "enum-iterator-derive" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1rmm7rj6snhp77pcid64sb9im7hrjg0ymvy2gnj6mn6bfaphcgzb";
        procMacro = true;
        authors = [
          "Stephane Raux <stephaneyfx@gmail.com>"
        ];
      ...
      "enum-unitary" = rec {
        crateName = "enum-unitary";
        version = "0.4.1";
        edition = "2018";
        sha256 = "179s4xd15y54j060rln9iknac20785jl4zk1srr89aiffb71hgh2";
        authors = [
      ...
      "kmon" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "kmon"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.0.nix {};
        authors = [
          "orhun <orhunparmaksiz@gmail.com>"
        ];
        dependencies = [
          {
            name = "bytesize";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "processenv" "shellapi" "std" "winbase" "winuser" ];
      };
