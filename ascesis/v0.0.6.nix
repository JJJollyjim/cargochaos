...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ascesis/v0.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "winbase" "wincon" "winerror" "winnt" ];
      };
