...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/epochs-cli/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "epochs" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "12z992x8nxdxrq8sjvlgynfikhkk1b3264nxndh8p6d6j0wlj2w4";
        authors = [
          "oylenshpeegul <oylenshpeegul@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "epochs-cli" = rec {
        crateName = "epochs-cli";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "epochs"; path = "src/main.rs"; }
        ];
