...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/census2csv/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "census-proteomics" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "0pjjsqjpiqlldw8y7zpi7bys3iyfanyfh5xjv6apc6xjzx9hc1wk";
        authors = [
      ...
      "census2csv" = rec {
        crateName = "census2csv";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "census2csv"; path = "src/main.rs"; }
        ];
