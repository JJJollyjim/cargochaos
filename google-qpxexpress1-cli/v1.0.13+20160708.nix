...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-qpxexpress1-cli/v1.0.13+20160708.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-qpxexpress1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-qpxexpress1" = rec {
        crateName = "google-qpxexpress1";
        version = "1.0.13+20160708";
        edition = "2015";
        sha256 = "1m09x917wpdimvchyk3srwpgw7ba984csppd6mp56cjj739f4rh5";
        authors = [
      ...
      "google-qpxexpress1-cli" = rec {
        crateName = "google-qpxexpress1-cli";
        version = "1.0.13+20160708";
        edition = "2015";
        crateBin = [
          { name = "qpxexpress1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20160708.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
