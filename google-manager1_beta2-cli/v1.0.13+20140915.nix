...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-manager1_beta2-cli/v1.0.13+20140915.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-manager1_beta2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-manager1_beta2" = rec {
        crateName = "google-manager1_beta2";
        version = "1.0.13+20140915";
        edition = "2015";
        sha256 = "03chm9g0yivggk2k01b5bv6jpc6dksbc949gjhdiyzb6d32awq4c";
        authors = [
      ...
      "google-manager1_beta2-cli" = rec {
        crateName = "google-manager1_beta2-cli";
        version = "1.0.13+20140915";
        edition = "2015";
        crateBin = [
          { name = "manager1-beta2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20140915.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-manager1_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
