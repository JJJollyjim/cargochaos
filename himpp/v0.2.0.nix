...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/himpp/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hifb-sys" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "1xchmn251g705mw05w96c0cnmbgywbih2c7hg8d9x9wijxrs829b";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "hi3531v100" "hi3559av100" ];
      };
      "himpi-sys" = rec {
        crateName = "himpi-sys";
        version = "0.1.8";
        edition = "2018";
        sha256 = "025ahp4d9hc124146s11k4ng2g8l6z0x7p4qpgnrhyq567nm97nn";
        authors = [
          "Varphone Wong <varphone@qq.com>"
        ];
        dependencies = [
        ...
        features = {
          "default" = [ "hi3559av100" "mpi-hdmi" "mpi-sys" "mpi-vb" "mpi-vdec" "mpi-venc" "mpi-vi" "mpi-vo" "mpi-vpss" ];
          "hi3531v100" = [ "static-link" ];
        };
        resolvedDefaultFeatures = [ "default" "hi3531v100" "hi3559av100" "mpi-ae" "mpi-audio" "mpi-avs" "mpi-awb" "mpi-dpu" "mpi-dsp" "mpi-gdc" "mpi-hdmi" "mpi-hdr" "mpi-isp" "mpi-ive" "mpi-nnie" "mpi-pciv" "mpi-photo" "mpi-region" "mpi-snap" "mpi-sys" "mpi-vb" "mpi-vdec" "mpi-venc" "mpi-vgs" "mpi-vi" "mpi-vo" "mpi-vpss" "static-link" ];
      };
      "himpp" = rec {
        crateName = "himpp";
        version = "0.2.0";
        ...
        features = {
          "default" = [ "hi3559av100" "hifb" "hitde" "iomem" "mpi-hdmi" "mpi-sys" "mpi-vb" "mpi-vdec" "mpi-venc" "mpi-vi" "mpi-vo" "mpi-vpss" ];
          "hi3531v100" = [ "hifb-sys/hi3531v100" "himpi-sys/hi3531v100" "himpi-sys/static-link" "hitde-sys/hi3531v100" "hitde-sys/static-link" ];
          "hi3559av100" = [ "hifb-sys/hi3559av100" "himpi-sys/hi3559av100" "hitde-sys/hi3559av100" ];
          "hifb" = [ "hifb-sys" "libc" ];
          "hitde" = [ "hitde-sys" ];
          "mpi-ae" = [ "himpi-sys/mpi-ae" ];
          "mpi-audio" = [ "himpi-sys/mpi-audio" ];
          "mpi-avs" = [ "himpi-sys/mpi-avs" ];
          "mpi-awb" = [ "himpi-sys/mpi-awb" ];
          "mpi-dpu" = [ "himpi-sys/mpi-dpu" ];
          "mpi-dsp" = [ "himpi-sys/mpi-dsp" ];
          "mpi-gdc" = [ "himpi-sys/mpi-gdc" ];
          "mpi-hdmi" = [ "himpi-sys/mpi-hdmi" ];
          "mpi-hdr" = [ "himpi-sys/mpi-hdr" ];
          "mpi-isp" = [ "himpi-sys/mpi-isp" ];
          "mpi-ive" = [ "himpi-sys/mpi-ive" ];
          "mpi-nnie" = [ "himpi-sys/mpi-nnie" ];
          "mpi-pciv" = [ "himpi-sys/mpi-pciv" ];
          "mpi-photo" = [ "himpi-sys/mpi-photo" ];
          "mpi-region" = [ "himpi-sys/mpi-region" ];
          "mpi-snap" = [ "himpi-sys/mpi-snap" ];
          "mpi-sys" = [ "himpi-sys/mpi-sys" ];
          "mpi-vb" = [ "himpi-sys/mpi-vb" ];
          "mpi-vdec" = [ "himpi-sys/mpi-vdec" ];
          "mpi-venc" = [ "himpi-sys/mpi-venc" ];
          "mpi-vgs" = [ "himpi-sys/mpi-vgs" ];
          "mpi-vi" = [ "himpi-sys/mpi-vi" ];
          "mpi-vo" = [ "himpi-sys/mpi-vo" ];
          "mpi-vpss" = [ "himpi-sys/mpi-vpss" ];
          "static-link" = [ "himpi-sys/static-link" "hitde-sys/static-link" ];
        };
        resolvedDefaultFeatures = [ "default" "hi3516ev200" "hi3516ev300" "hi3518ev200" "hi3518ev300" "hi3519av100" "hi3531v100" "hi3559av100" "hifb" "hifb-sys" "himpi-sys" "hitde" "hitde-sys" "iomem" "libc" "mpi-ae" "mpi-audio" "mpi-avs" "mpi-awb" "mpi-dpu" "mpi-dsp" "mpi-gdc" "mpi-hdmi" "mpi-hdr" "mpi-isp" "mpi-ive" "mpi-nnie" "mpi-pciv" "mpi-photo" "mpi-region" "mpi-snap" "mpi-sys" "mpi-vb" "mpi-vdec" "mpi-venc" "mpi-vgs" "mpi-vi" "mpi-vo" "mpi-vpss" "static-link" ];
      };
      "hitde-sys" = rec {
        crateName = "hitde-sys";
        version = "0.1.4";
        edition = "2018";
        sha256 = "1z402mgmm5awkmxksxzr9h7g8s27fxshawdk18shby66p9yx5mxj";
        authors = [
          "Varphone Wong <varphone@qq.com>"
        ];
        buildDependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "hi3531v100" "hi3559av100" "static-link" ];
      };
      "humantime" = rec {
        crateName = "humantime";
        version = "1.3.0";
      ...
      "rust-bitfield" = rec {
        crateName = "rust-bitfield";
        version = "0.1.1";
        edition = "2018";
        sha256 = "02fizlzb5rbm1dgzpca2wzv2i0528x1hlhsc47lq57f3giz3djcx";
        authors = [
          "Varphone Wong <varphone@qq.com>"
        ];
