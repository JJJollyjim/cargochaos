...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-geiger/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "geiger" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "173101mvi2p41n13ignq3namwwwbhbk56wqrfkk5dw7pyn6q3cb2";
        authors = [
          "anderejd <rajder@gmail.com>"
        ];
        dependencies = [
