...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-geiger/v0.10.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "geiger" = rec {
        ...
        version = "0.4.4";
        edition = "2018";
        sha256 = "0qll2xq4lrxd20i3qk8f1ngns4scql97i6pkiw9dfa18nn3k1f56";
        authors = [
          "anderejd <rajder@gmail.com>"
        ];
        dependencies = [
      ...
      "insta" = rec {
        ...
        version = "0.16.0";
        edition = "2018";
        sha256 = "15mhx4kjp0vbc4lzzi3dxd93ccwsa8y21pnflhg169rrzfayg1l3";
        authors = [
          "Armin Ronacher <armin.ronacher@active-4.com>"
        ];
        dependencies = [
