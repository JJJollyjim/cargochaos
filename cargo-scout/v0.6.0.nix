...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-scout/v0.6.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-scout" = rec {
        crateName = "cargo-scout";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-scout"; path = "src/main.rs"; }
        ];
      ...
      "cargo-scout-lib" = rec {
        crateName = "cargo-scout-lib";
        version = "0.6.0";
        edition = "2018";
        sha256 = "0rjadh8ia476mmxjvl3v92677a2lq9r3qg76iqjihac17lmarrm9";
        authors = [
          "o0Ignition0o <jeremy.lempereur@gmail.com>"
        ];
        dependencies = [
