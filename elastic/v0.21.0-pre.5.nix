...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/elastic/v0.21.0-pre.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "elastic" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.21.0-pre.5.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default-tls" "rustls-tls" ];
      };
      "elastic_derive" = rec {
