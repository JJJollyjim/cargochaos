...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blinds/v0.1.0-alpha10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha10.nix {};
        authors = [
      ...
      "glutin" = rec {
        ...
        version = "0.22.0";
        edition = "2018";
        sha256 = "1qbpk1yghd0m44raha2rcgb5gw8pdgx2n5bamnmbhpzsvp64131f";
        authors = [
