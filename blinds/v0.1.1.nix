...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blinds/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "enum-map" "event-cache" "favicon" "gamepad" "gilrs" "gl" "glow" "glutin" "image" "rustc-hash" "std_web" "stdweb" "wasm-bindgen" "web-sys" "web_sys" "webgl_stdweb" ];
      };
      "block" = rec {
        crateName = "block";
        version = "0.1.6";
