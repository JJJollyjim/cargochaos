...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blinds/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mint" = rec {
        ...
        version = "0.5.5";
        edition = "2015";
        sha256 = "1q4ivadb1lw7d5sxls2kclvmny27hwpdnwihiqixb6m3ckrm8bnl";
        authors = [
