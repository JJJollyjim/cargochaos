...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blinds/v0.1.0-alpha8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha8.nix {};
        authors = [
      ...
      "winit" = rec {
        ...
        edition = "2018";
        sha256 = "1g5cchl97zcg525j6jdr77yby8cmhwv1qqwcd3sf4l4zl263195z";
        authors = [
