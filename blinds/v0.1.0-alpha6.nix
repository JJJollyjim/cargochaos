...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blinds/v0.1.0-alpha6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha6.nix {};
        authors = [
