...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blinds/v0.1.0-alpha7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blinds" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha7.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "favicon" "gamepad" "gilrs" "gl" "glow" "glutin" "image" "std_web" "stdweb" "wasm-bindgen" "web-sys" "web_sys" "webgl_stdweb" ];
      };
      "block" = rec {
        crateName = "block";
        version = "0.1.6";
      ...
      "glutin" = rec {
        ...
        edition = "2018";
        sha256 = "1fnfpdmymj6s53p9ahpmqpqay7plj7fsshhsla0l408mnn93bpgw";
        authors = [
      ...
      "winit" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            target = { target, features }: (target."arch" == "wasm32");
            features = [ "console" "BeforeUnloadEvent" "Document" "DomRect" "Element" "Event" "EventTarget" "FocusEvent" "HtmlCanvasElement" "HtmlElement" "KeyboardEvent" "MouseEvent" "Node" "PointerEvent" "Window" "WheelEvent" ];
          }
          {
            name = "winapi";
            packageId = "winapi 0.3.8";
