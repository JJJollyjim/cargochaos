...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/routinator/v0.6.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcder" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "04xbxc54bs857pmylgi9q0j3r6yf9hvnbhixib0i4swxrlbnxaz1";
        authors = [
          "The NLnet Labs RPKI Team <rpki@nlnetlabs.nl>"
        ];
        dependencies = [
          {
            name = "backtrace";
        ...
        resolvedDefaultFeatures = [ "backtrace" "extra-debug" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "hyper-rustls" "rustls" "rustls-tls" "socks" "tls" "tokio-rustls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.14.6";
      ...
      "routinator" = rec {
        crateName = "routinator";
        version = "0.6.4";
        edition = "2018";
        crateBin = [
          { name = "routinator"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "extra-debug" ];
      };
      "rpki" = rec {
        crateName = "rpki";
        version = "0.8.1";
        edition = "2018";
        crateBin = [];
        sha256 = "03ad9r9vbwbwpi8hyj87ag5krha6h3ym2hsb23nbm9bsdj1xr5n1";
        authors = [
          "The NLnet Labs RPKI Team <rpki@nlnetlabs.nl>"
        ];
        dependencies = [
