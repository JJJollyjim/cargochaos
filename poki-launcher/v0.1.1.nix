...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/poki-launcher/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fuzzy-matcher" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0rrzjaajdypgvfdzrbvjhszg9vhca7vbg7ahzbsm0wjxfr9ckf1d";
        authors = [
      ...
      "lib-poki-launcher" = rec {
        crateName = "lib-poki-launcher";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1sd5g9801yz7l0a11yqgrcyld3897lg0x0qwkvw8d0vs6l8iax4g";
        authors = [
          "Ben Aaron <benaagoldberg@gmail.com>"
        ];
        dependencies = [
          {
            name = "config";
          ...
          {
            name = "poki-launcher-x11";
            packageId = "poki-launcher-x11";
          }
          {
            name = "rmp-serde";
            packageId = "rmp-serde";
      ...
      "poki-launcher" = rec {
        crateName = "poki-launcher";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "poki-launcher"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "poki-launcher-notifier";
            packageId = "poki-launcher-notifier";
          }
          {
            name = "rmp-serde";
            packageId = "rmp-serde";
        ...
        buildDependencies = [
          {
            ...
            packageId = "rust_qt_binding_generator";
          }
        ];
        
      };
      "poki-launcher-notifier" = rec {
        crateName = "poki-launcher-notifier";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1v5zd16mf4l8v10795jsvalzz5ii6cxrfnq6hvz6b46bsk1mr8jr";
        authors = [
          "Ben Aaron <benaagoldberg@gmail.com>"
        ];
        dependencies = [
      ...
      "poki-launcher-x11" = rec {
        crateName = "poki-launcher-x11";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1d60r1xvwg4m75p7c40q4ykyjbx4ira9yr4kyhj8bdw4hr30by1z";
        authors = [
          "Ben Aaron <benaagoldberg@gmail.com>"
        ];
      ...
      "rust_qt_binding_generator" = rec {
        crateName = "rust_qt_binding_generator";
        version = "0.3.4";
        edition = "2015";
        crateBin = [];
        sha256 = "1abwivs6jk47985nmnr7narvz0bvdmjhrj9cm7gzhz0mnw768d7r";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "winbase" "wincon" "windef" "winerror" "winnt" ];
      };
