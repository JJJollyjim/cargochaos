...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyper-tls/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-std" "io-util" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
