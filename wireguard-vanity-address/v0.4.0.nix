...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wireguard-vanity-address/v0.4.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "wireguard-vanity-address";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wireguard-vanity-address" = rec {
        crateName = "wireguard-vanity-address";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "wireguard-vanity-address"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        libName = "wireguard_vanity_lib";
        authors = [
