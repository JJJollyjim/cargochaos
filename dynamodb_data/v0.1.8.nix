...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dynamodb_data/v0.1.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dynamodb_data" = rec {
        crateName = "dynamodb_data";
        version = "0.1.8";
        edition = "2018";
        crateBin = [
          { name = "dynamodb_data"; path = "src/main.rs"; }
        ];
      ...
      "rusoto_dynamodb" = rec {
        ...
        version = "0.40.0";
        edition = "2018";
        sha256 = "1xiijdagdd2x8p4m22ff4rvm2p1bs6xp252i9l1s1286yvbm98wf";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
