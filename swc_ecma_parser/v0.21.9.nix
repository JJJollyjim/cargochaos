...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/swc_ecma_parser/v0.21.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "relative-path" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0m0rlasarkiaw9r0q50ml6zjkmizqp4nb8cy8g722a8gyh0f1pdy";
        authors = [
      ...
      "swc_ecma_parser" = rec {
        ...
        version = "0.21.9";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.21.9.nix {};
        authors = [
          "강동윤 <kdy1997.dev@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "fold" "verify" ];
      };
      ...
      "testing" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0cv17ma3015mcqgvzzmynifqimjvga6mfifq00z1q3a65l5s37ar";
        authors = [
          "강동윤 <kdy1997.dev@gmail.com>"
        ];
        dependencies = [
