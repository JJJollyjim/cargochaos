...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/htpa32x32d/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "htpa32x32d" = rec {
        crateName = "htpa32x32d";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Tobias Breitwieser <tobias@breitwieser.biz>"
        ];
        dependencies = [
          {
            name = "embedded-hal";
        ...
        devDependencies = [
          ...
          }
          {
            ...
            packageId = "embedded-graphics 0.5.2";
          }
          {
            name = "heapless";
            packageId = "heapless";
      ...
      "shared-bus" = rec {
        crateName = "shared-bus";
        version = "0.1.4";
        edition = "2015";
        sha256 = "1c4ay699abih7vnrdp48l8b20xahp6znx7fcq0i8h21ryd9jlygd";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m" "cortexm" ];
      };
      "ssd1306" = rec {
        crateName = "ssd1306";
        version = "0.2.6";
        edition = "2018";
        sha256 = "1ww7s1j9fvp7qn9q2g0j4yhgd8v00rq31ci8xj6cmsq14011in2p";
        authors = [
        ...
        dependencies = [
          {
            name = "embedded-graphics";
            packageId = "embedded-graphics 0.4.9";
            optional = true;
          }
          {
            name = "embedded-hal";
      ...
      "st7735-lcd" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "03wgc8sbqxp67zf28mfn6x844j32db74aganv6k2zm8v39j81lqq";
        authors = [
