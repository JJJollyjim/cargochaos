...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/moz-geckodriver/v0.26.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "marionette" = rec {
        crateName = "marionette";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0s70m8sq5nnd6cs0133j6a6anzhxiyjpr31v1jcig6dcn4r8w3xk";
        authors = [
          "Mozilla"
        ];
        dependencies = [
      ...
      "moz-geckodriver" = rec {
        crateName = "moz-geckodriver";
        version = "0.26.0";
        edition = "2015";
        crateBin = [
          { name = "geckodriver"; path = "src/main.rs"; }
        ];
      ...
      "mozdevice" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0g75qyz7hb66i4lvyll6jg89mk29zm9lyw0kl9kf77nv8d6rpsfy";
        authors = [
      ...
      "mozprofile" = rec {
        crateName = "mozprofile";
        version = "0.6.0";
        edition = "2015";
        sha256 = "077a6931zr3zhnlhcpwv8f4l291n6q6z3f5gl9n898rg5s8gw5az";
        authors = [
          "Mozilla"
        ];
        dependencies = [
      ...
      "mozrunner" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "03mrfwc8c0y8riprfnm8d7pmqigjqqp7a64n95ypmmz1vgbngzf3";
        authors = [
          "Mozilla"
        ];
        dependencies = [
      ...
      "mozversion" = rec {
        crateName = "mozversion";
        version = "0.2.1";
        edition = "2015";
        sha256 = "07kc30b5fhcawf6c7z006h4xwgvq01hdya1mw01qyhavfqclcz5w";
        authors = [
      ...
      "rust-ini" = rec {
        ...
        version = "0.10.3";
        edition = "2015";
        sha256 = "0qvjqdjqii3z8qz4qwjvv8l8j8fyj06lrzmhwsdnjb3jv9dlqrca";
        libName = "ini";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
