...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustget/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "parallel-getter" = rec {
        crateName = "parallel-getter";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0dvk9y1bhdn9skhii88j2vm4ichnc3ss1fjlqhvd2y2inksmd4fy";
        authors = [
          "Michael Aaron Murphy <mmstickman@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "numtoa";
            packageId = "numtoa 0.2.3";
          }
          {
            name = "progress-streams";
            packageId = "progress-streams";
          }
          {
            name = "reqwest";
            packageId = "reqwest";
      ...
      "progress-streams" = rec {
        crateName = "progress-streams";
        version = "1.0.0";
        edition = "2015";
        sha256 = "0cmx5qdd9gxl1wfj5c4dmcwvgnchminr410ds64m2zk98hf6l044";
        authors = [
          "Michael Aaron Murphy <mmstickman@gmail.com>"
        ];
      ...
      "rustget" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rget"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "SummaDiaboli <salim.hussaini@backlinq.ng>"
        ];
        dependencies = [
          {
            name = "indicatif";
