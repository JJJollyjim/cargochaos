...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miniserde-enum/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "miniserde-enum" = rec {
        crateName = "miniserde-enum";
        version = "0.1.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        procMacro = true;
        authors = [
          "Aymeric Beringer <aymeric.beringer@epita.fr>"
        ];
        dependencies = [
          {
            name = "miniserde";
