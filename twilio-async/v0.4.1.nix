...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/twilio-async/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "twiml" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1dgx71wp3an6rivdajzzmp140ily53xha23pzx98fn39vha2r6hi";
        authors = [
          "Evan Cameron <cameron.evan@gmail.com>"
        ];
        dependencies = [
