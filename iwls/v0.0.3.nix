...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/iwls/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iwls" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "iwls"; path = "src/bin/iwls.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.3.nix {};
        authors = [
          "Alexander Lopatin <github.com/alopatindev>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "wifiscanner" = rec {
        crateName = "wifiscanner";
        version = "0.5.1";
        edition = "2015";
        sha256 = "0mpqmrhj1bikszwn8nicp8a6bxa18v9f76jhbcg4zixb6iyncknp";
        authors = [
