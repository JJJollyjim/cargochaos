...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dotenv-exec/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dotenv-exec" = rec {
        crateName = "dotenv-exec";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "dotenv-exec"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "lirsacc <c.lirsac@gmail.com>"
        ];
        dependencies = [
          {
            name = "dotenv";
