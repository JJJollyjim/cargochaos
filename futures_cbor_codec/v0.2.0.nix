...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/futures_cbor_codec/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures_ringbuf" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "1qgmgp2ywbdavyxwq56w56lw4lmgilsf59l6f3mwcgbsn390byh1";
        authors = [
          "Naja Melan <najamelan@autistici.org>"
        ];
        dependencies = [
      ...
      "wasm-bindgen-test" = rec {
        ...
        version = "0.3.6";
        edition = "2018";
        sha256 = "0x2pssx8w7zr5fm5kj46hm06bm9y9rgm484lmpxdv413wx80glc7";
        authors = [
          "The wasm-bindgen Developers"
        ];
        dependencies = [
      ...
      "wasm-bindgen-test-macro" = rec {
        ...
        version = "0.3.6";
        edition = "2018";
        sha256 = "00ba351627yp2amcp0zq50w4i07jac8ng503xjyjlxz05m3bp12v";
        procMacro = true;
        authors = [
          "The wasm-bindgen Developers"
        ];
