...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cemu-smm/v4.0.25.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cemu-smm" = rec {
        ...
        src = pkgs.callPackage ./tarball-v4.0.25.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "console_error_panic_hook" "default" "js-sys" "wasm" "wasm-bindgen" "web-sys" "wee_alloc" "with-serde" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Document" "Element" "Event" "EventTarget" "HtmlElement" "MessageEvent" "Node" "Window" "Worker" "console" ];
      };
      "wee_alloc" = rec {
        crateName = "wee_alloc";
        version = "0.4.5";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "memoryapi" "minwinbase" "minwindef" "ntdef" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" ];
      };
