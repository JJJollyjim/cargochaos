...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/two_timer/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "two_timer" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "using_matcher"; path = "src/bin/using_matcher.rs"; }
          { name = "using_grammar"; path = "src/bin/using_grammar.rs"; }
          { name = "serializer"; path = "src/bin/serializer.rs"; }
        ];
