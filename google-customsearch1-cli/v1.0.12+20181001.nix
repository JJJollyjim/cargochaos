...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-customsearch1-cli/v1.0.12+20181001.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-customsearch1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-customsearch1" = rec {
        crateName = "google-customsearch1";
        version = "1.0.12+20181001";
        edition = "2015";
        sha256 = "0s7kbbxj8v3ybyx639swi1lkswza4qnzgy4v1slmxc55qzz0c78y";
        authors = [
      ...
      "google-customsearch1-cli" = rec {
        crateName = "google-customsearch1-cli";
        version = "1.0.12+20181001";
        edition = "2015";
        crateBin = [
          { name = "customsearch1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20181001.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-customsearch1";
          }
          {
            name = "hyper";
            packageId = "hyper";
