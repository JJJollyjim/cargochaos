...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-customsearch1-cli/v1.0.13+20181001.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-customsearch1" = rec {
        ...
        edition = "2015";
        sha256 = "12yynah487qwmc6a5099kcjvn3ahzvwr69fbdjw2ybilayv09qn5";
        authors = [
      ...
      "google-customsearch1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20181001.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
