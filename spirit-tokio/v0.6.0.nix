...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spirit-tokio/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "corona" = rec {
        ...
        version = "0.4.2";
        edition = "2015";
        sha256 = "0fxkw3cjsw40fp000xad9s7zd6r6l6vm3x7gjp26090b8n5qgyd7";
        authors = [
          "Michal 'vorner' Vaner <vorner@vorner.cz>"
        ];
        dependencies = [
      ...
      "spirit-tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg-help" "default" "either" "structdoc" ];
      };
      "structdoc" = rec {
        crateName = "structdoc";
        version = "0.1.4";
