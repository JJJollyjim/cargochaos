...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/propertybindings/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpp" = rec {
        ...
        version = "0.5.4";
        edition = "2018";
        sha256 = "1gb139xvrxyz934506ris8k87kwf9mwa4n9xa3gw41fn1w9lvnfh";
        authors = [
      ...
      "cpp_build" = rec {
        ...
        version = "0.5.4";
        edition = "2018";
        sha256 = "1dmywkpvdmh8k01mvyh8c8129axzs3nh0vizmgpc5s5cp1qpd9np";
        authors = [
          "Nika Layzell <nika@thelayzells.com>"
          "Olivier Goffart <ogoffart@woboq.com>"
        ];
      ...
      "cpp_common" = rec {
        crateName = "cpp_common";
        version = "0.5.4";
        edition = "2018";
        sha256 = "08wrv1cgwf2mx05jfw66fr0lnvyjj4008n48j565zh7zavnpr0kb";
        authors = [
          "Nika Layzell <nika@thelayzells.com>"
          "Olivier Goffart <ogoffart@woboq.com>"
        ];
      ...
      "cpp_macros" = rec {
        crateName = "cpp_macros";
        version = "0.5.4";
        edition = "2018";
        sha256 = "038rcpnqnb8bgr8f74riblbnz8p63c98apmdw2qf1a2idil1dhd5";
        procMacro = true;
        authors = [
          "Nika Layzell <nika@thelayzells.com>"
          "Olivier Goffart <ogoffart@woboq.com>"
      ...
      "if_rust_version" = rec {
        crateName = "if_rust_version";
        version = "1.0.0";
        edition = "2015";
        sha256 = "1v6mj3vqy5g0x7gpyg5kiivm42qqgras69cxb0hrg4w67qrwpns6";
        authors = [
          "Olivier Goffart <ogoffart@woboq.com>"
        ];
      ...
      "pin-project" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0paca5p496i8f6c2zac4jgv3q29hlr4m75x1ipp4bxdw4x7wpb9w";
        authors = [
      ...
      "pin-project-internal" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1gs8kd6ark47g327433b4j99s19dml4a1gp5mbf188j68vvmaqj4";
        procMacro = true;
        authors = [
          "Taiki Endo <te316e89@gmail.com>"
        ];
      ...
      "qmetaobject" = rec {
        crateName = "qmetaobject";
        version = "0.1.3";
        edition = "2018";
        sha256 = "1103w3dah76h6f41kvawq38qqfdk25gn14rxxs077v71sqqfq9dl";
        authors = [
          "Olivier Goffart <ogoffart@woboq.com>"
        ];
        dependencies = [
      ...
      "qmetaobject_impl" = rec {
        crateName = "qmetaobject_impl";
        version = "0.1.3";
        edition = "2018";
        sha256 = "0646aqabv2m3vg05baw8k8rkqqbgh89h46br74k6lrkkcmyyhkbl";
        procMacro = true;
        authors = [
          "Olivier Goffart <ogoffart@woboq.com>"
        ];
