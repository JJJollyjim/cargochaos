...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async_zmq/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async_zmq" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "default" "rt-async" "rt-tokio" "tokio" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "1.0.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processthreadsapi" "std" "synchapi" "threadpoollegacyapiset" "winbase" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
