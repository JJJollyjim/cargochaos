...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssd1675/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "profont" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "08nc7pkjh2ngq7v4zhy3qbxsgm3dpa38d4xyyf3ny3m4m3drabb3";
        authors = [
      ...
      "ssd1675" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "embedded-graphics" "examples" "graphics" "linux-embedded-hal" "profont" ];
      };
      "sysfs_gpio" = rec {
