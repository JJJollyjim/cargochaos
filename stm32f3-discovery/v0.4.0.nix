...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f3-discovery/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "accelerometer" = rec {
        ...
        version = "0.11.0";
        edition = "2018";
        sha256 = "0sj8f18l2xkc9i6s3wwbkr3zv87pzzmxfqqpwk10zmcjfyv5inwz";
        authors = [
      ...
      "lsm303dlhc" = rec {
        crateName = "lsm303dlhc";
        version = "0.2.0";
        edition = "2015";
        sha256 = "01kpwlm58ijigkka0d4ii3lpslr8v3nl0jhd3cfk4l8955f1lpcy";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
      ...
      "stm32f3" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1s1g1x0gx1sgcyxw4d4cd4h6b58fv4xzs5gjvwyfakxwq5kd15l7";
        authors = [
      ...
      "stm32f3xx-hal" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0626ppp64v0cd84mia1zgnlm35ji9839506260q5idln3mib521x";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ...
        resolvedDefaultFeatures = [ "default" "device-selected" "rt" "stm32-usbd" "stm32f303" "stm32f303xc" "unproven" ];
      };
      "switch-hal" = rec {
        crateName = "switch-hal";
        version = "0.3.2";
        edition = "2018";
        sha256 = "1dxc89b3kahapkyjk86bnvl2ivfpk2bk6i3sp7hvf8vj2r007hcj";
        authors = [
          "Christopher J. McClellan <chris.mcclellan203@gmail.com>"
        ];
        dependencies = [
