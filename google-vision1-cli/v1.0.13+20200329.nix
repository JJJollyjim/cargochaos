...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-vision1-cli/v1.0.13+20200329.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-vision1" = rec {
        crateName = "google-vision1";
        version = "1.0.13+20200329";
        edition = "2015";
        sha256 = "07ixms9gnwp1vxfwdw1q2fjfhml6khkdsj1hwnbrzyrwvl26zxhs";
        authors = [
      ...
      "google-vision1-cli" = rec {
        crateName = "google-vision1-cli";
        version = "1.0.13+20200329";
        edition = "2015";
        crateBin = [
          { name = "vision1"; path = "src/main.rs"; }
        ];
