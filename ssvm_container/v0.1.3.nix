...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ssvm_container/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ssvm_container" = rec {
        crateName = "ssvm_container";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "ssvm_container"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "tpmccallum <mistermac2008@gmail.com>"
        ];
        dependencies = [
          {
            name = "dirs";
