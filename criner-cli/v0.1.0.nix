...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/criner-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "criner" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "jwalk" "migration" ];
      };
      "criner-cli" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "migration" ];
      };
      "crossbeam" = rec {
        crateName = "crossbeam";
        version = "0.7.3";
