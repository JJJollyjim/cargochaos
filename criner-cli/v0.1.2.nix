...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/criner-cli/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git2" = rec {
        ...
        version = "0.13.1";
        edition = "2018";
        sha256 = "0yp4m5ygvg752hm92lj0pljkk6ix9mbj7r0wy1dgr706y8s208pg";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "libgit2-sys" = rec {
        ...
        edition = "2018";
        sha256 = "0f0jhd0541sl5fz0wk64zp3xqk0is9k3l8v4w9qzyj8srj68fb51";
        libName = "libgit2_sys";
        libPath = "lib.rs";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
