...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/double/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "double" = rec {
        ...
        authors = [
          "Donald Whyte <donsoft@donsoft.io>"
        ];
        dependencies = [
          {
            name = "float-cmp";
      ...
      "float-cmp" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "1w1il86960zsnk6cwbs2c3s2ncnjjswk7pfa717z963dxx1pl488";
        libName = "float_cmp";
        authors = [
