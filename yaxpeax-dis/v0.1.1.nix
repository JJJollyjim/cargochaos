...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yaxpeax-dis/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "yaxpeax-arch" = rec {
        crateName = "yaxpeax-arch";
        version = "0.0.3";
        edition = "2018";
        sha256 = "18h8m1z306i9if79m050wd4nmkl68h3y43djimyl6xp83c1yalmb";
        authors = [
        ...
        resolvedDefaultFeatures = [ "address-parse" "colors" "default" "serde" "termion" "use-serde" ];
      };
      "yaxpeax-arm" = rec {
        crateName = "yaxpeax-arm";
        version = "0.0.2";
        edition = "2015";
        sha256 = "1p2krmn8gzdq9llic64jfwkhmjf58cbdxw6xxsi1wgvq40bn6yrx";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_derive" "use-serde" ];
      };
      "yaxpeax-dis" = rec {
        crateName = "yaxpeax-dis";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "yaxdis"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "yaxpeax-arm";
            packageId = "yaxpeax-arm";
          }
          {
            name = "yaxpeax-m16c";
            packageId = "yaxpeax-m16c";
          }
          {
            name = "yaxpeax-mips";
            packageId = "yaxpeax-mips";
          }
          {
            name = "yaxpeax-msp430";
            packageId = "yaxpeax-msp430";
          }
          {
            name = "yaxpeax-pic17";
            packageId = "yaxpeax-pic17";
          }
          {
            name = "yaxpeax-pic18";
            packageId = "yaxpeax-pic18";
          }
          {
            name = "yaxpeax-x86";
            packageId = "yaxpeax-x86";
          }
        ];
        
      };
      "yaxpeax-m16c" = rec {
        crateName = "yaxpeax-m16c";
        version = "0.0.2";
        edition = "2018";
        sha256 = "1hdhx4906w3571ll4si28i0z5gkw6w1jb19j0w433sj7m1j8j900";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "serde" "serde_derive" "std" "use-serde" ];
      };
      "yaxpeax-mips" = rec {
        crateName = "yaxpeax-mips";
        version = "0.0.2";
        edition = "2015";
        sha256 = "0gsj0f5dqdnw3ayn3139qcjp1sskg57il1r9knwhl4faz650yajj";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
      ...
      "yaxpeax-msp430" = rec {
        crateName = "yaxpeax-msp430";
        version = "0.0.3";
        edition = "2015";
        sha256 = "0na2lgpz6h9gb1x0j0za2n11kqk32bsjm87hkxwsjrdi2vaqa64c";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
      ...
      "yaxpeax-pic17" = rec {
        crateName = "yaxpeax-pic17";
        version = "0.0.2";
        edition = "2015";
        sha256 = "0pd7qm7i6cwg4vxmcmscnswdp9sfr5mkbdp0hkal1nlwhslw3xsj";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
      ...
      "yaxpeax-pic18" = rec {
        crateName = "yaxpeax-pic18";
        version = "0.0.2";
        edition = "2015";
        sha256 = "1dlqqssvgb2gwqsxfmmz450j8ysgrdkysfb4l2l99svlxm5mssd5";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
      ...
      "yaxpeax-x86" = rec {
        crateName = "yaxpeax-x86";
        version = "0.0.4";
        edition = "2015";
        sha256 = "1d26g5n4dkgpvizf7l9k5vxdaq62imc8nwib95khvw8fdilpx769";
        authors = [
          "iximeow <me@iximeow.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "colors" "default" "serde" "serde_derive" "std" "use-serde" ];
      };
    };
