...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/r2d2_odbc/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "odbc" = rec {
        ...
        version = "0.16.1";
        edition = "2015";
        sha256 = "1jmlhkkawk9xx53235bn3k8k3y4q4vkwf7hczch024vk4w735ghn";
        authors = [
      ...
      "odbc-safe" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0nkyirklksyh6a8hiv626kc9058vjyfi6r0fxykkhyyhw8mf0pgl";
        authors = [
          "Markus Klein <markus-klein@live.de>"
        ];
        dependencies = [
