...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-securitycenter1-cli/v1.0.13+20200406.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-securitycenter1-cli";
  ...
  workspaceMembers = {
    "google-securitycenter1-cli" = rec {
      packageId = "google-securitycenter1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-securitycenter1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-securitycenter1" = rec {
        crateName = "google-securitycenter1";
        version = "1.0.13+20200406";
        edition = "2015";
        sha256 = "11m5s4iifdksgvrz4drypfxmhlvw8fq5scg3xn41rhx9v651vb66";
        authors = [
      ...
      "google-securitycenter1-cli" = rec {
        crateName = "google-securitycenter1-cli";
        version = "1.0.13+20200406";
        edition = "2015";
        crateBin = [
          { name = "securitycenter1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-securitycenter1";
            packageId = "google-securitycenter1";
          }
          {
            name = "hyper";
            packageId = "hyper";
