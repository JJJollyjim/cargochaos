...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "1mw1hd5wrsbdqig7skj9qqzfwmfcj6l9v3lj386v80nb1x0nr10d";
        authors = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "0f9v8701gcaja0f83n95q382dir6m4kgdjs4pvlrq9071h9w5djd";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
