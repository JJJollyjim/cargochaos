...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        edition = "2018";
        sha256 = "03i42rn1wjlm12sr7in0zzq3b1pw9qcdgk16yx4zzl8l6nyjcn4k";
        authors = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1izdq3zgm2wyqfffmgfvskgdqvm571lrffy45xkswcr3qwqp7g4b";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
