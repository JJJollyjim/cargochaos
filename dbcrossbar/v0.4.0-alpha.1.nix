...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.4.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dbcrossbar" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "io-std" "io-util" "process" "stream" "sync" "time" ];
          }
          {
            name = "tokio-util";
            packageId = "tokio-util 0.2.0";
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.4.0-alpha.1";
        edition = "2018";
        sha256 = "0fn0k3hfshz9980qjd5xrfy4lx9ccv5xw8qmz5y4aaibm38x0ydy";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
      ...
      "enumset" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "0hd29inm395rx70zgh2hjwzjdi72i3kdhzfm03cnlc9ljmswx49n";
        authors = [
      ...
      "enumset_derive" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1b3mm2aq1vwlbnjhj3m015mj889ilfdszmv8yxf0r0kimhvg9gkl";
        procMacro = true;
        authors = [
          "Alissa Rao <lymia@lymiahugs.com>"
        ];
      ...
      "native-tls" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "security-framework 0.4.2";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "ios"));
          }
          {
            name = "security-framework-sys";
            packageId = "security-framework-sys 0.4.2";
            target = { target, features }: ((target."os" == "macos") || (target."os" == "ios"));
          }
          {
            name = "tempfile";
      ...
      "rustls-native-certs" = rec {
        ...
        dependencies = [
          ...
          {
            name = "security-framework";
            packageId = "security-framework 0.3.4";
      ...
      "security-framework 0.3.4" = rec {
        ...
        dependencies = [
          ...
          {
            name = "security-framework-sys";
            packageId = "security-framework-sys 0.3.3";
          }
        ];
        features = {
      ...
      "security-framework-sys 0.3.3" = rec {
      ...
      "security-framework-sys 0.4.2" = rec {
        crateName = "security-framework-sys";
        version = "0.4.2";
        edition = "2015";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
