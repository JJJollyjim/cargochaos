...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.3.0-beta.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        version = "0.5.0-rc.1";
        edition = "2018";
        sha256 = "1pssvp68ryqr4dvxjcndzkji1yjmxf3wmshxrj2f7d8ivs6qb92n";
        authors = [
      ...
      "dbcrossbar" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.0-beta.2.nix {};
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.3.0-beta.2";
        edition = "2018";
        sha256 = "1v6c4j36nvhgsw9sg3ivhsa59icavfainq1i4kpqf502kqzhn8qv";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
