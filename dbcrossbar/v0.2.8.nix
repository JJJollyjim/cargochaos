...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.2.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "15g45gjs0j6nfzhqlikwijqq652p6vgxg23flxwrks5k6c3v17hl";
        authors = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.2.8";
        edition = "2018";
        sha256 = "0jwva1lq62smlihw9dzcjqngi4h4xh98d2sidzb7rimlnsdm3xki";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
