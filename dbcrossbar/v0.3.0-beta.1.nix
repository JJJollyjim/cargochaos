...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.3.0-beta.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dbcrossbar" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.0-beta.1.nix {};
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.3.0-beta.1";
        edition = "2018";
        sha256 = "12xvf3w663c7x5v7a15py3h9avgrcap4a3xrk96l1zv0kimn44c4";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
