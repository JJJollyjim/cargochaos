...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        edition = "2018";
        sha256 = "09g8z57vkywpcx3p1mi5l39jzjy92ln73fryixlkc5y30699w262";
        authors = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "08havhjzal8s4v2ykng8g68345w8p293bzsa92w7dj1ia19am4vj";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
