...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcrossbar/v0.3.0-beta.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1lj7r88ar2c1z5jxr6yyq9vfiibxg742s8nlqjvvpkkfzncd90h4";
        authors = [
      ...
      "dbcrossbar" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.0-beta.3.nix {};
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
      ...
      "dbcrossbarlib" = rec {
        ...
        version = "0.3.0-beta.3";
        edition = "2018";
        sha256 = "1zjm7vlz7k85ywsjs0ddjb0y48489qq00ajmgxs214jbfp8gn700";
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
        dependencies = [
      ...
      "geojson" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "1fcw84w04ikssjykzi71fzpr233wdk3s1ssn2xzzqxijid107b74";
        authors = [
          "Corey Farwell <coreyf@rwell.org>"
