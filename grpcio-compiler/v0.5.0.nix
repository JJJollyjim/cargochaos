...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grpcio-compiler/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "grpcio-compiler" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "grpc_rust_plugin"; path = "src/bin/grpc_rust_plugin.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "derive-new" "prost" "prost-build" "prost-codec" "prost-types" "protobuf" "protobuf-codec" "tempfile" ];
      };
      "heck" = rec {
        crateName = "heck";
        version = "0.3.1";
