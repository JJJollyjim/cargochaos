...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alice-download/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alice-download" = rec {
        crateName = "alice-download";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "alice-download"; path = "src/main.rs"; }
        ];
      ...
      "alice-open-data" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1jy0hgxi365rcacm3jp5ppscw1d52dpz95j448y7sds41xa591xq";
        authors = [
          "cbourjau <c.bourjau@posteo.de>"
        ];
        dependencies = [
      ...
      "indicatif" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "04m20ix7brfzvlkm49mp90bjhkd9mbmh846cicha1xf3mvhlgily";
        authors = [
          "Armin Ronacher <armin.ronacher@active-4.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
