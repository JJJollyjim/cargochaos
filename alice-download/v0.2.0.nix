...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alice-download/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "Headers" "MessageEvent" "Request" "RequestInit" "RequestMode" "Response" "Window" "Worker" "console" ];
      };
      "weedle" = rec {
        crateName = "weedle";
        version = "0.10.0";
