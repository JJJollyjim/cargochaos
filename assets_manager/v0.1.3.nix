...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/assets_manager/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "assets_manager" = rec {
        ...
        resolvedDefaultFeatures = [ "bincode" "cbor" "hashbrown" "json" "msgpack" "parking_lot" "ron" "serde" "serde_bincode" "serde_cbor" "serde_json" "serde_msgpack" "serde_ron" "serde_toml" "serde_yaml" "toml" "yaml" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "1.0.0";
