...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/circadian_time/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "circadia" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "1b74pv7fb0a5vg0dcc9xxi8bxr2x9kjmk8zma2f2zh7zkchzwzqp";
        authors = [
