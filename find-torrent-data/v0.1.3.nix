...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/find-torrent-data/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "find-torrent-data" = rec {
        crateName = "find-torrent-data";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "find-torrent-data"; path = "src/main.rs"; }
        ];
      ...
      "lava_torrent" = rec {
        crateName = "lava_torrent";
        version = "0.5.0";
        edition = "2015";
        sha256 = "1s3fsf6pv8s5kr553i39wxpx0la5hsw1gnjl48ijswi39w7hk879";
        authors = [
          "ttlajus <40629580+ttlajus@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "conv";
