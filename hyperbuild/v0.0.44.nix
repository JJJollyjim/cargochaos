...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hyperbuild/v0.0.44.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fastrie" = rec {
        ...
        version = "0.0.6";
        edition = "2018";
        sha256 = "05jdi1hwjqf0ajl8k2dxi7jlzi3i8qzwvb2yw46i10kn11ryia0n";
        authors = [
      ...
      "hyperbuild" = rec {
        crateName = "hyperbuild";
        version = "0.0.44";
        edition = "2018";
        crateBin = [
          { name = "hyperbuild"; path = "src/main.rs"; }
        ];
