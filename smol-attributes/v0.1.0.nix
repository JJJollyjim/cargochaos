...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/smol-attributes/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "smol" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "1pxhp8hvs4hrdl6d6hkmwx9wc21fml09yicay7s3rcmzhdc6n3ax";
        authors = [
      ...
      "smol-attributes" = rec {
        crateName = "smol-attributes";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        procMacro = true;
        authors = [
          "YuWeiWu <wusyong9104@gmail.com>"
        ];
        dependencies = [
          {
            name = "quote";
