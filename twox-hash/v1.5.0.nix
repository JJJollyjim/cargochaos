...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/twox-hash/v1.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "twox-hash" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "hash_file"; path = "src/bin/hash_file.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "digest" "rand" "serde" "serialize" "std" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.10.0";
