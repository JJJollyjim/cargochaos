...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/furs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "furs" = rec {
        ...
        authors = [
          "Devin Alvaro <devin.alvaro@gmail.com>"
        ];
        dependencies = [
          {
            name = "rpds";
      ...
      "rpds" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "085lvg8qd9ssckryxflpyx4bs27dqlywz6fjfgdpwfcq2abmzr8f";
        authors = [
