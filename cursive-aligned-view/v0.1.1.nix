...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cursive-aligned-view/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "cursive-aligned-view";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive-aligned-view" = rec {
        crateName = "cursive-aligned-view";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "end2end_top_right"; path = "src/bin/end2end_top_right.rs"; }
          { name = "end2end_top_left"; path = "src/bin/end2end_top_left.rs"; }
          { name = "end2end_top_center"; path = "src/bin/end2end_top_center.rs"; }
          { name = "end2end_center_right"; path = "src/bin/end2end_center_right.rs"; }
          { name = "end2end_center_left"; path = "src/bin/end2end_center_left.rs"; }
          { name = "end2end_center"; path = "src/bin/end2end_center.rs"; }
          { name = "end2end_bottom_right"; path = "src/bin/end2end_bottom_right.rs"; }
          { name = "end2end_bottom_left"; path = "src/bin/end2end_bottom_left.rs"; }
          { name = "end2end_bottom_center"; path = "src/bin/end2end_bottom_center.rs"; }
          { name = "end2end_align_top_right"; path = "src/bin/end2end_align_top_right.rs"; }
          { name = "end2end_align_top_left"; path = "src/bin/end2end_align_top_left.rs"; }
          { name = "end2end_align_top_center"; path = "src/bin/end2end_align_top_center.rs"; }
          { name = "end2end_align_center_right"; path = "src/bin/end2end_align_center_right.rs"; }
          { name = "end2end_align_center_left"; path = "src/bin/end2end_align_center_left.rs"; }
          { name = "end2end_align_center"; path = "src/bin/end2end_align_center.rs"; }
          { name = "end2end_align_bottom_right"; path = "src/bin/end2end_align_bottom_right.rs"; }
          { name = "end2end_align_bottom_left"; path = "src/bin/end2end_align_bottom_left.rs"; }
          { name = "end2end_align_bottom_center"; path = "src/bin/end2end_align_bottom_center.rs"; }
        ];
