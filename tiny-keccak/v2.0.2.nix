...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tiny-keccak/v2.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tiny-keccak" = rec {
        ...
        resolvedDefaultFeatures = [ "cshake" "default" "fips202" "k12" "keccak" "kmac" "parallel_hash" "sha3" "shake" "sp800" "tuple_hash" ];
      };
    };
