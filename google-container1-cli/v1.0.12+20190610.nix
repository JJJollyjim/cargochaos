...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-container1-cli/v1.0.12+20190610.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-container1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-container1" = rec {
        crateName = "google-container1";
        version = "1.0.12+20190610";
        edition = "2015";
        sha256 = "11plqxqa6lmci7zafsgzi17qprl78ay2f96dmq1nn8vcqyp099hv";
        authors = [
      ...
      "google-container1-cli" = rec {
        crateName = "google-container1-cli";
        version = "1.0.12+20190610";
        edition = "2015";
        crateBin = [
          { name = "container1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190610.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
