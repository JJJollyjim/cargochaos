...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-container1-cli/v1.0.13+20200324.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-container1" = rec {
        ...
        version = "1.0.13+20200324";
        edition = "2015";
        sha256 = "1y3nrcqzrr8ckyjj4g7hmlw9afml91ilczs75z87q8nii1v3safr";
        authors = [
      ...
      "google-container1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200324.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
