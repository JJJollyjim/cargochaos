...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/juniper-from-schema/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "assert-json-diff" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "1akgsv94r1fmai68v7xqd53z9v49cjk54cg5a68bcd5i76517fy4";
        authors = [
      ...
      "rustversion" = rec {
        ...
        version = "0.1.4";
        edition = "2018";
        sha256 = "1s3ib2paa5gq17x4qsmjmnsw68z7b5d5av1wsiqcrihmqb7kk0dl";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "trybuild" = rec {
        ...
        version = "1.0.21";
        edition = "2018";
        sha256 = "0pxccf89lx8rsk8gzzxnyqjpsfqlbndki3n738rja5vh1iskynrz";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
