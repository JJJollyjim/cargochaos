...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flume/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flume" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "default" "select" ];
      };
      "fuchsia-cprng" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
