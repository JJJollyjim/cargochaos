...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flume/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "mmsystem" "ntsecapi" "processenv" "std" "timeapi" "winbase" "wincon" "winerror" "winnt" ];
      };
