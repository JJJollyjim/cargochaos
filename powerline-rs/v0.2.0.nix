...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/powerline-rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "powerline-rs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "powerline-rs"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "flame" "git2" "users" ];
      };
      "proc-macro2" = rec {
