...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mklink/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "junction" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0gdr65kyyx59pnk6i6grbjl35ib883gc3pfy2v1dgb7n31dwdr3j";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi";
            target = { target, features }: target."windows";
            features = [ "errhandlingapi" "fileapi" "guiddef" "handleapi" "ioapiset" "winbase" "winioctl" "winnt" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "ioapiset" "minwinbase" "minwindef" "processenv" "winbase" "winioctl" "winnt" ];
      };
