...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gameoflife_cli/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gameoflife_cli" = rec {
        crateName = "gameoflife_cli";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "gameoflife_cli"; path = "src/main.rs"; }
        ];
