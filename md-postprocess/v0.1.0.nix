...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/md-postprocess/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "md-postprocess" = rec {
        crateName = "md-postprocess";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "md-postprocess"; path = "src/main.rs"; }
        ];
