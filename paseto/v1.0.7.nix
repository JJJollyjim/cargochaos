...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/paseto/v1.0.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "paseto" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "easy_tokens" "openssl" "serde_json" "sodiumoxide" "v1" "v2" ];
      };
      "pkg-config" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "fileapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wtypesbase" ];
      };
