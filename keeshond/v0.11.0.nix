...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/keeshond/v0.11.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "generic-array 0.14.1" = rec {
        crateName = "generic-array";
        version = "0.14.1";
        edition = "2015";
        sha256 = "1srd08b3z28n4knm4vyql5wi6ry3d96b058hycv90108rz1689kd";
      ...
      "keeshond" = rec {
        ...
        dependencies = [
          ...
          {
            name = "generic-array";
            packageId = "generic-array 0.14.1";
          }
          {
            name = "getopts";
            packageId = "getopts";
      ...
      "keeshond_datapack" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1dnhkkyc9wjbmwrzxzql6ypii6ziy83fkj76xmjcci3y9w8wg6lm";
        authors = [
          "Danni H <dannihfoss@fastmail.fm>"
        ];
        dependencies = [
