...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/irmaseal-cli/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arrayvec 0.4.12" = rec {
        ...
        resolvedDefaultFeatures = [ "array-sizes-129-255" "default" "serde" "serde-1" "std" ];
      };
      "arrayvec 0.5.1" = rec {
        crateName = "arrayvec";
        version = "0.5.1";
        ...
        resolvedDefaultFeatures = [ "array-sizes-129-255" "default" "std" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.14";
      ...
      "cfb-mode" = rec {
        ...
        version = "0.3.2";
        edition = "2015";
        sha256 = "0i8kk6gp21hpdp8l32i5yf1wgjs1l4si1xpckf3zhz52sdapn3hr";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "ibe" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "1vd8hsn0l2dc3lshay09932dsd6304n4z5z3bfjbxdnmqdbfcbw5";
        authors = [
      ...
      "irmaseal-cli" = rec {
        crateName = "irmaseal-cli";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "irmaseal-cli"; path = "src/main.rs"; }
        ];
      ...
      "irmaseal-core" = rec {
        crateName = "irmaseal-core";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0zcp7sh7xh0i5bmsz30dvavax5vg4161gqffrvyhjmd6rrzhdgcf";
        authors = [
          "Wouter Geraedts <git@woutergeraedts.nl>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            features = [ "array-sizes-129-255" "serde-1" ];
          }
          {
            name = "base64";
        ...
        resolvedDefaultFeatures = [ "aes" "cfb-mode" "default" "digest" "hmac" "rand" "sha3" "stream" ];
      };
      "irmaseal-curve" = rec {
        crateName = "irmaseal-curve";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1dk7qib19n8cian3bs1bnwnai7d98ahcz1sk4zymyypi55hm3ia2";
        authors = [
          "Wouter Geraedts <git@woutergeraedts.nl>"
