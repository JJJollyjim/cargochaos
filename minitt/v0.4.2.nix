...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/minitt/v0.4.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minitt" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "minittc"; path = "src/cli/mod.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "minitt-util" "parser" "pest" "pest_derive" "rustyline" "structopt" ];
      };
      "minitt-util" = rec {
