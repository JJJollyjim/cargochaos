...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lindera-ipadic-neologd-builder/v0.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lindera-ipadic-neologd-builder";
  ...
  workspaceMembers = {
    "lindera-ipadic-neologd-builder" = rec {
      packageId = "lindera-ipadic-neologd-builder";
      build = internal.buildRustCrateWithFeatures {
        packageId = "lindera-ipadic-neologd-builder";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lindera-ipadic-neologd-builder" = rec {
        crateName = "lindera-ipadic-neologd-builder";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "lindera-ipadic-neologd"; path = "src/main.rs"; }
        ];
