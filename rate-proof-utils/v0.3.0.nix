...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rate-proof-utils/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rate-proof-utils" = rec {
        crateName = "rate-proof-utils";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "apply-proof"; path = "apply-proof.rs"; }
          { name = "drat2bdrat"; path = "drat2bdrat.rs"; }
          { name = "bdrat2drat"; path = "bdrat2drat.rs"; }
        ];
