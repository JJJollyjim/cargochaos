...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/requiem-web/v2.0.0-r2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "requiem" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "107nlr6a65zgpvf13npl55rxw205jh0mlw5anpy353zgcvb499ls";
        libName = "actix";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "requiem-codec" = rec {
        crateName = "requiem-codec";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0kklhzwsvqv4l7h94wkwbfccj32nkwk2i9i6k3p4q14b6frjhrs3";
        libName = "requiem_codec";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-connect" = rec {
        crateName = "requiem-connect";
        version = "1.0.2";
        edition = "2018";
        sha256 = "02iz1s4h04qqr3fnvp13zqrbclsblcbwwj93zq2wbnkb87wa0zw9";
        libName = "requiem_connect";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "requiem-codec";
            packageId = "requiem-codec";
          }
          {
            name = "requiem-rt";
            packageId = "requiem-rt";
          }
          {
            name = "requiem-service";
            packageId = "requiem-service";
          }
          {
            name = "requiem-utils";
            packageId = "requiem-utils";
          }
          {
            name = "rustls";
            packageId = "rustls";
      ...
      "requiem-http" = rec {
        crateName = "requiem-http";
        version = "1.0.1";
        edition = "2018";
        sha256 = "00zm45vsxfq96687v325i1m8g4714vxc2jb57f9nxkl0j8bj9rzn";
        libName = "requiem_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "requiem-connect";
            packageId = "requiem-connect";
          }
          {
            name = "requiem-rt";
            packageId = "requiem-rt";
          ...
          }
          {
            ...
            packageId = "requiem-threadpool";
          }
          {
            name = "requiem-tls";
            packageId = "requiem-tls";
            optional = true;
          }
          {
            name = "requiem-utils";
        ...
        features = {
          "compress" = [ "flate2" "brotli2" ];
          "failure" = [ "fail-ure" ];
          "openssl" = [ "requiem-tls/openssl" "requiem-connect/openssl" ];
          "rustls" = [ "requiem-tls/rustls" "requiem-connect/rustls" ];
          "secure-cookies" = [ "ring" ];
        };
        resolvedDefaultFeatures = [ "brotli2" "compress" "default" "fail-ure" "failure" "flate2" "openssl" "requiem-tls" "ring" "rustls" "secure-cookies" ];
      };
      "requiem-macros" = rec {
        crateName = "requiem-macros";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0whyrp699qwck4rj9fica6vkpma0xxglavx4ch1bpvj9waww7xjl";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "requiem-router" = rec {
        crateName = "requiem-router";
        version = "0.2.4";
        edition = "2018";
        sha256 = "1bajg1rpvb4slwh13jal6w6gcc5j4379q72jp6wzpw6wr6a58aq6";
        libName = "requiem_router";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-rt" = rec {
        crateName = "requiem-rt";
        version = "1.0.0";
        edition = "2018";
        sha256 = "00sqi82xp4xxvs6v515jgldviqyhkgy05ygsrni8dnp0k2iyx8jh";
        libName = "requiem_rt";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "requiem-server" = rec {
        crateName = "requiem-server";
        version = "1.0.1";
        edition = "2018";
        sha256 = "07jidwnwgj790j3qy6ka3g1rcaaly3m0zab3n0dn8dqhdqc83hx1";
        libName = "requiem_server";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-service" = rec {
        crateName = "requiem-service";
        version = "1.0.5";
        edition = "2018";
        sha256 = "1pb30niwsmyayhazrkdpyfd875js3hsdlkm756p60hbphp66ccdd";
        libName = "requiem_service";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-testing" = rec {
        crateName = "requiem-testing";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1awvl20if79dmflmk9xms53yn42qac1gs6376hgnpk27xvm9h0y8";
        libName = "requiem_testing";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-threadpool" = rec {
        crateName = "requiem-threadpool";
        version = "0.3.1";
        edition = "2018";
        sha256 = "04g7yv5rpprgprc53rdqk6p5r9g8ismakfj6jrbq3bi9m9smzb4j";
        libName = "requiem_threadpool";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-tls" = rec {
        crateName = "requiem-tls";
        version = "1.0.0";
        edition = "2018";
        sha256 = "1c5r4f7zny6lx3p0787kkni4ij5l49rpyksrzkqwxwc33g8mbprj";
        libName = "requiem_tls";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "requiem-utils" = rec {
        crateName = "requiem-utils";
        version = "1.0.6";
        edition = "2018";
        sha256 = "1rfl18ilbslgz1356lrrd4bmxz5ib5hdms6s29a0cmdzvwzs5b34";
        libName = "requiem_utils";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "requiem-wc" = rec {
        crateName = "requiem-wc";
        version = "1.0.1";
        edition = "2018";
        sha256 = "0z9bx76iv73nppffd15lrc18r60l61j5y2xkvifslf8b7dakw0cn";
        libName = "requiem_wc";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        ...
        features = {
          "compress" = [ "requiem-http/compress" ];
          "default" = [ "compress" ];
          "openssl" = [ "open-ssl" "requiem-http/openssl" ];
          "rustls" = [ "rust-tls" "requiem-http/rustls" ];
        };
        resolvedDefaultFeatures = [ "compress" "open-ssl" "openssl" "rust-tls" "rustls" ];
      };
      "requiem-web" = rec {
        crateName = "requiem-web";
        version = "2.0.0-r2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.0.0-r2.nix {};
        libName = "requiem_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "requiem-wc";
            packageId = "requiem-wc";
            usesDefaultFeatures = false;
          }
          {
            name = "requiem-web-codegen";
            packageId = "requiem-web-codegen";
          }
          {
            name = "rustls";
            packageId = "rustls";
        ...
        features = {
          "compress" = [ "requiem-http/compress" "requiem-wc/compress" ];
          "default" = [ "compress" "failure" ];
          "failure" = [ "requiem-http/failure" ];
          "openssl" = [ "requiem-tls/openssl" "requiem-wc/openssl" "open-ssl" ];
          "rustls" = [ "requiem-tls/rustls" "requiem-wc/rustls" "rust-tls" ];
          "secure-cookies" = [ "requiem-http/secure-cookies" ];
        };
        resolvedDefaultFeatures = [ "compress" "default" "failure" "open-ssl" "openssl" "rust-tls" "rustls" "secure-cookies" ];
      };
      "requiem-web-codegen" = rec {
        crateName = "requiem-web-codegen";
        version = "0.2.0";
        edition = "2018";
        sha256 = "149z7q0cvvvh55nr9hphask58ir297ws5jzs6rsycd1sabw348a9";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
