...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-csv2beancount/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-csv2beancount" = rec {
        crateName = "rust-csv2beancount";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "rust-csv2beancount"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Alex Kursell <alexkursell@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
