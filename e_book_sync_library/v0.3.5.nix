...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/e_book_sync_library/v0.3.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "e_book_sync_library" = rec {
        crateName = "e_book_sync_library";
        version = "0.3.5";
        edition = "2018";
        crateBin = [
          { name = "e_book_sync_library"; path = "src/main.rs"; }
        ];
