...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cynic/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cynic" = rec {
        ...
        authors = [
          "Graeme Coupar <graeme@polyandglot.dev>"
        ];
        dependencies = [
          {
            name = "cynic-codegen";
      ...
      "cynic-codegen" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1cdgcb9g6nf471djg38li47qxfxq4a8kr489pjspn2mp6m157l1v";
        procMacro = true;
        authors = [
          "Graeme Coupar <graeme@polyandglot.dev>"
        ];
      ...
      "json-decode" = rec {
        crateName = "json-decode";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1qs4kx5wwbkl0kcaz8ygkrqyp103wzqkh85jmyjr2rqqc65swqab";
        authors = [
          "Graeme Coupar <graeme@polyandglot.dev>"
        ];
        dependencies = [
