...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/splitterrust_server/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "splitterrust_server" = rec {
        crateName = "splitterrust_server";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "splitterrust_server"; path = "src/main.rs"; }
        ];
