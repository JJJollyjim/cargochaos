...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-reseller1_sandbox-cli/v1.0.13+20160329.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-reseller1_sandbox-cli";
  ...
  workspaceMembers = {
    "google-reseller1_sandbox-cli" = rec {
      packageId = "google-reseller1_sandbox-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-reseller1_sandbox-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-reseller1_sandbox" = rec {
        crateName = "google-reseller1_sandbox";
        version = "1.0.13+20160329";
        edition = "2015";
        sha256 = "0kq9xxk0z8x9317078gpnh7vif544vmyw4675fw3f2hdd5kipzda";
        authors = [
      ...
      "google-reseller1_sandbox-cli" = rec {
        crateName = "google-reseller1_sandbox-cli";
        version = "1.0.13+20160329";
        edition = "2015";
        crateBin = [
          { name = "reseller1-sandbox"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20160329.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-reseller1_sandbox";
          }
          {
            name = "hyper";
            packageId = "hyper";
