...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/strchunk/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "range-split" = rec {
        crateName = "range-split";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0k8xfgc7bk0kgbkz4pv44vnsjb652kppdm66n7g7hji078sl8bfy";
        authors = [
      ...
      "strchunk" = rec {
        ...
        resolvedDefaultFeatures = [ "specialization" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.11";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-std" "io-util" "memchr" "rt-core" ];
      };
      "unicode-xid" = rec {
