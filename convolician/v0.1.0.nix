...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/convolician/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "convolician" = rec {
        crateName = "convolician";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "convolician"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Matt Gibb <matt@mattgibb.com>"
        ];
        dependencies = [
          {
            name = "clap";
