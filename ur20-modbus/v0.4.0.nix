...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ur20-modbus/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio-modbus" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1307rvydhy2wrks526bq6fkjh2ga68rkywvy6wksq6p83f1mxbnh";
        authors = [
          "slowtec GmbH"
      ...
      "ur20" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "1dg5l43m639kyx3wp0d6qb6k9xsx9372ra2b48p2cq5rbki3glr0";
        authors = [
          "slowtec GmbH"
          "Markus Kohlhase <markus.kohlhase@slowtec.de>"
        ];
