...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lustre_collector/v0.2.12.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lustre_collector" = rec {
        crateName = "lustre_collector";
        version = "0.2.12";
        edition = "2018";
        crateBin = [
          { name = "lustre_collector"; path = "src/main.rs"; }
        ];
