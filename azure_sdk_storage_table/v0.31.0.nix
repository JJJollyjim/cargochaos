...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_storage_table/v0.31.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "azure_sdk_storage_table";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_storage_core" = rec {
        ...
        version = "0.30.1";
        edition = "2018";
        sha256 = "0y339n84cq5hjxxw5hcla57x8s9jk3glmwwjfjwvbywc6jg6b33c";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
      ...
      "azure_sdk_storage_table" = rec {
        crateName = "azure_sdk_storage_table";
        version = "0.31.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.31.0.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
          "Max Gortman <mgortman@microsoft.com>"
          "Dong Liu <doliu@microsoft.com>"
