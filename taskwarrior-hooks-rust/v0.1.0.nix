...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/taskwarrior-hooks-rust/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "taskwarrior-hooks-rust";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "taskwarrior-hooks-rust" = rec {
        crateName = "taskwarrior-hooks-rust";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
