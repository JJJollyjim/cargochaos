...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbflow/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "winbase" "winnt" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
