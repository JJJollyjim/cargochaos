...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wgpu/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gfx-memory" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1052frn5wzicz0xqh0pdjdjs72zblpyjx37wri0jq0v56cwgxglx";
        authors = [
          "omni-viral <scareaangel@gmail.com>"
          "The Gfx-rs Developers"
        ];
      ...
      "wgpu-core" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "gfx-backend-vulkan" ];
      };
      "wgpu-native" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "vulkan-portability" ];
      };
      "wgpu-types" = rec {
