...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/emojifinder-builder/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "emojifinder-builder" = rec {
        crateName = "emojifinder-builder";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "emojifinder-builder"; path = "src/main.rs"; }
        ];
