...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/msp430fr2x5x-hal/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "msp430" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0cx4gjbkpf0w6n7f7c7y3qlks83xvcw328fqm4kwygncdp292pas";
        authors = [
      ...
      "msp430-atomic" = rec {
        crateName = "msp430-atomic";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1ihpkrh5jmr5mvi275z49wmv8ww6rpskaipssngqr9vl0y15cknj";
        authors = [
          "Vadzim Dambrouski <pftbest@gmail.com>"
        ];
      ...
      "msp430-rt" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "086cnfk568v7fdhk3393f3l4jj2bliw23iajgsiigqphdnalbvrf";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
          "Vadzim Dambrouski <pftbest@gmail.com>"
      ...
      "msp430-rt-macros" = rec {
        crateName = "msp430-rt-macros";
        version = "0.2.4";
        edition = "2018";
        sha256 = "0avbkl3svhsqi4zgqrz0a5z4mf8kvca52832vb5k4b688y8m3gyg";
        procMacro = true;
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
      ...
      "msp430fr2355" = rec {
        crateName = "msp430fr2355";
        version = "0.4.1";
        edition = "2015";
        sha256 = "1lpm3gvgh1cgknbckyzirdv9rr820m7akbxbvl8fxwb961lq603y";
        authors = [
          "YuhanLiin <linyuhan0315@hotmail.com>"
        ];
        dependencies = [
          {
            name = "bare-metal";
        ...
        resolvedDefaultFeatures = [ "msp430-rt" "rt" ];
      };
      "msp430fr2x5x-hal" = rec {
        crateName = "msp430fr2x5x-hal";
        version = "0.2.2";
        edition = "2018";
        ...
        devDependencies = [
          ...
          {
            name = "panic-msp430";
            packageId = "panic-msp430";
          }
          {
            name = "panic-never";
            packageId = "panic-never";
          }
        ];
      ...
      "panic-msp430" = rec {
        crateName = "panic-msp430";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0klq06i8ar8imirgddrw5yqvph45vfvbgxh97igchmb9sdlmcg2d";
        authors = [
          "YuhanLiin <linyuhan0315@hotmail.com>"
        ];
        dependencies = [
      ...
      "panic-never" = rec {
        crateName = "panic-never";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0w6kz0nv51ngpggnmdnmsbqxf4m5gljngzl3zrl78gjlyv8pbp5h";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
      ...
      "r0" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "04gjrcvl56x45jiz5awggxkz8wlfj1hp3bcjbp4wn7ars7p32ymx";
        authors = [
