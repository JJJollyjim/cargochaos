...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-drive3-cli/v1.0.13+20200326.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-drive3" = rec {
        ...
        edition = "2015";
        sha256 = "0b9wbk3hdjw27v8yia14alq89m1lr6mjd95934xl5jigvjj8k7nf";
        authors = [
      ...
      "google-drive3-cli" = rec {
        crateName = "google-drive3-cli";
        version = "1.0.13+20200326";
        edition = "2015";
        crateBin = [
          { name = "drive3"; path = "src/main.rs"; }
        ];
