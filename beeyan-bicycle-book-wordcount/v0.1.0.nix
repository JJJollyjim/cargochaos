...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/beeyan-bicycle-book-wordcount/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "beeyan-bicycle-book-wordcount";
  ...
  workspaceMembers = {
    "beeyan-bicycle-book-wordcount" = rec {
      packageId = "beeyan-bicycle-book-wordcount";
      build = internal.buildRustCrateWithFeatures {
        packageId = "beeyan-bicycle-book-wordcount";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "beeyan-bicycle-book-wordcount" = rec {
        crateName = "beeyan-bicycle-book-wordcount";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "beeyan-bicycle-book-wordcount"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "beeyan <beeyan0821@gmail.com>"
        ];
        dependencies = [
          {
            name = "regex";
