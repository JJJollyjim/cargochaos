...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zee/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossterm" = rec {
        ...
        version = "0.17.1";
        edition = "2018";
        sha256 = "1vsf6lxazw9y0flvlzxbq591xbnbwfxb123wi6vpym9xb41zra1a";
        authors = [
          "T. Post"
        ];
        dependencies = [
      ...
      "zee-grammar" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "02k99gx4bgq0mxqyd23b6h4p65rhr5v858qk7ffxsqqzddp603mg";
        authors = [
          "Marius Cobzarenco <marius@reinfer.io>"
        ];
        dependencies = [
