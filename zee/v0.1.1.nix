...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zee/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flexi_logger" = rec {
        ...
        version = "0.15.1";
        edition = "2018";
        sha256 = "19q1jkq9n880lnnwpx36skflg7acds5lskbpy26j3wrj7dbg7axh";
        authors = [
      ...
      "pkg-version" = rec {
        crateName = "pkg-version";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0xx3pkd538g409m3wpgf3jpi6wh7g917wxb5bqs1082bxrhqz10f";
        authors = [
      ...
      "pkg-version-impl" = rec {
        crateName = "pkg-version-impl";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0fqs6qsgx8848cp0mvwwlzf01h2l0i88rf10qkmabx3b8xfvyr0m";
        procMacro = true;
        authors = [
          "Jonas Schievink <jonasschievink@gmail.com>"
        ];
      ...
      "smart-ptr" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "00dlqrbp39l6g7vii7ahjd8y1pasyzr6yg7w21929dfq8qjhhkx9";
        authors = [
      ...
      "ttmap" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0cbqh88f4j38l62z1f3l0ikzd2bkfz83fkln8965q3fc02132kdc";
        authors = [
          "Douman <douman@gmx.se>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "zee" = rec {
        ...
        dependencies = [
          ...
          {
            name = "zee-grammar";
            packageId = "zee-grammar";
          }
          {
            name = "zee-highlight";
            packageId = "zee-highlight";
          }
        ];
        features = {
          "default" = [ "frontend-crossterm" "frontend-termion" ];
          "frontend-crossterm" = [ "crossterm" ];
          "frontend-termion" = [ "termion" ];
        };
        resolvedDefaultFeatures = [ "crossterm" "default" "frontend-crossterm" "frontend-termion" "termion" ];
      };
      "zee-grammar" = rec {
        crateName = "zee-grammar";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0j0g19vdlzq6wykd1y85g8qg8j8d8w6d68mglrslg4a1mwzikibm";
        authors = [
          "Marius Cobzarenco <marius@reinfer.io>"
        ];
        dependencies = [
      ...
      "zee-highlight" = rec {
        crateName = "zee-highlight";
        version = "0.1.1";
        edition = "2018";
        sha256 = "17cdyil3wkl8mma746vvmxgw4jz4qa44jdjkqdr5akpck0srximv";
        authors = [
          "Marius Cobzarenco <marius@reinfer.io>"
        ];
        dependencies = [
