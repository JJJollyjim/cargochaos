...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/s3-utils/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "s3-utils" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "s3-utils"; path = "src/main.rs"; }
        ];
      ...
      "standback" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0cf6d310vy18k9iwnpbqw5xf7vfc7k0lqpgh4a5x624wvfwi4aw6";
        authors = [
      ...
      "time 0.2.8" = rec {
        ...
        version = "0.2.8";
        edition = "2018";
        sha256 = "1wrv92nyix10vajk4dq8khq8ggm9l5y4nfbimmf2davwdxm9w5rx";
        authors = [
          "Jacob Pratt <the.z.cuber@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
