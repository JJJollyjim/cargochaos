...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/abci-rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "abci-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "async" "bytes" "default" "tokio" "uds" ];
      };
      "aho-corasick" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "codec" "io" "macros" "net" "num_cpus" "rt-full" "sync" "tcp" "timer" "tokio-codec" "tokio-executor" "tokio-io" "tokio-macros" "tokio-net" "tokio-sync" "tokio-timer" "tracing-core" "udp" "uds" ];
      };
      "tokio-codec" = rec {
