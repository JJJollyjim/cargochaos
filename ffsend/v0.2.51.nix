...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffsend/v0.2.51.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffsend" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.51.nix {};
        authors = [
      ...
      "ffsend-api" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "07xrvk4alp54bxamlwvh4ndzxyibpxx97z2j4dw2iqxaq1wqikn1";
        libName = "ffsend_api";
        authors = [
          "Tim Visee <timvisee@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "version-compare";
            packageId = "version-compare 0.0.6";
          }
          {
            name = "websocket";
            packageId = "websocket";
      ...
      "version-compare 0.0.6" = rec {
        crateName = "version-compare";
        version = "0.0.6";
        edition = "2015";
        sha256 = "0drdjjxam0rzfd9i10swaa73zh745wc6fn7s2dyx7r7iigfql1kq";
        authors = [
      ...
      "websocket" = rec {
        ...
        version = "0.22.4";
        edition = "2015";
        sha256 = "1gqc1vhynynbfi535yhxvxiw7c0252cinjim5dqcjijp9jkd5p0a";
        authors = [
