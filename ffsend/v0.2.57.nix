...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffsend/v0.2.57.nix.tmp"
    ...
    crates = {
      ...
      "derive_builder 0.9.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "derive_builder_core";
            packageId = "derive_builder_core 0.9.0";
          }
          {
            name = "proc-macro2";
            packageId = "proc-macro2 1.0.6";
      ...
      "ffsend" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.57.nix {};
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "derive_builder";
            packageId = "derive_builder 0.9.0";
          }
          {
            name = "directories";
