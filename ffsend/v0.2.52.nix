...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffsend/v0.2.52.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffsend" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.52.nix {};
        authors = [
      ...
      "ffsend-api" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "03gwpl55wi4v3vzwlanbja22lbxgbps6vn3p2nz085nwxlkd9vl7";
        libName = "ffsend_api";
        authors = [
          "Tim Visee <timvisee@gmail.com>"
        ];
