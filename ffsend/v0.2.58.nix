...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffsend/v0.2.58.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffsend" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.58.nix {};
        authors = [
      ...
      "ffsend-api" = rec {
        ...
        version = "0.4.4";
        edition = "2018";
        sha256 = "14f5b5piyhiarn90i5287bbpgl29n1vlpza6795vnk2vavbphlz3";
        libName = "ffsend_api";
        authors = [
      ...
      "qr2term" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "1vi69w5irjx9ra4bfhmylixp4apv2fvxq4zrr5p11gl9r9h29zn1";
        authors = [
      ...
      "qrcode" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0vb4ypv6ac659yhiamzgsagmxscji2b9759pa8384bpxakfr348b";
        authors = [
      ...
      "urlshortener" = rec {
        ...
        version = "2.1.0";
        edition = "2015";
        sha256 = "1dckkd84p74h08kdbq7724yzl6bf928pzfipw29iss8spmplaqbn";
        authors = [
