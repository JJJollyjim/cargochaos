...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffsend/v0.2.55.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffsend" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.55.nix {};
        authors = [
      ...
      "ffsend-api" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "077hc3x9dcjjpg0dnbac9lhm1m38psfchrk1vsqryv0fb1g1g46p";
        libName = "ffsend_api";
        authors = [
