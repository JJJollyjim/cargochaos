...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kunai/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kunai" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "kunai"; path = "src/bin/kunai.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Masato Mouri <13274198+mouri111@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "cargo";
