...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nimiq-client/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atomic" = rec {
        ...
        version = "0.4.5";
        edition = "2015";
        sha256 = "0a7w8gaknparcdvg2daqd509ck6qf82ifbb5gd3xm304vgsc2462";
        authors = [
      ...
      "beserial" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1jn2rlvz225452ci8nwzs3ni5bbnd4688fzcz39cyv46ahybrj3f";
        authors = [
          "Marvin W <git@larma.de>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "beserial_derive" = rec {
        crateName = "beserial_derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0c21296zbyc2l73wmsi3jvq0zkgshjc96jgpjd3yz7farcidvkap";
        procMacro = true;
        authors = [
          "Marvin W <git@larma.de>"
        ];
      ...
      "enum-display-derive" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "071zb2gg63yybx20ivk5kby43dq18wjhdw80a376zz2b7jv6xxsk";
        procMacro = true;
        authors = [
      ...
      "fixed-unsigned" = rec {
        crateName = "fixed-unsigned";
        version = "0.2.0";
        edition = "2018";
        sha256 = "13gakn742kw8gd2akyqmp6jvz01v656c2p4y9n98hg7g3lz5gzjr";
        authors = [
      ...
      "libargon2-sys" = rec {
        crateName = "libargon2-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1c060x6wma1skmal679w50z49cahrh2y09nyy3454sdkh0xkmmw5";
        authors = [
      ...
      "nimiq-account" = rec {
        crateName = "nimiq-account";
        version = "0.2.0";
        edition = "2018";
        sha256 = "18vm8m8zn4fh12z99q05hs9074knfl24hi8h6rqc6q0c5jj2ihkh";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          {
            name = "beserial_derive";
            packageId = "beserial_derive";
          }
          {
            name = "failure";
            packageId = "failure";
          ...
          {
            name = "nimiq-hash";
            packageId = "nimiq-hash";
          }
          {
            name = "nimiq-keys";
            packageId = "nimiq-keys";
          }
          {
            name = "nimiq-primitives";
            packageId = "nimiq-primitives";
            features = [ "coin" ];
          }
          {
            name = "nimiq-transaction";
            packageId = "nimiq-transaction";
          }
        ];
        
      };
      "nimiq-accounts" = rec {
        crateName = "nimiq-accounts";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0rq43k9j2s7ng8i007sl7m0hnk0cf10nzkcikcyxh6dnwrma5q25";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          {
            name = "nimiq-account";
            packageId = "nimiq-account";
          }
          {
            name = "nimiq-block";
            packageId = "nimiq-block";
          }
          {
            name = "nimiq-database";
            packageId = "nimiq-database";
            features = [ "full-nimiq" ];
          }
          {
            name = "nimiq-hash";
          ...
          }
          {
            ...
            packageId = "nimiq-network-primitives";
            features = [ "networks" ];
          }
          {
            name = "nimiq-primitives";
            packageId = "nimiq-primitives";
            features = [ "coin" "networks" "policy" ];
          }
          {
            name = "nimiq-transaction";
            packageId = "nimiq-transaction";
          ...
          {
            name = "nimiq-tree-primitives";
            packageId = "nimiq-tree-primitives";
          }
        ];
        
      };
      "nimiq-block" = rec {
        crateName = "nimiq-block";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0m1rzgqvg77g3fkapdm7zpn83mcrcpxgh3q3s74lyqdkrp2wrccw";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          {
            name = "nimiq-macros";
            packageId = "nimiq-macros";
          }
          {
            name = "nimiq-primitives";
            packageId = "nimiq-primitives";
            features = [ "policy" "networks" ];
          }
          {
            name = "nimiq-transaction";
            packageId = "nimiq-transaction";
      ...
      "nimiq-block-production" = rec {
        crateName = "nimiq-block-production";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0bhlkzxjbq800x50yz6g79zida2545qgk2lqc8gqqrmixihv4dmh";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
      ...
      "nimiq-blockchain" = rec {
        crateName = "nimiq-blockchain";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0wyznavvd5y5k12bpq347psf79ajzv9gx0bgzzz2vd1mg5ffypnj";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "nimiq-utils";
            packageId = "nimiq-utils";
            features = [ "observer" "unique-ptr" "iterators" ];
          }
          {
            name = "parking_lot";
        ...
        resolvedDefaultFeatures = [ "default" "metrics" "transaction-store" ];
      };
      "nimiq-client" = rec {
        crateName = "nimiq-client";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "nimiq-client"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "nimiq-metrics-server";
            optional = true;
          }
          {
            name = "nimiq-network";
            packageId = "nimiq-network";
          }
          {
            name = "nimiq-network-primitives";
            packageId = "nimiq-network-primitives";
          }
          {
            name = "nimiq-primitives";
            packageId = "nimiq-primitives";
            features = [ "networks" "coin" ];
          }
          {
            name = "nimiq-rpc-server";
            packageId = "nimiq-rpc-server";
            optional = true;
          }
          {
            name = "parking_lot";
        ...
        resolvedDefaultFeatures = [ "all" "deadlock-detection" "default" "human-panic" "metrics-server" "nimiq-metrics-server" "nimiq-rpc-server" "parking_lot" "rpc-server" "system-install" ];
      };
      "nimiq-collections" = rec {
        crateName = "nimiq-collections";
        version = "0.2.0";
        edition = "2018";
        sha256 = "171dqy1y8bqcfgp2h1h6gnl3k3mvb1f9gvj04cjipby9b6qlf7hl";
        authors = [
      ...
      "nimiq-consensus" = rec {
        crateName = "nimiq-consensus";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0099ryzda5i5r234bl62jnpi3prgrsfci9xxlvbapc5wcf2hg2yd";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "nimiq-blockchain";
            packageId = "nimiq-blockchain";
            features = [ "transaction-store" ];
          }
          {
            name = "nimiq-collections";
            packageId = "nimiq-collections";
          }
          {
            name = "nimiq-database";
            packageId = "nimiq-database";
          ...
          }
          {
            name = "nimiq-utils";
            packageId = "nimiq-utils";
            features = [ "observer" "timers" "mutable-once" "throttled-queue" "rate-limit" ];
          }
          {
            name = "parking_lot";
            packageId = "parking_lot 0.7.1";
      ...
      "nimiq-database" = rec {
        crateName = "nimiq-database";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0lfvimw98zhp4w0i7i5vnnyn8fy7h5qi2wa5n5pyjrbcv07j9a6r";
        authors = [
          "Pascal B <git@paberr.net>"
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "account" "block" "full-nimiq" "hash" "keys" "nimiq-block" "nimiq-hash" "nimiq-keys" "nimiq-tree-primitives" ];
      };
      "nimiq-hash" = rec {
        crateName = "nimiq-hash";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1jlclmw2bp1w4vbz7k1kbq2618njia0wiqyxkhvaw2ci1ny30sx6";
        authors = [
          "Pascal B <git@paberr.net>"
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
      ...
      "nimiq-keys" = rec {
        crateName = "nimiq-keys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "13cymlbp8iv2cx5nlr4rfqmsdmjkdqpv2k4qkpirk7lrhcx232pw";
        authors = [
          "Pascal B <git@paberr.net>"
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
      ...
      "nimiq-lib" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1f4gy2xdyf7sjddgff5h13wqlyvk5af4y61mfy7h4qpbk46k2c20";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
      ...
      "nimiq-macros" = rec {
        crateName = "nimiq-macros";
        version = "0.2.0";
        edition = "2018";
        sha256 = "19pard8zwcdk0k8q12jyngs711mjd44lxfdj05dspjarl6w38k86";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
      ...
      "nimiq-mempool" = rec {
        crateName = "nimiq-mempool";
        version = "0.2.0";
        edition = "2018";
        sha256 = "13zbcnypylqg7ji21li50hfs8lp24phq9cv4sapzpcy4r6vn014c";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "nimiq-utils";
            packageId = "nimiq-utils";
            features = [ "observer" "timers" "mutable-once" ];
          }
          {
            name = "parking_lot";
            packageId = "parking_lot 0.7.1";
      ...
      "nimiq-messages" = rec {
        crateName = "nimiq-messages";
        version = "0.2.0";
        edition = "2018";
        sha256 = "11cvr9ijq54bmx2m2ap6kffca3skdpsjsvszv1h49pxlfg5r0x35";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "nimiq-network-primitives";
            packageId = "nimiq-network-primitives";
            features = [ "networks" "subscription" "version" ];
          }
          {
            name = "nimiq-transaction";
            packageId = "nimiq-transaction";
      ...
      "nimiq-metrics-server" = rec {
        crateName = "nimiq-metrics-server";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0s1xipdgv07hg9yiwyld7p5cp3p15cpjkn9qha6gy0fvg8rkqj1h";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
      ...
      "nimiq-network" = rec {
        crateName = "nimiq-network";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1azmyi4iclp521rr5yxp2pw8sylcfkx1jpw13yf4mdidnmgya7l7";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "nimiq-utils";
            packageId = "nimiq-utils";
            features = [ "timers" "observer" "mutable-once" "time" "unique-ptr" "iterators" "locking" "rate-limit" "unique-id" ];
          }
          {
            name = "parking_lot";
            packageId = "parking_lot 0.7.1";
      ...
      "nimiq-network-primitives" = rec {
        crateName = "nimiq-network-primitives";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0ylx16dyrpqyk60yssm19cxp9ss1i8l0jgxphdvkmsyy51zzxlii";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "address" "all" "default" "networks" "protocol" "services" "subscription" "time" "version" ];
      };
      "nimiq-primitives" = rec {
        crateName = "nimiq-primitives";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1xn6wdnm1pg90rdipba759nld7pl4xf4dr263jyrwindrg573hb1";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "account" "all" "coin" "default" "enum-display-derive" "failure" "fixed-unsigned" "hex" "lazy_static" "networks" "nimiq-macros" "num-bigint" "num-traits" "parking_lot" "policy" ];
      };
      "nimiq-rpc-server" = rec {
        crateName = "nimiq-rpc-server";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0g31952apfh7jz31dszlmybyly68zygwk63byjaz5qcjxgyhfq1d";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "nimiq-block-production";
          }
          {
            name = "nimiq-blockchain";
            packageId = "nimiq-blockchain";
      ...
      "nimiq-transaction" = rec {
        crateName = "nimiq-transaction";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1s711yj1f705m9yx0immwz3w34ld4lzvjq0r2lnrrcj918fix200";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "nimiq-primitives";
            packageId = "nimiq-primitives";
            features = [ "policy" "networks" "account" "coin" ];
          }
          {
            name = "nimiq-utils";
            packageId = "nimiq-utils";
      ...
      "nimiq-tree-primitives" = rec {
        crateName = "nimiq-tree-primitives";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0wzgpxgv6ck1b8i508h8jl7kxis5nhk6m3m6p8gfp2nnlvm094j3";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
      ...
      "nimiq-utils" = rec {
        crateName = "nimiq-utils";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1r0zv5a11d7glkv7x6hj9mlb4hq33gvr50rjf5cxsnarlalfagr8";
        authors = [
          "The Nimiq Core Development Team <info@nimiq.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "beserial" "bit-vec" "crc" "futures" "iterators" "locking" "log" "merkle" "mutable-once" "nimiq-collections" "nimiq-hash" "observer" "parking_lot" "rate-limit" "throttled-queue" "time" "timers" "tokio" "unique-id" "unique-ptr" ];
      };
      "nodrop" = rec {
        crateName = "nodrop";
        version = "0.1.14";
      ...
      "parking_lot 0.7.1" = rec {
        ...
        resolvedDefaultFeatures = [ "deadlock_detection" "default" "owning_ref" ];
      };
      ...
      "tokio-tungstenite" = rec {
        ...
        version = "0.8.0";
        edition = "2015";
        sha256 = "0gmynf8bv0zkl52649xq6pn3kjar0hkhp86p3g6y0ynqh6gn8j6d";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
