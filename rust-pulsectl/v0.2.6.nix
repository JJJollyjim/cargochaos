...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-pulsectl/v0.2.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libpulse-binding" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "pa_latest_common" "pa_v12" "pa_v5" "pa_v6" "pa_v8" ];
      };
      "libpulse-sys" = rec {
