...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-run1-cli/v1.0.13+20200407.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-run1" = rec {
        crateName = "google-run1";
        version = "1.0.13+20200407";
        edition = "2015";
        sha256 = "02dpnhyyzsb9s9xfmr7rggaksx13mqvzz6cx5gw393kkjiaicdam";
        authors = [
      ...
      "google-run1-cli" = rec {
        crateName = "google-run1-cli";
        version = "1.0.13+20200407";
        edition = "2015";
        crateBin = [
          { name = "run1"; path = "src/main.rs"; }
        ];
