...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oxygengine-ignite/v0.7.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oxygengine-build-tools" = rec {
        crateName = "oxygengine-build-tools";
        version = "0.7.1";
        edition = "2018";
        sha256 = "0kxhqkimqjvyix8iby3bj9hlmkz7qp6f91h5zj7j8fc2d9vd9lnw";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "texture_packer";
            packageId = "texture_packer";
          }
        ];
        
      };
      "oxygengine-ignite" = rec {
        crateName = "oxygengine-ignite";
        version = "0.7.1";
        edition = "2018";
        crateBin = [
          { name = "oxygengine-ignite"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "oxygengine-build-tools";
          }
          {
            name = "reqwest";
            packageId = "reqwest";
      ...
      "texture_packer" = rec {
        crateName = "texture_packer";
        version = "0.18.0";
        edition = "2018";
        sha256 = "148caadl5j4d8i70qjxx14sflwkdr6yvp9184wsjpp9vrizrzl8b";
        authors = [
        ...
        features = {
          "bmp" = [ "image/bmp" ];
          "common" = [ "gif_codec" "jpeg" "png_codec" "tga" "bmp" ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
