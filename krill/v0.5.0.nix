...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/krill/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcder" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "03smg3w80zjggz0zxblypqxwwhhjg0xz0vcsdx8m066ys0q3xmmm";
        authors = [
      ...
      "krill" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "krillc"; path = "src/bin/krillc.rs"; }
          { name = "krill"; path = "src/bin/krill.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "The NLnet Labs RPKI team <rpki-team@nlnetlabs.nl>"
        ];
        dependencies = [
          {
            name = "actix-service";
      ...
      "rpki" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0avsjlhgzcj97gwzj460slriyb1yaskbiz9ij51kw364ichja1fq";
        authors = [
          "The NLnet Labs RPKI Team <rpki@nlnetlabs.nl>"
        ];
        dependencies = [
