...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/colonnade/v1.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "wincon" "winerror" "winnt" ];
      };
