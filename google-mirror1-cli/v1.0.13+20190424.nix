...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-mirror1-cli/v1.0.13+20190424.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-mirror1" = rec {
        crateName = "google-mirror1";
        version = "1.0.13+20190424";
        edition = "2015";
        sha256 = "1hn93a9zihdwijizzah8pz1sm1v317kkjyrx9sj5sqh8v5h0b6pv";
        authors = [
      ...
      "google-mirror1-cli" = rec {
        crateName = "google-mirror1-cli";
        version = "1.0.13+20190424";
        edition = "2015";
        crateBin = [
          { name = "mirror1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190424.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
