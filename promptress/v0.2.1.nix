...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/promptress/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "promptress" = rec {
        crateName = "promptress";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "promptress"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "James Tai <jtai@jtai.ca>"
        ];
        dependencies = [
          {
            name = "dirs";
