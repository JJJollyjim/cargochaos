...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.2.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dnsstamps" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0zjw1j203abzkrr6xx2nngl9cm5y3dc4m913mim949j15lksjv11";
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
      ...
      "futures-channel-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "cfg-target-has-atomic" "default" "futures-sink-preview" "sink" "std" "unstable" ];
      };
      "futures-core-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "cfg-target-has-atomic" "default" "std" "unstable" ];
      };
      ...
      "futures-io-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "std" "unstable" ];
      };
      ...
      "futures-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "cfg-target-has-atomic" "default" "std" "unstable" ];
      };
      ...
      "futures-util-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "cfg-target-has-atomic" "channel" "default" "futures-channel-preview" "futures-io-preview" "futures-join-macro-preview" "futures-select-macro-preview" "futures-sink-preview" "io" "join-macro" "memchr" "proc-macro-hack" "proc-macro-nested" "select-macro" "sink" "slab" "std" "unstable" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.12";
