...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.2.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-channel-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "cfg-target-has-atomic" "futures-sink-preview" "nightly" "sink" "std" ];
      };
