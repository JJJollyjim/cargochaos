...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.3.16.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dnsstamps" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0b2ncj2pbwx6cdfy4mi2bzgclwfpr8ahrkxr8a600wvbsih5wmkj";
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
      ...
      "encrypted-dns" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.16.nix {};
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
