...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.3.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "encrypted-dns" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.11.nix {};
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "fs" "rt-threaded" "time" "tcp" "udp" "stream" ];
          }
          {
            name = "toml";
            packageId = "toml";
      ...
      "libsodium-sys-stable" = rec {
        ...
        version = "1.19.0";
        edition = "2015";
        sha256 = "1pq0rqspny938yiba821sqipfr6sbsw20hhiq30drdznx6ig4ywp";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "udp" ];
      };
      "tokio-util" = rec {
