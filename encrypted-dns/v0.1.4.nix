...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "color" "default" "nightly" "strsim" "suggestions" "term_size" "vec_map" "wrap_help" ];
      };
      "clockpro-cache" = rec {
      ...
      "futures-channel-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "cfg-target-has-atomic" "default" "futures-sink-preview" "nightly" "sink" "std" ];
      };
      "futures-core-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "cfg-target-has-atomic" "default" "nightly" "std" ];
      };
      ...
      "futures-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "cfg-target-has-atomic" "default" "nightly" "std" ];
      };
      ...
      "futures-util-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "cfg-target-has-atomic" "channel" "default" "futures-channel-preview" "futures-io-preview" "futures-join-macro-preview" "futures-select-macro-preview" "futures-sink-preview" "io" "join-macro" "memchr" "nightly" "proc-macro-hack" "proc-macro-nested" "rand" "select-macro" "sink" "slab" "std" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.12";
      ...
      "isahc" = rec {
        ...
        version = "0.7.3";
        edition = "2018";
        sha256 = "0lydb5i8drq4wbk9kjiwh9pl9kn9mc6r0d16f5paqh1gndrw5rkw";
        authors = [
      ...
      "libsodium-sys-stable" = rec {
        ...
        version = "0.0.18";
        edition = "2015";
        sha256 = "01ycw59cbm3hgm4mixcdkf4268kqw9s71n6ipwrjxixbwsd75p3x";
