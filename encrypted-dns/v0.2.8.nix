...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.2.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-channel-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "cfg-target-has-atomic" "futures-sink-preview" "sink" "std" "unstable" ];
      };
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "minwindef" "ntstatus" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
