...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.3.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "encrypted-dns" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.10.nix {};
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "udp" ];
      };
      "tokio-util" = rec {
