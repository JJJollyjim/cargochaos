...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/encrypted-dns/v0.3.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "encrypted-dns" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.3.13.nix {};
        authors = [
          "Frank Denis <github@pureftpd.org>"
        ];
        dependencies = [
      ...
      "libsodium-sys-stable" = rec {
        ...
        version = "1.19.4";
        edition = "2015";
        sha256 = "1gf8zzyd72czwayg0cr5ars251zcb53j24qj0kb0i52mk4p2xh22";
