...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wof/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "json" = rec {
        ...
        version = "0.12.2";
        edition = "2018";
        sha256 = "0qfwgs18v2cp8qa3r4nl0mlchcfjkkjva3s4ffry2wf2d29ckjsk";
        authors = [
      ...
      "shapefile" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "10m4vczfki0hrvfby7gzpfbr3dgcvhqsiakny4z1yrl5yzd72lya";
        authors = [
          "tmontaigu <thomas.montaigu@laposte.net>"
        ];
        dependencies = [
      ...
      "wof" = rec {
        ...
        resolvedDefaultFeatures = [ "attohttpc" "chrono" "cli" "flate2" "git2" "log" "structopt" "tar" "which" ];
      };
      "xattr" = rec {
        crateName = "xattr";
        version = "0.2.2";
