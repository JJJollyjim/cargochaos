...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wof/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "json-joxit-fork" = rec {
        crateName = "json-joxit-fork";
        version = "0.12.1";
        edition = "2018";
        sha256 = "195kwhz2770vbjs1mk3dfpvxqz8svkwd696nhfckcirhd0kmp6ka";
        authors = [
      ...
      "wof" = rec {
        ...
        dependencies = [
          ...
          {
            name = "json-joxit-fork";
            packageId = "json-joxit-fork";
            rename = "json";
          }
          {
            name = "libc";
