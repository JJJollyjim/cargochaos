...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/glint/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "processenv" "winbase" "wincon" "winnt" "winuser" ];
      };
