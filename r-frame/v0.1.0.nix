...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/r-frame/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "r-frame" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "r-frame"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "wallacerob <rwwalla2@illinois.edu>"
        ];
        dependencies = [
          {
            name = "rocket";
