...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/http-signature-normalization-actix/v0.3.0-alpha.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http-signature-normalization" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "127095n7z6fxv1n15vpcfw0z4bzf7v3mwpcbq76s4pj63lrb1rpx";
        authors = [
      ...
      "standback" = rec {
        ...
        version = "0.2.6";
        edition = "2018";
        sha256 = "0v35v21nh2fbw30kvpwr1qqm8qhm03xhbpb5hqpjfc7c36jl30w9";
        authors = [
