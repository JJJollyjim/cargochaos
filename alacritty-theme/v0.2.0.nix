...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alacritty-theme/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alacritty-theme" = rec {
        crateName = "alacritty-theme";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "alacritty-theme"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "David Lewis <david@armstronglewis.com>"
        ];
        dependencies = [
          {
            name = "derive_more";
