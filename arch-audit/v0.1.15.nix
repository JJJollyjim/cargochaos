...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arch-audit/v0.1.15.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arch-audit" = rec {
        ...
        authors = [
          "Andrea Scarpino <andrea@scarpino.dev>"
        ];
        dependencies = [
          {
            name = "alpm";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "objbase" "processenv" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
