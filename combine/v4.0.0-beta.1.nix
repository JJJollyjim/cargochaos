...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/combine/v4.0.0-beta.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "combine" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v4.0.0-beta.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "doc" "mp4" "regex" "std" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.3.0";
