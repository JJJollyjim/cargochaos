...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/combine/v4.0.0.nix.tmp"
    ...
    crates = {
      ...
      "combine" = rec {
        ...
        features = {
          ...
          "tokio-02" = [ "pin-project" "tokio-02-dep" ];
        };
        resolvedDefaultFeatures = [ "bytes_05" "default" "futures-03" "futures-io-03" "futures-util-03" "mp4" "pin-project" "regex" "std" "tokio-02" "tokio-02-dep" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.3.0";
