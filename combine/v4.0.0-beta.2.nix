...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/combine/v4.0.0-beta.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "combine" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v4.0.0-beta.2.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "futures_03" "mp4" "pin-project" "regex" "std" "tokio-02" "tokio-02-dep" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.3.0";
