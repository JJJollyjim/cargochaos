...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redis-async/v0.6.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "iovec" "lazy_static" "libc" "macros" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
