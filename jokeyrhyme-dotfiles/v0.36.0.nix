...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jokeyrhyme-dotfiles/v0.36.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jokeyrhyme-dotfiles" = rec {
        crateName = "jokeyrhyme-dotfiles";
        version = "0.36.0";
        edition = "2018";
        crateBin = [
          { name = "jokeyrhyme-dotfiles"; path = "src/main.rs"; }
        ];
