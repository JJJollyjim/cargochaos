...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mandelbrot-rust/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgui-glium-renderer" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1liilvn1yxnlka0ls54f9rfyqdls94k7674m0va5cnfcb8d750wf";
        authors = [
          "Joonas Javanainen <joonas.javanainen@gmail.com>"
          "imgui-rs contributors"
        ];
      ...
      "imgui-winit-support" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "144k6ygh7h19ifk87r5a2dwjxz5nb7g44fxk75bdri8hcrj2d5nx";
        authors = [
          "Joonas Javanainen <joonas.javanainen@gmail.com>"
          "imgui-rs contributors"
        ];
      ...
      "mandelbrot-rust" = rec {
        crateName = "mandelbrot-rust";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "mandelbrot-rust"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Pepijn Dragt <pepijn.dragt@gmail.com>"
        ];
        dependencies = [
          {
            name = "glium";
