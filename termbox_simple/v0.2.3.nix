...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/termbox_simple/v0.2.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "term_input" = rec {
        crateName = "term_input";
        version = "0.1.5";
        edition = "2015";
        sha256 = "096818bsqzpj7135mqhqwjhqp20wscl8722cbl3x0hqada0xzlja";
        authors = [
