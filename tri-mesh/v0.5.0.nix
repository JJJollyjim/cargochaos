...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tri-mesh/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dust" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "1hglc0xjljwl3v42r4amf4qpis9bam420ynfdvlm9l3mn5fvq6w0";type = [ "dylib" ];
        authors = [
          "Jansen Jan <farodin91@sek-server.de>"
        ];
        dependencies = [
          {
            name = "proc-macro2";
