...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/test-erc20/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "test-erc20" = rec {
        crateName = "test-erc20";
        version = "0.3.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Taariq Levack <taariql@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "cosmwasm";
