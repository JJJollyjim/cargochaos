...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cord-broker/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cord-broker" = rec {
        crateName = "cord-broker";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cord-broker"; path = "src/main.rs"; }
        ];
      ...
      "cord-client" = rec {
        crateName = "cord-client";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0pbrdfs5zzxzag8ndpbj2bk9l6d0wg4r89jmnmjcrznji3n66s6i";
        authors = [
          "Cord Contributors"
        ];
        dependencies = [
      ...
      "cord-message" = rec {
        crateName = "cord-message";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1l5vd3kvd59c8399q99s8kd56x24zrpq96x812vcbfh8n9z7wa27";
        authors = [
          "Cord Contributors"
        ];
        dependencies = [
      ...
      "retain_mut" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0cgmm1q7sr31r9wk7syh53ipgqpl37jzsvahdhmwrsi6mmcdc1g0";
        authors = [
