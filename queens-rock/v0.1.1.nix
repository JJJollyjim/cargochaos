...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/queens-rock/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "queens-rock" = rec {
        crateName = "queens-rock";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Dmitry Kontsevoy <dmitry.kontsevoy@gmail.com>"
        ];
        devDependencies = [
          {
            name = "image";
