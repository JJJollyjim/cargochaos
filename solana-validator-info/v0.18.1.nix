...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-validator-info/v0.18.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "solana-validator-info";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "encoding_rs" = rec {
        ...
        version = "0.8.18";
        edition = "2015";
        sha256 = "1jxvcsg7zy3v5pgwdz3vwyp5v5djfq84pj0jbg3ql2s314aq5raa";
        authors = [
      ...
      "jsonrpc-core" = rec {
        ...
        version = "13.1.0";
        edition = "2018";
        sha256 = "05q2s3igf3k0a60qry3y74dq51adcnngnzlvw8754yahncg9ahnx";
        authors = [
      ...
      "solana-client" = rec {
        ...
        version = "0.18.1";
        edition = "2018";
        sha256 = "1bw0sjwjwkddmf4bpw67ij3rknq8nd64jinji2899fmljm7qg2pi";
        authors = [
      ...
      "solana-config-api" = rec {
        ...
        version = "0.18.1";
        edition = "2018";
        sha256 = "1l42f3irnmalw2p00qcpp3vj0m46rnfb1ggxl5pp5gazpk5ay66d";
      ...
      "solana-logger" = rec {
        ...
        version = "0.18.1";
        edition = "2018";
        sha256 = "1hcj9l9andszg0ncx8scipv6698n6dvhzsssa1cgnsnh0xxbzq99";
      ...
      "solana-netutil" = rec {
        crateName = "solana-netutil";
        version = "0.18.1";
        edition = "2018";
        crateBin = [];
        sha256 = "1ldysn227nddqxlqn6x7vyb74wymisxk917y8mdnas8l05p9ch79";
        libName = "solana_netutil";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
      ...
      "solana-sdk" = rec {
        ...
        version = "0.18.1";
        edition = "2018";
        sha256 = "1cd019w905ka5x0x38h3mavh3ii1gqvh80ny46hq1m8jhc87y8d5";
        authors = [
          "Solana Maintainers <maintainers@solana.com>"
        ];
        dependencies = [
      ...
      "solana-validator-info" = rec {
        crateName = "solana-validator-info";
        version = "0.18.1";
        edition = "2018";
        crateBin = [
          { name = "solana-validator-info"; path = "src/validator_info.rs"; }
        ];
