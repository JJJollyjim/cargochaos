...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solana-validator/v1.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "solana-validator" = rec {
        crateName = "solana-validator";
        version = "1.1.6";
        edition = "2018";
        crateBin = [
          { name = "solana-validator"; path = "src/main.rs"; }
        ];
