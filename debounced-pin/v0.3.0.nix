...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/debounced-pin/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "debounced-pin" = rec {
        crateName = "debounced-pin";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Quinn Johnson <winseven4lyf@gmail.com>"
        ];
        dependencies = [
          {
            name = "embedded-hal";
        ...
        devDependencies = [
          ...
          }
          {
            ...
            features = [ "rt" "unproven" "stm32f303" ];
          }
        ];
      ...
      "stm32f3" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0d6vx0ds1rksfsr64v098bwqir4vjwahiq79484l012h0ppxjalh";
        authors = [
      ...
      "stm32f3xx-hal" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1swbf0sazkc6h7014phhmzvfxgmcdar4wvy0203nldknqh88f8gg";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
