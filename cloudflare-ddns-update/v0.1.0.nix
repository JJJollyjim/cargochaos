...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cloudflare-ddns-update/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "cloudflare-ddns-update";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cloudflare" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1w32vqlvfxqv96knxwgxisqy0jb355c9yncjmrzcbi53z55fslic";
        authors = [
      ...
      "cloudflare-ddns-update" = rec {
        crateName = "cloudflare-ddns-update";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cloudflare-ddns-update"; path = "src/main.rs"; }
        ];
