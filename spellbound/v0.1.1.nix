...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spellbound/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hunspell-sys" = rec {
        crateName = "hunspell-sys";
        version = "0.1.3";
        edition = "2018";
        sha256 = "1784869wkkgmk2lx1bf8wynbsyn7g90bdwx84bwfkvydj8byijvh";
        authors = [
      ...
      "spellbound" = rec {
        crateName = "spellbound";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "spellbound"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "objbase" "processenv" "spellcheck" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
