...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-ensure-prefix/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "curl" = rec {
        ...
        version = "0.4.26";
        edition = "2015";
        sha256 = "1vqrgmmkq2n8j5v6d73dxjlxg86msgif3f58ray08386v7z39dgc";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "curl-sys" = rec {
        ...
        edition = "2015";
        sha256 = "1gw4lj4kc5s8ifg431l79kr9lcszyrxbg20784p1kainbpxbgip2";
        libName = "curl_sys";
        libPath = "lib.rs";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
