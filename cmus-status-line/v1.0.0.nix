...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cmus-status-line/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cmus-status-line" = rec {
        crateName = "cmus-status-line";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "cmus-status-line"; path = "src/main.rs"; }
        ];
