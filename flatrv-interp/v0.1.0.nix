...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flatrv-interp/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flatrv" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "05imrs42fhb1fds93wxchlxz6d7fl9s1lqrz29n37cckcf2rcrhf";
        authors = [
          "losfair <zhy20000919@hotmail.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
      ...
      "flatrv-interp" = rec {
        crateName = "flatrv-interp";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "flatrv-interp"; path = "src/main.rs"; }
        ];
