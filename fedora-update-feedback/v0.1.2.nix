...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fedora-update-feedback/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bodhi" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "080ni4wmbp2rgx21r5aflz7aibbs3ywx5c2hpc446bz3sd4rzbp9";
        authors = [
      ...
      "fedora-update-feedback" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "feedback" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
