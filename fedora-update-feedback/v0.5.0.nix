...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fedora-update-feedback/v0.5.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "fedora-update-feedback";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bodhi" = rec {
        ...
        version = "0.5.7";
        edition = "2018";
        sha256 = "0fff3zzj2bsc8xa06bnmk74mmhsh66v85hbi4dxx33ajmmc1rrh9";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "offline-tests" ];
      };
      "bumpalo" = rec {
        crateName = "bumpalo";
        version = "3.2.0";
      ...
      "fedora" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "1g4421h78dfvwfbfb4szhdx47njn3kyc6qyr296n61h3vkkjg5xz";
        authors = [
          "Fabio Valentini <decathorpe@gmail.com>"
        ];
        dependencies = [
      ...
      "fedora-update-feedback" = rec {
        crateName = "fedora-update-feedback";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "fedora-update-feedback"; path = "src/main.rs"; }
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "hyper-tls" "native-tls-crate" "tokio-tls" ];
      };
      "retry" = rec {
        crateName = "retry";
        version = "1.0.0";
      ...
      "structopt" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "default" "suggestions" "wrap_help" ];
      };
