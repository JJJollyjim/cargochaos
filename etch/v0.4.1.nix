...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/etch/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bork" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1wmmv2xjbkcqnvsyhhqs6jm4j172bnc0slhh0w13qv43df2gq0ir";
        authors = [
      ...
      "glue" = rec {
        ...
        version = "0.8.4";
        edition = "2018";
        sha256 = "1ikd10ia0b4g4cms6f6aaqkwh1ipc9l5a9yxhma01kmxl551dp4d";
        authors = [
          "Anarchist Mae <hello@mae.codes>"
        ];
        dependencies = [
