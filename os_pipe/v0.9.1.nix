...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/os_pipe/v0.9.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "os_pipe" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "swap"; path = "src/bin/swap.rs"; }
          { name = "cat_both"; path = "src/bin/cat_both.rs"; }
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "namedpipeapi" "processthreadsapi" "winnt" ];
      };
