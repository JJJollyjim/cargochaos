...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-surveys2-cli/v1.0.13+20180508.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-surveys2" = rec {
        crateName = "google-surveys2";
        version = "1.0.13+20180508";
        edition = "2015";
        sha256 = "0xsvmj02rwykpq1f4pwasjacfa24888bag67nlrppqq6sssbc7xn";
        authors = [
      ...
      "google-surveys2-cli" = rec {
        crateName = "google-surveys2-cli";
        version = "1.0.13+20180508";
        edition = "2015";
        crateBin = [
          { name = "surveys2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20180508.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
