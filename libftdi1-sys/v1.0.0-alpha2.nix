...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libftdi1-sys/v1.0.0-alpha2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libftdi1-sys" = rec {
        crateName = "libftdi1-sys";
        version = "1.0.0-alpha2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0-alpha2.nix {};
        authors = [
        ...
        buildDependencies = [
          ...
          }
          {
            ...
            target = {target, features}: (!(target."windows" && (target."env" == "msvc")));
          }
          {
            name = "vcpkg";
            packageId = "vcpkg";
      ...
      "pkg-config" = rec {
        ...
        version = "0.3.7";
        edition = "2015";
        sha256 = "1spb4a9l23csnzgkza2nsih5i3xkrcnxg6ammr2v8ag0ixdmi8an";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
      ...
      "vcpkg" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1k2gzrbsdkx5j3rdw6xmb6s78qvakbw40rp0cxzn1nffw9qgyx6z";
        authors = [
