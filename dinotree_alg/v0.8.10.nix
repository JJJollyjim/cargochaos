...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dinotree_alg/v0.8.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "axgeom" = rec {
        ...
        version = "1.6.5";
        edition = "2018";
        sha256 = "0lk5vg4kmb0jvd30c407sd7ys11qwm5hm8hh945zmhpspjms8cz5";
        authors = [
      ...
      "dinotree_alg" = rec {
        ...
        version = "0.8.10";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.8.10.nix {};
        authors = [
          "Ken Reed <kenakioreed@gmail.com>"
        ];
        dependencies = [
