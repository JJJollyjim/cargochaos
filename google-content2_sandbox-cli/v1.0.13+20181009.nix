...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-content2_sandbox-cli/v1.0.13+20181009.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-content2_sandbox" = rec {
        ...
        edition = "2015";
        sha256 = "0fs6m4l3a8qxa2ag2w3lkrwhz42z3yving19shqv044cgvqz1fzi";
        authors = [
      ...
      "google-content2_sandbox-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20181009.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
