...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-content2_sandbox-cli/v1.0.12+20181009.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-content2_sandbox-cli";
  ...
  workspaceMembers = {
    "google-content2_sandbox-cli" = rec {
      packageId = "google-content2_sandbox-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-content2_sandbox-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-content2_sandbox" = rec {
        crateName = "google-content2_sandbox";
        version = "1.0.12+20181009";
        edition = "2015";
        sha256 = "1h21wx9a26cs9fraa3q277xsw46bhfvbhcbjg0ffkm9ix00ypfdm";
        authors = [
      ...
      "google-content2_sandbox-cli" = rec {
        crateName = "google-content2_sandbox-cli";
        version = "1.0.12+20181009";
        edition = "2015";
        crateBin = [
          { name = "content2-sandbox"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20181009.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-content2_sandbox";
          }
          {
            name = "hyper";
            packageId = "hyper";
