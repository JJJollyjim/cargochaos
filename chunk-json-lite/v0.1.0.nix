...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/chunk-json-lite/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "chunk-json-lite" = rec {
        crateName = "chunk-json-lite";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "chunk-json-lite"; path = "src/main.rs"; }
        ];
      ...
      "main_error" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "017dbrcn2q4d62b5nzlk8xj6idmpvx5257c5drnzx62dnh7xy5im";
        authors = [
