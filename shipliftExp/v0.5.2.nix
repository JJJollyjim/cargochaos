...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shipliftExp/v0.5.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shipliftExp" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "hyper-openssl" "hyperlocal" "openssl" "tls" "unix-socket" ];
      };
      "slab" = rec {
        crateName = "slab";
        version = "0.4.2";
