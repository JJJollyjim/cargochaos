...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/komodo_rpc_client/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bech32" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "1n5ysyssijbljwlq1awv811k696x2fp9vzn7c0whqq8nzl3vj85d";
        authors = [
          "Clark Moody"
        ];
      ...
      "bitcoin" = rec {
        ...
        version = "0.14.2";
        edition = "2015";
        sha256 = "0c8dhd6qms5am36w5l3hmigmvf8xwxh0lzpq9jzhxkmdzka3fjw0";
        authors = [
      ...
      "bitcoin-bech32" = rec {
        ...
        version = "0.8.1";
        edition = "2015";
        sha256 = "0k2bjw2wfkicbx3mk6wmszmyz3r8jnxara2fdnrl0l6bmgjwz9gh";
        authors = [
          "Clark Moody"
        ];
        dependencies = [
      ...
      "komodo_rpc_client" = rec {
        crateName = "komodo_rpc_client";
        version = "0.1.1";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Jorian <jorian@outlook.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "secp256k1" = rec {
        ...
        version = "0.11.6";
        edition = "2015";
        sha256 = "0id7ng9ajv2czcq2rki4wg9gj04cgc638m978v0cf7w0k7k39fbp";
        authors = [
