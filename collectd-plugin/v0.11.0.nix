...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/collectd-plugin/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1l4sifn771v83q8wafyvmsrphjni8i8wvgdlddd09v35f3fhq9qq";
        authors = [
      ...
      "collectd-plugin" = rec {
        crateName = "collectd-plugin";
        version = "0.11.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.11.0.nix {};
        authors = [
          "Nick Babcock <nbabcock19@hotmail.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
        ...
        resolvedDefaultFeatures = [ "bindgen" "default" "serde" "stub" ];
      };
      "criterion" = rec {
        crateName = "criterion";
        version = "0.3.0";
      ...
      "serde_test" = rec {
        ...
        version = "1.0.98";
        edition = "2015";
        sha256 = "1ahy6m18dlsmnbgcrw85f8lbxll9gh13p5k8by2mk53lqyq8zram";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "trybuild" = rec {
        ...
        version = "1.0.10";
        edition = "2018";
        sha256 = "0g0sz3m3kyd88b0inxmqc8bhn65wn9dqsmksfr63c22px6vbmzsn";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
