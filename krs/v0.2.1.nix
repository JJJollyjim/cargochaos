...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/krs/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rdkafka" = rec {
        ...
        version = "0.21.0";
        edition = "2018";
        sha256 = "1xd6dsi1dnng3mir0mydg6qvv7qb5m1bgdlv14cmykba5iyp2kqi";
        authors = [
      ...
      "rdkafka-sys" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "1i5yhg3ifriij1sn2brri70a4hp3zda4pshgj90j29wnz2cr1plm";
        libName = "rdkafka_sys";
        authors = [
          "Federico Giraud <giraud.federico@gmail.com>"
        ];
