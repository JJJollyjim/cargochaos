...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tsar/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "comment" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1dr8dif37llm6477h7g0xnycan3is73rn1wnxn0k4lar3zf3lz7g";
        authors = [
        ...
        dependencies = [
          {
            name = "comment-strip";
            packageId = "comment-strip";
          }
        ];
        
      };
      "comment-strip" = rec {
        crateName = "comment-strip";
        version = "0.1.3";
        edition = "2015";
        crateBin = [];
        sha256 = "09f70v422r2w43862qvhx4h8sw110000h4dlafsyghry4h6ckgvd";
        authors = [
      ...
      "xasm" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0rb1agkviczjdjyq69z1g2985xccl8vwz3b2jfxp1islxcvi7zac";
        authors = [
      ...
      "xassembler" = rec {
        crateName = "xassembler";
        version = "0.5.1";
        edition = "2018";
        sha256 = "08dsfndlgcdakw5yv9lh2ij5y4f863z8prwi7fa1yjgcfhsjzapk";
        authors = [
          "adam-mcdaniel <adam.mcdanie17@gmail.com>"
        ];
        dependencies = [
