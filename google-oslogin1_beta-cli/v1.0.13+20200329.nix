...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-oslogin1_beta-cli/v1.0.13+20200329.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-oslogin1_beta-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-oslogin1_beta" = rec {
        crateName = "google-oslogin1_beta";
        version = "1.0.13+20200329";
        edition = "2015";
        sha256 = "1xx0xz1k9n1h45k5cinh35dma59lj884pc05vdyr6kjjqd4f79aq";
        authors = [
      ...
      "google-oslogin1_beta-cli" = rec {
        crateName = "google-oslogin1_beta-cli";
        version = "1.0.13+20200329";
        edition = "2015";
        crateBin = [
          { name = "oslogin1-beta"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200329.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-oslogin1_beta";
            packageId = "google-oslogin1_beta";
          }
          {
            name = "hyper";
            packageId = "hyper";
