...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/barc-cli/v2.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "barc" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "154b30cknqc7idaxjl9hbzmwwnfnd66780fzvmkra3a0nwvkl1j6";
        authors = [
      ...
      "blocking-permit" = rec {
        ...
        version = "1.2.0";
        edition = "2018";
        sha256 = "1xbvw66fckrn4i5ls0ks5kbz19kd1lfshnvm88bciqhbr34aa68s";
        authors = [
          "David Kellum <dek-oss@gravitext.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "bytes" "cleaver" "tokio" "tokio-omnibus" "tokio-oneshot" "tokio-semaphore" "tokio-threaded" "yield-stream" ];
      };
      "body-image" = rec {
      ...
      "body-image-futio" = rec {
        ...
        version = "2.1.0";
        edition = "2018";
        sha256 = "0ghjjvbb3f4v5avvaz2hzf39s8r5f8vq1ay76q3lrmi0z4nbyicm";
        authors = [
          "David Kellum <dek-oss@gravitext.com>"
        ];
        dependencies = [
          {
            ...
            usesDefaultFeatures = false;
            features = [ "tokio-omnibus" "cleaver" "yield-stream" ];
          }
          {
            name = "body-image";
            packageId = "body-image";
        ...
        resolvedDefaultFeatures = [ "brotli" "hyper" "hyper-http" "hyper-tls" "memmap" "mmap" ];
      };
      "brotli" = rec {
        crateName = "brotli";
        version = "3.3.0";
      ...
      "piccolog" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1v14rvzlp1kqqi2l6gv035mx5wh8wia2dwk9978czj50vbl2baja";
        authors = [
          "David Kellum <dek-oss@gravitext.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "parking_lot" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
