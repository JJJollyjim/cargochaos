...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wool/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gh-emoji" = rec {
        ...
        version = "1.0.2";
        edition = "2018";
        sha256 = "1x1v1rv2qamyyv82bh7yyxc8bi1arsxr25ls0ak41ncakl4f9l1l";
        authors = [
      ...
      "hyper-staticfile" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0nvs413sn6q92r0ngv6p7920mqvrk3qcnd2hxbx5n712wqjjq7i4";
        authors = [
