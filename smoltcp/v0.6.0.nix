...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/smoltcp/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "managed" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "map" "std" ];
      };
      "matches" = rec {
        crateName = "matches";
        version = "0.1.8";
      ...
      "smoltcp" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "ethernet" "libc" "log" "phy-raw_socket" "phy-tap_interface" "proto-dhcpv4" "proto-igmp" "proto-ipv4" "proto-ipv6" "rust-1_28" "socket-icmp" "socket-raw" "socket-tcp" "socket-udp" "std" "verbose" ];
      };
      "termcolor" = rec {
        crateName = "termcolor";
        version = "1.0.5";
