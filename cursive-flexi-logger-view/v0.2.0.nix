...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cursive-flexi-logger-view/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "cursive-flexi-logger-view";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cursive-flexi-logger-view" = rec {
        crateName = "cursive-flexi-logger-view";
        version = "0.2.0";
        edition = "2018";
      ...
      "flexi_logger" = rec {
        ...
        version = "0.14.3";
        edition = "2018";
        sha256 = "1ibrssfhlzbvhrjl4vwy2wfllx2c38136gcqxpv74ahdd8dkqiv6";
        authors = [
