...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mumble-protocol/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mumble-protocol" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "webrtc-extensions" ];
      };
      "native-tls" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
