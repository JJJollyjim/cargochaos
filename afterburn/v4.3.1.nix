...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/afterburn/v4.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pnet_base 0.25.0" = rec {
        crateName = "pnet_base";
        version = "0.25.0";
        edition = "2015";
        sha256 = "0ryrf4vx8kanxywc45a83j2179g2ly86k65778d90g6s3xmfr4xa";
        authors = [
          "Robert Clipsham <robert@octarineparrot.com>"
          "Linus Färnstrand <faern@faern.net>"
        ];
