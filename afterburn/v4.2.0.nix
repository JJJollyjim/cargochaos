...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/afterburn/v4.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "afterburn" = rec {
        ...
        src = pkgs.callPackage ./tarball-v4.2.0.nix {};
        authors = [
      ...
      "mockito" = rec {
        ...
        version = "0.21.0";
        edition = "2015";
        sha256 = "0l1l3j4abv2lgq5i4nn1j11gigbgf2z60hwacak7bk0424q8rqxf";
        authors = [
