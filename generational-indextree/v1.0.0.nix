...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/generational-indextree/v1.0.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "generational-indextree";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "generational-indextree" = rec {
        crateName = "generational-indextree";
        version = "1.0.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Barry van Acker <barry.van.acker@rubix.nl>"
        ];
        dependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "default" "deser" "serde" "std" ];
      };
      "proc-macro2" = rec {
