...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tuning/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "namedpipeapi" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" ];
      };
