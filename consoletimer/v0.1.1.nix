...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/consoletimer/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cc" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0vrxk685v4z5jx20393wz9wa1xn1s2wna0xkzqfjswmxyyax2phm";
        authors = [
      ...
      "consoletimer" = rec {
        crateName = "consoletimer";
        version = "0.1.1";
        edition = "2015";
        crateBin = [
          { name = "consoletimer"; path = "src/main.rs"; }
        ];
      ...
      "eventual" = rec {
        ...
        version = "0.1.7";
        edition = "2015";
        sha256 = "0jzmlfgqgzqwyndbxf4pmj5rnc11lkybbznnyd8cld5li78adgdr";
        authors = [
      ...
      "ncurses" = rec {
        ...
        version = "5.97.0";
        edition = "2015";
        sha256 = "1rjsm21qnq3cdr8anq0xlxqy8fkq5pch302bq38x2vzywx2130pf";
        authors = [
          "contact@jeaye.com"
        ];
        dependencies = [
      ...
      "syncbox" = rec {
        ...
        version = "0.2.4";
        edition = "2015";
        sha256 = "1iw57d91zj0jmgg6gxs19iy1jy35b746chbw1qnpmhlscmr2pg05";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
