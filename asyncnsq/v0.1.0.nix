...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/asyncnsq/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "asyncnsq" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "integrations_test"; path = "tests/integrations_test.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "linziyan <aohan237@gmail.com>"
        ];
        dependencies = [
          {
            name = "async-std";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "libloaderapi" "lmcons" "minschannel" "minwindef" "ntstatus" "schannel" "securitybaseapi" "sspi" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
