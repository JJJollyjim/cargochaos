...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/systray/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "impl-default" "libloaderapi" "minwinbase" "minwindef" "processenv" "shellapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
