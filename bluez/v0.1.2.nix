...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bluez/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitvec" = rec {
        ...
        version = "0.16.2";
        edition = "2018";
        sha256 = "10mzzw61q246wi75b9z7152ay0q83vd7gvfxkdr1bx6kyd716qiz";
        authors = [
      ...
      "bluez" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "discover"; path = "src/example/discover.rs"; }
          { name = "list"; path = "src/example/list.rs"; }
        ];
