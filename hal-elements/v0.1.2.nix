...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hal-elements/v0.1.2.nix.tmp"
    ...
    crates = {
      ...
      "bitcoin" = rec {
        ...
        dependencies = [
          ...
          {
            name = "bitcoin_hashes";
            packageId = "bitcoin_hashes 0.7.4";
          }
          {
            name = "hex";
            packageId = "hex";
      ...
      "bitcoin_hashes 0.3.1" = rec {
        crateName = "bitcoin_hashes";
        version = "0.3.1";
        edition = "2015";
        sha256 = "0cpjw8ffwj6i5ia6pb9cpp0sald39pvzgqdl5i4m97wmbi3x26dh";
        authors = [
          "Andrew Poelstra <apoelstra@wpsoftware.net>"
        ];
        dependencies = [
      ...
      "elements" = rec {
        ...
        version = "0.12.1";
        edition = "2015";
        sha256 = "0wvwmd6gmvb0j6isbiblqlsw5r8fs6lpsa6mk9zn5b2r9nmiqpc2";
        authors = [
        ...
        features = {
          "serde-feature" = [ "bitcoin/use-serde" "serde" ];
        };
      ...
      "hal" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0mkgzf8y8wny2ppl3p3wasnzb5494vns64cbghsfbj2hxmgbvypi";
        authors = [
      ...
      "hal-elements" = rec {
        crateName = "hal-elements";
        version = "0.1.2";
        edition = "2015";
        crateBin = [
          { name = "hal-elements"; path = "src/bin/hal-elements/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        libName = "hal_elements";
        authors = [
          "Steven Roose <steven@stevenroose.org>"
        ];
        dependencies = [
      ...
      "lightning-invoice" = rec {
        ...
        dependencies = [
          ...
          {
            name = "bitcoin_hashes";
            packageId = "bitcoin_hashes 0.3.1";
          }
          {
            name = "num-traits";
            packageId = "num-traits";
