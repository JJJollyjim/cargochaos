...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sand/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simon" = rec {
        ...
        version = "0.3.7";
        edition = "2018";
        sha256 = "1slz3a7x50nizp22x5s3z2j1r79x77xbj20p2d2q9njdz3qyx8fz";
        authors = [
          "Stephen Sherratt <stephen@sherra.tt>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "slab" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
