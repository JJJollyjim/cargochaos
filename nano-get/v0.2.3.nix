...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nano-get/v0.2.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nano-get" = rec {
        ...
        authors = [
          "Rahul Thomas <rapidclock@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "openssl";
        ...
        resolvedDefaultFeatures = [ "default" "http" "https" "openssl" ];
      };
      "openssl" = rec {
        crateName = "openssl";
        version = "0.10.26";
