...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32f7xx-hal/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f7" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "07wlfjbalmfpr4c5rwblg4na0bxaffyyyipz461l7pyjwy48ph95";
        authors = [
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32f7x2" "stm32f7x3" "stm32f7x5" "stm32f7x6" "stm32f7x7" "stm32f7x9" ];
      };
      "stm32f7xx-hal" = rec {
        crateName = "stm32f7xx-hal";
        version = "0.1.0";
        edition = "2018";
        ...
        resolvedDefaultFeatures = [ "rt" "stm32f722" "stm32f723" "stm32f732" "stm32f733" "stm32f745" "stm32f746" "stm32f756" "stm32f765" "stm32f767" "stm32f769" "stm32f777" "stm32f778" "stm32f779" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.7";
