...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudtrace1-cli/v1.0.12+20190622.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudtrace1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudtrace1" = rec {
        crateName = "google-cloudtrace1";
        version = "1.0.12+20190622";
        edition = "2015";
        sha256 = "0mih02dp7bgfjdgvja9a15md8vi6my17szafd5c3rr61sxnlwp2m";
        authors = [
      ...
      "google-cloudtrace1-cli" = rec {
        crateName = "google-cloudtrace1-cli";
        version = "1.0.12+20190622";
        edition = "2015";
        crateBin = [
          { name = "cloudtrace1"; path = "src/main.rs"; }
        ];
