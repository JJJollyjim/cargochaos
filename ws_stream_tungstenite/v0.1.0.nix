...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ws_stream_tungstenite/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "ws_stream_tungstenite";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tungstenite" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "async-std-runtime" "default" "tokio" "tokio-runtime" ];
      };
      "async_io_stream" = rec {
        crateName = "async_io_stream";
        version = "0.1.0";
        edition = "2018";
        sha256 = "161iddf7li7gx6gwc3ykcabm22jz3m6nh4jagfhs4n0l0zr0bjph";
        authors = [
        ...
        resolvedDefaultFeatures = [ "map_pharos" "pharos" "tokio" "tokio_io" ];
      };
      "async_progress" = rec {
        crateName = "async_progress";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1zf04128c6s24p58ifq84qj52zk7741hsi8xywh25k2irldl9lz7";
        authors = [
          "Naja Melan <najamelan@autistici.org>"
        ];
        dependencies = [
      ...
      "future-parking_lot" = rec {
        crateName = "future-parking_lot";
        version = "0.3.3";
        edition = "2018";
        sha256 = "121l17csqgrhj911g2wpd2aqd78ydvv1b6abk1kg211kpxw08qp2";
        authors = [
          "Marco Napetti <marco.napetti@gmail.com>"
        ];
        dependencies = [
          {
      ...
      "futures_ringbuf" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "12qkc9n1sfwkhwzl5jq2nq6xrc5kaz4x5ghlkqzhfar2war35mrh";
        authors = [
          "Naja Melan <najamelan@autistici.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "futures_io" ];
      };
      "generic-array" = rec {
      ...
      "pharos" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "1gmid60pc327z3m8r3sja6jyk0450xy2a89z72wvnzgc80syg25r";
        authors = [
          "Naja Melan <najamelan@autistici.org>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "futures-core" "io-driver" "iovec" "lazy_static" "macros" "mio" "rt-core" "stream" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "ws_stream_tungstenite" = rec {
        crateName = "ws_stream_tungstenite";
        version = "0.1.0";
        edition = "2018";
        ...
        resolvedDefaultFeatures = [ "default" "tokio" "tokio_io" ];
      };
      "yansi" = rec {
        crateName = "yansi";
        version = "0.5.0";
