...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_service_bus/v0.30.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "azure_sdk_service_bus";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_service_bus" = rec {
        crateName = "azure_sdk_service_bus";
        version = "0.30.0";
        edition = "2018";
