...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/email-extractor/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "email-extractor" = rec {
        crateName = "email-extractor";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "email-extractor"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "iamsaquib <saquib@distill.io>"
        ];
        dependencies = [
          {
            name = "actix-rt";
      ...
      "lol_html" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0w3qpif6f4rf6gb8b10sm32f04irmfcs45jwh2nv8ll03ryz2wqj";
        authors = [
      ...
      "mail_extractor" = rec {
        crateName = "mail_extractor";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0m4nh87yib7hd26f0kzvwhgc75ddp7vghs4c3gxizal9ykar6165";
        authors = [
          "iamsaquib <saquib@distill.io>"
        ];
        dependencies = [
      ...
      "tokio 0.2.6" = rec {
        ...
        resolvedDefaultFeatures = [ "futures-core" "io-driver" "iovec" "lazy_static" "libc" "mio" "mio-uds" "rt-core" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-buf" = rec {
        crateName = "tokio-buf";
        version = "0.1.1";
