...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-about/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "license" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "0lks0xs8rd345n53cxp7dsmfdki6ykvdjzjcp3l89fr5fswmzaay";
        authors = [
          "evenorog <evenorog@gmail.com>"
        ];
