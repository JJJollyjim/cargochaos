...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/prcn_lib/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "prcn_lib" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "pool"; path = "src/bin/pool.rs"; }
          { name = "one"; path = "src/bin/one.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Loptall <yutapypy0930@gmail.com>"
        ];
        dependencies = [
          {
            name = "ascii";
      ...
      "proconio" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0vsic9dfxj262ra6dgnafqnl9h1gwhapyjspfp9saik985z7m1zs";
        authors = [
        ...
        resolvedDefaultFeatures = [ "derive" "proconio-derive" ];
      };
      "proconio-derive" = rec {
        crateName = "proconio-derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0c1rjdq7s5vcr0a68ww09qmnlppxkb6amffra85yjjgvmia1lwhz";
        procMacro = true;
        authors = [
          "statiolake <statiolake@gmail.com>"
        ];
