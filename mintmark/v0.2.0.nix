...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mintmark/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "barcoders" = rec {
        ...
        version = "1.0.1";
        edition = "2015";
        sha256 = "0dii4rm4xc9g3mhfb1hsjnrvldl5xvmk3rczzfnpm9n2b2hp331r";
        authors = [
      ...
      "mintmark" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mintmark"; path = "src/main.rs"; }
        ];
