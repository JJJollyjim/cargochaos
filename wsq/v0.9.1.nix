...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wsq/v0.9.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wsq" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "libc" "libz-sys" "native-tls" "nativetls" "openssl" "permessage-deflate" "ssl" ];
      };
    };
