...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/honggfuzz/v0.5.48.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "arbitrary" = rec {
        ...
        version = "0.4.2";
        edition = "2018";
        sha256 = "1snkr9v8xv8i0rklm301c71a2h1az0qdvx9yrk20ffirbnrcjj0i";
        authors = [
      ...
      "honggfuzz" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.5.48.nix {};
        authors = [
