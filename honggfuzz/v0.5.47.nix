...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/honggfuzz/v0.5.47.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "honggfuzz" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "cargo-honggfuzz"; path = "src/bin/cargo-honggfuzz.rs"; }
          { name = "cargo-hfuzz"; path = "src/bin/cargo-hfuzz.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.47.nix {};
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "memmap";
            packageId = "memmap";
            target = { target, features }: target."fuzzing_debug";
          }
        ];
        devDependencies = [
          {
