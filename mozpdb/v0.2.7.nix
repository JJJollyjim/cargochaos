...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mozpdb/v0.2.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "fallible-iterator" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "07gzk5lnn0ynf7xlhjswq158h2r0vk1c436cx0l6c20sq4dsnj2x";
        authors = [
      ...
      "scroll_derive" = rec {
        ...
        version = "0.9.1";
        edition = "2015";
        sha256 = "0mmz9mcdkpdr91bqrjpg0wacl255cyrh72vcfb2c92jfl83khj5i";
        procMacro = true;
        authors = [
          "m4b <m4b.github.io@gmail.com>"
        ];
      ...
      "uuid" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "12wsky8yq7riqdqcbs2lvxkr7x1frixrnbzc4slq18km6q8gbl5m";
        authors = [
          "The Rust Project Developers"
        ];
        features = {
