...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wlambda/v0.4.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winuser" ];
      };
      ...
      "wlambda" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "regex" "rmp-serde" "rustyline" "serde" "serde_json" ];
      };
    };
