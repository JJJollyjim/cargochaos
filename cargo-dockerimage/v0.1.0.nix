...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-dockerimage/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-dockerimage" = rec {
        crateName = "cargo-dockerimage";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-dockerimage"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "bishtpawan <pawan.bisht@knoldus.in>"
        ];
        dependencies = [
          {
            name = "cargo_toml";
