...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ichen-openprotocol/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ichen-openprotocol" = rec {
        crateName = "ichen-openprotocol";
        version = "0.5.0";
        edition = "2018";
        crateBin = [
          { name = "openprotocolviewer"; path = "src/bin/openprotocolviewer/main.rs"; }
        ];
      ...
      "noisy_float" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "0bnkcjfbcg451jkdaapbln3cydciw2mpsk0x9cxw43d78yyy3cxi";
        authors = [
