...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pokedex-cli/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pokedex-cli" = rec {
        crateName = "pokedex-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "pokedex-cli"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Ari Vaniderstine <ari.vaniderstine@embark-studios.com>"
        ];
        dependencies = [
          {
            name = "clap";
