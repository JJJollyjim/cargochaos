...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crossterm_winapi/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "impl-default" "processenv" "synchapi" "winbase" ];
      };
