...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/machine_uuid/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "machine_uuid" = rec {
        crateName = "machine_uuid";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "machine_uuid"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "danebalia <dane.balia@sourcing-sa.co.za>"
        ];
        dependencies = [
          {
            name = "regex";
