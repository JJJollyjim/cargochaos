...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blkar/v7.2.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blkar" = rec {
        ...
        src = pkgs.callPackage ./tarball-v7.2.6.nix {};
        libName = "blkar_lib";
        authors = [
      ...
      "reed-solomon-erasure" = rec {
        ...
        version = "3.1.1";
        edition = "2015";
        sha256 = "0drw0j5grxqxw5sk985jzwqhf20h3dd2ax4ywigk8gpm096bvjvp";
        authors = [
          "Darren Ldl <darrenldldev@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "pure-rust" ];
      };
      "regex" = rec {
        crateName = "regex";
        version = "1.2.1";
