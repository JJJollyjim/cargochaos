...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blkar/v7.2.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blkar" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "blkar"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v7.2.7.nix {};
        libName = "blkar_lib";
        authors = [
      ...
      "reed-solomon-erasure" = rec {
        ...
        version = "4.0.1";
        edition = "2018";
        sha256 = "1264rr8f7kz7l4ds1p97px006gfnz8pykqb72kv2gz5mgphk3iy2";
        authors = [
          "Darren Ldl <darrenldldev@gmail.com>"
        ];
        dependencies = [
