...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/slack_api/v0.22.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "blocking" "default-tls" "gzip" "hyper-rustls" "hyper-tls" "native-tls" "native-tls-crate" "rustls" "rustls-tls" "tokio-rustls" "tokio-tls" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
      ...
      "slack_api" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "reqwest" "reqwest_" "with_native_tls" "with_rustls" ];
      };
      "smallvec" = rec {
        crateName = "smallvec";
        version = "1.1.0";
