...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cec-alsa-sync/v1.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cec-rs" = rec {
        ...
        version = "1.1.0";
        edition = "2018";
        sha256 = "0a678ci77c9q2r6yin2q34mj6yxlfxxnisy9qwxjpzaa2zdg1fii";
        authors = [
          "Sami Salonen"
        ];
        dependencies = [
      ...
      "libcec-sys" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1sx6jsj0lysw5lgx6qwq8lkwjk4w3vgj72vqfbv4cg94llxr4rvb";
        authors = [
          "Sami Salonen"
        ];
        buildDependencies = [
