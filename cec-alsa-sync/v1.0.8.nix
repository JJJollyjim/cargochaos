...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cec-alsa-sync/v1.0.8.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cec-alsa-sync" = rec {
        crateName = "cec-alsa-sync";
        version = "1.0.8";
        edition = "2018";
        crateBin = [
          { name = "cec-alsa-sync"; path = "src/bin.rs"; }
        ];
      ...
      "cec-rs" = rec {
        ...
        version = "2.0.1";
        edition = "2018";
        sha256 = "0k6cnrsm7ykqxxyhn6x1h2bjx62zrb4x3pvpsd4fsb3bxgf86nx2";
        authors = [
          "Sami Salonen"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "enum-repr-derive";
          }
          {
            name = "libcec-sys";
            packageId = "libcec-sys";
          }
          {
            name = "log";
            packageId = "log";
      ...
      "enum-repr-derive" = rec {
        crateName = "enum-repr-derive";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0ywh3mnzvspq6f74fkn3i6sphkfsrb0r2rqd1q9q17rs3wf5nd1d";
        procMacro = true;
        authors = [
          "Sami Salonen"
        ];
      ...
      "libcec-sys" = rec {
        crateName = "libcec-sys";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0q86r9s68k876ydf2mbvv103g2invzxx9fb786icdb0skz7f1xj2";
        authors = [
          "Sami Salonen"
        ];
        buildDependencies = [
