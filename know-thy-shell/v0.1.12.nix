...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/know-thy-shell/v0.1.12.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "know-thy-shell" = rec {
        crateName = "know-thy-shell";
        version = "0.1.12";
        edition = "2018";
        crateBin = [
          { name = "kts"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.12.nix {};
        authors = [
          "Marius Seritan <github@winding-lines.com>"
        ];
        dependencies = [
          {
            name = "arrow";
      ...
      "kts-analyze" = rec {
        crateName = "kts-analyze";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0mcif1mfyi0q72v08z29s41zh6vg1aq8m3902jkg1pq7ry2bgz48";
        authors = [
          "Marius Seritan <github@winding-lines.com>"
        ];
        dependencies = [
      ...
      "kts-etl" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "148qgyljr9wylf8a3yc1d89k9kyjdqzlzss1h7y79z0ckh8dny90";
        authors = [
          "Marius Seritan <github@winding-lines.com>"
        ];
        dependencies = [
