...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sse-server/v0.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sse-actix-web" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0fxhrvngjh7n432q8abcv0y26dvir95q73ikpvf2dxz4555jahmh";
        authors = [
      ...
      "sse-server" = rec {
        crateName = "sse-server";
        version = "0.0.4";
        edition = "2018";
        crateBin = [
          { name = "sse-server"; path = "src/main.rs"; }
        ];
