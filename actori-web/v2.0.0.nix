...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actori-web/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actori-http" = rec {
        ...
        resolvedDefaultFeatures = [ "actori-tls" "brotli2" "compress" "default" "fail-ure" "failure" "flate2" "openssl" "ring" "rustls" "secure-cookies" ];
      };
      "actori-macros" = rec {
