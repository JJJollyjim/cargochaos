...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/treesum/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "parallel-iterator" = rec {
        crateName = "parallel-iterator";
        version = "0.1.5";
        edition = "2015";
        sha256 = "1xmqk5ll5qh0fydxk4n22qx3k3w6drfgq5vn2ks7z8glwgky5h0k";
        authors = [
