...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/susu/v0.1.20190509190436.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "susu" = rec {
        crateName = "susu";
        version = "0.1.20190509190436";
        edition = "2018";
        crateBin = [
          { name = "susu"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.20190509190436.nix {};
        authors = [
          "MyCos Tech <sales@mycostech.com>"
        ];
        dependencies = [
          {
            name = "clap";
