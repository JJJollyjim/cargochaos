...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-coordinate1-cli/v1.0.12+20150811.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-coordinate1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-coordinate1" = rec {
        crateName = "google-coordinate1";
        version = "1.0.12+20150811";
        edition = "2015";
        sha256 = "126mlhv4gw9xd9jfcnvd6mj42sbaw2ymm2sx3iwv6l48w7343lxd";
        authors = [
      ...
      "google-coordinate1-cli" = rec {
        crateName = "google-coordinate1-cli";
        version = "1.0.12+20150811";
        edition = "2015";
        crateBin = [
          { name = "coordinate1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20150811.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
