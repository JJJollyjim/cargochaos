...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ksp-commnet-calculator-cli/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "ksp-commnet-calculator-cli";
  ...
  workspaceMembers = {
    "ksp-commnet-calculator-cli" = rec {
      packageId = "ksp-commnet-calculator-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "ksp-commnet-calculator-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ksp-commnet-calculator-cli" = rec {
        crateName = "ksp-commnet-calculator-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "ksp-commnet-calculator-cli"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "ksp-commnet-calculator-core";
          }
        ];
        
      };
      "ksp-commnet-calculator-core" = rec {
        crateName = "ksp-commnet-calculator-core";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0f6h973s55q551xk3b5q1dwlj9vvm9n7p5x02017bd7nvw8cbva2";
        authors = [
          "Igaguri <igagurimk@gmail.com>"
        ];
        dependencies = [
