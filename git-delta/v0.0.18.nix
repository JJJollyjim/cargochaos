...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-delta/v0.0.18.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
