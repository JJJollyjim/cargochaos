...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uvm-install2/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cluFlock" = rec {
        ...
        version = "1.2.5";
        edition = "2018";
        sha256 = "1gil2076kch93x2r5xjcp0mk8lhavqip0wjlc47syzd3drpmi6nw";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi 0.3.8";
            target = { target, features }: target."windows";
            features = [ "fileapi" "minwinbase" "winnt" "ntdef" ];
          }
        ];
        features = {
      ...
      "dmg" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "13yxp3gca7ph0n5djlqwh4v0c7ymik0nqlr0ag3k0h2fwqwmnmky";
        authors = [
          "Maciej Goszczycki <mgoszcz2@gmail.com>"
        ];
        dependencies = [
          {
            name = "log";
      ...
      "plist 0.3.0" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "1p1yb7ypi44ndrv8icqj083hgjphzaiqkp3bg01dmics5n1icwqc";
        authors = [
          "Ed Barnard <eabarnard@gmail.com>"
        ];
        dependencies = [
      ...
      "test-env-log" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "12ii7ji2zxrspaliv8j7h903skaan1nvfp396gs5gl5ir6l64nai";
        procMacro = true;
        authors = [
      ...
      "uvm-install2" = rec {
        crateName = "uvm-install2";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "uvm-install2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "uvm_install_core";
          }
          {
            name = "uvm_install_graph";
            packageId = "uvm_install_graph";
          }
        ];
        devDependencies = [
          {
      ...
      "uvm_core" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0c8f6v8p8z871n3cgfg1rxf3h7gs004l66qgikqykcj214jl88gc";
        authors = [
          "Manfred Endres <manfred.endres@tslarusso.de>"
        ];
        dependencies = [
      ...
      "uvm_install_core" = rec {
        crateName = "uvm_install_core";
        version = "0.3.0";
        edition = "2018";
        sha256 = "07m99j8d4prnyp4c3d0c49gyz4arkasggwlnz9rj8s3q5jffib3k";
        authors = [
          "Manfred Endres <manfred.endres@tslarusso.de>"
        ];
        dependencies = [
      ...
      "uvm_install_graph" = rec {
        crateName = "uvm_install_graph";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1gqaaz3xhd8pksfnvrcygnz19ax38y45vw6gx4dy6cvn9dwnw8mw";
        authors = [
          "Manfred Endres <manfred.endres@tslarusso.de>"
        ];
        dependencies = [
      ...
      "uvm_move_dir" = rec {
        crateName = "uvm_move_dir";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1jyrb72x75bvyf54rv6nbfq2n0d7rcm1h8yfc0bk1ynyn51h7kyi";
        authors = [
          "Manfred Endres <manfred.endres@tslarusso.de>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "winver" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
