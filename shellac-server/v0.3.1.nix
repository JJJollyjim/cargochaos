...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/shellac-server/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "shellac-codec" = rec {
        crateName = "shellac-codec";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0yg6jk3jqrzpx1s8w89vhghss62zwm9i5gsqw7q8ry968nfbgynb";
        authors = [
          "Xavier L'Heureux <xavier.lheureux@icloud.com>"
        ];
        dependencies = [
          {
            name = "capnp";
      ...
      "shellac-server" = rec {
        crateName = "shellac-server";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "shellac-server"; path = "src/main.rs"; }
        ];
