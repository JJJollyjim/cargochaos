...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/splines/v3.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "splines" = rec {
        ...
        resolvedDefaultFeatures = [ "cgmath" "default" "impl-cgmath" "impl-nalgebra" "nalgebra" "num-traits" "serde" "serde_derive" "serialization" "simba" "std" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
