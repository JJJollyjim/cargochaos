...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-fusiontables2-cli/v1.0.13+20171117.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-fusiontables2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-fusiontables2" = rec {
        crateName = "google-fusiontables2";
        version = "1.0.13+20171117";
        edition = "2015";
        sha256 = "0ndxsf2s1b6hvg6x2x3qm36lmlvy4zc7l8mkngad2rylgjd5x24s";
        authors = [
      ...
      "google-fusiontables2-cli" = rec {
        crateName = "google-fusiontables2-cli";
        version = "1.0.13+20171117";
        edition = "2015";
        crateBin = [
          { name = "fusiontables2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20171117.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-fusiontables2";
          }
          {
            name = "hyper";
            packageId = "hyper";
