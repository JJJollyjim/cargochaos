...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-swagger/v0.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-swagger" = rec {
        crateName = "actix-swagger";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "actix-swagger"; path = "src/main.rs"; }
        ];
