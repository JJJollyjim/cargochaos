...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/svlint/v0.4.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "svlint" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mdgen"; path = "src/mdgen.rs"; }
          { name = "svlint"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
