...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gpu-trace-perf/v1.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gpu-trace-perf" = rec {
        crateName = "gpu-trace-perf";
        version = "1.3.0";
        edition = "2018";
        crateBin = [
          { name = "gpu-trace-perf"; path = "src/main.rs"; }
        ];
      ...
      "log-once" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "132a4szdxd2h3h0bx73qn4x597r489hdzqkqjzgkfkr5j04g19mb";
        authors = [
          "Luthaf <luthaf@luthaf.fr>"
        ];
        dependencies = [
          {
            name = "log";
