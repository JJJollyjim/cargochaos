...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/turs/v0.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tico" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0r4lfgkav2l16rdnycmz16cw78mvsl9sqs17zcarqp90w2zkzmxr";
        authors = [
          "Ricardo Mendes <rokusu@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "winbase" "winerror" "winsock2" "ws2def" ];
      };
