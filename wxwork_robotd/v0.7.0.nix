...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wxwork_robotd/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli" "brotli2" "default" "fail" "failure" "flate2" "flate2-zlib" "openssl" "ssl" ];
      };
      "actix-router" = rec {
      ...
      "actix-server" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "openssl" "ssl" "tokio-openssl" ];
      };
      "actix-server-config" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "ssl" "tokio-openssl" ];
      };
      "actix-service" = rec {
      ...
      "actix-web" = rec {
        ...
        resolvedDefaultFeatures = [ "awc" "brotli" "client" "default" "fail" "flate2-zlib" "openssl" "ssl" ];
      };
      ...
      "wxwork_robotd" = rec {
        crateName = "wxwork_robotd";
        version = "0.7.0";
        edition = "2015";
        crateBin = [
          { name = "wxwork_robotd"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "system-alloc" ];
      };
    };
