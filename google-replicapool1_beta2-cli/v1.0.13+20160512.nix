...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-replicapool1_beta2-cli/v1.0.13+20160512.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-replicapool1_beta2-cli";
  ...
  workspaceMembers = {
    "google-replicapool1_beta2-cli" = rec {
      packageId = "google-replicapool1_beta2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-replicapool1_beta2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-replicapool1_beta2" = rec {
        crateName = "google-replicapool1_beta2";
        version = "1.0.13+20160512";
        edition = "2015";
        sha256 = "1vgdcfbllzxy92apsmsp3shy45wk4x9lqv15b2mzpf16462c7zna";
        authors = [
      ...
      "google-replicapool1_beta2-cli" = rec {
        crateName = "google-replicapool1_beta2-cli";
        version = "1.0.13+20160512";
        edition = "2015";
        crateBin = [
          { name = "replicapool1-beta2"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-replicapool1_beta2";
          }
          {
            name = "hyper";
            packageId = "hyper";
