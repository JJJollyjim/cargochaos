...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffsend-api/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffsend-api" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "send2" "send3" "websocket" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "time 0.2.3" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "10kr6xzihrzac6zi9fadbknijl82xnz3hks8js9mq6hjh8x7gkp2";
        authors = [
