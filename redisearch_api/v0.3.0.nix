...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/redisearch_api/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "redis-module" = rec {
        crateName = "redis-module";
        version = "0.7.0";
        edition = "2018";
        sha256 = "16lcl4c8cpmkk9knmchljszg4vhz7hnflj6s86cqhv3lpyvbsd9k";
        authors = [
          "Gavrie Philipson <gavrie@redislabs.com>"
          "Guy Korland <guy.korland@redislabs.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
        ...
        resolvedDefaultFeatures = [ "default" "experimental-api" ];
      };
      "redisearch_api" = rec {
        crateName = "redisearch_api";
        version = "0.3.0";
        edition = "2018";
