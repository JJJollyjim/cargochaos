...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/folia/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "folia" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "folialintr"; path = "src/bin/folialintr.rs"; }
          { name = "foliabenchmarkr"; path = "src/bin/foliabenchmarkr.rs"; }
        ];
