...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/notedown_zola/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "notedown_ast" = rec {
        crateName = "notedown_ast";
        version = "0.3.0";
        edition = "2018";
        sha256 = "14wk7vzn9j4v4zn633q9k808m1vyrcahcmv7xnk7xabhk4wf2mki";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "notedown_parser";
            packageId = "notedown_parser";
          }
          {
            name = "pest";
            packageId = "pest";
      ...
      "notedown_parser" = rec {
        crateName = "notedown_parser";
        version = "0.4.0";
        edition = "2018";
        sha256 = "1wdfc5qraa4302g0zsxnqc48v5raal9jim62xf8qlscsylv34sar";
        authors = [
          "Aster <192607617@qq.com>"
        ];
        dependencies = [
      ...
      "notedown_zola" = rec {
        crateName = "notedown_zola";
        version = "1.0.0";
        edition = "2018";
        crateBin = [
          { name = "notedown_zola"; path = "src/main.rs"; }
        ];
