...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hypertask_cli/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hypertask_cli" = rec {
        crateName = "hypertask_cli";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "task"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "Freddie Ridell <contact@freddieridell.com>"
        ];
        dependencies = [
          {
            name = "ansi_term";
          ...
          {
            name = "hypertask_config_file_opener";
            packageId = "hypertask_config_file_opener";
          }
          {
            name = "hypertask_engine";
            packageId = "hypertask_engine";
          }
          {
            name = "lazy_static";
            packageId = "lazy_static";
      ...
      "hypertask_config_file_opener" = rec {
        crateName = "hypertask_config_file_opener";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0sr0h98x4pdfwgs0xlqy7ws0pyhali13rq4z80g2gi62r58yf71g";
        authors = [
          "Freddie Ridell <contact@freddieridell.com>"
        ];
        dependencies = [
      ...
      "hypertask_engine" = rec {
        crateName = "hypertask_engine";
        version = "0.2.0";
        edition = "2018";
        sha256 = "15k4rm2yqzdxnml0l0dydpm1qkxf9l3kagxykc5j3p05l9xdl3ky";
        authors = [
          "Freddie Ridell <contact@freddieridell.com>"
        ];
        dependencies = [
