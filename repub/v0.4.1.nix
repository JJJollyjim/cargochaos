...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/repub/v0.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "colored_truecolor" = rec {
        crateName = "colored_truecolor";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0052drx350mbwr4icyvnfdvj09ia9rxdq685fji24kd3rab45x46";
        authors = [
          "Kaisei Yokoyama <yokoyama.kaisei.sm@tsukuba.ac.jp>"
        ];
        dependencies = [
          {
            name = "lazy_static";
      ...
      "html5ever" = rec {
        ...
        version = "0.24.0";
        edition = "2015";
        sha256 = "1wgli48ba86sw5c57kg132fgzf06igp808rzx9ys5yil5p5w4qia";
        authors = [
      ...
      "repub" = rec {
        ...
        dependencies = [
          ...
          {
            name = "colored_truecolor";
            packageId = "colored_truecolor";
          }
          {
            name = "comrak";
            packageId = "comrak";
