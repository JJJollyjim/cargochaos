...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-subcopy/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "anyhow" = rec {
        ...
        version = "1.0.11";
        edition = "2018";
        sha256 = "0bz5dxrnn9jbk8gy9rjc62bx1k3r2r2xhcf5m7y26zdazzbzjdv5";
        authors = [
      ...
      "git-subcopy" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "git-subcopy"; path = "src/main.rs"; }
        ];
