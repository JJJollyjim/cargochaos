...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure-app-configuration/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "azure-app-configuration";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure-app-configuration" = rec {
        crateName = "azure-app-configuration";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "azure-app-configuration"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntstatus" "processenv" "schannel" "securitybaseapi" "sspi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
