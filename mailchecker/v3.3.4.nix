...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mailchecker/v3.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mailchecker" = rec {
        ...
        version = "3.3.4";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v3.3.4.nix {};
        authors = [
      ...
      "pretty_assertions" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "0vkbkw45xxg5j01lgbaqjw51hcjg3368v63806js5iq758rz64i4";
        authors = [
