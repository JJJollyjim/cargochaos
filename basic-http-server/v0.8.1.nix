...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/basic-http-server/v0.8.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "basic-http-server" = rec {
        crateName = "basic-http-server";
        version = "0.8.1";
        edition = "2018";
        crateBin = [
          { name = "basic-http-server"; path = "src/main.rs"; }
        ];
