...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/diffmetrik/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diffmetrik" = rec {
        crateName = "diffmetrik";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "diffmetrik"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Miroslav Zoricak <miroslav.zoricak@gmail.com>"
        ];
        dependencies = [
          {
            name = "fs2";
