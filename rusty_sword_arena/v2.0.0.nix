...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty_sword_arena/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "glium" = rec {
        ...
        version = "0.26.0";
        edition = "2015";
        sha256 = "0qw67xcanmyq96z107kjn474fdjisahc4kfm9van7yjcqsr8hvm4";
        build = "build/main.rs";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
        ];
      ...
      "nalgebra" = rec {
        ...
        resolvedDefaultFeatures = [ "matrixmultiply" "rand_distr" "serde" "serde-serialize" "serde_derive" "std" ];
      };
      "nalgebra-glm" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "serde-serialize" "std" ];
      };
      "net2" = rec {
        crateName = "net2";
        version = "0.2.33";
      ...
      "rusty_audio" = rec {
        crateName = "rusty_audio";
        version = "1.1.1";
        edition = "2018";
        sha256 = "14li67697dcfvg7472qzbarpfrrzwn702p68hy3fcklzcq36gfh7";
        authors = [
          "Nathan Stocks <nathan.stocks@gmail.com>"
        ];
        dependencies = [
          {
            name = "rodio";
      ...
      "rusty_gfx" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "05q2yzv3nckksha5jh6pqy1sfr2x1f6n693axxn2rfh3ax3ybw46";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "basetsd" "combaseapi" "coml2api" "commctrl" "consoleapi" "debug" "devpkey" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "impl-debug" "ksmedia" "libloaderapi" "memoryapi" "minwindef" "mmdeviceapi" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "synchapi" "sysinfoapi" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
