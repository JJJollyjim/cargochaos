...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clicolors-control/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "minwinbase" "minwindef" "processenv" "winbase" ];
      };
