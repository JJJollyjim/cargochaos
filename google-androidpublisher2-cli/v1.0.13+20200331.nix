...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidpublisher2-cli/v1.0.13+20200331.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidpublisher2" = rec {
        ...
        edition = "2015";
        sha256 = "0jar6rfmgj9vq4wckc0jgpka95d6zqklhx32bjg3gcqih5vxdg59";
        authors = [
