...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidpublisher2-cli/v1.0.12+20190702.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-androidpublisher2-cli";
  ...
  workspaceMembers = {
    "google-androidpublisher2-cli" = rec {
      packageId = "google-androidpublisher2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-androidpublisher2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidpublisher2" = rec {
        crateName = "google-androidpublisher2";
        version = "1.0.12+20190702";
        edition = "2015";
        sha256 = "1hrl72hsqhpwpca4k5lf7z6yqs3xkh5yf4ap6z8m6j3m80p7bjsr";
        authors = [
      ...
      "google-androidpublisher2-cli" = rec {
        crateName = "google-androidpublisher2-cli";
        version = "1.0.12+20190702";
        edition = "2015";
        crateBin = [
          { name = "androidpublisher2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190702.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-androidpublisher2";
          }
          {
            name = "hyper";
            packageId = "hyper";
