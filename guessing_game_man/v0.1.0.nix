...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_man/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_man" = rec {
        crateName = "guessing_game_man";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_man"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Manav Prakash Sah <manav.sah@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
