...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/http-status-print/v0.1.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http-status-print" = rec {
        crateName = "http-status-print";
        version = "0.1.5";
        edition = "2018";
        crateBin = [
          { name = "http-status-print"; path = "src/main.rs"; }
        ];
