...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sqs-replay/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusoto_sqs" = rec {
        ...
        version = "0.42.0";
        edition = "2018";
        sha256 = "0q3qfxkr7fyh3m2hpk7126gdm4f6b9b7qaqylr9950c6h638l342";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "sqs-replay" = rec {
        crateName = "sqs-replay";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "sqs-replay"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        authors = [
          "stustill <stuart.still@icloud.com>"
        ];
        dependencies = [
          {
            name = "clap";
