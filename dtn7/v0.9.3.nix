...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dtn7/v0.9.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bp7" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0l4fs5azmx3nx6972990q76qf5r7lwp3n287bn0wx8ivvfygj3m4";
        authors = [
      ...
      "dtn7" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dtntrigger"; path = "src/bin/dtntrigger.rs"; }
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
