...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/minimult_cortex-m/v0.3.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minimult_cortex-m" = rec {
        crateName = "minimult_cortex-m";
        version = "0.3.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.3.nix {};
        authors = [
          "convexbrain <convexbrain@gmail.com>"
        ];
        dependencies = [
          {
            name = "cortex-m";
