...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/intcode_compiler/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "intcode_compiler" = rec {
        crateName = "intcode_compiler";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "ic"; path = "src/main.rs"; }
        ];
