...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/markdown_splitter/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "markdown_splitter" = rec {
        crateName = "markdown_splitter";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "mds"; path = "src/bin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Romain Bouyé <romain@bouye.fr>"
        ];
        dependencies = [
          {
            name = "structopt";
