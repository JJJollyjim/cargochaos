...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lindera-cli/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lindera" = rec {
        ...
        version = "0.3.4";
        edition = "2018";
        sha256 = "037gkshnmzfvyp4nmxjf2bl6wl8lhrrdi1j1d055787yli2shmam";
        authors = [
          "Paul Masurel <paul.masurel@gmail.com>"
      ...
      "lindera-cli" = rec {
        crateName = "lindera-cli";
        version = "0.3.4";
        edition = "2018";
        crateBin = [
          { name = "lindera"; path = "src/main.rs"; }
        ];
