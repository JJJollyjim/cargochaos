...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/prometheus_wireguard_exporter/v3.3.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "prometheus_wireguard_exporter";
  ...
  workspaceMembers = {
    "prometheus_wireguard_exporter" = rec {
      packageId = "prometheus_wireguard_exporter";
      build = internal.buildRustCrateWithFeatures {
        packageId = "prometheus_wireguard_exporter";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "prometheus_exporter_base" = rec {
        ...
        version = "0.30.2";
        edition = "2018";
        sha256 = "11yi3hs3cr3b79lzd4g7rg3zxvnyma9gy8gw3zhgr6mrbyzhcn0h";
        authors = [
      ...
      "prometheus_wireguard_exporter" = rec {
        crateName = "prometheus_wireguard_exporter";
        version = "3.3.0";
        edition = "2018";
        crateBin = [
          { name = "prometheus_wireguard_exporter"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v3.3.0.nix {};
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
        ];
        dependencies = [
