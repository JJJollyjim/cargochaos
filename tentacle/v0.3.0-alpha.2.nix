...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tentacle/v0.3.0-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "faster-hex" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "0a2c9n2hk3z83nch3dglbznfynqszd3rdydfih0v0fz04gfki09l";
        authors = [
      ...
      "molecule" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "14ydnzrhx75cr3vpij81qkmw7nqhzsmldx7dj61w57p2k6dzk4jl";
        authors = [
          "Nervos Core Dev <dev@nervos.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "faster-hex" "std" ];
      };
      "net2" = rec {
        crateName = "net2";
        version = "0.2.33";
      ...
      "tentacle" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "time" "io-util" "tcp" "dns" "rt-threaded" "blocking" ];
          }
          {
            name = "tokio-util";
      ...
      "tentacle-multiaddr" = rec {
        crateName = "tentacle-multiaddr";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1hyzwkwm7nbrc5fwphlh029c4aaxh9fy62niz76wn6b7gavnl8bd";
        authors = [
      ...
      "tentacle-secio" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1lsc7zajp49gcmxbgvpw9qx580r98f3ma4qvzfd9ncsxiqd5m16q";
        authors = [
          "piaoliu <441594700@qq.com>"
          "Nervos Core Dev <dev@nervos.org>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "tcp" "time" ];
      };
      "tokio-util" = rec {
      ...
      "tokio-yamux" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1yh833nr0rdw5igbk6bgpg6fgxinr6hq0s1zhc24adjjw30qx99x";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "heapapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
