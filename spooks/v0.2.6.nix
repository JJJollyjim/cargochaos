...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spooks/v0.2.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "easy_reader" = rec {
        crateName = "easy_reader";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1w9midip34cc2jfjjyz8ggnymlzrjvc493nlmlwxcs9hgr3nqlhi";
        authors = [
      ...
      "spooks" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "spooks"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.6.nix {};
        authors = [
          "Niklas R. <niklasr@protonmail.com>"
        ];
        dependencies = [
          {
            name = "easy_reader";
            packageId = "easy_reader";
          }
          {
            name = "getopts";
            packageId = "getopts";
