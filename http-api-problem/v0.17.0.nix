...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/http-api-problem/v0.17.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http-api-problem" = rec {
        ...
        resolvedDefaultFeatures = [ "actix" "actix-web" "default" "hyper" "warp" "with-actix-web" "with-api-error" "with-hyper" "with-warp" ];
      };
      "http-body" = rec {
        crateName = "http-body";
        version = "0.3.1";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "rt-core" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-util" = rec {
