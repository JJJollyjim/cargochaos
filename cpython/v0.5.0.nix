...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpython/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "python27-sys" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1m4lyxahnjn5yjbfy9jvfj83hq808c2m9hfm9svbl1gz6fdnssv4";
        authors = [
          "Daniel Grunwald <daniel@danielgrunwald.de>"
        ];
        dependencies = [
      ...
      "python3-sys" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "01rhpxm86nsvyyaslzm12gfn8j79pfgppsvs42ilv9qgbshxr3cn";
        authors = [
          "Daniel Grunwald <daniel@danielgrunwald.de>"
        ];
        dependencies = [
