...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpython/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpython" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "extension-module" "extension-module-2-7" "nightly" "no-auto-initialize" "nonnull" "py-link-mode-default" "py-link-mode-unresolved-static" "python-3-4" "python-3-5" "python-3-6" "python-3-7" "python-3-8" "python27-sys" "python3-sys" ];
      };
      "lazy_static" = rec {
      ...
      "python27-sys" = rec {
        crateName = "python27-sys";
        version = "0.4.0";
        edition = "2015";
        sha256 = "06glkvsdza9r30k7bw7jgj1fk3q5vlxy1xmn56hal1yzjvrdphpc";
        authors = [
          "Daniel Grunwald <daniel@danielgrunwald.de>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "extension-module" "python-2-7" ];
      };
      "python3-sys" = rec {
        crateName = "python3-sys";
        version = "0.4.0";
        edition = "2015";
        sha256 = "1lsgy8xvr912ggjl8i6amnd95r4pb76kxzjhmrxxgf8dzw7mb5nj";
        authors = [
          "Daniel Grunwald <daniel@danielgrunwald.de>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "extension-module" "link-mode-default" "link-mode-unresolved-static" "python-3" "python-3-4" "python-3-5" "python-3-6" "python-3-7" "python-3-8" ];
      };
      "regex" = rec {
        crateName = "regex";
        version = "1.3.3";
