...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/litex/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linked_list_allocator" = rec {
        ...
        version = "0.6.4";
        edition = "2015";
        sha256 = "1shb7rs2d6b8nqzrrmb7cp2ma44vprbvx9dmgkp6ka4ssb0lwca7";
        authors = [
          "Philipp Oppermann <dev@phil-opp.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "spin" "use_spin" ];
      };
      "litex" = rec {
        crateName = "litex";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "litex"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Tom Vijlbrief <tvijlbrief@gmail.com>"
        ];
        dependencies = [
          {
