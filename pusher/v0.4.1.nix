...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pusher/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "yup-hyper-mock" = rec {
        ...
        version = "4.0.0";
        edition = "2018";
        sha256 = "18ggyp9vn4y5pgj1dzs1zrrwlbhls3vaz5jalbvd99pw2zhhiarj";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-driver" "io-util" "stream" ];
          }
        ];
        devDependencies = [
          {
