...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/plotly/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "plotly" = rec {
        ...
        resolvedDefaultFeatures = [ "orca" "plotly_orca" ];
      };
      "plotly_orca" = rec {
        crateName = "plotly_orca";
        version = "0.2.1";
        edition = "2018";
        sha256 = "0s4v3p3whflwfspc6dqiykwi33zksag30yyawvzmn25nb8l43vrr";
        authors = [
          "Ioannis Giagkiozis <i.giagkiozis@gmail.com>"
        ];
        dependencies = [
