...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/toml-cli/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lexical-core" = rec {
        ...
        version = "0.4.4";
        edition = "2015";
        sha256 = "1ar7v9i7310ampwyrmrgla0a1nax8jwaw0659kv8pmiav4y4pqis";type = [ "lib" "staticlib" "cdylib" ];
        authors = [
      ...
      "stackvector" = rec {
        ...
        version = "1.0.8";
        edition = "2015";
        sha256 = "13249bnbqpq4v0m3z0igfdxqwj0pqz6xzc13g2bii424klw7h26f";
        authors = [
