...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/img2raw-tools/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "img2raw" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0sbv3vh459darchz68zk2vxjkqzba1pspm9qxz67ai9m4sbfs5zz";
        authors = [
          "Thomas Bénéteau <thomas@bitwise.me>"
        ];
        dependencies = [
          {
            name = "zerocopy";
        ...
        resolvedDefaultFeatures = [ "default" "zerocopy" ];
      };
      "img2raw-tools" = rec {
        crateName = "img2raw-tools";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "img2raw"; path = "src/main.rs"; }
        ];
      ...
      "squish" = rec {
        ...
        version = "1.0.0";
        edition = "2015";
        sha256 = "1cmfylif0zj294jxscaf4mhpqm2r67cwi1g6q4f168ps1ch2qylx";
        authors = [
          "Jan Solanti <jhs@psonet.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
