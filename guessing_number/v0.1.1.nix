...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_number/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_number" = rec {
        crateName = "guessing_number";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "guessing_number"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "elitecodegroovy <elite_jigang@163.com>"
        ];
        dependencies = [
          {
            name = "actix-web";
