...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rightscrape/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rightscrape" = rec {
        crateName = "rightscrape";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "rightscrape"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winnt" "wtypesbase" ];
      };
