...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ffmpeg-screen-recorder/v1.0.8.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "ffmpeg-screen-recorder";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ffmpeg-screen-recorder" = rec {
        crateName = "ffmpeg-screen-recorder";
        version = "1.0.8";
        edition = "2018";
        crateBin = [
          { name = "ffmpeg-screen-recorder"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
