...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/orgize/v0.8.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "orgize" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "ser" "serde" "serde_indextree" "syntect" ];
      };
      "output_vt100" = rec {
      ...
      "serde_indextree" = rec {
        crateName = "serde_indextree";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0kzp3dk6smfy0509fd1sih9ai4a31kgpb1rshsxb0m2l01c7s3m7";
        authors = [
          "PoiScript <poiscript@gmail.com>"
        ];
        dependencies = [
      ...
      "slugify" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "12xcybjhm7g2rql0n91lgb2j195za58qx3smswqvi2107lhczf6n";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
