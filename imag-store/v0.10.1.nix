...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imag-store/v0.10.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imag-store" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "imag-store"; path = "src/bin.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "early-panic" ];
      };
      "interactor" = rec {
      ...
      "libimagstore" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "early-panic" "verify" ];
      };
      "libimagutil" = rec {
