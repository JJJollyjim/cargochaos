...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flowc/v0.8.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flow_impl" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "029jkzkhr3a74v1mfj8m1hgjs9ywzcj6f7jzq1964dmf4pgvjs89";
        authors = [
      ...
      "flowclib" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "11r8z39nni08alz07g1ap807wd2hbyy4knl2f03262dggkgnwb2n";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
        dependencies = [
      ...
      "flowrlib" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "126llz7jwi3pzscpzdakxmzrr7cikaqj61hzlxp8n368zwk679ab";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
        dependencies = [
      ...
      "instant" = rec {
        ...
        resolvedDefaultFeatures = [ "now" "time" "wasm-bindgen" ];
      };
      "itertools" = rec {
        crateName = "itertools";
        version = "0.7.11";
      ...
      "provider" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "1jqs1rna2jy1i9x03f4zn6fymm60pssw1zgg9l2f48qav94j5w3s";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
        dependencies = [
      ...
      "simpath" = rec {
        ...
        version = "1.3.0";
        edition = "2015";
        sha256 = "1w9kjnny2h0k9xgz19m07r0cijx2wp1lrcd3zq0a8y4i8xqrxwaz";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
      ...
      "url" = rec {
        ...
        version = "1.6.1";
        edition = "2015";
        sha256 = "0pi1my6x65jc3kf22hdcxyvdlm77jvnz21w465214m5iz4nipvr3";
        authors = [
          "The rust-url developers"
        ];
        dependencies = [
