...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flowc/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flowclib" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0vcv1lx6myk0vjw4r2ldbcyksahs7d4v9kmwfc696wjfmi2hvnk5";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
        dependencies = [
      ...
      "flowrlib" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0s1v25j96x3dcxkj2bi9rfk89iw91j7sdwc2p0kks41yc6756w2k";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
        dependencies = [
      ...
      "parity-wasm" = rec {
        ...
        version = "0.40.2";
        edition = "2018";
        sha256 = "0lgq2pi40gd1h042z47hqx39fw9hb2czxjrfblsfaswpa4sy7la9";
        authors = [
      ...
      "provider" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "058y22h0yb48jk6pyzqvqkgg9h4vkcrc470hq9cma54ry8yaxyhc";
        authors = [
          "Andrew Mackenzie <andrew@mackenzie-serres.net>"
        ];
        dependencies = [
      ...
      "wasmi" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "04w3aad8zj8kbq1qkfimjysfl16n7v7fs86lzrn7x8yrnbg2c7gk";
        authors = [
          "Nikolay Volf <nikvolf@gmail.com>"
          "Svyatoslav Nikolsky <svyatonik@yandex.ru>"
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
