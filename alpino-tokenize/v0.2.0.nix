...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alpino-tokenize/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alpino-tokenize" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "alpino-tokenize"; path = "src/main.rs"; }
        ];
      ...
      "alpino-tokenizer-sys" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0pj3gnj1x3rpc241j9bxb3gqqsxnhvr8fj9p18a4l2q0dw6v8ywh";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
      ...
      "conllu" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "18fk7chcx18garvdakzra6zilsqym0v9nyq2b6hyfgj7s955cnl1";
        authors = [
          "Daniël de Kok <me@danieldk.eu>"
        ];
        dependencies = [
