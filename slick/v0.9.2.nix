...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/slick/v0.9.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compound_duration" = rec {
        crateName = "compound_duration";
        version = "1.0.2";
        edition = "2018";
        sha256 = "0v697qif28cmy81ak12wqq5gdxyxbhfjhvi9wiv4ib10wwany9cc";
        authors = [
