...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cw-escrow/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cosmwasm" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0arczz54mvnmz5cg1fgk785lajxb9v84f0cwzxvb3ddn7zv9a5s2";
        authors = [
      ...
      "cosmwasm-vm" = rec {
        ...
        version = "0.5.1";
        edition = "2018";
        sha256 = "0323g8cf9wk5hzm2nfj5hnmw4fbwcjybvz20n8rx1dhnnc4jas42";
        authors = [
          "Ethan Frey <ethanfrey@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "serde-json-wasm" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1fsd7nsml0kws0l0b0w813id2sfz0lgnk5w1ykncnnvj53dpnvnr";
        authors = [
