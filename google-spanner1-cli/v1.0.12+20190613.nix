...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-spanner1-cli/v1.0.12+20190613.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-spanner1" = rec {
        crateName = "google-spanner1";
        version = "1.0.12+20190613";
        edition = "2015";
        sha256 = "0c1zsq6wppg4jf2qgiqlnxg4ldi2gv7d7zxzrhxip2q81h5v45fv";
        authors = [
      ...
      "google-spanner1-cli" = rec {
        crateName = "google-spanner1-cli";
        version = "1.0.12+20190613";
        edition = "2015";
        crateBin = [
          { name = "spanner1"; path = "src/main.rs"; }
        ];
