...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/changepoint/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "changepoint" = rec {
        ...
        features = {
          "serde1" = [ "serde" "serde_derive" "rv/serde1" ];
        };
      ...
      "rv" = rec {
        ...
        version = "0.9.2";
        edition = "2018";
        sha256 = "1zpz5bj5kxnig5jlckh2p5srli158lfzm46968xgldjyxysikxd9";
        authors = [
          "Baxter Eaves"
          "Michael Schmidt"
        ];
