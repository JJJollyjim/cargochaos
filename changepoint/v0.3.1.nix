...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/changepoint/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "changepoint" = rec {
        ...
        features = {
          "serde_support" = [ "serde" "serde_derive" "rv/serde_support" ];
        };
      ...
      "rv" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "0ljv43ix4fdg9bsqppbxmxraj3k70rbkpqh46pjf8hcypirr24qr";
        authors = [
          "Baxter Eaves"
          "Michael Schmidt"
        ];
