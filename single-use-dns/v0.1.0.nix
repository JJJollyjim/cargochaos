...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/single-use-dns/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "single-use-dns" = rec {
        crateName = "single-use-dns";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "single-use-dns"; path = "src/main.rs"; }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "io-driver" "iovec" "lazy_static" "mio" "rt-core" "slab" "stream" "tcp" "time" "udp" ];
      };
      "toml" = rec {
        crateName = "toml";
        version = "0.5.6";
      ...
      "trust-dns-server" = rec {
        ...
        version = "0.19.3";
        edition = "2018";
        sha256 = "00q5va8j1nj8r8fird2yai27a2rm39jvr1sck40hw3kw72ijjxim";
