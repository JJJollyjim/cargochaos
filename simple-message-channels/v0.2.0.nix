...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-message-channels/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "simple-message-channels";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple-message-channels" = rec {
        crateName = "simple-message-channels";
        version = "0.2.0";
        edition = "2018";
