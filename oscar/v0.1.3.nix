...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oscar/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_info" "std" ];
      };
      "matches" = rec {
        crateName = "matches";
        version = "0.1.8";
      ...
      "oscar" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "oscar"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Adam Simpson <adam@heysparkbox.com>"
        ];
        dependencies = [
          {
            name = "dirs";
