...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sgx_crypto_helper/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rdrand" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1ir1d2xwknd9r2dpygpphdc7h7wmfy23kjivbp0n0psinm1gh52h";
        authors = [
      ...
      "sgx_crypto_helper" = rec {
        crateName = "sgx_crypto_helper";
        version = "1.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.1.0.nix {};
        authors = [
          "The Teaclave Authors"
        ];
        dependencies = [
          {
            name = "itertools";
        ...
        resolvedDefaultFeatures = [ "default" "enclave_cargo" "sgx_tcrypto" ];
      };
      "sgx_tcrypto" = rec {
        crateName = "sgx_tcrypto";
        version = "1.1.0";
        edition = "2018";
        sha256 = "1ipgzkli877rhbrjxbwsrh1ww935jhm7ady6d1dkb5l3yk752yzy";type = [ "rlib" ];
        authors = [
          "The Teaclave Authors"
        ];
        dependencies = [
      ...
      "sgx_types" = rec {
        ...
        version = "1.1.0";
        edition = "2018";
        sha256 = "18spkn16vwi7r2x499m8vs4is0sv169ki9sskm5pmr5rc0dwvfw3";
        authors = [
          "The Teaclave Authors"
        ];
        features = {
      ...
      "sgx_ucrypto" = rec {
        crateName = "sgx_ucrypto";
        version = "1.1.0";
        edition = "2018";
        sha256 = "19laa5z05al3qzd5y87nggwh55ds1mpk0yhw99a7blgjc6swyyjh";type = [ "rlib" ];
        authors = [
          "The Teaclave Authors"
        ];
        dependencies = [
