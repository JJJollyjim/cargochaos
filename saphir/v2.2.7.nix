...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/saphir/v2.2.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "saphir" = rec {
        ...
        version = "2.2.7";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v2.2.7.nix {};
        authors = [
          "Richer Archambault <richer.arc@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
          ...
          {
            name = "saphir-cookie";
            packageId = "saphir-cookie";
            rename = "cookie";
          }
          {
            name = "saphir_macro";
            packageId = "saphir_macro";
            optional = true;
          }
          {
            name = "serde";
        ...
        resolvedDefaultFeatures = [ "base64" "default" "form" "full" "hex" "https" "json" "macro" "mime" "multipart" "nom" "operation" "rand" "rustls" "saphir_macro" "serde" "serde_json" "serde_urlencoded" "tokio-rustls" ];
      };
      "saphir-cookie" = rec {
        crateName = "saphir-cookie";
        version = "0.13.0";
        edition = "2015";
        sha256 = "1xcik9wyiqvcmiqifw8prll6kc5fxa2l1grvz8ddlhpbyj00rf9d";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
      ...
      "saphir_macro" = rec {
        crateName = "saphir_macro";
        version = "2.0.2";
        edition = "2018";
        sha256 = "0q54clkw41rylnvnb0bp17hbwc6rvhng22apv6wiywj0m67gnqjr";
        procMacro = true;
        authors = [
          "Richer Archambault <richer.arc@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
