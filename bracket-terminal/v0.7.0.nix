...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bracket-terminal/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amethyst" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "16pyvvgcn2hhasc49h63adpmq7h97f2kszckxim3nlkq2l8r6c05";
        authors = [
      ...
      "bracket-color" = rec {
        ...
        resolvedDefaultFeatures = [ "byteorder" "rex" ];
      };
      ...
      "bracket-terminal" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst" "amethyst_engine_metal" "amethyst_engine_vulkan" "crossterm" "curses" "default" "glow" "glutin" "image" "opengl" "pancurses" ];
      };
      "bstr" = rec {
        crateName = "bstr";
        version = "0.2.11";
