...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tame-gcs/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-test" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "15ppdwyg7d94l4334ya40vbpb7l72hv378qzadz9nianfa6ipy91";
      ...
      "tame-gcs" = rec {
        ...
        resolvedDefaultFeatures = [ "async-multipart" "default" "futures-util" "pin-utils" "ring" "signing" "v1" ];
      };
      "tame-oauth" = rec {
        crateName = "tame-oauth";
        version = "0.4.1";
        edition = "2018";
        sha256 = "0avx8q1m9jj7ki5bz2z2awq1adc75bq4z1azjqwprcl16316ilfi";
        authors = [
          "Embark <opensource@embark-studios.com>"
          "Jake Shadle <jake.shadle@embark-studios.com>"
        ];
