...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gltfgen/v0.4.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gut" = rec {
        ...
        version = "0.4.7";
        edition = "2018";
        sha256 = "0dca94cj98hx3w8420cqwjwvzqp6wmq42minn5fbb91h8bxrjb36";
        authors = [
          "Egor Larionov <egor.larionov@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "io" "vtkio" ];
      };
      "gut-derive" = rec {
