...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gltfgen/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gltfgen" = rec {
        ...
        resolvedDefaultFeatures = [ "empty-sparse-base-buffer-view" ];
      };
      "gut" = rec {
        crateName = "gut";
        version = "0.4.6";
        edition = "2018";
        sha256 = "1x1m810y7cddzfg16nvl120304kxcpg0lhpcnwkm1rcpnzc5lzb3";
        authors = [
          "Egor Larionov <egor.larionov@gmail.com>"
        ];
        dependencies = [
