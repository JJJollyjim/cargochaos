...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/drive-adv/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "64-column-tables" "bitflags" "default" "postgres" "pq-sys" "serde_json" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "drive-adv" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "drive-adv"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "diesel";
            packageId = "diesel";
            features = [ "postgres" "serde_json" "64-column-tables" ];
          }
          {
            name = "dotenv";
            packageId = "dotenv";
