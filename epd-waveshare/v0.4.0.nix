...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/epd-waveshare/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "epd-waveshare" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "embedded-graphics" "graphics" "type_a_alternative_faster_lut" ];
      };
      "i2cdev" = rec {
        crateName = "i2cdev";
        version = "0.4.4";
