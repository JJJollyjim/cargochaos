...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-h1/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http-types" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1w0dfwsdrwqirpxxj1z604vhjqpd790ya1q51hca3hs1m5vrmvgx";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
        dependencies = [
      ...
      "infer" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0fa9w9ic2d7zydw98mhv3js5d4w312n1m8hl0xp0ff8784zz67qv";
        authors = [
