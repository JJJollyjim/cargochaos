...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/speedruns/v0.21.6-dev.36.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "remain" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "125qvj48zhj5glfynhqa10vhak6898a5hgdaznk8s364gwi63j4r";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "speedruns" = rec {
        crateName = "speedruns";
        version = "0.21.6-dev.36";
        edition = "2018";
        crateBin = [
          { name = "speedruns"; path = "src/bin/speedruns.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.21.6-dev.36.nix {};
        libPath = "src/lib/speedruns.rs";
        authors = [
        ...
        dependencies = [
          ...
          {
            name = "speedruns_utils";
            packageId = "speedruns_utils";
          }
          {
            name = "tempfile";
            packageId = "tempfile";
      ...
      "speedruns_utils" = rec {
        crateName = "speedruns_utils";
        version = "0.21.6-dev.36";
        edition = "2018";
        sha256 = "1nysi1zz1qzfz8qxsalfl26ar21rdhi4yzdpaa39ibwyy4i98wiy";
        libPath = "mod.rs";
        authors = [
          "Jeremy Banks <_@jeremy.ca>"
        ];
