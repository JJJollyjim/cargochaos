...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-node/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-node" = rec {
        crateName = "cargo-node";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-node"; path = "src/main.rs"; }
        ];
      ...
      "sigma" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0vyfn68pfz0jlc4jr3wmnbvkmj7aw2dfgj6bx9j865p66ld5qgv4";
        authors = [
