...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-analytics3-cli/v1.0.13+20190807.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-analytics3" = rec {
        ...
        edition = "2015";
        sha256 = "1bhddapxs9p0cjpp8xyhci9nwnn3crb7pd8d2jwf9h4937lr4nap";
        authors = [
      ...
      "google-analytics3-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20190807.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
