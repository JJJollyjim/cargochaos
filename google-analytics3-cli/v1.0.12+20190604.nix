...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-analytics3-cli/v1.0.12+20190604.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-analytics3-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-analytics3" = rec {
        crateName = "google-analytics3";
        version = "1.0.12+20190604";
        edition = "2015";
        sha256 = "0a53wqyizihlfhckvvmmdksd0wi5gl2w9i6n3gj8rxvqf5xh1vsa";
        authors = [
      ...
      "google-analytics3-cli" = rec {
        crateName = "google-analytics3-cli";
        version = "1.0.12+20190604";
        edition = "2015";
        crateBin = [
          { name = "analytics3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190604.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
