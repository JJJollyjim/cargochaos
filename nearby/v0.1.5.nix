...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nearby/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitops" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0zm5sk168v7q3m8k3nw17y6xvap7qy6x4pf93gz258zvn4y746pl";
        authors = [
          "Ross MacArthur <macarthur.ross@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-integer";
      ...
      "nearby" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "nearby"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.5.nix {};
        authors = [
          "Flavio <flavio@wisespace.io>"
        ];
        dependencies = [
          {
            name = "actix";
      ...
      "radiotap" = rec {
        ...
        version = "1.3.0";
        edition = "2015";
        sha256 = "0jirr3s0sqzmnccg8sgymc5znqzaxy3rl5h5swga98lr4w1mf1z5";
        authors = [
          "Ross MacArthur <macarthur.ross@gmail.com>"
        ];
        dependencies = [
