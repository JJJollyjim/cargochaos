...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_auth_aad/v0.42.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_auth_aad" = rec {
        ...
        version = "0.42.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.42.1.nix {};
        authors = [
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "0i41zr6jxhd4r2fmqwzkn8d4dd22a9qjpyk0zily97ri7nwqfg0n";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
