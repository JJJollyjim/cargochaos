...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_auth_aad/v0.41.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.40.0";
        edition = "2018";
        sha256 = "03fp85kfwpk7wzvx1mi8z7z935aaardz7xab5vp1ji07k7ihnl1k";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
      ...
      "oauth2" = rec {
        ...
        resolvedDefaultFeatures = [ "async-trait" "futures-0-3" "futures-03" "http-0-2" "reqwest-0-10" "reqwest-010" ];
      };
      "openssl" = rec {
        crateName = "openssl";
        version = "0.10.28";
