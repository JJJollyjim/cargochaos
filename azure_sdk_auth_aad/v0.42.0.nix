...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_auth_aad/v0.42.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_auth_aad" = rec {
        ...
        version = "0.42.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.42.0.nix {};
        authors = [
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.40.1";
        edition = "2018";
        sha256 = "1jlc8m6c80y4b5b2ykkz3fvk645qh8yhbp6a27xpd0rjdph1xqhk";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
