...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_auth_aad/v0.35.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "azure_sdk_auth_aad" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "oauth2";
            usesDefaultFeatures = false;
            features = [ "reqwest-010" "futures-03" ];
          }
          {
            name = "rand";
      ...
      "oauth2" = rec {
        ...
        edition = "2018";
        sha256 = "0zz5n2s3bz76j2qc04208db03hxrrymry27qkxzslhnzxbr5czs4";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ...
        resolvedDefaultFeatures = [ "async-trait" "futures-0-3" "futures-03" "reqwest-0-10" "reqwest-010" ];
      };
      "openssl" = rec {
        crateName = "openssl";
        version = "0.10.26";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "default-tls" "futures-channel-preview" "hyper-tls" "json" "native-tls" "serde_json" "tls" "tokio-tls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.9";
