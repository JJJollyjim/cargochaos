...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/azure_sdk_auth_aad/v0.30.0.nix.tmp"
    ...
    crates = {
      ...
      "azure_sdk_auth_aad" = rec {
        ...
        dependencies = [
          ...
          {
            name = "reqwest";
            packageId = "reqwest 0.10.0-alpha.2";
            features = [ "json" ];
          }
          {
            name = "serde";
      ...
      "azure_sdk_core" = rec {
        ...
        version = "0.30.0";
        edition = "2018";
        sha256 = "10vzfr8gdncmjzlk0w4zsydjv2w2vnzp4fkw6nlyam62wc5658rb";
        authors = [
          "Francesco Cogno <francesco.cogno@outlook.com>"
      ...
      "futures-util-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "channel" "compat" "default" "futures-channel-preview" "futures-io-preview" "futures-join-macro-preview" "futures-select-macro-preview" "futures-sink-preview" "futures_01" "io" "join-macro" "memchr" "proc-macro-hack" "proc-macro-nested" "select-macro" "sink" "slab" "std" ];
      };
      "generic-array" = rec {
      ...
      "oauth2" = rec {
        ...
        edition = "2015";
        sha256 = "1m2ady3i98nam56zp70w1fgid401963xshs32ay1ql4lpz0q5ydk";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
      ...
      "reqwest 0.10.0-alpha.2" = rec {
        ...
        dependencies = [
          ...
          {
            name = "hyper-tls";
            packageId = "hyper-tls 0.4.0-alpha.4";
            optional = true;
            target = { target, features }: (!(target."arch" == "wasm32"));
          }
          {
