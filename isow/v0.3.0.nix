...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/isow/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "isocal" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "11dxgv9w5h9w136g47rjxs5a5rnq0kbw2l6wz9f1j735sb6da580";
        authors = [
          "Anthony Foxclaw"
        ];
        dependencies = [
      ...
      "isow" = rec {
        ...
        resolvedDefaultFeatures = [ "self_update" "updater" ];
      };
      "itoa" = rec {
        crateName = "itoa";
        version = "0.4.5";
      ...
      "self_update" = rec {
        ...
        version = "0.11.1";
        edition = "2018";
        sha256 = "1vydslzljlkhd5iabd2jgp555igi8mihgjxypa0x2si60jpliihm";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
