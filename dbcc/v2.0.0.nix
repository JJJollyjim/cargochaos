...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dbcc/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "can-dbc" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "1m8vnwndk4kgn01lpqx3ig78l709ah1v1i78fxg6b3c6pnx1gg1r";
        authors = [
      ...
      "tokio-socketcan-bcm" = rec {
        crateName = "tokio-socketcan-bcm";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1mvybyj5wppdlrx566vdvnhbik0kwyqb38a11rnqm2qyrb8kq6nc";
        authors = [
          "marcelbuesing <buesing.marcel@googlemail.com>"
        ];
        dependencies = [
