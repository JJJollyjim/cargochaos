...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lnd-rust/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lnd-rust" = rec {
        ...
        authors = [
          "LightningPeach <contact@lightningpeach.com>"
        ];
        dependencies = [
          {
            name = "bytes";
      ...
      "tls-api-native-tls" = rec {
        crateName = "tls-api-native-tls";
        version = "0.1.22";
        edition = "2015";
        sha256 = "0qz7bhh8pjv1jrbnzajy1rd08ns21aaxz192as9j2kyav9ffiggm";
        authors = [
          "Stepan Koltsov <stepan.koltsov@gmail.com>"
        ];
        dependencies = [
