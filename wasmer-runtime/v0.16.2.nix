...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasmer-runtime/v0.16.2.nix.tmp"
    ...
    crates = {
      ...
      "cranelift-codegen" = rec {
        ...
        dependencies = [
          ...
          {
            name = "target-lexicon";
            packageId = "target-lexicon 0.10.0";
          }
          {
            name = "thiserror";
            packageId = "thiserror";
      ...
      "wasmer-clif-backend" = rec {
        ...
        version = "0.16.2";
        edition = "2018";
        sha256 = "15ykaqjbynblvra2gi1kccg0fq8ngrahs05qrwzi1nkb3lfdrk75";
        authors = [
      ...
      "wasmer-runtime" = rec {
        ...
        resolvedDefaultFeatures = [ "cache" "cranelift" "default" "default-backend-cranelift" "default-backend-singlepass" "deterministic-execution" "docs" "singlepass" "wasmer-clif-backend" "wasmer-singlepass-backend" ];
      };
      "wasmer-runtime-core" = rec {
        crateName = "wasmer-runtime-core";
        version = "0.16.2";
        edition = "2018";
        sha256 = "18hvxdixi4njy6zg92i01grpypbyzgyw04lar0vb33h09nqbsclf";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "deterministic-execution" ];
      };
      "wasmer-singlepass-backend" = rec {
        crateName = "wasmer-singlepass-backend";
        version = "0.16.2";
        edition = "2018";
        sha256 = "1h49mf8bbri4gdm22rj71n7za30h0q19ig8hc2gd5lf82p7m1y5l";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "deterministic-execution" ];
      };
      "wasmer-win-exception-handler" = rec {
        crateName = "wasmer-win-exception-handler";
        version = "0.16.2";
        edition = "2018";
        sha256 = "138v1an4q3ng9sgzf3xcwa4xmpwisqcwmk5lsnrrxavns0hdv7bx";
        authors = [
          "The Wasmer Engineering Team <engineering@wasmer.io>"
        ];
        dependencies = [
      ...
      "wasmparser" = rec {
        ...
        resolvedDefaultFeatures = [ "deterministic" ];
      };
      "winapi" = rec {
        crateName = "winapi";
        version = "0.3.8";
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" ];
      };
