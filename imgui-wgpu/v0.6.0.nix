...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imgui-wgpu/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgui-wgpu" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "glsl-to-spirv" ];
      };
      "imgui-winit-support" = rec {
        crateName = "imgui-winit-support";
        version = "0.3.1";
        edition = "2018";
        sha256 = "027z981xz8qkqr81kd7n2mq9m2cnmippnkwwgwvmb5gfgb8wg1an";
        authors = [
          "Joonas Javanainen <joonas.javanainen@gmail.com>"
          "imgui-rs contributors"
        ];
