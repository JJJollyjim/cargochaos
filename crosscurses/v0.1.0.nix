...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crosscurses/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crosscurses" = rec {
        ...
        resolvedDefaultFeatures = [ "disable_resize" "show_menu" "wide" "win32" "win32a" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.14";
      ...
      "pdcurses-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "win32" "win32a" ];
      };
      "pkg-config" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "timezoneapi" "winerror" "winnt" "winreg" ];
      };
