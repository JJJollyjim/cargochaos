...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hnsw_rs/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rayon" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "1prfy56x7kh02a5ffm4398ic751f2cmdcnkmvkgznky9jj9x00pd";
        authors = [
      ...
      "simdeez" = rec {
        ...
        version = "0.6.6";
        edition = "2018";
        sha256 = "1lm7ymvsw5s0zg129vkwnggczwlpk52vv08v0nlz5vfy2mc7nm6j";
        authors = [
      ...
      "skiplist" = rec {
        ...
        version = "0.2.10";
        edition = "2015";
        sha256 = "157b91jdww4rw86bki4v83mny8dr7cz4r362x9gm52g7yvi7wwxp";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "impl-debug" "impl-default" "ktmw32" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" ];
      };
