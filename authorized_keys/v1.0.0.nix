...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/authorized_keys/v1.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "authorized_keys" = rec {
        crateName = "authorized_keys";
        version = "1.0.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        authors = [
          "Liam Dawson <liam@ldaws.com>"
        ];
        dependencies = [
          {
            name = "data-encoding";
        ...
        resolvedDefaultFeatures = [ "data-encoding" "default" "key_encoding" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "0.1.6";
