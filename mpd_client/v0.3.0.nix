...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mpd_client/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mpd_client" = rec {
        crateName = "mpd_client";
        version = "0.3.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Ole Bertram <git@bertr.am>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "mpd_protocol" = rec {
        crateName = "mpd_protocol";
        version = "0.7.0";
        edition = "2018";
        sha256 = "17s9anhzq6rvvpfy8dxqs4xnbv27ssniy7n1hg5vl4zj6aiijrh7";
        authors = [
          "Ole Bertram <git@bertr.am>"
        ];
        dependencies = [
