...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-broker/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-http 0.2.5" = rec {
        crateName = "actix-http";
        version = "0.2.5";
        edition = "2018";
        sha256 = "1dhjr5ldgvr44j7910l4b6b78kq8phs4h0ifxfd0wy9cfwrivh99";
        libName = "actix_http";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-rt 0.2.3" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "1y2rwyap3a1prl785rda83nc8q905l34lz0pzm4m3cjc00krdq31";
        libName = "actix_rt";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-utils 0.4.2" = rec {
        crateName = "actix-utils";
        version = "0.4.2";
        edition = "2018";
        sha256 = "051w7l9dwwp9ssjksqbxh9lk78icm2vdcn48rm0k15jc0wfj01xk";
        libName = "actix_utils";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "actix-web" = rec {
        ...
        version = "1.0.3";
        edition = "2018";
        sha256 = "1wlgkssii4bwfbmsa9cszd0kabhcw9p9rbb8yfqfxf845nv7mp6h";
        libName = "actix_web";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "resolv-conf" = rec {
        ...
        version = "0.6.1";
        edition = "2015";
        sha256 = "14hs950j56j8rvc9d8axgsp8x3aawr8rkbm2zkvzs7l485ddjay6";
        libName = "resolv_conf";
        authors = [
          "paul@colomiets.name"
        ];
      ...
      "serde_json" = rec {
        ...
        version = "1.0.30";
        edition = "2015";
        sha256 = "1021isra9cfy52v0lnsjbib9wi9icmj3pa4spvdkwp6izsba4q3z";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "tokio-signal" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "1gxpwr4pp56pkfpysjkrxa5hkivqnma6sj78vr798r12jf9312dn";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
