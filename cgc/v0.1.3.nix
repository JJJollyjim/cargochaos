...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cgc/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cgc" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            target = { target, features }: target."windows";
            features = [ "winuser" "memoryapi" "errhandlingapi" ];
          }
        ];
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winuser" ];
      };
      "winapi-build" = rec {
