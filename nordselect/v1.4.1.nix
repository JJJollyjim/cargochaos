...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nordselect/v1.4.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nordselect" = rec {
        crateName = "nordselect";
        version = "1.4.1";
        edition = "2018";
        crateBin = [
          { name = "nordselect"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.4.1.nix {};
        authors = [
          "Ward Segers <w@rdsegers.be>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "oping" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0vqnd2syl01x3crfp1h3794qdg7k5pk8548vljfs1bdrv98hv069";
        authors = [
