...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-monitoring3-cli/v1.0.12+20190629.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-monitoring3-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-monitoring3" = rec {
        crateName = "google-monitoring3";
        version = "1.0.12+20190629";
        edition = "2015";
        sha256 = "1x6ldi5x1qi99hw4ssi7kbbxfw70mrcwmin5y2ag7gycfbs1ipak";
        authors = [
      ...
      "google-monitoring3-cli" = rec {
        crateName = "google-monitoring3-cli";
        version = "1.0.12+20190629";
        edition = "2015";
        crateBin = [
          { name = "monitoring3"; path = "src/main.rs"; }
        ];
