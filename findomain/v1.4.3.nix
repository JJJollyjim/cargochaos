...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/findomain/v1.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "findomain" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.4.3.nix {};
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "udp" "uds" ];
      };
      "tokio-postgres" = rec {
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-rustls" "dns-over-tls" "ipconfig" "resolv-conf" "rustls" "system-config" "tokio" "tokio-runtime" "tokio-rustls" "trust-dns-rustls" "webpki-roots" ];
      };
