...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/findomain/v1.3.0-rc.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "findomain" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.3.0-rc.1.nix {};
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "udp" "uds" ];
      };
      "tokio-postgres" = rec {
      ...
      "trust-dns-proto" = rec {
        ...
        version = "0.19.2";
        edition = "2018";
        sha256 = "0fq6d0liahpakzc98xp78hvwqf8nsg32xr02lrqmja7slz9id0ys";
      ...
      "trust-dns-resolver" = rec {
        ...
        version = "0.19.2";
        edition = "2018";
        sha256 = "0xsal5w91a1whx3zjlq0d24rpbvdlwick71jhhx283alj6vqf7ab";
      ...
      "trust-dns-rustls" = rec {
        ...
        version = "0.19.2";
        edition = "2018";
        sha256 = "105wgszqia3136sy4kh0dfm4naa00mihpabw8aksph4mm0fv3anw";
