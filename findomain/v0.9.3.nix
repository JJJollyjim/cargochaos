...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/findomain/v0.9.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-rustls" "dns-over-tls" "rustls" "tokio" "trust-dns-rustls" "webpki-roots" ];
      };
      "trust-dns-rustls" = rec {
        crateName = "trust-dns-rustls";
        version = "0.7.0";
        edition = "2015";
        sha256 = "0glpggq31764q7lp19h5l6implsr7ik015qkm5rg7pqwy93krsb3";
