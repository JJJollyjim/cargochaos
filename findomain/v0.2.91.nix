...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/findomain/v0.2.91.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "findomain" = rec {
        ...
        src = pkgs.callPackage ./tarball-v0.2.91.nix {};
        authors = [
