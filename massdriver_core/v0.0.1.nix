...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/massdriver_core/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "massdriver_core" = rec {
        crateName = "massdriver_core";
        version = "0.0.1";
        edition = "2015";
        crateBin = [
          { name = "massdriver_core"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Siddhant <me@madebysid.com>"
        ];
        dependencies = [
          {
            name = "gio";
