...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/convenient-skiplist/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "checkers" = rec {
        ...
        version = "0.5.2";
        edition = "2018";
        sha256 = "038378rm49zn42gdxnbygigakrcw5ixvcjhxk7ralj45xp8ghyrf";
        authors = [
          "John-John Tedro <udoprog@tedro.se>"
        ];
        dependencies = [
          {
            name = "checkers-macros";
            packageId = "checkers-macros";
          }
          {
            name = "fxhash";
            packageId = "fxhash";
        ...
        resolvedDefaultFeatures = [ "default" "fxhash" "realloc" ];
      };
      "checkers-macros" = rec {
        crateName = "checkers-macros";
        version = "0.5.0";
        edition = "2018";
        sha256 = "1wd3z5h9dplp9v9lg4nhs9py7hw0q576cybls92343yx4h6rb4qs";
        procMacro = true;
        authors = [
          "John-John Tedro <udoprog@tedro.se>"
        ];
