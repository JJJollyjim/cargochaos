...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gnuplot/v0.0.33.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "argparse-rs" = rec {
        crateName = "argparse-rs";
        version = "0.1.0";
        edition = "2015";
        sha256 = "042kyri24pjv68iaj42h80smgsxb5dnk86na8m8faj5xcxckgdw6";
        authors = [
