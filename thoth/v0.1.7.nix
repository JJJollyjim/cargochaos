...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thoth/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "prepush-hook" "run-cargo-check" "run-cargo-clippy" "run-cargo-fmt" "run-cargo-test" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "bitflags" "chrono" "default" "postgres" "pq-sys" "r2d2" "uuidv07" "with-deprecated" ];
      };
      "diesel-derive-enum" = rec {
        crateName = "diesel-derive-enum";
        version = "0.4.4";
        edition = "2015";
        sha256 = "1d9g1ya1f9xr6g2h8dvbn9di3i3grv1jvbffs72fvpjf6khzbfmd";
        procMacro = true;
      ...
      "dotenv" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "06f0jj7kj1csia1sm6n4zqisy32bs1srm7awaj7vvkswwrzk82s0";
        authors = [
      ...
      "thoth" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "thoth"; path = "src/bin/thoth.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.7.nix {};
        authors = [
          "Javier Arias <javi@openbookpublishers.com>"
        ];
        dependencies = [
          {
            name = "actix-http";
          ...
          }
          {
            name = "diesel";
            packageId = "diesel";
            features = [ "postgres" "uuidv07" "chrono" "r2d2" ];
          }
          {
        ...
        devDependencies = [
          {
            ...
            usesDefaultFeatures = false;
            features = [ "prepush-hook" "run-cargo-check" "run-cargo-test" "run-cargo-clippy" "run-cargo-fmt" ];
          }
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
