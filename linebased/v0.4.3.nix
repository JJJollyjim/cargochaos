...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linebased/v0.4.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linebased" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "tcp" "sync" "rt-core" "io-util" "blocking" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "sync" "tcp" "tokio-macros" ];
      };
      "tokio-macros" = rec {
