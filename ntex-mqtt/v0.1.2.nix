...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ntex-mqtt/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ntex" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "0gcmi1cnc73xm4lgvgaiqdmihdr5vvl8n6rwpvqk5a6jvmb2wqs4";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "ntex-codec";
            packageId = "ntex-codec";
          }
          {
            name = "ntex-macros";
            packageId = "ntex-macros";
          }
          {
            name = "ntex-router";
            packageId = "ntex-router";
          }
          {
            name = "ntex-rt";
            packageId = "ntex-rt";
          ...
          {
            name = "ntex-rt-macros";
            packageId = "ntex-rt-macros";
          }
          {
            name = "ntex-service";
            packageId = "ntex-service";
          }
          {
            name = "num_cpus";
            packageId = "num_cpus";
      ...
      "ntex-codec" = rec {
        crateName = "ntex-codec";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0vh1pwfp99b9cnr668ah0p0x04c6phhaiqq105mxprcmqr42cxzz";
        libName = "ntex_codec";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "ntex-macros" = rec {
        crateName = "ntex-macros";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0gqldbchvjzjz9vwgxsinikfhm3cxj7mx8vcklagw084y5dhz6w4";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "ntex-router" = rec {
        crateName = "ntex-router";
        version = "0.3.4";
        edition = "2018";
        sha256 = "1kwa6z84y8msmw82bf7n15wa53w1rdb05v8wlfnixcyqx4rcqrxb";
        libName = "ntex_router";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "ntex-rt" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1dwlsf7drrib2zg9bvpjd3yiqizp5yz6ckc7lja95iprzcjwm3wk";
        libName = "ntex_rt";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "ntex-rt-macros" = rec {
        crateName = "ntex-rt-macros";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1k2qm6a64vx4rx6bgrrl1n91xg59zfcnz90ra45hyz4rhyr135c0";
        procMacro = true;
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "ntex-service" = rec {
        crateName = "ntex-service";
        version = "0.1.0";
        edition = "2018";
        sha256 = "069ymsb8hr7bfr1jq8lkvrbia1c8paqxg52zbaqcj24vpi98hm15";
        libName = "ntex_service";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
