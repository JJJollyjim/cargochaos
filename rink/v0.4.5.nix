...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rink/v0.4.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "chrono-humanize" = rec {
        ...
        version = "0.0.6";
        edition = "2015";
        sha256 = "0kysk2jwywhys2s6a4i0bjacss8l1b9plx1wazny9c40c91v3bwj";
        authors = [
      ...
      "chrono-tz" = rec {
        ...
        version = "0.2.5";
        edition = "2015";
        sha256 = "0synlfgwm1lybj49cl31x95p206jgv5fqhd3a4lh6m7iyfaqchs5";
        authors = [
          "Djzin"
        ];
        dependencies = [
      ...
      "ipc-channel" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "0wg5b6q119s2v18q870kzmakiy12iy4gkzgx0gfmcryy1r1qfmb7";
        authors = [
          "The Servo Project Developers"
        ];
        dependencies = [
          ...
          {
            name = "uuid";
            packageId = "uuid 0.3.1";
            target = { target, features }: ((target."os" == "windows") || (target."os" == "android"));
            features = [ "v4" ];
          }
        ];
      ...
      "json" = rec {
        ...
        version = "0.10.3";
        edition = "2015";
        sha256 = "0p0n03b6kvx0c9j43vw1icrwvq7svr9qpgmx8dzqzhyvq084byzk";
        authors = [
      ...
      "linefeed" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1djk9r88rg3fn61hjsk53g40any8x9rzm8xp4krx1lp7wiqaa08k";
        authors = [
      ...
      "rink" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "rink"; path = "src/bin/rink.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "chrono-humanize" "currency" "default" "gpl" "ipc-channel" "json" "libc" "linefeed" "nightly" "reqwest" "sandbox" "serde" "serde_derive" "xml-rs" ];
      };
      "rust-gmp" = rec {
        crateName = "rust-gmp";
        version = "0.5.0";
        edition = "2015";
        sha256 = "01nrwlhpjhfib8bsw0zlgzbh7r9xjmbqa67ym6b0nwymk24z5pf3";
        libName = "gmp";
        authors = [
      ...
      "serde 1.0.101" = rec {
        ...
        dependencies = [
          {
            name = "serde_derive";
            packageId = "serde_derive 1.0.102";
            optional = true;
          }
        ];
        devDependencies = [
      ...
      "serde_codegen" = rec {
        crateName = "serde_codegen";
        version = "0.8.23";
        edition = "2015";
        sha256 = "1k159iz89p9rjfmh02q5frj8z84qchmadnimjm7rin4762ixiid4";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "with-syn" ];
      };
      "serde_codegen_internals" = rec {
        crateName = "serde_codegen_internals";
        version = "0.11.3";
        edition = "2015";
        sha256 = "01p83ar87nd4fjnwwps3csnc4id816jy78p4h3rmky09l0j7kbdg";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
        ];
        dependencies = [
      ...
      "serde_derive 0.8.23" = rec {
        crateName = "serde_derive";
        version = "0.8.23";
        edition = "2015";
        sha256 = "01jkmw0a9zs4bvxjpqmrgfbgpg9yrjvmflw7kk9fjfab4vsfai6f";
        procMacro = true;
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
        ];
      ...
      "syn 0.10.8" = rec {
        ...
        resolvedDefaultFeatures = [ "aster" "default" "parsing" "printing" "quote" "unicode-xid" "visit" ];
      };
      "syn 1.0.7" = rec {
        crateName = "syn";
        version = "1.0.7";
      ...
      "uuid 0.3.1" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "0qni2i2h45h7rfprsh935j2990ffyvcckwxs6wpy5xyaarqzb7qs";
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
