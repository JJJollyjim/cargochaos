...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-web-condition-middleware/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "actix-web-condition-middleware";
  ...
  workspaceMembers = {
    "actix-web-condition-middleware" = rec {
      packageId = "actix-web-condition-middleware";
      build = internal.buildRustCrateWithFeatures {
        packageId = "actix-web-condition-middleware";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-connect" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "144f4cxs8khgdj5mvhbb3ilnx115yg62ibd8ghkdpxkkxk851zx0";
      ...
      "actix-web-condition-middleware" = rec {
        crateName = "actix-web-condition-middleware";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "κeen <3han5chou7@gmail.com>"
        ];
        dependencies = [
          {
            name = "actix-service";
