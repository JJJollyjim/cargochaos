...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vhdl_parser/v0.13.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vhdl_parser" = rec {
        crateName = "vhdl_parser";
        version = "0.13.0";
        edition = "2018";
        crateBin = [
          { name = "vhdl_parser"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "objbase" "processenv" "shlobj" "std" "winbase" "winerror" "winnt" "winuser" ];
      };
