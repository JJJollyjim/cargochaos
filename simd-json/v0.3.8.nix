...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simd-json/v0.3.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alloc_counter" = rec {
        ...
        version = "0.0.4";
        edition = "2018";
        sha256 = "1agxzprqi37bcy9hh3clbsl3n0awbb34vrlv4rp5afib8w53m31s";
        authors = [
        ...
        resolvedDefaultFeatures = [ "alloc_counter_macro" "default" "macros" "std" ];
      };
      "alloc_counter_macro" = rec {
        crateName = "alloc_counter_macro";
        version = "0.0.2";
        edition = "2018";
        sha256 = "0nifqalryavmrdlkyv7cznp8yfjj16x0bjqzvjndw0fxk8gzhlhs";
        procMacro = true;
        libPath = "lib.rs";
        authors = [
          "The SiO4 Project Developers <https://gitlab.com/sio4>"
      ...
      "simd-json" = rec {
        ...
        resolvedDefaultFeatures = [ "128bit" "alloc" "alloc_counter" "allow-non-simd" "beef" "bench-serde" "colored" "default" "getopts" "hints" "jemallocator" "known-key" "neon" "no-inline" "perf" "perfcnt" "safe" "serde" "serde_impl" "serde_json" "simd-lite" "swar-number-parsing" ];
      };
      "simd-lite" = rec {
        crateName = "simd-lite";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0qim5gpyglc3846362xcp7dkc2ac8rrqirwcr9qji8j8n0bk11pc";
        authors = [
          "Sunny Gleason"
          "Heinz N. Gies <heinz@licenser.net>"
        ];
      ...
      "value-trait" = rec {
        ...
        version = "0.1.8";
        edition = "2018";
        sha256 = "1x57mqs68zfffkmjiwj3d293dr76zrcsz9j5h85ybj3045h094ns";
        authors = [
          "Heinz N. Gies <heinz@licenser.net>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "128bit" "neon" "simd-lite" ];
      };
      "version_check" = rec {
