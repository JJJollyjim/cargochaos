...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/motion_list_rs/v1.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "compile-time-crc32" = rec {
        crateName = "compile-time-crc32";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0sm3x4cfxjg7bylvsm024hmbdz2b50biff8c991dp1pvnzcsd7r7";
        authors = [
        ...
        dependencies = [
          {
            ...
            packageId = "compile-time-crc32-impl";
          }
          {
      ...
      "compile-time-crc32-impl" = rec {
        crateName = "compile-time-crc32-impl";
        version = "0.1.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0gc2xwsggl0i1w9v0h1vlhviji85dmihp527wy98cnpwnsbpiihc";
        procMacro = true;
        authors = [
          "jam1garner <jam1.mcleod@hotmail.com>"
        ];
      ...
      "hash40" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1h2wzv8i0f2p3g28nd7hbyc44a0khwvfqa45c4pgaz6aw26snr3x";
        authors = [
      ...
      "motion_list_rs" = rec {
        crateName = "motion_list_rs";
        version = "1.2.0";
        edition = "2018";
        crateBin = [
          { name = "yamlist"; path = "src/yamlist/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.2.0.nix {};
        libName = "motion_lib";
        libPath = "src/motion_lib/lib.rs";
        authors = [
          "BenHall-7 <benjaminjahall@gmail.com>"
        ];
        dependencies = [
