...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/atcoder-auto-tester/v0.9.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atcoder-auto-tester" = rec {
        crateName = "atcoder-auto-tester";
        version = "0.9.0";
        edition = "2018";
        crateBin = [
          { name = "atcoder-auto-tester"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.9.0.nix {};
        authors = [
          "Ark <target.ark@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
