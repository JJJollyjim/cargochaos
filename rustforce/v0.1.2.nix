...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustforce/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-license" = rec {
        crateName = "cargo-license";
        version = "0.2.0";
        edition = "2015";
        crateBin = [];
        sha256 = "1waa2zgnia2rm6b3nvp8il4r4dy39b6x80bgxgjk2aj36il5zcbh";
        authors = [
      ...
      "rustforce" = rec {
        ...
        authors = [
          "tzmfreedom <makoto_tajitsu@hotmail.co.jp>"
        ];
        dependencies = [
          {
            name = "reqwest";
