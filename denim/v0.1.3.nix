...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/denim/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cotton" = rec {
        ...
        version = "0.0.7";
        edition = "2018";
        sha256 = "0n3n67cigqam0yzx46v4xd3r9qjldcsr9v177r5icap01lb5pd5k";
        authors = [
      ...
      "duct" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0nfycvvnplkmzl4rxn8gnn2yyjd1wccm68nb80gcnx0nvgcq3f2x";
        authors = [
      ...
      "problem" = rec {
        ...
        version = "5.2.1";
        edition = "2015";
        sha256 = "14mjb1ghr5w7hybgwi90xxriv6yvfqd9kk0cv1066vvl9a2cv1l3";
        authors = [
          "Jakub Pastuszek <jpastuszek@protonmail.com>"
        ];
        dependencies = [
