...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imdb-rename/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bstr" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "1kc4qqwzq3zw2vf2jbzddz6wsr5v5fax1xn6ykbkvkimg1lvjc2b";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "imdb-index" = rec {
        crateName = "imdb-index";
        version = "0.1.3";
        edition = "2018";
        sha256 = "03954shhgcf72k7c47spmcki8z8w5phqdl6p8rn8kj69ilhyx5qi";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "imdb-rename" = rec {
        crateName = "imdb-rename";
        version = "0.1.5";
        edition = "2018";
        crateBin = [
          { name = "imdb-rename"; path = "src/main.rs"; }
        ];
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
