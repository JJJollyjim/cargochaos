...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darkredis/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "darkredis" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "default" "runtime_agnostic" "runtime_tokio" "tokio" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "tokio" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "0gaqj42c43an7wzs9c4k5vnv4pv3d2wpay66v6ylq56hp05ihi34";
        authors = [
