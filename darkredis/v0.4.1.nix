...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darkredis/v0.4.1.nix.tmp"
    ...
    crates = {
      ...
      "darkredis" = rec {
        ...
        features = {
          ...
          "runtime_tokio" = [ "tokio" "tokio-net" ];
        };
        resolvedDefaultFeatures = [ "async-std" "default" "runtime_agnostic" "runtime_tokio" "tokio" "tokio-net" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
