...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darkredis/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "tcp" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
