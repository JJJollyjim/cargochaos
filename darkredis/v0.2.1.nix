...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/darkredis/v0.2.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-datagram 2.2.0" = rec {
        crateName = "async-datagram";
        version = "2.2.0";
        edition = "2018";
        sha256 = "1bnigyl0cnj41gvcqwhqwjgzldi5ygy41b12yd0cby5h6m65kn23";
        authors = [
          "The Rust Async Ecosystem Working Group"
        ];
        
      };
      "async-datagram 3.0.0" = rec {
        crateName = "async-datagram";
        version = "3.0.0";
        edition = "2018";
      ...
      "futures-timer" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "1cdw184cadc40ld4zybvsc2n9d1dj46vsvjcji88crrm97l34jpb";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "romio" = rec {
        ...
        dependencies = [
          {
            name = "async-datagram";
            packageId = "async-datagram 3.0.0";
          }
          {
            name = "async-ready";
      ...
      "runtime" = rec {
        ...
        edition = "2018";
        sha256 = "0245139k7hcs4mw0zj3ybzj848y06yivzysna2anps4lnn76rndk";
        authors = [
          "The Rust Async Ecosystem Working Group"
        ];
        dependencies = [
      ...
      "runtime-attributes" = rec {
        ...
        edition = "2018";
        sha256 = "0lfbbgd30x1mzspspbjpa1xjmg903qh8dhxbh9zds7i4skf8kgzc";
        procMacro = true;
        authors = [
          "The Rust Async Ecosystem Working Group"
        ];
      ...
      "runtime-native" = rec {
        ...
        version = "0.3.0-alpha.5";
        edition = "2018";
        sha256 = "1x3c7bzp56hbq6dbm25j1hpfcisrx9mwc84h1207nnlwysah6q6d";
        authors = [
          "The Rust Async Ecosystem Working Group"
        ];
        dependencies = [
          {
            name = "async-datagram";
            packageId = "async-datagram 2.2.0";
      ...
      "runtime-raw" = rec {
        ...
        edition = "2018";
        sha256 = "03zsj6d8r4wipwvvs0zqgwv2639nvlafl00hcwfnr9n63d6kalbm";
        authors = [
          "The Rust Async Ecosystem Working Group"
        ];
        dependencies = [
