...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hexavalent/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hexavalent" = rec {
        crateName = "hexavalent";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "notdijon <61089563+notdijon@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
        ...
        resolvedDefaultFeatures = [ "__unstable_ircv3_line_in_event_attrs" "default" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.68";
