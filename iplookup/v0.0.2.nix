...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/iplookup/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iplookup" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "iplookup"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-core" "time" "udp" ];
          }
        ];
      ...
      "stun_codec" = rec {
        ...
        version = "0.1.12";
        edition = "2018";
        sha256 = "1k7c18a34fjmz15651kj05kd8ig17clkwwbhniv84mdjna274hj2";
        authors = [
          "Takeru Ohta <phjgt308@gmail.com>"
        ];
        dependencies = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "macros" "mio" "rt-core" "slab" "time" "tokio-macros" "udp" ];
      };
      "tokio-macros" = rec {
