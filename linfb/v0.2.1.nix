...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linfb/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linfb" = rec {
        ...
        authors = [
          "Maximilian Siling <mouse-art@ya.ru>"
        ];
        dependencies = [
          {
            name = "derive_builder";
        ...
        resolvedDefaultFeatures = [ "default" "font-loader" "image" "images" "lazy_static" "rusttype" "text" "xi-unicode" ];
      };
      "lzw" = rec {
        crateName = "lzw";
        version = "0.10.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "handleapi" "memoryapi" "minwindef" "std" "sysinfoapi" "wingdi" "winuser" ];
      };
