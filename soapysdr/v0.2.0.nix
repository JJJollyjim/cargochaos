...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/soapysdr/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "signalbool" = rec {
        crateName = "signalbool";
        version = "0.2.3";
        edition = "2018";
        sha256 = "0jg1v3w84cjq8rsrilnrr12040n08rnvzn8qp0mmzaz5ij29yias";
        authors = [
      ...
      "soapysdr" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "soapy-sdr-info"; path = "src/bin/soapy-sdr-info.rs"; }
          { name = "soapy-sdr-stream"; path = "src/bin/soapy-sdr-stream.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "signalbool";
            packageId = "signalbool";
            optional = true;
          }
          {
            name = "soapysdr-sys";
            packageId = "soapysdr-sys";
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "binaries" "byteorder" "default" "getopts" "log" "signalbool" ];
      };
      "soapysdr-sys" = rec {
        crateName = "soapysdr-sys";
        version = "0.7.0";
        edition = "2015";
        sha256 = "1i2l42lj124nhzvvrpf8zzp7vi26566kvknw2qlvxr5didw7zk15";
        authors = [
          "Kevin Mehall <km@kevinmehall.net>"
        ];
        buildDependencies = [
