...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/my-first-crate/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "my-first-crate" = rec {
        crateName = "my-first-crate";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "my-first-crate"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "philippe <phildoreau@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
