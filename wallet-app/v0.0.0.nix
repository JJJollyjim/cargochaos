...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wallet-app/v0.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wallet-app" = rec {
        crateName = "wallet-app";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "wallet-app"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.0.nix {};
        authors = [
          "Christian Mayer <christian@fox21.at>"
        ];
        dependencies = [
          {
            name = "clap";
          ...
          {
            name = "wallet-lib";
            packageId = "wallet-lib";
          }
        ];
        
      };
      "wallet-lib" = rec {
        crateName = "wallet-lib";
        version = "0.0.0";
        edition = "2018";
        sha256 = "069xlnz6mrrzs766i2i2kjrnh58pvcawhh4852bx6xf7kqdcb0r9";
        authors = [
          "Christian Mayer <christian@fox21.at>"
        ];
