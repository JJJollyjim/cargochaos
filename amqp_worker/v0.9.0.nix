...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amqp_worker/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin-futures" = rec {
        ...
        version = "0.28.4";
        edition = "2018";
        sha256 = "1nx3g37lnq8ykdfrdwmx6dlfbr2jhkxsgxw8b5am2wp02yx99cv8";
        authors = [
          "Geoffroy Couprie <geo.couprie@gmail.com>"
          "Marc-Antoine Perennou <Marc-Antoine@Perennou.com>"
        ];
