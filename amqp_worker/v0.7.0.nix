...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amqp_worker/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin" = rec {
        ...
        version = "0.25.0";
        edition = "2018";
        sha256 = "0qvg2w47qnn2n2agmpp0wh1nvzzkqzxlc6wrgdirbd151q1s0978";
        authors = [
          "Geoffroy Couprie <geo.couprie@gmail.com>"
      ...
      "lapin-futures" = rec {
        ...
        version = "0.25.0";
        edition = "2018";
        sha256 = "01jp67z5nkfzlznh007yzdc09779l0ax2yzx065s34aggqm7p8bj";
        authors = [
          "Geoffroy Couprie <geo.couprie@gmail.com>"
          "Marc-Antoine Perennou <Marc-Antoine@Perennou.com>"
        ];
