...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-http-server/v0.6.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "simple-http-server" = rec {
        crateName = "simple-http-server";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "simple-http-server"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.6.0.nix {};
        authors = [
          "thewawar <thewawar@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
