...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cddl/v0.3.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cddl" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "nightly" "serde" "serde_cbor" "serde_json" "std" "uriparse" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.9";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winnt" "winuser" ];
      };
