...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cddl/v0.3.18.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cddl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cddl"; path = "src/bin/cddl.rs"; }
          { name = "repl"; path = "src/bin/repl.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.18.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "console_error_panic_hook" "default" "nightly" "serde" "serde_cbor" "serde_json" "std" "uriparse" "wee_alloc" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
      ...
      "uriparse" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "0536603drya7gba5zwnvqi9hk30kld6hns356k1i81z4d7g4f0ai";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winnt" "winuser" ];
      };
