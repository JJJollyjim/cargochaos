...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cddl/v0.5.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cddl" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "clap" "console_error_panic_hook" "crossterm" "default" "nightly" "serde" "serde_cbor" "serde_json" "std" "uriparse" "wasm-bindgen" "wee_alloc" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
      ...
      "codespan-reporting" = rec {
        ...
        version = "0.9.2";
        edition = "2018";
        sha256 = "0zqhssjb4rs2h7qq1xgnd99sb47slpkxpnnrxlpfwp7lzpfsbz2f";
        authors = [
      ...
      "parking_lot" = rec {
        ...
        version = "0.10.1";
        edition = "2018";
        sha256 = "03gfigvrjnnxbdriwjr517c7nnyvkwm9kv7p4vipj2lk41gwppvg";
        authors = [
          "Amanieu d'Antras <amanieu@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
