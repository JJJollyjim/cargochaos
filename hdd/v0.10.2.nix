...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hdd/v0.10.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hdd" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "hdd"; path = "src/bin/hdd/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.2.nix {};
        authors = [
          "vthriller <unixway.drive+rs@gmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
        ...
        resolvedDefaultFeatures = [ "bin" "clap" "default" "env_logger" "lazy_static" "number_prefix" "prettytable-rs" "separator" "serde" "serde_derive" "serde_json" "serializable" ];
      };
      "hermit-abi" = rec {
