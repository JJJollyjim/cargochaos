...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket_upload/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "multipart" = rec {
        ...
        resolvedDefaultFeatures = [ "buf_redux" "client" "default" "httparse" "hyper" "iron" "mock" "nickel" "quick-error" "safemem" "server" "tiny_http" "twoway" ];
      };
      "mustache" = rec {
        crateName = "mustache";
        version = "0.9.0";
      ...
      "rocket_upload" = rec {
        crateName = "rocket_upload";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rocket_upload"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "andrew <andrewwang@sina.com>"
        ];
        dependencies = [
          {
            name = "multipart";
