...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/capstone/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "capstone" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "use_bindgen" ];
      };
      "capstone-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "bindgen" "default" "regex" "use_bindgen" ];
      };
      "cast" = rec {
        crateName = "cast";
        version = "0.2.3";
      ...
      "macho" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "011p1j9jlndbanmqy5y7lk1vn3mh4jk3chgjiw3wwnbfzkicdsvg";
        authors = [
          "Richo Healey <richo@psych0tik.net>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "libloaderapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
