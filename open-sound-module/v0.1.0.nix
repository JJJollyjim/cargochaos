...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/open-sound-module/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "open-sound-module" = rec {
        crateName = "open-sound-module";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "osm_cli"; path = "src/bin/osm_cli.rs"; }
        ];
