...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fromage_converter/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fromage_converter" = rec {
        crateName = "fromage_converter";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "fromage_converter"; path = "src/main.rs"; }
        ];
