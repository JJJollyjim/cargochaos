...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-youtube3-cli/v1.0.13+20200402.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-youtube3" = rec {
        crateName = "google-youtube3";
        version = "1.0.13+20200402";
        edition = "2015";
        sha256 = "0bq7fkhg27n6p6zzlnpmx2i99ixfszv1hwdkk38yyzyfs1809p28";
        authors = [
      ...
      "google-youtube3-cli" = rec {
        crateName = "google-youtube3-cli";
        version = "1.0.13+20200402";
        edition = "2015";
        crateBin = [
          { name = "youtube3"; path = "src/main.rs"; }
        ];
