...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/outline/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "outline" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "outline"; path = "src/bin/main.rs"; }
        ];
        ...
        features = {
          "bin" = [ "clap" "toml" "either" ];
        };
        resolvedDefaultFeatures = [ "bin" "clap" "either" "toml" ];
      };
      "proc-macro2" = rec {
