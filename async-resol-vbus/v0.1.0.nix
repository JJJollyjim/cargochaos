...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-resol-vbus/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "resol-vbus" = rec {
        crateName = "resol-vbus";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1scrq4z46sq925xr34ys1rac134qlm5q1b0m3mr52rkakga3zdid";
        authors = [
          "Daniel Wippermann <Daniel.Wippermann@gmail.com>"
        ];
        dependencies = [
