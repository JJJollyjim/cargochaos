...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_xxx/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_xxx" = rec {
        crateName = "guessing_game_xxx";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_xxx"; path = "src/main.rs"; }
        ];
