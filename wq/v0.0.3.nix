...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wq/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "derive" "serde_derive" ];
      };
      "serde_derive" = rec {
      ...
      "watson" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0x7p7pzldvifkqlp0f9216rbg4lqiwylpllw556nrk3fkbkpccl0";
        authors = [
          "Richard Anaya"
        ];
        dependencies = [
          ...
          {
            name = "webassembly";
            packageId = "webassembly";
          }
        ];
        
      };
      "webassembly" = rec {
        crateName = "webassembly";
        version = "0.5.0";
        edition = "2018";
        sha256 = "133sz94kcl9xyain192r89ixm1svqs4w4cyxrg7zkzyzvvhi06hx";
        authors = [
          "Richard Anaya"
        ];
