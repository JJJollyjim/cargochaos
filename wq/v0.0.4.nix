...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wq/v0.0.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "watson" = rec {
        ...
        version = "0.9.1";
        edition = "2018";
        sha256 = "02fv6zfj9yiwbh75nxjs9k4n6z533rkha147bl5lazjc2yb2a6jd";
        authors = [
          "Richard Anaya"
        ];
        dependencies = [
      ...
      "webassembly" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "0pf4v8pbx3iq3j7iwxmvqrdy9qppvgs685vvrc9yrmz27610qx1x";
        authors = [
          "Richard Anaya"
        ];
