...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reql/v0.0.27.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "protobuf" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0ss8fq6v5w1qspbm29q9mbjqxmvsrrvav0y4bycf1jlxcd74iqj0";
        authors = [
          "Stepan Koltsov <stepan.koltsov@gmail.com>"
        ];
        features = {
      ...
      "ql2" = rec {
        ...
        version = "1.1.2";
        edition = "2015";
        sha256 = "1vj91jpi8rgv1qnccp7nxd906li8i282iv5ai4z6iib2fl3s4ik7";
        authors = [
          "rushmorem <rushmore@webenchanter.com>"
        ];
        dependencies = [
      ...
      "reql-types" = rec {
        crateName = "reql-types";
        version = "0.0.4";
        edition = "2015";
        sha256 = "1mm2xs4sg4l4mm3klv4190njk1r0p1fmkx47mymf2r4hwfya08mh";
        authors = [
          "rushmorem <rushmore@webenchanter.com>"
        ];
        dependencies = [
      ...
      "scram" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "1br33r8jxjhf9mj7rp5shbb6awdc3a9m7apsn619h7yfd3x7hiiy";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "wtypesbase" ];
      };
