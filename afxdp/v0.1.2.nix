...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/afxdp/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "afxdp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "l2fwd-2link"; path = "src/bin/l2fwd-2link.rs"; }
          { name = "l2fwd-1link"; path = "src/bin/l2fwd-1link.rs"; }
        ];
      ...
      "libbpf-sys" = rec {
        ...
        version = "0.0.6-7";
        edition = "2018";
        sha256 = "1swdsfsxphl925jsg5x75jc1y5p3q2bjj8dmlxcwjc3a43ssvbhw";type = [ "lib" "staticlib" ];
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "minwinbase" "minwindef" "ntdef" "processenv" "winbase" ];
      };
