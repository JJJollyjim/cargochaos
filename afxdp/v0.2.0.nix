...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/afxdp/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libbpf-sys" = rec {
        ...
        version = "0.0.7-1";
        edition = "2018";
        sha256 = "0w9qwh7jdh57la2fdq3n6bmi531zvmqvv20g9syyvxb98srpsz6y";type = [ "lib" "staticlib" ];
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntdef" "processenv" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
