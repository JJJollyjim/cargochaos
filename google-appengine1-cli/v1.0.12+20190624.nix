...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-appengine1-cli/v1.0.12+20190624.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-appengine1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-appengine1" = rec {
        crateName = "google-appengine1";
        version = "1.0.12+20190624";
        edition = "2015";
        sha256 = "14iqzq8kchm6243wk18hrzqv8lndla9p1579ybs346ddm7x0s0p0";
        authors = [
      ...
      "google-appengine1-cli" = rec {
        crateName = "google-appengine1-cli";
        version = "1.0.12+20190624";
        edition = "2015";
        crateBin = [
          { name = "appengine1"; path = "src/main.rs"; }
        ];
