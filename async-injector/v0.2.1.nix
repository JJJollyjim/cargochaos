...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-injector/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-trait" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "0x5dmyhkvrbb1m3chpr94kp86jakn6ib88l8rkxiqhb1kqcav6zy";
        procMacro = true;
        authors = [
      ...
      "serde-hashkey" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1ig75sm814gsrg26wpaxhs9wgahhxhd4i9glphypy0wsw6si2yfg";
        authors = [
          "John-John Tedro"
        ];
        dependencies = [
