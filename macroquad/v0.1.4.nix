...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/macroquad/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "png" "png_codec" "tga" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
      ...
      "macroquad" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "log-impl" ];
      };
      "macroquad_macro" = rec {
        crateName = "macroquad_macro";
        version = "0.1.0";
        edition = "2018";
        sha256 = "02j6n0rxq7wq6wyqndcqfwzmlscyca8mfq65p1aa6p05vi72cg9y";
        procMacro = true;
        authors = [
          "not-fl3 <not.fl3@gmail.com>"
        ];
      ...
      "megaui" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "1v8bixblr46wbc952a6kqz6qpnfs85w73kh5rbs8bmmdplf3a2dg";
        authors = [
          "fl3 <not.fl3@gmail.com>"
        ];
      ...
      "miniquad" = rec {
        ...
        version = "0.2.53";
        edition = "2018";
        sha256 = "0azlab4yrjp5dbcjlslnq7lyr0hbb3mznx99h9393d6bjfifn47a";
        authors = [
          "not-fl3 <not.fl3@gmail.com>"
        ];
        dependencies = [
      ...
      "quad-gl" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "02f8d7y56m4f6yy6r1zqx2m6ma78s9xx197p8r0n35zb1b65qbyb";
        authors = [
          "not-fl3 <not.fl3@gmail.com>"
        ];
        dependencies = [
      ...
      "sapp-windows" = rec {
        ...
        version = "0.2.7";
        edition = "2018";
        sha256 = "0b3lcwd9f4h9zz2d6951889xfwb42h40z8jlasrc4z67izdg86xr";
        authors = [
          "not-fl3 <not.fl3@gmail.com>"
        ];
        dependencies = [
