...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bigml-parallel/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bigml" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1wcyy9a0kj0rj7mdfp4g31zppic56226awpl6yx67brbrz8hniik";
        authors = [
      ...
      "bigml-parallel" = rec {
        crateName = "bigml-parallel";
        version = "0.6.1";
        edition = "2018";
        crateBin = [
          { name = "bigml-parallel"; path = "src/main.rs"; }
        ];
      ...
      "bigml_derive" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "17pldh2wrwrbv3k8idk26xax9r1723m5c1h3la11gxc3jp1jqi9q";
        procMacro = true;
        authors = [
          "Eric Kidd <git@randomhacks.net>"
        ];
