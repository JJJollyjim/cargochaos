...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adexchangebuyer1d3-cli/v1.0.13+20191204.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adexchangebuyer1d3" = rec {
        ...
        edition = "2015";
        sha256 = "1rfni5jg6q977g7j9rf30vlhgqibfr9h1wl2q1dr184h1jmiqqxf";
        authors = [
      ...
      "google-adexchangebuyer1d3-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20191204.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
