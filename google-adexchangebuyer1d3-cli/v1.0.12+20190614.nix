...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-adexchangebuyer1d3-cli/v1.0.12+20190614.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-adexchangebuyer1d3-cli";
  ...
  workspaceMembers = {
    "google-adexchangebuyer1d3-cli" = rec {
      packageId = "google-adexchangebuyer1d3-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-adexchangebuyer1d3-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-adexchangebuyer1d3" = rec {
        crateName = "google-adexchangebuyer1d3";
        version = "1.0.12+20190614";
        edition = "2015";
        sha256 = "0pcqjd323jmxj0zdl2qzjbhbl7yw11npgj6y5mp97damx2aff32y";
        authors = [
      ...
      "google-adexchangebuyer1d3-cli" = rec {
        crateName = "google-adexchangebuyer1d3-cli";
        version = "1.0.12+20190614";
        edition = "2015";
        crateBin = [
          { name = "adexchangebuyer1d3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190614.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-adexchangebuyer1d3";
          }
          {
            name = "hyper";
            packageId = "hyper";
