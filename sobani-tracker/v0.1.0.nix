...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sobani-tracker/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sobani-tracker" = rec {
        crateName = "sobani-tracker";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "sobani-tracker"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Cocoa <kaoricocoa.neko@gmail.com>"
        ];
        dependencies = [
          {
            name = "async-std";
