...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crypto-literal/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crypto-literal" = rec {
        crateName = "crypto-literal";
        version = "0.1.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "bincode";
          ...
          }
          {
            ...
            packageId = "crypto-literal-algorithm";
          }
          {
            name = "crypto-literal-macro";
            packageId = "crypto-literal-macro";
          }
          {
            name = "derive_more";
      ...
      "crypto-literal-algorithm" = rec {
        crateName = "crypto-literal-algorithm";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0q287pvvy88girmspnv10sywyrzr205ps818rx5qfck0mg42pqqj";
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "crypto-literal-macro" = rec {
        crateName = "crypto-literal-macro";
        version = "0.1.1";
        edition = "2018";
        sha256 = "08l0028x3k30sbr6r8xkgln3cijwiza9jd6010hpqnh80zn0aqam";
        procMacro = true;
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
      ...
      "ofb" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "155q9fspk97hk1ls1yinzdzp1r6qa2gpj6m7wd2ix05iq1y7r1qa";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
