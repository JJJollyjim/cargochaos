...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spi-memory/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f4" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "stm32f401" ];
      };
      "stm32f4xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "device-selected" "stm32f401" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
