...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/itsybitsy_m0/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "itsybitsy_m0" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "unproven" "usb" "usb-device" "usbd-serial" "use_semihosting" ];
      };
      "memchr" = rec {
        crateName = "memchr";
        version = "2.3.0";
