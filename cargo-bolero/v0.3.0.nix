...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-bolero/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bolero-afl" = rec {
        crateName = "bolero-afl";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1zh66zg2i0zzrq3zmwrjlacf4csycazypvw9yi349vpjxrgsafy4";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bin" ];
      };
      "bolero-generator" = rec {
        crateName = "bolero-generator";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1nl97lzh42ilr36phnv5z4b0ga30549bzwg50maglfs4zmr3y2sm";
        authors = [
          "Cameron Bytheway <bytheway.cameron@gmail.com>"
        ];
        dependencies = [
          {
            name = "bolero-generator-derive";
            packageId = "bolero-generator-derive";
          }
          {
            name = "byteorder";
            packageId = "byteorder";
        ...
        features = {
          "default" = [ "alloc" "either" ];
          "std" = [ "alloc" "either/use_std" ];
        };
      };
      "bolero-generator-derive" = rec {
        crateName = "bolero-generator-derive";
        version = "0.3.0";
        edition = "2018";
        sha256 = "0zbziy6qwm15mrfali7wnr96s4w85a3nywcnwd5xq2i8ffljk66m";
        procMacro = true;
        authors = [
          "Cameron Bytheway <bytheway.cameron@gmail.com>"
        ];
      ...
      "bolero-honggfuzz" = rec {
        crateName = "bolero-honggfuzz";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1wb1dkqisd1iwc50vw7havyg3n12jyrayk24v3ly24i6sfgak6hw";
        authors = [
          "Cameron Bytheway <bytheway.cameron@gmail.com>"
        ];
        dependencies = [
      ...
      "cargo-bolero" = rec {
        crateName = "cargo-bolero";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-bolero"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          {
            name = "bolero-afl";
            packageId = "bolero-afl";
            features = [ "bin" ];
          }
          {
            name = "bolero-honggfuzz";
            packageId = "bolero-honggfuzz";
            features = [ "bin" ];
          }
          {
            name = "failure";
