...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sonos_discovery/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "socket" = rec {
        ...
        version = "0.0.7";
        edition = "2015";
        sha256 = "0lxkzqdlc7fba9qdmmxw0am22h4wf7fwkgc3xq1x15248bbwbw9n";
        authors = [
      ...
      "sonos_discovery" = rec {
        crateName = "sonos_discovery";
        version = "0.0.2";
        edition = "2015";
        crateBin = [
          { name = "sonos_discovery"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.2.nix {};
        authors = [
          "Chabare <chabare95@gmail.com>"
        ];
        dependencies = [
          {
            name = "socket";
