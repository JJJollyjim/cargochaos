...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fscmp/v0.2.16.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fscmp" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "loggest" "simplelog" ];
      };
      "fuchsia-cprng" = rec {
      ...
      "loggest" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0raap3alyla60a8phq3021zcqz9h132vz53ddig40dpfpbd8rya4";
        authors = [
          "Dror Levin <spatz@psybear.com>"
        ];
        dependencies = [
      ...
      "openat" = rec {
        ...
        version = "0.1.18";
        edition = "2015";
        sha256 = "16l18b7jcca5d2ikl7ybscl6sym0jk6vvwqb2xzzvqhvpwk7mrfc";
        authors = [
          "paul@colomiets.name"
        ];
        dependencies = [
