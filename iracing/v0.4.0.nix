...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/iracing/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iracing" = rec {
        ...
        authors = [
          "Leo Adamek <iracing.rs@breakerofthings.tech>"
        ];
        dependencies = [
          {
            name = "bitflags";
          ...
          }
          {
            name = "winapi";
            packageId = "winapi";
            features = [ "std" "memoryapi" "winnt" "errhandlingapi" "synchapi" "handleapi" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "memoryapi" "std" "synchapi" "winnt" ];
      };
