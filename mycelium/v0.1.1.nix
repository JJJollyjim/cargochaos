...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mycelium/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mycelium" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mycelium"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "matthew.bradford <matthew.bradford@tutanota.com>"
        ];
        dependencies = [
          {
            name = "mycelium_lib";
            packageId = "mycelium_lib";
          }
          {
            name = "tokio";
            packageId = "tokio";
      ...
      "mycelium_command" = rec {
        crateName = "mycelium_command";
        version = "0.1.1";
        edition = "2018";
        sha256 = "13dp0a3a56iy14wcy8ci3j6hqg228yyajch5xz3bdahj8c4plhyx";
        authors = [
          "matthew.bradford <matthew.bradford@tutanota.com>"
        ];
        dependencies = [
      ...
      "mycelium_core" = rec {
        crateName = "mycelium_core";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1zfqyg2x0vwrjdl6zazxq1a0j13dbvsnl06xa82cd71qvi7sjc84";
        authors = [
          "matthew.bradford <matthew.bradford@tutanota.com>"
        ];
        dependencies = [
          ...
          {
            name = "mycelium_command";
            packageId = "mycelium_command";
          }
          {
            name = "rayon";
            packageId = "rayon";
      ...
      "mycelium_experimental" = rec {
        crateName = "mycelium_experimental";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1m6s25wr7x875a57py6dqp4gk0ybnb4fi75brxxl0h6drv1flify";
        authors = [
          "matthew.bradford <matthew.bradford@tutanota.com>"
        ];
        dependencies = [
      ...
      "mycelium_index" = rec {
        crateName = "mycelium_index";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1n4cd9p7w5zmf0q07m85a8grbjcwscc452gljnab31y270cahba9";
        authors = [
          "matthew.bradford <matthew.bradford@tutanota.com>"
        ];
        dependencies = [
          ...
          {
            name = "mycelium_core";
            packageId = "mycelium_core";
          }
          {
            name = "mycelium_experimental";
            packageId = "mycelium_experimental";
          }
          {
            name = "rayon";
            packageId = "rayon";
      ...
      "mycelium_lib" = rec {
        crateName = "mycelium_lib";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1wrpf9z2x4vzp8vrb6d2p477p94hd871qn9966sy8lm7c0gbzvfv";
        authors = [
          "matthew.bradford <matthew.bradford@tutanota.com>"
        ];
        dependencies = [
