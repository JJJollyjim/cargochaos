...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-games1-cli/v1.0.13+20200402.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-games1" = rec {
        crateName = "google-games1";
        version = "1.0.13+20200402";
        edition = "2015";
        sha256 = "1mmsdxfn4ckv4mi6vq4vri30a5wxgfjx00cbkwnl8skkvmz90xkb";
        authors = [
      ...
      "google-games1-cli" = rec {
        crateName = "google-games1-cli";
        version = "1.0.13+20200402";
        edition = "2015";
        crateBin = [
          { name = "games1"; path = "src/main.rs"; }
        ];
