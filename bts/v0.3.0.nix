...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bts/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dir-assert" = rec {
        crateName = "dir-assert";
        version = "0.2.0";
        edition = "2018";
        sha256 = "168qkf40avq2ggy53bypfsmjv6kd55aj8xf4jll4zy19wd8ry1sj";
        authors = [
          "Łukasz Biel <lukasz.p.biel@gmail.com>"
        ];
