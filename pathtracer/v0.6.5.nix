...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pathtracer/v0.6.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pathtracer" = rec {
        crateName = "pathtracer";
        version = "0.6.5";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.6.5.nix {};
        authors = [
          "PontusLaestadius <pontus.laestadius@gmail.com>"
        ];
        dependencies = [
          {
            name = "gif";
      ...
      "pythagoras" = rec {
        crateName = "pythagoras";
        version = "0.1.1";
        edition = "2015";
        sha256 = "181lx3nhgsicax9bninizfnz0vnf03gskjm6gvnhjibfv4gd658h";
        authors = [
          "PontusLaestadius <pontus.laestadius@gmail.com>"
        ];
