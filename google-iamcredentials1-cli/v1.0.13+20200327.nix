...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-iamcredentials1-cli/v1.0.13+20200327.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-iamcredentials1-cli";
  ...
  workspaceMembers = {
    "google-iamcredentials1-cli" = rec {
      packageId = "google-iamcredentials1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-iamcredentials1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-iamcredentials1" = rec {
        crateName = "google-iamcredentials1";
        version = "1.0.13+20200327";
        edition = "2015";
        sha256 = "18vb96ramgckjqnhg6cfja72fm96lzvaxn9amawgd7s6qhs6pj17";
        authors = [
      ...
      "google-iamcredentials1-cli" = rec {
        crateName = "google-iamcredentials1-cli";
        version = "1.0.13+20200327";
        edition = "2015";
        crateBin = [
          { name = "iamcredentials1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-iamcredentials1";
          }
          {
            name = "hyper";
            packageId = "hyper";
