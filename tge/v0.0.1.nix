...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tge/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fontdue" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "00qx1fsi4dsmv24bh4r1ldk0j7kjk09kx3c61y1x4a7ffbcyag5z";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "basetsd" "combaseapi" "coml2api" "commctrl" "consoleapi" "debug" "devpkey" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "impl-debug" "ksmedia" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "mmdeviceapi" "ntdef" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "profileapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "synchapi" "sysinfoapi" "timezoneapi" "unknwnbase" "winbase" "wincon" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "xinput" ];
      };
      "winapi-build" = rec {
