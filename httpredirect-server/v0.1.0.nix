...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/httpredirect-server/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "httpredirect-server" = rec {
        crateName = "httpredirect-server";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "httpredirect-server"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "ZooSky <zoosky@gmail.com>"
        ];
        dependencies = [
          {
            name = "globwalk";
