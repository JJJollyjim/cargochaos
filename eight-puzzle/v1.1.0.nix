...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/eight-puzzle/v1.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "eight-puzzle" = rec {
        crateName = "eight-puzzle";
        version = "1.1.0";
        edition = "2018";
        crateBin = [
          { name = "eight-puzzle"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.0.nix {};
        authors = [
          "Jason Lee <jason5lee@hotmail.com>"
        ];
        dependencies = [
          {
            name = "eight-puzzle-core";
            packageId = "eight-puzzle-core";
          }
          {
            name = "env_logger";
      ...
      "eight-puzzle-core" = rec {
        crateName = "eight-puzzle-core";
        version = "1.0.0";
        edition = "2018";
        sha256 = "05sl9763d7vqfnvdx9y578ng23db7hvpa0lh6m42aajryi5dl25f";
        authors = [
          "Jason Lee <jason5lee@hotmail.com>"
        ];
        dependencies = [
      ...
      "piston_window" = rec {
        ...
        version = "0.98.0";
        edition = "2015";
        sha256 = "19ibci5hmhhdphqhy4aal8ryqhi29aqgj7nidqb3dav524b61gyr";
        authors = [
          "bvssvni <bvssvni@gmail.com>"
        ];
        dependencies = [
      ...
      "pistoncore-glutin_window" = rec {
        ...
        version = "0.61.0";
        edition = "2015";
        sha256 = "1ixd5jmnbfnh0hfvsavyplh01zb66i5kw2jbxx5fkd5li0kp4q4q";
