...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bootimage/v0.7.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bootimage" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "bootimage"; path = "src/main.rs"; }
          { name = "cargo-bootimage"; path = "src/bin/cargo-bootimage.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.7.9.nix {};
        authors = [
      ...
      "proc-macro2" = rec {
        ...
        version = "0.4.8";
        edition = "2015";
        sha256 = "1rjy474ghbidxx2xbynb771ym2xqnijifbfyr8idjndqbfhiwny6";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
