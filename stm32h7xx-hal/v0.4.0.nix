...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stm32h7xx-hal/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32h7" = rec {
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "stm32h743" "stm32h743v" "stm32h747cm7" "stm32h753" "stm32h753v" ];
      };
      "stm32h7xx-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "cm4" "cm7" "default" "device-selected" "dualcore" "revision_v" "rt" "singlecore" "stm32h742" "stm32h742v" "stm32h743" "stm32h743v" "stm32h747cm7" "stm32h750" "stm32h750v" "stm32h753" "stm32h753v" "unproven" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.16";
