...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/modbus/v1.0.3.nix.tmp"
      ...
      "modbus" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            ...
            packageId = "modbus-test-server";
          }
        ];
        features = {
          "modbus-server-tests" = [ "modbus-test-server/modbus-server-tests" ];
        };
        resolvedDefaultFeatures = [ "default" "modbus-server-tests" ];
      };
      "modbus-test-server" = rec {
        crateName = "modbus-test-server";
        version = "0.0.4";
        edition = "2015";
        sha256 = "06kz1lkx7271ql6cbwjdi8qzw8anz707n97ba80y63q9gnc797mg";
        libName = "test_server";
        libPath = "lib.rs";
        authors = [
          "Falco Hirschenberger <falco.hirschenberger@gmail.com>"
