...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/futures-async-combinators/v0.3.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "futures-async-combinators";
  ...
  internal = rec {
    ...
    crates = {
      "futures-async-combinators" = rec {
        crateName = "futures-async-combinators";
        version = "0.3.0";
        edition = "2018";
