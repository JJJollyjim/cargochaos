...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arrayfire/v3.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "arrayfire" = rec {
        ...
        version = "3.7.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v3.7.0.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "algorithm" "arithmetic" "blas" "data" "default" "graphics" "image" "indexing" "lapack" "machine_learning" "macros" "random" "signal" "sparse" "statistics" "vision" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "0.1.5";
      ...
      "serde_json" = rec {
        ...
        version = "1.0.20";
        edition = "2015";
        sha256 = "0xf8b3jgmnwp2z9whj2r1xgxvw4fq1hdf9j0aa29kwsr576cr5zw";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
        ];
