...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-diesel/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwindef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
