...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-blogger3-cli/v1.0.12+20150422.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-blogger3" = rec {
        crateName = "google-blogger3";
        version = "1.0.12+20150422";
        edition = "2015";
        sha256 = "0msg84fc3z4c94f8kkv8pc68y7p7sd61f826vd2wxvx26yagx142";
        authors = [
      ...
      "google-blogger3-cli" = rec {
        crateName = "google-blogger3-cli";
        version = "1.0.12+20150422";
        edition = "2015";
        crateBin = [
          { name = "blogger3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20150422.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
