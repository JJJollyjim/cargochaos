...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/automate/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "automate" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "default" "strict-deserializer" ];
      };
      "automate-derive" = rec {
        crateName = "automate-derive";
        version = "0.2.0";
        edition = "2018";
        sha256 = "0f3qny0izk7hc0c1dca1czzsqljz39lq0iv8a2yz629nr892m7fv";
        procMacro = true;
        authors = [
          "mbenoukaiss <marwane.benou-kaiss@etu.u-bordeaux.fr>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "rt-core" "slab" "sync" "tcp" "time" "udp" "uds" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
