...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nuclear-router/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nuclear-router" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "http" "http-router" "hyper" "hyper-service" ];
      };
      "num-traits" = rec {
