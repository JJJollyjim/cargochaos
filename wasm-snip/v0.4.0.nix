...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasm-snip/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "walrus" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "0gs4lvlyvndb85g4kffhfx1zdcy9dpi8c2f6bkamjnzbb6avvwz6";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
        dependencies = [
      ...
      "walrus-macro" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "0m75qi9csy14n3p6yn592q91x0yz20cwp2w3iifckr3bv3hacr04";
        procMacro = true;
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
      ...
      "wasm-snip" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wasm-snip"; path = "src/bin/wasm-snip.rs"; }
        ];
      ...
      "wasmparser" = rec {
        ...
        version = "0.37.2";
        edition = "2018";
        sha256 = "1ssyxc15cnx81lclwmi8z24yibkm6drix5kx3p89rp8kgjk7nf7p";
        authors = [
