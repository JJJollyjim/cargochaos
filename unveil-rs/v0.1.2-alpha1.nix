...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unveil-rs/v0.1.2-alpha1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sass-sys" = rec {
        ...
        version = "0.4.18";
        edition = "2015";
        sha256 = "1s8866y0f1k5wrq9ddgjxvvkqs6svxxksmya1ik9r518gzng9z9n";
        authors = [
          "Marius Seritan <github@seritan.net>"
          "Vincent Prouillet <prouillet.vincent@gmail.com>"
        ];
      ...
      "unveil-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "default" "unveil-cli" ];
      };
      "url 1.7.2" = rec {
        crateName = "url";
        version = "1.7.2";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shellapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
