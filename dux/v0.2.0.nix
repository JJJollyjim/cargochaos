...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dux/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xcb" = rec {
        ...
        resolvedDefaultFeatures = [ "damage" "randr" "render" "shape" "shm" "thread" "xfixes" ];
      };
      "xcb-util" = rec {
        crateName = "xcb-util";
        version = "0.2.1";
        ...
        resolvedDefaultFeatures = [ "ewmh" "icccm" "image" "shm" "thread" ];
      };
      "xdg" = rec {
        crateName = "xdg";
        version = "2.2.0";
