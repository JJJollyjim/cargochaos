...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-release/v0.13.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap-cargo" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "0iqk2xnqjfsdh6y1c7znix4223651kg53185x0bypyv97wzn7gwv";
        authors = [
          "Ed Page <eopage@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "userenv" "winbase" "wincon" "winerror" "winnt" ];
      };
