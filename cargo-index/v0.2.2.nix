...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-index/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-index" = rec {
        crateName = "cargo-index";
        version = "0.2.2";
        edition = "2018";
        crateBin = [
          { name = "cargo-index"; path = "src/main.rs"; }
        ];
      ...
      "reg-index" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1ir5q5ndx8zhyh5f8l1rhjbbwfrakc2zbjwzxwppi6vrqi3r54n0";
        authors = [
          "Eric Huss"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
