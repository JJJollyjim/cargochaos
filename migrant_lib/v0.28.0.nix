...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/migrant_lib/v0.28.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "migrant_lib" = rec {
        crateName = "migrant_lib";
        version = "0.28.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.28.0.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "d-all" "d-mysql" "d-postgres" "d-sqlite" "default" "mysql" "postgres" "rusqlite" ];
      };
      "miniz_oxide" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
