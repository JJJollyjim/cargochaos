...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-serial/v4.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1n05699ngcq08vlvdrzw80y7k2djj11r03bml36xsdri1zwlmxxm";
        authors = [
        ...
        features = {
          ...
          "dns" = [ "rt-core" ];
          "fs" = [ "rt-core" ];
          "full" = [ "blocking" "dns" "fs" "io-driver" "io-util" "io-std" "macros" "net" "process" "rt-core" "rt-threaded" "signal" "stream" "sync" "time" ];
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "macros" "mio" "tokio-macros" ];
      };
      "tokio-macros" = rec {
