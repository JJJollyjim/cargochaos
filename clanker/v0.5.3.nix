...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/clanker/v0.5.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clanker" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "clanker-prompt"; path = "src/prompt.rs"; }
          { name = "clanker-right-prompt"; path = "src/right_prompt.rs"; }
          { name = "clanker-title"; path = "src/title.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.3.nix {};
        libPath = "src/clanker.rs";
        authors = [
          "Gregory Meyer <gregjm@umich.edu>"
        ];
        dependencies = [
          {
            name = "dirs";
