...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/doh-client/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "doh-client" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "completions"; path = "src/main_completions.rs"; }
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-core" "net" "time" "macros" ];
          }
          {
            name = "tokio-rustls";
      ...
      "h2" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0b8whcbjmvf7mg2ljm7jjv8q355g9m2z7fss0lq8s4y9zn05mjhy";
        authors = [
          "Carl Lerche <me@carllerche.com>"
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "rt-core" "slab" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
