...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/newt/v0.6.2.nix.tmp"
    ...
    crates = {
      ...
      "newt" = rec {
        ...
        dependencies = [
          ...
          {
            name = "newt_proc_macros";
            packageId = "newt_proc_macros";
          }
        ];
        devDependencies = [
          {
        ...
        resolvedDefaultFeatures = [ "asm" "static" ];
      };
      "newt-sys" = rec {
        crateName = "newt-sys";
        version = "0.1.6";
        edition = "2015";
        sha256 = "1k80gn6fpbgw9wmlwanxw7qnqljlp0r6zk8maawdyrv3qmzwnyxz";
        authors = [
      ...
      "newt_proc_macros" = rec {
        crateName = "newt_proc_macros";
        version = "0.0.6";
        edition = "2015";
        sha256 = "0l3i8dsyjcryfkcixj35frbh1lb94kspvbhz3kh5nllvprjxhsna";
        procMacro = true;
        authors = [
          "Robert Gill <locke@sdf.lonestar.org>"
        ];
