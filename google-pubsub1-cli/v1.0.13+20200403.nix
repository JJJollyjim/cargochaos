...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-pubsub1-cli/v1.0.13+20200403.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-pubsub1" = rec {
        ...
        edition = "2015";
        sha256 = "1l06fdl5yq3c0cqfk7z5xq2bmvq7l3zarnzvbf5y5m6hvq7pxaxb";
        authors = [
      ...
      "google-pubsub1-cli" = rec {
        crateName = "google-pubsub1-cli";
        version = "1.0.13+20200403";
        edition = "2015";
        crateBin = [
          { name = "pubsub1"; path = "src/main.rs"; }
        ];
