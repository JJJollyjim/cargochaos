...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grammar_tool/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "grammar_tool" = rec {
        crateName = "grammar_tool";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "grammar_tool"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Jason Priest <jason@jpriest.me>"
        ];
        dependencies = [
          {
            name = "clap";
