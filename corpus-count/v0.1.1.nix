...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/corpus-count/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "corpus-count" = rec {
        crateName = "corpus-count";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "corpus-count"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Sebastian Puetz <sebastian.puetz@student.uni-tuebingen.de>"
        ];
        dependencies = [
          {
            name = "clap";
