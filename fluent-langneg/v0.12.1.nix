...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluent-langneg/v0.12.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-locale" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "01vca91slfn4f7k87iqq89zqpz94aww4m11rpbcfdy73fmhnw3ca";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-impl" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "14wyg17khxqx8zawj6b827rxp1q1413wymzcmkkj6b6wm86kangy";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-macros" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "091frqc6x5m5rpqi2znd6j2v6ff9c8vz4cg4gl5mlmrgi7rh1lq3";
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
      ...
      "unic-locale-macros-impl" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "161rb1axchr30iwrcq4lpzna62gpjqas1m8qyjfbiq6xz6mw6yq5";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
