...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluent-langneg/v0.11.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-langid-impl" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0r0xzsr46gxb577y4m1b3rcd3ipac1qkyv7dqxgh6d1g05zmjc8c";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "18pnx937kkq4gxc11nxya4kknv9ispgxg4q7wbpd3m3ia1qkw9gc";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-impl" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "0br5kx52qyy10h586hclyrdfpbcm5yzn0cfsswrk9j9i8hx1p1qb";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
