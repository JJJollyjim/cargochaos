...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fluent-langneg/v0.11.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-langid" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1j1xdv7wvvhvax3n34sn9dzqiq54r6qy304cz547axzdjdsb9xb5";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-langid-impl" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1kqzdplha4k7rqdyfcj47ikv4l0cfvr72dm3wfbf5psvrfbyb7hj";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1dj38i71gpfdqabsbsalp0qr8bkwjdnkr5v11xckp9ybvrbqdw2z";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-impl" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0pwhgmsd9h37v0frcshyi7qmk5zxixp1qjkqwiwwlj52d4h7sjf7";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
        dependencies = [
      ...
      "unic-locale-macros" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0vr98f0ipb877ad01gdlcf3a5sssg87k6vvfkzr0mvl4l1dm34iw";
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
        ];
      ...
      "unic-locale-macros-impl" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0wcn9j9738h1a5rmyc3iswkpkfwn1wh2m2fxd0mb4kvi5ks0y0id";
        procMacro = true;
        authors = [
          "Manish Goregaokar <manishsmail@gmail.com>"
          "Zibi Braniecki <gandalf@mozilla.com>"
