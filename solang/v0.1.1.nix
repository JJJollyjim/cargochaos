...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/solang/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "inkwell" = rec {
        ...
        edition = "2018";
        sha256 = "1k7lg67yvc650s4cqgdqn14ppkg52cqvhlzb3gazsfjsg34pan2p";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "llvm8-0" "target-aarch64" "target-all" "target-amdgpu" "target-arm" "target-bpf" "target-hexagon" "target-lanai" "target-mips" "target-msp430" "target-nvptx" "target-powerpc" "target-sparc" "target-systemz" "target-webassembly" "target-x86" "target-xcore" ];
      };
      ...
      "parity-scale-codec" = rec {
        ...
        resolvedDefaultFeatures = [ "bitvec" "default" "serde" "std" ];
      };
      ...
      "solang" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "solang"; path = "src/bin/solang.rs"; }
        ];
