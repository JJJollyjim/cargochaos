...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imgui-dx9-renderer/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imgui-dx9-renderer" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "d3d9" "d3d9types" "windef" ];
          }
        ];
        devDependencies = [
          {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "combaseapi" "commctrl" "consoleapi" "d3d9" "d3d9types" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "libloaderapi" "memoryapi" "minwindef" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "shellapi" "shellscalingapi" "shobjidl_core" "std" "sysinfoapi" "unknwnbase" "winbase" "wincon" "windef" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
