...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/uvc/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "uvc" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "system" "uvc-src" "uvc-sys" "vendor" ];
      };
      "uvc-src" = rec {
        crateName = "uvc-src";
        version = "0.1.0";
        edition = "2018";
        sha256 = "05vkva9hiq6i3b09v6dixihzrbjm1yf96m14jwblxsyjxf44cr0x";
        authors = [
          "Magnus Ulimoen <flymagnus@gmail.com>"
        ];
        buildDependencies = [
      ...
      "uvc-sys" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0a6qkn8lybhlj3mm7xa706kp9pa131z6cfzfsdrysj83dp2p0ss1";
        authors = [
          "Magnus Ulimoen <flymagnus@gmail.com>"
        ];
        buildDependencies = [
