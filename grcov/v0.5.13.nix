...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/grcov/v0.5.13.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fomat-macros" = rec {
        crateName = "fomat-macros";
        version = "0.3.1";
        edition = "2015";
        sha256 = "0cx8qrr5cskbyf2lbfyxs9gp3cx8q45kjszba1hmb7wziim5ampy";
        authors = [
      ...
      "grcov" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "grcov"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.13.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "tc" "tcmalloc" ];
      };
      "hermit-abi" = rec {
      ...
      "tcmalloc" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "16w1kpfzv093mljk9k2skldbwhcfw06amgk7xppcb8c47l8halip";
        authors = [
      ...
      "zip" = rec {
        ...
        resolvedDefaultFeatures = [ "deflate-zlib" "flate2" ];
      };
    };
