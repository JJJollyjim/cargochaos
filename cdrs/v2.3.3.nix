...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cdrs/v2.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cdrs" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "e2e-tests" "openssl" "rust-tls" "rustls" "ssl" "unstable-dynamic-cluster" "v3" "v4" "webpki" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "wtypesbase" ];
      };
