...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/namecheap-ddns/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "minreq" = rec {
        ...
        version = "2.0.0";
        edition = "2018";
        sha256 = "1lyf7pccrydvafrgc3ypn5fbwljps6bscpg47gdvl7632ddy3qwr";
        authors = [
      ...
      "namecheap-ddns" = rec {
        crateName = "namecheap-ddns";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "namecheap-ddns"; path = "src/main.rs"; }
        ];
