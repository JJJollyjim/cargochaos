...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/slp-cli/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "slp" = rec {
        ...
        version = "0.1.9";
        edition = "2018";
        sha256 = "1qd1dpjzvhg1j38aza1vf2nsb58d62pglq2ybw6l7zl85w2l81yr";
        authors = [
          "Prateek Kumar <prateek@prateekkumar.in>"
        ];
        dependencies = [
          {
            name = "num";
