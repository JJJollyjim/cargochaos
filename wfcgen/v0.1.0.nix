...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wfcgen/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fastwfc" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1aj143330hvvfpllkv386lp9bv7zz4r6k69kynncrnfbgbqa86fp";
        authors = [
          "ricky han <github@rickyhan.com>"
        ];
        dependencies = [
          {
            name = "fastwfc-sys";
            packageId = "fastwfc-sys";
          }
          {
            name = "image";
            packageId = "image";
      ...
      "fastwfc-sys" = rec {
        crateName = "fastwfc-sys";
        version = "0.1.0";
        edition = "2018";
        sha256 = "01a6k8rxwmvprkps540q9xq44dgbslw2jyh4yv9qr07mys39bgdn";
        authors = [
          "ricky han <github@rickyhan.com>"
        ];
        buildDependencies = [
      ...
      "wfcgen" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "wfcgen"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Ricky Han <rickylqhan@gmail.com>"
        ];
        dependencies = [
          {
            name = "fastwfc";
