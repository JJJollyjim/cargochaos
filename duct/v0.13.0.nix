...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/duct/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "minwindef" "namedpipeapi" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "winbase" "winerror" "winnt" ];
      };
