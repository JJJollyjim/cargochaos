...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-admin1_reports-cli/v1.0.12+20190521.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-admin1_reports-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-admin1_reports" = rec {
        crateName = "google-admin1_reports";
        version = "1.0.12+20190521";
        edition = "2015";
        sha256 = "17b9a0jqzs2xsszyzlp6ng4zsx1hn5aa1qclxzqdjrh9saiy4w0j";
        authors = [
      ...
      "google-admin1_reports-cli" = rec {
        crateName = "google-admin1_reports-cli";
        version = "1.0.12+20190521";
        edition = "2015";
        crateBin = [
          { name = "admin1-reports"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190521.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-admin1_reports";
          }
          {
            name = "hyper";
            packageId = "hyper";
