...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-expand/v0.4.19.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntstatus" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
