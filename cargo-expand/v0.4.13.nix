...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-expand/v0.4.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
