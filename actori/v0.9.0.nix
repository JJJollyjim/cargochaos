...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actori/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "actori" = rec {
        ...
        resolvedDefaultFeatures = [ "actori-http" "default" "http" "mailbox_assert" "resolver" "trust-dns-proto" "trust-dns-resolver" ];
      };
      "actori-codec" = rec {
