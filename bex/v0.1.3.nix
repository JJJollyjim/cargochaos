...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bex/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bex" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "bex-shell"; path = "examples/bex-shell.rs"; }
          { name = "bdd-solve"; path = "examples/bdd-solve.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "tangentstorm <michal.wallace@gmail.com>"
        ];
        dependencies = [
          {
            name = "bincode";
