...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-servicebroker1-cli/v1.0.13+20190624.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-servicebroker1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-servicebroker1" = rec {
        crateName = "google-servicebroker1";
        version = "1.0.13+20190624";
        edition = "2015";
        sha256 = "0682lpn6650liz0lbaad132dyk023hja3g9ncvqjfycai5vz14h6";
        authors = [
      ...
      "google-servicebroker1-cli" = rec {
        crateName = "google-servicebroker1-cli";
        version = "1.0.13+20190624";
        edition = "2015";
        crateBin = [
          { name = "servicebroker1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190624.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-servicebroker1";
            packageId = "google-servicebroker1";
          }
          {
            name = "hyper";
            packageId = "hyper";
