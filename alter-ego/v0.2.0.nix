...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alter-ego/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "acl-sys" = rec {
        ...
        version = "1.0.1";
        edition = "2015";
        sha256 = "07380z53gw3019y5l2kw6v4fg4rgcqjnmnk6n3xmdadppac4mkiq";
        authors = [
      ...
      "alter-ego" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "alter-ego"; path = "src/main.rs"; }
        ];
      ...
      "posix-acl" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0bc812k5hwz9mrz9k8v5cjl2k3l0xm230w3wip91mqx0bqip3ady";
        authors = [
          "Marti Raudsepp <marti@juffo.org>"
        ];
        dependencies = [
