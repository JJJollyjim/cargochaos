...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alter-ego/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "acl-sys" = rec {
        ...
        version = "1.2.0";
        edition = "2015";
        sha256 = "1r7ivaiwl5kdq599bz2pnfj1gqy1gwl0wnm435rsadhs09n4721q";
        authors = [
      ...
      "posix-acl" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1pyj6w80z5bid0rj912vjhdjy5x1v3v3jmclgcz2k09vizr4rqjh";
        authors = [
          "Marti Raudsepp <marti@juffo.org>"
        ];
        dependencies = [
