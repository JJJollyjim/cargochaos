...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reqwest/v0.10.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper" = rec {
        ...
        resolvedDefaultFeatures = [ "net2" "runtime" "stream" "tcp" ];
      };
      "hyper-rustls" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__internal_proxy_sys_no_cache" "__tls" "async-compression" "blocking" "brotli" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "gzip" "hyper-rustls" "hyper-tls" "json" "native-tls" "native-tls-crate" "native-tls-vendored" "rustls" "rustls-tls" "serde_json" "socks" "stream" "tokio-rustls" "tokio-socks" "tokio-tls" "trust-dns" "trust-dns-resolver" "webpki-roots" ];
      };
      "resolv-conf" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" "tokio-macros" "udp" ];
      };
      "tokio-macros" = rec {
