...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dotenvripper/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "dotenvripper" = rec {
        crateName = "dotenvripper";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "dotenvripper"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Edgar Cumbreras <edgarcumbrerastirado@gmail.com>"
        ];
        dependencies = [
          {
            name = "walkdir";
