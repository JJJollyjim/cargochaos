...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr/v0.4.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "minwindef" "ntsecapi" "objbase" "shlobj" "std" "winbase" "winerror" "winnt" ];
      };
