...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr/v0.3.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "evcxr" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "testing_runtime"; path = "src/bin/testing_runtime.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwindef" "ntsecapi" "profileapi" "std" "winbase" "winerror" "winnt" ];
      };
