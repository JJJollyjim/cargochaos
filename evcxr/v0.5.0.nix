...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/evcxr/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "objbase" "shlobj" "std" "winbase" "winerror" ];
      };
