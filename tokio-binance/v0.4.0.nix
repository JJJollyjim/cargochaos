...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-binance/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tungstenite" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "real-native-tls" "real-tokio-tls" "tokio" "tokio-runtime" "tokio-tls" ];
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "1.0.0";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "sync" "tcp" "time" "tokio-macros" ];
      };
      "tokio-binance" = rec {
        crateName = "tokio-binance";
        version = "0.4.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "kgeronim <kevin.geronimo@outlook.com>"
        ];
        dependencies = [
          {
