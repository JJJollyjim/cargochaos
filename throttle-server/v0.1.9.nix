...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/throttle-server/v0.1.9.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gelf" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0kazds54g4xhsd677dcail7ry4zr1f0izfqibs0c5is4d7f0id97";
        authors = [
      ...
      "throttle-server" = rec {
        crateName = "throttle-server";
        version = "0.1.9";
        edition = "2018";
        crateBin = [
          { name = "throttle"; path = "src/main.rs"; }
        ];
