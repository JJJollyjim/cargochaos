...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/daas/v0.0.5.nix.tmp"
    ...
    crates = {
      ...
      "daas" = rec {
        ...
        devDependencies = [
          ...
          {
            name = "json";
            packageId = "json 0.12.1";
          }
          {
            name = "reqwest";
            packageId = "reqwest 0.10.2";
            usesDefaultFeatures = false;
            features = [ "blocking" ];
          }
          {
      ...
      "pbd" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "064dzj1x771kp1dd4a7h3vklwlx3xr19kfhmxmmk5i0wmpdzzlf2";
        authors = [
          "dsietz <davidsietz@yahoo.com>"
        ];
        dependencies = [
        ...
        features = {
          "default" = [ "dua" "dtc" "dsg" ];
          "dsg" = [ "bytes" "openssl" "rand" ];
          "dtc" = [ "pow_sha256" "base64" ];
          "dua" = [ "actix-web" "actix-service" "futures" "rayon" "reqwest" ];
        };
        resolvedDefaultFeatures = [ "actix-service" "actix-web" "base64" "bytes" "default" "dsg" "dtc" "dua" "futures" "openssl" "pow_sha256" "rand" "rayon" "reqwest" ];
      };
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
