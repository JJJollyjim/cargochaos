...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bao_bin/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bao" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "08jcsvkxkwwxgnn5h3gmpi6jihh7hpmrcwq65bq6vizgid7n83l1";
        authors = [
          "Jack O'Connor"
        ];
        dependencies = [
      ...
      "blake3" = rec {
        ...
        resolvedDefaultFeatures = [ "c_avx512" "default" "rayon" "std" ];
      };
      "c2-chacha" = rec {
        crateName = "c2-chacha";
        version = "0.2.3";
