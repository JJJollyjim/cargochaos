...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/autograph/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "autograph" = rec {
        ...
        authors = [
          "charles-r-earp <charles.r.earp@gmail.com>"
        ];
        dependencies = [
          {
            name = "byteorder";
      ...
      "progress" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "0i0w5zh2hm4l16ibg5mgr9pf3vpybhhx0zrs0nb8d191awq21f0p";
        authors = [
