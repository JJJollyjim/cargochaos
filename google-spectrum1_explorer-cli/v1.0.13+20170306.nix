...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-spectrum1_explorer-cli/v1.0.13+20170306.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-spectrum1_explorer-cli";
  ...
  workspaceMembers = {
    "google-spectrum1_explorer-cli" = rec {
      packageId = "google-spectrum1_explorer-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-spectrum1_explorer-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-spectrum1_explorer" = rec {
        crateName = "google-spectrum1_explorer";
        version = "1.0.13+20170306";
        edition = "2015";
        sha256 = "0zn0sv5iy9hmi9nj6yrsad3rakkxjakw6llgv32l69xyyi50y4dp";
        authors = [
      ...
      "google-spectrum1_explorer-cli" = rec {
        crateName = "google-spectrum1_explorer-cli";
        version = "1.0.13+20170306";
        edition = "2015";
        crateBin = [
          { name = "spectrum1-explorer"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20170306.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-spectrum1_explorer";
          }
          {
            name = "hyper";
            packageId = "hyper";
