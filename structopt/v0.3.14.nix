...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/structopt/v0.3.14.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "ansi_term" "atty" "clippy" "color" "debug" "default" "doc" "lints" "no_cargo" "strsim" "suggestions" "term_size" "vec_map" "wrap_help" "yaml" "yaml-rust" ];
      };
      "dissimilar" = rec {
        crateName = "dissimilar";
        version = "1.0.1";
        edition = "2018";
        sha256 = "154ba92ifmh3js1k0hbmxz7pv95n8wmahlyvhdbnxggbs8f1dpir";
        authors = [
      ...
      "proc-macro-error" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "0pipraynh9wbx3sfqmv5s3y8f4m51znc618s7wzwfrda6h806cc9";
        authors = [
      ...
      "proc-macro-error-attr" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "161gifrkcpzljri267jrckyj00naf80xakin55asxrrf85pm6ir1";
        procMacro = true;
        authors = [
          "CreepySkeleton <creepy-skeleton@yandex.ru>"
        ];
      ...
      "structopt" = rec {
        ...
        resolvedDefaultFeatures = [ "color" "debug" "default" "doc" "lints" "no_cargo" "paw" "suggestions" "wrap_help" "yaml" ];
      };
      ...
      "trybuild" = rec {
        ...
        resolvedDefaultFeatures = [ "diff" "dissimilar" ];
      };
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
