...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xcursorlocate/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xcb" = rec {
        ...
        resolvedDefaultFeatures = [ "shape" ];
      };
      "xcursorlocate" = rec {
        crateName = "xcursorlocate";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "xcursorlocate"; path = "src/main.rs"; }
        ];
