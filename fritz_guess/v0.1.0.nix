...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fritz_guess/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fritz_guess" = rec {
        crateName = "fritz_guess";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "fritz-guess"; path = "src/bin/fritz-guess.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Martijn M.W. Gribnau <garm@ilumeo.com>"
        ];
        dependencies = [
          {
            name = "rayon";
      ...
      "parameterized" = rec {
        crateName = "parameterized";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1wvmvw1jcl1qg4akdllj7x7h8j5c7cf73wyjdbn9hml5prklj3y9";
        authors = [
        ...
        dependencies = [
          {
            ...
            packageId = "parameterized-macro";
          }
        ];
        
      };
      "parameterized-macro" = rec {
        crateName = "parameterized-macro";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0nyign5n4gcbjpbfi0s8j6vm18am489wz6xwr58hi11m41xdy0ca";
        procMacro = true;
        authors = [
          "Martijn Gribnau <garm@ilumeo.com>"
        ];
