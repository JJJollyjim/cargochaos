...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sway-alttab/v1.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sway-alttab" = rec {
        crateName = "sway-alttab";
        version = "1.1.2";
        edition = "2018";
        crateBin = [
          { name = "sway-alttab"; path = "src/main.rs"; }
        ];
      ...
      "swayipc" = rec {
        ...
        version = "2.2.4";
        edition = "2018";
        sha256 = "0ziaj2l7bigpvc0z9prpnll8ka1z0qal3wfy7j82x0g06gdwygpp";
        authors = [
          "Rex Hackbro <rex.hackbro@mailbox.org>"
        ];
        dependencies = [
          {
            name = "failure";
