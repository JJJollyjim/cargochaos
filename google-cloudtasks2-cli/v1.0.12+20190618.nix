...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudtasks2-cli/v1.0.12+20190618.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudtasks2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudtasks2" = rec {
        crateName = "google-cloudtasks2";
        version = "1.0.12+20190618";
        edition = "2015";
        sha256 = "1w4m7hqk10vn86cdqf85bg27c1b4g3nfrv5adbqyn25y8zcbahwj";
        authors = [
      ...
      "google-cloudtasks2-cli" = rec {
        crateName = "google-cloudtasks2-cli";
        version = "1.0.12+20190618";
        edition = "2015";
        crateBin = [
          { name = "cloudtasks2"; path = "src/main.rs"; }
        ];
