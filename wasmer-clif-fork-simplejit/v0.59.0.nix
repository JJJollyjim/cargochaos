...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wasmer-clif-fork-simplejit/v0.59.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "wasmer-clif-fork-simplejit";
  ...
  workspaceMembers = {
    "wasmer-clif-fork-simplejit" = rec {
      packageId = "wasmer-clif-fork-simplejit";
      build = internal.buildRustCrateWithFeatures {
        packageId = "wasmer-clif-fork-simplejit";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasmer-clif-fork-simplejit" = rec {
        crateName = "wasmer-clif-fork-simplejit";
        version = "0.59.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.59.0.nix {};
        authors = [
          "Forked from work done by The Cranelift Project Developers"
        ];
        dependencies = [
