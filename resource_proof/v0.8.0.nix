...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/resource_proof/v0.8.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "resource_proof" = rec {
        crateName = "resource_proof";
        version = "0.8.0";
        edition = "2018";
        crateBin = [
          { name = "resource_proof"; path = "src/main.rs"; }
        ];
