...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/skia-safe/v0.27.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "skia-bindings" = rec {
        ...
        version = "0.27.2";
        edition = "2018";
        sha256 = "1543nf0qizf1z32dc8qm1f2fiagb2kccp2nhw8d9dqn8jjk83waf";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "gl" "metal" "shaper" "svg" "textlayout" "vulkan" ];
      };
      "skia-safe" = rec {
        crateName = "skia-safe";
        version = "0.27.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.27.2.nix {};
        authors = [
          "Armin Sander <armin@replicator.org>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "gl" "gpu" "metal" "shaper" "svg" "textlayout" "vulkan" ];
      };
      "smallvec" = rec {
        crateName = "smallvec";
        version = "1.3.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntstatus" "processenv" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
