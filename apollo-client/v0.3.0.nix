...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/apollo-client/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "apollo-client" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "full" "host-ip" "host-name" "hostname" "regex" "serde-xml-rs" "serde_yaml" "systemstat" "xml" "yaml" ];
      };
