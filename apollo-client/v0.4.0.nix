...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/apollo-client/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "apollo-client" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "full" "host-ip" "host-name" "hostname" "mock-listen" "regex" "serde-xml-rs" "serde_yaml" "systemstat" "xml" "yaml" ];
      };
      "arc-swap" = rec {
        crateName = "arc-swap";
        version = "0.4.4";
