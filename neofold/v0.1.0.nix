...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/neofold/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bio-seq-algos" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1z58298mjdha6iidg5ai1lv6ndrzlvd29xzwrbdraqvv6134i1aw";
      ...
      "rna-algos" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1j5zmzv8sygi31y1b96sdmnlcnwcshcqg761xxjqmws2ghm4ag7s";
        libName = "rna_algos";
        authors = [
          "heartsh <heartsh@heartsh.io>"
        ];
      ...
      "rna-ss-params" = rec {
        ...
        version = "0.1.13";
        edition = "2015";
        sha256 = "0p9663iw2kb26ajlnpzkcgrbm80fz9gkwsjh6q8nhzhxx7dh1v52";
      ...
      "rnafamprob" = rec {
        crateName = "rnafamprob";
        version = "0.1.0";
        edition = "2015";
        crateBin = [];
        sha256 = "17li52mk3d1y6h6s846b4jkf5lyc49w5yhp2dvar8nn35mpa8aas";
        authors = [
          "heartsh <heartsh@heartsh.io>"
        ];
        dependencies = [
