...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/count_constant_sites/v0.1.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "count_constant_sites";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "count_constant_sites" = rec {
        crateName = "count_constant_sites";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "count_constant_sites"; path = "src/main.rs"; }
        ];
