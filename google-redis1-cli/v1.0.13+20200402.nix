...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-redis1-cli/v1.0.13+20200402.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-redis1" = rec {
        crateName = "google-redis1";
        version = "1.0.13+20200402";
        edition = "2015";
        sha256 = "1947bqfw2qygcj48cwg1gw6qni1h8wg29smcfd1xb3sx68xf0msn";
        authors = [
      ...
      "google-redis1-cli" = rec {
        crateName = "google-redis1-cli";
        version = "1.0.13+20200402";
        edition = "2015";
        crateBin = [
          { name = "redis1"; path = "src/main.rs"; }
        ];
