...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sapiens-rs/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sapiens-rs" = rec {
        crateName = "sapiens-rs";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "David Dubois <dexcelstraun7@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-derive";
          ...
          {
            name = "sapiens-sys";
            packageId = "sapiens-sys";
          }
        ];
        
      };
      "sapiens-sys" = rec {
        crateName = "sapiens-sys";
        version = "0.2.0";
        edition = "2018";
        sha256 = "1g77j34kjabqxh9l5ygcsfq76c7kbr5asxq53ridvv6wnfs77bgi";
        authors = [
          "David Dubois <dexcelstraun7@gmail.com>"
        ];
        buildDependencies = [
