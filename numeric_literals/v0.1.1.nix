...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/numeric_literals/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "syn" = rec {
        ...
        resolvedDefaultFeatures = [ "clone-impls" "full" "parsing" "printing" "proc-macro" "quote" "visit-mut" ];
      };
      "unicode-xid" = rec {
