...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rebuilderd/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "chrono" "default" "libsqlite3-sys" "r2d2" "sqlite" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "rebuilderd" = rec {
        crateName = "rebuilderd";
        version = "0.2.1";
        edition = "2018";
        crateBin = [
          { name = "rebuilderd"; path = "src/main.rs"; }
        ];
      ...
      "rebuilderd-common" = rec {
        crateName = "rebuilderd-common";
        version = "0.2.1";
        edition = "2018";
        sha256 = "15g33lmx9qhc33bngm3dn1khskiy64awgjc51lzy7mzld0hwpdli";
        authors = [
          "kpcyrd <git@rxv.cc>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
