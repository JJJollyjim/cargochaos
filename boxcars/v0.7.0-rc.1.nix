...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/boxcars/v0.7.0-rc.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bitter" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1csgj604bq5s7767gh2xi1dhmmnf9b9xfil2w29hdhwy3sbagvgm";
        authors = [
      ...
      "boxcars" = rec {
        ...
        version = "0.7.0-rc.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.0-rc.1.nix {};
        authors = [
          "Nick Babcock <nbabcock19@hotmail.com>"
        ];
        dependencies = [
