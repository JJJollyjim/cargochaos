...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nixpkgs-fmt/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rnix" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "0b00626jk69pdlg22wxhl2kprik0zwnigvabgba2nmafn8b6h7db";
        authors = [
          "jD91mZM2 <me@krake.one>"
        ];
        dependencies = [
      ...
      "rowan" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "130xnj58r7i4szxjkaqad5b6scwxcvmlh556hd001jgd5mhpjayw";
        authors = [
          "Aleksey Kladov <aleksey.kladov@gmail.com>"
        ];
        dependencies = [
