...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dynamic_ocl/v0.1.0-alpha.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dynamic_ocl" = rec {
        ...
        authors = [
          "Dominic Marcuse <dominic@marcuse.us>"
        ];
        dependencies = [
          {
            name = "const-cstr";
      ...
      "tynm" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0vm04jzx4p46lgkcvvy9w8di0v098y792davz5lcrmkff6vxdafh";
        authors = [
