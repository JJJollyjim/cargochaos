...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pwner/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pwner" = rec {
        ...
        authors = [
          "Marcelo Lima <marcelowind@gmail.com>"
        ];
        dependencies = [
          {
            name = "nix";
          ...
          }
          {
            ...
            packageId = "tokio";
            optional = true;
            features = [ "io-util" "process" "rt-core" "time" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "io-std" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "slab" "time" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
