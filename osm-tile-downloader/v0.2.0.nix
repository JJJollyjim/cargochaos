...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/osm-tile-downloader/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "osm-tile-downloader" = rec {
        crateName = "osm-tile-downloader";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "osm-tile-downloader"; path = "src/main.rs"; }
        ];
