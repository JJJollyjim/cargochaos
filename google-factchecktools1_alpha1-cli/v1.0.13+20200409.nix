...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-factchecktools1_alpha1-cli/v1.0.13+20200409.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-factchecktools1_alpha1-cli";
  ...
  workspaceMembers = {
    "google-factchecktools1_alpha1-cli" = rec {
      packageId = "google-factchecktools1_alpha1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-factchecktools1_alpha1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-factchecktools1_alpha1" = rec {
        crateName = "google-factchecktools1_alpha1";
        version = "1.0.13+20200409";
        edition = "2015";
        sha256 = "0nrn389gn40bc1qmdv92aa4462a2rfmj0hyisi448yg7lx1fhkfv";
        authors = [
      ...
      "google-factchecktools1_alpha1-cli" = rec {
        crateName = "google-factchecktools1_alpha1-cli";
        version = "1.0.13+20200409";
        edition = "2015";
        crateBin = [
          { name = "factchecktools1-alpha1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200409.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-factchecktools1_alpha1";
            packageId = "google-factchecktools1_alpha1";
          }
          {
            name = "hyper";
            packageId = "hyper";
