...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pihash/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dft" = rec {
        ...
        version = "0.5.5";
        edition = "2015";
        sha256 = "01q4576c8g5ic94cmaakakcbyjv982p9j6spaxkmjpddwin3rj46";
        authors = [
          "Christopher J. Woodall <chris.j.woodall@gmail.com>"
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
          "Karol Harasim <karol.harasim@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-complex";
      ...
      "pihash" = rec {
        ...
        resolvedDefaultFeatures = [ "bench" "default" ];
      };
      "png" = rec {
        crateName = "png";
        version = "0.15.0";
