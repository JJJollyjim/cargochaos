...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-firebasehosting1_beta1-cli/v1.0.13+20200325.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-firebasehosting1_beta1-cli";
  ...
  workspaceMembers = {
    "google-firebasehosting1_beta1-cli" = rec {
      packageId = "google-firebasehosting1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-firebasehosting1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-firebasehosting1_beta1" = rec {
        crateName = "google-firebasehosting1_beta1";
        version = "1.0.13+20200325";
        edition = "2015";
        sha256 = "1izq30fr3cnrm1s37hfbvvm94najnd1hilpiqpxjrkdkpqffpq26";
        authors = [
      ...
      "google-firebasehosting1_beta1-cli" = rec {
        crateName = "google-firebasehosting1_beta1-cli";
        version = "1.0.13+20200325";
        edition = "2015";
        crateBin = [
          { name = "firebasehosting1-beta1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200325.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-firebasehosting1_beta1";
            packageId = "google-firebasehosting1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
