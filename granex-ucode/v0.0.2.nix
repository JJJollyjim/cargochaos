...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/granex-ucode/v0.0.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "granex-ucode" = rec {
        crateName = "granex-ucode";
        version = "0.0.2";
        edition = "2018";
        crateBin = [
          { name = "granex-ucode"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.2.nix {};
        authors = [
          "Vitaly Domnikov <oss@vitaly.codes>"
          "Lukas Friedrich <lukas.b.friedrich@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
