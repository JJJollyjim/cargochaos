...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu_plugin_id3/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "id3" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0966fhv1zca4x3zg447gr0m66nzrpnbpiiq6fpmmqjwp6hckk4nx";
        authors = [
      ...
      "nu_plugin_id3" = rec {
        crateName = "nu_plugin_id3";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "nu_plugin_id3"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "notryanb@gmail.com <notryanb@gmail.com>"
        ];
        dependencies = [
          {
            name = "id3";
