...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nomap/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nom-fields" = rec {
        crateName = "nom-fields";
        version = "0.1.0";
        edition = "2018";
        sha256 = "168a6756ns2fzmrcjlkkxb72094q89krdz5h14akgr0zpvwv9j8a";
        authors = [
          "reslario <simon.kunze2310@gmail.com>"
        ];
