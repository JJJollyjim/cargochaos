...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bzlcfg/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "wincon" "winerror" "winnt" ];
      };
