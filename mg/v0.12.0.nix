...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mg/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "relm" = rec {
        ...
        version = "0.18.0";
        edition = "2018";
        sha256 = "057p5xnj2n1gxljzrfmx1yr13c1vg2i8g6x3kg4nvfaylx0p64nl";
        authors = [
          "Antoni Boucher <bouanto@zoho.com>"
        ];
        dependencies = [
      ...
      "relm-derive" = rec {
        ...
        version = "0.18.0";
        edition = "2018";
        sha256 = "0scx7zkd4d0cm7a5vfjscn86mpcajywnd60mb33ac7nwaiq3jrpc";
        procMacro = true;
        authors = [
          "Antoni Boucher <bouanto@zoho.com>"
        ];
