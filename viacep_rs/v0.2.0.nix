...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/viacep_rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "viacep_rs" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "search_zipcode"; path = "src/bin/search_zipcode.rs"; }
          { name = "search_address"; path = "src/bin/search_address.rs"; }
        ];
