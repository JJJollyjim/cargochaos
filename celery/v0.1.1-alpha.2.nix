...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.1-alpha.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1-alpha.2.nix {};
        authors = [
      ...
      "celery-codegen" = rec {
        ...
        version = "0.1.1-alpha.2";
        edition = "2018";
        sha256 = "19hdl3dd8x38f6f84zawfbbp8gyhqijwxaf56xj550hs7jzl2igz";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
