...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.1-alpha.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1-alpha.3.nix {};
        authors = [
      ...
      "celery-codegen" = rec {
        ...
        version = "0.1.1-alpha.3";
        edition = "2018";
        sha256 = "0ymk35zv684aziycbjn1ndbflnjkdxg5mp8idnff6jfg31lsfacz";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
