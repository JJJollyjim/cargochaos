...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.1-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.1-alpha.1.nix {};
        authors = [
      ...
      "celery-codegen" = rec {
        ...
        version = "0.1.1-alpha.1";
        edition = "2018";
        sha256 = "1ipp6hrf3hy5253d0g6709w27jcsf2mlc0hzv0syzicgs9fz7150";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
