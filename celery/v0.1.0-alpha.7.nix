...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.0-alpha.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.7.nix {};
        authors = [
      ...
      "celery-codegen" = rec {
        ...
        edition = "2018";
        sha256 = "11nynq54yd2i3p9m1y9dcghc8zamal88bgqr953ilpswl0wq7kzd";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
