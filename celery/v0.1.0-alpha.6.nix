...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.0-alpha.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.6.nix {};
        authors = [
      ...
      "celery-codegen" = rec {
        ...
        edition = "2018";
        sha256 = "1k8r578v6pqwcqz98psha4i63hq0rjin2fg8bj8fn7vcfzfwg1dc";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
