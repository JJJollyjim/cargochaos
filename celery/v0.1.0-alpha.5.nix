...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.0-alpha.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.5.nix {};
        authors = [
      ...
      "celery-codegen" = rec {
        ...
        edition = "2018";
        sha256 = "1g7cpsdjr1wzb8gpvrrmx0dnfdhsva06098ah3bbhnz0bmddmmfi";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
