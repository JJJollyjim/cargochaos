...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.0-alpha.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0-alpha.8.nix {};
        authors = [
        ...
        features = {
          "codegen" = [ "celery-codegen" "lazy_static" ];
          "default" = [ "codegen" ];
        };
        resolvedDefaultFeatures = [ "celery-codegen" "codegen" "default" "lazy_static" ];
      };
      "celery-codegen" = rec {
        crateName = "celery-codegen";
        version = "0.1.0-alpha.7";
        edition = "2018";
        sha256 = "1qc8q8jhicjpjzjkppxdnixgzxlcv3ckb4npsy7f7ic025a6926c";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
