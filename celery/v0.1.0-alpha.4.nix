...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/celery/v0.1.0-alpha.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "celery" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-threaded" "fs" "macros" ];
          }
        ];
        features = {
      ...
      "celery-codegen" = rec {
        ...
        edition = "2018";
        sha256 = "1g2nswpyjv7wgr7pc59f8q3ph6nds3gaq0flhqn2ynm2dlxz8hwn";
        procMacro = true;
        authors = [
          "epwalsh <epwalsh10@gmail.com>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "macros" "num_cpus" "rt-core" "rt-threaded" "slab" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
