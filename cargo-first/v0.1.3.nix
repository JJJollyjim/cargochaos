...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-first/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-first" = rec {
        crateName = "cargo-first";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "cargo-first"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "kdar <kevin@outroot.com>"
        ];
        dependencies = [
          {
            name = "atty";
