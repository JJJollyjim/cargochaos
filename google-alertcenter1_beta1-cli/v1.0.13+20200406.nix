...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-alertcenter1_beta1-cli/v1.0.13+20200406.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-alertcenter1_beta1" = rec {
        ...
        edition = "2015";
        sha256 = "0y30lvkgbwiyxbfhvc1q18acmmspdh1cz1mxfqbfx3ccrh032m0k";
        authors = [
      ...
      "google-alertcenter1_beta1-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200406.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
