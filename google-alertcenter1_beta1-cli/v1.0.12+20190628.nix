...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-alertcenter1_beta1-cli/v1.0.12+20190628.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-alertcenter1_beta1-cli";
  ...
  workspaceMembers = {
    "google-alertcenter1_beta1-cli" = rec {
      packageId = "google-alertcenter1_beta1-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-alertcenter1_beta1-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-alertcenter1_beta1" = rec {
        crateName = "google-alertcenter1_beta1";
        version = "1.0.12+20190628";
        edition = "2015";
        sha256 = "1mxkqw96pjfi6ipid3bhrb8g8q3fwvd0aq67fa3szkcn0g51b666";
        authors = [
      ...
      "google-alertcenter1_beta1-cli" = rec {
        crateName = "google-alertcenter1_beta1-cli";
        version = "1.0.12+20190628";
        edition = "2015";
        crateBin = [
          { name = "alertcenter1-beta1"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "google-alertcenter1_beta1";
            packageId = "google-alertcenter1_beta1";
          }
          {
            name = "hyper";
            packageId = "hyper";
