...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/webview2/v0.1.0-alpha.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "memory-module-sys" = rec {
        crateName = "memory-module-sys";
        version = "0.3.0";
        edition = "2018";
        sha256 = "18vdd2ffvgpy7bwnzi9pcfzksm5m9wjijlc7105qd0f64llwxg9v";
        authors = [
      ...
      "webview2" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "winapi";
            packageId = "winapi 0.3.8";
            features = [ "combaseapi" "libloaderapi" "shellapi" ];
          }
        ];
        devDependencies = [
          {
        ...
        features = {
          "default" = [ "memory-load-library" ];
          "memory-load-library" = [ "memory-module-sys" ];
        };
        resolvedDefaultFeatures = [ "default" "memory-load-library" "memory-module-sys" ];
      };
      "webview2-sys" = rec {
        crateName = "webview2-sys";
        version = "0.1.0-alpha.5";
        edition = "2018";
        sha256 = "1xiz1i517cdwzdzk24gaay0fvlik12hnni5x14kb1xplnl050p2z";
        authors = [
          "Yin Guanhao <sopium@mysterious.site>"
        ];
        dependencies = [
