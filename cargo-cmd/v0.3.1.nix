...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-cmd/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-cmd" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "cargo-cmd"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi";
            target = { target, features }: target."windows";
            features = [ "handleapi" "namedpipeapi" "processenv" "synchapi" "winerror" ];
          }
        ];
        devDependencies = [
          {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "namedpipeapi" "processenv" "processthreadsapi" "std" "synchapi" "winbase" "winerror" ];
      };
