...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-play/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-play" = rec {
        crateName = "cargo-play";
        version = "0.4.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-play"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Zeyi Fan <cargo@zeyi.fan>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "minwinbase" "minwindef" "processenv" "processthreadsapi" "winbase" "winnt" ];
      };
