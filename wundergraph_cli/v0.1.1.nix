...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wundergraph_cli/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        resolvedDefaultFeatures = [ "32-column-tables" "bitflags" "default" "libsqlite3-sys" "postgres" "pq-sys" "sqlite" "with-deprecated" ];
      };
      "diesel_derives" = rec {
      ...
      "wundergraph_cli" = rec {
        crateName = "wundergraph_cli";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "wundergraph_cli"; path = "src/main.rs"; }
        ];
