...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ndarray-vision/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ndarray-stats" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "0gj0aznfv8ahknyxh4jxkv1v4z2c4bzpzdxmxpi0xhnp04mais0r";
        authors = [
      ...
      "noisy_float" = rec {
        ...
        version = "0.1.9";
        edition = "2018";
        sha256 = "0a102q6cw2fzf0vwd48n37crrj7lz7jmkxp8m8b5a9z8r4ch0wj0";
        authors = [
