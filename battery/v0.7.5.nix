...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/battery/v0.7.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "devguid" "errhandlingapi" "fileapi" "handleapi" "impl-default" "ioapiset" "ntdef" "setupapi" "std" "winbase" "winerror" ];
      };
