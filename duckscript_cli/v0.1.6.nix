...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/duckscript_cli/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "duckscript" = rec {
        ...
        version = "0.1.5";
        edition = "2018";
        sha256 = "1pl7clfk8y4agr7jc2db96vhx0whpa6gybykn5q9iwg9glc2djap";
        authors = [
      ...
      "duckscriptsdk" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "0vm097zzwpc9xvd9nsn9nv4znh4n2b84wgm9jm8lnbkxidbl0glm";
        authors = [
          "Sagie Gur-Ari <sagiegurari@gmail.com>"
        ];
        dependencies = [
