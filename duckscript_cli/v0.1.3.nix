...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/duckscript_cli/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "duckscript_cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "duckscript"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "processthreadsapi" "std" "userenv" "winerror" "winnt" ];
      };
