...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/caldera/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "basalt" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "0q7lx8r3qa8i54vrbfw82n8pbqkwa1hb620dfpqa1xbsylzm2riz";
        authors = [
          "Austin <me@austinj.me>"
        ];
        dependencies = [
          {
            name = "crossbeam";
      ...
      "caldera" = rec {
        ...
        resolvedDefaultFeatures = [ "assets" "default" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.47";
      ...
      "freetype-sys" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "1i309xc6gcsgdfiim3j5f0sk08imr4frlzfa185iaxqciysqgikx";
        authors = [
      ...
      "include_dir" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "12rhcyf2sb7hqin0r5jyw3n6ps522pamndmqsk3l8n87298167c7";
        authors = [
      ...
      "include_dir_impl" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "1kjvq4ivji6gy4bi5ba1wi8z4yhab8f5ylyqlwnaf0pxy88b4iqg";
        procMacro = true;
        authors = [
          "Michael Bryan <michaelfbryan@gmail.com>"
        ];
      ...
      "mpris-player" = rec {
        crateName = "mpris-player";
        version = "0.4.0";
        edition = "2015";
        sha256 = "0k8mshskya3az1mn226rrwnyjijk0660b91d428387gjg4857sza";
        authors = [
      ...
      "splines" = rec {
        ...
        version = "3.0.0";
        edition = "2018";
        sha256 = "0scj7rvk8by3g6b604ly97jshkn2in8qx3449ai8jks5ir3bcbi9";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "audioclient" "audiosessiontypes" "basetsd" "combaseapi" "coml2api" "consoleapi" "debug" "devpkey" "dwmapi" "errhandlingapi" "fileapi" "handleapi" "hidusage" "impl-debug" "ksmedia" "libloaderapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "mmdeviceapi" "ntdef" "ntstatus" "objbase" "ole2" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shellapi" "shellscalingapi" "shobjidl_core" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "unknwnbase" "winbase" "wincon" "wincrypt" "windowsx" "winerror" "wingdi" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
