...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lapin-futures-rustls/v0.21.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lapin-futures-rustls";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lapin-futures-rustls" = rec {
        crateName = "lapin-futures-rustls";
        version = "0.21.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.21.1.nix {};
        libName = "lapin_futures_rustls";
        authors = [
          "Marc-Antoine Perennou <%arc-Antoine@Perennou.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-https" "dns-over-tls" ];
      };
      "lapin-futures-tls-internal" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-https-rustls" "dns-over-rustls" ];
      };
      "lazy_static" = rec {
      ...
      "trust-dns-https" = rec {
        ...
        version = "0.3.4";
        edition = "2015";
        sha256 = "14ps1fxngm8d3ynp9jf86zrqbyzjzh62v5grwrqb1q0xhbz98vv1";
      ...
      "trust-dns-resolver" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns-over-https" "dns-over-https-rustls" "dns-over-rustls" "dns-over-tls" "rustls" "tokio" "trust-dns-https" "trust-dns-rustls" "webpki-roots" ];
      };
      "trust-dns-rustls" = rec {
        crateName = "trust-dns-rustls";
        version = "0.6.4";
        edition = "2015";
        sha256 = "0vbh2y7w2s5gcw33fn4hb5f927kgjm6603vw63slg9riikmsiq43";
      ...
      "typed-headers" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "0g40nlq5iw0zxhwb7nfmfbr9m86abgwwhxwhzrm10nfq6bsmlvxx";
        authors = [
