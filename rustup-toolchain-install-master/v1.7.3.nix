...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustup-toolchain-install-master/v1.7.3.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rustup-toolchain-install-master";
  ...
  workspaceMembers = {
    "rustup-toolchain-install-master" = rec {
      packageId = "rustup-toolchain-install-master";
      build = internal.buildRustCrateWithFeatures {
        packageId = "rustup-toolchain-install-master";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "async-compression" "blocking" "default" "default-tls" "gzip" "hyper-tls" "native-tls-crate" "tokio-tls" ];
      };
      "rustc-demangle" = rec {
      ...
      "rustup-toolchain-install-master" = rec {
        crateName = "rustup-toolchain-install-master";
        version = "1.7.3";
        edition = "2018";
        crateBin = [
          { name = "rustup-toolchain-install-master"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.7.3.nix {};
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "userenv" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
