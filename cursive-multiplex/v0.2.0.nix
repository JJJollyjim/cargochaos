...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cursive-multiplex/v0.2.0.nix.tmp"
    ...
    crates = {
      ...
      "cursive-multiplex" = rec {
        ...
        crateBin = [
          ...
          { name = "end2end_vertical_focus"; path = "src/bin/end2end_vertical_focus.rs"; }
          ...
          { name = "end2end_horizontal_focus"; path = "src/bin/end2end_horizontal_focus.rs"; }
