...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gcp-pubsub/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gcp-pubsub" = rec {
        crateName = "gcp-pubsub";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "tehAnswer <sergiorodriguezgijon@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "goauth" = rec {
        ...
        version = "0.6.0-beta1";
        edition = "2015";
        sha256 = "0xcr1wqha19wm038rasnxi10lz3k8mbj1ldm7i92pdmx68qg11ja";
        authors = [
          "Drazen Urch <github@drazenur.ch>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "smpl_jwt" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "187asavgnq3jdwmnzgmi24szm3gcm7xmlwa9airdp9v3m3gr5yrw";
        authors = [
          "Drazen Urch <github@drazenur.ch>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
