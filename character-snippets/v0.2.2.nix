...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/character-snippets/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "character-snippets" = rec {
        crateName = "character-snippets";
        version = "0.2.2";
        edition = "2018";
        crateBin = [
          { name = "character-snippets"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "Bram Geron <bram@bram.xyz>"
        ];
        dependencies = [
          {
            name = "chrono";
