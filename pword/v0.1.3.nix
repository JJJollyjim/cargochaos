...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pword/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rpassword" = rec {
        ...
        version = "0.0.4";
        edition = "2015";
        sha256 = "0i4gcvgd8cm5pmqzlywxl95i44n0m9h1vp0ngx6w45w2qxixx78a";
        authors = [
      ...
      "termios" = rec {
        ...
        version = "0.0.5";
        edition = "2015";
        sha256 = "1zn3rb6g5css784rmagfc3778slnaqvp31qk156sg08pfqqil1vm";
        authors = [
