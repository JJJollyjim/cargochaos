...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/devx1/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cosmwasm" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "1gfdd58lgwn1fs66df869dbk2ash9kb8lqvssnm2bzbhahwz4za3";
        authors = [
      ...
      "cosmwasm-vm" = rec {
        ...
        version = "0.7.1";
        edition = "2018";
        sha256 = "1av1plppsnmyh4z6zdfv1a5g2p54xkfx1hc56ramhjxbzzxyf3d3";
        authors = [
          "Ethan Frey <ethanfrey@users.noreply.github.com>"
        ];
        dependencies = [
      ...
      "devx1" = rec {
        ...
        authors = [
          "Taariq Levack <taariql@gmail.com>"
        ];
        dependencies = [
          {
            name = "cosmwasm";
