...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spelling_corrector/v0.2.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "spelling_corrector" = rec {
        crateName = "spelling_corrector";
        version = "0.2.3";
        edition = "2018";
        crateBin = [
          { name = "spelling_corrector"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.3.nix {};
        authors = [
          "NavyaZaveri <navyajayesh+1@gmail.com>"
        ];
        dependencies = [
          {
            name = "generator";
      ...
      "structopt 0.3.7" = rec {
        ...
        dependencies = [
          ...
          {
            name = "structopt-derive";
            packageId = "structopt-derive 0.4.0";
          }
        ];
        features = {
          "color" = [ "clap/color" ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "memoryapi" "minwinbase" "minwindef" "processenv" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" ];
      };
