...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/random_number_generators/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "random_number_generators";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rand_lcg" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1bqlqnfx9qnn07g6djgqvmgbzvwwycyx2can0iw1rhrd9mc71q56";
        authors = [
          "Malcolm Ramsay <malramsay64@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand_core";
      ...
      "random_number_generators" = rec {
        crateName = "random_number_generators";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "random_number_generators"; path = "src/main.rs"; }
        ];
      ...
      "sfmt" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "02g39qfj8xf0nyjjwy942b79a2qbn1hd0y81vkak74g1536kk4i6";
        authors = [
