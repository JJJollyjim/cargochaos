...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zrs/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "objbase" "shlobj" "std" "winbase" "winerror" ];
      };
