...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/zrs/v0.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "shlobj" "std" "winbase" "winerror" "winnt" ];
      };
