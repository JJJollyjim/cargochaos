...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gremlin-client/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tungstenite" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "async-std-runtime" "async-tls" "real-async-tls" "real-native-tls" "real-tokio-tls" "tokio" "tokio-runtime" "tokio-tls" ];
      };
      "autocfg 0.1.7" = rec {
        crateName = "autocfg";
        version = "0.1.7";
      ...
      "gremlin-client" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "async-std-runtime" "async-tls" "async-trait" "async-tungstenite" "async_gremlin" "async_std" "default" "futures" "mobc" "pin-project-lite" "tokio" "tokio-runtime" "tokio-tls" "url" ];
      };
      "hermit-abi" = rec {
      ...
      "mobc" = rec {
        ...
        version = "0.5.7";
        edition = "2018";
        sha256 = "0hfdcydyxjhmk3nnsnwlnjfb685wjlfqfzf1jfjx5jbqqrk5qncy";
        authors = [
        ...
        resolvedDefaultFeatures = [ "async-std" "tokio" "unstable" ];
      };
      "native-tls" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
