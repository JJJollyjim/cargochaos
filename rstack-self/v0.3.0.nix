...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rstack-self/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dw" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1hw0rbrydijcf6y059vq80pj10ymbg4z4jwfnjgvfajwfqmxh3pg";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "dw-sys" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0wx9anfiv11s6kqfmqa74nkjwdx5v73jpcqv0b8nqqpngz43bsql";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "rstack" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1f859v3xklxkdpdlhcx0r13h5vhgq8xp3q4pikhs8b3jj1kzd844";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "dw" "dw_" "lazy_static" "unwind" "unwind_" ];
      };
      "rstack-self" = rec {
        crateName = "rstack-self";
        version = "0.3.0";
        edition = "2018";
        ...
        resolvedDefaultFeatures = [ "default" "dw" "unwind" ];
      };
      "rustc-demangle" = rec {
