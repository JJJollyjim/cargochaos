...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thruster/v0.9.0-alpha.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "thruster" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.9.0-alpha.7.nix {};
        authors = [
          "Pete Mertz <peter.s.mertz@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "chashmap" "default" "file" "hyper" "hyper_server" "native-tls" "tls" "tokio-tls" ];
      };
      "thruster-proc" = rec {
        crateName = "thruster-proc";
        version = "0.9.0-alpha.4";
        edition = "2018";
        sha256 = "1crfhy7d92p9q68y5craaivw492q8gjak9h48ma9g3lnk0n71qx4";
        procMacro = true;
        authors = [
          "Pete Mertz <peter.s.mertz@gmail.com>"
        ];
