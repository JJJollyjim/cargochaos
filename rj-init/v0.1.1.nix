...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rj-init/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "j4rs" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "0kq9m87xvlrcmvlm0jrd0ldab9d85qcax127c4zxnfbg7ygisx91";type = [ "rlib" "cdylib" ];
        authors = [
      ...
      "java-locator" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1ay0lxsnbafh612fxhmmghmhz2lvjjjric0dwg4f48kj8sa35cip";type = [ "rlib" ];
        authors = [
          "aston <astonbitecode@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "libloaderapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
