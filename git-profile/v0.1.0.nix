...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-profile/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-profile" = rec {
        crateName = "git-profile";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "git-profile"; path = "src/main.rs"; }
        ];
      ...
      "ramhorns" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0716gww0h03l048ddahwb94kgcji3bphgkz7hzcj3n5i0hifc9bm";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "export_derive" "ramhorns-derive" ];
      };
      "ramhorns-derive" = rec {
        crateName = "ramhorns-derive";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0qv5crnk9w1dha5x5zf2m9ym54515vvs6zcpgpcmgm3rkl1sdcv4";
        procMacro = true;
        libName = "ramhorns_derive";
        authors = [
          "Maciej Hirsz <maciej.hirsz@pm.me>"
        ];
        dependencies = [
