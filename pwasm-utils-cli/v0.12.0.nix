...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pwasm-utils-cli/v0.12.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pwasm-utils-cli" = rec {
        crateName = "pwasm-utils-cli";
        version = "0.12.0";
        edition = "2015";
        crateBin = [
          { name = "wasm-prune"; path = "prune/main.rs"; }
          { name = "wasm-ext"; path = "ext/main.rs"; }
          { name = "wasm-gas"; path = "gas/main.rs"; }
          { name = "wasm-build"; path = "build/main.rs"; }
          { name = "wasm-stack-height"; path = "stack_height/main.rs"; }
          { name = "wasm-pack"; path = "pack/main.rs"; }
          { name = "wasm-check"; path = "check/main.rs"; }
        ];
