...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/reformation/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "reformation_derive" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1clwbj5bb3w8hy0ckcgxvmc9hhrmp2i455dm9ca47pda2p0sl4bk";
        procMacro = true;
        authors = [
          "hukumka <hukumka212@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
