...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/serde_tuple/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde_tuple_macros" = rec {
        crateName = "serde_tuple_macros";
        version = "0.5.0";
        edition = "2018";
        sha256 = "0zhdcfzb52lb4j5rydnhf2w1hvn66dwrjdpjm8jqws1b38fiaxj0";
        procMacro = true;
        authors = [
          "Jacob Brown <kardeiz@gmail.com>"
        ];
