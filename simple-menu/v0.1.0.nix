...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/simple-menu/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iui" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0mqzlpfjh8sk6pv82ja249n3paigv4rlk3jxg0010gkc8sp37pqw";
        authors = [
          "Leo Tindall <lfstindall@gmail.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
      ...
      "simple-menu" = rec {
        crateName = "simple-menu";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "simple-menu"; path = "src/main.rs"; }
        ];
      ...
      "ui-sys" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "1xf76ydsscbqidqclcnn87w9hdc98wcb4sfgi3wnz47f8qiz9wby";
        authors = [
          "Leo Tindall <lfstindall@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "build" "default" "fetch" ];
      };
      "unicode-xid" = rec {
