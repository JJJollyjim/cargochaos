...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nu" = rec {
        ...
        resolvedDefaultFeatures = [ "all" "battery" "binaryview" "clipboard" "crossterm" "default" "heim" "image" "neso" "onig_sys" "ps" "ptree" "raw-key" "rawkey" "regex" "syntect" "sys" "textview" ];
      };
      "num-bigint" = rec {
