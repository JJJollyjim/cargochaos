...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "anyhow" = rec {
        ...
        version = "1.0.24";
        edition = "2018";
        sha256 = "1vvcghhdwandy5ipnwhddzyxlhwf5mv0nc1g6rmlijmp5143j4ml";
        authors = [
      ...
      "starship" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0ipilb2df50dqf1d4ac32ajjp76yf2vj1z9czmgk1yiffcjd157q";
        authors = [
