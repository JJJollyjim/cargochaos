...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nu" = rec {
        ...
        resolvedDefaultFeatures = [ "average" "battery" "binaryview" "clipboard" "crossterm" "default" "futures-timer" "heim" "inc" "match" "nu_plugin_average" "nu_plugin_binaryview" "nu_plugin_fetch" "nu_plugin_inc" "nu_plugin_match" "nu_plugin_post" "nu_plugin_ps" "nu_plugin_str" "nu_plugin_sum" "nu_plugin_sys" "nu_plugin_textview" "nu_plugin_tree" "onig_sys" "ps" "semver" "stable" "starship" "starship-prompt" "str" "sum" "syntect" "sys" "textview" "trace" "tree" "url" ];
      };
      "nu-build" = rec {
        crateName = "nu-build";
        version = "0.7.0";
