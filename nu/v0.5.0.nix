...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-stream" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0wzsavkx40z3fl55qfks8jr3qi1m37xk8c755v20cxg4cyvfj2v5";
        authors = [
      ...
      "nom-tracable" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0a15592ggj0i91r5n3vk431iq4557alcjrkrl7a33n1p52nn9apd";
        authors = [
      ...
      "nom-tracable-macros" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0ra77nsr1plr1mpakwkcfzgfjk79k7zx6gbb82ynizm9fw4gf9gx";
        procMacro = true;
        authors = [
          "dalance <dalance@gmail.com>"
        ];
      ...
      "nu" = rec {
        ...
        crateBin = [
          ...
          { name = "nu_plugin_read"; path = "src/plugins/read.rs"; }
        ...
        resolvedDefaultFeatures = [ "all" "battery" "binaryview" "clipboard" "crossterm" "default" "heim" "image" "neso" "onig_sys" "ps" "raw-key" "rawkey" "syntect" "sys" "textview" ];
      };
      "num-bigint" = rec {
