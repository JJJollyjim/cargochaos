...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nu/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "anyhow" = rec {
        ...
        version = "1.0.20";
        edition = "2018";
        sha256 = "0287karf6nz4qfhjpwqqcr7xwkd3g9jy0n07158vzfg67w85b0bn";
        authors = [
      ...
      "calamine" = rec {
        ...
        version = "0.16.0";
        edition = "2015";
        sha256 = "0bwqsba9j0p8yii2qw4svfxb7p8w3zvahggv0szhfw5k3ljgjg91";
        authors = [
      ...
      "heim" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "0xsvmycj9lc0r1clvvi4wlda8n6mnz8bs5a6cfmxancnmrk8916y";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-common" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "001iyp47snmqdw4av8rbnfny9ziyrlbdz0q3d84k4mv93v1hix33";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-cpu" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "1vv40q4l4ldicmpgnpc3asl4iiqnvj6ppch4slaahs5xzm6h11ap";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-derive" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "12qqbjqy4fx1bxlknsavk4kjp79jb4am5wg7piab5hbk8vgvwwwm";
        procMacro = true;
        authors = [
          "svartalf <self@svartalf.info>"
        ];
      ...
      "heim-disk" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "0ri3lx386l89925ipjdnmf4wqfgin2yvza3hrbj8m0k44pk80jf8";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-host" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "1lwf4py2191rqmhkhkwwnmlb06xxi23kgghicdvanswzjvaikq0x";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-memory" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "1ifdk6zfm35jamisgy2mblwb8k8qv6pz236dglwahz8r6djbxkd9";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-net" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "0wz059l46hq1cbrrfdkxhcly5q5fwzvhcjzz54rb5y5j1rcmw3vv";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-process" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "08g16wy5vc3n3g0hlrbqcyzh091fng98fyiyjp3w1f9rccqp8j56";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-runtime" = rec {
        ...
        version = "0.0.4";
        edition = "2018";
        sha256 = "1lgvwmhhwz7zx7a1n4xvi1fl5264wfq4shdi6xjiwl2smfsi1vqk";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-sensors" = rec {
        ...
        version = "0.0.3";
        edition = "2018";
        sha256 = "12s0bg2ipkbsvi4ikciw6h2wbq24h1ffpqa3vmv1mjib0g4v7n4a";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "heim-virt" = rec {
        ...
        version = "0.0.8";
        edition = "2018";
        sha256 = "0avfach7alyl78a6yb77mk1h4py6mdjw0c7irpxsh46s2i9xlbdv";
        authors = [
          "svartalf <self@svartalf.info>"
        ];
        dependencies = [
      ...
      "nu" = rec {
        ...
        crateBin = [
          ...
          { name = "nu_plugin_average"; path = "src/plugins/average.rs"; }
          { name = "nu_plugin_embed"; path = "src/plugins/embed.rs"; }
          { name = "nu_plugin_insert"; path = "src/plugins/insert.rs"; }
          { name = "nu_plugin_edit"; path = "src/plugins/edit.rs"; }
          { name = "nu_plugin_format"; path = "src/plugins/format.rs"; }
          { name = "nu_plugin_parse"; path = "src/plugins/parse.rs"; }
          { name = "nu_plugin_str"; path = "src/plugins/str.rs"; }
          { name = "nu_plugin_skip"; path = "src/plugins/skip.rs"; }
          { name = "nu_plugin_match"; path = "src/plugins/match.rs"; }
          ...
          { name = "nu_plugin_docker"; path = "src/plugins/docker.rs"; }
        ...
        resolvedDefaultFeatures = [ "battery" "binaryview" "clipboard" "crossterm" "default" "heim" "image" "neso" "onig_sys" "ps" "raw-key" "rawkey" "starship" "starship-prompt" "syntect" "sys" "textview" ];
      };
      "nu-source" = rec {
        crateName = "nu-source";
        version = "0.1.0";
        edition = "2018";
        sha256 = "181n7fjqa7r9i7975n1shk46aqvfn766y239vc07mjvvs3vz2ww5";
        authors = [
          "Yehuda Katz <wycats@gmail.com>"
        ];
        dependencies = [
      ...
      "starship" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1n07jy7fnv5sdq2d3mx9smx4mbjhrr85hlc8ixfgs2pp3qrr24fk";
        authors = [
      ...
      "starship_module_config_derive" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "18b97qjvnqd4yfbdrxj381ys7x9y9yfpi2ajad8jb12qy7i4gl9n";
        procMacro = true;
        authors = [
          "Matan Kushner <hello@matchai.me>"
        ];
