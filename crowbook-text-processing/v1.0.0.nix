...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crowbook-text-processing/v1.0.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "crowbook-text-processing";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crowbook-text-processing" = rec {
        crateName = "crowbook-text-processing";
        version = "1.0.0";
        edition = "2015";
        crateBin = [
          { name = "crowbook_text_processing"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        libName = "crowbook_text_processing";
