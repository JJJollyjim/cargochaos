...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kubectl-view-allocations/v0.7.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "kubectl-view-allocations";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kube" = rec {
        ...
        version = "0.25.0";
        edition = "2018";
        sha256 = "0skacragwh4jypmcs0qjrm0nvg926k6vr8qb3s33dr4xmdqklhrq";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "k8s-openapi" "native-tls" "openapi" "openssl" ];
      };
      "kubectl-view-allocations" = rec {
        crateName = "kubectl-view-allocations";
        version = "0.7.2";
        edition = "2018";
        crateBin = [
          { name = "kubectl-view-allocations"; path = "src/main.rs"; }
        ];
