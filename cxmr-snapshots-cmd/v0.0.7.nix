...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cxmr-snapshots-cmd/v0.0.7.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cxmr-candles" = rec {
        crateName = "cxmr-candles";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1vwcrpyl8rysjkjfb8b31d8jvp48sbg0h2m1h01li07yd3473spk";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "analysis" "cxmr-ta" "default" ];
      };
      "cxmr-currency" = rec {
      ...
      "cxmr-orderbook" = rec {
        crateName = "cxmr-orderbook";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1kk47kdsqfs7qk8gn893xqjn236820g9x6pzkrc8rnm1ljj7iiav";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-snapshots" = rec {
        crateName = "cxmr-snapshots";
        version = "0.0.6";
        edition = "2018";
        sha256 = "05rqvl2isk8cw222ing46fi09s45qxc390bx7ibcz74vvs0b3c95";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-snapshots-cmd" = rec {
        crateName = "cxmr-snapshots-cmd";
        version = "0.0.7";
        edition = "2018";
        crateBin = [
          { name = "cxmr-snapshot"; path = "bin/main.rs"; }
        ];
      ...
      "cxmr-ta" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        sha256 = "0p5r8ihh4lc1bb8iaw1badsw1xywklff0h4v6xhs1n7si5lwhfdj";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "cxmr-ta-core" = rec {
        crateName = "cxmr-ta-core";
        version = "0.1.5";
        edition = "2018";
        sha256 = "05ji6wz5iqf70sa0b8j2wy5k649xmw5yqziw32r09lb1fwqs4jyk";
        authors = [
      ...
      "cxmr-tectonic" = rec {
        crateName = "cxmr-tectonic";
        version = "0.0.1";
        edition = "2018";
        sha256 = "1ci0sk2s0p9j6q8f8w5q53wav52biirvs194dwhr5qwjr4yplvf1";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
