...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/r53ddns/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "r53ddns" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "r53ddns"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.0.nix {};
        libPath = "src/r53ddns.rs";
        authors = [
      ...
      "rusoto_route53" = rec {
        crateName = "rusoto_route53";
        version = "0.43.0-beta.1";
        edition = "2018";
        sha256 = "00lzwbarcdzc15ciz6pp5cg49akfh5in4v7qip17f8srksxwybpf";
        authors = [
          "Anthony DiMarco <ocramida@gmail.com>"
          "Jimmy Cuadra <jimmy@jimmycuadra.com>"
          "Matthew Mayer <matthewkmayer@gmail.com>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
