...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xml_to_json/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xml_to_json" = rec {
        crateName = "xml_to_json";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "xml_to_json"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Andres Garcia <andresa.garciah621@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
