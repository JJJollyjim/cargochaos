...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kanidm_tools/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kanidm_client" = rec {
        crateName = "kanidm_client";
        version = "0.1.1";
        edition = "2018";
        sha256 = "022wdvv535k7pwyjn8acdr4v4kn6921wsw7mj9v6qbjdnbv5skyj";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "reqwest";
            packageId = "reqwest";
            features = [ "blocking" "cookies" "json" "native-tls" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "kanidm_tools" = rec {
        crateName = "kanidm_tools";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "kanidm"; path = "src/main.rs"; }
          { name = "kanidm_ssh_authorizedkeys_direct"; path = "src/ssh_authorizedkeys.rs"; }
          { name = "kanidm_badlist_preprocess"; path = "src/badlist_preprocess.rs"; }
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "blocking" "cookie_crate" "cookie_store" "cookies" "default" "default-tls" "hyper-tls" "json" "native-tls" "native-tls-crate" "serde_json" "tokio-tls" ];
      };
      "rpassword" = rec {
        crateName = "rpassword";
        version = "0.4.2";
