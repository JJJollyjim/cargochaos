...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidpublisher3-cli/v1.0.13+20200331.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidpublisher3" = rec {
        ...
        edition = "2015";
        sha256 = "0g9wvpsdx6507368cg7wsf7wmpjjygwpszklnfsr6yj7l0cm4n9s";
        authors = [
