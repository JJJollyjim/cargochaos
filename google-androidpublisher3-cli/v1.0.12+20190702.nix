...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-androidpublisher3-cli/v1.0.12+20190702.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-androidpublisher3-cli";
  ...
  workspaceMembers = {
    "google-androidpublisher3-cli" = rec {
      packageId = "google-androidpublisher3-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-androidpublisher3-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-androidpublisher3" = rec {
        crateName = "google-androidpublisher3";
        version = "1.0.12+20190702";
        edition = "2015";
        sha256 = "01hms4lfk8srypvmsxnfd6wwm36av5kh5l3ybmiyp7dqxc79ijmj";
        authors = [
      ...
      "google-androidpublisher3-cli" = rec {
        crateName = "google-androidpublisher3-cli";
        version = "1.0.12+20190702";
        edition = "2015";
        crateBin = [
          { name = "androidpublisher3"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-androidpublisher3";
          }
          {
            name = "hyper";
            packageId = "hyper";
