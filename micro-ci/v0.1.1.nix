...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/micro-ci/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hubcaps" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "0d2k8n6lvdq8hvhwnpa55x9ixjfq5d7v6xs679q26bny0k0zca3q";
        authors = [
          "softprops <d.tangren@gmail.com>"
        ];
        dependencies = [
      ...
      "micro-ci" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "micro-ci"; path = "src/main.rs"; }
        ];
