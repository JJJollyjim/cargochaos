...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nature_demo_executor_restful/v0.6.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "nature_demo_executor_restful";
  ...
  workspaceMembers = {
    "nature_demo_executor_restful" = rec {
      packageId = "nature_demo_executor_restful";
      build = internal.buildRustCrateWithFeatures {
        packageId = "nature_demo_executor_restful";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nature_demo_executor_restful" = rec {
        crateName = "nature_demo_executor_restful";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "restful_executor"; path = "src/bin/restful_executor.rs"; }
        ];
      ...
      "uuid" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "md5" "std" "v3" ];
      };
      "vcpkg" = rec {
        crateName = "vcpkg";
        version = "0.2.8";
