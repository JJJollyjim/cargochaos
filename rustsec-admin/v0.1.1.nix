...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustsec-admin/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustsec" = rec {
        ...
        version = "0.15.1";
        edition = "2018";
        sha256 = "0jl4zmp2hga43syr77s18a086w5h2msnm4hrlsllhxnvr00rkv3z";
        authors = [
          "Tony Arcieri <bascule@gmail.com>"
        ];
        dependencies = [
      ...
      "rustsec-admin" = rec {
        crateName = "rustsec-admin";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "rustsec-admin"; path = "src/bin/rustsec-admin/main.rs"; }
        ];
