...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-movemint/v0.0.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-movemint" = rec {
        crateName = "cargo-movemint";
        version = "0.0.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-movemint"; path = "src/bin/cargo-movemint/main.rs"; }
        ];
