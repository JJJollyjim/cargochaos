...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust_transit_kafka/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust_transit_kafka" = rec {
        crateName = "rust_transit_kafka";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rust_transit_kafka"; path = "src/main.rs"; }
        ];
