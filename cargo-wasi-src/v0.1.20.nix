...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-wasi-src/v0.1.20.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "wasmparser 0.48.1" = rec {
        crateName = "wasmparser";
        version = "0.48.1";
        edition = "2018";
        sha256 = "01yc6ynw20z7aha1c98rdbq4wbh9kd2i64fmyi93way75ycajhqq";
        authors = [
          "Yury Delendik <ydelendik@mozilla.com>"
        ];
        features = {
