...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/monotree/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "monotree" = rec {
        ...
        authors = [
          "Francis Lim <thyeem@gmail.com>"
          "Jongwhan Lee <leejw51@gmail.com>"
        ];
        dependencies = [
          {
            name = "blake2-rfc";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwinbase" "minwindef" "ntstatus" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
