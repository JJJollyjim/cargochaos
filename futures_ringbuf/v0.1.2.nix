...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/futures_ringbuf/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "compat" "default" "nightly" "std" ];
      };
      ...
      "futures-util-preview" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "async-await" "channel" "compat" "default" "futures-channel-preview" "futures-io-preview" "futures-join-macro-preview" "futures-select-macro-preview" "futures-sink-preview" "futures_01" "io" "join-macro" "memchr" "nightly" "proc-macro-hack" "proc-macro-nested" "rand" "select-macro" "sink" "slab" "std" ];
      };
      "futures_codec" = rec {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "winbase" "winerror" "winnt" "winuser" ];
      };
