...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/a2/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-alpn" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "0v7rmz375lf58k7q9a4yd28n7mnd2yvylxyl9z9yga2yy3lyia55";
        authors = [
          "Julius de Bruijn <julius@nauk.io>"
        ];
        dependencies = [
      ...
      "syn 0.15.44" = rec {
        ...
        resolvedDefaultFeatures = [ "derive" "parsing" "printing" "quote" ];
      };
      "syn 1.0.11" = rec {
        crateName = "syn";
        version = "1.0.11";
