...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/a2/v0.5.0-alpha.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "a2" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.7.nix {};
        authors = [
      ...
      "hyper-alpn" = rec {
        ...
        edition = "2018";
        sha256 = "0fcg717d6a2j1v5vfvb501ib5y4v5pczmz0rnblgf8xx7sb63s5j";
        authors = [
          "Julius de Bruijn <julius@nauk.io>"
        ];
        dependencies = [
      ...
      "tokio-rustls" = rec {
        ...
        edition = "2018";
        sha256 = "117qdqk2vmxhzaz8r25dxam7arbyna064cxyrjbv8asy1sycf8ls";
        authors = [
