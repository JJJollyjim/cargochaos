...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/a2/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
        ...
        dependencies = [
          {
            ...
            packageId = "proc-macro-hack 0.5.11";
          }
          {
            name = "proc-macro2";
      ...
      "hyper-alpn" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0njkrljx7lmild6sdc23fk853ly31gq9s1n7vwh71izhsx1zdhaf";
        authors = [
          "Julius de Bruijn <julius@nauk.io>"
        ];
        dependencies = [
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-threaded" "net" ];
          }
        ];
      ...
      "indoc" = rec {
        ...
        dependencies = [
          ...
          {
            name = "proc-macro-hack";
            packageId = "proc-macro-hack 0.4.1";
          }
        ];
        features = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "io-driver" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "tcp" "time" "tokio-macros" "udp" "uds" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
