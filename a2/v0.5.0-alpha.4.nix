...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/a2/v0.5.0-alpha.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "a2" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0-alpha.4.nix {};
        authors = [
      ...
      "hyper-alpn" = rec {
        ...
        edition = "2018";
        sha256 = "177pv5brigxwnj22gq4f6fy8rcj9b3ajrryb5kj79l3n9l51pcnw";
        authors = [
          "Julius de Bruijn <julius@nauk.io>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
