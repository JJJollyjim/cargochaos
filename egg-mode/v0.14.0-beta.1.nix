...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/egg-mode/v0.14.0-beta.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "egg-mode" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.14.0-beta.1.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "hyper-rustls" "hyper-tls" "native-tls" "native_tls" ];
      };
      "fake-simd" = rec {
        crateName = "fake-simd";
        version = "0.1.2";
