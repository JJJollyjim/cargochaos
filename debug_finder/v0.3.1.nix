...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/debug_finder/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "debug_finder" = rec {
        crateName = "debug_finder";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "debug_finder"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Maciej Zaręba <Clinkz155@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
