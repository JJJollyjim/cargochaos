...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/svd2rust/v0.17.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "svd-parser" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1qhvdz3k76i3sfypcy8c84hhb8sqixrckba21kalzcpgy6an45ml";
        authors = [
        ...
        resolvedDefaultFeatures = [ "derive-from" ];
      };
      "svd2rust" = rec {
        crateName = "svd2rust";
        version = "0.17.0";
        edition = "2018";
        crateBin = [
          { name = "svd2rust"; path = "src/main.rs"; }
        ];
