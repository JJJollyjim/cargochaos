...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rusty-guess/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusty-guess" = rec {
        crateName = "rusty-guess";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rusty-guess"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Hammed Oyedele <itz.harmid@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
