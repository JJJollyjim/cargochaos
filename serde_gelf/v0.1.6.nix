...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/serde_gelf/v0.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serde-value-utils" = rec {
        crateName = "serde-value-utils";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1jgbfd81gns2srdi3anlq4v6cnis89qwp4fj3bz4yilks8237rzm";
        authors = [
          "OVH SAS <github@ovh.net>"
        ];
        dependencies = [
          {
            name = "serde";
        ...
        resolvedDefaultFeatures = [ "with-schema" ];
      };
      "serde_derive" = rec {
      ...
      "serde_gelf" = rec {
        ...
        dependencies = [
          ...
          {
            name = "serde-value-utils";
            packageId = "serde-value-utils";
          }
          {
            name = "serde_derive";
        ...
        features = {
          "ovh-ldp" = [ "serde-value-utils/with-schema" ];
        };
        resolvedDefaultFeatures = [ "ovh-ldp" ];
      };
      "serde_json" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "processthreadsapi" "winbase" "wow64apiset" ];
      };
