...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bingrep/v0.8.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hexplay" = rec {
        ...
        version = "0.2.1";
        edition = "2015";
        sha256 = "162qmkp3idzg6lj024nzv9apbzp4wc7s0jms8fjbaa0yffkbwqh9";
        authors = [
          "Tom Moers <tmoers@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "atty";
      ...
      "metagoblin" = rec {
        crateName = "metagoblin";
        version = "0.3.1";
        edition = "2018";
        sha256 = "087v6x85946nw8pj81hxflak7xdpgi3i2zn05hhqdn9pinjdbd80";
        authors = [
          "m4b <m4b.github.io@gmail.com>"
        ];
        dependencies = [
      ...
      "structopt" = rec {
        ...
        dependencies = [
          ...
          {
            name = "structopt-derive";
            packageId = "structopt-derive 0.4.1";
          }
        ];
        features = {
          "color" = [ "clap/color" ];
      ...
      "structopt-derive 0.4.1" = rec {
        ...
        dependencies = [
          ...
          {
            name = "proc-macro-error";
            packageId = "proc-macro-error 0.4.5";
          }
          {
            name = "proc-macro2";
            packageId = "proc-macro2";
