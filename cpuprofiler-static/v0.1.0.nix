...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cpuprofiler-static/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cpuprofiler-static" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "gperftools" "unwind" ];
      };
      "dbghelp-sys" = rec {
