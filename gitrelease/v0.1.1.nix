...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gitrelease/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gitrelease" = rec {
        crateName = "gitrelease";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "gitrelease"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Hengfeng Li <hengf.li@gmail.com>"
        ];
        dependencies = [
          {
            name = "chrono";
