...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cabot/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cabot" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "functional_tests" "pretty_env_logger" "pretty_log" ];
      };
      "cc" = rec {
        crateName = "cc";
        version = "1.0.50";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
