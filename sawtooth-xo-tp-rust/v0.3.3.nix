...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sawtooth-xo-tp-rust/v0.3.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sawtooth-sdk" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "0zbaa4r4pmdpzzn2k4yq0ky6wkalz3agisip77l9x67l305r7y13";
        authors = [
          "Bitwise IO, Inc."
          "Intel Corporation"
        ];
