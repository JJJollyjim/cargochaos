...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust_graphics_packer/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rust_graphics_packer";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust_graphics_packer" = rec {
        crateName = "rust_graphics_packer";
        version = "0.1.0";
        edition = "2015";
        crateBin = [
          { name = "rust_graphics_packer"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "debug_derive" "verbose_log" ];
      };
      "ryu" = rec {
        crateName = "ryu";
        version = "1.0.2";
