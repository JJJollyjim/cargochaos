...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/physx/v0.5.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "physx-macros" = rec {
        crateName = "physx-macros";
        version = "0.1.1";
        edition = "2018";
        sha256 = "0rhrlkchys6imc2iahwnabgi4zk3xdwgdvf82yw16ha2i6dd2ki7";
        procMacro = true;
        authors = [
          "Embark <opensource@embark-studios.com>"
        ];
      ...
      "physx-sys" = rec {
        ...
        version = "0.3.0";
        edition = "2018";
        sha256 = "1zigsyv8y9dfgglqcxymsqn6540sjf1lja6awa2hi1qr0jv7541f";
        authors = [
          "Embark <opensource@embark-studios.com>"
