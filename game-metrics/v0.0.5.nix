...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/game-metrics/v0.0.5.nix.tmp"
    ...
    crates = {
      ...
      "game-metrics" = rec {
        ...
        dependencies = [
          ...
          {
            name = "game-metrics-macro";
            packageId = "game-metrics-macro";
          }
          {
            name = "hdrhistogram";
        ...
        resolvedDefaultFeatures = [ "crossbeam-channel" "default" "disable" "hdrhistogram" "log" "logging" "metrics" "quanta" "threads" ];
      };
      "game-metrics-macro" = rec {
        crateName = "game-metrics-macro";
        version = "0.0.4";
        edition = "2018";
        sha256 = "15h6nzzgw3lyyl76jn8s16kqw6i6mhwg3snpa5x4rj4gw57xw1sg";
        procMacro = true;
        authors = [
          "Walter Pearce <jaynus@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "minwindef" "ntstatus" "profileapi" "winbase" "winerror" "winnt" ];
      };
