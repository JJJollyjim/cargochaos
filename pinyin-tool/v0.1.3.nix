...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pinyin-tool/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pinyin" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "132s89n6h6bs0h8nxw6ks4gjihzs17snqzg8asyl7s1gm8nmcw3s";
        authors = [
          "mozillazg <mozillazg101@gmail.com>"
          "Xidorn Quan <me@upsuper.org>"
        ];
        features = {
          "compat" = [ "plain" "with_tone" "with_tone_num" "heteronym" ];
          "default" = [ "compat" "plain" "with_tone" "with_tone_num" "with_tone_num_end" "heteronym" ];
        };
        resolvedDefaultFeatures = [ "compat" "default" "heteronym" "plain" "with_tone" "with_tone_num" "with_tone_num_end" ];
      };
      "pinyin-tool" = rec {
        crateName = "pinyin-tool";
        version = "0.1.3";
        edition = "2018";
        crateBin = [
          { name = "pinyin-tool"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Brian Kung <github@briankung.xyz>"
        ];
        dependencies = [
          {
            name = "jieba-rs";
