...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/b2sum-rust/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "memoryapi" "processthreadsapi" "sysinfoapi" "winnt" ];
      };
