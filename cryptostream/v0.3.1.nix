...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cryptostream/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cryptostream" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "openssl-vendored" ];
      };
      "foreign-types" = rec {
