...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/usage-tracker/v0.1.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "standard_paths" = rec {
        crateName = "standard_paths";
        version = "0.4.6";
        edition = "2015";
        sha256 = "0d57wq2c8r1r5xpqf26ixpyw734gzm4mwig6rm3x19g0py88xhk0";
        authors = [
      ...
      "usage-tracker" = rec {
        crateName = "usage-tracker";
        version = "0.1.5";
        edition = "2018";
        crateBin = [
          { name = "usage-tracker"; path = "src/main.rs"; }
        ];
      ...
      "users" = rec {
        ...
        version = "0.5.3";
        edition = "2015";
        sha256 = "1psw930gzrm5vk4ldwzk4ndbwpyvivq3kki5iahydq3wy4bgpn77";
        authors = [
          "ogham@bsago.me"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" ];
      };
