...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guessing_game_crate/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guessing_game_crate" = rec {
        crateName = "guessing_game_crate";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "guessing_game_crate"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Tyler Oalman <tyleroalman@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
