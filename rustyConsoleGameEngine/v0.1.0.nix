...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustyConsoleGameEngine/v0.1.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rustyConsoleGameEngine";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustyConsoleGameEngine" = rec {
        crateName = "rustyConsoleGameEngine";
        version = "0.1.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Mark Anthony <markanthonymartinez9@gmail.com>"
        ];
        dependencies = [
          {
            name = "rand";
          ...
          }
          {
            ...
            features = [ "handleapi" "processenv" "wincon" "winbase" "winuser" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "processenv" "winbase" "wincon" "winuser" ];
      };
