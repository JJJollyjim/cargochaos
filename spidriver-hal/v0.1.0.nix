...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/spidriver-hal/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "serial-embedded-hal" = rec {
        crateName = "serial-embedded-hal";
        version = "0.1.2";
        edition = "2015";
        sha256 = "1k5ijcp3avzsv4fbk39dqjqkjh4ghx3slqj2mala5xjzhz1ssz1a";
        authors = [
          "Brandon Matthews <bmatthews@zipcar.com>"
        ];
        dependencies = [
          {
            name = "embedded-hal";
      ...
      "spidriver" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1hzrn2r93q9rpg67040wmhf8q1mggbkdqyrlmm63skxqcgw03a8z";
        authors = [
      ...
      "spidriver-hal" = rec {
        ...
        devDependencies = [
          {
            name = "serial-embedded-hal";
            packageId = "serial-embedded-hal";
          }
        ];
