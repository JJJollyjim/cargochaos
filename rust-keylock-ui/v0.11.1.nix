...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-keylock-ui/v0.11.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "j4rs" = rec {
        ...
        version = "0.11.2";
        edition = "2018";
        sha256 = "1hxd87w83fvccwwf269ycx6i96ymyr3qjwdviz0hip436l3kw20i";type = [ "rlib" "cdylib" ];
        authors = [
          "aston <astonbitecode@gmail.com>"
        ];
        dependencies = [
          {
            name = "cesu8";
      ...
      "java-locator" = rec {
        crateName = "java-locator";
        version = "0.1.2";
        edition = "2018";
        crateBin = [];
        sha256 = "1pzrl07j41ahlsylbj1ppxfd3rpciarn8vdb7dnizrbmyy9jjh32";type = [ "rlib" ];
        authors = [
          "aston <astonbitecode@gmail.com>"
        ];
        dependencies = [
      ...
      "rust-keylock-ui" = rec {
        crateName = "rust-keylock-ui";
        version = "0.11.1";
        edition = "2018";
        crateBin = [
          { name = "rust-keylock-ui"; path = "src/main.rs"; }
        ];
      ...
      "rust_keylock" = rec {
        crateName = "rust_keylock";
        version = "0.11.0";
        edition = "2018";
        sha256 = "1fk7693rrkf5zb1qwn6fskzyj9im6yacwmyd6iyww6s6ilajsz6s";type = [ "rlib" "dylib" ];
        authors = [
          "aston <astonbitecode@gmail.com>"
        ];
        dependencies = [
      ...
      "toml" = rec {
        ...
        resolvedDefaultFeatures = [ "indexmap" "preserve_order" ];
      };
      "traitobject" = rec {
