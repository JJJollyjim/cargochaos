...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sensor-scd30/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sensor-scd30" = rec {
        crateName = "sensor-scd30";
        version = "0.3.0";
        edition = "2018";
        crateBin = [
          { name = "scd30-util"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "humantime" "linux-embedded-hal" "simplelog" "structopt" "util" ];
      };
      "simplelog" = rec {
        crateName = "simplelog";
        version = "0.5.3";
