...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libmdns/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libmdns" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "sync" "udp" "stream" "rt-core" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-driver" "lazy_static" "mio" "rt-core" "stream" "sync" "udp" ];
      };
      "unicode-xid" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
