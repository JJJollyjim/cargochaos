...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rumq-cli/v0.1.0-alpha.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rumq-broker" = rec {
        crateName = "rumq-broker";
        version = "0.1.0-alpha.5";
        edition = "2018";
        sha256 = "1qkjnlw8jgmcnv8x2cxm0zqbvg70yhq99mrxvd244a82kxsh0rh3";
        authors = [
          "tekjar <kraviteza@gmail.com>"
        ];
        dependencies = [
          {
            name = "bytes";
      ...
      "rumq-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rumq-cli"; path = "src/main.rs"; }
        ];
      ...
      "rumq-core" = rec {
        ...
        version = "0.1.0-alpha.5";
        edition = "2018";
        sha256 = "18wssfra9cq9xwyj779lipspqc6n71yyh4i0fpdwhspraqjljih8";
        authors = [
          "tekjar"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
