...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bulletml_viewer/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bulletml_viewer" = rec {
        crateName = "bulletml_viewer";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "bulletml_viewer"; path = "src/main.rs"; }
        ];
