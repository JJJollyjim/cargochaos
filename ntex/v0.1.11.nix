...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ntex/v0.1.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ntex-codec" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1m760lcc0xyrz508gz5c4rqi6lvfbjin0q66g9jcnk6cqgi0mbfk";
        libName = "ntex_codec";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
      ...
      "ntex-router" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "1cf0x1jiqasdij18cfyyvggdffzl7dr6zkx4hmf61zd9nxqwzbzl";
        libName = "ntex_router";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
