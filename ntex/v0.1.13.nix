...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ntex/v0.1.13.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ntex" = rec {
        ...
        resolvedDefaultFeatures = [ "brotli2" "compress" "coo-kie" "cookie" "default" "flate2" "open-ssl" "openssl" "rust-tls" "rustls" "tokio-openssl" "tokio-rustls" "webpki" "webpki-roots" ];
      };
      "ntex-codec" = rec {
