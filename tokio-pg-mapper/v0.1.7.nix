...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-pg-mapper/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio-pg-mapper" = rec {
        ...
        resolvedDefaultFeatures = [ "derive" "tokio-pg-mapper-derive" ];
      };
      "tokio-pg-mapper-derive" = rec {
        crateName = "tokio-pg-mapper-derive";
        version = "0.1.5";
        edition = "2018";
        sha256 = "0576sjndap1567cljxlnhm252207zaw5jnx781bh77rv7fnlas9v";
        procMacro = true;
        authors = [
          "Darin Gordon <dkcdkg@gmail.com>"
          "Zeyla Hellyer <zeyla@hellyer.dev>"
