...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mio/v0.7.0-alpha.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "guide" "os-poll" "os-util" "tcp" "udp" "uds" ];
      };
      "miow" = rec {
        crateName = "miow";
        version = "0.3.3";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "errhandlingapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "profileapi" "std" "synchapi" "winbase" "windef" "winerror" "winioctl" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
