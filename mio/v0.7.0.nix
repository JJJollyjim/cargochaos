...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mio/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "extra-docs" "os-poll" "os-util" "tcp" "udp" "uds" ];
      };
      "miow" = rec {
        crateName = "miow";
        version = "0.3.3";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "std" "synchapi" "windef" "winerror" "winioctl" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
