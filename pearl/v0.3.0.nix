...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pearl/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pearl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "benchmark"; path = "src/benchmark/bin.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "benchmark" "clap" ];
      };
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "rt-core" "slab" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
