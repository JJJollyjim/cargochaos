...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-maj/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-maj" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-maj"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.6.nix {};
        authors = [
          "Artefaritaj <artefaritaj@0nline.fr>"
        ];
        dependencies = [
          {
            name = "app_dirs";
      ...
      "file-fetcher" = rec {
        crateName = "file-fetcher";
        version = "0.1.4";
        edition = "2018";
        sha256 = "08cynkfyk6g6jkvqiivinngjbp161hgfh67yj166r1kcax3f52ag";
        authors = [
          "Artefaritaj <artefaritaj@0nline.fr>"
        ];
        dependencies = [
      ...
      "libmaj" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "1ki8gc396vwkkl3919yyncgwkif3w3gqy3zk5vhkhl7zj4sv8l8g";
        authors = [
          "Artefaritaj <artefaritaj@0nline.fr>"
        ];
        dependencies = [
