...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fastblur/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        version = "0.15.0";
        edition = "2015";
        sha256 = "1xr13r9dbbx6gdfhi4fn5dqpnb46px31s04qlzm1ra8zlpa00iv3";
        authors = [
          "ccgn"
      ...
      "png" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "0g7far28rk3z5hcglxybwmamwvpsdjhj4bfm15czais4xrp4fmpj";
        authors = [
          "nwin <nwin@users.noreply.github.com>"
        ];
        dependencies = [
