...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rustimate/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rustimate" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "rustimate"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "rustimate-controllers";
          }
          {
            name = "rustimate-core";
            packageId = "rustimate-core";
          }
          {
            name = "rustimate-service";
            packageId = "rustimate-service";
          }
          {
            name = "rustimate-templates";
            packageId = "rustimate-templates";
          }
          {
            name = "ryu";
            packageId = "ryu";
      ...
      "rustimate-assets" = rec {
        crateName = "rustimate-assets";
        version = "0.1.0";
        edition = "2018";
        sha256 = "15ky1v7pm46r3mivm2pb3v93filh0gmalia1s798vaahrg0chz57";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "rustimate-controllers" = rec {
        crateName = "rustimate-controllers";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1a45i91drmr4i7kih6yrfqcjrw3gdrpar03zrq0cx386jmcwxpad";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
          ...
          {
            name = "rustimate-assets";
            packageId = "rustimate-assets";
          }
          {
            name = "rustimate-core";
            packageId = "rustimate-core";
      ...
      "rustimate-core" = rec {
        crateName = "rustimate-core";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0x7wnlir9cjf8l6k9dvgng993h9qx1r06cgs73xjqk3i4xqcjy3x";
        authors = [
      ...
      "rustimate-service" = rec {
        crateName = "rustimate-service";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0wsmds6a03rf16xr5mblf53rdgva4hnv1cdn8sdfdx2gpj6k7lls";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
      ...
      "rustimate-templates" = rec {
        crateName = "rustimate-templates";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0lhqpd7c2v5634q1chkikkm5084i77r74g1rdlir85p93d402268";
        authors = [
          "Kyle U <kyle@kyleu.com>"
        ];
        dependencies = [
