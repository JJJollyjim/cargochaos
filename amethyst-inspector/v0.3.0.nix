...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amethyst-inspector/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ahash" = rec {
        ...
        version = "0.2.16";
        edition = "2018";
        sha256 = "1d2hd61fgbh82ysmrsyhji5js59pbsv80cdp9qmq9haplsbgqpdk";
        authors = [
      ...
      "amethyst-imgui" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "1c2q19qhzmh6h6yccwl5m28lxf46mnyb634ghq9kkavjyfwaa4cc";
        authors = [
      ...
      "amethyst_rendy" = rec {
        ...
        resolvedDefaultFeatures = [ "amethyst_window" "vulkan" "window" ];
      };
      "amethyst_ui" = rec {
