...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/monirs/v0.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kern" = rec {
        ...
        version = "1.1.0";
        edition = "2018";
        sha256 = "1l8zr8cp8j0gk1dklzqdpdjv9jlxc4m853gm4whs81dl6yx5q0g2";
        authors = [
      ...
      "lhi" = rec {
        ...
        version = "0.0.0-dev.1";
        edition = "2018";
        sha256 = "0lvma54b8g5636a5bag69i7i7l02qax13bdpy51v1xxp9g4xi9vd";
        authors = [
          "Lennart Heinrich <lennart@ltheinrich.de>"
        ];
        dependencies = [
