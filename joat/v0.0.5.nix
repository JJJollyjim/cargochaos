...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/joat/v0.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bstr" = rec {
        ...
        version = "0.1.3";
        edition = "2015";
        sha256 = "0dh02yffr88iqlb6fy9kbs1dm8wy0f4byri6j1jh4pglw060jfw5";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "tera" = rec {
        ...
        edition = "2018";
        sha256 = "0ialk88wqnm8dhavpjcgaczxh1xmz46gg4bz6g69bwah451qcapf";
        authors = [
