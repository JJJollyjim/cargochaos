...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/line_diff/v0.9.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "line_diff" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "line_diff"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.9.0.nix {};
        libPath = "src/line_diff.rs";
        authors = [
          "Thomas Niederberger <thomas@niederb.ch>"
        ];
        dependencies = [
          {
            name = "difference";
