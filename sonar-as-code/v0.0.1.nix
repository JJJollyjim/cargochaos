...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sonar-as-code/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sonar-as-code" = rec {
        crateName = "sonar-as-code";
        version = "0.0.1";
        edition = "2015";
        crateBin = [
          { name = "sonar-as-code"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Sebastien Gerard <me@sgerard.be>"
        ];
        dependencies = [
          {
            name = "clap";
