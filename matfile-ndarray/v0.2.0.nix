...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/matfile-ndarray/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "matfile" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0vghrdv23j6cchmcw17cgkd3ghnvcl7mkr73ri9b7myl07cphm46";
        authors = [
