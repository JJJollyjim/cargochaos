...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cvx/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cvx" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cvx"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Vinícius Dantas <vinicius.gppcom@gmail.com>"
        ];
        dependencies = [
          {
            name = "approx";
      ...
      "osqp" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "0swlyqd05790cpca8799l0yfj1772pvfhz6044i0hvvkar5v4775";
        authors = [
      ...
      "osqp-sys" = rec {
        ...
        version = "0.6.0";
        edition = "2015";
        sha256 = "1ysmqjqg46fbhm6b626wsm6157wkzm5xdrs2nvn9xc476723m33v";
        authors = [
          "Edward Barnard <eabarnard@gmail.com>"
        ];
        buildDependencies = [
