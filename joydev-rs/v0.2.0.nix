...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/joydev-rs/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "input-event-codes" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0msnmbrpz68nnbx6w5xhyxx61cim8b2b80pcbsqdb59c0sxvjvn6";
        authors = [
      ...
      "joydev-sys" = rec {
        crateName = "joydev-sys";
        version = "0.1.2";
        edition = "2018";
        sha256 = "1rxbmyqcfz9sr3cfx64i4aiwcd4s3i8w3xyqh23lxwq1mgx8snlr";
        authors = [
          "Jan Śmiałkowski <gm666q@gm666q.space>"
        ];
        dependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "synchapi" "winbase" ];
      };
