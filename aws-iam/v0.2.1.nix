...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aws-iam/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aws-iam" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "policy"; path = "src/bin/policy.rs"; }
        ];
        ...
        features = {
          "command-line" = [ "structopt" "env_logger" ];
        };
        resolvedDefaultFeatures = [ "command-line" "env_logger" "structopt" ];
      };
      "bitflags" = rec {
        crateName = "bitflags";
        version = "1.2.1";
