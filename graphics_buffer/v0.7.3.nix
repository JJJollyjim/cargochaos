...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/graphics_buffer/v0.7.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "graphics_buffer" = rec {
        crateName = "graphics_buffer";
        version = "0.7.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.7.3.nix {};
        authors = [
          "Kai Schmidt <kaikaliischmidt@gmail.com>"
        ];
        dependencies = [
          {
            name = "bit-vec";
        ...
        resolvedDefaultFeatures = [ "default" "piston_window" "piston_window_texture" ];
      };
      "image" = rec {
        crateName = "image";
        version = "0.23.0";
