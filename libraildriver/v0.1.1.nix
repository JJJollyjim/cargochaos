...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/libraildriver/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "libraildriver" = rec {
        ...
        dependencies = [
          ...
          {
            name = "libraildriver-sys";
            packageId = "libraildriver-sys";
          }
        ];
        
      };
      "libraildriver-sys" = rec {
        crateName = "libraildriver-sys";
        version = "0.1.1";
        edition = "2018";
        sha256 = "1zfd181jyw2jdbhkbbkn6vq6al940770lzc1v7cfqda2v4nnc8gj";
        authors = [
          "Lily Hopkins <bsalarius@gmail.com>"
        ];
        dependencies = [
