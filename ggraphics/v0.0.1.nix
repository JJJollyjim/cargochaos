...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ggraphics/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bytemuck" = rec {
        ...
        version = "1.0.1";
        edition = "2018";
        sha256 = "16rzsni2ppfcwkbnh049gjda0wna4hyykl3k540c69dgqls99y94";
        authors = [
      ...
      "ggraphics" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "image";
            usesDefaultFeatures = false;
            features = [ "jpeg" "png_codec" "pnm" "tiff" "webp" "bmp" "hdr" "dxt" ];
          }
          {
            name = "instant";
            packageId = "instant";
      ...
      "glam" = rec {
        ...
        version = "0.8.3";
        edition = "2018";
        sha256 = "14pjjpm3skmaw8q721hicz2hdslixj7zlmw7khfnrzlv64p2r65d";
        authors = [
      ...
      "glow" = rec {
        ...
        resolvedDefaultFeatures = [ "js-sys" "wasm-bindgen" "web-sys" "web_sys" ];
      };
      "glutin" = rec {
        crateName = "glutin";
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "bmp" "dxt" "hdr" "jpeg" "jpeg-decoder" "png" "png_codec" "pnm" "scoped_threadpool" "tiff" "webp" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
      ...
      "raw-window-handle" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "1zlhwmn7405z8wc4yjn0g3x4z5hli6zj7857an1zvjpkg8pafzha";
        authors = [
