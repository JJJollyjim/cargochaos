...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rs-minecraft-exporter/v1.1.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rs-minecraft-exporter";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rs-minecraft-exporter" = rec {
        crateName = "rs-minecraft-exporter";
        version = "1.1.2";
        edition = "2018";
        crateBin = [
          { name = "rs-minecraft-exporter"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.1.2.nix {};
        authors = [
          "Marvin Altemeier <marv.internetz@gmail.com>"
        ];
        dependencies = [
          {
            name = "hematite-nbt";
