...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-consumersurveys2-cli/v1.0.12+20170407.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-consumersurveys2-cli";
  ...
  workspaceMembers = {
    "google-consumersurveys2-cli" = rec {
      packageId = "google-consumersurveys2-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-consumersurveys2-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-consumersurveys2" = rec {
        crateName = "google-consumersurveys2";
        version = "1.0.12+20170407";
        edition = "2015";
        sha256 = "0x0smw35kvicfpcyrbl3g0zf9psq5wm0ma3hgn6smcwc7hc6r4ms";
        authors = [
      ...
      "google-consumersurveys2-cli" = rec {
        crateName = "google-consumersurveys2-cli";
        version = "1.0.12+20170407";
        edition = "2015";
        crateBin = [
          { name = "consumersurveys2"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20170407.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-consumersurveys2";
          }
          {
            name = "hyper";
            packageId = "hyper";
