...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-consumersurveys2-cli/v1.0.13+20170407.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-consumersurveys2" = rec {
        ...
        edition = "2015";
        sha256 = "1bxp25q8lpbhqyzavdfsmlqqmaxqgbjfaw63yq7rirqa9wrqm4xl";
        authors = [
      ...
      "google-consumersurveys2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20170407.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
