...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-bin-template/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-bin-template" = rec {
        crateName = "rust-bin-template";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rust-bin-template"; path = "src/main.rs"; }
        ];
