...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/usfx/v0.1.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-music-theory" = rec {
        crateName = "rust-music-theory";
        version = "0.1.6";
        edition = "2018";
        crateBin = [];
        sha256 = "0wyrq7v8h3nc23kdh5ddcq39z6cc629gw326sf6ywdv7p68fpdd2";
        authors = [
          "Ozan Kasikci <ozan@kasikci.io>"
        ];
        dependencies = [
          {
            name = "clap";
