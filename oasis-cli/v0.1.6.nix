...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/oasis-cli/v0.1.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo_toml" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "17apqzawz4bxzjivmww0maq6fa2avnwyzbx49xgrcfkcj7hzlkag";
      ...
      "ignore" = rec {
        ...
        version = "0.4.9";
        edition = "2015";
        sha256 = "16ziza9gkk30diz1hzmmp06784dqk9mdf3cyakjmzff2jj8q2rjx";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = [
      ...
      "mime_guess" = rec {
        ...
        version = "2.0.0";
        edition = "2015";
        sha256 = "179ahap1z3cm02yrdskj5bpb6yhqj10z0fhlwwgq75prx92wyafp";
        authors = [
      ...
      "oasis-rpc" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0mfp60a92hdmhcpkba66wlfvvvh46xhsgyby5rfa6996bmr3vzrc";
        authors = [
          "Oasis Labs <feedback@oasislabs.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "failure" "import" "libflate" "saveload" "serde_json" "url" "walrus" ];
      };
      "once_cell" = rec {
        crateName = "once_cell";
        version = "0.2.4";
      ...
      "walrus 0.10.0" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "00jz657pp684qn31pfp1ygngd5mbspcxf246xpjinmxyg3xdm4v0";
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "walrus-macro";
            packageId = "walrus-macro 0.10.0";
          }
          {
            name = "wasmparser";
            packageId = "wasmparser 0.34.0";
          }
        ];
        features = {
      ...
      "walrus-macro 0.10.0" = rec {
        crateName = "walrus-macro";
        version = "0.10.0";
        edition = "2018";
        sha256 = "0zg4pw08s3bvjz8sjiylhh1hcg3vh3l5r7cxbcm8q795zy9lszyp";
        procMacro = true;
        authors = [
          "Nick Fitzgerald <fitzgen@gmail.com>"
        ];
      ...
      "wasmparser 0.34.0" = rec {
        crateName = "wasmparser";
        version = "0.34.0";
        edition = "2018";
        sha256 = "0l0qc791rbadqliylm6rrsd95h57x59bgza736a92ai4gidfqc40";
        authors = [
          "Yury Delendik <ydelendik@mozilla.com>"
        ];
        features = {
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "combaseapi" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "shellapi" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
