...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/miter/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gcd" = rec {
        ...
        version = "2.0.1";
        edition = "2015";
        sha256 = "14ib5nrrrl795sk49488dkj2aynr4717kzdxwpj1mc9apw0x6z0w";
        authors = [
      ...
      "miter" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "miter"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Rafael Morais <rafaelcanical@gmail.com>"
        ];
        dependencies = [
          {
            name = "gcd";
