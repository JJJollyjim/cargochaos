...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/prometheus/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mime" = rec {
        ...
        version = "0.3.9";
        edition = "2015";
        sha256 = "0ydx71p722pqvx0j9fqw87215hnzwff86wxgafs43kznsf92c22b";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
      ...
      "procfs" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "09h6r14m1npxx7rj4i7abf7j2cd0p7830rsqsn4p51zkmsb8a3r8";
        authors = [
      ...
      "prometheus" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "gen" "libc" "nightly" "process" "procfs" "protobuf" "protobuf-codegen-pure" "push" "reqwest" ];
      };
      "protobuf" = rec {
        crateName = "protobuf";
        version = "2.10.1";
      ...
      "serde" = rec {
        ...
        version = "1.0.77";
        edition = "2015";
        sha256 = "0zxbai367kzgmx22q6dnxpl2sfcrmwc8kmaf53cy8g2jsxvpkrn6";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "profileapi" "schannel" "securitybaseapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
