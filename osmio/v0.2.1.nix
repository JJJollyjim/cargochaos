...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/osmio/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "osmio" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "osmio-pdf-read-speed"; path = "src/bin/osmio-pdf-read-speed.rs"; }
          { name = "osmio-osc-debug"; path = "src/bin/osmio-osc-debug.rs"; }
        ];
