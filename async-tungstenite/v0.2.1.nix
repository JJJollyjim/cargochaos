...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-tungstenite/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-native-tls" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1dr3vrpjr00anmbdd01c8ja2qsf7vxgbvl4rc3fp0h3zv179x7m2";
        authors = [
      ...
      "async-tungstenite" = rec {
        ...
        resolvedDefaultFeatures = [ "async-native-tls" "async-std" "async-tls" "async_std_runtime" "connect" "default" "native-tls" "real-native-tls" "stream" "tls" "tls-base" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.13";
