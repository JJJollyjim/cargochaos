...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/async-tungstenite/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tungstenite" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "async-tls" "async_std_runtime" "connect" "default" "stream" "tls" ];
      };
      "atty" = rec {
        crateName = "atty";
        version = "0.2.13";
