...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/skyway-webrtc-gateway-api/v0.0.3.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "skyway-webrtc-gateway-api";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dotenv" = rec {
        ...
        version = "0.8.0";
        edition = "2015";
        sha256 = "1wcfb5yxc3m8i905q44ddqlh70spv6b9503pqm6k9dgk5mfkk8gf";
        authors = [
      ...
      "dotenv_codegen" = rec {
        ...
        version = "0.11.0";
        edition = "2015";
        sha256 = "1yn3a0m0xbp7hzgj93g12mszhkaii06ds730m480qb9wk03v2v8h";
        authors = [
          "Santiago Lapresta <santiago.lapresta@gmail.com>"
          "Craig Hills <chills@gmail.com>"
          "Mike Piccolo <mfpiccolo@gmail.com>"
      ...
      "dotenv_codegen_impl" = rec {
        crateName = "dotenv_codegen_impl";
        version = "0.1.0";
        edition = "2015";
        sha256 = "0jll6924vrh45qdzjbzzxz051zb7dyxalphjjxdxix3grb1sc056";
        procMacro = true;
        authors = [
          "Santiago Lapresta <santiago.lapresta@gmail.com>"
          "Craig Hills <chills@gmail.com>"
      ...
      "skyway-webrtc-gateway-api" = rec {
        crateName = "skyway-webrtc-gateway-api";
        version = "0.0.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.3.nix {};
        authors = [
          "Toshiya Nakakura <nakakura@me.com>"
        ];
        dependencies = [
          {
            name = "dotenv_codegen";
