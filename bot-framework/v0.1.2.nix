...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bot-framework/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bot-framework" = rec {
        crateName = "bot-framework";
        version = "0.1.2";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Gustavo Aguiar <gugahoa@gmail.com>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "telegram-bot" = rec {
        ...
        version = "0.6.3";
        edition = "2018";
        sha256 = "1dhkm7ddridl22g7yk33jwfl53cgvhf9jsdj4nnj7kqg4b55wp92";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "hyper" "hyper-tls" "hyper_connector" ];
      };
      "telegram-bot-raw" = rec {
        crateName = "telegram-bot-raw";
        version = "0.6.3";
        edition = "2018";
        sha256 = "0i4pxr4j74ib01bpjyarni97mmg1lw4mdm30rm3p7lddimqqymv5";
        authors = [
          "Lukas Kalbertodt <lukas.kalbertodt@gmail.com>"
          "Fedor Gogolev <knsd@knsd.net>"
        ];
