...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/flowgger/v0.2.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flowgger" = rec {
        ...
        resolvedDefaultFeatures = [ "capnp" "capnp-recompile" "capnpc" "coroutines" "default" "file" "gelf" "glob" "kafka" "kafka-output" "ltsv" "may" "notify" "openssl" "passthrough" "redis" "redis-input" "rfc3164" "rfc5424" "serde" "serde_json" "syslog" "tls" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
      ...
      "may" = rec {
        ...
        version = "0.3.17";
        edition = "2018";
        sha256 = "1qnzsmc5yi4czx2m8flcf70djjg10129bqaz3l0bpqsi9c05ihly";
        authors = [
          "Xudong Huang <huangxu008@hotmail.com>"
        ];
        dependencies = [
