...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-compute1-cli/v1.0.12+20190618.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-compute1" = rec {
        crateName = "google-compute1";
        version = "1.0.12+20190618";
        edition = "2015";
        sha256 = "1blvbh98w3c71fl39crgdm7wjww0ggm91yfp4y563l4wxhlnhvh2";
        authors = [
      ...
      "google-compute1-cli" = rec {
        crateName = "google-compute1-cli";
        version = "1.0.12+20190618";
        edition = "2015";
        crateBin = [
          { name = "compute1"; path = "src/main.rs"; }
        ];
