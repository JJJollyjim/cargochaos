...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/wfc_image/v0.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coord_2d" = rec {
        ...
        version = "0.2.17";
        edition = "2018";
        sha256 = "1nm3nmvv1zqvpyj958jwaz9b6m12y59syf7jplrbyfy3hfxz2dlc";
        authors = [
          "Stephen Sherratt <sfsherratt@gmail.com>"
        ];
        features = {
          "serialize" = [ "serde" ];
        };
      ...
      "direction" = rec {
        ...
        version = "0.17.10";
        edition = "2018";
        sha256 = "0rvq0h7hbq0gb0nymm0lk65sg2n8njv0m13k30vwaym996zgwa14";
        authors = [
          "Stephen Sherratt <sfsherratt@gmail.com>"
        ];
        dependencies = [
      ...
      "gfx_window_glutin" = rec {
        ...
        version = "0.29.0";
        edition = "2015";
        sha256 = "19q9dhl0yqwcbs8kpzm0gsl7xh1l0mrg3ixj609mmn92ygh05lwl";
        authors = [
          "The Gfx-rs Developers"
        ];
        dependencies = [
      ...
      "grid_2d 0.12.5" = rec {
        ...
        version = "0.12.5";
        edition = "2015";
        sha256 = "0p0bjf3b7a3nbj0q3j1a6najidyl886j2ihdpv8vrg188rgv7047";
        authors = [
          "Stephen Sherratt <sfsherratt@gmail.com>"
        ];
        dependencies = [
      ...
      "grid_2d 0.14.1" = rec {
        ...
        version = "0.14.1";
        edition = "2015";
        sha256 = "0dmgwl6ncffmdvc04jdl1b81gwxhf4vjnfsfhlmhy4i3wkc5zlbr";
        authors = [
          "Stephen Sherratt <sfsherratt@gmail.com>"
        ];
        dependencies = [
      ...
      "pixel_grid" = rec {
        crateName = "pixel_grid";
        version = "0.5.0";
        edition = "2015";
        sha256 = "0g04s9bppcx9yf55bdsp3qvldhn82jnwjv1q8sg1jwvdlhlmz5cs";
        authors = [
      ...
      "simon" = rec {
        ...
        version = "0.3.2";
        edition = "2015";
        sha256 = "0ia80zbnbkwqi3x42dck6nz9ni3a2q5qvds5k7wxrz5wipa0mwy0";
        authors = [
          "Stephen Sherratt <stephen@sherra.tt>"
        ];
        dependencies = [
      ...
      "wfc" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1h1ms8ps1cn9iq36jwknck1p267r2w7kc3zcwdgwg6iprww424hn";
        authors = [
          "Stephen Sherratt <stephen@sherra.tt>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "parallel" "rand_xorshift" "rayon" ];
      };
      "wfc_image" = rec {
        crateName = "wfc_image";
        version = "0.10.0";
