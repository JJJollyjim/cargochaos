...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rut-lib/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "precommit-hook" "run-cargo-clippy" "run-cargo-fmt" "run-cargo-test" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
      ...
      "rut-lib" = rec {
        ...
        libName = "rut_lib";
        authors = [
          "Erik Jara <39597280+erikjara@users.noreply.github.com>"
        ];
        dependencies = [
          {
            name = "libmath";
