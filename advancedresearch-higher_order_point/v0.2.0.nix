...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/advancedresearch-higher_order_point/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "advancedresearch-higher_order_point";
  ...
  workspaceMembers = {
    "advancedresearch-higher_order_point" = rec {
      packageId = "advancedresearch-higher_order_point";
      build = internal.buildRustCrateWithFeatures {
        packageId = "advancedresearch-higher_order_point";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "advancedresearch-higher_order_core" = rec {
        crateName = "advancedresearch-higher_order_core";
        version = "0.2.0";
        edition = "2018";
        sha256 = "180a3w4k36psbhhch05aayx6xpgidsm2hij0imiydrh7mq8p2rl3";
        libName = "higher_order_core";
        authors = [
      ...
      "advancedresearch-higher_order_point" = rec {
        crateName = "advancedresearch-higher_order_point";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "higher_order_point";
        authors = [
          "Sven Nilsen <bvssvni@gmail.com>"
        ];
        dependencies = [
          {
            ...
            packageId = "advancedresearch-higher_order_core";
          }
        ];
        devDependencies = [
          {
      ...
      "piston2d-opengl_graphics" = rec {
        ...
        version = "0.68.0";
        edition = "2015";
        sha256 = "0fxcwy7vljvr9cwy2hd081i1qclfs5zkgjahvfsckbf9bxgsq05n";
