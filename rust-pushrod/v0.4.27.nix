...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-pushrod/v0.4.27.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-pushrod" = rec {
        crateName = "rust-pushrod";
        version = "0.4.27";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.4.27.nix {};
        libName = "pushrod";
        authors = [
          "Ken Suenobu <ksuenobu@fastmail.com>"
        ];
        dependencies = [
          {
            name = "sdl2";
      ...
      "sdl2" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "image" "ttf" "unsafe_textures" ];
      };
      "sdl2-sys" = rec {
        crateName = "sdl2-sys";
        version = "0.33.0";
        ...
        resolvedDefaultFeatures = [ "default" "image" "ttf" ];
      };
    };
