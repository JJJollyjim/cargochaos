...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/remodel/v0.6.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rbx_dom_weak" = rec {
        ...
        version = "1.10.0";
        edition = "2018";
        sha256 = "0bgxwlgal5sv6rgcfcxvp8w6yifswackxqv4l48hikxzsy1wkdy6";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
      ...
      "rbx_xml" = rec {
        ...
        version = "0.11.3";
        edition = "2018";
        sha256 = "1wcgjcfcv4x44qg18yn4zpi13m6ik5m83skjlzpjg3fgdhx0cn4b";
        authors = [
          "Lucien Greathouse <me@lpghatguy.com>"
        ];
        dependencies = [
