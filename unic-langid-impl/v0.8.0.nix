...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unic-langid-impl/v0.8.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "unic-langid-impl" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "generate_likelysubtags"; path = "src/bin/generate_likelysubtags.rs"; }
          { name = "generate_layout"; path = "src/bin/generate_layout.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "binary" "likelysubtags" "serde" "serde_json" ];
      };
