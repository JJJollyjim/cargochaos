...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arcs/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      "aabb-quadtree" = rec {
        crateName = "aabb-quadtree";
        version = "0.2.0";
        edition = "2015";
        sha256 = "08ddm7c3xvzbz57r3dyi0qgbgfzl8bh09l6kik7mn5v5n5l6jlxr";
        authors = [
      ...
      "arcs" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "euclid";
            packageId = "euclid 0.19.9";
            rename = "quadtree_euclid";
          }
          {
            name = "euclid";
            packageId = "euclid 0.20.7";
          }
          {
            name = "kurbo";
            packageId = "kurbo";
