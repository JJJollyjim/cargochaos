...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-forth-interactive-compiler/v0.1.7.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rust-forth-interactive-compiler";
  ...
  workspaceMembers = {
    "rust-forth-interactive-compiler" = rec {
      packageId = "rust-forth-interactive-compiler";
      build = internal.buildRustCrateWithFeatures {
        packageId = "rust-forth-interactive-compiler";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-forth-compiler" = rec {
        crateName = "rust-forth-compiler";
        version = "0.5.3";
        edition = "2018";
        crateBin = [];
        sha256 = "1klrwv7sgr48dfrsxj3hzvd46kzfgvmndfbcvcl137arnjwyabbj";
        authors = [
          "Frederick Price <rprice@pricemail.ca>"
        ];
        dependencies = [
          {
            name = "rust-forth-tokenizer";
            packageId = "rust-forth-tokenizer";
          }
          {
            name = "rust-simple-stack-processor";
            packageId = "rust-simple-stack-processor";
          }
        ];
        features = {
        };
        resolvedDefaultFeatures = [ "enable_reflection" ];
      };
      "rust-forth-interactive-compiler" = rec {
        crateName = "rust-forth-interactive-compiler";
        version = "0.1.7";
        edition = "2018";
        crateBin = [
          { name = "rust-forth-interactive-compiler"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          {
            ...
            packageId = "rust-forth-compiler";
            features = [ "enable_reflection" ];
          }
          {
            name = "rustyline";
            packageId = "rustyline";
      ...
      "rust-forth-tokenizer" = rec {
        crateName = "rust-forth-tokenizer";
        version = "0.2.0";
        edition = "2018";
        crateBin = [];
        sha256 = "0pk6s7ba8zkbin352ppr9d7y3m557wg79rqin8n2mxqcqpihaaj5";
        authors = [
          "Frederick Price <rprice@pricemail.ca>"
        ];
        
      };
      "rust-simple-stack-processor" = rec {
        crateName = "rust-simple-stack-processor";
        version = "0.7.0";
        edition = "2018";
        sha256 = "0gimw6p7j0v006pmk84zn7bn94cgxcr98fjnmqgmr6s6vn9q2krv";
        authors = [
          "Frederick Price <rprice@pricemail.ca>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "knownfolders" "minwindef" "ntsecapi" "objbase" "processenv" "shlobj" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
