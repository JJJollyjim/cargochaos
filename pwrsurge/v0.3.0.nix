...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pwrsurge/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "buffering 0.4.1" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "0h37mbdap5i23k98r5cl6fid0r0p9601yy91l0v29kymmkx8mxgf";
        authors = [
          "John Baublitz <john.m.baublitz@gmail.com>"
        ];
        dependencies = [
          {
            name = "buffering_nocopy_macro";
            packageId = "buffering_nocopy_macro";
            optional = true;
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "buffering_nocopy_macro" "copy" "nocopy" ];
      };
      "buffering_nocopy_macro" = rec {
        crateName = "buffering_nocopy_macro";
        version = "0.2.0";
        edition = "2015";
        sha256 = "1hb08bmj3r1ajfibyp8g0ay3xkxfa9px2yr64hssmx822mws5kp3";
        procMacro = true;
        authors = [
          "John Baublitz <john.m.baublitz@gmail.com>"
        ];
      ...
      "neli" = rec {
        ...
        version = "0.4.3-r2";
        edition = "2015";
        sha256 = "1j4ag7dklyvgl641rlqxby2zl7jidw5nwmhri35a1q944jy3x8dl";
        authors = [
          "John Baublitz <john.m.baublitz@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "mio" "stream" "tokio" ];
      };
      "net2" = rec {
        crateName = "net2";
        version = "0.2.33";
      ...
      "pwrsurge" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "pwrsurge"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          {
            name = "buffering";
            packageId = "buffering 0.4.1";
            features = [ "copy" "nocopy" ];
          }
          {
            name = "getopts";
            packageId = "getopts";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "handleapi" "libloaderapi" "minwindef" "ntsecapi" "ntstatus" "profileapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
