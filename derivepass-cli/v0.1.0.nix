...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/derivepass-cli/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "derivepass-cli" = rec {
        crateName = "derivepass-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "derivepass-cli"; path = "src/main.rs"; }
        ];
