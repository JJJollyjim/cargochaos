...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gstats/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gstats" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "gstats"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.3.nix {};
        authors = [
          "Boon Hian Tek <boon.tek@gmail.com>"
        ];
        dependencies = [
          {
            name = "colored";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "minwinbase" "minwindef" "processenv" "winbase" "winsock2" "ws2def" ];
      };
