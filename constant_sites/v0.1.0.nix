...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/constant_sites/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "constant_sites" = rec {
        crateName = "constant_sites";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "constant_sites"; path = "src/main.rs"; }
        ];
