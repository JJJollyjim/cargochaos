...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sqlite2dir/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sqlite2dir" = rec {
        crateName = "sqlite2dir";
        version = "0.2.0";
        edition = "2018";
        crateBin = [
          { name = "sqlite2dir"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "vendored-sqlite" ];
      };
      "structopt" = rec {
        crateName = "structopt";
        version = "0.3.1";
