...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rocket-multipart-form-data/v0.8.1.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "rocket-multipart-form-data";
  ...
  workspaceMembers = {
    "rocket-multipart-form-data" = rec {
      packageId = "rocket-multipart-form-data";
      build = internal.buildRustCrateWithFeatures {
        packageId = "rocket-multipart-form-data";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crc-any" = rec {
        ...
        version = "1.1.3";
        edition = "2015";
        sha256 = "1906nlcsmr4nzg93af8pk3dnnw86k47631pdfib12807524hvzqz";
        authors = [
      ...
      "rocket-include-static-resources" = rec {
        ...
        version = "0.8.5";
        edition = "2015";
        sha256 = "1sh996xp5x3skbmdpy8rwib4l81jpjpjn03ybrfiv03fr2ig2vck";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
      ...
      "rocket-multipart-form-data" = rec {
        crateName = "rocket-multipart-form-data";
        version = "0.8.1";
        edition = "2018";
        ...
        devDependencies = [
          ...
          }
          {
            ...
            packageId = "rocket-raw-response";
          }
        ];
        
      };
      "rocket-raw-response" = rec {
        crateName = "rocket-raw-response";
        version = "0.4.8";
        edition = "2018";
        sha256 = "0ml9lkh9rxsmqvimnps8xbllaf5cg2bpg8g4ziais4fyvivv9sph";
        authors = [
          "Magic Len <len@magiclen.org>"
        ];
        dependencies = [
