...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/just/v0.5.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "just" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "help4help2man" "summary" ];
      };
      "lazy_static" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwinbase" "minwindef" "processenv" "std" "synchapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
