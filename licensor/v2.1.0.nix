...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/licensor/v2.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "calm_io" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0pzsp3kiq978cgsffd1fvxkrn8ng6mizil3sq47djhpy023n181f";
        authors = [
        ...
        dependencies = [
          {
            name = "calmio_filters";
            packageId = "calmio_filters";
          }
        ];
        
      };
      "calmio_filters" = rec {
        crateName = "calmio_filters";
        version = "0.1.0";
        edition = "2018";
        sha256 = "18kcrw4hx3mx6a13qxcznizdq2lnirnspdqblik6gmjwazs02rc4";
        procMacro = true;
        authors = [
          "myrrlyn <self@myrrlyn.dev>"
        ];
      ...
      "cargo-husky" = rec {
        ...
        resolvedDefaultFeatures = [ "precommit-hook" "run-cargo-clippy" "run-cargo-fmt" "run-cargo-test" "run-for-all" ];
      };
      "cfg-if" = rec {
        crateName = "cfg-if";
        version = "0.1.10";
      ...
      "licensor" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "licensor"; path = "src/main.rs"; }
        ];
