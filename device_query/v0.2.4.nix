...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/device_query/v0.2.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "readmouse" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "18yydzfz5iwbhclc2vj0zv3f165ck8b5nl8dd4sawrxnkmnygp2p";
        authors = [
          "Klas Segeljakt <klasseg@kth.se>"
        ];
      ...
      "x11" = rec {
        ...
        version = "2.17.2";
        edition = "2015";
        sha256 = "0lzzmjyhm3wkkvz9asm7d1d8lsmdn0v5ibh8ybg5kcr5bb430qb7";
        authors = [
