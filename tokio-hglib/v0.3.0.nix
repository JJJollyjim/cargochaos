...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-hglib/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "io-driver" "io-std" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "stream" "tokio-macros" "uds" "winapi" ];
      };
      "tokio-hglib" = rec {
        crateName = "tokio-hglib";
        version = "0.3.0";
        edition = "2018";
