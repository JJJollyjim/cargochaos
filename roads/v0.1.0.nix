...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/roads/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "oats" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1q44zbd3yrvc416snflh72qccz40wxg28axx8qmgxmb0gqsmakss";
        authors = [
      ...
      "roads" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "roads"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Matt Briggs <brigmatt>"
        ];
        dependencies = [
          {
            name = "oats";
