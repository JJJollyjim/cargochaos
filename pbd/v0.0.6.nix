...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pbd/v0.0.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pbd" = rec {
        ...
        features = {
          "default" = [ "dua" ];
          "dua" = [ "actix-web" "actix-service" "futures" ];
        };
        resolvedDefaultFeatures = [ "actix-service" "actix-web" "default" "dua" "futures" ];
      };
