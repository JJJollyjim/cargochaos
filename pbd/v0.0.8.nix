...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pbd/v0.0.8.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "pbd" = rec {
        ...
        resolvedDefaultFeatures = [ "actix-service" "actix-web" "default" "dtc" "dua" "futures" "pow_sha256" "rayon" "reqwest" ];
      };
