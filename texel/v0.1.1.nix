...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/texel/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "big_enum_set" = rec {
        crateName = "big_enum_set";
        version = "0.1.3";
        edition = "2018";
        sha256 = "0f29di5vs7dn6rsnmfvw95qjmbmhkbwf63b9qb6rgk3k0c75as2i";
        authors = [
          "Manu Thambi <manu@meshcapital.com>"
          "Lymia Aluysia <lymia@lymiahugs.com>"
        ];
        dependencies = [
          {
            name = "big_enum_set_derive";
            packageId = "big_enum_set_derive";
          }
          {
            name = "serde";
            packageId = "serde";
        ...
        resolvedDefaultFeatures = [ "serde" "serde2" ];
      };
      "big_enum_set_derive" = rec {
        crateName = "big_enum_set_derive";
        version = "0.1.2";
        edition = "2018";
        sha256 = "11x6qd6q8c5fb7lvg6l5plvrhjlz6h6i4nxpa8ggj54i4qr8q7fb";
        procMacro = true;
        authors = [
          "Manu Thambi <manu@meshcapital.com>"
          "Lymia Aluysia <lymia@lymiahugs.com>"
      ...
      "texel" = rec {
        ...
        dependencies = [
          ...
          {
            name = "texel_types";
            packageId = "texel_types";
            features = [ "ecs_specs" "serde_support" ];
          }
        ];
        
      };
      "texel_types" = rec {
        crateName = "texel_types";
        version = "1.0.1";
        edition = "2018";
        sha256 = "1rr0sfmjqaksnsfldwfkrk3dbf7by5s6ayr5b420ylg9mjk6bgd3";
        authors = [
        ...
        features = {
          "ecs_specs" = [ "specs" ];
          "serde_support" = [ "serde" "serde_derive" "big_enum_set/serde" ];
        };
        resolvedDefaultFeatures = [ "ecs_specs" "serde" "serde_derive" "serde_support" "specs" ];
      };
      "tuple_utils" = rec {
