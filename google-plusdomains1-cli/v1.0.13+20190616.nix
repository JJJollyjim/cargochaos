...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-plusdomains1-cli/v1.0.13+20190616.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-plusdomains1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-plusdomains1" = rec {
        crateName = "google-plusdomains1";
        version = "1.0.13+20190616";
        edition = "2015";
        sha256 = "0h95zk8hhbhqrvhxjjsd13h1gb4r9yxq4vji0vrpxwmmd89263yw";
        authors = [
      ...
      "google-plusdomains1-cli" = rec {
        crateName = "google-plusdomains1-cli";
        version = "1.0.13+20190616";
        edition = "2015";
        crateBin = [
          { name = "plusdomains1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20190616.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
