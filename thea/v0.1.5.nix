...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/thea/v0.1.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "html-minifier" = rec {
        ...
        version = "1.1.14";
        edition = "2018";
        sha256 = "07s9gfd08k75pw5whilyc867k7mfwv21c2l95alyl2v2sxf1dnsa";
        authors = [
      ...
      "minifier" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0ckkbvdywqn6id5i7x297w399hikzr9clxyshxvn4pjz8yr0vgvh";
        authors = [
          "Guillaume Gomez <guillaume1.gomez@gmail.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
