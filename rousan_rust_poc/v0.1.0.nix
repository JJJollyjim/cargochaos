...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rousan_rust_poc/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rousan_rust_poc" = rec {
        crateName = "rousan_rust_poc";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "rousan_rust_poc"; path = "src/main.rs"; }
          { name = "sky"; path = "src/bin/sky.rs"; }
        ];
