...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/opennode-client/v1.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "opennode" = rec {
        ...
        version = "1.0.0";
        edition = "2018";
        sha256 = "1608xxpans6a0zmqihbk1rxywj6ssi9fqzrb7cm8f4x1q0x6q71g";
        authors = [
