...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/kf-protocol-fs/v1.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "flv-future-aio" = rec {
        ...
        resolvedDefaultFeatures = [ "async-std" "asyncstd" "default" "futures-timer" "futures_codec" ];
      };
      "flv-types" = rec {
        crateName = "flv-types";
        version = "0.1.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "memoryapi" "minwinbase" "minwindef" "ntdef" "ntstatus" "processenv" "processthreadsapi" "profileapi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
