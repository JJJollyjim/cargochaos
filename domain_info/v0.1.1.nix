...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/domain_info/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dns-lookup" = rec {
        ...
        version = "1.0.1";
        edition = "2015";
        sha256 = "1gvjdcwj803w9gd2bfy8f3n1skzw9r2586sfqx4641qbhrq8d60k";
        authors = [
      ...
      "domain_info" = rec {
        crateName = "domain_info";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "domain_info"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Garrett Hunyadi <garrett@pobox.com>"
        ];
        dependencies = [
          {
            name = "chrono";
          ...
          }
          {
            ...
            packageId = "unicode-segmentation 0.1.3";
          }
          {
            name = "void";
            packageId = "void";
      ...
      "heck" = rec {
        ...
        dependencies = [
          {
            name = "unicode-segmentation";
            packageId = "unicode-segmentation 1.6.0";
          }
        ];
      ...
      "unicode-segmentation 0.1.3" = rec {
        crateName = "unicode-segmentation";
        version = "0.1.3";
        edition = "2015";
        sha256 = "1dcqkrlpg3xrn5vshsnbm2jjiwvn41zb7rpzzw2i7c8pxlyl9g63";
        authors = [
          "kwantam <kwantam@gmail.com>"
        ];
        features = {
      ...
      "unicode-segmentation 1.6.0" = rec {
        crateName = "unicode-segmentation";
        version = "1.6.0";
        edition = "2015";
      ...
      "whatlang" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "1zpxz7cj8nf6ncp67amia8ppzcsipdg6w9aqn4bpl1zs4p9k96vf";
        authors = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "windef" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
