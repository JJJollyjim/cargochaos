...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/igd/v0.10.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "objbase" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
      ...
      "xmltree" = rec {
        ...
        version = "0.10.0";
        edition = "2015";
        sha256 = "1pq4602zdi6p4yq522qnpb284yi174gsp6wdg922bnq0wvphg9kp";
        authors = [
