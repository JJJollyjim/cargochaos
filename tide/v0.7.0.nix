...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tide/v0.7.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "http-service" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0cndh0c6lmci771m1aa5x8mqvkh42xaanwch5svi4yjnm684ymrc";
        authors = [
      ...
      "http-service-h1" = rec {
        crateName = "http-service-h1";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1pvi0aqf6ipra7qhfcgfzzy8skrh2d9qwikxmg6qwdw6iwl1235i";
        authors = [
          "dignifiedquire <me@dignifiedquire.com>"
        ];
        dependencies = [
      ...
      "http-service-mock" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0cajy57l7csjrrywp5k4wsbf0p9i4p9r7d5lqlffbzpxqpm5mpbr";
        authors = [
      ...
      "surf" = rec {
        ...
        edition = "2018";
        sha256 = "0missi9lskjs5ygkiap5njj0xgwra93lpivwc0kcmzxf908c7zy7";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
          "dignifiedquire <me@dignifiedquire.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "curl-client" "default" "encoding" "encoding_rs" "isahc" "js-sys" "middleware-logger" "native-client" "wasm-bindgen" "wasm-bindgen-futures" "wasm-client" "web-sys" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.17";
      ...
      "tide" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "docs" "futures" "h1-server" "http" "http-service-h1" "hyper" "tokio" "unstable" ];
      };
      "time" = rec {
        crateName = "time";
        version = "0.1.42";
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "AbortSignal" "Event" "EventTarget" "Headers" "MessageEvent" "ObserverCallback" "ReferrerPolicy" "Request" "RequestCache" "RequestCredentials" "RequestInit" "RequestMode" "RequestRedirect" "Response" "TextDecoder" "Window" "Worker" ];
      };
      "winapi 0.2.8" = rec {
        crateName = "winapi";
        version = "0.2.8";
