...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/actix-mqtt/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "actix-ioframe" = rec {
        crateName = "actix-ioframe";
        version = "0.4.1";
        edition = "2018";
        sha256 = "1qalg1ksc2gmvjw9mamrzpb660wllkh562mp2n7q8fds5y9rwm76";
        libName = "actix_ioframe";
        authors = [
          "Nikolay Kim <fafhrd91@gmail.com>"
        ];
        dependencies = [
      ...
      "mqtt-codec" = rec {
        crateName = "mqtt-codec";
        version = "0.3.0";
        edition = "2018";
        sha256 = "1rlxrjfg6zz42bgsvgv69gy6fikkjsaciwf11zdab8akx7cq7rjs";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures-core" "io-driver" "iovec" "lazy_static" "libc" "mio" "mio-uds" "rt-core" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-util" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "minwinbase" "minwindef" "ntstatus" "processenv" "processthreadsapi" "std" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winreg" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
