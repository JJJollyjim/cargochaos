...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/bridges/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mio-serial" = rec {
        ...
        version = "3.2.14";
        edition = "2015";
        sha256 = "12sfc2rw6n9hvd5zsvgd49l317zxi84cyiprwjg5i7azqw4wnfsb";
        authors = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "cguid" "commapi" "consoleapi" "errhandlingapi" "fileapi" "guiddef" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processenv" "setupapi" "std" "synchapi" "winbase" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
