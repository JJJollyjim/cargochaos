...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aubio-rs/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aubio-lib" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0558zppgyg695mmipkqci5y96n8fyyp1fm7dnvrbi81wca5pjvnn";
        authors = [
          "K. <kayo@illumium.org>"
        ];
        buildDependencies = [
      ...
      "aubio-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "check-size" "generate-bindings" "log" "rustdoc" ];
      };
      "aubio-sys" = rec {
        crateName = "aubio-sys";
        version = "0.1.2";
        edition = "2018";
        sha256 = "0minbv875bfabcgm1i88851vn6xdpckvanamz4zndvn36xvgv5c0";
        authors = [
          "K. <kayo@illumium.org>"
        ];
        buildDependencies = [
        ...
        resolvedDefaultFeatures = [ "bindgen" "fetch_unroll" "generate-bindings" "rustdoc" ];
      };
      "base64 0.10.1" = rec {
        crateName = "base64";
        version = "0.10.1";
