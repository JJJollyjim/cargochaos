...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aubio-rs/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aubio-lib" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "0jcq99zmibkrgpyxw0faj4j2g3p8rcg2xgqz6x8wqb8g0fq4aard";
        authors = [
          "K. <kayo@illumium.org>"
        ];
        dependencies = [
      ...
      "aubio-sys" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "08x23y5hbwvv93p68njv4pji9y8jnf2xajnd732z7fyhb6phk2y7";
        authors = [
          "K. <kayo@illumium.org>"
        ];
        buildDependencies = [
