...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/magicpak/v1.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "auxv" = rec {
        ...
        version = "0.3.3";
        edition = "2015";
        sha256 = "0gasmz0pkl6qra2r5c039xgb09maxrv1ra4z741gpvxqpvwk0175";
        authors = [
      ...
      "magicpak" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "magicpak"; path = "src/bin/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.3.nix {};
        libPath = "src/magicpak.rs";
        authors = [
