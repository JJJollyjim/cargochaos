...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mqtt-analyzer/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mqtt-analyzer" = rec {
        crateName = "mqtt-analyzer";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "mqtt-analyzer"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Alessandro Pezzato <alessandro@pezzato.net>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
