...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/xml-xls-parser/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "xml-xls-parser" = rec {
        crateName = "xml-xls-parser";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "xml-xls-parser"; path = "src/main.rs"; }
        ];
