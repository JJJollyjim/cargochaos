...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/stor-age/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stor-age" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "stor-age"; path = "src/main.rs"; }
        ];
        ...
        features = {
          ...
          "table" = [ "bytesize" "prettytable-rs" ];
        };
        resolvedDefaultFeatures = [ "bstr" "bytesize" "default" "prettytable-rs" "spectrum-scale" "table" "tempfile" ];
      };
      "strsim" = rec {
        crateName = "strsim";
        version = "0.8.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" ];
      };
      "winapi-build" = rec {
