...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/narwhalol/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "narwhalol" = rec {
        ...
        authors = [
          "Kirill Mironov <arkrait04@gmail.com>"
        ];
        dependencies = [
          {
            name = "env_logger";
      ...
      "snafu" = rec {
        ...
        resolvedDefaultFeatures = [ "backtrace" "backtraces" "default" "doc-comment" "futures-01" "futures01" "rust_1_30" ];
      };
      "snafu-derive" = rec {
