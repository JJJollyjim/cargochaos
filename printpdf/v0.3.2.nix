...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/printpdf/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "image" = rec {
        ...
        resolvedDefaultFeatures = [ "bmp" "dds" "dxt" "gif" "hdr" "ico" "jpeg" "jpeg_rayon" "png" "pnm" "scoped_threadpool" "tga" "tiff" "webp" ];
      };
      "inflate" = rec {
        crateName = "inflate";
        version = "0.4.5";
      ...
      "pom" = rec {
        ...
        version = "3.0.3";
        edition = "2018";
        sha256 = "05lhlrj1w7ikc21blchfqhaq0p6cch1fs71h5gk39hf0s9sxavcm";
        authors = [
          "Junfeng Liu <china.liujunfeng@gmail.com>"
        ];
      ...
      "printpdf" = rec {
        ...
        resolvedDefaultFeatures = [ "clippy" "dds" "default" "dxt" "embedded_images" "hdr" "ico" "image" "jpeg_rayon" "log" "logging" "tga" "webp" ];
      };
      "rayon" = rec {
        crateName = "rayon";
        version = "1.3.0";
      ...
      "rusttype" = rec {
        ...
        resolvedDefaultFeatures = [ "has-atomics" "std" ];
      };
