...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ninjify/v0.1.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ninjify" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ninjify"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.7.nix {};
        authors = [
          "John Nanney <john.nanney@gmail.com>"
        ];
        dependencies = [
          {
            name = "clap";
      ...
      "ron 0.3.0" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0yy4k9ayg3acdchd1g8pdxs8mgb0pdpf96lmy5px84c5lfvi3ym9";
        authors = [
      ...
      "serde-xml-any" = rec {
        crateName = "serde-xml-any";
        version = "0.0.3";
        edition = "2015";
        sha256 = "0ssqwyi5lj1jq2a3ln7j5ik2jz7gyz77i6yivc4yh11i7s5950g2";
        authors = [
      ...
      "serde_any" = rec {
        ...
        version = "0.5.0";
        edition = "2015";
        sha256 = "1vj6gnkq2qby3krys6mgh8byk75n6yylg6976djwzhmcxdpm1jrq";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "json" "ron" "serde-xml-any" "serde_json" "serde_urlencoded" "serde_yaml" "toml" "url" "xml" "yaml" ];
      };
      "serde_derive" = rec {
