...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/serde-odbc/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "odbc-sys" = rec {
        ...
        version = "0.8.2";
        edition = "2015";
        sha256 = "0dsg5xj5fn57c5mv9may7w290923rk93rc88ap927i0k1r4wbify";
        authors = [
