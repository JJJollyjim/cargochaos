...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/arduino_mkrzero/v0.5.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "arduino_mkrzero" = rec {
        crateName = "arduino_mkrzero";
        version = "0.5.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Wez Furlong <wez@wezfurlong.org>"
          "David McGillicuddy <contact@djmcgill.co.uk>"
        ];
        dependencies = [
          {
            name = "atsamd-hal";
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "panic-halt" "panic_halt" "rt" "unproven" "use_semihosting" ];
      };
      "as-slice" = rec {
        crateName = "as-slice";
        version = "0.1.0";
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21g18a" "samd21g18a" "samd21g18a-rt" "unproven" ];
      };
      "atsamd21g18a" = rec {
      ...
      "bitfield" = rec {
        ...
        version = "0.13.1";
        edition = "2015";
        sha256 = "10sfib2wwy29kzriwfz6sflw0fsss4f1n2rri51nm89wkxmysq52";
        authors = [
      ...
      "paste" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "17aga345115vfz224qnngcq7vm5n1v24qhbkjbpgp4jh4v8r40zm";
        authors = [
      ...
      "paste-impl" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0yj6v5j6if4461601r0jsn3dnfan6qz93bfwn8rqjpm5wcpm3kd3";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
