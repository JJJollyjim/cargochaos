...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/writeup/v1.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "runtime-fmt" = rec {
        ...
        version = "0.4.1";
        edition = "2015";
        sha256 = "1s1cr8k7nhbargq2qa0qvi027p764gc29b160xcix5jhhkvjad3h";
        authors = [
      ...
      "writeup" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "writeup"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.2.nix {};
        authors = [
          "Alex Habich <me@alexnader.dev>"
        ];
        dependencies = [
          {
            name = "clap";
