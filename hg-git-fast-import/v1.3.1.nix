...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hg-git-fast-import/v1.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hg-parser" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "1nf9nzx8dygm2lzzi2gvwwd1vjgbcdfzjc15zaf8i06xa1cilfvj";
        authors = [
          "Alexander Korolev <kilork@yandex.ru>"
        ];
        dependencies = [
      ...
      "ordered-parallel-iterator" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0i980rhfrrgzdq13a0z44ika0i31ahjwygqr7lw251wpglvbr04c";
        authors = [
          "Alexander Korolev <kilork@yandex.ru>"
        ];
        dependencies = [
