...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dia-args/v0.51.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dia-args" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dia-args"; path = "src/bin/dia-args/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "bin" "dia-files" "time" "tiny-keccak" "zeros" ];
      };
      "dia-files" = rec {
        crateName = "dia-files";
        version = "0.11.0";
        edition = "2018";
        sha256 = "1xj3qs10270h16jr1yimckag0043sa928kwbas5sfc2k6i57wb4i";
        authors = [
          "Hai Bison <haibison.apps@gmail.com>"
        ];
