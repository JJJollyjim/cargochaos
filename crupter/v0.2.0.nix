...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crupter/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crupter" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "crupter"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Miguel Chan <vvchan@outlook.com>"
        ];
        dependencies = [
          {
            name = "aes-ctr";
      ...
      "scrypt" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "default" "include_simple" "rand" "subtle" ];
      };
      "semver" = rec {
        crateName = "semver";
        version = "0.9.0";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winuser" ];
      };
