...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-clouduseraccountsvm_beta-cli/v1.0.12+20160316.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-clouduseraccountsvm_beta-cli";
  ...
  workspaceMembers = {
    "google-clouduseraccountsvm_beta-cli" = rec {
      packageId = "google-clouduseraccountsvm_beta-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "google-clouduseraccountsvm_beta-cli";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-clouduseraccountsvm_beta" = rec {
        crateName = "google-clouduseraccountsvm_beta";
        version = "1.0.12+20160316";
        edition = "2015";
        sha256 = "0gihzvp0291sdpk7i6xcji8d1w9zpwbaxzx01qc59pi25wx171p1";
        authors = [
      ...
      "google-clouduseraccountsvm_beta-cli" = rec {
        crateName = "google-clouduseraccountsvm_beta-cli";
        version = "1.0.12+20160316";
        edition = "2015";
        crateBin = [
          { name = "clouduseraccountsvm-beta"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20160316.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "google-clouduseraccountsvm_beta";
          }
          {
            name = "hyper";
            packageId = "hyper";
