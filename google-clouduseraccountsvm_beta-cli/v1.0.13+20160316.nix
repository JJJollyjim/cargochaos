...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-clouduseraccountsvm_beta-cli/v1.0.13+20160316.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-clouduseraccountsvm_beta" = rec {
        ...
        edition = "2015";
        sha256 = "1dlgys1pyf132wp5ssdqp2kgjmfc510dfg3k2g3ncx03f4iisnls";
        authors = [
      ...
      "google-clouduseraccountsvm_beta-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20160316.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
