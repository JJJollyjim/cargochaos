...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-cloudtrace2-cli/v1.0.12+20190622.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-cloudtrace2-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-cloudtrace2" = rec {
        crateName = "google-cloudtrace2";
        version = "1.0.12+20190622";
        edition = "2015";
        sha256 = "199hm1amqsvsy14m0j84547808qhh9i6kixr49pvdbl2gbi6xw98";
        authors = [
      ...
      "google-cloudtrace2-cli" = rec {
        crateName = "google-cloudtrace2-cli";
        version = "1.0.12+20190622";
        edition = "2015";
        crateBin = [
          { name = "cloudtrace2"; path = "src/main.rs"; }
        ];
