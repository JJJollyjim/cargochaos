...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/naja_async_runtime/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "naja_async_runtime" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "external_doc" "juliex" ];
      };
      "nodrop" = rec {
        crateName = "nodrop";
        version = "0.1.14";
      ...
      "wasm-bindgen-test" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1a4fbzpq1il04sr4qhii31ndv0vgs5b385pq6m44rfrywk0k0g9c";
        authors = [
          "The wasm-bindgen Developers"
        ];
        dependencies = [
      ...
      "wasm-bindgen-test-macro" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1gli5ifp140hlygn2x7x3hmlxac2kzcsiiqs0sz1830ccc9302az";
        procMacro = true;
        authors = [
          "The wasm-bindgen Developers"
        ];
