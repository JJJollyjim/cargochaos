...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/radish-server/v0.1.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "radish-database" = rec {
        crateName = "radish-database";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0g63hrqs4xvsq0x4nl0f24j82k9kza418861gij9fbffj71wpxv3";
        authors = [
          "Dmitry Shatilov <shatilov.diman@gmail.com>"
        ];
        dependencies = [
          {
            name = "indexmap";
      ...
      "radish-server" = rec {
        crateName = "radish-server";
        version = "0.1.2";
        edition = "2018";
        crateBin = [
          { name = "radish-server"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "radish-database";
            packageId = "radish-database";
          }
          {
            name = "radish-types";
            packageId = "radish-types";
      ...
      "radish-types" = rec {
        crateName = "radish-types";
        version = "0.1.0";
        edition = "2018";
        sha256 = "05x7ahxarvscwzvd0ww59fg891vh0jslvavbxj2jwj8h5f171sc9";
        authors = [
          "Dmitry Shatilov <shatilov.diman@gmail.com>"
        ];
        dependencies = [
