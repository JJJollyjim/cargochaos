...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/earth_codec/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "earth_codec" = rec {
        crateName = "earth_codec";
        version = "0.0.1";
        edition = "2018";
        crateBin = [
          { name = "earth_codec"; path = "src/main.rs"; }
        ];
      ...
      "keyphrase" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0y228kdvj0lf3wsv5qv9zysv4xb8njnl0rckbi9k8s8k55m3c4hv";
        authors = [
          "Gabriel Cardona <https://www.earth.engineering>"
        ];
        dependencies = [
