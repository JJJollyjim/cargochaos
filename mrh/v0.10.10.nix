...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/mrh/v0.10.10.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mrh" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "mrh"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.10.10.nix {};
        authors = [
        ...
        resolvedDefaultFeatures = [ "json" "serde" "serde_derive" "serde_json" "serde_yaml" "yaml" ];
      };
      "openssl-probe" = rec {
