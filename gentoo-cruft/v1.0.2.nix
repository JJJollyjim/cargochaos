...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gentoo-cruft/v1.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fs-tree" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0zm5729dl39lqfnz1s009qjdbm4cyi0ip0ld1lah3hvww5akm5cd";
        authors = [
      ...
      "gentoo-cruft" = rec {
        crateName = "gentoo-cruft";
        version = "1.0.2";
        edition = "2018";
        crateBin = [
          { name = "cruft"; path = "src/main.rs"; }
        ];
