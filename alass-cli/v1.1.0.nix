...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alass-cli/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alass-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "alass-cli"; path = "src/main.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "byteorder" "default" "ffmpeg-binary" "statistics" ];
      };
      "alass-core" = rec {
        crateName = "alass-core";
        version = "1.1.0";
        edition = "2018";
        sha256 = "002423xf66xsjki86iwdh7k65sr5s6qwcdh5k5vc1x84ynlppima";
        authors = [
          "kaegi <kaegi.dev@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "statistics" ];
      };
      "ansi_term" = rec {
        crateName = "ansi_term";
        version = "0.11.0";
      ...
      "image" = rec {
        ...
        version = "0.13.0";
        edition = "2015";
        sha256 = "1a3dkw777zrnsg7ghz726cnvim4i82hshq57xjcriv8kl9g4ygqw";
        authors = [
          "ccgn"
      ...
      "subparse" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "11qnzw1kqfqh2qaivkj4xc2ghma6f7a4vpwzm3qak4hna96dxbrw";
        authors = [
          "kaegi <kaegi.dev@gmail.com>"
        ];
        dependencies = [
      ...
      "vobsub" = rec {
        ...
        version = "0.2.3";
        edition = "2015";
        sha256 = "04n8xal5rrfp82bd39a81ny1rj3ycr5k0diliymbdn961rk2s4ma";
        authors = [
      ...
      "webrtc-vad" = rec {
        crateName = "webrtc-vad";
        version = "0.1.0";
        edition = "2018";
        sha256 = "1fjdbn8isrns0nb2cx6swjcv8x21sjwmxs66i4zvz1jh7randshp";
        authors = [
          "kaegi <kaegi.dev@gmail.com>"
        ];
        buildDependencies = [
