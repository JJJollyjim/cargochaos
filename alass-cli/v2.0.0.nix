...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/alass-cli/v2.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "alass-cli" = rec {
        ...
        resolvedDefaultFeatures = [ "byteorder" "default" "ffmpeg-binary" ];
      };
      "alass-core" = rec {
        crateName = "alass-core";
        version = "2.0.0";
        edition = "2018";
        sha256 = "09012w850w8sb966nw5akiwgk6fkad4v43gvqhfp7lzv7vjmdbgl";
        authors = [
          "kaegi <kaegi.dev@gmail.com>"
        ];
        features = {
      ...
      "subparse" = rec {
        ...
        version = "0.6.2";
        edition = "2018";
        sha256 = "0f803n1x989ypma40jklxdlbascmi46smbljx2q0185cdxg9mpw5";
        authors = [
          "kaegi <kaegi.dev@gmail.com>"
        ];
        dependencies = [
      ...
      "webrtc-vad" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "021h9v4lz9yaxgvp6c5iw5p2i91bgx9s4lli8navx46asq7y989r";
        authors = [
          "kaegi <kaegi.dev@gmail.com>"
        ];
        buildDependencies = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "ntdef" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" ];
      };
