...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/unix-fifo-async/v0.0.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "async-std" = rec {
        ...
        version = "0.99.3";
        edition = "2018";
        sha256 = "0gqqxmdz20d8x8szlav7xzv5hcvgy0nnxg2ms7png3hxm028rg32";
        authors = [
