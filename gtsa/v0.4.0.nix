...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gtsa/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gtsa" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "gtsa"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Mnwa <mihan@panfilov.biz>"
        ];
        dependencies = [
          {
            name = "actix";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "rt-core" "rt-util" "signal" "signal-hook-registry" "slab" "stream" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.0";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
