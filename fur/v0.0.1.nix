...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fur/v0.0.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "mio 0.7.0-alpha.1" = rec {
        crateName = "mio";
        version = "0.7.0-alpha.1";
        edition = "2018";
        sha256 = "18dmdg2raw82z8a06d75p2wzm02sh38kham2il3p00jf6ll1829z";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "evntrace" "fileapi" "handleapi" "in6addr" "inaddr" "ioapiset" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "std" "synchapi" "threadpoollegacyapiset" "winbase" "windef" "winerror" "winioctl" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
