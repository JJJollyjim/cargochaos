...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/knox/v0.3.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "libknox" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1nvdqj8xr80ipgsy0c17c9flrhjyvz4v2a0swaahqg814bsjsqd8";
        authors = [
          "Antoine POPINEAU <antoine.popineau@appscho.com>"
        ];
        dependencies = [
