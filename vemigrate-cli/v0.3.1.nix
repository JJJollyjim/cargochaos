...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vemigrate-cli/v0.3.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cdrs" = rec {
        ...
        version = "2.3.0";
        edition = "2018";
        sha256 = "0nj95a9zxywiasggf4j70b4qcx9hi3im0ivg31cyjp1zsn9r1qcm";
        authors = [
      ...
      "cdrs_helpers_derive" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0hnszy7vswxz72xhr17f3yqsky0b7whxlr0nns5y02l9hm4snkj5";
        procMacro = true;
        authors = [
          "Alex Pikalov <alex.pikalov.khar@gmail.com>"
        ];
      ...
      "vemigrate" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "1r1dyqsb0wg7qrnyyvnrp9a7rh2pibmrv321gbymnmpx6pawkyy2";
        authors = [
          "Arekkusuva <vuraddo@yahoo.com>"
        ];
        
      };
      "vemigrate-cli" = rec {
        crateName = "vemigrate-cli";
        version = "0.3.1";
        edition = "2018";
        crateBin = [
          { name = "vemigrate-cli"; path = "src/main.rs"; }
        ];
