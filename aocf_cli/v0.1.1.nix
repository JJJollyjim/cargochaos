...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/aocf_cli/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aocf" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "1f8qljsjxgkzdxg9mgnrqsl6acdmmp24fl5c6dawfj999nc17gqp";
        authors = [
          "Ed Cragg <ed@eipi.xyz>"
        ];
        dependencies = [
          {
            name = "failure";
      ...
      "aocf_cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "aocf"; path = "src/bin/aocf.rs"; }
        ];
      ...
      "html2md" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "0g13y9nas18ca6z0xky65554g0g6jh3cxkrmz8ihx2p1xcahbx73";type = [ "rlib" "dylib" "staticlib" ];
        authors = [
          "Oleg `Kanedias` Chernovskiy <kanedias@xaker.ru>"
        ];
        dependencies = [
          {
            name = "html5ever";
      ...
      "jni" = rec {
        ...
        version = "0.11.0";
        edition = "2015";
        sha256 = "14j2zc2vgpixxmbwjr34kyg14xszzbmggfasvrcvzh0xgl4wlki9";
        authors = [
