...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tarssh/v0.4.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rusty-sandbox" = rec {
        crateName = "rusty-sandbox";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0yys71f3lyf8459wrwm4l3g102hbipkb6f71bakrbkadagalnb05";
        authors = [
      ...
      "tarssh" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "signal" "sync" "net" "time" "tcp" "io-driver" "io-util" "rt-threaded" ];
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "default" "drop_privs" "privdrop" "rusty-sandbox" "sandbox" ];
      };
      "termcolor" = rec {
        crateName = "termcolor";
        version = "1.1.0";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "dns" "fnv" "io-driver" "io-util" "iovec" "lazy_static" "libc" "memchr" "mio" "mio-uds" "net" "num_cpus" "rt-core" "rt-threaded" "signal" "signal-hook-registry" "slab" "sync" "tcp" "time" "udp" "uds" "winapi" ];
      };
