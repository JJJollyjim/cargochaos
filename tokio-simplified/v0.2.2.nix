...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-simplified/v0.2.2.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "futures-promises" = rec {
        crateName = "futures-promises";
        version = "0.1.7";
        edition = "2018";
        sha256 = "1z83rjph3zdwrlwqkm0mipzqkb3nh7ksd6cph7sqvqzcank572qs";
        authors = [
          "Pierre Avital <pierre.avital+gitlab@gmail.com>"
        ];
        dependencies = [
          {
            name = "futures";
      ...
      "tokio-simplified" = rec {
        ...
        resolvedDefaultFeatures = [ "big_channels" "very_big_channels" ];
      };
      "tokio-sync" = rec {
