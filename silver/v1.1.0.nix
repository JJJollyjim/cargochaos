...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/silver/v1.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "silver" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "winapi";
            target = { target, features }: target."windows";
            features = [ "handleapi" "processthreadsapi" "securitybaseapi" ];
          }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "knownfolders" "minwinbase" "minwindef" "ntdef" "ntsecapi" "objbase" "processenv" "processthreadsapi" "profileapi" "securitybaseapi" "shlobj" "std" "sysinfoapi" "timezoneapi" "winbase" "winerror" "winnt" "wow64apiset" ];
      };
