...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/snare/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cfgrammar" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "00d9x6842xgbnvinsljgskcldn1m1d5n1cgyyj5cxiqcw12dkwi0";
      ...
      "lrlex" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1pak46mc61b0mv5r01dkmj4rsarzi8r48af23xqssa7j6zxynnr0";
        libPath = "src/lib/mod.rs";
        authors = [
          "Laurence Tratt <http://tratt.net/laurie/>"
        ];
      ...
      "lrtable" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "0i7h7vz47wx6g7d8pyxmy2b828qik2nrd9mrd1v2fdcigcmakbrm";
        libPath = "src/lib/mod.rs";
        authors = [
          "Lukas Diekmann <http://lukasdiekmann.com/>"
          "Laurence Tratt <http://tratt.net/laurie/>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "wow64apiset" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
