...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/crossref/v0.2.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "crossref" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "crossref"; path = "src/crossref.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.2.nix {};
        authors = [
          "matthiasseitz <matthias.seitz@tum.de>"
        ];
        dependencies = [
          {
            name = "chrono";
        ...
        resolvedDefaultFeatures = [ "cli" "pretty_env_logger" "structopt" ];
      };
      "dtoa" = rec {
        crateName = "dtoa";
        version = "0.4.4";
