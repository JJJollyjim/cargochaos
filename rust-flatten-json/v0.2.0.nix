...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rust-flatten-json/v0.2.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rust-flatten-json" = rec {
        crateName = "rust-flatten-json";
        version = "0.2.0";
        edition = "2015";
        crateBin = [
          { name = "from_stdin"; path = "src/bin/from_stdin.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        libName = "flatten_json";
        authors = [
