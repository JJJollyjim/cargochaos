...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dlphn/v0.4.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dlphn" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "dlphn"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.4.0.nix {};
        authors = [
          "Todd Treece <todd@uniontownlabs.org>"
        ];
        dependencies = [
          {
            name = "actix-rt";
      ...
      "local-ip" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0d0d8jbdnvy7g0n5qxj6j2vdixmx5nky03c096wb4jgadsryr68i";
        authors = [
          "Tim Ryan <id@timryan.org>"
        ];
        dependencies = [
          {
            name = "regex";
      ...
      "r2d2_sqlite" = rec {
        ...
        version = "0.13.0";
        edition = "2015";
        sha256 = "17hx5nlhm8jabizydjy4anjaw4vxzkk943r6xcgfifwjcsqzaqdh";
        authors = [
      ...
      "rusqlite" = rec {
        ...
        resolvedDefaultFeatures = [ "bundled" "chrono" "serde_json" ];
      };
      "rust-embed" = rec {
