...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dynpool/v0.0.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "backoff" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "12apmwm4ah91mdv75c3q1bgkrxb9057npjwi32xykpy95k86ggdp";
        authors = [
      ...
      "dynpool" = rec {
        ...
        resolvedDefaultFeatures = [ "instrument" ];
      };
      "fuchsia-zircon" = rec {
