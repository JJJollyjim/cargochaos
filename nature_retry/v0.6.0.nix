...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nature_retry/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        version = "1.4.1";
        edition = "2015";
        sha256 = "0qz86v6yb0mcjbl43l7phwzi6m157i4lrb0w95p49ffzy6y9qim2";
        authors = [
        ...
        resolvedDefaultFeatures = [ "chrono" "mysql" "mysqlclient-sys" "r2d2" "url" ];
      };
      "diesel_derives" = rec {
      ...
      "nature_common" = rec {
        crateName = "nature_common";
        version = "0.6.0";
        edition = "2018";
        sha256 = "1xmhibzja29i90hg1l94nvhhxbl7sb2y3b44xppyly0pkhc21rkr";
        authors = [
          "XueBin Li <llxxbb@yeah.net>"
        ];
        dependencies = [
          {
            name = "actix";
      ...
      "nature_db" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0mvdrzkx02hq0shk7a91w8sqnaq1yycjw6ri9igv7rnbfxlbsn03";
        authors = [
          "XueBin Li <llxxbb@yeah.net>"
        ];
        dependencies = [
      ...
      "nature_retry" = rec {
        crateName = "nature_retry";
        version = "0.6.0";
        edition = "2018";
        crateBin = [
          { name = "retry"; path = "src/bin/retry.rs"; }
        ];
      ...
      "r2d2" = rec {
        ...
        version = "0.8.3";
        edition = "2015";
        sha256 = "08mxwyrd0p6xaglxr32b7gdhvsalb19sswzzlz79rcfsl346yx2x";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "uuid" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "md5" "rand" "std" "v3" "v4" ];
      };
      "vcpkg" = rec {
        crateName = "vcpkg";
        version = "0.2.6";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
