...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/blend2d/v0.3.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "blend2d-sys" = rec {
        crateName = "blend2d-sys";
        version = "0.3.0";
        edition = "2018";
        sha256 = "16p1yi6wba1qhfcaskrwywxnay566kwvr5hqz2xf96n98pll9ah3";
        authors = [
          "Lukas Wirth <lukastw97@gmail.com>"
        ];
        buildDependencies = [
        ...
        resolvedDefaultFeatures = [ "avx" "avx2" "default" "sse2" "sse3" "sse4_1" "sse4_2" "ssse3" ];
      };
      "byteorder" = rec {
        crateName = "byteorder";
        version = "1.3.1";
