...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/lindera-unidic-builder/v0.3.2.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "lindera-unidic-builder";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lindera-unidic-builder" = rec {
        crateName = "lindera-unidic-builder";
        version = "0.3.2";
        edition = "2018";
        crateBin = [
          { name = "lindera-unidic"; path = "src/main.rs"; }
        ];
