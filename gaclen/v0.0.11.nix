...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gaclen/v0.0.11.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gaclen_shader" = rec {
        ...
        version = "0.0.11";
        edition = "2018";
        sha256 = "13b0j3kdj9j2wjzacjb93sjsfr4p2h4afsq4p4ny7b1ppy8427if";
        procMacro = true;
        authors = [
          "Grigory 'Griffone' Glukhov <thegriffones@gmail.com>"
        ];
      ...
      "vk-sys" = rec {
        ...
        version = "0.5.1";
        edition = "2015";
        sha256 = "0z6m6k9858l2m8khzawb1qbrx366plyhzp6j6ka6m1820iy10k62";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
      ...
      "vulkano" = rec {
        ...
        version = "0.17.0";
        edition = "2015";
        sha256 = "0jr513lnllp51p6av28cngzrk2nhzc3j41g94qhdfxvkxcsbjdwi";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
          "The vulkano contributors"
        ];
      ...
      "vulkano-win" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "16kwlngminlaxccmify7anpfycshqwsnyw533cj3ib9q8vnf2ags";
        authors = [
          "Pierre Krieger <pierre.krieger1708@gmail.com>"
          "The vulkano contributors"
        ];
