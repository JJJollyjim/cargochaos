...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gaclen/v0.0.7.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gaclen" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "expose-underlying-vulkano" ];
      };
      "gaclen_shader" = rec {
        crateName = "gaclen_shader";
        version = "0.0.7";
        edition = "2018";
        sha256 = "1h3jvb4p03h3ci0zcjwj1qrn6zy0ry6r4d2a650r5kmqn6c04z94";
        procMacro = true;
        authors = [
          "Grigory 'Griffone' Glukhov <thegriffones@gmail.com>"
        ];
