...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/domain-resolv/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "domain" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "0h7qmazwks6lz50c2pc548q4c059zgqgc6vpagp06b81k1x8wfw8";
        authors = [
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "smallvec" "std" ];
      };
      "domain-resolv" = rec {
        crateName = "domain-resolv";
        version = "0.5.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        libName = "domain_resolv";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "io-util" "macros" "tcp" "time" "udp" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "io-util" "iovec" "lazy_static" "macros" "memchr" "mio" "rt-core" "slab" "tcp" "time" "tokio-macros" "udp" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
