...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-tree/v0.27.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-tree" = rec {
        crateName = "cargo-tree";
        version = "0.27.0";
        edition = "2018";
        crateBin = [
          { name = "cargo-tree"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.27.0.nix {};
        authors = [
