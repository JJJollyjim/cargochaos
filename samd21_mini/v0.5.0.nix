...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/samd21_mini/v0.5.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atsamd-hal" = rec {
        ...
        resolvedDefaultFeatures = [ "atsamd21g18a" "samd21" "samd21g18a" "samd21g18a-rt" "unproven" ];
      };
      "atsamd21g18a" = rec {
      ...
      "samd21_mini" = rec {
        crateName = "samd21_mini";
        version = "0.5.0";
        edition = "2015";
        src = pkgs.callPackage ./tarball-v0.5.0.nix {};
        authors = [
          "Ze'ev Klapow <zklapow@gmail.com>"
        ];
        dependencies = [
          {
            name = "atsamd-hal";
        ...
        resolvedDefaultFeatures = [ "cortex-m-rt" "default" "rt" "unproven" "use_semihosting" ];
      };
      "semver" = rec {
        crateName = "semver";
        version = "0.9.0";
