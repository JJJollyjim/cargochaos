...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/amp-async/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "futures-core" "io-driver" "io-std" "io-util" "lazy_static" "libc" "macros" "memchr" "mio" "mio-uds" "rt-core" "rt-util" "signal" "signal-hook-registry" "stream" "sync" "tcp" "tokio-macros" "winapi" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "minwindef" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
