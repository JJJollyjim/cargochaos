...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/git-req/v2.2.0-rc.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-req" = rec {
        ...
        src = pkgs.callPackage ./tarball-v2.2.0-rc.0.nix {};
        authors = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "processthreadsapi" "profileapi" "shlobj" "std" "synchapi" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
