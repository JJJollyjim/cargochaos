...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/guzuta/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "guzuta" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "guzuta"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.3.0.nix {};
        authors = [
          "Kohei Suzuki <eagletmt@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
