...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dqcsim-openqasm/v0.1.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "dqcsim" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1nfh0c7f9zpln9ccks87m4yhy2mcriz71lw6w081imh0vdmk1gr3";
        ...
        resolvedDefaultFeatures = [ "ansi_term" "clap" "cli" "default" "git-testament" "null-plugins" "structopt" ];
      };
      "dqcsim-openqasm" = rec {
        crateName = "dqcsim-openqasm";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "dqcsfeqasm"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.0.nix {};
        authors = [
          "Matthijs Brobbel <m1brobbel@gmail.com>"
        ];
        dependencies = [
          {
            name = "dqcsim";
      ...
      "qasm" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "0kki899j6rb1n2vv2bsv48gk7zi53h2xynsr6aw3m7za9shmjnx2";
        authors = [
