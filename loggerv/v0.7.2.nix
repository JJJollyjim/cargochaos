...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/loggerv/v0.7.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "handleapi" "minwinbase" "minwindef" "processenv" "winbase" ];
      };
