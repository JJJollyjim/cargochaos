...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/sx127x_lora/v0.3.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sx127x_lora" = rec {
        crateName = "sx127x_lora";
        version = "0.3.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.3.1.nix {};
        authors = [
          "Charles Wade <charles.wade@rockets.utoledo.edu>"
        ];
        dependencies = [
          {
            name = "bit_field";
