...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-binutils/v0.1.7.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-binutils" = rec {
        crateName = "cargo-binutils";
        version = "0.1.7";
        edition = "2015";
        crateBin = [
          { name = "rust-strip"; path = "src/bin/rust-strip.rs"; }
          { name = "rust-size"; path = "src/bin/rust-size.rs"; }
          { name = "rust-readobj"; path = "src/bin/rust-readobj.rs"; }
          { name = "rust-profdata"; path = "src/bin/rust-profdata.rs"; }
          { name = "rust-objdump"; path = "src/bin/rust-objdump.rs"; }
          { name = "rust-objcopy"; path = "src/bin/rust-objcopy.rs"; }
          { name = "rust-nm"; path = "src/bin/rust-nm.rs"; }
          { name = "rust-lld"; path = "src/bin/rust-lld.rs"; }
          { name = "rust-ld"; path = "src/bin/rust-ld.rs"; }
          { name = "rust-ar"; path = "src/bin/rust-ar.rs"; }
          { name = "cargo-strip"; path = "src/bin/cargo-strip.rs"; }
          { name = "cargo-size"; path = "src/bin/cargo-size.rs"; }
          { name = "cargo-readobj"; path = "src/bin/cargo-readobj.rs"; }
          { name = "cargo-profdata"; path = "src/bin/cargo-profdata.rs"; }
          { name = "cargo-objdump"; path = "src/bin/cargo-objdump.rs"; }
          { name = "cargo-objcopy"; path = "src/bin/cargo-objcopy.rs"; }
          { name = "cargo-nm"; path = "src/bin/cargo-nm.rs"; }
        ];
      ...
      "cc" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "01q09asiybpzvp2f1ql6pzk8k3lxzrzv1557292qvlpx8v0hfq2a";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        features = {
