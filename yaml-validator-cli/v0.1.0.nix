...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/yaml-validator-cli/v0.1.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "yaml-validator" = rec {
        crateName = "yaml-validator";
        version = "0.1.0";
        edition = "2018";
        sha256 = "0b4h3d3bjvpxjgis75060l1ivrplv9iz09nyhrdfkfjv3k8rj5bp";
        authors = [
          "Mathias Pius <contact@pius.io>"
        ];
        dependencies = [
          {
            name = "thiserror";
      ...
      "yaml-validator-cli" = rec {
        crateName = "yaml-validator-cli";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "yaml-validator-cli"; path = "src/main.rs"; }
        ];
