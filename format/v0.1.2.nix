...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/format/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "format-core" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "13qbrsjwqfhymv8w33yb8fc2sdb2dicdla9g4z9q59qm3y0iiz82";
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
      ...
      "format-macro" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1xl3dj08aid33p1ykw5dam6xiaiv5r1fip6f64n48k1msdfs2a54";
        procMacro = true;
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
