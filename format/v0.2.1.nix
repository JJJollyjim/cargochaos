...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/format/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      "format" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "format-macro" "macro" "nightly" "unstable" ];
      };
      "format-core" = rec {
        crateName = "format-core";
        version = "0.2.1";
        edition = "2018";
        sha256 = "1f7bs7n0lcy0ypdfnyvfqhbgd0xzl311y6yyizb18rdnl08w109z";
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
      ...
      "format-macro" = rec {
        ...
        version = "0.2.1";
        edition = "2018";
        sha256 = "015lnpfh50i88h627ixfy9kb013mhvd2r1xnyvrj110j9gnbzhjy";
        procMacro = true;
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
