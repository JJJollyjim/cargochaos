...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/format/v0.1.3.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "format" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "format-macro" "macro" ];
      };
      "format-core" = rec {
        crateName = "format-core";
        version = "0.1.3";
        edition = "2018";
        sha256 = "1za2hxa4db1c7hip72chmhwd1kir1vc93967pxqjxgzfhnksdr00";
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
      ...
      "format-macro" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "1yls2dmaw3pg2jqlkr2xajnalmpy9c9ij2nvm4g233djv3xhcflq";
        procMacro = true;
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
