...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/format/v0.2.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "format-core" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "1sl3kwazq96r0f8mg6n0yrc4gnzklqyikaflkm56c3h52fpy4v7i";
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
      ...
      "format-macro" = rec {
        ...
        version = "0.2.0";
        edition = "2018";
        sha256 = "0b7l8glj0a1p5n9a8d8vkbcsqpl4pgf9havwby6ka78z9fmkq6al";
        procMacro = true;
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
