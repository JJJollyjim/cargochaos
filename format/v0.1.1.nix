...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/format/v0.1.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "format-core" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "08qwa292yn3jrr2swmqr3wp8v3r0jb96abbxqd45wdmls53kkw7s";
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
      ...
      "format-macro" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "036njm3x0qq04dmm8yaiac0dkspmhfkqz56xvn95bwpww9kyy050";
        procMacro = true;
        authors = [
          "kgv <kgv@users.noreply.github.com>"
        ];
