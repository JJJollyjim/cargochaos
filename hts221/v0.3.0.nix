...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/hts221/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "stm32f30x" = rec {
        ...
        version = "0.7.1";
        edition = "2015";
        sha256 = "0fvnh4w4cvb53pz9f1g91sk250ql2g9a6pv4i4nqr36ywmgdpkvc";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
      ...
      "stm32f30x-hal" = rec {
        crateName = "stm32f30x-hal";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0b28swpysqs6ajjzbnnpva3zc7rsg4gjnqb69yrzg585nmhkchbb";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
