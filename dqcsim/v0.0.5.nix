...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dqcsim/v0.0.5.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git-testament" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "15d6v06j3hcn70rbmaxdm1vc91fsdi6cjrsy91l3jkckbazbzf22";
        authors = [
      ...
      "git-testament-derive" = rec {
        ...
        version = "0.1.7";
        edition = "2018";
        sha256 = "029zjzi7crwa7s1cfvagwqs4klkspkd4lxm7vi477hgps570rwr7";
        procMacro = true;
        authors = [
          "Daniel Silverstone <dsilvers@digital-scurf.org>"
        ];
      ...
      "ipc-channel" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "05sjs5wrmqh3fq079amff5sx12bixa3gs1s84mnpjbhxvpkqxnbr";
        authors = [
