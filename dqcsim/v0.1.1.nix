...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/dqcsim/v0.1.1.nix.tmp"
    ...
    crates = {
      ...
      "dqcsim" = rec {
        ...
        crateBin = [
          ...
          { name = "dqcsbenull"; path = "src/bin/null/backend.rs"; }
          { name = "dqcsopnull"; path = "src/bin/null/operator.rs"; }
          { name = "dqcsfenull"; path = "src/bin/null/frontend.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "ansi_term" "bindings" "cbindgen" "clap" "cli" "default" "git-testament" "lazy_static" "libc" "null-plugins" "regex" "structopt" ];
      };
      "dtoa" = rec {
        crateName = "dtoa";
        version = "0.4.4";
      ...
      "integer-sqrt" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "00y9n0jx9kzr4zj7swnfv6g9b0py0n69h60lbykq5wx67fxml5ga";
        authors = [
