...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/vcontrol/v0.3.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "vcontrol" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "vcontrol"; path = "src/bin/vcontrol.rs"; }
          { name = "vclient"; path = "src/bin/vclient.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "serde_json" ];
      };
      "vec_map" = rec {
        crateName = "vec_map";
        version = "0.8.1";
      ...
      "yaml-merge-keys" = rec {
        crateName = "yaml-merge-keys";
        version = "0.4.0";
        edition = "2015";
        sha256 = "1ylccnxg4nqlq2gwx2w3bwng9shh98hn2xwc942bglisp8c372ar";
        authors = [
        ...
        resolvedDefaultFeatures = [ "serde_yaml" ];
      };
      "yaml-rust" = rec {
        crateName = "yaml-rust";
        version = "0.4.3";
