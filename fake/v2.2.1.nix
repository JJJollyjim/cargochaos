...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/fake/v2.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "fake 2.2.0" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "derive" "dummy" "http" ];
      };
      "fake 2.2.1" = rec {
        crateName = "fake";
        version = "2.2.1";
        ...
        devDependencies = [
          {
            name = "fake";
            packageId = "fake 2.2.0";
            features = [ "derive" "http" "chrono" ];
          }
        ];
        features = {
          "derive" = [ "dummy" ];
        ...
        resolvedDefaultFeatures = [ "chrono" "derive" "dummy" "http" "wasm-bindgen" ];
      };
      "fnv" = rec {
        crateName = "fnv";
        version = "1.0.6";
