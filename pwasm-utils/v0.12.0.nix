...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/pwasm-utils/v0.12.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aster" = rec {
        ...
        version = "0.41.0";
        edition = "2015";
        sha256 = "1q704kn23wnwnrxml7w1mxw6a3xb6386x5wgys6ibnyramrxzksc";
        authors = [
      ...
      "binaryen" = rec {
        ...
        version = "0.8.1";
        edition = "2015";
        sha256 = "038b399v6c93l1cjlwibdlj6z78zy5b5rnrxfqndn8narjd30b1g";
        authors = [
      ...
      "binaryen-sys" = rec {
        ...
        version = "0.8.1";
        edition = "2015";
        sha256 = "06v3nzr0l5k76p6jlypigzd2vxlkxnchdaw3a0yfvs4lk81fpkj6";
        authors = [
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
        ];
        buildDependencies = [
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "01g5pa9xl63ygcq1vb7ppmljlw45nizzibb1fiij1nallxaly0ik";
        authors = [
      ...
      "clang-sys" = rec {
        ...
        version = "0.19.0";
        edition = "2015";
        sha256 = "16mlsm81phcx3ghmzgxbjkc5jmxmns3ph0hdij5gsfk2lziw47k1";
        authors = [
      ...
      "cmake" = rec {
        ...
        version = "0.1.38";
        edition = "2015";
        sha256 = "1j6fggcv675nwncflv6sbwh81ajf89lkg9jj0kygphsgagn0w8cn";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "indoc" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "06bwg2zzzjqllfjx57kp6gfa6p1rqjpil4hpg3i0w6pby21r42kk";
        authors = [
      ...
      "indoc-impl" = rec {
        ...
        version = "0.3.1";
        edition = "2015";
        sha256 = "0sazcd90avzxwl7yqwk3nw2wvs03n1l2cnmka596m4lkn64iqd65";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "proc-macro-hack" = rec {
        ...
        version = "0.5.4";
        edition = "2015";
        sha256 = "0rmb97j8xnp6im1j3d8axxgp6g877x3hg10y1qnxrpkkrlcsm41y";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "quasi" = rec {
        ...
        version = "0.32.0";
        edition = "2015";
        sha256 = "1csqqgz3aw85q570ywmhb34r3sqgi1sprf8xadfwzlfnai45ri0q";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
        ];
        dependencies = [
      ...
      "quasi_codegen" = rec {
        ...
        version = "0.32.0";
        edition = "2015";
        sha256 = "1m3nwzn5ip8y86cyfk6hdnbhiinsk2faag7l0cc4q11wl9gy5fai";
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
        ];
        dependencies = [
      ...
      "syntex" = rec {
        ...
        version = "0.58.1";
        edition = "2015";
        sha256 = "03lgd36cxhc6gzaab0wqvckbhml00s6s73lk34ymf6cklymf7xd8";
        authors = [
      ...
      "wabt" = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "0gfzr4rypddjxwll4k8d5rrifnhpvljxfngz63zlklcaq2iikqci";
        authors = [
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
        ];
        dependencies = [
      ...
      "wabt-sys" = rec {
        ...
        version = "0.1.4";
        edition = "2015";
        sha256 = "0ab5bsgwvb1kvip7rk792kv8679mcsz99pvfk7k9p0ypdkcv2rzw";
        authors = [
          "Sergey Pepyakin <s.pepyakin@gmail.com>"
        ];
        buildDependencies = [
      ...
      "winapi 0.3.7" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "minwinbase" "minwindef" "ntsecapi" "processenv" "profileapi" "std" "winbase" "winerror" "winnt" ];
      };
      "winapi-build" = rec {
