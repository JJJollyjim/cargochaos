...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/emuman/v1.10.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "emuman" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.10.0.nix {};
        authors = [
      ...
      "nohash-hasher" = rec {
        ...
        version = "0.1.2";
        edition = "2015";
        sha256 = "13hfpr4xl0xwnxs11vr53nvxbz5rdpm38w3gdyj3p6kzr5p7lraf";
        authors = [
