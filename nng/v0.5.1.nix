...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nng/v0.5.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cmake" = rec {
        ...
        version = "0.1.37";
        edition = "2015";
        sha256 = "01ickz92mxwan15n4zzmic305glrvb34hwjgf01frmi6y3xpj6y1";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "nng-sys" = rec {
        ...
        version = "1.1.1-rc.2";
        edition = "2018";
        sha256 = "0wg379wsilpfxfy8jkh2ih2lzlvncmr4rmj7rh2vf30mzs0z37r1";
        authors = [
          "Nathan Kent <nate@nkent.net>"
        ...
        resolvedDefaultFeatures = [ "build-nng" "cmake" ];
      };
    };
