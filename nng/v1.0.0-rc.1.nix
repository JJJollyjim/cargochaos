...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/nng/v1.0.0-rc.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nng" = rec {
        ...
        features = {
          "build-nng" = [ "nng-sys/build-nng" "nng-sys/nng-stats" ];
          "default" = [ "build-nng" ];
        };
        resolvedDefaultFeatures = [ "build-nng" "default" "ffi-module" ];
      };
      "nng-sys" = rec {
        crateName = "nng-sys";
        version = "1.2.3-rc.1";
        edition = "2018";
        sha256 = "0376qvrnwd77qhl9nz3irfdz8pywyvdb009dllg5cy1a3w7k0j9k";
        authors = [
          "Nathan Kent <nate@nkent.net>"
        ...
        resolvedDefaultFeatures = [ "build-nng" "cmake" "default" "nng-stats" ];
      };
      "version_check" = rec {
