...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rtr_translator/v0.1.1.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "rtr_translator" = rec {
        crateName = "rtr_translator";
        version = "0.1.1";
        edition = "2018";
        crateBin = [
          { name = "rtr_translator"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.1.nix {};
        authors = [
          "Clément Guiton <clement.guiton.dev@gmail.com>"
        ];
        dependencies = [
          {
            name = "glob";
