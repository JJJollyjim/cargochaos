...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/telegram-bot/v0.7.0.nix.tmp"
    ...
    crates = {
      ...
      "telegram-bot" = rec {
        ...
        authors = [
          ...
          "Gustavo Aguiar <gustavo.h.o.aguiar@gmail.com>"
        ];
        dependencies = [
          {
            name = "bytes";
        ...
        resolvedDefaultFeatures = [ "default" "hyper-rustls" "hyper-tls" "openssl" "rustls" ];
      };
      "telegram-bot-raw" = rec {
        crateName = "telegram-bot-raw";
        version = "0.7.0";
        edition = "2018";
        sha256 = "0b39v4sl0vfwx9a00mwr0v2d21dfgija861b14gka1g4pqs5immd";
        authors = [
          "Lukas Kalbertodt <lukas.kalbertodt@gmail.com>"
          "Fedor Gogolev <knsd@knsd.net>"
          "Gustavo Aguiar <gustavo.h.o.aguiar@gmail.com>"
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      "winapi-build" = rec {
