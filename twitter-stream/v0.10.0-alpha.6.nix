...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/twitter-stream/v0.10.0-alpha.6.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-timeout" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "02jbr27gbwdbzj64p7mrjcmnq28lxz9j304j8n7yzqsqh85rn7qd";
        authors = [
      ...
      "oauth1-request" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "14i6q4cfwdrini3j7ghclp5xzr8mqy2m3wpzss5blif6l9mzj3bl";
        authors = [
      ...
      "oauth1-request-derive" = rec {
        ...
        version = "0.3.2";
        edition = "2018";
        sha256 = "0xd5ib8h9dlfz3q7p83bwdjsgxbm6y1f91mikhad02ax4rqijsw2";
        procMacro = true;
        authors = [
          "Daiki Mizukami <tesaguriguma@gmail.com>"
        ];
      ...
      "twitter-stream" = rec {
        ...
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.10.0-alpha.6.nix {};
        authors = [
          "Daiki Mizukami <tesaguriguma@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "async-compression" "default" "gzip" "hyper" "hyper-pkg" "hyper-tls" ];
      };
      "typenum" = rec {
        crateName = "typenum";
        version = "1.11.2";
