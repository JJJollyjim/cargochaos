...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/impromptu/v0.0.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "impromptu" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "impromptu"; path = "src/main.rs"; }
          { name = "impromptu-colors"; path = "src/main-colors.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.0.1.nix {};
        authors = [
          "Fabian Köhler <fkoehler1024@googlemail.com>"
        ];
        dependencies = [
          {
            name = "cached";
