...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-content2-cli/v1.0.13+20200310.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-content2" = rec {
        ...
        edition = "2015";
        sha256 = "10kmf9zraqnpy85dsmc2zrkx1g82rfh65cphz824qcymrfg71v0y";
        authors = [
      ...
      "google-content2-cli" = rec {
        ...
        src = pkgs.callPackage ./tarball-v1.0.13+20200310.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
