...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-content2-cli/v1.0.12+20190702.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-content2" = rec {
        crateName = "google-content2";
        version = "1.0.12+20190702";
        edition = "2015";
        sha256 = "1df8q80alnqy6pkpvnqbhcq2i0h8s1hkmkpn18d63vz0sr0rnbqb";
        authors = [
      ...
      "google-content2-cli" = rec {
        crateName = "google-content2-cli";
        version = "1.0.12+20190702";
        edition = "2015";
        crateBin = [
          { name = "content2"; path = "src/main.rs"; }
        ];
