...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/get_local_ip/v0.1.6.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "get_local_ip" = rec {
        crateName = "get_local_ip";
        version = "0.1.6";
        edition = "2018";
        crateBin = [
          { name = "get_local_ip"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.6.nix {};
        authors = [
          "Adiatma Kamarudin <adiatma.kamaarudin@ralali.com>"
        ];
        dependencies = [
          {
            name = "regex";
