...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/opcua-certificate-creator/v0.7.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "opcua-certificate-creator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "opcua-certificate-creator" = rec {
        crateName = "opcua-certificate-creator";
        version = "0.7.0";
        edition = "2018";
        crateBin = [
          { name = "opcua-certificate-creator"; path = "src/main.rs"; }
        ];
        ...
        dependencies = [
          ...
          {
            name = "opcua-core";
            packageId = "opcua-core";
          }
          {
            name = "opcua-types";
            packageId = "opcua-types";
          }
        ];
        
      };
      "opcua-core" = rec {
        crateName = "opcua-core";
        version = "0.7.0";
        edition = "2018";
        sha256 = "1497wigg4y3hdrz0w7awxskjyvklv6mgizvhy1b2b5hg0yc74ybm";
        authors = [
          "Adam Lock <locka99@gmail.com>"
        ];
        dependencies = [
      ...
      "opcua-types" = rec {
        crateName = "opcua-types";
        version = "0.7.0";
        edition = "2018";
        sha256 = "093f3pmmxxdphrrl1j5224wif7q2lbdaw1gavvl77v5h9wq91gyp";
        authors = [
          "Adam Lock <locka99@gmail.com>"
        ];
        dependencies = [
