...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/orderbook/v0.1.9.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "coinbase-pro-rs" = rec {
        crateName = "coinbase-pro-rs";
        version = "0.5.1";
        edition = "2015";
        sha256 = "0akv21l12z81n73wnk1w2raa2xsdgqvbvrn0kqfkz6a34cgmiycg";
        authors = [
          "ae <inv2004@gmail.com>"
        ];
        dependencies = [
          {
            name = "base64";
