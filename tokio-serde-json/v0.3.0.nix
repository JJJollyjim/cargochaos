...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/tokio-serde-json/v0.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "tokio-serde" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "08c8l8c0vrka7b6yqdv36k99911r9r6j6ypy337zr7jxrr39xl30";
        authors = [
          "Carl Lerche <me@carllerche.com>"
        ];
        dependencies = [
