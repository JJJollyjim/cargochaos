...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/jsonsv/v0.1.2.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "iri-string" = rec {
        ...
        version = "0.1.1";
        edition = "2015";
        sha256 = "1q12q3wyf3b78kqqfsw5airqfwfm52aanxaqzivqppisnmdrhpgy";
        authors = [
      ...
      "jsonschema-valid" = rec {
        ...
        version = "0.2.0";
        edition = "2015";
        sha256 = "191119djbfm628hakvikvipks5pj2k8nsyp20xramr01hsa0px4z";
        authors = [
      ...
      "jsonsv" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "jsonsv"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.2.nix {};
        authors = [
          "Efron Licht <efron.python@gmail.com>"
        ];
        dependencies = [
          {
      ...
      "opaque_typedef" = rec {
        ...
        version = "0.0.3";
        edition = "2015";
        sha256 = "0h0b800aif6s7mhsjhlgs18jzlxd4wpia71psm2ybyg43pz6mys7";
        authors = [
      ...
      "opaque_typedef_macros" = rec {
        ...
        version = "0.0.3";
        edition = "2015";
        sha256 = "1356k270bp83qibc73z66qi686j4slix0b71zzv00rvvlqggvcl8";
        procMacro = true;
        authors = [
          "YOSHIOKA Takuma <tashioka.256@gmail.com>"
        ];
      ...
      "strum" = rec {
        ...
        version = "0.9.0";
        edition = "2015";
        sha256 = "0i95aglal34csmizk6rmm7byzdy0lwivgi7qvid7pl3dvnsj37h9";
        authors = [
      ...
      "strum_macros" = rec {
        ...
        version = "0.9.1";
        edition = "2015";
        sha256 = "0p8shq1z1zffafz8jklpcvr8mywli5jb4bcvnvn9cilfd1gdi4hj";
        procMacro = true;
        authors = [
          "Peter Glotfelty <peglotfe@microsoft.com>"
        ];
