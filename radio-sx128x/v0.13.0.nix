...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/radio-sx128x/v0.13.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "embedded-spi" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "1k58imnsmpiih2lcswfg1l362b2sfmh5gz8xsqzc2wi9k8k8ayqa";
        authors = [
        ...
        resolvedDefaultFeatures = [ "linux-embedded-hal" "serde" "simplelog" "structopt" "toml" "utils" ];
      };
      "getrandom" = rec {
        crateName = "getrandom";
        version = "0.1.14";
      ...
      "linux-embedded-hal" = rec {
        ...
        version = "0.3.0";
        edition = "2015";
        sha256 = "0b84mgr7wkf7s1wy9iricwb36f03wp78mvghr6dr8bdv5672sjz0";
        authors = [
          "Jorge Aparicio <jorge@japaric.io>"
        ];
        dependencies = [
      ...
      "radio" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0rvazwffv3imk8f93x2hv2z6f8lmvvkbiwd7a9vkw40vja57lpaw";
        authors = [
          "Ryan Kurte <ryankurte@gmail.com>"
        ];
        dependencies = [
      ...
      "radio-sx128x" = rec {
        crateName = "radio-sx128x";
        version = "0.13.0";
        edition = "2015";
        crateBin = [
          { name = "sx128x-util"; path = "src/util/main.rs"; }
        ];
        ...
        features = {
          "default" = [ "util" "serde" ];
          "util" = [ "structopt" "linux-embedded-hal" "simplelog" "humantime" "embedded-spi/utils" ];
        };
      ...
      "spidev" = rec {
        ...
        version = "0.4.0";
        edition = "2015";
        sha256 = "1sczfwgi1rni1aq6pfjn29h24ma7zgw7x4clykylw3y2hwxajnma";
        authors = [
          "Paul Osborne <osbpau@gmail.com>"
        ];
        dependencies = [
