...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/imag-todo/v0.10.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "imag-todo" = rec {
        ...
        edition = "2015";
        crateBin = [
          { name = "imag-todo"; path = "src/bin.rs"; }
        ];
        ...
        resolvedDefaultFeatures = [ "default" "import-taskwarrior" "libimagentrylink" "libimagentrytag" "task-hookrs" "uuid" ];
      };
      "immeta" = rec {
        crateName = "immeta";
        version = "0.4.0";
      ...
      "task-hookrs" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "14bnsd6mkzq1d1xk9jak28wcdxbl6fx8h9ik27yhcrhsq40cigs5";
        authors = [
          "Matthias Beyer <mail@beyermatthias.de>"
