...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/onnx-helpers/v1.3.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
        ...
        devDependencies = [
          {
            ...
            packageId = "onnx-shape-inference";
          }
        ];
      ...
      "onnx-pb" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0zn06cjpwhqmqb582grjkvpg9mcwia4hxp3cp9yrshpp229js45m";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
      ...
      "onnx-shape-inference" = rec {
        crateName = "onnx-shape-inference";
        version = "1.0.0";
        edition = "2018";
        sha256 = "0jd12s101a7ma1yjcxpsvc9lh62rq4cf65f6hgn0vjs8k375aihp";
        authors = [
          "Łukasz Kurowski <crackcomm@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "onnx-pb" "prost" "proto" ];
      };
      "petgraph" = rec {
        crateName = "petgraph";
        version = "0.5.0";
