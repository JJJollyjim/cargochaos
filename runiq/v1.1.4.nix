...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/runiq/v1.1.4.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bytelines" = rec {
        ...
        version = "2.2.2";
        edition = "2018";
        sha256 = "0pv1dwbbqws84v31f64g6b3nxi0jbhi59cipwpg6651ys504w7kr";
        authors = [
      ...
      "runiq" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "scalable_bloom_filter";
          }
          {
            name = "xxhash2";
            packageId = "xxhash2";
      ...
      "scalable_bloom_filter" = rec {
        crateName = "scalable_bloom_filter";
        version = "0.1.1";
        edition = "2015";
        sha256 = "1i2iwzsjs3vjpnfnz60k9xylwma1kbkw1nk0fpp9jhjyvmpl7z1a";
        authors = [
      ...
      "xxhash-sys" = rec {
        crateName = "xxhash-sys";
        version = "0.1.0";
        edition = "2015";
        sha256 = "1l44slbnnzawyfalcwd928wx4bqbs827cjriigis7zjrw0d29dv5";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "xxhash2" = rec {
        ...
        version = "0.1.0";
        edition = "2015";
        sha256 = "10xihhbnxpnn6mzqghsv3nm7dw8p8pnjbksk2jf3fw038f3qhdnx";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
