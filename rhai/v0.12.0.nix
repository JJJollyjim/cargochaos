...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/rhai/v0.12.0.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "core-error" = rec {
        crateName = "core-error";
        version = "0.0.0";
        edition = "2015";
        sha256 = "13wvc7lcpi7f6rr0racns4l52gzpix4xhih6qns30hmn5sbv5kgg";
        authors = [
      ...
      "hashbrown" = rec {
        ...
        resolvedDefaultFeatures = [ "ahash" "inline-more" "nightly" ];
      };
      "libm" = rec {
        crateName = "libm";
        version = "0.2.1";
      ...
      "rhai" = rec {
        ...
        resolvedDefaultFeatures = [ "ahash" "core-error" "default" "hashbrown" "libm" "no_float" "no_function" "no_index" "no_object" "no_optimize" "no_std" "no_stdlib" "only_i32" "only_i64" "optimize_full" "sync" "unchecked" ];
      };
      "version_check" = rec {
