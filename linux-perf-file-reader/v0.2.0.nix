...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linux-perf-file-reader/v0.2.0.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "linux-perf-file-reader";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "linux-perf-file-reader" = rec {
        crateName = "linux-perf-file-reader";
        version = "0.2.0";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.0.nix {};
        authors = [
          "Mikhail Modin <mikhailm1@gmail.com>"
        ];
        dependencies = [
          {
            name = "bitflags";
