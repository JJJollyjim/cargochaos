...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-iam1-cli/v1.0.13+20200319.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-iam1" = rec {
        crateName = "google-iam1";
        version = "1.0.13+20200319";
        edition = "2015";
        sha256 = "17dr6mnjckknnrf5lbyqhiqzmqs1nlnkzahjav4kmgr8ksfm3a57";
        authors = [
      ...
      "google-iam1-cli" = rec {
        crateName = "google-iam1-cli";
        version = "1.0.13+20200319";
        edition = "2015";
        crateBin = [
          { name = "iam1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.13+20200319.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
