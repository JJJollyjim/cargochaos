...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/ethabi-cli/v10.0.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ethabi" = rec {
        ...
        version = "10.0.0";
        edition = "2015";
        sha256 = "07301a6j6hj7j156i3rpdig5nqsp26i58hpgbsvr04nrarjsdz5a";
        authors = [
      ...
      "ethabi-cli" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "ethabi"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v10.0.0.nix {};
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
        dependencies = [
      ...
      "rand" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "getrandom" "getrandom_package" "std" ];
      };
      "rand_chacha" = rec {
