...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/cargo-insta/v0.14.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo-insta" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "cargo-insta"; path = "src/main.rs"; }
        ];
      ...
      "insta" = rec {
        ...
        version = "0.14.0";
        edition = "2018";
        sha256 = "1xhp26r8ckmls588pg47q3hdx2nsv8p31lx86xm4bd235yv21p58";
        authors = [
          "Armin Ronacher <armin.ronacher@active-4.com>"
        ];
        dependencies = [
