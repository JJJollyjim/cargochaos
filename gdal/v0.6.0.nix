...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gdal/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bindgen" = rec {
        ...
        edition = "2015";
        crateBin = [];
        sha256 = "1s82s8ssk1rqhq8rjlry2y7gxrwx6d7ci6dpn89dzvv5ilph77a2";
        authors = [
      ...
      "gdal" = rec {
        ...
        resolvedDefaultFeatures = [ "array" "bindgen" "gdal_2_2" "ndarray" ];
      };
      "gdal-sys" = rec {
        crateName = "gdal-sys";
        version = "0.2.0";
        edition = "2015";
        sha256 = "0y893yjyzf80l3d0vdrvyy06w56bv0lwisjs0prd7kvkfdv88hzi";
        authors = [
          "Johannes Drönner <droenner@informatik.uni-marburg.de>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "bindgen" "default" "min_gdal_version_1_11" "min_gdal_version_2_2" ];
      };
      "geo-types" = rec {
        crateName = "geo-types";
        version = "0.4.3";
