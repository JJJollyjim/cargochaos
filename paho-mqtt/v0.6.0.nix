...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/paho-mqtt/v0.6.0.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "paho-mqtt" = rec {
        ...
        resolvedDefaultFeatures = [ "build_bindgen" "bundled" "default" "ssl" ];
      };
      "paho-mqtt-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "bindgen" "build_bindgen" "bundled" "cmake" "ssl" ];
      };
