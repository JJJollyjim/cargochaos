...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/py_pathfinding/v0.1.5.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "py_pathfinding" = rec {
        crateName = "py_pathfinding";
        version = "0.1.5";
        edition = "2018";
        crateBin = [
          { name = "py_pathfinding"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v0.1.5.nix {};
        authors = [
          "BuRny <gamingburny@gmail.com>"
        ];
        dependencies = [
          {
            name = "fnv";
