...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/gd32vf103-hal/v0.0.3.nix.tmp"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "gd32vf103-hal" = rec {
        crateName = "gd32vf103-hal";
        version = "0.0.3";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.0.3.nix {};
        libName = "gd32vf103_hal";
        authors = [
      ...
      "linked_list_allocator" = rec {
        ...
        version = "0.7.0";
        edition = "2015";
        sha256 = "0shkf015b9wq5rnmmjg323kp0xz67y81arrgyymr06847xcr26a1";
        authors = [
          "Philipp Oppermann <dev@phil-opp.com>"
        ];
        dependencies = [
