...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/google-firestore1-cli/v1.0.12+20190419.nix.tmp"
...
rec {
  ...
  rootCrate = rec {
    packageId = "google-firestore1-cli";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "google-firestore1" = rec {
        crateName = "google-firestore1";
        version = "1.0.12+20190419";
        edition = "2015";
        sha256 = "0agks1464mwnxnrni87l4fbn5jp4a15lqh5m1kn1iny33qzl5b97";
        authors = [
      ...
      "google-firestore1-cli" = rec {
        crateName = "google-firestore1-cli";
        version = "1.0.12+20190419";
        edition = "2015";
        crateBin = [
          { name = "firestore1"; path = "src/main.rs"; }
        ];
        src = pkgs.callPackage ./tarball-v1.0.12+20190419.nix {};
        authors = [
          "Sebastian Thiel <byronimo@gmail.com>"
        ];
        dependencies = [
          ...
          {
            name = "google-firestore1";
            packageId = "google-firestore1";
          }
          {
            name = "hyper";
            packageId = "hyper";
