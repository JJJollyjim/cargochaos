...
#   "generate" "-o" "/home/jamie/Misc/cratesioout/linux-aio-tokio/v0.2.1.nix.tmp"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "intrusive-collections" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1ny37qhp5mm8a5b6cpdnxx3yp9jwf3imi6m7vpa61k9ip05qrjjb";
        authors = [
      ...
      "linux-aio-tokio" = rec {
        crateName = "linux-aio-tokio";
        version = "0.2.1";
        edition = "2018";
        src = pkgs.callPackage ./tarball-v0.2.1.nix {};
        build = "build/build.rs";
        authors = [
          "Gleb Pomykalov <glebpom@gmail.com>"
          "Hans-Martin Will <hwill@acm.org>"
        ];
        dependencies = [
          {
            name = "async-trait";
        ...
        devDependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-core" "rt-threaded" "time" ];
          }
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fnv" "fs" "io-driver" "io-util" "lazy_static" "macros" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "sync" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "ntstatus" "processenv" "std" "sysinfoapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
